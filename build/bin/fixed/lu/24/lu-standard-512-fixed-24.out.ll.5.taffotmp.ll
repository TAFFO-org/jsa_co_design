; ModuleID = './build/bin/fixed/lu/24/lu-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3_fixp(i32 20, i32 20, i32* %u13_19fixp, i32 512), !taffo.info !45, !taffo.constinfo !47, !taffo.target !44
  ...
  call void @kernel_lu.1_fixp(i32 20, [20 x i32]* %arraydecay3.u13_19fixp), !taffo.info !45, !taffo.constinfo !46, !taffo.target !44
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_lu.1_fixp(i32 noundef %n, [20 x i32]* noundef %A.u13_19fixp) #0 !taffo.initweight !67 !taffo.funinfo !68 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body6:                                        ; preds = %for.cond4
  %arrayidx.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %arrayidx8.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %k.0, !taffo.info !41
  %u13_19fixp = load i32, i32* %arrayidx8.u13_19fixp, align 4, !taffo.info !41
  %arrayidx9.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %k.0, !taffo.info !41
  %arrayidx10.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx9.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp1 = load i32, i32* %arrayidx10.u13_19fixp, align 4, !taffo.info !41
  %0 = lshr i32 %u13_19fixp, 1, !taffo.info !41
  %1 = lshr i32 %u13_19fixp1, 1, !taffo.info !41
  %2 = ashr i32 %0, 12, !taffo.info !41
  %3 = ashr i32 %1, 12, !taffo.info !41
  %mul.s26_6fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 6), !taffo.info !70
  %arrayidx11.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %arrayidx12.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx11.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp2 = load i32, i32* %arrayidx12.u13_19fixp, align 4, !taffo.info !41
  %4 = lshr i32 %u13_19fixp2, 13, !taffo.info !41
  %sub.s26_6fixp = sub i32 %4, %mul.s26_6fixp, !taffo.info !73
  %5 = shl i32 %sub.s26_6fixp, 13, !taffo.info !73
  store i32 %5, i32* %arrayidx12.u13_19fixp, align 4, !taffo.info !75
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  %arrayidx13.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %j.0, !taffo.info !41
  %arrayidx14.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx13.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp3 = load i32, i32* %arrayidx14.u13_19fixp, align 4, !taffo.info !41
  %arrayidx15.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %arrayidx16.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx15.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp4 = load i32, i32* %arrayidx16.u13_19fixp, align 4, !taffo.info !41
  %6 = lshr i32 %u13_19fixp4, 1, !taffo.info !41
  %7 = lshr i32 %u13_19fixp3, 1, !taffo.info !41
  %8 = ashr i32 %6, 3, !taffo.info !41
  %9 = ashr i32 %7, 3, !taffo.info !41
  %10 = call i32 @llvm.sdiv.fix.i32(i32 %8, i32 %9, i32 15), !taffo.info !77
  %div.u16_16fixp = shl i32 %10, 1, !taffo.info !80
  %11 = shl i32 %div.u16_16fixp, 3, !taffo.info !80
  store i32 %11, i32* %arrayidx16.u13_19fixp, align 4, !taffo.info !45
  br label %for.inc17
...
for.body25:                                       ; preds = %for.cond23
  ...
  %arrayidx29.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx28.u13_19fixp, i32 0, i32 %k.1, !taffo.info !41
  %u13_19fixp5 = load i32, i32* %arrayidx29.u13_19fixp, align 4, !taffo.info !41
  %arrayidx30.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %k.1, !taffo.info !41
  %arrayidx31.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx30.u13_19fixp, i32 0, i32 %j.1, !taffo.info !41
  %u13_19fixp6 = load i32, i32* %arrayidx31.u13_19fixp, align 4, !taffo.info !41
  %12 = lshr i32 %u13_19fixp5, 1, !taffo.info !41
  %13 = lshr i32 %u13_19fixp6, 1, !taffo.info !41
  %14 = ashr i32 %12, 12, !taffo.info !41
  %15 = ashr i32 %13, 12, !taffo.info !41
  %mul32.s26_6fixp = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 6), !taffo.info !70
  %arrayidx33.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %arrayidx34.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx33.u13_19fixp, i32 0, i32 %j.1, !taffo.info !41
  %u13_19fixp7 = load i32, i32* %arrayidx34.u13_19fixp, align 4, !taffo.info !41
  %16 = lshr i32 %u13_19fixp7, 13, !taffo.info !41
  %sub35.s26_6fixp = sub i32 %16, %mul32.s26_6fixp, !taffo.info !73
  %17 = shl i32 %sub35.s26_6fixp, 13, !taffo.info !73
  store i32 %17, i32* %arrayidx34.u13_19fixp, align 4, !taffo.info !75
  br label %for.inc36
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.2_fixp(i32 noundef %n, [20 x i32]* noundef %A.u13_19fixp) #0 !taffo.initweight !67 !taffo.funinfo !68 !taffo.sourceFunction !86 {
entry:
  %B.u25_7fixp = alloca [20 x [20 x i32]], align 4, !taffo.info !87
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !111
  %arrayidx7.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !111
  %3 = ashr i32 %add.s3_29fixp, 10, !taffo.info !108, !taffo.constinfo !110
  store i32 %3, i32* %arrayidx7.u13_19fixp, align 4, !taffo.info !75
  br label %for.inc
...
for.body12:                                       ; preds = %for.cond9
  %arrayidx13.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !111
  %arrayidx14.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx13.u13_19fixp, i32 0, i32 %j.1, !taffo.info !111
  store i32 0, i32* %arrayidx14.u13_19fixp, align 4, !taffo.info !75, !taffo.constinfo !117
  br label %for.inc15
...
for.end17:                                        ; preds = %for.cond9
  %arrayidx18.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !111
  %arrayidx19.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx18.u13_19fixp, i32 0, i32 %i.0, !taffo.info !111
  store i32 524288, i32* %arrayidx19.u13_19fixp, align 4, !taffo.info !75, !taffo.constinfo !121
  br label %for.inc20
...
for.body31:                                       ; preds = %for.cond28
  %arrayidx32.u25_7fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u25_7fixp, i32 0, i32 %r.0, !taffo.info !87
  %arrayidx33.u25_7fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx32.u25_7fixp, i32 0, i32 %s.0, !taffo.info !87
  store i32 0, i32* %arrayidx33.u25_7fixp, align 4, !taffo.info !75, !taffo.constinfo !117
  br label %for.inc34
...
for.body51:                                       ; preds = %for.cond48
  %arrayidx52.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %r.1, !taffo.info !41
  %arrayidx53.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx52.u13_19fixp, i32 0, i32 %t.0, !taffo.info !41
  %u13_19fixp = load i32, i32* %arrayidx53.u13_19fixp, align 4, !taffo.info !41
  %arrayidx54.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %s.1, !taffo.info !41
  %arrayidx55.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx54.u13_19fixp, i32 0, i32 %t.0, !taffo.info !41
  %u13_19fixp1 = load i32, i32* %arrayidx55.u13_19fixp, align 4, !taffo.info !41
  %4 = lshr i32 %u13_19fixp, 1, !taffo.info !41
  %5 = lshr i32 %u13_19fixp1, 1, !taffo.info !41
  %6 = ashr i32 %4, 12, !taffo.info !41
  %7 = ashr i32 %5, 12, !taffo.info !41
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 6), !taffo.info !125
  %mul.u25_7fixp = shl i32 %8, 1, !taffo.info !126
  %arrayidx56.u25_7fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u25_7fixp, i32 0, i32 %r.1, !taffo.info !87
  %arrayidx57.u25_7fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx56.u25_7fixp, i32 0, i32 %s.1, !taffo.info !87
  %u25_7fixp2 = load i32, i32* %arrayidx57.u25_7fixp, align 4, !taffo.info !127
  %add58.u25_7fixp = add i32 %u25_7fixp2, %mul.u25_7fixp, !taffo.info !129
  store i32 %add58.u25_7fixp, i32* %arrayidx57.u25_7fixp, align 4, !taffo.info !75
  br label %for.inc59
...
for.body75:                                       ; preds = %for.cond72
  %arrayidx76.u25_7fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u25_7fixp, i32 0, i32 %r.2, !taffo.info !87
  %arrayidx77.u25_7fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx76.u25_7fixp, i32 0, i32 %s.2, !taffo.info !87
  %u25_7fixp = load i32, i32* %arrayidx77.u25_7fixp, align 4, !taffo.info !87
  %arrayidx78.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %r.2, !taffo.info !41
  %arrayidx79.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx78.u13_19fixp, i32 0, i32 %s.2, !taffo.info !41
  %9 = shl i32 %u25_7fixp, 12, !taffo.info !87
  store i32 %9, i32* %arrayidx79.u13_19fixp, align 4, !taffo.info !75
  br label %for.inc80
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !135 !taffo.funinfo !136 !taffo.sourceFunction !139 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !140
  %1 = lshr i32 %u13_19fixp, 1, !taffo.info !41
  %2 = lshr i32 %conv.u10_22fixp, 1, !taffo.info !140
  %3 = ashr i32 %1, 9, !taffo.info !41
  %4 = ashr i32 %2, 12, !taffo.info !140
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 9), !taffo.info !142
  %mul.u22_10fixp = shl i32 %5, 1, !taffo.info !145
  ...
  %7 = shl i32 %mul.u22_10fixp, 9, !taffo.info !145
...
!1 = !{double 0.000000e+00, double 0x40B05851DFFC547A}
...
!43 = !{double 1.000000e-01, double 0x40B05851DFFC547A}
!44 = !{!"A"}
...
!72 = !{double 0x3F847AE147AE147C, double 0x4170B28B463B78B0}
!73 = !{!71, !74, i1 false, i2 1}
!74 = !{double 0xC170B28B44A1DF16, double 0x40B0584F50A02B84}
!75 = !{i1 false, i1 false, i1 false, i2 1}
!76 = distinct !{!76, !23}
!77 = !{!78, !79, i1 false, i2 -1}
!78 = !{!"fixp", i32 -32, i32 15}
!79 = !{double 0x3EF90F455FEACCE2, double 0x40E46E6657FB6998}
!80 = !{!81, !79, i1 false, i2 -1}
!81 = !{!"fixp", i32 32, i32 16}
!82 = distinct !{!82, !23}
!83 = distinct !{!83, !23}
!84 = distinct !{!84, !23}
!85 = distinct !{!85, !23}
...
!88 = !{!"fixp", i32 32, i32 7}
!89 = !{double 0.000000e+00, double 0x4170B28B463B78B0}
...
!138 = !{double 5.120000e+02, double 5.120000e+02}
!139 = !{void (i32, i32, float*, i32)* @scale_2d}
!140 = !{!141, !138, i1 false, i2 1}
!141 = !{!"fixp", i32 32, i32 22}
!142 = !{!143, !144, i1 false, i2 -1}
!143 = !{!"fixp", i32 -32, i32 9}
!144 = !{double 5.120000e+01, double 0x41405851DFFC547A}
