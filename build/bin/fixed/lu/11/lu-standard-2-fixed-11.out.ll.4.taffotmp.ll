; ModuleID = './build/bin/fixed/lu/11/lu-standard-2-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div = fdiv float %conv, %conv6, !taffo.info !109, !taffo.initweight !78
  %add = fadd float %div, 1.000000e+00, !taffo.info !112, !taffo.initweight !78, !taffo.constinfo !114
  %arrayidx = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !115, !taffo.initweight !49
  %arrayidx7 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !115, !taffo.initweight !49
  store float %add, float* %arrayidx7, align 4, !taffo.info !86, !taffo.initweight !52
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !116, !taffo.initweight !49, !taffo.constinfo !21
  br label %for.cond3, !llvm.loop !118

for.end:                                          ; preds = %for.cond3
  %add8 = add nsw i32 %i.0, 1, !taffo.info !116, !taffo.initweight !49, !taffo.constinfo !21
  br label %for.cond9

for.cond9:                                        ; preds = %for.inc15, %for.end
  %j.1 = phi i32 [ %add8, %for.end ], [ %inc16, %for.inc15 ], !taffo.info !119, !taffo.initweight !44
...
for.body12:                                       ; preds = %for.cond9
  %arrayidx13 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !115, !taffo.initweight !49
  %arrayidx14 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx13, i32 0, i32 %j.1, !taffo.info !115, !taffo.initweight !49
  store float 0.000000e+00, float* %arrayidx14, align 4, !taffo.info !86, !taffo.initweight !52, !taffo.constinfo !121
  br label %for.inc15

for.inc15:                                        ; preds = %for.body12
  %inc16 = add nsw i32 %j.1, 1, !taffo.info !122, !taffo.initweight !49, !taffo.constinfo !21
  br label %for.cond9, !llvm.loop !124

for.end17:                                        ; preds = %for.cond9
  %arrayidx18 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !115, !taffo.initweight !49
  %arrayidx19 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx18, i32 0, i32 %i.0, !taffo.info !115, !taffo.initweight !49
  store float 1.000000e+00, float* %arrayidx19, align 4, !taffo.info !86, !taffo.initweight !52, !taffo.constinfo !125
  br label %for.inc20

for.inc20:                                        ; preds = %for.end17
  %inc21 = add nsw i32 %i.0, 1, !taffo.info !116, !taffo.initweight !49, !taffo.constinfo !21
  br label %for.cond, !llvm.loop !126

for.end22:                                        ; preds = %for.cond
  %B23 = bitcast [20 x [20 x float]]* %B to i8*, !taffo.info !127, !taffo.initweight !47
  br label %for.cond24
...
for.body31:                                       ; preds = %for.cond28
  ...
  store float 0.000000e+00, float* %arrayidx33, align 4, !taffo.info !86, !taffo.initweight !52, !taffo.constinfo !121
  br label %for.inc34

for.inc34:                                        ; preds = %for.body31
  %inc35 = add nsw i32 %s.0, 1, !taffo.info !69, !taffo.constinfo !21
  br label %for.cond28, !llvm.loop !128
...
for.body51:                                       ; preds = %for.cond48
  ...
  %mul = fmul float %0, %1, !taffo.info !130, !taffo.initweight !91
  ...
  %2 = load float, float* %arrayidx57, align 4, !taffo.info !131, !taffo.initweight !52
  %add58 = fadd float %2, %mul, !taffo.info !133, !taffo.initweight !61
...
for.inc62:                                        ; preds = %for.end61
  ...
  br label %for.cond44, !llvm.loop !135
...
for.inc65:                                        ; preds = %for.end64
  ...
  br label %for.cond40, !llvm.loop !136
...
for.inc80:                                        ; preds = %for.body75
  ...
  br label %for.cond72, !llvm.loop !137
...
for.inc83:                                        ; preds = %for.end82
  ...
  br label %for.cond68, !llvm.loop !138
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !139 !taffo.funinfo !140 !taffo.sourceFunction !54 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !141, !taffo.initweight !91
  %conv = sitofp i32 %factor to float, !taffo.info !143
  %mul = fmul float %1, %conv, !taffo.info !145, !taffo.initweight !147
...
!83 = !{double 0x3F847AE147AE147C, double 0x4070B28B3B853C52}
!84 = !{!82, !85, i1 false, i2 1}
!85 = !{double 0xC070B0F1A1EBA2B8, double 0x403055C27E953155}
!86 = !{i1 false, i1 false, i1 false, i2 1}
!87 = distinct !{!87, !23}
!88 = !{!89, !90, i1 false, i2 -1}
!89 = !{!"fixp", i32 32, i32 24}
!90 = !{double 0x3F790F4567F495E0, double 0x40646E66516DB0DE}
!91 = !{i32 8}
!92 = distinct !{!92, !23}
!93 = distinct !{!93, !23}
!94 = distinct !{!94, !23}
...
!98 = !{double 0.000000e+00, double 0x4070B28B3B853C52}
...
!108 = !{!42, !68, i1 false, i2 1}
!109 = !{!110, !111, i1 false, i2 1}
!110 = !{!"fixp", i32 -32, i32 29}
!111 = !{double 0xBFEE666666666666, double 0x3FEE666666666666}
!112 = !{!110, !113, i1 false, i2 1}
!113 = !{double 0x3FA99999999999A0, double 1.950000e+00}
!114 = !{i1 false, !69}
!115 = !{!42, !43, i1 false, i2 1}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double -1.900000e+01, double 2.100000e+01}
!118 = distinct !{!118, !23}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double -2.000000e+01, double 2.200000e+01}
!121 = !{!71, i1 false}
!122 = !{i1 false, !123, i1 false, i2 1}
!123 = !{double -1.900000e+01, double 2.200000e+01}
!124 = distinct !{!124, !23}
!125 = !{!69, i1 false}
!126 = distinct !{!126, !23}
!127 = !{!97, i1 false, i1 false, i2 1}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
!130 = !{!97, !83, i1 false, i2 -1}
!131 = !{!132, !72, i1 false, i2 1}
!132 = !{!"fixp", i32 32, i32 32}
!133 = !{!97, !83, i1 false, i2 1}
!134 = distinct !{!134, !23}
!135 = distinct !{!135, !23}
!136 = distinct !{!136, !23}
!137 = distinct !{!137, !23}
...
!140 = !{i32 1, !67, i32 1, !67, i32 1, !41, i32 1, !19}
!141 = !{!142, !43, i1 false, i2 -1}
!142 = !{!"fixp", i32 32, i32 26}
!143 = !{!144, !20, i1 false, i2 1}
!144 = !{!"fixp", i32 32, i32 30}
!145 = !{!142, !146, i1 false, i2 -1}
!146 = !{double 2.000000e-01, double 0x40405851DABE2718}
!147 = !{i32 9}
!148 = distinct !{!148, !23}
!149 = distinct !{!149, !23}
