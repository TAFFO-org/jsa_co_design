; ModuleID = './build/bin/fixed/mvt/16/mvt-standard-64-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,60.799999) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [51 x i8] c"target('x1') scalar(range(0.0,20124.798828) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [51 x i8] c"target('x2') scalar(range(0.0,20409.599609) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 64), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 64), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 64), !taffo.initweight !58, !taffo.info !55, !taffo.target !56, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 64), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 64), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x40D3A7331FFF79C8}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x40D3EE665FFE6D59}
...
!52 = !{double 0.000000e+00, double 0x404E66665E02EA96}
...
!107 = !{double 0.000000e+00, double 0x4133A7331FFF79C8}
!108 = distinct !{!108, !31}
!109 = !{i32 1, !91, i32 1, !55, i32 1, !102}
!110 = !{i1 false, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x4133EE665FFE6D59}
!112 = distinct !{!112, !31}
!113 = !{i32 1, !91, i32 1, !51, i32 1, !102}
!114 = !{i1 false, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!116 = distinct !{!116, !31}
...
!120 = !{double 0.000000e+00, double 0x40ACE1479E2442D8}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x40D7435C13C40223}
!123 = distinct !{!123, !31}
!124 = distinct !{!124, !31}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x40D78A8F53C2F5B4}
!127 = distinct !{!127, !31}
!128 = distinct !{!128, !31}
!129 = distinct !{!129, !31}
