; ModuleID = './build/bin/fixed/symm/11/symm-standard-4-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 4), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 4), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 4), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 4), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @kernel_symm.3(i32 noundef 10, i32 noundef 16, float noundef %3, float noundef %4, [16 x float]* noundef %arraydecay11, [10 x float]* noundef %arraydecay12, [16 x float]* noundef %arraydecay13), !taffo.info !62, !taffo.initweight !68, !taffo.constinfo !63, !taffo.originalCall !77
  call void @timer_stop(), !taffo.constinfo !75
  br label %for.cond

for.cond:                                         ; preds = %for.inc20, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc21, %for.inc20 ], !taffo.info !78
  %cmp = icmp slt i32 %i.0, 10, !taffo.info !80
...
for.cond14:                                       ; preds = %for.inc, %for.body
  ...
  %cmp15 = icmp slt i32 %j.0, 16, !taffo.info !80
...
for.body16:                                       ; preds = %for.cond14
  ...
  store float %5, float* %arrayidx19, align 4, !taffo.info !69, !taffo.initweight !84, !taffo.target !50
  br label %for.inc

for.inc:                                          ; preds = %for.body16
  %inc = add nsw i32 %j.0, 1, !taffo.info !85, !taffo.constinfo !21
  br label %for.cond14, !llvm.loop !87

for.end:                                          ; preds = %for.cond14
  br label %for.inc20

for.inc20:                                        ; preds = %for.end
  %inc21 = add nsw i32 %i.0, 1, !taffo.info !88, !taffo.constinfo !21
  br label %for.cond, !llvm.loop !90

for.end22:                                        ; preds = %for.cond
  call void @print_array(i32 noundef 10, i32 noundef 16, [16 x float]* noundef getelementptr inbounds ([10 x [16 x float]], [10 x [16 x float]]* @C_float, i32 0, i32 0)), !taffo.constinfo !91
  ret i32 0
}

; Function Attrs: noinline nounwind uwtable
define internal void @print_array(i32 noundef %m, i32 noundef %n, [16 x float]* noundef %C) #0 !taffo.initweight !27 !taffo.funinfo !92 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc7, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc8, %for.inc7 ], !taffo.info !80
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !95
  br i1 %cmp, label %for.body, label %for.end9
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %j.0, %n, !taffo.info !95
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %mul = mul nsw i32 %i.0, %m, !taffo.info !97
  %add = add nsw i32 %mul, %j.0, !taffo.info !97
  %rem = srem i32 %add, 20, !taffo.info !97, !taffo.constinfo !21
  %cmp4 = icmp eq i32 %rem, 0, !taffo.info !95
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), double noundef %conv), !taffo.constinfo !91
  br label %for.inc

for.inc:                                          ; preds = %if.end
  %inc = add nsw i32 %j.0, 1, !taffo.info !95, !taffo.constinfo !21
...
for.inc7:                                         ; preds = %for.end
  %inc8 = add nsw i32 %i.0, 1, !taffo.info !95, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.1(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !101 !taffo.funinfo !102 !taffo.sourceFunction !66 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3(i32 noundef %m, i32 noundef %n, float noundef %alpha, float noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !105 !taffo.funinfo !106 !taffo.sourceFunction !77 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc36, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc37, %for.inc36 ], !taffo.info !80
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !95
...
for.cond1:                                        ; preds = %for.inc33, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc34, %for.inc33 ], !taffo.info !80
  %cmp2 = icmp slt i32 %j.0, %n, !taffo.info !95
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %temp2.0 = phi float [ 0.000000e+00, %for.body3 ], [ %add18, %for.inc ], !taffo.info !107
  %cmp5 = icmp slt i32 %k.0, %i.0, !taffo.info !97
  br i1 %cmp5, label %for.body6, label %for.end

for.body6:                                        ; preds = %for.cond4
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.info !54, !taffo.initweight !110
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !54, !taffo.initweight !111
  %0 = load float, float* %arrayidx7, align 4, !taffo.info !54, !taffo.initweight !112
  %mul = fmul float %alpha, %0, !taffo.info !113, !taffo.initweight !110
  %arrayidx8 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !51, !taffo.initweight !110
  %arrayidx9 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx8, i32 0, i32 %k.0, !taffo.info !51, !taffo.initweight !111
  %1 = load float, float* %arrayidx9, align 4, !taffo.info !51, !taffo.initweight !112
  %mul10 = fmul float %mul, %1, !taffo.info !115, !taffo.initweight !111
  %arrayidx11 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %k.0, !taffo.info !48, !taffo.initweight !110
  %arrayidx12 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx11, i32 0, i32 %j.0, !taffo.info !48, !taffo.initweight !111
  ...
  %arrayidx13 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %k.0, !taffo.info !54, !taffo.initweight !110
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.info !54, !taffo.initweight !111
  %3 = load float, float* %arrayidx14, align 4, !taffo.info !54, !taffo.initweight !112
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !51, !taffo.initweight !110
  %arrayidx16 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx15, i32 0, i32 %k.0, !taffo.info !51, !taffo.initweight !111
...
for.inc:                                          ; preds = %for.body6
  %inc = add nsw i32 %k.0, 1, !taffo.info !95, !taffo.constinfo !21
  br label %for.cond4, !llvm.loop !122

for.end:                                          ; preds = %for.cond4
  %arrayidx19 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.info !48, !taffo.initweight !110
  %arrayidx20 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx19, i32 0, i32 %j.0, !taffo.info !48, !taffo.initweight !111
  %5 = load float, float* %arrayidx20, align 4, !taffo.info !48, !taffo.initweight !112
  %mul21 = fmul float %beta, %5, !taffo.info !123, !taffo.initweight !110
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.info !54, !taffo.initweight !110
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.0, !taffo.info !54, !taffo.initweight !111
  %6 = load float, float* %arrayidx23, align 4, !taffo.info !54, !taffo.initweight !112
  %mul24 = fmul float %alpha, %6, !taffo.info !113, !taffo.initweight !110
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !51, !taffo.initweight !110
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %i.0, !taffo.info !51, !taffo.initweight !111
  %7 = load float, float* %arrayidx26, align 4, !taffo.info !51, !taffo.initweight !112
  %mul27 = fmul float %mul24, %7, !taffo.info !115, !taffo.initweight !111
  %add28 = fadd float %mul21, %mul27, !taffo.info !125, !taffo.initweight !111
  %mul29 = fmul float %alpha, %temp2.0, !taffo.info !128, !taffo.initweight !110
  %add30 = fadd float %add28, %mul29, !taffo.info !129, !taffo.initweight !111
  %arrayidx31 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.info !48, !taffo.initweight !110
  %arrayidx32 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx31, i32 0, i32 %j.0, !taffo.info !48, !taffo.initweight !111
  store float %add30, float* %arrayidx32, align 4, !taffo.info !62, !taffo.initweight !112
  br label %for.inc33

for.inc33:                                        ; preds = %for.end
  %inc34 = add nsw i32 %j.0, 1, !taffo.info !95, !taffo.constinfo !21
...
for.inc36:                                        ; preds = %for.end35
  %inc37 = add nsw i32 %i.0, 1, !taffo.info !95, !taffo.constinfo !21
...
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !62, !taffo.initweight !84, !taffo.constinfo !135
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !67, !taffo.initweight !84, !taffo.constinfo !137
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv = sitofp i32 %rem to float, !taffo.info !149, !taffo.initweight !84
  %conv6 = sitofp i32 %m to float, !taffo.info !151
  %div = fdiv float %conv, %conv6, !taffo.info !152, !taffo.initweight !110
  ...
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !149, !taffo.initweight !84
  %conv11 = sitofp i32 %m to float, !taffo.info !151
  %div12 = fdiv float %conv10, %conv11, !taffo.info !152, !taffo.initweight !110
...
for.body25:                                       ; preds = %for.cond22
  ...
  %conv28 = sitofp i32 %rem27 to float, !taffo.info !149, !taffo.initweight !84
  %conv29 = sitofp i32 %m to float, !taffo.info !151
  %div30 = fdiv float %conv28, %conv29, !taffo.info !152, !taffo.initweight !110
...
for.cond:                                         ; preds = %for.inc7, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc8, %for.inc7 ], !taffo.info !80
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !95
  br i1 %cmp, label %for.body, label %for.end9
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !80
  %cmp2 = icmp slt i32 %j.0, %m, !taffo.info !95
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !97
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.info !48, !taffo.initweight !111
  ...
  %mul = fmul float %1, %conv, !taffo.info !177, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !97
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !48, !taffo.initweight !111
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !181 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !97
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.info !51, !taffo.initweight !111
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !51, !taffo.initweight !112
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !182, !taffo.initweight !120
  %conv = sitofp i32 %factor to float, !taffo.info !175
  %mul = fmul float %1, %conv, !taffo.info !184, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !97
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !51, !taffo.initweight !111
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !188 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !97
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.info !54, !taffo.initweight !111
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !54, !taffo.initweight !112
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !189, !taffo.initweight !120
  %conv = sitofp i32 %factor to float, !taffo.info !175
  %mul = fmul float %1, %conv, !taffo.info !191, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !97
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !54, !taffo.initweight !111
...
!53 = !{double -3.996000e+03, double 7.200000e+00}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 28}
!56 = !{double 4.000000e-01, double 1.000000e+01}
...
!75 = !{i1 false}
!76 = !{!55, !44, i1 false, i2 -1}
!77 = distinct !{null}
!78 = !{i1 false, !79, i1 false, i2 0}
!79 = !{double 0.000000e+00, double 1.100000e+01}
!80 = !{i1 false, !81, i1 false, i2 0}
!81 = !{double 0.000000e+00, double 1.000000e+00}
!82 = !{i1 false, !83, i1 false, i2 0}
!83 = !{double 0.000000e+00, double 1.870000e+02}
!84 = !{i32 4}
!85 = !{i1 false, !86, i1 false, i2 0}
!86 = !{double 1.000000e+00, double 1.870000e+02}
!87 = distinct !{!87, !23}
!88 = !{i1 false, !89, i1 false, i2 0}
!89 = !{double 1.000000e+00, double 1.100000e+01}
!90 = distinct !{!90, !23}
!91 = !{i1 false, i1 false, i1 false, i1 false}
!92 = !{i32 1, !16, i32 1, !93, i32 1, !0}
!93 = !{i1 false, !94, i1 false, i2 0}
!94 = !{double 1.600000e+01, double 1.600000e+01}
!95 = !{i1 false, !96, i1 false, i2 0}
!96 = !{double 1.000000e+00, double 1.000000e+00}
!97 = !{i1 false, !98, i1 false, i2 0}
!98 = !{double 0.000000e+00, double 0.000000e+00}
!99 = distinct !{!99, !23}
!100 = distinct !{!100, !23}
!101 = !{i32 1, i32 -1}
!102 = !{i32 1, !42, i32 1, !103}
!103 = !{i1 false, !104, i1 false, i2 0}
!104 = !{double 4.000000e+00, double 4.000000e+00}
!105 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!106 = !{i32 1, !16, i32 1, !93, i32 1, !76, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!107 = !{!108, !109, i1 false, i2 1}
!108 = !{!"fixp", i32 -32, i32 15}
!109 = !{double -3.996000e+04, double 7.200000e+01}
!110 = !{i32 5}
!111 = !{i32 6}
!112 = !{i32 7}
!113 = !{!55, !114, i1 false, i2 -1}
!114 = !{double 0x3FE3333333333334, double 1.500000e+01}
!115 = !{!108, !116, i1 false, i2 -1}
!116 = !{double -5.994000e+04, double 1.080000e+02}
!117 = !{!108, !118, i1 false, i2 -1}
!118 = !{double -5.994000e+04, double 0x4088E28F5FD47BEE}
!119 = !{!108, !109, i1 false, i2 -1}
!120 = !{i32 8}
!121 = !{i32 9}
!122 = distinct !{!122, !23}
!123 = !{!49, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4089CFDF3FCBC7EA}
!125 = !{!126, !127, i1 false, i2 -1}
!126 = !{!"fixp", i32 -32, i32 14}
!127 = !{double -5.994000e+04, double 0x408D2FDF3FCBC7EA}
!128 = !{!126, !116, i1 false, i2 -1}
!129 = !{!126, !130, i1 false, i2 -1}
!130 = !{double -1.198800e+05, double 0x409047EF9FE5E3F5}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!134 = !{i32 1, !16, i32 1, !93, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!135 = !{!136, i1 false}
...
!151 = !{!55, !17, i1 false, i2 1}
!152 = !{!55, !153, i1 false, i2 1}
...
!172 = !{i32 1, !16, i32 1, !93, i32 1, !48, i32 1, !103}
!173 = !{!174, !1, i1 false, i2 -1}
!174 = !{!"fixp", i32 32, i32 20}
!175 = !{!176, !104, i1 false, i2 1}
!176 = !{!"fixp", i32 32, i32 29}
!177 = !{!174, !178, i1 false, i2 -1}
!178 = !{double 0.000000e+00, double 0x40A5828F5FD47BEE}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !103}
!182 = !{!183, !53, i1 false, i2 -1}
!183 = !{!"fixp", i32 -32, i32 17}
!184 = !{!183, !185, i1 false, i2 -1}
!185 = !{double -1.598400e+04, double 2.880000e+01}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
!188 = !{i32 1, !16, i32 1, !93, i32 1, !54, i32 1, !103}
!189 = !{!190, !56, i1 false, i2 -1}
!190 = !{!"fixp", i32 32, i32 26}
!191 = !{!190, !192, i1 false, i2 -1}
!192 = !{double 1.600000e+00, double 4.000000e+01}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
