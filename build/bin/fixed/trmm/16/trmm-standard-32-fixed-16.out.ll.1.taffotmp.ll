...
@.str.2 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,32.0) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [44 x i8] c"target('B') scalar(range(0.0,5346.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %B3, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 117, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 32)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 32)
