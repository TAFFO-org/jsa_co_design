; ModuleID = './build/bin/fixed/symm/11/symm-standard-256-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 256), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 256), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 256), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 256), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 256), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
...
for.body6:                                        ; preds = %for.cond4
  ...
  %add = fadd float %2, %mul10, !taffo.info !116, !taffo.initweight !111
  ...
  %mul17 = fmul float %3, %4, !taffo.info !118, !taffo.initweight !119
  %add18 = fadd float %temp2.0, %mul17, !taffo.info !118, !taffo.initweight !120
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  ...
  %mul21 = fmul float %beta, %5, !taffo.info !122, !taffo.initweight !109
  ...
  %add28 = fadd float %mul21, %mul27, !taffo.info !124, !taffo.initweight !110
  %mul29 = fmul float %alpha, %temp2.0, !taffo.info !126, !taffo.initweight !109
  %add30 = fadd float %add28, %mul29, !taffo.info !128, !taffo.initweight !110
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %m, i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !133 !taffo.funinfo !105 !taffo.sourceFunction !64 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !62, !taffo.initweight !83, !taffo.constinfo !134
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !67, !taffo.initweight !83, !taffo.constinfo !136
  br label %for.cond

for.cond:                                         ; preds = %for.inc15, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc16, %for.inc15 ], !taffo.info !139, !taffo.initweight !45
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !140, !taffo.initweight !68
  br i1 %cmp, label %for.body, label %for.end17, !taffo.info !141, !taffo.initweight !70

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !142, !taffo.initweight !45
  %cmp4 = icmp slt i32 %j.0, %n, !taffo.info !140, !taffo.initweight !68
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !144, !taffo.initweight !70

for.body5:                                        ; preds = %for.cond3
  %add = add nsw i32 %i.0, %j.0, !taffo.info !146, !taffo.initweight !68
  %rem = srem i32 %add, 100, !taffo.info !146, !taffo.initweight !70, !taffo.constinfo !21
  %conv = sitofp i32 %rem to float, !taffo.info !148, !taffo.initweight !83
  %conv6 = sitofp i32 %m to float, !taffo.info !150
  ...
  %sub = sub nsw i32 %add8, %j.0, !taffo.info !146, !taffo.initweight !68
  %rem9 = srem i32 %sub, 100, !taffo.info !146, !taffo.initweight !70, !taffo.constinfo !21
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !148, !taffo.initweight !83
  %conv11 = sitofp i32 %m to float, !taffo.info !150
...
for.cond18:                                       ; preds = %for.inc46, %for.end17
  %i.1 = phi i32 [ 0, %for.end17 ], [ %inc47, %for.inc46 ], !taffo.info !139, !taffo.initweight !45
  %cmp19 = icmp slt i32 %i.1, %m, !taffo.info !140, !taffo.initweight !68
  br i1 %cmp19, label %for.body21, label %for.end48, !taffo.info !141, !taffo.initweight !70

for.body21:                                       ; preds = %for.cond18
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc33, %for.body21
  %j.1 = phi i32 [ 0, %for.body21 ], [ %inc34, %for.inc33 ], !taffo.info !142, !taffo.initweight !45
  %cmp23 = icmp sle i32 %j.1, %i.1, !taffo.info !140, !taffo.initweight !68
  br i1 %cmp23, label %for.body25, label %for.end35, !taffo.info !141, !taffo.initweight !70

for.body25:                                       ; preds = %for.cond22
  %add26 = add nsw i32 %i.1, %j.1, !taffo.info !146, !taffo.initweight !68
  %rem27 = srem i32 %add26, 100, !taffo.info !146, !taffo.initweight !70, !taffo.constinfo !21
  %conv28 = sitofp i32 %rem27 to float, !taffo.info !148, !taffo.initweight !83
  %conv29 = sitofp i32 %m to float, !taffo.info !150
...
for.cond37:                                       ; preds = %for.inc43, %for.end35
  %j.2 = phi i32 [ %add36, %for.end35 ], [ %inc44, %for.inc43 ], !taffo.info !142, !taffo.initweight !45
  %cmp38 = icmp slt i32 %j.2, %m, !taffo.info !140, !taffo.initweight !68
  br i1 %cmp38, label %for.body40, label %for.end45, !taffo.info !144, !taffo.initweight !70
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !173
  %mul = fmul float %1, %conv, !taffo.info !175, !taffo.initweight !120
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !69, !taffo.initweight !119
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !173
  %mul = fmul float %1, %conv, !taffo.info !181, !taffo.initweight !120
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !73, !taffo.initweight !119
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !186 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !54, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !173
  %mul = fmul float %1, %conv, !taffo.info !187, !taffo.initweight !120
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
...
!49 = !{!"fixp", i32 32, i32 10}
!50 = !{!"C"}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 13}
!53 = !{double -2.557440e+05, double 0x407CCCCCC0379314}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 22}
!56 = !{double 2.560000e+01, double 6.400000e+02}
...
!103 = !{double 2.560000e+02, double 2.560000e+02}
...
!107 = !{!"fixp", i32 -32, i32 3}
!108 = !{double 0xC1A3830000000000, double 0x4111FFFFF822BBEC}
!109 = !{i32 5}
!110 = !{i32 6}
!111 = !{i32 7}
!112 = !{!55, !113, i1 false, i2 -1}
!113 = !{double 0x4043333333333334, double 9.600000e+02}
!114 = !{!107, !115, i1 false, i2 -1}
!115 = !{double 0xC1AD448000000000, double 0x411AFFFFF43419E3}
!116 = !{!107, !117, i1 false, i2 -1}
!117 = !{double 0xC1AD448000000000, double 0x4148C08A3E86833C}
!118 = !{!107, !108, i1 false, i2 -1}
!119 = !{i32 8}
!120 = !{i32 9}
!121 = distinct !{!121, !23}
!122 = !{!49, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x4149A70C4CCCCCCD}
!124 = !{!107, !125, i1 false, i2 -1}
!125 = !{double 0xC1AD448000000000, double 0x414D070C4B535009}
!126 = !{!107, !127, i1 false, i2 -1}
!127 = !{double 0xC1AD448000000000, double 0x411AFFFFF43419E2}
!128 = !{!129, !130, i1 false, i2 -1}
!129 = !{!"float", i32 1, double 0x41BD448000000000}
!130 = !{double 0xC1BD448000000000, double 0x4150338624ECE9A3}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!134 = !{!135, i1 false}
!135 = !{i1 false, !44, i1 false, i2 0}
!136 = !{!137, i1 false}
!137 = !{i1 false, !138, i1 false, i2 0}
!138 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!139 = !{i1 false, !78, i1 false, i2 1}
!140 = !{i1 false, !80, i1 false, i2 1}
!141 = !{i1 false, !3, i1 false, i2 1}
!142 = !{i1 false, !143, i1 false, i2 1}
!143 = !{double 0.000000e+00, double 1.700000e+01}
!144 = !{i1 false, !145, i1 false, i2 1}
!145 = !{double 0.000000e+00, double 1.600000e+01}
!146 = !{i1 false, !147, i1 false, i2 1}
!147 = !{double 0.000000e+00, double 2.600000e+01}
!148 = !{!149, !147, i1 false, i2 1}
!149 = !{!"fixp", i32 32, i32 27}
!150 = !{!151, !17, i1 false, i2 1}
!151 = !{!"fixp", i32 32, i32 28}
...
!172 = !{i32 1, !16, i32 1, !92, i32 1, !48, i32 1, !102}
!173 = !{!174, !103, i1 false, i2 1}
!174 = !{!"fixp", i32 32, i32 23}
!175 = !{!176, !177, i1 false, i2 -1}
!176 = !{!"float", i32 1, double 0x41C5608A40000000}
!177 = !{double 0.000000e+00, double 0x41C5608A40000000}
!178 = distinct !{!178, !23}
!179 = distinct !{!179, !23}
!180 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !102}
!181 = !{!182, !183, i1 false, i2 -1}
!182 = !{!"fixp", i32 -32, i32 5}
!183 = !{double 0xC18F380000000000, double 0x40FCCCCCC0379314}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
!186 = !{i32 1, !16, i32 1, !92, i32 1, !54, i32 1, !102}
!187 = !{!188, !189, i1 false, i2 -1}
!188 = !{!"fixp", i32 32, i32 14}
!189 = !{double 6.553600e+03, double 1.638400e+05}
!190 = distinct !{!190, !23}
!191 = distinct !{!191, !23}
