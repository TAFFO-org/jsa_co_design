...
# %bb.16:                               # %for.body40
	...
	imull	$40, %edx, %edx
	addl	%edx, %eax
	movl	$-2045952, (%eax,%ecx,4)        # imm = 0xFFE0C800
# %bb.17:                               # %for.inc43
                                        #   in Loop: Header=BB10_15 Depth=2
...
.LBB10_20:                              # %for.end48
	...
	retl
.Lfunc_end10:
	.size	init_array.4_fixp, .Lfunc_end10-init_array.4_fixp
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function kernel_symm.3_fixp
.LCPI11_0:
...
.Ltmp4:
	...
	movl	$0, -20(%ebp)
	fildll	-24(%ebp)
	flds	.LCPI11_0@GOTOFF(%eax)
	fdivrp	%st, %st(1)
	fstps	-116(%ebp)                      # 4-byte Folded Spill
	xorl	%eax, %eax
	movl	%eax, -112(%ebp)                # 4-byte Spill
.LBB11_1:                               # %for.cond
                                        # =>This Loop Header: Depth=1
...
# %bb.4:                                # %for.body3
	...
	fstps	-164(%ebp)                      # 4-byte Folded Spill
	jmp	.LBB11_5
.LBB11_5:                               # %for.cond4
                                        #   Parent Loop BB11_1 Depth=1
	...
	flds	-164(%ebp)                      # 4-byte Folded Reload
	fstps	-176(%ebp)                      # 4-byte Folded Spill
	movl	%eax, -172(%ebp)                # 4-byte Spill
	cmpl	%ecx, %eax
	jge	.LBB11_8
# %bb.6:                                # %for.body6
                                        #   in Loop: Header=BB11_5 Depth=3
	flds	-176(%ebp)                      # 4-byte Folded Reload
	movl	-172(%ebp), %ebx                # 4-byte Reload
	movl	-160(%ebp), %edi                # 4-byte Reload
	...
	movl	%ecx, -68(%ebp)
	fildl	-68(%ebp)
	flds	.LCPI11_3@GOTOFF(%eax)
	fdivrp	%st, %st(1)
	fmulp	%st, %st(1)
	faddp	%st, %st(1)
	fstps	-180(%ebp)                      # 4-byte Folded Spill
# %bb.7:                                # %for.inc
                                        #   in Loop: Header=BB11_5 Depth=3
	flds	-180(%ebp)                      # 4-byte Folded Reload
...
.LBB11_8:                               # %for.end
                                        #   in Loop: Header=BB11_3 Depth=2
	movl	-160(%ebp), %ecx                # 4-byte Reload
	flds	-116(%ebp)                      # 4-byte Folded Reload
	flds	-176(%ebp)                      # 4-byte Folded Reload
...
.LBB11_12:                              # %for.end38
	...
	retl
.Lfunc_end11:
	.size	kernel_symm.3_fixp, .Lfunc_end11-kernel_symm.3_fixp
	.cfi_endproc
                                        # -- End function
...
.LBB12_8:                               # %for.end9
	...
	retl
.Lfunc_end12:
	.size	scale_2d.7_fixp, .Lfunc_end12-scale_2d.7_fixp
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
...
.L13$pb:
	popl	%eax
.Ltmp5:
	addl	$_GLOBAL_OFFSET_TABLE_+(.Ltmp5-.L13$pb), %eax
...
.Lfunc_end13:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function scale_2d.6_fixp
.LCPI14_0:
	.long	0x45000000                      # float 2048
.LCPI14_1:
	.long	0x4a000000                      # float 2097152
...
.L14$pb:
	popl	%eax
.Ltmp6:
	addl	$_GLOBAL_OFFSET_TABLE_+(.Ltmp6-.L14$pb), %eax
	movl	%eax, -60(%ebp)                 # 4-byte Spill
	movl	20(%ebp), %eax
	movl	%eax, -56(%ebp)                 # 4-byte Spill
	movl	16(%ebp), %eax
...
# %bb.4:                                # %for.body3
	...
	movl	%edi, -20(%ebp)
	fildl	-20(%ebp)
	flds	.LCPI14_0@GOTOFF(%edx)
	fdivr	%st, %st(1)
	shll	$21, %esi
	movl	%esi, -32(%ebp)
	movl	$0, -28(%ebp)
	fildll	-32(%ebp)
	flds	.LCPI14_1@GOTOFF(%edx)
	fdivrp	%st, %st(1)
	fmulp	%st, %st(2)
	fmulp	%st, %st(1)
	fnstcw	-34(%ebp)
