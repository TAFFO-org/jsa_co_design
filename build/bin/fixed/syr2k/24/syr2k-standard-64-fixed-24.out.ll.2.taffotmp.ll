; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-64-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 64), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %3, i32 noundef 64), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %4, i32 noundef 64), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
