; ModuleID = './build/bin/fixed/seidel-2d/16/seidel-2d-standard-32-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3_fixp(i32 20, i32 20, i32* %u10_22fixp, i32 32), !taffo.info !45, !taffo.constinfo !47, !taffo.target !44
  ...
  call void @kernel_seidel_2d.1_fixp(i32 10, i32 20, [20 x i32]* %arraydecay3.u10_22fixp), !taffo.info !45, !taffo.constinfo !49, !taffo.target !44
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_seidel_2d.1_fixp(i32 noundef %tsteps, i32 noundef %n, [20 x i32]* noundef %A.u10_22fixp) #0 !taffo.initweight !71 !taffo.funinfo !72 !taffo.sourceFunction !73 {
entry:
  br label %for.cond
...
for.body8:                                        ; preds = %for.cond5
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %sub10, !taffo.info !41
  %sub11 = sub nsw i32 %j.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx12.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u10_22fixp, i32 0, i32 %sub11, !taffo.info !41
  %u10_22fixp = load i32, i32* %arrayidx12.u10_22fixp, align 4, !taffo.info !80
  %sub13 = sub nsw i32 %i.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx14.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %sub13, !taffo.info !41
  %arrayidx15.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx14.u10_22fixp, i32 0, i32 %j.0, !taffo.info !41
  %u10_22fixp1 = load i32, i32* %arrayidx15.u10_22fixp, align 4, !taffo.info !80
  %0 = lshr i32 %u10_22fixp, 1, !taffo.info !80
  %1 = lshr i32 %u10_22fixp1, 1, !taffo.info !80
  %add.u11_21fixp = add i32 %0, %1, !taffo.info !82
  %sub16 = sub nsw i32 %i.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx17.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %sub16, !taffo.info !41
  %add18 = add nsw i32 %j.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx19.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx17.u10_22fixp, i32 0, i32 %add18, !taffo.info !41
  %u10_22fixp2 = load i32, i32* %arrayidx19.u10_22fixp, align 4, !taffo.info !80
  %2 = lshr i32 %add.u11_21fixp, 1, !taffo.info !82
  %3 = lshr i32 %u10_22fixp2, 2, !taffo.info !80
  %add20.u12_20fixp = add i32 %2, %3, !taffo.info !84
  %arrayidx21.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !41
  %sub22 = sub nsw i32 %j.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx23.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx21.u10_22fixp, i32 0, i32 %sub22, !taffo.info !41
  %u10_22fixp3 = load i32, i32* %arrayidx23.u10_22fixp, align 4, !taffo.info !87
  %4 = lshr i32 %add20.u12_20fixp, 1, !taffo.info !84
  %5 = lshr i32 %u10_22fixp3, 3, !taffo.info !87
  %add24.u13_19fixp = add i32 %4, %5, !taffo.info !88
  %arrayidx26.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !41
  %arrayidx27.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx26.u10_22fixp, i32 0, i32 %j.0, !taffo.info !41
  %u10_22fixp4 = load i32, i32* %arrayidx27.u10_22fixp, align 4, !taffo.info !80
  ...
  %arrayidx30.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx28.u10_22fixp, i32 0, i32 %add29, !taffo.info !41
  %u10_22fixp5 = load i32, i32* %arrayidx30.u10_22fixp, align 4, !taffo.info !80
  %6 = lshr i32 %u10_22fixp4, 1, !taffo.info !80
  %7 = lshr i32 %u10_22fixp5, 1, !taffo.info !80
  %add31.u11_21fixp = add i32 %6, %7, !taffo.info !82
  %add32 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx33.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %add32, !taffo.info !41
  %sub34 = sub nsw i32 %j.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx35.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx33.u10_22fixp, i32 0, i32 %sub34, !taffo.info !41
  %u10_22fixp6 = load i32, i32* %arrayidx35.u10_22fixp, align 4, !taffo.info !80
  %8 = lshr i32 %add31.u11_21fixp, 1, !taffo.info !82
  %9 = lshr i32 %u10_22fixp6, 2, !taffo.info !80
  %add36.u12_20fixp = add i32 %8, %9, !taffo.info !84
  %add37 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx38.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %add37, !taffo.info !41
  %arrayidx39.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx38.u10_22fixp, i32 0, i32 %j.0, !taffo.info !41
  %u10_22fixp7 = load i32, i32* %arrayidx39.u10_22fixp, align 4, !taffo.info !87
  %10 = lshr i32 %u10_22fixp7, 2, !taffo.info !87
  %add40.u12_20fixp = add i32 %add36.u12_20fixp, %10, !taffo.info !91
  %add41 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx42.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %add41, !taffo.info !41
  %add43 = add nsw i32 %j.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx44.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx42.u10_22fixp, i32 0, i32 %add43, !taffo.info !41
  %u10_22fixp8 = load i32, i32* %arrayidx44.u10_22fixp, align 4, !taffo.info !87
  %11 = lshr i32 %add40.u12_20fixp, 1, !taffo.info !91
  %12 = lshr i32 %u10_22fixp8, 3, !taffo.info !87
  %add45.u13_19fixp = add i32 %11, %12, !taffo.info !92
  %add47.u13_19fixp = add i32 %add24.u13_19fixp, %add45.u13_19fixp, !taffo.info !94
  %13 = lshr i32 %add47.u13_19fixp, 1, !taffo.info !94
  %14 = shl i32 9, 27
  %15 = ashr i32 %14, 9
  %16 = call i32 @llvm.sdiv.fix.i32(i32 %13, i32 %15, i32 18), !taffo.info !96
  %div49.u10_22fixp = shl i32 %16, 4, !taffo.info !98, !taffo.constinfo !99
  %arrayidx50.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !41
  %arrayidx51.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx50.u10_22fixp, i32 0, i32 %j.0, !taffo.info !41
  store i32 %div49.u10_22fixp, i32* %arrayidx51.u10_22fixp, align 4, !taffo.info !100
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.2_fixp(i32 noundef %n, [20 x i32]* noundef %A.u10_22fixp) #0 !taffo.initweight !104 !taffo.funinfo !105 !taffo.sourceFunction !106 {
entry:
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !98
  %arrayidx9.u10_22fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u10_22fixp, i32 0, i32 %j.0, !taffo.info !98
  %5 = ashr i32 %div.s6_26fixp, 4, !taffo.info !127
  store i32 %5, i32* %arrayidx9.u10_22fixp, align 4, !taffo.info !100
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !132 !taffo.funinfo !133 !taffo.sourceFunction !136 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !137
  %1 = lshr i32 %u10_22fixp, 1, !taffo.info !41
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !137
  %3 = ashr i32 %1, 5, !taffo.info !41
  %4 = ashr i32 %2, 9, !taffo.info !137
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 16), !taffo.info !139
  %mul.u15_17fixp = shl i32 %5, 1, !taffo.info !142
  ...
  %7 = shl i32 %mul.u15_17fixp, 5, !taffo.info !142
...
!1 = !{double 0.000000e+00, double 0x40840CCCC0379314}
...
!43 = !{double 3.200000e+00, double 0x40840CCCC0379314}
!44 = !{!"A"}
...
!83 = !{double 6.400000e+00, double 0x40940CCCC0379314}
!84 = !{!85, !86, i1 false, i2 -1}
!85 = !{!"fixp", i32 32, i32 20}
!86 = !{double 0x4023333333333334, double 0x409E133320535C9E}
!87 = !{!85, !43, i1 false, i2 -1}
!88 = !{!89, !90, i1 false, i2 1}
!89 = !{!"fixp", i32 32, i32 19}
!90 = !{double 1.280000e+01, double 0x40A40CCCC0379314}
!91 = !{!85, !90, i1 false, i2 -1}
!92 = !{!89, !93, i1 false, i2 1}
!93 = !{double 1.600000e+01, double 0x40A90FFFF04577D9}
!94 = !{!89, !95, i1 false, i2 1}
!95 = !{double 2.880000e+01, double 0x40B68E66583E8576}
...
!135 = !{double 3.200000e+01, double 3.200000e+01}
!136 = !{void (i32, i32, float*, i32)* @scale_2d}
!137 = !{!138, !135, i1 false, i2 1}
!138 = !{!"fixp", i32 32, i32 26}
!139 = !{!140, !141, i1 false, i2 -1}
!140 = !{!"fixp", i32 -32, i32 16}
!141 = !{double 1.024000e+02, double 0x40D40CCCC0379314}
