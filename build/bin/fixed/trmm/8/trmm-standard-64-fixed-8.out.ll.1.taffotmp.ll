...
@.str.2 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,64.0) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [45 x i8] c"target('B') scalar(range(0.0,21348.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A2, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 116, i8* null)
  %B3 = bitcast [10 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B3, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 117, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 64)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 64)
  call void @timer_start()
  %4 = load i32, i32* %m, align 4
  %5 = load i32, i32* %n, align 4
  %6 = load float, float* %alpha, align 4
  %arraydecay7 = getelementptr inbounds [10 x [10 x float]], [10 x [10 x float]]* %A, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [10 x [16 x float]], [10 x [16 x float]]* %B, i32 0, i32 0
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx = getelementptr inbounds [10 x [16 x float]], [10 x [16 x float]]* %B, i32 0, i32 %11
  %12 = load i32, i32* %j, align 4
  %arrayidx12 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %12
