; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-32-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 32), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
!94 = !{double 6.400000e+00, double 0x40940CCCC0379314}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 20}
!98 = !{double 0x4023333333333334, double 0x409E133320535C9E}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 19}
!102 = !{double 1.280000e+01, double 0x40A40CCCC0379314}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 1.600000e+01, double 0x40A90FFFF04577D9}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 2.880000e+01, double 0x40B68E66583E8576}
...
!144 = !{!"fixp", i32 32, i32 17}
!145 = !{double 1.024000e+02, double 0x40D40CCCC0379314}
!146 = !{i32 9}
!147 = distinct !{!147, !23}
!148 = distinct !{!148, !23}
