; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-32-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,7960.319336) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 32), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x40BF1851C0010C6F}
...
!119 = !{double 3.200000e+01, double 3.200000e+01}
...
!125 = !{double 0.000000e+00, double 0x40C2A8310CCD6DDC}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 4.500000e+01}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x40943FFFF43419E3}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 0x404599998D045FE1}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0.000000e+00, double 0x40A43FFFF43419E3}
!135 = !{i32 8}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x40C49C28DD0D8CB0}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
