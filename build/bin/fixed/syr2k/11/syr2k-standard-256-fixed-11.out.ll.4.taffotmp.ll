; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-256-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 256), !taffo.info !60, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 256), !taffo.info !65, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 256), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 256), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 256), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
!53 = !{double 0.000000e+00, double 2.400000e+02}
...
!101 = !{double 2.560000e+02, double 2.560000e+02}
...
!110 = !{double 0.000000e+00, double 0x412298104CCCCCCD}
!111 = distinct !{!111, !23}
!112 = !{!113, !53, i1 false, i2 -1}
!113 = !{!"fixp", i32 32, i32 23}
!114 = !{!113, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 3.600000e+02}
!116 = !{!117, !118, i1 false, i2 -1}
!117 = !{!"fixp", i32 32, i32 14}
!118 = !{double 0.000000e+00, double 0x40F43FFFF727136A}
!119 = !{!113, !55, i1 false, i2 -1}
!120 = !{!113, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x407599999029AE4F}
!122 = !{!107, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x41043FFFF727136A}
!124 = !{!107, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x41248EB83DC9C4DA}
!126 = !{i32 8}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!185 = !{double 0.000000e+00, double 0x419EFD7080000000}
!186 = !{i32 9}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
