; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-512-fixed-11.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %3, 0x4150000000000000, !taffo.info !181
  %mul.1flp = fmul float %2, %4, !taffo.info !190
  ...
  %6 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !190
  %7 = fptoui float %6 to i32, !taffo.info !190
