; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-1-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x41D0000000000000, !taffo.info !50
  %arrayidx29 = getelementptr inbounds [20 x float], [20 x float]* @x_float, i32 0, i32 %i.0, !taffo.info !0
  store float %1, float* %arrayidx29, align 4, !taffo.info !62
  ...
  %3 = fdiv float %2, 0x41A0000000000000, !taffo.info !47, !taffo.target !49
  %arrayidx31 = getelementptr inbounds [20 x float], [20 x float]* @w_float, i32 0, i32 %i.0, !taffo.info !2
  store float %3, float* %arrayidx31, align 4, !taffo.info !63, !taffo.target !49
  br label %for.cond32
...
for.body34:                                       ; preds = %for.cond32
  ...
  %5 = fdiv float %4, 0x41D0000000000000, !taffo.info !37
  ...
  store float %5, float* %arrayidx38, align 4, !taffo.info !66
  br label %for.inc
