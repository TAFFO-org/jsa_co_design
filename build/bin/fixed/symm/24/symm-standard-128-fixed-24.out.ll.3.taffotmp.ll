; ModuleID = './build/bin/fixed/symm/24/symm-standard-128-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,700554.25) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [42 x i8] c"scalar(range(-127872.0,230.399994) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [32 x i8] c"scalar(range(12.8,320.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.initweight !59, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 128), !taffo.initweight !59, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 128), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 128), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 128), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x4125611480000000}
...
!56 = !{double -1.278720e+05, double 0x406CCCCCC0379314}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 1.280000e+01, double 3.200000e+02}
!59 = !{i32 1}
...
!121 = !{double 1.280000e+02, double 1.280000e+02}
...
!126 = !{double 0xC183830000000000, double 0x40F1FFFFF822BBEC}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4033333333333334, double 4.800000e+02}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0xC18D448000000000, double 0x40FAFFFFF43419E3}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0xC18D448000000000, double 0x4128C1147E86833C}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x4129A7B233333333}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0xC18D448000000000, double 0x412D07B231B9B66F}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC18D448000000000, double 0x40FAFFFFF43419E2}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0xC19D448000000000, double 0x413033D918201CD6}
!147 = distinct !{!147, !29}
!148 = distinct !{!148, !29}
...
!174 = !{double 0.000000e+00, double 0x4195611480000000}
!175 = distinct !{!175, !29}
!176 = distinct !{!176, !29}
!177 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !120}
!178 = !{i1 false, !179, i1 false, i2 -1}
!179 = !{double 0xC16F380000000000, double 0x40DCCCCCC0379314}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
!182 = !{i32 1, !22, i32 1, !110, i32 1, !57, i32 1, !120}
!183 = !{i1 false, !184, i1 false, i2 -1}
!184 = !{double 1.638400e+03, double 4.096000e+04}
!185 = distinct !{!185, !29}
!186 = distinct !{!186, !29}
