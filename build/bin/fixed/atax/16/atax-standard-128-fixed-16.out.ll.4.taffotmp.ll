; ModuleID = './build/bin/fixed/atax/16/atax-standard-128-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 128), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.info !46, !taffo.initweight !56
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 128), !taffo.info !67, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 128), !taffo.info !70, !taffo.initweight !61, !taffo.constinfo !68, !taffo.target !51, !taffo.originalCall !69
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !56
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 128), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
...
!48 = !{double 1.280000e+02, double 0x406F45D18090B418}
!49 = !{!50, !1, i1 false, i2 -1}
!50 = !{!"fixp", i32 32, i32 8}
!51 = !{!"y"}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 16}
!54 = !{double 0.000000e+00, double 0x40EE851EC0010C6F}
...
!93 = !{double 1.280000e+02, double 1.280000e+02}
!94 = !{i32 5}
!95 = !{i32 6}
!96 = !{!47, !93, i1 false, i2 1}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"fixp", i32 32, i32 17}
!99 = !{double 1.638400e+04, double 0x40DF45D18090B418}
!100 = !{i32 7}
!101 = distinct !{!101, !23}
!102 = !{i32 1, !83, i32 1, !49, i32 1, !92}
!103 = !{!104, !105, i1 false, i2 -1}
!104 = !{!"float", i32 1, double 0x41DEC418A0000000}
!105 = !{double 0.000000e+00, double 0x41DEC418A0000000}
!106 = distinct !{!106, !23}
...
!118 = !{double 0.000000e+00, double 0x40BA44E31E28AD2B}
!119 = !{!115, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x40F0E6DD91E3110A}
!121 = distinct !{!121, !23}
!122 = !{!123, !1, i1 false, i2 -1}
!123 = !{!"fixp", i32 32, i32 7}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 32, i32 11}
...
!133 = !{!"fixp", i32 32, i32 9}
!134 = !{double 0.000000e+00, double 0x415E851EC0010C6F}
!135 = distinct !{!135, !23}
!136 = !{!43, !84, i1 false, i2 1}
!137 = !{i1 false, !138, i1 false, i2 -1}
!138 = !{double 0.000000e+00, double 2.200000e+01}
!139 = !{i1 false, !77, i1 false, i2 -1}
!140 = !{!43, !138, i1 false, i2 -1}
...
!172 = !{double 0.000000e+00, double 0x40AAE1479D4D8341}
!173 = !{i32 9}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
