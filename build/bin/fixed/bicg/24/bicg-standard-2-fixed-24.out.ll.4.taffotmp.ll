; ModuleID = './build/bin/fixed/bicg/24/bicg-standard-2-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.info !58, !taffo.initweight !62, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.info !65, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !50, !taffo.originalCall !67
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 2), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !52, !taffo.originalCall !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.info !53, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 2), !taffo.info !69, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.info !44, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 2), !taffo.info !58, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !48, !taffo.initweight !98
  %0 = load float, float* %arrayidx, align 4, !taffo.info !99, !taffo.initweight !101
  %conv = sitofp i32 %factor to float, !taffo.info !102
  %mul = fmul float %0, %conv, !taffo.info !103, !taffo.initweight !105
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !48, !taffo.initweight !98
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !96 !taffo.funinfo !107 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !53, !taffo.initweight !98
  %0 = load float, float* %arrayidx, align 4, !taffo.info !108, !taffo.initweight !101
  %conv = sitofp i32 %factor to float, !taffo.info !110
  %mul = fmul float %0, %conv, !taffo.info !111, !taffo.initweight !105
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !53, !taffo.initweight !98
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_bicg.4(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %s, float* noundef %q, float* noundef %p, float* noundef %r) #0 !taffo.initweight !114 !taffo.funinfo !115 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %s, i32 %i.0, !taffo.info !48, !taffo.initweight !98
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !116, !taffo.initweight !98, !taffo.constinfo !117
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx4 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !51, !taffo.initweight !98
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !116, !taffo.initweight !98, !taffo.constinfo !117
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx8 = getelementptr inbounds float, float* %s, i32 %j.0, !taffo.info !48, !taffo.initweight !98
  %0 = load float, float* %arrayidx8, align 4, !taffo.info !99, !taffo.initweight !101
  %arrayidx9 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.info !44, !taffo.initweight !98
  %1 = load float, float* %arrayidx9, align 4, !taffo.info !119, !taffo.initweight !101
  %arrayidx10 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !44, !taffo.initweight !98
  %arrayidx11 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx10, i32 0, i32 %j.0, !taffo.info !44, !taffo.initweight !101
  %2 = load float, float* %arrayidx11, align 4, !taffo.info !119, !taffo.initweight !105
  %mul = fmul float %1, %2, !taffo.info !120, !taffo.initweight !105
  %add = fadd float %0, %mul, !taffo.info !122, !taffo.initweight !105
  %arrayidx12 = getelementptr inbounds float, float* %s, i32 %j.0, !taffo.info !48, !taffo.initweight !98
  store float %add, float* %arrayidx12, align 4, !taffo.info !65, !taffo.initweight !101
  %arrayidx13 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !51, !taffo.initweight !98
  %3 = load float, float* %arrayidx13, align 4, !taffo.info !51, !taffo.initweight !101
  %arrayidx14 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !44, !taffo.initweight !98
  %arrayidx15 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.info !44, !taffo.initweight !101
  %4 = load float, float* %arrayidx15, align 4, !taffo.info !119, !taffo.initweight !105
  %arrayidx16 = getelementptr inbounds float, float* %p, i32 %j.0, !taffo.info !53, !taffo.initweight !98
  %5 = load float, float* %arrayidx16, align 4, !taffo.info !108, !taffo.initweight !101
  %mul17 = fmul float %4, %5, !taffo.info !124, !taffo.initweight !105
  %add18 = fadd float %3, %mul17, !taffo.info !126, !taffo.initweight !105
  %arrayidx19 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !51, !taffo.initweight !98
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %r, float* noundef %p, float* noundef %s, float* noundef %q) #0 !taffo.initweight !114 !taffo.funinfo !130 !taffo.sourceFunction !61 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !131, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !132, !taffo.initweight !59
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !133, !taffo.initweight !62

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %m, !taffo.info !135, !taffo.initweight !59
  %conv = sitofp i32 %rem to float, !taffo.info !137, !taffo.initweight !62
  %conv3 = sitofp i32 %m to float, !taffo.info !138
  %div = fdiv float %conv, %conv3, !taffo.info !139, !taffo.initweight !142
  %arrayidx = getelementptr inbounds float, float* %p, i32 %i.0, !taffo.info !143, !taffo.initweight !59
  store float %div, float* %arrayidx, align 4, !taffo.info !116, !taffo.initweight !62
  %arrayidx4 = getelementptr inbounds float, float* %s, i32 %i.0, !taffo.info !144, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !116, !taffo.initweight !62, !taffo.constinfo !117
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !145, !taffo.initweight !59, !taffo.constinfo !23
...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc29, %for.inc28 ], !taffo.info !131, !taffo.initweight !47
  %cmp6 = icmp slt i32 %i.1, %n, !taffo.info !132, !taffo.initweight !59
  br i1 %cmp6, label %for.body8, label %for.end30, !taffo.info !133, !taffo.initweight !62

for.body8:                                        ; preds = %for.cond5
  %rem9 = srem i32 %i.1, %n, !taffo.info !147, !taffo.initweight !59
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !148, !taffo.initweight !62
  %conv11 = sitofp i32 %n to float, !taffo.info !149
  %div12 = fdiv float %conv10, %conv11, !taffo.info !150, !taffo.initweight !142
  %arrayidx13 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.info !152, !taffo.initweight !59
  store float %div12, float* %arrayidx13, align 4, !taffo.info !116, !taffo.initweight !62
  %arrayidx14 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !153, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx14, align 4, !taffo.info !116, !taffo.initweight !62, !taffo.constinfo !117
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc25, %for.body8
  %j.0 = phi i32 [ 0, %for.body8 ], [ %inc26, %for.inc25 ], !taffo.info !147, !taffo.initweight !47
  %cmp16 = icmp slt i32 %j.0, %m, !taffo.info !132, !taffo.initweight !59
  br i1 %cmp16, label %for.body18, label %for.end27, !taffo.info !154, !taffo.initweight !62

for.body18:                                       ; preds = %for.cond15
  %add = add nsw i32 %j.0, 1, !taffo.info !156, !taffo.initweight !59, !taffo.constinfo !23
  %mul = mul nsw i32 %i.1, %add, !taffo.info !157, !taffo.initweight !59
  %rem19 = srem i32 %mul, %n, !taffo.info !147, !taffo.initweight !62
  %conv20 = sitofp i32 %rem19 to float, !taffo.info !148, !taffo.initweight !142
  %conv21 = sitofp i32 %n to float, !taffo.info !149
  %div22 = fdiv float %conv20, %conv21, !taffo.info !150, !taffo.initweight !98
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !152, !taffo.initweight !59
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx23, i32 0, i32 %j.0, !taffo.info !152, !taffo.initweight !59
  store float %div22, float* %arrayidx24, align 4, !taffo.info !116, !taffo.initweight !62
  br label %for.inc25

for.inc25:                                        ; preds = %for.body18
  %inc26 = add nsw i32 %j.0, 1, !taffo.info !156, !taffo.initweight !59, !taffo.constinfo !23
...
for.inc28:                                        ; preds = %for.end27
  %inc29 = add nsw i32 %i.1, 1, !taffo.info !145, !taffo.initweight !59, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !161 !taffo.funinfo !162 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !44, !taffo.initweight !105
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !119, !taffo.initweight !163
  %conv = sitofp i32 %factor to float, !taffo.info !110
  %mul = fmul float %1, %conv, !taffo.info !164, !taffo.initweight !166
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !44, !taffo.initweight !105
  store float %mul, float* %arrayidx6, align 4, !taffo.info !58, !taffo.initweight !163
  br label %for.inc
...
!97 = !{i32 1, !85, i32 1, !48, i32 1, !21}
!98 = !{i32 5}
!99 = !{!100, !1, i1 false, i2 -1}
!100 = !{!"fixp", i32 32, i32 26}
!101 = !{i32 6}
!102 = !{!45, !22, i1 false, i2 1}
!103 = !{!100, !104, i1 false, i2 -1}
!104 = !{double 0.000000e+00, double 0x404B5D1761459536}
!105 = !{i32 7}
!106 = distinct !{!106, !25}
!107 = !{i32 1, !85, i32 1, !53, i32 1, !21}
!108 = !{!109, !54, i1 false, i2 -1}
!109 = !{!"fixp", i32 32, i32 29}
!110 = !{!109, !22, i1 false, i2 1}
!111 = !{!109, !112, i1 false, i2 -1}
!112 = !{double 0.000000e+00, double 3.800000e+00}
!113 = distinct !{!113, !25}
!114 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!115 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !48, i32 1, !51, i32 1, !53, i32 1, !44}
!116 = !{i1 false, i1 false, i1 false, i2 1}
!117 = !{!91, i1 false}
!118 = distinct !{!118, !25}
!119 = !{!109, !46, i1 false, i2 -1}
!120 = !{!109, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x400D2832F576C918}
!122 = !{!100, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x403F021DBFF46E59}
!124 = !{!49, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x400D04A7A779562D}
!126 = !{!49, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x403BCF2094CAFDC0}
!128 = distinct !{!128, !25}
!129 = distinct !{!129, !25}
!130 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !44, i32 1, !53, i32 1, !48, i32 1, !51}
!131 = !{i1 false, !80, i1 false, i2 1}
!132 = !{i1 false, !75, i1 false, i2 1}
...
!137 = !{!49, !136, i1 false, i2 1}
!138 = !{!49, !86, i1 false, i2 1}
!139 = !{!140, !141, i1 false, i2 1}
!140 = !{!"fixp", i32 32, i32 31}
!141 = !{double 0.000000e+00, double 0x3FEE666666666666}
!142 = !{i32 4}
!143 = !{!45, !54, i1 false, i2 1}
!144 = !{!49, !1, i1 false, i2 1}
!145 = !{i1 false, !82, i1 false, i2 1}
!146 = distinct !{!146, !25}
!147 = !{i1 false, !73, i1 false, i2 1}
!148 = !{!49, !73, i1 false, i2 1}
!149 = !{!49, !88, i1 false, i2 1}
!150 = !{!140, !151, i1 false, i2 1}
!151 = !{double 0.000000e+00, double 0x3FEE8BA2E8BA2E8C}
!152 = !{!45, !46, i1 false, i2 1}
!153 = !{!49, !3, i1 false, i2 1}
...
!162 = !{i32 1, !87, i32 1, !85, i32 1, !44, i32 1, !21}
!163 = !{i32 8}
!164 = !{!109, !165, i1 false, i2 -1}
!165 = !{double 0.000000e+00, double 0x400E8BA301216830}
!166 = !{i32 9}
!167 = distinct !{!167, !25}
!168 = distinct !{!168, !25}
