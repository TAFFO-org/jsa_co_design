; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-64-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,64.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [45 x i8] c"target('B') scalar(range(0.0,21348.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 64), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 64), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 64), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
!7 = !{double 0.000000e+00, double 2.134800e+04}
...
!52 = !{double 0.000000e+00, double 6.400000e+01}
...
!118 = !{double 0.000000e+00, double 0x4134D90000000000}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 1.387620e+06}
!121 = distinct !{!121, !29}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 3.202200e+04}
!124 = distinct !{!124, !29}
!125 = distinct !{!125, !29}
...
!155 = !{double 0.000000e+00, double 4.096000e+03}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
