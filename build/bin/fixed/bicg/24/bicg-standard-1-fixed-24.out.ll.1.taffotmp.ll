...
entry:
  ...
  call void @llvm.var.annotation(i8* %s2, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  %q3 = bitcast [22 x float]* %q to i8*
  call void @llvm.var.annotation(i8* %q3, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 121, i8* null)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [20 x float], [20 x float]* %s, i32 0, i32 %6
...
for.body19:                                       ; preds = %for.cond17
  ...
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %q, i32 0, i32 %12
  ...
  store float %13, float* %arrayidx21, align 4
  br label %for.inc22
