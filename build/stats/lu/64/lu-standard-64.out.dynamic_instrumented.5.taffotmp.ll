; ModuleID = './build/stats/lu/64/lu-standard-64.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.1(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 64), !taffo.originalCall !27
