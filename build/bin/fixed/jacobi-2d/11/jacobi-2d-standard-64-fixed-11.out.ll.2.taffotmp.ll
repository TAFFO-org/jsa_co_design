; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-64-fixed-11.out.ll.1.taffotmp.ll'
...
@.str = private unnamed_addr constant [53 x i8] c"target('A') scalar(range(8.533334,964.266663) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [38 x i8] c"scalar(range(12.8,1028.266724) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 64), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 64), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x40211111276FB092, double 0x408E22222036006D}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 1.280000e+01, double 0x409011112018A43C}
!34 = !{i32 1}
!35 = !{i32 2}
