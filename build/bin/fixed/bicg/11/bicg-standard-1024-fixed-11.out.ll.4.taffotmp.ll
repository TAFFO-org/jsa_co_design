; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.info !58, !taffo.initweight !62, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 1024), !taffo.info !65, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !50, !taffo.originalCall !67
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 1024), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !52, !taffo.originalCall !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.info !53, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024), !taffo.info !69, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.info !44, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 1024), !taffo.info !58, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !53, !taffo.initweight !101
  %conv = sitofp i32 %factor to float, !taffo.info !102
  %mul = fmul float %0, %conv, !taffo.info !110, !taffo.initweight !107
...
for.body:                                         ; preds = %for.cond
  ...
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !116, !taffo.initweight !100, !taffo.constinfo !117
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !116, !taffo.initweight !100, !taffo.constinfo !117
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %1 = load float, float* %arrayidx9, align 4, !taffo.info !44, !taffo.initweight !101
  ...
  %2 = load float, float* %arrayidx11, align 4, !taffo.info !44, !taffo.initweight !107
  %mul = fmul float %1, %2, !taffo.info !119, !taffo.initweight !107
  %add = fadd float %0, %mul, !taffo.info !121, !taffo.initweight !107
  ...
  %4 = load float, float* %arrayidx15, align 4, !taffo.info !44, !taffo.initweight !107
  %arrayidx16 = getelementptr inbounds float, float* %p, i32 %j.0, !taffo.info !53, !taffo.initweight !100
  %5 = load float, float* %arrayidx16, align 4, !taffo.info !53, !taffo.initweight !101
  %mul17 = fmul float %4, %5, !taffo.info !123, !taffo.initweight !107
  %add18 = fadd float %3, %mul17, !taffo.info !125, !taffo.initweight !107
...
for.inc20:                                        ; preds = %for.body7
  ...
  br label %for.cond5, !llvm.loop !127
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %r, float* noundef %p, float* noundef %s, float* noundef %q) #0 !taffo.initweight !114 !taffo.funinfo !129 !taffo.sourceFunction !61 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !130, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !131, !taffo.initweight !59
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !132, !taffo.initweight !62

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %m, !taffo.info !134, !taffo.initweight !59
  %conv = sitofp i32 %rem to float, !taffo.info !136, !taffo.initweight !62
...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc29, %for.inc28 ], !taffo.info !130, !taffo.initweight !47
  %cmp6 = icmp slt i32 %i.1, %n, !taffo.info !131, !taffo.initweight !59
  br i1 %cmp6, label %for.body8, label %for.end30, !taffo.info !132, !taffo.initweight !62
...
for.cond15:                                       ; preds = %for.inc25, %for.body8
  ...
  %cmp16 = icmp slt i32 %j.0, %m, !taffo.info !131, !taffo.initweight !59
...
for.body18:                                       ; preds = %for.cond15
  ...
  %div22 = fdiv float %conv20, %conv21, !taffo.info !150, !taffo.initweight !100
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !44, !taffo.initweight !163
  %conv = sitofp i32 %factor to float, !taffo.info !102
...
!54 = !{double 0.000000e+00, double 0x408E6666601BC98A}
...
!99 = !{double 1.024000e+03, double 1.024000e+03}
!100 = !{i32 5}
!101 = !{i32 6}
!102 = !{!103, !99, i1 false, i2 1}
!103 = !{!"fixp", i32 32, i32 21}
!104 = !{!105, !106, i1 false, i2 -1}
!105 = !{!"float", i32 1, double 0x41FB5D1760000000}
!106 = !{double 0.000000e+00, double 0x41FB5D1760000000}
!107 = !{i32 7}
!108 = distinct !{!108, !25}
!109 = !{i32 1, !85, i32 1, !53, i32 1, !98}
!110 = !{!111, !112, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 12}
!112 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!113 = distinct !{!113, !25}
...
!117 = !{!91, i1 false}
!118 = distinct !{!118, !25}
!119 = !{!111, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x412D2832B6680D95}
!121 = !{!49, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x415F021DB6CD01B3}
!123 = !{!111, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x412D04A7821700A8}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x415BCF209042E015}
!127 = distinct !{!127, !25}
!128 = distinct !{!128, !25}
!129 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !44, i32 1, !53, i32 1, !48, i32 1, !51}
!130 = !{i1 false, !80, i1 false, i2 1}
!131 = !{i1 false, !75, i1 false, i2 1}
!132 = !{i1 false, !133, i1 false, i2 1}
!133 = !{double 0.000000e+00, double 2.200000e+01}
!134 = !{i1 false, !135, i1 false, i2 1}
!135 = !{double 0.000000e+00, double 1.900000e+01}
!136 = !{!137, !135, i1 false, i2 1}
!137 = !{!"fixp", i32 32, i32 27}
!138 = !{!137, !86, i1 false, i2 1}
...
!148 = !{!137, !73, i1 false, i2 1}
!149 = !{!137, !88, i1 false, i2 1}
...
!162 = !{i32 1, !87, i32 1, !85, i32 1, !44, i32 1, !98}
!163 = !{i32 8}
!164 = !{!111, !165, i1 false, i2 -1}
!165 = !{double 0.000000e+00, double 0x412E8BA2E019B0AB}
!166 = !{i32 9}
!167 = distinct !{!167, !25}
!168 = distinct !{!168, !25}
