; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-32-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 32), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 32), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
!103 = !{double 1.280000e+02, double 1.664000e+03}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -1.600000e+03, double 7.040000e+02}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -1.536000e+03, double 1.536000e+03}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 22}
!111 = !{double -1.920000e+02, double 1.920000e+02}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -3.840000e+02, double 3.840000e+02}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -5.760000e+02, double 5.760000e+02}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -5.120000e+02, double 1.408000e+03}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!161 = !{double 3.200000e+01, double 3.200000e+01}
...
!167 = !{!"fixp", i32 32, i32 17}
!168 = !{double 2.048000e+03, double 2.662400e+04}
!169 = distinct !{!169, !23}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
