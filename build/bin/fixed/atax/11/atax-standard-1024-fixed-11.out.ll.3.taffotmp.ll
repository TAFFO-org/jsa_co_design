; ModuleID = './build/bin/fixed/atax/11/atax-standard-1024-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,215.039993) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [39 x i8] c"scalar(range(1024.0,2001.45459) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [50 x i8] c"target('y') scalar(range(0.0,8258685440.0) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,4000317.5) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 1024), !taffo.initweight !61, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 1024), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 1024), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.initweight !57, !taffo.info !55
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 1024), !taffo.initweight !58, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x41FEC418A0000000}
...
!50 = !{double 0.000000e+00, double 0x406AE1479F666235}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 1.024000e+03, double 0x409F45D1800A7C5B}
!53 = !{i1 false, !7, i1 false, i2 -1}
!54 = !{!"y"}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 0x414E851EC0000000}
!57 = !{i32 1}
!58 = !{i32 2}
...
!105 = !{double 1.024000e+03, double 1.024000e+03}
!106 = !{i32 6}
!107 = !{i32 7}
!108 = !{i1 false, !109, i1 false, i2 -1}
!109 = !{double 0x4130000000000000, double 0x413F45D1800A7C5B}
!110 = distinct !{!110, !29}
!111 = !{i32 1, !99, i32 1, !53, i32 1, !104}
!112 = !{i1 false, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x429EC418A0000000}
!114 = distinct !{!114, !29}
...
!121 = !{double 0.000000e+00, double 0x411A44E31FC49A55}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x4150E6DD91FC49A5}
!124 = distinct !{!124, !29}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x41C9A3054B9950C6}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x4200FC3CA4B9950C}
!129 = distinct !{!129, !29}
!130 = distinct !{!130, !29}
!131 = !{i32 1, !117, i32 1, !55, i32 1, !104}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x41EE851EC0000000}
!134 = distinct !{!134, !29}
...
!161 = !{double 0.000000e+00, double 0x410AE1479F666235}
!162 = distinct !{!162, !29}
!163 = distinct !{!163, !29}
