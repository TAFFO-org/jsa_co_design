; ModuleID = './build/bin/fixed/2mm/8/2mm-standard-4-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6_fixp(i32 8, i32 12, i32* %u3_29fixp, i32 4), !taffo.info !64, !taffo.constinfo !65
  ...
  %u3_29fixp3 = bitcast [14 x i32]* %arraydecay14.u3_29fixp to i32*, !taffo.info !55
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u3_29fixp3, i32 4), !taffo.info !67, !taffo.constinfo !65
  ...
  %u2_30fixp1 = load i32, i32* %alpha.u2_30fixp, align 4, !taffo.info !71
  ...
  %0 = lshr i32 %u2_30fixp1, 1, !taffo.info !71
  call void @kernel_2mm.3_fixp(i32 8, i32 10, i32 12, i32 14, i32 %0, i32 %u2_30fixp, [10 x i32]* %arraydecay17.u7_25fixp, [12 x i32]* %arraydecay18.u3_29fixp, [10 x i32]* %arraydecay19.u3_29fixp, [14 x i32]* %arraydecay20.u3_29fixp, [14 x i32]* %arraydecay21.u11_21fixp), !taffo.info !60, !taffo.constinfo !61
...
for.body24:                                       ; preds = %for.cond22
  ...
  %2 = fdiv float %1, 0x4140000000000000, !taffo.info !57, !taffo.target !59
  ...
  store float %2, float* %arrayidx27, align 4, !taffo.info !68, !taffo.target !59
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i32 0, i32 0), double noundef %conv), !taffo.constinfo !84
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !219 !taffo.funinfo !220 !taffo.sourceFunction !221 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u11_21fixp = load i32, i32* %arrayidx4.u11_21fixp, align 4, !taffo.info !222
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !224
  %1 = lshr i32 %u11_21fixp, 1, !taffo.info !222
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !224
  %3 = ashr i32 %1, 2, !taffo.info !222
  %4 = ashr i32 %2, 10, !taffo.info !224
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 18), !taffo.info !225
  %mul.u13_19fixp = shl i32 %5, 1, !taffo.info !228
  ...
  %7 = shl i32 %mul.u13_19fixp, 2, !taffo.info !228
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !219 !taffo.funinfo !231 !taffo.sourceFunction !221 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 6, !taffo.info !224
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !232
  %mul.u9_23fixp = shl i32 %5, 1, !taffo.info !235
  %6 = mul nsw i32 %i.0, %m, !taffo.info !92
  ...
  %7 = shl i32 %mul.u9_23fixp, 2, !taffo.info !235
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !219 !taffo.funinfo !238 !taffo.sourceFunction !221 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u3_29fixp = load i32, i32* %arrayidx4.u3_29fixp, align 4, !taffo.info !239
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !240
  %1 = lshr i32 %u3_29fixp, 1, !taffo.info !239
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !240
  %3 = ashr i32 %1, 1, !taffo.info !239
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 27), !taffo.info !241
  %mul.u4_28fixp = shl i32 %4, 1, !taffo.info !242
  ...
  %6 = shl i32 %mul.u4_28fixp, 1, !taffo.info !242
...
!220 = !{i32 1, !86, i32 1, !88, i32 1, !57, i32 1, !98}
!221 = !{void (i32, i32, float*, i32)* @scale_2d}
!222 = !{!223, !1, i1 false, i2 -1}
!223 = !{!"fixp", i32 32, i32 19}
!224 = !{!51, !99, i1 false, i2 1}
!225 = !{!226, !227, i1 false, i2 -1}
!226 = !{!"fixp", i32 -32, i32 18}
!227 = !{double 0.000000e+00, double 0x40B32E66601BC98A}
!228 = !{!223, !227, i1 false, i2 -1}
!229 = distinct !{!229, !23}
!230 = distinct !{!230, !23}
!231 = !{i32 1, !86, i32 1, !16, i32 1, !47, i32 1, !98}
!232 = !{!233, !234, i1 false, i2 -1}
!233 = !{!"fixp", i32 -32, i32 22}
!234 = !{double 0.000000e+00, double 0x407273331E3A7DAA}
!235 = !{!128, !234, i1 false, i2 -1}
!236 = distinct !{!236, !23}
!237 = distinct !{!237, !23}
!238 = !{i32 1, !86, i32 1, !103, i32 1, !50, i32 1, !98}
!239 = !{!162, !52, i1 false, i2 -1}
!240 = !{!162, !99, i1 false, i2 1}
!241 = !{!164, !152, i1 false, i2 -1}
!242 = !{!162, !152, i1 false, i2 -1}
!243 = distinct !{!243, !23}
!244 = distinct !{!244, !23}
