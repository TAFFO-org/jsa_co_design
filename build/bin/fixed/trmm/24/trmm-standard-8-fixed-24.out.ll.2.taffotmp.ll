; ModuleID = './build/bin/fixed/trmm/24/trmm-standard-8-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 8), !taffo.initweight !39, !taffo.info !32, !taffo.originalCall !41
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 8), !taffo.initweight !43, !taffo.info !34, !taffo.originalCall !44
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 8), !taffo.initweight !43, !taffo.info !36, !taffo.target !38, !taffo.originalCall !44
...
!35 = !{double 0.000000e+00, double 8.000000e+00}
!36 = !{i1 false, !37, i1 false, i2 -1}
!37 = !{double 0.000000e+00, double 3.375000e+02}
!38 = !{!"B"}
!39 = !{i32 1}
