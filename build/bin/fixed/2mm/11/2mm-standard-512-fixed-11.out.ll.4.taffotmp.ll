; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-512-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.info !66, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 512), !taffo.info !71, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 512), !taffo.info !73, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 512), !taffo.info !77, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 512), !taffo.info !78, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 512), !taffo.info !79, !taffo.initweight !74, !taffo.constinfo !75, !taffo.target !60, !taffo.originalCall !76
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 512), !taffo.info !80, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
...
for.body32:                                       ; preds = %for.cond30
  ...
  %mul37 = fmul float %4, %5, !taffo.info !135, !taffo.initweight !138
  ...
  %add40 = fadd float %6, %mul37, !taffo.info !139, !taffo.initweight !138
...
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !66, !taffo.initweight !89, !taffo.constinfo !147
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !71, !taffo.initweight !89, !taffo.constinfo !149
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %rem = srem i32 %add, %ni, !taffo.info !161, !taffo.initweight !89
  %conv = sitofp i32 %rem to float, !taffo.info !163, !taffo.initweight !116
  %conv6 = sitofp i32 %ni to float, !taffo.info !165
  %div = fdiv float %conv, %conv6, !taffo.info !167, !taffo.initweight !117
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %A, i32 %i.0, !taffo.info !169, !taffo.initweight !72
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !169, !taffo.initweight !72
  store float %div, float* %arrayidx7, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !170, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !173, !taffo.initweight !72, !taffo.constinfo !21
...
for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !170, !taffo.initweight !72, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !176, !taffo.initweight !72
  %rem21 = srem i32 %mul20, %nj, !taffo.info !178, !taffo.initweight !74
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !179, !taffo.initweight !89
  %conv23 = sitofp i32 %nj to float, !taffo.info !180
  %div24 = fdiv float %conv22, %conv23, !taffo.info !181, !taffo.initweight !116
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.1, !taffo.info !184, !taffo.initweight !72
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.info !184, !taffo.initweight !72
  store float %div24, float* %arrayidx26, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !170, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !173, !taffo.initweight !72, !taffo.constinfo !21
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 3, !taffo.info !187, !taffo.initweight !72, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !189, !taffo.initweight !72
  %add43 = add nsw i32 %mul42, 1, !taffo.info !191, !taffo.initweight !74, !taffo.constinfo !21
  %rem44 = srem i32 %add43, %nl, !taffo.info !193, !taffo.initweight !89
  %conv45 = sitofp i32 %rem44 to float, !taffo.info !195, !taffo.initweight !116
  %conv46 = sitofp i32 %nl to float, !taffo.info !196
  %div47 = fdiv float %conv45, %conv46, !taffo.info !197, !taffo.initweight !117
  %arrayidx48 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %i.2, !taffo.info !199, !taffo.initweight !72
  %arrayidx49 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx48, i32 0, i32 %j.2, !taffo.info !199, !taffo.initweight !72
  store float %div47, float* %arrayidx49, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc50

for.inc50:                                        ; preds = %for.body40
  %inc51 = add nsw i32 %j.2, 1, !taffo.info !170, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc53:                                        ; preds = %for.end52
  %inc54 = add nsw i32 %i.2, 1, !taffo.info !173, !taffo.initweight !72, !taffo.constinfo !21
...
for.body63:                                       ; preds = %for.cond60
  %add64 = add nsw i32 %j.3, 2, !taffo.info !202, !taffo.initweight !72, !taffo.constinfo !21
  %mul65 = mul nsw i32 %i.3, %add64, !taffo.info !204, !taffo.initweight !72
  %rem66 = srem i32 %mul65, %nk, !taffo.info !206, !taffo.initweight !74
  %conv67 = sitofp i32 %rem66 to float, !taffo.info !208, !taffo.initweight !89
  %conv68 = sitofp i32 %nk to float, !taffo.info !209
  %div69 = fdiv float %conv67, %conv68, !taffo.info !210, !taffo.initweight !116
  %arrayidx70 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.3, !taffo.info !212, !taffo.initweight !72
  %arrayidx71 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx70, i32 0, i32 %j.3, !taffo.info !212, !taffo.initweight !72
  store float %div69, float* %arrayidx71, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc72

for.inc72:                                        ; preds = %for.body63
  %inc73 = add nsw i32 %j.3, 1, !taffo.info !170, !taffo.initweight !72, !taffo.constinfo !21
  br label %for.cond60, !llvm.loop !213

for.end74:                                        ; preds = %for.cond60
  br label %for.inc75

for.inc75:                                        ; preds = %for.end74
  %inc76 = add nsw i32 %i.3, 1, !taffo.info !173, !taffo.initweight !72, !taffo.constinfo !21
  br label %for.cond56, !llvm.loop !214
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.4, !taffo.info !215, !taffo.initweight !72
  %arrayidx87 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx86, i32 0, i32 %j.4, !taffo.info !215, !taffo.initweight !72
...
for.inc88:                                        ; preds = %for.body85
  %inc89 = add nsw i32 %j.4, 1, !taffo.info !170, !taffo.initweight !72, !taffo.constinfo !21
  br label %for.cond82, !llvm.loop !216

for.end90:                                        ; preds = %for.cond82
  br label %for.inc91

for.inc91:                                        ; preds = %for.end90
  %inc92 = add nsw i32 %i.4, 1, !taffo.info !173, !taffo.initweight !72, !taffo.constinfo !21
  br label %for.cond78, !llvm.loop !217
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !218 !taffo.funinfo !219 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !138
  %conv = sitofp i32 %factor to float, !taffo.info !220
  %mul = fmul float %1, %conv, !taffo.info !221, !taffo.initweight !224
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !80, !taffo.initweight !138
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !218 !taffo.funinfo !227 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !138
  %conv = sitofp i32 %factor to float, !taffo.info !220
  %mul = fmul float %1, %conv, !taffo.info !228, !taffo.initweight !224
  %2 = mul nsw i32 %i.0, %m, !taffo.info !104
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !73, !taffo.initweight !138
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !218 !taffo.funinfo !233 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !58, !taffo.initweight !138
  %conv = sitofp i32 %factor to float, !taffo.info !220
  %mul = fmul float %1, %conv, !taffo.info !234, !taffo.initweight !224
  %2 = mul nsw i32 %i.0, %m, !taffo.info !104
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !79, !taffo.initweight !138
  br label %for.inc
...
!50 = !{double 0.000000e+00, double 0x4132733320000000}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 32, i32 23}
!53 = !{double 0.000000e+00, double 4.480000e+02}
!54 = !{!52, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x407CCCCCC0379314}
!56 = !{!52, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x407DB6DB5FA22707}
!58 = !{!59, !1, i1 false, i2 -1}
!59 = !{!"float", i32 1, double 0x41E32E6660000000}
!60 = !{!"D"}
...
!111 = !{double 5.120000e+02, double 5.120000e+02}
...
!124 = !{double 0.000000e+00, double 6.720000e+02}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4112E6665E247885}
!127 = !{!49, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x41372CCCB7891E21}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"float", i32 1, double 0x41E7047AD9999999}
!134 = !{double 0.000000e+00, double 0x41E7047AD9999999}
!135 = !{!136, !137, i1 false, i2 -1}
!136 = !{!"float", i32 1, double 0x41C121D4034F607A}
!137 = !{double 0.000000e+00, double 0x41C121D4034F607A}
!138 = !{i32 8}
!139 = !{!140, !141, i1 false, i2 -1}
!140 = !{!"float", i32 1, double 0x41E776DB60D3D81E}
!141 = !{double 0.000000e+00, double 0x41E776DB60D3D81E}
!142 = distinct !{!142, !23}
!143 = distinct !{!143, !23}
!144 = distinct !{!144, !23}
!145 = !{i32 -1, i32 -1, i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2}
!146 = !{i32 1, !98, i32 1, !16, i32 1, !114, i32 1, !100, i32 1, !42, i32 1, !46, i32 1, !51, i32 1, !54, i32 1, !56, i32 1, !58, i32 1, !48}
!147 = !{!148, i1 false}
...
!164 = !{!"fixp", i32 32, i32 29}
!165 = !{!166, !99, i1 false, i2 1}
!166 = !{!"fixp", i32 32, i32 28}
!167 = !{!164, !168, i1 false, i2 -1}
!168 = !{double 0.000000e+00, double 8.750000e-01}
!169 = !{!52, !53, i1 false, i2 1}
...
!178 = !{i1 false, !84, i1 false, i2 -1}
!179 = !{!166, !84, i1 false, i2 -1}
!180 = !{!166, !17, i1 false, i2 1}
!181 = !{!182, !183, i1 false, i2 -1}
!182 = !{!"fixp", i32 32, i32 31}
!183 = !{double 0.000000e+00, double 9.000000e-01}
!184 = !{!52, !55, i1 false, i2 1}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
...
!195 = !{!166, !194, i1 false, i2 -1}
!196 = !{!166, !101, i1 false, i2 1}
!197 = !{!182, !198, i1 false, i2 -1}
!198 = !{double 0.000000e+00, double 0x3FEDB6DB6DB6DB6E}
!199 = !{!52, !57, i1 false, i2 1}
!200 = distinct !{!200, !23}
!201 = distinct !{!201, !23}
...
!208 = !{!166, !207, i1 false, i2 -1}
!209 = !{!166, !115, i1 false, i2 1}
!210 = !{!182, !211, i1 false, i2 -1}
!211 = !{double 0.000000e+00, double 0x3FED555555555555}
!212 = !{!59, !1, i1 false, i2 1}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = !{!49, !50, i1 false, i2 1}
!216 = distinct !{!216, !23}
!217 = distinct !{!217, !23}
!218 = !{i32 -1, i32 -1, i32 3, i32 -1}
!219 = !{i32 1, !98, i32 1, !16, i32 1, !48, i32 1, !110}
!220 = !{!121, !111, i1 false, i2 1}
!221 = !{!222, !223, i1 false, i2 -1}
!222 = !{!"float", i32 1, double 0x41C2733320000000}
!223 = !{double 0.000000e+00, double 0x41C2733320000000}
!224 = !{i32 9}
!225 = distinct !{!225, !23}
!226 = distinct !{!226, !23}
!227 = !{i32 1, !98, i32 1, !114, i32 1, !51, i32 1, !110}
!228 = !{!229, !230, i1 false, i2 -1}
!229 = !{!"fixp", i32 32, i32 14}
!230 = !{double 0.000000e+00, double 2.293760e+05}
!231 = distinct !{!231, !23}
!232 = distinct !{!232, !23}
!233 = !{i32 1, !98, i32 1, !100, i32 1, !58, i32 1, !110}
!234 = !{!235, !236, i1 false, i2 -1}
!235 = !{!"float", i32 1, double 0x42732E6660000000}
!236 = !{double 0.000000e+00, double 0x42732E6660000000}
!237 = distinct !{!237, !23}
!238 = distinct !{!238, !23}
