; ModuleID = './build/bin/fixed/symm/16/symm-standard-8-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,2744.640137) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [34 x i8] c"scalar(range(-7992.0,14.4) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.8,20.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 8), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 8), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 8), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x40A57147C0096FEB}
...
!56 = !{double -7.992000e+03, double 1.440000e+01}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 8.000000e-01, double 2.000000e+01}
!59 = !{i32 1}
...
!126 = !{double -1.598400e+05, double 2.880000e+02}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x3FF3333333333334, double 3.000000e+01}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -2.397600e+05, double 4.320000e+02}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -2.397600e+05, double 0x40A8D147C0096FEB}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x40A9BB22E671B980}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double -2.397600e+05, double 0x40AD1B22E671B980}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double -4.795200e+05, double 0x40B03D917338DCC0}
!145 = distinct !{!145, !29}
!146 = distinct !{!146, !29}
...
!172 = !{double 0.000000e+00, double 0x40D57147C0096FEB}
!173 = distinct !{!173, !29}
!174 = distinct !{!174, !29}
!175 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !120}
!176 = !{i1 false, !177, i1 false, i2 -1}
!177 = !{double -6.393600e+04, double 1.152000e+02}
!178 = distinct !{!178, !29}
!179 = distinct !{!179, !29}
