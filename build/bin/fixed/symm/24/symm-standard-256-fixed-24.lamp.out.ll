; ModuleID = './build/bin/fixed/symm/24/symm-standard-256-fixed-24.out.ll'
...
entry:
  ...
  call void @kernel_symm.3_fixp(i32 10, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u22_10fixp, [10 x i32]* %arraydecay12.s19_13fixp, [16 x i32]* %arraydecay13.u10_22fixp), !taffo.info !56, !taffo.constinfo !57
...
for.body16:                                       ; preds = %for.cond14
  ...
  %1 = fdiv float %lampsim2, 1.024000e+03, !taffo.info !47, !taffo.target !49
...
for.end:                                          ; preds = %for.cond4
  ...
  %lampsim = bitcast float %25 to i32
  %lampsim1 = and i32 %lampsim, -1
  %lampsim2 = bitcast i32 %lampsim1 to float
  %26 = fdiv float %lampsim2, 8.000000e+00, !taffo.info !112
  %lampsim3 = bitcast float %26 to i32
  %lampsim4 = and i32 %lampsim3, -1
  %lampsim5 = bitcast i32 %lampsim4 to float
  ...
  %lampsim6 = bitcast float %29 to i32
  %lampsim7 = and i32 %lampsim6, -1
  %lampsim8 = bitcast i32 %lampsim7 to float
  %30 = fdiv float %lampsim8, 8.000000e+00, !taffo.info !114
  %lampsim9 = bitcast float %30 to i32
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %add30.1flp12 = fadd float %lampsim5, %lampsim11, !taffo.info !116
  %lampsim13 = bitcast float %add30.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -1
  %lampsim15 = bitcast i32 %lampsim14 to float
  ...
  %31 = fmul float 1.024000e+03, %lampsim15, !taffo.info !116
  %lampsim16 = bitcast float %31 to i32
  %lampsim17 = and i32 %lampsim16, -1
  %lampsim18 = bitcast i32 %lampsim17 to float
  %32 = fptoui float %lampsim18 to i32, !taffo.info !116
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u22_10fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !166 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim1 = and i32 %lampsim, -1
  %lampsim2 = bitcast i32 %lampsim1 to float
  %2 = fdiv float %lampsim2, 1.024000e+03, !taffo.info !47
  ...
  %lampsim7 = and i32 %lampsim6, -1
  %lampsim8 = bitcast i32 %lampsim7 to float
  %4 = fdiv float %lampsim8, 0x4160000000000000, !taffo.info !168
  %lampsim9 = bitcast float %4 to i32
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !170
  ...
  %6 = fmul float 1.024000e+03, %lampsim15, !taffo.info !170
  %lampsim16 = bitcast float %6 to i32
  %lampsim17 = and i32 %lampsim16, -1
  %lampsim18 = bitcast i32 %lampsim17 to float
  %7 = fptoui float %lampsim18 to i32, !taffo.info !170
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !175 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !176
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !178
  ...
  %7 = shl i32 %mul.u18_14fixp, 8, !taffo.info !178
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s19_13fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !182 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.s27_5fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 5), !taffo.info !183
  ...
  %5 = shl i32 %mul.s27_5fixp, 8, !taffo.info !183
...
!171 = !{!"float", i32 1, double 0x41C5608A40000000}
!172 = !{double 0.000000e+00, double 0x41C5608A40000000}
!173 = distinct !{!173, !23}
!174 = distinct !{!174, !23}
!175 = !{i32 1, !16, i32 1, !79, i32 1, !53, i32 1, !89}
!176 = !{!51, !177, i1 false, i2 -1}
!177 = !{double 6.553600e+03, double 1.638400e+05}
!178 = !{!179, !177, i1 false, i2 -1}
!179 = !{!"fixp", i32 32, i32 14}
!180 = distinct !{!180, !23}
!181 = distinct !{!181, !23}
!182 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !89}
!183 = !{!184, !185, i1 false, i2 -1}
!184 = !{!"fixp", i32 -32, i32 5}
!185 = !{double 0xC18F380000000000, double 0x40FCCCCCC0379314}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
