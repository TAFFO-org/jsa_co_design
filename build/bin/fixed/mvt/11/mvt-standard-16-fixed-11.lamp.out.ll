; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-16-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !82
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !85
  %arrayidx1.u11_21fixp = getelementptr inbounds i32, i32* %val.u11_21fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u15_17fixp, 4, !taffo.info !85
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !88 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 23), !taffo.info !89
  %mul.u8_24fixp = shl i32 %4, 1, !taffo.info !92
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !44
  %5 = shl i32 %mul.u8_24fixp, 3, !taffo.info !92
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 23), !taffo.info !89
  %mul.u8_24fixp = shl i32 %5, 1, !taffo.info !92
  ...
  %7 = shl i32 %mul.u8_24fixp, 3, !taffo.info !92
...
!83 = !{!"fixp", i32 -32, i32 16}
!84 = !{double 0.000000e+00, double 0x40D3CFFFE004B7F6}
!85 = !{!86, !84, i1 false, i2 -1}
!86 = !{!"fixp", i32 32, i32 17}
!87 = distinct !{!87, !25}
!88 = !{i32 1, !67, i32 1, !44, i32 1, !78}
!89 = !{!90, !91, i1 false, i2 -1}
!90 = !{!"fixp", i32 -32, i32 23}
!91 = !{double 0.000000e+00, double 2.432000e+02}
...
!97 = distinct !{null}
!98 = !{!90, !99, i1 false, i2 -1}
!99 = !{double 0.000000e+00, double 2.310400e+02}
!100 = !{!93, !99, i1 false, i2 -1}
