; ModuleID = './build/bin/fixed/atax/11/atax-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.42) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(2.0,3.909091) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [47 x i8] c"target('y') scalar(range(0.0,61.532001) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,15.26) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 2), !taffo.initweight !61, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 2), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 2), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.initweight !57, !taffo.info !55
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.initweight !58, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.2(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !102 !taffo.funinfo !109 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_atax.3(i32 noundef %m, i32 noundef %n, [22 x float]* noundef %A, float* noundef %x, float* noundef %y, float* noundef %tmp) #0 !taffo.initweight !113 !taffo.funinfo !114 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body7:                                        ; preds = %for.cond5
  ...
  %0 = load float, float* %arrayidx8, align 4, !taffo.initweight !104, !taffo.info !55
  %arrayidx9 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.initweight !90, !taffo.info !49
  %arrayidx10 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx9, i32 0, i32 %j.0, !taffo.initweight !104, !taffo.info !49
  %1 = load float, float* %arrayidx10, align 4, !taffo.initweight !105, !taffo.info !49
  %arrayidx11 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.initweight !90, !taffo.info !51
  %2 = load float, float* %arrayidx11, align 4, !taffo.initweight !104, !taffo.info !51
  %mul = fmul float %1, %2, !taffo.initweight !105, !taffo.info !118
  %add = fadd float %0, %mul, !taffo.initweight !105, !taffo.info !120
  %arrayidx12 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.initweight !90, !taffo.info !55
  store float %add, float* %arrayidx12, align 4, !taffo.initweight !104, !taffo.info !55
  br label %for.inc13
...
for.body18:                                       ; preds = %for.cond16
  ...
  %3 = load float, float* %arrayidx19, align 4, !taffo.initweight !104, !taffo.info !53
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.initweight !90, !taffo.info !49
  %arrayidx21 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx20, i32 0, i32 %j.1, !taffo.initweight !104, !taffo.info !49
  %4 = load float, float* %arrayidx21, align 4, !taffo.initweight !105, !taffo.info !49
  %arrayidx22 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.initweight !90, !taffo.info !55
  %5 = load float, float* %arrayidx22, align 4, !taffo.initweight !104, !taffo.info !55
  %mul23 = fmul float %4, %5, !taffo.initweight !105, !taffo.info !123
  %add24 = fadd float %3, %mul23, !taffo.initweight !105, !taffo.info !125
  %arrayidx25 = getelementptr inbounds float, float* %y, i32 %j.1, !taffo.initweight !90, !taffo.info !53
  store float %add24, float* %arrayidx25, align 4, !taffo.initweight !104, !taffo.info !53
  br label %for.inc26
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !102 !taffo.funinfo !129 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %0, %conv, !taffo.initweight !105, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.5(i32 noundef %m, i32 noundef %n, [22 x float]* noundef %A, float* noundef %x, float* noundef %y, float* noundef %tmp) #0 !taffo.initweight !113 !taffo.funinfo !114 !taffo.sourceFunction !59 {
entry:
  %conv = sitofp i32 %n to float, !taffo.initweight !58, !taffo.info !133
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !80
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !58, !taffo.info !134
  br i1 %cmp, label %for.body, label %for.end, !taffo.initweight !61, !taffo.info !80

for.body:                                         ; preds = %for.cond
  %conv5 = sitofp i32 %i.0 to float, !taffo.initweight !58, !taffo.info !80
  %div = fdiv float %conv5, %conv, !taffo.initweight !58, !taffo.info !135
  %add = fadd float 1.000000e+00, %div, !taffo.initweight !61, !taffo.info !136, !taffo.constinfo !82
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.initweight !58, !taffo.info !138
  store float %add, float* %arrayidx, align 4, !taffo.initweight !61, !taffo.info !79
  %arrayidx6 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.initweight !58, !taffo.info !139
  store float 0.000000e+00, float* %arrayidx6, align 4, !taffo.initweight !61, !taffo.info !79, !taffo.constinfo !85
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.initweight !58, !taffo.info !140, !taffo.constinfo !27
...
for.cond7:                                        ; preds = %for.inc25, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc26, %for.inc25 ], !taffo.initweight !48, !taffo.info !80
  %cmp8 = icmp slt i32 %i.1, %m, !taffo.initweight !58, !taffo.info !134
  br i1 %cmp8, label %for.body10, label %for.end27, !taffo.initweight !61, !taffo.info !80

for.body10:                                       ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.initweight !58, !taffo.info !142
  store float 0.000000e+00, float* %arrayidx11, align 4, !taffo.initweight !61, !taffo.info !79, !taffo.constinfo !85
  br label %for.cond12

for.cond12:                                       ; preds = %for.inc22, %for.body10
  %j.0 = phi i32 [ 0, %for.body10 ], [ %inc23, %for.inc22 ], !taffo.initweight !48, !taffo.info !80
  %cmp13 = icmp slt i32 %j.0, %n, !taffo.initweight !58, !taffo.info !134
  br i1 %cmp13, label %for.body15, label %for.end24, !taffo.initweight !61, !taffo.info !80

for.body15:                                       ; preds = %for.cond12
  %add16 = add nsw i32 %i.1, %j.0, !taffo.initweight !58, !taffo.info !143
  %rem = srem i32 %add16, %n, !taffo.initweight !61, !taffo.info !145
  %conv17 = sitofp i32 %rem to float, !taffo.initweight !89, !taffo.info !145
  %mul = mul nsw i32 5, %m, !taffo.info !147, !taffo.constinfo !27
  %conv18 = sitofp i32 %mul to float, !taffo.info !147
  %div19 = fdiv float %conv17, %conv18, !taffo.initweight !90, !taffo.info !149
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.initweight !58, !taffo.info !151
  %arrayidx21 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx20, i32 0, i32 %j.0, !taffo.initweight !58, !taffo.info !151
  store float %div19, float* %arrayidx21, align 4, !taffo.initweight !61, !taffo.info !79
  br label %for.inc22

for.inc22:                                        ; preds = %for.body15
  %inc23 = add nsw i32 %j.0, 1, !taffo.initweight !58, !taffo.info !140, !taffo.constinfo !27
...
for.inc25:                                        ; preds = %for.end24
  %inc26 = add nsw i32 %i.1, 1, !taffo.initweight !58, !taffo.info !140, !taffo.constinfo !27
  br label %for.cond7, !llvm.loop !153
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !154 !taffo.funinfo !155 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !156, !taffo.info !49
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !157, !taffo.info !158
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !156, !taffo.info !49
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 0x404EC4189BD8383B}
...
!50 = !{double 0.000000e+00, double 4.200000e-01}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 2.000000e+00, double 0x400F45D18090B418}
!53 = !{i1 false, !7, i1 false, i2 -1}
!54 = !{!"y"}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 1.526000e+01}
!57 = !{i32 1}
!58 = !{i32 2}
...
!103 = !{i32 1, !99, i32 1, !51, i32 1, !25}
!104 = !{i32 6}
!105 = !{i32 7}
!106 = !{i1 false, !107, i1 false, i2 -1}
!107 = !{double 4.000000e+00, double 0x401F45D18090B418}
!108 = distinct !{!108, !29}
!109 = !{i32 1, !99, i32 1, !53, i32 1, !25}
!110 = !{i1 false, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x405EC4189BD8383B}
!112 = distinct !{!112, !29}
!113 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2}
!114 = !{i32 1, !115, i32 1, !99, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55}
!115 = !{i1 false, !116, i1 false, i2 0}
!116 = !{double 2.000000e+01, double 2.000000e+01}
!117 = distinct !{!117, !29}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x3FFA44E32E8E07EB}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x4030E6DD8F11D641}
!122 = distinct !{!122, !29}
...
!127 = distinct !{!127, !29}
!128 = distinct !{!128, !29}
!129 = !{i32 1, !115, i32 1, !55, i32 1, !25}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 3.052000e+01}
!132 = distinct !{!132, !29}
!133 = !{i1 false, !100, i1 false, i2 1}
!134 = !{i1 false, !71, i1 false, i2 -1}
!135 = !{i1 false, !71, i1 false, i2 1}
!136 = !{i1 false, !137, i1 false, i2 1}
!137 = !{double 1.000000e+00, double 2.000000e+00}
!138 = !{i1 false, !52, i1 false, i2 1}
!139 = !{i1 false, !7, i1 false, i2 1}
!140 = !{i1 false, !73, i1 false, i2 -1}
!141 = distinct !{!141, !29}
!142 = !{i1 false, !56, i1 false, i2 1}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0.000000e+00, double 4.400000e+01}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0.000000e+00, double 2.100000e+01}
!147 = !{i1 false, !148, i1 false, i2 0}
!148 = !{double 1.000000e+02, double 1.000000e+02}
...
!155 = !{i32 1, !115, i32 1, !99, i32 1, !49, i32 1, !25}
!156 = !{i32 8}
!157 = !{i32 9}
!158 = !{i1 false, !159, i1 false, i2 -1}
!159 = !{double 0.000000e+00, double 8.400000e-01}
!160 = distinct !{!160, !29}
!161 = distinct !{!161, !29}
