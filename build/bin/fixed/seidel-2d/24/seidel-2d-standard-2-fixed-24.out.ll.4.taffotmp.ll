; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-2-fixed-24.out.ll.3.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !90, !taffo.initweight !95
  %conv = sitofp i32 %factor to float, !taffo.info !139
  %mul = fmul float %1, %conv, !taffo.info !93, !taffo.initweight !141
...
!94 = !{double 4.000000e-01, double 0x40540CCCBC05D52C}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 24}
!98 = !{double 0x3FE3333333333334, double 0x405E13331A08BFC2}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 23}
!102 = !{double 8.000000e-01, double 0x40640CCCBC05D52C}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 1.000000e+00, double 0x40690FFFEB074A77}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 1.800000e+00, double 0x40768E6653868FD2}
...
!138 = !{i32 1, !72, i32 1, !72, i32 1, !41, i32 1, !19}
