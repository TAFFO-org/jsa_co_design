; ModuleID = './build/bin/fixed/symm/8/symm-standard-2-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s12_20fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !166 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %s12_20fixp = load i32, i32* %arrayidx4.s12_20fixp, align 4, !taffo.info !168
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !170
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !170
  %2 = ashr i32 %s12_20fixp, 1, !taffo.info !168
  %3 = ashr i32 %1, 10, !taffo.info !170
  %mul.s13_19fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !171
  ...
  %5 = shl i32 %mul.s13_19fixp, 1, !taffo.info !171
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !175 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.u4_28fixp = shl i32 %4, 1, !taffo.info !179
  ...
  %6 = shl i32 %mul.u4_28fixp, 1, !taffo.info !179
...
!166 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !19}
!167 = !{void (i32, i32, float*, i32)* @scale_2d}
!168 = !{!169, !52, i1 false, i2 -1}
!169 = !{!"fixp", i32 -32, i32 19}
!170 = !{!43, !20, i1 false, i2 1}
!171 = !{!169, !172, i1 false, i2 -1}
!172 = !{double -3.996000e+03, double 7.200000e+00}
!173 = distinct !{!173, !23}
!174 = distinct !{!174, !23}
!175 = !{i32 1, !16, i32 1, !81, i32 1, !53, i32 1, !19}
!176 = !{!66, !20, i1 false, i2 1}
!177 = !{!100, !178, i1 false, i2 -1}
!178 = !{double 4.000000e-01, double 1.000000e+01}
!179 = !{!66, !178, i1 false, i2 -1}
!180 = distinct !{!180, !23}
!181 = distinct !{!181, !23}
