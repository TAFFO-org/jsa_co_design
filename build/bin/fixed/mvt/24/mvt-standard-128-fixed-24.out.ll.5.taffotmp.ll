; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-128-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u17_15fixp = load i32, i32* %arrayidx21.u17_15fixp, align 4, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 7), !taffo.info !83
  %mul.u24_8fixp = shl i32 %4, 1, !taffo.info !86
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u24_8fixp, 7, !taffo.info !86
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !89 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !90
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !93
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !44
  %5 = shl i32 %mul.u14_18fixp, 7, !taffo.info !93
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 17), !taffo.info !90
  %mul.u14_18fixp = shl i32 %5, 1, !taffo.info !93
  ...
  %7 = shl i32 %mul.u14_18fixp, 7, !taffo.info !93
...
!84 = !{!"fixp", i32 -32, i32 7}
!85 = !{double 0.000000e+00, double 0x4163A06660008638}
!86 = !{!87, !85, i1 false, i2 -1}
!87 = !{!"fixp", i32 32, i32 8}
!88 = distinct !{!88, !25}
!89 = !{i32 1, !67, i32 1, !44, i32 1, !78}
!90 = !{!91, !92, i1 false, i2 -1}
!91 = !{!"fixp", i32 -32, i32 17}
!92 = !{double 0.000000e+00, double 0x40CE66665E02EA96}
