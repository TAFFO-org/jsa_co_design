; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-8-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %0 = lshr i32 %u2_30fixp, 2, !taffo.info !64
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %0, i32 %u2_30fixp1, [12 x i32]* %arraydecay11.u9_23fixp, [16 x i32]* %arraydecay12.u4_28fixp, [12 x i32]* %arraydecay13.u4_28fixp), !taffo.info !55, !taffo.constinfo !56
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i32 0, i32 0), double noundef %conv), !taffo.constinfo !77
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u4_28fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u9_23fixp, [16 x i32]* noundef %A.u4_28fixp, [12 x i32]* noundef %B.u4_28fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !96 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 22), !taffo.info !97
  %mul.u9_23fixp = shl i32 %3, 1, !taffo.info !100
...
for.body10:                                       ; preds = %for.cond8
  ...
  %6 = call i32 @llvm.smul.fix.i32(i32 %4, i32 %5, i32 27), !taffo.info !102
  %mul13.u4_28fixp = shl i32 %6, 1, !taffo.info !105
  ...
  %7 = lshr i32 %mul13.u4_28fixp, 1, !taffo.info !105
  %8 = lshr i32 %u4_28fixp2, 1, !taffo.info !53
  %9 = ashr i32 %7, 5, !taffo.info !105
  %10 = ashr i32 %8, 5, !taffo.info !53
  %11 = call i32 @llvm.smul.fix.i32(i32 %9, i32 %10, i32 22), !taffo.info !106
  %mul16.u9_23fixp = shl i32 %11, 1, !taffo.info !108
  ...
  %add.u9_23fixp = add i32 %u9_23fixp1, %mul16.u9_23fixp, !taffo.info !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u9_23fixp, [16 x i32]* noundef %A.u4_28fixp, [12 x i32]* noundef %B.u4_28fixp) #0 !taffo.initweight !114 !taffo.funinfo !115 !taffo.sourceFunction !116 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div.u1_31fixp = shl i32 %2, 4, !taffo.info !141
  %arrayidx.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u9_23fixp, i32 %i.0, !taffo.info !143
  %arrayidx7.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u9_23fixp, i32 0, i32 %j.0, !taffo.info !143
  %3 = lshr i32 %div.u1_31fixp, 8, !taffo.info !141
  store i32 %3, i32* %arrayidx7.u9_23fixp, align 4, !taffo.info !144
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
...
for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !149, !taffo.initweight !126
  %rem21 = srem i32 %mul20, %nk, !taffo.info !151, !taffo.initweight !129
  %conv22.u4_28fixp = shl i32 %rem21, 28, !taffo.info !153
  %conv23.u5_27fixp = shl i32 %nk, 27, !taffo.info !154
  %4 = lshr i32 %conv22.u4_28fixp, 1, !taffo.info !153
  %5 = lshr i32 %conv23.u5_27fixp, 1, !taffo.info !154
  %6 = ashr i32 %4, 1, !taffo.info !153
  %7 = call i32 @llvm.sdiv.fix.i32(i32 %6, i32 %5, i32 26), !taffo.info !156
  %div24.u1_31fixp = shl i32 %7, 5, !taffo.info !159
  %arrayidx25.u4_28fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u4_28fixp, i32 %i.1, !taffo.info !160
  %arrayidx26.u4_28fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u4_28fixp, i32 0, i32 %j.1, !taffo.info !160
  %8 = lshr i32 %div24.u1_31fixp, 3, !taffo.info !159
  store i32 %8, i32* %arrayidx26.u4_28fixp, align 4, !taffo.info !144
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.info !163, !taffo.initweight !126, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !165, !taffo.initweight !126
  %rem43 = srem i32 %mul42, %nj, !taffo.info !167, !taffo.initweight !129
  ...
  %arrayidx47.u4_28fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u4_28fixp, i32 %i.2, !taffo.info !173
  %arrayidx48.u4_28fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u4_28fixp, i32 0, i32 %j.2, !taffo.info !173
  %12 = lshr i32 %div46.u1_31fixp, 3, !taffo.info !172
  store i32 %12, i32* %arrayidx48.u4_28fixp, align 4, !taffo.info !144
  br label %for.inc49

for.inc49:                                        ; preds = %for.body40
  %inc50 = add nsw i32 %j.2, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
...
for.inc52:                                        ; preds = %for.end51
  %inc53 = add nsw i32 %i.2, 1, !taffo.info !145, !taffo.initweight !126, !taffo.constinfo !21
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u4_28fixp = load i32, i32* %arrayidx4.u4_28fixp, align 4, !taffo.info !179
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !181
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !179
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !181
  %3 = ashr i32 %1, 2, !taffo.info !179
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !182
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !185
  ...
  %6 = shl i32 %mul.u6_26fixp, 2, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !176 !taffo.funinfo !188 !taffo.sourceFunction !178 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u9_23fixp = load i32, i32* %arrayidx4.u9_23fixp, align 4, !taffo.info !47
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !189
  %1 = lshr i32 %u9_23fixp, 1, !taffo.info !47
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !189
  %3 = ashr i32 %1, 3, !taffo.info !47
  %4 = ashr i32 %2, 8, !taffo.info !189
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !190
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !193
  ...
  %7 = shl i32 %mul.u12_20fixp, 3, !taffo.info !193
...
!98 = !{!"fixp", i32 -32, i32 22}
!99 = !{double 0.000000e+00, double 0x407E9374B39BA35F}
...
!106 = !{!98, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 0x40549FFFF04577D9}
!108 = !{!48, !107, i1 false, i2 -1}
!109 = !{!48, !110, i1 false, i2 -1}
!110 = !{double 0.000000e+00, double 0x407EA2E13C68661B}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = !{i32 -1, i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!115 = !{i32 1, !16, i32 1, !79, i32 1, !94, i32 1, !42, i32 1, !45, i32 1, !47, i32 1, !50, i32 1, !53}
!116 = distinct !{null}
!117 = !{!118, i1 false}
...
!136 = !{i32 4}
!137 = !{!51, !135, i1 false, i2 1}
!138 = !{!51, !17, i1 false, i2 1}
!139 = !{!103, !140, i1 false, i2 1}
!140 = !{double 0.000000e+00, double 9.000000e-01}
...
!167 = !{i1 false, !66, i1 false, i2 1}
!168 = !{!51, !66, i1 false, i2 1}
!169 = !{!51, !80, i1 false, i2 1}
!170 = !{!103, !171, i1 false, i2 1}
!171 = !{double 0.000000e+00, double 0x3FED555555555555}
!172 = !{!142, !171, i1 false, i2 1}
!173 = !{!51, !54, i1 false, i2 1}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
!176 = !{i32 -1, i32 -1, i32 3, i32 -1}
!177 = !{i32 1, !16, i32 1, !94, i32 1, !50, i32 1, !89}
!178 = !{void (i32, i32, float*, i32)* @scale_2d}
!179 = !{!180, !52, i1 false, i2 -1}
!180 = !{!"fixp", i32 32, i32 26}
!181 = !{!180, !90, i1 false, i2 1}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 -32, i32 25}
!184 = !{double 0.000000e+00, double 6.000000e+01}
!185 = !{!180, !184, i1 false, i2 -1}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
!188 = !{i32 1, !16, i32 1, !79, i32 1, !47, i32 1, !89}
!189 = !{!51, !90, i1 false, i2 1}
!190 = !{!191, !192, i1 false, i2 -1}
!191 = !{!"fixp", i32 -32, i32 19}
!192 = !{double 0.000000e+00, double 0x40A97AE140570825}
