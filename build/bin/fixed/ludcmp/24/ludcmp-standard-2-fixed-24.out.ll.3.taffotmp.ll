; ModuleID = './build/bin/fixed/ludcmp/24/ludcmp-standard-2-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [35 x i8] c"scalar(range(0.1,16.344999) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(2.0,16.344999) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(8.05,9.0) final)\00", section "llvm.metadata", !taffo.info !0
...
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,8.05) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 2), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !59, !taffo.info !53
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 2), !taffo.initweight !60, !taffo.info !53, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 2), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 2), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!50 = !{double 1.000000e-01, double 0x40305851DABE2718}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 2.000000e+00, double 0x40305851DABE2718}
!53 = !{i1 false, !54, i1 false, i2 -1}
!54 = !{double 8.050000e+00, double 9.000000e+00}
!55 = !{i1 false, !7, i1 false, i2 -1}
!56 = !{!"x"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 8.050000e+00}
!59 = !{i32 1}
!60 = !{i32 2}
...
!127 = !{i32 1, !123, i32 1, !53, i32 1, !25}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 1.610000e+01, double 1.800000e+01}
!131 = distinct !{!131, !29}
!132 = !{i32 1, !123, i32 1, !55, i32 1, !25}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -7.589400e-02, double 0x401FFCF893FAF428}
!135 = distinct !{!135, !29}
!136 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!137 = !{i32 1, !123, i32 1, !49, i32 1, !53, i32 1, !55, i32 1, !57}
!138 = !{i32 8}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0x3F847AE147AE147C, double 0x4070B28B3B853C52}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0xC07D328B3B853C52, double 1.999900e+02}
!143 = distinct !{!143, !29}
...
!151 = !{double 0.000000e+00, double 0x40607278C41C2424}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0xC074B93C620E1212, double 2.000000e+02}
!154 = distinct !{!154, !29}
!155 = distinct !{!155, !29}
...
!163 = !{double 0xBFE3D909448FCA1B, double 0x405056C5C893154F}
!164 = !{i1 false, !165, i1 false, i2 -1}
!165 = !{double 0xC07095B17224C554, double 0x406913D909448FCA}
...
!171 = distinct !{!171, !29}
!172 = !{i32 1, !123, i32 1, !57, i32 1, !25}
!173 = !{i1 false, !174, i1 false, i2 -1}
!174 = !{double 0.000000e+00, double 1.610000e+01}
!175 = distinct !{!175, !29}
...
!213 = !{double 2.010000e+00, double 0x4071B81059311EC4}
!214 = distinct !{!214, !29}
!215 = distinct !{!215, !29}
!216 = distinct !{!216, !29}
!217 = distinct !{!217, !29}
...
!220 = !{i32 1, !123, i32 1, !123, i32 1, !49, i32 1, !25}
!221 = !{i32 9}
!222 = !{i1 false, !223, i1 false, i2 -1}
!223 = !{double 2.000000e-01, double 0x40405851DABE2718}
!224 = distinct !{!224, !29}
!225 = distinct !{!225, !29}
!226 = !{i32 1, !123, i32 1, !123, i32 1, !51, i32 1, !25}
!227 = !{i1 false, !228, i1 false, i2 -1}
!228 = !{double 4.000000e+00, double 0x40405851DABE2718}
!229 = distinct !{!229, !29}
!230 = distinct !{!230, !29}
