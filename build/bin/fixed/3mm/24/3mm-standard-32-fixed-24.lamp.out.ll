; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-32-fixed-24.out.ll'
...
entry:
  ...
  %u3_29fixp = bitcast [10 x i32]* %arraydecay15.u3_29fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u3_29fixp, i32 32), !taffo.info !62, !taffo.constinfo !61
  ...
  %u3_29fixp1 = bitcast [12 x i32]* %arraydecay19.u3_29fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u3_29fixp1, i32 32), !taffo.info !66, !taffo.constinfo !61
