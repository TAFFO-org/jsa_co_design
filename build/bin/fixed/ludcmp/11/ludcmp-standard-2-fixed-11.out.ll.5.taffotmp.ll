; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-2-fixed-11.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.2_fixp(i32 noundef %n, i32* noundef %val.s4_28fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !92 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %s4_28fixp = load i32, i32* %arrayidx.s4_28fixp, align 4, !taffo.info !93
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !85
  %0 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !85
  %1 = ashr i32 %s4_28fixp, 1, !taffo.info !93
  %2 = ashr i32 %0, 2, !taffo.info !85
  %mul.s5_27fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 27), !taffo.info !95
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s5_27fixp, 1, !taffo.info !95
...
!91 = distinct !{!91, !23}
!92 = !{i32 1, !74, i32 1, !50, i32 1, !19}
!93 = !{!94, !1, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 27}
!95 = !{!94, !96, i1 false, i2 -1}
!96 = !{double -7.589400e-02, double 0x401FFCF893FAF428}
!97 = distinct !{!97, !23}
