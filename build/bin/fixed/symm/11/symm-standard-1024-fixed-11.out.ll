; ModuleID = './build/bin/fixed/symm/11/symm-standard-1024-fixed-11.out.ll.4.taffotmp.ll'
...
for.body6:                                        ; preds = %for.cond4
  ...
  %7 = fdiv float %6, 0x4130000000000000, !taffo.info !145
  ...
  %12 = fmul float 6.400000e+01, %add.1flp, !taffo.info !149
...
for.end:                                          ; preds = %for.cond4
  ...
  %23 = fdiv float %22, 6.400000e+01, !taffo.info !156
  ...
  %29 = fdiv float %28, 0x4130000000000000, !taffo.info !145
  ...
  %mul29.1flp = fmul float %1, %temp2.0.1flp, !taffo.info !146
  %add30.1flp = fadd float %add28.1flp, %mul29.1flp, !taffo.info !159
  ...
  %32 = fmul float 6.400000e+01, %add30.1flp, !taffo.info !159
  %33 = fptoui float %32 to i32, !taffo.info !159
