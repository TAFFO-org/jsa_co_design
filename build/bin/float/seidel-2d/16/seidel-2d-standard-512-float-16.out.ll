...
@.str = private unnamed_addr constant [56 x i8] c"target('A') scalar(range(51.200001,10265.599609) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay1, i32 noundef 512)
