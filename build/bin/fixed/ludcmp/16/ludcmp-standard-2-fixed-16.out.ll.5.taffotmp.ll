; ModuleID = './build/bin/fixed/ludcmp/16/ludcmp-standard-2-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u5_27fixp1 = bitcast [20 x i32]* %arraydecay10.u5_27fixp to i32*, !taffo.info !42
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u5_27fixp1, i32 2), !taffo.info !55, !taffo.constinfo !57
  %arraydecay11.u5_27fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u5_27fixp, i32 0, i32 0, !taffo.info !45
  %u5_27fixp = bitcast [20 x i32]* %arraydecay11.u5_27fixp to i32*, !taffo.info !45
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u5_27fixp, i32 2), !taffo.info !58, !taffo.constinfo !57
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !82 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u4_28fixp = load i32, i32* %arrayidx.u4_28fixp, align 4, !taffo.info !84
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !85
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !84
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !85
  %2 = ashr i32 %0, 1, !taffo.info !84
  %3 = ashr i32 %1, 3, !taffo.info !85
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 26), !taffo.info !87
  %mul.u5_27fixp = shl i32 %4, 1, !taffo.info !90
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u5_27fixp, 1, !taffo.info !90
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u5_27fixp, i32* noundef %b.u4_28fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u4_28fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !94 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u5_27fixp = load i32, i32* %arrayidx5.u5_27fixp, align 4, !taffo.info !95
  %0 = lshr i32 %u5_27fixp, 5, !taffo.info !95
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body4
  %k.0 = phi i32 [ 0, %for.body4 ], [ %inc, %for.inc ], !taffo.info !67
  %w.0.s10_22fixp = phi i32 [ %0, %for.body4 ], [ %sub.s10_22fixp, %for.inc ], !taffo.info !98
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s10_22fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !100
  %sub.s10_22fixp = sub i32 %w.0.s10_22fixp, %mul.s10_22fixp, !taffo.info !102
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  br label %for.cond6, !llvm.loop !104
...
for.end:                                          ; preds = %for.cond6
  ...
  %6 = ashr i32 %w.0.s10_22fixp, 2, !taffo.info !98
  %7 = ashr i32 %5, 6, !taffo.info !42
  %div.s12_20fixp = call i32 @llvm.sdiv.fix.i32(i32 %6, i32 %7, i32 20), !taffo.info !105
  ...
  %8 = shl i32 %div.s12_20fixp, 7, !taffo.info !105
  store i32 %8, i32* %arrayidx16.u5_27fixp, align 4, !taffo.info !108
  br label %for.inc17

for.inc17:                                        ; preds = %for.end
  %inc18 = add nsw i32 %j.0, 1, !taffo.info !76, !taffo.constinfo !21
  br label %for.cond2, !llvm.loop !109
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u5_27fixp12 = load i32, i32* %arrayidx24.u5_27fixp, align 4, !taffo.info !95
  %9 = lshr i32 %u5_27fixp12, 5, !taffo.info !95
  br label %for.cond25

for.cond25:                                       ; preds = %for.inc34, %for.body22
  %k.1 = phi i32 [ 0, %for.body22 ], [ %inc35, %for.inc34 ], !taffo.info !67
  %w.1.s10_22fixp = phi i32 [ %9, %for.body22 ], [ %sub33.s10_22fixp, %for.inc34 ], !taffo.info !98
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s10_22fixp = call i32 @llvm.smul.fix.i32(i32 %12, i32 %13, i32 22), !taffo.info !100
  %sub33.s10_22fixp = sub i32 %w.1.s10_22fixp, %mul32.s10_22fixp, !taffo.info !102
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  br label %for.cond25, !llvm.loop !110
...
for.end36:                                        ; preds = %for.cond25
  ...
  %14 = shl i32 %w.1.s10_22fixp, 5, !taffo.info !98
  store i32 %14, i32* %arrayidx38.u5_27fixp, align 4, !taffo.info !108
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u4_28fixp = load i32, i32* %arrayidx48.u4_28fixp, align 4, !taffo.info !95
  %15 = lshr i32 %u4_28fixp, 6, !taffo.info !95
  br label %for.cond49

for.cond49:                                       ; preds = %for.inc57, %for.body47
  %j.2 = phi i32 [ 0, %for.body47 ], [ %inc58, %for.inc57 ], !taffo.info !67
  %w.2.s10_22fixp = phi i32 [ %15, %for.body47 ], [ %sub56.s10_22fixp, %for.inc57 ], !taffo.info !98
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.u8_24fixp = shl i32 %20, 1, !taffo.info !115
  %21 = lshr i32 %mul55.u8_24fixp, 2, !taffo.info !115
  %sub56.s10_22fixp = sub i32 %w.2.s10_22fixp, %21, !taffo.info !117
  br label %for.inc57
...
for.end59:                                        ; preds = %for.cond49
  ...
  %22 = shl i32 %w.2.s10_22fixp, 6, !taffo.info !98
  store i32 %22, i32* %arrayidx60.u4_28fixp, align 4, !taffo.info !108
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u4_28fixp8 = load i32, i32* %arrayidx68.u4_28fixp, align 4, !taffo.info !95
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %23 = lshr i32 %u4_28fixp8, 6, !taffo.info !95
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc77, %for.body67
  %j.3 = phi i32 [ %add, %for.body67 ], [ %inc78, %for.inc77 ], !taffo.info !125
  %w.3.s10_22fixp = phi i32 [ %23, %for.body67 ], [ %sub76.s10_22fixp, %for.inc77 ], !taffo.info !98
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s10_22fixp = call i32 @llvm.smul.fix.i32(i32 %25, i32 %26, i32 22), !taffo.info !127
  %sub76.s10_22fixp = sub i32 %w.3.s10_22fixp, %mul75.s10_22fixp, !taffo.info !129
  br label %for.inc77
...
for.end79:                                        ; preds = %for.cond69
  ...
  %28 = ashr i32 %w.3.s10_22fixp, 2, !taffo.info !98
  %29 = ashr i32 %27, 6, !taffo.info !42
  %div82.s12_20fixp = call i32 @llvm.sdiv.fix.i32(i32 %28, i32 %29, i32 20), !taffo.info !105
  %arrayidx83.s4_28fixp = getelementptr inbounds i32, i32* %x.s4_28fixp, i32 %i.2, !taffo.info !50
  %30 = shl i32 %div82.s12_20fixp, 8, !taffo.info !105
  store i32 %30, i32* %arrayidx83.s4_28fixp, align 4, !taffo.info !108
  br label %for.inc84
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.2_fixp(i32 noundef %n, i32* noundef %val.s4_28fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !137 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %s4_28fixp = load i32, i32* %arrayidx.s4_28fixp, align 4, !taffo.info !138
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !85
  %0 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !85
  %1 = ashr i32 %s4_28fixp, 1, !taffo.info !138
  %2 = ashr i32 %0, 2, !taffo.info !85
  %mul.s5_27fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 27), !taffo.info !140
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s5_27fixp, 1, !taffo.info !140
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 22), !taffo.info !100
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !85
  %3 = ashr i32 %1, 1, !taffo.info !210
  %4 = ashr i32 %2, 4, !taffo.info !85
...
!82 = !{i32 1, !74, i32 1, !47, i32 1, !19}
!83 = !{void (i32, float*, i32)* @scale_1d}
!84 = !{!43, !49, i1 false, i2 -1}
!85 = !{!86, !20, i1 false, i2 1}
!86 = !{!"fixp", i32 32, i32 30}
!87 = !{!88, !89, i1 false, i2 -1}
!88 = !{!"fixp", i32 -32, i32 26}
!89 = !{double 1.610000e+01, double 1.800000e+01}
!90 = !{!43, !89, i1 false, i2 -1}
!91 = distinct !{!91, !23}
!92 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!93 = !{i32 1, !74, i32 1, !42, i32 1, !47, i32 1, !50, i32 1, !53}
!94 = distinct !{null}
!95 = !{!96, !97, i1 false, i2 -1}
!96 = !{!"fixp", i32 -32, i32 23}
!97 = !{double -2.000000e+02, double 2.000000e+02}
!98 = !{!99, !97, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 22}
!100 = !{!99, !101, i1 false, i2 -1}
!101 = !{double 0x3F847AE147AE147C, double 0x4070B28B3B853C52}
!102 = !{!99, !103, i1 false, i2 -1}
!103 = !{double 0xC07D328B3B853C52, double 1.999900e+02}
!104 = distinct !{!104, !23}
!105 = !{!106, !107, i1 false, i2 -1}
!106 = !{!"fixp", i32 -32, i32 20}
!107 = !{double -2.000000e+03, double 2.000000e+03}
!108 = !{i1 false, !97, i1 false, i2 -1}
!109 = distinct !{!109, !23}
!110 = distinct !{!110, !23}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = !{!96, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 0x40607278C41C2424}
!115 = !{!116, !114, i1 false, i2 -1}
!116 = !{!"fixp", i32 32, i32 24}
!117 = !{!99, !118, i1 false, i2 -1}
!118 = !{double 0xC074B93C620E1212, double 2.000000e+02}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
...
!127 = !{!99, !128, i1 false, i2 -1}
!128 = !{double 0xBFE3D909448FCA1B, double 0x405056C5C893154F}
!129 = !{!99, !130, i1 false, i2 -1}
!130 = !{double 0xC07095B17224C554, double 0x406913D909448FCA}
...
!136 = distinct !{!136, !23}
!137 = !{i32 1, !74, i32 1, !50, i32 1, !19}
!138 = !{!139, !1, i1 false, i2 -1}
!139 = !{!"fixp", i32 -32, i32 27}
!140 = !{!139, !141, i1 false, i2 -1}
!141 = !{double -7.589400e-02, double 0x401FFCF893FAF428}
!142 = distinct !{!142, !23}
...
!179 = !{!88, !178, i1 false, i2 1}
!180 = !{!88, !181, i1 false, i2 1}
