; ModuleID = './build/bin/fixed/symm/11/symm-standard-256-fixed-11.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = fmul float 1.024000e+03, %mul.1flp, !taffo.info !183
  %7 = fptoui float %6 to i32, !taffo.info !183
