; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-1024-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u14_18fixp = bitcast [20 x i32]* %arraydecay10.u14_18fixp to i32*, !taffo.info !42
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u14_18fixp, i32 1024), !taffo.info !55, !taffo.constinfo !57
  %arraydecay11.u14_18fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u14_18fixp, i32 0, i32 0, !taffo.info !45
  %u14_18fixp1 = bitcast [20 x i32]* %arraydecay11.u14_18fixp to i32*, !taffo.info !45
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u14_18fixp1, i32 1024), !taffo.info !58, !taffo.constinfo !57
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !92 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 8), !taffo.info !93
  %mul.u23_9fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u13_19fixp = getelementptr inbounds i32, i32* %val.u13_19fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u23_9fixp, 10, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u14_18fixp, i32* noundef %b.u13_19fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u13_19fixp) #0 !taffo.initweight !99 !taffo.funinfo !100 !taffo.sourceFunction !101 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u14_18fixp = load i32, i32* %arrayidx5.u14_18fixp, align 4, !taffo.info !102
  %0 = shl i32 %u14_18fixp, 5, !taffo.info !102
  br label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s28_4fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !105
  %5 = ashr i32 %w.0.s9_23fixp, 19, !taffo.info !102
  %sub.s28_4fixp = sub i32 %5, %mul.s28_4fixp, !taffo.info !108
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s28_4fixp, 19, !taffo.info !108
...
for.end:                                          ; preds = %for.cond6
  ...
  %8 = ashr i32 %w.0.s9_23fixp, 6, !taffo.info !102
  %9 = call i32 @llvm.sdiv.fix.i32(i32 %8, i32 %7, i32 17), !taffo.info !111
  %div.s12_20fixp = shl i32 %9, 3, !taffo.info !114
  ...
  %10 = ashr i32 %div.s12_20fixp, 2, !taffo.info !114
  store i32 %10, i32* %arrayidx16.u14_18fixp, align 4, !taffo.info !116
  br label %for.inc17

for.inc17:                                        ; preds = %for.end
  %inc18 = add nsw i32 %j.0, 1, !taffo.info !76, !taffo.constinfo !21
  br label %for.cond2, !llvm.loop !117
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u14_18fixp12 = load i32, i32* %arrayidx24.u14_18fixp, align 4, !taffo.info !102
  %11 = shl i32 %u14_18fixp12, 5, !taffo.info !102
  br label %for.cond25
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s28_4fixp = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 4), !taffo.info !105
  %16 = ashr i32 %w.1.s9_23fixp, 19, !taffo.info !102
  %sub33.s28_4fixp = sub i32 %16, %mul32.s28_4fixp, !taffo.info !108
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %17 = shl i32 %sub33.s28_4fixp, 19, !taffo.info !108
  br label %for.cond25, !llvm.loop !118
...
for.end36:                                        ; preds = %for.cond25
  ...
  %18 = ashr i32 %w.1.s9_23fixp, 5, !taffo.info !102
  store i32 %18, i32* %arrayidx38.u14_18fixp, align 4, !taffo.info !116
  br label %for.inc39

for.inc39:                                        ; preds = %for.end36
  %inc40 = add nsw i32 %j.1, 1, !taffo.info !76, !taffo.constinfo !21
  br label %for.cond20, !llvm.loop !119
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u13_19fixp = load i32, i32* %arrayidx48.u13_19fixp, align 4, !taffo.info !102
  %19 = shl i32 %u13_19fixp, 4, !taffo.info !102
  br label %for.cond49
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s27_5fixp = call i32 @llvm.smul.fix.i32(i32 %22, i32 %23, i32 5), !taffo.info !121
  %24 = ashr i32 %w.2.s9_23fixp, 18, !taffo.info !102
  %sub56.s27_5fixp = sub i32 %24, %mul55.s27_5fixp, !taffo.info !124
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !76, !taffo.constinfo !21
  %25 = shl i32 %sub56.s27_5fixp, 18, !taffo.info !124
...
for.end59:                                        ; preds = %for.cond49
  ...
  %26 = ashr i32 %w.2.s9_23fixp, 4, !taffo.info !102
  store i32 %26, i32* %arrayidx60.u13_19fixp, align 4, !taffo.info !116
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u13_19fixp8 = load i32, i32* %arrayidx68.u13_19fixp, align 4, !taffo.info !102
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %27 = shl i32 %u13_19fixp8, 4, !taffo.info !102
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc77, %for.body67
  %j.3 = phi i32 [ %add, %for.body67 ], [ %inc78, %for.inc77 ], !taffo.info !132
  %w.3.s9_23fixp = phi i32 [ %27, %for.body67 ], [ %32, %for.inc77 ], !taffo.info !102
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s17_15fixp = call i32 @llvm.smul.fix.i32(i32 %29, i32 %30, i32 15), !taffo.info !134
  %31 = ashr i32 %w.3.s9_23fixp, 8, !taffo.info !102
  %sub76.s17_15fixp = sub i32 %31, %mul75.s17_15fixp, !taffo.info !137
  br label %for.inc77

for.inc77:                                        ; preds = %for.body71
  %inc78 = add nsw i32 %j.3, 1, !taffo.info !139, !taffo.constinfo !21
  %32 = shl i32 %sub76.s17_15fixp, 8, !taffo.info !137
  br label %for.cond69, !llvm.loop !141
...
for.end79:                                        ; preds = %for.cond69
  ...
  %34 = ashr i32 %w.3.s9_23fixp, 6, !taffo.info !102
  %35 = call i32 @llvm.sdiv.fix.i32(i32 %34, i32 %33, i32 17), !taffo.info !111
  %div82.s12_20fixp = shl i32 %35, 3, !taffo.info !114
  %arrayidx83.s4_28fixp = getelementptr inbounds i32, i32* %x.s4_28fixp, i32 %i.2, !taffo.info !50
  %36 = shl i32 %div82.s12_20fixp, 8, !taffo.info !114
  store i32 %36, i32* %arrayidx83.s4_28fixp, align 4, !taffo.info !116
  br label %for.inc84

for.inc84:                                        ; preds = %for.end79
  %dec = add nsw i32 %i.2, -1, !taffo.info !142, !taffo.constinfo !21
  br label %for.cond65, !llvm.loop !144
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 4), !taffo.info !105
...
!90 = !{double 0xC0436DCA07F66E87, double 0x40AFFCF893FAF428}
!91 = distinct !{!91, !23}
!92 = !{i32 1, !74, i32 1, !47, i32 1, !83}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 8}
!95 = !{double 0x41501999A005C465, double 0x4152000000000000}
...
!106 = !{!"fixp", i32 -32, i32 4}
!107 = !{double 0x3F847AE147AE147C, double 0x4190B28B463B78B0}
!108 = !{!106, !109, i1 false, i2 -1}
!109 = !{double 0xC190B28E663B78B0, double 1.999900e+02}
!110 = distinct !{!110, !23}
!111 = !{!112, !113, i1 false, i2 -1}
!112 = !{!"fixp", i32 -32, i32 17}
!113 = !{double -2.000000e+03, double 2.000000e+03}
!114 = !{!115, !113, i1 false, i2 -1}
!115 = !{!"fixp", i32 -32, i32 20}
!116 = !{i1 false, !104, i1 false, i2 -1}
!117 = distinct !{!117, !23}
!118 = distinct !{!118, !23}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
...
!123 = !{double 0.000000e+00, double 0x41807278CFF25395}
!124 = !{!122, !125, i1 false, i2 -1}
!125 = !{double 0xC180727F0FF25395, double 2.000000e+02}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
...
!135 = !{!"fixp", i32 -32, i32 15}
!136 = !{double 0xC073D9094AED99C8, double 0x40E056C5CDD0C3A5}
!137 = !{!135, !138, i1 false, i2 -1}
!138 = !{double 0xC0E06FC5CDD0C3A5, double 0x40802C84A576CCE4}
!139 = !{i1 false, !140, i1 false, i2 0}
!140 = !{double 2.100000e+01, double 2.100000e+01}
!141 = distinct !{!141, !23}
!142 = !{i1 false, !143, i1 false, i2 0}
!143 = !{double 1.800000e+01, double 1.800000e+01}
!144 = distinct !{!144, !23}
