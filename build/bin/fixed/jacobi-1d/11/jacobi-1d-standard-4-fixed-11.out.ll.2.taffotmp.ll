; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-4-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 4), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !37
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !34, !taffo.info !32
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 4), !taffo.initweight !35, !taffo.info !32, !taffo.originalCall !37
...
!31 = !{double 5.333330e-01, double 0x40111111276FB092}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 8.000000e-01, double 0x401222220BC382A1}
!34 = !{i32 1}
!35 = !{i32 2}
