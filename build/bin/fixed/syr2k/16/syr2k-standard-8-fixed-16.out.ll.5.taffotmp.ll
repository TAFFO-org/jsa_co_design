; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-8-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u4_28fixp, i32 8), !taffo.info !61, !taffo.constinfo !60
  ...
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u4_28fixp2, i32 8), !taffo.info !62, !taffo.constinfo !60
