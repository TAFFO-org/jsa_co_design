...
@.str = private unnamed_addr constant [49 x i8] c"target('A') scalar(range(0.1,8368.639648) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 121, i8* null)
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx7 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx, i32 0, i32 %8
  ...
  store float %9, float* %arrayidx9, align 4
  br label %for.inc
...
entry:
  ...
  call void @llvm.var.annotation(i8* %i1, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 33, i8* null)
  %j2 = bitcast i32* %j to i8*
  call void @llvm.var.annotation(i8* %j2, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 34, i8* null)
  store i32 0, i32* %i, align 4
  br label %for.cond
...
for.body12:                                       ; preds = %for.cond9
  ...
  %arrayidx13 = getelementptr inbounds [20 x float], [20 x float]* %14, i32 %15
  %16 = load i32, i32* %j, align 4
  %arrayidx14 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx13, i32 0, i32 %16
...
for.end17:                                        ; preds = %for.cond9
  ...
  %19 = load i32, i32* %i, align 4
  %arrayidx18 = getelementptr inbounds [20 x float], [20 x float]* %18, i32 %19
  %20 = load i32, i32* %i, align 4
  %arrayidx19 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx18, i32 0, i32 %20
...
for.end22:                                        ; preds = %for.cond
  %B23 = bitcast [20 x [20 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B23, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 49, i8* null)
...
for.body31:                                       ; preds = %for.cond28
  ...
  %arrayidx32 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %B, i32 0, i32 %26
  %27 = load i32, i32* %s, align 4
  %arrayidx33 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx32, i32 0, i32 %27
...
for.body51:                                       ; preds = %for.cond48
  ...
  %arrayidx56 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %B, i32 0, i32 %44
  %45 = load i32, i32* %s, align 4
  %arrayidx57 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx56, i32 0, i32 %45
  %46 = load float, float* %arrayidx57, align 4
  %add58 = fadd float %46, %mul
...
for.inc62:                                        ; preds = %for.end61
  ...
  br label %for.cond44, !llvm.loop !23
...
for.body75:                                       ; preds = %for.cond72
  ...
  %arrayidx76 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %B, i32 0, i32 %54
  %55 = load i32, i32* %s, align 4
  %arrayidx77 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx76, i32 0, i32 %55
  %56 = load float, float* %arrayidx77, align 4
  ...
  store float %56, float* %arrayidx79, align 4
  br label %for.inc80
...
for.body6:                                        ; preds = %for.cond4
  ...
  call void @llvm.var.annotation(i8* %tmp7, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 99, i8* null)
...
for.body25:                                       ; preds = %for.cond23
  %tmp2627 = bitcast float* %tmp26 to i8*
  call void @llvm.var.annotation(i8* %tmp2627, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 106, i8* null)
  ...
  %mul32 = fmul float %37, %41
  store float %mul32, float* %tmp26, align 4
  %42 = load float, float* %tmp26, align 4
  ...
  %sub35 = fsub float %46, %42
  store float %sub35, float* %arrayidx34, align 4
  br label %for.inc36
