; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-512-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.initweight !47, !taffo.info !32, !taffo.originalCall !49
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 512), !taffo.initweight !47, !taffo.info !34, !taffo.originalCall !49
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %4, i32 noundef 512), !taffo.initweight !51, !taffo.info !38, !taffo.originalCall !52
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %5, i32 noundef 512), !taffo.initweight !51, !taffo.info !40, !taffo.originalCall !52
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %6, i32 noundef 512), !taffo.initweight !51, !taffo.info !42, !taffo.originalCall !52
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %7, i32 noundef 512), !taffo.initweight !51, !taffo.info !44, !taffo.target !46, !taffo.originalCall !52
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %8, i32 noundef 512), !taffo.initweight !51, !taffo.info !36, !taffo.originalCall !52
...
!37 = !{double 0.000000e+00, double 0x4132733320000000}
!38 = !{i1 false, !39, i1 false, i2 -1}
!39 = !{double 0.000000e+00, double 4.480000e+02}
!40 = !{i1 false, !41, i1 false, i2 -1}
!41 = !{double 0.000000e+00, double 0x407CCCCCC0379314}
!42 = !{i1 false, !43, i1 false, i2 -1}
!43 = !{double 0.000000e+00, double 0x407DB6DB5FA22707}
!44 = !{i1 false, !45, i1 false, i2 -1}
!45 = !{double 0.000000e+00, double 0x41E32E6660000000}
!46 = !{!"D"}
!47 = !{i32 1}
