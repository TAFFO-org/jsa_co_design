; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-2-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.info !56, !taffo.initweight !60, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.info !63, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !50, !taffo.originalCall !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 2), !taffo.info !66, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !52, !taffo.originalCall !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 2), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 2), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !48, !taffo.initweight !88
  %0 = load float, float* %arrayidx, align 4, !taffo.info !89, !taffo.initweight !91
  %conv = sitofp i32 %factor to float, !taffo.info !92
  %mul = fmul float %0, %conv, !taffo.info !93, !taffo.initweight !95
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !48, !taffo.initweight !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !97 !taffo.sourceFunction !65 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !44, !taffo.initweight !88
  %0 = load float, float* %arrayidx, align 4, !taffo.info !98, !taffo.initweight !91
  %conv = sitofp i32 %factor to float, !taffo.info !100
  %mul = fmul float %0, %conv, !taffo.info !101, !taffo.initweight !95
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !44, !taffo.initweight !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_mvt.4(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !104 !taffo.funinfo !105 !taffo.sourceFunction !68 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !48, !taffo.initweight !88
  %0 = load float, float* %arrayidx, align 4, !taffo.info !48, !taffo.initweight !91
  %arrayidx4 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !44, !taffo.initweight !88
  %arrayidx5 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx4, i32 0, i32 %j.0, !taffo.info !44, !taffo.initweight !91
  %1 = load float, float* %arrayidx5, align 4, !taffo.info !98, !taffo.initweight !95
  %arrayidx6 = getelementptr inbounds float, float* %y_1, i32 %j.0, !taffo.info !44, !taffo.initweight !88
  %2 = load float, float* %arrayidx6, align 4, !taffo.info !98, !taffo.initweight !91
  %mul = fmul float %1, %2, !taffo.info !106, !taffo.initweight !95
  %add = fadd float %0, %mul, !taffo.info !108, !taffo.initweight !95
  %arrayidx7 = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !48, !taffo.initweight !88
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx17 = getelementptr inbounds float, float* %x2, i32 %i.1, !taffo.info !51, !taffo.initweight !88
  %3 = load float, float* %arrayidx17, align 4, !taffo.info !51, !taffo.initweight !91
  %arrayidx18 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %j.1, !taffo.info !44, !taffo.initweight !88
  %arrayidx19 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx18, i32 0, i32 %i.1, !taffo.info !44, !taffo.initweight !91
  %4 = load float, float* %arrayidx19, align 4, !taffo.info !98, !taffo.initweight !95
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %j.1, !taffo.info !44, !taffo.initweight !88
  %5 = load float, float* %arrayidx20, align 4, !taffo.info !98, !taffo.initweight !91
  %mul21 = fmul float %4, %5, !taffo.info !106, !taffo.initweight !95
  %add22 = fadd float %3, %mul21, !taffo.info !112, !taffo.initweight !95
  %arrayidx23 = getelementptr inbounds float, float* %x2, i32 %i.1, !taffo.info !51, !taffo.initweight !88
...
for.inc24:                                        ; preds = %for.body16
  ...
  br label %for.cond14, !llvm.loop !114
...
for.inc27:                                        ; preds = %for.end26
  ...
  br label %for.cond11, !llvm.loop !115
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !104 !taffo.funinfo !105 !taffo.sourceFunction !59 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc31, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc32, %for.inc31 ], !taffo.info !116, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !117, !taffo.initweight !57
  br i1 %cmp, label %for.body, label %for.end33, !taffo.info !118, !taffo.initweight !60

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.info !120, !taffo.initweight !57
  %conv = sitofp i32 %rem to float, !taffo.info !122, !taffo.initweight !60
  %conv3 = sitofp i32 %n to float, !taffo.info !123
  %div = fdiv float %conv, %conv3, !taffo.info !124, !taffo.initweight !127
  %arrayidx = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !128, !taffo.initweight !57
  store float %div, float* %arrayidx, align 4, !taffo.info !129, !taffo.initweight !60
  %add = add nsw i32 %i.0, 1, !taffo.info !130, !taffo.initweight !57, !taffo.constinfo !23
  %rem4 = srem i32 %add, %n, !taffo.info !120, !taffo.initweight !60
  %conv5 = sitofp i32 %rem4 to float, !taffo.info !122, !taffo.initweight !127
  %conv6 = sitofp i32 %n to float, !taffo.info !123
  %div7 = fdiv float %conv5, %conv6, !taffo.info !124, !taffo.initweight !88
  %arrayidx8 = getelementptr inbounds float, float* %x2, i32 %i.0, !taffo.info !131, !taffo.initweight !57
  store float %div7, float* %arrayidx8, align 4, !taffo.info !129, !taffo.initweight !60
  %add9 = add nsw i32 %i.0, 3, !taffo.info !132, !taffo.initweight !57, !taffo.constinfo !23
  %rem10 = srem i32 %add9, %n, !taffo.info !120, !taffo.initweight !60
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !122, !taffo.initweight !127
  %conv12 = sitofp i32 %n to float, !taffo.info !123
  %div13 = fdiv float %conv11, %conv12, !taffo.info !124, !taffo.initweight !88
  %arrayidx14 = getelementptr inbounds float, float* %y_1, i32 %i.0, !taffo.info !134, !taffo.initweight !57
  store float %div13, float* %arrayidx14, align 4, !taffo.info !129, !taffo.initweight !60
  %add15 = add nsw i32 %i.0, 4, !taffo.info !135, !taffo.initweight !57, !taffo.constinfo !23
  %rem16 = srem i32 %add15, %n, !taffo.info !120, !taffo.initweight !60
  %conv17 = sitofp i32 %rem16 to float, !taffo.info !122, !taffo.initweight !127
  %conv18 = sitofp i32 %n to float, !taffo.info !123
  %div19 = fdiv float %conv17, %conv18, !taffo.info !124, !taffo.initweight !88
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %i.0, !taffo.info !134, !taffo.initweight !57
  store float %div19, float* %arrayidx20, align 4, !taffo.info !129, !taffo.initweight !60
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !116, !taffo.initweight !47
  %cmp22 = icmp slt i32 %j.0, %n, !taffo.info !117, !taffo.initweight !57
  br i1 %cmp22, label %for.body24, label %for.end, !taffo.info !118, !taffo.initweight !60

for.body24:                                       ; preds = %for.cond21
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !137, !taffo.initweight !57
  %rem25 = srem i32 %mul, %n, !taffo.info !120, !taffo.initweight !60
  %conv26 = sitofp i32 %rem25 to float, !taffo.info !122, !taffo.initweight !127
  %conv27 = sitofp i32 %n to float, !taffo.info !123
  %div28 = fdiv float %conv26, %conv27, !taffo.info !124, !taffo.initweight !88
  %arrayidx29 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !134, !taffo.initweight !57
  %arrayidx30 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx29, i32 0, i32 %j.0, !taffo.info !134, !taffo.initweight !57
  store float %div28, float* %arrayidx30, align 4, !taffo.info !129, !taffo.initweight !60
  br label %for.inc

for.inc:                                          ; preds = %for.body24
  %inc = add nsw i32 %j.0, 1, !taffo.info !130, !taffo.initweight !57, !taffo.constinfo !23
...
for.inc31:                                        ; preds = %for.end
  %inc32 = add nsw i32 %i.0, 1, !taffo.info !130, !taffo.initweight !57, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !141 !taffo.funinfo !142 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !44, !taffo.initweight !95
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !98, !taffo.initweight !143
  %conv = sitofp i32 %factor to float, !taffo.info !100
  %mul = fmul float %1, %conv, !taffo.info !101, !taffo.initweight !144
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !44, !taffo.initweight !95
  store float %mul, float* %arrayidx6, align 4, !taffo.info !56, !taffo.initweight !143
  br label %for.inc
...
!87 = !{i32 1, !77, i32 1, !48, i32 1, !21}
!88 = !{i32 5}
!89 = !{!90, !1, i1 false, i2 -1}
!90 = !{!"fixp", i32 32, i32 26}
!91 = !{i32 6}
!92 = !{!45, !22, i1 false, i2 1}
!93 = !{!90, !94, i1 false, i2 -1}
!94 = !{double 0.000000e+00, double 0x40454CCCDD93C46E}
!95 = !{i32 7}
!96 = distinct !{!96, !25}
!97 = !{i32 1, !77, i32 1, !44, i32 1, !21}
!98 = !{!99, !46, i1 false, i2 -1}
!99 = !{!"fixp", i32 32, i32 29}
!100 = !{!99, !22, i1 false, i2 1}
!101 = !{!99, !102, i1 false, i2 -1}
!102 = !{double 0.000000e+00, double 3.800000e+00}
!103 = distinct !{!103, !25}
!104 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!105 = !{i32 1, !77, i32 1, !48, i32 1, !51, i32 1, !44, i32 1, !44, i32 1, !44}
!106 = !{!49, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 3.610000e+00}
!108 = !{!49, !109, i1 false, i2 -1}
!109 = !{double 0.000000e+00, double 0x4038E8F5D35653CA}
!110 = distinct !{!110, !25}
!111 = distinct !{!111, !25}
!112 = !{!49, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x4038828F7DB6E504}
!114 = distinct !{!114, !25}
!115 = distinct !{!115, !25}
!116 = !{i1 false, !70, i1 false, i2 1}
!117 = !{i1 false, !72, i1 false, i2 1}
!118 = !{i1 false, !119, i1 false, i2 1}
!119 = !{double 0.000000e+00, double 2.000000e+01}
!120 = !{i1 false, !121, i1 false, i2 1}
!121 = !{double 0.000000e+00, double 1.900000e+01}
!122 = !{!49, !121, i1 false, i2 1}
!123 = !{!49, !78, i1 false, i2 1}
!124 = !{!125, !126, i1 false, i2 1}
!125 = !{!"fixp", i32 32, i32 31}
!126 = !{double 0.000000e+00, double 0x3FEE666666666666}
!127 = !{i32 4}
!128 = !{!49, !1, i1 false, i2 1}
!129 = !{i1 false, i1 false, i1 false, i2 1}
!130 = !{i1 false, !74, i1 false, i2 1}
!131 = !{!49, !3, i1 false, i2 1}
...
!142 = !{i32 1, !77, i32 1, !77, i32 1, !44, i32 1, !21}
!143 = !{i32 8}
!144 = !{i32 9}
!145 = distinct !{!145, !25}
!146 = distinct !{!146, !25}
