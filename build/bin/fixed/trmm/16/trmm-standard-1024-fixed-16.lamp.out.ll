; ModuleID = './build/bin/fixed/trmm/16/trmm-standard-1024-fixed-16.out.ll'
...
for.body11:                                       ; preds = %for.cond9
  ...
  %1 = fdiv float %lampsim2, 5.120000e+02, !taffo.info !48, !taffo.target !50
...
for.body6:                                        ; preds = %for.cond4
  ...
  %lampsim1 = and i32 %lampsim, -256
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !45
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -256
  %lampsim5 = bitcast i32 %lampsim4 to float
  ...
  %3 = fdiv float %lampsim8, 5.120000e+02, !taffo.info !48
  ...
  %5 = fdiv float %lampsim18, 5.120000e+02, !taffo.info !48
  ...
  %6 = fmul float 5.120000e+02, %lampsim25, !taffo.info !93
  %lampsim26 = bitcast float %6 to i32
  %lampsim27 = and i32 %lampsim26, -256
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim1 = and i32 %lampsim, -256
  %lampsim2 = bitcast i32 %lampsim1 to float
  %2 = fdiv float %lampsim2, 5.120000e+02, !taffo.info !48
  ...
  %lampsim7 = and i32 %lampsim6, -256
  %lampsim8 = bitcast i32 %lampsim7 to float
  %4 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !155
  ...
  %6 = fmul float 5.120000e+02, %lampsim15, !taffo.info !90
