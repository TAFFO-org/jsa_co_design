...
@.str = private unnamed_addr constant [50 x i8] c"target('A') scalar(range(12.8,2566.399902) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay1, i32 noundef 128)
