; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-4-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [43 x i8] c"target('A') scalar(range(8.0,104.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [20 x i8] c"./sources/heat-3d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [31 x i8] c"scalar(range(8.0,104.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 4), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
  ...
  call void @scale_3d.4(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 4), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
for.body6:                                        ; preds = %for.cond4
  %0 = mul nuw i32 %m, %p, !taffo.info !165
  ...
  %mul = fmul float %3, %conv, !taffo.initweight !127, !taffo.info !167
  %4 = mul nuw i32 %m, %p, !taffo.info !165
...
for.inc:                                          ; preds = %for.body6
  %inc = add nsw i32 %k.0, 1, !taffo.info !103, !taffo.constinfo !27
  br label %for.cond4, !llvm.loop !172
...
!7 = !{double 0.000000e+00, double 1.040000e+02}
...
!50 = !{double 8.000000e+00, double 1.040000e+02}
!51 = !{i32 1}
!52 = !{i32 2}
...
!122 = !{double 1.600000e+01, double 2.080000e+02}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double -2.000000e+02, double 8.800000e+01}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double -1.920000e+02, double 1.920000e+02}
!127 = !{i32 10}
!128 = !{i1 false, !129, i1 false, i2 -1}
!129 = !{double -2.400000e+01, double 2.400000e+01}
!130 = !{i32 11}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -4.800000e+01, double 4.800000e+01}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -7.200000e+01, double 7.200000e+01}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -6.400000e+01, double 1.760000e+02}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
...
!164 = !{i32 1, !101, i32 1, !101, i32 1, !101, i32 1, !49, i32 1, !114}
!165 = !{i1 false, !166, i1 false, i2 0}
!166 = !{double 2.500000e+01, double 2.500000e+01}
!167 = !{i1 false, !168, i1 false, i2 -1}
!168 = !{double 3.200000e+01, double 4.160000e+02}
!169 = distinct !{!169, !29}
!170 = distinct !{!170, !29}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
