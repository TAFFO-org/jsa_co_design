; ModuleID = './build/bin/fixed/jacobi-1d/16/jacobi-1d-standard-512-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 512), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 512), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
!47 = !{double 0x40599999A1FD156A, double 0x408222222036006D}
...
!85 = !{double 0x40E111111F0C34C2, double 0x411111112018A43C}
!86 = !{i32 7}
!87 = distinct !{!87, !23}
...
!97 = !{double 0x406111111F0C34C2, double 0x409111112018A43C}
!98 = !{!95, !99, i1 false, i2 -1}
!99 = !{double 0x40699999AE924F23, double 0x40999999B024F65A}
!100 = !{i32 8}
!101 = !{!95, !102, i1 false, i2 -1}
!102 = !{double 0x40511105EFBC6B1F, double 0x40811105F0C8D9E9}
!103 = !{i32 9}
!104 = !{!105, i1 false}
!105 = !{i1 false, !106, i1 false, i2 0}
!106 = !{double 3.333300e-01, double 3.333300e-01}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x40511105E0000000, double 0x4081110600000000}
!109 = !{i32 10}
!110 = distinct !{!110, !23}
!111 = !{!95, !47, i1 false, i2 -1}
!112 = !{!95, !113, i1 false, i2 -1}
!113 = !{double 0x40699999A1FD156A, double 0x409222222036006D}
!114 = !{!95, !115, i1 false, i2 -1}
!115 = !{double 0x40733333397DD010, double 0x409B3333305100A4}
!116 = !{!95, !117, i1 false, i2 -1}
!117 = !{double 0x40599988DB056F36, double 0x408222163DF1452F}
!118 = !{!42, !119, i1 false, i2 -1}
!119 = !{double 0x40599988C0000000, double 0x4082221640000000}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
