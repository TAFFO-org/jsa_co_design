; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-8-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7_fixp(i32 12, i32 10, i32* %u4_28fixp, i32 8), !taffo.info !67, !taffo.constinfo !66
  %arraydecay14.u4_28fixp = getelementptr inbounds [10 x [14 x i32]], [10 x [14 x i32]]* %C.u4_28fixp, i32 0, i32 0, !taffo.info !56
  %u4_28fixp2 = bitcast [14 x i32]* %arraydecay14.u4_28fixp to i32*, !taffo.info !56
  call void @scale_2d.7_fixp(i32 10, i32 14, i32* %u4_28fixp2, i32 8), !taffo.info !68, !taffo.constinfo !66
  ...
  %u2_30fixp = load i32, i32* %alpha.u2_30fixp, align 4, !taffo.info !72
  ...
  %0 = lshr i32 %u2_30fixp, 2, !taffo.info !72
  call void @kernel_2mm.3_fixp(i32 8, i32 10, i32 12, i32 14, i32 %0, i32 %u2_30fixp1, [10 x i32]* %arraydecay17.u9_23fixp, [12 x i32]* %arraydecay18.u3_29fixp, [10 x i32]* %arraydecay19.u4_28fixp, [14 x i32]* %arraydecay20.u4_28fixp, [14 x i32]* %arraydecay21.u14_18fixp), !taffo.info !61, !taffo.constinfo !62
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !211 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u4_28fixp = load i32, i32* %arrayidx4.u4_28fixp, align 4, !taffo.info !213
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !215
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !213
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !215
  %3 = ashr i32 %1, 2, !taffo.info !213
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !216
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !219
  ...
  %6 = shl i32 %mul.u6_26fixp, 2, !taffo.info !219
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !222 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 14), !taffo.info !223
  %mul.u17_15fixp = shl i32 %5, 1, !taffo.info !226
  ...
  %7 = shl i32 %mul.u17_15fixp, 3, !taffo.info !226
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !230 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !231
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !234
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u12_20fixp, 3, !taffo.info !234
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !238 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = shl i32 %mul.u6_26fixp, 3, !taffo.info !241
...
!211 = !{i32 1, !102, i32 1, !16, i32 1, !53, i32 1, !87}
!212 = !{void (i32, i32, float*, i32)* @scale_2d}
!213 = !{!214, !55, i1 false, i2 -1}
!214 = !{!"fixp", i32 32, i32 26}
!215 = !{!214, !88, i1 false, i2 1}
!216 = !{!217, !218, i1 false, i2 -1}
!217 = !{!"fixp", i32 -32, i32 25}
!218 = !{double 0.000000e+00, double 5.760000e+01}
!219 = !{!214, !218, i1 false, i2 -1}
!220 = distinct !{!220, !23}
!221 = distinct !{!221, !23}
!222 = !{i32 1, !87, i32 1, !89, i32 1, !58, i32 1, !87}
!223 = !{!224, !225, i1 false, i2 -1}
!224 = !{!"fixp", i32 -32, i32 14}
!225 = !{double 0.000000e+00, double 0x40F32E6660029F17}
!226 = !{!227, !225, i1 false, i2 -1}
!227 = !{!"fixp", i32 32, i32 15}
!228 = distinct !{!228, !23}
!229 = distinct !{!229, !23}
!230 = !{i32 1, !87, i32 1, !16, i32 1, !47, i32 1, !87}
!231 = !{!232, !233, i1 false, i2 -1}
!232 = !{!"fixp", i32 -32, i32 19}
!233 = !{double 0.000000e+00, double 0x40A2733320535C9E}
!234 = !{!235, !233, i1 false, i2 -1}
!235 = !{!"fixp", i32 32, i32 20}
!236 = distinct !{!236, !23}
!237 = distinct !{!237, !23}
!238 = !{i32 1, !87, i32 1, !102, i32 1, !50, i32 1, !87}
!239 = !{!217, !240, i1 false, i2 -1}
!240 = !{double 0.000000e+00, double 5.600000e+01}
