; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-128-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.info !58, !taffo.initweight !55, !taffo.constinfo !61, !taffo.originalCall !62
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 128), !taffo.info !63, !taffo.initweight !55, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 128), !taffo.info !65, !taffo.initweight !66, !taffo.constinfo !67, !taffo.target !50, !taffo.originalCall !68
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 128), !taffo.info !69, !taffo.initweight !66, !taffo.constinfo !67, !taffo.originalCall !68
...
!94 = !{double 1.280000e+02, double 1.280000e+02}
...
!101 = !{double 0.000000e+00, double 0x40FEFF4380000000}
!102 = distinct !{!102, !23}
!103 = !{!104, !53, i1 false, i2 -1}
!104 = !{!"fixp", i32 32, i32 24}
!105 = !{!104, !106, i1 false, i2 -1}
!106 = !{double 0.000000e+00, double 1.800000e+02}
!107 = !{!49, !108, i1 false, i2 -1}
!108 = !{double 0.000000e+00, double 2.160000e+04}
!109 = !{!49, !110, i1 false, i2 -1}
!110 = !{double 0.000000e+00, double 0x40FF1AB840000000}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
...
!164 = !{!"fixp", i32 32, i32 8}
!165 = !{double 0.000000e+00, double 0x4169D4B840000000}
!166 = !{i32 9}
!167 = distinct !{!167, !23}
!168 = distinct !{!168, !23}
!169 = !{i32 1, !82, i32 1, !16, i32 1, !51, i32 1, !93}
!170 = !{!171, !172, i1 false, i2 -1}
!171 = !{!"fixp", i32 32, i32 18}
!172 = !{double 0.000000e+00, double 1.536000e+04}
!173 = distinct !{!173, !23}
!174 = distinct !{!174, !23}
