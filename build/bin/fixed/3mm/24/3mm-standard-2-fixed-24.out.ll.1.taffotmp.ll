...
entry:
  ...
  call void @llvm.var.annotation(i8* %B3, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 145, i8* null)
  ...
  call void @llvm.var.annotation(i8* %G7, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 149, i8* null)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, float* noundef %5, i32 noundef 2)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 10, float* noundef %6, i32 noundef 2)
  %arraydecay16 = getelementptr inbounds [10 x [8 x float]], [10 x [8 x float]]* %B, i32 0, i32 0
  %7 = bitcast [8 x float]* %arraydecay16 to float*
  call void @scale_2d(i32 noundef 10, i32 noundef 8, float* noundef %7, i32 noundef 2)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 12, float* noundef %8, i32 noundef 2)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 14, float* noundef %9, i32 noundef 2)
  ...
  call void @scale_2d(i32 noundef 14, i32 noundef 12, float* noundef %10, i32 noundef 2)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 12, float* noundef %11, i32 noundef 2)
