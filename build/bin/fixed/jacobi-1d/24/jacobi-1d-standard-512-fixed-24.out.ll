; ModuleID = './build/bin/fixed/jacobi-1d/24/jacobi-1d-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  %A.u10_22fixp = alloca [15 x i32], align 4, !taffo.info !41, !taffo.target !44
  %B.u10_22fixp = alloca [15 x i32], align 4, !taffo.info !45
  %arraydecay.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u10_22fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %arraydecay3.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u10_22fixp, i32 0, i32 0, !taffo.info !45
  call void @init_array.4_fixp(i32 15, i32* %arraydecay.u10_22fixp, i32* %arraydecay3.u10_22fixp), !taffo.info !47, !taffo.constinfo !48, !taffo.target !44
  %arraydecay4.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u10_22fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  call void @scale_1d.1_fixp(i32 15, i32* %arraydecay4.u10_22fixp, i32 512), !taffo.info !47, !taffo.constinfo !48, !taffo.target !44
  %arraydecay5.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u10_22fixp, i32 0, i32 0, !taffo.info !45
  call void @scale_1d.1_fixp(i32 15, i32* %arraydecay5.u10_22fixp, i32 512), !taffo.info !49, !taffo.constinfo !48
  call void @timer_start(), !taffo.constinfo !50
  %arraydecay6.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u10_22fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %arraydecay7.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u10_22fixp, i32 0, i32 0, !taffo.info !45
  call void @kernel_jacobi_1d.2_fixp(i32 10, i32 15, i32* %arraydecay6.u10_22fixp, i32* %arraydecay7.u10_22fixp), !taffo.info !47, !taffo.constinfo !51, !taffo.target !44
...
for.body:                                         ; preds = %for.cond
  %arrayidx.u10_22fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u10_22fixp, i32 0, i32 %i.0, !taffo.info !41, !taffo.target !44
  %u10_22fixp = load i32, i32* %arrayidx.u10_22fixp, align 4, !taffo.info !41, !taffo.target !44
  %0 = uitofp i32 %u10_22fixp to float, !taffo.info !41, !taffo.target !44
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !68 !taffo.funinfo !69 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.u10_22fixp = getelementptr inbounds i32, i32* %val.u10_22fixp, i32 %i.0, !taffo.info !41
  %u10_22fixp = load i32, i32* %arrayidx.u10_22fixp, align 4, !taffo.info !41
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !73
  %0 = lshr i32 %u10_22fixp, 1, !taffo.info !41
  %1 = lshr i32 %conv.u10_22fixp, 1, !taffo.info !73
  %2 = ashr i32 %0, 9, !taffo.info !41
  %3 = ashr i32 %1, 9, !taffo.info !73
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !74
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !77
  %arrayidx1.u10_22fixp = getelementptr inbounds i32, i32* %val.u10_22fixp, i32 %i.0, !taffo.info !41
  %5 = shl i32 %mul.u19_13fixp, 9, !taffo.info !77
  store i32 %5, i32* %arrayidx1.u10_22fixp, align 4, !taffo.info !47
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_1d.2_fixp(i32 noundef %tsteps, i32 noundef %n, i32* noundef %A.u10_22fixp, i32* noundef %B.u10_22fixp) #0 !taffo.initweight !80 !taffo.funinfo !81 !taffo.sourceFunction !82 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds i32, i32* %A.u10_22fixp, i32 %sub4, !taffo.info !41
  %u10_22fixp = load i32, i32* %arrayidx.u10_22fixp, align 4, !taffo.info !87
  %arrayidx5.u10_22fixp = getelementptr inbounds i32, i32* %A.u10_22fixp, i32 %i.0, !taffo.info !41
  %u10_22fixp1 = load i32, i32* %arrayidx5.u10_22fixp, align 4, !taffo.info !87
  %0 = lshr i32 %u10_22fixp, 1, !taffo.info !87
  %1 = lshr i32 %u10_22fixp1, 1, !taffo.info !87
  %add.u11_21fixp = add i32 %0, %1, !taffo.info !89
  %add6 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx7.u10_22fixp = getelementptr inbounds i32, i32* %A.u10_22fixp, i32 %add6, !taffo.info !41
  %u10_22fixp2 = load i32, i32* %arrayidx7.u10_22fixp, align 4, !taffo.info !87
  %2 = lshr i32 %u10_22fixp2, 1, !taffo.info !87
  %add8.u11_21fixp = add i32 %add.u11_21fixp, %2, !taffo.info !91
  %3 = lshr i32 715820724, 1
  %4 = lshr i32 %add8.u11_21fixp, 1, !taffo.info !91
  %5 = ashr i32 %3, 10
  %6 = call i32 @llvm.smul.fix.i32(i32 %5, i32 %4, i32 20), !taffo.info !93
  %mul.u11_21fixp = shl i32 %6, 1, !taffo.info !96, !taffo.constinfo !97
  %conv9.u10_22fixp = shl i32 %mul.u11_21fixp, 1, !taffo.info !100, !taffo.constinfo !97
  %arrayidx10.u10_22fixp = getelementptr inbounds i32, i32* %B.u10_22fixp, i32 %i.0, !taffo.info !45
  store i32 %conv9.u10_22fixp, i32* %arrayidx10.u10_22fixp, align 4, !taffo.info !49
  br label %for.inc
...
for.body15:                                       ; preds = %for.cond11
  ...
  %arrayidx17.u10_22fixp = getelementptr inbounds i32, i32* %B.u10_22fixp, i32 %sub16, !taffo.info !45
  %u10_22fixp3 = load i32, i32* %arrayidx17.u10_22fixp, align 4, !taffo.info !103
  %arrayidx18.u10_22fixp = getelementptr inbounds i32, i32* %B.u10_22fixp, i32 %i.1, !taffo.info !45
  %u10_22fixp4 = load i32, i32* %arrayidx18.u10_22fixp, align 4, !taffo.info !103
  %7 = lshr i32 %u10_22fixp3, 1, !taffo.info !103
  %8 = lshr i32 %u10_22fixp4, 1, !taffo.info !103
  %add19.u11_21fixp = add i32 %7, %8, !taffo.info !104
  %add20 = add nsw i32 %i.1, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx21.u10_22fixp = getelementptr inbounds i32, i32* %B.u10_22fixp, i32 %add20, !taffo.info !45
  %u10_22fixp5 = load i32, i32* %arrayidx21.u10_22fixp, align 4, !taffo.info !103
  %9 = lshr i32 %u10_22fixp5, 1, !taffo.info !103
  %add22.u11_21fixp = add i32 %add19.u11_21fixp, %9, !taffo.info !106
  %10 = lshr i32 715820724, 1
  %11 = lshr i32 %add22.u11_21fixp, 1, !taffo.info !106
  %12 = ashr i32 %10, 10
  %13 = call i32 @llvm.smul.fix.i32(i32 %12, i32 %11, i32 20), !taffo.info !108
  %mul24.u11_21fixp = shl i32 %13, 1, !taffo.info !110, !taffo.constinfo !97
  %conv25.u10_22fixp = shl i32 %mul24.u11_21fixp, 1, !taffo.info !111, !taffo.constinfo !97
  %arrayidx26.u10_22fixp = getelementptr inbounds i32, i32* %A.u10_22fixp, i32 %i.1, !taffo.info !41
  store i32 %conv25.u10_22fixp, i32* %arrayidx26.u10_22fixp, align 4, !taffo.info !47
  br label %for.inc27
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32* noundef %A.u10_22fixp, i32* noundef %B.u10_22fixp) #0 !taffo.initweight !115 !taffo.funinfo !116 !taffo.sourceFunction !117 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds i32, i32* %A.u10_22fixp, i32 %i.0, !taffo.info !134
  %3 = ashr i32 %div.s5_27fixp, 5, !taffo.info !133
  store i32 %3, i32* %arrayidx.u10_22fixp, align 4, !taffo.info !135
  ...
  %arrayidx7.u10_22fixp = getelementptr inbounds i32, i32* %B.u10_22fixp, i32 %i.0, !taffo.info !144
  %7 = ashr i32 %div6.s5_27fixp, 5, !taffo.info !143
  store i32 %7, i32* %arrayidx7.u10_22fixp, align 4, !taffo.info !135
  br label %for.inc
...
!1 = !{double 0.000000e+00, double 0x408111112018A43C}
...
!43 = !{double 0x405111111F0C34C2, double 0x408111112018A43C}
!44 = !{!"A"}
!45 = !{!42, !46, i1 false, i2 -1}
!46 = !{double 0x40599999A1FD156A, double 0x408222222036006D}
...
!71 = !{double 5.120000e+02, double 5.120000e+02}
!72 = !{void (i32, float*, i32)* @scale_1d}
!73 = !{!42, !71, i1 false, i2 1}
!74 = !{!75, !76, i1 false, i2 -1}
!75 = !{!"fixp", i32 -32, i32 12}
!76 = !{double 0x40E111111F0C34C2, double 0x411111112018A43C}
!77 = !{!78, !76, i1 false, i2 -1}
!78 = !{!"fixp", i32 32, i32 13}
!79 = distinct !{!79, !23}
...
!90 = !{double 0x406111111F0C34C2, double 0x409111112018A43C}
!91 = !{!88, !92, i1 false, i2 -1}
!92 = !{double 0x40699999AE924F23, double 0x40999999B024F65A}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 20}
!95 = !{double 0x40511105EFBC6B1F, double 0x40811105F0C8D9E9}
!96 = !{!88, !95, i1 false, i2 -1}
!97 = !{!98, i1 false}
!98 = !{i1 false, !99, i1 false, i2 0}
!99 = !{double 3.333300e-01, double 3.333300e-01}
!100 = !{!42, !101, i1 false, i2 -1}
!101 = !{double 0x40511105E0000000, double 0x4081110600000000}
!102 = distinct !{!102, !23}
!103 = !{!88, !46, i1 false, i2 -1}
!104 = !{!88, !105, i1 false, i2 -1}
!105 = !{double 0x40699999A1FD156A, double 0x409222222036006D}
!106 = !{!88, !107, i1 false, i2 -1}
!107 = !{double 0x40733333397DD010, double 0x409B3333305100A4}
!108 = !{!94, !109, i1 false, i2 -1}
!109 = !{double 0x40599988DB056F36, double 0x408222163DF1452F}
!110 = !{!88, !109, i1 false, i2 -1}
!111 = !{!42, !112, i1 false, i2 -1}
!112 = !{double 0x40599988C0000000, double 0x4082221640000000}
!113 = distinct !{!113, !23}
!114 = distinct !{!114, !23}
