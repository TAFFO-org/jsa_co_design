...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function scale_1d.8_fixp
.LCPI10_0:
	.long	0x44000000                      # float 512
.LCPI10_1:
...
.LBB10_4:                               # %for.end
	...
	retl
.Lfunc_end10:
	.size	scale_1d.8_fixp, .Lfunc_end10-scale_1d.8_fixp
	.cfi_endproc
                                        # -- End function
...
.LBB11_4:                               # %for.end
	...
	retl
.Lfunc_end11:
	.size	scale_1d.4_fixp, .Lfunc_end11-scale_1d.4_fixp
	.cfi_endproc
                                        # -- End function
...
.LBB12_4:                               # %for.end
	...
	retl
.Lfunc_end12:
	.size	scale_1d.11_fixp, .Lfunc_end12-scale_1d.11_fixp
	.cfi_endproc
                                        # -- End function
...
.LBB13_4:                               # %for.end
	...
	retl
.Lfunc_end13:
	.size	scale_1d.3_fixp, .Lfunc_end13-scale_1d.3_fixp
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
...
.L14$pb:
	popl	%eax
.Ltmp4:
	addl	$_GLOBAL_OFFSET_TABLE_+(.Ltmp4-.L14$pb), %eax
	movl	%eax, -36(%ebp)                 # 4-byte Spill
	movl	16(%ebp), %eax
	movl	%eax, -32(%ebp)                 # 4-byte Spill
	movl	12(%ebp), %eax
...
.LBB15_4:                               # %for.end
	...
	retl
.Lfunc_end15:
	.size	scale_1d.6_fixp, .Lfunc_end15-scale_1d.6_fixp
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
...
.L16$pb:
	popl	%eax
.Ltmp5:
	addl	$_GLOBAL_OFFSET_TABLE_+(.Ltmp5-.L16$pb), %eax
...
.L17$pb:
	popl	%eax
.Ltmp6:
	addl	$_GLOBAL_OFFSET_TABLE_+(.Ltmp6-.L17$pb), %eax
	movl	%eax, -64(%ebp)                 # 4-byte Spill
	movl	52(%ebp), %eax
	movl	%eax, -60(%ebp)                 # 4-byte Spill
	movl	48(%ebp), %eax
