...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,977.454529) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/bicg.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [47 x i8] c"target('s') scalar(range(0.0,7173213.5) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [47 x i8] c"target('q') scalar(range(0.0,6339118.5) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %s2, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  ...
  call void @scale_2d(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 1024)
  ...
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 1024)
  ...
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 1024)
