; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-2-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 2), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 2), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !93, !taffo.initweight !98
  %conv = sitofp i32 %factor to float, !taffo.info !172
  %mul = fmul float %1, %conv, !taffo.info !174, !taffo.initweight !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !177 !taffo.sourceFunction !58 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !115, !taffo.initweight !98
  %conv = sitofp i32 %factor to float, !taffo.info !172
  %mul = fmul float %1, %conv, !taffo.info !116, !taffo.initweight !109
  %2 = mul nsw i32 %i.0, %m, !taffo.info !81
...
!48 = !{double 4.000000e-01, double 0x404011111F0C34C2}
...
!97 = !{double 5.333340e-01, double 0x404E22221C8A7A42}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x3FE9999BB2788DB0, double 0x405699999567DBB2}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 24}
!104 = !{double 0x3FF1111276FB0920, double 0x405E22221C8A7A42}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x3FF5555714B9CB68, double 0x4062D55551D68C69}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x3FD111127B3F4DBE, double 0x403E2222241302C9}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 8.000000e-01, double 0x405011111F0C34C2}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x3FF3333333333334, double 0x40581999AE924F23}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 1.600000e+00, double 0x406011111F0C34C2}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 2.000000e+00, double 0x4064155566CF41F2}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x3FD99999A0000000, double 0x4040111123107909}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!171 = !{i32 1, !77, i32 1, !77, i32 1, !41, i32 1, !19}
!172 = !{!173, !20, i1 false, i2 1}
!173 = !{!"fixp", i32 32, i32 30}
!174 = !{!47, !97, i1 false, i2 -1}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = !{i32 1, !77, i32 1, !77, i32 1, !46, i32 1, !19}
!178 = distinct !{!178, !23}
!179 = distinct !{!179, !23}
