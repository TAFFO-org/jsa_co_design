...
entry:
  ...
  call void @llvm.var.annotation(i8* %u14, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 156, i8* null)
  ...
  call void @llvm.var.annotation(i8* %w8, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 160, i8* null)
  ...
  call void @llvm.var.annotation(i8* %y10, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 162, i8* null)
  ...
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 64)
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 64)
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 64)
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 64)
  %arraydecay25 = getelementptr inbounds [20 x float], [20 x float]* %w, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 64)
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 64)
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 64)
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 64)
