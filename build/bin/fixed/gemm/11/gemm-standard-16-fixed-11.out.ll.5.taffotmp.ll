; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-16-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u4_28fixp2, i32 16), !taffo.info !61, !taffo.constinfo !60
  ...
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u4_28fixp, i32 16), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [12 x i32]* %arraydecay11.u11_21fixp, [16 x i32]* %arraydecay12.u4_28fixp, [12 x i32]* %arraydecay13.u4_28fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !172 !taffo.sourceFunction !173 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 16), !taffo.info !174
  %mul.u15_17fixp = shl i32 %5, 1, !taffo.info !177
  ...
  %7 = shl i32 %mul.u15_17fixp, 4, !taffo.info !177
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !181 !taffo.sourceFunction !173 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 23), !taffo.info !182
  %mul.u8_24fixp = shl i32 %5, 1, !taffo.info !185
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u8_24fixp, 4, !taffo.info !185
...
!172 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
...
!178 = !{!"fixp", i32 32, i32 17}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !16, i32 1, !88, i32 1, !50, i32 1, !88}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 -32, i32 23}
!184 = !{double 0.000000e+00, double 2.400000e+02}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 24}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
