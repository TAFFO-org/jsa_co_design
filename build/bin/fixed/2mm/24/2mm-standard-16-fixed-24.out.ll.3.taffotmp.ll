; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-16-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,1180.799927) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,14.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,14.4) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,14.857142) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [50 x i8] c"target('D') scalar(range(0.0,78566.398438) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !66, !taffo.constinfo !67
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 16), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 16), !taffo.initweight !69, !taffo.info !55, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 16), !taffo.initweight !69, !taffo.info !57, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 16), !taffo.initweight !69, !taffo.info !59, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 16), !taffo.initweight !69, !taffo.info !61, !taffo.target !62, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 16), !taffo.initweight !69, !taffo.info !53, !taffo.originalCall !70, !taffo.constinfo !71
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !55
  %cmp4 = icmp slt i32 %j.0, %nk, !taffo.initweight !68, !taffo.info !55
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !69, !taffo.info !55
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv = sitofp i32 %rem to float, !taffo.initweight !98, !taffo.info !96
  %conv6 = sitofp i32 %ni to float
  %div = fdiv float %conv, %conv6, !taffo.initweight !99, !taffo.info !96
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %A, i32 %i.0, !taffo.initweight !68, !taffo.info !100
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !68, !taffo.info !100
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  %j.1 = phi i32 [ 0, %for.body14 ], [ %inc28, %for.inc27 ], !taffo.initweight !48, !taffo.info !55
  %cmp16 = icmp slt i32 %j.1, %nj, !taffo.initweight !68, !taffo.info !55
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.initweight !69, !taffo.info !55

for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
  ...
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !98, !taffo.info !96
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.1, !taffo.initweight !68, !taffo.info !100
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.initweight !68, !taffo.info !100
  store float %div24, float* %arrayidx26, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
  br label %for.cond15, !llvm.loop !103
...
for.cond37:                                       ; preds = %for.inc50, %for.body36
  %j.2 = phi i32 [ 0, %for.body36 ], [ %inc51, %for.inc50 ], !taffo.initweight !48, !taffo.info !55
  %cmp38 = icmp slt i32 %j.2, %nl, !taffo.initweight !68, !taffo.info !55
  br i1 %cmp38, label %for.body40, label %for.end52, !taffo.initweight !69, !taffo.info !55

for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 3, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
  ...
  %conv45 = sitofp i32 %rem44 to float, !taffo.initweight !98, !taffo.info !96
  %conv46 = sitofp i32 %nl to float
  %div47 = fdiv float %conv45, %conv46, !taffo.initweight !99, !taffo.info !96
  %arrayidx48 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %i.2, !taffo.initweight !68, !taffo.info !100
  %arrayidx49 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx48, i32 0, i32 %j.2, !taffo.initweight !68, !taffo.info !100
  store float %div47, float* %arrayidx49, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc50

for.inc50:                                        ; preds = %for.body40
  %inc51 = add nsw i32 %j.2, 1, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
  br label %for.cond37, !llvm.loop !105
...
for.cond60:                                       ; preds = %for.inc72, %for.body59
  %j.3 = phi i32 [ 0, %for.body59 ], [ %inc73, %for.inc72 ], !taffo.initweight !48, !taffo.info !55
  %cmp61 = icmp slt i32 %j.3, %nl, !taffo.initweight !68, !taffo.info !55
  br i1 %cmp61, label %for.body63, label %for.end74, !taffo.initweight !69, !taffo.info !55

for.body63:                                       ; preds = %for.cond60
  %add64 = add nsw i32 %j.3, 2, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
  ...
  %div69 = fdiv float %conv67, %conv68, !taffo.initweight !98, !taffo.info !96
  %arrayidx70 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.3, !taffo.initweight !68, !taffo.info !100
  %arrayidx71 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx70, i32 0, i32 %j.3, !taffo.initweight !68, !taffo.info !100
  store float %div69, float* %arrayidx71, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc72

for.inc72:                                        ; preds = %for.body63
  %inc73 = add nsw i32 %j.3, 1, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
...
for.inc75:                                        ; preds = %for.end74
  ...
  br label %for.cond56, !llvm.loop !108
...
for.cond82:                                       ; preds = %for.inc88, %for.body81
  %j.4 = phi i32 [ 0, %for.body81 ], [ %inc89, %for.inc88 ], !taffo.initweight !48, !taffo.info !55
  %cmp83 = icmp slt i32 %j.4, %nj, !taffo.initweight !68, !taffo.info !55
  br i1 %cmp83, label %for.body85, label %for.end90, !taffo.initweight !69, !taffo.info !55

for.body85:                                       ; preds = %for.cond82
  %arrayidx86 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.4, !taffo.initweight !68, !taffo.info !100
  %arrayidx87 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx86, i32 0, i32 %j.4, !taffo.initweight !68, !taffo.info !100
  store float 0.000000e+00, float* %arrayidx87, align 4, !taffo.initweight !69, !taffo.info !100, !taffo.constinfo !109
  br label %for.inc88

for.inc88:                                        ; preds = %for.body85
  %inc89 = add nsw i32 %j.4, 1, !taffo.initweight !68, !taffo.info !55, !taffo.constinfo !27
  br label %for.cond82, !llvm.loop !112
...
for.inc91:                                        ; preds = %for.end90
  ...
  br label %for.cond78, !llvm.loop !113
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_2mm(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, float noundef %alpha, float noundef %beta, [10 x float]* noundef %tmp, [12 x float]* noundef %A, [10 x float]* noundef %B, [14 x float]* noundef %C, [14 x float]* noundef %D) #0 !taffo.initweight !88 !taffo.funinfo !89 !taffo.equivalentChild !114 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !98, !taffo.info !100, !taffo.constinfo !109
  br label %for.cond5
...
for.inc41:                                        ; preds = %for.body32
  ...
  br label %for.cond30, !llvm.loop !118
...
for.inc44:                                        ; preds = %for.end43
  ...
  br label %for.cond24, !llvm.loop !119
...
; Function Attrs: noinline nounwind uwtable
define internal void @print_array(i32 noundef %ni, i32 noundef %nl, [14 x float]* noundef %D) #0 !taffo.initweight !33 !taffo.funinfo !121 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc7, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc8, %for.inc7 ], !taffo.info !76
  %cmp = icmp slt i32 %i.0, %ni, !taffo.info !126
  br i1 %cmp, label %for.body, label %for.end9
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %cmp2 = icmp slt i32 %j.0, %nl, !taffo.info !126
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %mul = mul nsw i32 %i.0, %ni, !taffo.info !110
  %add = add nsw i32 %mul, %j.0, !taffo.info !110
  %rem = srem i32 %add, 20, !taffo.info !110, !taffo.constinfo !27
  %cmp4 = icmp eq i32 %rem, 0, !taffo.info !126
...
for.inc:                                          ; preds = %if.end
  %inc = add nsw i32 %j.0, 1, !taffo.info !126, !taffo.constinfo !27
...
for.inc7:                                         ; preds = %for.end
  %inc8 = add nsw i32 %i.0, 1, !taffo.info !126, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.1(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !130 !taffo.funinfo !131 !taffo.sourceFunction !66 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !130 !taffo.funinfo !134 !taffo.sourceFunction !66 {
entry:
  ret void
}
...
for.cond1:                                        ; preds = %for.inc15, %for.body
  ...
  %cmp2 = icmp slt i32 %j.0, %nj, !taffo.info !126
  br i1 %cmp2, label %for.body3, label %for.end17

for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.0, !taffo.initweight !98, !taffo.info !53
  %arrayidx4 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !99, !taffo.info !53
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !98, !taffo.info !100, !taffo.constinfo !109
  br label %for.cond5

for.cond5:                                        ; preds = %for.inc, %for.body3
  %k.0 = phi i32 [ 0, %for.body3 ], [ %inc, %for.inc ], !taffo.info !76
  %cmp6 = icmp slt i32 %k.0, %nk, !taffo.info !126
  br i1 %cmp6, label %for.body7, label %for.end

for.body7:                                        ; preds = %for.cond5
  %arrayidx8 = getelementptr inbounds [12 x float], [12 x float]* %A, i32 %i.0, !taffo.initweight !98, !taffo.info !55
  %arrayidx9 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx8, i32 0, i32 %k.0, !taffo.initweight !99, !taffo.info !55
  %0 = load float, float* %arrayidx9, align 4, !taffo.initweight !139, !taffo.info !55
  %mul = fmul float %alpha, %0, !taffo.initweight !98, !taffo.info !140
  %arrayidx10 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %k.0, !taffo.initweight !98, !taffo.info !57
  %arrayidx11 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx10, i32 0, i32 %j.0, !taffo.initweight !99, !taffo.info !57
  %1 = load float, float* %arrayidx11, align 4, !taffo.initweight !139, !taffo.info !57
  %mul12 = fmul float %mul, %1, !taffo.initweight !99, !taffo.info !142
  %arrayidx13 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.0, !taffo.initweight !98, !taffo.info !53
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.initweight !99, !taffo.info !53
...
for.inc:                                          ; preds = %for.body7
  %inc = add nsw i32 %k.0, 1, !taffo.info !126, !taffo.constinfo !27
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %j.0, 1, !taffo.info !126, !taffo.constinfo !27
...
for.inc18:                                        ; preds = %for.end17
  %inc19 = add nsw i32 %i.0, 1, !taffo.info !126, !taffo.constinfo !27
...
for.cond21:                                       ; preds = %for.inc47, %for.end20
  ...
  %cmp22 = icmp slt i32 %i.1, %ni, !taffo.info !126
  br i1 %cmp22, label %for.body23, label %for.end49
...
for.cond24:                                       ; preds = %for.inc44, %for.body23
  ...
  %cmp25 = icmp slt i32 %j.1, %nl, !taffo.info !126
  br i1 %cmp25, label %for.body26, label %for.end46

for.body26:                                       ; preds = %for.cond24
  %arrayidx27 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.1, !taffo.initweight !98, !taffo.info !61
  %arrayidx28 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx27, i32 0, i32 %j.1, !taffo.initweight !99, !taffo.info !61
  %3 = load float, float* %arrayidx28, align 4, !taffo.initweight !139, !taffo.info !61
  %mul29 = fmul float %3, %beta, !taffo.initweight !98, !taffo.info !149
  store float %mul29, float* %arrayidx28, align 4, !taffo.initweight !99, !taffo.info !51
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc41, %for.body26
  %k.1 = phi i32 [ 0, %for.body26 ], [ %inc42, %for.inc41 ], !taffo.info !76
  %cmp31 = icmp slt i32 %k.1, %nj, !taffo.info !126
  br i1 %cmp31, label %for.body32, label %for.end43

for.body32:                                       ; preds = %for.cond30
  %arrayidx33 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.1, !taffo.initweight !98, !taffo.info !53
  %arrayidx34 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx33, i32 0, i32 %k.1, !taffo.initweight !99, !taffo.info !53
  %4 = load float, float* %arrayidx34, align 4, !taffo.initweight !139, !taffo.info !53
  %arrayidx35 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %k.1, !taffo.initweight !98, !taffo.info !59
  %arrayidx36 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx35, i32 0, i32 %j.1, !taffo.initweight !99, !taffo.info !59
  ...
  %arrayidx38 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.1, !taffo.initweight !98, !taffo.info !61
  %arrayidx39 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx38, i32 0, i32 %j.1, !taffo.initweight !99, !taffo.info !61
...
for.inc41:                                        ; preds = %for.body32
  %inc42 = add nsw i32 %k.1, 1, !taffo.info !126, !taffo.constinfo !27
...
for.inc44:                                        ; preds = %for.end43
  %inc45 = add nsw i32 %j.1, 1, !taffo.info !126, !taffo.constinfo !27
...
for.inc47:                                        ; preds = %for.end46
  %inc48 = add nsw i32 %i.1, 1, !taffo.info !126, !taffo.constinfo !27
...
for.body5:                                        ; preds = %for.cond3
  ...
  %rem = srem i32 %add, %ni, !taffo.initweight !80, !taffo.info !166
  %conv = sitofp i32 %rem to float, !taffo.initweight !98, !taffo.info !166
  %conv6 = sitofp i32 %ni to float, !taffo.info !122
  %div = fdiv float %conv, %conv6, !taffo.initweight !99, !taffo.info !168
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %A, i32 %i.0, !taffo.initweight !68, !taffo.info !170
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !68, !taffo.info !170
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !68, !taffo.info !171, !taffo.constinfo !27
  br label %for.cond3, !llvm.loop !173

for.end:                                          ; preds = %for.cond3
  br label %for.inc8

for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.initweight !68, !taffo.info !174, !taffo.constinfo !27
...
for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.initweight !68, !taffo.info !171, !taffo.constinfo !27
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.initweight !68, !taffo.info !177
  %rem21 = srem i32 %mul20, %nj, !taffo.initweight !69, !taffo.info !179
  %conv22 = sitofp i32 %rem21 to float, !taffo.initweight !80, !taffo.info !179
  %conv23 = sitofp i32 %nj to float, !taffo.info !22
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !98, !taffo.info !180
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.1, !taffo.initweight !68, !taffo.info !182
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.initweight !68, !taffo.info !182
  store float %div24, float* %arrayidx26, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.initweight !68, !taffo.info !171, !taffo.constinfo !27
  br label %for.cond15, !llvm.loop !183

for.end29:                                        ; preds = %for.cond15
  br label %for.inc30

for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.initweight !68, !taffo.info !174, !taffo.constinfo !27
  br label %for.cond11, !llvm.loop !184
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 3, !taffo.initweight !68, !taffo.info !185, !taffo.constinfo !27
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.initweight !68, !taffo.info !187
  %add43 = add nsw i32 %mul42, 1, !taffo.initweight !69, !taffo.info !189, !taffo.constinfo !27
  %rem44 = srem i32 %add43, %nl, !taffo.initweight !80, !taffo.info !191
  %conv45 = sitofp i32 %rem44 to float, !taffo.initweight !98, !taffo.info !191
  %conv46 = sitofp i32 %nl to float, !taffo.info !124
  %div47 = fdiv float %conv45, %conv46, !taffo.initweight !99, !taffo.info !193
  %arrayidx48 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %i.2, !taffo.initweight !68, !taffo.info !195
  %arrayidx49 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx48, i32 0, i32 %j.2, !taffo.initweight !68, !taffo.info !195
  store float %div47, float* %arrayidx49, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc50

for.inc50:                                        ; preds = %for.body40
  %inc51 = add nsw i32 %j.2, 1, !taffo.initweight !68, !taffo.info !171, !taffo.constinfo !27
...
for.inc53:                                        ; preds = %for.end52
  %inc54 = add nsw i32 %i.2, 1, !taffo.initweight !68, !taffo.info !174, !taffo.constinfo !27
...
for.body63:                                       ; preds = %for.cond60
  %add64 = add nsw i32 %j.3, 2, !taffo.initweight !68, !taffo.info !198, !taffo.constinfo !27
  %mul65 = mul nsw i32 %i.3, %add64, !taffo.initweight !68, !taffo.info !200
  %rem66 = srem i32 %mul65, %nk, !taffo.initweight !69, !taffo.info !202
  %conv67 = sitofp i32 %rem66 to float, !taffo.initweight !80, !taffo.info !202
  %conv68 = sitofp i32 %nk to float, !taffo.info !137
  %div69 = fdiv float %conv67, %conv68, !taffo.initweight !98, !taffo.info !204
  %arrayidx70 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.3, !taffo.initweight !68, !taffo.info !206
  %arrayidx71 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx70, i32 0, i32 %j.3, !taffo.initweight !68, !taffo.info !206
  store float %div69, float* %arrayidx71, align 4, !taffo.initweight !69, !taffo.info !100
  br label %for.inc72

for.inc72:                                        ; preds = %for.body63
  %inc73 = add nsw i32 %j.3, 1, !taffo.initweight !68, !taffo.info !171, !taffo.constinfo !27
...
for.inc75:                                        ; preds = %for.end74
  %inc76 = add nsw i32 %i.3, 1, !taffo.initweight !68, !taffo.info !174, !taffo.constinfo !27
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.4, !taffo.initweight !68, !taffo.info !209
  %arrayidx87 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx86, i32 0, i32 %j.4, !taffo.initweight !68, !taffo.info !209
  store float 0.000000e+00, float* %arrayidx87, align 4, !taffo.initweight !69, !taffo.info !100, !taffo.constinfo !109
  br label %for.inc88

for.inc88:                                        ; preds = %for.body85
  %inc89 = add nsw i32 %j.4, 1, !taffo.initweight !68, !taffo.info !171, !taffo.constinfo !27
...
for.inc91:                                        ; preds = %for.end90
  %inc92 = add nsw i32 %i.4, 1, !taffo.initweight !68, !taffo.info !174, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !213 !taffo.sourceFunction !70 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc7, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc8, %for.inc7 ], !taffo.info !76
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !126
  br i1 %cmp, label %for.body, label %for.end9
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !76
  %cmp2 = icmp slt i32 %j.0, %m, !taffo.info !126
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !99, !taffo.info !53
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !214, !taffo.info !215
  %2 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !99, !taffo.info !53
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !219 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !99, !taffo.info !55
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !214, !taffo.info !220
  %2 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !99, !taffo.info !55
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !224 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !99, !taffo.info !57
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !214, !taffo.info !225
  %2 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !99, !taffo.info !57
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !229 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !99, !taffo.info !59
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !214, !taffo.info !230
  %2 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !99, !taffo.info !59
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !234 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !99, !taffo.info !61
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !214, !taffo.info !235
  %2 = mul nsw i32 %i.0, %m, !taffo.info !110
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !99, !taffo.info !61
...
!7 = !{double 0.000000e+00, double 0x40F32E6660008638}
...
!54 = !{double 0.000000e+00, double 0x40927333201040C0}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 1.400000e+01}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 1.440000e+01}
!59 = !{i1 false, !60, i1 false, i2 -1}
!60 = !{double 0.000000e+00, double 0x402DB6DB50F40E5A}
...
!112 = distinct !{!112, !29}
!113 = distinct !{!113, !29}
!114 = !{void (i32, i32, i32, i32, float, float, [10 x float]*, [12 x float]*, [10 x float]*, [14 x float]*, [14 x float]*)* @kernel_2mm.3}
!115 = distinct !{!115, !29}
!116 = distinct !{!116, !29}
!117 = distinct !{!117, !29}
!118 = distinct !{!118, !29}
!119 = distinct !{!119, !29}
!120 = distinct !{!120, !29}
!121 = !{i32 1, !122, i32 1, !124, i32 1, !6}
!122 = !{i1 false, !123, i1 false, i2 0}
!123 = !{double 8.000000e+00, double 8.000000e+00}
!124 = !{i1 false, !125, i1 false, i2 0}
!125 = !{double 1.400000e+01, double 1.400000e+01}
!126 = !{i1 false, !127, i1 false, i2 0}
!127 = !{double 1.000000e+00, double 1.000000e+00}
!128 = distinct !{!128, !29}
!129 = distinct !{!129, !29}
!130 = !{i32 1, i32 -1}
!131 = !{i32 1, !49, i32 1, !132}
!132 = !{i1 false, !133, i1 false, i2 0}
!133 = !{double 1.600000e+01, double 1.600000e+01}
!134 = !{i32 1, !51, i32 1, !132}
!135 = !{i32 -1, i32 -1, i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!136 = !{i32 1, !122, i32 1, !22, i32 1, !137, i32 1, !124, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55, i32 1, !57, i32 1, !59, i32 1, !61}
!137 = !{i1 false, !138, i1 false, i2 0}
!138 = !{double 1.200000e+01, double 1.200000e+01}
!139 = !{i32 7}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 2.100000e+01}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 0.000000e+00, double 0x4072E66666666667}
!144 = !{i1 false, !145, i1 false, i2 -1}
!145 = !{double 0.000000e+00, double 0x40972CCCB9A9DA5A}
!146 = distinct !{!146, !29}
!147 = distinct !{!147, !29}
!148 = distinct !{!148, !29}
!149 = !{i1 false, !150, i1 false, i2 -1}
!150 = !{double 0.000000e+00, double 0x40F7047AD99A3AA9}
!151 = !{i32 8}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x40D121D3FAE7B10A}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x40F776DB5EBA727A}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
!159 = !{i32 -1, i32 -1, i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2}
!160 = !{i32 1, !122, i32 1, !22, i32 1, !137, i32 1, !124, i32 1, !49, i32 1, !51, i32 1, !55, i32 1, !57, i32 1, !59, i32 1, !61, i32 1, !53}
...
!167 = !{double 0.000000e+00, double 7.000000e+00}
!168 = !{i1 false, !169, i1 false, i2 -1}
!169 = !{double 0.000000e+00, double 8.750000e-01}
!170 = !{i1 false, !56, i1 false, i2 1}
!171 = !{i1 false, !172, i1 false, i2 -1}
!172 = !{double 1.000000e+00, double 1.500000e+01}
!173 = distinct !{!173, !29}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double 1.000000e+00, double 1.300000e+01}
!176 = distinct !{!176, !29}
!177 = !{i1 false, !178, i1 false, i2 -1}
!178 = !{double 0.000000e+00, double 1.800000e+02}
!179 = !{i1 false, !75, i1 false, i2 -1}
!180 = !{i1 false, !181, i1 false, i2 -1}
!181 = !{double 0.000000e+00, double 9.000000e-01}
...
!188 = !{double 0.000000e+00, double 2.040000e+02}
!189 = !{i1 false, !190, i1 false, i2 -1}
!190 = !{double 1.000000e+00, double 2.050000e+02}
!191 = !{i1 false, !192, i1 false, i2 -1}
!192 = !{double 0.000000e+00, double 1.300000e+01}
!193 = !{i1 false, !194, i1 false, i2 -1}
!194 = !{double 0.000000e+00, double 0x3FEDB6DB6DB6DB6E}
!195 = !{i1 false, !60, i1 false, i2 1}
!196 = distinct !{!196, !29}
!197 = distinct !{!197, !29}
...
!206 = !{i1 false, !7, i1 false, i2 1}
!207 = distinct !{!207, !29}
!208 = distinct !{!208, !29}
!209 = !{i1 false, !54, i1 false, i2 1}
!210 = distinct !{!210, !29}
!211 = distinct !{!211, !29}
!212 = !{i32 -1, i32 -1, i32 3, i32 -1}
!213 = !{i32 1, !122, i32 1, !22, i32 1, !53, i32 1, !132}
!214 = !{i32 9}
!215 = !{i1 false, !216, i1 false, i2 -1}
!216 = !{double 0.000000e+00, double 0x40D27333201040C0}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = !{i32 1, !122, i32 1, !137, i32 1, !55, i32 1, !132}
!220 = !{i1 false, !221, i1 false, i2 -1}
!221 = !{double 0.000000e+00, double 2.240000e+02}
!222 = distinct !{!222, !29}
!223 = distinct !{!223, !29}
!224 = !{i32 1, !137, i32 1, !22, i32 1, !57, i32 1, !132}
!225 = !{i1 false, !226, i1 false, i2 -1}
!226 = !{double 0.000000e+00, double 2.304000e+02}
!227 = distinct !{!227, !29}
!228 = distinct !{!228, !29}
!229 = !{i32 1, !22, i32 1, !124, i32 1, !59, i32 1, !132}
!230 = !{i1 false, !231, i1 false, i2 -1}
!231 = !{double 0.000000e+00, double 0x406DB6DB50F40E5A}
!232 = distinct !{!232, !29}
!233 = distinct !{!233, !29}
!234 = !{i32 1, !122, i32 1, !124, i32 1, !61, i32 1, !132}
!235 = !{i1 false, !236, i1 false, i2 -1}
!236 = !{double 0.000000e+00, double 0x41332E6660008638}
!237 = distinct !{!237, !29}
!238 = distinct !{!238, !29}
