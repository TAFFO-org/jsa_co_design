; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-1024-fixed-16.out.ll'
...
for.body58:                                       ; preds = %for.cond56
  ...
  %14 = fdiv float %lampsim2, 3.276800e+04, !taffo.info !41
  ...
  %16 = fdiv float %lampsim8, 1.638400e+04, !taffo.info !49
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim1 = and i32 %lampsim, -256
  %lampsim2 = bitcast i32 %lampsim1 to float
  %2 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !235
  %lampsim3 = bitcast float %2 to i32
  %lampsim4 = and i32 %lampsim3, -256
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !246
