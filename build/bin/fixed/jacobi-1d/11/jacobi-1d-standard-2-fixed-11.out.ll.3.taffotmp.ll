; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [51 x i8] c"target('A') scalar(range(0.266667,2.133333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-1d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.4,2.266667) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 2), !taffo.initweight !54, !taffo.target !48, !taffo.info !49, !taffo.originalCall !57, !taffo.constinfo !56
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !53, !taffo.info !51
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 2), !taffo.initweight !54, !taffo.info !51, !taffo.originalCall !57, !taffo.constinfo !56
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !97, !taffo.info !49
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !98, !taffo.info !49
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %0, %conv, !taffo.initweight !99, !taffo.info !100
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !97, !taffo.info !49
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !98, !taffo.info !49
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_1d.2(i32 noundef %tsteps, i32 noundef %n, float* noundef %A, float* noundef %B) #0 !taffo.initweight !103 !taffo.funinfo !104 !taffo.sourceFunction !59 {
entry:
  br label %for.cond
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %i.0 = phi i32 [ 1, %for.body ], [ %inc, %for.inc ], !taffo.info !105
  %sub = sub nsw i32 %n, 1, !taffo.info !107, !taffo.constinfo !27
  %cmp2 = icmp slt i32 %i.0, %sub, !taffo.info !90
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %sub4 = sub nsw i32 %i.0, 1, !taffo.info !92, !taffo.constinfo !27
  %arrayidx = getelementptr inbounds float, float* %A, i32 %sub4, !taffo.initweight !97, !taffo.info !49
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !98, !taffo.info !49
  %arrayidx5 = getelementptr inbounds float, float* %A, i32 %i.0, !taffo.initweight !97, !taffo.info !49
  %1 = load float, float* %arrayidx5, align 4, !taffo.initweight !98, !taffo.info !49
  %add = fadd float %0, %1, !taffo.initweight !99, !taffo.info !100
  %add6 = add nsw i32 %i.0, 1, !taffo.info !25, !taffo.constinfo !27
  %arrayidx7 = getelementptr inbounds float, float* %A, i32 %add6, !taffo.initweight !97, !taffo.info !49
  %2 = load float, float* %arrayidx7, align 4, !taffo.initweight !98, !taffo.info !49
  %add8 = fadd float %add, %2, !taffo.initweight !99, !taffo.info !109
  %conv = fpext float %add8 to double, !taffo.initweight !111, !taffo.info !109
  %mul = fmul double 3.333300e-01, %conv, !taffo.initweight !112, !taffo.info !113, !taffo.constinfo !81
  %conv9 = fptrunc double %mul to float, !taffo.initweight !115, !taffo.info !116
  %arrayidx10 = getelementptr inbounds float, float* %B, i32 %i.0, !taffo.initweight !97, !taffo.info !51
  store float %conv9, float* %arrayidx10, align 4, !taffo.initweight !98, !taffo.info !51
  br label %for.inc
...
for.cond11:                                       ; preds = %for.inc27, %for.end
  %i.1 = phi i32 [ 1, %for.end ], [ %inc28, %for.inc27 ], !taffo.info !105
  %sub12 = sub nsw i32 %n, 1, !taffo.info !107, !taffo.constinfo !27
  %cmp13 = icmp slt i32 %i.1, %sub12, !taffo.info !90
  br i1 %cmp13, label %for.body15, label %for.end29

for.body15:                                       ; preds = %for.cond11
  %sub16 = sub nsw i32 %i.1, 1, !taffo.info !92, !taffo.constinfo !27
  %arrayidx17 = getelementptr inbounds float, float* %B, i32 %sub16, !taffo.initweight !97, !taffo.info !51
  %3 = load float, float* %arrayidx17, align 4, !taffo.initweight !98, !taffo.info !51
  %arrayidx18 = getelementptr inbounds float, float* %B, i32 %i.1, !taffo.initweight !97, !taffo.info !51
  %4 = load float, float* %arrayidx18, align 4, !taffo.initweight !98, !taffo.info !51
  %add19 = fadd float %3, %4, !taffo.initweight !99, !taffo.info !119
  %add20 = add nsw i32 %i.1, 1, !taffo.info !25, !taffo.constinfo !27
  %arrayidx21 = getelementptr inbounds float, float* %B, i32 %add20, !taffo.initweight !97, !taffo.info !51
  %5 = load float, float* %arrayidx21, align 4, !taffo.initweight !98, !taffo.info !51
  %add22 = fadd float %add19, %5, !taffo.initweight !99, !taffo.info !121
  %conv23 = fpext float %add22 to double, !taffo.initweight !111, !taffo.info !121
  %mul24 = fmul double 3.333300e-01, %conv23, !taffo.initweight !112, !taffo.info !123, !taffo.constinfo !81
  %conv25 = fptrunc double %mul24 to float, !taffo.initweight !115, !taffo.info !125
  %arrayidx26 = getelementptr inbounds float, float* %A, i32 %i.1, !taffo.initweight !97, !taffo.info !49
  store float %conv25, float* %arrayidx26, align 4, !taffo.initweight !98, !taffo.info !49
  br label %for.inc27

for.inc27:                                        ; preds = %for.body15
  %inc28 = add nsw i32 %i.1, 1, !taffo.info !25, !taffo.constinfo !27
  br label %for.cond11, !llvm.loop !127
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !95 !taffo.funinfo !129 !taffo.sourceFunction !57 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !97, !taffo.info !51
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !98, !taffo.info !51
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %0, %conv, !taffo.initweight !99, !taffo.info !119
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !97, !taffo.info !51
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !98, !taffo.info !51
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, float* noundef %A, float* noundef %B) #0 !taffo.initweight !131 !taffo.funinfo !132 !taffo.sourceFunction !55 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.initweight !47, !taffo.info !71
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !54, !taffo.info !133
  br i1 %cmp, label %for.body, label %for.end, !taffo.initweight !65, !taffo.info !71

for.body:                                         ; preds = %for.cond
  %conv = sitofp i32 %i.0 to float, !taffo.initweight !54, !taffo.info !71
  %add = fadd float %conv, 2.000000e+00, !taffo.initweight !65, !taffo.info !134, !taffo.constinfo !73
  %conv2 = sitofp i32 %n to float, !taffo.info !88
  %div = fdiv float %add, %conv2, !taffo.initweight !74, !taffo.info !136
  %arrayidx = getelementptr inbounds float, float* %A, i32 %i.0, !taffo.initweight !54, !taffo.info !138
  store float %div, float* %arrayidx, align 4, !taffo.initweight !65, !taffo.info !75
  %conv3 = sitofp i32 %i.0 to float, !taffo.initweight !54, !taffo.info !71
  %add4 = fadd float %conv3, 3.000000e+00, !taffo.initweight !65, !taffo.info !139, !taffo.constinfo !76
  %conv5 = sitofp i32 %n to float, !taffo.info !88
  %div6 = fdiv float %add4, %conv5, !taffo.initweight !74, !taffo.info !141
  %arrayidx7 = getelementptr inbounds float, float* %B, i32 %i.0, !taffo.initweight !54, !taffo.info !143
  store float %div6, float* %arrayidx7, align 4, !taffo.initweight !65, !taffo.info !75
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.initweight !54, !taffo.info !144, !taffo.constinfo !27
...
!7 = !{double 0.000000e+00, double 0x40011110E453D20F}
...
!50 = !{double 2.666670e-01, double 0x40011110E453D20F}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 4.000000e-01, double 0x400222224EDF6124}
!53 = !{i32 1}
!54 = !{i32 2}
...
!96 = !{i32 1, !88, i32 1, !49, i32 1, !25}
!97 = !{i32 5}
!98 = !{i32 6}
!99 = !{i32 7}
!100 = !{i1 false, !101, i1 false, i2 -1}
!101 = !{double 5.333340e-01, double 0x40111110E453D20F}
!102 = distinct !{!102, !29}
!103 = !{i32 -1, i32 -1, i32 2, i32 2}
!104 = !{i32 1, !22, i32 1, !88, i32 1, !49, i32 1, !51}
!105 = !{i1 false, !106, i1 false, i2 0}
!106 = !{double 1.000000e+00, double 2.000000e+00}
!107 = !{i1 false, !108, i1 false, i2 0}
!108 = !{double 1.400000e+01, double 1.400000e+01}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x3FE9999BB2788DB0, double 0x40199999567DBB16}
!111 = !{i32 8}
!112 = !{i32 9}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3FD1110747AA5E17, double 0x40011105B5042EE8}
!115 = !{i32 10}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0x3FD1110740000000, double 0x40011105C0000000}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 8.000000e-01, double 0x401222224EDF6124}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0x3FF3333333333334, double 0x401B3333764F11B6}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x3FD99988D2A1F8E5, double 0x400222166C9A8751}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0x3FD99988C0000000, double 0x4002221680000000}
!127 = distinct !{!127, !29}
!128 = distinct !{!128, !29}
!129 = !{i32 1, !88, i32 1, !51, i32 1, !25}
!130 = distinct !{!130, !29}
!131 = !{i32 -1, i32 2, i32 2}
!132 = !{i32 1, !88, i32 1, !49, i32 1, !51}
!133 = !{i1 false, !64, i1 false, i2 -1}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double -1.300000e+01, double 1.700000e+01}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0xBFEBBBBBBBBBBBBC, double 0x3FF2222222222222}
!138 = !{i1 false, !50, i1 false, i2 1}
