...
entry:
  ...
  call void @llvm.var.annotation(i8* %D7, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 135, i8* null)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 12, float* noundef %4, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 12, i32 noundef 10, float* noundef %5, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 14, float* noundef %6, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 14, float* noundef %7, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 10, float* noundef %8, i32 noundef 512)
