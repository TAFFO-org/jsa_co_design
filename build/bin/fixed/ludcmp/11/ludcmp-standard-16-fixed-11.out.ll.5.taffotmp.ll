; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-16-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u8_24fixp = bitcast [20 x i32]* %arraydecay10.u8_24fixp to i32*, !taffo.info !42
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u8_24fixp, i32 16), !taffo.info !55, !taffo.constinfo !57
  %arraydecay11.u8_24fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !45
  %u8_24fixp1 = bitcast [20 x i32]* %arraydecay11.u8_24fixp to i32*, !taffo.info !45
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u8_24fixp1, i32 16), !taffo.info !58, !taffo.constinfo !57
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s8_24fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 24), !taffo.info !88
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s8_24fixp, 4, !taffo.info !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !92 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 20), !taffo.info !93
  %mul.u11_21fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u11_21fixp, 4, !taffo.info !96
...
!90 = !{double -6.071520e-01, double 0x404FFCF893FAF428}
!91 = distinct !{!91, !23}
!92 = !{i32 1, !74, i32 1, !47, i32 1, !83}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 20}
!95 = !{double 0x40901999A1FD156A, double 1.152000e+03}
