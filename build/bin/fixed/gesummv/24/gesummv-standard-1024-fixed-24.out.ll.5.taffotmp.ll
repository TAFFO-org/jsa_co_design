; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 2.560000e+02, %mul.1flp, !taffo.info !92
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !90
  %3 = fdiv float %2, 0x4140000000000000, !taffo.info !90
  %mul.1flp = fmul float %1, %3, !taffo.info !104
  %arrayidx1.u23_9fixp = getelementptr inbounds i32, i32* %val.u23_9fixp, i32 %i.0, !taffo.info !51
  %4 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !104
