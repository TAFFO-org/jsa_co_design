; ModuleID = './build/bin/fixed/trmm/24/trmm-standard-1-fixed-24.out.ll'
...
for.body9:                                        ; preds = %for.cond7
  ...
  %2 = fdiv float %lampsim2, 0x41C0000000000000, !taffo.info !34, !taffo.target !36
  ...
  store float %lampsim5, float* %arrayidx12, align 4, !taffo.info !47, !taffo.target !36
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.7, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !54
  br label %for.inc
