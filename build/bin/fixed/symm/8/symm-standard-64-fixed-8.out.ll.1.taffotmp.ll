...
entry:
  ...
  call void @llvm.var.annotation(i8* %B5, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 126, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 64)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 64)
