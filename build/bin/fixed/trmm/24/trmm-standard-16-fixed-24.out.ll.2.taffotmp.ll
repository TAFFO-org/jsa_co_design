; ModuleID = './build/bin/fixed/trmm/24/trmm-standard-16-fixed-24.out.ll.1.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,16.0) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [44 x i8] c"target('B') scalar(range(0.0,1341.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.initweight !39, !taffo.info !32, !taffo.originalCall !41
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 16), !taffo.initweight !43, !taffo.info !34, !taffo.originalCall !44
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 16), !taffo.initweight !43, !taffo.info !36, !taffo.target !38, !taffo.originalCall !44
...
for.body16:                                       ; preds = %for.cond13
  ...
  %div21 = fdiv float %conv19, %conv20, !taffo.initweight !54, !taffo.info !50
...
for.inc24:                                        ; preds = %for.body16
  ...
  br label %for.cond13, !llvm.loop !55
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_trmm(i32 noundef %m, i32 noundef %n, float noundef %alpha, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !24 !taffo.equivalentChild !57 !taffo.funinfo !25 {
entry:
  %m.addr = alloca i32, align 4
  %n.addr = alloca i32, align 4
  %alpha.addr = alloca float, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.1(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !63 !taffo.sourceFunction !41 !taffo.funinfo !64 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_trmm.2(i32 noundef %m, i32 noundef %n, float noundef %alpha, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !65 !taffo.sourceFunction !45 !taffo.funinfo !66 {
entry:
  %m.addr = alloca i32, align 4
  %n.addr = alloca i32, align 4
...
for.body6:                                        ; preds = %for.cond4
  ...
  %9 = load i32, i32* %i, align 4
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %9, !taffo.initweight !54, !taffo.info !34
  %10 = load float, float* %arrayidx7, align 4, !taffo.initweight !67, !taffo.info !34
  ...
  %13 = load i32, i32* %j, align 4
  %arrayidx9 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx8, i32 0, i32 %13, !taffo.initweight !54, !taffo.info !36
  %14 = load float, float* %arrayidx9, align 4, !taffo.initweight !67, !taffo.info !36
  %mul = fmul float %10, %14, !taffo.initweight !68, !taffo.info !34
  ...
  %17 = load i32, i32* %j, align 4
  %arrayidx11 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx10, i32 0, i32 %17, !taffo.initweight !54, !taffo.info !36
  %18 = load float, float* %arrayidx11, align 4, !taffo.initweight !67, !taffo.info !36
  %add12 = fadd float %18, %mul, !taffo.initweight !68, !taffo.info !36
  store float %add12, float* %arrayidx11, align 4, !taffo.initweight !67, !taffo.info !36
  br label %for.inc
...
for.inc:                                          ; preds = %for.body6
  ...
  %inc = add nsw i32 %19, 1
  store i32 %inc, i32* %k, align 4
  br label %for.cond4, !llvm.loop !69
...
for.end:                                          ; preds = %for.cond4
  ...
  %23 = load i32, i32* %j, align 4
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %23, !taffo.initweight !54, !taffo.info !36
  %24 = load float, float* %arrayidx14, align 4, !taffo.initweight !67, !taffo.info !36
  ...
  %27 = load i32, i32* %j, align 4
  %arrayidx17 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx16, i32 0, i32 %27, !taffo.initweight !54, !taffo.info !36
  store float %mul15, float* %arrayidx17, align 4, !taffo.initweight !54, !taffo.info !32
  br label %for.inc18
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.3(i32 noundef %m, i32 noundef %n, float* noundef %alpha, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !72 !taffo.sourceFunction !40 !taffo.funinfo !66 {
entry:
  %m.addr = alloca i32, align 4
  %n.addr = alloca i32, align 4
...
for.inc24:                                        ; preds = %for.body16
  ...
  %inc25 = add nsw i32 %31, 1, !taffo.initweight !42, !taffo.info !52
  store i32 %inc25, i32* %j, align 4, !taffo.initweight !39, !taffo.info !52
  br label %for.cond13, !llvm.loop !74
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.sourceFunction !44 !taffo.funinfo !77 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !54, !taffo.info !34
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !67, !taffo.info !34
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !68, !taffo.info !34
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !78, !taffo.info !34
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !34
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !54, !taffo.info !34
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !67, !taffo.info !34
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !68, !taffo.info !34
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.sourceFunction !44 !taffo.funinfo !81 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !54, !taffo.info !36
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !67, !taffo.info !36
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !68, !taffo.info !36
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !78, !taffo.info !36
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !36
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !54, !taffo.info !36
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !67, !taffo.info !36
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !68, !taffo.info !36
  br label %for.inc
...
!37 = !{double 0.000000e+00, double 1.341000e+03}
!38 = !{!"B"}
!39 = !{i32 1}
...
!52 = !{i1 false, !35, i1 false, i2 1}
!53 = distinct !{!53, !12}
!54 = !{i32 6}
!55 = distinct !{!55, !12}
!56 = distinct !{!56, !12}
!57 = !{void (i32, i32, float, [10 x float]*, [16 x float]*)* @kernel_trmm.2}
!58 = distinct !{!58, !12}
!59 = distinct !{!59, !12}
!60 = distinct !{!60, !12}
!61 = distinct !{!61, !12}
...
!65 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2}
!66 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !32, i32 1, !34, i32 1, !36}
!67 = !{i32 7}
!68 = !{i32 8}
!69 = distinct !{!69, !12}
!70 = distinct !{!70, !12}
!71 = distinct !{!71, !12}
!72 = !{i32 -1, i32 -1, i32 1, i32 2, i32 2}
!73 = distinct !{!73, !12}
!74 = distinct !{!74, !12}
!75 = distinct !{!75, !12}
!76 = !{i32 -1, i32 -1, i32 3, i32 -1}
!77 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !34, i32 0, i1 false}
!78 = !{i32 9}
!79 = distinct !{!79, !12}
!80 = distinct !{!80, !12}
!81 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !36, i32 0, i1 false}
!82 = distinct !{!82, !12}
!83 = distinct !{!83, !12}
