; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-256-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 256), !taffo.info !66, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 256), !taffo.info !71, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 256), !taffo.info !73, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 256), !taffo.info !77, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 256), !taffo.info !78, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 256), !taffo.info !79, !taffo.initweight !74, !taffo.constinfo !75, !taffo.target !60, !taffo.originalCall !76
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 256), !taffo.info !80, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
...
!50 = !{double 0.000000e+00, double 0x4112733320000000}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 32, i32 24}
!53 = !{double 0.000000e+00, double 2.240000e+02}
!54 = !{!52, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x406CCCCCC0379314}
!56 = !{!52, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x406DB6DB5FA22707}
!58 = !{!59, !1, i1 false, i2 -1}
!59 = !{!"fixp", i32 32, i32 3}
!60 = !{!"D"}
...
!124 = !{double 0.000000e+00, double 3.360000e+02}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x40F2E6665E247885}
!127 = !{!49, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x41172CCCB7891E21}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{!59, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x41B7047AD9999999}
!134 = !{!59, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x419121D4034F607A}
!136 = !{i32 8}
!137 = !{!59, !138, i1 false, i2 -1}
!138 = !{double 0.000000e+00, double 0x41B776DB60D3D81E}
!139 = distinct !{!139, !23}
!140 = distinct !{!140, !23}
!141 = distinct !{!141, !23}
...
!219 = !{!"fixp", i32 32, i32 5}
!220 = !{double 0.000000e+00, double 0x4192733320000000}
!221 = !{i32 9}
!222 = distinct !{!222, !23}
!223 = distinct !{!223, !23}
!224 = !{i32 1, !98, i32 1, !114, i32 1, !51, i32 1, !110}
!225 = !{!226, !227, i1 false, i2 -1}
!226 = !{!"fixp", i32 32, i32 16}
!227 = !{double 0.000000e+00, double 5.734400e+04}
!228 = distinct !{!228, !23}
!229 = distinct !{!229, !23}
!230 = !{i32 1, !98, i32 1, !100, i32 1, !58, i32 1, !110}
!231 = !{!232, !233, i1 false, i2 -1}
!232 = !{!"float", i32 1, double 0x42332E6660000000}
!233 = !{double 0.000000e+00, double 0x42332E6660000000}
!234 = distinct !{!234, !23}
!235 = distinct !{!235, !23}
