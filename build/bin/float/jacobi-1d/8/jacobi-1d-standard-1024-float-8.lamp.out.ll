; ModuleID = './build/bin/float/jacobi-1d/8/jacobi-1d-standard-1024-float-8.out.ll'
source_filename = "./sources/jacobi-1d.c"
target datalayout = "e-m:e-p:32:32-p270:32:32-p271:32:32-p272:64:64-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-unknown-linux-gnu"

@.str = private unnamed_addr constant [55 x i8] c"target('A') scalar(range(136.53334,1092.266724) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-1d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [44 x i8] c"scalar(range(204.800003,1160.533325) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_1d(i32 noundef 15, ptr noundef %arraydecay2, i32 noundef 1024)
  %arraydecay3 = getelementptr inbounds [15 x float], ptr %B, i32 0, i32 0
  call void @scale_1d(i32 noundef 15, ptr noundef %arraydecay3, i32 noundef 1024)
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim4 = and i32 %lampsim, -65536
  ...
  %lampsim12 = and i32 %lampsim11, -65536
  ...
  %lampsim32 = and i32 %lampsim31, -65536
...
for.body15:                                       ; preds = %for.cond11
  ...
  %lampsim30 = and i64 %lampsim29, -35184372088832
  ...
  %lampsim34 = and i64 %lampsim33, -35184372088832
