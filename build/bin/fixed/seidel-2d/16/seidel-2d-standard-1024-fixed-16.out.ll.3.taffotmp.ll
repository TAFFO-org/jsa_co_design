; ModuleID = './build/bin/fixed/seidel-2d/16/seidel-2d-standard-1024-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [57 x i8] c"target('A') scalar(range(102.400002,20531.199219) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !141, !taffo.info !142
...
!5 = !{double 0.000000e+00, double 0x40D40CCCC0010C6F}
...
!50 = !{double 0x40599999A1FD156A, double 0x40D40CCCC0010C6F}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x40699999A1FD156A, double 0x40E40CCCC0010C6F}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x40733333397DD010, double 0x40EE1333200192A6}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 0x40799999A1FD156A, double 0x40F40CCCC0010C6F}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 0x40800000053E2D62, double 0x40F90FFFF0014F8B}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 0x408CCCCCD63CB817, double 0x41068E6658012DFD}
...
!138 = !{i32 1, !90, i32 1, !90, i32 1, !49, i32 1, !139}
!139 = !{i1 false, !140, i1 false, i2 0}
!140 = !{double 1.024000e+03, double 1.024000e+03}
!141 = !{i32 9}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 0x40F99999A1FD156A, double 0x41740CCCC0010C6F}
!144 = distinct !{!144, !29}
!145 = distinct !{!145, !29}
