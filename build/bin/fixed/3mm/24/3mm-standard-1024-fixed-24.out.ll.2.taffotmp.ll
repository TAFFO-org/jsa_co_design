; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-1024-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %5, i32 noundef 1024), !taffo.initweight !49, !taffo.info !31, !taffo.originalCall !50
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %6, i32 noundef 1024), !taffo.initweight !49, !taffo.info !33, !taffo.originalCall !50
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 8, float* noundef %7, i32 noundef 1024), !taffo.initweight !49, !taffo.info !35, !taffo.originalCall !50
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %8, i32 noundef 1024), !taffo.initweight !49, !taffo.info !37, !taffo.originalCall !50
  ...
  call void @scale_2d.7(i32 noundef 8, i32 noundef 14, float* noundef %9, i32 noundef 1024), !taffo.initweight !49, !taffo.info !39, !taffo.originalCall !50
  ...
  call void @scale_2d.8(i32 noundef 14, i32 noundef 12, float* noundef %10, i32 noundef 1024), !taffo.initweight !49, !taffo.info !41, !taffo.originalCall !50
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %11, i32 noundef 1024), !taffo.initweight !49, !taffo.info !43, !taffo.target !45, !taffo.originalCall !50
...
!32 = !{double 0.000000e+00, double 0x40FBBBBBE0008638}
!33 = !{i1 false, !34, i1 false, i2 -1}
!34 = !{double 0.000000e+00, double 0x406555556084A516}
!35 = !{i1 false, !36, i1 false, i2 -1}
!36 = !{double 0.000000e+00, double 0x40666666601BC98A}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double 0.000000e+00, double 0x4100624DE0000000}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 0.000000e+00, double 0x406777777F27FE4C}
!41 = !{i1 false, !42, i1 false, i2 -1}
!42 = !{double 0.000000e+00, double 0x40670A3D7F51EFB7}
!43 = !{i1 false, !44, i1 false, i2 -1}
!44 = !{double 0.000000e+00, double 0x422BCB0680000000}
!45 = !{!"G"}
!46 = !{i32 1}
!47 = !{i32 2}
