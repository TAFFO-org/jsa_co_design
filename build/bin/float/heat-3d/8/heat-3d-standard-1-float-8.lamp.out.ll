; ModuleID = './build/bin/float/heat-3d/8/heat-3d-standard-1-float-8.out.ll'
...
entry:
  ...
  call void @kernel_heat_3d(i32 noundef %1, i32 noundef %2, ptr noundef %arraydecay2, ptr noundef %arraydecay3)
...
for.body9:                                        ; preds = %for.cond7
  ...
  %arrayidx10 = getelementptr inbounds [5 x [5 x float]], ptr %arrayidx, i32 0, i32 %10
  %11 = load i32, ptr %k, align 4
  %arrayidx11 = getelementptr inbounds [5 x float], ptr %arrayidx10, i32 0, i32 %11
  %12 = load float, ptr %arrayidx11, align 4
  %13 = load i32, ptr %i, align 4
  %arrayidx12 = getelementptr inbounds [5 x [5 x [5 x float]]], ptr @A_float, i32 0, i32 %13
  %14 = load i32, ptr %j, align 4
  %arrayidx13 = getelementptr inbounds [5 x [5 x float]], ptr %arrayidx12, i32 0, i32 %14
  %15 = load i32, ptr %k, align 4
  %arrayidx14 = getelementptr inbounds [5 x float], ptr %arrayidx13, i32 0, i32 %15
...
for.body80:                                       ; preds = %for.cond77
  ...
  %lampsim66 = and i32 %lampsim65, -65536
  ...
  %lampsim86 = and i32 %lampsim85, -65536
  ...
  %lampsim94 = and i32 %lampsim93, -65536
  ...
  %lampsim106 = and i32 %lampsim105, -65536
  ...
  %lampsim110 = and i32 %lampsim109, -65536
  ...
  %lampsim114 = and i32 %lampsim113, -65536
  ...
  %lampsim118 = and i32 %lampsim117, -65536
