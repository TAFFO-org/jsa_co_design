; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-8-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 0x4170000000000000, !taffo.info !67
  ...
  %3 = fdiv float %lampsim8, 3.276800e+04, !taffo.info !64, !taffo.target !66
  ...
  store float %lampsim11, float* %arrayidx40, align 4, !taffo.info !85, !taffo.target !66
  br label %for.cond41
...
for.body43:                                       ; preds = %for.cond41
  ...
  %5 = fdiv float %lampsim14, 0x41A0000000000000, !taffo.info !52
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.9_fixp(i32 noundef %n, i32* noundef %val.u1_31fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !127 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 27), !taffo.info !129
  %mul.u4_28fixp = shl i32 %3, 1, !taffo.info !132
  %arrayidx1.u1_31fixp = getelementptr inbounds i32, i32* %val.u1_31fixp, i32 %i.0, !taffo.info !69
  %4 = shl i32 %mul.u4_28fixp, 3, !taffo.info !132
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5_fixp(i32 noundef %n, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !134 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !135
  %0 = lshr i32 %u3_29fixp, 1, !taffo.info !59
  %1 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !135
  %2 = ashr i32 %0, 3, !taffo.info !59
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 25), !taffo.info !137
  %mul.u6_26fixp = shl i32 %3, 1, !taffo.info !140
  %arrayidx1.u3_29fixp = getelementptr inbounds i32, i32* %val.u3_29fixp, i32 %i.0, !taffo.info !59
  %4 = shl i32 %mul.u6_26fixp, 3, !taffo.info !140
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !142 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !143
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !146
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !64
  %5 = shl i32 %mul.u20_12fixp, 3, !taffo.info !146
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !149 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u4_28fixp = load i32, i32* %arrayidx.u4_28fixp, align 4, !taffo.info !150
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !135
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !150
  %1 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !135
  %2 = ashr i32 %0, 2, !taffo.info !150
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 25), !taffo.info !151
  %mul.u6_26fixp = shl i32 %3, 1, !taffo.info !153
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !54
  %4 = shl i32 %mul.u6_26fixp, 2, !taffo.info !153
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !155 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 20), !taffo.info !156
  %mul.u11_21fixp = shl i32 %4, 1, !taffo.info !159
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !67
  %5 = shl i32 %mul.u11_21fixp, 3, !taffo.info !159
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx.u4_28fixp = getelementptr inbounds i32, i32* %u1.u4_28fixp, i32 %i.0, !taffo.info !180
  %3 = lshr i32 %div.u1_31fixp, 3, !taffo.info !179
  store i32 %3, i32* %arrayidx.u4_28fixp, align 4, !taffo.info !181
  ...
  %arrayidx11.u3_29fixp = getelementptr inbounds i32, i32* %u2.u3_29fixp, i32 %i.0, !taffo.info !194
  %10 = lshr i32 %conv10.u1_31fixp, 2, !taffo.info !192, !taffo.constinfo !191
  store i32 %10, i32* %arrayidx11.u3_29fixp, align 4, !taffo.info !181
  ...
  %div16.u2_30fixp = shl i32 %17, 2, !taffo.info !198, !taffo.constinfo !199
  %conv17.u1_31fixp = shl i32 %div16.u2_30fixp, 1, !taffo.info !202, !taffo.constinfo !199
  %arrayidx18.u2_30fixp = getelementptr inbounds i32, i32* %v1.u2_30fixp, i32 %i.0, !taffo.info !204
  %18 = lshr i32 %conv17.u1_31fixp, 1, !taffo.info !202, !taffo.constinfo !199
  store i32 %18, i32* %arrayidx18.u2_30fixp, align 4, !taffo.info !181
  ...
  %19 = lshr i32 %conv20.u5_27fixp, 1, !taffo.info !183, !taffo.constinfo !25
  %20 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !170
  %21 = call i32 @llvm.sdiv.fix.i32(i32 %19, i32 %20, i32 26), !taffo.info !184
  %div21.u2_30fixp = shl i32 %21, 4, !taffo.info !186
  %22 = lshr i32 %div21.u2_30fixp, 1, !taffo.info !186
  %23 = shl i32 6, 28
  %24 = ashr i32 %22, 1, !taffo.info !186
  %25 = call i32 @llvm.sdiv.fix.i32(i32 %24, i32 %23, i32 28), !taffo.info !205
  %div23.u2_30fixp = shl i32 %25, 2, !taffo.info !207, !taffo.constinfo !208
  %conv24.u1_31fixp = shl i32 %div23.u2_30fixp, 1, !taffo.info !211, !taffo.constinfo !208
  %arrayidx25.u2_30fixp = getelementptr inbounds i32, i32* %v2.u2_30fixp, i32 %i.0, !taffo.info !213
  %26 = lshr i32 %conv24.u1_31fixp, 1, !taffo.info !211, !taffo.constinfo !208
  store i32 %26, i32* %arrayidx25.u2_30fixp, align 4, !taffo.info !181
  ...
  %27 = lshr i32 %conv27.u5_27fixp, 1, !taffo.info !183, !taffo.constinfo !25
  %28 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !170
  %29 = call i32 @llvm.sdiv.fix.i32(i32 %27, i32 %28, i32 26), !taffo.info !184
  %div28.u2_30fixp = shl i32 %29, 4, !taffo.info !186
  %30 = lshr i32 %div28.u2_30fixp, 1, !taffo.info !186
  %31 = shl i32 8, 27
  %32 = ashr i32 %30, 2, !taffo.info !186
  %33 = call i32 @llvm.sdiv.fix.i32(i32 %32, i32 %31, i32 27), !taffo.info !214
  %div30.u2_30fixp = shl i32 %33, 3, !taffo.info !216, !taffo.constinfo !217
  %conv31.u1_31fixp = shl i32 %div30.u2_30fixp, 1, !taffo.info !218, !taffo.constinfo !217
  %arrayidx32.u1_31fixp = getelementptr inbounds i32, i32* %y.u1_31fixp, i32 %i.0, !taffo.info !220
  ...
  %34 = lshr i32 %conv34.u5_27fixp, 1, !taffo.info !183, !taffo.constinfo !25
  %35 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !170
  %36 = call i32 @llvm.sdiv.fix.i32(i32 %34, i32 %35, i32 26), !taffo.info !184
  %div35.u2_30fixp = shl i32 %36, 4, !taffo.info !186
  %37 = lshr i32 %div35.u2_30fixp, 1, !taffo.info !186
  %38 = shl i32 9, 27
  %39 = ashr i32 %37, 2, !taffo.info !186
  %40 = call i32 @llvm.sdiv.fix.i32(i32 %39, i32 %38, i32 27), !taffo.info !221
  %div37.u2_30fixp = shl i32 %40, 3, !taffo.info !223, !taffo.constinfo !224
  %conv38.u1_31fixp = shl i32 %div37.u2_30fixp, 1, !taffo.info !227, !taffo.constinfo !224
  %arrayidx39.u1_31fixp = getelementptr inbounds i32, i32* %z.u1_31fixp, i32 %i.0, !taffo.info !229
  store i32 %conv38.u1_31fixp, i32* %arrayidx39.u1_31fixp, align 4, !taffo.info !181
  %arrayidx40.u8_24fixp = getelementptr inbounds i32, i32* %x.u8_24fixp, i32 %i.0, !taffo.info !230
  store i32 0, i32* %arrayidx40.u8_24fixp, align 4, !taffo.info !181, !taffo.constinfo !231
  %arrayidx41.u17_15fixp = getelementptr inbounds i32, i32* %w.u17_15fixp, i32 %i.0, !taffo.info !232
  store i32 0, i32* %arrayidx41.u17_15fixp, align 4, !taffo.info !181, !taffo.constinfo !231
  br label %for.cond42
...
for.body45:                                       ; preds = %for.cond42
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !233, !taffo.initweight !175
  %rem = srem i32 %mul, %n, !taffo.info !235, !taffo.initweight !176
  %conv46.u5_27fixp = shl i32 %rem, 27, !taffo.info !237
  %conv47.u5_27fixp = shl i32 %n, 27, !taffo.info !170
  %41 = lshr i32 %conv46.u5_27fixp, 1, !taffo.info !237
  %42 = lshr i32 %conv47.u5_27fixp, 1, !taffo.info !170
  %43 = call i32 @llvm.sdiv.fix.i32(i32 %41, i32 %42, i32 26), !taffo.info !238
  %div48.u1_31fixp = shl i32 %43, 5, !taffo.info !240
  %arrayidx49.u5_27fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u5_27fixp, i32 %i.0, !taffo.info !241
  %arrayidx50.u5_27fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx49.u5_27fixp, i32 0, i32 %j.0, !taffo.info !241
  %44 = lshr i32 %div48.u1_31fixp, 4, !taffo.info !240
  store i32 %44, i32* %arrayidx50.u5_27fixp, align 4, !taffo.info !181
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemver.10_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u5_27fixp, i32* noundef %u1.u4_28fixp, i32* noundef %v1.u2_30fixp, i32* noundef %u2.u3_29fixp, i32* noundef %v2.u2_30fixp, i32* noundef %w.u17_15fixp, i32* noundef %x.u8_24fixp, i32* noundef %y.u1_31fixp, i32* noundef %z.u1_31fixp) #0 !taffo.initweight !244 !taffo.funinfo !163 !taffo.sourceFunction !245 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u5_27fixp = load i32, i32* %arrayidx4.u5_27fixp, align 4, !taffo.info !246
  %arrayidx5.u4_28fixp = getelementptr inbounds i32, i32* %u1.u4_28fixp, i32 %i.0, !taffo.info !54
  %u4_28fixp = load i32, i32* %arrayidx5.u4_28fixp, align 4, !taffo.info !247
  ...
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !247
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !57
  %2 = ashr i32 %0, 2, !taffo.info !247
  %3 = ashr i32 %1, 4, !taffo.info !57
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 25), !taffo.info !248
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !250
  %5 = lshr i32 %u5_27fixp, 1, !taffo.info !246
  %add.u6_26fixp = add i32 %5, %mul.u6_26fixp, !taffo.info !251
  ...
  %u2_30fixp1 = load i32, i32* %arrayidx8.u2_30fixp, align 4, !taffo.info !253
  %6 = lshr i32 %u3_29fixp, 1, !taffo.info !59
  %7 = lshr i32 %u2_30fixp1, 1, !taffo.info !253
  %8 = ashr i32 %7, 1, !taffo.info !253
  %9 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %8, i32 28), !taffo.info !254
  %mul9.u3_29fixp = shl i32 %9, 1, !taffo.info !256
  %10 = lshr i32 %mul9.u3_29fixp, 3, !taffo.info !256
  %add10.u6_26fixp = add i32 %add.u6_26fixp, %10, !taffo.info !257
  ...
  %11 = shl i32 %add10.u6_26fixp, 1, !taffo.info !257
...
for.body21:                                       ; preds = %for.cond19
  ...
  %15 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %13, i32 26), !taffo.info !261
  %mul25.u5_27fixp = shl i32 %15, 1, !taffo.info !263
  ...
  %16 = lshr i32 %mul25.u5_27fixp, 1, !taffo.info !263
  %17 = lshr i32 %u1_31fixp, 1, !taffo.info !69
  %18 = ashr i32 %17, 4, !taffo.info !69
  %19 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %18, i32 26), !taffo.info !261
  %mul27.u5_27fixp = shl i32 %19, 1, !taffo.info !263
  %20 = lshr i32 %mul27.u5_27fixp, 3, !taffo.info !263
  %add28.u8_24fixp = add i32 %u8_24fixp, %20, !taffo.info !264
...
for.inc30:                                        ; preds = %for.body21
  ...
  br label %for.cond19, !llvm.loop !266
...
for.inc33:                                        ; preds = %for.end32
  ...
  br label %for.cond16, !llvm.loop !267
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u8_24fixp = add i32 %u8_24fixp2, %21, !taffo.info !268
...
for.inc43:                                        ; preds = %for.body38
  ...
  br label %for.cond36, !llvm.loop !270
...
for.body51:                                       ; preds = %for.cond49
  ...
  %u5_27fixp6 = load i32, i32* %arrayidx54.u5_27fixp, align 4, !taffo.info !246
  %22 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !47
  %23 = lshr i32 %u5_27fixp6, 1, !taffo.info !246
  %24 = ashr i32 %22, 4, !taffo.info !47
  %25 = ashr i32 %23, 1, !taffo.info !246
  %26 = call i32 @llvm.smul.fix.i32(i32 %24, i32 %25, i32 25), !taffo.info !271
  %mul55.u6_26fixp = shl i32 %26, 1, !taffo.info !273
  ...
  %27 = lshr i32 %mul55.u6_26fixp, 1, !taffo.info !273
  %28 = lshr i32 %u8_24fixp3, 1, !taffo.info !67
  %29 = ashr i32 %27, 7, !taffo.info !273
  %30 = ashr i32 %28, 5, !taffo.info !67
  %31 = call i32 @llvm.smul.fix.i32(i32 %29, i32 %30, i32 18), !taffo.info !274
  %mul57.u13_19fixp = shl i32 %31, 1, !taffo.info !277
  %32 = lshr i32 %mul57.u13_19fixp, 4, !taffo.info !277
  %add58.u17_15fixp = add i32 %u17_15fixp, %32, !taffo.info !279
...
for.inc60:                                        ; preds = %for.body51
  ...
  br label %for.cond49, !llvm.loop !281
...
for.inc63:                                        ; preds = %for.end62
  ...
  br label %for.cond46, !llvm.loop !282
...
!126 = distinct !{!126, !27}
!127 = !{i32 1, !103, i32 1, !69, i32 1, !115}
!128 = !{!55, !116, i1 false, i2 1}
!129 = !{!130, !131, i1 false, i2 -1}
!130 = !{!"fixp", i32 -32, i32 27}
!131 = !{double 4.000000e-01, double 8.000000e+00}
!132 = !{!55, !131, i1 false, i2 -1}
!133 = distinct !{!133, !27}
!134 = !{i32 1, !103, i32 1, !59, i32 1, !115}
!135 = !{!136, !116, i1 false, i2 1}
!136 = !{!"fixp", i32 32, i32 26}
!137 = !{!138, !139, i1 false, i2 -1}
!138 = !{!"fixp", i32 -32, i32 25}
!139 = !{double 1.600000e+00, double 3.200000e+01}
!140 = !{!136, !139, i1 false, i2 -1}
!141 = distinct !{!141, !27}
!142 = !{i32 1, !103, i32 1, !64, i32 1, !115}
!143 = !{!144, !145, i1 false, i2 -1}
!144 = !{!"fixp", i32 -32, i32 11}
!145 = !{double 0.000000e+00, double 0x41201ADA40000000}
!146 = !{!147, !145, i1 false, i2 -1}
!147 = !{!"fixp", i32 32, i32 12}
!148 = distinct !{!148, !27}
!149 = !{i32 1, !103, i32 1, !54, i32 1, !115}
!150 = !{!136, !56, i1 false, i2 -1}
!151 = !{!138, !152, i1 false, i2 -1}
!152 = !{double 0.000000e+00, double 6.080000e+01}
!153 = !{!136, !152, i1 false, i2 -1}
!154 = distinct !{!154, !27}
!155 = !{i32 1, !103, i32 1, !67, i32 1, !115}
!156 = !{!157, !158, i1 false, i2 -1}
!157 = !{!"fixp", i32 -32, i32 20}
!158 = !{double 0.000000e+00, double 0x409A5F011F4F50A0}
!159 = !{!160, !158, i1 false, i2 -1}
!160 = !{!"fixp", i32 32, i32 21}
!161 = distinct !{!161, !27}
!162 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!163 = !{i32 1, !103, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !59, i32 1, !62, i32 1, !64, i32 1, !67, i32 1, !69, i32 1, !72}
!164 = distinct !{null}
!165 = !{!166, i1 false}
...
!175 = !{i32 2}
!176 = !{i32 3}
!177 = !{!53, !172, i1 false, i2 -1}
!178 = !{!123, !93, i1 false, i2 1}
!179 = !{!70, !93, i1 false, i2 1}
!180 = !{!55, !56, i1 false, i2 1}
!181 = !{i1 false, i1 false, i1 false, i2 1}
!182 = !{i1 false, !100, i1 false, i2 -1}
!183 = !{!53, !100, i1 false, i2 -1}
!184 = !{!123, !185, i1 false, i2 1}
...
!191 = !{i1 false, !23}
!192 = !{!70, !193, i1 false, i2 1}
!193 = !{double 0x3F99999980000000, double 0x3FE0CCCCE0000000}
!194 = !{!60, !61, i1 false, i2 1}
!195 = !{!196, !197, i1 false, i2 1}
!196 = !{!"fixp", i32 -32, i32 28}
!197 = !{double 1.250000e-02, double 2.625000e-01}
!198 = !{!48, !197, i1 false, i2 1}
!199 = !{i1 false, !200}
!200 = !{i1 false, !201, i1 false, i2 0}
!201 = !{double 4.000000e+00, double 4.000000e+00}
!202 = !{!70, !203, i1 false, i2 1}
!203 = !{double 0x3F89999980000000, double 0x3FD0CCCCE0000000}
!204 = !{!48, !58, i1 false, i2 1}
!205 = !{!196, !206, i1 false, i2 1}
!206 = !{double 0x3F81111111111111, double 0x3FC6666666666667}
!207 = !{!48, !206, i1 false, i2 1}
!208 = !{i1 false, !209}
!209 = !{i1 false, !210, i1 false, i2 0}
!210 = !{double 6.000000e+00, double 6.000000e+00}
!211 = !{!70, !212, i1 false, i2 1}
!212 = !{double 0x3F81111100000000, double 0x3FC6666680000000}
!213 = !{!48, !63, i1 false, i2 1}
!214 = !{!130, !215, i1 false, i2 1}
!215 = !{double 6.250000e-03, double 1.312500e-01}
!216 = !{!48, !215, i1 false, i2 1}
!217 = !{i1 false, !115}
!218 = !{!70, !219, i1 false, i2 1}
!219 = !{double 0x3F79999980000000, double 0x3FC0CCCCE0000000}
!220 = !{!70, !71, i1 false, i2 1}
!221 = !{!130, !222, i1 false, i2 1}
...
!227 = !{!70, !228, i1 false, i2 1}
!228 = !{double 0x3F76C16C00000000, double 0x3FBDDDDDE0000000}
!229 = !{!70, !73, i1 false, i2 1}
!230 = !{!68, !1, i1 false, i2 1}
!231 = !{!107, i1 false}
!232 = !{!65, !3, i1 false, i2 1}
...
!237 = !{!53, !236, i1 false, i2 -1}
!238 = !{!123, !239, i1 false, i2 -1}
!239 = !{double 0.000000e+00, double 0x3FEE666666666666}
!240 = !{!70, !239, i1 false, i2 -1}
!241 = !{!53, !5, i1 false, i2 1}
!242 = distinct !{!242, !27}
!243 = distinct !{!243, !27}
!244 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!245 = distinct !{null}
!246 = !{!136, !5, i1 false, i2 -1}
!247 = !{!53, !56, i1 false, i2 -1}
!248 = !{!138, !249, i1 false, i2 -1}
!249 = !{double 0.000000e+00, double 1.520000e+01}
!250 = !{!136, !249, i1 false, i2 -1}
!251 = !{!136, !252, i1 false, i2 -1}
!252 = !{double 0.000000e+00, double 0x40422AAAB8A5CE5B}
!253 = !{!60, !63, i1 false, i2 -1}
!254 = !{!196, !255, i1 false, i2 -1}
!255 = !{double 0x3F8B4E8AA78E4EE4, double 0x40155554FBDAD752}
!256 = !{!60, !255, i1 false, i2 -1}
!257 = !{!136, !258, i1 false, i2 -1}
!258 = !{double 0x3F8B4E8AA78E4EE4, double 0x4044D55558212945}
!259 = distinct !{!259, !27}
!260 = distinct !{!260, !27}
!261 = !{!123, !262, i1 false, i2 -1}
!262 = !{double 0.000000e+00, double 0x40395C2917507E9D}
!263 = !{!53, !262, i1 false, i2 -1}
!264 = !{!68, !265, i1 false, i2 -1}
!265 = !{double 0.000000e+00, double 0x406D8A8642396074}
!266 = distinct !{!266, !27}
!267 = distinct !{!267, !27}
!268 = !{!68, !269, i1 false, i2 -1}
!269 = !{double 4.444400e-02, double 0x406A7B72E6A76966}
!270 = distinct !{!270, !27}
!271 = !{!138, !272, i1 false, i2 -1}
!272 = !{double 0.000000e+00, double 0x403FB3335D249E44}
!273 = !{!136, !272, i1 false, i2 -1}
!274 = !{!275, !276, i1 false, i2 -1}
!275 = !{!"fixp", i32 -32, i32 18}
!276 = !{double 0.000000e+00, double 0x40BA1FB6D8C80C3E}
!277 = !{!278, !276, i1 false, i2 -1}
!278 = !{!"fixp", i32 32, i32 19}
!279 = !{!65, !280, i1 false, i2 -1}
!280 = !{double 0.000000e+00, double 0x40F1BCD5AD8C80C4}
!281 = distinct !{!281, !27}
!282 = distinct !{!282, !27}
