; ModuleID = './build/bin/fixed/gemm/8/gemm-standard-64-fixed-8.out.ll'
...
entry:
  ...
  %u6_26fixp2 = bitcast [16 x i32]* %arraydecay9.u6_26fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u6_26fixp2, i32 64), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u6_26fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u6_26fixp, i32 0, i32 0, !taffo.info !53
  %u6_26fixp = bitcast [12 x i32]* %arraydecay10.u6_26fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u6_26fixp, i32 64), !taffo.info !62, !taffo.constinfo !60
