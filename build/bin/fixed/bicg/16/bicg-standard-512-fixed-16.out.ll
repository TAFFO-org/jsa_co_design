; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-512-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %1, %3, !taffo.info !93
  %arrayidx1.u21_11fixp = getelementptr inbounds i32, i32* %val.u21_11fixp, i32 %i.0, !taffo.info !47
  %4 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !93
  %5 = fptoui float %4 to i32, !taffo.info !93
