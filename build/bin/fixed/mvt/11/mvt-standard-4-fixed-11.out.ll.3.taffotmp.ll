; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-4-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,3.8) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [48 x i8] c"target('x1') scalar(range(0.0,81.799995) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [48 x i8] c"target('x2') scalar(range(0.0,81.599998) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 4), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 4), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 4), !taffo.initweight !58, !taffo.info !55, !taffo.target !56, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 4), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 4), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x405473331E3A7DAA}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x405466665E02EA96}
...
!52 = !{double 0.000000e+00, double 3.800000e+00}
...
!103 = !{double 4.000000e+00, double 4.000000e+00}
!104 = !{i32 6}
!105 = !{i32 7}
!106 = !{i1 false, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 0x407473331E3A7DAA}
!108 = distinct !{!108, !31}
!109 = !{i32 1, !91, i32 1, !55, i32 1, !102}
!110 = !{i1 false, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x407466665E02EA96}
!112 = distinct !{!112, !31}
!113 = !{i32 1, !91, i32 1, !51, i32 1, !102}
!114 = !{i1 false, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 1.520000e+01}
!116 = distinct !{!116, !31}
...
!120 = !{double 0.000000e+00, double 1.444000e+01}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x40580F5C13FD0D06}
!123 = distinct !{!123, !31}
!124 = distinct !{!124, !31}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4058028F53C579F2}
!127 = distinct !{!127, !31}
!128 = distinct !{!128, !31}
!129 = distinct !{!129, !31}
