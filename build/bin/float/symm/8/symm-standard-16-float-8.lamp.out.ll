; ModuleID = './build/bin/float/symm/8/symm-standard-16-float-8.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, ptr noundef %arraydecay3, i32 noundef 16)
  %arraydecay4 = getelementptr inbounds [10 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 10, ptr noundef %arraydecay4, i32 noundef 16)
  %arraydecay5 = getelementptr inbounds [10 x [16 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 16, ptr noundef %arraydecay5, i32 noundef 16)
