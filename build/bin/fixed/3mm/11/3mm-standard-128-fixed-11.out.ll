; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-128-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u5_27fixp = bitcast [8 x i32]* %arraydecay16.u5_27fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u5_27fixp, i32 128), !taffo.info !63, !taffo.constinfo !61
  ...
  %u5_27fixp3 = bitcast [14 x i32]* %arraydecay18.u5_27fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u5_27fixp3, i32 128), !taffo.info !65, !taffo.constinfo !61
  %arraydecay19.u5_27fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u5_27fixp, i32 0, i32 0, !taffo.info !54
  %u5_27fixp2 = bitcast [12 x i32]* %arraydecay19.u5_27fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u5_27fixp2, i32 128), !taffo.info !66, !taffo.constinfo !61
...
for.body30:                                       ; preds = %for.cond28
  ...
  %1 = fdiv float %0, 2.560000e+02, !taffo.info !56, !taffo.target !58
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 12), !taffo.info !235
  %mul.u19_13fixp = shl i32 %5, 1, !taffo.info !238
  ...
  %7 = shl i32 %mul.u19_13fixp, 7, !taffo.info !238
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u24_8fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !242 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 2.560000e+02, !taffo.info !56
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !233
  %3 = uitofp i32 %conv.u8_24fixp to float, !taffo.info !233
  %4 = fdiv float %3, 0x4170000000000000, !taffo.info !233
  ...
  %6 = fmul float 2.560000e+02, %mul.1flp, !taffo.info !243
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !248 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !249
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !251
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u12_20fixp, 7, !taffo.info !251
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !254 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !255
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !258
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u18_14fixp, 7, !taffo.info !258
...
!236 = !{!"fixp", i32 -32, i32 12}
!237 = !{double 0.000000e+00, double 0x4110624DE00D1B71}
...
!244 = !{!"float", i32 1, double 0x41DBCB0680000000}
!245 = !{double 0.000000e+00, double 0x41DBCB0680000000}
!246 = distinct !{!246, !23}
!247 = distinct !{!247, !23}
!248 = !{i32 1, !83, i32 1, !16, i32 1, !44, i32 1, !230}
!249 = !{!115, !250, i1 false, i2 -1}
!250 = !{double 0.000000e+00, double 0x40A555556084A516}
!251 = !{!50, !250, i1 false, i2 -1}
!252 = distinct !{!252, !23}
!253 = distinct !{!253, !23}
!254 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !230}
!255 = !{!256, !257, i1 false, i2 -1}
!256 = !{!"fixp", i32 -32, i32 13}
!257 = !{double 0.000000e+00, double 0x410BBBBBE0157EED}
!258 = !{!259, !257, i1 false, i2 -1}
!259 = !{!"fixp", i32 32, i32 14}
!260 = distinct !{!260, !23}
!261 = distinct !{!261, !23}
