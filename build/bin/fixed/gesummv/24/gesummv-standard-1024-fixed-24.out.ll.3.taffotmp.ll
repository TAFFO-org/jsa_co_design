; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-1024-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,960.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,4620288.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [48 x i8] c"target('y') scalar(range(0.0,11875124.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.initweight !60, !taffo.info !50, !taffo.originalCall !63, !taffo.constinfo !64
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 1024), !taffo.initweight !60, !taffo.info !52, !taffo.originalCall !63, !taffo.constinfo !64
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 1024), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 1024), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.initweight !60, !taffo.info !56
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 1024), !taffo.initweight !65, !taffo.info !56, !taffo.originalCall !69, !taffo.constinfo !70
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.initweight !60, !taffo.info !54
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 1024), !taffo.initweight !65, !taffo.info !54, !taffo.originalCall !69, !taffo.constinfo !70
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 1024), !taffo.initweight !65, !taffo.info !58, !taffo.target !59, !taffo.originalCall !69, !taffo.constinfo !70
...
for.body:                                         ; preds = %for.cond
  ...
  %div = fdiv float %conv, %conv3, !taffo.initweight !90, !taffo.info !149
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.initweight !65, !taffo.info !151
  store float %div, float* %arrayidx, align 4, !taffo.initweight !66, !taffo.info !91
  %arrayidx4 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.initweight !65, !taffo.info !152
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !66, !taffo.info !91, !taffo.constinfo !92
  %arrayidx5 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.initweight !65, !taffo.info !153
  store float 0.000000e+00, float* %arrayidx5, align 4, !taffo.initweight !66, !taffo.info !91, !taffo.constinfo !92
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !65, !taffo.info !154
  %add = add nsw i32 %mul, 1, !taffo.initweight !66, !taffo.info !156, !taffo.constinfo !27
  ...
  %div13 = fdiv float %conv11, %conv12, !taffo.initweight !96, !taffo.info !149
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.0, !taffo.initweight !65, !taffo.info !151
  %arrayidx15 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.initweight !65, !taffo.info !151
  store float %div13, float* %arrayidx15, align 4, !taffo.initweight !66, !taffo.info !91
  %mul16 = mul nsw i32 %i.0, %j.0, !taffo.initweight !65, !taffo.info !154
  %add17 = add nsw i32 %mul16, 2, !taffo.initweight !66, !taffo.info !158, !taffo.constinfo !27
  ...
  %div21 = fdiv float %conv19, %conv20, !taffo.initweight !96, !taffo.info !149
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !65, !taffo.info !151
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.0, !taffo.initweight !65, !taffo.info !151
  store float %div21, float* %arrayidx23, align 4, !taffo.initweight !66, !taffo.info !91
  br label %for.inc

for.inc:                                          ; preds = %for.body9
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !65, !taffo.info !160, !taffo.constinfo !27
  br label %for.cond6, !llvm.loop !161

for.end:                                          ; preds = %for.cond6
  br label %for.inc24

for.inc24:                                        ; preds = %for.end
  %inc25 = add nsw i32 %i.0, 1, !taffo.initweight !65, !taffo.info !160, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !163 !taffo.funinfo !164 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !165, !taffo.info !54
  %conv = sitofp i32 %factor to float, !taffo.info !110
  %mul = fmul float %1, %conv, !taffo.initweight !166, !taffo.info !120
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !165, !taffo.info !54
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !163 !taffo.funinfo !164 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
!7 = !{double 0.000000e+00, double 0x4166A66680000000}
...
!55 = !{double 0.000000e+00, double 9.600000e+02}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x4151A00000000000}
...
!117 = !{double 0.000000e+00, double 0x41F1A00000000000}
!118 = distinct !{!118, !29}
!119 = !{i32 1, !103, i32 1, !54, i32 1, !110}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 9.830400e+05}
!122 = distinct !{!122, !29}
...
!126 = !{double 0.000000e+00, double 9.216000e+05}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x4155240000000000}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x4168686680000000}
!131 = distinct !{!131, !29}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x415A700000000000}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x416B2E1499999999}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x4174330A4CCCCCCC}
!138 = distinct !{!138, !29}
!139 = !{i32 1, !103, i32 1, !58, i32 1, !110}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x4206A66680000000}
!142 = distinct !{!142, !29}
...
!151 = !{i1 false, !55, i1 false, i2 1}
!152 = !{i1 false, !7, i1 false, i2 1}
!153 = !{i1 false, !57, i1 false, i2 1}
!154 = !{i1 false, !155, i1 false, i2 1}
!155 = !{double 0.000000e+00, double 2.560000e+02}
!156 = !{i1 false, !157, i1 false, i2 1}
!157 = !{double 1.000000e+00, double 2.570000e+02}
!158 = !{i1 false, !159, i1 false, i2 1}
!159 = !{double 2.000000e+00, double 2.580000e+02}
!160 = !{i1 false, !78, i1 false, i2 1}
!161 = distinct !{!161, !29}
!162 = distinct !{!162, !29}
!163 = !{i32 -1, i32 -1, i32 3, i32 -1}
!164 = !{i32 1, !103, i32 1, !103, i32 1, !54, i32 1, !110}
!165 = !{i32 8}
!166 = !{i32 9}
!167 = distinct !{!167, !29}
!168 = distinct !{!168, !29}
