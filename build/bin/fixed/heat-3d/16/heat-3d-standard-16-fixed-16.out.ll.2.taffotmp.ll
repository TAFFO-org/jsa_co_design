; ModuleID = './build/bin/fixed/heat-3d/16/heat-3d-standard-16-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 16), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !36
  ...
  call void @scale_3d.4(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %2, i32 noundef 16), !taffo.initweight !35, !taffo.info !30, !taffo.originalCall !36
...
!31 = !{double 3.200000e+01, double 4.160000e+02}
!32 = !{i32 1}
!33 = !{i32 2}
