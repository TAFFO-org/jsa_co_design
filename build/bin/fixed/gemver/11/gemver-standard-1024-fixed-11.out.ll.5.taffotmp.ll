; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-1024-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !150
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 8.000000e+00, %mul.1flp, !taffo.info !161
