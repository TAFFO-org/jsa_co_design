; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-512-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 6.400000e+01, !taffo.info !69
...
for.body43:                                       ; preds = %for.cond41
  ...
  %3 = fdiv float %2, 3.276800e+04, !taffo.info !52
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !127
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !130
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u16_16fixp, 9, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !133 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !134
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !137
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u18_14fixp, 9, !taffo.info !137
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !140 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !141
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !142
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !125
  %0 = uitofp i32 %conv.u10_22fixp to float, !taffo.info !125
  %1 = fdiv float %0, 0x4150000000000000, !taffo.info !125
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !143
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !141
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !147 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 14), !taffo.info !148
  %mul.u17_15fixp = shl i32 %4, 1, !taffo.info !151
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u17_15fixp, 9, !taffo.info !151
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !153 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !154
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !157
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u15_17fixp, 9, !taffo.info !157
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u26_6fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !160 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %2, 0x4150000000000000, !taffo.info !125
  %mul.1flp = fmul float %1, %3, !taffo.info !161
  %arrayidx1.u26_6fixp = getelementptr inbounds i32, i32* %val.u26_6fixp, i32 %i.0, !taffo.info !69
  %4 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !161
  %5 = fptoui float %4 to i32, !taffo.info !161
...
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !77, !taffo.constinfo !168
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !80, !taffo.constinfo !170
  %conv.u5_27fixp = shl i32 %n, 27, !taffo.info !173
  br label %for.cond

for.cond:                                         ; preds = %for.inc51, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc52, %for.inc51 ], !taffo.info !175, !taffo.initweight !67
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !177, !taffo.initweight !97
  br i1 %cmp, label %for.body, label %for.end53, !taffo.info !175, !taffo.initweight !178

for.body:                                         ; preds = %for.cond
  %conv5.u5_27fixp = shl i32 %i.0, 27, !taffo.info !179
  %0 = lshr i32 %conv5.u5_27fixp, 1, !taffo.info !179
  %1 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !173
  %2 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %1, i32 26), !taffo.info !180
  %div.u1_31fixp = shl i32 %2, 5, !taffo.info !182
  %arrayidx.u9_23fixp = getelementptr inbounds i32, i32* %u1.u9_23fixp, i32 %i.0, !taffo.info !184
  %3 = lshr i32 %div.u1_31fixp, 8, !taffo.info !182
  store i32 %3, i32* %arrayidx.u9_23fixp, align 4, !taffo.info !185
  %add = add nsw i32 %i.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
  %conv6.u5_27fixp = shl i32 %add, 27, !taffo.info !187, !taffo.constinfo !25
  %4 = lshr i32 %conv6.u5_27fixp, 1, !taffo.info !187, !taffo.constinfo !25
  %5 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !173
  %6 = call i32 @llvm.sdiv.fix.i32(i32 %4, i32 %5, i32 26), !taffo.info !188
  %div7.u2_30fixp = shl i32 %6, 4, !taffo.info !190
  %7 = lshr i32 %div7.u2_30fixp, 1, !taffo.info !190
  %8 = shl i32 2, 29
  %9 = call i32 @llvm.sdiv.fix.i32(i32 %7, i32 %8, i32 29), !taffo.info !191
  %div9.u2_30fixp = shl i32 %9, 1, !taffo.info !194, !taffo.constinfo !195
  %conv10.u1_31fixp = shl i32 %div9.u2_30fixp, 1, !taffo.info !196, !taffo.constinfo !195
  %arrayidx11.u9_23fixp = getelementptr inbounds i32, i32* %u2.u9_23fixp, i32 %i.0, !taffo.info !198
  %10 = lshr i32 %conv10.u1_31fixp, 8, !taffo.info !196, !taffo.constinfo !195
  store i32 %10, i32* %arrayidx11.u9_23fixp, align 4, !taffo.info !185
  %add12 = add nsw i32 %i.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
  %conv13.u5_27fixp = shl i32 %add12, 27, !taffo.info !187, !taffo.constinfo !25
  %11 = lshr i32 %conv13.u5_27fixp, 1, !taffo.info !187, !taffo.constinfo !25
  %12 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !173
  %13 = call i32 @llvm.sdiv.fix.i32(i32 %11, i32 %12, i32 26), !taffo.info !188
  %div14.u2_30fixp = shl i32 %13, 4, !taffo.info !190
  %14 = lshr i32 %div14.u2_30fixp, 1, !taffo.info !190
  %15 = shl i32 4, 28
  %16 = ashr i32 %14, 1, !taffo.info !190
  %17 = call i32 @llvm.sdiv.fix.i32(i32 %16, i32 %15, i32 28), !taffo.info !199
  %div16.u2_30fixp = shl i32 %17, 2, !taffo.info !202, !taffo.constinfo !203
  %conv17.u1_31fixp = shl i32 %div16.u2_30fixp, 1, !taffo.info !206, !taffo.constinfo !203
  %arrayidx18.u8_24fixp = getelementptr inbounds i32, i32* %v1.u8_24fixp, i32 %i.0, !taffo.info !208
  %18 = lshr i32 %conv17.u1_31fixp, 7, !taffo.info !206, !taffo.constinfo !203
  store i32 %18, i32* %arrayidx18.u8_24fixp, align 4, !taffo.info !185
  %add19 = add nsw i32 %i.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
  %conv20.u5_27fixp = shl i32 %add19, 27, !taffo.info !187, !taffo.constinfo !25
  %19 = lshr i32 %conv20.u5_27fixp, 1, !taffo.info !187, !taffo.constinfo !25
  %20 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !173
  %21 = call i32 @llvm.sdiv.fix.i32(i32 %19, i32 %20, i32 26), !taffo.info !188
  %div21.u2_30fixp = shl i32 %21, 4, !taffo.info !190
  %22 = lshr i32 %div21.u2_30fixp, 1, !taffo.info !190
  %23 = shl i32 6, 28
  %24 = ashr i32 %22, 1, !taffo.info !190
  %25 = call i32 @llvm.sdiv.fix.i32(i32 %24, i32 %23, i32 28), !taffo.info !209
  %div23.u2_30fixp = shl i32 %25, 2, !taffo.info !211, !taffo.constinfo !212
  %conv24.u1_31fixp = shl i32 %div23.u2_30fixp, 1, !taffo.info !215, !taffo.constinfo !212
  %arrayidx25.u7_25fixp = getelementptr inbounds i32, i32* %v2.u7_25fixp, i32 %i.0, !taffo.info !217
  %26 = lshr i32 %conv24.u1_31fixp, 6, !taffo.info !215, !taffo.constinfo !212
  store i32 %26, i32* %arrayidx25.u7_25fixp, align 4, !taffo.info !185
  %add26 = add nsw i32 %i.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
  %conv27.u5_27fixp = shl i32 %add26, 27, !taffo.info !187, !taffo.constinfo !25
  %27 = lshr i32 %conv27.u5_27fixp, 1, !taffo.info !187, !taffo.constinfo !25
  %28 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !173
  %29 = call i32 @llvm.sdiv.fix.i32(i32 %27, i32 %28, i32 26), !taffo.info !188
  %div28.u2_30fixp = shl i32 %29, 4, !taffo.info !190
  %30 = lshr i32 %div28.u2_30fixp, 1, !taffo.info !190
  %31 = shl i32 8, 27
  %32 = ashr i32 %30, 2, !taffo.info !190
  %33 = call i32 @llvm.sdiv.fix.i32(i32 %32, i32 %31, i32 27), !taffo.info !218
  %div30.u2_30fixp = shl i32 %33, 3, !taffo.info !221, !taffo.constinfo !222
  %conv31.u1_31fixp = shl i32 %div30.u2_30fixp, 1, !taffo.info !225, !taffo.constinfo !222
  %arrayidx32.u7_25fixp = getelementptr inbounds i32, i32* %y.u7_25fixp, i32 %i.0, !taffo.info !227
  %34 = lshr i32 %conv31.u1_31fixp, 6, !taffo.info !225, !taffo.constinfo !222
  store i32 %34, i32* %arrayidx32.u7_25fixp, align 4, !taffo.info !185
  %add33 = add nsw i32 %i.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
  %conv34.u5_27fixp = shl i32 %add33, 27, !taffo.info !187, !taffo.constinfo !25
  %35 = lshr i32 %conv34.u5_27fixp, 1, !taffo.info !187, !taffo.constinfo !25
  %36 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !173
  %37 = call i32 @llvm.sdiv.fix.i32(i32 %35, i32 %36, i32 26), !taffo.info !188
  %div35.u2_30fixp = shl i32 %37, 4, !taffo.info !190
  %38 = lshr i32 %div35.u2_30fixp, 1, !taffo.info !190
  %39 = shl i32 9, 27
  %40 = ashr i32 %38, 2, !taffo.info !190
  %41 = call i32 @llvm.sdiv.fix.i32(i32 %40, i32 %39, i32 27), !taffo.info !228
  %div37.u2_30fixp = shl i32 %41, 3, !taffo.info !230, !taffo.constinfo !231
  %conv38.u1_31fixp = shl i32 %div37.u2_30fixp, 1, !taffo.info !234, !taffo.constinfo !231
  %arrayidx39.u6_26fixp = getelementptr inbounds i32, i32* %z.u6_26fixp, i32 %i.0, !taffo.info !236
  %42 = lshr i32 %conv38.u1_31fixp, 5, !taffo.info !234, !taffo.constinfo !231
  store i32 %42, i32* %arrayidx39.u6_26fixp, align 4, !taffo.info !185
  %arrayidx40.u26_6fixp = getelementptr inbounds i32, i32* %x.u26_6fixp, i32 %i.0, !taffo.info !237
  store i32 0, i32* %arrayidx40.u26_6fixp, align 4, !taffo.info !185, !taffo.constinfo !238
  %arrayidx41.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.0, !taffo.info !239, !taffo.initweight !97
  store float 0.000000e+00, float* %arrayidx41.flt.1flp, align 4, !taffo.info !185, !taffo.constinfo !238
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !175, !taffo.initweight !67
  %cmp43 = icmp slt i32 %j.0, %n, !taffo.info !177, !taffo.initweight !97
  br i1 %cmp43, label %for.body45, label %for.end, !taffo.info !175, !taffo.initweight !178

for.body45:                                       ; preds = %for.cond42
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !240, !taffo.initweight !97
  %rem = srem i32 %mul, %n, !taffo.info !242, !taffo.initweight !178
  %conv46.u5_27fixp = shl i32 %rem, 27, !taffo.info !244
  %conv47.u5_27fixp = shl i32 %n, 27, !taffo.info !173
  %43 = lshr i32 %conv46.u5_27fixp, 1, !taffo.info !244
  %44 = lshr i32 %conv47.u5_27fixp, 1, !taffo.info !173
  %45 = call i32 @llvm.sdiv.fix.i32(i32 %43, i32 %44, i32 26), !taffo.info !245
  %div48.u1_31fixp = shl i32 %45, 5, !taffo.info !247
  %arrayidx49.u17_15fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u17_15fixp, i32 %i.0, !taffo.info !248
  %arrayidx50.u17_15fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx49.u17_15fixp, i32 0, i32 %j.0, !taffo.info !248
  %46 = lshr i32 %div48.u1_31fixp, 16, !taffo.info !247
  store i32 %46, i32* %arrayidx50.u17_15fixp, align 4, !taffo.info !185
  br label %for.inc

for.inc:                                          ; preds = %for.body45
  %inc = add nsw i32 %j.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
  br label %for.cond42, !llvm.loop !249

for.end:                                          ; preds = %for.cond42
  br label %for.inc51

for.inc51:                                        ; preds = %for.end
  %inc52 = add nsw i32 %i.0, 1, !taffo.info !186, !taffo.initweight !97, !taffo.constinfo !25
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemver.10_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u17_15fixp, i32* noundef %u1.u9_23fixp, i32* noundef %v1.u8_24fixp, i32* noundef %u2.u9_23fixp, i32* noundef %v2.u7_25fixp, float* noundef %w, i32* noundef %x.u26_6fixp, i32* noundef %y.u7_25fixp, i32* noundef %z.u6_26fixp) #0 !taffo.initweight !251 !taffo.funinfo !166 !taffo.sourceFunction !252 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u17_15fixp = load i32, i32* %arrayidx4.u17_15fixp, align 4, !taffo.info !253
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !254
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !256
  %5 = lshr i32 %u17_15fixp, 1, !taffo.info !253
  %add.u18_14fixp = add i32 %5, %mul.u18_14fixp, !taffo.info !257
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 16), !taffo.info !259
  %mul9.u15_17fixp = shl i32 %10, 1, !taffo.info !261
  %11 = lshr i32 %mul9.u15_17fixp, 3, !taffo.info !261
  %add10.u18_14fixp = add i32 %add.u18_14fixp, %11, !taffo.info !262
  ...
  %12 = shl i32 %add10.u18_14fixp, 1, !taffo.info !262
...
for.body21:                                       ; preds = %for.cond19
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 14), !taffo.info !266
  %mul25.u17_15fixp = shl i32 %16, 1, !taffo.info !268
  ...
  %17 = lshr i32 %mul25.u17_15fixp, 1, !taffo.info !268
  %18 = lshr i32 %u7_25fixp4, 1, !taffo.info !71
  %19 = ashr i32 %17, 6, !taffo.info !268
  %20 = ashr i32 %18, 16, !taffo.info !71
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 8), !taffo.info !269
  %mul27.u23_9fixp = shl i32 %21, 1, !taffo.info !272
  %22 = lshr i32 %mul27.u23_9fixp, 3, !taffo.info !272
  %add28.u26_6fixp = add i32 %u26_6fixp, %22, !taffo.info !274
...
for.inc30:                                        ; preds = %for.body21
  ...
  br label %for.cond19, !llvm.loop !276
...
for.inc33:                                        ; preds = %for.end32
  ...
  br label %for.cond16, !llvm.loop !277
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u26_6fixp = add i32 %u26_6fixp2, %23, !taffo.info !278
...
for.inc43:                                        ; preds = %for.body38
  ...
  br label %for.cond36, !llvm.loop !280
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !141
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !142
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 14), !taffo.info !281
  %mul55.u17_15fixp = shl i32 %27, 1, !taffo.info !283
  %28 = uitofp i32 %mul55.u17_15fixp to float, !taffo.info !283
  %29 = fdiv float %28, 3.276800e+04, !taffo.info !283
  ...
  %31 = fdiv float %30, 6.400000e+01, !taffo.info !69
  %mul57.1flp = fmul float %29, %31, !taffo.info !284
  %add58.1flp = fadd float %.flt.fallback.1flp, %mul57.1flp, !taffo.info !287
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !141
...
for.inc60:                                        ; preds = %for.body51
  ...
  br label %for.cond49, !llvm.loop !290
...
for.inc63:                                        ; preds = %for.end62
  ...
  br label %for.cond46, !llvm.loop !291
...
!123 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!124 = !{void (i32, float*, i32)* @scale_1d}
!125 = !{!126, !120, i1 false, i2 1}
!126 = !{!"fixp", i32 32, i32 22}
!127 = !{!128, !129, i1 false, i2 -1}
!128 = !{!"fixp", i32 -32, i32 15}
!129 = !{double 0x40A11111276FB092, double 0x40E555556084A516}
!130 = !{!131, !129, i1 false, i2 -1}
!131 = !{!"fixp", i32 32, i32 16}
!132 = distinct !{!132, !27}
!133 = !{i32 1, !107, i32 1, !54, i32 1, !119}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 -32, i32 13}
!136 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!137 = !{!138, !136, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 14}
!139 = distinct !{!139, !27}
!140 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!141 = !{i32 5}
!142 = !{i32 6}
!143 = !{!144, !145, i1 false, i2 -1}
!144 = !{!"float", i32 1, double 0x4352E67000000000}
!145 = !{double 0.000000e+00, double 0x4352E67000000000}
!146 = distinct !{!146, !27}
!147 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!148 = !{!149, !150, i1 false, i2 -1}
!149 = !{!"fixp", i32 -32, i32 14}
!150 = !{double 3.276800e+03, double 6.553600e+04}
!151 = !{!53, !150, i1 false, i2 -1}
!152 = distinct !{!152, !27}
!153 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!154 = !{!155, !156, i1 false, i2 -1}
!155 = !{!"fixp", i32 -32, i32 16}
!156 = !{double 0x4096C16C61522A6F, double 0x40DC71C71D606317}
!157 = !{!158, !156, i1 false, i2 -1}
!158 = !{!"fixp", i32 32, i32 17}
!159 = distinct !{!159, !27}
!160 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!161 = !{!162, !163, i1 false, i2 -1}
!162 = !{!"float", i32 1, double 0x4215C57280000000}
!163 = !{double 0.000000e+00, double 0x4215C57280000000}
!164 = distinct !{!164, !27}
!165 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!166 = !{i32 1, !107, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !60, i32 1, !62, i32 1, !65, i32 1, !69, i32 1, !71, i32 1, !73}
!167 = distinct !{null}
!168 = !{!169, i1 false}
!169 = !{i1 false, !49, i1 false, i2 0}
!170 = !{!171, i1 false}
!171 = !{i1 false, !172, i1 false, i2 0}
!172 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!173 = !{!174, !108, i1 false, i2 1}
!174 = !{!"fixp", i32 32, i32 27}
!175 = !{i1 false, !176, i1 false, i2 -1}
!176 = !{double 0.000000e+00, double 2.000000e+01}
!177 = !{i1 false, !96, i1 false, i2 -1}
!178 = !{i32 3}
!179 = !{!174, !176, i1 false, i2 -1}
!180 = !{!181, !96, i1 false, i2 1}
!181 = !{!"fixp", i32 -32, i32 26}
!182 = !{!183, !96, i1 false, i2 1}
!183 = !{!"fixp", i32 32, i32 31}
!184 = !{!55, !56, i1 false, i2 1}
!185 = !{i1 false, i1 false, i1 false, i2 1}
!186 = !{i1 false, !104, i1 false, i2 -1}
!187 = !{!174, !104, i1 false, i2 -1}
!188 = !{!181, !189, i1 false, i2 1}
!189 = !{double 5.000000e-02, double 1.050000e+00}
!190 = !{!48, !189, i1 false, i2 1}
!191 = !{!192, !193, i1 false, i2 1}
!192 = !{!"fixp", i32 -32, i32 29}
!193 = !{double 2.500000e-02, double 5.250000e-01}
!194 = !{!48, !193, i1 false, i2 1}
!195 = !{i1 false, !23}
!196 = !{!183, !197, i1 false, i2 1}
!197 = !{double 0x3F99999980000000, double 0x3FE0CCCCE0000000}
!198 = !{!55, !61, i1 false, i2 1}
!199 = !{!200, !201, i1 false, i2 1}
!200 = !{!"fixp", i32 -32, i32 28}
!201 = !{double 1.250000e-02, double 2.625000e-01}
!202 = !{!48, !201, i1 false, i2 1}
!203 = !{i1 false, !204}
!204 = !{i1 false, !205, i1 false, i2 0}
!205 = !{double 4.000000e+00, double 4.000000e+00}
!206 = !{!183, !207, i1 false, i2 1}
!207 = !{double 0x3F89999980000000, double 0x3FD0CCCCE0000000}
!208 = !{!58, !59, i1 false, i2 1}
!209 = !{!200, !210, i1 false, i2 1}
!210 = !{double 0x3F81111111111111, double 0x3FC6666666666667}
!211 = !{!48, !210, i1 false, i2 1}
!212 = !{i1 false, !213}
!213 = !{i1 false, !214, i1 false, i2 0}
!214 = !{double 6.000000e+00, double 6.000000e+00}
!215 = !{!183, !216, i1 false, i2 1}
!216 = !{double 0x3F81111100000000, double 0x3FC6666680000000}
!217 = !{!63, !64, i1 false, i2 1}
!218 = !{!219, !220, i1 false, i2 1}
!219 = !{!"fixp", i32 -32, i32 27}
!220 = !{double 6.250000e-03, double 1.312500e-01}
!221 = !{!48, !220, i1 false, i2 1}
!222 = !{i1 false, !223}
!223 = !{i1 false, !224, i1 false, i2 0}
!224 = !{double 8.000000e+00, double 8.000000e+00}
!225 = !{!183, !226, i1 false, i2 1}
!226 = !{double 0x3F79999980000000, double 0x3FC0CCCCE0000000}
!227 = !{!63, !72, i1 false, i2 1}
!228 = !{!219, !229, i1 false, i2 1}
!229 = !{double 0x3F76C16C16C16C17, double 0x3FBDDDDDDDDDDDDE}
!230 = !{!48, !229, i1 false, i2 1}
!231 = !{i1 false, !232}
!232 = !{i1 false, !233, i1 false, i2 0}
!233 = !{double 9.000000e+00, double 9.000000e+00}
!234 = !{!183, !235, i1 false, i2 1}
!235 = !{double 0x3F76C16C00000000, double 0x3FBDDDDDE0000000}
!236 = !{!74, !75, i1 false, i2 1}
!237 = !{!70, !1, i1 false, i2 1}
!238 = !{!111, i1 false}
!239 = !{!66, !3, i1 false, i2 1}
!240 = !{i1 false, !241, i1 false, i2 -1}
!241 = !{double 0.000000e+00, double 4.000000e+02}
!242 = !{i1 false, !243, i1 false, i2 -1}
!243 = !{double 0.000000e+00, double 1.900000e+01}
!244 = !{!174, !243, i1 false, i2 -1}
!245 = !{!181, !246, i1 false, i2 -1}
!246 = !{double 0.000000e+00, double 0x3FEE666666666666}
!247 = !{!183, !246, i1 false, i2 -1}
!248 = !{!53, !5, i1 false, i2 1}
!249 = distinct !{!249, !27}
!250 = distinct !{!250, !27}
!251 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!252 = distinct !{null}
!253 = !{!138, !5, i1 false, i2 -1}
!254 = !{!135, !255, i1 false, i2 -1}
!255 = !{double 0.000000e+00, double 0x40EE6666601BC98A}
!256 = !{!138, !255, i1 false, i2 -1}
!257 = !{!138, !258, i1 false, i2 -1}
!258 = !{double 0.000000e+00, double 0x4101DEAAA806AF46}
!259 = !{!155, !260, i1 false, i2 -1}
!260 = !{double 0x404B4E81D8B2B41D, double 0x40D555556084A516}
!261 = !{!158, !260, i1 false, i2 -1}
!262 = !{!138, !263, i1 false, i2 -1}
!263 = !{double 0x404B4E81D8B2B41D, double 0x41048955541743E9}
!264 = distinct !{!264, !27}
!265 = distinct !{!265, !27}
!266 = !{!149, !267, i1 false, i2 -1}
!267 = !{double 0.000000e+00, double 0x40F8A5C28CCC2BBD}
!268 = !{!53, !267, i1 false, i2 -1}
!269 = !{!270, !271, i1 false, i2 -1}
!270 = !{!"fixp", i32 -32, i32 8}
!271 = !{double 0.000000e+00, double 0x4158A5C28CCC2BBD}
!272 = !{!273, !271, i1 false, i2 -1}
!273 = !{!"fixp", i32 32, i32 9}
!274 = !{!70, !275, i1 false, i2 -1}
!275 = !{double 0.000000e+00, double 0x4188DA2AD1998578}
!276 = distinct !{!276, !27}
!277 = distinct !{!277, !27}
!278 = !{!70, !279, i1 false, i2 -1}
!279 = !{double 0x4006C16C61522A6F, double 0x4185C574471C71D6}
!280 = distinct !{!280, !27}
!281 = !{!149, !282, i1 false, i2 -1}
!282 = !{double 0.000000e+00, double 0x40FECF332FFF36AC}
!283 = !{!53, !282, i1 false, i2 -1}
!284 = !{!285, !286, i1 false, i2 -1}
!285 = !{!"float", i32 1, double 0x4294F61368021EC7}
!286 = !{double 0.000000e+00, double 0x4294F61368021EC7}
!287 = !{!288, !289, i1 false, i2 -1}
!288 = !{!"float", i32 1, double 0x42C585326D0043D9}
!289 = !{double 0.000000e+00, double 0x42C585326D0043D9}
!290 = distinct !{!290, !27}
!291 = distinct !{!291, !27}
