...
@.str = private unnamed_addr constant [55 x i8] c"target('A') scalar(range(17.066668,1928.533325) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [38 x i8] c"scalar(range(25.6,2056.533447) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 100, i8* null)
  %B2 = bitcast [15 x [15 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 101, i8* null)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 128)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 128)
