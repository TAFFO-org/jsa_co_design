; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-2-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,32.894997) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,1.875) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,1.8) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !59, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 2), !taffo.initweight !59, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 2), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 2), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 2), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !116 !taffo.funinfo !118 !taffo.sourceFunction !62 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k.3(i32 noundef %n, i32 noundef %m, float noundef %alpha, float noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [10 x float]* noundef %B) #0 !taffo.initweight !119 !taffo.funinfo !120 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx4, align 4, !taffo.initweight !121, !taffo.info !53
  %mul = fmul float %0, %beta, !taffo.initweight !94, !taffo.info !122
...
for.body10:                                       ; preds = %for.cond8
  ...
  %1 = load float, float* %arrayidx12, align 4, !taffo.initweight !121, !taffo.info !55
  %mul13 = fmul float %1, %alpha, !taffo.initweight !94, !taffo.info !125
  ...
  %2 = load float, float* %arrayidx15, align 4, !taffo.initweight !121, !taffo.info !57
  %mul16 = fmul float %mul13, %2, !taffo.initweight !95, !taffo.info !127
  ...
  %3 = load float, float* %arrayidx18, align 4, !taffo.initweight !121, !taffo.info !57
  %mul19 = fmul float %3, %alpha, !taffo.initweight !94, !taffo.info !129
  ...
  %4 = load float, float* %arrayidx21, align 4, !taffo.initweight !121, !taffo.info !55
  %mul22 = fmul float %mul19, %4, !taffo.initweight !95, !taffo.info !127
  %add = fadd float %mul16, %mul22, !taffo.initweight !121, !taffo.info !131
  ...
  %5 = load float, float* %arrayidx24, align 4, !taffo.initweight !121, !taffo.info !53
  %add25 = fadd float %5, %add, !taffo.initweight !133, !taffo.info !134
  store float %add25, float* %arrayidx24, align 4, !taffo.initweight !121, !taffo.info !53
  br label %for.inc26

for.inc26:                                        ; preds = %for.body10
  %inc27 = add nsw i32 %j.1, 1, !taffo.info !109, !taffo.constinfo !27
  br label %for.cond8, !llvm.loop !136
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, i32 noundef %m, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [10 x float]* noundef %B) #0 !taffo.initweight !139 !taffo.funinfo !120 !taffo.sourceFunction !60 {
entry:
...
for.cond:                                         ; preds = %for.inc16, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc17, %for.inc16 ], !taffo.initweight !48, !taffo.info !140
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !64, !taffo.info !141
  br i1 %cmp, label %for.body, label %for.end18, !taffo.initweight !65, !taffo.info !91
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !142
  %cmp4 = icmp slt i32 %j.0, %m, !taffo.initweight !64, !taffo.info !141
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !65, !taffo.info !93

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !64, !taffo.info !144
  %add = add nsw i32 %mul, 1, !taffo.initweight !65, !taffo.info !146, !taffo.constinfo !27
  %rem = srem i32 %add, %n, !taffo.initweight !76, !taffo.info !148
  %conv = sitofp i32 %rem to float, !taffo.initweight !94, !taffo.info !148
  %conv6 = sitofp i32 %n to float, !taffo.info !107
  %div = fdiv float %conv, %conv6, !taffo.initweight !95, !taffo.info !150
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !64, !taffo.info !152
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !152
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !65, !taffo.info !96
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.initweight !64, !taffo.info !144
  %add9 = add nsw i32 %mul8, 2, !taffo.initweight !65, !taffo.info !153, !taffo.constinfo !27
  %rem10 = srem i32 %add9, %m, !taffo.initweight !76, !taffo.info !155
  %conv11 = sitofp i32 %rem10 to float, !taffo.initweight !94, !taffo.info !155
  %conv12 = sitofp i32 %m to float, !taffo.info !22
  %div13 = fdiv float %conv11, %conv12, !taffo.initweight !95, !taffo.info !157
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.0, !taffo.initweight !64, !taffo.info !159
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !159
  store float %div13, float* %arrayidx15, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.initweight !64, !taffo.info !163, !taffo.constinfo !27
...
for.cond19:                                       ; preds = %for.inc38, %for.end18
  %i.1 = phi i32 [ 0, %for.end18 ], [ %inc39, %for.inc38 ], !taffo.initweight !48, !taffo.info !140
  %cmp20 = icmp slt i32 %i.1, %n, !taffo.initweight !64, !taffo.info !141
  br i1 %cmp20, label %for.body22, label %for.end40, !taffo.initweight !65, !taffo.info !91
...
for.cond23:                                       ; preds = %for.inc35, %for.body22
  %j.1 = phi i32 [ 0, %for.body22 ], [ %inc36, %for.inc35 ], !taffo.initweight !48, !taffo.info !142
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.initweight !64, !taffo.info !165
  br i1 %cmp24, label %for.body26, label %for.end37, !taffo.initweight !65, !taffo.info !93

for.body26:                                       ; preds = %for.cond23
  %mul27 = mul nsw i32 %i.1, %j.1, !taffo.initweight !64, !taffo.info !144
  %add28 = add nsw i32 %mul27, 3, !taffo.initweight !65, !taffo.info !166, !taffo.constinfo !27
  %rem29 = srem i32 %add28, %n, !taffo.initweight !76, !taffo.info !148
  %conv30 = sitofp i32 %rem29 to float, !taffo.initweight !94, !taffo.info !148
  %conv31 = sitofp i32 %m to float, !taffo.info !22
  %div32 = fdiv float %conv30, %conv31, !taffo.initweight !95, !taffo.info !168
  %arrayidx33 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.initweight !64, !taffo.info !170
  %arrayidx34 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx33, i32 0, i32 %j.1, !taffo.initweight !64, !taffo.info !170
  store float %div32, float* %arrayidx34, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.initweight !64, !taffo.info !160, !taffo.constinfo !27
...
for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !163, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !173 !taffo.funinfo !174 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !121, !taffo.info !53
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !133, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !175, !taffo.info !176
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !121, !taffo.info !53
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !173 !taffo.funinfo !180 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !121, !taffo.info !55
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !133, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !175, !taffo.info !181
  %2 = mul nsw i32 %i.0, %m, !taffo.info !111
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !95, !taffo.info !55
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !121, !taffo.info !55
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !173 !taffo.funinfo !185 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !121, !taffo.info !57
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !133, !taffo.info !57
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !175, !taffo.info !186
  %2 = mul nsw i32 %i.0, %m, !taffo.info !111
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !95, !taffo.info !57
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !121, !taffo.info !57
...
!7 = !{double 0.000000e+00, double 0x4040728F42FE8251}
...
!56 = !{double 0.000000e+00, double 1.875000e+00}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 1.800000e+00}
!59 = !{i32 1}
...
!115 = distinct !{!115, !29}
!116 = !{i32 1, i32 -1}
!117 = !{i32 1, !49, i32 1, !25}
!118 = !{i32 1, !51, i32 1, !25}
!119 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!120 = !{i32 1, !107, i32 1, !22, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55, i32 1, !57}
!121 = !{i32 7}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x4043BCABE9FE35FB}
!124 = distinct !{!124, !29}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 2.812500e+00}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 5.062500e+00}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 2.700000e+00}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 1.012500e+01}
!133 = !{i32 8}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x4045828F42FE8251}
!136 = distinct !{!136, !29}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!140 = !{i1 false, !71, i1 false, i2 1}
!141 = !{i1 false, !73, i1 false, i2 1}
!142 = !{i1 false, !143, i1 false, i2 1}
!143 = !{double 0.000000e+00, double 1.100000e+01}
!144 = !{i1 false, !145, i1 false, i2 1}
!145 = !{double 0.000000e+00, double 1.600000e+02}
!146 = !{i1 false, !147, i1 false, i2 1}
!147 = !{double 1.000000e+00, double 1.610000e+02}
...
!152 = !{i1 false, !56, i1 false, i2 1}
!153 = !{i1 false, !154, i1 false, i2 1}
!154 = !{double 2.000000e+00, double 1.620000e+02}
!155 = !{i1 false, !156, i1 false, i2 1}
!156 = !{double 0.000000e+00, double 9.000000e+00}
...
!164 = distinct !{!164, !29}
!165 = !{i1 false, !110, i1 false, i2 1}
...
!170 = !{i1 false, !7, i1 false, i2 1}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
!173 = !{i32 -1, i32 -1, i32 3, i32 -1}
!174 = !{i32 1, !107, i32 1, !107, i32 1, !53, i32 1, !25}
!175 = !{i32 9}
!176 = !{i1 false, !177, i1 false, i2 -1}
!177 = !{double 0.000000e+00, double 0x4050728F42FE8251}
!178 = distinct !{!178, !29}
!179 = distinct !{!179, !29}
!180 = !{i32 1, !107, i32 1, !22, i32 1, !55, i32 1, !25}
!181 = !{i1 false, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 3.750000e+00}
!183 = distinct !{!183, !29}
!184 = distinct !{!184, !29}
!185 = !{i32 1, !107, i32 1, !22, i32 1, !57, i32 1, !25}
!186 = !{i1 false, !187, i1 false, i2 -1}
!187 = !{double 0.000000e+00, double 3.600000e+00}
!188 = distinct !{!188, !29}
!189 = distinct !{!189, !29}
