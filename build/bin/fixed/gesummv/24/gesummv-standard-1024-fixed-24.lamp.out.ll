; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-1024-fixed-24.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 2.560000e+02, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u24_8fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim1 = and i32 %lampsim, -1
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 2.560000e+02, !taffo.info !54
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -1
  %lampsim5 = bitcast i32 %lampsim4 to float
  ...
  %3 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !90
  ...
  %4 = fmul float 2.560000e+02, %lampsim15, !taffo.info !92
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !96 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !103 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim1 = and i32 %lampsim, -1
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 5.120000e+02, !taffo.info !51
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -1
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !90
  ...
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !104
  %lampsim13 = bitcast float %mul.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -1
  %lampsim15 = bitcast i32 %lampsim14 to float
  %arrayidx1.u23_9fixp = getelementptr inbounds i32, i32* %val.u23_9fixp, i32 %i.0, !taffo.info !51
  %4 = fmul float 5.120000e+02, %lampsim15, !taffo.info !104
  %lampsim16 = bitcast float %4 to i32
  %lampsim17 = and i32 %lampsim16, -1
  %lampsim18 = bitcast i32 %lampsim17 to float
  %5 = fptoui float %lampsim18 to i32, !taffo.info !104
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 0, i32* %arrayidx.u23_9fixp, align 4, !taffo.info !111, !taffo.constinfo !112
  %arrayidx1.u24_8fixp = getelementptr inbounds i32, i32* %y.u24_8fixp, i32 %i.0, !taffo.info !54
  store i32 0, i32* %arrayidx1.u24_8fixp, align 4, !taffo.info !111, !taffo.constinfo !112
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !113
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !115
  ...
  %5 = lshr i32 %mul.u20_12fixp, 3, !taffo.info !115
  %add.u23_9fixp = add i32 %5, %u23_9fixp, !taffo.info !116
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 11), !taffo.info !113
  %mul13.u20_12fixp = shl i32 %10, 1, !taffo.info !115
  ...
  %11 = lshr i32 %mul13.u20_12fixp, 4, !taffo.info !115
  %add15.u24_8fixp = add i32 %11, %u24_8fixp, !taffo.info !118
...
for.end:                                          ; preds = %for.cond2
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 6), !taffo.info !121
  %mul18.u25_7fixp = shl i32 %16, 1, !taffo.info !124
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 6), !taffo.info !126
  %mul20.u25_7fixp = shl i32 %21, 1, !taffo.info !128
  %add21.u25_7fixp = add i32 %mul18.u25_7fixp, %mul20.u25_7fixp, !taffo.info !129
  %arrayidx22.u24_8fixp = getelementptr inbounds i32, i32* %y.u24_8fixp, i32 %i.0, !taffo.info !54
  %22 = shl i32 %add21.u25_7fixp, 1, !taffo.info !129
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u10_22fixp, [16 x i32]* noundef %B.u10_22fixp, i32* noundef %x.u10_22fixp, i32* noundef %tmp.u23_9fixp, i32* noundef %y.u24_8fixp) #0 !taffo.initweight !132 !taffo.funinfo !133 !taffo.sourceFunction !134 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds i32, i32* %x.u10_22fixp, i32 %i.0, !taffo.info !158
  %4 = lshr i32 %div.u1_31fixp, 9, !taffo.info !156
  store i32 %4, i32* %arrayidx.u10_22fixp, align 4, !taffo.info !111
  %arrayidx4.u24_8fixp = getelementptr inbounds i32, i32* %y.u24_8fixp, i32 %i.0, !taffo.info !159
  store i32 0, i32* %arrayidx4.u24_8fixp, align 4, !taffo.info !111, !taffo.constinfo !112
  %arrayidx5.u23_9fixp = getelementptr inbounds i32, i32* %tmp.u23_9fixp, i32 %i.0, !taffo.info !160
  store i32 0, i32* %arrayidx5.u23_9fixp, align 4, !taffo.info !111, !taffo.constinfo !112
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx14.u10_22fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !158
  %arrayidx15.u10_22fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx14.u10_22fixp, i32 0, i32 %j.0, !taffo.info !158
  %9 = lshr i32 %div13.u1_31fixp, 9, !taffo.info !156
  store i32 %9, i32* %arrayidx15.u10_22fixp, align 4, !taffo.info !111
  ...
  %arrayidx22.u10_22fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u10_22fixp, i32 %i.0, !taffo.info !158
  %arrayidx23.u10_22fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx22.u10_22fixp, i32 0, i32 %j.0, !taffo.info !158
  %14 = lshr i32 %div21.u1_31fixp, 9, !taffo.info !156
  store i32 %14, i32* %arrayidx23.u10_22fixp, align 4, !taffo.info !111
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 11), !taffo.info !97
  %mul.u20_12fixp = shl i32 %5, 1, !taffo.info !100
  ...
  %7 = shl i32 %mul.u20_12fixp, 10, !taffo.info !100
...
!93 = !{!"float", i32 1, double 0x4206A66680000000}
!94 = !{double 0.000000e+00, double 0x4206A66680000000}
!95 = distinct !{!95, !23}
!96 = !{i32 1, !75, i32 1, !48, i32 1, !84}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"fixp", i32 -32, i32 11}
!99 = !{double 0.000000e+00, double 9.830400e+05}
!100 = !{!101, !99, i1 false, i2 -1}
!101 = !{!"fixp", i32 32, i32 12}
!102 = distinct !{!102, !23}
!103 = !{i32 1, !75, i32 1, !51, i32 1, !84}
!104 = !{!105, !106, i1 false, i2 -1}
!105 = !{!"float", i32 1, double 0x41F1A00000000000}
!106 = !{double 0.000000e+00, double 0x41F1A00000000000}
!107 = distinct !{!107, !23}
!108 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!109 = !{i32 1, !75, i32 1, !43, i32 1, !46, i32 1, !48, i32 1, !48, i32 1, !51, i32 1, !48, i32 1, !54}
!110 = distinct !{null}
!111 = !{i1 false, i1 false, i1 false, i2 1}
!112 = !{!79, i1 false}
!113 = !{!98, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 9.216000e+05}
!115 = !{!101, !114, i1 false, i2 -1}
!116 = !{!52, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x4155240000000000}
!118 = !{!55, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x4168686680000000}
!120 = distinct !{!120, !23}
!121 = !{!122, !123, i1 false, i2 -1}
!122 = !{!"fixp", i32 -32, i32 6}
!123 = !{double 0.000000e+00, double 0x415A700000000000}
!124 = !{!125, !123, i1 false, i2 -1}
!125 = !{!"fixp", i32 32, i32 7}
!126 = !{!122, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x416B2E1499999999}
!128 = !{!125, !127, i1 false, i2 -1}
!129 = !{!125, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x4174330A4CCCCCCC}
!131 = distinct !{!131, !23}
