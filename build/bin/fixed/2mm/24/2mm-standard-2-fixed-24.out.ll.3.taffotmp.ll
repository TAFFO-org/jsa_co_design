; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-2-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,18.449999) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,1.75) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,1.8) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.857143) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [48 x i8] c"target('D') scalar(range(0.0,153.449997) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !66, !taffo.constinfo !67
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 2), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 2), !taffo.initweight !69, !taffo.info !55, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 2), !taffo.initweight !69, !taffo.info !57, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 2), !taffo.initweight !69, !taffo.info !59, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 2), !taffo.initweight !69, !taffo.info !61, !taffo.target !62, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 2), !taffo.initweight !69, !taffo.info !53, !taffo.originalCall !70, !taffo.constinfo !71
...
!7 = !{double 0.000000e+00, double 0x40632E66601BC98A}
...
!54 = !{double 0.000000e+00, double 0x40327333226C3B92}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 1.750000e+00}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 1.800000e+00}
!59 = !{i1 false, !60, i1 false, i2 -1}
!60 = !{double 0.000000e+00, double 0x3FFDB6DB940FECDD}
...
!131 = distinct !{!131, !29}
!132 = !{i32 1, i32 -1}
!133 = !{i32 1, !49, i32 1, !25}
!134 = !{i32 1, !51, i32 1, !25}
...
!141 = !{double 0.000000e+00, double 2.625000e+00}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 0.000000e+00, double 0x4012E66666666667}
!144 = !{i1 false, !145, i1 false, i2 -1}
!145 = !{double 0.000000e+00, double 0x40372CCCBC05D52C}
!146 = distinct !{!146, !29}
!147 = distinct !{!147, !29}
!148 = distinct !{!148, !29}
!149 = !{i1 false, !150, i1 false, i2 -1}
!150 = !{double 0.000000e+00, double 0x4067047AD9BAF1D9}
!151 = !{i32 8}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x404121D423C9CC34}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x406776DB690E3C97}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
...
!213 = !{i32 1, !124, i32 1, !22, i32 1, !53, i32 1, !25}
!214 = !{i32 9}
!215 = !{i1 false, !216, i1 false, i2 -1}
!216 = !{double 0.000000e+00, double 0x40427333226C3B92}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = !{i32 1, !124, i32 1, !137, i32 1, !55, i32 1, !25}
!220 = !{i1 false, !221, i1 false, i2 -1}
!221 = !{double 0.000000e+00, double 3.500000e+00}
!222 = distinct !{!222, !29}
!223 = distinct !{!223, !29}
!224 = !{i32 1, !137, i32 1, !22, i32 1, !57, i32 1, !25}
!225 = !{i1 false, !226, i1 false, i2 -1}
!226 = !{double 0.000000e+00, double 3.600000e+00}
!227 = distinct !{!227, !29}
!228 = distinct !{!228, !29}
!229 = !{i32 1, !22, i32 1, !126, i32 1, !59, i32 1, !25}
!230 = !{i1 false, !231, i1 false, i2 -1}
!231 = !{double 0.000000e+00, double 0x400DB6DB940FECDD}
!232 = distinct !{!232, !29}
!233 = distinct !{!233, !29}
!234 = !{i32 1, !124, i32 1, !126, i32 1, !61, i32 1, !25}
!235 = !{i1 false, !236, i1 false, i2 -1}
!236 = !{double 0.000000e+00, double 0x40732E66601BC98A}
!237 = distinct !{!237, !29}
!238 = distinct !{!238, !29}
