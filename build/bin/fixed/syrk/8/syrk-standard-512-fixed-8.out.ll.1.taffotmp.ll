...
entry:
  ...
  call void @llvm.var.annotation(i8* %C3, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 112, i8* null)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 10, float* noundef %3, i32 noundef 512)
