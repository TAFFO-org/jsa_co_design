; ModuleID = './build/bin/fixed/symm/16/symm-standard-32-fixed-16.out.ll.4.taffotmp.ll'
...
for.body16:                                       ; preds = %for.cond14
  ...
  %1 = fdiv float %0, 6.553600e+04, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u16_16fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !166 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !170
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !173
  ...
  %7 = shl i32 %mul.u21_11fixp, 5, !taffo.info !173
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !177 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !178
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !181
  %6 = mul nsw i32 %i.0, %m, !taffo.info !83
  ...
  %7 = shl i32 %mul.u12_20fixp, 5, !taffo.info !181
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s16_16fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !185 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.s21_11fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !186
  ...
  %5 = shl i32 %mul.s21_11fixp, 5, !taffo.info !186
...
!172 = !{double 0.000000e+00, double 0x41356451E0008638}
!173 = !{!174, !172, i1 false, i2 -1}
!174 = !{!"fixp", i32 32, i32 11}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = !{i32 1, !16, i32 1, !79, i32 1, !53, i32 1, !89}
!178 = !{!179, !180, i1 false, i2 -1}
!179 = !{!"fixp", i32 -32, i32 19}
!180 = !{double 1.024000e+02, double 2.560000e+03}
!181 = !{!182, !180, i1 false, i2 -1}
!182 = !{!"fixp", i32 32, i32 20}
!183 = distinct !{!183, !23}
!184 = distinct !{!184, !23}
!185 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !89}
!186 = !{!187, !188, i1 false, i2 -1}
!187 = !{!"fixp", i32 -32, i32 11}
!188 = !{double 0xC12F380000000000, double 0x409CCCCCBC05D52C}
!189 = distinct !{!189, !23}
!190 = distinct !{!190, !23}
