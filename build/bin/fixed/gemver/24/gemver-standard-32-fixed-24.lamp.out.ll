; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-32-fixed-24.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim7 = and i32 %lampsim6, -1
  %lampsim8 = bitcast i32 %lampsim7 to float
  %3 = fdiv float %lampsim8, 0x4190000000000000, !taffo.info !129
  %lampsim9 = bitcast float %3 to i32
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !197
