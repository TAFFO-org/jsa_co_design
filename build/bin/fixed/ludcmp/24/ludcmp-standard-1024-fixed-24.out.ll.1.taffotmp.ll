...
@.str = private unnamed_addr constant [37 x i8] c"scalar(range(0.1,8368.639648) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [40 x i8] c"scalar(range(1024.0,8368.639648) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [40 x i8] c"scalar(range(4121.600098,4608.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [52 x i8] c"target('x') scalar(range(-0.037947,3.998521) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,4121.600098) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 166, i8* null)
  %B2 = bitcast [20 x [20 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 167, i8* null)
  %b3 = bitcast [20 x float]* %b to i8*
  call void @llvm.var.annotation(i8* %b3, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 168, i8* null)
  %x4 = bitcast [20 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x4, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 169, i8* null)
  %y5 = bitcast [20 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y5, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 170, i8* null)
  %0 = load i32, i32* %n, align 4
  %arraydecay = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %A, i32 0, i32 0
  %arraydecay6 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %B, i32 0, i32 0
  %arraydecay7 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  %arraydecay9 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 1024)
  %arraydecay11 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %B, i32 0, i32 0
  %2 = bitcast [20 x float]* %arraydecay11 to float*
  call void @scale_2d(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 1024)
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 1024)
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024)
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 1024)
  call void @timer_start()
  %3 = load i32, i32* %n, align 4
  %arraydecay15 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %A, i32 0, i32 0
  %arraydecay16 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0
...
for.cond12:                                       ; preds = %for.inc41, %for.end
  ...
  br i1 %cmp13, label %for.body15, label %for.end43
...
for.body19:                                       ; preds = %for.cond16
  ...
  %rem = srem i32 %sub, %17
  %conv20 = sitofp i32 %rem to float
  %18 = load i32, i32* %n.addr, align 4
  %conv21 = sitofp i32 %18 to float
  %div22 = fdiv float %conv20, %conv21
  %add23 = fadd float %div22, 1.000000e+00
  %19 = load [20 x float]*, [20 x float]** %A.addr, align 4
  %20 = load i32, i32* %i, align 4
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %19, i32 %20
  %21 = load i32, i32* %j, align 4
  %arrayidx25 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx24, i32 0, i32 %21
...
for.body33:                                       ; preds = %for.cond30
  ...
  %27 = load i32, i32* %i, align 4
  %arrayidx34 = getelementptr inbounds [20 x float], [20 x float]* %26, i32 %27
  %28 = load i32, i32* %j, align 4
  %arrayidx35 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx34, i32 0, i32 %28
...
for.end38:                                        ; preds = %for.cond30
  ...
  %arrayidx39 = getelementptr inbounds [20 x float], [20 x float]* %30, i32 %31
  %32 = load i32, i32* %i, align 4
  %arrayidx40 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx39, i32 0, i32 %32
...
for.body27:                                       ; preds = %for.cond25
  ...
  %sub33 = fsub float %46, %mul32
  store float %sub33, float* %w, align 4
  br label %for.inc34
...
for.end36:                                        ; preds = %for.cond25
  ...
  store float %48, float* %arrayidx38, align 4
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %58 = load float, float* %arrayidx48, align 4
...
for.body51:                                       ; preds = %for.cond49
  ...
  %sub56 = fsub float %68, %mul55
  store float %sub56, float* %w, align 4
  br label %for.inc57
...
for.end59:                                        ; preds = %for.cond49
  ...
  store float %70, float* %arrayidx60, align 4
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %78 = load float, float* %arrayidx68, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal void @print_array(i32 noundef %n, float* noundef %x) #0 {
entry:
  %n.addr = alloca i32, align 4
  %x.addr = alloca float*, align 4
  %i = alloca i32, align 4
