; ModuleID = './build/bin/fixed/gemm/16/gemm-standard-4-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,103.839996) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,3.75) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,3.666667) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !59, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 4), !taffo.initweight !59, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 4), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 4), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 4), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !119
  %mul = fmul float %1, %conv, !taffo.initweight !178, !taffo.info !188
  %2 = mul nsw i32 %i.0, %m, !taffo.info !113
...
!7 = !{double 0.000000e+00, double 0x4059F5C27E953155}
...
!56 = !{double 0.000000e+00, double 3.750000e+00}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x400D555582129457}
!59 = !{i32 1}
...
!128 = !{double 0.000000e+00, double 0x405F26E964B307FF}
!129 = distinct !{!129, !29}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 5.625000e+00}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x4034A0001F75104D}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x405F1DC286727568}
!136 = distinct !{!136, !29}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
...
!180 = !{double 0.000000e+00, double 0x4079F5C27E953155}
!181 = distinct !{!181, !29}
!182 = distinct !{!182, !29}
!183 = !{i32 1, !22, i32 1, !124, i32 1, !55, i32 1, !119}
!184 = !{i1 false, !159, i1 false, i2 -1}
!185 = distinct !{!185, !29}
!186 = distinct !{!186, !29}
!187 = !{i32 1, !124, i32 1, !109, i32 1, !57, i32 1, !119}
!188 = !{i1 false, !189, i1 false, i2 -1}
!189 = !{double 0.000000e+00, double 0x402D555582129457}
!190 = distinct !{!190, !29}
!191 = distinct !{!191, !29}
