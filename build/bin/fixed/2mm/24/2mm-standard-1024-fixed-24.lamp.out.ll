; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-1024-fixed-24.out.ll'
...
entry:
  ...
  %u10_22fixp3 = bitcast [12 x i32]* %arraydecay12.u10_22fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 8, i32 12, i32* %u10_22fixp3, i32 1024), !taffo.info !66, !taffo.constinfo !67
  %arraydecay13.u10_22fixp = getelementptr inbounds [12 x [10 x i32]], [12 x [10 x i32]]* %B.u10_22fixp, i32 0, i32 0, !taffo.info !53
  %u10_22fixp2 = bitcast [10 x i32]* %arraydecay13.u10_22fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u10_22fixp2, i32 1024), !taffo.info !68, !taffo.constinfo !67
...
for.body3:                                        ; preds = %for.cond1
  ...
  store i32 0, i32* %arrayidx4.u23_9fixp, align 4, !taffo.info !109, !taffo.constinfo !110
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %u10_22fixp = load i32, i32* %arrayidx9.u10_22fixp, align 4, !taffo.info !111
  %2 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %3 = lshr i32 %u10_22fixp, 1, !taffo.info !111
  %4 = ashr i32 %2, 9, !taffo.info !42
  %5 = ashr i32 %3, 1, !taffo.info !111
  %6 = call i32 @llvm.smul.fix.i32(i32 %4, i32 %5, i32 20), !taffo.info !113
  %mul.u11_21fixp = shl i32 %6, 1, !taffo.info !116
  ...
  %7 = lshr i32 %mul.u11_21fixp, 1, !taffo.info !116
  %8 = lshr i32 %u10_22fixp3, 1, !taffo.info !53
  %9 = ashr i32 %7, 12, !taffo.info !116
  %10 = ashr i32 %8, 13, !taffo.info !53
  %11 = call i32 @llvm.smul.fix.i32(i32 %9, i32 %10, i32 8), !taffo.info !117
  %mul12.u23_9fixp = shl i32 %11, 1, !taffo.info !120
  ...
  %add.u23_9fixp = add i32 %u23_9fixp, %mul12.u23_9fixp, !taffo.info !121
...
for.body32:                                       ; preds = %for.cond30
  ...
  %13 = fdiv float %lampsim12, 5.120000e+02, !taffo.info !47
  ...
  %15 = fdiv float %lampsim18, 0x4150000000000000, !taffo.info !55
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds [12 x i32], [12 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !169
  %arrayidx7.u10_22fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u10_22fixp, i32 0, i32 %j.0, !taffo.info !169
  %4 = lshr i32 %div.u3_29fixp, 7, !taffo.info !168
  store i32 %4, i32* %arrayidx7.u10_22fixp, align 4, !taffo.info !109
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u10_22fixp, i32 %i.1, !taffo.info !185
  %arrayidx26.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx25.u10_22fixp, i32 0, i32 %j.1, !taffo.info !185
  %8 = lshr i32 %div24.u1_31fixp, 9, !taffo.info !183
  store i32 %8, i32* %arrayidx26.u10_22fixp, align 4, !taffo.info !109
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx48.u10_22fixp = getelementptr inbounds [14 x i32], [14 x i32]* %C.u10_22fixp, i32 %i.2, !taffo.info !201
  %arrayidx49.u10_22fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx48.u10_22fixp, i32 0, i32 %j.2, !taffo.info !201
  %12 = lshr i32 %div47.u1_31fixp, 9, !taffo.info !200
  store i32 %12, i32* %arrayidx49.u10_22fixp, align 4, !taffo.info !109
  br label %for.inc50
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86.u23_9fixp = getelementptr inbounds [10 x i32], [10 x i32]* %tmp.u23_9fixp, i32 %i.4, !taffo.info !218
  %arrayidx87.u23_9fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx86.u23_9fixp, i32 0, i32 %j.4, !taffo.info !218
  store i32 0, i32* %arrayidx87.u23_9fixp, align 4, !taffo.info !109, !taffo.constinfo !110
  br label %for.inc88
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !225
  %1 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !225
  %lampsim = bitcast float %1 to i32
  %lampsim1 = and i32 %lampsim, -1
  %lampsim2 = bitcast i32 %lampsim1 to float
  %2 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !225
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !221 !taffo.funinfo !231 !taffo.sourceFunction !223 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !225
  %3 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !225
  %lampsim6 = bitcast float %3 to i32
  %lampsim7 = and i32 %lampsim6, -1
  %lampsim8 = bitcast i32 %lampsim7 to float
  %4 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !225
  ...
  %6 = fmul float 5.120000e+02, %lampsim15, !taffo.info !232
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !221 !taffo.funinfo !237 !taffo.sourceFunction !223 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u11_21fixp, 1, !taffo.info !225
  %3 = ashr i32 %1, 10, !taffo.info !50
  %4 = ashr i32 %2, 9, !taffo.info !225
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 11), !taffo.info !238
  %mul.u20_12fixp = shl i32 %5, 1, !taffo.info !241
  ...
  %7 = shl i32 %mul.u20_12fixp, 10, !taffo.info !241
...
!112 = !{!"fixp", i32 32, i32 21}
!113 = !{!114, !115, i1 false, i2 -1}
!114 = !{!"fixp", i32 -32, i32 20}
!115 = !{double 0.000000e+00, double 1.344000e+03}
!116 = !{!112, !115, i1 false, i2 -1}
!117 = !{!118, !119, i1 false, i2 -1}
!118 = !{!"fixp", i32 -32, i32 8}
!119 = !{double 0.000000e+00, double 0x4132E6665E247885}
!120 = !{!48, !119, i1 false, i2 -1}
!121 = !{!48, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x41572CCCB7891E21}
!123 = distinct !{!123, !23}
!124 = distinct !{!124, !23}
!125 = distinct !{!125, !23}
!126 = !{i32 5}
...
!130 = !{!"float", i32 1, double 0x4217047AD9999999}
!131 = !{double 0.000000e+00, double 0x4217047AD9999999}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"float", i32 1, double 0x41F121D4039CC303}
!134 = !{double 0.000000e+00, double 0x41F121D4039CC303}
!135 = !{!136, !137, i1 false, i2 -1}
!136 = !{!"float", i32 1, double 0x421776DB60E730C1}
!137 = !{double 0.000000e+00, double 0x421776DB60E730C1}
!138 = distinct !{!138, !23}
!139 = distinct !{!139, !23}
!140 = distinct !{!140, !23}
...
!227 = !{!"float", i32 1, double 0x42B32E6660000000}
!228 = !{double 0.000000e+00, double 0x42B32E6660000000}
!229 = distinct !{!229, !23}
!230 = distinct !{!230, !23}
!231 = !{i32 1, !89, i32 1, !16, i32 1, !47, i32 1, !101}
!232 = !{!233, !234, i1 false, i2 -1}
!233 = !{!"float", i32 1, double 0x41F2733320000000}
!234 = !{double 0.000000e+00, double 0x41F2733320000000}
!235 = distinct !{!235, !23}
!236 = distinct !{!236, !23}
!237 = !{i32 1, !89, i32 1, !106, i32 1, !50, i32 1, !101}
!238 = !{!239, !240, i1 false, i2 -1}
!239 = !{!"fixp", i32 -32, i32 11}
!240 = !{double 0.000000e+00, double 9.175040e+05}
!241 = !{!242, !240, i1 false, i2 -1}
!242 = !{!"fixp", i32 32, i32 12}
!243 = distinct !{!243, !23}
!244 = distinct !{!244, !23}
