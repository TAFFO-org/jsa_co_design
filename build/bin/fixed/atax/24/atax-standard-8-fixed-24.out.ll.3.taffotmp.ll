; ModuleID = './build/bin/fixed/atax/24/atax-standard-8-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,1.68) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(8.0,15.636364) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [49 x i8] c"target('y') scalar(range(0.0,3938.048096) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,244.160004) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 8), !taffo.initweight !61, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 8), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 8), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.initweight !57, !taffo.info !55
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 8), !taffo.initweight !58, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x40AEC418A009F623}
...
!50 = !{double 0.000000e+00, double 1.680000e+00}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 8.000000e+00, double 0x402F45D18090B418}
!53 = !{i1 false, !7, i1 false, i2 -1}
!54 = !{!"y"}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 0x406E851EC0B56755}
!57 = !{i32 1}
!58 = !{i32 2}
...
!105 = !{double 8.000000e+00, double 8.000000e+00}
!106 = !{i32 6}
!107 = !{i32 7}
!108 = !{i1 false, !109, i1 false, i2 -1}
!109 = !{double 6.400000e+01, double 0x405F45D18090B418}
!110 = distinct !{!110, !29}
!111 = !{i32 1, !99, i32 1, !53, i32 1, !104}
!112 = !{i1 false, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x40DEC418A009F623}
!114 = distinct !{!114, !29}
...
!121 = !{double 0.000000e+00, double 0x403A44E32E8E07EB}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x4070E6DD93439429}
!124 = distinct !{!124, !29}
...
!133 = !{double 0.000000e+00, double 0x409E851EC0B56755}
!134 = distinct !{!134, !29}
...
!161 = !{double 0.000000e+00, double 1.344000e+01}
!162 = distinct !{!162, !29}
!163 = distinct !{!163, !29}
