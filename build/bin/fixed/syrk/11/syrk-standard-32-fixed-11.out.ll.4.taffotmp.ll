; ModuleID = './build/bin/fixed/syrk/11/syrk-standard-32-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.info !58, !taffo.initweight !55, !taffo.constinfo !61, !taffo.originalCall !62
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 32), !taffo.info !63, !taffo.initweight !55, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.info !65, !taffo.initweight !66, !taffo.constinfo !67, !taffo.target !50, !taffo.originalCall !68
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.info !69, !taffo.initweight !66, !taffo.constinfo !67, !taffo.originalCall !68
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div = fdiv float %conv, %conv6, !taffo.info !136, !taffo.initweight !98
...
for.body18:                                       ; preds = %for.cond15
  ...
  %rem21 = srem i32 %add20, %m, !taffo.info !149, !taffo.initweight !76
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !151, !taffo.initweight !97
  %conv23 = sitofp i32 %m to float, !taffo.info !152
  %div24 = fdiv float %conv22, %conv23, !taffo.info !153, !taffo.initweight !98
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !160
  %conv = sitofp i32 %factor to float, !taffo.info !161
  %mul = fmul float %1, %conv, !taffo.info !169, !taffo.initweight !165
  %2 = mul nsw i32 %i.0, %m, !taffo.info !86
...
!94 = !{double 3.200000e+01, double 3.200000e+01}
...
!101 = !{double 0.000000e+00, double 0x40BF1774B336F990}
!102 = distinct !{!102, !23}
!103 = !{!104, !53, i1 false, i2 -1}
!104 = !{!"fixp", i32 32, i32 26}
!105 = !{!104, !106, i1 false, i2 -1}
!106 = !{double 0.000000e+00, double 4.500000e+01}
!107 = !{!49, !108, i1 false, i2 -1}
!108 = !{double 0.000000e+00, double 1.350000e+03}
!109 = !{!49, !110, i1 false, i2 -1}
!110 = !{double 0.000000e+00, double 0x40BF2EE14003254E}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
...
!143 = distinct !{!143, !23}
!144 = !{i1 false, !78, i1 false, i2 1}
!145 = distinct !{!145, !23}
!146 = !{i1 false, !85, i1 false, i2 1}
...
!151 = !{!134, !150, i1 false, i2 1}
!152 = !{!134, !17, i1 false, i2 1}
...
!159 = !{i32 1, !82, i32 1, !82, i32 1, !48, i32 1, !93}
!160 = !{i32 8}
!161 = !{!104, !94, i1 false, i2 1}
!162 = !{!163, !164, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 14}
!164 = !{double 0.000000e+00, double 0x4109E8E14003254E}
!165 = !{i32 9}
!166 = distinct !{!166, !23}
!167 = distinct !{!167, !23}
!168 = !{i32 1, !82, i32 1, !16, i32 1, !51, i32 1, !93}
!169 = !{!170, !171, i1 false, i2 -1}
!170 = !{!"fixp", i32 32, i32 22}
!171 = !{double 0.000000e+00, double 9.600000e+02}
!172 = distinct !{!172, !23}
!173 = distinct !{!173, !23}
