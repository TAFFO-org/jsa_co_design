; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,2.6625) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,1.9) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [31 x i8] c"scalar(range(0.025,0.5) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.05,1.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [39 x i8] c"scalar(range(0.016667,0.333333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.8 = private unnamed_addr constant [48 x i8] c"target('w') scalar(range(0.0,213.954514) final)\00", section "llvm.metadata", !taffo.info !4
@.str.9 = private unnamed_addr constant [33 x i8] c"scalar(range(0.0,5.55125) final)\00", section "llvm.metadata", !taffo.info !0
@.str.10 = private unnamed_addr constant [33 x i8] c"scalar(range(0.0125,0.25) final)\00", section "llvm.metadata", !taffo.info !0
@.str.11 = private unnamed_addr constant [39 x i8] c"scalar(range(0.011111,0.222222) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !74, !taffo.info !54, !taffo.originalCall !77, !taffo.constinfo !78
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 2), !taffo.initweight !74, !taffo.info !56, !taffo.originalCall !77, !taffo.constinfo !78
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.initweight !80, !taffo.info !58, !taffo.originalCall !81, !taffo.constinfo !82
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !59
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 2), !taffo.initweight !79, !taffo.info !59, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !61
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 2), !taffo.initweight !79, !taffo.info !61, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !63
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 2), !taffo.initweight !79, !taffo.info !63, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !65
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 2), !taffo.initweight !79, !taffo.info !65, !taffo.originalCall !83, !taffo.constinfo !84
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 2), !taffo.initweight !79, !taffo.info !67, !taffo.target !68, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !74, !taffo.info !69
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 2), !taffo.initweight !79, !taffo.info !69, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !74, !taffo.info !70
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 2), !taffo.initweight !79, !taffo.info !70, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !74, !taffo.info !72
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 2), !taffo.initweight !79, !taffo.info !72, !taffo.originalCall !83, !taffo.constinfo !84
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !147 !taffo.funinfo !149 !taffo.sourceFunction !77 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !151 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !59
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !154
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !59
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !59
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !157 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !61
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !63
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !61
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !61
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !159 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !63
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !160
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !63
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !63
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !163 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !65
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !164
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !65
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !65
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !167 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !67
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !168
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !67
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !67
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !171 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !69
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !172
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !69
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !69
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.9(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !175 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !70
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !61
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !70
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !70
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemver.10(i32 noundef %n, float noundef %alpha, float noundef %beta, [20 x float]* noundef %A, float* noundef %u1, float* noundef %v1, float* noundef %u2, float* noundef %v2, float* noundef %w, float* noundef %x, float* noundef %y, float* noundef %z) #0 !taffo.initweight !177 !taffo.funinfo !178 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !152, !taffo.info !58
  %0 = load float, float* %arrayidx4, align 4, !taffo.initweight !153, !taffo.info !58
  %arrayidx5 = getelementptr inbounds float, float* %u1, i32 %i.0, !taffo.initweight !112, !taffo.info !59
  %1 = load float, float* %arrayidx5, align 4, !taffo.initweight !152, !taffo.info !59
  %arrayidx6 = getelementptr inbounds float, float* %v1, i32 %j.0, !taffo.initweight !112, !taffo.info !61
  %2 = load float, float* %arrayidx6, align 4, !taffo.initweight !152, !taffo.info !61
  %mul = fmul float %1, %2, !taffo.initweight !153, !taffo.info !179
  %add = fadd float %0, %mul, !taffo.initweight !181, !taffo.info !182
  %arrayidx7 = getelementptr inbounds float, float* %u2, i32 %i.0, !taffo.initweight !112, !taffo.info !63
  %3 = load float, float* %arrayidx7, align 4, !taffo.initweight !152, !taffo.info !63
  %arrayidx8 = getelementptr inbounds float, float* %v2, i32 %j.0, !taffo.initweight !112, !taffo.info !65
  %4 = load float, float* %arrayidx8, align 4, !taffo.initweight !152, !taffo.info !65
  %mul9 = fmul float %3, %4, !taffo.initweight !153, !taffo.info !184
  %add10 = fadd float %add, %mul9, !taffo.initweight !181, !taffo.info !186
  %arrayidx11 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.initweight !112, !taffo.info !58
  %arrayidx12 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx11, i32 0, i32 %j.0, !taffo.initweight !152, !taffo.info !58
  store float %add10, float* %arrayidx12, align 4, !taffo.initweight !153, !taffo.info !58
  br label %for.inc
...
for.body21:                                       ; preds = %for.cond19
  ...
  %5 = load float, float* %arrayidx22, align 4, !taffo.initweight !152, !taffo.info !69
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %j.1, !taffo.initweight !112, !taffo.info !58
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx23, i32 0, i32 %i.1, !taffo.initweight !152, !taffo.info !58
  %6 = load float, float* %arrayidx24, align 4, !taffo.initweight !153, !taffo.info !58
  %mul25 = fmul float %beta, %6, !taffo.initweight !112, !taffo.info !190
  %arrayidx26 = getelementptr inbounds float, float* %y, i32 %j.1, !taffo.initweight !112, !taffo.info !70
  %7 = load float, float* %arrayidx26, align 4, !taffo.initweight !152, !taffo.info !70
  %mul27 = fmul float %mul25, %7, !taffo.initweight !152, !taffo.info !192
  %add28 = fadd float %5, %mul27, !taffo.initweight !153, !taffo.info !194
  %arrayidx29 = getelementptr inbounds float, float* %x, i32 %i.1, !taffo.initweight !112, !taffo.info !69
  store float %add28, float* %arrayidx29, align 4, !taffo.initweight !152, !taffo.info !69
  br label %for.inc30

for.inc30:                                        ; preds = %for.body21
  %inc31 = add nsw i32 %j.1, 1, !taffo.info !141, !taffo.constinfo !31
  br label %for.cond19, !llvm.loop !196
...
for.inc33:                                        ; preds = %for.end32
  ...
  br label %for.cond16, !llvm.loop !197
...
for.body38:                                       ; preds = %for.cond36
  ...
  %8 = load float, float* %arrayidx39, align 4, !taffo.initweight !152, !taffo.info !69
  %arrayidx40 = getelementptr inbounds float, float* %z, i32 %i.2, !taffo.initweight !112, !taffo.info !72
  %9 = load float, float* %arrayidx40, align 4, !taffo.initweight !152, !taffo.info !72
  %add41 = fadd float %8, %9, !taffo.initweight !153, !taffo.info !198
  %arrayidx42 = getelementptr inbounds float, float* %x, i32 %i.2, !taffo.initweight !112, !taffo.info !69
  store float %add41, float* %arrayidx42, align 4, !taffo.initweight !152, !taffo.info !69
  br label %for.inc43
...
for.body51:                                       ; preds = %for.cond49
  ...
  %10 = load float, float* %arrayidx52, align 4, !taffo.initweight !152, !taffo.info !67
  %arrayidx53 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.3, !taffo.initweight !112, !taffo.info !58
  %arrayidx54 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx53, i32 0, i32 %j.2, !taffo.initweight !152, !taffo.info !58
  %11 = load float, float* %arrayidx54, align 4, !taffo.initweight !153, !taffo.info !58
  %mul55 = fmul float %alpha, %11, !taffo.initweight !112, !taffo.info !201
  %arrayidx56 = getelementptr inbounds float, float* %x, i32 %j.2, !taffo.initweight !112, !taffo.info !69
  %12 = load float, float* %arrayidx56, align 4, !taffo.initweight !152, !taffo.info !69
  %mul57 = fmul float %mul55, %12, !taffo.initweight !152, !taffo.info !203
  %add58 = fadd float %10, %mul57, !taffo.initweight !153, !taffo.info !205
  %arrayidx59 = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.initweight !112, !taffo.info !67
  store float %add58, float* %arrayidx59, align 4, !taffo.initweight !152, !taffo.info !67
  br label %for.inc60
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !150 !taffo.funinfo !209 !taffo.sourceFunction !83 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !152, !taffo.info !72
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %0, %conv, !taffo.initweight !153, !taffo.info !210
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !112, !taffo.info !72
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !152, !taffo.info !72
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12(i32 noundef %n, float* noundef %alpha, float* noundef %beta, [20 x float]* noundef %A, float* noundef %u1, float* noundef %v1, float* noundef %u2, float* noundef %v2, float* noundef %w, float* noundef %x, float* noundef %y, float* noundef %z) #0 !taffo.initweight !213 !taffo.funinfo !178 !taffo.sourceFunction !75 {
entry:
  ...
  %conv = sitofp i32 %n to float, !taffo.initweight !79, !taffo.info !214
  br label %for.cond

for.cond:                                         ; preds = %for.inc51, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc52, %for.inc51 ], !taffo.initweight !53, !taffo.info !109
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !79, !taffo.info !215
  br i1 %cmp, label %for.body, label %for.end53, !taffo.initweight !80, !taffo.info !109

for.body:                                         ; preds = %for.cond
  %conv5 = sitofp i32 %i.0 to float, !taffo.initweight !79, !taffo.info !109
  %div = fdiv float %conv5, %conv, !taffo.initweight !79, !taffo.info !216
  %arrayidx = getelementptr inbounds float, float* %u1, i32 %i.0, !taffo.initweight !79, !taffo.info !217
  store float %div, float* %arrayidx, align 4, !taffo.initweight !80, !taffo.info !108
  %add = add nsw i32 %i.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  %conv6 = sitofp i32 %add to float, !taffo.initweight !80, !taffo.info !218
  %div7 = fdiv float %conv6, %conv, !taffo.initweight !79, !taffo.info !219
  %conv8 = fpext float %div7 to double, !taffo.initweight !80, !taffo.info !219
  %div9 = fdiv double %conv8, 2.000000e+00, !taffo.initweight !93, !taffo.info !221, !taffo.constinfo !111
  %conv10 = fptrunc double %div9 to float, !taffo.initweight !112, !taffo.info !223
  %arrayidx11 = getelementptr inbounds float, float* %u2, i32 %i.0, !taffo.initweight !79, !taffo.info !225
  store float %conv10, float* %arrayidx11, align 4, !taffo.initweight !80, !taffo.info !108
  %add12 = add nsw i32 %i.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  %conv13 = sitofp i32 %add12 to float, !taffo.initweight !80, !taffo.info !218
  %div14 = fdiv float %conv13, %conv, !taffo.initweight !79, !taffo.info !219
  %conv15 = fpext float %div14 to double, !taffo.initweight !80, !taffo.info !219
  %div16 = fdiv double %conv15, 4.000000e+00, !taffo.initweight !93, !taffo.info !226, !taffo.constinfo !113
  %conv17 = fptrunc double %div16 to float, !taffo.initweight !112, !taffo.info !228
  %arrayidx18 = getelementptr inbounds float, float* %v1, i32 %i.0, !taffo.initweight !79, !taffo.info !230
  store float %conv17, float* %arrayidx18, align 4, !taffo.initweight !80, !taffo.info !108
  %add19 = add nsw i32 %i.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  %conv20 = sitofp i32 %add19 to float, !taffo.initweight !80, !taffo.info !218
  %div21 = fdiv float %conv20, %conv, !taffo.initweight !79, !taffo.info !219
  %conv22 = fpext float %div21 to double, !taffo.initweight !80, !taffo.info !219
  %div23 = fdiv double %conv22, 6.000000e+00, !taffo.initweight !93, !taffo.info !231, !taffo.constinfo !116
  %conv24 = fptrunc double %div23 to float, !taffo.initweight !112, !taffo.info !233
  %arrayidx25 = getelementptr inbounds float, float* %v2, i32 %i.0, !taffo.initweight !79, !taffo.info !235
  store float %conv24, float* %arrayidx25, align 4, !taffo.initweight !80, !taffo.info !108
  %add26 = add nsw i32 %i.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  %conv27 = sitofp i32 %add26 to float, !taffo.initweight !80, !taffo.info !218
  %div28 = fdiv float %conv27, %conv, !taffo.initweight !79, !taffo.info !219
  %conv29 = fpext float %div28 to double, !taffo.initweight !80, !taffo.info !219
  %div30 = fdiv double %conv29, 8.000000e+00, !taffo.initweight !93, !taffo.info !236, !taffo.constinfo !119
  %conv31 = fptrunc double %div30 to float, !taffo.initweight !112, !taffo.info !238
  %arrayidx32 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.initweight !79, !taffo.info !240
  store float %conv31, float* %arrayidx32, align 4, !taffo.initweight !80, !taffo.info !108
  %add33 = add nsw i32 %i.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  %conv34 = sitofp i32 %add33 to float, !taffo.initweight !80, !taffo.info !218
  %div35 = fdiv float %conv34, %conv, !taffo.initweight !79, !taffo.info !219
  %conv36 = fpext float %div35 to double, !taffo.initweight !80, !taffo.info !219
  %div37 = fdiv double %conv36, 9.000000e+00, !taffo.initweight !93, !taffo.info !241, !taffo.constinfo !122
  %conv38 = fptrunc double %div37 to float, !taffo.initweight !112, !taffo.info !243
  %arrayidx39 = getelementptr inbounds float, float* %z, i32 %i.0, !taffo.initweight !79, !taffo.info !245
  store float %conv38, float* %arrayidx39, align 4, !taffo.initweight !80, !taffo.info !108
  %arrayidx40 = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.initweight !79, !taffo.info !246
  store float 0.000000e+00, float* %arrayidx40, align 4, !taffo.initweight !80, !taffo.info !108, !taffo.constinfo !125
  %arrayidx41 = getelementptr inbounds float, float* %w, i32 %i.0, !taffo.initweight !79, !taffo.info !247
  store float 0.000000e+00, float* %arrayidx41, align 4, !taffo.initweight !80, !taffo.info !108, !taffo.constinfo !125
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !53, !taffo.info !109
  %cmp43 = icmp slt i32 %j.0, %n, !taffo.initweight !79, !taffo.info !215
  br i1 %cmp43, label %for.body45, label %for.end, !taffo.initweight !80, !taffo.info !109

for.body45:                                       ; preds = %for.cond42
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !79, !taffo.info !248
  %rem = srem i32 %mul, %n, !taffo.initweight !80, !taffo.info !250
  %conv46 = sitofp i32 %rem to float, !taffo.initweight !93, !taffo.info !250
  %conv47 = sitofp i32 %n to float, !taffo.info !139
  %div48 = fdiv float %conv46, %conv47, !taffo.initweight !112, !taffo.info !179
  %arrayidx49 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.initweight !79, !taffo.info !252
  %arrayidx50 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx49, i32 0, i32 %j.0, !taffo.initweight !79, !taffo.info !252
  store float %div48, float* %arrayidx50, align 4, !taffo.initweight !80, !taffo.info !108
  br label %for.inc

for.inc:                                          ; preds = %for.body45
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  br label %for.cond42, !llvm.loop !253

for.end:                                          ; preds = %for.cond42
  br label %for.inc51

for.inc51:                                        ; preds = %for.end
  %inc52 = add nsw i32 %i.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.13(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !255 !taffo.funinfo !256 !taffo.sourceFunction !81 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !152, !taffo.info !58
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !153, !taffo.info !58
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !181, !taffo.info !58
  %conv = sitofp i32 %factor to float, !taffo.info !29
  %mul = fmul float %1, %conv, !taffo.initweight !257, !taffo.info !258
  %2 = mul nsw i32 %i.0, %m, !taffo.info !126
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !152, !taffo.info !58
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !153, !taffo.info !58
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !181, !taffo.info !58
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 5.551250e+00}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x406ABE8B60F1B25F}
!10 = !{i1 false, !11, i1 false, i2 0}
!11 = !{double 0.000000e+00, double 2.662500e+00}
...
!60 = !{double 0.000000e+00, double 1.900000e+00}
!61 = !{i1 false, !62, i1 false, i2 -1}
!62 = !{double 2.500000e-02, double 5.000000e-01}
!63 = !{i1 false, !64, i1 false, i2 -1}
!64 = !{double 5.000000e-02, double 1.000000e+00}
!65 = !{i1 false, !66, i1 false, i2 -1}
!66 = !{double 1.666700e-02, double 3.333330e-01}
!67 = !{i1 false, !9, i1 false, i2 -1}
!68 = !{!"w"}
!69 = !{i1 false, !7, i1 false, i2 -1}
!70 = !{i1 false, !71, i1 false, i2 -1}
!71 = !{double 1.250000e-02, double 2.500000e-01}
!72 = !{i1 false, !73, i1 false, i2 -1}
!73 = !{double 1.111100e-02, double 2.222220e-01}
!74 = !{i32 1}
...
!146 = distinct !{!146, !33}
!147 = !{i32 1, i32 -1}
!148 = !{i32 1, !54, i32 1, !29}
!149 = !{i32 1, !56, i32 1, !29}
!150 = !{i32 -1, i32 2, i32 -1}
!151 = !{i32 1, !139, i32 1, !59, i32 1, !29}
!152 = !{i32 6}
!153 = !{i32 7}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 3.800000e+00}
!156 = distinct !{!156, !33}
!157 = !{i32 1, !139, i32 1, !61, i32 1, !29}
!158 = distinct !{!158, !33}
!159 = !{i32 1, !139, i32 1, !63, i32 1, !29}
!160 = !{i1 false, !161, i1 false, i2 -1}
!161 = !{double 1.000000e-01, double 2.000000e+00}
!162 = distinct !{!162, !33}
!163 = !{i32 1, !139, i32 1, !65, i32 1, !29}
!164 = !{i1 false, !165, i1 false, i2 -1}
!165 = !{double 3.333400e-02, double 0x3FE55553EF6B5D46}
!166 = distinct !{!166, !33}
!167 = !{i32 1, !139, i32 1, !67, i32 1, !29}
!168 = !{i1 false, !169, i1 false, i2 -1}
!169 = !{double 0.000000e+00, double 0x407ABE8B60F1B25F}
!170 = distinct !{!170, !33}
!171 = !{i32 1, !139, i32 1, !69, i32 1, !29}
!172 = !{i1 false, !173, i1 false, i2 -1}
!173 = !{double 0.000000e+00, double 1.110250e+01}
!174 = distinct !{!174, !33}
!175 = !{i32 1, !139, i32 1, !70, i32 1, !29}
!176 = distinct !{!176, !33}
!177 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!178 = !{i32 1, !139, i32 1, !54, i32 1, !56, i32 1, !58, i32 1, !59, i32 1, !61, i32 1, !63, i32 1, !65, i32 1, !67, i32 1, !69, i32 1, !70, i32 1, !72}
!179 = !{i1 false, !180, i1 false, i2 -1}
!180 = !{double 0.000000e+00, double 0x3FEE666666666666}
!181 = !{i32 8}
!182 = !{i1 false, !183, i1 false, i2 -1}
!183 = !{double 0.000000e+00, double 3.612500e+00}
!184 = !{i1 false, !185, i1 false, i2 -1}
!185 = !{double 0x3F4B4EA57F80E9A0, double 3.333330e-01}
!186 = !{i1 false, !187, i1 false, i2 -1}
!187 = !{double 0x3F4B4EA57F80E9A0, double 0x400F9110E453D20F}
!188 = distinct !{!188, !33}
!189 = distinct !{!189, !33}
!190 = !{i1 false, !191, i1 false, i2 -1}
!191 = !{double 0.000000e+00, double 3.195000e+00}
!192 = !{i1 false, !193, i1 false, i2 -1}
!193 = !{double 0.000000e+00, double 7.987500e-01}
!194 = !{i1 false, !195, i1 false, i2 -1}
!195 = !{double 0.000000e+00, double 6.350000e+00}
!196 = distinct !{!196, !33}
!197 = distinct !{!197, !33}
!198 = !{i1 false, !199, i1 false, i2 -1}
!199 = !{double 1.111100e-02, double 0x401718090B417CA2}
!200 = distinct !{!200, !33}
!201 = !{i1 false, !202, i1 false, i2 -1}
!202 = !{double 0.000000e+00, double 0x400FF33333333334}
!203 = !{i1 false, !204, i1 false, i2 -1}
!204 = !{double 0.000000e+00, double 0x40362B9916872B02}
!205 = !{i1 false, !206, i1 false, i2 -1}
!206 = !{double 0.000000e+00, double 0x406D83FE83C297BF}
!207 = distinct !{!207, !33}
!208 = distinct !{!208, !33}
!209 = !{i32 1, !139, i32 1, !72, i32 1, !29}
!210 = !{i1 false, !211, i1 false, i2 -1}
!211 = !{double 2.222200e-02, double 4.444440e-01}
!212 = distinct !{!212, !33}
!213 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!214 = !{i1 false, !140, i1 false, i2 1}
!215 = !{i1 false, !90, i1 false, i2 -1}
!216 = !{i1 false, !90, i1 false, i2 1}
!217 = !{i1 false, !60, i1 false, i2 1}
!218 = !{i1 false, !98, i1 false, i2 -1}
...
!225 = !{i1 false, !64, i1 false, i2 1}
!226 = !{i1 false, !227, i1 false, i2 1}
!227 = !{double 1.250000e-02, double 2.625000e-01}
!228 = !{i1 false, !229, i1 false, i2 1}
!229 = !{double 0x3F89999980000000, double 0x3FD0CCCCE0000000}
!230 = !{i1 false, !62, i1 false, i2 1}
!231 = !{i1 false, !232, i1 false, i2 1}
!232 = !{double 0x3F81111111111111, double 0x3FC6666666666667}
!233 = !{i1 false, !234, i1 false, i2 1}
!234 = !{double 0x3F81111100000000, double 0x3FC6666680000000}
!235 = !{i1 false, !66, i1 false, i2 1}
!236 = !{i1 false, !237, i1 false, i2 1}
!237 = !{double 6.250000e-03, double 1.312500e-01}
!238 = !{i1 false, !239, i1 false, i2 1}
!239 = !{double 0x3F79999980000000, double 0x3FC0CCCCE0000000}
!240 = !{i1 false, !71, i1 false, i2 1}
!241 = !{i1 false, !242, i1 false, i2 1}
!242 = !{double 0x3F76C16C16C16C17, double 0x3FBDDDDDDDDDDDDE}
!243 = !{i1 false, !244, i1 false, i2 1}
!244 = !{double 0x3F76C16C00000000, double 0x3FBDDDDDE0000000}
!245 = !{i1 false, !73, i1 false, i2 1}
!246 = !{i1 false, !7, i1 false, i2 1}
!247 = !{i1 false, !9, i1 false, i2 1}
!248 = !{i1 false, !249, i1 false, i2 -1}
!249 = !{double 0.000000e+00, double 4.000000e+02}
!250 = !{i1 false, !251, i1 false, i2 -1}
!251 = !{double 0.000000e+00, double 1.900000e+01}
!252 = !{i1 false, !11, i1 false, i2 1}
!253 = distinct !{!253, !33}
!254 = distinct !{!254, !33}
!255 = !{i32 -1, i32 -1, i32 3, i32 -1}
!256 = !{i32 1, !139, i32 1, !139, i32 1, !58, i32 1, !29}
!257 = !{i32 9}
!258 = !{i1 false, !259, i1 false, i2 -1}
!259 = !{double 0.000000e+00, double 5.325000e+00}
!260 = distinct !{!260, !33}
!261 = distinct !{!261, !33}
