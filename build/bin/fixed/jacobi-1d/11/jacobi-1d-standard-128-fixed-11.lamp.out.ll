; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-128-fixed-11.out.ll'
...
entry:
  %A.u8_24fixp = alloca [15 x i32], align 4, !taffo.info !41, !taffo.target !44
  %B.u8_24fixp = alloca [15 x i32], align 4, !taffo.info !45
  %arraydecay.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u8_24fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %arraydecay3.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !45
  call void @init_array.4_fixp(i32 15, i32* %arraydecay.u8_24fixp, i32* %arraydecay3.u8_24fixp), !taffo.info !47, !taffo.constinfo !48, !taffo.target !44
  %arraydecay4.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u8_24fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  call void @scale_1d.1_fixp(i32 15, i32* %arraydecay4.u8_24fixp, i32 128), !taffo.info !47, !taffo.constinfo !48, !taffo.target !44
  %arraydecay5.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !45
  call void @scale_1d.1_fixp(i32 15, i32* %arraydecay5.u8_24fixp, i32 128), !taffo.info !49, !taffo.constinfo !48
  call void @timer_start(), !taffo.constinfo !50
  %arraydecay6.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u8_24fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %arraydecay7.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !45
  call void @kernel_jacobi_1d.2_fixp(i32 10, i32 15, i32* %arraydecay6.u8_24fixp, i32* %arraydecay7.u8_24fixp), !taffo.info !47, !taffo.constinfo !51, !taffo.target !44
...
for.body:                                         ; preds = %for.cond
  %arrayidx.u8_24fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u8_24fixp, i32 0, i32 %i.0, !taffo.info !41, !taffo.target !44
  %u8_24fixp = load i32, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !41, !taffo.target !44
  %0 = uitofp i32 %u8_24fixp to float, !taffo.info !41, !taffo.target !44
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !68 !taffo.funinfo !69 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !41
  %u8_24fixp = load i32, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !41
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !73
  %0 = lshr i32 %u8_24fixp, 1, !taffo.info !41
  %1 = lshr i32 %conv.u8_24fixp, 1, !taffo.info !73
  %2 = ashr i32 %0, 7, !taffo.info !41
  %3 = ashr i32 %1, 7, !taffo.info !73
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !74
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !77
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !41
  %5 = shl i32 %mul.u15_17fixp, 7, !taffo.info !77
  store i32 %5, i32* %arrayidx1.u8_24fixp, align 4, !taffo.info !47
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_1d.2_fixp(i32 noundef %tsteps, i32 noundef %n, i32* noundef %A.u8_24fixp, i32* noundef %B.u8_24fixp) #0 !taffo.initweight !80 !taffo.funinfo !81 !taffo.sourceFunction !82 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx.u8_24fixp = getelementptr inbounds i32, i32* %A.u8_24fixp, i32 %sub4, !taffo.info !41
  %u8_24fixp = load i32, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !87
  %arrayidx5.u8_24fixp = getelementptr inbounds i32, i32* %A.u8_24fixp, i32 %i.0, !taffo.info !41
  %u8_24fixp1 = load i32, i32* %arrayidx5.u8_24fixp, align 4, !taffo.info !87
  %0 = lshr i32 %u8_24fixp, 1, !taffo.info !87
  %1 = lshr i32 %u8_24fixp1, 1, !taffo.info !87
  %add.u9_23fixp = add i32 %0, %1, !taffo.info !89
  %add6 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx7.u8_24fixp = getelementptr inbounds i32, i32* %A.u8_24fixp, i32 %add6, !taffo.info !41
  %u8_24fixp2 = load i32, i32* %arrayidx7.u8_24fixp, align 4, !taffo.info !87
  %2 = lshr i32 %u8_24fixp2, 1, !taffo.info !87
  %add8.u9_23fixp = add i32 %add.u9_23fixp, %2, !taffo.info !91
  %3 = lshr i32 715820724, 1
  %4 = lshr i32 %add8.u9_23fixp, 1, !taffo.info !91
  %5 = ashr i32 %3, 8
  %6 = call i32 @llvm.smul.fix.i32(i32 %5, i32 %4, i32 22), !taffo.info !93
  %mul.u9_23fixp = shl i32 %6, 1, !taffo.info !96, !taffo.constinfo !97
  %conv9.u8_24fixp = shl i32 %mul.u9_23fixp, 1, !taffo.info !100, !taffo.constinfo !97
  %arrayidx10.u8_24fixp = getelementptr inbounds i32, i32* %B.u8_24fixp, i32 %i.0, !taffo.info !45
  store i32 %conv9.u8_24fixp, i32* %arrayidx10.u8_24fixp, align 4, !taffo.info !49
  br label %for.inc
...
for.body15:                                       ; preds = %for.cond11
  ...
  %arrayidx17.u8_24fixp = getelementptr inbounds i32, i32* %B.u8_24fixp, i32 %sub16, !taffo.info !45
  %u8_24fixp3 = load i32, i32* %arrayidx17.u8_24fixp, align 4, !taffo.info !103
  %arrayidx18.u8_24fixp = getelementptr inbounds i32, i32* %B.u8_24fixp, i32 %i.1, !taffo.info !45
  %u8_24fixp4 = load i32, i32* %arrayidx18.u8_24fixp, align 4, !taffo.info !103
  %7 = lshr i32 %u8_24fixp3, 1, !taffo.info !103
  %8 = lshr i32 %u8_24fixp4, 1, !taffo.info !103
  %add19.u9_23fixp = add i32 %7, %8, !taffo.info !104
  %add20 = add nsw i32 %i.1, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx21.u8_24fixp = getelementptr inbounds i32, i32* %B.u8_24fixp, i32 %add20, !taffo.info !45
  %u8_24fixp5 = load i32, i32* %arrayidx21.u8_24fixp, align 4, !taffo.info !103
  %9 = lshr i32 %u8_24fixp5, 1, !taffo.info !103
  %add22.u9_23fixp = add i32 %add19.u9_23fixp, %9, !taffo.info !106
  %10 = lshr i32 715820724, 1
  %11 = lshr i32 %add22.u9_23fixp, 1, !taffo.info !106
  %12 = ashr i32 %10, 8
  %13 = call i32 @llvm.smul.fix.i32(i32 %12, i32 %11, i32 22), !taffo.info !108
  %mul24.u9_23fixp = shl i32 %13, 1, !taffo.info !110, !taffo.constinfo !97
  %conv25.u8_24fixp = shl i32 %mul24.u9_23fixp, 1, !taffo.info !111, !taffo.constinfo !97
  %arrayidx26.u8_24fixp = getelementptr inbounds i32, i32* %A.u8_24fixp, i32 %i.1, !taffo.info !41
  store i32 %conv25.u8_24fixp, i32* %arrayidx26.u8_24fixp, align 4, !taffo.info !47
  br label %for.inc27
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32* noundef %A.u8_24fixp, i32* noundef %B.u8_24fixp) #0 !taffo.initweight !115 !taffo.funinfo !116 !taffo.sourceFunction !117 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx.u8_24fixp = getelementptr inbounds i32, i32* %A.u8_24fixp, i32 %i.0, !taffo.info !134
  %3 = ashr i32 %div.s5_27fixp, 3, !taffo.info !133
  store i32 %3, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !135
  ...
  %arrayidx7.u8_24fixp = getelementptr inbounds i32, i32* %B.u8_24fixp, i32 %i.0, !taffo.info !144
  %7 = ashr i32 %div6.s5_27fixp, 3, !taffo.info !143
  store i32 %7, i32* %arrayidx7.u8_24fixp, align 4, !taffo.info !135
  br label %for.inc
...
!1 = !{double 0.000000e+00, double 0x406111111F0C34C2}
...
!43 = !{double 0x40311111276FB092, double 0x406111111F0C34C2}
!44 = !{!"A"}
!45 = !{!42, !46, i1 false, i2 -1}
!46 = !{double 2.560000e+01, double 0x4062222220BC382A}
...
!71 = !{double 1.280000e+02, double 1.280000e+02}
!72 = !{void (i32, float*, i32)* @scale_1d}
!73 = !{!42, !71, i1 false, i2 1}
!74 = !{!75, !76, i1 false, i2 -1}
!75 = !{!"fixp", i32 -32, i32 16}
!76 = !{double 0x40A11111276FB092, double 0x40D111111F0C34C2}
...
!90 = !{double 0x40411111276FB092, double 0x407111111F0C34C2}
!91 = !{!88, !92, i1 false, i2 -1}
!92 = !{double 0x40499999BB2788DB, double 0x40799999AE924F23}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 22}
!95 = !{double 0x40311105F81FE170, double 0x40611105EFBC6B1F}
!96 = !{!88, !95, i1 false, i2 -1}
!97 = !{!98, i1 false}
!98 = !{i1 false, !99, i1 false, i2 0}
!99 = !{double 3.333300e-01, double 3.333300e-01}
!100 = !{!42, !101, i1 false, i2 -1}
!101 = !{double 0x40311105E0000000, double 0x4061110600000000}
!102 = distinct !{!102, !23}
!103 = !{!88, !46, i1 false, i2 -1}
!104 = !{!88, !105, i1 false, i2 -1}
!105 = !{double 5.120000e+01, double 0x4072222220BC382A}
!106 = !{!88, !107, i1 false, i2 -1}
!107 = !{double 0x4053333333333334, double 0x407B3333311A543F}
!108 = !{!94, !109, i1 false, i2 -1}
!109 = !{double 0x40399988D2A1F8E5, double 0x406222163E777C94}
!110 = !{!88, !109, i1 false, i2 -1}
!111 = !{!42, !112, i1 false, i2 -1}
!112 = !{double 0x40399988C0000000, double 0x4062221640000000}
!113 = distinct !{!113, !23}
!114 = distinct !{!114, !23}
