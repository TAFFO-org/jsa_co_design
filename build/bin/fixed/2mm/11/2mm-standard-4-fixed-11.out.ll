; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-4-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u3_29fixp = bitcast [10 x i32]* %arraydecay13.u3_29fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u3_29fixp, i32 4), !taffo.info !66, !taffo.constinfo !65
  %arraydecay14.u3_29fixp = getelementptr inbounds [10 x [14 x i32]], [10 x [14 x i32]]* %C.u3_29fixp, i32 0, i32 0, !taffo.info !55
  %u3_29fixp2 = bitcast [14 x i32]* %arraydecay14.u3_29fixp to i32*, !taffo.info !55
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u3_29fixp2, i32 4), !taffo.info !67, !taffo.constinfo !65
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !219 !taffo.funinfo !228 !taffo.sourceFunction !221 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u11_21fixp = load i32, i32* %arrayidx4.u11_21fixp, align 4, !taffo.info !229
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !231
  %1 = lshr i32 %u11_21fixp, 1, !taffo.info !229
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !231
  %3 = ashr i32 %1, 2, !taffo.info !229
  %4 = ashr i32 %2, 10, !taffo.info !231
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 18), !taffo.info !232
  %mul.u13_19fixp = shl i32 %5, 1, !taffo.info !235
  ...
  %7 = shl i32 %mul.u13_19fixp, 2, !taffo.info !235
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !219 !taffo.funinfo !238 !taffo.sourceFunction !221 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 6, !taffo.info !231
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !239
  %mul.u9_23fixp = shl i32 %5, 1, !taffo.info !242
  %6 = mul nsw i32 %i.0, %m, !taffo.info !92
  ...
  %7 = shl i32 %mul.u9_23fixp, 2, !taffo.info !242
...
!226 = distinct !{!226, !23}
!227 = distinct !{!227, !23}
!228 = !{i32 1, !86, i32 1, !88, i32 1, !57, i32 1, !98}
!229 = !{!230, !1, i1 false, i2 -1}
!230 = !{!"fixp", i32 32, i32 19}
!231 = !{!51, !99, i1 false, i2 1}
!232 = !{!233, !234, i1 false, i2 -1}
!233 = !{!"fixp", i32 -32, i32 18}
!234 = !{double 0.000000e+00, double 0x40B32E66601BC98A}
!235 = !{!230, !234, i1 false, i2 -1}
!236 = distinct !{!236, !23}
!237 = distinct !{!237, !23}
!238 = !{i32 1, !86, i32 1, !16, i32 1, !47, i32 1, !98}
!239 = !{!240, !241, i1 false, i2 -1}
!240 = !{!"fixp", i32 -32, i32 22}
!241 = !{double 0.000000e+00, double 0x407273331E3A7DAA}
!242 = !{!128, !241, i1 false, i2 -1}
!243 = distinct !{!243, !23}
!244 = distinct !{!244, !23}
