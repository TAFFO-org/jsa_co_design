; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,1.9) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [48 x i8] c"target('x1') scalar(range(0.0,21.300001) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [48 x i8] c"target('x2') scalar(range(0.0,20.900002) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 2), !taffo.initweight !58, !taffo.info !55, !taffo.target !56, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 2), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 2), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !102, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %0, %conv, !taffo.initweight !103, !taffo.info !104
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !82, !taffo.info !53
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !102, !taffo.info !53
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.2(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !100 !taffo.funinfo !107 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !102, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %0, %conv, !taffo.initweight !103, !taffo.info !108
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !82, !taffo.info !55
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !102, !taffo.info !55
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !100 !taffo.funinfo !111 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !102, !taffo.info !51
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %0, %conv, !taffo.initweight !103, !taffo.info !112
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !82, !taffo.info !51
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !102, !taffo.info !51
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_mvt.4(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !115 !taffo.funinfo !116 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx5 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx4, i32 0, i32 %j.0, !taffo.initweight !102, !taffo.info !51
  %1 = load float, float* %arrayidx5, align 4, !taffo.initweight !103, !taffo.info !51
  %arrayidx6 = getelementptr inbounds float, float* %y_1, i32 %j.0, !taffo.initweight !82, !taffo.info !51
  %2 = load float, float* %arrayidx6, align 4, !taffo.initweight !102, !taffo.info !51
  %mul = fmul float %1, %2, !taffo.initweight !103, !taffo.info !117
  %add = fadd float %0, %mul, !taffo.initweight !103, !taffo.info !119
  %arrayidx7 = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.initweight !82, !taffo.info !53
  store float %add, float* %arrayidx7, align 4, !taffo.initweight !102, !taffo.info !53
  br label %for.inc
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = load float, float* %arrayidx17, align 4, !taffo.initweight !102, !taffo.info !55
  %arrayidx18 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %j.1, !taffo.initweight !82, !taffo.info !51
  %arrayidx19 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx18, i32 0, i32 %i.1, !taffo.initweight !102, !taffo.info !51
  %4 = load float, float* %arrayidx19, align 4, !taffo.initweight !103, !taffo.info !51
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %j.1, !taffo.initweight !82, !taffo.info !51
  %5 = load float, float* %arrayidx20, align 4, !taffo.initweight !102, !taffo.info !51
  %mul21 = fmul float %4, %5, !taffo.initweight !103, !taffo.info !117
  %add22 = fadd float %3, %mul21, !taffo.initweight !103, !taffo.info !123
  %arrayidx23 = getelementptr inbounds float, float* %x2, i32 %i.1, !taffo.initweight !82, !taffo.info !55
  store float %add22, float* %arrayidx23, align 4, !taffo.initweight !102, !taffo.info !55
  br label %for.inc24

for.inc24:                                        ; preds = %for.body16
  %inc25 = add nsw i32 %j.1, 1, !taffo.info !93, !taffo.constinfo !29
  br label %for.cond14, !llvm.loop !125
...
for.inc27:                                        ; preds = %for.end26
  ...
  br label %for.cond11, !llvm.loop !126
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !100 !taffo.funinfo !111 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !115 !taffo.funinfo !116 !taffo.sourceFunction !59 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc31, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc32, %for.inc31 ], !taffo.initweight !50, !taffo.info !128
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !58, !taffo.info !129
  br i1 %cmp, label %for.body, label %for.end33, !taffo.initweight !61, !taffo.info !78

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.initweight !58, !taffo.info !130
  %conv = sitofp i32 %rem to float, !taffo.initweight !61, !taffo.info !130
  %conv3 = sitofp i32 %n to float, !taffo.info !91
  %div = fdiv float %conv, %conv3, !taffo.initweight !80, !taffo.info !132
  %arrayidx = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.initweight !58, !taffo.info !134
  store float %div, float* %arrayidx, align 4, !taffo.initweight !61, !taffo.info !81
  %add = add nsw i32 %i.0, 1, !taffo.initweight !58, !taffo.info !135, !taffo.constinfo !29
  %rem4 = srem i32 %add, %n, !taffo.initweight !61, !taffo.info !130
  %conv5 = sitofp i32 %rem4 to float, !taffo.initweight !80, !taffo.info !130
  %conv6 = sitofp i32 %n to float, !taffo.info !91
  %div7 = fdiv float %conv5, %conv6, !taffo.initweight !82, !taffo.info !132
  %arrayidx8 = getelementptr inbounds float, float* %x2, i32 %i.0, !taffo.initweight !58, !taffo.info !136
  store float %div7, float* %arrayidx8, align 4, !taffo.initweight !61, !taffo.info !81
  %add9 = add nsw i32 %i.0, 3, !taffo.initweight !58, !taffo.info !137, !taffo.constinfo !29
  %rem10 = srem i32 %add9, %n, !taffo.initweight !61, !taffo.info !130
  %conv11 = sitofp i32 %rem10 to float, !taffo.initweight !80, !taffo.info !130
  %conv12 = sitofp i32 %n to float, !taffo.info !91
  %div13 = fdiv float %conv11, %conv12, !taffo.initweight !82, !taffo.info !132
  %arrayidx14 = getelementptr inbounds float, float* %y_1, i32 %i.0, !taffo.initweight !58, !taffo.info !139
  store float %div13, float* %arrayidx14, align 4, !taffo.initweight !61, !taffo.info !81
  %add15 = add nsw i32 %i.0, 4, !taffo.initweight !58, !taffo.info !140, !taffo.constinfo !29
  %rem16 = srem i32 %add15, %n, !taffo.initweight !61, !taffo.info !130
  %conv17 = sitofp i32 %rem16 to float, !taffo.initweight !80, !taffo.info !130
  %conv18 = sitofp i32 %n to float, !taffo.info !91
  %div19 = fdiv float %conv17, %conv18, !taffo.initweight !82, !taffo.info !132
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %i.0, !taffo.initweight !58, !taffo.info !139
  store float %div19, float* %arrayidx20, align 4, !taffo.initweight !61, !taffo.info !81
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !50, !taffo.info !128
  %cmp22 = icmp slt i32 %j.0, %n, !taffo.initweight !58, !taffo.info !129
  br i1 %cmp22, label %for.body24, label %for.end, !taffo.initweight !61, !taffo.info !78

for.body24:                                       ; preds = %for.cond21
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !58, !taffo.info !142
  %rem25 = srem i32 %mul, %n, !taffo.initweight !61, !taffo.info !130
  %conv26 = sitofp i32 %rem25 to float, !taffo.initweight !80, !taffo.info !130
  %conv27 = sitofp i32 %n to float, !taffo.info !91
  %div28 = fdiv float %conv26, %conv27, !taffo.initweight !82, !taffo.info !132
  %arrayidx29 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.initweight !58, !taffo.info !139
  %arrayidx30 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx29, i32 0, i32 %j.0, !taffo.initweight !58, !taffo.info !139
  store float %div28, float* %arrayidx30, align 4, !taffo.initweight !61, !taffo.info !81
  br label %for.inc

for.inc:                                          ; preds = %for.body24
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !58, !taffo.info !135, !taffo.constinfo !29
...
for.inc31:                                        ; preds = %for.end
  %inc32 = add nsw i32 %i.0, 1, !taffo.initweight !58, !taffo.info !135, !taffo.constinfo !29
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !146 !taffo.funinfo !147 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !102, !taffo.info !51
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !103, !taffo.info !51
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !148, !taffo.info !51
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %1, %conv, !taffo.initweight !149, !taffo.info !112
  %2 = mul nsw i32 %i.0, %m, !taffo.info !95
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !102, !taffo.info !51
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !103, !taffo.info !51
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !148, !taffo.info !51
  br label %for.inc

for.inc:                                          ; preds = %for.body3
  %inc = add nsw i32 %j.0, 1, !taffo.info !93, !taffo.constinfo !29
  br label %for.cond1, !llvm.loop !150
...
!7 = !{double 0.000000e+00, double 0x40354CCCDD93C46E}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x4034E66687F455A8}
...
!52 = !{double 0.000000e+00, double 1.900000e+00}
...
!101 = !{i32 1, !91, i32 1, !53, i32 1, !27}
!102 = !{i32 6}
!103 = !{i32 7}
!104 = !{i1 false, !105, i1 false, i2 -1}
!105 = !{double 0.000000e+00, double 0x40454CCCDD93C46E}
!106 = distinct !{!106, !31}
!107 = !{i32 1, !91, i32 1, !55, i32 1, !27}
!108 = !{i1 false, !109, i1 false, i2 -1}
!109 = !{double 0.000000e+00, double 0x4044E66687F455A8}
!110 = distinct !{!110, !31}
!111 = !{i32 1, !91, i32 1, !51, i32 1, !27}
!112 = !{i1 false, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 3.800000e+00}
!114 = distinct !{!114, !31}
!115 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!116 = !{i32 1, !91, i32 1, !53, i32 1, !55, i32 1, !51, i32 1, !51, i32 1, !51}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 3.610000e+00}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x4038E8F5D35653CA}
!121 = distinct !{!121, !31}
!122 = distinct !{!122, !31}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4038828F7DB6E504}
!125 = distinct !{!125, !31}
!126 = distinct !{!126, !31}
!127 = distinct !{!127, !31}
!128 = !{i1 false, !69, i1 false, i2 1}
!129 = !{i1 false, !71, i1 false, i2 1}
!130 = !{i1 false, !131, i1 false, i2 1}
!131 = !{double 0.000000e+00, double 1.900000e+01}
!132 = !{i1 false, !133, i1 false, i2 1}
!133 = !{double 0.000000e+00, double 0x3FEE666666666666}
!134 = !{i1 false, !7, i1 false, i2 1}
!135 = !{i1 false, !73, i1 false, i2 1}
!136 = !{i1 false, !9, i1 false, i2 1}
!137 = !{i1 false, !138, i1 false, i2 1}
!138 = !{double 3.000000e+00, double 2.300000e+01}
!139 = !{i1 false, !52, i1 false, i2 1}
!140 = !{i1 false, !141, i1 false, i2 1}
!141 = !{double 4.000000e+00, double 2.400000e+01}
!142 = !{i1 false, !143, i1 false, i2 1}
!143 = !{double 0.000000e+00, double 4.000000e+02}
!144 = distinct !{!144, !31}
!145 = distinct !{!145, !31}
!146 = !{i32 -1, i32 -1, i32 3, i32 -1}
!147 = !{i32 1, !91, i32 1, !91, i32 1, !51, i32 1, !27}
!148 = !{i32 8}
!149 = !{i32 9}
!150 = distinct !{!150, !31}
!151 = distinct !{!151, !31}
