...
@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,3.36) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [36 x i8] c"scalar(range(16.0,31.272728) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [50 x i8] c"target('y') scalar(range(0.0,31504.384766) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,976.640015) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %x2, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 112, i8* null)
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, float* noundef %2, i32 noundef 16)
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 16)
  %arraydecay10 = getelementptr inbounds [22 x float], [22 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 16)
