; ModuleID = './build/bin/float/gesummv/11/gesummv-standard-2-float-11.out.ll'
...
@.str.3 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,1.875) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,17.625) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [47 x i8] c"target('y') scalar(range(0.0,45.300003) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay5, i32 noundef 2)
  %arraydecay6 = getelementptr inbounds [16 x [16 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay6, i32 noundef 2)
  %arraydecay7 = getelementptr inbounds [16 x float], ptr %tmp, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay7, i32 noundef 2)
  %arraydecay8 = getelementptr inbounds [16 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay8, i32 noundef 2)
  %arraydecay9 = getelementptr inbounds [16 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay9, i32 noundef 2)
