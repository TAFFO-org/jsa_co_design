; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-4-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !41, !taffo.info !30, !taffo.originalCall !43
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 4), !taffo.initweight !41, !taffo.info !32, !taffo.originalCall !43
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %3, i32 noundef 4), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 4), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 12, float* noundef %5, i32 noundef 4), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
