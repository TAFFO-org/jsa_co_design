; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-256-fixed-8.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !133 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 18), !taffo.info !134
  %mul.u13_19fixp = shl i32 %4, 1, !taffo.info !137
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u13_19fixp, 8, !taffo.info !137
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !140 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 5.120000e+02, %lampsim15, !taffo.info !141
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !145 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !146
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !149
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u15_17fixp, 8, !taffo.info !149
...
!135 = !{!"fixp", i32 -32, i32 18}
!136 = !{double 0x4076C16BDB1A6D6A, double 0x40BC71C725C3DEE8}
!137 = !{!138, !136, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 19}
!139 = distinct !{!139, !27}
!140 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!141 = !{!142, !143, i1 false, i2 -1}
!142 = !{!"float", i32 1, double 0x41D5D7B540000000}
!143 = !{double 0.000000e+00, double 0x41D5D7B540000000}
!144 = distinct !{!144, !27}
!145 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!146 = !{!147, !148, i1 false, i2 -1}
!147 = !{!"fixp", i32 -32, i32 16}
!148 = !{double 8.192000e+02, double 1.638400e+04}
