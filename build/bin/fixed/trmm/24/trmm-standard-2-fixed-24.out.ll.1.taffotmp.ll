...
@.str.2 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,2.0) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [45 x i8] c"target('B') scalar(range(0.0,21.9375) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 2)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 2)
