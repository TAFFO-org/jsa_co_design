; ModuleID = './build/stats/2mm/1/2mm-standard-1.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
for.body68:                                       ; preds = %for.cond65
  ...
  %"a::var37" = sitofp i32 %48 to float
...
for.body19:                                       ; preds = %for.cond16
  ...
  %22 = load i32, i32* %nj.addr, align 4
  %"a::var56" = sitofp i32 %22 to float
...
for.body43:                                       ; preds = %for.cond40
  ...
  %35 = load i32, i32* %nl.addr, align 4
  %"a::var59" = sitofp i32 %35 to float
...
for.body68:                                       ; preds = %for.cond65
  ...
  %48 = load i32, i32* %nk.addr, align 4
  %"a::var62" = sitofp i32 %48 to float
