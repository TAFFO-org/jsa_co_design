...
@.str = private unnamed_addr constant [35 x i8] c"scalar(range(0.1,16.344999) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(2.0,16.344999) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(8.05,9.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [52 x i8] c"target('x') scalar(range(-0.037947,3.998521) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,8.05) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %b3, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 168, i8* null)
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 2)
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 2)
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 2)
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 2)
