...
@.str = private unnamed_addr constant [50 x i8] c"target('A') scalar(range(25.6,5132.799805) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay1, i32 noundef 256)
