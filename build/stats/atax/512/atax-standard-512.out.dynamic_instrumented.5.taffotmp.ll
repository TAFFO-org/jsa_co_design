; ModuleID = './build/stats/atax/512/atax-standard-512.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4(i32 noundef 20, i32 noundef 22, float* noundef %2, i32 noundef 512), !taffo.originalCall !28
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i64 0, i64 0
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 512), !taffo.originalCall !29
  %arraydecay10 = getelementptr inbounds [22 x float], [22 x float]* %y, i64 0, i64 0
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 512), !taffo.originalCall !29
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i64 0, i64 0
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 512), !taffo.originalCall !29
