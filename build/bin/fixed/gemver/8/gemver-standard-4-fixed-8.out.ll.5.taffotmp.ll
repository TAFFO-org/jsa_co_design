; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-4-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !119 !taffo.funinfo !130 !taffo.sourceFunction !121 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u12_20fixp = load i32, i32* %arrayidx.u12_20fixp, align 4, !taffo.info !131
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !133
  %0 = lshr i32 %u12_20fixp, 1, !taffo.info !131
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !133
  %2 = ashr i32 %0, 2, !taffo.info !131
  ...
  %5 = shl i32 %mul.u14_18fixp, 2, !taffo.info !137
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !119 !taffo.funinfo !146 !taffo.sourceFunction !121 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u6_26fixp = load i32, i32* %arrayidx.u6_26fixp, align 4, !taffo.info !147
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !133
  %0 = lshr i32 %u6_26fixp, 1, !taffo.info !147
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !133
  %2 = ashr i32 %0, 1, !taffo.info !147
  %3 = ashr i32 %1, 4, !taffo.info !133
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 24), !taffo.info !149
  %mul.u7_25fixp = shl i32 %4, 1, !taffo.info !152
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !67
  %5 = shl i32 %mul.u7_25fixp, 1, !taffo.info !152
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !119 !taffo.funinfo !154 !taffo.sourceFunction !121 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u2_30fixp = load i32, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !155
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !156
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !155
  %1 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !156
  %2 = ashr i32 %0, 2, !taffo.info !155
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 27), !taffo.info !157
  %mul.u4_28fixp = shl i32 %3, 1, !taffo.info !160
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !60
  %4 = shl i32 %mul.u4_28fixp, 2, !taffo.info !160
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 27), !taffo.info !165
  %mul.u4_28fixp = shl i32 %4, 1, !taffo.info !166
  %add.u4_28fixp = add i32 %u4_28fixp, %mul.u4_28fixp, !taffo.info !167
  ...
  %u1_31fixp1 = load i32, i32* %arrayidx8.u1_31fixp, align 4, !taffo.info !169
  %5 = lshr i32 %u2_30fixp, 1, !taffo.info !60
  %6 = lshr i32 %u1_31fixp1, 1, !taffo.info !169
  %7 = ashr i32 %5, 2, !taffo.info !60
  %8 = ashr i32 %6, 3, !taffo.info !169
  %9 = call i32 @llvm.smul.fix.i32(i32 %7, i32 %8, i32 27), !taffo.info !170
  %mul9.u4_28fixp = shl i32 %9, 1, !taffo.info !172
  %add10.u4_28fixp = add i32 %add.u4_28fixp, %mul9.u4_28fixp, !taffo.info !173
...
for.body21:                                       ; preds = %for.cond19
  ...
  %12 = call i32 @llvm.smul.fix.i32(i32 %10, i32 %11, i32 27), !taffo.info !177
  %mul25.u4_28fixp = shl i32 %12, 1, !taffo.info !179
  %arrayidx26.u1_31fixp = getelementptr inbounds i32, i32* %y.u1_31fixp, i32 %j.1, !taffo.info !69
  %u1_31fixp4 = load i32, i32* %arrayidx26.u1_31fixp, align 4, !taffo.info !180
  %13 = lshr i32 %mul25.u4_28fixp, 1, !taffo.info !179
  %14 = lshr i32 %u1_31fixp4, 1, !taffo.info !180
  %15 = ashr i32 %14, 3, !taffo.info !180
  %16 = call i32 @llvm.smul.fix.i32(i32 %13, i32 %15, i32 27), !taffo.info !181
  %mul27.u4_28fixp = shl i32 %16, 1, !taffo.info !183
  %17 = lshr i32 %mul27.u4_28fixp, 2, !taffo.info !183
  %add28.u6_26fixp = add i32 %u6_26fixp, %17, !taffo.info !184
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u6_26fixp = add i32 %u6_26fixp2, %18, !taffo.info !188
...
for.body51:                                       ; preds = %for.cond49
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 27), !taffo.info !191
  %mul55.u4_28fixp = shl i32 %21, 1, !taffo.info !193
  ...
  %22 = lshr i32 %mul55.u4_28fixp, 1, !taffo.info !193
  %23 = lshr i32 %u6_26fixp3, 1, !taffo.info !67
  %24 = ashr i32 %22, 5, !taffo.info !193
  %25 = ashr i32 %23, 3, !taffo.info !67
  %26 = call i32 @llvm.smul.fix.i32(i32 %24, i32 %25, i32 22), !taffo.info !194
  %mul57.u9_23fixp = shl i32 %26, 1, !taffo.info !197
  %27 = lshr i32 %mul57.u9_23fixp, 3, !taffo.info !197
  %add58.u12_20fixp = add i32 %u12_20fixp, %27, !taffo.info !199
...
!129 = distinct !{!129, !27}
!130 = !{i32 1, !104, i32 1, !64, i32 1, !116}
!131 = !{!132, !3, i1 false, i2 -1}
!132 = !{!"fixp", i32 32, i32 18}
!133 = !{!55, !117, i1 false, i2 1}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 -32, i32 17}
!136 = !{double 0.000000e+00, double 0x40C9AA50A009F623}
...
!145 = distinct !{!145, !27}
!146 = !{i32 1, !104, i32 1, !67, i32 1, !116}
!147 = !{!148, !1, i1 false, i2 -1}
!148 = !{!"fixp", i32 32, i32 25}
!149 = !{!150, !151, i1 false, i2 -1}
!150 = !{!"fixp", i32 -32, i32 24}
!151 = !{double 0.000000e+00, double 0x405F91EB6390C910}
!152 = !{!148, !151, i1 false, i2 -1}
!153 = distinct !{!153, !27}
!154 = !{i32 1, !104, i32 1, !60, i32 1, !116}
!155 = !{!53, !61, i1 false, i2 -1}
!156 = !{!53, !117, i1 false, i2 1}
!157 = !{!158, !159, i1 false, i2 -1}
!158 = !{!"fixp", i32 -32, i32 27}
!159 = !{double 4.000000e-01, double 8.000000e+00}
!160 = !{!53, !159, i1 false, i2 -1}
!161 = distinct !{!161, !27}
!162 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!163 = !{i32 1, !104, i32 1, !89, i32 1, !90, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !60, i32 1, !62, i32 1, !64, i32 1, !67, i32 1, !69, i32 1, !71}
!164 = distinct !{null}
!165 = !{!158, !56, i1 false, i2 -1}
!166 = !{!53, !56, i1 false, i2 -1}
!167 = !{!53, !168, i1 false, i2 -1}
!168 = !{double 0.000000e+00, double 1.085000e+01}
!169 = !{!48, !63, i1 false, i2 -1}
!170 = !{!158, !171, i1 false, i2 -1}
!171 = !{double 0x3F6B4E6FCF9BB427, double 0x3FF55556084A515D}
!172 = !{!53, !171, i1 false, i2 -1}
!173 = !{!53, !174, i1 false, i2 -1}
!174 = !{double 0x3F6B4E6FCF9BB427, double 0x40285DDDF43C7D5F}
!175 = distinct !{!175, !27}
!176 = distinct !{!176, !27}
!177 = !{!158, !178, i1 false, i2 -1}
!178 = !{double 0.000000e+00, double 0x4020EB851EB851EB}
!179 = !{!53, !178, i1 false, i2 -1}
!180 = !{!55, !70, i1 false, i2 -1}
!181 = !{!158, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 0x4010EB851EB851EB}
!183 = !{!53, !182, i1 false, i2 -1}
!184 = !{!68, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 0x4041E666559F6EC5}
!186 = distinct !{!186, !27}
!187 = distinct !{!187, !27}
!188 = !{!68, !189, i1 false, i2 -1}
!189 = !{double 2.222200e-02, double 0x404001D93C46D82B}
!190 = distinct !{!190, !27}
!191 = !{!158, !192, i1 false, i2 -1}
!192 = !{double 0.000000e+00, double 1.057500e+01}
!193 = !{!53, !192, i1 false, i2 -1}
!194 = !{!195, !196, i1 false, i2 -1}
!195 = !{!"fixp", i32 -32, i32 22}
!196 = !{double 0.000000e+00, double 0x4074DDA4C701B1B0}
!197 = !{!198, !196, i1 false, i2 -1}
!198 = !{!"fixp", i32 32, i32 23}
...
!277 = !{!123, !276, i1 false, i2 -1}
!278 = !{!126, !279, i1 false, i2 -1}
