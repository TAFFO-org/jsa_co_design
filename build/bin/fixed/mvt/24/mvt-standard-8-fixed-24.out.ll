; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-8-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4160000000000000, !taffo.info !47, !taffo.target !49
  ...
  %3 = fdiv float %2, 0x4160000000000000, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !81
  %0 = lshr i32 %u9_23fixp, 1, !taffo.info !47
  %1 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !81
  %2 = ashr i32 %0, 3, !taffo.info !47
  %3 = ashr i32 %1, 8, !taffo.info !81
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !82
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !85
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u12_20fixp, 3, !taffo.info !85
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !88 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u4_28fixp = load i32, i32* %arrayidx.u4_28fixp, align 4, !taffo.info !89
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !91
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !89
  %1 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !91
  %2 = ashr i32 %0, 2, !taffo.info !89
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 25), !taffo.info !92
  %mul.u6_26fixp = shl i32 %3, 1, !taffo.info !95
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !44
  %4 = shl i32 %mul.u6_26fixp, 2, !taffo.info !95
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u4_28fixp3 = load i32, i32* %arrayidx5.u4_28fixp, align 4, !taffo.info !89
  %arrayidx6.u4_28fixp = getelementptr inbounds i32, i32* %y_1.u4_28fixp, i32 %j.0, !taffo.info !44
  %u4_28fixp = load i32, i32* %arrayidx6.u4_28fixp, align 4, !taffo.info !89
  %0 = lshr i32 %u4_28fixp3, 1, !taffo.info !89
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !89
  %2 = ashr i32 %0, 2, !taffo.info !89
  %3 = ashr i32 %1, 2, !taffo.info !89
...
for.body16:                                       ; preds = %for.cond14
  ...
  %u4_28fixp4 = load i32, i32* %arrayidx19.u4_28fixp, align 4, !taffo.info !89
  %arrayidx20.u4_28fixp = getelementptr inbounds i32, i32* %y_2.u4_28fixp, i32 %j.1, !taffo.info !44
  %u4_28fixp2 = load i32, i32* %arrayidx20.u4_28fixp, align 4, !taffo.info !89
  %6 = lshr i32 %u4_28fixp4, 1, !taffo.info !89
  %7 = lshr i32 %u4_28fixp2, 1, !taffo.info !89
  %8 = ashr i32 %6, 2, !taffo.info !89
  %9 = ashr i32 %7, 2, !taffo.info !89
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u4_28fixp = load i32, i32* %arrayidx4.u4_28fixp, align 4, !taffo.info !89
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !91
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !89
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !91
  %3 = ashr i32 %1, 2, !taffo.info !89
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !92
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !95
  ...
  %6 = shl i32 %mul.u6_26fixp, 2, !taffo.info !95
