...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,700554.25) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [42 x i8] c"scalar(range(-127872.0,230.399994) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [32 x i8] c"scalar(range(12.8,320.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 128)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 128)
