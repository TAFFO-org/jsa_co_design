; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-8-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u2_30fixp2, i32 8), !taffo.info !62, !taffo.constinfo !61
  ...
  %u2_30fixp1 = bitcast [14 x i32]* %arraydecay18.u2_30fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u2_30fixp1, i32 8), !taffo.info !65, !taffo.constinfo !61
  %arraydecay19.u2_30fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u2_30fixp, i32 0, i32 0, !taffo.info !54
  %u2_30fixp3 = bitcast [12 x i32]* %arraydecay19.u2_30fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u2_30fixp3, i32 8), !taffo.info !66, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !234 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 20), !taffo.info !235
  %mul.u11_21fixp = shl i32 %5, 1, !taffo.info !238
  ...
  %7 = shl i32 %mul.u11_21fixp, 3, !taffo.info !238
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !242 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 24), !taffo.info !243
  %mul.u7_25fixp = shl i32 %5, 1, !taffo.info !246
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u7_25fixp, 3, !taffo.info !246
...
!232 = distinct !{!232, !23}
!233 = distinct !{!233, !23}
!234 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !96}
!235 = !{!236, !237, i1 false, i2 -1}
!236 = !{!"fixp", i32 -32, i32 20}
!237 = !{double 0.000000e+00, double 0x409BCB067F0AA21A}
!238 = !{!239, !237, i1 false, i2 -1}
!239 = !{!"fixp", i32 32, i32 21}
!240 = distinct !{!240, !23}
!241 = distinct !{!241, !23}
!242 = !{i32 1, !96, i32 1, !85, i32 1, !49, i32 1, !96}
!243 = !{!244, !245, i1 false, i2 -1}
!244 = !{!"fixp", i32 -32, i32 24}
!245 = !{double 0.000000e+00, double 6.553600e+01}
!246 = !{!247, !245, i1 false, i2 -1}
!247 = !{!"fixp", i32 32, i32 25}
!248 = distinct !{!248, !23}
!249 = distinct !{!249, !23}
