; ModuleID = './build/bin/fixed/ludcmp/16/ludcmp-standard-4-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u6_26fixp, i32* noundef %b.u5_27fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u5_27fixp) #0 !taffo.initweight !95 !taffo.funinfo !96 !taffo.sourceFunction !97 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u6_26fixp = load i32, i32* %arrayidx5.u6_26fixp, align 4, !taffo.info !98
  %0 = lshr i32 %u6_26fixp, 3, !taffo.info !98
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body4
  %k.0 = phi i32 [ 0, %for.body4 ], [ %inc, %for.inc ], !taffo.info !67
  %w.0.s9_23fixp = phi i32 [ %0, %for.body4 ], [ %6, %for.inc ], !taffo.info !98
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s12_20fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 20), !taffo.info !101
  %5 = ashr i32 %w.0.s9_23fixp, 3, !taffo.info !98
  %sub.s12_20fixp = sub i32 %5, %mul.s12_20fixp, !taffo.info !104
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s12_20fixp, 3, !taffo.info !104
  br label %for.cond6, !llvm.loop !106
...
for.end:                                          ; preds = %for.cond6
  ...
  %8 = ashr i32 %w.0.s9_23fixp, 3, !taffo.info !98
  %9 = ashr i32 %7, 5, !taffo.info !42
  %div.s12_20fixp = call i32 @llvm.sdiv.fix.i32(i32 %8, i32 %9, i32 20), !taffo.info !107
  ...
  %10 = shl i32 %div.s12_20fixp, 6, !taffo.info !107
  store i32 %10, i32* %arrayidx16.u6_26fixp, align 4, !taffo.info !109
  br label %for.inc17
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u6_26fixp12 = load i32, i32* %arrayidx24.u6_26fixp, align 4, !taffo.info !98
  %11 = lshr i32 %u6_26fixp12, 3, !taffo.info !98
  br label %for.cond25

for.cond25:                                       ; preds = %for.inc34, %for.body22
  %k.1 = phi i32 [ 0, %for.body22 ], [ %inc35, %for.inc34 ], !taffo.info !67
  %w.1.s9_23fixp = phi i32 [ %11, %for.body22 ], [ %17, %for.inc34 ], !taffo.info !98
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s12_20fixp = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 20), !taffo.info !101
  %16 = ashr i32 %w.1.s9_23fixp, 3, !taffo.info !98
  %sub33.s12_20fixp = sub i32 %16, %mul32.s12_20fixp, !taffo.info !104
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %17 = shl i32 %sub33.s12_20fixp, 3, !taffo.info !104
...
for.end36:                                        ; preds = %for.cond25
  ...
  %18 = shl i32 %w.1.s9_23fixp, 3, !taffo.info !98
  store i32 %18, i32* %arrayidx38.u6_26fixp, align 4, !taffo.info !109
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u5_27fixp = load i32, i32* %arrayidx48.u5_27fixp, align 4, !taffo.info !98
  %19 = lshr i32 %u5_27fixp, 6, !taffo.info !98
  br label %for.cond49

for.cond49:                                       ; preds = %for.inc57, %for.body47
  %j.2 = phi i32 [ 0, %for.body47 ], [ %inc58, %for.inc57 ], !taffo.info !67
  %w.2.s11_21fixp = phi i32 [ %19, %for.body47 ], [ %sub56.s11_21fixp, %for.inc57 ], !taffo.info !114
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s11_21fixp = call i32 @llvm.smul.fix.i32(i32 %22, i32 %23, i32 21), !taffo.info !116
  %sub56.s11_21fixp = sub i32 %w.2.s11_21fixp, %mul55.s11_21fixp, !taffo.info !118
  br label %for.inc57
...
for.end59:                                        ; preds = %for.cond49
  ...
  %24 = shl i32 %w.2.s11_21fixp, 6, !taffo.info !114
  store i32 %24, i32* %arrayidx60.u5_27fixp, align 4, !taffo.info !109
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u5_27fixp8 = load i32, i32* %arrayidx68.u5_27fixp, align 4, !taffo.info !98
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %25 = lshr i32 %u5_27fixp8, 5, !taffo.info !98
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc77, %for.body67
  %j.3 = phi i32 [ %add, %for.body67 ], [ %inc78, %for.inc77 ], !taffo.info !126
  %w.3.s10_22fixp = phi i32 [ %25, %for.body67 ], [ %sub76.s10_22fixp, %for.inc77 ], !taffo.info !128
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s10_22fixp = call i32 @llvm.smul.fix.i32(i32 %27, i32 %28, i32 22), !taffo.info !130
  %sub76.s10_22fixp = sub i32 %w.3.s10_22fixp, %mul75.s10_22fixp, !taffo.info !132
  br label %for.inc77
...
for.end79:                                        ; preds = %for.cond69
  ...
  %30 = ashr i32 %w.3.s10_22fixp, 2, !taffo.info !128
  %31 = ashr i32 %29, 5, !taffo.info !42
  %div82.s12_20fixp = call i32 @llvm.sdiv.fix.i32(i32 %30, i32 %31, i32 20), !taffo.info !107
  %arrayidx83.s4_28fixp = getelementptr inbounds i32, i32* %x.s4_28fixp, i32 %i.2, !taffo.info !50
  %32 = shl i32 %div82.s12_20fixp, 8, !taffo.info !107
  store i32 %32, i32* %arrayidx83.s4_28fixp, align 4, !taffo.info !109
  br label %for.inc84
...
for.body:                                         ; preds = %for.cond
  ...
  %s4_28fixp = load i32, i32* %arrayidx.s4_28fixp, align 4, !taffo.info !141
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !88
  %0 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !88
  %1 = ashr i32 %s4_28fixp, 2, !taffo.info !141
  %2 = ashr i32 %0, 2, !taffo.info !88
  %mul.s6_26fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 26), !taffo.info !143
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s6_26fixp, 2, !taffo.info !143
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 20), !taffo.info !101
...
!94 = distinct !{!94, !23}
!95 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!96 = !{i32 1, !74, i32 1, !42, i32 1, !47, i32 1, !50, i32 1, !53}
!97 = distinct !{null}
!98 = !{!99, !100, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 23}
!100 = !{double -2.000000e+02, double 2.000000e+02}
!101 = !{!102, !103, i1 false, i2 -1}
!102 = !{!"fixp", i32 -32, i32 20}
!103 = !{double 0x3F847AE147AE147C, double 0x4090B28B4CA8D01D}
!104 = !{!102, !105, i1 false, i2 -1}
!105 = !{double 0xC093D28B4CA8D01D, double 1.999900e+02}
!106 = distinct !{!106, !23}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -2.000000e+03, double 2.000000e+03}
!109 = !{i1 false, !100, i1 false, i2 -1}
!110 = distinct !{!110, !23}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = !{!115, !100, i1 false, i2 -1}
!115 = !{!"fixp", i32 -32, i32 21}
!116 = !{!115, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x40807278CC8D0BED}
!118 = !{!115, !119, i1 false, i2 -1}
!119 = !{double 0xC086B278CC8D0BED, double 2.000000e+02}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
...
!128 = !{!129, !100, i1 false, i2 -1}
!129 = !{!"fixp", i32 -32, i32 22}
!130 = !{!129, !131, i1 false, i2 -1}
!131 = !{double 0xBFF3D9094EBF7CC9, double 0x406056C5D0F5C5D9}
!132 = !{!129, !133, i1 false, i2 -1}
!133 = !{double 0xC074AB62E87AE2EC, double 0x406927B2129D7EFA}
...
!144 = !{double -1.517880e-01, double 0x402FFCF893FAF428}
!145 = distinct !{!145, !23}
...
!180 = !{!142, !179, i1 false, i2 1}
!181 = !{!142, !182, i1 false, i2 1}
