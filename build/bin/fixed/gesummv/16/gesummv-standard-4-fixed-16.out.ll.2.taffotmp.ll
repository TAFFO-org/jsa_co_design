; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-4-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !44, !taffo.info !33, !taffo.originalCall !46
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 4), !taffo.initweight !44, !taffo.info !35, !taffo.originalCall !46
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 4), !taffo.initweight !48, !taffo.info !37, !taffo.originalCall !49
  ...
  call void @scale_2d.9(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 4), !taffo.initweight !48, !taffo.info !37, !taffo.originalCall !49
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.initweight !44, !taffo.info !39
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 4), !taffo.initweight !47, !taffo.info !39, !taffo.originalCall !50
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.initweight !44, !taffo.info !37
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 4), !taffo.initweight !47, !taffo.info !37, !taffo.originalCall !50
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 4), !taffo.initweight !47, !taffo.info !41, !taffo.target !43, !taffo.originalCall !50
...
!38 = !{double 0.000000e+00, double 3.750000e+00}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 0.000000e+00, double 7.050000e+01}
!41 = !{i1 false, !42, i1 false, i2 -1}
!42 = !{double 0.000000e+00, double 0x4066A6667F90D9D7}
!43 = !{!"y"}
!44 = !{i32 1}
