; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-2-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u2_30fixp2 = bitcast [10 x i32]* %arraydecay13.u2_30fixp to i32*, !taffo.info !52
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u2_30fixp2, i32 2), !taffo.info !65, !taffo.constinfo !64
  %arraydecay14.u2_30fixp = getelementptr inbounds [10 x [14 x i32]], [10 x [14 x i32]]* %C.u2_30fixp, i32 0, i32 0, !taffo.info !54
  %u2_30fixp3 = bitcast [14 x i32]* %arraydecay14.u2_30fixp to i32*, !taffo.info !54
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u2_30fixp3, i32 2), !taffo.info !66, !taffo.constinfo !64
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !215 !taffo.funinfo !225 !taffo.sourceFunction !217 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u8_24fixp = load i32, i32* %arrayidx4.u8_24fixp, align 4, !taffo.info !226
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !228
  %1 = lshr i32 %u8_24fixp, 1, !taffo.info !226
  %2 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !228
  %3 = ashr i32 %1, 1, !taffo.info !226
  %4 = ashr i32 %2, 7, !taffo.info !228
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !229
  %mul.u9_23fixp = shl i32 %5, 1, !taffo.info !232
  ...
  %7 = shl i32 %mul.u9_23fixp, 1, !taffo.info !232
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !215 !taffo.funinfo !235 !taffo.sourceFunction !217 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u6_26fixp, 1, !taffo.info !239
...
!218 = !{!108, !51, i1 false, i2 -1}
!219 = !{!108, !20, i1 false, i2 1}
!220 = !{!105, !221, i1 false, i2 -1}
!221 = !{double 0.000000e+00, double 3.500000e+00}
!222 = !{!108, !221, i1 false, i2 -1}
!223 = distinct !{!223, !23}
!224 = distinct !{!224, !23}
!225 = !{i32 1, !84, i32 1, !86, i32 1, !56, i32 1, !19}
!226 = !{!227, !1, i1 false, i2 -1}
!227 = !{!"fixp", i32 32, i32 23}
!228 = !{!43, !20, i1 false, i2 1}
!229 = !{!230, !231, i1 false, i2 -1}
!230 = !{!"fixp", i32 -32, i32 22}
!231 = !{double 0.000000e+00, double 0x40732E66601BC98A}
!232 = !{!227, !231, i1 false, i2 -1}
!233 = distinct !{!233, !23}
!234 = distinct !{!234, !23}
!235 = !{i32 1, !84, i32 1, !16, i32 1, !47, i32 1, !19}
!236 = !{!237, !238, i1 false, i2 -1}
!237 = !{!"fixp", i32 -32, i32 25}
!238 = !{double 0.000000e+00, double 0x40427333226C3B92}
!239 = !{!124, !238, i1 false, i2 -1}
!240 = distinct !{!240, !23}
!241 = distinct !{!241, !23}
