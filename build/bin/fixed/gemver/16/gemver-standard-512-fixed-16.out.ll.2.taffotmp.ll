; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-512-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.initweight !56, !taffo.info !33, !taffo.originalCall !58
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 512), !taffo.initweight !56, !taffo.info !35, !taffo.originalCall !58
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 512), !taffo.initweight !60, !taffo.info !37, !taffo.originalCall !61
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !56, !taffo.info !39
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 512), !taffo.initweight !59, !taffo.info !39, !taffo.originalCall !62
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !56, !taffo.info !41
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 512), !taffo.initweight !59, !taffo.info !41, !taffo.originalCall !62
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !56, !taffo.info !43
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 512), !taffo.initweight !59, !taffo.info !43, !taffo.originalCall !62
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !56, !taffo.info !45
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 512), !taffo.initweight !59, !taffo.info !45, !taffo.originalCall !62
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 512), !taffo.initweight !59, !taffo.info !47, !taffo.target !49, !taffo.originalCall !62
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !56, !taffo.info !50
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 512), !taffo.initweight !59, !taffo.info !50, !taffo.originalCall !62
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !56, !taffo.info !52
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 512), !taffo.initweight !59, !taffo.info !52, !taffo.originalCall !62
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !56, !taffo.info !54
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 512), !taffo.initweight !59, !taffo.info !54, !taffo.originalCall !62
...
!38 = !{double 0.000000e+00, double 0x40F48A221FFF79C8}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 0.000000e+00, double 0x407E6666601BC98A}
!41 = !{i1 false, !42, i1 false, i2 -1}
!42 = !{double 6.400000e+00, double 1.280000e+02}
!43 = !{i1 false, !44, i1 false, i2 -1}
!44 = !{double 1.280000e+01, double 2.560000e+02}
!45 = !{i1 false, !46, i1 false, i2 -1}
!46 = !{double 0x40111111276FB092, double 0x405555556084A516}
!47 = !{i1 false, !48, i1 false, i2 -1}
!48 = !{double 0.000000e+00, double 0x42C2E67000000000}
!49 = !{!"w"}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 0x4185C57280000000}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 3.200000e+00, double 6.400000e+01}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 0x4006C16C61522A6F, double 0x404C71C71D606317}
!56 = !{i32 1}
