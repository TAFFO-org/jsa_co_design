; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-32-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,30.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,4512.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [50 x i8] c"target('y') scalar(range(0.0,11596.800781) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.initweight !60, !taffo.info !50, !taffo.originalCall !63, !taffo.constinfo !64
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 32), !taffo.initweight !60, !taffo.info !52, !taffo.originalCall !63, !taffo.constinfo !64
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 32), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.initweight !60, !taffo.info !56
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 32), !taffo.initweight !65, !taffo.info !56, !taffo.originalCall !69, !taffo.constinfo !70
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.initweight !60, !taffo.info !54
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 32), !taffo.initweight !65, !taffo.info !54, !taffo.originalCall !69, !taffo.constinfo !70
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 32), !taffo.initweight !65, !taffo.info !58, !taffo.target !59, !taffo.originalCall !69, !taffo.constinfo !70
...
!7 = !{double 0.000000e+00, double 0x40C6A6667FFDE721}
...
!55 = !{double 0.000000e+00, double 3.000000e+01}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 4.512000e+03}
...
!117 = !{double 0.000000e+00, double 1.443840e+05}
!118 = distinct !{!118, !29}
!119 = !{i32 1, !103, i32 1, !54, i32 1, !110}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 9.600000e+02}
!122 = distinct !{!122, !29}
...
!126 = !{double 0.000000e+00, double 9.000000e+02}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 5.412000e+03}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x40C868667FFDE721}
!131 = distinct !{!131, !29}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 6.768000e+03}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x40CB2E149997155B}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x40D4330A4CCB8AAE}
!138 = distinct !{!138, !29}
!139 = !{i32 1, !103, i32 1, !58, i32 1, !110}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x4116A6667FFDE721}
!142 = distinct !{!142, !29}
