; ModuleID = './build/bin/fixed/seidel-2d/16/seidel-2d-standard-512-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [56 x i8] c"target('A') scalar(range(51.200001,10265.599609) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 512), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40C40CCCBFFCDAB2}
...
!50 = !{double 0x40499999A1FD156A, double 0x40C40CCCBFFCDAB2}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x40599999A1FD156A, double 0x40D40CCCBFFCDAB2}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x40633333397DD010, double 0x40DE13331FFB480B}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 0x40699999A1FD156A, double 0x40E40CCCBFFCDAB2}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 0x40700000053E2D62, double 0x40E90FFFEFFC115E}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 0x407CCCCCD63CB817, double 0x40F68E6657FC7608}
...
!140 = !{double 5.120000e+02, double 5.120000e+02}
!141 = !{i32 9}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 0x40D99999A1FD156A, double 0x41540CCCBFFCDAB2}
!144 = distinct !{!144, !29}
!145 = distinct !{!145, !29}
