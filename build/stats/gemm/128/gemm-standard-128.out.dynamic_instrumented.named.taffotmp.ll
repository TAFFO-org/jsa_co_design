; ModuleID = './build/stats/gemm/128/gemm-standard-128.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %3, i32 noundef 128), !taffo.originalCall !29
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 128), !taffo.originalCall !29
  ...
  call void @scale_2d.3(i32 noundef 16, i32 noundef 12, float* noundef %5, i32 noundef 128), !taffo.originalCall !29
...
for.body3:                                        ; preds = %for.cond1
  ...
  %12 = load i32, i32* %factor.addr, align 4
  %"a::var57" = sitofp i32 %12 to float
...
for.body19:                                       ; preds = %for.cond16
  ...
  %22 = load i32, i32* %nk.addr, align 4
  %"a::var66" = sitofp i32 %22 to float
...
for.body43:                                       ; preds = %for.cond40
  ...
  %35 = load i32, i32* %nj.addr, align 4
  %"a::var69" = sitofp i32 %35 to float
