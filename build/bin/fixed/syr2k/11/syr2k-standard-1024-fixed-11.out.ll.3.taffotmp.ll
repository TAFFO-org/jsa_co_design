; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-1024-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,8120893.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 1024), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 1024), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x415EFA8F40000000}
...
!119 = !{double 1.024000e+03, double 1.024000e+03}
...
!125 = !{double 0.000000e+00, double 0x41629655F3333333}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 1.440000e+03}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x41343FFFF727136A}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 0x409599999029AE4F}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0.000000e+00, double 0x41443FFFF727136A}
!135 = !{i32 8}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x41648D479DC9C4DA}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
...
!179 = !{double 0.000000e+00, double 0x41FEFA8F40000000}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
...
!189 = !{double 0.000000e+00, double 0x412CCCCCC0379314}
!190 = distinct !{!190, !29}
!191 = distinct !{!191, !29}
