; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-512-fixed-24.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %A.u9_23fixp, [10 x i32]* noundef %B.u9_23fixp, [14 x i32]* noundef %C.u9_23fixp, [14 x float]* noundef %D, [10 x i32]* noundef %tmp.u21_11fixp) #0 !taffo.initweight !104 !taffo.funinfo !105 !taffo.sourceFunction !108 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %A.u9_23fixp, i32 %i.0, !taffo.info !134
  %arrayidx7.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u9_23fixp, i32 0, i32 %j.0, !taffo.info !134
  %4 = lshr i32 %div.u3_29fixp, 6, !taffo.info !133
  store i32 %4, i32* %arrayidx7.u9_23fixp, align 4, !taffo.info !135
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u9_23fixp, i32 %i.1, !taffo.info !151
  %arrayidx26.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx25.u9_23fixp, i32 0, i32 %j.1, !taffo.info !151
  %8 = lshr i32 %div24.u1_31fixp, 8, !taffo.info !149
  store i32 %8, i32* %arrayidx26.u9_23fixp, align 4, !taffo.info !135
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx48.u9_23fixp = getelementptr inbounds [14 x i32], [14 x i32]* %C.u9_23fixp, i32 %i.2, !taffo.info !167
  %arrayidx49.u9_23fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx48.u9_23fixp, i32 0, i32 %j.2, !taffo.info !167
  %12 = lshr i32 %div47.u1_31fixp, 8, !taffo.info !166
  store i32 %12, i32* %arrayidx49.u9_23fixp, align 4, !taffo.info !135
  br label %for.inc50
...
for.body63:                                       ; preds = %for.cond60
  ...
  %17 = fdiv float %lampsim2, 0x41E0000000000000, !taffo.info !180
  ...
  store float %lampsim5, float* %arrayidx71.flt.1flp, align 4, !taffo.info !135
  br label %for.inc72
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86.u21_11fixp = getelementptr inbounds [10 x i32], [10 x i32]* %tmp.u21_11fixp, i32 %i.4, !taffo.info !184
  %arrayidx87.u21_11fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx86.u21_11fixp, i32 0, i32 %j.4, !taffo.info !184
  store i32 0, i32* %arrayidx87.u21_11fixp, align 4, !taffo.info !135, !taffo.constinfo !185
  br label %for.inc88
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_2mm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [10 x i32]* noundef %tmp.u21_11fixp, [12 x i32]* noundef %A.u9_23fixp, [10 x i32]* noundef %B.u9_23fixp, [14 x i32]* noundef %C.u9_23fixp, [14 x float]* noundef %D) #0 !taffo.initweight !188 !taffo.funinfo !189 !taffo.sourceFunction !190 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  store i32 0, i32* %arrayidx4.u21_11fixp, align 4, !taffo.info !135, !taffo.constinfo !185
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %u9_23fixp = load i32, i32* %arrayidx9.u9_23fixp, align 4, !taffo.info !191
  %2 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %3 = lshr i32 %u9_23fixp, 1, !taffo.info !191
  %4 = ashr i32 %2, 8, !taffo.info !42
  %5 = ashr i32 %3, 1, !taffo.info !191
  %6 = call i32 @llvm.smul.fix.i32(i32 %4, i32 %5, i32 21), !taffo.info !193
  %mul.u10_22fixp = shl i32 %6, 1, !taffo.info !196
  ...
  %7 = lshr i32 %mul.u10_22fixp, 1, !taffo.info !196
  %8 = lshr i32 %u9_23fixp3, 1, !taffo.info !53
  %9 = ashr i32 %7, 11, !taffo.info !196
  %10 = ashr i32 %8, 12, !taffo.info !53
  %11 = call i32 @llvm.smul.fix.i32(i32 %9, i32 %10, i32 10), !taffo.info !197
  %mul12.u21_11fixp = shl i32 %11, 1, !taffo.info !200
  ...
  %add.u21_11fixp = add i32 %u21_11fixp, %mul12.u21_11fixp, !taffo.info !201
...
for.body26:                                       ; preds = %for.cond24
  ...
  %mul29.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !209
...
for.body32:                                       ; preds = %for.cond30
  ...
  %mul37.1flp22 = fmul float %lampsim15, %lampsim21, !taffo.info !212
  ...
  %add40.1flp26 = fadd float %.flt.fallback.1flp1, %lampsim25, !taffo.info !215
...
!194 = !{!"fixp", i32 -32, i32 21}
!195 = !{double 0.000000e+00, double 6.720000e+02}
!196 = !{!192, !195, i1 false, i2 -1}
!197 = !{!198, !199, i1 false, i2 -1}
!198 = !{!"fixp", i32 -32, i32 10}
!199 = !{double 0.000000e+00, double 0x4112E6665E247885}
!200 = !{!48, !199, i1 false, i2 -1}
!201 = !{!48, !202, i1 false, i2 -1}
!202 = !{double 0.000000e+00, double 0x41372CCCB7891E21}
!203 = distinct !{!203, !23}
!204 = distinct !{!204, !23}
!205 = distinct !{!205, !23}
!206 = !{i32 5}
...
!210 = !{!"float", i32 1, double 0x41E7047AD9999999}
!211 = !{double 0.000000e+00, double 0x41E7047AD9999999}
!212 = !{!213, !214, i1 false, i2 -1}
!213 = !{!"float", i32 1, double 0x41C121D4034F607A}
!214 = !{double 0.000000e+00, double 0x41C121D4034F607A}
!215 = !{!216, !217, i1 false, i2 -1}
!216 = !{!"float", i32 1, double 0x41E776DB60D3D81E}
!217 = !{double 0.000000e+00, double 0x41E776DB60D3D81E}
!218 = distinct !{!218, !23}
!219 = distinct !{!219, !23}
!220 = distinct !{!220, !23}
