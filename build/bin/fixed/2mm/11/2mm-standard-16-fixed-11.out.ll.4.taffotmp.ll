; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-16-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.info !66, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 16), !taffo.info !71, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 16), !taffo.info !73, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 16), !taffo.info !77, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 16), !taffo.info !78, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 16), !taffo.info !79, !taffo.initweight !74, !taffo.constinfo !75, !taffo.target !60, !taffo.originalCall !76
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 16), !taffo.info !80, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !73, !taffo.initweight !45
  %cmp4 = icmp slt i32 %j.0, %nk, !taffo.info !151, !taffo.initweight !72
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !73, !taffo.initweight !74

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !152, !taffo.initweight !72
  %add = add nsw i32 %mul, 1, !taffo.info !154, !taffo.initweight !74, !taffo.constinfo !21
  %rem = srem i32 %add, %ni, !taffo.info !156, !taffo.initweight !89
  %conv = sitofp i32 %rem to float, !taffo.info !158, !taffo.initweight !116
  %conv6 = sitofp i32 %ni to float, !taffo.info !160
  %div = fdiv float %conv, %conv6, !taffo.info !161, !taffo.initweight !117
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %A, i32 %i.0, !taffo.info !163, !taffo.initweight !72
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !163, !taffo.initweight !72
  store float %div, float* %arrayidx7, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !164, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !167, !taffo.initweight !72, !taffo.constinfo !21
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  %j.1 = phi i32 [ 0, %for.body14 ], [ %inc28, %for.inc27 ], !taffo.info !73, !taffo.initweight !45
  %cmp16 = icmp slt i32 %j.1, %nj, !taffo.info !151, !taffo.initweight !72
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.info !73, !taffo.initweight !74

for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !164, !taffo.initweight !72, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !170, !taffo.initweight !72
  %rem21 = srem i32 %mul20, %nj, !taffo.info !172, !taffo.initweight !74
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !173, !taffo.initweight !89
  %conv23 = sitofp i32 %nj to float, !taffo.info !174
  %div24 = fdiv float %conv22, %conv23, !taffo.info !175, !taffo.initweight !116
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.1, !taffo.info !178, !taffo.initweight !72
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.info !178, !taffo.initweight !72
  store float %div24, float* %arrayidx26, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !164, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !167, !taffo.initweight !72, !taffo.constinfo !21
...
for.cond37:                                       ; preds = %for.inc50, %for.body36
  %j.2 = phi i32 [ 0, %for.body36 ], [ %inc51, %for.inc50 ], !taffo.info !73, !taffo.initweight !45
  %cmp38 = icmp slt i32 %j.2, %nl, !taffo.info !151, !taffo.initweight !72
  br i1 %cmp38, label %for.body40, label %for.end52, !taffo.info !73, !taffo.initweight !74

for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 3, !taffo.info !181, !taffo.initweight !72, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !183, !taffo.initweight !72
  %add43 = add nsw i32 %mul42, 1, !taffo.info !185, !taffo.initweight !74, !taffo.constinfo !21
  %rem44 = srem i32 %add43, %nl, !taffo.info !187, !taffo.initweight !89
  %conv45 = sitofp i32 %rem44 to float, !taffo.info !189, !taffo.initweight !116
  %conv46 = sitofp i32 %nl to float, !taffo.info !190
  %div47 = fdiv float %conv45, %conv46, !taffo.info !191, !taffo.initweight !117
  %arrayidx48 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %i.2, !taffo.info !193, !taffo.initweight !72
  %arrayidx49 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx48, i32 0, i32 %j.2, !taffo.info !193, !taffo.initweight !72
  store float %div47, float* %arrayidx49, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc50

for.inc50:                                        ; preds = %for.body40
  %inc51 = add nsw i32 %j.2, 1, !taffo.info !164, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc53:                                        ; preds = %for.end52
  %inc54 = add nsw i32 %i.2, 1, !taffo.info !167, !taffo.initweight !72, !taffo.constinfo !21
...
for.cond60:                                       ; preds = %for.inc72, %for.body59
  %j.3 = phi i32 [ 0, %for.body59 ], [ %inc73, %for.inc72 ], !taffo.info !73, !taffo.initweight !45
  %cmp61 = icmp slt i32 %j.3, %nl, !taffo.info !151, !taffo.initweight !72
  br i1 %cmp61, label %for.body63, label %for.end74, !taffo.info !73, !taffo.initweight !74

for.body63:                                       ; preds = %for.cond60
  %add64 = add nsw i32 %j.3, 2, !taffo.info !196, !taffo.initweight !72, !taffo.constinfo !21
  %mul65 = mul nsw i32 %i.3, %add64, !taffo.info !198, !taffo.initweight !72
  %rem66 = srem i32 %mul65, %nk, !taffo.info !200, !taffo.initweight !74
  %conv67 = sitofp i32 %rem66 to float, !taffo.info !202, !taffo.initweight !89
  %conv68 = sitofp i32 %nk to float, !taffo.info !203
  %div69 = fdiv float %conv67, %conv68, !taffo.info !204, !taffo.initweight !116
  %arrayidx70 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.3, !taffo.info !206, !taffo.initweight !72
  %arrayidx71 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx70, i32 0, i32 %j.3, !taffo.info !206, !taffo.initweight !72
  store float %div69, float* %arrayidx71, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc72

for.inc72:                                        ; preds = %for.body63
  %inc73 = add nsw i32 %j.3, 1, !taffo.info !164, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc75:                                        ; preds = %for.end74
  %inc76 = add nsw i32 %i.3, 1, !taffo.info !167, !taffo.initweight !72, !taffo.constinfo !21
...
for.cond82:                                       ; preds = %for.inc88, %for.body81
  %j.4 = phi i32 [ 0, %for.body81 ], [ %inc89, %for.inc88 ], !taffo.info !73, !taffo.initweight !45
  %cmp83 = icmp slt i32 %j.4, %nj, !taffo.info !151, !taffo.initweight !72
  br i1 %cmp83, label %for.body85, label %for.end90, !taffo.info !73, !taffo.initweight !74

for.body85:                                       ; preds = %for.cond82
  %arrayidx86 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.4, !taffo.info !209, !taffo.initweight !72
  %arrayidx87 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx86, i32 0, i32 %j.4, !taffo.info !209, !taffo.initweight !72
...
for.inc88:                                        ; preds = %for.body85
  %inc89 = add nsw i32 %j.4, 1, !taffo.info !164, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc91:                                        ; preds = %for.end90
  %inc92 = add nsw i32 %i.4, 1, !taffo.info !167, !taffo.initweight !72, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !213 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !215, !taffo.initweight !218
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !221 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !214
  %mul = fmul float %1, %conv, !taffo.info !222, !taffo.initweight !218
  %2 = mul nsw i32 %i.0, %m, !taffo.info !104
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !212 !taffo.funinfo !227 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !214
  %mul = fmul float %1, %conv, !taffo.info !228, !taffo.initweight !218
  %2 = mul nsw i32 %i.0, %m, !taffo.info !104
...
!50 = !{double 0.000000e+00, double 0x40927333201040C0}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 32, i32 28}
!53 = !{double 0.000000e+00, double 1.400000e+01}
!54 = !{!52, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 1.440000e+01}
!56 = !{!52, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x402DB6DB50F40E5A}
!58 = !{!59, !1, i1 false, i2 -1}
!59 = !{!"fixp", i32 32, i32 15}
!60 = !{!"D"}
...
!124 = !{double 0.000000e+00, double 2.100000e+01}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4072E66666666667}
!127 = !{!49, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x40972CCCB9A9DA5A}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{!59, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x40F7047AD99A3AA9}
!134 = !{!59, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x40D121D3FAE7B10A}
!136 = !{i32 8}
!137 = !{!59, !138, i1 false, i2 -1}
!138 = !{double 0.000000e+00, double 0x40F776DB5EBA727A}
!139 = distinct !{!139, !23}
!140 = distinct !{!140, !23}
!141 = distinct !{!141, !23}
...
!172 = !{i1 false, !84, i1 false, i2 -1}
!173 = !{!52, !84, i1 false, i2 -1}
!174 = !{!52, !17, i1 false, i2 1}
!175 = !{!176, !177, i1 false, i2 -1}
!176 = !{!"fixp", i32 32, i32 31}
!177 = !{double 0.000000e+00, double 9.000000e-01}
!178 = !{!52, !55, i1 false, i2 1}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
...
!213 = !{i32 1, !98, i32 1, !16, i32 1, !48, i32 1, !110}
!214 = !{!121, !111, i1 false, i2 1}
!215 = !{!216, !217, i1 false, i2 -1}
!216 = !{!"fixp", i32 32, i32 17}
!217 = !{double 0.000000e+00, double 0x40D27333201040C0}
!218 = !{i32 9}
!219 = distinct !{!219, !23}
!220 = distinct !{!220, !23}
!221 = !{i32 1, !98, i32 1, !114, i32 1, !51, i32 1, !110}
!222 = !{!223, !224, i1 false, i2 -1}
!223 = !{!"fixp", i32 32, i32 24}
!224 = !{double 0.000000e+00, double 2.240000e+02}
!225 = distinct !{!225, !23}
!226 = distinct !{!226, !23}
!227 = !{i32 1, !98, i32 1, !100, i32 1, !58, i32 1, !110}
!228 = !{!229, !230, i1 false, i2 -1}
!229 = !{!"fixp", i32 32, i32 11}
!230 = !{double 0.000000e+00, double 0x41332E6660008638}
!231 = distinct !{!231, !23}
!232 = distinct !{!232, !23}
