; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %.flt.fallback.1flp, %2, !taffo.info !244
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !249 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !250
  %mul.u27_5fixp = shl i32 %5, 1, !taffo.info !253
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u27_5fixp, 10, !taffo.info !253
...
!245 = !{!"float", i32 1, double 0x42CBCB0680000000}
!246 = !{double 0.000000e+00, double 0x42CBCB0680000000}
!247 = distinct !{!247, !23}
!248 = distinct !{!248, !23}
!249 = !{i32 1, !87, i32 1, !100, i32 1, !41, i32 1, !232}
!250 = !{!251, !252, i1 false, i2 -1}
!251 = !{!"fixp", i32 -32, i32 4}
!252 = !{double 0.000000e+00, double 0x419BBBBBE0008638}
!253 = !{!254, !252, i1 false, i2 -1}
!254 = !{!"fixp", i32 32, i32 5}
!255 = distinct !{!255, !23}
!256 = distinct !{!256, !23}
