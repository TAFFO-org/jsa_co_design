...
@.str = private unnamed_addr constant [54 x i8] c"target('A') scalar(range(68.26667,7714.133301) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [44 x i8] c"scalar(range(102.400002,8226.133789) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 100, i8* null)
  %B2 = bitcast [15 x [15 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 101, i8* null)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 512)
