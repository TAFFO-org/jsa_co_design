; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-128-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [50 x i8] c"target('A') scalar(range(12.8,2566.399902) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 128), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40A40CCCBFF47736}
...
!50 = !{double 1.280000e+01, double 0x40A40CCCBFF47736}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 2.560000e+01, double 0x40B40CCCBFF47736}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x4043333333333334, double 0x40BE13331FEEB2D1}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 5.120000e+01, double 0x40C40CCCBFF47736}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 6.400000e+01, double 0x40C90FFFEFF19504}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 1.152000e+02, double 0x40D68E6657F3061D}
...
!140 = !{double 1.280000e+02, double 1.280000e+02}
!141 = !{i32 9}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 1.638400e+03, double 0x41140CCCBFF47736}
!144 = distinct !{!144, !29}
!145 = distinct !{!145, !29}
