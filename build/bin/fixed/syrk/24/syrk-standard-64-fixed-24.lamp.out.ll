; ModuleID = './build/bin/fixed/syrk/24/syrk-standard-64-fixed-24.out.ll'
...
entry:
  ...
  %arraydecay5.u6_26fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %A.u6_26fixp, i32 0, i32 0, !taffo.info !50
  call void @init_array.4_fixp(i32 16, i32 10, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [16 x i32]* %arraydecay.u15_17fixp, [10 x i32]* %arraydecay5.u6_26fixp), !taffo.info !53, !taffo.constinfo !54
  call void @scale_scalar.1_fixp(i32* %alpha.u2_30fixp, i32 64), !taffo.info !53, !taffo.constinfo !55
  call void @scale_scalar.1_fixp(i32* %beta.u2_30fixp, i32 64), !taffo.info !56, !taffo.constinfo !55
  %arraydecay6.u15_17fixp = getelementptr inbounds [16 x [16 x i32]], [16 x [16 x i32]]* %C.u15_17fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u15_17fixp = bitcast [16 x i32]* %arraydecay6.u15_17fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 16, i32 16, i32* %u15_17fixp, i32 64), !taffo.info !57, !taffo.constinfo !58, !taffo.target !49
  %arraydecay7.u6_26fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %A.u6_26fixp, i32 0, i32 0, !taffo.info !50
  %u6_26fixp = bitcast [10 x i32]* %arraydecay7.u6_26fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u6_26fixp, i32 64), !taffo.info !59, !taffo.constinfo !58
  ...
  call void @kernel_syrk.3_fixp(i32 16, i32 10, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay8.u15_17fixp, [10 x i32]* %arraydecay9.u6_26fixp), !taffo.info !53, !taffo.constinfo !54
...
for.body12:                                       ; preds = %for.cond10
  ...
  %arrayidx13.u15_17fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u15_17fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
  %u15_17fixp2 = load i32, i32* %arrayidx13.u15_17fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u15_17fixp2 to float, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syrk.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u15_17fixp, [10 x i32]* noundef %A.u6_26fixp) #0 !taffo.initweight !84 !taffo.funinfo !85 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 16), !taffo.info !87
  %mul.u15_17fixp = shl i32 %3, 1, !taffo.info !90
  store i32 %mul.u15_17fixp, i32* %arrayidx4.u15_17fixp, align 4, !taffo.info !56
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u6_26fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx11.u6_26fixp, i32 0, i32 %k.0, !taffo.info !50
  %u6_26fixp = load i32, i32* %arrayidx12.u6_26fixp, align 4, !taffo.info !92
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u6_26fixp, 1, !taffo.info !92
  %6 = ashr i32 %4, 5, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !92
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 24), !taffo.info !94
  %mul13.u7_25fixp = shl i32 %8, 1, !taffo.info !97
  %arrayidx14.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u6_26fixp, i32 %j.1, !taffo.info !50
  %arrayidx15.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u6_26fixp, i32 0, i32 %k.0, !taffo.info !50
  %u6_26fixp2 = load i32, i32* %arrayidx15.u6_26fixp, align 4, !taffo.info !50
  %9 = lshr i32 %mul13.u7_25fixp, 1, !taffo.info !97
  %10 = lshr i32 %u6_26fixp2, 1, !taffo.info !50
  %11 = ashr i32 %9, 8, !taffo.info !97
  %12 = ashr i32 %10, 9, !taffo.info !50
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 16), !taffo.info !98
  %mul16.u15_17fixp = shl i32 %13, 1, !taffo.info !100
  %arrayidx17.u15_17fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u15_17fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u15_17fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx17.u15_17fixp, i32 0, i32 %j.1, !taffo.info !47
  %u15_17fixp1 = load i32, i32* %arrayidx18.u15_17fixp, align 4, !taffo.info !47
  %add.u15_17fixp = add i32 %u15_17fixp1, %mul16.u15_17fixp, !taffo.info !101
  store i32 %add.u15_17fixp, i32* %arrayidx18.u15_17fixp, align 4, !taffo.info !57
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u15_17fixp, [10 x i32]* noundef %A.u6_26fixp) #0 !taffo.initweight !106 !taffo.funinfo !85 !taffo.sourceFunction !107 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u6_26fixp, i32 %i.0, !taffo.info !139
  %arrayidx7.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u6_26fixp, i32 0, i32 %j.0, !taffo.info !139
  %4 = lshr i32 %div.u1_31fixp, 5, !taffo.info !137
  store i32 %4, i32* %arrayidx7.u6_26fixp, align 4, !taffo.info !140
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u15_17fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u15_17fixp, i32 %i.1, !taffo.info !157
  %arrayidx26.u15_17fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u15_17fixp, i32 0, i32 %j.1, !taffo.info !157
  %8 = lshr i32 %div24.u1_31fixp, 14, !taffo.info !156
  store i32 %8, i32* %arrayidx26.u15_17fixp, align 4, !taffo.info !140
  br label %for.inc27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !160 !taffo.funinfo !161 !taffo.sourceFunction !162 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u15_17fixp = load i32, i32* %arrayidx4.u15_17fixp, align 4, !taffo.info !47
  %conv.u7_25fixp = shl i32 %factor, 25, !taffo.info !163
  %1 = lshr i32 %u15_17fixp, 1, !taffo.info !47
  %2 = lshr i32 %conv.u7_25fixp, 1, !taffo.info !163
  %3 = ashr i32 %1, 6, !taffo.info !47
  %4 = ashr i32 %2, 14, !taffo.info !163
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !164
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !167
  ...
  %7 = shl i32 %mul.u21_11fixp, 6, !taffo.info !167
  store i32 %7, i32* %arrayidx6.u15_17fixp, align 4, !taffo.info !57
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !160 !taffo.funinfo !171 !taffo.sourceFunction !162 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u12_20fixp, 6, !taffo.info !175
  store i32 %7, i32* %arrayidx6.u6_26fixp, align 4, !taffo.info !59
  br label %for.inc
...
!82 = !{double 6.400000e+01, double 6.400000e+01}
...
!89 = !{double 0.000000e+00, double 0x40DF0753F3351662}
...
!96 = !{double 0.000000e+00, double 9.000000e+01}
!97 = !{!93, !96, i1 false, i2 -1}
!98 = !{!88, !99, i1 false, i2 -1}
!99 = !{double 0.000000e+00, double 5.400000e+03}
!100 = !{!48, !99, i1 false, i2 -1}
!101 = !{!48, !102, i1 false, i2 -1}
!102 = !{double 0.000000e+00, double 0x40DF2170A00192A7}
!103 = distinct !{!103, !23}
!104 = distinct !{!104, !23}
!105 = distinct !{!105, !23}
...
!165 = !{!"fixp", i32 -32, i32 10}
!166 = !{double 0.000000e+00, double 0x4139DB70A00192A7}
!167 = !{!168, !166, i1 false, i2 -1}
!168 = !{!"fixp", i32 32, i32 11}
!169 = distinct !{!169, !23}
!170 = distinct !{!170, !23}
!171 = !{i32 1, !70, i32 1, !16, i32 1, !50, i32 1, !81}
!172 = !{!173, !174, i1 false, i2 -1}
!173 = !{!"fixp", i32 -32, i32 19}
!174 = !{double 0.000000e+00, double 3.840000e+03}
