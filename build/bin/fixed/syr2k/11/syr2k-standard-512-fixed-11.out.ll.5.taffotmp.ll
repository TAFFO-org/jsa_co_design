; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-512-fixed-11.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %3, 0x4150000000000000, !taffo.info !186
  %mul.1flp = fmul float %2, %4, !taffo.info !187
  ...
  %6 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !187
  %7 = fptoui float %6 to i32, !taffo.info !187
