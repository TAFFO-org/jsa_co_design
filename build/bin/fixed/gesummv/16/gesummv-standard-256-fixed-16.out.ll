; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !105 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !106
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !109
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !48
  %5 = shl i32 %mul.u16_16fixp, 8, !taffo.info !109
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !106
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !109
  ...
  %7 = shl i32 %mul.u16_16fixp, 8, !taffo.info !109
...
!107 = !{!"fixp", i32 -32, i32 15}
!108 = !{double 0.000000e+00, double 6.144000e+04}
!109 = !{!110, !108, i1 false, i2 -1}
!110 = !{!"fixp", i32 32, i32 16}
!111 = distinct !{!111, !23}
