...
@.str = private unnamed_addr constant [54 x i8] c"target('A') scalar(range(34.133335,3857.06665) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [43 x i8] c"scalar(range(51.200001,4113.066895) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 101, i8* null)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 256)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 256)
