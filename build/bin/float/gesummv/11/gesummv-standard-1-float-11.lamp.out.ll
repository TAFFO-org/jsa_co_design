; ModuleID = './build/bin/float/gesummv/11/gesummv-standard-1-float-11.out.ll'
...
entry:
  ...
  call void @kernel_gesummv(i32 noundef %1, float noundef %2, float noundef %3, ptr noundef %arraydecay5, ptr noundef %arraydecay6, ptr noundef %arraydecay7, ptr noundef %arraydecay8, ptr noundef %arraydecay9)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx10 = getelementptr inbounds [16 x float], ptr @y_float, i32 0, i32 %8
