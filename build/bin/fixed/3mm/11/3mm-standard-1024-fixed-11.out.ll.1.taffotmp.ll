...
entry:
  ...
  call void @llvm.var.annotation(i8* %E1, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 143, i8* null)
  %A2 = bitcast [6 x [10 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A2, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 144, i8* null)
  %B3 = bitcast [10 x [8 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B3, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 145, i8* null)
  %F4 = bitcast [8 x [12 x float]]* %F to i8*
  call void @llvm.var.annotation(i8* %F4, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 146, i8* null)
  %C5 = bitcast [8 x [14 x float]]* %C to i8*
  call void @llvm.var.annotation(i8* %C5, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 147, i8* null)
  %D6 = bitcast [14 x [12 x float]]* %D to i8*
  call void @llvm.var.annotation(i8* %D6, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 148, i8* null)
  %G7 = bitcast [6 x [12 x float]]* %G to i8*
  call void @llvm.var.annotation(i8* %G7, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 149, i8* null)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, float* noundef %5, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 10, float* noundef %6, i32 noundef 1024)
  %arraydecay16 = getelementptr inbounds [10 x [8 x float]], [10 x [8 x float]]* %B, i32 0, i32 0
  %7 = bitcast [8 x float]* %arraydecay16 to float*
  call void @scale_2d(i32 noundef 10, i32 noundef 8, float* noundef %7, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 12, float* noundef %8, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 14, float* noundef %9, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 14, i32 noundef 12, float* noundef %10, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 12, float* noundef %11, i32 noundef 1024)
