...
entry:
  ...
  call void @llvm.var.annotation(i8* %E1, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 143, i8* null)
  ...
  call void @llvm.var.annotation(i8* %F4, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 146, i8* null)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, float* noundef %5, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 10, float* noundef %6, i32 noundef 512)
  %arraydecay16 = getelementptr inbounds [10 x [8 x float]], [10 x [8 x float]]* %B, i32 0, i32 0
  %7 = bitcast [8 x float]* %arraydecay16 to float*
  call void @scale_2d(i32 noundef 10, i32 noundef 8, float* noundef %7, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 12, float* noundef %8, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 14, float* noundef %9, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 14, i32 noundef 12, float* noundef %10, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 12, float* noundef %11, i32 noundef 512)
