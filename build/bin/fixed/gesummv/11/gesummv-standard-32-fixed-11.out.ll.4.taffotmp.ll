; ModuleID = './build/bin/fixed/gesummv/11/gesummv-standard-32-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.info !63, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 32), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 32), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !59
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 32), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.info !49, !taffo.initweight !59
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 32), !taffo.info !70, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 32), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !75, !taffo.target !57, !taffo.originalCall !76
...
for.body:                                         ; preds = %for.cond
  ...
  %mul = fmul float %0, %conv, !taffo.info !105, !taffo.initweight !108
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !99 !taffo.funinfo !110 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !49, !taffo.initweight !102
  %conv = sitofp i32 %factor to float, !taffo.info !103
  %mul = fmul float %0, %conv, !taffo.info !111, !taffo.initweight !108
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv.5(i32 noundef %n, float noundef %alpha, float noundef %beta, [16 x float]* noundef %A, [16 x float]* noundef %B, float* noundef %tmp, float* noundef %x, float* noundef %y) #0 !taffo.initweight !115 !taffo.funinfo !116 !taffo.sourceFunction !79 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !117, !taffo.initweight !101, !taffo.constinfo !118
  %arrayidx1 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  store float 0.000000e+00, float* %arrayidx1, align 4, !taffo.info !117, !taffo.initweight !101, !taffo.constinfo !118
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %0 = load float, float* %arrayidx6, align 4, !taffo.info !49, !taffo.initweight !108
  %arrayidx7 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.info !49, !taffo.initweight !101
  %1 = load float, float* %arrayidx7, align 4, !taffo.info !49, !taffo.initweight !102
  %mul = fmul float %0, %1, !taffo.info !119, !taffo.initweight !108
  ...
  %add = fadd float %mul, %2, !taffo.info !121, !taffo.initweight !108
  ...
  %3 = load float, float* %arrayidx11, align 4, !taffo.info !49, !taffo.initweight !108
  %arrayidx12 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.info !49, !taffo.initweight !101
  %4 = load float, float* %arrayidx12, align 4, !taffo.info !49, !taffo.initweight !102
  %mul13 = fmul float %3, %4, !taffo.info !119, !taffo.initweight !108
  ...
  %add15 = fadd float %mul13, %5, !taffo.info !123, !taffo.initweight !108
...
for.inc:                                          ; preds = %for.body4
  ...
  br label %for.cond2, !llvm.loop !125
...
for.end:                                          ; preds = %for.cond2
  ...
  %mul18 = fmul float %alpha, %6, !taffo.info !126, !taffo.initweight !101
  ...
  %mul20 = fmul float %beta, %7, !taffo.info !129, !taffo.initweight !101
  %add21 = fadd float %mul18, %mul20, !taffo.info !131, !taffo.initweight !102
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !99 !taffo.funinfo !134 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !103
  %mul = fmul float %0, %conv, !taffo.info !135, !taffo.initweight !108
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7(i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %A, [16 x float]* noundef %B, float* noundef %x, float* noundef %tmp, float* noundef %y) #0 !taffo.initweight !139 !taffo.funinfo !140 !taffo.sourceFunction !65 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !63, !taffo.initweight !141, !taffo.constinfo !142
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !68, !taffo.initweight !141, !taffo.constinfo !144
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc25, %for.inc24 ], !taffo.info !147, !taffo.initweight !46
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !148, !taffo.initweight !69
  br i1 %cmp, label %for.body, label %for.end26, !taffo.info !149, !taffo.initweight !71

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.info !151, !taffo.initweight !69
  %conv = sitofp i32 %rem to float, !taffo.info !153, !taffo.initweight !71
  %conv3 = sitofp i32 %n to float, !taffo.info !155
  %div = fdiv float %conv, %conv3, !taffo.info !156, !taffo.initweight !141
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.info !159, !taffo.initweight !69
  store float %div, float* %arrayidx, align 4, !taffo.info !117, !taffo.initweight !71
  %arrayidx4 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !160, !taffo.initweight !69
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !117, !taffo.initweight !71, !taffo.constinfo !118
  %arrayidx5 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.info !161, !taffo.initweight !69
  store float 0.000000e+00, float* %arrayidx5, align 4, !taffo.info !117, !taffo.initweight !71, !taffo.constinfo !118
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !147, !taffo.initweight !46
  %cmp7 = icmp slt i32 %j.0, %n, !taffo.info !148, !taffo.initweight !69
  br i1 %cmp7, label %for.body9, label %for.end, !taffo.info !149, !taffo.initweight !71

for.body9:                                        ; preds = %for.cond6
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !162, !taffo.initweight !69
  %add = add nsw i32 %mul, 1, !taffo.info !164, !taffo.initweight !71, !taffo.constinfo !21
  %rem10 = srem i32 %add, %n, !taffo.info !151, !taffo.initweight !141
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !153, !taffo.initweight !101
  %conv12 = sitofp i32 %n to float, !taffo.info !155
  %div13 = fdiv float %conv11, %conv12, !taffo.info !156, !taffo.initweight !102
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.0, !taffo.info !159, !taffo.initweight !69
  %arrayidx15 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.info !159, !taffo.initweight !69
  store float %div13, float* %arrayidx15, align 4, !taffo.info !117, !taffo.initweight !71
  %mul16 = mul nsw i32 %i.0, %j.0, !taffo.info !162, !taffo.initweight !69
  %add17 = add nsw i32 %mul16, 2, !taffo.info !166, !taffo.initweight !71, !taffo.constinfo !21
  %rem18 = srem i32 %add17, %n, !taffo.info !151, !taffo.initweight !141
  %conv19 = sitofp i32 %rem18 to float, !taffo.info !153, !taffo.initweight !101
  %conv20 = sitofp i32 %n to float, !taffo.info !155
  %div21 = fdiv float %conv19, %conv20, !taffo.info !156, !taffo.initweight !102
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.info !159, !taffo.initweight !69
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.0, !taffo.info !159, !taffo.initweight !69
  store float %div21, float* %arrayidx23, align 4, !taffo.info !117, !taffo.initweight !71
  br label %for.inc

for.inc:                                          ; preds = %for.body9
  %inc = add nsw i32 %j.0, 1, !taffo.info !168, !taffo.initweight !69, !taffo.constinfo !21
...
for.inc24:                                        ; preds = %for.end
  %inc25 = add nsw i32 %i.0, 1, !taffo.info !168, !taffo.initweight !69, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !172 !taffo.sourceFunction !73 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !49, !taffo.initweight !108
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !49, !taffo.initweight !173
  %conv = sitofp i32 %factor to float, !taffo.info !103
  %mul = fmul float %1, %conv, !taffo.info !111, !taffo.initweight !174
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !49, !taffo.initweight !108
  store float %mul, float* %arrayidx6, align 4, !taffo.info !70, !taffo.initweight !173
  br label %for.inc
...
!51 = !{double 0.000000e+00, double 3.000000e+01}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 19}
!54 = !{double 0.000000e+00, double 4.512000e+03}
!55 = !{!56, !1, i1 false, i2 -1}
!56 = !{!"fixp", i32 32, i32 18}
!57 = !{!"y"}
...
!101 = !{i32 5}
!102 = !{i32 6}
!103 = !{!104, !98, i1 false, i2 1}
!104 = !{!"fixp", i32 32, i32 26}
!105 = !{!106, !107, i1 false, i2 -1}
!106 = !{!"fixp", i32 32, i32 14}
!107 = !{double 0.000000e+00, double 1.443840e+05}
!108 = !{i32 7}
!109 = distinct !{!109, !23}
!110 = !{i32 1, !88, i32 1, !49, i32 1, !97}
!111 = !{!112, !113, i1 false, i2 -1}
!112 = !{!"fixp", i32 32, i32 22}
!113 = !{double 0.000000e+00, double 9.600000e+02}
!114 = distinct !{!114, !23}
!115 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!116 = !{i32 1, !88, i32 1, !43, i32 1, !47, i32 1, !49, i32 1, !49, i32 1, !52, i32 1, !49, i32 1, !55}
!117 = !{i1 false, i1 false, i1 false, i2 1}
!118 = !{!92, i1 false}
!119 = !{!112, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 9.000000e+02}
!121 = !{!53, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 5.412000e+03}
!123 = !{!56, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x40C868667FFDE721}
!125 = distinct !{!125, !23}
!126 = !{!127, !128, i1 false, i2 -1}
!127 = !{!"fixp", i32 32, i32 17}
!128 = !{double 0.000000e+00, double 6.768000e+03}
!129 = !{!127, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x40CB2E149997155B}
!131 = !{!127, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 0x40D4330A4CCB8AAE}
!133 = distinct !{!133, !23}
!134 = !{i32 1, !88, i32 1, !55, i32 1, !97}
!135 = !{!136, !137, i1 false, i2 -1}
!136 = !{!"fixp", i32 32, i32 13}
!137 = !{double 0.000000e+00, double 0x4116A6667FFDE721}
!138 = distinct !{!138, !23}
!139 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2}
!140 = !{i32 1, !88, i32 1, !43, i32 1, !47, i32 1, !49, i32 1, !49, i32 1, !49, i32 1, !52, i32 1, !55}
!141 = !{i32 4}
!142 = !{!143, i1 false}
!143 = !{i1 false, !45, i1 false, i2 0}
!144 = !{!145, i1 false}
!145 = !{i1 false, !146, i1 false, i2 0}
!146 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!147 = !{i1 false, !81, i1 false, i2 1}
!148 = !{i1 false, !83, i1 false, i2 1}
