; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-4-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,106.578751) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !57, !taffo.info !49, !taffo.originalCall !60, !taffo.constinfo !61
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 4), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !60, !taffo.constinfo !61
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 4), !taffo.initweight !63, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 4), !taffo.initweight !63, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x405AA50A41A261BF}
...
!113 = !{double 4.000000e+00, double 4.000000e+00}
...
!119 = !{double 0.000000e+00, double 0x405FF93F81F60EE5}
!120 = distinct !{!120, !29}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 5.625000e+00}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4035180000000000}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x405FEB0A41A261BF}
!127 = distinct !{!127, !29}
!128 = distinct !{!128, !29}
!129 = distinct !{!129, !29}
...
!164 = !{double 0.000000e+00, double 0x407AA50A41A261BF}
!165 = distinct !{!165, !29}
!166 = distinct !{!166, !29}
!167 = !{i32 1, !101, i32 1, !22, i32 1, !55, i32 1, !112}
!168 = !{i1 false, !140, i1 false, i2 -1}
!169 = distinct !{!169, !29}
!170 = distinct !{!170, !29}
