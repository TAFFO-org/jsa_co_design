; ModuleID = './build/bin/fixed/2mm/8/2mm-standard-64-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u6_26fixp = bitcast [10 x i32]* %arraydecay13.u6_26fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u6_26fixp, i32 64), !taffo.info !66, !taffo.constinfo !65
