; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-8-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 8), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 8), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
for.body9:                                        ; preds = %for.cond7
  ...
  %mul = fmul float %conv, 1.000000e+01, !taffo.info !144, !taffo.initweight !67, !taffo.constinfo !15
  %conv11 = sitofp i32 %n to float, !taffo.info !147
  %div = fdiv float %mul, %conv11, !taffo.info !149, !taffo.initweight !96
  %arrayidx = getelementptr inbounds [5 x [5 x float]], [5 x [5 x float]]* %B, i32 %i.0, !taffo.info !151, !taffo.initweight !49
  %arrayidx12 = getelementptr inbounds [5 x [5 x float]], [5 x [5 x float]]* %arrayidx, i32 0, i32 %j.0, !taffo.info !151, !taffo.initweight !49
  %arrayidx13 = getelementptr inbounds [5 x float], [5 x float]* %arrayidx12, i32 0, i32 %k.0, !taffo.info !151, !taffo.initweight !49
  store float %div, float* %arrayidx13, align 4, !taffo.info !152, !taffo.initweight !52
  %arrayidx14 = getelementptr inbounds [5 x [5 x float]], [5 x [5 x float]]* %A, i32 %i.0, !taffo.info !151, !taffo.initweight !49
  %arrayidx15 = getelementptr inbounds [5 x [5 x float]], [5 x [5 x float]]* %arrayidx14, i32 0, i32 %j.0, !taffo.info !151, !taffo.initweight !49
  %arrayidx16 = getelementptr inbounds [5 x float], [5 x float]* %arrayidx15, i32 0, i32 %k.0, !taffo.info !151, !taffo.initweight !49
  store float %div, float* %arrayidx16, align 4, !taffo.info !152, !taffo.initweight !52
  br label %for.inc

for.inc:                                          ; preds = %for.body9
  %inc = add nsw i32 %k.0, 1, !taffo.info !153, !taffo.initweight !49, !taffo.constinfo !21
...
for.inc17:                                        ; preds = %for.end
  %inc18 = add nsw i32 %j.0, 1, !taffo.info !153, !taffo.initweight !49, !taffo.constinfo !21
  br label %for.cond4, !llvm.loop !156

for.end19:                                        ; preds = %for.cond4
  br label %for.inc20

for.inc20:                                        ; preds = %for.end19
  %inc21 = add nsw i32 %i.0, 1, !taffo.info !153, !taffo.initweight !49, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_3d.3(i32 noundef %n, i32 noundef %m, i32 noundef %p, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !158 !taffo.funinfo !159 !taffo.sourceFunction !54 {
entry:
  br label %for.cond
...
for.body6:                                        ; preds = %for.cond4
  %0 = mul nuw i32 %m, %p, !taffo.info !162
  ...
  %3 = load float, float* %arrayidx8, align 4, !taffo.info !41, !taffo.initweight !104
  %conv = sitofp i32 %factor to float, !taffo.info !164
  %mul = fmul float %3, %conv, !taffo.info !166, !taffo.initweight !112
  %4 = mul nuw i32 %m, %p, !taffo.info !162
...
!103 = !{double 3.200000e+01, double 4.160000e+02}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -4.000000e+02, double 1.760000e+02}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -3.840000e+02, double 3.840000e+02}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 24}
!111 = !{double -4.800000e+01, double 4.800000e+01}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -9.600000e+01, double 9.600000e+01}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -1.440000e+02, double 1.440000e+02}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -1.280000e+02, double 3.520000e+02}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!143 = !{!117, !142, i1 false, i2 -1}
!144 = !{!145, !146, i1 false, i2 -1}
!145 = !{!"fixp", i32 -32, i32 20}
!146 = !{double -7.500000e+02, double 1.650000e+03}
!147 = !{!148, !80, i1 false, i2 1}
!148 = !{!"fixp", i32 32, i32 29}
!149 = !{!145, !150, i1 false, i2 -1}
!150 = !{double -1.500000e+02, double 3.300000e+02}
!151 = !{!42, !43, i1 false, i2 1}
!152 = !{i1 false, i1 false, i1 false, i2 1}
!153 = !{i1 false, !154, i1 false, i2 -1}
!154 = !{double 1.000000e+00, double 8.100000e+01}
!155 = distinct !{!155, !23}
!156 = distinct !{!156, !23}
!157 = distinct !{!157, !23}
!158 = !{i32 -1, i32 -1, i32 -1, i32 3, i32 -1}
!159 = !{i32 1, !79, i32 1, !79, i32 1, !79, i32 1, !41, i32 1, !160}
!160 = !{i1 false, !161, i1 false, i2 0}
!161 = !{double 8.000000e+00, double 8.000000e+00}
!162 = !{i1 false, !163, i1 false, i2 0}
!163 = !{double 2.500000e+01, double 2.500000e+01}
!164 = !{!165, !161, i1 false, i2 1}
!165 = !{!"fixp", i32 32, i32 28}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 32, i32 21}
!168 = !{double 1.280000e+02, double 1.664000e+03}
!169 = distinct !{!169, !23}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
