; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-4-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [52 x i8] c"target('A') scalar(range(0.533333,60.266666) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.8,64.26667) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 4), !taffo.initweight !57, !taffo.target !48, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 4), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !58, !taffo.constinfo !59
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !122, !taffo.info !118
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !171 !taffo.sourceFunction !58 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !167
  %mul = fmul float %1, %conv, !taffo.initweight !122, !taffo.info !131
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
...
!7 = !{double 0.000000e+00, double 0x404E22221C8A7A42}
...
!50 = !{double 5.333330e-01, double 0x404E22221C8A7A42}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 8.000000e-01, double 0x405011111F0C34C2}
!53 = !{i32 1}
!54 = !{i32 2}
...
!115 = !{double 0x3FF111105E1C1509, double 0x405E22221C8A7A42}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0x3FF999988D2A1F8E, double 0x406699999567DBB2}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0x400111105E1C1509, double 0x406E22221C8A7A42}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x4005555475A31A4B, double 0x4072D55551D68C69}
!122 = !{i32 9}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x3FE1111062605920, double 0x404E2222241302C9}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 1.600000e+00, double 0x406011111F0C34C2}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4003333333333334, double 0x40681999AE924F23}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 3.200000e+00, double 0x407011111F0C34C2}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 4.000000e+00, double 0x4074155566CF41F2}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0x3FE99999A0000000, double 0x4050111123107909}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
...
!168 = !{double 4.000000e+00, double 4.000000e+00}
!169 = distinct !{!169, !29}
!170 = distinct !{!170, !29}
!171 = !{i32 1, !97, i32 1, !97, i32 1, !51, i32 1, !167}
!172 = distinct !{!172, !29}
!173 = distinct !{!173, !29}
