; ModuleID = './build/bin/fixed/gemm/16/gemm-standard-32-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,6430.719727) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,30.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,29.333334) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 32), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 32), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 32), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx4, align 4, !taffo.initweight !126, !taffo.info !53
  %mul = fmul float %0, %beta, !taffo.initweight !94, !taffo.info !127
...
for.body10:                                       ; preds = %for.cond8
  ...
  %1 = load float, float* %arrayidx12, align 4, !taffo.initweight !126, !taffo.info !55
  %mul13 = fmul float %alpha, %1, !taffo.initweight !94, !taffo.info !130
  ...
  %2 = load float, float* %arrayidx15, align 4, !taffo.initweight !126, !taffo.info !57
  %mul16 = fmul float %mul13, %2, !taffo.initweight !95, !taffo.info !132
  ...
  %3 = load float, float* %arrayidx18, align 4, !taffo.initweight !126, !taffo.info !53
  %add = fadd float %3, %mul16, !taffo.initweight !126, !taffo.info !134
  store float %add, float* %arrayidx18, align 4, !taffo.initweight !126, !taffo.info !53
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, float* noundef %alpha, float* noundef %beta, [12 x float]* noundef %C, [16 x float]* noundef %A, [12 x float]* noundef %B) #0 !taffo.initweight !139 !taffo.funinfo !123 !taffo.sourceFunction !60 {
entry:
...
for.cond:                                         ; preds = %for.inc8, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc9, %for.inc8 ], !taffo.initweight !48, !taffo.info !140
  %cmp = icmp slt i32 %i.0, %ni, !taffo.initweight !64, !taffo.info !142
  br i1 %cmp, label %for.body, label %for.end10, !taffo.initweight !65, !taffo.info !92
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !140
  %cmp4 = icmp slt i32 %j.0, %nj, !taffo.initweight !64, !taffo.info !142
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !65, !taffo.info !92

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !64, !taffo.info !143
  %add = add nsw i32 %mul, 1, !taffo.initweight !65, !taffo.info !145, !taffo.constinfo !27
  %rem = srem i32 %add, %ni, !taffo.initweight !76, !taffo.info !147
  %conv = sitofp i32 %rem to float, !taffo.initweight !94, !taffo.info !147
  %conv6 = sitofp i32 %ni to float, !taffo.info !22
  %div = fdiv float %conv, %conv6, !taffo.initweight !95, !taffo.info !149
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %C, i32 %i.0, !taffo.initweight !64, !taffo.info !151
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !151
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
...
for.cond11:                                       ; preds = %for.inc30, %for.end10
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc31, %for.inc30 ], !taffo.initweight !48, !taffo.info !140
  %cmp12 = icmp slt i32 %i.1, %ni, !taffo.initweight !64, !taffo.info !142
  br i1 %cmp12, label %for.body14, label %for.end32, !taffo.initweight !65, !taffo.info !92
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  %j.1 = phi i32 [ 0, %for.body14 ], [ %inc28, %for.inc27 ], !taffo.initweight !48, !taffo.info !140
  %cmp16 = icmp slt i32 %j.1, %nk, !taffo.initweight !64, !taffo.info !142
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.initweight !65, !taffo.info !92

for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.initweight !64, !taffo.info !156
  %rem21 = srem i32 %mul20, %nk, !taffo.initweight !65, !taffo.info !158
  %conv22 = sitofp i32 %rem21 to float, !taffo.initweight !76, !taffo.info !158
  %conv23 = sitofp i32 %nk to float, !taffo.info !124
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !94, !taffo.info !160
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.1, !taffo.initweight !64, !taffo.info !162
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.initweight !64, !taffo.info !162
  store float %div24, float* %arrayidx26, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
...
for.cond33:                                       ; preds = %for.inc52, %for.end32
  %i.2 = phi i32 [ 0, %for.end32 ], [ %inc53, %for.inc52 ], !taffo.initweight !48, !taffo.info !140
  %cmp34 = icmp slt i32 %i.2, %nk, !taffo.initweight !64, !taffo.info !142
  br i1 %cmp34, label %for.body36, label %for.end54, !taffo.initweight !65, !taffo.info !92
...
for.cond37:                                       ; preds = %for.inc49, %for.body36
  %j.2 = phi i32 [ 0, %for.body36 ], [ %inc50, %for.inc49 ], !taffo.initweight !48, !taffo.info !140
  %cmp38 = icmp slt i32 %j.2, %nj, !taffo.initweight !64, !taffo.info !142
  br i1 %cmp38, label %for.body40, label %for.end51, !taffo.initweight !65, !taffo.info !92

for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.initweight !64, !taffo.info !165, !taffo.constinfo !27
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.initweight !64, !taffo.info !167
  %rem43 = srem i32 %mul42, %nj, !taffo.initweight !65, !taffo.info !169
  %conv44 = sitofp i32 %rem43 to float, !taffo.initweight !76, !taffo.info !169
  %conv45 = sitofp i32 %nj to float, !taffo.info !109
  %div46 = fdiv float %conv44, %conv45, !taffo.initweight !94, !taffo.info !170
  %arrayidx47 = getelementptr inbounds [12 x float], [12 x float]* %B, i32 %i.2, !taffo.initweight !64, !taffo.info !172
  %arrayidx48 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx47, i32 0, i32 %j.2, !taffo.initweight !64, !taffo.info !172
  store float %div46, float* %arrayidx48, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc49

for.inc49:                                        ; preds = %for.body40
  %inc50 = add nsw i32 %j.2, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
  br label %for.cond37, !llvm.loop !173

for.end51:                                        ; preds = %for.cond37
  br label %for.inc52

for.inc52:                                        ; preds = %for.end51
  %inc53 = add nsw i32 %i.2, 1, !taffo.initweight !64, !taffo.info !152, !taffo.constinfo !27
  br label %for.cond33, !llvm.loop !174
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !177, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !119
  %mul = fmul float %1, %conv, !taffo.initweight !178, !taffo.info !179
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !177, !taffo.info !53
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !175 !taffo.funinfo !183 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !177, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !119
  %mul = fmul float %1, %conv, !taffo.initweight !178, !taffo.info !184
  %2 = mul nsw i32 %i.0, %m, !taffo.info !113
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !177, !taffo.info !55
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !175 !taffo.funinfo !188 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !177, !taffo.info !57
  %conv = sitofp i32 %factor to float, !taffo.info !119
  %mul = fmul float %1, %conv, !taffo.initweight !178, !taffo.info !189
  %2 = mul nsw i32 %i.0, %m, !taffo.info !113
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !177, !taffo.info !57
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 0x40B91EB84007570C}
...
!56 = !{double 0.000000e+00, double 3.000000e+01}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x403D55556084A516}
!59 = !{i32 1}
...
!120 = !{double 3.200000e+01, double 3.200000e+01}
!121 = !{i32 1, !51, i32 1, !119}
!122 = !{i32 -1, i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!123 = !{i32 1, !22, i32 1, !109, i32 1, !124, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55, i32 1, !57}
!124 = !{i1 false, !125, i1 false, i2 0}
!125 = !{double 1.600000e+01, double 1.600000e+01}
!126 = !{i32 7}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x40BE24DD19A26874}
!129 = distinct !{!129, !29}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 4.500000e+01}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x4094A00007DD4413}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x40BE46B841FEA811}
!136 = distinct !{!136, !29}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = !{i32 -1, i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
...
!150 = !{double 0.000000e+00, double 9.000000e-01}
!151 = !{i1 false, !7, i1 false, i2 1}
!152 = !{i1 false, !153, i1 false, i2 1}
!153 = !{double 1.000000e+00, double 1.700000e+01}
!154 = distinct !{!154, !29}
!155 = distinct !{!155, !29}
!156 = !{i1 false, !157, i1 false, i2 1}
!157 = !{double 0.000000e+00, double 2.720000e+02}
!158 = !{i1 false, !159, i1 false, i2 1}
!159 = !{double 0.000000e+00, double 1.500000e+01}
!160 = !{i1 false, !161, i1 false, i2 1}
!161 = !{double 0.000000e+00, double 9.375000e-01}
!162 = !{i1 false, !56, i1 false, i2 1}
!163 = distinct !{!163, !29}
!164 = distinct !{!164, !29}
...
!169 = !{i1 false, !71, i1 false, i2 1}
!170 = !{i1 false, !171, i1 false, i2 1}
!171 = !{double 0.000000e+00, double 0x3FED555555555555}
!172 = !{i1 false, !58, i1 false, i2 1}
!173 = distinct !{!173, !29}
!174 = distinct !{!174, !29}
!175 = !{i32 -1, i32 -1, i32 3, i32 -1}
!176 = !{i32 1, !22, i32 1, !109, i32 1, !53, i32 1, !119}
!177 = !{i32 8}
!178 = !{i32 9}
!179 = !{i1 false, !180, i1 false, i2 -1}
!180 = !{double 0.000000e+00, double 0x41091EB84007570C}
!181 = distinct !{!181, !29}
!182 = distinct !{!182, !29}
!183 = !{i32 1, !22, i32 1, !124, i32 1, !55, i32 1, !119}
!184 = !{i1 false, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 9.600000e+02}
!186 = distinct !{!186, !29}
!187 = distinct !{!187, !29}
!188 = !{i32 1, !124, i32 1, !109, i32 1, !57, i32 1, !119}
!189 = !{i1 false, !190, i1 false, i2 -1}
!190 = !{double 0.000000e+00, double 0x408D55556084A516}
!191 = distinct !{!191, !29}
!192 = distinct !{!192, !29}
