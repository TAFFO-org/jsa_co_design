; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-512-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 2.048000e+03, %lampsim15, !taffo.info !92
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !97
  %lampsim13 = bitcast float %mul.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -256
  %lampsim15 = bitcast i32 %lampsim14 to float
  %arrayidx1.u22_10fixp = getelementptr inbounds i32, i32* %val.u22_10fixp, i32 %i.0, !taffo.info !54
  %4 = fmul float 1.024000e+03, %lampsim15, !taffo.info !97
  %lampsim16 = bitcast float %4 to i32
  %lampsim17 = and i32 %lampsim16, -256
  %lampsim18 = bitcast i32 %lampsim17 to float
  %5 = fptoui float %lampsim18 to i32, !taffo.info !97
