; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-4-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,127.73999) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 4), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 4), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 4), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !175 !taffo.funinfo !186 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !118
  %mul = fmul float %1, %conv, !taffo.initweight !177, !taffo.info !187
  %2 = mul nsw i32 %i.0, %m, !taffo.info !111
...
!7 = !{double 0.000000e+00, double 0x405FEF5BFF04577E}
...
!119 = !{double 4.000000e+00, double 4.000000e+00}
...
!125 = !{double 0.000000e+00, double 0x40632937329C347F}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 5.625000e+00}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 2.025000e+01}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 5.400000e+00}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0.000000e+00, double 4.050000e+01}
!135 = !{i32 8}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x406507ADFF822BBF}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
...
!179 = !{double 0.000000e+00, double 0x407FEF5BFF04577E}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
!182 = !{i32 1, !107, i32 1, !22, i32 1, !55, i32 1, !118}
!183 = !{i1 false, !151, i1 false, i2 -1}
!184 = distinct !{!184, !29}
!185 = distinct !{!185, !29}
!186 = !{i32 1, !107, i32 1, !22, i32 1, !57, i32 1, !118}
!187 = !{i1 false, !188, i1 false, i2 -1}
!188 = !{double 0.000000e+00, double 1.440000e+01}
!189 = distinct !{!189, !29}
!190 = distinct !{!190, !29}
