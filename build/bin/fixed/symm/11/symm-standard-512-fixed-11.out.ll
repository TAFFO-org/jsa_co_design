; ModuleID = './build/bin/fixed/symm/11/symm-standard-512-fixed-11.out.ll.4.taffotmp.ll'
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %temp2.0.1flp = phi float [ 0.000000e+00, %for.body3 ], [ %add18.1flp, %for.inc ], !taffo.info !139
...
for.body6:                                        ; preds = %for.cond4
  ...
  %7 = fdiv float %6, 0x4140000000000000, !taffo.info !145
  ...
  %mul10.1flp = fmul float %7, %9, !taffo.info !146
  ...
  %add.1flp = fadd float %11, %mul10.1flp, !taffo.info !149
  %12 = fmul float 2.560000e+02, %add.1flp, !taffo.info !149
  %13 = fptoui float %12 to i32, !taffo.info !149
  ...
  %mul17.1flp = fmul float %15, %17, !taffo.info !151
  %add18.1flp = fadd float %temp2.0.1flp, %mul17.1flp, !taffo.info !151
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  ...
  %23 = fdiv float %22, 2.560000e+02, !taffo.info !156
  ...
  %29 = fdiv float %28, 0x4140000000000000, !taffo.info !145
  ...
  %mul27.1flp = fmul float %29, %31, !taffo.info !146
  %add28.1flp = fadd float %23, %mul27.1flp, !taffo.info !157
  %mul29.1flp = fmul float %1, %temp2.0.1flp, !taffo.info !159
  %add30.1flp = fadd float %add28.1flp, %mul29.1flp, !taffo.info !161
  ...
  %32 = fmul float 2.560000e+02, %add30.1flp, !taffo.info !161
  %33 = fptoui float %32 to i32, !taffo.info !161
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !179
  ...
  %6 = fmul float 2.560000e+02, %mul.1flp, !taffo.info !179
  %7 = fptoui float %6 to i32, !taffo.info !179
