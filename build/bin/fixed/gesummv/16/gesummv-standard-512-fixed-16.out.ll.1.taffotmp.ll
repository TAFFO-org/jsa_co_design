...
entry:
  ...
  call void @llvm.var.annotation(i8* %tmp5, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 119, i8* null)
  ...
  call void @scale_scalar(float* noundef %beta, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 512)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 512)
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 512)
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 512)
  %arraydecay16 = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 512)
