; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-64-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,18892.798828) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,56.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,57.599998) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,59.42857) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [47 x i8] c"target('D') scalar(range(0.0,5028249.5) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 64), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !66, !taffo.constinfo !67
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 64), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 64), !taffo.initweight !69, !taffo.info !55, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 64), !taffo.initweight !69, !taffo.info !57, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 64), !taffo.initweight !69, !taffo.info !59, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 64), !taffo.initweight !69, !taffo.info !61, !taffo.target !62, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 64), !taffo.initweight !69, !taffo.info !53, !taffo.originalCall !70, !taffo.constinfo !71
...
!7 = !{double 0.000000e+00, double 0x41532E6660000000}
...
!54 = !{double 0.000000e+00, double 0x40D273331FFF79C8}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 5.600000e+01}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x404CCCCCBC05D52C}
!59 = !{i1 false, !60, i1 false, i2 -1}
!60 = !{double 0.000000e+00, double 0x404DB6DB61BB05FB}
...
!143 = !{double 0.000000e+00, double 8.400000e+01}
!144 = !{i1 false, !145, i1 false, i2 -1}
!145 = !{double 0.000000e+00, double 0x40B2E6665B63D3E5}
!146 = !{i1 false, !147, i1 false, i2 -1}
!147 = !{double 0.000000e+00, double 0x40D72CCCB6D86EC1}
!148 = distinct !{!148, !29}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = !{i1 false, !152, i1 false, i2 -1}
!152 = !{double 0.000000e+00, double 0x4157047AD9999999}
!153 = !{i32 8}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x413121D404846DFD}
!156 = !{i1 false, !157, i1 false, i2 -1}
!157 = !{double 0.000000e+00, double 0x415776DB61211B7F}
!158 = distinct !{!158, !29}
!159 = distinct !{!159, !29}
!160 = distinct !{!160, !29}
...
!218 = !{double 0.000000e+00, double 0x413273331FFF79C8}
!219 = distinct !{!219, !29}
!220 = distinct !{!220, !29}
...
!228 = !{double 0.000000e+00, double 0x40ACCCCCBC05D52C}
!229 = distinct !{!229, !29}
!230 = distinct !{!230, !29}
!231 = !{i32 1, !22, i32 1, !126, i32 1, !59, i32 1, !134}
!232 = !{i1 false, !233, i1 false, i2 -1}
!233 = !{double 0.000000e+00, double 0x40ADB6DB61BB05FB}
!234 = distinct !{!234, !29}
!235 = distinct !{!235, !29}
!236 = !{i32 1, !124, i32 1, !126, i32 1, !61, i32 1, !134}
!237 = !{i1 false, !238, i1 false, i2 -1}
!238 = !{double 0.000000e+00, double 0x41B32E6660000000}
!239 = distinct !{!239, !29}
!240 = distinct !{!240, !29}
