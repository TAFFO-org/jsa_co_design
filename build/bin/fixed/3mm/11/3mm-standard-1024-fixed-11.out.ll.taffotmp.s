...
.Ltmp1:
	...
	movl	%eax, -2564(%ebp)               # 4-byte Spill
	leal	-444(%ebp), %eax
	...
	movl	%ebx, 24(%esp)
	movl	-2564(%ebp), %ebx               # 4-byte Reload
	movl	%edi, 28(%esp)
	movl	%esi, 32(%esp)
	movl	%edx, 36(%esp)
	movl	%ecx, 40(%esp)
	...
	leal	-2268(%ebp), %ecx
	leal	-2556(%ebp), %eax
	movl	%eax, -2568(%ebp)               # 4-byte Spill
	...
	movl	$14, 16(%esp)
	movl	%eax, 20(%esp)
	movl	-2568(%ebp), %eax               # 4-byte Reload
	movl	%ebx, 24(%esp)
	movl	-2564(%ebp), %ebx               # 4-byte Reload
	movl	%edi, 28(%esp)
	movl	%esi, 32(%esp)
	...
	calll	timer_stop
	xorl	%eax, %eax
	movl	%eax, -2560(%ebp)               # 4-byte Spill
.LBB7_1:                                # %for.cond
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB7_3 Depth 2
	movl	-2560(%ebp), %eax               # 4-byte Reload
...
# %bb.4:                                # %for.body30
	...
	movl	-2592(%ebp), %ecx               # 4-byte Reload
	movl	-2564(%ebp), %eax               # 4-byte Reload
	movl	-2584(%ebp), %edx               # 4-byte Reload
	shll	$4, %edx
	leal	(%edx,%edx,2), %edx
...
.Lfunc_end8:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function kernel_3mm.1_fixp
.LCPI9_0:
...
.LBB11_8:                               # %for.end9
	...
	retl
.Lfunc_end11:
	.size	scale_2d.4_fixp, .Lfunc_end11-scale_2d.4_fixp
	.cfi_endproc
                                        # -- End function
...
.LBB12_8:                               # %for.end9
	...
	retl
.Lfunc_end12:
	.size	scale_2d.3_fixp, .Lfunc_end12-scale_2d.3_fixp
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
