; ModuleID = './build/bin/fixed/ludcmp/16/ludcmp-standard-256-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [37 x i8] c"scalar(range(0.1,2092.159912) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [39 x i8] c"scalar(range(256.0,2092.159912) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [40 x i8] c"scalar(range(1030.400024,1152.0) final)\00", section "llvm.metadata", !taffo.info !0
...
@.str.5 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,1030.400024) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 256), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 256), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !59, !taffo.info !53
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 256), !taffo.initweight !60, !taffo.info !53, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 256), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 256), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!50 = !{double 1.000000e-01, double 0x40A05851DFFC547A}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 2.560000e+02, double 0x40A05851DFFC547A}
!53 = !{i1 false, !54, i1 false, i2 -1}
!54 = !{double 0x409019999FE43676, double 1.152000e+03}
!55 = !{i1 false, !7, i1 false, i2 -1}
!56 = !{!"x"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x409019999FE43676}
!59 = !{i32 1}
!60 = !{i32 2}
...
!132 = !{double 0x411019999FE43676, double 2.949120e+05}
!133 = distinct !{!133, !29}
!134 = !{i32 1, !123, i32 1, !55, i32 1, !128}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0xC0236DCA07F66E87, double 0x408FFCF893FAF428}
!137 = distinct !{!137, !29}
!138 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!139 = !{i32 1, !123, i32 1, !49, i32 1, !53, i32 1, !55, i32 1, !57}
!140 = !{i32 8}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0x3F847AE147AE147C, double 0x4150B28B463B78B0}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC150B2BD463B78B0, double 1.999900e+02}
!145 = distinct !{!145, !29}
...
!153 = !{double 0.000000e+00, double 0x41407278CFD00C6E}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0xC14072DCCFD00C6E, double 2.000000e+02}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
...
!165 = !{double 0xC053D9094AED99C8, double 0x40C056C5CDD0C3A5}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 0xC0C0BAC5CDD0C3A5, double 0x4071764252BB6672}
...
!176 = !{double 0.000000e+00, double 0x411019999FE43676}
!177 = distinct !{!177, !29}
...
!215 = !{double 2.560100e+02, double 0x4150B4965077783B}
!216 = distinct !{!216, !29}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = distinct !{!219, !29}
...
!225 = !{double 2.560000e+01, double 0x41205851DFFC547A}
!226 = distinct !{!226, !29}
!227 = distinct !{!227, !29}
!228 = !{i32 1, !123, i32 1, !123, i32 1, !51, i32 1, !128}
!229 = !{i1 false, !230, i1 false, i2 -1}
!230 = !{double 6.553600e+04, double 0x41205851DFFC547A}
!231 = distinct !{!231, !29}
!232 = distinct !{!232, !29}
