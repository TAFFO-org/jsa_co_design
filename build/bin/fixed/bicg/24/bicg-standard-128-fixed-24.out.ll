; ModuleID = './build/bin/fixed/bicg/24/bicg-standard-128-fixed-24.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !87 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !93
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !52
  %5 = shl i32 %mul.u14_18fixp, 7, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !99 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 7), !taffo.info !100
  %mul.u24_8fixp = shl i32 %4, 1, !taffo.info !103
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u24_8fixp, 7, !taffo.info !103
...
!95 = !{double 0.000000e+00, double 0x40CE66665E02EA96}
!96 = !{!97, !95, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 18}
!98 = distinct !{!98, !25}
!99 = !{i32 1, !75, i32 1, !47, i32 1, !88}
!100 = !{!101, !102, i1 false, i2 -1}
!101 = !{!"fixp", i32 -32, i32 7}
!102 = !{double 0.000000e+00, double 0x416B5D1760008638}
!103 = !{!104, !102, i1 false, i2 -1}
!104 = !{!"fixp", i32 32, i32 8}
!105 = distinct !{!105, !25}
