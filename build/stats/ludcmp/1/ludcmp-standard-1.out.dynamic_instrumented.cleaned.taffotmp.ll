; ModuleID = './build/stats/ludcmp/1/ludcmp-standard-1.out.dynamic_instrumented.1.taffotmp.ll'
...
for.inc101:                                       ; preds = %for.end100
  ...
  br label %for.cond70, !llvm.loop !17
...
for.inc120:                                       ; preds = %for.body111
  ...
  br label %for.cond108, !llvm.loop !18
...
for.inc103:                                       ; preds = %for.body94
  ...
  br label %for.cond92, !llvm.loop !27
...
for.inc113:                                       ; preds = %for.end105
  ...
  br label %for.cond87, !llvm.loop !28
