; ModuleID = './build/bin/fixed/symm/11/symm-standard-256-fixed-11.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,2801940.5) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [42 x i8] c"scalar(range(-255744.0,460.799988) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [32 x i8] c"scalar(range(25.6,640.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 256), !taffo.initweight !41, !taffo.info !30, !taffo.originalCall !43
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 256), !taffo.initweight !41, !taffo.info !32, !taffo.originalCall !43
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 256), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 256), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 256), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
...
!35 = !{double 0.000000e+00, double 0x4145608A40000000}
!36 = !{!"C"}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double -2.557440e+05, double 0x407CCCCCC0379314}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 2.560000e+01, double 6.400000e+02}
!41 = !{i32 1}
