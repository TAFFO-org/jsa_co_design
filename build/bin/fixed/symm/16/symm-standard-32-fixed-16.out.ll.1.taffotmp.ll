...
@.str.3 = private unnamed_addr constant [50 x i8] c"target('C') scalar(range(0.0,43810.558594) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [40 x i8] c"scalar(range(-31968.0,57.599998) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(3.2,80.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %C3, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 124, i8* null)
  %A4 = bitcast [10 x [10 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 125, i8* null)
  %B5 = bitcast [10 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B5, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 126, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 32)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 32)
