...
for.body6:                                        ; preds = %for.cond3
  ...
  store float %div10, ptr %arrayidx11, align 4
...
for.body16:                                       ; preds = %for.cond13
  ...
  %div20 = fdiv float %conv18, %conv19
...
for.body7:                                        ; preds = %for.cond5
  ...
  store float %add18, ptr %arrayidx19, align 4
  br label %for.inc20
...
if.end12:                                         ; preds = %if.then10, %for.body6
  ...
  %call15 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef @.str.8, double noundef %conv14)
  br label %for.inc16
