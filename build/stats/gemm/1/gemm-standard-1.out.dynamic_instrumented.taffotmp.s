...
# %bb.0:                                # %entry
	...
	callq	printf@PLT
	movss	-36(%rbp), %xmm0                # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1948(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movl	-1964(%rbp), %edi               # 4-byte Reload
	movl	-1960(%rbp), %esi               # 4-byte Reload
	movl	-1956(%rbp), %edx               # 4-byte Reload
	movss	-1952(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	-1948(%rbp), %xmm1              # 4-byte Reload
                                        # xmm1 = mem[0],zero,zero,zero
	leaq	-528(%rbp), %rcx
	leaq	-1168(%rbp), %r8
	leaq	-1936(%rbp), %r9
...
# %bb.4:                                # %for.body13
	...
	movss	%xmm0, -1968(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1968(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movslq	-1940(%rbp), %rcx
...
.Lfunc_end4:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_gemm
...
.LBB5_16:                               # %for.end34
	...
	retq
.Lfunc_end5:
	.size	kernel_gemm, .Lfunc_end5-kernel_gemm
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
...
.Lfunc_end6:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_gemm.2
...
.LBB7_16:                               # %for.end34
	...
	retq
.Lfunc_end7:
	.size	kernel_gemm.2, .Lfunc_end7-kernel_gemm.2
	.cfi_endproc
                                        # -- End function
...
PrintfTimerStr:
	...
	.type	.L__unnamed_72,@object          # @0
	.section	.rodata.str1.1,"aMS",@progbits,1
.L__unnamed_72:
	.asciz	"Float_half"
	.size	.L__unnamed_72, 11

	.type	.L__unnamed_73,@object          # @1
.L__unnamed_73:
	.asciz	"Float_bfloat"
	.size	.L__unnamed_73, 13
...
.L__unnamed_2:
	...
	.type	.L__unnamed_74,@object          # @3
.L__unnamed_74:
	.asciz	"Float_double"
	.size	.L__unnamed_74, 13

	.type	.L__unnamed_75,@object          # @4
.L__unnamed_75:
	.asciz	"Float_x86_fp80"
	.size	.L__unnamed_75, 15

	.type	.L__unnamed_76,@object          # @5
.L__unnamed_76:
	.asciz	"Float_fp128"
	.size	.L__unnamed_76, 12

	.type	.L__unnamed_77,@object          # @6
.L__unnamed_77:
