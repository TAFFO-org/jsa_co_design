; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %1, %3, !taffo.info !141
  %arrayidx1.u29_3fixp = getelementptr inbounds i32, i32* %val.u29_3fixp, i32 %i.0, !taffo.info !69
  %4 = fmul float 8.000000e+00, %mul.1flp, !taffo.info !141
  %5 = fptoui float %4 to i32, !taffo.info !141
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !154
