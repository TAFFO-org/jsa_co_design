; ModuleID = './build/bin/fixed/symm/8/symm-standard-16-fixed-8.out.ll'
...
entry:
  ...
  call void @kernel_symm.3_fixp(i32 10, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u14_18fixp, [10 x i32]* %arraydecay12.s15_17fixp, [16 x i32]* %arraydecay13.u6_26fixp), !taffo.info !56, !taffo.constinfo !57
...
for.body16:                                       ; preds = %for.cond14
  ...
  %1 = fdiv float %lampsim2, 2.621440e+05, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3_fixp(i32 noundef %m, i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u14_18fixp, [10 x i32]* noundef %A.s15_17fixp, [16 x i32]* noundef %B.u6_26fixp) #0 !taffo.initweight !90 !taffo.funinfo !91 !taffo.sourceFunction !92 {
entry:
  br label %for.cond
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %temp2.0.s21_11fixp = phi i32 [ %0, %for.body3 ], [ %add18.s21_11fixp, %for.inc ], !taffo.info !93
...
for.body6:                                        ; preds = %for.cond4
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !96
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !99
  ...
  %5 = lshr i32 %mul.u6_26fixp, 1, !taffo.info !99
  %6 = ashr i32 %5, 14, !taffo.info !99
  %7 = ashr i32 %s15_17fixp, 6, !taffo.info !50
  %mul10.s21_11fixp = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 11), !taffo.info !100
  ...
  %add.s21_11fixp = add i32 %8, %mul10.s21_11fixp, !taffo.info !102
  %9 = shl i32 %add.s21_11fixp, 7, !taffo.info !102
  ...
  %mul17.s21_11fixp = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 11), !taffo.info !104
  %add18.s21_11fixp = add i32 %temp2.0.s21_11fixp, %mul17.s21_11fixp, !taffo.info !104
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 17), !taffo.info !106
  %mul21.u14_18fixp = shl i32 %16, 1, !taffo.info !108
  ...
  %20 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %18, i32 25), !taffo.info !96
  %mul24.u6_26fixp = shl i32 %20, 1, !taffo.info !99
  ...
  %21 = lshr i32 %mul24.u6_26fixp, 1, !taffo.info !99
  %22 = ashr i32 %21, 14, !taffo.info !99
  %23 = ashr i32 %s15_17fixp3, 6, !taffo.info !50
  %mul27.s21_11fixp = call i32 @llvm.smul.fix.i32(i32 %22, i32 %23, i32 11), !taffo.info !100
  %24 = lshr i32 %mul21.u14_18fixp, 8, !taffo.info !108
  %25 = ashr i32 %mul27.s21_11fixp, 1, !taffo.info !100
  %add28.s22_10fixp = add i32 %24, %25, !taffo.info !109
  %26 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %27 = ashr i32 %26, 19, !taffo.info !42
  %28 = ashr i32 %temp2.0.s21_11fixp, 1, !taffo.info !93
  %mul29.s22_10fixp = call i32 @llvm.smul.fix.i32(i32 %27, i32 %28, i32 10), !taffo.info !112
  %add30.s22_10fixp = add i32 %add28.s22_10fixp, %mul29.s22_10fixp, !taffo.info !114
  ...
  %29 = shl i32 %add30.s22_10fixp, 8, !taffo.info !114
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %m, i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u14_18fixp, [10 x i32]* noundef %A.s15_17fixp, [16 x i32]* noundef %B.u6_26fixp) #0 !taffo.initweight !118 !taffo.funinfo !91 !taffo.sourceFunction !119 {
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !56, !taffo.constinfo !120
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !59, !taffo.constinfo !122
  br label %for.cond

for.cond:                                         ; preds = %for.inc15, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc16, %for.inc15 ], !taffo.info !125, !taffo.initweight !126
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !127, !taffo.initweight !128
  br i1 %cmp, label %for.body, label %for.end17, !taffo.info !129, !taffo.initweight !130

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !131, !taffo.initweight !126
  %cmp4 = icmp slt i32 %j.0, %n, !taffo.info !127, !taffo.initweight !128
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !133, !taffo.initweight !130

for.body5:                                        ; preds = %for.cond3
  %add = add nsw i32 %i.0, %j.0, !taffo.info !135, !taffo.initweight !128
  %rem = srem i32 %add, 100, !taffo.info !135, !taffo.initweight !130, !taffo.constinfo !21
  %conv.u5_27fixp = shl i32 %rem, 27, !taffo.info !137, !taffo.constinfo !21
  %conv6.u4_28fixp = shl i32 %m, 28, !taffo.info !139
  %0 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !137, !taffo.constinfo !21
  %1 = lshr i32 %conv6.u4_28fixp, 1, !taffo.info !139
  %2 = ashr i32 %1, 1, !taffo.info !139
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %2, i32 26), !taffo.info !141
  %div.u4_28fixp = shl i32 %3, 2, !taffo.info !144
  %arrayidx.u14_18fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u14_18fixp, i32 %i.0, !taffo.info !145
  %arrayidx7.u14_18fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u14_18fixp, i32 0, i32 %j.0, !taffo.info !145
  %4 = lshr i32 %div.u4_28fixp, 10, !taffo.info !144
  store i32 %4, i32* %arrayidx7.u14_18fixp, align 4, !taffo.info !146
  %add8 = add nsw i32 %n, %i.0, !taffo.info !147, !taffo.initweight !128
  %sub = sub nsw i32 %add8, %j.0, !taffo.info !135, !taffo.initweight !128
  %rem9 = srem i32 %sub, 100, !taffo.info !135, !taffo.initweight !130, !taffo.constinfo !21
  %conv10.u5_27fixp = shl i32 %rem9, 27, !taffo.info !137, !taffo.constinfo !21
  %conv11.u4_28fixp = shl i32 %m, 28, !taffo.info !139
  %5 = lshr i32 %conv10.u5_27fixp, 1, !taffo.info !137, !taffo.constinfo !21
  %6 = lshr i32 %conv11.u4_28fixp, 1, !taffo.info !139
  %7 = ashr i32 %6, 1, !taffo.info !139
  %8 = call i32 @llvm.sdiv.fix.i32(i32 %5, i32 %7, i32 26), !taffo.info !141
  %div12.u4_28fixp = shl i32 %8, 2, !taffo.info !144
  %arrayidx13.u6_26fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u6_26fixp, i32 %i.0, !taffo.info !149
  %arrayidx14.u6_26fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx13.u6_26fixp, i32 0, i32 %j.0, !taffo.info !149
  %9 = lshr i32 %div12.u4_28fixp, 2, !taffo.info !144
  store i32 %9, i32* %arrayidx14.u6_26fixp, align 4, !taffo.info !146
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !150, !taffo.initweight !128, !taffo.constinfo !21
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %i.0, 1, !taffo.info !153, !taffo.initweight !128, !taffo.constinfo !21
...
for.cond18:                                       ; preds = %for.inc46, %for.end17
  %i.1 = phi i32 [ 0, %for.end17 ], [ %inc47, %for.inc46 ], !taffo.info !125, !taffo.initweight !126
  %cmp19 = icmp slt i32 %i.1, %m, !taffo.info !127, !taffo.initweight !128
  br i1 %cmp19, label %for.body21, label %for.end48, !taffo.info !129, !taffo.initweight !130

for.body21:                                       ; preds = %for.cond18
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc33, %for.body21
  %j.1 = phi i32 [ 0, %for.body21 ], [ %inc34, %for.inc33 ], !taffo.info !131, !taffo.initweight !126
  %cmp23 = icmp sle i32 %j.1, %i.1, !taffo.info !127, !taffo.initweight !128
  br i1 %cmp23, label %for.body25, label %for.end35, !taffo.info !129, !taffo.initweight !130

for.body25:                                       ; preds = %for.cond22
  %add26 = add nsw i32 %i.1, %j.1, !taffo.info !135, !taffo.initweight !128
  %rem27 = srem i32 %add26, 100, !taffo.info !135, !taffo.initweight !130, !taffo.constinfo !21
  %conv28.u5_27fixp = shl i32 %rem27, 27, !taffo.info !137, !taffo.constinfo !21
  %conv29.u4_28fixp = shl i32 %m, 28, !taffo.info !139
  %10 = lshr i32 %conv28.u5_27fixp, 1, !taffo.info !137, !taffo.constinfo !21
  %11 = lshr i32 %conv29.u4_28fixp, 1, !taffo.info !139
  %12 = ashr i32 %11, 1, !taffo.info !139
  %13 = call i32 @llvm.sdiv.fix.i32(i32 %10, i32 %12, i32 26), !taffo.info !141
  %div30.u4_28fixp = shl i32 %13, 2, !taffo.info !144
  %arrayidx31.s15_17fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s15_17fixp, i32 %i.1, !taffo.info !155
  %arrayidx32.s15_17fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx31.s15_17fixp, i32 0, i32 %j.1, !taffo.info !155
  %14 = lshr i32 %div30.u4_28fixp, 11, !taffo.info !144
  store i32 %14, i32* %arrayidx32.s15_17fixp, align 4, !taffo.info !146
  br label %for.inc33

for.inc33:                                        ; preds = %for.body25
  %inc34 = add nsw i32 %j.1, 1, !taffo.info !150, !taffo.initweight !128, !taffo.constinfo !21
  br label %for.cond22, !llvm.loop !156

for.end35:                                        ; preds = %for.cond22
  %add36 = add nsw i32 %i.1, 1, !taffo.info !153, !taffo.initweight !128, !taffo.constinfo !21
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc43, %for.end35
  %j.2 = phi i32 [ %add36, %for.end35 ], [ %inc44, %for.inc43 ], !taffo.info !131, !taffo.initweight !126
  %cmp38 = icmp slt i32 %j.2, %m, !taffo.info !127, !taffo.initweight !128
  br i1 %cmp38, label %for.body40, label %for.end45, !taffo.info !133, !taffo.initweight !130

for.body40:                                       ; preds = %for.cond37
  %arrayidx41.s15_17fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s15_17fixp, i32 %i.1, !taffo.info !155
  %arrayidx42.s15_17fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx41.s15_17fixp, i32 0, i32 %j.2, !taffo.info !155
  store i32 -130940928, i32* %arrayidx42.s15_17fixp, align 4, !taffo.info !146, !taffo.constinfo !157
  br label %for.inc43

for.inc43:                                        ; preds = %for.body40
  %inc44 = add nsw i32 %j.2, 1, !taffo.info !150, !taffo.initweight !128, !taffo.constinfo !21
...
for.inc46:                                        ; preds = %for.end45
  %inc47 = add nsw i32 %i.1, 1, !taffo.info !153, !taffo.initweight !128, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !163 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !166
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !169
  ...
  %7 = shl i32 %mul.u18_14fixp, 4, !taffo.info !169
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s15_17fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !173 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.s19_13fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !174
  ...
  %5 = shl i32 %mul.s19_13fixp, 4, !taffo.info !174
...
!90 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!91 = !{i32 1, !16, i32 1, !79, i32 1, !42, i32 1, !45, i32 1, !47, i32 1, !50, i32 1, !53}
!92 = distinct !{null}
!93 = !{!94, !95, i1 false, i2 1}
!94 = !{!"fixp", i32 -32, i32 11}
!95 = !{double -6.393600e+05, double 0x4091FFFFF583A53C}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 -32, i32 25}
!98 = !{double 0x4003333333333334, double 6.000000e+01}
!99 = !{!54, !98, i1 false, i2 -1}
!100 = !{!94, !101, i1 false, i2 -1}
!101 = !{double -9.590400e+05, double 0x409AFFFFF04577D9}
!102 = !{!94, !103, i1 false, i2 -1}
!103 = !{double -9.590400e+05, double 0x40C8C8A3DE050375}
!104 = !{!94, !95, i1 false, i2 -1}
!105 = distinct !{!105, !23}
!106 = !{!51, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 0x40C9B0C4A661FEF9}
!108 = !{!48, !107, i1 false, i2 -1}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 10}
!111 = !{double -9.590400e+05, double 0x40CD10C4A46AADF4}
!112 = !{!110, !113, i1 false, i2 -1}
!113 = !{double -9.590400e+05, double 0x409AFFFFF04577DA}
!114 = !{!110, !115, i1 false, i2 -1}
!115 = !{double -1.918080e+06, double 0x40D038625139AE78}
!116 = distinct !{!116, !23}
!117 = distinct !{!117, !23}
...
!163 = !{i32 1, !16, i32 1, !79, i32 1, !47, i32 1, !79}
!164 = !{void (i32, i32, float*, i32)* @scale_2d}
!165 = !{!138, !80, i1 false, i2 1}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 -32, i32 13}
!168 = !{double 0.000000e+00, double 0x410568A3DFFC547A}
!169 = !{!170, !168, i1 false, i2 -1}
!170 = !{!"fixp", i32 32, i32 14}
!171 = distinct !{!171, !23}
!172 = distinct !{!172, !23}
!173 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !79}
!174 = !{!167, !175, i1 false, i2 -1}
!175 = !{double -2.557440e+05, double 0x407CCCCCBC05D52C}
!176 = distinct !{!176, !23}
!177 = distinct !{!177, !23}
