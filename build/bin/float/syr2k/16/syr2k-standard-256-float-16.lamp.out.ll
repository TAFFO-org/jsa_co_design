; ModuleID = './build/bin/float/syr2k/16/syr2k-standard-256-float-16.out.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,507740.125) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay3, i32 noundef 256)
  %arraydecay4 = getelementptr inbounds [16 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay4, i32 noundef 256)
  %arraydecay5 = getelementptr inbounds [16 x [10 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay5, i32 noundef 256)
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv912 = sitofp i32 %rem8 to float
  %lampsim13 = bitcast float %conv912 to i32
  %lampsim14 = and i32 %lampsim13, -256
  %lampsim15 = bitcast i32 %lampsim14 to float
  %16 = load i32, ptr %m.addr, align 4
  %conv1016 = sitofp i32 %16 to float
  %lampsim17 = bitcast float %conv1016 to i32
  %lampsim18 = and i32 %lampsim17, -256
  %lampsim19 = bitcast i32 %lampsim18 to float
  %div1120 = fdiv float %lampsim15, %lampsim19
  %lampsim21 = bitcast float %div1120 to i32
  %lampsim22 = and i32 %lampsim21, -256
  %lampsim23 = bitcast i32 %lampsim22 to float
  ...
  store float %lampsim23, ptr %arrayidx13, align 4
  br label %for.inc
...
for.body24:                                       ; preds = %for.cond21
  ...
  %conv2824 = sitofp i32 %rem27 to float
  %lampsim25 = bitcast float %conv2824 to i32
  %lampsim26 = and i32 %lampsim25, -256
  %lampsim27 = bitcast i32 %lampsim26 to float
  %29 = load i32, ptr %m.addr, align 4
  %conv2928 = sitofp i32 %29 to float
  %lampsim29 = bitcast float %conv2928 to i32
  %lampsim30 = and i32 %lampsim29, -256
  %lampsim31 = bitcast i32 %lampsim30 to float
  %div3032 = fdiv float %lampsim27, %lampsim31
  %lampsim33 = bitcast float %div3032 to i32
  ...
  store float %lampsim35, ptr %arrayidx32, align 4
  br label %for.inc33
...
for.body10:                                       ; preds = %for.cond8
  ...
  %mul1912 = fmul float %26, %27
  %lampsim13 = bitcast float %mul1912 to i32
  %lampsim14 = and i32 %lampsim13, -256
  %lampsim15 = bitcast i32 %lampsim14 to float
  ...
  %mul2216 = fmul float %lampsim15, %31
  %lampsim17 = bitcast float %mul2216 to i32
  %lampsim18 = and i32 %lampsim17, -256
  %lampsim19 = bitcast i32 %lampsim18 to float
  %add20 = fadd float %lampsim11, %lampsim19
  %lampsim21 = bitcast float %add20 to i32
  %lampsim22 = and i32 %lampsim21, -256
  %lampsim23 = bitcast i32 %lampsim22 to float
  ...
  %add2524 = fadd float %35, %lampsim23
  %lampsim25 = bitcast float %add2524 to i32
  %lampsim26 = and i32 %lampsim25, -256
  %lampsim27 = bitcast i32 %lampsim26 to float
  store float %lampsim27, ptr %arrayidx24, align 4
  br label %for.inc26
