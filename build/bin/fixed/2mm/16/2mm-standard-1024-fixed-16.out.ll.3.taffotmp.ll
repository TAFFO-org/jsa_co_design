; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-1024-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,4836556.5) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,896.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,921.599976) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,950.857117) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [51 x i8] c"target('D') scalar(range(0.0,20595709952.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !66, !taffo.constinfo !67
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 1024), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 1024), !taffo.initweight !69, !taffo.info !55, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.initweight !69, !taffo.info !57, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 1024), !taffo.initweight !69, !taffo.info !59, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 1024), !taffo.initweight !69, !taffo.info !61, !taffo.target !62, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 1024), !taffo.initweight !69, !taffo.info !53, !taffo.originalCall !70, !taffo.constinfo !71
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !134
  %mul = fmul float %1, %conv, !taffo.initweight !216, !taffo.info !222
  %2 = mul nsw i32 %i.0, %m, !taffo.info !112
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !226 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !134
  %mul = fmul float %1, %conv, !taffo.initweight !216, !taffo.info !227
  %2 = mul nsw i32 %i.0, %m, !taffo.info !112
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !231 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !134
  %mul = fmul float %1, %conv, !taffo.initweight !216, !taffo.info !232
  %2 = mul nsw i32 %i.0, %m, !taffo.info !112
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !236 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !134
  %mul = fmul float %1, %conv, !taffo.initweight !216, !taffo.info !237
  %2 = mul nsw i32 %i.0, %m, !taffo.info !112
...
!7 = !{double 0.000000e+00, double 0x42132E6660000000}
...
!54 = !{double 0.000000e+00, double 0x4152733320000000}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 8.960000e+02}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x408CCCCCC0379314}
!59 = !{i1 false, !60, i1 false, i2 -1}
!60 = !{double 0.000000e+00, double 0x408DB6DB60285EC4}
...
!143 = !{double 0.000000e+00, double 1.344000e+03}
!144 = !{i1 false, !145, i1 false, i2 -1}
!145 = !{double 0.000000e+00, double 0x4132E6665E247885}
!146 = !{i1 false, !147, i1 false, i2 -1}
!147 = !{double 0.000000e+00, double 0x41572CCCB7891E21}
!148 = distinct !{!148, !29}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = !{i1 false, !152, i1 false, i2 -1}
!152 = !{double 0.000000e+00, double 0x4217047AD9999999}
!153 = !{i32 8}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x41F121D4039CC303}
!156 = !{i1 false, !157, i1 false, i2 -1}
!157 = !{double 0.000000e+00, double 0x421776DB60E730C1}
!158 = distinct !{!158, !29}
!159 = distinct !{!159, !29}
!160 = distinct !{!160, !29}
...
!218 = !{double 0.000000e+00, double 0x41F2733320000000}
!219 = distinct !{!219, !29}
!220 = distinct !{!220, !29}
!221 = !{i32 1, !124, i32 1, !139, i32 1, !55, i32 1, !134}
!222 = !{i1 false, !223, i1 false, i2 -1}
!223 = !{double 0.000000e+00, double 9.175040e+05}
!224 = distinct !{!224, !29}
!225 = distinct !{!225, !29}
!226 = !{i32 1, !139, i32 1, !22, i32 1, !57, i32 1, !134}
!227 = !{i1 false, !228, i1 false, i2 -1}
!228 = !{double 0.000000e+00, double 0x412CCCCCC0379314}
!229 = distinct !{!229, !29}
!230 = distinct !{!230, !29}
!231 = !{i32 1, !22, i32 1, !126, i32 1, !59, i32 1, !134}
!232 = !{i1 false, !233, i1 false, i2 -1}
!233 = !{double 0.000000e+00, double 0x412DB6DB60285EC4}
!234 = distinct !{!234, !29}
!235 = distinct !{!235, !29}
!236 = !{i32 1, !124, i32 1, !126, i32 1, !61, i32 1, !134}
!237 = !{i1 false, !238, i1 false, i2 -1}
!238 = !{double 0.000000e+00, double 0x42B32E6660000000}
!239 = distinct !{!239, !29}
!240 = distinct !{!240, !29}
