; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 1024), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 1024), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 1024), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
!55 = !{double 0.000000e+00, double 0x408D55555FFE6D59}
...
!110 = !{double 0.000000e+00, double 0x415E0126E6666666}
!111 = distinct !{!111, !23}
...
!117 = !{double 0.000000e+00, double 0x4134A000077EE4E3}
!118 = !{!49, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x415E28F5C1DFB939}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = distinct !{!122, !23}
...
!181 = !{!"float", i32 1, double 0x41F900F5C0000000}
!182 = !{double 0.000000e+00, double 0x41F900F5C0000000}
!183 = !{i32 9}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
