; ModuleID = './build/bin/fixed/3mm/8/3mm-standard-64-fixed-8.out.ll'
...
entry:
  ...
  %u4_28fixp1 = bitcast [10 x i32]* %arraydecay15.u4_28fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u4_28fixp1, i32 64), !taffo.info !62, !taffo.constinfo !61
  ...
  %u4_28fixp = bitcast [12 x i32]* %arraydecay19.u4_28fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u4_28fixp, i32 64), !taffo.info !66, !taffo.constinfo !61
