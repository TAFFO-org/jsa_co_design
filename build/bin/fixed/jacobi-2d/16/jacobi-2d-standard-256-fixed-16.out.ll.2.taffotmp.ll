; ModuleID = './build/bin/fixed/jacobi-2d/16/jacobi-2d-standard-256-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 256), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 256), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x404111111F0C34C2, double 0x40AE22221FF2E48F}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 0x40499999A1FD156A, double 0x40B011112007DD44}
!34 = !{i32 1}
!35 = !{i32 2}
