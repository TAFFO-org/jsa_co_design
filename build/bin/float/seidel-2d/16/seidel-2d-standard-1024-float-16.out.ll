...
@.str = private unnamed_addr constant [57 x i8] c"target('A') scalar(range(102.400002,20531.199219) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay1, i32 noundef 1024)
