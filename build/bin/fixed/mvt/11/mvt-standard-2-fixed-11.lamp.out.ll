; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-2-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %lampsim8, 0x41A0000000000000, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !78 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u5_27fixp = load i32, i32* %arrayidx.u5_27fixp, align 4, !taffo.info !79
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !81
  %0 = lshr i32 %u5_27fixp, 1, !taffo.info !79
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !81
  %2 = ashr i32 %0, 1, !taffo.info !79
  %3 = ashr i32 %1, 4, !taffo.info !81
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 25), !taffo.info !82
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !85
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u6_26fixp, 1, !taffo.info !85
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !87 !taffo.sourceFunction !78 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u2_30fixp = load i32, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !88
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !90
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !88
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !90
  %2 = ashr i32 %0, 1, !taffo.info !88
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 28), !taffo.info !91
  %mul.u3_29fixp = shl i32 %3, 1, !taffo.info !94
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !44
  %4 = shl i32 %mul.u3_29fixp, 1, !taffo.info !94
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp3 = load i32, i32* %arrayidx5.u2_30fixp, align 4, !taffo.info !88
  %arrayidx6.u2_30fixp = getelementptr inbounds i32, i32* %y_1.u2_30fixp, i32 %j.0, !taffo.info !44
  %u2_30fixp = load i32, i32* %arrayidx6.u2_30fixp, align 4, !taffo.info !88
  %0 = lshr i32 %u2_30fixp3, 1, !taffo.info !88
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !88
  %2 = ashr i32 %0, 3, !taffo.info !88
...
for.body16:                                       ; preds = %for.cond14
  ...
  %u2_30fixp4 = load i32, i32* %arrayidx19.u2_30fixp, align 4, !taffo.info !88
  %arrayidx20.u2_30fixp = getelementptr inbounds i32, i32* %y_2.u2_30fixp, i32 %j.1, !taffo.info !44
  %u2_30fixp2 = load i32, i32* %arrayidx20.u2_30fixp, align 4, !taffo.info !88
  %5 = lshr i32 %u2_30fixp4, 1, !taffo.info !88
  %6 = lshr i32 %u2_30fixp2, 1, !taffo.info !88
  %7 = ashr i32 %5, 3, !taffo.info !88
  %8 = ashr i32 %6, 3, !taffo.info !88
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp = load i32, i32* %arrayidx4.u2_30fixp, align 4, !taffo.info !88
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !90
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !88
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !90
  %3 = ashr i32 %1, 1, !taffo.info !88
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 28), !taffo.info !91
  %mul.u3_29fixp = shl i32 %4, 1, !taffo.info !94
  ...
  %6 = shl i32 %mul.u3_29fixp, 1, !taffo.info !94
...
!77 = !{i32 1, !67, i32 1, !47, i32 1, !21}
!78 = !{void (i32, float*, i32)* @scale_1d}
!79 = !{!80, !1, i1 false, i2 -1}
!80 = !{!"fixp", i32 32, i32 26}
!81 = !{!45, !22, i1 false, i2 1}
!82 = !{!83, !84, i1 false, i2 -1}
!83 = !{!"fixp", i32 -32, i32 25}
!84 = !{double 0.000000e+00, double 0x40454CCCDD93C46E}
!85 = !{!80, !84, i1 false, i2 -1}
!86 = distinct !{!86, !25}
!87 = !{i32 1, !67, i32 1, !44, i32 1, !21}
!88 = !{!89, !46, i1 false, i2 -1}
!89 = !{!"fixp", i32 32, i32 29}
!90 = !{!89, !22, i1 false, i2 1}
!91 = !{!92, !93, i1 false, i2 -1}
!92 = !{!"fixp", i32 -32, i32 28}
!93 = !{double 0.000000e+00, double 3.800000e+00}
