; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-64-fixed-24.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,18892.798828) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,56.0) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,57.599998) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,59.42857) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [47 x i8] c"target('D') scalar(range(0.0,5028249.5) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 64), !taffo.initweight !47, !taffo.info !32, !taffo.originalCall !49
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 64), !taffo.initweight !47, !taffo.info !34, !taffo.originalCall !49
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %4, i32 noundef 64), !taffo.initweight !51, !taffo.info !38, !taffo.originalCall !52
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %5, i32 noundef 64), !taffo.initweight !51, !taffo.info !40, !taffo.originalCall !52
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %6, i32 noundef 64), !taffo.initweight !51, !taffo.info !42, !taffo.originalCall !52
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %7, i32 noundef 64), !taffo.initweight !51, !taffo.info !44, !taffo.target !46, !taffo.originalCall !52
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %8, i32 noundef 64), !taffo.initweight !51, !taffo.info !36, !taffo.originalCall !52
...
!37 = !{double 0.000000e+00, double 0x40D273331FFF79C8}
!38 = !{i1 false, !39, i1 false, i2 -1}
!39 = !{double 0.000000e+00, double 5.600000e+01}
!40 = !{i1 false, !41, i1 false, i2 -1}
!41 = !{double 0.000000e+00, double 0x404CCCCCBC05D52C}
!42 = !{i1 false, !43, i1 false, i2 -1}
!43 = !{double 0.000000e+00, double 0x404DB6DB61BB05FB}
!44 = !{i1 false, !45, i1 false, i2 -1}
!45 = !{double 0.000000e+00, double 0x41532E6660000000}
!46 = !{!"D"}
!47 = !{i32 1}
