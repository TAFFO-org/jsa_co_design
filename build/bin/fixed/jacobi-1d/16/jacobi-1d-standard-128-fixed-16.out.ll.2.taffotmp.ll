; ModuleID = './build/bin/fixed/jacobi-1d/16/jacobi-1d-standard-128-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 128), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !37
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !34, !taffo.info !32
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 128), !taffo.initweight !35, !taffo.info !32, !taffo.originalCall !37
...
!31 = !{double 0x40311111276FB092, double 0x406111111F0C34C2}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 2.560000e+01, double 0x4062222220BC382A}
!34 = !{i32 1}
!35 = !{i32 2}
