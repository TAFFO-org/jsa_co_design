; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-1024-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,6554583.0) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,960.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,938.666687) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.initweight !59, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 1024), !taffo.initweight !59, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 1024), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 1024), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 1024), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x415900F5C0000000}
...
!56 = !{double 0.000000e+00, double 9.600000e+02}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x408D55555FFE6D59}
!59 = !{i32 1}
...
!128 = !{double 0.000000e+00, double 0x415E0126E6666666}
!129 = distinct !{!129, !29}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 1.440000e+03}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x4134A000077EE4E3}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x415E28F5C1DFB939}
!136 = distinct !{!136, !29}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
