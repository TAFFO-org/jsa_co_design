; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-32-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !119 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !123
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !126
  %arrayidx1.u14_18fixp = getelementptr inbounds i32, i32* %val.u14_18fixp, i32 %i.0, !taffo.info !68
  %5 = shl i32 %mul.u19_13fixp, 5, !taffo.info !126
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !129 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !130
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !133
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u10_22fixp, 5, !taffo.info !133
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !144 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 22), !taffo.info !145
  %mul.u9_23fixp = shl i32 %4, 1, !taffo.info !148
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u9_23fixp, 5, !taffo.info !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u26_6fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !150 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %1, %3, !taffo.info !151
  %arrayidx1.u26_6fixp = getelementptr inbounds i32, i32* %val.u26_6fixp, i32 %i.0, !taffo.info !65
  %4 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !151
  %5 = fptoui float %4 to i32, !taffo.info !151
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u9_23fixp = load i32, i32* %arrayidx4.u9_23fixp, align 4, !taffo.info !158
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !159
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !161
  %5 = lshr i32 %u9_23fixp, 1, !taffo.info !158
  %add.u10_22fixp = add i32 %5, %mul.u10_22fixp, !taffo.info !162
  %arrayidx7.u5_27fixp = getelementptr inbounds i32, i32* %u2.u5_27fixp, i32 %i.0, !taffo.info !60
  %u5_27fixp1 = load i32, i32* %arrayidx7.u5_27fixp, align 4, !taffo.info !164
  ...
  %6 = lshr i32 %u5_27fixp1, 1, !taffo.info !164
  %7 = lshr i32 %u3_29fixp, 1, !taffo.info !62
  %8 = ashr i32 %6, 2, !taffo.info !164
  %9 = ashr i32 %7, 4, !taffo.info !62
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 24), !taffo.info !166
  %mul9.u7_25fixp = shl i32 %10, 1, !taffo.info !169
  %11 = lshr i32 %mul9.u7_25fixp, 3, !taffo.info !169
  %add10.u10_22fixp = add i32 %add.u10_22fixp, %11, !taffo.info !170
  ...
  %12 = shl i32 %add10.u10_22fixp, 1, !taffo.info !170
...
for.body21:                                       ; preds = %for.cond19
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 20), !taffo.info !174
  %mul25.u11_21fixp = shl i32 %17, 1, !taffo.info !177
  ...
  %18 = lshr i32 %mul25.u11_21fixp, 1, !taffo.info !177
  %19 = lshr i32 %u3_29fixp4, 1, !taffo.info !70
  %20 = ashr i32 %19, 8, !taffo.info !70
  %21 = call i32 @llvm.smul.fix.i32(i32 %18, i32 %20, i32 20), !taffo.info !179
  %mul27.u11_21fixp = shl i32 %21, 1, !taffo.info !181
  %22 = lshr i32 %mul27.u11_21fixp, 3, !taffo.info !181
  %add28.u14_18fixp = add i32 %u14_18fixp, %22, !taffo.info !182
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u14_18fixp = add i32 %u14_18fixp2, %23, !taffo.info !186
...
for.body51:                                       ; preds = %for.cond49
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 22), !taffo.info !189
  %mul55.u9_23fixp = shl i32 %27, 1, !taffo.info !191
  ...
  %28 = lshr i32 %mul55.u9_23fixp, 1, !taffo.info !191
  %29 = lshr i32 %u14_18fixp3, 1, !taffo.info !68
  %30 = ashr i32 %28, 14, !taffo.info !191
  %31 = ashr i32 %29, 9, !taffo.info !68
  %32 = call i32 @llvm.smul.fix.i32(i32 %30, i32 %31, i32 8), !taffo.info !192
  %mul57.u23_9fixp = shl i32 %32, 1, !taffo.info !195
  %33 = lshr i32 %mul57.u23_9fixp, 3, !taffo.info !195
  %add58.u26_6fixp = add i32 %u26_6fixp, %33, !taffo.info !197
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u9_23fixp, i32* noundef %u1.u5_27fixp, i32* noundef %v1.u4_28fixp, i32* noundef %u2.u5_27fixp, i32* noundef %v2.u3_29fixp, i32* noundef %w.u26_6fixp, i32* noundef %x.u14_18fixp, i32* noundef %y.u3_29fixp, i32* noundef %z.u3_29fixp) #0 !taffo.initweight !201 !taffo.funinfo !156 !taffo.sourceFunction !202 {
entry:
...
!143 = distinct !{!143, !27}
!144 = !{i32 1, !103, i32 1, !57, i32 1, !115}
!145 = !{!146, !147, i1 false, i2 -1}
!146 = !{!"fixp", i32 -32, i32 22}
!147 = !{double 1.280000e+01, double 2.560000e+02}
!148 = !{!53, !147, i1 false, i2 -1}
!149 = distinct !{!149, !27}
!150 = !{i32 1, !103, i32 1, !65, i32 1, !115}
!151 = !{!152, !153, i1 false, i2 -1}
!152 = !{!"float", i32 1, double 0x41D59442A0000000}
!153 = !{double 0.000000e+00, double 0x41D59442A0000000}
!154 = distinct !{!154, !27}
...
!157 = distinct !{null}
!158 = !{!134, !5, i1 false, i2 -1}
!159 = !{!131, !160, i1 false, i2 -1}
!160 = !{double 0.000000e+00, double 2.432000e+02}
!161 = !{!134, !160, i1 false, i2 -1}
!162 = !{!134, !163, i1 false, i2 -1}
!163 = !{double 0.000000e+00, double 0x4081EAAAA9717DF2}
!164 = !{!165, !61, i1 false, i2 -1}
!165 = !{!"fixp", i32 32, i32 25}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 -32, i32 24}
!168 = !{double 0x3FCB4E83F191A834, double 0x405555553EF6B5D4}
!169 = !{!165, !168, i1 false, i2 -1}
!170 = !{!134, !171, i1 false, i2 -1}
!171 = !{double 0x3FCB4E83F191A834, double 0x40849555515054AC}
!172 = distinct !{!172, !27}
!173 = distinct !{!173, !27}
!174 = !{!175, !176, i1 false, i2 -1}
!175 = !{!"fixp", i32 -32, i32 20}
!176 = !{double 0.000000e+00, double 0x4078C28F59395739}
!177 = !{!178, !176, i1 false, i2 -1}
!178 = !{!"fixp", i32 32, i32 21}
!179 = !{!175, !180, i1 false, i2 -1}
!180 = !{double 0.000000e+00, double 0x4098C28F59395739}
!181 = !{!178, !180, i1 false, i2 -1}
!182 = !{!69, !183, i1 false, i2 -1}
!183 = !{double 0.000000e+00, double 0x40C9F1234B259840}
!184 = distinct !{!184, !27}
!185 = distinct !{!185, !27}
!186 = !{!69, !187, i1 false, i2 -1}
!187 = !{double 1.777780e-01, double 0x40C6DA987C73EEE5}
!188 = distinct !{!188, !27}
!189 = !{!146, !190, i1 false, i2 -1}
!190 = !{double 0.000000e+00, double 0x407EF3332F87AD08}
!191 = !{!53, !190, i1 false, i2 -1}
!192 = !{!193, !194, i1 false, i2 -1}
!193 = !{!"fixp", i32 -32, i32 8}
!194 = !{double 0.000000e+00, double 0x415618E74B6C7D51}
!195 = !{!196, !194, i1 false, i2 -1}
!196 = !{!"fixp", i32 32, i32 9}
!197 = !{!66, !198, i1 false, i2 -1}
!198 = !{double 0.000000e+00, double 0x4188575F896D8FAA}
!199 = distinct !{!199, !27}
!200 = distinct !{!200, !27}
