...
entry:
  ...
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 101, i8* null)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 4)
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 4)
