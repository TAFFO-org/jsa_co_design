; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-16-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 16), !taffo.initweight !41, !taffo.info !30, !taffo.originalCall !42
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 16), !taffo.initweight !39, !taffo.info !32, !taffo.target !34, !taffo.originalCall !43
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 16), !taffo.initweight !39, !taffo.info !35, !taffo.target !37, !taffo.originalCall !43
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.initweight !38, !taffo.info !30
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 16), !taffo.initweight !39, !taffo.info !30, !taffo.originalCall !43
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.initweight !38, !taffo.info !30
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 16), !taffo.initweight !39, !taffo.info !30, !taffo.originalCall !43
...
!31 = !{double 0.000000e+00, double 1.520000e+01}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 0.000000e+00, double 0x4093CFFFE004B7F6}
!34 = !{!"x1"}
!35 = !{i1 false, !36, i1 false, i2 -1}
!36 = !{double 0.000000e+00, double 0x40940666601BC98A}
!37 = !{!"x2"}
!38 = !{i32 1}
!39 = !{i32 2}
