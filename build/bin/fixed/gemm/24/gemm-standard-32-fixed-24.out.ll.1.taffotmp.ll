...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,6430.719727) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,30.0) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,29.333334) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 12, float* noundef %3, i32 noundef 32)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 32)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 12, float* noundef %5, i32 noundef 32)
