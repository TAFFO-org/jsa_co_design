; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-16-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [53 x i8] c"target('A') scalar(range(2.133333,241.066666) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [36 x i8] c"scalar(range(3.2,257.066681) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 16), !taffo.initweight !57, !taffo.target !48, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 16), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !58, !taffo.constinfo !59
...
!7 = !{double 0.000000e+00, double 0x406E222220BC382A}
...
!50 = !{double 0x40011110E453D20F, double 0x406E222220BC382A}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 3.200000e+00, double 0x407011112018A43C}
!53 = !{i32 1}
!54 = !{i32 2}
...
!115 = !{double 0x40111110E453D20F, double 0x407E222220BC382A}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0x40199999567DBB16, double 0x40869999988D2A20}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0x40211110E453D20F, double 0x408E222220BC382A}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x402555551D68C693, double 0x4092D5555475A31A}
!122 = !{i32 9}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x40011110E8981648, double 0x406E22222844C0B2}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 6.400000e+00, double 0x408011112018A43C}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4023333333333334, double 0x40881999B024F65A}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 1.280000e+01, double 0x409011112018A43C}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 1.600000e+01, double 0x40941555681ECD4B}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0x40099999A0000000, double 0x40701111241CE884}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
...
!170 = !{double 0x40411110E453D20F, double 0x40AE222220BC382A}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
!173 = !{i32 1, !97, i32 1, !97, i32 1, !51, i32 1, !167}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double 5.120000e+01, double 0x40B011112018A43C}
!176 = distinct !{!176, !29}
!177 = distinct !{!177, !29}
