; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-64-fixed-24.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 10), !taffo.info !92
  %mul.u21_11fixp = shl i32 %4, 1, !taffo.info !95
  %arrayidx1.u15_17fixp = getelementptr inbounds i32, i32* %val.u15_17fixp, i32 %i.0, !taffo.info !51
  %5 = shl i32 %mul.u21_11fixp, 6, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !105 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !106
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !109
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !48
  %5 = shl i32 %mul.u12_20fixp, 6, !taffo.info !109
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !106
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !109
  ...
  %7 = shl i32 %mul.u12_20fixp, 6, !taffo.info !109
...
!93 = !{!"fixp", i32 -32, i32 10}
!94 = !{double 0.000000e+00, double 0x4131A00000000000}
!95 = !{!96, !94, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 11}
!97 = distinct !{!97, !23}
...
!108 = !{double 0.000000e+00, double 3.840000e+03}
