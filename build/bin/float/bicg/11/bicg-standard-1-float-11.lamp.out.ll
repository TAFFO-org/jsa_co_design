; ModuleID = './build/bin/float/bicg/11/bicg-standard-1-float-11.out.ll'
...
entry:
  ...
  call void @kernel_bicg(i32 noundef %2, i32 noundef %3, ptr noundef %arraydecay5, ptr noundef %arraydecay6, ptr noundef %arraydecay7, ptr noundef %arraydecay8, ptr noundef %arraydecay9)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx10 = getelementptr inbounds [20 x float], ptr @s_float, i32 0, i32 %8
...
for.body14:                                       ; preds = %for.cond12
  ...
  %arrayidx15 = getelementptr inbounds [22 x float], ptr %q, i32 0, i32 %12
  %13 = load float, ptr %arrayidx15, align 4
  %14 = load i32, ptr %i11, align 4
  %arrayidx16 = getelementptr inbounds [22 x float], ptr @q_float, i32 0, i32 %14
