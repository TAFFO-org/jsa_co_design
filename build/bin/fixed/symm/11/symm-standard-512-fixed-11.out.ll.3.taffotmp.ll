; ModuleID = './build/bin/fixed/symm/11/symm-standard-512-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,11207209.0) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [42 x i8] c"scalar(range(-511488.0,921.599976) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [38 x i8] c"scalar(range(51.200001,1280.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.initweight !59, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 512), !taffo.initweight !59, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 512), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 512), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 512), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !122 !taffo.sourceFunction !62 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3(i32 noundef %m, i32 noundef %n, float noundef %alpha, float noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !123 !taffo.funinfo !124 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %temp2.0 = phi float [ 0.000000e+00, %for.body3 ], [ %add18, %for.inc ], !taffo.info !125
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !127, !taffo.info !57
  %0 = load float, float* %arrayidx7, align 4, !taffo.initweight !128, !taffo.info !57
  %mul = fmul float %alpha, %0, !taffo.initweight !95, !taffo.info !129
  %arrayidx8 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !95, !taffo.info !55
  %arrayidx9 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx8, i32 0, i32 %k.0, !taffo.initweight !127, !taffo.info !55
  %1 = load float, float* %arrayidx9, align 4, !taffo.initweight !128, !taffo.info !55
  %mul10 = fmul float %mul, %1, !taffo.initweight !127, !taffo.info !131
  %arrayidx11 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %k.0, !taffo.initweight !95, !taffo.info !53
  %arrayidx12 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx11, i32 0, i32 %j.0, !taffo.initweight !127, !taffo.info !53
  %2 = load float, float* %arrayidx12, align 4, !taffo.initweight !128, !taffo.info !53
  %add = fadd float %2, %mul10, !taffo.initweight !128, !taffo.info !133
  store float %add, float* %arrayidx12, align 4, !taffo.initweight !128, !taffo.info !53
  %arrayidx13 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %k.0, !taffo.initweight !95, !taffo.info !57
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.initweight !127, !taffo.info !57
  %3 = load float, float* %arrayidx14, align 4, !taffo.initweight !128, !taffo.info !57
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !95, !taffo.info !55
  %arrayidx16 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx15, i32 0, i32 %k.0, !taffo.initweight !127, !taffo.info !55
  %4 = load float, float* %arrayidx16, align 4, !taffo.initweight !128, !taffo.info !55
  %mul17 = fmul float %3, %4, !taffo.initweight !135, !taffo.info !136
  %add18 = fadd float %temp2.0, %mul17, !taffo.initweight !137, !taffo.info !136
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  ...
  %arrayidx20 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx19, i32 0, i32 %j.0, !taffo.initweight !127, !taffo.info !53
  %5 = load float, float* %arrayidx20, align 4, !taffo.initweight !128, !taffo.info !53
  %mul21 = fmul float %beta, %5, !taffo.initweight !95, !taffo.info !139
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !95, !taffo.info !57
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.0, !taffo.initweight !127, !taffo.info !57
  %6 = load float, float* %arrayidx23, align 4, !taffo.initweight !128, !taffo.info !57
  %mul24 = fmul float %alpha, %6, !taffo.initweight !95, !taffo.info !129
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !95, !taffo.info !55
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %i.0, !taffo.initweight !127, !taffo.info !55
  %7 = load float, float* %arrayidx26, align 4, !taffo.initweight !128, !taffo.info !55
  %mul27 = fmul float %mul24, %7, !taffo.initweight !127, !taffo.info !131
  %add28 = fadd float %mul21, %mul27, !taffo.initweight !127, !taffo.info !141
  %mul29 = fmul float %alpha, %temp2.0, !taffo.initweight !95, !taffo.info !143
  %add30 = fadd float %add28, %mul29, !taffo.initweight !127, !taffo.info !145
  %arrayidx31 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.initweight !95, !taffo.info !53
  %arrayidx32 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx31, i32 0, i32 %j.0, !taffo.initweight !127, !taffo.info !53
  store float %add30, float* %arrayidx32, align 4, !taffo.initweight !128, !taffo.info !49
  br label %for.inc33
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %m, i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !149 !taffo.funinfo !124 !taffo.sourceFunction !60 {
entry:
...
for.cond:                                         ; preds = %for.inc15, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc16, %for.inc15 ], !taffo.initweight !48, !taffo.info !150
  %cmp = icmp slt i32 %i.0, %m, !taffo.initweight !64, !taffo.info !151
  br i1 %cmp, label %for.body, label %for.end17, !taffo.initweight !65, !taffo.info !92
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !152
  %cmp4 = icmp slt i32 %j.0, %n, !taffo.initweight !64, !taffo.info !151
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !65, !taffo.info !93

for.body5:                                        ; preds = %for.cond3
  %add = add nsw i32 %i.0, %j.0, !taffo.initweight !64, !taffo.info !154
  %rem = srem i32 %add, 100, !taffo.initweight !65, !taffo.info !154, !taffo.constinfo !27
  %conv = sitofp i32 %rem to float, !taffo.initweight !76, !taffo.info !154
  %conv6 = sitofp i32 %m to float, !taffo.info !22
  %div = fdiv float %conv, %conv6, !taffo.initweight !95, !taffo.info !156
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.initweight !64, !taffo.info !158
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !158
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !65, !taffo.info !96
  %add8 = add nsw i32 %n, %i.0, !taffo.initweight !64, !taffo.info !159
  %sub = sub nsw i32 %add8, %j.0, !taffo.initweight !64, !taffo.info !154
  %rem9 = srem i32 %sub, 100, !taffo.initweight !65, !taffo.info !154, !taffo.constinfo !27
  %conv10 = sitofp i32 %rem9 to float, !taffo.initweight !76, !taffo.info !154
  %conv11 = sitofp i32 %m to float, !taffo.info !22
  %div12 = fdiv float %conv10, %conv11, !taffo.initweight !95, !taffo.info !156
  %arrayidx13 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !64, !taffo.info !161
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !161
  store float %div12, float* %arrayidx14, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %i.0, 1, !taffo.initweight !64, !taffo.info !165, !taffo.constinfo !27
...
for.cond18:                                       ; preds = %for.inc46, %for.end17
  %i.1 = phi i32 [ 0, %for.end17 ], [ %inc47, %for.inc46 ], !taffo.initweight !48, !taffo.info !150
  %cmp19 = icmp slt i32 %i.1, %m, !taffo.initweight !64, !taffo.info !151
  br i1 %cmp19, label %for.body21, label %for.end48, !taffo.initweight !65, !taffo.info !92
...
for.cond22:                                       ; preds = %for.inc33, %for.body21
  %j.1 = phi i32 [ 0, %for.body21 ], [ %inc34, %for.inc33 ], !taffo.initweight !48, !taffo.info !152
  %cmp23 = icmp sle i32 %j.1, %i.1, !taffo.initweight !64, !taffo.info !151
  br i1 %cmp23, label %for.body25, label %for.end35, !taffo.initweight !65, !taffo.info !92

for.body25:                                       ; preds = %for.cond22
  %add26 = add nsw i32 %i.1, %j.1, !taffo.initweight !64, !taffo.info !154
  %rem27 = srem i32 %add26, 100, !taffo.initweight !65, !taffo.info !154, !taffo.constinfo !27
  %conv28 = sitofp i32 %rem27 to float, !taffo.initweight !76, !taffo.info !154
  %conv29 = sitofp i32 %m to float, !taffo.info !22
  %div30 = fdiv float %conv28, %conv29, !taffo.initweight !95, !taffo.info !156
  %arrayidx31 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.initweight !64, !taffo.info !167
  %arrayidx32 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx31, i32 0, i32 %j.1, !taffo.initweight !64, !taffo.info !167
  store float %div30, float* %arrayidx32, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc33

for.inc33:                                        ; preds = %for.body25
  %inc34 = add nsw i32 %j.1, 1, !taffo.initweight !64, !taffo.info !162, !taffo.constinfo !27
  br label %for.cond22, !llvm.loop !168

for.end35:                                        ; preds = %for.cond22
  %add36 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !165, !taffo.constinfo !27
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc43, %for.end35
  %j.2 = phi i32 [ %add36, %for.end35 ], [ %inc44, %for.inc43 ], !taffo.initweight !48, !taffo.info !152
  %cmp38 = icmp slt i32 %j.2, %m, !taffo.initweight !64, !taffo.info !151
  br i1 %cmp38, label %for.body40, label %for.end45, !taffo.initweight !65, !taffo.info !93

for.body40:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.initweight !64, !taffo.info !167
  %arrayidx42 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx41, i32 0, i32 %j.2, !taffo.initweight !64, !taffo.info !167
  store float -9.990000e+02, float* %arrayidx42, align 4, !taffo.initweight !65, !taffo.info !96, !taffo.constinfo !100
  br label %for.inc43

for.inc43:                                        ; preds = %for.body40
  %inc44 = add nsw i32 %j.2, 1, !taffo.initweight !64, !taffo.info !162, !taffo.constinfo !27
...
for.inc46:                                        ; preds = %for.end45
  %inc47 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !165, !taffo.constinfo !27
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !127, !taffo.info !53
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !128, !taffo.info !53
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !135, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !120
  %mul = fmul float %1, %conv, !taffo.initweight !137, !taffo.info !173
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !127, !taffo.info !53
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !128, !taffo.info !53
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !177 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !114
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !127, !taffo.info !55
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !128, !taffo.info !55
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !135, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !120
  %mul = fmul float %1, %conv, !taffo.initweight !137, !taffo.info !178
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !127, !taffo.info !55
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !128, !taffo.info !55
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !182 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !114
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !127, !taffo.info !57
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !128, !taffo.info !57
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !135, !taffo.info !57
  %conv = sitofp i32 %factor to float, !taffo.info !120
  %mul = fmul float %1, %conv, !taffo.initweight !137, !taffo.info !183
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !127, !taffo.info !57
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !128, !taffo.info !57
...
!7 = !{double 0.000000e+00, double 0x4165604520000000}
...
!56 = !{double -5.114880e+05, double 0x408CCCCCC0379314}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0x40499999A1FD156A, double 1.280000e+03}
!59 = !{i32 1}
...
!117 = distinct !{!117, !29}
!118 = !{i32 1, i32 -1}
!119 = !{i32 1, !49, i32 1, !120}
!120 = !{i1 false, !121, i1 false, i2 0}
!121 = !{double 5.120000e+02, double 5.120000e+02}
!122 = !{i32 1, !51, i32 1, !120}
!123 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!124 = !{i32 1, !22, i32 1, !110, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55, i32 1, !57}
!125 = !{i1 false, !126, i1 false, i2 0}
!126 = !{double 0xC1C3830000000000, double 0x4131FFFFF822BBEC}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x40533333397DD010, double 1.920000e+03}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0xC1CD448000000000, double 0x413AFFFFF43419E3}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0xC1CD448000000000, double 0x4168C0451E86833C}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x4169A6B959999999}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0xC1CD448000000000, double 0x416D06B958201CD5}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC1CD448000000000, double 0x413AFFFFF43419E2}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0xC1DD448000000000, double 0x4170335CAB535009}
!147 = distinct !{!147, !29}
!148 = distinct !{!148, !29}
!149 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!150 = !{i1 false, !71, i1 false, i2 1}
!151 = !{i1 false, !73, i1 false, i2 1}
!152 = !{i1 false, !153, i1 false, i2 1}
!153 = !{double 0.000000e+00, double 1.700000e+01}
!154 = !{i1 false, !155, i1 false, i2 1}
!155 = !{double 0.000000e+00, double 2.600000e+01}
!156 = !{i1 false, !157, i1 false, i2 1}
!157 = !{double 0.000000e+00, double 2.600000e+00}
!158 = !{i1 false, !7, i1 false, i2 1}
!159 = !{i1 false, !160, i1 false, i2 1}
!160 = !{double 1.600000e+01, double 2.600000e+01}
!161 = !{i1 false, !58, i1 false, i2 1}
!162 = !{i1 false, !163, i1 false, i2 1}
!163 = !{double 1.000000e+00, double 1.700000e+01}
!164 = distinct !{!164, !29}
!165 = !{i1 false, !81, i1 false, i2 1}
!166 = distinct !{!166, !29}
!167 = !{i1 false, !56, i1 false, i2 1}
!168 = distinct !{!168, !29}
!169 = distinct !{!169, !29}
!170 = distinct !{!170, !29}
!171 = !{i32 -1, i32 -1, i32 3, i32 -1}
!172 = !{i32 1, !22, i32 1, !110, i32 1, !53, i32 1, !120}
!173 = !{i1 false, !174, i1 false, i2 -1}
!174 = !{double 0.000000e+00, double 0x41F5604520000000}
!175 = distinct !{!175, !29}
!176 = distinct !{!176, !29}
!177 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !120}
!178 = !{i1 false, !179, i1 false, i2 -1}
!179 = !{double 0xC1AF380000000000, double 0x411CCCCCC0379314}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
!182 = !{i32 1, !22, i32 1, !110, i32 1, !57, i32 1, !120}
!183 = !{i1 false, !184, i1 false, i2 -1}
!184 = !{double 0x40D99999A1FD156A, double 6.553600e+05}
!185 = distinct !{!185, !29}
!186 = distinct !{!186, !29}
