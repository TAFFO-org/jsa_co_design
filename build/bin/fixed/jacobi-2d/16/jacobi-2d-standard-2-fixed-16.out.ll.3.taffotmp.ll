; ModuleID = './build/bin/fixed/jacobi-2d/16/jacobi-2d-standard-2-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [52 x i8] c"target('A') scalar(range(0.266667,30.133333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(0.4,32.133335) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 2), !taffo.initweight !57, !taffo.target !48, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 2), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !58, !taffo.constinfo !59
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !122, !taffo.info !114
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !169 !taffo.sourceFunction !58 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !122, !taffo.info !127
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
...
!7 = !{double 0.000000e+00, double 0x403E22221C8A7A42}
...
!50 = !{double 2.666670e-01, double 0x403E22221C8A7A42}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 4.000000e-01, double 0x404011111F0C34C2}
!53 = !{i32 1}
!54 = !{i32 2}
...
!115 = !{double 5.333340e-01, double 0x404E22221C8A7A42}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0x3FE9999BB2788DB0, double 0x405699999567DBB2}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0x3FF1111276FB0920, double 0x405E22221C8A7A42}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x3FF5555714B9CB68, double 0x4062D55551D68C69}
!122 = !{i32 9}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x3FD111127B3F4DBE, double 0x403E2222241302C9}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 8.000000e-01, double 0x405011111F0C34C2}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x3FF3333333333334, double 0x40581999AE924F23}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 1.600000e+00, double 0x406011111F0C34C2}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 2.000000e+00, double 0x4064155566CF41F2}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0x3FD99999A0000000, double 0x4040111123107909}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
...
!166 = !{i32 1, !97, i32 1, !97, i32 1, !49, i32 1, !25}
!167 = distinct !{!167, !29}
!168 = distinct !{!168, !29}
!169 = !{i32 1, !97, i32 1, !97, i32 1, !51, i32 1, !25}
!170 = distinct !{!170, !29}
!171 = distinct !{!171, !29}
