...
@.str.2 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,256.0) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [46 x i8] c"target('B') scalar(range(0.0,341136.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A2, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 116, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 256)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 256)
