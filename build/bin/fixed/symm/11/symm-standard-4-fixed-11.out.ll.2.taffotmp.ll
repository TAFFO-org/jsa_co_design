; ModuleID = './build/bin/fixed/symm/11/symm-standard-4-fixed-11.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,688.320007) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [33 x i8] c"scalar(range(-3996.0,7.2) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.4,10.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 4), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 4), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 4), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
...
!35 = !{double 0.000000e+00, double 0x4085828F5FD47BEE}
!36 = !{!"C"}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double -3.996000e+03, double 7.200000e+00}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 4.000000e-01, double 1.000000e+01}
!41 = !{i32 1}
