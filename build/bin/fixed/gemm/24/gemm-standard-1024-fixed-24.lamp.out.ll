; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-1024-fixed-24.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u23_9fixp, [16 x i32]* noundef %A.u10_22fixp, [12 x i32]* noundef %B.u10_22fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u23_9fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u23_9fixp, i32 %i.0, !taffo.info !124
  %arrayidx7.u23_9fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u23_9fixp, i32 0, i32 %j.0, !taffo.info !124
  %3 = lshr i32 %div.u1_31fixp, 22, !taffo.info !122
  store i32 %3, i32* %arrayidx7.u23_9fixp, align 4, !taffo.info !125
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u10_22fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u10_22fixp, i32 %i.1, !taffo.info !141
  %arrayidx26.u10_22fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u10_22fixp, i32 0, i32 %j.1, !taffo.info !141
  %8 = lshr i32 %div24.u1_31fixp, 9, !taffo.info !140
  store i32 %8, i32* %arrayidx26.u10_22fixp, align 4, !taffo.info !125
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx47.u10_22fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u10_22fixp, i32 %i.2, !taffo.info !154
  %arrayidx48.u10_22fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u10_22fixp, i32 0, i32 %j.2, !taffo.info !154
  %12 = lshr i32 %div46.u1_31fixp, 9, !taffo.info !153
  store i32 %12, i32* %arrayidx48.u10_22fixp, align 4, !taffo.info !125
  br label %for.inc49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u23_9fixp, [16 x i32]* noundef %A.u10_22fixp, [12 x i32]* noundef %B.u10_22fixp) #0 !taffo.initweight !157 !taffo.funinfo !92 !taffo.sourceFunction !158 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 8), !taffo.info !159
  %mul.u23_9fixp = shl i32 %3, 1, !taffo.info !162
...
for.body10:                                       ; preds = %for.cond8
  ...
  %u10_22fixp = load i32, i32* %arrayidx12.u10_22fixp, align 4, !taffo.info !164
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u10_22fixp, 1, !taffo.info !164
  %6 = ashr i32 %4, 9, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !164
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 20), !taffo.info !166
  %mul13.u11_21fixp = shl i32 %8, 1, !taffo.info !169
  ...
  %9 = lshr i32 %mul13.u11_21fixp, 1, !taffo.info !169
  %10 = lshr i32 %u10_22fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 12, !taffo.info !169
  %12 = ashr i32 %10, 13, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 8), !taffo.info !170
  %mul16.u23_9fixp = shl i32 %13, 1, !taffo.info !172
  ...
  %add.u23_9fixp = add i32 %u23_9fixp1, %mul16.u23_9fixp, !taffo.info !173
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 11), !taffo.info !182
  %mul.u20_12fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u20_12fixp, 10, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !189 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !181
  ...
  %6 = fmul float 5.120000e+02, %lampsim15, !taffo.info !190
...
!161 = !{double 0.000000e+00, double 0x415E0126E6666666}
!162 = !{!48, !161, i1 false, i2 -1}
!163 = distinct !{!163, !23}
!164 = !{!165, !52, i1 false, i2 -1}
!165 = !{!"fixp", i32 32, i32 21}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 -32, i32 20}
!168 = !{double 0.000000e+00, double 1.440000e+03}
!169 = !{!165, !168, i1 false, i2 -1}
!170 = !{!160, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 0x4134A000077EE4E3}
!172 = !{!48, !171, i1 false, i2 -1}
!173 = !{!48, !174, i1 false, i2 -1}
!174 = !{double 0.000000e+00, double 0x415E28F5C1DFB939}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = distinct !{!177, !23}
...
!183 = !{!"fixp", i32 -32, i32 11}
!184 = !{double 0.000000e+00, double 9.830400e+05}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 12}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
!189 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
!190 = !{!191, !192, i1 false, i2 -1}
!191 = !{!"float", i32 1, double 0x41F900F5C0000000}
!192 = !{double 0.000000e+00, double 0x41F900F5C0000000}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
