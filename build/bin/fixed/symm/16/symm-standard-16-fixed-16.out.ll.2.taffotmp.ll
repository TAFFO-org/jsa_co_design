; ModuleID = './build/bin/fixed/symm/16/symm-standard-16-fixed-16.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [50 x i8] c"target('C') scalar(range(0.0,10961.280273) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [40 x i8] c"scalar(range(-15984.0,28.799999) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(1.6,40.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.initweight !41, !taffo.info !30, !taffo.originalCall !43
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 16), !taffo.initweight !41, !taffo.info !32, !taffo.originalCall !43
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 16), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 16), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 16), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
...
!35 = !{double 0.000000e+00, double 0x40C568A3DFFC547A}
!36 = !{!"C"}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double -1.598400e+04, double 0x403CCCCCBC05D52C}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 1.600000e+00, double 4.000000e+01}
!41 = !{i32 1}
