; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-512-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s13_19fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 19), !taffo.info !88
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s13_19fixp, 9, !taffo.info !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !92 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 10), !taffo.info !93
  %mul.u21_11fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u12_20fixp = getelementptr inbounds i32, i32* %val.u12_20fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u21_11fixp, 9, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u13_19fixp, i32* noundef %b.u12_20fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u12_20fixp) #0 !taffo.initweight !99 !taffo.funinfo !100 !taffo.sourceFunction !101 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u13_19fixp = load i32, i32* %arrayidx5.u13_19fixp, align 4, !taffo.info !102
  %0 = shl i32 %u13_19fixp, 4, !taffo.info !102
  br label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s26_6fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 6), !taffo.info !105
  %5 = ashr i32 %w.0.s9_23fixp, 17, !taffo.info !102
  %sub.s26_6fixp = sub i32 %5, %mul.s26_6fixp, !taffo.info !108
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s26_6fixp, 17, !taffo.info !108
...
for.end:                                          ; preds = %for.cond6
  ...
  %u13_19fixp11 = load i32, i32* %arrayidx14.u13_19fixp, align 4, !taffo.info !111
  %7 = lshr i32 %u13_19fixp11, 1, !taffo.info !111
  %8 = ashr i32 %w.0.s9_23fixp, 5, !taffo.info !102
  %div.s14_18fixp = call i32 @llvm.sdiv.fix.i32(i32 %8, i32 %7, i32 18), !taffo.info !113
  ...
  %9 = shl i32 %div.s14_18fixp, 1, !taffo.info !113
  store i32 %9, i32* %arrayidx16.u13_19fixp, align 4, !taffo.info !115
  br label %for.inc17
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u13_19fixp12 = load i32, i32* %arrayidx24.u13_19fixp, align 4, !taffo.info !102
  %10 = shl i32 %u13_19fixp12, 4, !taffo.info !102
  br label %for.cond25
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s26_6fixp = call i32 @llvm.smul.fix.i32(i32 %13, i32 %14, i32 6), !taffo.info !105
  %15 = ashr i32 %w.1.s9_23fixp, 17, !taffo.info !102
  %sub33.s26_6fixp = sub i32 %15, %mul32.s26_6fixp, !taffo.info !108
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %16 = shl i32 %sub33.s26_6fixp, 17, !taffo.info !108
...
for.end36:                                        ; preds = %for.cond25
  ...
  %17 = ashr i32 %w.1.s9_23fixp, 4, !taffo.info !102
  store i32 %17, i32* %arrayidx38.u13_19fixp, align 4, !taffo.info !115
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u12_20fixp = load i32, i32* %arrayidx48.u12_20fixp, align 4, !taffo.info !102
  %18 = shl i32 %u12_20fixp, 3, !taffo.info !102
  br label %for.cond49
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s25_7fixp = call i32 @llvm.smul.fix.i32(i32 %21, i32 %22, i32 7), !taffo.info !120
  %23 = ashr i32 %w.2.s9_23fixp, 16, !taffo.info !102
  %sub56.s25_7fixp = sub i32 %23, %mul55.s25_7fixp, !taffo.info !123
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !76, !taffo.constinfo !21
  %24 = shl i32 %sub56.s25_7fixp, 16, !taffo.info !123
...
for.end59:                                        ; preds = %for.cond49
  ...
  %25 = ashr i32 %w.2.s9_23fixp, 3, !taffo.info !102
  store i32 %25, i32* %arrayidx60.u12_20fixp, align 4, !taffo.info !115
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u12_20fixp8 = load i32, i32* %arrayidx68.u12_20fixp, align 4, !taffo.info !102
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %26 = shl i32 %u12_20fixp8, 3, !taffo.info !102
  br label %for.cond69
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s16_16fixp = call i32 @llvm.smul.fix.i32(i32 %28, i32 %29, i32 16), !taffo.info !133
  %30 = ashr i32 %w.3.s9_23fixp, 7, !taffo.info !102
  %sub76.s16_16fixp = sub i32 %30, %mul75.s16_16fixp, !taffo.info !136
  br label %for.inc77

for.inc77:                                        ; preds = %for.body71
  %inc78 = add nsw i32 %j.3, 1, !taffo.info !138, !taffo.constinfo !21
  %31 = shl i32 %sub76.s16_16fixp, 7, !taffo.info !136
...
for.end79:                                        ; preds = %for.cond69
  ...
  %u13_19fixp17 = load i32, i32* %arrayidx81.u13_19fixp, align 4, !taffo.info !111
  %32 = lshr i32 %u13_19fixp17, 1, !taffo.info !111
  %33 = ashr i32 %w.3.s9_23fixp, 5, !taffo.info !102
  %div82.s14_18fixp = call i32 @llvm.sdiv.fix.i32(i32 %33, i32 %32, i32 18), !taffo.info !113
  %arrayidx83.s4_28fixp = getelementptr inbounds i32, i32* %x.s4_28fixp, i32 %i.2, !taffo.info !50
  %34 = shl i32 %div82.s14_18fixp, 10, !taffo.info !113
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 6), !taffo.info !105
...
!89 = !{!"fixp", i32 -32, i32 19}
!90 = !{double 0xC0336DCA07F66E87, double 0x409FFCF893FAF428}
!91 = distinct !{!91, !23}
!92 = !{i32 1, !74, i32 1, !47, i32 1, !83}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 10}
!95 = !{double 0x41301999A005C465, double 0x4132000000000000}
!96 = !{!97, !95, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 11}
!98 = distinct !{!98, !23}
...
!106 = !{!"fixp", i32 -32, i32 6}
!107 = !{double 0x3F847AE147AE147C, double 0x4170B28B463B78B0}
!108 = !{!106, !109, i1 false, i2 -1}
!109 = !{double 0xC170B297C63B78B0, double 1.999900e+02}
!110 = distinct !{!110, !23}
!111 = !{!112, !44, i1 false, i2 -1}
!112 = !{!"fixp", i32 -32, i32 18}
...
!121 = !{!"fixp", i32 -32, i32 7}
!122 = !{double 0.000000e+00, double 0x41607278CFF25395}
!123 = !{!121, !124, i1 false, i2 -1}
!124 = !{double 0xC1607291CFF25395, double 2.000000e+02}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
...
!134 = !{!"fixp", i32 -32, i32 16}
!135 = !{double 0xC063D9094AED99C8, double 0x40D056C5CDD0C3A5}
!136 = !{!134, !137, i1 false, i2 -1}
!137 = !{double 0xC0D088C5CDD0C3A5, double 0x40766C84A576CCE4}
