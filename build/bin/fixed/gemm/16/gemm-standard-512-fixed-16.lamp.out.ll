; ModuleID = './build/bin/fixed/gemm/16/gemm-standard-512-fixed-16.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u21_11fixp, [16 x i32]* noundef %A.u9_23fixp, [12 x i32]* noundef %B.u9_23fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u21_11fixp, i32 %i.0, !taffo.info !124
  %arrayidx7.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u21_11fixp, i32 0, i32 %j.0, !taffo.info !124
  %3 = lshr i32 %div.u1_31fixp, 20, !taffo.info !122
  store i32 %3, i32* %arrayidx7.u21_11fixp, align 4, !taffo.info !125
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u9_23fixp, i32 %i.1, !taffo.info !141
  %arrayidx26.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u9_23fixp, i32 0, i32 %j.1, !taffo.info !141
  %8 = lshr i32 %div24.u1_31fixp, 8, !taffo.info !140
  store i32 %8, i32* %arrayidx26.u9_23fixp, align 4, !taffo.info !125
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx47.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u9_23fixp, i32 %i.2, !taffo.info !154
  %arrayidx48.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u9_23fixp, i32 0, i32 %j.2, !taffo.info !154
  %12 = lshr i32 %div46.u1_31fixp, 8, !taffo.info !153
  store i32 %12, i32* %arrayidx48.u9_23fixp, align 4, !taffo.info !125
  br label %for.inc49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u21_11fixp, [16 x i32]* noundef %A.u9_23fixp, [12 x i32]* noundef %B.u9_23fixp) #0 !taffo.initweight !157 !taffo.funinfo !92 !taffo.sourceFunction !158 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 10), !taffo.info !159
  %mul.u21_11fixp = shl i32 %3, 1, !taffo.info !162
...
for.body10:                                       ; preds = %for.cond8
  ...
  %u9_23fixp = load i32, i32* %arrayidx12.u9_23fixp, align 4, !taffo.info !164
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u9_23fixp, 1, !taffo.info !164
  %6 = ashr i32 %4, 8, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !164
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 21), !taffo.info !166
  %mul13.u10_22fixp = shl i32 %8, 1, !taffo.info !169
  ...
  %9 = lshr i32 %mul13.u10_22fixp, 1, !taffo.info !169
  %10 = lshr i32 %u9_23fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 11, !taffo.info !169
  %12 = ashr i32 %10, 12, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 10), !taffo.info !170
  %mul16.u21_11fixp = shl i32 %13, 1, !taffo.info !172
  ...
  %add.u21_11fixp = add i32 %u21_11fixp1, %mul16.u21_11fixp, !taffo.info !173
...
!161 = !{double 0.000000e+00, double 0x413E024DCCCCCCCC}
!162 = !{!48, !161, i1 false, i2 -1}
!163 = distinct !{!163, !23}
!164 = !{!165, !52, i1 false, i2 -1}
!165 = !{!"fixp", i32 32, i32 22}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 -32, i32 21}
!168 = !{double 0.000000e+00, double 7.200000e+02}
!169 = !{!165, !168, i1 false, i2 -1}
!170 = !{!160, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 0x4114A00007DD4413}
!172 = !{!48, !171, i1 false, i2 -1}
!173 = !{!48, !174, i1 false, i2 -1}
!174 = !{double 0.000000e+00, double 0x413E29EB81F75105}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = distinct !{!177, !23}
