...
entry:
  ...
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 125, i8* null)
  %B5 = bitcast [10 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B5, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 126, i8* null)
  ...
  call void @kernel_symm(i32 noundef %2, i32 noundef %3, float noundef %4, float noundef %5, [16 x float]* noundef %arraydecay8, [10 x float]* noundef %arraydecay9, [16 x float]* noundef %arraydecay10)
...
for.body13:                                       ; preds = %for.cond11
  ...
  %arrayidx = getelementptr inbounds [10 x [16 x float]], [10 x [16 x float]]* %C, i32 0, i32 %10
