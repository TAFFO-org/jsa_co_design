; ModuleID = './build/bin/fixed/symm/24/symm-standard-4-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,688.320007) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [33 x i8] c"scalar(range(-3996.0,7.2) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.4,10.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 4), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 4), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 4), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x4085828F5FD47BEE}
...
!56 = !{double -3.996000e+03, double 7.200000e+00}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 4.000000e-01, double 1.000000e+01}
!59 = !{i32 1}
...
!121 = !{double 4.000000e+00, double 4.000000e+00}
...
!126 = !{double -3.996000e+04, double 7.200000e+01}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x3FE3333333333334, double 1.500000e+01}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -5.994000e+04, double 1.080000e+02}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -5.994000e+04, double 0x4088E28F5FD47BEE}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x4089CFDF3FCBC7EA}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double -5.994000e+04, double 0x408D2FDF3FCBC7EA}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double -1.198800e+05, double 0x409047EF9FE5E3F5}
!145 = distinct !{!145, !29}
!146 = distinct !{!146, !29}
