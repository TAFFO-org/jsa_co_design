; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u10_22fixp = bitcast [10 x i32]* %arraydecay9.u10_22fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u10_22fixp, i32 1024), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u10_22fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %B.u10_22fixp, i32 0, i32 0, !taffo.info !53
  %u10_22fixp2 = bitcast [10 x i32]* %arraydecay10.u10_22fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u10_22fixp2, i32 1024), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay11.u23_9fixp, [10 x i32]* %arraydecay12.u10_22fixp, [10 x i32]* %arraydecay13.u10_22fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u23_9fixp, [10 x i32]* noundef %A.u10_22fixp, [10 x i32]* noundef %B.u10_22fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !93 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u23_9fixp = load i32, i32* %arrayidx4.u23_9fixp, align 4, !taffo.info !94
  %0 = lshr i32 %u23_9fixp, 1, !taffo.info !94
  %1 = lshr i32 %beta.u2_30fixp, 1, !taffo.info !45
  %2 = ashr i32 %0, 1, !taffo.info !94
  %3 = ashr i32 %1, 22, !taffo.info !45
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 7), !taffo.info !96
  %mul.u24_8fixp = shl i32 %4, 1, !taffo.info !99
  %5 = shl i32 %mul.u24_8fixp, 1, !taffo.info !99
...
for.body10:                                       ; preds = %for.cond8
  ...
  %6 = lshr i32 %u10_22fixp, 1, !taffo.info !101
  %7 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %8 = ashr i32 %6, 1, !taffo.info !101
  %9 = ashr i32 %7, 9, !taffo.info !42
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 20), !taffo.info !103
  %mul13.u11_21fixp = shl i32 %10, 1, !taffo.info !106
  ...
  %11 = lshr i32 %mul13.u11_21fixp, 1, !taffo.info !106
  %12 = lshr i32 %u10_22fixp3, 1, !taffo.info !53
  %13 = ashr i32 %11, 11, !taffo.info !106
  %14 = ashr i32 %12, 12, !taffo.info !53
  %15 = call i32 @llvm.smul.fix.i32(i32 %13, i32 %14, i32 9), !taffo.info !107
  %mul16.u22_10fixp = shl i32 %15, 1, !taffo.info !110
  ...
  %u10_22fixp4 = load i32, i32* %arrayidx18.u10_22fixp, align 4, !taffo.info !112
  %16 = lshr i32 %u10_22fixp4, 1, !taffo.info !112
  %17 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %18 = ashr i32 %16, 1, !taffo.info !112
  %19 = ashr i32 %17, 9, !taffo.info !42
  %20 = call i32 @llvm.smul.fix.i32(i32 %18, i32 %19, i32 20), !taffo.info !113
  %mul19.u11_21fixp = shl i32 %20, 1, !taffo.info !115
  ...
  %21 = lshr i32 %mul19.u11_21fixp, 1, !taffo.info !115
  %22 = lshr i32 %u10_22fixp2, 1, !taffo.info !50
  %23 = ashr i32 %21, 11, !taffo.info !115
  %24 = ashr i32 %22, 12, !taffo.info !50
  %25 = call i32 @llvm.smul.fix.i32(i32 %23, i32 %24, i32 9), !taffo.info !107
  %mul22.u22_10fixp = shl i32 %25, 1, !taffo.info !110
  %26 = lshr i32 %mul16.u22_10fixp, 2, !taffo.info !110
  %27 = lshr i32 %mul22.u22_10fixp, 2, !taffo.info !110
  %add.u24_8fixp = add i32 %26, %27, !taffo.info !116
  ...
  %u23_9fixp1 = load i32, i32* %arrayidx24.u23_9fixp, align 4, !taffo.info !94
  %28 = lshr i32 %u23_9fixp1, 1, !taffo.info !94
  %add25.u24_8fixp = add i32 %28, %add.u24_8fixp, !taffo.info !118
  %29 = shl i32 %add25.u24_8fixp, 1, !taffo.info !118
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u23_9fixp, [10 x i32]* noundef %A.u10_22fixp, [10 x i32]* noundef %B.u10_22fixp) #0 !taffo.initweight !123 !taffo.funinfo !92 !taffo.sourceFunction !124 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !156
  %arrayidx7.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u10_22fixp, i32 0, i32 %j.0, !taffo.info !156
  %4 = lshr i32 %div.u1_31fixp, 9, !taffo.info !154
  store i32 %4, i32* %arrayidx7.u10_22fixp, align 4, !taffo.info !157
  ...
  %arrayidx14.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u10_22fixp, i32 %i.0, !taffo.info !168
  %arrayidx15.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u10_22fixp, i32 0, i32 %j.0, !taffo.info !168
  %8 = lshr i32 %div13.u1_31fixp, 9, !taffo.info !167
  store i32 %8, i32* %arrayidx15.u10_22fixp, align 4, !taffo.info !157
  br label %for.inc
...
for.body26:                                       ; preds = %for.cond23
  ...
  %arrayidx33.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u23_9fixp, i32 %i.1, !taffo.info !180
  %arrayidx34.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx33.u23_9fixp, i32 0, i32 %j.1, !taffo.info !180
  %12 = lshr i32 %div32.u4_28fixp, 19, !taffo.info !179
  store i32 %12, i32* %arrayidx34.u23_9fixp, align 4, !taffo.info !157
  br label %for.inc35
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %3, 0x4140000000000000, !taffo.info !186
  ...
  %6 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !195
...
!97 = !{!"fixp", i32 -32, i32 7}
!98 = !{double 0.000000e+00, double 0x41629655F3333333}
...
!108 = !{!"fixp", i32 -32, i32 9}
!109 = !{double 0.000000e+00, double 0x41343FFFF727136A}
!110 = !{!111, !109, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 10}
!112 = !{!102, !54, i1 false, i2 -1}
!113 = !{!104, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 0x409599999029AE4F}
!115 = !{!102, !114, i1 false, i2 -1}
!116 = !{!95, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x41443FFFF727136A}
!118 = !{!95, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x41648D479DC9C4DA}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = distinct !{!122, !23}
