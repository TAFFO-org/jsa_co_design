; ModuleID = './build/stats/gemm/1024/gemm-standard-1024.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %3, i32 noundef 1024), !taffo.originalCall !29
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 1024), !taffo.originalCall !29
  ...
  call void @scale_2d.3(i32 noundef 16, i32 noundef 12, float* noundef %5, i32 noundef 1024), !taffo.originalCall !29
