; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-64-fixed-16.out.ll'
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u15_17fixp = load i32, i32* %arrayidx25.u15_17fixp, align 4, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !87 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u21_11fixp, 6, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !99 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !100
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !103
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !52
  %5 = shl i32 %mul.u12_20fixp, 6, !taffo.info !103
...
!95 = !{double 0.000000e+00, double 0x413B5D175FFE6D59}
