; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.info !66, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 1024), !taffo.info !71, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 1024), !taffo.info !73, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.info !77, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 1024), !taffo.info !78, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 1024), !taffo.info !79, !taffo.initweight !74, !taffo.constinfo !75, !taffo.target !60, !taffo.originalCall !76
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 1024), !taffo.info !80, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
...
!49 = !{!"fixp", i32 32, i32 9}
!50 = !{double 0.000000e+00, double 0x4152733320000000}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 32, i32 22}
!53 = !{double 0.000000e+00, double 8.960000e+02}
!54 = !{!52, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x408CCCCCC0379314}
!56 = !{!52, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x408DB6DB60285EC4}
!58 = !{!59, !1, i1 false, i2 -1}
!59 = !{!"float", i32 1, double 0x42132E6660000000}
!60 = !{!"D"}
...
!111 = !{double 1.024000e+03, double 1.024000e+03}
...
!124 = !{double 0.000000e+00, double 1.344000e+03}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4132E6665E247885}
!127 = !{!49, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x41572CCCB7891E21}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"float", i32 1, double 0x4217047AD9999999}
!134 = !{double 0.000000e+00, double 0x4217047AD9999999}
!135 = !{!136, !137, i1 false, i2 -1}
!136 = !{!"float", i32 1, double 0x41F121D4039CC303}
!137 = !{double 0.000000e+00, double 0x41F121D4039CC303}
!138 = !{i32 8}
!139 = !{!140, !141, i1 false, i2 -1}
!140 = !{!"float", i32 1, double 0x421776DB60E730C1}
!141 = !{double 0.000000e+00, double 0x421776DB60E730C1}
!142 = distinct !{!142, !23}
!143 = distinct !{!143, !23}
!144 = distinct !{!144, !23}
...
!222 = !{!"float", i32 1, double 0x41F2733320000000}
!223 = !{double 0.000000e+00, double 0x41F2733320000000}
!224 = !{i32 9}
!225 = distinct !{!225, !23}
!226 = distinct !{!226, !23}
...
!230 = !{double 0.000000e+00, double 9.175040e+05}
!231 = distinct !{!231, !23}
!232 = distinct !{!232, !23}
