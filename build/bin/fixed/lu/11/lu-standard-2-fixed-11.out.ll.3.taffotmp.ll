; ModuleID = './build/bin/fixed/lu/11/lu-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [47 x i8] c"target('A') scalar(range(0.1,16.344999) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.initweight !55, !taffo.info !48, !taffo.target !50, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40305851DABE2718}
...
!49 = !{double 1.000000e-01, double 0x40305851DABE2718}
!50 = !{!"A"}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x3F847AE147AE147C, double 0x4070B28B3B853C52}
!109 = !{i1 false, !110, i1 false, i2 1}
!110 = !{double 0xC070B0F1A1EBA2B8, double 0x403055C27E953155}
!111 = distinct !{!111, !29}
!112 = !{i32 8}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3F790F4567F495E0, double 0x40646E66516DB0DE}
!115 = distinct !{!115, !29}
!116 = distinct !{!116, !29}
!117 = distinct !{!117, !29}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double 0.000000e+00, double 0x4070B28B3B853C52}
...
!150 = !{i32 1, !98, i32 1, !98, i32 1, !48, i32 1, !25}
!151 = !{i32 9}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 2.000000e-01, double 0x40405851DABE2718}
!154 = distinct !{!154, !29}
!155 = distinct !{!155, !29}
