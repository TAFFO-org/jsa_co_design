; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-1024-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.info !63, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 1024), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 1024), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 1024), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !59
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 1024), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.info !49, !taffo.initweight !59
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 1024), !taffo.info !70, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 1024), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !75, !taffo.target !57, !taffo.originalCall !76
...
for.body:                                         ; preds = %for.cond
  ...
  %div = fdiv float %conv, %conv3, !taffo.info !157, !taffo.initweight !141
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !49, !taffo.initweight !174
  %conv = sitofp i32 %factor to float, !taffo.info !103
  %mul = fmul float %1, %conv, !taffo.info !111, !taffo.initweight !175
...
!51 = !{double 0.000000e+00, double 9.600000e+02}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 9}
!54 = !{double 0.000000e+00, double 0x4151A00000000000}
!55 = !{!56, !1, i1 false, i2 -1}
!56 = !{!"fixp", i32 32, i32 8}
!57 = !{!"y"}
...
!98 = !{double 1.024000e+03, double 1.024000e+03}
...
!106 = !{!"float", i32 1, double 0x41F1A00000000000}
!107 = !{double 0.000000e+00, double 0x41F1A00000000000}
!108 = !{i32 7}
!109 = distinct !{!109, !23}
!110 = !{i32 1, !88, i32 1, !49, i32 1, !97}
!111 = !{!112, !113, i1 false, i2 -1}
!112 = !{!"fixp", i32 32, i32 12}
!113 = !{double 0.000000e+00, double 9.830400e+05}
!114 = distinct !{!114, !23}
...
!120 = !{double 0.000000e+00, double 9.216000e+05}
!121 = !{!53, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x4155240000000000}
!123 = !{!56, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4168686680000000}
!125 = distinct !{!125, !23}
!126 = !{!127, !128, i1 false, i2 -1}
!127 = !{!"fixp", i32 32, i32 7}
!128 = !{double 0.000000e+00, double 0x415A700000000000}
!129 = !{!127, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x416B2E1499999999}
!131 = !{!127, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 0x4174330A4CCCCCCC}
!133 = distinct !{!133, !23}
!134 = !{i32 1, !88, i32 1, !55, i32 1, !97}
!135 = !{!136, !137, i1 false, i2 -1}
!136 = !{!"float", i32 1, double 0x4206A66680000000}
!137 = !{double 0.000000e+00, double 0x4206A66680000000}
!138 = distinct !{!138, !23}
