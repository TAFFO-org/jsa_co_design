...
@.str.3 = private unnamed_addr constant [50 x i8] c"target('C') scalar(range(0.0,422999.03125) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,240.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(ptr %alpha, ptr @.str, ptr @.str.1, i32 110, ptr null)
  call void @llvm.var.annotation(ptr %beta, ptr @.str.2, ptr @.str.1, i32 111, ptr null)
  call void @llvm.var.annotation(ptr %C, ptr @.str.3, ptr @.str.1, i32 112, ptr null)
  call void @llvm.var.annotation(ptr %A, ptr @.str.4, ptr @.str.1, i32 113, ptr null)
  ...
  call void @init_array(i32 noundef %0, i32 noundef %1, ptr noundef %alpha, ptr noundef %beta, ptr noundef %arraydecay, ptr noundef %arraydecay1)
  call void @scale_scalar(ptr noundef %alpha, i32 noundef 256)
  call void @scale_scalar(ptr noundef %beta, i32 noundef 256)
  %arraydecay2 = getelementptr inbounds [16 x [16 x float]], ptr %C, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay2, i32 noundef 256)
  %arraydecay3 = getelementptr inbounds [16 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay3, i32 noundef 256)
  call void @timer_start()
  %2 = load i32, ptr %n, align 4
  %3 = load i32, ptr %m, align 4
  %4 = load float, ptr %alpha, align 4
  %5 = load float, ptr %beta, align 4
  %arraydecay4 = getelementptr inbounds [16 x [16 x float]], ptr %C, i32 0, i32 0
  %arraydecay5 = getelementptr inbounds [16 x [10 x float]], ptr %A, i32 0, i32 0
  call void @kernel_syrk(i32 noundef %2, i32 noundef %3, float noundef %4, float noundef %5, ptr noundef %arraydecay4, ptr noundef %arraydecay5)
...
for.body8:                                        ; preds = %for.cond6
  ...
  %13 = load i32, ptr %i, align 4
  %arrayidx10 = getelementptr inbounds [16 x [16 x float]], ptr @C_float, i32 0, i32 %13
...
entry:
  ...
  call void @llvm.var.annotation(ptr %i, ptr @.str.5, ptr @.str.1, i32 36, ptr null)
  call void @llvm.var.annotation(ptr %j, ptr @.str.6, ptr @.str.1, i32 37, ptr null)
...
for.body16:                                       ; preds = %for.cond13
  ...
  store float %div22, ptr %arrayidx24, align 4
  br label %for.inc25
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syrk(i32 noundef %n, i32 noundef %m, float noundef %alpha, float noundef %beta, ptr noundef %C, ptr noundef %A) #0 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body10:                                       ; preds = %for.cond8
  ...
  %16 = load i32, ptr %i, align 4
  %arrayidx11 = getelementptr inbounds [10 x float], ptr %15, i32 %16
  %17 = load i32, ptr %k, align 4
  %arrayidx12 = getelementptr inbounds [10 x float], ptr %arrayidx11, i32 0, i32 %17
  ...
  %23 = load ptr, ptr %C.addr, align 4
  %24 = load i32, ptr %i, align 4
  %arrayidx17 = getelementptr inbounds [16 x float], ptr %23, i32 %24
  %25 = load i32, ptr %j, align 4
  %arrayidx18 = getelementptr inbounds [16 x float], ptr %arrayidx17, i32 0, i32 %25
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef @.str.8, double noundef %conv)
  br label %for.inc
