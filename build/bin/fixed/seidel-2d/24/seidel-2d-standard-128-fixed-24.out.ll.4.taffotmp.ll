; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-128-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 128), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
!94 = !{double 2.560000e+01, double 0x40B40CCCBFF47736}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 18}
!98 = !{double 0x4043333333333334, double 0x40BE13331FEEB2D1}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 17}
!102 = !{double 5.120000e+01, double 0x40C40CCCBFF47736}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 6.400000e+01, double 0x40C90FFFEFF19504}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 1.152000e+02, double 0x40D68E6657F3061D}
...
!142 = !{!"fixp", i32 32, i32 24}
!143 = !{!144, !145, i1 false, i2 -1}
!144 = !{!"fixp", i32 32, i32 13}
!145 = !{double 1.638400e+03, double 0x41140CCCBFF47736}
!146 = !{i32 9}
!147 = distinct !{!147, !23}
!148 = distinct !{!148, !23}
