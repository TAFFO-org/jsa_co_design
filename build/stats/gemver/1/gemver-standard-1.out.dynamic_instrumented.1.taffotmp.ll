...
entry:
  ...
  call void @kernel_gemver(i32 noundef %1, float noundef %2, float noundef %3, [20 x float]* noundef %arraydecay20, float* noundef %arraydecay21, float* noundef %arraydecay22, float* noundef %arraydecay23, float* noundef %arraydecay24, float* noundef %arraydecay25, float* noundef %arraydecay26, float* noundef %arraydecay27, float* noundef %arraydecay28)
...
for.body:                                         ; preds = %for.cond
  ...
  store float %7, float* %arrayidx30, align 4
  ...
  store float %10, float* %arrayidx34, align 4
...
for.body37:                                       ; preds = %for.cond35
  ...
  store float %16, float* %arrayidx45, align 4
  br label %for.inc
