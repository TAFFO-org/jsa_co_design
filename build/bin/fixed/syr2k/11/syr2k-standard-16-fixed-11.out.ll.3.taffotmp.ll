; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-16-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,1997.759888) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 16), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 16), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 16), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div = fdiv float %conv, %conv6, !taffo.initweight !95, !taffo.info !149
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !64, !taffo.info !148
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !148
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !65, !taffo.info !96
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.initweight !64, !taffo.info !144
  %add9 = add nsw i32 %mul8, 2, !taffo.initweight !65, !taffo.info !151, !taffo.constinfo !27
  %rem10 = srem i32 %add9, %m, !taffo.initweight !76, !taffo.info !153
  %conv11 = sitofp i32 %rem10 to float, !taffo.initweight !94, !taffo.info !153
  %conv12 = sitofp i32 %m to float, !taffo.info !22
  %div13 = fdiv float %conv11, %conv12, !taffo.initweight !95, !taffo.info !155
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.0, !taffo.initweight !64, !taffo.info !157
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !157
  store float %div13, float* %arrayidx15, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !64, !taffo.info !158, !taffo.constinfo !27
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.initweight !64, !taffo.info !161, !taffo.constinfo !27
...
for.cond23:                                       ; preds = %for.inc35, %for.body22
  ...
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.initweight !64, !taffo.info !163
  br i1 %cmp24, label %for.body26, label %for.end37, !taffo.initweight !65, !taffo.info !93

for.body26:                                       ; preds = %for.cond23
  %mul27 = mul nsw i32 %i.1, %j.1, !taffo.initweight !64, !taffo.info !144
  %add28 = add nsw i32 %mul27, 3, !taffo.initweight !65, !taffo.info !164, !taffo.constinfo !27
  ...
  %div32 = fdiv float %conv30, %conv31, !taffo.initweight !95, !taffo.info !166
  %arrayidx33 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.initweight !64, !taffo.info !168
  %arrayidx34 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx33, i32 0, i32 %j.1, !taffo.initweight !64, !taffo.info !168
  store float %div32, float* %arrayidx34, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.initweight !64, !taffo.info !158, !taffo.constinfo !27
  br label %for.cond23, !llvm.loop !169

for.end37:                                        ; preds = %for.cond23
  br label %for.inc38

for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !161, !taffo.constinfo !27
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !107
  %mul = fmul float %1, %conv, !taffo.initweight !173, !taffo.info !174
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !178 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !107
  %mul = fmul float %1, %conv, !taffo.initweight !173, !taffo.info !179
  %2 = mul nsw i32 %i.0, %m, !taffo.info !111
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !171 !taffo.funinfo !183 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !107
  %mul = fmul float %1, %conv, !taffo.initweight !173, !taffo.info !184
  %2 = mul nsw i32 %i.0, %m, !taffo.info !111
...
!7 = !{double 0.000000e+00, double 0x409F370A2014727E}
...
!115 = distinct !{!115, !29}
!116 = !{i32 1, i32 -1}
!117 = !{i32 1, !49, i32 1, !107}
!118 = !{i32 1, !51, i32 1, !107}
...
!123 = !{double 0.000000e+00, double 0x40A2BA9FACD9117F}
!124 = distinct !{!124, !29}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 2.250000e+01}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 3.240000e+02}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 2.160000e+01}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 6.480000e+02}
!133 = !{i32 8}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x40A4AB85100A393F}
!136 = distinct !{!136, !29}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
...
!156 = !{double 0.000000e+00, double 9.000000e-01}
!157 = !{i1 false, !58, i1 false, i2 1}
!158 = !{i1 false, !159, i1 false, i2 1}
!159 = !{double 1.000000e+00, double 1.100000e+01}
!160 = distinct !{!160, !29}
!161 = !{i1 false, !81, i1 false, i2 1}
!162 = distinct !{!162, !29}
!163 = !{i1 false, !110, i1 false, i2 1}
!164 = !{i1 false, !165, i1 false, i2 1}
!165 = !{double 3.000000e+00, double 1.630000e+02}
!166 = !{i1 false, !167, i1 false, i2 1}
!167 = !{double 0.000000e+00, double 1.500000e+00}
!168 = !{i1 false, !7, i1 false, i2 1}
!169 = distinct !{!169, !29}
!170 = distinct !{!170, !29}
!171 = !{i32 -1, i32 -1, i32 3, i32 -1}
!172 = !{i32 1, !107, i32 1, !107, i32 1, !53, i32 1, !107}
!173 = !{i32 9}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double 0.000000e+00, double 0x40DF370A2014727E}
!176 = distinct !{!176, !29}
!177 = distinct !{!177, !29}
!178 = !{i32 1, !107, i32 1, !22, i32 1, !55, i32 1, !107}
!179 = !{i1 false, !180, i1 false, i2 -1}
!180 = !{double 0.000000e+00, double 2.400000e+02}
!181 = distinct !{!181, !29}
!182 = distinct !{!182, !29}
!183 = !{i32 1, !107, i32 1, !22, i32 1, !57, i32 1, !107}
!184 = !{i1 false, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 2.304000e+02}
!186 = distinct !{!186, !29}
!187 = distinct !{!187, !29}
