; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-256-fixed-11.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 4), !taffo.info !83
  %mul.u27_5fixp = shl i32 %4, 1, !taffo.info !86
  %arrayidx1.u19_13fixp = getelementptr inbounds i32, i32* %val.u19_13fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u27_5fixp, 8, !taffo.info !86
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !89 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u16_16fixp, 8, !taffo.info !93
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !90
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !93
  ...
  %7 = shl i32 %mul.u16_16fixp, 8, !taffo.info !93
...
!84 = !{!"fixp", i32 -32, i32 4}
!85 = !{double 0.000000e+00, double 0x41939CFFE0000000}
!86 = !{!87, !85, i1 false, i2 -1}
!87 = !{!"fixp", i32 32, i32 5}
!88 = distinct !{!88, !25}
!89 = !{i32 1, !67, i32 1, !44, i32 1, !78}
!90 = !{!91, !92, i1 false, i2 -1}
!91 = !{!"fixp", i32 -32, i32 15}
!92 = !{double 0.000000e+00, double 0x40EE6666601BC98A}
