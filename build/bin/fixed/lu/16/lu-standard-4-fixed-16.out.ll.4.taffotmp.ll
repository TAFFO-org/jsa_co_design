; ModuleID = './build/bin/fixed/lu/16/lu-standard-4-fixed-16.out.ll.3.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !144, !taffo.initweight !91
  %conv = sitofp i32 %factor to float, !taffo.info !146
  %mul = fmul float %1, %conv, !taffo.info !148, !taffo.initweight !150
...
for.inc:                                          ; preds = %for.body3
  %inc = add nsw i32 %j.0, 1, !taffo.info !69, !taffo.constinfo !21
  br label %for.cond1, !llvm.loop !151
...
!82 = !{!"fixp", i32 -32, i32 20}
!83 = !{double 0x3F847AE147AE147C, double 0x4090B28B4CA8D01D}
!84 = !{!82, !85, i1 false, i2 1}
!85 = !{double 0xC090B224E64269B7, double 0x4040570A350D2807}
!86 = !{i1 false, i1 false, i1 false, i2 1}
!87 = distinct !{!87, !23}
!88 = !{!89, !90, i1 false, i2 -1}
!89 = !{!"fixp", i32 32, i32 23}
!90 = !{double 0x3F690F455B182118, double 0x40746E665BEA0BA2}
!91 = !{i32 8}
!92 = distinct !{!92, !23}
!93 = distinct !{!93, !23}
!94 = distinct !{!94, !23}
...
!98 = !{double 0.000000e+00, double 0x4090B28B4CA8D01D}
...
!143 = !{double 4.000000e+00, double 4.000000e+00}
!144 = !{!145, !43, i1 false, i2 -1}
!145 = !{!"fixp", i32 32, i32 24}
!146 = !{!147, !143, i1 false, i2 1}
!147 = !{!"fixp", i32 32, i32 29}
!148 = !{!145, !149, i1 false, i2 -1}
!149 = !{double 4.000000e-01, double 0x40605851E321A2E8}
!150 = !{i32 9}
!151 = distinct !{!151, !23}
!152 = distinct !{!152, !23}
