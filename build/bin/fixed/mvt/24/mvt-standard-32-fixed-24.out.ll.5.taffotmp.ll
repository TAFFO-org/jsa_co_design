; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-32-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !83
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !86
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !44
  %5 = shl i32 %mul.u10_22fixp, 5, !taffo.info !86
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !89 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !90
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !93
  %arrayidx1.u13_19fixp = getelementptr inbounds i32, i32* %val.u13_19fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u18_14fixp, 5, !taffo.info !93
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !83
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !86
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !86
...
!85 = !{double 0.000000e+00, double 0x408E666666666666}
...
!92 = !{double 0.000000e+00, double 0x4103B4CCE0008638}
!93 = !{!94, !92, i1 false, i2 -1}
!94 = !{!"fixp", i32 32, i32 14}
!95 = distinct !{!95, !25}
