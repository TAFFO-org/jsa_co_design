; ModuleID = './build/bin/fixed/trmm/24/trmm-standard-4-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,4.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [42 x i8] c"target('B') scalar(range(0.0,85.5) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 4), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 4), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !151 !taffo.funinfo !157 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.inc:                                          ; preds = %for.body3
  %inc = add nsw i32 %j.0, 1, !taffo.info !93, !taffo.constinfo !27
  br label %for.cond1, !llvm.loop !158
...
!7 = !{double 0.000000e+00, double 8.550000e+01}
...
!52 = !{double 0.000000e+00, double 4.000000e+00}
...
!110 = !{double 4.000000e+00, double 4.000000e+00}
...
!118 = !{double 0.000000e+00, double 3.420000e+02}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 4.275000e+02}
!121 = distinct !{!121, !29}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 1.282500e+02}
!124 = distinct !{!124, !29}
!125 = distinct !{!125, !29}
...
!153 = !{i32 9}
!154 = !{i1 false, !85, i1 false, i2 -1}
!155 = distinct !{!155, !29}
!156 = distinct !{!156, !29}
!157 = !{i32 1, !22, i32 1, !103, i32 1, !53, i32 1, !109}
!158 = distinct !{!158, !29}
!159 = distinct !{!159, !29}
