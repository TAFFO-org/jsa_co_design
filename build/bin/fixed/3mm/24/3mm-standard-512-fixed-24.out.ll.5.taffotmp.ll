; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp3 = bitcast [14 x i32]* %arraydecay18.u7_25fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u7_25fixp3, i32 512), !taffo.info !67, !taffo.constinfo !63
  %arraydecay19.u7_25fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u7_25fixp, i32 0, i32 0, !taffo.info !54
  %u7_25fixp2 = bitcast [12 x i32]* %arraydecay19.u7_25fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u7_25fixp2, i32 512), !taffo.info !68, !taffo.constinfo !63
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u16_16fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !231 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u25_7fixp, 9, !taffo.info !240
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !251 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !252
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !254
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u16_16fixp, 9, !taffo.info !254
...
!239 = !{double 0.000000e+00, double 0x4170624DE0008638}
...
!247 = !{!"float", i32 1, double 0x427BCB0680000000}
!248 = !{double 0.000000e+00, double 0x427BCB0680000000}
!249 = distinct !{!249, !23}
!250 = distinct !{!250, !23}
!251 = !{i32 1, !87, i32 1, !16, i32 1, !44, i32 1, !232}
!252 = !{!119, !253, i1 false, i2 -1}
!253 = !{double 0.000000e+00, double 0x40E555556084A516}
