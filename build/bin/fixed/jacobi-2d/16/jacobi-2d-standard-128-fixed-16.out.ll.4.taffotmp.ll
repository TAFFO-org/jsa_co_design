; ModuleID = './build/bin/fixed/jacobi-2d/16/jacobi-2d-standard-128-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 128), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 128), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
!48 = !{double 2.560000e+01, double 0x40A011111FF7164C}
...
!96 = !{!"fixp", i32 32, i32 19}
!97 = !{double 0x40411111276FB092, double 0x40AE22221FF2E48F}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x40499999BB2788DB, double 0x40B6999997F62B6B}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 18}
!104 = !{double 0x40511111276FB092, double 0x40BE22221FF2E48F}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x40555555714B9CB6, double 0x40C2D55553F7CED9}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x403111112BB3F4DB, double 0x409E2222277B6D16}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 5.120000e+01, double 0x40B011111FF7164C}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x4053333333333334, double 0x40B81999AFF2A172}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 1.024000e+02, double 0x40C011111FF7164C}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 1.280000e+02, double 0x40C4155567F4DBDF}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x40399999A0000000, double 0x40A0111123FB5A94}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!173 = !{double 1.280000e+02, double 1.280000e+02}
!174 = !{!175, !173, i1 false, i2 1}
!175 = !{!"fixp", i32 32, i32 24}
!176 = !{!177, !178, i1 false, i2 -1}
!177 = !{!"fixp", i32 32, i32 14}
!178 = !{double 0x40A11111276FB092, double 0x410E22221FF2E48F}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !77, i32 1, !77, i32 1, !46, i32 1, !172}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 13}
!184 = !{double 3.276800e+03, double 0x411011111FF7164C}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
