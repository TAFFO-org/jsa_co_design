; ModuleID = './build/bin/float/syr2k/24/syr2k-standard-64-float-24.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay3, i32 noundef 64)
  %arraydecay4 = getelementptr inbounds [16 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay4, i32 noundef 64)
  %arraydecay5 = getelementptr inbounds [16 x [10 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay5, i32 noundef 64)
