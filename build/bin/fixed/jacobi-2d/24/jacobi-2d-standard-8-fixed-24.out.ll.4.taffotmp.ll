; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-8-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 8), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 8), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !175, !taffo.initweight !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !179 !taffo.sourceFunction !58 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !174
  %mul = fmul float %1, %conv, !taffo.info !180, !taffo.initweight !109
  %2 = mul nsw i32 %i.0, %m, !taffo.info !81
...
!48 = !{double 1.600000e+00, double 0x406011111F0C34C2}
...
!97 = !{double 0x400111116A8B8F15, double 0x406E222220BC382A}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x4009999A1FD156A0, double 0x40769999988D2A20}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 22}
!104 = !{double 0x401111116A8B8F15, double 0x407E222220BC382A}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x40155555C52E72DA, double 0x4082D5555475A31A}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x3FF111116ECFD36F, double 0x405E22222844C0B2}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 3.200000e+00, double 0x407011111F0C34C2}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x4013333333333334, double 0x40781999AE924F23}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 6.400000e+00, double 0x408011111F0C34C2}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 8.000000e+00, double 0x4084155566CF41F2}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x3FF99999A0000000, double 0x4060111123107909}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!173 = !{double 8.000000e+00, double 8.000000e+00}
!174 = !{!148, !173, i1 false, i2 1}
!175 = !{!103, !176, i1 false, i2 -1}
!176 = !{double 0x402111116A8B8F15, double 0x408E222220BC382A}
!177 = distinct !{!177, !23}
!178 = distinct !{!178, !23}
!179 = !{i32 1, !77, i32 1, !77, i32 1, !46, i32 1, !172}
!180 = !{!181, !182, i1 false, i2 -1}
!181 = !{!"fixp", i32 32, i32 21}
!182 = !{double 1.280000e+01, double 0x409011111F0C34C2}
!183 = distinct !{!183, !23}
!184 = distinct !{!184, !23}
