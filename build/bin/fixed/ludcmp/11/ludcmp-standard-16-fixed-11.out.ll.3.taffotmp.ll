; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-16-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.1,130.759995) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [37 x i8] c"scalar(range(16.0,130.759995) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [36 x i8] c"scalar(range(64.400002,72.0) final)\00", section "llvm.metadata", !taffo.info !0
...
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,64.400002) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 16), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 16), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !59, !taffo.info !53
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 16), !taffo.initweight !60, !taffo.info !53, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 16), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 16), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!50 = !{double 1.000000e-01, double 0x40605851E108C3F4}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 1.600000e+01, double 0x40605851E108C3F4}
!53 = !{i1 false, !54, i1 false, i2 -1}
!54 = !{double 0x40501999A1FD156A, double 7.200000e+01}
!55 = !{i1 false, !7, i1 false, i2 -1}
!56 = !{!"x"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x40501999A1FD156A}
!59 = !{i32 1}
!60 = !{i32 2}
...
!129 = !{double 1.600000e+01, double 1.600000e+01}
!130 = !{i32 7}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0x40901999A1FD156A, double 1.152000e+03}
!133 = distinct !{!133, !29}
!134 = !{i32 1, !123, i32 1, !55, i32 1, !128}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -6.071520e-01, double 0x404FFCF893FAF428}
!137 = distinct !{!137, !29}
!138 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!139 = !{i32 1, !123, i32 1, !49, i32 1, !53, i32 1, !55, i32 1, !57}
!140 = !{i32 8}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0x3F847AE147AE147C, double 0x40D0B28B485FEB29}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC0D0E48B485FEB29, double 1.999900e+02}
!145 = distinct !{!145, !29}
...
!153 = !{double 0.000000e+00, double 0x40C07278D3029BE1}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0xC0C0D678D3029BE1, double 2.000000e+02}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
...
!165 = !{double 0xC013D9094C33901E, double 0x408056C5CEDD19B7}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 0xC08696C5CEDD19B7, double 0x40699EC84A619C81}
...
!176 = !{double 0.000000e+00, double 0x40901999A1FD156A}
!177 = distinct !{!177, !29}
...
!215 = !{double 1.601000e+01, double 0x40D0D33BEC21FCB1}
!216 = distinct !{!216, !29}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = distinct !{!219, !29}
...
!225 = !{double 1.600000e+00, double 0x40A05851E108C3F4}
!226 = distinct !{!226, !29}
!227 = distinct !{!227, !29}
!228 = !{i32 1, !123, i32 1, !123, i32 1, !51, i32 1, !128}
!229 = !{i1 false, !230, i1 false, i2 -1}
!230 = !{double 2.560000e+02, double 0x40A05851E108C3F4}
!231 = distinct !{!231, !29}
!232 = distinct !{!232, !29}
