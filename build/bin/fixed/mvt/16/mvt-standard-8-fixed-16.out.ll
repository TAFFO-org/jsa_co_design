; ModuleID = './build/bin/fixed/mvt/16/mvt-standard-8-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u9_23fixp = load i32, i32* %arrayidx21.u9_23fixp, align 4, !taffo.info !50, !taffo.target !51
