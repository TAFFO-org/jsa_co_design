; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-8-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 8), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !37
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !34, !taffo.info !32
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 8), !taffo.initweight !35, !taffo.info !32, !taffo.originalCall !37
...
!31 = !{double 0x3FF111116A8B8F15, double 0x40211111276FB092}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 1.600000e+00, double 0x402222222D5171E3}
!34 = !{i32 1}
!35 = !{i32 2}
