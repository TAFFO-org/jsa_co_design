; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-512-fixed-16.out.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %lampsim8, 0x4150000000000000, !taffo.info !163
  ...
  %6 = fmul float 2.048000e+03, %lampsim15, !taffo.info !164
