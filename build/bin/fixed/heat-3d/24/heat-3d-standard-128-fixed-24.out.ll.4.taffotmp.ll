; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-128-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 128), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 128), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
!102 = !{!"fixp", i32 -32, i32 18}
!103 = !{double 5.120000e+02, double 6.656000e+03}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -6.400000e+03, double 2.816000e+03}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -6.144000e+03, double 6.144000e+03}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 20}
!111 = !{double -7.680000e+02, double 7.680000e+02}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -1.536000e+03, double 1.536000e+03}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -2.304000e+03, double 2.304000e+03}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -2.048000e+03, double 5.632000e+03}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!161 = !{double 1.280000e+02, double 1.280000e+02}
...
!168 = !{double 3.276800e+04, double 4.259840e+05}
!169 = distinct !{!169, !23}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
