...
entry:
  ...
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 117, i8* null)
  %B4 = bitcast [16 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B4, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 118, i8* null)
  %tmp5 = bitcast [16 x float]* %tmp to i8*
  call void @llvm.var.annotation(i8* %tmp5, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 119, i8* null)
  %x6 = bitcast [16 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x6, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  %y7 = bitcast [16 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y7, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 121, i8* null)
  ...
  call void @scale_scalar(float* noundef %alpha, i32 noundef 4)
  call void @scale_scalar(float* noundef %beta, i32 noundef 4)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 4)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 4)
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 4)
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 4)
  %arraydecay16 = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 4)
