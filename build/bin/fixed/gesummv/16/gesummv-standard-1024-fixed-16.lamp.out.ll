; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-1024-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 5.120000e+02, %lampsim15, !taffo.info !92
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u24_8fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !103 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 2.560000e+02, %lampsim15, !taffo.info !104
  %lampsim16 = bitcast float %4 to i32
  %lampsim17 = and i32 %lampsim16, -256
  %lampsim18 = bitcast i32 %lampsim17 to float
...
!102 = distinct !{!102, !23}
!103 = !{i32 1, !75, i32 1, !54, i32 1, !84}
!104 = !{!105, !106, i1 false, i2 -1}
!105 = !{!"float", i32 1, double 0x4206A66680000000}
!106 = !{double 0.000000e+00, double 0x4206A66680000000}
!107 = distinct !{!107, !23}
