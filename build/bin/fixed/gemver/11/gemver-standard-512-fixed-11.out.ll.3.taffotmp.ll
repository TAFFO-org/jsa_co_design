; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-512-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,84130.132812) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,486.399994) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [31 x i8] c"scalar(range(6.4,128.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [32 x i8] c"scalar(range(12.8,256.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [40 x i8] c"scalar(range(4.266667,85.333336) final)\00", section "llvm.metadata", !taffo.info !0
@.str.8 = private unnamed_addr constant [54 x i8] c"target('w') scalar(range(0.0,41561861652480.0) final)\00", section "llvm.metadata", !taffo.info !4
@.str.9 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,45657680.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.10 = private unnamed_addr constant [30 x i8] c"scalar(range(3.2,64.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.11 = private unnamed_addr constant [40 x i8] c"scalar(range(2.844445,56.888889) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.initweight !74, !taffo.info !54, !taffo.originalCall !77, !taffo.constinfo !78
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 512), !taffo.initweight !74, !taffo.info !56, !taffo.originalCall !77, !taffo.constinfo !78
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 512), !taffo.initweight !80, !taffo.info !58, !taffo.originalCall !81, !taffo.constinfo !82
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !59
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 512), !taffo.initweight !79, !taffo.info !59, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !61
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 512), !taffo.initweight !79, !taffo.info !61, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !63
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 512), !taffo.initweight !79, !taffo.info !63, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !65
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 512), !taffo.initweight !79, !taffo.info !65, !taffo.originalCall !83, !taffo.constinfo !84
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 512), !taffo.initweight !79, !taffo.info !67, !taffo.target !68, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !74, !taffo.info !69
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 512), !taffo.initweight !79, !taffo.info !69, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !74, !taffo.info !70
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 512), !taffo.initweight !79, !taffo.info !70, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !74, !taffo.info !72
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 512), !taffo.initweight !79, !taffo.info !72, !taffo.originalCall !83, !taffo.constinfo !84
...
!7 = !{double 0.000000e+00, double 0x4185C57280000000}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x42C2E67000000000}
!10 = !{i1 false, !11, i1 false, i2 0}
!11 = !{double 0.000000e+00, double 0x40F48A221FFF79C8}
...
!60 = !{double 0.000000e+00, double 0x407E6666601BC98A}
!61 = !{i1 false, !62, i1 false, i2 -1}
!62 = !{double 6.400000e+00, double 1.280000e+02}
!63 = !{i1 false, !64, i1 false, i2 -1}
!64 = !{double 1.280000e+01, double 2.560000e+02}
!65 = !{i1 false, !66, i1 false, i2 -1}
!66 = !{double 0x40111111276FB092, double 0x405555556084A516}
!67 = !{i1 false, !9, i1 false, i2 -1}
!68 = !{!"w"}
!69 = !{i1 false, !7, i1 false, i2 -1}
!70 = !{i1 false, !71, i1 false, i2 -1}
!71 = !{double 3.200000e+00, double 6.400000e+01}
!72 = !{i1 false, !73, i1 false, i2 -1}
!73 = !{double 0x4006C16C61522A6F, double 0x404C71C71D606317}
!74 = !{i32 1}
...
!150 = !{double 5.120000e+02, double 5.120000e+02}
...
!186 = !{double 0.000000e+00, double 0x40EE6666601BC98A}
!187 = !{i32 8}
!188 = !{i1 false, !189, i1 false, i2 -1}
!189 = !{double 0.000000e+00, double 0x4101DEAAA806AF46}
!190 = !{i1 false, !191, i1 false, i2 -1}
!191 = !{double 0x404B4E81D8B2B41D, double 0x40D555556084A516}
!192 = !{i1 false, !193, i1 false, i2 -1}
!193 = !{double 0x404B4E81D8B2B41D, double 0x41048955541743E9}
!194 = distinct !{!194, !33}
!195 = distinct !{!195, !33}
!196 = !{i1 false, !197, i1 false, i2 -1}
!197 = !{double 0.000000e+00, double 0x40F8A5C28CCC2BBD}
!198 = !{i1 false, !199, i1 false, i2 -1}
!199 = !{double 0.000000e+00, double 0x4158A5C28CCC2BBD}
!200 = !{i1 false, !201, i1 false, i2 -1}
!201 = !{double 0.000000e+00, double 0x4188DA2AD1998578}
!202 = distinct !{!202, !33}
!203 = distinct !{!203, !33}
!204 = !{i1 false, !205, i1 false, i2 -1}
!205 = !{double 0x4006C16C61522A6F, double 0x4185C574471C71D6}
!206 = distinct !{!206, !33}
!207 = !{i1 false, !208, i1 false, i2 -1}
!208 = !{double 0.000000e+00, double 0x40FECF332FFF36AC}
!209 = !{i1 false, !210, i1 false, i2 -1}
!210 = !{double 0.000000e+00, double 0x4294F61368021EC7}
!211 = !{i1 false, !212, i1 false, i2 -1}
!212 = !{double 0.000000e+00, double 0x42C585326D0043D9}
!213 = distinct !{!213, !33}
!214 = distinct !{!214, !33}
!215 = !{i32 1, !139, i32 1, !72, i32 1, !149}
!216 = !{i1 false, !217, i1 false, i2 -1}
!217 = !{double 0x4096C16C61522A6F, double 0x40DC71C71D606317}
!218 = distinct !{!218, !33}
...
!267 = !{double 0.000000e+00, double 0x41848A221FFF79C8}
!268 = distinct !{!268, !33}
!269 = distinct !{!269, !33}
