; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-128-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 128), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 128), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
!47 = !{double 2.560000e+01, double 0x4062222220BC382A}
...
!85 = !{double 0x40A11111276FB092, double 0x40D111111F0C34C2}
!86 = !{i32 7}
!87 = distinct !{!87, !23}
...
!97 = !{double 0x40411111276FB092, double 0x407111111F0C34C2}
!98 = !{!95, !99, i1 false, i2 -1}
!99 = !{double 0x40499999BB2788DB, double 0x40799999AE924F23}
!100 = !{i32 8}
!101 = !{!95, !102, i1 false, i2 -1}
!102 = !{double 0x40311105F81FE170, double 0x40611105EFBC6B1F}
!103 = !{i32 9}
!104 = !{!105, i1 false}
!105 = !{i1 false, !106, i1 false, i2 0}
!106 = !{double 3.333300e-01, double 3.333300e-01}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x40311105E0000000, double 0x4061110600000000}
!109 = !{i32 10}
!110 = distinct !{!110, !23}
!111 = !{!95, !47, i1 false, i2 -1}
!112 = !{!95, !113, i1 false, i2 -1}
!113 = !{double 5.120000e+01, double 0x4072222220BC382A}
!114 = !{!95, !115, i1 false, i2 -1}
!115 = !{double 0x4053333333333334, double 0x407B3333311A543F}
!116 = !{!95, !117, i1 false, i2 -1}
!117 = !{double 0x40399988D2A1F8E5, double 0x406222163E777C94}
!118 = !{!42, !119, i1 false, i2 -1}
!119 = !{double 0x40399988C0000000, double 0x4062221640000000}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
