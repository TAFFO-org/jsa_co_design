; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-16-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u2_30fixp2, i32 16), !taffo.info !65, !taffo.constinfo !61
  ...
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u2_30fixp, i32 16), !taffo.info !66, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !233
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !44
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !233
  %3 = ashr i32 %1, 4, !taffo.info !44
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !234
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !236
  ...
  %6 = shl i32 %mul.u6_26fixp, 4, !taffo.info !236
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !239 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u5_27fixp = shl i32 %factor, 27, !taffo.info !240
  %1 = lshr i32 %u5_27fixp, 1, !taffo.info !41
  %2 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !240
  %3 = ashr i32 %1, 4, !taffo.info !41
  %4 = ashr i32 %2, 4, !taffo.info !240
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !241
  %mul.u9_23fixp = shl i32 %5, 1, !taffo.info !244
  ...
  %7 = shl i32 %mul.u9_23fixp, 4, !taffo.info !244
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !248 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 5, !taffo.info !240
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !249
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !251
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u10_22fixp, 4, !taffo.info !251
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !254 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 11, !taffo.info !240
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !255
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !258
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u16_16fixp, 4, !taffo.info !258
...
!234 = !{!107, !235, i1 false, i2 -1}
!235 = !{double 0.000000e+00, double 0x4045555582129457}
!236 = !{!50, !235, i1 false, i2 -1}
!237 = distinct !{!237, !23}
!238 = distinct !{!238, !23}
!239 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !230}
!240 = !{!42, !231, i1 false, i2 1}
!241 = !{!242, !243, i1 false, i2 -1}
!242 = !{!"fixp", i32 -32, i32 22}
!243 = !{double 0.000000e+00, double 0x407BBBBBD7B2031D}
!244 = !{!245, !243, i1 false, i2 -1}
!245 = !{!"fixp", i32 32, i32 23}
!246 = distinct !{!246, !23}
!247 = distinct !{!247, !23}
!248 = !{i32 1, !96, i32 1, !85, i32 1, !49, i32 1, !230}
!249 = !{!127, !250, i1 false, i2 -1}
!250 = !{double 0.000000e+00, double 0x4080624DE3B8A19D}
!251 = !{!130, !250, i1 false, i2 -1}
!252 = distinct !{!252, !23}
!253 = distinct !{!253, !23}
!254 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !230}
!255 = !{!256, !257, i1 false, i2 -1}
!256 = !{!"fixp", i32 -32, i32 15}
!257 = !{double 0.000000e+00, double 0x40EBCB067FF583A5}
!258 = !{!259, !257, i1 false, i2 -1}
!259 = !{!"fixp", i32 32, i32 16}
!260 = distinct !{!260, !23}
!261 = distinct !{!261, !23}
