; ModuleID = './build/bin/fixed/gemm/16/gemm-standard-32-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 32), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 32), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 32), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
for.body18:                                       ; preds = %for.cond15
  ...
  %div24 = fdiv float %conv22, %conv23, !taffo.info !158, !taffo.initweight !106
...
for.body40:                                       ; preds = %for.cond37
  ...
  %conv44 = sitofp i32 %rem43 to float, !taffo.info !168, !taffo.initweight !81
  %conv45 = sitofp i32 %nj to float, !taffo.info !169
  %div46 = fdiv float %conv44, %conv45, !taffo.info !170, !taffo.initweight !106
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !177
  %conv = sitofp i32 %factor to float, !taffo.info !178
  %mul = fmul float %1, %conv, !taffo.info !186, !taffo.initweight !182
  %2 = mul nsw i32 %i.0, %m, !taffo.info !94
...
!55 = !{double 0.000000e+00, double 0x403D55556084A516}
...
!110 = !{double 0.000000e+00, double 0x40BE24DD19A26874}
!111 = distinct !{!111, !23}
...
!117 = !{double 0.000000e+00, double 0x4094A00007DD4413}
!118 = !{!49, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x40BE46B841FEA811}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = distinct !{!122, !23}
...
!157 = !{!52, !105, i1 false, i2 1}
!158 = !{!144, !159, i1 false, i2 1}
...
!167 = !{i1 false, !76, i1 false, i2 1}
!168 = !{!141, !76, i1 false, i2 1}
!169 = !{!141, !91, i1 false, i2 1}
!170 = !{!144, !171, i1 false, i2 1}
!171 = !{double 0.000000e+00, double 0x3FED555555555555}
!172 = !{!52, !55, i1 false, i2 1}
!173 = distinct !{!173, !23}
!174 = distinct !{!174, !23}
!175 = !{i32 -1, i32 -1, i32 3, i32 -1}
!176 = !{i32 1, !16, i32 1, !90, i32 1, !48, i32 1, !100}
!177 = !{i32 8}
!178 = !{!113, !101, i1 false, i2 1}
!179 = !{!180, !181, i1 false, i2 -1}
!180 = !{!"fixp", i32 32, i32 14}
!181 = !{double 0.000000e+00, double 0x41091EB84007570C}
!182 = !{i32 9}
!183 = distinct !{!183, !23}
!184 = distinct !{!184, !23}
!185 = !{i32 1, !16, i32 1, !104, i32 1, !51, i32 1, !100}
