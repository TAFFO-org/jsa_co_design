; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-256-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u8_24fixp2 = bitcast [16 x i32]* %arraydecay12.u8_24fixp to i32*, !taffo.info !48
  ...
  %u8_24fixp = bitcast [16 x i32]* %arraydecay13.u8_24fixp to i32*, !taffo.info !48
  ...
  call void @kernel_gesummv.5_fixp(i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay17.u8_24fixp, [16 x i32]* %arraydecay18.u8_24fixp, i32* %arraydecay19.u19_13fixp, i32* %arraydecay20.u8_24fixp, i32* %arraydecay21.u20_12fixp), !taffo.info !57, !taffo.constinfo !58
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 4.096000e+03, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u20_12fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 3), !taffo.info !92
  %mul.u28_4fixp = shl i32 %4, 1, !taffo.info !95
  %arrayidx1.u20_12fixp = getelementptr inbounds i32, i32* %val.u20_12fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u28_4fixp, 8, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !98 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !105 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 4), !taffo.info !106
  %mul.u27_5fixp = shl i32 %4, 1, !taffo.info !109
  %arrayidx1.u19_13fixp = getelementptr inbounds i32, i32* %val.u19_13fixp, i32 %i.0, !taffo.info !51
  %5 = shl i32 %mul.u27_5fixp, 8, !taffo.info !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u8_24fixp, [16 x i32]* noundef %B.u8_24fixp, i32* noundef %x.u8_24fixp, i32* noundef %tmp.u19_13fixp, i32* noundef %y.u20_12fixp) #0 !taffo.initweight !112 !taffo.funinfo !113 !taffo.sourceFunction !114 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx.u8_24fixp = getelementptr inbounds i32, i32* %x.u8_24fixp, i32 %i.0, !taffo.info !138
  %4 = lshr i32 %div.u1_31fixp, 7, !taffo.info !136
  store i32 %4, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !139
  %arrayidx4.u20_12fixp = getelementptr inbounds i32, i32* %y.u20_12fixp, i32 %i.0, !taffo.info !140
  store i32 0, i32* %arrayidx4.u20_12fixp, align 4, !taffo.info !139, !taffo.constinfo !141
  %arrayidx5.u19_13fixp = getelementptr inbounds i32, i32* %tmp.u19_13fixp, i32 %i.0, !taffo.info !142
  store i32 0, i32* %arrayidx5.u19_13fixp, align 4, !taffo.info !139, !taffo.constinfo !141
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx14.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u8_24fixp, i32 %i.0, !taffo.info !138
  %arrayidx15.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx14.u8_24fixp, i32 0, i32 %j.0, !taffo.info !138
  %9 = lshr i32 %div13.u1_31fixp, 7, !taffo.info !136
  store i32 %9, i32* %arrayidx15.u8_24fixp, align 4, !taffo.info !139
  ...
  %arrayidx22.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u8_24fixp, i32 %i.0, !taffo.info !138
  %arrayidx23.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx22.u8_24fixp, i32 0, i32 %j.0, !taffo.info !138
  %14 = lshr i32 %div21.u1_31fixp, 7, !taffo.info !136
  store i32 %14, i32* %arrayidx23.u8_24fixp, align 4, !taffo.info !139
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv.5_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u8_24fixp, [16 x i32]* noundef %B.u8_24fixp, i32* noundef %tmp.u19_13fixp, i32* noundef %x.u8_24fixp, i32* noundef %y.u20_12fixp) #0 !taffo.initweight !153 !taffo.funinfo !154 !taffo.sourceFunction !155 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 0, i32* %arrayidx.u19_13fixp, align 4, !taffo.info !139, !taffo.constinfo !141
  %arrayidx1.u20_12fixp = getelementptr inbounds i32, i32* %y.u20_12fixp, i32 %i.0, !taffo.info !54
  store i32 0, i32* %arrayidx1.u20_12fixp, align 4, !taffo.info !139, !taffo.constinfo !141
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !156
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !158
  ...
  %5 = lshr i32 %mul.u16_16fixp, 3, !taffo.info !158
  %add.u19_13fixp = add i32 %5, %u19_13fixp, !taffo.info !159
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 15), !taffo.info !156
  %mul13.u16_16fixp = shl i32 %10, 1, !taffo.info !158
  ...
  %11 = lshr i32 %mul13.u16_16fixp, 4, !taffo.info !158
  %add15.u20_12fixp = add i32 %11, %u20_12fixp, !taffo.info !161
...
for.end:                                          ; preds = %for.cond2
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 10), !taffo.info !164
  %mul18.u21_11fixp = shl i32 %16, 1, !taffo.info !167
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 10), !taffo.info !169
  %mul20.u21_11fixp = shl i32 %21, 1, !taffo.info !171
  %add21.u21_11fixp = add i32 %mul18.u21_11fixp, %mul20.u21_11fixp, !taffo.info !172
  %arrayidx22.u20_12fixp = getelementptr inbounds i32, i32* %y.u20_12fixp, i32 %i.0, !taffo.info !54
  %22 = shl i32 %add21.u21_11fixp, 1, !taffo.info !172
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !99
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !102
  ...
  %7 = shl i32 %mul.u16_16fixp, 8, !taffo.info !102
...
!93 = !{!"fixp", i32 -32, i32 3}
!94 = !{double 0.000000e+00, double 0x41A6A66680000000}
!95 = !{!96, !94, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 4}
!97 = distinct !{!97, !23}
!98 = !{i32 1, !75, i32 1, !48, i32 1, !84}
!99 = !{!100, !101, i1 false, i2 -1}
!100 = !{!"fixp", i32 -32, i32 15}
!101 = !{double 0.000000e+00, double 6.144000e+04}
!102 = !{!103, !101, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 16}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !75, i32 1, !51, i32 1, !84}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 4}
!108 = !{double 0.000000e+00, double 0x4191A00000000000}
...
!157 = !{double 0.000000e+00, double 5.760000e+04}
!158 = !{!103, !157, i1 false, i2 -1}
!159 = !{!52, !160, i1 false, i2 -1}
!160 = !{double 0.000000e+00, double 3.463680e+05}
!161 = !{!55, !162, i1 false, i2 -1}
!162 = !{double 0.000000e+00, double 0x4128686680000000}
!163 = distinct !{!163, !23}
!164 = !{!165, !166, i1 false, i2 -1}
!165 = !{!"fixp", i32 -32, i32 10}
!166 = !{double 0.000000e+00, double 4.331520e+05}
!167 = !{!168, !166, i1 false, i2 -1}
!168 = !{!"fixp", i32 32, i32 11}
!169 = !{!165, !170, i1 false, i2 -1}
!170 = !{double 0.000000e+00, double 0x412B2E1499999999}
!171 = !{!168, !170, i1 false, i2 -1}
!172 = !{!168, !173, i1 false, i2 -1}
!173 = !{double 0.000000e+00, double 0x4134330A4CCCCCCC}
!174 = distinct !{!174, !23}
