; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-2-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 2), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 2), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !41, !taffo.initweight !78
  %0 = load float, float* %arrayidx, align 4, !taffo.info !79, !taffo.initweight !81
  %conv = sitofp i32 %factor to float, !taffo.info !82
  %mul = fmul float %0, %conv, !taffo.info !83, !taffo.initweight !85
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !41, !taffo.initweight !78
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_1d.2(i32 noundef %tsteps, i32 noundef %n, float* noundef %A, float* noundef %B) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !58 {
entry:
  br label %for.cond
...
for.cond1:                                        ; preds = %for.inc, %for.body
  ...
  %sub = sub nsw i32 %n, 1, !taffo.info !91, !taffo.constinfo !21
  %cmp2 = icmp slt i32 %i.0, %sub, !taffo.info !71
  br i1 %cmp2, label %for.body3, label %for.end

for.body3:                                        ; preds = %for.cond1
  %sub4 = sub nsw i32 %i.0, 1, !taffo.info !73, !taffo.constinfo !21
  %arrayidx = getelementptr inbounds float, float* %A, i32 %sub4, !taffo.info !41, !taffo.initweight !78
  %0 = load float, float* %arrayidx, align 4, !taffo.info !79, !taffo.initweight !81
  %arrayidx5 = getelementptr inbounds float, float* %A, i32 %i.0, !taffo.info !41, !taffo.initweight !78
  %1 = load float, float* %arrayidx5, align 4, !taffo.info !79, !taffo.initweight !81
  %add = fadd float %0, %1, !taffo.info !83, !taffo.initweight !85
  %add6 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx7 = getelementptr inbounds float, float* %A, i32 %add6, !taffo.info !41, !taffo.initweight !78
  %2 = load float, float* %arrayidx7, align 4, !taffo.info !79, !taffo.initweight !81
  %add8 = fadd float %add, %2, !taffo.info !93, !taffo.initweight !85
  %conv = fpext float %add8 to double, !taffo.info !93, !taffo.initweight !95
  %mul = fmul double 3.333300e-01, %conv, !taffo.info !96, !taffo.initweight !98, !taffo.constinfo !99
  %conv9 = fptrunc double %mul to float, !taffo.info !102, !taffo.initweight !104
  %arrayidx10 = getelementptr inbounds float, float* %B, i32 %i.0, !taffo.info !46, !taffo.initweight !78
...
for.cond11:                                       ; preds = %for.inc27, %for.end
  ...
  %sub12 = sub nsw i32 %n, 1, !taffo.info !91, !taffo.constinfo !21
...
for.body15:                                       ; preds = %for.cond11
  ...
  %arrayidx17 = getelementptr inbounds float, float* %B, i32 %sub16, !taffo.info !46, !taffo.initweight !78
  %3 = load float, float* %arrayidx17, align 4, !taffo.info !106, !taffo.initweight !81
  %arrayidx18 = getelementptr inbounds float, float* %B, i32 %i.1, !taffo.info !46, !taffo.initweight !78
  %4 = load float, float* %arrayidx18, align 4, !taffo.info !106, !taffo.initweight !81
  %add19 = fadd float %3, %4, !taffo.info !107, !taffo.initweight !85
  %add20 = add nsw i32 %i.1, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx21 = getelementptr inbounds float, float* %B, i32 %add20, !taffo.info !46, !taffo.initweight !78
  %5 = load float, float* %arrayidx21, align 4, !taffo.info !106, !taffo.initweight !81
  %add22 = fadd float %add19, %5, !taffo.info !109, !taffo.initweight !85
  %conv23 = fpext float %add22 to double, !taffo.info !109, !taffo.initweight !95
  %mul24 = fmul double 3.333300e-01, %conv23, !taffo.info !111, !taffo.initweight !98, !taffo.constinfo !99
  %conv25 = fptrunc double %mul24 to float, !taffo.info !113, !taffo.initweight !104
  %arrayidx26 = getelementptr inbounds float, float* %A, i32 %i.1, !taffo.info !41, !taffo.initweight !78
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, float* noundef %A, float* noundef %B) #0 !taffo.initweight !117 !taffo.funinfo !118 !taffo.sourceFunction !53 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !119, !taffo.initweight !44
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !121, !taffo.initweight !51
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !119, !taffo.initweight !63

for.body:                                         ; preds = %for.cond
  %conv = sitofp i32 %i.0 to float, !taffo.info !122, !taffo.initweight !51
  %add = fadd float %conv, 2.000000e+00, !taffo.info !124, !taffo.initweight !63, !taffo.constinfo !126
  %conv2 = sitofp i32 %n to float, !taffo.info !127
  %div = fdiv float %add, %conv2, !taffo.info !129, !taffo.initweight !131
  %arrayidx = getelementptr inbounds float, float* %A, i32 %i.0, !taffo.info !132, !taffo.initweight !51
  store float %div, float* %arrayidx, align 4, !taffo.info !133, !taffo.initweight !63
  %conv3 = sitofp i32 %i.0 to float, !taffo.info !122, !taffo.initweight !51
  %add4 = fadd float %conv3, 3.000000e+00, !taffo.info !134, !taffo.initweight !63, !taffo.constinfo !136
  %conv5 = sitofp i32 %n to float, !taffo.info !127
  %div6 = fdiv float %add4, %conv5, !taffo.info !139, !taffo.initweight !131
  %arrayidx7 = getelementptr inbounds float, float* %B, i32 %i.0, !taffo.info !141, !taffo.initweight !51
  store float %div6, float* %arrayidx7, align 4, !taffo.info !133, !taffo.initweight !63
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !142, !taffo.initweight !51, !taffo.constinfo !21
...
!47 = !{double 4.000000e-01, double 0x400222224EDF6124}
...
!77 = !{i32 1, !69, i32 1, !41, i32 1, !19}
!78 = !{i32 5}
!79 = !{!80, !43, i1 false, i2 -1}
!80 = !{!"fixp", i32 32, i32 29}
!81 = !{i32 6}
!82 = !{!80, !20, i1 false, i2 1}
!83 = !{!80, !84, i1 false, i2 -1}
!84 = !{double 5.333340e-01, double 0x40111110E453D20F}
!85 = !{i32 7}
!86 = distinct !{!86, !23}
!87 = !{i32 -1, i32 -1, i32 2, i32 2}
!88 = !{i32 1, !16, i32 1, !69, i32 1, !41, i32 1, !46}
...
!93 = !{!80, !94, i1 false, i2 -1}
!94 = !{double 0x3FE9999BB2788DB0, double 0x40199999567DBB16}
!95 = !{i32 8}
!96 = !{!80, !97, i1 false, i2 -1}
!97 = !{double 0x3FD1110747AA5E17, double 0x40011105B5042EE8}
!98 = !{i32 9}
!99 = !{!100, i1 false}
!100 = !{i1 false, !101, i1 false, i2 0}
!101 = !{double 3.333300e-01, double 3.333300e-01}
!102 = !{!42, !103, i1 false, i2 -1}
!103 = !{double 0x3FD1110740000000, double 0x40011105C0000000}
!104 = !{i32 10}
!105 = distinct !{!105, !23}
!106 = !{!80, !47, i1 false, i2 -1}
!107 = !{!80, !108, i1 false, i2 -1}
!108 = !{double 8.000000e-01, double 0x401222224EDF6124}
!109 = !{!80, !110, i1 false, i2 -1}
!110 = !{double 0x3FF3333333333334, double 0x401B3333764F11B6}
!111 = !{!80, !112, i1 false, i2 -1}
!112 = !{double 0x3FD99988D2A1F8E5, double 0x400222166C9A8751}
!113 = !{!42, !114, i1 false, i2 -1}
!114 = !{double 0x3FD99988C0000000, double 0x4002221680000000}
!115 = distinct !{!115, !23}
!116 = distinct !{!116, !23}
!117 = !{i32 -1, i32 2, i32 2}
!118 = !{i32 1, !69, i32 1, !41, i32 1, !46}
...
!125 = !{double -1.300000e+01, double 1.700000e+01}
!126 = !{i1 false, !19}
!127 = !{!128, !70, i1 false, i2 1}
!128 = !{!"fixp", i32 -32, i32 27}
!129 = !{!128, !130, i1 false, i2 -1}
!130 = !{double 0xBFEBBBBBBBBBBBBC, double 0x3FF2222222222222}
!131 = !{i32 4}
!132 = !{!42, !43, i1 false, i2 1}
!133 = !{i1 false, i1 false, i1 false, i2 1}
!134 = !{!123, !135, i1 false, i2 -1}
!135 = !{double -1.200000e+01, double 1.800000e+01}
!136 = !{i1 false, !137}
!137 = !{i1 false, !138, i1 false, i2 0}
!138 = !{double 3.000000e+00, double 3.000000e+00}
!139 = !{!128, !140, i1 false, i2 -1}
!140 = !{double -8.000000e-01, double 1.200000e+00}
!141 = !{!42, !47, i1 false, i2 1}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double -1.400000e+01, double 1.600000e+01}
!144 = distinct !{!144, !23}
