...
entry:
  ...
  call void @kernel_seidel_2d(i32 noundef %1, i32 noundef %2, ptr noundef %arraydecay1)
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx5 = getelementptr inbounds [20 x float], ptr %arrayidx, i32 0, i32 %8
  %9 = load float, ptr %arrayidx5, align 4
  %10 = load i32, ptr %i, align 4
  %arrayidx6 = getelementptr inbounds [20 x [20 x float]], ptr @A_float, i32 0, i32 %10
  %11 = load i32, ptr %j, align 4
  %arrayidx7 = getelementptr inbounds [20 x float], ptr %arrayidx6, i32 0, i32 %11
...
for.body8:                                        ; preds = %for.cond5
  ...
  %add23 = fadd float %add19, %21
  store float %add23, ptr %term1, align 4
  ...
  %add43 = fadd float %add38, %41
  store float %add43, ptr %term2, align 4
  ...
  %add44 = fadd float %42, %43
  store float %add44, ptr %sum, align 4
  call void @llvm.var.annotation(ptr %div, ptr @.str.3, ptr @.str.1, i32 82, ptr null)
  %44 = load float, ptr %sum, align 4
  %div45 = fdiv float %44, 9.000000e+00
  store float %div45, ptr %div, align 4
