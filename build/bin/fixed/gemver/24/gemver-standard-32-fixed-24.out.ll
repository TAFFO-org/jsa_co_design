; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-32-fixed-24.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !119 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !121
  %0 = lshr i32 %u3_29fixp, 1, !taffo.info !62
  %1 = lshr i32 %conv.u8_24fixp, 1, !taffo.info !121
  %2 = ashr i32 %0, 5, !taffo.info !62
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 23), !taffo.info !123
  %mul.u8_24fixp = shl i32 %3, 1, !taffo.info !126
  %arrayidx1.u3_29fixp = getelementptr inbounds i32, i32* %val.u3_29fixp, i32 %i.0, !taffo.info !62
  %4 = shl i32 %mul.u8_24fixp, 5, !taffo.info !126
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !128 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !129
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !57
  %1 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !129
  %2 = ashr i32 %0, 5, !taffo.info !57
  %3 = ashr i32 %1, 3, !taffo.info !129
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 22), !taffo.info !131
  %mul.u9_23fixp = shl i32 %4, 1, !taffo.info !134
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u9_23fixp, 5, !taffo.info !134
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !136 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 13, !taffo.info !129
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !137
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !140
  %arrayidx1.u14_18fixp = getelementptr inbounds i32, i32* %val.u14_18fixp, i32 %i.0, !taffo.info !68
  %5 = shl i32 %mul.u19_13fixp, 5, !taffo.info !140
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !143 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 4, !taffo.info !129
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !144
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !147
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u10_22fixp, 5, !taffo.info !147
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u9_23fixp = load i32, i32* %arrayidx4.u9_23fixp, align 4, !taffo.info !153
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !154
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !156
  %5 = lshr i32 %u9_23fixp, 1, !taffo.info !153
  %add.u10_22fixp = add i32 %5, %mul.u10_22fixp, !taffo.info !157
  %arrayidx7.u5_27fixp = getelementptr inbounds i32, i32* %u2.u5_27fixp, i32 %i.0, !taffo.info !60
  %u5_27fixp1 = load i32, i32* %arrayidx7.u5_27fixp, align 4, !taffo.info !159
  ...
  %6 = lshr i32 %u5_27fixp1, 1, !taffo.info !159
  %7 = lshr i32 %u3_29fixp, 1, !taffo.info !62
  %8 = ashr i32 %6, 2, !taffo.info !159
  %9 = ashr i32 %7, 4, !taffo.info !62
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 24), !taffo.info !161
  %mul9.u7_25fixp = shl i32 %10, 1, !taffo.info !164
  %11 = lshr i32 %mul9.u7_25fixp, 3, !taffo.info !164
  %add10.u10_22fixp = add i32 %add.u10_22fixp, %11, !taffo.info !165
  ...
  %12 = shl i32 %add10.u10_22fixp, 1, !taffo.info !165
...
for.body21:                                       ; preds = %for.cond19
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 20), !taffo.info !169
  %mul25.u11_21fixp = shl i32 %17, 1, !taffo.info !172
  ...
  %18 = lshr i32 %mul25.u11_21fixp, 1, !taffo.info !172
  %19 = lshr i32 %u3_29fixp4, 1, !taffo.info !70
  %20 = ashr i32 %19, 8, !taffo.info !70
  %21 = call i32 @llvm.smul.fix.i32(i32 %18, i32 %20, i32 20), !taffo.info !174
  %mul27.u11_21fixp = shl i32 %21, 1, !taffo.info !176
  %22 = lshr i32 %mul27.u11_21fixp, 3, !taffo.info !176
  %add28.u14_18fixp = add i32 %u14_18fixp, %22, !taffo.info !177
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u14_18fixp = add i32 %u14_18fixp2, %23, !taffo.info !181
...
for.inc43:                                        ; preds = %for.body38
  ...
  br label %for.cond36, !llvm.loop !183
...
for.body51:                                       ; preds = %for.cond49
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 22), !taffo.info !184
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u26_6fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !196 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !129
  %2 = uitofp i32 %conv.u6_26fixp to float, !taffo.info !129
  %3 = fdiv float %2, 0x4190000000000000, !taffo.info !129
  %mul.1flp = fmul float %1, %3, !taffo.info !197
  %arrayidx1.u26_6fixp = getelementptr inbounds i32, i32* %val.u26_6fixp, i32 %i.0, !taffo.info !65
  %4 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !197
  %5 = fptoui float %4 to i32, !taffo.info !197
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u9_23fixp, i32* noundef %u1.u5_27fixp, i32* noundef %v1.u4_28fixp, i32* noundef %u2.u5_27fixp, i32* noundef %v2.u3_29fixp, i32* noundef %w.u26_6fixp, i32* noundef %x.u14_18fixp, i32* noundef %y.u3_29fixp, i32* noundef %z.u3_29fixp) #0 !taffo.initweight !201 !taffo.funinfo !151 !taffo.sourceFunction !202 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !129
  %3 = ashr i32 %1, 5, !taffo.info !52
  %4 = ashr i32 %2, 8, !taffo.info !129
...
!119 = !{i32 1, !103, i32 1, !62, i32 1, !115}
!120 = !{void (i32, float*, i32)* @scale_1d}
!121 = !{!122, !116, i1 false, i2 1}
!122 = !{!"fixp", i32 32, i32 24}
!123 = !{!124, !125, i1 false, i2 -1}
!124 = !{!"fixp", i32 -32, i32 23}
!125 = !{double 0x4021111276FB0920, double 0x406555553EF6B5D4}
!126 = !{!122, !125, i1 false, i2 -1}
!127 = distinct !{!127, !27}
!128 = !{i32 1, !103, i32 1, !57, i32 1, !115}
!129 = !{!130, !116, i1 false, i2 1}
!130 = !{!"fixp", i32 32, i32 26}
!131 = !{!132, !133, i1 false, i2 -1}
!132 = !{!"fixp", i32 -32, i32 22}
!133 = !{double 1.280000e+01, double 2.560000e+02}
!134 = !{!53, !133, i1 false, i2 -1}
!135 = distinct !{!135, !27}
!136 = !{i32 1, !103, i32 1, !68, i32 1, !115}
!137 = !{!138, !139, i1 false, i2 -1}
!138 = !{!"fixp", i32 -32, i32 12}
!139 = !{double 0.000000e+00, double 0x4116D8D15FFE6D59}
!140 = !{!141, !139, i1 false, i2 -1}
!141 = !{!"fixp", i32 32, i32 13}
!142 = distinct !{!142, !27}
!143 = !{i32 1, !103, i32 1, !54, i32 1, !115}
!144 = !{!145, !146, i1 false, i2 -1}
!145 = !{!"fixp", i32 -32, i32 21}
!146 = !{double 0.000000e+00, double 0x408E666666666666}
!147 = !{!148, !146, i1 false, i2 -1}
!148 = !{!"fixp", i32 32, i32 22}
!149 = distinct !{!149, !27}
!150 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!151 = !{i32 1, !103, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !60, i32 1, !62, i32 1, !65, i32 1, !68, i32 1, !70, i32 1, !72}
!152 = distinct !{null}
!153 = !{!148, !5, i1 false, i2 -1}
!154 = !{!145, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 2.432000e+02}
!156 = !{!148, !155, i1 false, i2 -1}
!157 = !{!148, !158, i1 false, i2 -1}
!158 = !{double 0.000000e+00, double 0x4081EAAAA9717DF2}
!159 = !{!160, !61, i1 false, i2 -1}
!160 = !{!"fixp", i32 32, i32 25}
!161 = !{!162, !163, i1 false, i2 -1}
!162 = !{!"fixp", i32 -32, i32 24}
!163 = !{double 0x3FCB4E83F191A834, double 0x405555553EF6B5D4}
!164 = !{!160, !163, i1 false, i2 -1}
!165 = !{!148, !166, i1 false, i2 -1}
!166 = !{double 0x3FCB4E83F191A834, double 0x40849555515054AC}
!167 = distinct !{!167, !27}
!168 = distinct !{!168, !27}
!169 = !{!170, !171, i1 false, i2 -1}
!170 = !{!"fixp", i32 -32, i32 20}
!171 = !{double 0.000000e+00, double 0x4078C28F59395739}
!172 = !{!173, !171, i1 false, i2 -1}
!173 = !{!"fixp", i32 32, i32 21}
!174 = !{!170, !175, i1 false, i2 -1}
!175 = !{double 0.000000e+00, double 0x4098C28F59395739}
!176 = !{!173, !175, i1 false, i2 -1}
!177 = !{!69, !178, i1 false, i2 -1}
!178 = !{double 0.000000e+00, double 0x40C9F1234B259840}
!179 = distinct !{!179, !27}
!180 = distinct !{!180, !27}
!181 = !{!69, !182, i1 false, i2 -1}
!182 = !{double 1.777780e-01, double 0x40C6DA987C73EEE5}
!183 = distinct !{!183, !27}
!184 = !{!132, !185, i1 false, i2 -1}
...
!194 = distinct !{!194, !27}
!195 = distinct !{!195, !27}
!196 = !{i32 1, !103, i32 1, !65, i32 1, !115}
!197 = !{!198, !199, i1 false, i2 -1}
!198 = !{!"float", i32 1, double 0x41D59442A0000000}
!199 = !{double 0.000000e+00, double 0x41D59442A0000000}
!200 = distinct !{!200, !27}
