; ModuleID = './build/bin/fixed/atax/11/atax-standard-1024-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !86
...
for.body18:                                       ; preds = %for.cond16
  ...
  %lampsim = bitcast float %8 to i32
  %lampsim1 = and i32 %lampsim, -8192
  %lampsim2 = bitcast i32 %lampsim1 to float
  %9 = fdiv float %lampsim2, 0x4170000000000000, !taffo.info !42
  %lampsim3 = bitcast float %9 to i32
  %lampsim4 = and i32 %lampsim3, -8192
  %lampsim5 = bitcast i32 %lampsim4 to float
  ...
  %lampsim6 = bitcast float %10 to i32
  %lampsim7 = and i32 %lampsim6, -8192
  %lampsim8 = bitcast i32 %lampsim7 to float
  %11 = fdiv float %lampsim8, 1.024000e+03, !taffo.info !52
  %lampsim9 = bitcast float %11 to i32
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul23.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !118
  %lampsim13 = bitcast float %mul23.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -8192
  %lampsim15 = bitcast i32 %lampsim14 to float
  %add24.1flp16 = fadd float %.flt.fallback.1flp, %lampsim15, !taffo.info !121
  %lampsim17 = bitcast float %add24.1flp16 to i32
  %lampsim18 = and i32 %lampsim17, -8192
  %lampsim19 = bitcast i32 %lampsim18 to float
  %arrayidx25.flt.1flp = getelementptr inbounds float, float* %y, i32 %j.1, !taffo.info !48, !taffo.initweight !94
  store float %lampsim19, float* %arrayidx25.flt.1flp, align 4, !taffo.info !61
  br label %for.inc26
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim1 = and i32 %lampsim, -8192
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 1.024000e+03, !taffo.info !52
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -8192
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !86
  ...
  %lampsim7 = and i32 %lampsim6, -8192
  %lampsim8 = bitcast i32 %lampsim7 to float
  %3 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !86
  ...
  %4 = fmul float 1.024000e+03, %lampsim15, !taffo.info !127
