; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-256-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u6_26fixp = bitcast [12 x i32]* %arraydecay19.u6_26fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u6_26fixp, i32 256), !taffo.info !66, !taffo.constinfo !61
