; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [43 x i8] c"target('C') scalar(range(0.0,26.92) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,1.875) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.833333) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 2), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 2), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 2), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !117 !taffo.funinfo !119 !taffo.sourceFunction !62 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, float noundef %alpha, float noundef %beta, [12 x float]* noundef %C, [16 x float]* noundef %A, [12 x float]* noundef %B) #0 !taffo.initweight !120 !taffo.funinfo !121 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, float* noundef %alpha, float* noundef %beta, [12 x float]* noundef %C, [16 x float]* noundef %A, [12 x float]* noundef %B) #0 !taffo.initweight !137 !taffo.funinfo !121 !taffo.sourceFunction !60 {
entry:
...
for.body18:                                       ; preds = %for.cond15
  ...
  %conv23 = sitofp i32 %nk to float, !taffo.info !122
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !94, !taffo.info !158
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.1, !taffo.initweight !64, !taffo.info !160
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.initweight !64, !taffo.info !160
  store float %div24, float* %arrayidx26, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.initweight !64, !taffo.info !163, !taffo.constinfo !27
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.initweight !64, !taffo.info !165
  %rem43 = srem i32 %mul42, %nj, !taffo.initweight !65, !taffo.info !167
  %conv44 = sitofp i32 %rem43 to float, !taffo.initweight !76, !taffo.info !167
  %conv45 = sitofp i32 %nj to float, !taffo.info !109
  %div46 = fdiv float %conv44, %conv45, !taffo.initweight !94, !taffo.info !168
  %arrayidx47 = getelementptr inbounds [12 x float], [12 x float]* %B, i32 %i.2, !taffo.initweight !64, !taffo.info !170
  %arrayidx48 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx47, i32 0, i32 %j.2, !taffo.initweight !64, !taffo.info !170
  store float %div46, float* %arrayidx48, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc49
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !175, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !176, !taffo.info !177
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !175, !taffo.info !53
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !173 !taffo.funinfo !181 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !175, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !176, !taffo.info !182
  %2 = mul nsw i32 %i.0, %m, !taffo.info !113
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !175, !taffo.info !55
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !173 !taffo.funinfo !186 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !175, !taffo.info !57
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !176, !taffo.info !187
  %2 = mul nsw i32 %i.0, %m, !taffo.info !113
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !175, !taffo.info !57
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 2.692000e+01}
...
!58 = !{double 0.000000e+00, double 0x3FFD5554FBDAD752}
!59 = !{i32 1}
...
!116 = distinct !{!116, !29}
!117 = !{i32 1, i32 -1}
!118 = !{i32 1, !49, i32 1, !25}
!119 = !{i32 1, !51, i32 1, !25}
!120 = !{i32 -1, i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!121 = !{i32 1, !22, i32 1, !109, i32 1, !122, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55, i32 1, !57}
!122 = !{i1 false, !123, i1 false, i2 0}
!123 = !{double 1.600000e+01, double 1.600000e+01}
!124 = !{i32 7}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 3.230400e+01}
!127 = distinct !{!127, !29}
!128 = !{i1 false, !129, i1 false, i2 -1}
!129 = !{double 0.000000e+00, double 2.812500e+00}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 0x40149FFFC115DF66}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x404009C2877EE4E3}
!134 = distinct !{!134, !29}
!135 = distinct !{!135, !29}
!136 = distinct !{!136, !29}
...
!179 = distinct !{!179, !29}
!180 = distinct !{!180, !29}
!181 = !{i32 1, !22, i32 1, !122, i32 1, !55, i32 1, !25}
!182 = !{i1 false, !183, i1 false, i2 -1}
!183 = !{double 0.000000e+00, double 3.750000e+00}
!184 = distinct !{!184, !29}
!185 = distinct !{!185, !29}
!186 = !{i32 1, !122, i32 1, !109, i32 1, !57, i32 1, !25}
!187 = !{i1 false, !188, i1 false, i2 -1}
!188 = !{double 0.000000e+00, double 0x400D5554FBDAD752}
!189 = distinct !{!189, !29}
!190 = distinct !{!190, !29}
