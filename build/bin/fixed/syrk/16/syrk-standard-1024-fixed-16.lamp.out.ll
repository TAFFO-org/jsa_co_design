; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-1024-fixed-16.out.ll'
...
entry:
  ...
  %arraydecay5.u10_22fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %A.u10_22fixp, i32 0, i32 0, !taffo.info !50
  call void @init_array.4_fixp(i32 16, i32 10, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [16 x i32]* %arraydecay.u23_9fixp, [10 x i32]* %arraydecay5.u10_22fixp), !taffo.info !53, !taffo.constinfo !54
  call void @scale_scalar.1_fixp(i32* %alpha.u2_30fixp, i32 1024), !taffo.info !53, !taffo.constinfo !55
  call void @scale_scalar.1_fixp(i32* %beta.u2_30fixp, i32 1024), !taffo.info !56, !taffo.constinfo !55
  %arraydecay6.u23_9fixp = getelementptr inbounds [16 x [16 x i32]], [16 x [16 x i32]]* %C.u23_9fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u23_9fixp = bitcast [16 x i32]* %arraydecay6.u23_9fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 16, i32 16, i32* %u23_9fixp, i32 1024), !taffo.info !57, !taffo.constinfo !58, !taffo.target !49
  %arraydecay7.u10_22fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %A.u10_22fixp, i32 0, i32 0, !taffo.info !50
  %u10_22fixp = bitcast [10 x i32]* %arraydecay7.u10_22fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u10_22fixp, i32 1024), !taffo.info !59, !taffo.constinfo !58
  ...
  call void @kernel_syrk.3_fixp(i32 16, i32 10, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay8.u23_9fixp, [10 x i32]* %arraydecay9.u10_22fixp), !taffo.info !53, !taffo.constinfo !54
...
for.body12:                                       ; preds = %for.cond10
  ...
  %arrayidx13.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u23_9fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
  %u23_9fixp2 = load i32, i32* %arrayidx13.u23_9fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u23_9fixp2 to float, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syrk.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u23_9fixp, [10 x i32]* noundef %A.u10_22fixp) #0 !taffo.initweight !84 !taffo.funinfo !85 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 8), !taffo.info !87
  %mul.u23_9fixp = shl i32 %3, 1, !taffo.info !90
  store i32 %mul.u23_9fixp, i32* %arrayidx4.u23_9fixp, align 4, !taffo.info !56
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx11.u10_22fixp, i32 0, i32 %k.0, !taffo.info !50
  %u10_22fixp = load i32, i32* %arrayidx12.u10_22fixp, align 4, !taffo.info !92
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u10_22fixp, 1, !taffo.info !92
  %6 = ashr i32 %4, 9, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !92
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 20), !taffo.info !94
  %mul13.u11_21fixp = shl i32 %8, 1, !taffo.info !97
  %arrayidx14.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u10_22fixp, i32 %j.1, !taffo.info !50
  %arrayidx15.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u10_22fixp, i32 0, i32 %k.0, !taffo.info !50
  %u10_22fixp2 = load i32, i32* %arrayidx15.u10_22fixp, align 4, !taffo.info !50
  %9 = lshr i32 %mul13.u11_21fixp, 1, !taffo.info !97
  %10 = lshr i32 %u10_22fixp2, 1, !taffo.info !50
  %11 = ashr i32 %9, 12, !taffo.info !97
  %12 = ashr i32 %10, 13, !taffo.info !50
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 8), !taffo.info !98
  %mul16.u23_9fixp = shl i32 %13, 1, !taffo.info !100
  %arrayidx17.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u23_9fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx17.u23_9fixp, i32 0, i32 %j.1, !taffo.info !47
  %u23_9fixp1 = load i32, i32* %arrayidx18.u23_9fixp, align 4, !taffo.info !47
  %add.u23_9fixp = add i32 %u23_9fixp1, %mul16.u23_9fixp, !taffo.info !101
  store i32 %add.u23_9fixp, i32* %arrayidx18.u23_9fixp, align 4, !taffo.info !57
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u23_9fixp, [10 x i32]* noundef %A.u10_22fixp) #0 !taffo.initweight !106 !taffo.funinfo !85 !taffo.sourceFunction !107 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u10_22fixp, i32 %i.0, !taffo.info !139
  %arrayidx7.u10_22fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u10_22fixp, i32 0, i32 %j.0, !taffo.info !139
  %4 = lshr i32 %div.u1_31fixp, 9, !taffo.info !137
  store i32 %4, i32* %arrayidx7.u10_22fixp, align 4, !taffo.info !140
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u23_9fixp, i32 %i.1, !taffo.info !157
  %arrayidx26.u23_9fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u23_9fixp, i32 0, i32 %j.1, !taffo.info !157
  %8 = lshr i32 %div24.u1_31fixp, 22, !taffo.info !156
  store i32 %8, i32* %arrayidx26.u23_9fixp, align 4, !taffo.info !140
  br label %for.inc27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !160 !taffo.funinfo !161 !taffo.sourceFunction !162 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim4 = and i32 %lampsim3, -256
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !163
  %3 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !163
  %lampsim6 = bitcast float %3 to i32
  %lampsim7 = and i32 %lampsim6, -256
  %lampsim8 = bitcast i32 %lampsim7 to float
  %4 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !163
  %lampsim9 = bitcast float %4 to i32
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !164
  ...
  %6 = fmul float 5.120000e+02, %lampsim15, !taffo.info !164
  %lampsim16 = bitcast float %6 to i32
  %lampsim17 = and i32 %lampsim16, -256
  %lampsim18 = bitcast i32 %lampsim17 to float
  %7 = fptoui float %lampsim18 to i32, !taffo.info !164
  store i32 %7, i32* %arrayidx6.u23_9fixp, align 4, !taffo.info !57
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !160 !taffo.funinfo !169 !taffo.sourceFunction !162 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u11_21fixp, 1, !taffo.info !163
  %3 = ashr i32 %1, 10, !taffo.info !50
  %4 = ashr i32 %2, 9, !taffo.info !163
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 11), !taffo.info !170
  %mul.u20_12fixp = shl i32 %5, 1, !taffo.info !173
  ...
  %7 = shl i32 %mul.u20_12fixp, 10, !taffo.info !173
  store i32 %7, i32* %arrayidx6.u10_22fixp, align 4, !taffo.info !59
  br label %for.inc
...
!1 = !{double 0.000000e+00, double 0x4159CED700000000}
...
!89 = !{double 0.000000e+00, double 0x415EF83533333333}
...
!96 = !{double 0.000000e+00, double 1.440000e+03}
!97 = !{!93, !96, i1 false, i2 -1}
!98 = !{!88, !99, i1 false, i2 -1}
!99 = !{double 0.000000e+00, double 1.382400e+06}
!100 = !{!48, !99, i1 false, i2 -1}
!101 = !{!48, !102, i1 false, i2 -1}
!102 = !{double 0.000000e+00, double 0x415F14D700000000}
!103 = distinct !{!103, !23}
!104 = distinct !{!104, !23}
!105 = distinct !{!105, !23}
...
!165 = !{!"float", i32 1, double 0x41F9CED700000000}
!166 = !{double 0.000000e+00, double 0x41F9CED700000000}
!167 = distinct !{!167, !23}
!168 = distinct !{!168, !23}
!169 = !{i32 1, !70, i32 1, !16, i32 1, !50, i32 1, !81}
!170 = !{!171, !172, i1 false, i2 -1}
!171 = !{!"fixp", i32 -32, i32 11}
!172 = !{double 0.000000e+00, double 9.830400e+05}
!173 = !{!174, !172, i1 false, i2 -1}
!174 = !{!"fixp", i32 32, i32 12}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
