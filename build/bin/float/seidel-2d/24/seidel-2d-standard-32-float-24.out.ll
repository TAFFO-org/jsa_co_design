...
@.str = private unnamed_addr constant [48 x i8] c"target('A') scalar(range(3.2,641.599976) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay1, i32 noundef 32)
