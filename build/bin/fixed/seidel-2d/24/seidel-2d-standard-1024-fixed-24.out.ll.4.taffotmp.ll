; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-1024-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !143, !taffo.initweight !146
...
!94 = !{double 0x40699999A1FD156A, double 0x40E40CCCC0010C6F}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 15}
!98 = !{double 0x40733333397DD010, double 0x40EE1333200192A6}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 14}
!102 = !{double 0x40799999A1FD156A, double 0x40F40CCCC0010C6F}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 0x40800000053E2D62, double 0x40F90FFFF0014F8B}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 0x408CCCCCD63CB817, double 0x41068E6658012DFD}
...
!142 = !{!"fixp", i32 32, i32 21}
!143 = !{!144, !145, i1 false, i2 -1}
!144 = !{!"fixp", i32 32, i32 7}
!145 = !{double 0x40F99999A1FD156A, double 0x41740CCCC0010C6F}
!146 = !{i32 9}
!147 = distinct !{!147, !23}
!148 = distinct !{!148, !23}
