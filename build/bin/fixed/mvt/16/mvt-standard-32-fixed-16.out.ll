; ModuleID = './build/bin/fixed/mvt/16/mvt-standard-32-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %x1.u13_19fixp = alloca [20 x i32], align 4, !taffo.info !47, !taffo.target !49
  %x2.u13_19fixp = alloca [20 x i32], align 4, !taffo.info !50, !taffo.target !51
  %y_1.u5_27fixp = alloca [20 x i32], align 4, !taffo.info !44
  %y_2.u5_27fixp = alloca [20 x i32], align 4, !taffo.info !44
  %arraydecay.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x1.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay6.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x2.u13_19fixp, i32 0, i32 0, !taffo.info !50, !taffo.target !51
  ...
  call void @init_array.6_fixp(i32 20, i32* %arraydecay.u13_19fixp, i32* %arraydecay6.u13_19fixp, i32* %arraydecay7.u5_27fixp, i32* %arraydecay8.u5_27fixp, [20 x i32]* %arraydecay9.u5_27fixp), !taffo.info !52, !taffo.constinfo !53
  ...
  call void @scale_2d.7_fixp(i32 20, i32 20, i32* %u5_27fixp, i32 32), !taffo.info !52, !taffo.constinfo !54
  %arraydecay11.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x1.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  call void @scale_1d.1_fixp(i32 20, i32* %arraydecay11.u13_19fixp, i32 32), !taffo.info !55, !taffo.constinfo !56, !taffo.target !49
  %arraydecay12.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x2.u13_19fixp, i32 0, i32 0, !taffo.info !50, !taffo.target !51
  call void @scale_1d.1_fixp(i32 20, i32* %arraydecay12.u13_19fixp, i32 32), !taffo.info !57, !taffo.constinfo !56, !taffo.target !51
  %arraydecay13.u5_27fixp = getelementptr inbounds [20 x i32], [20 x i32]* %y_1.u5_27fixp, i32 0, i32 0, !taffo.info !44
  call void @scale_1d.3_fixp(i32 20, i32* %arraydecay13.u5_27fixp, i32 32), !taffo.info !52, !taffo.constinfo !56
  %arraydecay14.u5_27fixp = getelementptr inbounds [20 x i32], [20 x i32]* %y_2.u5_27fixp, i32 0, i32 0, !taffo.info !44
  call void @scale_1d.3_fixp(i32 20, i32* %arraydecay14.u5_27fixp, i32 32), !taffo.info !52, !taffo.constinfo !56
  call void @timer_start(), !taffo.constinfo !58
  %arraydecay15.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x1.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay16.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x2.u13_19fixp, i32 0, i32 0, !taffo.info !50, !taffo.target !51
  ...
  call void @kernel_mvt.4_fixp(i32 20, i32* %arraydecay15.u13_19fixp, i32* %arraydecay16.u13_19fixp, i32* %arraydecay17.u5_27fixp, i32* %arraydecay18.u5_27fixp, [20 x i32]* %arraydecay19.u5_27fixp), !taffo.info !52, !taffo.constinfo !53
...
for.body:                                         ; preds = %for.cond
  %arrayidx.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x1.u13_19fixp, i32 0, i32 %i.0, !taffo.info !47, !taffo.target !49
  %u13_19fixp1 = load i32, i32* %arrayidx.u13_19fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u13_19fixp1 to float, !taffo.info !47, !taffo.target !49
  ...
  %arrayidx21.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %x2.u13_19fixp, i32 0, i32 %i.0, !taffo.info !50, !taffo.target !51
  %u13_19fixp = load i32, i32* %arrayidx21.u13_19fixp, align 4, !taffo.info !50, !taffo.target !51
  %2 = uitofp i32 %u13_19fixp to float, !taffo.info !50, !taffo.target !51
  %3 = fdiv float %2, 5.242880e+05, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !81
  %0 = lshr i32 %u13_19fixp, 1, !taffo.info !47
  %1 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !81
  %2 = ashr i32 %0, 5, !taffo.info !47
  %3 = ashr i32 %1, 12, !taffo.info !81
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !83
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !86
  %arrayidx1.u13_19fixp = getelementptr inbounds i32, i32* %val.u13_19fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u18_14fixp, 5, !taffo.info !86
  store i32 %5, i32* %arrayidx1.u13_19fixp, align 4, !taffo.info !55
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !89 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 4, !taffo.info !81
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !90
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !93
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !44
  %5 = shl i32 %mul.u10_22fixp, 5, !taffo.info !93
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_mvt.4_fixp(i32 noundef %n, i32* noundef %x1.u13_19fixp, i32* noundef %x2.u13_19fixp, i32* noundef %y_1.u5_27fixp, i32* noundef %y_2.u5_27fixp, [20 x i32]* noundef %A.u5_27fixp) #0 !taffo.initweight !96 !taffo.funinfo !97 !taffo.sourceFunction !98 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx.u13_19fixp = getelementptr inbounds i32, i32* %x1.u13_19fixp, i32 %i.0, !taffo.info !47
  %u13_19fixp = load i32, i32* %arrayidx.u13_19fixp, align 4, !taffo.info !47
  ...
  %5 = lshr i32 %mul.u10_22fixp, 3, !taffo.info !101
  %add.u13_19fixp = add i32 %u13_19fixp, %5, !taffo.info !102
  %arrayidx7.u13_19fixp = getelementptr inbounds i32, i32* %x1.u13_19fixp, i32 %i.0, !taffo.info !47
  store i32 %add.u13_19fixp, i32* %arrayidx7.u13_19fixp, align 4, !taffo.info !55
  br label %for.inc
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx17.u13_19fixp = getelementptr inbounds i32, i32* %x2.u13_19fixp, i32 %i.1, !taffo.info !50
  %u13_19fixp1 = load i32, i32* %arrayidx17.u13_19fixp, align 4, !taffo.info !50
  ...
  %9 = ashr i32 %7, 5, !taffo.info !44
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 21), !taffo.info !99
  %mul21.u10_22fixp = shl i32 %10, 1, !taffo.info !101
  %11 = lshr i32 %mul21.u10_22fixp, 3, !taffo.info !101
  %add22.u13_19fixp = add i32 %u13_19fixp1, %11, !taffo.info !106
  %arrayidx23.u13_19fixp = getelementptr inbounds i32, i32* %x2.u13_19fixp, i32 %i.1, !taffo.info !50
  store i32 %add22.u13_19fixp, i32* %arrayidx23.u13_19fixp, align 4, !taffo.info !57
  br label %for.inc24
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6_fixp(i32 noundef %n, i32* noundef %x1.u13_19fixp, i32* noundef %x2.u13_19fixp, i32* noundef %y_1.u5_27fixp, i32* noundef %y_2.u5_27fixp, [20 x i32]* noundef %A.u5_27fixp) #0 !taffo.initweight !96 !taffo.funinfo !97 !taffo.sourceFunction !110 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv3.u5_27fixp = shl i32 %n, 27, !taffo.info !121
  %0 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !120
  %1 = lshr i32 %conv3.u5_27fixp, 1, !taffo.info !121
  %2 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %1, i32 26), !taffo.info !122
  %div.u1_31fixp = shl i32 %2, 5, !taffo.info !125
  %arrayidx.u13_19fixp = getelementptr inbounds i32, i32* %x1.u13_19fixp, i32 %i.0, !taffo.info !127
  %3 = lshr i32 %div.u1_31fixp, 12, !taffo.info !125
  store i32 %3, i32* %arrayidx.u13_19fixp, align 4, !taffo.info !128
  %add = add nsw i32 %i.0, 1, !taffo.info !129, !taffo.initweight !114, !taffo.constinfo !23
  %rem4 = srem i32 %add, %n, !taffo.info !118, !taffo.initweight !117
  %conv5.u5_27fixp = shl i32 %rem4, 27, !taffo.info !120
  %conv6.u5_27fixp = shl i32 %n, 27, !taffo.info !121
  %4 = lshr i32 %conv5.u5_27fixp, 1, !taffo.info !120
  %5 = lshr i32 %conv6.u5_27fixp, 1, !taffo.info !121
  %6 = call i32 @llvm.sdiv.fix.i32(i32 %4, i32 %5, i32 26), !taffo.info !122
  %div7.u1_31fixp = shl i32 %6, 5, !taffo.info !125
  %arrayidx8.u13_19fixp = getelementptr inbounds i32, i32* %x2.u13_19fixp, i32 %i.0, !taffo.info !130
  %7 = lshr i32 %div7.u1_31fixp, 12, !taffo.info !125
  store i32 %7, i32* %arrayidx8.u13_19fixp, align 4, !taffo.info !128
  %add9 = add nsw i32 %i.0, 3, !taffo.info !131, !taffo.initweight !114, !taffo.constinfo !23
  %rem10 = srem i32 %add9, %n, !taffo.info !118, !taffo.initweight !117
  %conv11.u5_27fixp = shl i32 %rem10, 27, !taffo.info !120
  %conv12.u5_27fixp = shl i32 %n, 27, !taffo.info !121
  %8 = lshr i32 %conv11.u5_27fixp, 1, !taffo.info !120
  %9 = lshr i32 %conv12.u5_27fixp, 1, !taffo.info !121
  %10 = call i32 @llvm.sdiv.fix.i32(i32 %8, i32 %9, i32 26), !taffo.info !122
  %div13.u1_31fixp = shl i32 %10, 5, !taffo.info !125
  %arrayidx14.u5_27fixp = getelementptr inbounds i32, i32* %y_1.u5_27fixp, i32 %i.0, !taffo.info !133
  %11 = lshr i32 %div13.u1_31fixp, 4, !taffo.info !125
  store i32 %11, i32* %arrayidx14.u5_27fixp, align 4, !taffo.info !128
  %add15 = add nsw i32 %i.0, 4, !taffo.info !134, !taffo.initweight !114, !taffo.constinfo !23
  %rem16 = srem i32 %add15, %n, !taffo.info !118, !taffo.initweight !117
  %conv17.u5_27fixp = shl i32 %rem16, 27, !taffo.info !120
  %conv18.u5_27fixp = shl i32 %n, 27, !taffo.info !121
  %12 = lshr i32 %conv17.u5_27fixp, 1, !taffo.info !120
  %13 = lshr i32 %conv18.u5_27fixp, 1, !taffo.info !121
  %14 = call i32 @llvm.sdiv.fix.i32(i32 %12, i32 %13, i32 26), !taffo.info !122
  %div19.u1_31fixp = shl i32 %14, 5, !taffo.info !125
  %arrayidx20.u5_27fixp = getelementptr inbounds i32, i32* %y_2.u5_27fixp, i32 %i.0, !taffo.info !133
  %15 = lshr i32 %div19.u1_31fixp, 4, !taffo.info !125
  store i32 %15, i32* %arrayidx20.u5_27fixp, align 4, !taffo.info !128
  br label %for.cond21
...
for.body24:                                       ; preds = %for.cond21
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !136, !taffo.initweight !114
  %rem25 = srem i32 %mul, %n, !taffo.info !118, !taffo.initweight !117
  %conv26.u5_27fixp = shl i32 %rem25, 27, !taffo.info !120
  %conv27.u5_27fixp = shl i32 %n, 27, !taffo.info !121
  %16 = lshr i32 %conv26.u5_27fixp, 1, !taffo.info !120
  %17 = lshr i32 %conv27.u5_27fixp, 1, !taffo.info !121
  %18 = call i32 @llvm.sdiv.fix.i32(i32 %16, i32 %17, i32 26), !taffo.info !122
  %div28.u1_31fixp = shl i32 %18, 5, !taffo.info !125
  %arrayidx29.u5_27fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u5_27fixp, i32 %i.0, !taffo.info !133
  %arrayidx30.u5_27fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx29.u5_27fixp, i32 0, i32 %j.0, !taffo.info !133
  %19 = lshr i32 %div28.u1_31fixp, 4, !taffo.info !125
  store i32 %19, i32* %arrayidx30.u5_27fixp, align 4, !taffo.info !128
  br label %for.inc

for.inc:                                          ; preds = %for.body24
  %inc = add nsw i32 %j.0, 1, !taffo.info !129, !taffo.initweight !114, !taffo.constinfo !23
...
for.inc31:                                        ; preds = %for.end
  %inc32 = add nsw i32 %i.0, 1, !taffo.info !129, !taffo.initweight !114, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !140 !taffo.funinfo !141 !taffo.sourceFunction !142 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !81
  %1 = lshr i32 %u5_27fixp, 1, !taffo.info !44
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !81
  %3 = ashr i32 %1, 5, !taffo.info !44
  %4 = ashr i32 %2, 4, !taffo.info !81
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !90
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !93
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !93
...
!1 = !{double 0.000000e+00, double 0x40B3B4CCE0008638}
!2 = !{i1 false, !3, i1 false, i2 0}
!3 = !{double 0.000000e+00, double 0x40B3F6665FFA3B9B}
...
!46 = !{double 0.000000e+00, double 3.040000e+01}
...
!100 = !{double 0.000000e+00, double 0x408CE147AE147AE1}
!101 = !{!94, !100, i1 false, i2 -1}
!102 = !{!48, !103, i1 false, i2 -1}
!103 = !{double 0.000000e+00, double 0x40B750F5D5C31594}
!104 = distinct !{!104, !25}
!105 = distinct !{!105, !25}
!106 = !{!48, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 0x40B7928F55BCCAF7}
!108 = distinct !{!108, !25}
!109 = distinct !{!109, !25}
!110 = distinct !{null}
...
!120 = !{!45, !119, i1 false, i2 1}
!121 = !{!45, !68, i1 false, i2 1}
...
!141 = !{i32 1, !67, i32 1, !67, i32 1, !44, i32 1, !78}
