...
entry:
  ...
  call void @llvm.var.annotation(i8* %alpha1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 116, i8* null)
  %beta2 = bitcast float* %beta to i8*
  call void @llvm.var.annotation(i8* %beta2, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 117, i8* null)
  %C3 = bitcast [16 x [16 x float]]* %C to i8*
  call void @llvm.var.annotation(i8* %C3, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 118, i8* null)
  %A4 = bitcast [16 x [10 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 119, i8* null)
  %B5 = bitcast [16 x [10 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B5, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 10, float* noundef %4, i32 noundef 256)
...
for.body29:                                       ; preds = %for.cond26
  ...
  %conv33 = sitofp i32 %rem32 to float
  %29 = load i32, i32* %m.addr, align 4
  %conv34 = sitofp i32 %29 to float
  ...
  store float %div35, float* %arrayidx39, align 4
  br label %for.inc40
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx28 = getelementptr inbounds [10 x float], [10 x float]* %28, i64 %idxprom27
  ...
  %mul31 = fmul float %mul26, %31
  %add = fadd float %mul21, %mul31
  %32 = load [16 x float]*, [16 x float]** %C.addr, align 8
  %33 = load i32, i32* %i, align 4
  %idxprom32 = sext i32 %33 to i64
  %arrayidx33 = getelementptr inbounds [16 x float], [16 x float]* %32, i64 %idxprom32
