; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-128-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u5_27fixp = bitcast [10 x i32]* %arraydecay15.u5_27fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u5_27fixp, i32 128), !taffo.info !62, !taffo.constinfo !61
  ...
  %u5_27fixp1 = bitcast [12 x i32]* %arraydecay19.u5_27fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u5_27fixp1, i32 128), !taffo.info !66, !taffo.constinfo !61
...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = fmul float 2.560000e+02, %mul.1flp, !taffo.info !257
