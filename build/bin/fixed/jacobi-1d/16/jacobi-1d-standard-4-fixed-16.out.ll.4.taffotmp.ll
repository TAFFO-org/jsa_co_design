; ModuleID = './build/bin/fixed/jacobi-1d/16/jacobi-1d-standard-4-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 4), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 4), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !81, !taffo.initweight !83
  %conv = sitofp i32 %factor to float, !taffo.info !84
  %mul = fmul float %0, %conv, !taffo.info !85, !taffo.initweight !87
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !41, !taffo.initweight !80
  store float %mul, float* %arrayidx1, align 4, !taffo.info !50, !taffo.initweight !83
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_1d.2(i32 noundef %tsteps, i32 noundef %n, float* noundef %A, float* noundef %B) #0 !taffo.initweight !89 !taffo.funinfo !90 !taffo.sourceFunction !58 {
entry:
  br label %for.cond
...
for.cond1:                                        ; preds = %for.inc, %for.body
  %i.0 = phi i32 [ 1, %for.body ], [ %inc, %for.inc ], !taffo.info !91
  %sub = sub nsw i32 %n, 1, !taffo.info !93, !taffo.constinfo !21
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !95, !taffo.initweight !83
  %arrayidx5 = getelementptr inbounds float, float* %A, i32 %i.0, !taffo.info !41, !taffo.initweight !80
  %1 = load float, float* %arrayidx5, align 4, !taffo.info !95, !taffo.initweight !83
  %add = fadd float %0, %1, !taffo.info !97, !taffo.initweight !87
  ...
  %2 = load float, float* %arrayidx7, align 4, !taffo.info !95, !taffo.initweight !83
  %add8 = fadd float %add, %2, !taffo.info !99, !taffo.initweight !87
  %conv = fpext float %add8 to double, !taffo.info !99, !taffo.initweight !101
  %mul = fmul double 3.333300e-01, %conv, !taffo.info !102, !taffo.initweight !104, !taffo.constinfo !105
  %conv9 = fptrunc double %mul to float, !taffo.info !108, !taffo.initweight !110
  %arrayidx10 = getelementptr inbounds float, float* %B, i32 %i.0, !taffo.info !46, !taffo.initweight !80
  store float %conv9, float* %arrayidx10, align 4, !taffo.info !55, !taffo.initweight !83
  br label %for.inc
...
for.cond11:                                       ; preds = %for.inc27, %for.end
  %i.1 = phi i32 [ 1, %for.end ], [ %inc28, %for.inc27 ], !taffo.info !91
  %sub12 = sub nsw i32 %n, 1, !taffo.info !93, !taffo.constinfo !21
...
for.body15:                                       ; preds = %for.cond11
  ...
  %3 = load float, float* %arrayidx17, align 4, !taffo.info !112, !taffo.initweight !83
  %arrayidx18 = getelementptr inbounds float, float* %B, i32 %i.1, !taffo.info !46, !taffo.initweight !80
  %4 = load float, float* %arrayidx18, align 4, !taffo.info !112, !taffo.initweight !83
  %add19 = fadd float %3, %4, !taffo.info !113, !taffo.initweight !87
  ...
  %5 = load float, float* %arrayidx21, align 4, !taffo.info !112, !taffo.initweight !83
  %add22 = fadd float %add19, %5, !taffo.info !115, !taffo.initweight !87
  %conv23 = fpext float %add22 to double, !taffo.info !115, !taffo.initweight !101
  %mul24 = fmul double 3.333300e-01, %conv23, !taffo.info !117, !taffo.initweight !104, !taffo.constinfo !105
  %conv25 = fptrunc double %mul24 to float, !taffo.info !119, !taffo.initweight !110
  %arrayidx26 = getelementptr inbounds float, float* %A, i32 %i.1, !taffo.info !41, !taffo.initweight !80
  store float %conv25, float* %arrayidx26, align 4, !taffo.info !50, !taffo.initweight !83
  br label %for.inc27

for.inc27:                                        ; preds = %for.body15
  %inc28 = add nsw i32 %i.1, 1, !taffo.info !19, !taffo.constinfo !21
  br label %for.cond11, !llvm.loop !121
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, float* noundef %A, float* noundef %B) #0 !taffo.initweight !123 !taffo.funinfo !124 !taffo.sourceFunction !53 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !125, !taffo.initweight !44
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !127, !taffo.initweight !51
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !125, !taffo.initweight !63

for.body:                                         ; preds = %for.cond
  %conv = sitofp i32 %i.0 to float, !taffo.info !128, !taffo.initweight !51
  %add = fadd float %conv, 2.000000e+00, !taffo.info !130, !taffo.initweight !63, !taffo.constinfo !132
  %conv2 = sitofp i32 %n to float, !taffo.info !133
  %div = fdiv float %add, %conv2, !taffo.info !135, !taffo.initweight !137
  %arrayidx = getelementptr inbounds float, float* %A, i32 %i.0, !taffo.info !138, !taffo.initweight !51
  store float %div, float* %arrayidx, align 4, !taffo.info !139, !taffo.initweight !63
  %conv3 = sitofp i32 %i.0 to float, !taffo.info !128, !taffo.initweight !51
  %add4 = fadd float %conv3, 3.000000e+00, !taffo.info !140, !taffo.initweight !63, !taffo.constinfo !142
  %conv5 = sitofp i32 %n to float, !taffo.info !133
  %div6 = fdiv float %add4, %conv5, !taffo.info !145, !taffo.initweight !137
  %arrayidx7 = getelementptr inbounds float, float* %B, i32 %i.0, !taffo.info !147, !taffo.initweight !51
  store float %div6, float* %arrayidx7, align 4, !taffo.info !139, !taffo.initweight !63
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !148, !taffo.initweight !51, !taffo.constinfo !21
...
!47 = !{double 8.000000e-01, double 0x401222220BC382A1}
...
!80 = !{i32 5}
!81 = !{!82, !43, i1 false, i2 -1}
!82 = !{!"fixp", i32 32, i32 27}
!83 = !{i32 6}
!84 = !{!82, !79, i1 false, i2 1}
!85 = !{!82, !86, i1 false, i2 -1}
!86 = !{double 0x400111105E1C1509, double 0x40311111276FB092}
!87 = !{i32 7}
!88 = distinct !{!88, !23}
!89 = !{i32 -1, i32 -1, i32 2, i32 2}
!90 = !{i32 1, !16, i32 1, !69, i32 1, !41, i32 1, !46}
!91 = !{i1 false, !92, i1 false, i2 0}
!92 = !{double 1.000000e+00, double 2.000000e+00}
!93 = !{i1 false, !94, i1 false, i2 0}
!94 = !{double 1.400000e+01, double 1.400000e+01}
!95 = !{!96, !43, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 28}
!97 = !{!96, !98, i1 false, i2 -1}
!98 = !{double 0x3FF111105E1C1509, double 0x40211111276FB092}
!99 = !{!96, !100, i1 false, i2 -1}
!100 = !{double 0x3FF999988D2A1F8E, double 0x40299999BB2788DB}
!101 = !{i32 8}
!102 = !{!96, !103, i1 false, i2 -1}
!103 = !{double 0x3FE111052ECCC9D8, double 0x40111105F81FE170}
!104 = !{i32 9}
!105 = !{!106, i1 false}
!106 = !{i1 false, !107, i1 false, i2 0}
!107 = !{double 3.333300e-01, double 3.333300e-01}
!108 = !{!42, !109, i1 false, i2 -1}
!109 = !{double 0x3FE1110520000000, double 0x4011110600000000}
!110 = !{i32 10}
!111 = distinct !{!111, !23}
!112 = !{!96, !47, i1 false, i2 -1}
!113 = !{!96, !114, i1 false, i2 -1}
!114 = !{double 1.600000e+00, double 0x402222220BC382A1}
!115 = !{!96, !116, i1 false, i2 -1}
!116 = !{double 0x4003333333333334, double 0x402B333311A543F2}
!117 = !{!96, !118, i1 false, i2 -1}
!118 = !{double 0x3FE99988D2A1F8E5, double 0x40122216297ED4CA}
!119 = !{!42, !120, i1 false, i2 -1}
!120 = !{double 0x3FE99988C0000000, double 0x4012221640000000}
!121 = distinct !{!121, !23}
!122 = distinct !{!122, !23}
!123 = !{i32 -1, i32 2, i32 2}
!124 = !{i32 1, !69, i32 1, !41, i32 1, !46}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double -1.500000e+01, double 1.500000e+01}
!127 = !{i1 false, !62, i1 false, i2 -1}
!128 = !{!129, !126, i1 false, i2 -1}
!129 = !{!"fixp", i32 -32, i32 26}
!130 = !{!129, !131, i1 false, i2 -1}
!131 = !{double -1.300000e+01, double 1.700000e+01}
!132 = !{i1 false, !19}
!133 = !{!134, !70, i1 false, i2 1}
!134 = !{!"fixp", i32 -32, i32 27}
!135 = !{!134, !136, i1 false, i2 -1}
!136 = !{double 0xBFEBBBBBBBBBBBBC, double 0x3FF2222222222222}
!137 = !{i32 4}
!138 = !{!42, !43, i1 false, i2 1}
!139 = !{i1 false, i1 false, i1 false, i2 1}
!140 = !{!129, !141, i1 false, i2 -1}
!141 = !{double -1.200000e+01, double 1.800000e+01}
!142 = !{i1 false, !143}
!143 = !{i1 false, !144, i1 false, i2 0}
!144 = !{double 3.000000e+00, double 3.000000e+00}
!145 = !{!134, !146, i1 false, i2 -1}
!146 = !{double -8.000000e-01, double 1.200000e+00}
!147 = !{!42, !47, i1 false, i2 1}
!148 = !{i1 false, !149, i1 false, i2 -1}
!149 = !{double -1.400000e+01, double 1.600000e+01}
!150 = distinct !{!150, !23}
