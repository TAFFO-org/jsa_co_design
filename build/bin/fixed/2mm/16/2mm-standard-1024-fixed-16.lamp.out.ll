; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-1024-fixed-16.out.ll'
...
entry:
  ...
  %u10_22fixp = bitcast [12 x i32]* %arraydecay12.u10_22fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 8, i32 12, i32* %u10_22fixp, i32 1024), !taffo.info !66, !taffo.constinfo !67
  ...
  %u10_22fixp3 = bitcast [14 x i32]* %arraydecay14.u10_22fixp to i32*, !taffo.info !55
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u10_22fixp3, i32 1024), !taffo.info !69, !taffo.constinfo !67
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim4 = and i32 %lampsim3, -256
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !234
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !240
  ...
  %6 = fmul float 5.120000e+02, %lampsim15, !taffo.info !240
  %lampsim16 = bitcast float %6 to i32
  %lampsim17 = and i32 %lampsim16, -256
  %lampsim18 = bitcast i32 %lampsim17 to float
  %7 = fptoui float %lampsim18 to i32, !taffo.info !240
