...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function kernel_trmm.2_fixp
.LCPI10_0:
...
.LCPI10_1:
	...
	.text
	.p2align	4, 0x90
	.type	kernel_trmm.2_fixp,@function
kernel_trmm.2_fixp:                     # @kernel_trmm.2_fixp
	.cfi_startproc
# %bb.0:                                # %entry
	pushl	%ebp
	.cfi_def_cfa_offset 8
...
.LBB10_12:                              # %for.end23
	...
	retl
.Lfunc_end10:
	.size	kernel_trmm.2_fixp, .Lfunc_end10-kernel_trmm.2_fixp
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function init_array.3_fixp
	.type	init_array.3_fixp,@function
init_array.3_fixp:                      # @init_array.3_fixp
	.cfi_startproc
# %bb.0:                                # %entry
	pushl	%ebp
	.cfi_def_cfa_offset 8
...
.LBB11_9:                               # %for.end
	...
	imull	$40, %ecx, %edx
	addl	%edx, %eax
	movl	$2097152, (%eax,%ecx,4)         # imm = 0x200000
	xorl	%eax, %eax
	movl	%eax, -80(%ebp)                 # 4-byte Spill
.LBB11_10:                              # %for.cond13
                                        #   Parent Loop BB11_1 Depth=1
...
.LBB11_15:                              # %for.end29
	...
	retl
.Lfunc_end11:
	.size	init_array.3_fixp, .Lfunc_end11-init_array.3_fixp
	.cfi_endproc
                                        # -- End function
...
.L.str.7:
	...
	.addrsig_sym kernel_trmm.2_fixp
	.addrsig_sym init_array.3_fixp
