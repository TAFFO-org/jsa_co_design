; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-64-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 64), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 64), !taffo.info !67, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.info !48, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 64), !taffo.info !68, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 64), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !69, !taffo.target !53, !taffo.originalCall !70
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !54, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 64), !taffo.info !72, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
...
!47 = !{double 6.400000e+01, double 0x40805851DFFC547A}
!48 = !{!49, !50, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 23}
!50 = !{double 0x407019999FE43676, double 2.880000e+02}
!51 = !{!52, !1, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 28}
!53 = !{!"x"}
!54 = !{!49, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x407019999FE43676}
...
!95 = !{double 6.400000e+01, double 6.400000e+01}
!96 = !{i32 5}
!97 = !{i32 6}
...
!102 = !{double 0x40D019999FE43676, double 1.843200e+04}
!103 = !{i32 7}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !85, i32 1, !51, i32 1, !94}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 22}
!108 = !{double 0xC0036DCA07F66E87, double 0x406FFCF893FAF428}
!109 = distinct !{!109, !23}
...
!116 = !{!"fixp", i32 -32, i32 12}
!117 = !{double 0x3F847AE147AE147C, double 0x4110B28B463B78B0}
!118 = !{i32 8}
!119 = !{!116, !120, i1 false, i2 -1}
!120 = !{double 0xC110B5AB463B78B0, double 1.999900e+02}
!121 = distinct !{!121, !23}
...
!131 = !{!"fixp", i32 -32, i32 13}
!132 = !{double 0.000000e+00, double 0x41007278CFD00C6E}
!133 = !{!131, !134, i1 false, i2 -1}
!134 = !{double 0xC10078B8CFD00C6E, double 2.000000e+02}
!135 = distinct !{!135, !23}
!136 = distinct !{!136, !23}
...
!144 = !{!"fixp", i32 -32, i32 19}
!145 = !{double 0xC033D9094AED99C8, double 0x40A056C5CDD0C3A5}
!146 = !{!144, !147, i1 false, i2 -1}
!147 = !{double 0xC0A1E6C5CDD0C3A5, double 0x406B7B21295DB339}
...
!209 = !{!"fixp", i32 32, i32 13}
!210 = !{!209, !211, i1 false, i2 -1}
!211 = !{double 6.401000e+01, double 0x4110BAB76F2B76DA}
!212 = distinct !{!212, !23}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = distinct !{!215, !23}
...
!220 = !{!"fixp", i32 32, i32 16}
!221 = !{double 6.400000e+00, double 0x40E05851DFFC547A}
!222 = !{i32 9}
!223 = distinct !{!223, !23}
!224 = distinct !{!224, !23}
