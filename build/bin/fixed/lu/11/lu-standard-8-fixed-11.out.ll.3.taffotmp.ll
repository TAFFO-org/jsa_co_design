; ModuleID = './build/bin/fixed/lu/11/lu-standard-8-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [47 x i8] c"target('A') scalar(range(0.1,65.379997) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 8), !taffo.initweight !55, !taffo.info !48, !taffo.target !50, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40505851DEEFE500}
...
!49 = !{double 1.000000e-01, double 0x40505851DEEFE500}
!50 = !{!"A"}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x3F847AE147AE147C, double 0x40B0B28B44170636}
!109 = !{i1 false, !110, i1 false, i2 1}
!110 = !{double 0xC0B0B271AA7D6C9C, double 0x405057AE07E5A78F}
!111 = distinct !{!111, !29}
!112 = !{i32 8}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3F590F4561865B7B, double 0x40846E6656ABDE40}
!115 = distinct !{!115, !29}
!116 = distinct !{!116, !29}
!117 = distinct !{!117, !29}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double 0.000000e+00, double 0x40B0B28B44170636}
...
!155 = !{double 8.000000e-01, double 0x40805851DEEFE500}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
