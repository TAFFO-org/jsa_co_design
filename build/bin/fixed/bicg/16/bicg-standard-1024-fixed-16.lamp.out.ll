; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-1024-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u23_9fixp1 = load i32, i32* %arrayidx.u23_9fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u23_9fixp1 to float, !taffo.info !47, !taffo.target !49
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u23_9fixp = load i32, i32* %arrayidx25.u23_9fixp, align 4, !taffo.info !50, !taffo.target !51
  %2 = uitofp i32 %u23_9fixp to float, !taffo.info !50, !taffo.target !51
