; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  %A.u13_19fixp = alloca [15 x [15 x i32]], align 4, !taffo.info !41, !taffo.target !44
  %B.u14_18fixp = alloca [15 x [15 x i32]], align 4, !taffo.info !45
  %arraydecay.u13_19fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %A.u13_19fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %arraydecay3.u14_18fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %B.u14_18fixp, i32 0, i32 0, !taffo.info !45
  call void @init_array.2_fixp(i32 15, [15 x i32]* %arraydecay.u13_19fixp, [15 x i32]* %arraydecay3.u14_18fixp), !taffo.info !48, !taffo.constinfo !49, !taffo.target !44
  %arraydecay4.u13_19fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %A.u13_19fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %u13_19fixp = bitcast [15 x i32]* %arraydecay4.u13_19fixp to i32*, !taffo.info !41, !taffo.target !44
  call void @scale_2d.3_fixp(i32 15, i32 15, i32* %u13_19fixp, i32 512), !taffo.info !48, !taffo.constinfo !50, !taffo.target !44
  %arraydecay5.u14_18fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %B.u14_18fixp, i32 0, i32 0, !taffo.info !45
  %u14_18fixp = bitcast [15 x i32]* %arraydecay5.u14_18fixp to i32*, !taffo.info !45
  call void @scale_2d.4_fixp(i32 15, i32 15, i32* %u14_18fixp, i32 512), !taffo.info !51, !taffo.constinfo !50
  call void @timer_start(), !taffo.constinfo !52
  %arraydecay6.u13_19fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %A.u13_19fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %arraydecay7.u14_18fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %B.u14_18fixp, i32 0, i32 0, !taffo.info !45
  call void @kernel_jacobi_2d.1_fixp(i32 10, i32 15, [15 x i32]* %arraydecay6.u13_19fixp, [15 x i32]* %arraydecay7.u14_18fixp), !taffo.info !48, !taffo.constinfo !50, !taffo.target !44
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx.u13_19fixp = getelementptr inbounds [15 x [15 x i32]], [15 x [15 x i32]]* %A.u13_19fixp, i32 0, i32 %i.0, !taffo.info !41, !taffo.target !44
  %arrayidx11.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41, !taffo.target !44
  %u13_19fixp1 = load i32, i32* %arrayidx11.u13_19fixp, align 4, !taffo.info !41, !taffo.target !44
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_jacobi_2d.1_fixp(i32 noundef %tsteps, i32 noundef %n, [15 x i32]* noundef %A.u13_19fixp, [15 x i32]* noundef %B.u14_18fixp) #0 !taffo.initweight !75 !taffo.funinfo !76 !taffo.sourceFunction !77 {
entry:
  br label %for.cond
...
for.body7:                                        ; preds = %for.cond4
  %arrayidx.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %arrayidx8.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp = load i32, i32* %arrayidx8.u13_19fixp, align 4, !taffo.info !82
  %arrayidx9.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %sub10 = sub nsw i32 %j.0, 1, !taffo.info !71, !taffo.constinfo !21
  %arrayidx11.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx9.u13_19fixp, i32 0, i32 %sub10, !taffo.info !41
  %u13_19fixp1 = load i32, i32* %arrayidx11.u13_19fixp, align 4, !taffo.info !82
  %0 = lshr i32 %u13_19fixp, 2, !taffo.info !82
  %1 = lshr i32 %u13_19fixp1, 2, !taffo.info !82
  %add.u15_17fixp = add i32 %0, %1, !taffo.info !83
  %arrayidx12.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !41
  %add13 = add nsw i32 1, %j.0, !taffo.info !19, !taffo.constinfo !21
  %arrayidx14.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx12.u13_19fixp, i32 0, i32 %add13, !taffo.info !41
  %u13_19fixp2 = load i32, i32* %arrayidx14.u13_19fixp, align 4, !taffo.info !86
  %2 = lshr i32 %u13_19fixp2, 2, !taffo.info !86
  %add15.u15_17fixp = add i32 %add.u15_17fixp, %2, !taffo.info !87
  %add16 = add nsw i32 1, %i.0, !taffo.info !19, !taffo.constinfo !21
  %arrayidx17.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %add16, !taffo.info !41
  %arrayidx18.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx17.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp3 = load i32, i32* %arrayidx18.u13_19fixp, align 4, !taffo.info !86
  %3 = lshr i32 %add15.u15_17fixp, 1, !taffo.info !87
  %4 = lshr i32 %u13_19fixp3, 3, !taffo.info !86
  %add19.u16_16fixp = add i32 %3, %4, !taffo.info !89
  %sub20 = sub nsw i32 %i.0, 1, !taffo.info !71, !taffo.constinfo !21
  %arrayidx21.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %sub20, !taffo.info !41
  %arrayidx22.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx21.u13_19fixp, i32 0, i32 %j.0, !taffo.info !41
  %u13_19fixp4 = load i32, i32* %arrayidx22.u13_19fixp, align 4, !taffo.info !41
  %5 = lshr i32 %u13_19fixp4, 3, !taffo.info !41
  %add23.u16_16fixp = add i32 %add19.u16_16fixp, %5, !taffo.info !92
  %6 = lshr i32 13421773, 1
  %7 = lshr i32 %add23.u16_16fixp, 1, !taffo.info !92
  %8 = ashr i32 %6, 10
  %9 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %7, i32 15), !taffo.info !94
  %mul.u13_19fixp = shl i32 %9, 4, !taffo.info !97, !taffo.constinfo !98
  %arrayidx24.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %i.0, !taffo.info !45
  %arrayidx25.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx24.u14_18fixp, i32 0, i32 %j.0, !taffo.info !45
  %10 = lshr i32 %mul.u13_19fixp, 1, !taffo.info !97, !taffo.constinfo !98
  store i32 %10, i32* %arrayidx25.u14_18fixp, align 4, !taffo.info !51
  br label %for.inc
...
for.body36:                                       ; preds = %for.cond33
  %arrayidx37.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %i.1, !taffo.info !45
  %arrayidx38.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx37.u14_18fixp, i32 0, i32 %j.1, !taffo.info !45
  %u14_18fixp = load i32, i32* %arrayidx38.u14_18fixp, align 4, !taffo.info !103
  %arrayidx39.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %i.1, !taffo.info !45
  %sub40 = sub nsw i32 %j.1, 1, !taffo.info !71, !taffo.constinfo !21
  %arrayidx41.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx39.u14_18fixp, i32 0, i32 %sub40, !taffo.info !45
  %u14_18fixp5 = load i32, i32* %arrayidx41.u14_18fixp, align 4, !taffo.info !103
  %11 = lshr i32 %u14_18fixp, 1, !taffo.info !103
  %12 = lshr i32 %u14_18fixp5, 1, !taffo.info !103
  %add42.u15_17fixp = add i32 %11, %12, !taffo.info !104
  %arrayidx43.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %i.1, !taffo.info !45
  %add44 = add nsw i32 1, %j.1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx45.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx43.u14_18fixp, i32 0, i32 %add44, !taffo.info !45
  %u14_18fixp6 = load i32, i32* %arrayidx45.u14_18fixp, align 4, !taffo.info !103
  %13 = lshr i32 %add42.u15_17fixp, 1, !taffo.info !104
  %14 = lshr i32 %u14_18fixp6, 2, !taffo.info !103
  %add46.u16_16fixp = add i32 %13, %14, !taffo.info !106
  %add47 = add nsw i32 1, %i.1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx48.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %add47, !taffo.info !45
  %arrayidx49.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx48.u14_18fixp, i32 0, i32 %j.1, !taffo.info !45
  %u14_18fixp7 = load i32, i32* %arrayidx49.u14_18fixp, align 4, !taffo.info !108
  %15 = lshr i32 %u14_18fixp7, 2, !taffo.info !108
  %add50.u16_16fixp = add i32 %add46.u16_16fixp, %15, !taffo.info !109
  %sub51 = sub nsw i32 %i.1, 1, !taffo.info !71, !taffo.constinfo !21
  %arrayidx52.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %sub51, !taffo.info !45
  %arrayidx53.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx52.u14_18fixp, i32 0, i32 %j.1, !taffo.info !45
  %u14_18fixp8 = load i32, i32* %arrayidx53.u14_18fixp, align 4, !taffo.info !108
  %16 = lshr i32 %u14_18fixp8, 2, !taffo.info !108
  %add54.u16_16fixp = add i32 %add50.u16_16fixp, %16, !taffo.info !111
  %17 = lshr i32 13421773, 1
  %18 = lshr i32 %add54.u16_16fixp, 1, !taffo.info !111
  %19 = ashr i32 %17, 10
  %20 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %18, i32 15), !taffo.info !113
  %mul55.u16_16fixp = shl i32 %20, 1, !taffo.info !115, !taffo.constinfo !98
  %arrayidx56.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %i.1, !taffo.info !41
  %arrayidx57.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx56.u13_19fixp, i32 0, i32 %j.1, !taffo.info !41
  %21 = shl i32 %mul55.u16_16fixp, 3, !taffo.info !115, !taffo.constinfo !98
  store i32 %21, i32* %arrayidx57.u13_19fixp, align 4, !taffo.info !48
  br label %for.inc58
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.2_fixp(i32 noundef %n, [15 x i32]* noundef %A.u13_19fixp, [15 x i32]* noundef %B.u14_18fixp) #0 !taffo.initweight !119 !taffo.funinfo !120 !taffo.sourceFunction !121 {
entry:
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !145
  %arrayidx9.u13_19fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !145
  %6 = ashr i32 %div.s6_26fixp, 7, !taffo.info !144
  store i32 %6, i32* %arrayidx9.u13_19fixp, align 4, !taffo.info !146
  ...
  %arrayidx17.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %B.u14_18fixp, i32 %i.0, !taffo.info !160
  %arrayidx18.u14_18fixp = getelementptr inbounds [15 x i32], [15 x i32]* %arrayidx17.u14_18fixp, i32 0, i32 %j.0, !taffo.info !160
  %13 = ashr i32 %div16.s6_26fixp, 8, !taffo.info !159
  store i32 %13, i32* %arrayidx18.u14_18fixp, align 4, !taffo.info !146
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !166 !taffo.sourceFunction !169 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !170
  %1 = lshr i32 %u13_19fixp, 1, !taffo.info !41
  %2 = lshr i32 %conv.u10_22fixp, 1, !taffo.info !170
  %3 = ashr i32 %1, 9, !taffo.info !41
  %4 = ashr i32 %2, 12, !taffo.info !170
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 9), !taffo.info !172
  %mul.u22_10fixp = shl i32 %5, 1, !taffo.info !175
  ...
  %7 = shl i32 %mul.u22_10fixp, 9, !taffo.info !175
  store i32 %7, i32* %arrayidx6.u13_19fixp, align 4, !taffo.info !48
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !179 !taffo.sourceFunction !169 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !71
  %arrayidx.u14_18fixp = getelementptr inbounds i32, i32* %val.u14_18fixp, i32 %0, !taffo.info !45
  %arrayidx4.u14_18fixp = getelementptr inbounds i32, i32* %arrayidx.u14_18fixp, i32 %j.0, !taffo.info !45
  %u14_18fixp = load i32, i32* %arrayidx4.u14_18fixp, align 4, !taffo.info !45
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !170
  %1 = lshr i32 %u14_18fixp, 1, !taffo.info !45
  %2 = lshr i32 %conv.u10_22fixp, 1, !taffo.info !170
  %3 = ashr i32 %1, 9, !taffo.info !45
  %4 = ashr i32 %2, 13, !taffo.info !170
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 8), !taffo.info !180
  %mul.u23_9fixp = shl i32 %5, 1, !taffo.info !183
  %6 = mul nsw i32 %i.0, %m, !taffo.info !71
  %arrayidx5.u14_18fixp = getelementptr inbounds i32, i32* %val.u14_18fixp, i32 %6, !taffo.info !45
  %arrayidx6.u14_18fixp = getelementptr inbounds i32, i32* %arrayidx5.u14_18fixp, i32 %j.0, !taffo.info !45
  %7 = shl i32 %mul.u23_9fixp, 9, !taffo.info !183
  store i32 %7, i32* %arrayidx6.u14_18fixp, align 4, !taffo.info !51
  br label %for.inc
...
!1 = !{double 0.000000e+00, double 0x40BE22222003AB86}
...
!43 = !{double 0x405111111F0C34C2, double 0x40BE22222003AB86}
!44 = !{!"A"}
!45 = !{!46, !47, i1 false, i2 -1}
!46 = !{!"fixp", i32 32, i32 18}
!47 = !{double 0x40599999A1FD156A, double 0x40C011111FFF79C8}
...
!85 = !{double 0x406111111F0C34C2, double 0x40CE22222003AB86}
!86 = !{!84, !43, i1 false, i2 -1}
!87 = !{!84, !88, i1 false, i2 -1}
!88 = !{double 0x40699999AE924F23, double 0x40D699999802C0A4}
!89 = !{!90, !91, i1 false, i2 -1}
!90 = !{!"fixp", i32 32, i32 16}
!91 = !{double 0x407111111F0C34C2, double 0x40DE22222003AB86}
!92 = !{!90, !93, i1 false, i2 -1}
!93 = !{double 0x4075555566CF41F2, double 0x40E2D55554024B34}
!94 = !{!95, !96, i1 false, i2 -1}
!95 = !{!"fixp", i32 -32, i32 15}
!96 = !{double 0x4051111123507909, double 0x40BE2222278C340E}
...
!105 = !{double 0x40699999A1FD156A, double 0x40D011111FFF79C8}
!106 = !{!90, !107, i1 false, i2 -1}
!107 = !{double 0x40733333397DD010, double 0x40D81999AFFF36AC}
!108 = !{!90, !47, i1 false, i2 -1}
!109 = !{!90, !110, i1 false, i2 -1}
!110 = !{double 0x40799999A1FD156A, double 0x40E011111FFF79C8}
!111 = !{!90, !112, i1 false, i2 -1}
!112 = !{double 0x40800000053E2D62, double 0x40E4155567FF583A}
!113 = !{!95, !114, i1 false, i2 -1}
!114 = !{double 0x40599999A8637BD2, double 0x40C011112403BE10}
...
!173 = !{!"fixp", i32 -32, i32 9}
!174 = !{double 0x40E111111F0C34C2, double 0x414E22222003AB86}
...
!182 = !{double 0x40E99999A1FD156A, double 0x415011111FFF79C8}
!183 = !{!184, !182, i1 false, i2 -1}
!184 = !{!"fixp", i32 32, i32 9}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
