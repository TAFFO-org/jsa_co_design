; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-4-fixed-16.out.ll'
...
entry:
  ...
  %u1_31fixp4 = bitcast [8 x i32]* %arraydecay16.u1_31fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u1_31fixp4, i32 4), !taffo.info !62, !taffo.constinfo !60
  %arraydecay17.u2_30fixp = getelementptr inbounds [8 x [12 x i32]], [8 x [12 x i32]]* %F.u2_30fixp, i32 0, i32 0, !taffo.info !49
  %u2_30fixp3 = bitcast [12 x i32]* %arraydecay17.u2_30fixp to i32*, !taffo.info !49
  call void @scale_2d.3_fixp(i32 8, i32 12, i32* %u2_30fixp3, i32 4), !taffo.info !63, !taffo.constinfo !60
  ...
  %u1_31fixp = bitcast [12 x i32]* %arraydecay19.u1_31fixp to i32*, !taffo.info !53
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u1_31fixp, i32 4), !taffo.info !65, !taffo.constinfo !60
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !222 !taffo.funinfo !235 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.u3_29fixp = shl i32 %4, 1, !taffo.info !238
  %5 = mul nsw i32 %i.0, %m, !taffo.info !88
  ...
  %6 = shl i32 %mul.u3_29fixp, 1, !taffo.info !238
...
!233 = distinct !{!233, !23}
!234 = distinct !{!234, !23}
!235 = !{i32 1, !82, i32 1, !95, i32 1, !41, i32 1, !224}
!236 = !{!230, !237, i1 false, i2 -1}
!237 = !{double 0.000000e+00, double 0x401BBBBB62413DB8}
!238 = !{!120, !237, i1 false, i2 -1}
!239 = distinct !{!239, !23}
!240 = distinct !{!240, !23}
