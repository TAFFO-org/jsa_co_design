; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-8-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 8), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 8), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 8), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
for.body10:                                       ; preds = %for.cond8
  ...
  %mul16 = fmul float %mul13, %2, !taffo.info !115, !taffo.initweight !108
  ...
  %add = fadd float %3, %mul16, !taffo.info !117, !taffo.initweight !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, float* noundef %alpha, float* noundef %beta, [12 x float]* noundef %C, [16 x float]* noundef %A, [12 x float]* noundef %B) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !62 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !60, !taffo.initweight !82, !taffo.constinfo !124
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !65, !taffo.initweight !82, !taffo.constinfo !126
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %rem = srem i32 %add, %ni, !taffo.info !138, !taffo.initweight !82
  %conv = sitofp i32 %rem to float, !taffo.info !140, !taffo.initweight !107
  %conv6 = sitofp i32 %ni to float, !taffo.info !141
  %div = fdiv float %conv, %conv6, !taffo.info !142, !taffo.initweight !108
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %C, i32 %i.0, !taffo.info !145, !taffo.initweight !66
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !145, !taffo.initweight !66
  store float %div, float* %arrayidx7, align 4, !taffo.info !146, !taffo.initweight !68
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
...
for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !151, !taffo.initweight !66
  %rem21 = srem i32 %mul20, %nk, !taffo.info !153, !taffo.initweight !68
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !155, !taffo.initweight !82
  %conv23 = sitofp i32 %nk to float, !taffo.info !156
  %div24 = fdiv float %conv22, %conv23, !taffo.info !158, !taffo.initweight !107
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.1, !taffo.info !160, !taffo.initweight !66
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.info !160, !taffo.initweight !66
  store float %div24, float* %arrayidx26, align 4, !taffo.info !146, !taffo.initweight !68
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.info !163, !taffo.initweight !66, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !165, !taffo.initweight !66
  %rem43 = srem i32 %mul42, %nj, !taffo.info !167, !taffo.initweight !68
  %conv44 = sitofp i32 %rem43 to float, !taffo.info !168, !taffo.initweight !82
  %conv45 = sitofp i32 %nj to float, !taffo.info !169
  %div46 = fdiv float %conv44, %conv45, !taffo.info !170, !taffo.initweight !107
  %arrayidx47 = getelementptr inbounds [12 x float], [12 x float]* %B, i32 %i.2, !taffo.info !172, !taffo.initweight !66
  %arrayidx48 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx47, i32 0, i32 %j.2, !taffo.info !172, !taffo.initweight !66
  store float %div46, float* %arrayidx48, align 4, !taffo.info !146, !taffo.initweight !68
  br label %for.inc49

for.inc49:                                        ; preds = %for.body40
  %inc50 = add nsw i32 %j.2, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc52:                                        ; preds = %for.end51
  %inc53 = add nsw i32 %i.2, 1, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !175 !taffo.funinfo !176 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !177
  %conv = sitofp i32 %factor to float, !taffo.info !178
  %mul = fmul float %1, %conv, !taffo.info !179, !taffo.initweight !182
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !67, !taffo.initweight !177
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !175 !taffo.funinfo !185 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !186, !taffo.initweight !177
  %conv = sitofp i32 %factor to float, !taffo.info !188
  %mul = fmul float %1, %conv, !taffo.info !189, !taffo.initweight !182
  %2 = mul nsw i32 %i.0, %m, !taffo.info !95
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !71, !taffo.initweight !177
  br label %for.inc
...
!55 = !{double 0.000000e+00, double 0x401D55553EF6B5D4}
...
!111 = !{double 0.000000e+00, double 0x407E9374B39BA35F}
!112 = distinct !{!112, !23}
!113 = !{!52, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 1.125000e+01}
!115 = !{!49, !116, i1 false, i2 -1}
!116 = !{double 0.000000e+00, double 0x40549FFFF04577D9}
!117 = !{!49, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 0x407EA2E13C68661B}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = !{i32 -1, i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!123 = !{i32 1, !16, i32 1, !91, i32 1, !105, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!124 = !{!125, i1 false}
...
!140 = !{!52, !139, i1 false, i2 1}
!141 = !{!52, !17, i1 false, i2 1}
...
!155 = !{!52, !154, i1 false, i2 1}
!156 = !{!157, !106, i1 false, i2 1}
!157 = !{!"fixp", i32 32, i32 27}
!158 = !{!143, !159, i1 false, i2 1}
...
!167 = !{i1 false, !77, i1 false, i2 1}
!168 = !{!52, !77, i1 false, i2 1}
!169 = !{!52, !92, i1 false, i2 1}
!170 = !{!143, !171, i1 false, i2 1}
!171 = !{double 0.000000e+00, double 0x3FED555555555555}
!172 = !{!52, !55, i1 false, i2 1}
!173 = distinct !{!173, !23}
!174 = distinct !{!174, !23}
!175 = !{i32 -1, i32 -1, i32 3, i32 -1}
!176 = !{i32 1, !16, i32 1, !91, i32 1, !48, i32 1, !101}
!177 = !{i32 8}
!178 = !{!52, !102, i1 false, i2 1}
!179 = !{!180, !181, i1 false, i2 -1}
!180 = !{!"fixp", i32 32, i32 20}
!181 = !{double 0.000000e+00, double 0x40A97AE140570825}
!182 = !{i32 9}
!183 = distinct !{!183, !23}
!184 = distinct !{!184, !23}
!185 = !{i32 1, !16, i32 1, !105, i32 1, !51, i32 1, !101}
!186 = !{!187, !53, i1 false, i2 -1}
!187 = !{!"fixp", i32 32, i32 26}
!188 = !{!187, !102, i1 false, i2 1}
!189 = !{!187, !190, i1 false, i2 -1}
!190 = !{double 0.000000e+00, double 6.000000e+01}
!191 = distinct !{!191, !23}
!192 = distinct !{!192, !23}
