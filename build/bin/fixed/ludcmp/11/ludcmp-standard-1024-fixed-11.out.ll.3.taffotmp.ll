; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-1024-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [37 x i8] c"scalar(range(0.1,8368.639648) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [40 x i8] c"scalar(range(1024.0,8368.639648) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [40 x i8] c"scalar(range(4121.600098,4608.0) final)\00", section "llvm.metadata", !taffo.info !0
...
@.str.5 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,4121.600098) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 1024), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !59, !taffo.info !53
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 1024), !taffo.initweight !60, !taffo.info !53, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 1024), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!50 = !{double 1.000000e-01, double 0x40C05851DFFC547A}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 1.024000e+03, double 0x40C05851DFFC547A}
!53 = !{i1 false, !54, i1 false, i2 -1}
!54 = !{double 0x40B01999A005C465, double 4.608000e+03}
!55 = !{i1 false, !7, i1 false, i2 -1}
!56 = !{!"x"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x40B01999A005C465}
!59 = !{i32 1}
!60 = !{i32 2}
...
!132 = !{double 0x41501999A005C465, double 0x4152000000000000}
!133 = distinct !{!133, !29}
!134 = !{i32 1, !123, i32 1, !55, i32 1, !128}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0xC0436DCA07F66E87, double 0x40AFFCF893FAF428}
!137 = distinct !{!137, !29}
!138 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!139 = !{i32 1, !123, i32 1, !49, i32 1, !53, i32 1, !55, i32 1, !57}
!140 = !{i32 8}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0x3F847AE147AE147C, double 0x4190B28B463B78B0}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC190B28E663B78B0, double 1.999900e+02}
!145 = distinct !{!145, !29}
...
!153 = !{double 0.000000e+00, double 0x41807278CFF25395}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0xC180727F0FF25395, double 2.000000e+02}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
...
!165 = !{double 0xC073D9094AED99C8, double 0x40E056C5CDD0C3A5}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 0xC0E06FC5CDD0C3A5, double 0x40802C84A576CCE4}
...
!176 = !{double 0.000000e+00, double 0x41501999A005C465}
!177 = distinct !{!177, !29}
...
!215 = !{double 1.024010e+03, double 0x4190B30E08CA7893}
!216 = distinct !{!216, !29}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = distinct !{!219, !29}
...
!225 = !{double 1.024000e+02, double 0x41605851DFFC547A}
!226 = distinct !{!226, !29}
!227 = distinct !{!227, !29}
!228 = !{i32 1, !123, i32 1, !123, i32 1, !51, i32 1, !128}
!229 = !{i1 false, !230, i1 false, i2 -1}
!230 = !{double 0x4130000000000000, double 0x41605851DFFC547A}
!231 = distinct !{!231, !29}
!232 = distinct !{!232, !29}
