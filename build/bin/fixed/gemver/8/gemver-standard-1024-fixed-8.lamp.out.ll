; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-1024-fixed-8.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 8.000000e+00, !taffo.info !69
...
for.body43:                                       ; preds = %for.cond41
  ...
  %3 = fdiv float %lampsim8, 8.192000e+03, !taffo.info !52
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !125
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !126
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !127
  %0 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !127
  %lampsim = bitcast float %0 to i32
  %lampsim1 = and i32 %lampsim, -65536
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !127
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -65536
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !129
  %lampsim7 = bitcast float %mul.1flp6 to i32
  %lampsim8 = and i32 %lampsim7, -65536
  %lampsim9 = bitcast i32 %lampsim8 to float
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !125
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !133 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = lshr i32 %conv.u11_21fixp, 1, !taffo.info !127
  %2 = ashr i32 %0, 10, !taffo.info !62
  %3 = ashr i32 %1, 7, !taffo.info !127
  ...
  %5 = shl i32 %mul.u18_14fixp, 10, !taffo.info !137
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !140 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 9, !taffo.info !127
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !141
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !144
  %arrayidx1.u10_22fixp = getelementptr inbounds i32, i32* %val.u10_22fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u20_12fixp, 10, !taffo.info !144
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u29_3fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !147 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !127
  %2 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !127
  %lampsim6 = bitcast float %2 to i32
  %lampsim7 = and i32 %lampsim6, -65536
  %lampsim8 = bitcast i32 %lampsim7 to float
  %3 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !127
  %lampsim9 = bitcast float %3 to i32
  %lampsim10 = and i32 %lampsim9, -65536
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !152 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 8, !taffo.info !127
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !153
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !156
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u19_13fixp, 10, !taffo.info !156
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !158 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 6, !taffo.info !127
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 14), !taffo.info !159
  %mul.u17_15fixp = shl i32 %4, 1, !taffo.info !162
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u17_15fixp, 10, !taffo.info !162
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u19_13fixp = load i32, i32* %arrayidx4.u19_13fixp, align 4, !taffo.info !168
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !169
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !171
  %5 = lshr i32 %u19_13fixp, 1, !taffo.info !168
  %add.u20_12fixp = add i32 %5, %mul.u20_12fixp, !taffo.info !172
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 14), !taffo.info !174
  %mul9.u17_15fixp = shl i32 %10, 1, !taffo.info !176
  %11 = lshr i32 %mul9.u17_15fixp, 3, !taffo.info !176
  %add10.u20_12fixp = add i32 %add.u20_12fixp, %11, !taffo.info !177
  ...
  %12 = shl i32 %add10.u20_12fixp, 1, !taffo.info !177
...
for.body21:                                       ; preds = %for.cond19
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 12), !taffo.info !181
  %mul25.u19_13fixp = shl i32 %16, 1, !taffo.info !183
  ...
  %17 = lshr i32 %mul25.u19_13fixp, 1, !taffo.info !183
  %18 = lshr i32 %u8_24fixp4, 1, !taffo.info !71
  %19 = ashr i32 %17, 7, !taffo.info !183
  %20 = ashr i32 %18, 18, !taffo.info !71
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 5), !taffo.info !184
  %mul27.u26_6fixp = shl i32 %21, 1, !taffo.info !187
  %22 = lshr i32 %mul27.u26_6fixp, 3, !taffo.info !187
  %add28.u29_3fixp = add i32 %u29_3fixp, %22, !taffo.info !189
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u29_3fixp = add i32 %u29_3fixp2, %23, !taffo.info !193
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !125
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !126
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 12), !taffo.info !196
  %mul55.u19_13fixp = shl i32 %27, 1, !taffo.info !198
  %28 = uitofp i32 %mul55.u19_13fixp to float, !taffo.info !198
  %lampsim = bitcast float %28 to i32
  %lampsim1 = and i32 %lampsim, -65536
  %lampsim2 = bitcast i32 %lampsim1 to float
  %29 = fdiv float %lampsim2, 8.192000e+03, !taffo.info !198
  ...
  %lampsim7 = and i32 %lampsim6, -65536
  %lampsim8 = bitcast i32 %lampsim7 to float
  %31 = fdiv float %lampsim8, 8.000000e+00, !taffo.info !69
  ...
  %lampsim18 = and i32 %lampsim17, -65536
  %lampsim19 = bitcast i32 %lampsim18 to float
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !125
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u19_13fixp, i32* noundef %u1.u10_22fixp, i32* noundef %v1.u9_23fixp, i32* noundef %u2.u10_22fixp, i32* noundef %v2.u8_24fixp, float* noundef %w, i32* noundef %x.u29_3fixp, i32* noundef %y.u8_24fixp, i32* noundef %z.u7_25fixp) #0 !taffo.initweight !207 !taffo.funinfo !166 !taffo.sourceFunction !208 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u11_21fixp, 1, !taffo.info !127
  %3 = ashr i32 %1, 10, !taffo.info !52
  %4 = ashr i32 %2, 18, !taffo.info !127
...
!123 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!124 = !{void (i32, float*, i32)* @scale_1d}
!125 = !{i32 5}
!126 = !{i32 6}
!127 = !{!128, !120, i1 false, i2 1}
!128 = !{!"fixp", i32 32, i32 21}
!129 = !{!130, !131, i1 false, i2 -1}
!130 = !{!"float", i32 1, double 0x43B2D0EAC0000000}
!131 = !{double 0.000000e+00, double 0x43B2D0EAC0000000}
!132 = distinct !{!132, !27}
!133 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 -32, i32 13}
!136 = !{double 0x40C11111276FB092, double 0x410555556084A516}
!137 = !{!138, !136, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 14}
!139 = distinct !{!139, !27}
!140 = !{i32 1, !107, i32 1, !54, i32 1, !119}
!141 = !{!142, !143, i1 false, i2 -1}
!142 = !{!"fixp", i32 -32, i32 11}
!143 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!144 = !{!145, !143, i1 false, i2 -1}
!145 = !{!"fixp", i32 32, i32 12}
!146 = distinct !{!146, !27}
!147 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!148 = !{!149, !150, i1 false, i2 -1}
!149 = !{!"float", i32 1, double 0x4255BC5260000000}
!150 = !{double 0.000000e+00, double 0x4255BC5260000000}
!151 = distinct !{!151, !27}
!152 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!153 = !{!154, !155, i1 false, i2 -1}
!154 = !{!"fixp", i32 -32, i32 12}
!155 = !{double 1.310720e+04, double 2.621440e+05}
!156 = !{!53, !155, i1 false, i2 -1}
!157 = distinct !{!157, !27}
!158 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!159 = !{!160, !161, i1 false, i2 -1}
!160 = !{!"fixp", i32 -32, i32 14}
!161 = !{double 0x40B6C16C1E364BEC, double 0x40FC71C7219220FF}
!162 = !{!163, !161, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 15}
!164 = distinct !{!164, !27}
...
!167 = distinct !{null}
!168 = !{!145, !5, i1 false, i2 -1}
!169 = !{!142, !170, i1 false, i2 -1}
!170 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!171 = !{!145, !170, i1 false, i2 -1}
!172 = !{!145, !173, i1 false, i2 -1}
!173 = !{double 0.000000e+00, double 0x4121DE444806F262}
!174 = !{!160, !175, i1 false, i2 -1}
!175 = !{double 0x406B4E81D8B2B41D, double 0x40F555556084A516}
!176 = !{!163, !175, i1 false, i2 -1}
!177 = !{!145, !178, i1 false, i2 -1}
!178 = !{double 0x406B4E81D8B2B41D, double 0x412488EEF4178705}
!179 = distinct !{!179, !27}
!180 = distinct !{!180, !27}
!181 = !{!154, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 0x4118A4CCD9999999}
!183 = !{!53, !182, i1 false, i2 -1}
!184 = !{!185, !186, i1 false, i2 -1}
!185 = !{!"fixp", i32 -32, i32 5}
!186 = !{double 0.000000e+00, double 0x4188A4CCD9999999}
!187 = !{!188, !186, i1 false, i2 -1}
!188 = !{!"fixp", i32 32, i32 6}
!189 = !{!70, !190, i1 false, i2 -1}
!190 = !{double 0.000000e+00, double 0x41B8D0EBFB333333}
!191 = distinct !{!191, !27}
!192 = distinct !{!192, !27}
!193 = !{!70, !194, i1 false, i2 -1}
!194 = !{double 0x4016C16C1E364BEC, double 0x41B5BC52D1C71C86}
!195 = distinct !{!195, !27}
!196 = !{!154, !197, i1 false, i2 -1}
!197 = !{double 0.000000e+00, double 0x411ECE0010000000}
!198 = !{!53, !197, i1 false, i2 -1}
!199 = !{!200, !201, i1 false, i2 -1}
!200 = !{!"float", i32 1, double 0x42E4EC7997282930}
!201 = !{double 0.000000e+00, double 0x42E4EC7997282930}
!202 = !{!203, !204, i1 false, i2 -1}
!203 = !{!"float", i32 1, double 0x43156E79F2E50526}
!204 = !{double 0.000000e+00, double 0x43156E79F2E50526}
!205 = distinct !{!205, !27}
!206 = distinct !{!206, !27}
