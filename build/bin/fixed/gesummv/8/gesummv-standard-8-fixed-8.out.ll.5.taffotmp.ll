; ModuleID = './build/bin/fixed/gesummv/8/gesummv-standard-8-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4150000000000000, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !106 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u13_19fixp, 3, !taffo.info !110
...
!105 = distinct !{!105, !23}
!106 = !{i32 1, !75, i32 1, !54, i32 1, !84}
!107 = !{!108, !109, i1 false, i2 -1}
!108 = !{!"fixp", i32 -32, i32 18}
!109 = !{double 0.000000e+00, double 0x40B6A66680171194}
...
!155 = distinct !{null}
!156 = !{!102, !157, i1 false, i2 -1}
!157 = !{double 0.000000e+00, double 5.625000e+01}
!158 = !{!99, !157, i1 false, i2 -1}
