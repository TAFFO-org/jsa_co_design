; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-32-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 32), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 32), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
!48 = !{double 6.400000e+00, double 0x408011112018A43C}
...
!97 = !{double 0x40211111276FB092, double 0x408E22221FAFC8B0}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x40299999BB2788DB, double 0x4096999997C3D684}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 20}
!104 = !{double 0x40311111276FB092, double 0x409E22221FAFC8B0}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x40355555714B9CB6, double 0x40A2D55553CDDD6E}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x401111112BB3F4DB, double 0x407E222227385138}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 1.280000e+01, double 0x409011112018A43C}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x4033333333333334, double 0x40981999B024F65A}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 2.560000e+01, double 0x40A011112018A43C}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 3.200000e+01, double 0x40A41555681ECD4B}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x40199999A0000000, double 0x40801111241CE884}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
