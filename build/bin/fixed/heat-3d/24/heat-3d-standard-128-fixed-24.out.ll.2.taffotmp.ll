; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-128-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 128), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !36
  ...
  call void @scale_3d.4(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %2, i32 noundef 128), !taffo.initweight !35, !taffo.info !30, !taffo.originalCall !36
...
!31 = !{double 2.560000e+02, double 3.328000e+03}
!32 = !{i32 1}
!33 = !{i32 2}
