; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,0.433333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,0.333333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.35) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,0.512) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,0.366667) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.36) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [46 x i8] c"target('G') scalar(range(0.0,0.868533) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 2), !taffo.initweight !66, !taffo.info !48, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 2), !taffo.initweight !66, !taffo.info !50, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 2), !taffo.initweight !66, !taffo.info !52, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 2), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.7(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 2), !taffo.initweight !66, !taffo.info !56, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.8(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 2), !taffo.initweight !66, !taffo.info !58, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 2), !taffo.initweight !66, !taffo.info !60, !taffo.target !61, !taffo.originalCall !67, !taffo.constinfo !68
...
!7 = !{double 0.000000e+00, double 0x3FEBCB05B7CFE586}
...
!49 = !{double 0.000000e+00, double 4.333330e-01}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 3.333330e-01}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 0.000000e+00, double 3.500000e-01}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 5.120000e-01}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 3.666670e-01}
!58 = !{i1 false, !59, i1 false, i2 -1}
!59 = !{double 0.000000e+00, double 3.600000e-01}
...
!139 = !{double 0.000000e+00, double 0x3FBDDDDBE8C98295}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x3FE19998A8021229}
!142 = distinct !{!142, !29}
!143 = distinct !{!143, !29}
!144 = distinct !{!144, !29}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0.000000e+00, double 0x3FC0E561433BE9E6}
!147 = !{i1 false, !148, i1 false, i2 -1}
!148 = !{double 0.000000e+00, double 0x3FE49BA623C0A476}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = distinct !{!151, !29}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x3FCC661F1032F56E}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x3FF17246BDEE5171}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
...
!228 = !{i32 1, !121, i32 1, !132, i32 1, !48, i32 1, !25}
!229 = !{i32 9}
!230 = !{i1 false, !231, i1 false, i2 -1}
!231 = !{double 0.000000e+00, double 8.666660e-01}
!232 = distinct !{!232, !29}
!233 = distinct !{!233, !29}
!234 = !{i32 1, !121, i32 1, !22, i32 1, !50, i32 1, !25}
!235 = !{i1 false, !236, i1 false, i2 -1}
!236 = !{double 0.000000e+00, double 0x3FE55553EF6B5D46}
!237 = distinct !{!237, !29}
!238 = distinct !{!238, !29}
!239 = !{i32 1, !22, i32 1, !132, i32 1, !52, i32 1, !25}
!240 = !{i1 false, !241, i1 false, i2 -1}
!241 = !{double 0.000000e+00, double 0x3FE6666666666666}
!242 = distinct !{!242, !29}
!243 = distinct !{!243, !29}
!244 = !{i32 1, !132, i32 1, !123, i32 1, !54, i32 1, !25}
!245 = !{i1 false, !246, i1 false, i2 -1}
!246 = !{double 0.000000e+00, double 1.024000e+00}
!247 = distinct !{!247, !29}
!248 = distinct !{!248, !29}
!249 = !{i32 1, !132, i32 1, !134, i32 1, !56, i32 1, !25}
!250 = !{i1 false, !251, i1 false, i2 -1}
!251 = !{double 0.000000e+00, double 7.333340e-01}
!252 = distinct !{!252, !29}
!253 = distinct !{!253, !29}
!254 = !{i32 1, !134, i32 1, !123, i32 1, !58, i32 1, !25}
!255 = !{i1 false, !256, i1 false, i2 -1}
!256 = !{double 0.000000e+00, double 0x3FE70A3D70A3D70A}
!257 = distinct !{!257, !29}
!258 = distinct !{!258, !29}
!259 = !{i32 1, !121, i32 1, !123, i32 1, !60, i32 1, !25}
!260 = !{i1 false, !261, i1 false, i2 -1}
!261 = !{double 0.000000e+00, double 0x3FFBCB05B7CFE586}
!262 = distinct !{!262, !29}
!263 = distinct !{!263, !29}
