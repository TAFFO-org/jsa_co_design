; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-8-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 8), !taffo.info !58, !taffo.initweight !55, !taffo.constinfo !61, !taffo.originalCall !62
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 8), !taffo.info !63, !taffo.initweight !55, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 8), !taffo.info !65, !taffo.initweight !66, !taffo.constinfo !67, !taffo.target !50, !taffo.originalCall !68
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 8), !taffo.info !69, !taffo.initweight !66, !taffo.constinfo !67, !taffo.originalCall !68
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !100
  %mul = fmul float %0, %beta, !taffo.info !101, !taffo.initweight !98
...
for.body10:                                       ; preds = %for.cond8
  ...
  %1 = load float, float* %arrayidx12, align 4, !taffo.info !51, !taffo.initweight !100
  %mul13 = fmul float %alpha, %1, !taffo.info !104, !taffo.initweight !98
  ...
  %2 = load float, float* %arrayidx15, align 4, !taffo.info !51, !taffo.initweight !100
  %mul16 = fmul float %mul13, %2, !taffo.info !106, !taffo.initweight !99
  ...
  %3 = load float, float* %arrayidx18, align 4, !taffo.info !48, !taffo.initweight !100
  %add = fadd float %3, %mul16, !taffo.info !108, !taffo.initweight !100
  store float %add, float* %arrayidx18, align 4, !taffo.info !65, !taffo.initweight !100
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, i32 noundef %m, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A) #0 !taffo.initweight !113 !taffo.funinfo !114 !taffo.sourceFunction !60 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !58, !taffo.initweight !77, !taffo.constinfo !115
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !63, !taffo.initweight !77, !taffo.constinfo !117
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %rem = srem i32 %add, %n, !taffo.info !131, !taffo.initweight !77
  %conv = sitofp i32 %rem to float, !taffo.info !133, !taffo.initweight !98
  %conv6 = sitofp i32 %n to float, !taffo.info !134
  %div = fdiv float %conv, %conv6, !taffo.info !136, !taffo.initweight !99
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !139, !taffo.initweight !64
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !139, !taffo.initweight !64
  store float %div, float* %arrayidx7, align 4, !taffo.info !140, !taffo.initweight !66
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !141, !taffo.initweight !64, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !144, !taffo.initweight !64, !taffo.constinfo !21
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  ...
  %cmp16 = icmp slt i32 %j.1, %n, !taffo.info !146, !taffo.initweight !64
...
for.body18:                                       ; preds = %for.cond15
  ...
  %add20 = add nsw i32 %mul19, 2, !taffo.info !147, !taffo.initweight !66, !taffo.constinfo !21
  %rem21 = srem i32 %add20, %m, !taffo.info !149, !taffo.initweight !77
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !151, !taffo.initweight !98
  %conv23 = sitofp i32 %m to float, !taffo.info !152
  %div24 = fdiv float %conv22, %conv23, !taffo.info !153, !taffo.initweight !99
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.info !155, !taffo.initweight !64
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.info !155, !taffo.initweight !64
  store float %div24, float* %arrayidx26, align 4, !taffo.info !140, !taffo.initweight !66
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !141, !taffo.initweight !64, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !144, !taffo.initweight !64, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !158 !taffo.funinfo !159 !taffo.sourceFunction !68 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !48, !taffo.initweight !100
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !160
  %conv = sitofp i32 %factor to float, !taffo.info !161
  %mul = fmul float %1, %conv, !taffo.info !162, !taffo.initweight !165
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !48, !taffo.initweight !100
  store float %mul, float* %arrayidx6, align 4, !taffo.info !65, !taffo.initweight !160
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !158 !taffo.funinfo !168 !taffo.sourceFunction !68 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !51, !taffo.initweight !100
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !169, !taffo.initweight !160
  %conv = sitofp i32 %factor to float, !taffo.info !171
  %mul = fmul float %1, %conv, !taffo.info !172, !taffo.initweight !165
  %2 = mul nsw i32 %i.0, %m, !taffo.info !87
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !51, !taffo.initweight !99
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !51, !taffo.initweight !100
  store float %mul, float* %arrayidx6, align 4, !taffo.info !69, !taffo.initweight !160
  br label %for.inc
...
!99 = !{i32 6}
!100 = !{i32 7}
!101 = !{!49, !102, i1 false, i2 -1}
!102 = !{double 0.000000e+00, double 0x407F7839595281AD}
!103 = distinct !{!103, !23}
!104 = !{!52, !105, i1 false, i2 -1}
!105 = !{double 0.000000e+00, double 1.125000e+01}
!106 = !{!49, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 8.437500e+01}
!108 = !{!49, !109, i1 false, i2 -1}
!109 = !{double 0.000000e+00, double 0x407F7F851FC4C166}
!110 = distinct !{!110, !23}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2}
!114 = !{i32 1, !83, i32 1, !16, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51}
!115 = !{!116, i1 false}
!116 = !{i1 false, !44, i1 false, i2 0}
!117 = !{!118, i1 false}
!118 = !{i1 false, !119, i1 false, i2 0}
!119 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!120 = !{i1 false, !74, i1 false, i2 1}
!121 = !{i1 false, !76, i1 false, i2 1}
...
!151 = !{!52, !150, i1 false, i2 1}
!152 = !{!52, !17, i1 false, i2 1}
!153 = !{!137, !154, i1 false, i2 1}
!154 = !{double 0.000000e+00, double 9.000000e-01}
!155 = !{!49, !1, i1 false, i2 1}
!156 = distinct !{!156, !23}
!157 = distinct !{!157, !23}
!158 = !{i32 -1, i32 -1, i32 3, i32 -1}
!159 = !{i32 1, !83, i32 1, !83, i32 1, !48, i32 1, !94}
!160 = !{i32 8}
!161 = !{!52, !95, i1 false, i2 1}
!162 = !{!163, !164, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 20}
!164 = !{double 0.000000e+00, double 0x40AA39851FC4C166}
!165 = !{i32 9}
!166 = distinct !{!166, !23}
!167 = distinct !{!167, !23}
!168 = !{i32 1, !83, i32 1, !16, i32 1, !51, i32 1, !94}
!169 = !{!170, !53, i1 false, i2 -1}
!170 = !{!"fixp", i32 32, i32 26}
!171 = !{!170, !95, i1 false, i2 1}
!172 = !{!170, !173, i1 false, i2 -1}
!173 = !{double 0.000000e+00, double 6.000000e+01}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
