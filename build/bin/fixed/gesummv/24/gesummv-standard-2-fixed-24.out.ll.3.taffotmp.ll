; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-2-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,1.875) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,17.625) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [47 x i8] c"target('y') scalar(range(0.0,45.300003) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !60, !taffo.info !50, !taffo.originalCall !63, !taffo.constinfo !64
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 2), !taffo.initweight !60, !taffo.info !52, !taffo.originalCall !63, !taffo.constinfo !64
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 2), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 2), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.initweight !60, !taffo.info !56
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 2), !taffo.initweight !65, !taffo.info !56, !taffo.originalCall !69, !taffo.constinfo !70
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.initweight !60, !taffo.info !54
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 2), !taffo.initweight !65, !taffo.info !54, !taffo.originalCall !69, !taffo.constinfo !70
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 2), !taffo.initweight !65, !taffo.info !58, !taffo.target !59, !taffo.originalCall !69, !taffo.constinfo !70
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !108 !taffo.funinfo !110 !taffo.sourceFunction !63 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !111 !taffo.funinfo !112 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %mul = fmul float %0, %conv, !taffo.initweight !113, !taffo.info !114
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !111 !taffo.funinfo !117 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %0, %conv, !taffo.initweight !113, !taffo.info !118
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv.5(i32 noundef %n, float noundef %alpha, float noundef %beta, [16 x float]* noundef %A, [16 x float]* noundef %B, float* noundef %tmp, float* noundef %x, float* noundef %y) #0 !taffo.initweight !121 !taffo.funinfo !122 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %0 = load float, float* %arrayidx6, align 4, !taffo.initweight !113, !taffo.info !54
  ...
  %mul = fmul float %0, %1, !taffo.initweight !113, !taffo.info !123
  ...
  %add = fadd float %mul, %2, !taffo.initweight !113, !taffo.info !125
  ...
  %3 = load float, float* %arrayidx11, align 4, !taffo.initweight !113, !taffo.info !54
  ...
  %mul13 = fmul float %3, %4, !taffo.initweight !113, !taffo.info !123
  ...
  %add15 = fadd float %mul13, %5, !taffo.initweight !113, !taffo.info !127
...
for.end:                                          ; preds = %for.cond2
  ...
  %mul18 = fmul float %alpha, %6, !taffo.initweight !95, !taffo.info !130
  ...
  %mul20 = fmul float %beta, %7, !taffo.initweight !95, !taffo.info !132
  %add21 = fadd float %mul18, %mul20, !taffo.initweight !96, !taffo.info !134
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !111 !taffo.funinfo !137 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %0, %conv, !taffo.initweight !113, !taffo.info !138
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7(i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %A, [16 x float]* noundef %B, float* noundef %x, float* noundef %tmp, float* noundef %y) #0 !taffo.initweight !141 !taffo.funinfo !142 !taffo.sourceFunction !61 {
entry:
...
for.cond:                                         ; preds = %for.inc24, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc25, %for.inc24 ], !taffo.initweight !49, !taffo.info !143
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !65, !taffo.info !144
  br i1 %cmp, label %for.body, label %for.end26, !taffo.initweight !66, !taffo.info !88

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.initweight !65, !taffo.info !145
  %conv = sitofp i32 %rem to float, !taffo.initweight !66, !taffo.info !145
  %conv3 = sitofp i32 %n to float, !taffo.info !103
  %div = fdiv float %conv, %conv3, !taffo.initweight !90, !taffo.info !147
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.initweight !65, !taffo.info !149
  store float %div, float* %arrayidx, align 4, !taffo.initweight !66, !taffo.info !91
  %arrayidx4 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.initweight !65, !taffo.info !150
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !66, !taffo.info !91, !taffo.constinfo !92
  %arrayidx5 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.initweight !65, !taffo.info !151
  store float 0.000000e+00, float* %arrayidx5, align 4, !taffo.initweight !66, !taffo.info !91, !taffo.constinfo !92
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !49, !taffo.info !143
  %cmp7 = icmp slt i32 %j.0, %n, !taffo.initweight !65, !taffo.info !144
  br i1 %cmp7, label %for.body9, label %for.end, !taffo.initweight !66, !taffo.info !88

for.body9:                                        ; preds = %for.cond6
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !65, !taffo.info !152
  %add = add nsw i32 %mul, 1, !taffo.initweight !66, !taffo.info !154, !taffo.constinfo !27
  %rem10 = srem i32 %add, %n, !taffo.initweight !90, !taffo.info !145
  %conv11 = sitofp i32 %rem10 to float, !taffo.initweight !95, !taffo.info !145
  %conv12 = sitofp i32 %n to float, !taffo.info !103
  %div13 = fdiv float %conv11, %conv12, !taffo.initweight !96, !taffo.info !147
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.0, !taffo.initweight !65, !taffo.info !149
  %arrayidx15 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.initweight !65, !taffo.info !149
  store float %div13, float* %arrayidx15, align 4, !taffo.initweight !66, !taffo.info !91
  %mul16 = mul nsw i32 %i.0, %j.0, !taffo.initweight !65, !taffo.info !152
  %add17 = add nsw i32 %mul16, 2, !taffo.initweight !66, !taffo.info !156, !taffo.constinfo !27
  %rem18 = srem i32 %add17, %n, !taffo.initweight !90, !taffo.info !145
  %conv19 = sitofp i32 %rem18 to float, !taffo.initweight !95, !taffo.info !145
  %conv20 = sitofp i32 %n to float, !taffo.info !103
  %div21 = fdiv float %conv19, %conv20, !taffo.initweight !96, !taffo.info !147
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !65, !taffo.info !149
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.0, !taffo.initweight !65, !taffo.info !149
  store float %div21, float* %arrayidx23, align 4, !taffo.initweight !66, !taffo.info !91
  br label %for.inc

for.inc:                                          ; preds = %for.body9
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !65, !taffo.info !158, !taffo.constinfo !27
  br label %for.cond6, !llvm.loop !159

for.end:                                          ; preds = %for.cond6
  br label %for.inc24

for.inc24:                                        ; preds = %for.end
  %inc25 = add nsw i32 %i.0, 1, !taffo.initweight !65, !taffo.info !158, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !161 !taffo.funinfo !162 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !113, !taffo.info !54
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !163, !taffo.info !54
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !164, !taffo.info !118
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !113, !taffo.info !54
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !163, !taffo.info !54
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !161 !taffo.funinfo !162 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
!7 = !{double 0.000000e+00, double 0x4046A6667F90D9D7}
...
!55 = !{double 0.000000e+00, double 1.875000e+00}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 1.762500e+01}
...
!107 = distinct !{!107, !29}
!108 = !{i32 1, i32 -1}
!109 = !{i32 1, !50, i32 1, !25}
!110 = !{i32 1, !52, i32 1, !25}
!111 = !{i32 -1, i32 2, i32 -1}
!112 = !{i32 1, !103, i32 1, !56, i32 1, !25}
!113 = !{i32 7}
!114 = !{i1 false, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 3.525000e+01}
!116 = distinct !{!116, !29}
!117 = !{i32 1, !103, i32 1, !54, i32 1, !25}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 3.750000e+00}
!120 = distinct !{!120, !29}
!121 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!122 = !{i32 1, !103, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !54, i32 1, !56, i32 1, !54, i32 1, !58}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x400C200000000000}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4035240000000000}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x404868667F90D9D7}
!129 = distinct !{!129, !29}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 2.643750e+01}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x404B2E149914389B}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x4054330A4C8A1C4E}
!136 = distinct !{!136, !29}
!137 = !{i32 1, !103, i32 1, !58, i32 1, !25}
!138 = !{i1 false, !139, i1 false, i2 -1}
!139 = !{double 0.000000e+00, double 0x4056A6667F90D9D7}
!140 = distinct !{!140, !29}
!141 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2}
!142 = !{i32 1, !103, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !54, i32 1, !54, i32 1, !56, i32 1, !58}
...
!149 = !{i1 false, !55, i1 false, i2 1}
!150 = !{i1 false, !7, i1 false, i2 1}
!151 = !{i1 false, !57, i1 false, i2 1}
!152 = !{i1 false, !153, i1 false, i2 1}
!153 = !{double 0.000000e+00, double 2.560000e+02}
!154 = !{i1 false, !155, i1 false, i2 1}
!155 = !{double 1.000000e+00, double 2.570000e+02}
!156 = !{i1 false, !157, i1 false, i2 1}
!157 = !{double 2.000000e+00, double 2.580000e+02}
!158 = !{i1 false, !78, i1 false, i2 1}
!159 = distinct !{!159, !29}
!160 = distinct !{!160, !29}
!161 = !{i32 -1, i32 -1, i32 3, i32 -1}
!162 = !{i32 1, !103, i32 1, !103, i32 1, !54, i32 1, !25}
!163 = !{i32 8}
!164 = !{i32 9}
!165 = distinct !{!165, !29}
!166 = distinct !{!166, !29}
