; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-256-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 256), !taffo.info !65, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 256), !taffo.info !72, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 256), !taffo.info !73, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 256), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 256), !taffo.info !75, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 256), !taffo.info !76, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 256), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !70, !taffo.target !59, !taffo.originalCall !71
...
!47 = !{double 0.000000e+00, double 0x404555556084A516}
!48 = !{!46, !49, i1 false, i2 -1}
!49 = !{double 0.000000e+00, double 0x404666665E02EA96}
!50 = !{!51, !52, i1 false, i2 -1}
!51 = !{!"fixp", i32 32, i32 18}
!52 = !{double 0.000000e+00, double 0x40C0624DDFFC547A}
!53 = !{!46, !54, i1 false, i2 -1}
!54 = !{double 0.000000e+00, double 0x404777777D0F1F58}
!55 = !{!46, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 0x40470A3D816ACEAB}
...
!118 = !{!"fixp", i32 32, i32 21}
!119 = !{double 0.000000e+00, double 0x409DDDDDE25730F2}
!120 = !{i32 8}
!121 = !{!51, !43, i1 false, i2 -1}
!122 = !{!51, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40C19999AC4D4219}
!124 = distinct !{!124, !23}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = !{!51, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x40A0E56051DDA6A0}
!129 = !{!51, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x40C49BA5F473BE22}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = distinct !{!133, !23}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 32, i32 6}
!136 = !{double 0.000000e+00, double 0x418C6620BA76E4B2}
!137 = !{!138, !1, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 3}
!139 = !{!138, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x41B17247574EDC96}
!141 = distinct !{!141, !23}
!142 = distinct !{!142, !23}
!143 = distinct !{!143, !23}
...
!229 = !{double 2.560000e+02, double 2.560000e+02}
!230 = !{!231, !229, i1 false, i2 1}
!231 = !{!"fixp", i32 32, i32 23}
!232 = !{!233, !234, i1 false, i2 -1}
!233 = !{!"fixp", i32 32, i32 11}
!234 = !{double 0.000000e+00, double 0x413BBBBBE004B7F6}
!235 = !{i32 9}
!236 = distinct !{!236, !23}
!237 = distinct !{!237, !23}
!238 = !{i32 1, !95, i32 1, !16, i32 1, !45, i32 1, !228}
!239 = !{!51, !240, i1 false, i2 -1}
!240 = !{double 0.000000e+00, double 0x40C555556084A516}
!241 = distinct !{!241, !23}
!242 = distinct !{!242, !23}
!243 = !{i32 1, !108, i32 1, !97, i32 1, !50, i32 1, !228}
!244 = !{!245, !246, i1 false, i2 -1}
!245 = !{!"fixp", i32 32, i32 10}
!246 = !{double 0.000000e+00, double 0x4140624DDFFC547A}
!247 = distinct !{!247, !23}
!248 = distinct !{!248, !23}
!249 = !{i32 1, !95, i32 1, !97, i32 1, !57, i32 1, !228}
!250 = !{!251, !252, i1 false, i2 -1}
!251 = !{!"float", i32 1, double 0x422BCB0680000000}
!252 = !{double 0.000000e+00, double 0x422BCB0680000000}
!253 = distinct !{!253, !23}
!254 = distinct !{!254, !23}
