; ModuleID = './build/bin/fixed/lu/16/lu-standard-1-fixed-16.out.ll'
...
for.body5:                                        ; preds = %for.cond3
  ...
  %1 = fdiv float %lampsim2, 0x41B0000000000000, !taffo.info !28, !taffo.target !31
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !50
  br label %for.inc
