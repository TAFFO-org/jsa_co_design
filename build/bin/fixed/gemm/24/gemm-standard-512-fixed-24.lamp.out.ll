; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-512-fixed-24.out.ll'
...
entry:
  ...
  %C.u21_11fixp = alloca [10 x [12 x i32]], align 4, !taffo.info !47, !taffo.target !49
  %A.u9_23fixp = alloca [10 x [16 x i32]], align 4, !taffo.info !50
  %B.u9_23fixp = alloca [16 x [12 x i32]], align 4, !taffo.info !53
  %arraydecay.u21_11fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u21_11fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay6.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u9_23fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay7.u9_23fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !53
  call void @init_array.4_fixp(i32 10, i32 12, i32 16, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [12 x i32]* %arraydecay.u21_11fixp, [16 x i32]* %arraydecay6.u9_23fixp, [12 x i32]* %arraydecay7.u9_23fixp), !taffo.info !55, !taffo.constinfo !56
  ...
  %arraydecay8.u21_11fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u21_11fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u21_11fixp = bitcast [12 x i32]* %arraydecay8.u21_11fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 10, i32 12, i32* %u21_11fixp, i32 512), !taffo.info !59, !taffo.constinfo !60, !taffo.target !49
  %arraydecay9.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u9_23fixp, i32 0, i32 0, !taffo.info !50
  %u9_23fixp2 = bitcast [16 x i32]* %arraydecay9.u9_23fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u9_23fixp2, i32 512), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u9_23fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !53
  %u9_23fixp = bitcast [12 x i32]* %arraydecay10.u9_23fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u9_23fixp, i32 512), !taffo.info !62, !taffo.constinfo !60
  ...
  %arraydecay11.u21_11fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u21_11fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay12.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u9_23fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay13.u9_23fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !53
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [12 x i32]* %arraydecay11.u21_11fixp, [16 x i32]* %arraydecay12.u9_23fixp, [12 x i32]* %arraydecay13.u9_23fixp), !taffo.info !55, !taffo.constinfo !56
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx.u21_11fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u21_11fixp, i32 0, i32 %i.0, !taffo.info !47, !taffo.target !49
  %arrayidx17.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u21_11fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u21_11fixp, [16 x i32]* noundef %A.u9_23fixp, [12 x i32]* noundef %B.u9_23fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u21_11fixp, i32 %i.0, !taffo.info !47
  %arrayidx4.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u21_11fixp, i32 0, i32 %j.0, !taffo.info !47
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 10), !taffo.info !96
  %mul.u21_11fixp = shl i32 %3, 1, !taffo.info !99
  store i32 %mul.u21_11fixp, i32* %arrayidx4.u21_11fixp, align 4, !taffo.info !58
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u9_23fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx11.u9_23fixp, i32 0, i32 %k.0, !taffo.info !50
  %u9_23fixp = load i32, i32* %arrayidx12.u9_23fixp, align 4, !taffo.info !101
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u9_23fixp, 1, !taffo.info !101
  %6 = ashr i32 %4, 8, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !101
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 21), !taffo.info !103
  %mul13.u10_22fixp = shl i32 %8, 1, !taffo.info !106
  %arrayidx14.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u9_23fixp, i32 %k.0, !taffo.info !53
  %arrayidx15.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx14.u9_23fixp, i32 0, i32 %j.1, !taffo.info !53
  %u9_23fixp2 = load i32, i32* %arrayidx15.u9_23fixp, align 4, !taffo.info !53
  %9 = lshr i32 %mul13.u10_22fixp, 1, !taffo.info !106
  %10 = lshr i32 %u9_23fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 11, !taffo.info !106
  %12 = ashr i32 %10, 12, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 10), !taffo.info !107
  %mul16.u21_11fixp = shl i32 %13, 1, !taffo.info !109
  %arrayidx17.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u21_11fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx17.u21_11fixp, i32 0, i32 %j.1, !taffo.info !47
  %u21_11fixp1 = load i32, i32* %arrayidx18.u21_11fixp, align 4, !taffo.info !47
  %add.u21_11fixp = add i32 %u21_11fixp1, %mul16.u21_11fixp, !taffo.info !110
  store i32 %add.u21_11fixp, i32* %arrayidx18.u21_11fixp, align 4, !taffo.info !59
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u21_11fixp, [16 x i32]* noundef %A.u9_23fixp, [12 x i32]* noundef %B.u9_23fixp) #0 !taffo.initweight !115 !taffo.funinfo !92 !taffo.sourceFunction !116 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u21_11fixp, i32 %i.0, !taffo.info !145
  %arrayidx7.u21_11fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u21_11fixp, i32 0, i32 %j.0, !taffo.info !145
  %3 = lshr i32 %div.u1_31fixp, 20, !taffo.info !143
  store i32 %3, i32* %arrayidx7.u21_11fixp, align 4, !taffo.info !146
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u9_23fixp, i32 %i.1, !taffo.info !162
  %arrayidx26.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u9_23fixp, i32 0, i32 %j.1, !taffo.info !162
  %8 = lshr i32 %div24.u1_31fixp, 8, !taffo.info !161
  store i32 %8, i32* %arrayidx26.u9_23fixp, align 4, !taffo.info !146
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx47.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u9_23fixp, i32 %i.2, !taffo.info !175
  %arrayidx48.u9_23fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u9_23fixp, i32 0, i32 %j.2, !taffo.info !175
  %12 = lshr i32 %div46.u1_31fixp, 8, !taffo.info !174
  store i32 %12, i32* %arrayidx48.u9_23fixp, align 4, !taffo.info !146
  br label %for.inc49
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u21_11fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim4 = and i32 %lampsim3, -1
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !181
  %3 = uitofp i32 %conv.u10_22fixp to float, !taffo.info !181
  %lampsim6 = bitcast float %3 to i32
  %lampsim7 = and i32 %lampsim6, -1
  %lampsim8 = bitcast i32 %lampsim7 to float
  %4 = fdiv float %lampsim8, 0x4150000000000000, !taffo.info !181
  %lampsim9 = bitcast float %4 to i32
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !182
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !187 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u10_22fixp, 1, !taffo.info !181
  %3 = ashr i32 %1, 9, !taffo.info !50
  %4 = ashr i32 %2, 8, !taffo.info !181
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !188
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !191
  ...
  %7 = shl i32 %mul.u18_14fixp, 9, !taffo.info !191
...
!1 = !{double 0.000000e+00, double 0x413901EB80000000}
...
!54 = !{double 0.000000e+00, double 0x407D55556084A516}
...
!97 = !{!"fixp", i32 -32, i32 10}
!98 = !{double 0.000000e+00, double 0x413E024DCCCCCCCC}
...
!108 = !{double 0.000000e+00, double 0x4114A00007DD4413}
!109 = !{!48, !108, i1 false, i2 -1}
!110 = !{!48, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x413E29EB81F75105}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = distinct !{!114, !23}
...
!183 = !{!"float", i32 1, double 0x41C901EB80000000}
!184 = !{double 0.000000e+00, double 0x41C901EB80000000}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
!187 = !{i32 1, !16, i32 1, !93, i32 1, !50, i32 1, !88}
!188 = !{!189, !190, i1 false, i2 -1}
!189 = !{!"fixp", i32 -32, i32 13}
!190 = !{double 0.000000e+00, double 2.457600e+05}
!191 = !{!192, !190, i1 false, i2 -1}
!192 = !{!"fixp", i32 32, i32 14}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
