; ModuleID = './build/bin/float/jacobi-2d/8/jacobi-2d-standard-1-float-8.out.ll'
...
entry:
  ...
  call void @kernel_jacobi_2d(i32 noundef %1, i32 noundef %2, ptr noundef %arraydecay2, ptr noundef %arraydecay3)
...
for.body6:                                        ; preds = %for.cond4
  ...
  %arrayidx7 = getelementptr inbounds [15 x float], ptr %arrayidx, i32 0, i32 %8
  %9 = load float, ptr %arrayidx7, align 4
  %10 = load i32, ptr %i, align 4
  %arrayidx8 = getelementptr inbounds [15 x [15 x float]], ptr @A_float, i32 0, i32 %10
  %11 = load i32, ptr %j, align 4
  %arrayidx9 = getelementptr inbounds [15 x float], ptr %arrayidx8, i32 0, i32 %11
