...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,0.433333) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,0.333333) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.35) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,0.512) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,0.366667) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.36) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [46 x i8] c"target('G') scalar(range(0.0,0.868533) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, ptr noundef %arraydecay7, i32 noundef 2)
  %arraydecay8 = getelementptr inbounds [6 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 10, ptr noundef %arraydecay8, i32 noundef 2)
  %arraydecay9 = getelementptr inbounds [10 x [8 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 8, ptr noundef %arraydecay9, i32 noundef 2)
  %arraydecay10 = getelementptr inbounds [8 x [12 x float]], ptr %F, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 12, ptr noundef %arraydecay10, i32 noundef 2)
  %arraydecay11 = getelementptr inbounds [8 x [14 x float]], ptr %C, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 14, ptr noundef %arraydecay11, i32 noundef 2)
  %arraydecay12 = getelementptr inbounds [14 x [12 x float]], ptr %D, i32 0, i32 0
  call void @scale_2d(i32 noundef 14, i32 noundef 12, ptr noundef %arraydecay12, i32 noundef 2)
  %arraydecay13 = getelementptr inbounds [6 x [12 x float]], ptr %G, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 12, ptr noundef %arraydecay13, i32 noundef 2)
