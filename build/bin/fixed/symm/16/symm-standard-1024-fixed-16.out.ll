; ModuleID = './build/bin/fixed/symm/16/symm-standard-1024-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_symm.3_fixp(i32 10, i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay11.u26_6fixp, [10 x i32]* %arraydecay12.s21_11fixp, [16 x i32]* %arraydecay13.u12_20fixp), !taffo.info !56, !taffo.constinfo !57
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !177
  ...
  %6 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !177
  %7 = fptoui float %6 to i32, !taffo.info !177
