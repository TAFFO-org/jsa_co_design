; ModuleID = './build/bin/fixed/jacobi-1d/24/jacobi-1d-standard-16-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 16), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 16), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
!47 = !{double 3.200000e+00, double 0x403222221C8A7A42}
...
!85 = !{double 0x40411110E453D20F, double 0x40711111276FB092}
!86 = !{i32 7}
!87 = distinct !{!87, !23}
...
!97 = !{double 0x40111110E453D20F, double 0x40411111276FB092}
!98 = !{!95, !99, i1 false, i2 -1}
!99 = !{double 0x40199999567DBB16, double 0x40499999BB2788DB}
!100 = !{i32 8}
!101 = !{!95, !102, i1 false, i2 -1}
!102 = !{double 0x40011105B5042EE8, double 0x40311105F81FE170}
!103 = !{i32 9}
!104 = !{!105, i1 false}
!105 = !{i1 false, !106, i1 false, i2 0}
!106 = !{double 3.333300e-01, double 3.333300e-01}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x40011105A0000000, double 0x4031110600000000}
!109 = !{i32 10}
!110 = distinct !{!110, !23}
!111 = !{!95, !47, i1 false, i2 -1}
!112 = !{!95, !113, i1 false, i2 -1}
!113 = !{double 6.400000e+00, double 0x404222221C8A7A42}
!114 = !{!95, !115, i1 false, i2 -1}
!115 = !{double 0x4023333333333334, double 0x404B33332ACFB763}
!116 = !{!95, !117, i1 false, i2 -1}
!117 = !{double 0x40099988D2A1F8E5, double 0x403222163A45C16C}
!118 = !{!42, !119, i1 false, i2 -1}
!119 = !{double 0x40099988C0000000, double 0x4032221640000000}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
