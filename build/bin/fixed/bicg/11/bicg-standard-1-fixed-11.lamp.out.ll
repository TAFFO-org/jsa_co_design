; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-1-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  store float %lampsim5, float* %arrayidx15, align 4, !taffo.info !47, !taffo.target !35
  br label %for.inc
...
for.body19:                                       ; preds = %for.cond17
  ...
  store float %lampsim11, float* %arrayidx21, align 4, !taffo.info !53, !taffo.target !37
  br label %for.inc22
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !69
  br label %for.inc
...
if.end12:                                         ; preds = %if.then10, %for.body6
  ...
  %call15 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %4, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i32 0, i32 0), double noundef %lampsim7), !taffo.constinfo !69
  br label %for.inc16
