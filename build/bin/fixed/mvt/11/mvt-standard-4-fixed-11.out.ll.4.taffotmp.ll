; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-4-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 4), !taffo.info !56, !taffo.initweight !60, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 4), !taffo.info !63, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !50, !taffo.originalCall !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 4), !taffo.info !66, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !52, !taffo.originalCall !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 4), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 4), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !91, !taffo.initweight !93
  %conv = sitofp i32 %factor to float, !taffo.info !94
  %mul = fmul float %0, %conv, !taffo.info !95, !taffo.initweight !97
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !48, !taffo.initweight !90
  store float %mul, float* %arrayidx1, align 4, !taffo.info !63, !taffo.initweight !93
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !99 !taffo.sourceFunction !65 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !100, !taffo.initweight !93
  %conv = sitofp i32 %factor to float, !taffo.info !102
  %mul = fmul float %0, %conv, !taffo.info !103, !taffo.initweight !97
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !44, !taffo.initweight !90
  store float %mul, float* %arrayidx1, align 4, !taffo.info !56, !taffo.initweight !93
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_mvt.4(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !106 !taffo.funinfo !107 !taffo.sourceFunction !68 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !48, !taffo.initweight !93
  %arrayidx4 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !44, !taffo.initweight !90
  %arrayidx5 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx4, i32 0, i32 %j.0, !taffo.info !44, !taffo.initweight !93
  %1 = load float, float* %arrayidx5, align 4, !taffo.info !108, !taffo.initweight !97
  %arrayidx6 = getelementptr inbounds float, float* %y_1, i32 %j.0, !taffo.info !44, !taffo.initweight !90
  %2 = load float, float* %arrayidx6, align 4, !taffo.info !108, !taffo.initweight !93
  %mul = fmul float %1, %2, !taffo.info !110, !taffo.initweight !97
  %add = fadd float %0, %mul, !taffo.info !112, !taffo.initweight !97
  %arrayidx7 = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !48, !taffo.initweight !90
  store float %add, float* %arrayidx7, align 4, !taffo.info !63, !taffo.initweight !93
  br label %for.inc
...
for.body16:                                       ; preds = %for.cond14
  ...
  %3 = load float, float* %arrayidx17, align 4, !taffo.info !51, !taffo.initweight !93
  %arrayidx18 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %j.1, !taffo.info !44, !taffo.initweight !90
  %arrayidx19 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx18, i32 0, i32 %i.1, !taffo.info !44, !taffo.initweight !93
  %4 = load float, float* %arrayidx19, align 4, !taffo.info !108, !taffo.initweight !97
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %j.1, !taffo.info !44, !taffo.initweight !90
  %5 = load float, float* %arrayidx20, align 4, !taffo.info !108, !taffo.initweight !93
  %mul21 = fmul float %4, %5, !taffo.info !110, !taffo.initweight !97
  %add22 = fadd float %3, %mul21, !taffo.info !116, !taffo.initweight !97
  %arrayidx23 = getelementptr inbounds float, float* %x2, i32 %i.1, !taffo.info !51, !taffo.initweight !90
  store float %add22, float* %arrayidx23, align 4, !taffo.info !66, !taffo.initweight !93
  br label %for.inc24

for.inc24:                                        ; preds = %for.body16
  %inc25 = add nsw i32 %j.1, 1, !taffo.info !79, !taffo.constinfo !23
  br label %for.cond14, !llvm.loop !118
...
for.inc27:                                        ; preds = %for.end26
  ...
  br label %for.cond11, !llvm.loop !119
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !106 !taffo.funinfo !107 !taffo.sourceFunction !59 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc31, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc32, %for.inc31 ], !taffo.info !120, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !121, !taffo.initweight !57
  br i1 %cmp, label %for.body, label %for.end33, !taffo.info !122, !taffo.initweight !60

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.info !124, !taffo.initweight !57
  %conv = sitofp i32 %rem to float, !taffo.info !126, !taffo.initweight !60
  %conv3 = sitofp i32 %n to float, !taffo.info !127
  %div = fdiv float %conv, %conv3, !taffo.info !128, !taffo.initweight !131
  %arrayidx = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !132, !taffo.initweight !57
  store float %div, float* %arrayidx, align 4, !taffo.info !133, !taffo.initweight !60
  %add = add nsw i32 %i.0, 1, !taffo.info !134, !taffo.initweight !57, !taffo.constinfo !23
  %rem4 = srem i32 %add, %n, !taffo.info !124, !taffo.initweight !60
  %conv5 = sitofp i32 %rem4 to float, !taffo.info !126, !taffo.initweight !131
  %conv6 = sitofp i32 %n to float, !taffo.info !127
  %div7 = fdiv float %conv5, %conv6, !taffo.info !128, !taffo.initweight !90
  %arrayidx8 = getelementptr inbounds float, float* %x2, i32 %i.0, !taffo.info !135, !taffo.initweight !57
  store float %div7, float* %arrayidx8, align 4, !taffo.info !133, !taffo.initweight !60
  %add9 = add nsw i32 %i.0, 3, !taffo.info !136, !taffo.initweight !57, !taffo.constinfo !23
  %rem10 = srem i32 %add9, %n, !taffo.info !124, !taffo.initweight !60
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !126, !taffo.initweight !131
  %conv12 = sitofp i32 %n to float, !taffo.info !127
  %div13 = fdiv float %conv11, %conv12, !taffo.info !128, !taffo.initweight !90
  %arrayidx14 = getelementptr inbounds float, float* %y_1, i32 %i.0, !taffo.info !138, !taffo.initweight !57
  store float %div13, float* %arrayidx14, align 4, !taffo.info !133, !taffo.initweight !60
  %add15 = add nsw i32 %i.0, 4, !taffo.info !139, !taffo.initweight !57, !taffo.constinfo !23
  %rem16 = srem i32 %add15, %n, !taffo.info !124, !taffo.initweight !60
  %conv17 = sitofp i32 %rem16 to float, !taffo.info !126, !taffo.initweight !131
  %conv18 = sitofp i32 %n to float, !taffo.info !127
  %div19 = fdiv float %conv17, %conv18, !taffo.info !128, !taffo.initweight !90
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %i.0, !taffo.info !138, !taffo.initweight !57
  store float %div19, float* %arrayidx20, align 4, !taffo.info !133, !taffo.initweight !60
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !120, !taffo.initweight !47
  %cmp22 = icmp slt i32 %j.0, %n, !taffo.info !121, !taffo.initweight !57
  br i1 %cmp22, label %for.body24, label %for.end, !taffo.info !122, !taffo.initweight !60

for.body24:                                       ; preds = %for.cond21
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !141, !taffo.initweight !57
  %rem25 = srem i32 %mul, %n, !taffo.info !124, !taffo.initweight !60
  %conv26 = sitofp i32 %rem25 to float, !taffo.info !126, !taffo.initweight !131
  %conv27 = sitofp i32 %n to float, !taffo.info !127
  %div28 = fdiv float %conv26, %conv27, !taffo.info !128, !taffo.initweight !90
  %arrayidx29 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !138, !taffo.initweight !57
  %arrayidx30 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx29, i32 0, i32 %j.0, !taffo.info !138, !taffo.initweight !57
  store float %div28, float* %arrayidx30, align 4, !taffo.info !133, !taffo.initweight !60
  br label %for.inc

for.inc:                                          ; preds = %for.body24
  %inc = add nsw i32 %j.0, 1, !taffo.info !134, !taffo.initweight !57, !taffo.constinfo !23
...
for.inc31:                                        ; preds = %for.end
  %inc32 = add nsw i32 %i.0, 1, !taffo.info !134, !taffo.initweight !57, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !145 !taffo.funinfo !146 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.info !44, !taffo.initweight !93
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !44, !taffo.initweight !97
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !100, !taffo.initweight !147
  %conv = sitofp i32 %factor to float, !taffo.info !102
  %mul = fmul float %1, %conv, !taffo.info !103, !taffo.initweight !148
  %2 = mul nsw i32 %i.0, %m, !taffo.info !81
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !44, !taffo.initweight !93
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !44, !taffo.initweight !97
  store float %mul, float* %arrayidx6, align 4, !taffo.info !56, !taffo.initweight !147
  br label %for.inc
...
!90 = !{i32 5}
!91 = !{!92, !1, i1 false, i2 -1}
!92 = !{!"fixp", i32 32, i32 23}
!93 = !{i32 6}
!94 = !{!45, !89, i1 false, i2 1}
!95 = !{!92, !96, i1 false, i2 -1}
!96 = !{double 0.000000e+00, double 0x407473331E3A7DAA}
!97 = !{i32 7}
!98 = distinct !{!98, !25}
!99 = !{i32 1, !77, i32 1, !44, i32 1, !88}
!100 = !{!101, !46, i1 false, i2 -1}
!101 = !{!"fixp", i32 32, i32 27}
!102 = !{!101, !89, i1 false, i2 1}
!103 = !{!101, !104, i1 false, i2 -1}
!104 = !{double 0.000000e+00, double 1.520000e+01}
!105 = distinct !{!105, !25}
!106 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!107 = !{i32 1, !77, i32 1, !48, i32 1, !51, i32 1, !44, i32 1, !44, i32 1, !44}
!108 = !{!109, !46, i1 false, i2 -1}
!109 = !{!"fixp", i32 32, i32 28}
!110 = !{!109, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 1.444000e+01}
!112 = !{!49, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x40580F5C13FD0D06}
!114 = distinct !{!114, !25}
!115 = distinct !{!115, !25}
!116 = !{!49, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x4058028F53C579F2}
!118 = distinct !{!118, !25}
!119 = distinct !{!119, !25}
...
!125 = !{double 0.000000e+00, double 1.900000e+01}
!126 = !{!101, !125, i1 false, i2 1}
!127 = !{!101, !78, i1 false, i2 1}
!128 = !{!129, !130, i1 false, i2 1}
!129 = !{!"fixp", i32 32, i32 31}
!130 = !{double 0.000000e+00, double 0x3FEE666666666666}
!131 = !{i32 4}
!132 = !{!49, !1, i1 false, i2 1}
!133 = !{i1 false, i1 false, i1 false, i2 1}
!134 = !{i1 false, !74, i1 false, i2 1}
!135 = !{!49, !3, i1 false, i2 1}
!136 = !{i1 false, !137, i1 false, i2 1}
!137 = !{double 3.000000e+00, double 2.300000e+01}
!138 = !{!45, !46, i1 false, i2 1}
!139 = !{i1 false, !140, i1 false, i2 1}
!140 = !{double 4.000000e+00, double 2.400000e+01}
!141 = !{i1 false, !142, i1 false, i2 1}
!142 = !{double 0.000000e+00, double 4.000000e+02}
!143 = distinct !{!143, !25}
!144 = distinct !{!144, !25}
!145 = !{i32 -1, i32 -1, i32 3, i32 -1}
!146 = !{i32 1, !77, i32 1, !77, i32 1, !44, i32 1, !88}
!147 = !{i32 8}
!148 = !{i32 9}
!149 = distinct !{!149, !25}
!150 = distinct !{!150, !25}
