; ModuleID = './build/stats/lu/16/lu-standard-16.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.1(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 16), !taffo.originalCall !27
