; ModuleID = './build/bin/fixed/lu/11/lu-standard-32-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [48 x i8] c"target('A') scalar(range(0.1,261.519989) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 32), !taffo.initweight !55, !taffo.info !48, !taffo.target !50, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40705851DFFC547A}
...
!49 = !{double 1.000000e-01, double 0x40705851DFFC547A}
!50 = !{!"A"}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x3F847AE147AE147C, double 0x40F0B28B463B78B0}
!109 = !{i1 false, !110, i1 false, i2 1}
!110 = !{double 0xC0F0B289ACA1DF16, double 0x40705828EA39C51E}
!111 = distinct !{!111, !29}
!112 = !{i32 8}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3F390F455FEACCE2, double 0x40A46E6657FB6998}
!115 = distinct !{!115, !29}
!116 = distinct !{!116, !29}
!117 = distinct !{!117, !29}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double 0.000000e+00, double 0x40F0B28B463B78B0}
...
!155 = !{double 3.200000e+00, double 0x40C05851DFFC547A}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
