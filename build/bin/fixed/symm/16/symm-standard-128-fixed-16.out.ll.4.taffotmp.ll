; ModuleID = './build/bin/fixed/symm/16/symm-standard-128-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 128), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 128), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 128), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 128), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
...
!49 = !{!"fixp", i32 32, i32 12}
!50 = !{!"C"}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 14}
!53 = !{double -1.278720e+05, double 0x406CCCCCC0379314}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 23}
!56 = !{double 1.280000e+01, double 3.200000e+02}
...
!103 = !{double 1.280000e+02, double 1.280000e+02}
...
!107 = !{!"fixp", i32 -32, i32 5}
!108 = !{double 0xC183830000000000, double 0x40F1FFFFF822BBEC}
!109 = !{i32 5}
!110 = !{i32 6}
!111 = !{i32 7}
!112 = !{!55, !113, i1 false, i2 -1}
!113 = !{double 0x4033333333333334, double 4.800000e+02}
!114 = !{!107, !115, i1 false, i2 -1}
!115 = !{double 0xC18D448000000000, double 0x40FAFFFFF43419E3}
!116 = !{!107, !117, i1 false, i2 -1}
!117 = !{double 0xC18D448000000000, double 0x4128C1147E86833C}
!118 = !{!107, !108, i1 false, i2 -1}
!119 = !{i32 8}
!120 = !{i32 9}
!121 = distinct !{!121, !23}
!122 = !{!49, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x4129A7B233333333}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 -32, i32 4}
!126 = !{double 0xC18D448000000000, double 0x412D07B231B9B66F}
!127 = !{!125, !128, i1 false, i2 -1}
!128 = !{double 0xC18D448000000000, double 0x40FAFFFFF43419E2}
!129 = !{!125, !130, i1 false, i2 -1}
!130 = !{double 0xC19D448000000000, double 0x413033D918201CD6}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
...
!174 = !{!"fixp", i32 32, i32 24}
!175 = !{!176, !177, i1 false, i2 -1}
!176 = !{!"fixp", i32 32, i32 5}
!177 = !{double 0.000000e+00, double 0x4195611480000000}
!178 = distinct !{!178, !23}
!179 = distinct !{!179, !23}
!180 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !102}
!181 = !{!182, !183, i1 false, i2 -1}
!182 = !{!"fixp", i32 -32, i32 7}
!183 = !{double 0xC16F380000000000, double 0x40DCCCCCC0379314}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
!186 = !{i32 1, !16, i32 1, !92, i32 1, !54, i32 1, !102}
!187 = !{!188, !189, i1 false, i2 -1}
!188 = !{!"fixp", i32 32, i32 16}
!189 = !{double 1.638400e+03, double 4.096000e+04}
!190 = distinct !{!190, !23}
!191 = distinct !{!191, !23}
