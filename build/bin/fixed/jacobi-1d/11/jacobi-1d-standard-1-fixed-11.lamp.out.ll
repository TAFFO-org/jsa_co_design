; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-1-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 0x41D0000000000000, !taffo.info !28, !taffo.target !31
  ...
  store float %lampsim5, float* %arrayidx6, align 4, !taffo.info !34, !taffo.target !31
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !35
  br label %for.inc
