; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-16-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u11_21fixp, [10 x i32]* noundef %A.u4_28fixp, [10 x i32]* noundef %B.u4_28fixp) #0 !taffo.initweight !89 !taffo.funinfo !90 !taffo.sourceFunction !91 {
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !55, !taffo.constinfo !92
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !58, !taffo.constinfo !94
  br label %for.cond

for.cond:                                         ; preds = %for.inc16, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc17, %for.inc16 ], !taffo.info !97, !taffo.initweight !98
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !99, !taffo.initweight !100
  br i1 %cmp, label %for.body, label %for.end18, !taffo.info !101, !taffo.initweight !103

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !104, !taffo.initweight !98
  %cmp4 = icmp slt i32 %j.0, %m, !taffo.info !99, !taffo.initweight !100
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !106, !taffo.initweight !103

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !107, !taffo.initweight !100
  %add = add nsw i32 %mul, 1, !taffo.info !109, !taffo.initweight !103, !taffo.constinfo !21
  %rem = srem i32 %add, %n, !taffo.info !111, !taffo.initweight !112
  %conv.u4_28fixp = shl i32 %rem, 28, !taffo.info !113
  %conv6.u5_27fixp = shl i32 %n, 27, !taffo.info !114
  %0 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !113
  %1 = lshr i32 %conv6.u5_27fixp, 1, !taffo.info !114
  %2 = ashr i32 %0, 1, !taffo.info !113
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %2, i32 %1, i32 26), !taffo.info !116
  %div.u1_31fixp = shl i32 %3, 5, !taffo.info !119
  %arrayidx.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u4_28fixp, i32 %i.0, !taffo.info !113
  %arrayidx7.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u4_28fixp, i32 0, i32 %j.0, !taffo.info !113
  %4 = lshr i32 %div.u1_31fixp, 3, !taffo.info !119
  store i32 %4, i32* %arrayidx7.u4_28fixp, align 4, !taffo.info !121
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.info !107, !taffo.initweight !100
  %add9 = add nsw i32 %mul8, 2, !taffo.info !122, !taffo.initweight !103, !taffo.constinfo !21
  %rem10 = srem i32 %add9, %m, !taffo.info !124, !taffo.initweight !112
  %conv11.u4_28fixp = shl i32 %rem10, 28, !taffo.info !126
  %conv12.u4_28fixp = shl i32 %m, 28, !taffo.info !127
  %5 = lshr i32 %conv11.u4_28fixp, 1, !taffo.info !126
  %6 = lshr i32 %conv12.u4_28fixp, 1, !taffo.info !127
  %7 = call i32 @llvm.sdiv.fix.i32(i32 %5, i32 %6, i32 27), !taffo.info !128
  %div13.u1_31fixp = shl i32 %7, 4, !taffo.info !131
  %arrayidx14.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u4_28fixp, i32 %i.0, !taffo.info !132
  %arrayidx15.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u4_28fixp, i32 0, i32 %j.0, !taffo.info !132
  %8 = lshr i32 %div13.u1_31fixp, 3, !taffo.info !131
  store i32 %8, i32* %arrayidx15.u4_28fixp, align 4, !taffo.info !121
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !133, !taffo.initweight !100, !taffo.constinfo !21
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.info !136, !taffo.initweight !100, !taffo.constinfo !21
...
for.cond19:                                       ; preds = %for.inc38, %for.end18
  %i.1 = phi i32 [ 0, %for.end18 ], [ %inc39, %for.inc38 ], !taffo.info !97, !taffo.initweight !98
  %cmp20 = icmp slt i32 %i.1, %n, !taffo.info !99, !taffo.initweight !100
  br i1 %cmp20, label %for.body22, label %for.end40, !taffo.info !101, !taffo.initweight !103

for.body22:                                       ; preds = %for.cond19
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc35, %for.body22
  %j.1 = phi i32 [ 0, %for.body22 ], [ %inc36, %for.inc35 ], !taffo.info !104, !taffo.initweight !98
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.info !138, !taffo.initweight !100
  br i1 %cmp24, label %for.body26, label %for.end37, !taffo.info !106, !taffo.initweight !103

for.body26:                                       ; preds = %for.cond23
  %mul27 = mul nsw i32 %i.1, %j.1, !taffo.info !107, !taffo.initweight !100
  %add28 = add nsw i32 %mul27, 3, !taffo.info !139, !taffo.initweight !103, !taffo.constinfo !21
  %rem29 = srem i32 %add28, %n, !taffo.info !111, !taffo.initweight !112
  %conv30.u4_28fixp = shl i32 %rem29, 28, !taffo.info !113
  %conv31.u4_28fixp = shl i32 %m, 28, !taffo.info !127
  %9 = lshr i32 %conv30.u4_28fixp, 1, !taffo.info !113
  %10 = lshr i32 %conv31.u4_28fixp, 1, !taffo.info !127
  %11 = call i32 @llvm.sdiv.fix.i32(i32 %9, i32 %10, i32 27), !taffo.info !141
  %div32.u4_28fixp = shl i32 %11, 1, !taffo.info !143
  %arrayidx33.u11_21fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u11_21fixp, i32 %i.1, !taffo.info !144
  %arrayidx34.u11_21fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx33.u11_21fixp, i32 0, i32 %j.1, !taffo.info !144
  %12 = lshr i32 %div32.u4_28fixp, 7, !taffo.info !143
  store i32 %12, i32* %arrayidx34.u11_21fixp, align 4, !taffo.info !121
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.info !133, !taffo.initweight !100, !taffo.constinfo !21
  br label %for.cond23, !llvm.loop !145

for.end37:                                        ; preds = %for.cond23
  br label %for.inc38

for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.info !136, !taffo.initweight !100, !taffo.constinfo !21
  br label %for.cond19, !llvm.loop !146
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u11_21fixp, [10 x i32]* noundef %A.u4_28fixp, [10 x i32]* noundef %B.u4_28fixp) #0 !taffo.initweight !147 !taffo.funinfo !90 !taffo.sourceFunction !148 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u11_21fixp = load i32, i32* %arrayidx4.u11_21fixp, align 4, !taffo.info !149
  %0 = lshr i32 %u11_21fixp, 1, !taffo.info !149
  %1 = lshr i32 %beta.u2_30fixp, 1, !taffo.info !45
  %2 = ashr i32 %0, 1, !taffo.info !149
  %3 = ashr i32 %1, 10, !taffo.info !45
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !151
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !154
  %5 = shl i32 %mul.u12_20fixp, 1, !taffo.info !154
...
for.body10:                                       ; preds = %for.cond8
  ...
  %u4_28fixp = load i32, i32* %arrayidx12.u4_28fixp, align 4, !taffo.info !156
  %6 = lshr i32 %u4_28fixp, 1, !taffo.info !156
  %7 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %8 = ashr i32 %6, 1, !taffo.info !156
  %9 = ashr i32 %7, 3, !taffo.info !42
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 26), !taffo.info !157
  %mul13.u5_27fixp = shl i32 %10, 1, !taffo.info !159
  ...
  %11 = lshr i32 %mul13.u5_27fixp, 1, !taffo.info !159
  %12 = lshr i32 %u4_28fixp3, 1, !taffo.info !53
  %13 = ashr i32 %11, 5, !taffo.info !159
  %14 = ashr i32 %12, 6, !taffo.info !53
  %15 = call i32 @llvm.smul.fix.i32(i32 %13, i32 %14, i32 21), !taffo.info !160
  %mul16.u10_22fixp = shl i32 %15, 1, !taffo.info !163
  ...
  %u4_28fixp4 = load i32, i32* %arrayidx18.u4_28fixp, align 4, !taffo.info !165
  %16 = lshr i32 %u4_28fixp4, 1, !taffo.info !165
  %17 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %18 = ashr i32 %16, 1, !taffo.info !165
  %19 = ashr i32 %17, 3, !taffo.info !42
  %20 = call i32 @llvm.smul.fix.i32(i32 %18, i32 %19, i32 26), !taffo.info !166
  %mul19.u5_27fixp = shl i32 %20, 1, !taffo.info !168
  ...
  %21 = lshr i32 %mul19.u5_27fixp, 1, !taffo.info !168
  %22 = lshr i32 %u4_28fixp2, 1, !taffo.info !50
  %23 = ashr i32 %21, 5, !taffo.info !168
  %24 = ashr i32 %22, 6, !taffo.info !50
  %25 = call i32 @llvm.smul.fix.i32(i32 %23, i32 %24, i32 21), !taffo.info !160
  %mul22.u10_22fixp = shl i32 %25, 1, !taffo.info !163
  %26 = lshr i32 %mul16.u10_22fixp, 2, !taffo.info !163
  %27 = lshr i32 %mul22.u10_22fixp, 2, !taffo.info !163
  %add.u12_20fixp = add i32 %26, %27, !taffo.info !169
  ...
  %u11_21fixp1 = load i32, i32* %arrayidx24.u11_21fixp, align 4, !taffo.info !149
  %28 = lshr i32 %u11_21fixp1, 1, !taffo.info !149
  %add25.u12_20fixp = add i32 %28, %add.u12_20fixp, !taffo.info !171
  %29 = shl i32 %add25.u12_20fixp, 1, !taffo.info !171
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u5_27fixp = shl i32 %factor, 27, !taffo.info !114
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !50
  %2 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !114
  %3 = ashr i32 %1, 4, !taffo.info !50
  %4 = ashr i32 %2, 3, !taffo.info !114
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 10, !taffo.info !114
...
!89 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!90 = !{i32 1, !77, i32 1, !16, i32 1, !42, i32 1, !45, i32 1, !47, i32 1, !50, i32 1, !53}
!91 = distinct !{null}
!92 = !{!93, i1 false}
!93 = !{i1 false, !44, i1 false, i2 0}
!94 = !{!95, i1 false}
!95 = !{i1 false, !96, i1 false, i2 0}
!96 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!97 = !{i1 false, !65, i1 false, i2 1}
!98 = !{i32 0}
!99 = !{i1 false, !67, i1 false, i2 1}
!100 = !{i32 2}
!101 = !{i1 false, !102, i1 false, i2 1}
!102 = !{double 0.000000e+00, double 1.600000e+01}
!103 = !{i32 3}
!104 = !{i1 false, !105, i1 false, i2 1}
!105 = !{double 0.000000e+00, double 1.100000e+01}
!106 = !{i1 false, !3, i1 false, i2 1}
!107 = !{i1 false, !108, i1 false, i2 1}
!108 = !{double 0.000000e+00, double 1.600000e+02}
!109 = !{i1 false, !110, i1 false, i2 1}
!110 = !{double 1.000000e+00, double 1.610000e+02}
!111 = !{i1 false, !52, i1 false, i2 1}
!112 = !{i32 4}
!113 = !{!51, !52, i1 false, i2 1}
!114 = !{!115, !78, i1 false, i2 1}
!115 = !{!"fixp", i32 32, i32 27}
!116 = !{!117, !118, i1 false, i2 1}
!117 = !{!"fixp", i32 -32, i32 26}
!118 = !{double 0.000000e+00, double 9.375000e-01}
!119 = !{!120, !118, i1 false, i2 1}
!120 = !{!"fixp", i32 32, i32 31}
!121 = !{i1 false, i1 false, i1 false, i2 1}
!122 = !{i1 false, !123, i1 false, i2 1}
!123 = !{double 2.000000e+00, double 1.620000e+02}
!124 = !{i1 false, !125, i1 false, i2 1}
!125 = !{double 0.000000e+00, double 9.000000e+00}
!126 = !{!51, !125, i1 false, i2 1}
!127 = !{!51, !17, i1 false, i2 1}
!128 = !{!129, !130, i1 false, i2 1}
!129 = !{!"fixp", i32 -32, i32 27}
!130 = !{double 0.000000e+00, double 9.000000e-01}
!131 = !{!120, !130, i1 false, i2 1}
!132 = !{!51, !54, i1 false, i2 1}
!133 = !{i1 false, !134, i1 false, i2 1}
!134 = !{double 1.000000e+00, double 1.100000e+01}
!135 = distinct !{!135, !23}
!136 = !{i1 false, !74, i1 false, i2 1}
!137 = distinct !{!137, !23}
!138 = !{i1 false, !80, i1 false, i2 1}
!139 = !{i1 false, !140, i1 false, i2 1}
!140 = !{double 3.000000e+00, double 1.630000e+02}
!141 = !{!129, !142, i1 false, i2 1}
!142 = !{double 0.000000e+00, double 1.500000e+00}
!143 = !{!51, !142, i1 false, i2 1}
!144 = !{!48, !1, i1 false, i2 1}
!145 = distinct !{!145, !23}
!146 = distinct !{!146, !23}
!147 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!148 = distinct !{null}
!149 = !{!150, !1, i1 false, i2 -1}
!150 = !{!"fixp", i32 32, i32 20}
!151 = !{!152, !153, i1 false, i2 -1}
!152 = !{!"fixp", i32 -32, i32 19}
!153 = !{double 0.000000e+00, double 0x40A2BA9FACD9117F}
!154 = !{!150, !153, i1 false, i2 -1}
!155 = distinct !{!155, !23}
!156 = !{!115, !52, i1 false, i2 -1}
!157 = !{!117, !158, i1 false, i2 -1}
!158 = !{double 0.000000e+00, double 2.250000e+01}
!159 = !{!115, !158, i1 false, i2 -1}
!160 = !{!161, !162, i1 false, i2 -1}
!161 = !{!"fixp", i32 -32, i32 21}
!162 = !{double 0.000000e+00, double 3.240000e+02}
!163 = !{!164, !162, i1 false, i2 -1}
!164 = !{!"fixp", i32 32, i32 22}
!165 = !{!115, !54, i1 false, i2 -1}
!166 = !{!117, !167, i1 false, i2 -1}
!167 = !{double 0.000000e+00, double 2.160000e+01}
!168 = !{!115, !167, i1 false, i2 -1}
!169 = !{!150, !170, i1 false, i2 -1}
!170 = !{double 0.000000e+00, double 6.480000e+02}
!171 = !{!150, !172, i1 false, i2 -1}
!172 = !{double 0.000000e+00, double 0x40A4AB85100A393F}
!173 = distinct !{!173, !23}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
