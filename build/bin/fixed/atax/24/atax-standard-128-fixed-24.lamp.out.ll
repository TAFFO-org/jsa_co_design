; ModuleID = './build/bin/fixed/atax/24/atax-standard-128-fixed-24.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 2.560000e+02, !taffo.info !48, !taffo.target !50
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim1 = and i32 %lampsim, -1
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 2.560000e+02, !taffo.info !48
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -1
  %lampsim5 = bitcast i32 %lampsim4 to float
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !83
  ...
  %3 = fdiv float %lampsim8, 0x4170000000000000, !taffo.info !83
  ...
  %4 = fmul float 2.560000e+02, %lampsim15, !taffo.info !91
