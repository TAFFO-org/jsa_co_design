...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 113, i8* null)
  %B2 = bitcast [5 x [5 x [5 x float]]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 114, i8* null)
...
for.body11:                                       ; preds = %for.cond9
  ...
  store float %12, float* %arrayidx21, align 4
  br label %for.inc
...
for.inc203:                                       ; preds = %for.end202
  ...
  br label %for.cond105, !llvm.loop !18
