; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-128-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 18), !taffo.info !127
  %mul.u13_19fixp = shl i32 %4, 1, !taffo.info !130
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u13_19fixp, 7, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !132 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !133
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !136
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u14_18fixp, 7, !taffo.info !136
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u20_12fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !139 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 4), !taffo.info !140
  %mul.u27_5fixp = shl i32 %4, 1, !taffo.info !143
  %arrayidx1.u20_12fixp = getelementptr inbounds i32, i32* %val.u20_12fixp, i32 %i.0, !taffo.info !69
  %5 = shl i32 %mul.u27_5fixp, 7, !taffo.info !143
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !146 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !147
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !150
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u12_20fixp, 7, !taffo.info !150
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemver.10_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u13_19fixp, i32* noundef %u1.u7_25fixp, i32* noundef %v1.u6_26fixp, i32* noundef %u2.u7_25fixp, i32* noundef %v2.u5_27fixp, float* noundef %w, i32* noundef %x.u20_12fixp, i32* noundef %y.u5_27fixp, i32* noundef %z.u4_28fixp) #0 !taffo.initweight !160 !taffo.funinfo !161 !taffo.sourceFunction !162 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u13_19fixp = load i32, i32* %arrayidx4.u13_19fixp, align 4, !taffo.info !163
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !164
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !166
  %5 = lshr i32 %u13_19fixp, 1, !taffo.info !163
  %add.u14_18fixp = add i32 %5, %mul.u14_18fixp, !taffo.info !167
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 20), !taffo.info !169
  %mul9.u11_21fixp = shl i32 %10, 1, !taffo.info !171
  %11 = lshr i32 %mul9.u11_21fixp, 3, !taffo.info !171
  %add10.u14_18fixp = add i32 %add.u14_18fixp, %11, !taffo.info !172
  ...
  %12 = shl i32 %add10.u14_18fixp, 1, !taffo.info !172
...
for.body21:                                       ; preds = %for.cond19
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 18), !taffo.info !176
  %mul25.u13_19fixp = shl i32 %16, 1, !taffo.info !178
  ...
  %17 = lshr i32 %mul25.u13_19fixp, 1, !taffo.info !178
  %18 = lshr i32 %u5_27fixp4, 1, !taffo.info !71
  %19 = ashr i32 %17, 4, !taffo.info !178
  %20 = ashr i32 %18, 12, !taffo.info !71
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 14), !taffo.info !179
  %mul27.u17_15fixp = shl i32 %21, 1, !taffo.info !182
  %22 = lshr i32 %mul27.u17_15fixp, 3, !taffo.info !182
  %add28.u20_12fixp = add i32 %u20_12fixp, %22, !taffo.info !184
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u20_12fixp = add i32 %u20_12fixp2, %23, !taffo.info !188
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !191
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !192
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 18), !taffo.info !193
  %mul55.u13_19fixp = shl i32 %27, 1, !taffo.info !195
  %28 = uitofp i32 %mul55.u13_19fixp to float, !taffo.info !195
  %29 = fdiv float %28, 5.242880e+05, !taffo.info !195
  ...
  %mul57.1flp = fmul float %29, %31, !taffo.info !196
  %add58.1flp = fadd float %.flt.fallback.1flp, %mul57.1flp, !taffo.info !199
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !191
...
for.inc60:                                        ; preds = %for.body51
  ...
  br label %for.cond49, !llvm.loop !202
...
for.inc63:                                        ; preds = %for.end62
  ...
  br label %for.cond46, !llvm.loop !203
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !204 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !191
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !192
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !125
  %0 = uitofp i32 %conv.u8_24fixp to float, !taffo.info !125
  %1 = fdiv float %0, 0x4170000000000000, !taffo.info !125
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !205
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !191
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u13_19fixp, i32* noundef %u1.u7_25fixp, i32* noundef %v1.u6_26fixp, i32* noundef %u2.u7_25fixp, i32* noundef %v2.u5_27fixp, float* noundef %w, i32* noundef %x.u20_12fixp, i32* noundef %y.u5_27fixp, i32* noundef %z.u4_28fixp) #0 !taffo.initweight !209 !taffo.funinfo !161 !taffo.sourceFunction !210 {
entry:
...
!128 = !{!"fixp", i32 -32, i32 18}
!129 = !{double 2.048000e+02, double 4.096000e+03}
!130 = !{!53, !129, i1 false, i2 -1}
!131 = distinct !{!131, !27}
!132 = !{i32 1, !107, i32 1, !54, i32 1, !119}
!133 = !{!134, !135, i1 false, i2 -1}
!134 = !{!"fixp", i32 -32, i32 17}
!135 = !{double 0.000000e+00, double 0x40CE66665E02EA96}
!136 = !{!137, !135, i1 false, i2 -1}
!137 = !{!"fixp", i32 32, i32 18}
!138 = distinct !{!138, !27}
!139 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!140 = !{!141, !142, i1 false, i2 -1}
!141 = !{!"fixp", i32 -32, i32 4}
!142 = !{double 0.000000e+00, double 0x4195FC45A0000000}
!143 = !{!144, !142, i1 false, i2 -1}
!144 = !{!"fixp", i32 32, i32 5}
!145 = distinct !{!145, !27}
!146 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!147 = !{!148, !149, i1 false, i2 -1}
!148 = !{!"fixp", i32 -32, i32 19}
!149 = !{double 0x406111116A8B8F15, double 0x40A555556084A516}
!150 = !{!151, !149, i1 false, i2 -1}
!151 = !{!"fixp", i32 32, i32 20}
!152 = distinct !{!152, !27}
...
!159 = distinct !{!159, !27}
!160 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!161 = !{i32 1, !107, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !60, i32 1, !62, i32 1, !65, i32 1, !69, i32 1, !71, i32 1, !73}
!162 = distinct !{null}
!163 = !{!137, !5, i1 false, i2 -1}
!164 = !{!134, !165, i1 false, i2 -1}
!165 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!166 = !{!137, !165, i1 false, i2 -1}
!167 = !{!137, !168, i1 false, i2 -1}
!168 = !{double 0.000000e+00, double 0x40C1E111077CCC04}
!169 = !{!155, !170, i1 false, i2 -1}
!170 = !{double 0x400B4E8244127E88, double 0x409555556084A516}
!171 = !{!158, !170, i1 false, i2 -1}
!172 = !{!137, !173, i1 false, i2 -1}
!173 = !{double 0x400B4E8244127E88, double 0x40C48BBBB38D60A7}
!174 = distinct !{!174, !27}
!175 = distinct !{!175, !27}
!176 = !{!128, !177, i1 false, i2 -1}
!177 = !{double 0.000000e+00, double 0x40B8AB850CC35CE1}
!178 = !{!53, !177, i1 false, i2 -1}
!179 = !{!180, !181, i1 false, i2 -1}
!180 = !{!"fixp", i32 -32, i32 14}
!181 = !{double 0.000000e+00, double 0x40F8AB850CC35CE1}
!182 = !{!183, !181, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 15}
!184 = !{!70, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 0x412911B641986B9C}
!186 = distinct !{!186, !27}
!187 = distinct !{!187, !27}
!188 = !{!70, !189, i1 false, i2 -1}
!189 = !{double 7.111110e-01, double 0x4125FC6211C714FD}
!190 = distinct !{!190, !27}
!191 = !{i32 5}
!192 = !{i32 6}
!193 = !{!128, !194, i1 false, i2 -1}
!194 = !{double 0.000000e+00, double 0x40BED6664FF4341A}
!195 = !{!53, !194, i1 false, i2 -1}
!196 = !{!197, !198, i1 false, i2 -1}
!197 = !{!"float", i32 1, double 0x41F52FCEA2AA8142}
!198 = !{double 0.000000e+00, double 0x41F52FCEA2AA8142}
!199 = !{!200, !201, i1 false, i2 -1}
!200 = !{!"float", i32 1, double 0x42260F5914555028}
!201 = !{double 0.000000e+00, double 0x42260F5914555028}
!202 = distinct !{!202, !27}
!203 = distinct !{!203, !27}
!204 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!205 = !{!206, !207, i1 false, i2 -1}
!206 = !{!"float", i32 1, double 0x4293695F40000000}
!207 = !{double 0.000000e+00, double 0x4293695F40000000}
!208 = distinct !{!208, !27}
