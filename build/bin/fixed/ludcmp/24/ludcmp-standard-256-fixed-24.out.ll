; ModuleID = './build/bin/fixed/ludcmp/24/ludcmp-standard-256-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u12_20fixp = bitcast [20 x i32]* %arraydecay10.u12_20fixp to i32*, !taffo.info !42
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u12_20fixp, i32 256), !taffo.info !55, !taffo.constinfo !57
  %arraydecay11.u12_20fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u12_20fixp, i32 0, i32 0, !taffo.info !45
  %u12_20fixp1 = bitcast [20 x i32]* %arraydecay11.u12_20fixp to i32*, !taffo.info !45
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u12_20fixp1, i32 256), !taffo.info !58, !taffo.constinfo !57
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s12_20fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 20), !taffo.info !88
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s12_20fixp, 8, !taffo.info !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !92 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !93
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u11_21fixp = getelementptr inbounds i32, i32* %val.u11_21fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u19_13fixp, 8, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u12_20fixp, i32* noundef %b.u11_21fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u11_21fixp) #0 !taffo.initweight !99 !taffo.funinfo !100 !taffo.sourceFunction !101 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u12_20fixp = load i32, i32* %arrayidx5.u12_20fixp, align 4, !taffo.info !102
  %0 = shl i32 %u12_20fixp, 3, !taffo.info !102
  br label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s24_8fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 8), !taffo.info !105
  %5 = ashr i32 %w.0.s9_23fixp, 15, !taffo.info !102
  %sub.s24_8fixp = sub i32 %5, %mul.s24_8fixp, !taffo.info !108
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s24_8fixp, 15, !taffo.info !108
...
for.end:                                          ; preds = %for.cond6
  ...
  %u12_20fixp11 = load i32, i32* %arrayidx14.u12_20fixp, align 4, !taffo.info !111
  %7 = lshr i32 %u12_20fixp11, 1, !taffo.info !111
  %8 = ashr i32 %w.0.s9_23fixp, 4, !taffo.info !102
  %div.s13_19fixp = call i32 @llvm.sdiv.fix.i32(i32 %8, i32 %7, i32 19), !taffo.info !113
  ...
  %9 = shl i32 %div.s13_19fixp, 1, !taffo.info !113
  store i32 %9, i32* %arrayidx16.u12_20fixp, align 4, !taffo.info !115
  br label %for.inc17
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u12_20fixp12 = load i32, i32* %arrayidx24.u12_20fixp, align 4, !taffo.info !102
  %10 = shl i32 %u12_20fixp12, 3, !taffo.info !102
  br label %for.cond25
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s24_8fixp = call i32 @llvm.smul.fix.i32(i32 %13, i32 %14, i32 8), !taffo.info !105
  %15 = ashr i32 %w.1.s9_23fixp, 15, !taffo.info !102
  %sub33.s24_8fixp = sub i32 %15, %mul32.s24_8fixp, !taffo.info !108
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %16 = shl i32 %sub33.s24_8fixp, 15, !taffo.info !108
...
for.end36:                                        ; preds = %for.cond25
  ...
  %17 = ashr i32 %w.1.s9_23fixp, 3, !taffo.info !102
  store i32 %17, i32* %arrayidx38.u12_20fixp, align 4, !taffo.info !115
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u11_21fixp = load i32, i32* %arrayidx48.u11_21fixp, align 4, !taffo.info !102
  %18 = shl i32 %u11_21fixp, 2, !taffo.info !102
  br label %for.cond49
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s23_9fixp = call i32 @llvm.smul.fix.i32(i32 %21, i32 %22, i32 9), !taffo.info !120
  %23 = ashr i32 %w.2.s9_23fixp, 14, !taffo.info !102
  %sub56.s23_9fixp = sub i32 %23, %mul55.s23_9fixp, !taffo.info !123
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !76, !taffo.constinfo !21
  %24 = shl i32 %sub56.s23_9fixp, 14, !taffo.info !123
...
for.end59:                                        ; preds = %for.cond49
  ...
  %25 = ashr i32 %w.2.s9_23fixp, 2, !taffo.info !102
  store i32 %25, i32* %arrayidx60.u11_21fixp, align 4, !taffo.info !115
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u11_21fixp8 = load i32, i32* %arrayidx68.u11_21fixp, align 4, !taffo.info !102
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %26 = shl i32 %u11_21fixp8, 2, !taffo.info !102
  br label %for.cond69
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s15_17fixp = call i32 @llvm.smul.fix.i32(i32 %28, i32 %29, i32 17), !taffo.info !133
  %30 = ashr i32 %w.3.s9_23fixp, 6, !taffo.info !102
  %sub76.s15_17fixp = sub i32 %30, %mul75.s15_17fixp, !taffo.info !136
  br label %for.inc77

for.inc77:                                        ; preds = %for.body71
  %inc78 = add nsw i32 %j.3, 1, !taffo.info !138, !taffo.constinfo !21
  %31 = shl i32 %sub76.s15_17fixp, 6, !taffo.info !136
...
for.end79:                                        ; preds = %for.cond69
  ...
  %u12_20fixp17 = load i32, i32* %arrayidx81.u12_20fixp, align 4, !taffo.info !111
  %32 = lshr i32 %u12_20fixp17, 1, !taffo.info !111
  %33 = ashr i32 %w.3.s9_23fixp, 4, !taffo.info !102
  %div82.s13_19fixp = call i32 @llvm.sdiv.fix.i32(i32 %33, i32 %32, i32 19), !taffo.info !113
  %arrayidx83.s4_28fixp = getelementptr inbounds i32, i32* %x.s4_28fixp, i32 %i.2, !taffo.info !50
  %34 = shl i32 %div82.s13_19fixp, 9, !taffo.info !113
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 8), !taffo.info !105
...
!90 = !{double 0xC0236DCA07F66E87, double 0x408FFCF893FAF428}
!91 = distinct !{!91, !23}
!92 = !{i32 1, !74, i32 1, !47, i32 1, !83}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 12}
!95 = !{double 0x411019999FE43676, double 2.949120e+05}
!96 = !{!97, !95, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 13}
!98 = distinct !{!98, !23}
...
!106 = !{!"fixp", i32 -32, i32 8}
!107 = !{double 0x3F847AE147AE147C, double 0x4150B28B463B78B0}
!108 = !{!106, !109, i1 false, i2 -1}
!109 = !{double 0xC150B2BD463B78B0, double 1.999900e+02}
!110 = distinct !{!110, !23}
!111 = !{!112, !44, i1 false, i2 -1}
!112 = !{!"fixp", i32 -32, i32 19}
...
!121 = !{!"fixp", i32 -32, i32 9}
!122 = !{double 0.000000e+00, double 0x41407278CFD00C6E}
!123 = !{!121, !124, i1 false, i2 -1}
!124 = !{double 0xC14072DCCFD00C6E, double 2.000000e+02}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
...
!134 = !{!"fixp", i32 -32, i32 17}
!135 = !{double 0xC053D9094AED99C8, double 0x40C056C5CDD0C3A5}
!136 = !{!134, !137, i1 false, i2 -1}
!137 = !{double 0xC0C0BAC5CDD0C3A5, double 0x4071764252BB6672}
