; ModuleID = './build/stats/3mm/1024/3mm-standard-1024.out.dynamic_instrumented.1.taffotmp.ll'
...
for.body30:                                       ; preds = %for.cond28
  ...
  store float %23, float* %arrayidx36, align 4
  br label %for.inc
...
for.inc61:                                        ; preds = %for.end60
  ...
  br label %for.cond39, !llvm.loop !21
...
for.inc120:                                       ; preds = %for.body115
  ...
  br label %for.cond112, !llvm.loop !26
...
for.inc123:                                       ; preds = %for.end122
  ...
  br label %for.cond108, !llvm.loop !27
...
for.inc138:                                       ; preds = %for.body133
  ...
  br label %for.cond130, !llvm.loop !28
...
for.inc141:                                       ; preds = %for.end140
  ...
  br label %for.cond126, !llvm.loop !29
...
for.inc54:                                        ; preds = %for.body39
  ...
  br label %for.cond37, !llvm.loop !33
