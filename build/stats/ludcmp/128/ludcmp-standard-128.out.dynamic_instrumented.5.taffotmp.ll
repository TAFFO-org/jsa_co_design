; ModuleID = './build/stats/ludcmp/128/ludcmp-standard-128.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 128), !taffo.originalCall !28
