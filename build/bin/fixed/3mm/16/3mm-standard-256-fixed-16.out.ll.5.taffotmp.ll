; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u6_26fixp = bitcast [10 x i32]* %arraydecay15.u6_26fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u6_26fixp, i32 256), !taffo.info !62, !taffo.constinfo !61
  ...
  %u6_26fixp2 = bitcast [14 x i32]* %arraydecay18.u6_26fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u6_26fixp2, i32 256), !taffo.info !65, !taffo.constinfo !61
  %arraydecay19.u6_26fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u6_26fixp, i32 0, i32 0, !taffo.info !54
  %u6_26fixp1 = bitcast [12 x i32]* %arraydecay19.u6_26fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u6_26fixp1, i32 256), !taffo.info !66, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 17), !taffo.info !235
  %mul.u14_18fixp = shl i32 %5, 1, !taffo.info !237
  ...
  %7 = shl i32 %mul.u14_18fixp, 8, !taffo.info !237
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !240 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !241
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !244
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u21_11fixp, 8, !taffo.info !244
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !248 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 9), !taffo.info !249
  %mul.u22_10fixp = shl i32 %5, 1, !taffo.info !252
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u22_10fixp, 8, !taffo.info !252
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u28_4fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !256 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !257
  ...
  %6 = fmul float 1.600000e+01, %mul.1flp, !taffo.info !257
  %7 = fptoui float %6 to i32, !taffo.info !257
...
!236 = !{double 0.000000e+00, double 0x40C555556084A516}
!237 = !{!50, !236, i1 false, i2 -1}
!238 = distinct !{!238, !23}
!239 = distinct !{!239, !23}
!240 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !230}
!241 = !{!242, !243, i1 false, i2 -1}
!242 = !{!"fixp", i32 -32, i32 10}
!243 = !{double 0.000000e+00, double 0x413BBBBBE004B7F6}
!244 = !{!245, !243, i1 false, i2 -1}
!245 = !{!"fixp", i32 32, i32 11}
!246 = distinct !{!246, !23}
!247 = distinct !{!247, !23}
!248 = !{i32 1, !96, i32 1, !85, i32 1, !49, i32 1, !230}
!249 = !{!250, !251, i1 false, i2 -1}
!250 = !{!"fixp", i32 -32, i32 9}
!251 = !{double 0.000000e+00, double 0x4140624DDFFC547A}
!252 = !{!253, !251, i1 false, i2 -1}
!253 = !{!"fixp", i32 32, i32 10}
!254 = distinct !{!254, !23}
!255 = distinct !{!255, !23}
!256 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !230}
!257 = !{!258, !259, i1 false, i2 -1}
!258 = !{!"float", i32 1, double 0x422BCB0680000000}
!259 = !{double 0.000000e+00, double 0x422BCB0680000000}
!260 = distinct !{!260, !23}
!261 = distinct !{!261, !23}
