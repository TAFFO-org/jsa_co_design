; ModuleID = './build/bin/fixed/symm/24/symm-standard-8-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 8), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 8), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 8), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 8), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 8), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div = fdiv float %conv, %conv6, !taffo.info !150, !taffo.initweight !109
  ...
  %div12 = fdiv float %conv10, %conv11, !taffo.info !150, !taffo.initweight !109
...
for.body25:                                       ; preds = %for.cond22
  ...
  %div30 = fdiv float %conv28, %conv29, !taffo.info !150, !taffo.initweight !109
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !172, !taffo.initweight !120
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !171
  %mul = fmul float %1, %conv, !taffo.info !178, !taffo.initweight !120
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !171
  %mul = fmul float %1, %conv, !taffo.info !184, !taffo.initweight !120
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
...
!53 = !{double -7.992000e+03, double 1.440000e+01}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 27}
!56 = !{double 8.000000e-01, double 2.000000e+01}
...
!107 = !{!"fixp", i32 -32, i32 13}
!108 = !{double -1.598400e+05, double 2.880000e+02}
!109 = !{i32 5}
!110 = !{i32 6}
!111 = !{i32 7}
!112 = !{!55, !113, i1 false, i2 -1}
!113 = !{double 0x3FF3333333333334, double 3.000000e+01}
!114 = !{!107, !115, i1 false, i2 -1}
!115 = !{double -2.397600e+05, double 4.320000e+02}
!116 = !{!107, !117, i1 false, i2 -1}
!117 = !{double -2.397600e+05, double 0x40A8D147C0096FEB}
!118 = !{!107, !108, i1 false, i2 -1}
!119 = !{i32 8}
!120 = !{i32 9}
!121 = distinct !{!121, !23}
!122 = !{!49, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40A9BB22E671B980}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 -32, i32 12}
!126 = !{double -2.397600e+05, double 0x40AD1B22E671B980}
!127 = !{!125, !115, i1 false, i2 -1}
!128 = !{!125, !129, i1 false, i2 -1}
!129 = !{double -4.795200e+05, double 0x40B03D917338DCC0}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
...
!170 = !{i32 1, !16, i32 1, !92, i32 1, !48, i32 1, !102}
!171 = !{!149, !103, i1 false, i2 1}
!172 = !{!173, !174, i1 false, i2 -1}
!173 = !{!"fixp", i32 32, i32 17}
!174 = !{double 0.000000e+00, double 0x40D57147C0096FEB}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !102}
!178 = !{!179, !180, i1 false, i2 -1}
!179 = !{!"fixp", i32 -32, i32 15}
!180 = !{double -6.393600e+04, double 1.152000e+02}
!181 = distinct !{!181, !23}
!182 = distinct !{!182, !23}
!183 = !{i32 1, !16, i32 1, !92, i32 1, !54, i32 1, !102}
!184 = !{!185, !186, i1 false, i2 -1}
!185 = !{!"fixp", i32 32, i32 24}
!186 = !{double 6.400000e+00, double 1.600000e+02}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
