; ModuleID = './build/bin/fixed/symm/24/symm-standard-1024-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,44827728.0) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [44 x i8] c"scalar(range(-1022976.0,1843.199951) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [39 x i8] c"scalar(range(102.400002,2560.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 1024), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 1024), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
for.end:                                          ; preds = %for.cond4
  ...
  %mul29 = fmul float %alpha, %temp2.0, !taffo.initweight !95, !taffo.info !131
  %add30 = fadd float %add28, %mul29, !taffo.initweight !127, !taffo.info !143
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %m, i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !147 !taffo.funinfo !124 !taffo.sourceFunction !60 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !137, !taffo.info !171
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !120
  %mul = fmul float %1, %conv, !taffo.initweight !137, !taffo.info !176
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !120
  %mul = fmul float %1, %conv, !taffo.initweight !137, !taffo.info !181
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
...
!7 = !{double 0.000000e+00, double 0x4185602280000000}
...
!56 = !{double 0xC12F380000000000, double 0x409CCCCCBFF47736}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0x40599999A1FD156A, double 2.560000e+03}
!59 = !{i32 1}
...
!121 = !{double 1.024000e+03, double 1.024000e+03}
...
!126 = !{double 0xC1E3830000000000, double 0x4151FFFFF7F8CA82}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x40633333397DD010, double 3.840000e+03}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0xC1ED448000000000, double 0x415AFFFFF3F52FC3}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0xC1ED448000000000, double 0x4188C0227E7EA5F8}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x4189A68FCCCCCCCD}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0xC1ED448000000000, double 0x418D068FCB4B72C5}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC1FD448000000000, double 0x41903347E4E50C5F}
!145 = distinct !{!145, !29}
!146 = distinct !{!146, !29}
...
!170 = !{i32 1, !22, i32 1, !110, i32 1, !53, i32 1, !120}
!171 = !{i1 false, !172, i1 false, i2 -1}
!172 = !{double 0.000000e+00, double 0x4225602280000000}
!173 = distinct !{!173, !29}
!174 = distinct !{!174, !29}
!175 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !120}
!176 = !{i1 false, !177, i1 false, i2 -1}
!177 = !{double 0xC1CF380000000000, double 0x413CCCCCBFF47736}
!178 = distinct !{!178, !29}
!179 = distinct !{!179, !29}
!180 = !{i32 1, !22, i32 1, !110, i32 1, !57, i32 1, !120}
!181 = !{i1 false, !182, i1 false, i2 -1}
!182 = !{double 0x40F99999A1FD156A, double 2.621440e+06}
!183 = distinct !{!183, !29}
!184 = distinct !{!184, !29}
