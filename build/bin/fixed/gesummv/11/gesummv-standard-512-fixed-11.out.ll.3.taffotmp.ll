; ModuleID = './build/bin/fixed/gesummv/11/gesummv-standard-512-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,480.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,1155072.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [47 x i8] c"target('y') scalar(range(0.0,2968781.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.initweight !60, !taffo.info !50, !taffo.originalCall !63, !taffo.constinfo !64
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 512), !taffo.initweight !60, !taffo.info !52, !taffo.originalCall !63, !taffo.constinfo !64
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 512), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 512), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.initweight !60, !taffo.info !56
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 512), !taffo.initweight !65, !taffo.info !56, !taffo.originalCall !69, !taffo.constinfo !70
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.initweight !60, !taffo.info !54
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 512), !taffo.initweight !65, !taffo.info !54, !taffo.originalCall !69, !taffo.constinfo !70
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 512), !taffo.initweight !65, !taffo.info !58, !taffo.target !59, !taffo.originalCall !69, !taffo.constinfo !70
...
!7 = !{double 0.000000e+00, double 0x4146A66680000000}
...
!55 = !{double 0.000000e+00, double 4.800000e+02}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x4131A00000000000}
...
!117 = !{double 0.000000e+00, double 0x41C1A00000000000}
!118 = distinct !{!118, !29}
!119 = !{i32 1, !103, i32 1, !54, i32 1, !110}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 2.457600e+05}
!122 = distinct !{!122, !29}
...
!126 = !{double 0.000000e+00, double 2.304000e+05}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x4135240000000000}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x4148686680000000}
!131 = distinct !{!131, !29}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x413A700000000000}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x414B2E1499999999}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x4154330A4CCCCCCC}
!138 = distinct !{!138, !29}
!139 = !{i32 1, !103, i32 1, !58, i32 1, !110}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x41D6A66680000000}
!142 = distinct !{!142, !29}
