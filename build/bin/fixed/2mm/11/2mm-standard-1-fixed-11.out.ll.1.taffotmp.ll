...
entry:
  ...
  call void @llvm.var.annotation(i8* %tmp3, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 131, i8* null)
  ...
  call void @llvm.var.annotation(i8* %D7, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 135, i8* null)
  ...
  %arraydecay12 = getelementptr inbounds [8 x [10 x float]], [8 x [10 x float]]* %tmp, i32 0, i32 0
  %arraydecay13 = getelementptr inbounds [8 x [12 x float]], [8 x [12 x float]]* %A, i32 0, i32 0
  %arraydecay14 = getelementptr inbounds [12 x [10 x float]], [12 x [10 x float]]* %B, i32 0, i32 0
  %arraydecay15 = getelementptr inbounds [10 x [14 x float]], [10 x [14 x float]]* %C, i32 0, i32 0
  %arraydecay16 = getelementptr inbounds [8 x [14 x float]], [8 x [14 x float]]* %D, i32 0, i32 0
  call void @kernel_2mm(i32 noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7, float noundef %8, float noundef %9, [10 x float]* noundef %arraydecay12, [12 x float]* noundef %arraydecay13, [10 x float]* noundef %arraydecay14, [14 x float]* noundef %arraydecay15, [14 x float]* noundef %arraydecay16)
...
for.body19:                                       ; preds = %for.cond17
  ...
  %arrayidx = getelementptr inbounds [8 x [14 x float]], [8 x [14 x float]]* %D, i32 0, i32 %14
  %15 = load i32, i32* %j, align 4
  %arrayidx20 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx, i32 0, i32 %15
  ...
  store float %16, float* %arrayidx22, align 4
  br label %for.inc
