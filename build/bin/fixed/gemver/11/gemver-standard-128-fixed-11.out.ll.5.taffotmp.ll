; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-128-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 4.096000e+03, !taffo.info !69
...
for.body43:                                       ; preds = %for.cond41
  ...
  %3 = fdiv float %2, 5.242880e+05, !taffo.info !52
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !127
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !130
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u12_20fixp, 7, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !133 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !134
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !137
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u14_18fixp, 7, !taffo.info !137
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4170000000000000, !taffo.info !125
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !153 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u11_21fixp, 7, !taffo.info !157
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u20_12fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !160 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 4), !taffo.info !161
  %mul.u27_5fixp = shl i32 %4, 1, !taffo.info !164
  %arrayidx1.u20_12fixp = getelementptr inbounds i32, i32* %val.u20_12fixp, i32 %i.0, !taffo.info !69
  %5 = shl i32 %mul.u27_5fixp, 7, !taffo.info !164
...
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !77, !taffo.constinfo !170
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !80, !taffo.constinfo !172
  %conv.u5_27fixp = shl i32 %n, 27, !taffo.info !175
  br label %for.cond

for.cond:                                         ; preds = %for.inc51, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc52, %for.inc51 ], !taffo.info !176, !taffo.initweight !67
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !178, !taffo.initweight !97
  br i1 %cmp, label %for.body, label %for.end53, !taffo.info !176, !taffo.initweight !179

for.body:                                         ; preds = %for.cond
  %conv5.u5_27fixp = shl i32 %i.0, 27, !taffo.info !180
  %0 = lshr i32 %conv5.u5_27fixp, 1, !taffo.info !180
  %1 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !175
  %2 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %1, i32 26), !taffo.info !181
  %div.u1_31fixp = shl i32 %2, 5, !taffo.info !183
  %arrayidx.u7_25fixp = getelementptr inbounds i32, i32* %u1.u7_25fixp, i32 %i.0, !taffo.info !185
  %3 = lshr i32 %div.u1_31fixp, 6, !taffo.info !183
  store i32 %3, i32* %arrayidx.u7_25fixp, align 4, !taffo.info !186
  %add = add nsw i32 %i.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
  %conv6.u5_27fixp = shl i32 %add, 27, !taffo.info !188, !taffo.constinfo !25
  %4 = lshr i32 %conv6.u5_27fixp, 1, !taffo.info !188, !taffo.constinfo !25
  %5 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !175
  %6 = call i32 @llvm.sdiv.fix.i32(i32 %4, i32 %5, i32 26), !taffo.info !189
  %div7.u2_30fixp = shl i32 %6, 4, !taffo.info !191
  %7 = lshr i32 %div7.u2_30fixp, 1, !taffo.info !191
  %8 = shl i32 2, 29
  %9 = call i32 @llvm.sdiv.fix.i32(i32 %7, i32 %8, i32 29), !taffo.info !192
  %div9.u2_30fixp = shl i32 %9, 1, !taffo.info !195, !taffo.constinfo !196
  %conv10.u1_31fixp = shl i32 %div9.u2_30fixp, 1, !taffo.info !197, !taffo.constinfo !196
  %arrayidx11.u7_25fixp = getelementptr inbounds i32, i32* %u2.u7_25fixp, i32 %i.0, !taffo.info !199
  %10 = lshr i32 %conv10.u1_31fixp, 6, !taffo.info !197, !taffo.constinfo !196
  store i32 %10, i32* %arrayidx11.u7_25fixp, align 4, !taffo.info !186
  %add12 = add nsw i32 %i.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
  %conv13.u5_27fixp = shl i32 %add12, 27, !taffo.info !188, !taffo.constinfo !25
  %11 = lshr i32 %conv13.u5_27fixp, 1, !taffo.info !188, !taffo.constinfo !25
  %12 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !175
  %13 = call i32 @llvm.sdiv.fix.i32(i32 %11, i32 %12, i32 26), !taffo.info !189
  %div14.u2_30fixp = shl i32 %13, 4, !taffo.info !191
  %14 = lshr i32 %div14.u2_30fixp, 1, !taffo.info !191
  %15 = shl i32 4, 28
  %16 = ashr i32 %14, 1, !taffo.info !191
  %17 = call i32 @llvm.sdiv.fix.i32(i32 %16, i32 %15, i32 28), !taffo.info !200
  %div16.u2_30fixp = shl i32 %17, 2, !taffo.info !203, !taffo.constinfo !204
  %conv17.u1_31fixp = shl i32 %div16.u2_30fixp, 1, !taffo.info !207, !taffo.constinfo !204
  %arrayidx18.u6_26fixp = getelementptr inbounds i32, i32* %v1.u6_26fixp, i32 %i.0, !taffo.info !209
  %18 = lshr i32 %conv17.u1_31fixp, 5, !taffo.info !207, !taffo.constinfo !204
  store i32 %18, i32* %arrayidx18.u6_26fixp, align 4, !taffo.info !186
  %add19 = add nsw i32 %i.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
  %conv20.u5_27fixp = shl i32 %add19, 27, !taffo.info !188, !taffo.constinfo !25
  %19 = lshr i32 %conv20.u5_27fixp, 1, !taffo.info !188, !taffo.constinfo !25
  %20 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !175
  %21 = call i32 @llvm.sdiv.fix.i32(i32 %19, i32 %20, i32 26), !taffo.info !189
  %div21.u2_30fixp = shl i32 %21, 4, !taffo.info !191
  %22 = lshr i32 %div21.u2_30fixp, 1, !taffo.info !191
  %23 = shl i32 6, 28
  %24 = ashr i32 %22, 1, !taffo.info !191
  %25 = call i32 @llvm.sdiv.fix.i32(i32 %24, i32 %23, i32 28), !taffo.info !210
  %div23.u2_30fixp = shl i32 %25, 2, !taffo.info !212, !taffo.constinfo !213
  %conv24.u1_31fixp = shl i32 %div23.u2_30fixp, 1, !taffo.info !216, !taffo.constinfo !213
  %arrayidx25.u5_27fixp = getelementptr inbounds i32, i32* %v2.u5_27fixp, i32 %i.0, !taffo.info !218
  %26 = lshr i32 %conv24.u1_31fixp, 4, !taffo.info !216, !taffo.constinfo !213
  store i32 %26, i32* %arrayidx25.u5_27fixp, align 4, !taffo.info !186
  %add26 = add nsw i32 %i.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
  %conv27.u5_27fixp = shl i32 %add26, 27, !taffo.info !188, !taffo.constinfo !25
  %27 = lshr i32 %conv27.u5_27fixp, 1, !taffo.info !188, !taffo.constinfo !25
  %28 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !175
  %29 = call i32 @llvm.sdiv.fix.i32(i32 %27, i32 %28, i32 26), !taffo.info !189
  %div28.u2_30fixp = shl i32 %29, 4, !taffo.info !191
  %30 = lshr i32 %div28.u2_30fixp, 1, !taffo.info !191
  %31 = shl i32 8, 27
  %32 = ashr i32 %30, 2, !taffo.info !191
  %33 = call i32 @llvm.sdiv.fix.i32(i32 %32, i32 %31, i32 27), !taffo.info !219
  %div30.u2_30fixp = shl i32 %33, 3, !taffo.info !222, !taffo.constinfo !223
  %conv31.u1_31fixp = shl i32 %div30.u2_30fixp, 1, !taffo.info !226, !taffo.constinfo !223
  %arrayidx32.u5_27fixp = getelementptr inbounds i32, i32* %y.u5_27fixp, i32 %i.0, !taffo.info !228
  %34 = lshr i32 %conv31.u1_31fixp, 4, !taffo.info !226, !taffo.constinfo !223
  store i32 %34, i32* %arrayidx32.u5_27fixp, align 4, !taffo.info !186
  %add33 = add nsw i32 %i.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
  %conv34.u5_27fixp = shl i32 %add33, 27, !taffo.info !188, !taffo.constinfo !25
  %35 = lshr i32 %conv34.u5_27fixp, 1, !taffo.info !188, !taffo.constinfo !25
  %36 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !175
  %37 = call i32 @llvm.sdiv.fix.i32(i32 %35, i32 %36, i32 26), !taffo.info !189
  %div35.u2_30fixp = shl i32 %37, 4, !taffo.info !191
  %38 = lshr i32 %div35.u2_30fixp, 1, !taffo.info !191
  %39 = shl i32 9, 27
  %40 = ashr i32 %38, 2, !taffo.info !191
  %41 = call i32 @llvm.sdiv.fix.i32(i32 %40, i32 %39, i32 27), !taffo.info !229
  %div37.u2_30fixp = shl i32 %41, 3, !taffo.info !231, !taffo.constinfo !232
  %conv38.u1_31fixp = shl i32 %div37.u2_30fixp, 1, !taffo.info !235, !taffo.constinfo !232
  %arrayidx39.u4_28fixp = getelementptr inbounds i32, i32* %z.u4_28fixp, i32 %i.0, !taffo.info !237
  %42 = lshr i32 %conv38.u1_31fixp, 3, !taffo.info !235, !taffo.constinfo !232
  store i32 %42, i32* %arrayidx39.u4_28fixp, align 4, !taffo.info !186
  %arrayidx40.u20_12fixp = getelementptr inbounds i32, i32* %x.u20_12fixp, i32 %i.0, !taffo.info !238
  store i32 0, i32* %arrayidx40.u20_12fixp, align 4, !taffo.info !186, !taffo.constinfo !239
  %arrayidx41.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.0, !taffo.info !240, !taffo.initweight !97
  store float 0.000000e+00, float* %arrayidx41.flt.1flp, align 4, !taffo.info !186, !taffo.constinfo !239
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !176, !taffo.initweight !67
  %cmp43 = icmp slt i32 %j.0, %n, !taffo.info !178, !taffo.initweight !97
  br i1 %cmp43, label %for.body45, label %for.end, !taffo.info !176, !taffo.initweight !179

for.body45:                                       ; preds = %for.cond42
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !241, !taffo.initweight !97
  %rem = srem i32 %mul, %n, !taffo.info !243, !taffo.initweight !179
  %conv46.u5_27fixp = shl i32 %rem, 27, !taffo.info !245
  %conv47.u5_27fixp = shl i32 %n, 27, !taffo.info !175
  %43 = lshr i32 %conv46.u5_27fixp, 1, !taffo.info !245
  %44 = lshr i32 %conv47.u5_27fixp, 1, !taffo.info !175
  %45 = call i32 @llvm.sdiv.fix.i32(i32 %43, i32 %44, i32 26), !taffo.info !246
  %div48.u1_31fixp = shl i32 %45, 5, !taffo.info !248
  %arrayidx49.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u13_19fixp, i32 %i.0, !taffo.info !249
  %arrayidx50.u13_19fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx49.u13_19fixp, i32 0, i32 %j.0, !taffo.info !249
  %46 = lshr i32 %div48.u1_31fixp, 12, !taffo.info !248
  store i32 %46, i32* %arrayidx50.u13_19fixp, align 4, !taffo.info !186
  br label %for.inc

for.inc:                                          ; preds = %for.body45
  %inc = add nsw i32 %j.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
  br label %for.cond42, !llvm.loop !250

for.end:                                          ; preds = %for.cond42
  br label %for.inc51

for.inc51:                                        ; preds = %for.end
  %inc52 = add nsw i32 %i.0, 1, !taffo.info !187, !taffo.initweight !97, !taffo.constinfo !25
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemver.10_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u13_19fixp, i32* noundef %u1.u7_25fixp, i32* noundef %v1.u6_26fixp, i32* noundef %u2.u7_25fixp, i32* noundef %v2.u5_27fixp, float* noundef %w, i32* noundef %x.u20_12fixp, i32* noundef %y.u5_27fixp, i32* noundef %z.u4_28fixp) #0 !taffo.initweight !252 !taffo.funinfo !168 !taffo.sourceFunction !253 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u13_19fixp = load i32, i32* %arrayidx4.u13_19fixp, align 4, !taffo.info !254
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !255
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !257
  %5 = lshr i32 %u13_19fixp, 1, !taffo.info !254
  %add.u14_18fixp = add i32 %5, %mul.u14_18fixp, !taffo.info !258
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 20), !taffo.info !260
  %mul9.u11_21fixp = shl i32 %10, 1, !taffo.info !262
  %11 = lshr i32 %mul9.u11_21fixp, 3, !taffo.info !262
  %add10.u14_18fixp = add i32 %add.u14_18fixp, %11, !taffo.info !263
  ...
  %12 = shl i32 %add10.u14_18fixp, 1, !taffo.info !263
...
for.body21:                                       ; preds = %for.cond19
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 18), !taffo.info !267
  %mul25.u13_19fixp = shl i32 %16, 1, !taffo.info !269
  ...
  %17 = lshr i32 %mul25.u13_19fixp, 1, !taffo.info !269
  %18 = lshr i32 %u5_27fixp4, 1, !taffo.info !71
  %19 = ashr i32 %17, 4, !taffo.info !269
  %20 = ashr i32 %18, 12, !taffo.info !71
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 14), !taffo.info !270
  %mul27.u17_15fixp = shl i32 %21, 1, !taffo.info !273
  %22 = lshr i32 %mul27.u17_15fixp, 3, !taffo.info !273
  %add28.u20_12fixp = add i32 %u20_12fixp, %22, !taffo.info !275
...
for.inc30:                                        ; preds = %for.body21
  ...
  br label %for.cond19, !llvm.loop !277
...
for.inc33:                                        ; preds = %for.end32
  ...
  br label %for.cond16, !llvm.loop !278
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u20_12fixp = add i32 %u20_12fixp2, %23, !taffo.info !279
...
for.inc43:                                        ; preds = %for.body38
  ...
  br label %for.cond36, !llvm.loop !281
...
for.body51:                                       ; preds = %for.cond49
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 18), !taffo.info !282
  %mul55.u13_19fixp = shl i32 %27, 1, !taffo.info !284
  %28 = uitofp i32 %mul55.u13_19fixp to float, !taffo.info !284
  %29 = fdiv float %28, 5.242880e+05, !taffo.info !284
  ...
  %31 = fdiv float %30, 4.096000e+03, !taffo.info !69
  %mul57.1flp = fmul float %29, %31, !taffo.info !285
  %add58.1flp = fadd float %.flt.fallback.1flp, %mul57.1flp, !taffo.info !288
...
for.inc60:                                        ; preds = %for.body51
  ...
  br label %for.cond49, !llvm.loop !291
...
for.inc63:                                        ; preds = %for.end62
  ...
  br label %for.cond46, !llvm.loop !292
...
!128 = !{!"fixp", i32 -32, i32 19}
!129 = !{double 0x406111116A8B8F15, double 0x40A555556084A516}
!130 = !{!131, !129, i1 false, i2 -1}
!131 = !{!"fixp", i32 32, i32 20}
!132 = distinct !{!132, !27}
!133 = !{i32 1, !107, i32 1, !54, i32 1, !119}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 -32, i32 17}
!136 = !{double 0.000000e+00, double 0x40CE66665E02EA96}
!137 = !{!138, !136, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 18}
!139 = distinct !{!139, !27}
!140 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!141 = !{i32 5}
!142 = !{i32 6}
!143 = !{!144, !145, i1 false, i2 -1}
!144 = !{!"float", i32 1, double 0x4293695F40000000}
!145 = !{double 0.000000e+00, double 0x4293695F40000000}
!146 = distinct !{!146, !27}
...
!156 = !{double 0x4056C16BDB1A6D6A, double 0x409C71C714FCE747}
!157 = !{!158, !156, i1 false, i2 -1}
!158 = !{!"fixp", i32 32, i32 21}
!159 = distinct !{!159, !27}
!160 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!161 = !{!162, !163, i1 false, i2 -1}
!162 = !{!"fixp", i32 -32, i32 4}
!163 = !{double 0.000000e+00, double 0x4195FC45A0000000}
!164 = !{!165, !163, i1 false, i2 -1}
!165 = !{!"fixp", i32 32, i32 5}
!166 = distinct !{!166, !27}
!167 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!168 = !{i32 1, !107, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !60, i32 1, !62, i32 1, !65, i32 1, !69, i32 1, !71, i32 1, !73}
!169 = distinct !{null}
!170 = !{!171, i1 false}
!171 = !{i1 false, !49, i1 false, i2 0}
!172 = !{!173, i1 false}
!173 = !{i1 false, !174, i1 false, i2 0}
!174 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!175 = !{!63, !108, i1 false, i2 1}
!176 = !{i1 false, !177, i1 false, i2 -1}
!177 = !{double 0.000000e+00, double 2.000000e+01}
!178 = !{i1 false, !96, i1 false, i2 -1}
!179 = !{i32 3}
!180 = !{!63, !177, i1 false, i2 -1}
!181 = !{!182, !96, i1 false, i2 1}
!182 = !{!"fixp", i32 -32, i32 26}
!183 = !{!184, !96, i1 false, i2 1}
!184 = !{!"fixp", i32 32, i32 31}
!185 = !{!55, !56, i1 false, i2 1}
!186 = !{i1 false, i1 false, i1 false, i2 1}
!187 = !{i1 false, !104, i1 false, i2 -1}
!188 = !{!63, !104, i1 false, i2 -1}
!189 = !{!182, !190, i1 false, i2 1}
!190 = !{double 5.000000e-02, double 1.050000e+00}
!191 = !{!48, !190, i1 false, i2 1}
!192 = !{!193, !194, i1 false, i2 1}
!193 = !{!"fixp", i32 -32, i32 29}
!194 = !{double 2.500000e-02, double 5.250000e-01}
!195 = !{!48, !194, i1 false, i2 1}
!196 = !{i1 false, !23}
!197 = !{!184, !198, i1 false, i2 1}
!198 = !{double 0x3F99999980000000, double 0x3FE0CCCCE0000000}
!199 = !{!55, !61, i1 false, i2 1}
!200 = !{!201, !202, i1 false, i2 1}
!201 = !{!"fixp", i32 -32, i32 28}
!202 = !{double 1.250000e-02, double 2.625000e-01}
!203 = !{!48, !202, i1 false, i2 1}
!204 = !{i1 false, !205}
!205 = !{i1 false, !206, i1 false, i2 0}
!206 = !{double 4.000000e+00, double 4.000000e+00}
!207 = !{!184, !208, i1 false, i2 1}
!208 = !{double 0x3F89999980000000, double 0x3FD0CCCCE0000000}
!209 = !{!58, !59, i1 false, i2 1}
!210 = !{!201, !211, i1 false, i2 1}
!211 = !{double 0x3F81111111111111, double 0x3FC6666666666667}
!212 = !{!48, !211, i1 false, i2 1}
!213 = !{i1 false, !214}
!214 = !{i1 false, !215, i1 false, i2 0}
!215 = !{double 6.000000e+00, double 6.000000e+00}
!216 = !{!184, !217, i1 false, i2 1}
!217 = !{double 0x3F81111100000000, double 0x3FC6666680000000}
!218 = !{!63, !64, i1 false, i2 1}
!219 = !{!220, !221, i1 false, i2 1}
!220 = !{!"fixp", i32 -32, i32 27}
!221 = !{double 6.250000e-03, double 1.312500e-01}
!222 = !{!48, !221, i1 false, i2 1}
!223 = !{i1 false, !224}
!224 = !{i1 false, !225, i1 false, i2 0}
!225 = !{double 8.000000e+00, double 8.000000e+00}
!226 = !{!184, !227, i1 false, i2 1}
!227 = !{double 0x3F79999980000000, double 0x3FC0CCCCE0000000}
!228 = !{!63, !72, i1 false, i2 1}
!229 = !{!220, !230, i1 false, i2 1}
!230 = !{double 0x3F76C16C16C16C17, double 0x3FBDDDDDDDDDDDDE}
!231 = !{!48, !230, i1 false, i2 1}
!232 = !{i1 false, !233}
!233 = !{i1 false, !234, i1 false, i2 0}
!234 = !{double 9.000000e+00, double 9.000000e+00}
!235 = !{!184, !236, i1 false, i2 1}
!236 = !{double 0x3F76C16C00000000, double 0x3FBDDDDDE0000000}
!237 = !{!74, !75, i1 false, i2 1}
!238 = !{!70, !1, i1 false, i2 1}
!239 = !{!111, i1 false}
!240 = !{!66, !3, i1 false, i2 1}
!241 = !{i1 false, !242, i1 false, i2 -1}
!242 = !{double 0.000000e+00, double 4.000000e+02}
!243 = !{i1 false, !244, i1 false, i2 -1}
!244 = !{double 0.000000e+00, double 1.900000e+01}
!245 = !{!63, !244, i1 false, i2 -1}
!246 = !{!182, !247, i1 false, i2 -1}
!247 = !{double 0.000000e+00, double 0x3FEE666666666666}
!248 = !{!184, !247, i1 false, i2 -1}
!249 = !{!53, !5, i1 false, i2 1}
!250 = distinct !{!250, !27}
!251 = distinct !{!251, !27}
!252 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!253 = distinct !{null}
!254 = !{!138, !5, i1 false, i2 -1}
!255 = !{!135, !256, i1 false, i2 -1}
!256 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!257 = !{!138, !256, i1 false, i2 -1}
!258 = !{!138, !259, i1 false, i2 -1}
!259 = !{double 0.000000e+00, double 0x40C1E111077CCC04}
!260 = !{!155, !261, i1 false, i2 -1}
!261 = !{double 0x400B4E8244127E88, double 0x409555556084A516}
!262 = !{!158, !261, i1 false, i2 -1}
!263 = !{!138, !264, i1 false, i2 -1}
!264 = !{double 0x400B4E8244127E88, double 0x40C48BBBB38D60A7}
!265 = distinct !{!265, !27}
!266 = distinct !{!266, !27}
!267 = !{!149, !268, i1 false, i2 -1}
!268 = !{double 0.000000e+00, double 0x40B8AB850CC35CE1}
!269 = !{!53, !268, i1 false, i2 -1}
!270 = !{!271, !272, i1 false, i2 -1}
!271 = !{!"fixp", i32 -32, i32 14}
!272 = !{double 0.000000e+00, double 0x40F8AB850CC35CE1}
!273 = !{!274, !272, i1 false, i2 -1}
!274 = !{!"fixp", i32 32, i32 15}
!275 = !{!70, !276, i1 false, i2 -1}
!276 = !{double 0.000000e+00, double 0x412911B641986B9C}
!277 = distinct !{!277, !27}
!278 = distinct !{!278, !27}
!279 = !{!70, !280, i1 false, i2 -1}
!280 = !{double 7.111110e-01, double 0x4125FC6211C714FD}
!281 = distinct !{!281, !27}
!282 = !{!149, !283, i1 false, i2 -1}
!283 = !{double 0.000000e+00, double 0x40BED6664FF4341A}
!284 = !{!53, !283, i1 false, i2 -1}
!285 = !{!286, !287, i1 false, i2 -1}
!286 = !{!"float", i32 1, double 0x41F52FCEA2AA8142}
!287 = !{double 0.000000e+00, double 0x41F52FCEA2AA8142}
!288 = !{!289, !290, i1 false, i2 -1}
!289 = !{!"float", i32 1, double 0x42260F5914555028}
!290 = !{double 0.000000e+00, double 0x42260F5914555028}
!291 = distinct !{!291, !27}
!292 = distinct !{!292, !27}
