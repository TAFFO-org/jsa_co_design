; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-64-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !132 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 8), !taffo.info !133
  %mul.u23_9fixp = shl i32 %4, 1, !taffo.info !136
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !69
  %5 = shl i32 %mul.u23_9fixp, 6, !taffo.info !136
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !146 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !147
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !148
  %conv.u7_25fixp = shl i32 %factor, 25, !taffo.info !124
  %0 = uitofp i32 %conv.u7_25fixp to float, !taffo.info !124
  %1 = fdiv float %0, 0x4180000000000000, !taffo.info !124
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !149
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !147
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !147
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !148
  ...
  %34 = fdiv float %33, 1.600000e+01, !taffo.info !282
  %add58.1flp = fadd float %.flt.fallback.1flp, %34, !taffo.info !284
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !147
...
!131 = distinct !{!131, !27}
!132 = !{i32 1, !106, i32 1, !69, i32 1, !118}
!133 = !{!134, !135, i1 false, i2 -1}
!134 = !{!"fixp", i32 -32, i32 8}
!135 = !{double 0.000000e+00, double 0x4156459080000000}
!136 = !{!137, !135, i1 false, i2 -1}
!137 = !{!"fixp", i32 32, i32 9}
!138 = distinct !{!138, !27}
...
!145 = distinct !{!145, !27}
!146 = !{i32 1, !106, i32 1, !65, i32 1, !118}
!147 = !{i32 5}
!148 = !{i32 6}
!149 = !{!150, !151, i1 false, i2 -1}
!150 = !{!"float", i32 1, double 0x42341CCAE0000000}
!151 = !{double 0.000000e+00, double 0x42341CCAE0000000}
!152 = distinct !{!152, !27}
