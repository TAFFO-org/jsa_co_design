; ModuleID = './build/bin/fixed/gesummv/8/gesummv-standard-16-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !85 !taffo.funinfo !127 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !128
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !131
  %arrayidx1.u12_20fixp = getelementptr inbounds i32, i32* %val.u12_20fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u16_16fixp, 4, !taffo.info !131
...
!126 = distinct !{!126, !23}
!127 = !{i32 1, !75, i32 1, !54, i32 1, !75}
!128 = !{!129, !130, i1 false, i2 -1}
!129 = !{!"fixp", i32 -32, i32 15}
!130 = !{double 0.000000e+00, double 0x40E6A6667FF583A5}
!131 = !{!132, !130, i1 false, i2 -1}
!132 = !{!"fixp", i32 32, i32 16}
!133 = distinct !{!133, !23}
