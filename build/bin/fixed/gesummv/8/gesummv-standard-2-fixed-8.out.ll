; ModuleID = './build/bin/fixed/gesummv/8/gesummv-standard-2-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u2_30fixp3 = bitcast [16 x i32]* %arraydecay12.u2_30fixp to i32*, !taffo.info !48
  ...
  %u2_30fixp2 = bitcast [16 x i32]* %arraydecay13.u2_30fixp to i32*, !taffo.info !48
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4190000000000000, !taffo.info !53, !taffo.target !55
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* @y_float, i32 0, i32 %i.0, !taffo.info !0
  store float %1, float* %arrayidx22, align 4, !taffo.info !64, !taffo.target !55
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !84 !taffo.funinfo !94 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u2_30fixp = load i32, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !95
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !97
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !95
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !97
  %2 = ashr i32 %0, 1, !taffo.info !95
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 28), !taffo.info !98
  %mul.u3_29fixp = shl i32 %3, 1, !taffo.info !101
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !48
  %4 = shl i32 %mul.u3_29fixp, 1, !taffo.info !101
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !84 !taffo.funinfo !103 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u6_26fixp = load i32, i32* %arrayidx.u6_26fixp, align 4, !taffo.info !104
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !88
  %0 = lshr i32 %u6_26fixp, 1, !taffo.info !104
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !88
  %2 = ashr i32 %0, 1, !taffo.info !104
  %3 = ashr i32 %1, 5, !taffo.info !88
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 24), !taffo.info !106
  %mul.u7_25fixp = shl i32 %4, 1, !taffo.info !109
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !53
  %5 = shl i32 %mul.u7_25fixp, 1, !taffo.info !109
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 0, i32* %arrayidx.u5_27fixp, align 4, !taffo.info !114, !taffo.constinfo !115
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %y.u6_26fixp, i32 %i.0, !taffo.info !53
  store i32 0, i32* %arrayidx1.u6_26fixp, align 4, !taffo.info !114, !taffo.constinfo !115
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u2_30fixp4 = load i32, i32* %arrayidx6.u2_30fixp, align 4, !taffo.info !95
  %arrayidx7.u2_30fixp = getelementptr inbounds i32, i32* %x.u2_30fixp, i32 %j.0, !taffo.info !48
  %u2_30fixp = load i32, i32* %arrayidx7.u2_30fixp, align 4, !taffo.info !95
  %0 = lshr i32 %u2_30fixp4, 1, !taffo.info !95
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !95
  %2 = ashr i32 %0, 3, !taffo.info !95
  %3 = ashr i32 %1, 3, !taffo.info !95
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 26), !taffo.info !116
  %mul.u5_27fixp = shl i32 %4, 1, !taffo.info !119
  ...
  %add.u5_27fixp = add i32 %mul.u5_27fixp, %u5_27fixp, !taffo.info !120
  ...
  %u2_30fixp5 = load i32, i32* %arrayidx11.u2_30fixp, align 4, !taffo.info !95
  %arrayidx12.u2_30fixp = getelementptr inbounds i32, i32* %x.u2_30fixp, i32 %j.0, !taffo.info !48
  %u2_30fixp2 = load i32, i32* %arrayidx12.u2_30fixp, align 4, !taffo.info !95
  %5 = lshr i32 %u2_30fixp5, 1, !taffo.info !95
  %6 = lshr i32 %u2_30fixp2, 1, !taffo.info !95
  %7 = ashr i32 %5, 1, !taffo.info !95
  %8 = ashr i32 %6, 1, !taffo.info !95
  %9 = call i32 @llvm.smul.fix.i32(i32 %7, i32 %8, i32 28), !taffo.info !122
  %mul13.u3_29fixp = shl i32 %9, 1, !taffo.info !123
  ...
  %10 = lshr i32 %mul13.u3_29fixp, 3, !taffo.info !123
  %add15.u6_26fixp = add i32 %10, %u6_26fixp, !taffo.info !124
...
for.end:                                          ; preds = %for.cond2
  ...
  %15 = call i32 @llvm.smul.fix.i32(i32 %13, i32 %14, i32 24), !taffo.info !127
  %mul18.u7_25fixp = shl i32 %15, 1, !taffo.info !129
  ...
  %20 = call i32 @llvm.smul.fix.i32(i32 %18, i32 %19, i32 24), !taffo.info !130
  %mul20.u7_25fixp = shl i32 %20, 1, !taffo.info !132
  %add21.u7_25fixp = add i32 %mul18.u7_25fixp, %mul20.u7_25fixp, !taffo.info !133
  %arrayidx22.u6_26fixp = getelementptr inbounds i32, i32* %y.u6_26fixp, i32 %i.0, !taffo.info !53
  %21 = shl i32 %add21.u7_25fixp, 1, !taffo.info !133
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 %4, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !114
  %arrayidx4.u6_26fixp = getelementptr inbounds i32, i32* %y.u6_26fixp, i32 %i.0, !taffo.info !161
  store i32 0, i32* %arrayidx4.u6_26fixp, align 4, !taffo.info !114, !taffo.constinfo !115
  %arrayidx5.u5_27fixp = getelementptr inbounds i32, i32* %tmp.u5_27fixp, i32 %i.0, !taffo.info !162
  store i32 0, i32* %arrayidx5.u5_27fixp, align 4, !taffo.info !114, !taffo.constinfo !115
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  ...
  store i32 %9, i32* %arrayidx15.u2_30fixp, align 4, !taffo.info !114
  ...
  store i32 %14, i32* %arrayidx23.u2_30fixp, align 4, !taffo.info !114
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp = load i32, i32* %arrayidx4.u2_30fixp, align 4, !taffo.info !95
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !97
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !95
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !97
  %3 = ashr i32 %1, 1, !taffo.info !95
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 28), !taffo.info !98
  %mul.u3_29fixp = shl i32 %4, 1, !taffo.info !101
  ...
  %6 = shl i32 %mul.u3_29fixp, 1, !taffo.info !101
...
!93 = distinct !{!93, !23}
!94 = !{i32 1, !74, i32 1, !48, i32 1, !19}
!95 = !{!96, !49, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 29}
!97 = !{!96, !20, i1 false, i2 1}
!98 = !{!99, !100, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 28}
!100 = !{double 0.000000e+00, double 3.750000e+00}
!101 = !{!96, !100, i1 false, i2 -1}
!102 = distinct !{!102, !23}
!103 = !{i32 1, !74, i32 1, !53, i32 1, !19}
!104 = !{!105, !1, i1 false, i2 -1}
!105 = !{!"fixp", i32 32, i32 25}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 24}
!108 = !{double 0.000000e+00, double 0x4056A6667F90D9D7}
!109 = !{!105, !108, i1 false, i2 -1}
!110 = distinct !{!110, !23}
!111 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!112 = !{i32 1, !74, i32 1, !43, i32 1, !46, i32 1, !48, i32 1, !48, i32 1, !50, i32 1, !48, i32 1, !53}
!113 = distinct !{null}
!114 = !{i1 false, i1 false, i1 false, i2 1}
!115 = !{!78, i1 false}
!116 = !{!117, !118, i1 false, i2 -1}
!117 = !{!"fixp", i32 -32, i32 26}
!118 = !{double 0.000000e+00, double 0x400C200000000000}
!119 = !{!51, !118, i1 false, i2 -1}
!120 = !{!51, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x4035240000000000}
!122 = !{!99, !118, i1 false, i2 -1}
!123 = !{!96, !118, i1 false, i2 -1}
!124 = !{!54, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x404868667F90D9D7}
!126 = distinct !{!126, !23}
!127 = !{!107, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 2.643750e+01}
!129 = !{!105, !128, i1 false, i2 -1}
!130 = !{!107, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 0x404B2E149914389B}
!132 = !{!105, !131, i1 false, i2 -1}
!133 = !{!105, !134, i1 false, i2 -1}
!134 = !{double 0.000000e+00, double 0x4054330A4C8A1C4E}
!135 = distinct !{!135, !23}
