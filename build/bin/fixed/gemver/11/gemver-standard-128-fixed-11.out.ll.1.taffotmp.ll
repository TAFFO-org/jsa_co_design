...
@.str.3 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,5262.933105) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,121.599998) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(1.6,32.0) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(3.2,64.0) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [40 x i8] c"scalar(range(1.066667,21.333334) final)\00", section "llvm.metadata"
@.str.8 = private unnamed_addr constant [51 x i8] c"target('w') scalar(range(0.0,41686114304.0) final)\00", section "llvm.metadata"
@.str.9 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,720418.8125) final)\00", section "llvm.metadata"
@.str.10 = private unnamed_addr constant [30 x i8] c"scalar(range(0.8,16.0) final)\00", section "llvm.metadata"
@.str.11 = private unnamed_addr constant [40 x i8] c"scalar(range(0.711111,14.222222) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 155, i8* null)
  ...
  call void @llvm.var.annotation(i8* %w8, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 160, i8* null)
  %x9 = bitcast [20 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x9, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 161, i8* null)
  ...
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 128)
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 128)
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 128)
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 128)
  %arraydecay25 = getelementptr inbounds [20 x float], [20 x float]* %w, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 128)
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 128)
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 128)
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 128)
