; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u19_13fixp1 = load i32, i32* %arrayidx.u19_13fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u19_13fixp1 to float, !taffo.info !47, !taffo.target !49
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u19_13fixp = load i32, i32* %arrayidx25.u19_13fixp, align 4, !taffo.info !50, !taffo.target !51
  %2 = uitofp i32 %u19_13fixp to float, !taffo.info !50, !taffo.target !51
