; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %2 = uitofp i32 %conv.u10_22fixp to float, !taffo.info !90
  %3 = fdiv float %2, 0x4150000000000000, !taffo.info !90
  %mul.1flp = fmul float %1, %3, !taffo.info !128
  %arrayidx1.u21_11fixp = getelementptr inbounds i32, i32* %val.u21_11fixp, i32 %i.0, !taffo.info !51
  %4 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !128
  %5 = fptoui float %4 to i32, !taffo.info !128
