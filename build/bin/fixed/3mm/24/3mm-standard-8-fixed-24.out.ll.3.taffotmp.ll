; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-8-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,6.933334) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.333333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,1.4) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,8.192) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.466667) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,1.44) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [48 x i8] c"target('G') scalar(range(0.0,222.344543) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 8), !taffo.initweight !66, !taffo.info !48, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 8), !taffo.initweight !66, !taffo.info !50, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 8), !taffo.initweight !66, !taffo.info !52, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 8), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.7(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 8), !taffo.initweight !66, !taffo.info !56, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.8(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 8), !taffo.initweight !66, !taffo.info !58, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 8), !taffo.initweight !66, !taffo.info !60, !taffo.target !61, !taffo.originalCall !67, !taffo.constinfo !68
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !230
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !227 !taffo.funinfo !234 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !235
  %2 = mul nsw i32 %i.0, %m, !taffo.info !102
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !227 !taffo.funinfo !239 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !240
  %2 = mul nsw i32 %i.0, %m, !taffo.info !102
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !227 !taffo.funinfo !244 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !245
  %2 = mul nsw i32 %i.0, %m, !taffo.info !102
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !227 !taffo.funinfo !249 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !250
  %2 = mul nsw i32 %i.0, %m, !taffo.info !102
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !227 !taffo.funinfo !254 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !255
  %2 = mul nsw i32 %i.0, %m, !taffo.info !102
...
for.inc:                                          ; preds = %for.body3
  %inc = add nsw i32 %j.0, 1, !taffo.info !125, !taffo.constinfo !27
  br label %for.cond1, !llvm.loop !257
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !227 !taffo.funinfo !259 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !132
  %mul = fmul float %1, %conv, !taffo.initweight !229, !taffo.info !260
  %2 = mul nsw i32 %i.0, %m, !taffo.info !102
...
!7 = !{double 0.000000e+00, double 0x406BCB067F0AA21A}
...
!49 = !{double 0.000000e+00, double 0x401BBBBBE878FABE}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 0x3FF55554FBDAD752}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 0.000000e+00, double 1.400000e+00}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 8.192000e+00}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x3FF77777D0F1F57B}
!58 = !{i1 false, !59, i1 false, i2 -1}
!59 = !{double 0.000000e+00, double 1.440000e+00}
...
!139 = !{double 0.000000e+00, double 0x3FFDDDDD6098C70C}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x40219999A04F9640}
!142 = distinct !{!142, !29}
!143 = distinct !{!143, !29}
!144 = distinct !{!144, !29}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0.000000e+00, double 0x4000E56081F5E3F2}
!147 = !{i1 false, !148, i1 false, i2 -1}
!148 = !{double 0.000000e+00, double 0x40249BA5F36F22F8}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = distinct !{!151, !29}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x404C6620AC841331}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x407172475515D373}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
...
!228 = !{i32 1, !121, i32 1, !132, i32 1, !48, i32 1, !132}
!229 = !{i32 9}
!230 = !{i1 false, !231, i1 false, i2 -1}
!231 = !{double 0.000000e+00, double 0x404BBBBBE878FABE}
!232 = distinct !{!232, !29}
!233 = distinct !{!233, !29}
!234 = !{i32 1, !121, i32 1, !22, i32 1, !50, i32 1, !132}
!235 = !{i1 false, !236, i1 false, i2 -1}
!236 = !{double 0.000000e+00, double 0x40255554FBDAD752}
!237 = distinct !{!237, !29}
!238 = distinct !{!238, !29}
!239 = !{i32 1, !22, i32 1, !132, i32 1, !52, i32 1, !132}
!240 = !{i1 false, !241, i1 false, i2 -1}
!241 = !{double 0.000000e+00, double 1.120000e+01}
!242 = distinct !{!242, !29}
!243 = distinct !{!243, !29}
!244 = !{i32 1, !132, i32 1, !123, i32 1, !54, i32 1, !132}
!245 = !{i1 false, !246, i1 false, i2 -1}
!246 = !{double 0.000000e+00, double 6.553600e+01}
!247 = distinct !{!247, !29}
!248 = distinct !{!248, !29}
!249 = !{i32 1, !132, i32 1, !134, i32 1, !56, i32 1, !132}
!250 = !{i1 false, !251, i1 false, i2 -1}
!251 = !{double 0.000000e+00, double 0x40277777D0F1F57B}
!252 = distinct !{!252, !29}
!253 = distinct !{!253, !29}
!254 = !{i32 1, !134, i32 1, !123, i32 1, !58, i32 1, !132}
!255 = !{i1 false, !256, i1 false, i2 -1}
!256 = !{double 0.000000e+00, double 1.152000e+01}
!257 = distinct !{!257, !29}
!258 = distinct !{!258, !29}
!259 = !{i32 1, !121, i32 1, !123, i32 1, !60, i32 1, !132}
!260 = !{i1 false, !261, i1 false, i2 -1}
!261 = !{double 0.000000e+00, double 0x409BCB067F0AA21A}
!262 = distinct !{!262, !29}
!263 = distinct !{!263, !29}
