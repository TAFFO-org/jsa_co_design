; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-32-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,32.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [44 x i8] c"target('B') scalar(range(0.0,5346.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 32), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 32), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
!7 = !{double 0.000000e+00, double 5.346000e+03}
...
!52 = !{double 0.000000e+00, double 3.200000e+01}
...
!110 = !{double 3.200000e+01, double 3.200000e+01}
...
!118 = !{double 0.000000e+00, double 1.710720e+05}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 1.764180e+05}
!121 = distinct !{!121, !29}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 8.019000e+03}
!124 = distinct !{!124, !29}
!125 = distinct !{!125, !29}
...
!155 = !{double 0.000000e+00, double 1.024000e+03}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
