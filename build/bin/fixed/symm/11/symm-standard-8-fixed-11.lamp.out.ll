; ModuleID = './build/bin/fixed/symm/11/symm-standard-8-fixed-11.out.ll'
...
entry:
  ...
  call void @kernel_symm.3_fixp(i32 10, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u12_20fixp, [10 x i32]* %arraydecay12.s14_18fixp, [16 x i32]* %arraydecay13.u5_27fixp), !taffo.info !56, !taffo.constinfo !57
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !173 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u8_24fixp, 3, !taffo.info !177
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s14_18fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !181 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.s17_15fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !182
  ...
  %5 = shl i32 %mul.s17_15fixp, 3, !taffo.info !182
...
!171 = distinct !{!171, !23}
!172 = distinct !{!172, !23}
!173 = !{i32 1, !16, i32 1, !79, i32 1, !53, i32 1, !89}
!174 = !{!175, !176, i1 false, i2 -1}
!175 = !{!"fixp", i32 -32, i32 23}
!176 = !{double 6.400000e+00, double 1.600000e+02}
!177 = !{!178, !176, i1 false, i2 -1}
!178 = !{!"fixp", i32 32, i32 24}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !89}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 -32, i32 15}
!184 = !{double -6.393600e+04, double 1.152000e+02}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
