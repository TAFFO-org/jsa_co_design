; ModuleID = './build/bin/fixed/ludcmp/16/ludcmp-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s12_20fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 20), !taffo.info !95
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s12_20fixp, 8, !taffo.info !95
...
!97 = !{double 0xC0236DCA07F66E87, double 0x408FFCF893FAF428}
!98 = distinct !{!98, !23}
