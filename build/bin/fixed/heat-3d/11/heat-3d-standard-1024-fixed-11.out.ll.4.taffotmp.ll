; ModuleID = './build/bin/fixed/heat-3d/11/heat-3d-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 1024), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 1024), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
!102 = !{!"fixp", i32 -32, i32 15}
!103 = !{double 4.096000e+03, double 5.324800e+04}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -5.120000e+04, double 2.252800e+04}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -4.915200e+04, double 4.915200e+04}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 17}
!111 = !{double -6.144000e+03, double 6.144000e+03}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -1.228800e+04, double 1.228800e+04}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -1.843200e+04, double 1.843200e+04}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -1.638400e+04, double 4.505600e+04}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!162 = !{double 1.024000e+03, double 1.024000e+03}
!163 = !{i1 false, !164, i1 false, i2 0}
!164 = !{double 2.500000e+01, double 2.500000e+01}
!165 = !{!166, !162, i1 false, i2 1}
!166 = !{!"fixp", i32 32, i32 21}
!167 = !{!168, !169, i1 false, i2 -1}
!168 = !{!"fixp", i32 32, i32 7}
!169 = !{double 0x4140000000000000, double 0x417A000000000000}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
!172 = distinct !{!172, !23}
