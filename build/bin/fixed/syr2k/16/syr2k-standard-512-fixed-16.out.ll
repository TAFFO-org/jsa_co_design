; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-512-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u9_23fixp = bitcast [10 x i32]* %arraydecay9.u9_23fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u9_23fixp, i32 512), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u9_23fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !53
  %u9_23fixp2 = bitcast [10 x i32]* %arraydecay10.u9_23fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u9_23fixp2, i32 512), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay11.u21_11fixp, [10 x i32]* %arraydecay12.u9_23fixp, [10 x i32]* %arraydecay13.u9_23fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !183 !taffo.funinfo !184 !taffo.sourceFunction !185 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !187
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !190
  ...
  %7 = shl i32 %mul.u18_14fixp, 9, !taffo.info !190
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u21_11fixp, i32 noundef %factor) #0 !taffo.initweight !183 !taffo.funinfo !194 !taffo.sourceFunction !185 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !195
  ...
  %6 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !195
  %7 = fptoui float %6 to i32, !taffo.info !195
...
!188 = !{!"fixp", i32 -32, i32 13}
!189 = !{double 0.000000e+00, double 2.457600e+05}
!190 = !{!191, !189, i1 false, i2 -1}
!191 = !{!"fixp", i32 32, i32 14}
!192 = distinct !{!192, !23}
!193 = distinct !{!193, !23}
!194 = !{i32 1, !77, i32 1, !77, i32 1, !47, i32 1, !88}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"float", i32 1, double 0x41CEFB8500000000}
!197 = !{double 0.000000e+00, double 0x41CEFB8500000000}
!198 = distinct !{!198, !23}
!199 = distinct !{!199, !23}
