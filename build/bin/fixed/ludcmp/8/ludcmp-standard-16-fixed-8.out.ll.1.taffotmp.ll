...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.1,130.759995) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [37 x i8] c"scalar(range(16.0,130.759995) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [36 x i8] c"scalar(range(64.400002,72.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [52 x i8] c"target('x') scalar(range(-0.037947,3.998521) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,64.400002) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 16)
