; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-8-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [35 x i8] c"scalar(range(0.1,65.379997) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(8.0,65.379997) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [36 x i8] c"scalar(range(32.200001,36.0) final)\00", section "llvm.metadata", !taffo.info !0
...
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,32.200001) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 8), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 8), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !59, !taffo.info !53
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 8), !taffo.initweight !60, !taffo.info !53, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 8), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 8), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!50 = !{double 1.000000e-01, double 0x40505851DEEFE500}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 8.000000e+00, double 0x40505851DEEFE500}
!53 = !{i1 false, !54, i1 false, i2 -1}
!54 = !{double 0x40401999A1FD156A, double 3.600000e+01}
!55 = !{i1 false, !7, i1 false, i2 -1}
!56 = !{!"x"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x40401999A1FD156A}
!59 = !{i32 1}
!60 = !{i32 2}
...
!129 = !{double 8.000000e+00, double 8.000000e+00}
!130 = !{i32 7}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0x40701999A1FD156A, double 2.880000e+02}
!133 = distinct !{!133, !29}
!134 = !{i32 1, !123, i32 1, !55, i32 1, !128}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -3.035760e-01, double 0x403FFCF893FAF428}
!137 = distinct !{!137, !29}
!138 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!139 = !{i32 1, !123, i32 1, !49, i32 1, !53, i32 1, !55, i32 1, !57}
!140 = !{i32 8}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0x3F847AE147AE147C, double 0x40B0B28B44170636}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC0B17A8B44170636, double 1.999900e+02}
!145 = distinct !{!145, !29}
...
!153 = !{double 0.000000e+00, double 0x40A07278D0E661EE}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0xC0A20278D0E661EE, double 2.000000e+02}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
...
!165 = !{double 0xC003D90949A7A372, double 0x407056C5CCC46D94}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 0xC07CD6C5CCC46D94, double 0x40694F6425269E8E}
...
!176 = !{double 0.000000e+00, double 0x40701999A1FD156A}
!177 = distinct !{!177, !29}
...
!215 = !{double 8.010000e+00, double 0x40B0F3EC8B92C5CA}
!216 = distinct !{!216, !29}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = distinct !{!219, !29}
...
!225 = !{double 8.000000e-01, double 0x40805851DEEFE500}
!226 = distinct !{!226, !29}
!227 = distinct !{!227, !29}
!228 = !{i32 1, !123, i32 1, !123, i32 1, !51, i32 1, !128}
!229 = !{i1 false, !230, i1 false, i2 -1}
!230 = !{double 6.400000e+01, double 0x40805851DEEFE500}
!231 = distinct !{!231, !29}
!232 = distinct !{!232, !29}
