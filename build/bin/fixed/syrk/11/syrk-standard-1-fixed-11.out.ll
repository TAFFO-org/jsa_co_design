; ModuleID = './build/bin/fixed/syrk/11/syrk-standard-1-fixed-11.out.ll.4.taffotmp.ll'
...
for.body10:                                       ; preds = %for.cond8
  ...
  store float %2, float* %arrayidx13, align 4, !taffo.info !47, !taffo.target !35
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i32 0, i32 0), double noundef %conv), !taffo.constinfo !60
  br label %for.inc
