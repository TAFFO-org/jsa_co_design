; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-4-fixed-11.out.ll'
...
entry:
  ...
  %u2_30fixp3 = bitcast [8 x i32]* %arraydecay14.u2_30fixp to i32*, !taffo.info !41
  call void @scale_2d.3_fixp(i32 6, i32 8, i32* %u2_30fixp3, i32 4), !taffo.info !58, !taffo.constinfo !60
  ...
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u1_31fixp2, i32 4), !taffo.info !61, !taffo.constinfo !60
  ...
  %u1_31fixp4 = bitcast [14 x i32]* %arraydecay18.u1_31fixp to i32*, !taffo.info !51
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u1_31fixp4, i32 4), !taffo.info !64, !taffo.constinfo !60
  %arraydecay19.u1_31fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u1_31fixp, i32 0, i32 0, !taffo.info !53
  %u1_31fixp1 = bitcast [12 x i32]* %arraydecay19.u1_31fixp to i32*, !taffo.info !53
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u1_31fixp1, i32 4), !taffo.info !65, !taffo.constinfo !60
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !222 !taffo.funinfo !234 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u4_28fixp = load i32, i32* %arrayidx4.u4_28fixp, align 4, !taffo.info !235
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !227
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !235
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !227
  %3 = ashr i32 %1, 2, !taffo.info !235
  %4 = ashr i32 %2, 3, !taffo.info !227
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 25), !taffo.info !236
  %mul.u6_26fixp = shl i32 %5, 1, !taffo.info !238
  ...
  %7 = shl i32 %mul.u6_26fixp, 2, !taffo.info !238
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u1_31fixp, i32 noundef %factor) #0 !taffo.initweight !222 !taffo.funinfo !241 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u1_31fixp = load i32, i32* %arrayidx4.u1_31fixp, align 4, !taffo.info !242
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !227
  %1 = lshr i32 %u1_31fixp, 1, !taffo.info !242
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !227
  %3 = ashr i32 %1, 2, !taffo.info !242
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 28), !taffo.info !243
  %mul.u2_30fixp = shl i32 %4, 2, !taffo.info !245
  %5 = mul nsw i32 %i.0, %m, !taffo.info !88
  ...
  %6 = shl i32 %mul.u2_30fixp, 1, !taffo.info !245
...
!232 = distinct !{!232, !23}
!233 = distinct !{!233, !23}
!234 = !{i32 1, !82, i32 1, !84, i32 1, !55, i32 1, !224}
!235 = !{!171, !1, i1 false, i2 -1}
!236 = !{!173, !237, i1 false, i2 -1}
!237 = !{double 0.000000e+00, double 0x404BCB068123810F}
!238 = !{!171, !237, i1 false, i2 -1}
!239 = distinct !{!239, !23}
!240 = distinct !{!240, !23}
!241 = !{i32 1, !82, i32 1, !16, i32 1, !44, i32 1, !224}
!242 = !{!42, !46, i1 false, i2 -1}
!243 = !{!229, !244, i1 false, i2 -1}
!244 = !{double 0.000000e+00, double 0x40055556084A515D}
!245 = !{!42, !244, i1 false, i2 -1}
!246 = distinct !{!246, !23}
!247 = distinct !{!247, !23}
