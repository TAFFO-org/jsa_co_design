; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-4-fixed-16.out.ll.4.taffotmp.ll'
...
for.body12:                                       ; preds = %for.cond10
  ...
  %2 = fdiv float %1, 0x4180000000000000, !taffo.info !47, !taffo.target !49
  ...
  store float %2, float* %arrayidx15, align 4, !taffo.info !57, !taffo.target !49
  br label %for.inc
