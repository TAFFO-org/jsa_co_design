; ModuleID = './build/bin/fixed/mvt/8/mvt-standard-1024-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u23_9fixp = load i32, i32* %arrayidx21.u23_9fixp, align 4, !taffo.info !50, !taffo.target !51
