; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-32-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %arraydecay5.u5_27fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %A.u5_27fixp, i32 0, i32 0, !taffo.info !50
  call void @init_array.4_fixp(i32 16, i32 10, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [16 x i32]* %arraydecay.u13_19fixp, [10 x i32]* %arraydecay5.u5_27fixp), !taffo.info !53, !taffo.constinfo !54
  call void @scale_scalar.1_fixp(i32* %alpha.u2_30fixp, i32 32), !taffo.info !53, !taffo.constinfo !55
  call void @scale_scalar.1_fixp(i32* %beta.u2_30fixp, i32 32), !taffo.info !56, !taffo.constinfo !55
  %arraydecay6.u13_19fixp = getelementptr inbounds [16 x [16 x i32]], [16 x [16 x i32]]* %C.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u13_19fixp = bitcast [16 x i32]* %arraydecay6.u13_19fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 16, i32 16, i32* %u13_19fixp, i32 32), !taffo.info !57, !taffo.constinfo !58, !taffo.target !49
  %arraydecay7.u5_27fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %A.u5_27fixp, i32 0, i32 0, !taffo.info !50
  %u5_27fixp = bitcast [10 x i32]* %arraydecay7.u5_27fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u5_27fixp, i32 32), !taffo.info !59, !taffo.constinfo !58
  ...
  call void @kernel_syrk.3_fixp(i32 16, i32 10, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay8.u13_19fixp, [10 x i32]* %arraydecay9.u5_27fixp), !taffo.info !53, !taffo.constinfo !54
...
for.body12:                                       ; preds = %for.cond10
  ...
  %arrayidx13.u13_19fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
  %u13_19fixp2 = load i32, i32* %arrayidx13.u13_19fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u13_19fixp2 to float, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syrk.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u13_19fixp, [10 x i32]* noundef %A.u5_27fixp) #0 !taffo.initweight !84 !taffo.funinfo !85 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 18), !taffo.info !87
  %mul.u13_19fixp = shl i32 %3, 1, !taffo.info !90
  store i32 %mul.u13_19fixp, i32* %arrayidx4.u13_19fixp, align 4, !taffo.info !56
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u5_27fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx11.u5_27fixp, i32 0, i32 %k.0, !taffo.info !50
  %u5_27fixp = load i32, i32* %arrayidx12.u5_27fixp, align 4, !taffo.info !92
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u5_27fixp, 1, !taffo.info !92
  %6 = ashr i32 %4, 4, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !92
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 25), !taffo.info !94
  %mul13.u6_26fixp = shl i32 %8, 1, !taffo.info !97
  %arrayidx14.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u5_27fixp, i32 %j.1, !taffo.info !50
  %arrayidx15.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u5_27fixp, i32 0, i32 %k.0, !taffo.info !50
  %u5_27fixp2 = load i32, i32* %arrayidx15.u5_27fixp, align 4, !taffo.info !50
  %9 = lshr i32 %mul13.u6_26fixp, 1, !taffo.info !97
  %10 = lshr i32 %u5_27fixp2, 1, !taffo.info !50
  %11 = ashr i32 %9, 7, !taffo.info !97
  %12 = ashr i32 %10, 8, !taffo.info !50
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 18), !taffo.info !98
  %mul16.u13_19fixp = shl i32 %13, 1, !taffo.info !100
  %arrayidx17.u13_19fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u13_19fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u13_19fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx17.u13_19fixp, i32 0, i32 %j.1, !taffo.info !47
  %u13_19fixp1 = load i32, i32* %arrayidx18.u13_19fixp, align 4, !taffo.info !47
  %add.u13_19fixp = add i32 %u13_19fixp1, %mul16.u13_19fixp, !taffo.info !101
  store i32 %add.u13_19fixp, i32* %arrayidx18.u13_19fixp, align 4, !taffo.info !57
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u13_19fixp, [10 x i32]* noundef %A.u5_27fixp) #0 !taffo.initweight !106 !taffo.funinfo !85 !taffo.sourceFunction !107 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u5_27fixp, i32 %i.0, !taffo.info !138
  %arrayidx7.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u5_27fixp, i32 0, i32 %j.0, !taffo.info !138
  %4 = lshr i32 %div.u1_31fixp, 4, !taffo.info !136
  store i32 %4, i32* %arrayidx7.u5_27fixp, align 4, !taffo.info !139
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %div24.u1_31fixp = shl i32 %7, 4, !taffo.info !155
  %arrayidx25.u13_19fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u13_19fixp, i32 %i.1, !taffo.info !156
  %arrayidx26.u13_19fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u13_19fixp, i32 0, i32 %j.1, !taffo.info !156
  %8 = lshr i32 %div24.u1_31fixp, 12, !taffo.info !155
  store i32 %8, i32* %arrayidx26.u13_19fixp, align 4, !taffo.info !139
  br label %for.inc27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !159 !taffo.funinfo !160 !taffo.sourceFunction !161 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u13_19fixp = load i32, i32* %arrayidx4.u13_19fixp, align 4, !taffo.info !47
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !162
  %1 = lshr i32 %u13_19fixp, 1, !taffo.info !47
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !162
  %3 = ashr i32 %1, 5, !taffo.info !47
  %4 = ashr i32 %2, 12, !taffo.info !162
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !163
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !166
  ...
  %7 = shl i32 %mul.u18_14fixp, 5, !taffo.info !166
  store i32 %7, i32* %arrayidx6.u13_19fixp, align 4, !taffo.info !57
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !159 !taffo.funinfo !170 !taffo.sourceFunction !161 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 4, !taffo.info !162
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !171
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !174
  %6 = mul nsw i32 %i.0, %m, !taffo.info !74
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !174
...
!1 = !{double 0.000000e+00, double 0x40B9E8E14003254E}
...
!82 = !{double 3.200000e+01, double 3.200000e+01}
...
!89 = !{double 0.000000e+00, double 0x40BF1774B336F990}
!90 = !{!48, !89, i1 false, i2 -1}
!91 = distinct !{!91, !23}
!92 = !{!93, !52, i1 false, i2 -1}
!93 = !{!"fixp", i32 32, i32 26}
!94 = !{!95, !96, i1 false, i2 -1}
!95 = !{!"fixp", i32 -32, i32 25}
!96 = !{double 0.000000e+00, double 4.500000e+01}
!97 = !{!93, !96, i1 false, i2 -1}
!98 = !{!88, !99, i1 false, i2 -1}
!99 = !{double 0.000000e+00, double 1.350000e+03}
!100 = !{!48, !99, i1 false, i2 -1}
!101 = !{!48, !102, i1 false, i2 -1}
!102 = !{double 0.000000e+00, double 0x40BF2EE14003254E}
!103 = distinct !{!103, !23}
!104 = distinct !{!104, !23}
!105 = distinct !{!105, !23}
...
!150 = !{!131, !149, i1 false, i2 1}
!151 = !{!131, !17, i1 false, i2 1}
!152 = !{!153, !154, i1 false, i2 1}
!153 = !{!"fixp", i32 -32, i32 27}
!154 = !{double 0.000000e+00, double 9.000000e-01}
!155 = !{!137, !154, i1 false, i2 1}
!156 = !{!48, !1, i1 false, i2 1}
!157 = distinct !{!157, !23}
!158 = distinct !{!158, !23}
!159 = !{i32 -1, i32 -1, i32 3, i32 -1}
!160 = !{i32 1, !70, i32 1, !70, i32 1, !47, i32 1, !81}
!161 = !{void (i32, i32, float*, i32)* @scale_2d}
!162 = !{!93, !82, i1 false, i2 1}
!163 = !{!164, !165, i1 false, i2 -1}
!164 = !{!"fixp", i32 -32, i32 13}
!165 = !{double 0.000000e+00, double 0x4109E8E14003254E}
!166 = !{!167, !165, i1 false, i2 -1}
!167 = !{!"fixp", i32 32, i32 14}
!168 = distinct !{!168, !23}
!169 = distinct !{!169, !23}
!170 = !{i32 1, !70, i32 1, !16, i32 1, !50, i32 1, !81}
!171 = !{!172, !173, i1 false, i2 -1}
!172 = !{!"fixp", i32 -32, i32 21}
!173 = !{double 0.000000e+00, double 9.600000e+02}
