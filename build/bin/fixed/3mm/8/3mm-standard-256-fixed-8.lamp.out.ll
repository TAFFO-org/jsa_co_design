; ModuleID = './build/bin/fixed/3mm/8/3mm-standard-256-fixed-8.out.ll'
...
entry:
  ...
  %u6_26fixp3 = bitcast [8 x i32]* %arraydecay16.u6_26fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u6_26fixp3, i32 256), !taffo.info !63, !taffo.constinfo !61
  ...
  %u6_26fixp = bitcast [14 x i32]* %arraydecay18.u6_26fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u6_26fixp, i32 256), !taffo.info !65, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !235
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !238
  ...
  %7 = shl i32 %mul.u21_11fixp, 8, !taffo.info !238
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !242 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 17), !taffo.info !243
  %mul.u14_18fixp = shl i32 %5, 1, !taffo.info !245
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u14_18fixp, 8, !taffo.info !245
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u28_4fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !248 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -65536
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !249
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !254 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 9), !taffo.info !255
  %mul.u22_10fixp = shl i32 %5, 1, !taffo.info !258
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u22_10fixp, 8, !taffo.info !258
...
!236 = !{!"fixp", i32 -32, i32 10}
!237 = !{double 0.000000e+00, double 0x413BBBBBE004B7F6}
!238 = !{!239, !237, i1 false, i2 -1}
!239 = !{!"fixp", i32 32, i32 11}
!240 = distinct !{!240, !23}
!241 = distinct !{!241, !23}
!242 = !{i32 1, !83, i32 1, !16, i32 1, !44, i32 1, !230}
!243 = !{!115, !244, i1 false, i2 -1}
!244 = !{double 0.000000e+00, double 0x40C555556084A516}
!245 = !{!50, !244, i1 false, i2 -1}
!246 = distinct !{!246, !23}
!247 = distinct !{!247, !23}
!248 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !230}
!249 = !{!250, !251, i1 false, i2 -1}
!250 = !{!"float", i32 1, double 0x422BCB0680000000}
!251 = !{double 0.000000e+00, double 0x422BCB0680000000}
!252 = distinct !{!252, !23}
!253 = distinct !{!253, !23}
!254 = !{i32 1, !96, i32 1, !85, i32 1, !49, i32 1, !230}
!255 = !{!256, !257, i1 false, i2 -1}
!256 = !{!"fixp", i32 -32, i32 9}
!257 = !{double 0.000000e+00, double 0x4140624DDFFC547A}
!258 = !{!259, !257, i1 false, i2 -1}
!259 = !{!"fixp", i32 32, i32 10}
!260 = distinct !{!260, !23}
!261 = distinct !{!261, !23}
