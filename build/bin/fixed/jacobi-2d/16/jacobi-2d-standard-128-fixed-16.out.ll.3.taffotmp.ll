; ModuleID = './build/bin/fixed/jacobi-2d/16/jacobi-2d-standard-128-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [55 x i8] c"target('A') scalar(range(17.066668,1928.533325) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [38 x i8] c"scalar(range(25.6,2056.533447) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 128), !taffo.initweight !57, !taffo.target !48, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 128), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !58, !taffo.constinfo !59
...
!7 = !{double 0.000000e+00, double 0x409E22221FF2E48F}
...
!50 = !{double 0x40311111276FB092, double 0x409E22221FF2E48F}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 2.560000e+01, double 0x40A011111FF7164C}
!53 = !{i32 1}
!54 = !{i32 2}
...
!115 = !{double 0x40411111276FB092, double 0x40AE22221FF2E48F}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0x40499999BB2788DB, double 0x40B6999997F62B6B}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0x40511111276FB092, double 0x40BE22221FF2E48F}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x40555555714B9CB6, double 0x40C2D55553F7CED9}
!122 = !{i32 9}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x403111112BB3F4DB, double 0x409E2222277B6D16}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 5.120000e+01, double 0x40B011111FF7164C}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4053333333333334, double 0x40B81999AFF2A172}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 1.024000e+02, double 0x40C011111FF7164C}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 1.280000e+02, double 0x40C4155567F4DBDF}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0x40399999A0000000, double 0x40A0111123FB5A94}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
...
!170 = !{double 0x40A11111276FB092, double 0x410E22221FF2E48F}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
!173 = !{i32 1, !97, i32 1, !97, i32 1, !51, i32 1, !167}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double 3.276800e+03, double 0x411011111FF7164C}
!176 = distinct !{!176, !29}
!177 = distinct !{!177, !29}
