; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-8-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 8), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 8), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x3FF111116A8B8F15, double 0x405E222220BC382A}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 1.600000e+00, double 0x406011111F0C34C2}
!34 = !{i32 1}
!35 = !{i32 2}
