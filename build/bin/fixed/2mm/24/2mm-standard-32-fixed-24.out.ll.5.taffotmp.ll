; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-32-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u5_27fixp2 = bitcast [10 x i32]* %arraydecay13.u5_27fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u5_27fixp2, i32 32), !taffo.info !66, !taffo.constinfo !65
  %arraydecay14.u5_27fixp = getelementptr inbounds [10 x [14 x i32]], [10 x [14 x i32]]* %C.u5_27fixp, i32 0, i32 0, !taffo.info !55
  %u5_27fixp3 = bitcast [14 x i32]* %arraydecay14.u5_27fixp to i32*, !taffo.info !55
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u5_27fixp3, i32 32), !taffo.info !67, !taffo.constinfo !65
...
for.body3:                                        ; preds = %for.cond1
  ...
  store i32 0, i32* %arrayidx4.u13_19fixp, align 4, !taffo.info !105, !taffo.constinfo !106
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %u5_27fixp = load i32, i32* %arrayidx9.u5_27fixp, align 4, !taffo.info !107
  %0 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %1 = lshr i32 %u5_27fixp, 1, !taffo.info !107
  %2 = ashr i32 %0, 4, !taffo.info !42
  %3 = ashr i32 %1, 1, !taffo.info !107
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 25), !taffo.info !109
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !112
  ...
  %5 = lshr i32 %mul.u6_26fixp, 1, !taffo.info !112
  %6 = lshr i32 %u5_27fixp2, 1, !taffo.info !53
  %7 = ashr i32 %5, 7, !taffo.info !112
  %8 = ashr i32 %6, 8, !taffo.info !53
  %9 = call i32 @llvm.smul.fix.i32(i32 %7, i32 %8, i32 18), !taffo.info !113
  %mul12.u13_19fixp = shl i32 %9, 1, !taffo.info !116
  ...
  %add.u13_19fixp = add i32 %u13_19fixp, %mul12.u13_19fixp, !taffo.info !117
...
for.body26:                                       ; preds = %for.cond24
  ...
  %13 = call i32 @llvm.smul.fix.i32(i32 %10, i32 %12, i32 11), !taffo.info !122
  %mul29.u20_12fixp = shl i32 %13, 1, !taffo.info !125
...
for.body32:                                       ; preds = %for.cond30
  ...
  %18 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %17, i32 11), !taffo.info !126
  %mul37.u20_12fixp = shl i32 %18, 1, !taffo.info !128
  ...
  %add40.u20_12fixp = add i32 %u20_12fixp4, %mul37.u20_12fixp, !taffo.info !129
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %A.u5_27fixp, i32 %i.0, !taffo.info !165
  %arrayidx7.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u5_27fixp, i32 0, i32 %j.0, !taffo.info !165
  %4 = lshr i32 %div.u3_29fixp, 2, !taffo.info !164
  store i32 %4, i32* %arrayidx7.u5_27fixp, align 4, !taffo.info !105
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u5_27fixp, i32 %i.1, !taffo.info !181
  %arrayidx26.u5_27fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx25.u5_27fixp, i32 0, i32 %j.1, !taffo.info !181
  %8 = lshr i32 %div24.u1_31fixp, 4, !taffo.info !179
  store i32 %8, i32* %arrayidx26.u5_27fixp, align 4, !taffo.info !105
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx48.u5_27fixp = getelementptr inbounds [14 x i32], [14 x i32]* %C.u5_27fixp, i32 %i.2, !taffo.info !197
  %arrayidx49.u5_27fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx48.u5_27fixp, i32 0, i32 %j.2, !taffo.info !197
  %12 = lshr i32 %div47.u1_31fixp, 4, !taffo.info !196
  store i32 %12, i32* %arrayidx49.u5_27fixp, align 4, !taffo.info !105
  br label %for.inc50
...
for.body63:                                       ; preds = %for.cond60
  ...
  %arrayidx70.u20_12fixp = getelementptr inbounds [14 x i32], [14 x i32]* %D.u20_12fixp, i32 %i.3, !taffo.info !211
  %arrayidx71.u20_12fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx70.u20_12fixp, i32 0, i32 %j.3, !taffo.info !211
  %16 = lshr i32 %div69.u1_31fixp, 19, !taffo.info !210
  store i32 %16, i32* %arrayidx71.u20_12fixp, align 4, !taffo.info !105
  br label %for.inc72
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86.u13_19fixp = getelementptr inbounds [10 x i32], [10 x i32]* %tmp.u13_19fixp, i32 %i.4, !taffo.info !214
  %arrayidx87.u13_19fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx86.u13_19fixp, i32 0, i32 %j.4, !taffo.info !214
  store i32 0, i32* %arrayidx87.u13_19fixp, align 4, !taffo.info !105, !taffo.constinfo !106
  br label %for.inc88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u20_12fixp, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !218 !taffo.sourceFunction !219 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 6), !taffo.info !221
  %mul.u25_7fixp = shl i32 %5, 1, !taffo.info !224
  ...
  %7 = shl i32 %mul.u25_7fixp, 5, !taffo.info !224
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !236 !taffo.sourceFunction !219 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !237
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !240
  %6 = mul nsw i32 %i.0, %m, !taffo.info !91
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !240
...
!110 = !{!"fixp", i32 -32, i32 25}
!111 = !{double 0.000000e+00, double 4.200000e+01}
!112 = !{!108, !111, i1 false, i2 -1}
!113 = !{!114, !115, i1 false, i2 -1}
!114 = !{!"fixp", i32 -32, i32 18}
!115 = !{double 0.000000e+00, double 0x4092E6665B63D3E5}
!116 = !{!48, !115, i1 false, i2 -1}
!117 = !{!48, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 0x40B72CCCB6D86EC1}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = !{!123, !124, i1 false, i2 -1}
!123 = !{!"fixp", i32 -32, i32 11}
!124 = !{double 0.000000e+00, double 0x4127047AD9999999}
!125 = !{!58, !124, i1 false, i2 -1}
!126 = !{!123, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x410121D404846DFD}
!128 = !{!58, !127, i1 false, i2 -1}
!129 = !{!58, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x412776DB61211B7F}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = distinct !{!133, !23}
...
!218 = !{i32 1, !85, i32 1, !87, i32 1, !57, i32 1, !97}
!219 = !{void (i32, i32, float*, i32)* @scale_2d}
!220 = !{!108, !98, i1 false, i2 1}
!221 = !{!222, !223, i1 false, i2 -1}
!222 = !{!"fixp", i32 -32, i32 6}
!223 = !{double 0.000000e+00, double 0x41732E6660000000}
!224 = !{!225, !223, i1 false, i2 -1}
!225 = !{!"fixp", i32 32, i32 7}
!226 = distinct !{!226, !23}
!227 = distinct !{!227, !23}
...
!234 = distinct !{!234, !23}
!235 = distinct !{!235, !23}
!236 = !{i32 1, !85, i32 1, !102, i32 1, !50, i32 1, !97}
!237 = !{!238, !239, i1 false, i2 -1}
!238 = !{!"fixp", i32 -32, i32 21}
!239 = !{double 0.000000e+00, double 8.960000e+02}
!240 = !{!241, !239, i1 false, i2 -1}
!241 = !{!"fixp", i32 32, i32 22}
!242 = distinct !{!242, !23}
!243 = distinct !{!243, !23}
