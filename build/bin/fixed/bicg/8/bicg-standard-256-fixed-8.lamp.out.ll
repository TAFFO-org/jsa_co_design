; ModuleID = './build/bin/fixed/bicg/8/bicg-standard-256-fixed-8.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !87 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !93
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !52
  %5 = shl i32 %mul.u16_16fixp, 8, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !99 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 4), !taffo.info !100
  %mul.u27_5fixp = shl i32 %4, 1, !taffo.info !103
  %arrayidx1.u19_13fixp = getelementptr inbounds i32, i32* %val.u19_13fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u27_5fixp, 8, !taffo.info !103
...
!94 = !{!"fixp", i32 -32, i32 15}
!95 = !{double 0.000000e+00, double 0x40EE6666601BC98A}
...
!102 = !{double 0.000000e+00, double 0x419B5D1760000000}
