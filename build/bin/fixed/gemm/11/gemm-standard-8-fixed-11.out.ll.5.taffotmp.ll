; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-8-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u4_28fixp, i32 8), !taffo.info !61, !taffo.constinfo !60
  ...
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u4_28fixp2, i32 8), !taffo.info !62, !taffo.constinfo !60
