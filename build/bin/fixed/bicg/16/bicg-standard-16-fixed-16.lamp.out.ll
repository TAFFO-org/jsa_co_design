; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-16-fixed-16.out.ll'
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u11_21fixp = load i32, i32* %arrayidx25.u11_21fixp, align 4, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !87 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !92
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !95
  %arrayidx1.u11_21fixp = getelementptr inbounds i32, i32* %val.u11_21fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u15_17fixp, 4, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !98 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 23), !taffo.info !99
  %mul.u8_24fixp = shl i32 %4, 1, !taffo.info !102
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !52
  %5 = shl i32 %mul.u8_24fixp, 3, !taffo.info !102
...
!93 = !{!"fixp", i32 -32, i32 16}
!94 = !{double 0.000000e+00, double 0x40DB5D175FF609DD}
...
!163 = !{!100, !164, i1 false, i2 -1}
!164 = !{double 0.000000e+00, double 0x406E8BA2DF9378EE}
!165 = !{!103, !164, i1 false, i2 -1}
!166 = distinct !{!166, !25}
!167 = distinct !{!167, !25}
