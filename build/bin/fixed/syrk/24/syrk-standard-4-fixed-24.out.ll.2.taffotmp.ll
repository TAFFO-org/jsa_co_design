; ModuleID = './build/bin/fixed/syrk/24/syrk-standard-4-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !39, !taffo.info !30, !taffo.originalCall !41
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 4), !taffo.initweight !39, !taffo.info !32, !taffo.originalCall !41
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 4), !taffo.initweight !43, !taffo.info !34, !taffo.target !36, !taffo.originalCall !44
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %3, i32 noundef 4), !taffo.initweight !43, !taffo.info !37, !taffo.originalCall !44
...
!35 = !{double 0.000000e+00, double 0x405AA50A41A261BF}
!36 = !{!"C"}
