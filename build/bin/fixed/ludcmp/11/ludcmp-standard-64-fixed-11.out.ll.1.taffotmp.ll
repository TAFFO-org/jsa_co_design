...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.1,523.039978) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [37 x i8] c"scalar(range(64.0,523.039978) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(257.600006,288.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [52 x i8] c"target('x') scalar(range(-0.037947,3.998521) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,257.600006) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 166, i8* null)
  %B2 = bitcast [20 x [20 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 167, i8* null)
  %b3 = bitcast [20 x float]* %b to i8*
  call void @llvm.var.annotation(i8* %b3, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 168, i8* null)
  ...
  call void @llvm.var.annotation(i8* %y5, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 170, i8* null)
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 64)
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 64)
  ...
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 64)
