; ModuleID = './build/bin/fixed/gesummv/8/gesummv-standard-4-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_gesummv.5_fixp(i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay17.u3_29fixp, [16 x i32]* %arraydecay18.u3_29fixp, i32* %arraydecay19.u7_25fixp, i32* %arraydecay20.u3_29fixp, i32* %arraydecay21.u8_24fixp), !taffo.info !57, !taffo.constinfo !58
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4170000000000000, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u8_24fixp = load i32, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !90
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !92
  %0 = lshr i32 %u8_24fixp, 1, !taffo.info !90
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !92
  %2 = ashr i32 %0, 2, !taffo.info !90
  %3 = ashr i32 %1, 7, !taffo.info !92
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !93
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !96
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u10_22fixp, 2, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !98 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u3_29fixp = load i32, i32* %arrayidx.u3_29fixp, align 4, !taffo.info !99
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !101
  %0 = lshr i32 %u3_29fixp, 1, !taffo.info !99
  %1 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !101
  %2 = ashr i32 %0, 1, !taffo.info !99
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 27), !taffo.info !102
  %mul.u4_28fixp = shl i32 %3, 1, !taffo.info !105
  %arrayidx1.u3_29fixp = getelementptr inbounds i32, i32* %val.u3_29fixp, i32 %i.0, !taffo.info !48
  %4 = shl i32 %mul.u4_28fixp, 1, !taffo.info !105
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !107 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u7_25fixp = load i32, i32* %arrayidx.u7_25fixp, align 4, !taffo.info !108
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !92
  %0 = lshr i32 %u7_25fixp, 1, !taffo.info !108
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !92
  %2 = ashr i32 %0, 2, !taffo.info !108
  %3 = ashr i32 %1, 6, !taffo.info !92
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 22), !taffo.info !110
  %mul.u9_23fixp = shl i32 %4, 1, !taffo.info !113
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !51
  %5 = shl i32 %mul.u9_23fixp, 2, !taffo.info !113
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u3_29fixp4 = load i32, i32* %arrayidx6.u3_29fixp, align 4, !taffo.info !99
  %arrayidx7.u3_29fixp = getelementptr inbounds i32, i32* %x.u3_29fixp, i32 %j.0, !taffo.info !48
  %u3_29fixp = load i32, i32* %arrayidx7.u3_29fixp, align 4, !taffo.info !99
  %0 = lshr i32 %u3_29fixp4, 1, !taffo.info !99
  %1 = lshr i32 %u3_29fixp, 1, !taffo.info !99
  %2 = ashr i32 %0, 1, !taffo.info !99
  %3 = ashr i32 %1, 1, !taffo.info !99
  ...
  %u3_29fixp5 = load i32, i32* %arrayidx11.u3_29fixp, align 4, !taffo.info !99
  %arrayidx12.u3_29fixp = getelementptr inbounds i32, i32* %x.u3_29fixp, i32 %j.0, !taffo.info !48
  %u3_29fixp2 = load i32, i32* %arrayidx12.u3_29fixp, align 4, !taffo.info !99
  %6 = lshr i32 %u3_29fixp5, 1, !taffo.info !99
  %7 = lshr i32 %u3_29fixp2, 1, !taffo.info !99
  %8 = ashr i32 %6, 1, !taffo.info !99
  %9 = ashr i32 %7, 1, !taffo.info !99
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u3_29fixp = load i32, i32* %arrayidx4.u3_29fixp, align 4, !taffo.info !99
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !101
  %1 = lshr i32 %u3_29fixp, 1, !taffo.info !99
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !101
  %3 = ashr i32 %1, 1, !taffo.info !99
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 27), !taffo.info !102
  %mul.u4_28fixp = shl i32 %4, 1, !taffo.info !105
  ...
  %6 = shl i32 %mul.u4_28fixp, 1, !taffo.info !105
...
!95 = !{double 0.000000e+00, double 0x4086A6667F90D9D7}
!96 = !{!91, !95, i1 false, i2 -1}
!97 = distinct !{!97, !23}
!98 = !{i32 1, !75, i32 1, !48, i32 1, !84}
!99 = !{!100, !50, i1 false, i2 -1}
!100 = !{!"fixp", i32 32, i32 28}
!101 = !{!100, !85, i1 false, i2 1}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 -32, i32 27}
!104 = !{double 0.000000e+00, double 1.500000e+01}
!105 = !{!100, !104, i1 false, i2 -1}
!106 = distinct !{!106, !23}
!107 = !{i32 1, !75, i32 1, !51, i32 1, !84}
!108 = !{!109, !53, i1 false, i2 -1}
!109 = !{!"fixp", i32 32, i32 23}
!110 = !{!111, !112, i1 false, i2 -1}
!111 = !{!"fixp", i32 -32, i32 22}
!112 = !{double 0.000000e+00, double 2.820000e+02}
...
!129 = !{i32 3}
!130 = !{i1 false, !104, i1 false, i2 1}
!131 = !{!100, !104, i1 false, i2 1}
...
!156 = distinct !{null}
!157 = !{!103, !158, i1 false, i2 -1}
!158 = !{double 0.000000e+00, double 1.406250e+01}
!159 = !{!100, !158, i1 false, i2 -1}
...
!167 = !{!109, !166, i1 false, i2 -1}
!168 = !{!111, !169, i1 false, i2 -1}
!169 = !{double 0.000000e+00, double 0x406B2E149914389B}
!170 = !{!109, !169, i1 false, i2 -1}
!171 = !{!109, !172, i1 false, i2 -1}
