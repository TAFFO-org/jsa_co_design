; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-1024-fixed-16.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %3, 0x4140000000000000, !taffo.info !163
  ...
  %6 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !164
