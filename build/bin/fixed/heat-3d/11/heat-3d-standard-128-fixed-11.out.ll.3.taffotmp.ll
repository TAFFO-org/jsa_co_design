; ModuleID = './build/bin/fixed/heat-3d/11/heat-3d-standard-128-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [46 x i8] c"target('A') scalar(range(256.0,3328.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [20 x i8] c"./sources/heat-3d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(256.0,3328.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 128), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
  ...
  call void @scale_3d.4(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 128), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!7 = !{double 0.000000e+00, double 3.328000e+03}
...
!50 = !{double 2.560000e+02, double 3.328000e+03}
!51 = !{i32 1}
!52 = !{i32 2}
...
!122 = !{double 5.120000e+02, double 6.656000e+03}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double -6.400000e+03, double 2.816000e+03}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double -6.144000e+03, double 6.144000e+03}
!127 = !{i32 10}
!128 = !{i1 false, !129, i1 false, i2 -1}
!129 = !{double -7.680000e+02, double 7.680000e+02}
!130 = !{i32 11}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -1.536000e+03, double 1.536000e+03}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -2.304000e+03, double 2.304000e+03}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -2.048000e+03, double 5.632000e+03}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
...
!170 = !{double 3.276800e+04, double 4.259840e+05}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
!173 = distinct !{!173, !29}
!174 = distinct !{!174, !29}
