; ModuleID = './build/bin/float/atax/16/atax-standard-1024-float-16.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, ptr noundef %arraydecay4, i32 noundef 1024)
  %arraydecay5 = getelementptr inbounds [22 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, ptr noundef %arraydecay5, i32 noundef 1024)
  %arraydecay6 = getelementptr inbounds [22 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, ptr noundef %arraydecay6, i32 noundef 1024)
...
for.body:                                         ; preds = %for.cond
  %3 = load i32, ptr %i, align 4
  %conv24 = sitofp i32 %3 to float
  %lampsim5 = bitcast float %conv24 to i32
  %lampsim6 = and i32 %lampsim5, -256
  %lampsim7 = bitcast i32 %lampsim6 to float
  %4 = load float, ptr %fn, align 4
  %div8 = fdiv float %lampsim7, %4
  %lampsim9 = bitcast float %div8 to i32
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %add12 = fadd float 1.000000e+00, %lampsim11
...
for.body12:                                       ; preds = %for.cond9
  ...
  %conv1416 = sitofp i32 %rem to float
  %lampsim17 = bitcast float %conv1416 to i32
  %lampsim18 = and i32 %lampsim17, -256
  %lampsim19 = bitcast i32 %lampsim18 to float
  %19 = load i32, ptr %m.addr, align 4
  %mul = mul nsw i32 5, %19
  %conv1520 = sitofp i32 %mul to float
  %lampsim21 = bitcast float %conv1520 to i32
  %lampsim22 = and i32 %lampsim21, -256
  %lampsim23 = bitcast i32 %lampsim22 to float
  %div1624 = fdiv float %lampsim19, %lampsim23
  %lampsim25 = bitcast float %div1624 to i32
  %lampsim26 = and i32 %lampsim25, -256
  %lampsim27 = bitcast i32 %lampsim26 to float
  ...
  store float %lampsim27, ptr %arrayidx18, align 4
  br label %for.inc19
...
for.body18:                                       ; preds = %for.cond16
  ...
  %mul238 = fmul float %32, %35
  %lampsim9 = bitcast float %mul238 to i32
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %add2412 = fadd float %28, %lampsim11
  %lampsim13 = bitcast float %add2412 to i32
  %lampsim14 = and i32 %lampsim13, -256
  %lampsim15 = bitcast i32 %lampsim14 to float
  %36 = load ptr, ptr %y.addr, align 4
  %37 = load i32, ptr %j, align 4
  %arrayidx25 = getelementptr inbounds float, ptr %36, i32 %37
  store float %lampsim15, ptr %arrayidx25, align 4
  br label %for.inc26
