; ModuleID = './build/bin/fixed/seidel-2d/11/seidel-2d-standard-8-fixed-11.out.ll.3.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !143, !taffo.initweight !145
...
!94 = !{double 1.600000e+00, double 0x40740CCCC0379314}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 22}
!98 = !{double 0x4003333333333334, double 0x407E133320535C9E}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 21}
!102 = !{double 3.200000e+00, double 0x40840CCCC0379314}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 4.000000e+00, double 0x40890FFFF04577D9}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 7.200000e+00, double 0x40968E66583E8576}
...
!143 = !{!101, !144, i1 false, i2 -1}
!144 = !{double 6.400000e+00, double 0x40940CCCC0379314}
!145 = !{i32 9}
!146 = distinct !{!146, !23}
!147 = distinct !{!147, !23}
