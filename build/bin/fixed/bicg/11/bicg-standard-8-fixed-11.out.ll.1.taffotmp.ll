...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,7.636364) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/bicg.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [48 x i8] c"target('s') scalar(range(0.0,437.818207) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [48 x i8] c"target('q') scalar(range(0.0,386.909088) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 119, i8* null)
  %s2 = bitcast [20 x float]* %s to i8*
  call void @llvm.var.annotation(i8* %s2, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  %q3 = bitcast [22 x float]* %q to i8*
  call void @llvm.var.annotation(i8* %q3, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 121, i8* null)
  %p4 = bitcast [20 x float]* %p to i8*
  call void @llvm.var.annotation(i8* %p4, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 122, i8* null)
  %r5 = bitcast [22 x float]* %r to i8*
  call void @llvm.var.annotation(i8* %r5, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 123, i8* null)
  ...
  call void @scale_2d(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 8)
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %s, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 8)
  %arraydecay12 = getelementptr inbounds [22 x float], [22 x float]* %q, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 8)
  ...
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 8)
