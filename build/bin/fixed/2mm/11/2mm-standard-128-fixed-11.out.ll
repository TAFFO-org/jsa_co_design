; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-128-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp2 = bitcast [10 x i32]* %arraydecay13.u7_25fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u7_25fixp2, i32 128), !taffo.info !66, !taffo.constinfo !65
  %arraydecay14.u7_25fixp = getelementptr inbounds [10 x [14 x i32]], [10 x [14 x i32]]* %C.u7_25fixp, i32 0, i32 0, !taffo.info !55
  %u7_25fixp = bitcast [14 x i32]* %arraydecay14.u7_25fixp to i32*, !taffo.info !55
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u7_25fixp, i32 128), !taffo.info !67, !taffo.constinfo !65
  ...
  call void @kernel_2mm.3_fixp(i32 8, i32 10, i32 12, i32 14, i32 %u2_30fixp, i32 %u2_30fixp1, [10 x i32]* %arraydecay17.u17_15fixp, [12 x i32]* %arraydecay18.u7_25fixp, [10 x i32]* %arraydecay19.u7_25fixp, [14 x i32]* %arraydecay20.u7_25fixp, [14 x i32]* %arraydecay21.u26_6fixp), !taffo.info !60, !taffo.constinfo !61
