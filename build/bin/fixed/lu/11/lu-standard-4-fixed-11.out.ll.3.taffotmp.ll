; ModuleID = './build/bin/fixed/lu/11/lu-standard-4-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [47 x i8] c"target('A') scalar(range(0.1,32.689999) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 4), !taffo.initweight !55, !taffo.info !48, !taffo.target !50, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40405851E321A2E8}
...
!49 = !{double 1.000000e-01, double 0x40405851E321A2E8}
!50 = !{!"A"}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x3F847AE147AE147C, double 0x4090B28B4CA8D01D}
!109 = !{i1 false, !110, i1 false, i2 1}
!110 = !{double 0xC090B224E64269B7, double 0x4040570A350D2807}
!111 = distinct !{!111, !29}
!112 = !{i32 8}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3F690F455B182118, double 0x40746E665BEA0BA2}
!115 = distinct !{!115, !29}
!116 = distinct !{!116, !29}
!117 = distinct !{!117, !29}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double 0.000000e+00, double 0x4090B28B4CA8D01D}
...
!152 = !{double 4.000000e+00, double 4.000000e+00}
!153 = !{i32 9}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 4.000000e-01, double 0x40605851E321A2E8}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
