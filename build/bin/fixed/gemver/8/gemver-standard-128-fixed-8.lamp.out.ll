; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-128-fixed-8.out.ll'
...
for.body51:                                       ; preds = %for.cond49
  ...
  %lampsim1 = and i32 %lampsim, -65536
  %lampsim2 = bitcast i32 %lampsim1 to float
  %29 = fdiv float %lampsim2, 5.242880e+05, !taffo.info !195
  ...
  %lampsim10 = and i32 %lampsim9, -65536
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul57.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !196
  %lampsim13 = bitcast float %mul57.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -65536
  %lampsim15 = bitcast i32 %lampsim14 to float
  %add58.1flp16 = fadd float %.flt.fallback.1flp, %lampsim15, !taffo.info !199
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim4 = and i32 %lampsim3, -65536
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !205
