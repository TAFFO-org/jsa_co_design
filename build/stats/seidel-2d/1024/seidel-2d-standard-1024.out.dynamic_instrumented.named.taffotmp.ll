; ModuleID = './build/stats/seidel-2d/1024/seidel-2d-standard-1024.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %12 = load i32, i32* %factor.addr, align 4
  %"a::var63" = sitofp i32 %12 to float
