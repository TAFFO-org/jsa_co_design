; ModuleID = './build/stats/gesummv/4/gesummv-standard-4.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 4), !taffo.originalCall !30
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 4), !taffo.originalCall !30
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i64 0, i64 0
  call void @scale_1d.5(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 4), !taffo.originalCall !31
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i64 0, i64 0
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 4), !taffo.originalCall !31
  %arraydecay16 = getelementptr inbounds [16 x float], [16 x float]* %y, i64 0, i64 0
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 4), !taffo.originalCall !31
