; ModuleID = './build/bin/fixed/atax/11/atax-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 1024), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.info !46, !taffo.initweight !56
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 1024), !taffo.info !67, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 1024), !taffo.info !70, !taffo.initweight !61, !taffo.constinfo !68, !taffo.target !51, !taffo.originalCall !69
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !56
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 1024), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
...
!48 = !{double 1.024000e+03, double 0x409F45D1800A7C5B}
!49 = !{!50, !1, i1 false, i2 -1}
!50 = !{!"float", i32 1, double 0x41FEC418A0000000}
!51 = !{!"y"}
...
!93 = !{double 1.024000e+03, double 1.024000e+03}
!94 = !{i32 5}
!95 = !{i32 6}
!96 = !{!47, !93, i1 false, i2 1}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"fixp", i32 32, i32 11}
!99 = !{double 0x4130000000000000, double 0x413F45D1800A7C5B}
!100 = !{i32 7}
!101 = distinct !{!101, !23}
!102 = !{i32 1, !83, i32 1, !49, i32 1, !92}
!103 = !{!104, !105, i1 false, i2 -1}
!104 = !{!"float", i32 1, double 0x429EC418A0000000}
!105 = !{double 0.000000e+00, double 0x429EC418A0000000}
!106 = distinct !{!106, !23}
...
!115 = !{!"fixp", i32 32, i32 9}
!116 = !{!117, !118, i1 false, i2 -1}
!117 = !{!"fixp", i32 32, i32 13}
!118 = !{double 0.000000e+00, double 0x411A44E31FC49A55}
!119 = !{!115, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x4150E6DD91FC49A5}
!121 = distinct !{!121, !23}
!122 = !{!123, !124, i1 false, i2 -1}
!123 = !{!"float", i32 1, double 0x41C9A3054B9950C6}
!124 = !{double 0.000000e+00, double 0x41C9A3054B9950C6}
!125 = !{!126, !127, i1 false, i2 -1}
!126 = !{!"float", i32 1, double 0x4200FC3CA4B9950C}
!127 = !{double 0.000000e+00, double 0x4200FC3CA4B9950C}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
!130 = !{i32 1, !109, i32 1, !52, i32 1, !92}
!131 = !{!132, !133, i1 false, i2 -1}
!132 = !{!"float", i32 1, double 0x41EE851EC0000000}
...
!172 = !{double 0.000000e+00, double 0x410AE1479F666235}
!173 = !{i32 9}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
