; ModuleID = './build/bin/fixed/3mm/8/3mm-standard-512-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp1 = bitcast [14 x i32]* %arraydecay18.u7_25fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u7_25fixp1, i32 512), !taffo.info !67, !taffo.constinfo !63
