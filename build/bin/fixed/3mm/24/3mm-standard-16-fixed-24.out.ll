; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-16-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u2_30fixp1, i32 16), !taffo.info !62, !taffo.constinfo !61
  ...
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u2_30fixp, i32 16), !taffo.info !63, !taffo.constinfo !61
  ...
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u2_30fixp3, i32 16), !taffo.info !65, !taffo.constinfo !61
  ...
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u2_30fixp2, i32 16), !taffo.info !66, !taffo.constinfo !61
...
for.body30:                                       ; preds = %for.cond28
  ...
  %1 = fdiv float %0, 0x4130000000000000, !taffo.info !56, !taffo.target !58
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u10_22fixp, 4, !taffo.info !236
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !239 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !240
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !243
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u16_16fixp, 4, !taffo.info !243
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !247 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !248
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !44
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !248
  %3 = ashr i32 %1, 4, !taffo.info !44
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !249
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !251
  ...
  %6 = shl i32 %mul.u6_26fixp, 4, !taffo.info !251
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !254 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !255
  %mul.u9_23fixp = shl i32 %5, 1, !taffo.info !258
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u9_23fixp, 4, !taffo.info !258
...
!234 = !{!127, !235, i1 false, i2 -1}
!235 = !{double 0.000000e+00, double 0x4080624DE3B8A19D}
!236 = !{!130, !235, i1 false, i2 -1}
!237 = distinct !{!237, !23}
!238 = distinct !{!238, !23}
!239 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !230}
!240 = !{!241, !242, i1 false, i2 -1}
!241 = !{!"fixp", i32 -32, i32 15}
!242 = !{double 0.000000e+00, double 0x40EBCB067FF583A5}
!243 = !{!244, !242, i1 false, i2 -1}
!244 = !{!"fixp", i32 32, i32 16}
!245 = distinct !{!245, !23}
!246 = distinct !{!246, !23}
!247 = !{i32 1, !83, i32 1, !16, i32 1, !44, i32 1, !230}
!248 = !{!50, !231, i1 false, i2 1}
!249 = !{!107, !250, i1 false, i2 -1}
!250 = !{double 0.000000e+00, double 0x4045555582129457}
!251 = !{!50, !250, i1 false, i2 -1}
!252 = distinct !{!252, !23}
!253 = distinct !{!253, !23}
!254 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !230}
!255 = !{!256, !257, i1 false, i2 -1}
!256 = !{!"fixp", i32 -32, i32 22}
!257 = !{double 0.000000e+00, double 0x407BBBBBD7B2031D}
!258 = !{!259, !257, i1 false, i2 -1}
!259 = !{!"fixp", i32 32, i32 23}
!260 = distinct !{!260, !23}
!261 = distinct !{!261, !23}
