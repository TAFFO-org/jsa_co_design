; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-4-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 4), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 4), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 5.333330e-01, double 0x404E22221C8A7A42}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 8.000000e-01, double 0x405011111F0C34C2}
!34 = !{i32 1}
!35 = !{i32 2}
