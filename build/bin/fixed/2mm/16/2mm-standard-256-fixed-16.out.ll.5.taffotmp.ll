; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !229
  ...
  %6 = fmul float 8.000000e+00, %mul.1flp, !taffo.info !229
  %7 = fptoui float %6 to i32, !taffo.info !229
