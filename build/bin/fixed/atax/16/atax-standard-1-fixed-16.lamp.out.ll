; ModuleID = './build/bin/fixed/atax/16/atax-standard-1-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 0x41B0000000000000, !taffo.info !34, !taffo.target !36
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.8, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !59
  br label %for.inc
