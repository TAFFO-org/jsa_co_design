; ModuleID = './build/bin/fixed/syrk/11/syrk-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,27.484688) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !57, !taffo.info !49, !taffo.originalCall !60, !taffo.constinfo !61
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 2), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !60, !taffo.constinfo !61
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 2), !taffo.initweight !63, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 2), !taffo.initweight !63, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !110 !taffo.funinfo !112 !taffo.sourceFunction !60 {
entry:
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syrk.3(i32 noundef %n, i32 noundef %m, float noundef %alpha, float noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A) #0 !taffo.initweight !113 !taffo.funinfo !114 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx4, align 4, !taffo.initweight !115, !taffo.info !53
  %mul = fmul float %0, %beta, !taffo.initweight !88, !taffo.info !116
...
for.body10:                                       ; preds = %for.cond8
  ...
  %1 = load float, float* %arrayidx12, align 4, !taffo.initweight !115, !taffo.info !55
  %mul13 = fmul float %alpha, %1, !taffo.initweight !88, !taffo.info !119
  ...
  %2 = load float, float* %arrayidx15, align 4, !taffo.initweight !115, !taffo.info !55
  %mul16 = fmul float %mul13, %2, !taffo.initweight !89, !taffo.info !121
  ...
  %3 = load float, float* %arrayidx18, align 4, !taffo.initweight !115, !taffo.info !53
  %add = fadd float %3, %mul16, !taffo.initweight !115, !taffo.info !123
  store float %add, float* %arrayidx18, align 4, !taffo.initweight !115, !taffo.info !53
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, i32 noundef %m, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A) #0 !taffo.initweight !128 !taffo.funinfo !114 !taffo.sourceFunction !58 {
entry:
...
for.cond:                                         ; preds = %for.inc8, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc9, %for.inc8 ], !taffo.initweight !48, !taffo.info !129
  %cmp = icmp slt i32 %i.0, %n, !taffo.initweight !62, !taffo.info !130
  br i1 %cmp, label %for.body, label %for.end10, !taffo.initweight !63, !taffo.info !85
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !131
  %cmp4 = icmp slt i32 %j.0, %m, !taffo.initweight !62, !taffo.info !130
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !63, !taffo.info !87

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !62, !taffo.info !133
  %add = add nsw i32 %mul, 1, !taffo.initweight !63, !taffo.info !135, !taffo.constinfo !27
  %rem = srem i32 %add, %n, !taffo.initweight !72, !taffo.info !137
  %conv = sitofp i32 %rem to float, !taffo.initweight !88, !taffo.info !137
  %conv6 = sitofp i32 %n to float, !taffo.info !101
  %div = fdiv float %conv, %conv6, !taffo.initweight !89, !taffo.info !139
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !62, !taffo.info !141
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !62, !taffo.info !141
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !63, !taffo.info !90
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !62, !taffo.info !142, !taffo.constinfo !27
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.initweight !62, !taffo.info !145, !taffo.constinfo !27
...
for.cond11:                                       ; preds = %for.inc30, %for.end10
  %i.1 = phi i32 [ 0, %for.end10 ], [ %inc31, %for.inc30 ], !taffo.initweight !48, !taffo.info !129
  %cmp12 = icmp slt i32 %i.1, %n, !taffo.initweight !62, !taffo.info !130
  br i1 %cmp12, label %for.body14, label %for.end32, !taffo.initweight !63, !taffo.info !85
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  %j.1 = phi i32 [ 0, %for.body14 ], [ %inc28, %for.inc27 ], !taffo.initweight !48, !taffo.info !131
  %cmp16 = icmp slt i32 %j.1, %n, !taffo.initweight !62, !taffo.info !147
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.initweight !63, !taffo.info !87

for.body18:                                       ; preds = %for.cond15
  %mul19 = mul nsw i32 %i.1, %j.1, !taffo.initweight !62, !taffo.info !133
  %add20 = add nsw i32 %mul19, 2, !taffo.initweight !63, !taffo.info !148, !taffo.constinfo !27
  %rem21 = srem i32 %add20, %m, !taffo.initweight !72, !taffo.info !150
  %conv22 = sitofp i32 %rem21 to float, !taffo.initweight !88, !taffo.info !150
  %conv23 = sitofp i32 %m to float, !taffo.info !22
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !89, !taffo.info !152
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.initweight !62, !taffo.info !154
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.initweight !62, !taffo.info !154
  store float %div24, float* %arrayidx26, align 4, !taffo.initweight !63, !taffo.info !90
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.initweight !62, !taffo.info !142, !taffo.constinfo !27
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.initweight !62, !taffo.info !145, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !157 !taffo.funinfo !158 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !159, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !160, !taffo.info !161
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !159, !taffo.info !53
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !157 !taffo.funinfo !165 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !115, !taffo.info !55
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !159, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !160, !taffo.info !166
  %2 = mul nsw i32 %i.0, %m, !taffo.info !105
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !89, !taffo.info !55
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !115, !taffo.info !55
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !159, !taffo.info !55
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 0x403B7C148344C37E}
...
!109 = distinct !{!109, !29}
!110 = !{i32 1, i32 -1}
!111 = !{i32 1, !49, i32 1, !25}
!112 = !{i32 1, !51, i32 1, !25}
!113 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2}
!114 = !{i32 1, !101, i32 1, !22, i32 1, !49, i32 1, !51, i32 1, !53, i32 1, !55}
!115 = !{i32 7}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x40407DA5E85C754B}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 2.812500e+00}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x4015180000000000}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4040610A41A261BF}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = distinct !{!127, !29}
!128 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2}
!129 = !{i1 false, !69, i1 false, i2 1}
!130 = !{i1 false, !71, i1 false, i2 1}
!131 = !{i1 false, !132, i1 false, i2 1}
!132 = !{double 0.000000e+00, double 1.100000e+01}
!133 = !{i1 false, !134, i1 false, i2 1}
!134 = !{double 0.000000e+00, double 1.600000e+02}
!135 = !{i1 false, !136, i1 false, i2 1}
!136 = !{double 1.000000e+00, double 1.610000e+02}
...
!158 = !{i32 1, !101, i32 1, !101, i32 1, !53, i32 1, !25}
!159 = !{i32 8}
!160 = !{i32 9}
!161 = !{i1 false, !162, i1 false, i2 -1}
!162 = !{double 0.000000e+00, double 0x404B7C148344C37E}
!163 = distinct !{!163, !29}
!164 = distinct !{!164, !29}
!165 = !{i32 1, !101, i32 1, !22, i32 1, !55, i32 1, !25}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 0.000000e+00, double 3.750000e+00}
!168 = distinct !{!168, !29}
!169 = distinct !{!169, !29}
