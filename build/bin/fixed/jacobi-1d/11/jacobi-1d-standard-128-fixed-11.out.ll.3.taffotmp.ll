; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-128-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [53 x i8] c"target('A') scalar(range(17.066668,136.53334) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-1d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [37 x i8] c"scalar(range(25.6,145.066666) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 128), !taffo.initweight !54, !taffo.target !48, !taffo.info !49, !taffo.originalCall !57, !taffo.constinfo !56
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !53, !taffo.info !51
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 128), !taffo.initweight !54, !taffo.info !51, !taffo.originalCall !57, !taffo.constinfo !56
...
!7 = !{double 0.000000e+00, double 0x406111111F0C34C2}
...
!50 = !{double 0x40311111276FB092, double 0x406111111F0C34C2}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 2.560000e+01, double 0x4062222220BC382A}
!53 = !{i32 1}
!54 = !{i32 2}
...
!103 = !{double 0x40A11111276FB092, double 0x40D111111F0C34C2}
!104 = distinct !{!104, !29}
...
!112 = !{double 0x40411111276FB092, double 0x407111111F0C34C2}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x40499999BB2788DB, double 0x40799999AE924F23}
!115 = !{i32 8}
!116 = !{i32 9}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double 0x40311105F81FE170, double 0x40611105EFBC6B1F}
!119 = !{i32 10}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x40311105E0000000, double 0x4061110600000000}
!122 = distinct !{!122, !29}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 5.120000e+01, double 0x4072222220BC382A}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0x4053333333333334, double 0x407B3333311A543F}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0x40399988D2A1F8E5, double 0x406222163E777C94}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x40399988C0000000, double 0x4062221640000000}
!131 = distinct !{!131, !29}
!132 = distinct !{!132, !29}
!133 = !{i32 1, !88, i32 1, !51, i32 1, !97}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 3.276800e+03, double 0x40D2222220BC382A}
!136 = distinct !{!136, !29}
