...
entry:
  ...
  call void @llvm.var.annotation(i8* %C3, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 124, i8* null)
  %A4 = bitcast [10 x [10 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 125, i8* null)
  %B5 = bitcast [10 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B5, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 126, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 256)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 256)
