; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-2-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !56, !taffo.info !33, !taffo.originalCall !58
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 2), !taffo.initweight !56, !taffo.info !35, !taffo.originalCall !58
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 2), !taffo.initweight !60, !taffo.info !37, !taffo.originalCall !61
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !56, !taffo.info !39
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 2), !taffo.initweight !59, !taffo.info !39, !taffo.originalCall !62
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !56, !taffo.info !41
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 2), !taffo.initweight !59, !taffo.info !41, !taffo.originalCall !62
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !56, !taffo.info !43
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 2), !taffo.initweight !59, !taffo.info !43, !taffo.originalCall !62
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !56, !taffo.info !45
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 2), !taffo.initweight !59, !taffo.info !45, !taffo.originalCall !62
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 2), !taffo.initweight !59, !taffo.info !47, !taffo.target !49, !taffo.originalCall !62
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !56, !taffo.info !50
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 2), !taffo.initweight !59, !taffo.info !50, !taffo.originalCall !62
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !56, !taffo.info !52
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 2), !taffo.initweight !59, !taffo.info !52, !taffo.originalCall !62
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !56, !taffo.info !54
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 2), !taffo.initweight !59, !taffo.info !54, !taffo.originalCall !62
...
!38 = !{double 0.000000e+00, double 2.662500e+00}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 0.000000e+00, double 1.900000e+00}
!41 = !{i1 false, !42, i1 false, i2 -1}
!42 = !{double 2.500000e-02, double 5.000000e-01}
!43 = !{i1 false, !44, i1 false, i2 -1}
!44 = !{double 5.000000e-02, double 1.000000e+00}
!45 = !{i1 false, !46, i1 false, i2 -1}
!46 = !{double 1.666700e-02, double 3.333330e-01}
!47 = !{i1 false, !48, i1 false, i2 -1}
!48 = !{double 0.000000e+00, double 0x406ABE8B60F1B25F}
!49 = !{!"w"}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 5.551250e+00}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 1.250000e-02, double 2.500000e-01}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 1.111100e-02, double 2.222220e-01}
!56 = !{i32 1}
