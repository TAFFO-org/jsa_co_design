; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-128-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,75571.195312) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,112.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,115.199997) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,118.85714) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [48 x i8] c"target('D') scalar(range(0.0,40225996.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !66, !taffo.constinfo !67
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 128), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 128), !taffo.initweight !69, !taffo.info !55, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 128), !taffo.initweight !69, !taffo.info !57, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 128), !taffo.initweight !69, !taffo.info !59, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 128), !taffo.initweight !69, !taffo.info !61, !taffo.target !62, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 128), !taffo.initweight !69, !taffo.info !53, !taffo.originalCall !70, !taffo.constinfo !71
...
for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !68, !taffo.info !142
  ...
  %conv = sitofp i32 %rem to float, !taffo.initweight !100, !taffo.info !166
  %conv6 = sitofp i32 %ni to float, !taffo.info !124
  %div = fdiv float %conv, %conv6, !taffo.initweight !101, !taffo.info !168
...
for.body18:                                       ; preds = %for.cond15
  ...
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !100, !taffo.info !180
...
for.body40:                                       ; preds = %for.cond37
  ...
  %conv45 = sitofp i32 %rem44 to float, !taffo.initweight !100, !taffo.info !191
  %conv46 = sitofp i32 %nl to float, !taffo.info !126
  %div47 = fdiv float %conv45, %conv46, !taffo.initweight !101, !taffo.info !193
...
for.body63:                                       ; preds = %for.cond60
  ...
  %div69 = fdiv float %conv67, %conv68, !taffo.initweight !100, !taffo.info !204
...
!7 = !{double 0.000000e+00, double 0x41832E6660000000}
...
!54 = !{double 0.000000e+00, double 0x40F273331FFF79C8}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 1.120000e+02}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x405CCCCCC0379314}
!59 = !{i1 false, !60, i1 false, i2 -1}
!60 = !{double 0.000000e+00, double 0x405DB6DB61BB05FB}
...
!143 = !{double 0.000000e+00, double 1.680000e+02}
!144 = !{i1 false, !145, i1 false, i2 -1}
!145 = !{double 0.000000e+00, double 0x40D2E6665E247885}
!146 = !{i1 false, !147, i1 false, i2 -1}
!147 = !{double 0.000000e+00, double 0x40F72CCCB78897E9}
!148 = distinct !{!148, !29}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = !{i1 false, !152, i1 false, i2 -1}
!152 = !{double 0.000000e+00, double 0x4187047AD9999999}
!153 = !{i32 8}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x416121D404846DFD}
!156 = !{i1 false, !157, i1 false, i2 -1}
!157 = !{double 0.000000e+00, double 0x418776DB61211B7F}
!158 = distinct !{!158, !29}
!159 = distinct !{!159, !29}
!160 = distinct !{!160, !29}
...
!213 = !{i32 1, !124, i32 1, !22, i32 1, !53, i32 1, !134}
!214 = !{i32 9}
!215 = !{i1 false, !216, i1 false, i2 -1}
!216 = !{double 0.000000e+00, double 0x416273331FFF79C8}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = !{i32 1, !124, i32 1, !139, i32 1, !55, i32 1, !134}
!220 = !{i1 false, !221, i1 false, i2 -1}
!221 = !{double 0.000000e+00, double 1.433600e+04}
!222 = distinct !{!222, !29}
!223 = distinct !{!223, !29}
!224 = !{i32 1, !139, i32 1, !22, i32 1, !57, i32 1, !134}
!225 = !{i1 false, !226, i1 false, i2 -1}
!226 = !{double 0.000000e+00, double 0x40CCCCCCC0379314}
!227 = distinct !{!227, !29}
!228 = distinct !{!228, !29}
!229 = !{i32 1, !22, i32 1, !126, i32 1, !59, i32 1, !134}
!230 = !{i1 false, !231, i1 false, i2 -1}
!231 = !{double 0.000000e+00, double 0x40CDB6DB61BB05FB}
!232 = distinct !{!232, !29}
!233 = distinct !{!233, !29}
!234 = !{i32 1, !124, i32 1, !126, i32 1, !61, i32 1, !134}
!235 = !{i1 false, !236, i1 false, i2 -1}
!236 = !{double 0.000000e+00, double 0x41F32E6660000000}
!237 = distinct !{!237, !29}
!238 = distinct !{!238, !29}
