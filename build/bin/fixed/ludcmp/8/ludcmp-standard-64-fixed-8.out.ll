; ModuleID = './build/bin/fixed/ludcmp/8/ludcmp-standard-64-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !82 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u15_17fixp, 6, !taffo.info !91
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u10_22fixp, i32* noundef %b.u9_23fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u9_23fixp) #0 !taffo.initweight !94 !taffo.funinfo !95 !taffo.sourceFunction !96 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u10_22fixp = load i32, i32* %arrayidx5.u10_22fixp, align 4, !taffo.info !97
  %0 = shl i32 %u10_22fixp, 1, !taffo.info !97
  br label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s20_12fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 12), !taffo.info !100
  %5 = ashr i32 %w.0.s9_23fixp, 11, !taffo.info !97
  %sub.s20_12fixp = sub i32 %5, %mul.s20_12fixp, !taffo.info !103
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s20_12fixp, 11, !taffo.info !103
...
for.end:                                          ; preds = %for.cond6
  ...
  %10 = shl i32 %div.s12_20fixp, 2, !taffo.info !106
  store i32 %10, i32* %arrayidx16.u10_22fixp, align 4, !taffo.info !109
  br label %for.inc17
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u10_22fixp12 = load i32, i32* %arrayidx24.u10_22fixp, align 4, !taffo.info !97
  %11 = shl i32 %u10_22fixp12, 1, !taffo.info !97
  br label %for.cond25
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s20_12fixp = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 12), !taffo.info !100
  %16 = ashr i32 %w.1.s9_23fixp, 11, !taffo.info !97
  %sub33.s20_12fixp = sub i32 %16, %mul32.s20_12fixp, !taffo.info !103
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %17 = shl i32 %sub33.s20_12fixp, 11, !taffo.info !103
...
for.end36:                                        ; preds = %for.cond25
  ...
  %18 = ashr i32 %w.1.s9_23fixp, 1, !taffo.info !97
  store i32 %18, i32* %arrayidx38.u10_22fixp, align 4, !taffo.info !109
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u9_23fixp = load i32, i32* %arrayidx48.u9_23fixp, align 4, !taffo.info !97
  br label %for.cond49

for.cond49:                                       ; preds = %for.inc57, %for.body47
  %j.2 = phi i32 [ 0, %for.body47 ], [ %inc58, %for.inc57 ], !taffo.info !67
  %w.2.s9_23fixp = phi i32 [ %u9_23fixp, %for.body47 ], [ %24, %for.inc57 ], !taffo.info !97
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s19_13fixp = call i32 @llvm.smul.fix.i32(i32 %21, i32 %22, i32 13), !taffo.info !114
  %23 = ashr i32 %w.2.s9_23fixp, 10, !taffo.info !97
  %sub56.s19_13fixp = sub i32 %23, %mul55.s19_13fixp, !taffo.info !117
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !76, !taffo.constinfo !21
  %24 = shl i32 %sub56.s19_13fixp, 10, !taffo.info !117
...
for.end59:                                        ; preds = %for.cond49
  ...
  store i32 %w.2.s9_23fixp, i32* %arrayidx60.u9_23fixp, align 4, !taffo.info !109
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u9_23fixp8 = load i32, i32* %arrayidx68.u9_23fixp, align 4, !taffo.info !97
...
for.cond69:                                       ; preds = %for.inc77, %for.body67
  ...
  %w.3.s9_23fixp = phi i32 [ %u9_23fixp8, %for.body67 ], [ %29, %for.inc77 ], !taffo.info !97
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s13_19fixp = call i32 @llvm.smul.fix.i32(i32 %26, i32 %27, i32 19), !taffo.info !127
  %28 = ashr i32 %w.3.s9_23fixp, 4, !taffo.info !97
  %sub76.s13_19fixp = sub i32 %28, %mul75.s13_19fixp, !taffo.info !130
  br label %for.inc77

for.inc77:                                        ; preds = %for.body71
  %inc78 = add nsw i32 %j.3, 1, !taffo.info !132, !taffo.constinfo !21
  %29 = shl i32 %sub76.s13_19fixp, 4, !taffo.info !130
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s10_22fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 22), !taffo.info !139
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s10_22fixp, 6, !taffo.info !139
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 12), !taffo.info !100
...
!90 = !{double 0x40D019999FE43676, double 1.843200e+04}
...
!102 = !{double 0x3F847AE147AE147C, double 0x4110B28B463B78B0}
!103 = !{!101, !104, i1 false, i2 -1}
!104 = !{double 0xC110B5AB463B78B0, double 1.999900e+02}
!105 = distinct !{!105, !23}
...
!115 = !{!"fixp", i32 -32, i32 13}
!116 = !{double 0.000000e+00, double 0x41007278CFD00C6E}
!117 = !{!115, !118, i1 false, i2 -1}
!118 = !{double 0xC10078B8CFD00C6E, double 2.000000e+02}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
...
!129 = !{double 0xC033D9094AED99C8, double 0x40A056C5CDD0C3A5}
!130 = !{!128, !131, i1 false, i2 -1}
!131 = !{double 0xC0A1E6C5CDD0C3A5, double 0x406B7B21295DB339}
...
!140 = !{!"fixp", i32 -32, i32 22}
!141 = !{double 0xC0036DCA07F66E87, double 0x406FFCF893FAF428}
!142 = distinct !{!142, !23}
