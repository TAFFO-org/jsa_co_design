; ModuleID = './build/bin/fixed/symm/11/symm-standard-512-fixed-11.out.ll'
...
entry:
  ...
  call void @kernel_symm.3_fixp(i32 10, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u24_8fixp, [10 x i32]* %arraydecay12.s20_12fixp, [16 x i32]* %arraydecay13.u11_21fixp), !taffo.info !56, !taffo.constinfo !57
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %m, i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u24_8fixp, [10 x i32]* noundef %A.s20_12fixp, [16 x i32]* noundef %B.u11_21fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !94 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u24_8fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u24_8fixp, i32 %i.0, !taffo.info !120
  %arrayidx7.u24_8fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u24_8fixp, i32 0, i32 %j.0, !taffo.info !120
  %4 = lshr i32 %div.u4_28fixp, 20, !taffo.info !119
  store i32 %4, i32* %arrayidx7.u24_8fixp, align 4, !taffo.info !121
  ...
  %arrayidx13.u11_21fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u11_21fixp, i32 %i.0, !taffo.info !124
  %arrayidx14.u11_21fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx13.u11_21fixp, i32 0, i32 %j.0, !taffo.info !124
  %9 = lshr i32 %div12.u4_28fixp, 7, !taffo.info !119
  store i32 %9, i32* %arrayidx14.u11_21fixp, align 4, !taffo.info !121
  br label %for.inc
...
for.body25:                                       ; preds = %for.cond22
  ...
  %arrayidx31.s20_12fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s20_12fixp, i32 %i.1, !taffo.info !130
  %arrayidx32.s20_12fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx31.s20_12fixp, i32 0, i32 %j.1, !taffo.info !130
  %14 = lshr i32 %div30.u4_28fixp, 16, !taffo.info !119
  store i32 %14, i32* %arrayidx32.s20_12fixp, align 4, !taffo.info !121
  br label %for.inc33
...
for.body40:                                       ; preds = %for.cond37
  %arrayidx41.s20_12fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s20_12fixp, i32 %i.1, !taffo.info !130
  %arrayidx42.s20_12fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx41.s20_12fixp, i32 0, i32 %j.2, !taffo.info !130
  store i32 -4091904, i32* %arrayidx42.s20_12fixp, align 4, !taffo.info !121, !taffo.constinfo !132
  br label %for.inc43
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3_fixp(i32 noundef %m, i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u24_8fixp, [10 x i32]* noundef %A.s20_12fixp, [16 x i32]* noundef %B.u11_21fixp) #0 !taffo.initweight !137 !taffo.funinfo !93 !taffo.sourceFunction !138 {
entry:
...
for.body6:                                        ; preds = %for.cond4
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %4, i32 %3, i32 20), !taffo.info !142
  %mul.u11_21fixp = shl i32 %5, 1, !taffo.info !145
  %6 = uitofp i32 %mul.u11_21fixp to float, !taffo.info !145
  %lampsim6 = bitcast float %6 to i32
  %lampsim7 = and i32 %lampsim6, -8192
  %lampsim8 = bitcast i32 %lampsim7 to float
  %7 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !145
  ...
  %lampsim30 = and i32 %lampsim29, -8192
  %lampsim31 = bitcast i32 %lampsim30 to float
  %12 = fmul float 2.560000e+02, %lampsim31, !taffo.info !149
  %lampsim32 = bitcast float %12 to i32
  %lampsim33 = and i32 %lampsim32, -8192
  ...
  %lampsim36 = and i32 %lampsim35, -8192
  ...
  %lampsim39 = and i32 %lampsim38, -8192
  ...
  %lampsim45 = and i32 %lampsim44, -8192
  ...
  %lampsim49 = and i32 %lampsim48, -8192
  ...
  %lampsim53 = and i32 %lampsim52, -8192
...
for.end:                                          ; preds = %for.cond4
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %20, i32 %19, i32 7), !taffo.info !153
  %mul21.u24_8fixp = shl i32 %21, 1, !taffo.info !156
  %22 = uitofp i32 %mul21.u24_8fixp to float, !taffo.info !156
  %lampsim55 = bitcast float %22 to i32
  %lampsim56 = and i32 %lampsim55, -8192
  %lampsim57 = bitcast i32 %lampsim56 to float
  %23 = fdiv float %lampsim57, 2.560000e+02, !taffo.info !156
  %lampsim58 = bitcast float %23 to i32
  %lampsim59 = and i32 %lampsim58, -8192
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 20), !taffo.info !142
  %mul24.u11_21fixp = shl i32 %27, 1, !taffo.info !145
  %28 = uitofp i32 %mul24.u11_21fixp to float, !taffo.info !145
  %lampsim61 = bitcast float %28 to i32
  %lampsim62 = and i32 %lampsim61, -8192
  %lampsim63 = bitcast i32 %lampsim62 to float
  %29 = fdiv float %lampsim63, 0x4140000000000000, !taffo.info !145
  %lampsim64 = bitcast float %29 to i32
  %lampsim65 = and i32 %lampsim64, -8192
  ...
  %lampsim68 = and i32 %lampsim67, -8192
  ...
  %lampsim71 = and i32 %lampsim70, -8192
  ...
  %lampsim75 = and i32 %lampsim74, -8192
  ...
  %lampsim79 = and i32 %lampsim78, -8192
  %lampsim80 = bitcast i32 %lampsim79 to float
  %mul29.1flp81 = fmul float %lampsim5, %temp2.0.1flp, !taffo.info !159
  %lampsim82 = bitcast float %mul29.1flp81 to i32
  %lampsim83 = and i32 %lampsim82, -8192
  %lampsim84 = bitcast i32 %lampsim83 to float
  %add30.1flp85 = fadd float %lampsim80, %lampsim84, !taffo.info !161
  %lampsim86 = bitcast float %add30.1flp85 to i32
  %lampsim87 = and i32 %lampsim86, -8192
  ...
  %32 = fmul float 2.560000e+02, %lampsim88, !taffo.info !161
  %lampsim89 = bitcast float %32 to i32
  %lampsim90 = and i32 %lampsim89, -8192
  %lampsim91 = bitcast i32 %lampsim90 to float
  %33 = fptoui float %lampsim91 to i32, !taffo.info !161
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !166 !taffo.funinfo !167 !taffo.sourceFunction !168 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 11), !taffo.info !171
  %mul.u20_12fixp = shl i32 %5, 1, !taffo.info !174
  ...
  %7 = shl i32 %mul.u20_12fixp, 9, !taffo.info !174
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u24_8fixp, i32 noundef %factor) #0 !taffo.initweight !166 !taffo.funinfo !178 !taffo.sourceFunction !168 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !179
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s20_12fixp, i32 noundef %factor) #0 !taffo.initweight !166 !taffo.funinfo !184 !taffo.sourceFunction !168 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.s29_3fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 3), !taffo.info !185
  ...
  %5 = shl i32 %mul.s29_3fixp, 9, !taffo.info !185
...
!140 = !{!"float", i32 1, double 0x41C3830000000000}
!141 = !{double 0xC1C3830000000000, double 0x4131FFFFF822BBEC}
!142 = !{!143, !144, i1 false, i2 -1}
!143 = !{!"fixp", i32 -32, i32 20}
!144 = !{double 0x40533333397DD010, double 1.920000e+03}
!145 = !{!54, !144, i1 false, i2 -1}
!146 = !{!147, !148, i1 false, i2 -1}
!147 = !{!"float", i32 1, double 0x41CD448000000000}
!148 = !{double 0xC1CD448000000000, double 0x413AFFFFF43419E3}
!149 = !{!147, !150, i1 false, i2 -1}
!150 = !{double 0xC1CD448000000000, double 0x4168C0451E86833C}
!151 = !{!140, !141, i1 false, i2 -1}
!152 = distinct !{!152, !23}
!153 = !{!154, !155, i1 false, i2 -1}
!154 = !{!"fixp", i32 -32, i32 7}
!155 = !{double 0.000000e+00, double 0x4169A6B959999999}
!156 = !{!48, !155, i1 false, i2 -1}
!157 = !{!147, !158, i1 false, i2 -1}
!158 = !{double 0xC1CD448000000000, double 0x416D06B958201CD5}
!159 = !{!147, !160, i1 false, i2 -1}
!160 = !{double 0xC1CD448000000000, double 0x413AFFFFF43419E2}
!161 = !{!162, !163, i1 false, i2 -1}
!162 = !{!"float", i32 1, double 0x41DD448000000000}
!163 = !{double 0xC1DD448000000000, double 0x4170335CAB535009}
!164 = distinct !{!164, !23}
!165 = distinct !{!165, !23}
!166 = !{i32 -1, i32 -1, i32 3, i32 -1}
!167 = !{i32 1, !16, i32 1, !79, i32 1, !53, i32 1, !89}
!168 = !{void (i32, i32, float*, i32)* @scale_2d}
!169 = !{!170, !90, i1 false, i2 1}
!170 = !{!"fixp", i32 32, i32 22}
!171 = !{!172, !173, i1 false, i2 -1}
!172 = !{!"fixp", i32 -32, i32 11}
!173 = !{double 0x40D99999A1FD156A, double 6.553600e+05}
!174 = !{!175, !173, i1 false, i2 -1}
!175 = !{!"fixp", i32 32, i32 12}
!176 = distinct !{!176, !23}
!177 = distinct !{!177, !23}
!178 = !{i32 1, !16, i32 1, !79, i32 1, !47, i32 1, !89}
!179 = !{!180, !181, i1 false, i2 -1}
!180 = !{!"float", i32 1, double 0x41F5604520000000}
!181 = !{double 0.000000e+00, double 0x41F5604520000000}
!182 = distinct !{!182, !23}
!183 = distinct !{!183, !23}
!184 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !89}
!185 = !{!186, !187, i1 false, i2 -1}
!186 = !{!"fixp", i32 -32, i32 3}
!187 = !{double 0xC1AF380000000000, double 0x411CCCCCC0379314}
!188 = distinct !{!188, !23}
!189 = distinct !{!189, !23}
