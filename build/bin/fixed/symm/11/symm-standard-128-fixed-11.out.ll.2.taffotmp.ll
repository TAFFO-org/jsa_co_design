; ModuleID = './build/bin/fixed/symm/11/symm-standard-128-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 128), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 128), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 128), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
...
!35 = !{double 0.000000e+00, double 0x4125611480000000}
!36 = !{!"C"}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double -1.278720e+05, double 0x406CCCCCC0379314}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 1.280000e+01, double 3.200000e+02}
!41 = !{i32 1}
