; ModuleID = './build/bin/fixed/gemm/8/gemm-standard-32-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [12 x i32]* %arraydecay11.u13_19fixp, [16 x i32]* %arraydecay12.u5_27fixp, [12 x i32]* %arraydecay13.u5_27fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !177 !taffo.funinfo !178 !taffo.sourceFunction !179 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !181
  ...
  %7 = shl i32 %mul.u18_14fixp, 5, !taffo.info !184
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !177 !taffo.funinfo !188 !taffo.sourceFunction !179 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !189
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !192
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !192
...
!178 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
!179 = !{void (i32, i32, float*, i32)* @scale_2d}
!180 = !{!102, !89, i1 false, i2 1}
!181 = !{!182, !183, i1 false, i2 -1}
!182 = !{!"fixp", i32 -32, i32 13}
!183 = !{double 0.000000e+00, double 0x41091EB84007570C}
!184 = !{!185, !183, i1 false, i2 -1}
!185 = !{!"fixp", i32 32, i32 14}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
!188 = !{i32 1, !16, i32 1, !93, i32 1, !50, i32 1, !88}
!189 = !{!190, !191, i1 false, i2 -1}
!190 = !{!"fixp", i32 -32, i32 21}
!191 = !{double 0.000000e+00, double 9.600000e+02}
!192 = !{!193, !191, i1 false, i2 -1}
!193 = !{!"fixp", i32 32, i32 22}
!194 = distinct !{!194, !23}
!195 = distinct !{!195, !23}
