; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-2-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u2_30fixp2 = bitcast [16 x i32]* %arraydecay9.u2_30fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u2_30fixp2, i32 2), !taffo.info !60, !taffo.constinfo !59
  %arraydecay10.u2_30fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u2_30fixp, i32 0, i32 0, !taffo.info !52
  %u2_30fixp3 = bitcast [12 x i32]* %arraydecay10.u2_30fixp to i32*, !taffo.info !52
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u2_30fixp3, i32 2), !taffo.info !61, !taffo.constinfo !59
  ...
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [12 x i32]* %arraydecay11.u5_27fixp, [16 x i32]* %arraydecay12.u2_30fixp, [12 x i32]* %arraydecay13.u2_30fixp), !taffo.info !54, !taffo.constinfo !55
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u5_27fixp, [16 x i32]* noundef %A.u2_30fixp, [12 x i32]* noundef %B.u2_30fixp) #0 !taffo.initweight !88 !taffo.funinfo !89 !taffo.sourceFunction !92 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u5_27fixp = load i32, i32* %arrayidx4.u5_27fixp, align 4, !taffo.info !93
  %0 = lshr i32 %u5_27fixp, 1, !taffo.info !93
  %1 = lshr i32 %beta.u2_30fixp, 1, !taffo.info !45
  %2 = ashr i32 %0, 1, !taffo.info !93
  %3 = ashr i32 %1, 4, !taffo.info !45
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 25), !taffo.info !95
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !98
  %5 = shl i32 %mul.u6_26fixp, 1, !taffo.info !98
...
for.body10:                                       ; preds = %for.cond8
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 28), !taffo.info !100
  %mul13.u3_29fixp = shl i32 %10, 1, !taffo.info !103
  ...
  %u2_30fixp2 = load i32, i32* %arrayidx15.u2_30fixp, align 4, !taffo.info !105
  %11 = lshr i32 %mul13.u3_29fixp, 1, !taffo.info !103
  %12 = lshr i32 %u2_30fixp2, 1, !taffo.info !105
  %13 = ashr i32 %12, 1, !taffo.info !105
  %14 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %13, i32 28), !taffo.info !106
  %mul16.u3_29fixp = shl i32 %14, 1, !taffo.info !108
  ...
  %u5_27fixp1 = load i32, i32* %arrayidx18.u5_27fixp, align 4, !taffo.info !93
  %15 = lshr i32 %u5_27fixp1, 1, !taffo.info !93
  %16 = lshr i32 %mul16.u3_29fixp, 3, !taffo.info !108
  %add.u6_26fixp = add i32 %15, %16, !taffo.info !109
  %17 = shl i32 %add.u6_26fixp, 1, !taffo.info !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u5_27fixp, [16 x i32]* noundef %A.u2_30fixp, [12 x i32]* noundef %B.u2_30fixp) #0 !taffo.initweight !114 !taffo.funinfo !89 !taffo.sourceFunction !115 {
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !54, !taffo.constinfo !116
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !57, !taffo.constinfo !118
  br label %for.cond
...
for.cond:                                         ; preds = %for.inc8, %entry
  ...
  br i1 %cmp, label %for.body, label %for.end10, !taffo.info !126, !taffo.initweight !128

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !121, !taffo.initweight !123
  %cmp4 = icmp slt i32 %j.0, %nj, !taffo.info !124, !taffo.initweight !125
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !126, !taffo.initweight !128

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !129, !taffo.initweight !125
  %add = add nsw i32 %mul, 1, !taffo.info !131, !taffo.initweight !128, !taffo.constinfo !21
  %rem = srem i32 %add, %ni, !taffo.info !133, !taffo.initweight !135
  %conv.u4_28fixp = shl i32 %rem, 28, !taffo.info !136
  %conv6.u4_28fixp = shl i32 %ni, 28, !taffo.info !138
  %0 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !136
  %1 = lshr i32 %conv6.u4_28fixp, 1, !taffo.info !138
  %2 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %1, i32 27), !taffo.info !139
  %div.u1_31fixp = shl i32 %2, 4, !taffo.info !142
  %arrayidx.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u5_27fixp, i32 %i.0, !taffo.info !144
  %arrayidx7.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u5_27fixp, i32 0, i32 %j.0, !taffo.info !144
  %3 = lshr i32 %div.u1_31fixp, 4, !taffo.info !142
  store i32 %3, i32* %arrayidx7.u5_27fixp, align 4, !taffo.info !145
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !146, !taffo.initweight !125, !taffo.constinfo !21
...
for.cond11:                                       ; preds = %for.inc30, %for.end10
  ...
  %cmp12 = icmp slt i32 %i.1, %ni, !taffo.info !124, !taffo.initweight !125
  br i1 %cmp12, label %for.body14, label %for.end32, !taffo.info !126, !taffo.initweight !128

for.body14:                                       ; preds = %for.cond11
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc27, %for.body14
  %j.1 = phi i32 [ 0, %for.body14 ], [ %inc28, %for.inc27 ], !taffo.info !121, !taffo.initweight !123
  %cmp16 = icmp slt i32 %j.1, %nk, !taffo.info !124, !taffo.initweight !125
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.info !126, !taffo.initweight !128

for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !146, !taffo.initweight !125, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !150, !taffo.initweight !125
  %rem21 = srem i32 %mul20, %nk, !taffo.info !152, !taffo.initweight !128
  %conv22.u4_28fixp = shl i32 %rem21, 28, !taffo.info !154
  %conv23.u5_27fixp = shl i32 %nk, 27, !taffo.info !155
  %4 = lshr i32 %conv22.u4_28fixp, 1, !taffo.info !154
  %5 = lshr i32 %conv23.u5_27fixp, 1, !taffo.info !155
  %6 = ashr i32 %4, 1, !taffo.info !154
  %7 = call i32 @llvm.sdiv.fix.i32(i32 %6, i32 %5, i32 26), !taffo.info !156
  %div24.u1_31fixp = shl i32 %7, 5, !taffo.info !159
  %arrayidx25.u2_30fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u2_30fixp, i32 %i.1, !taffo.info !160
  %arrayidx26.u2_30fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u2_30fixp, i32 0, i32 %j.1, !taffo.info !160
  %8 = lshr i32 %div24.u1_31fixp, 1, !taffo.info !159
  store i32 %8, i32* %arrayidx26.u2_30fixp, align 4, !taffo.info !145
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !146, !taffo.initweight !125, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  ...
  br label %for.cond11, !llvm.loop !162

for.end32:                                        ; preds = %for.cond11
  br label %for.cond33

for.cond33:                                       ; preds = %for.inc52, %for.end32
  %i.2 = phi i32 [ 0, %for.end32 ], [ %inc53, %for.inc52 ], !taffo.info !121, !taffo.initweight !123
  %cmp34 = icmp slt i32 %i.2, %nk, !taffo.info !124, !taffo.initweight !125
  br i1 %cmp34, label %for.body36, label %for.end54, !taffo.info !126, !taffo.initweight !128

for.body36:                                       ; preds = %for.cond33
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc49, %for.body36
  %j.2 = phi i32 [ 0, %for.body36 ], [ %inc50, %for.inc49 ], !taffo.info !121, !taffo.initweight !123
  %cmp38 = icmp slt i32 %j.2, %nj, !taffo.info !124, !taffo.initweight !125
  br i1 %cmp38, label %for.body40, label %for.end51, !taffo.info !126, !taffo.initweight !128

for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.info !163, !taffo.initweight !125, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !165, !taffo.initweight !125
  %rem43 = srem i32 %mul42, %nj, !taffo.info !167, !taffo.initweight !128
  %conv44.u4_28fixp = shl i32 %rem43, 28, !taffo.info !168
  %conv45.u4_28fixp = shl i32 %nj, 28, !taffo.info !169
  %9 = lshr i32 %conv44.u4_28fixp, 1, !taffo.info !168
  %10 = lshr i32 %conv45.u4_28fixp, 1, !taffo.info !169
  %11 = call i32 @llvm.sdiv.fix.i32(i32 %9, i32 %10, i32 27), !taffo.info !170
  %div46.u1_31fixp = shl i32 %11, 4, !taffo.info !172
  %arrayidx47.u2_30fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u2_30fixp, i32 %i.2, !taffo.info !173
  %arrayidx48.u2_30fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u2_30fixp, i32 0, i32 %j.2, !taffo.info !173
  %12 = lshr i32 %div46.u1_31fixp, 1, !taffo.info !172
  store i32 %12, i32* %arrayidx48.u2_30fixp, align 4, !taffo.info !145
  br label %for.inc49

for.inc49:                                        ; preds = %for.body40
  %inc50 = add nsw i32 %j.2, 1, !taffo.info !146, !taffo.initweight !125, !taffo.constinfo !21
...
for.inc52:                                        ; preds = %for.end51
  %inc53 = add nsw i32 %i.2, 1, !taffo.info !146, !taffo.initweight !125, !taffo.constinfo !21
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp = load i32, i32* %arrayidx4.u2_30fixp, align 4, !taffo.info !179
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !180
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !179
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !180
  %3 = ashr i32 %1, 1, !taffo.info !179
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 28), !taffo.info !181
  %mul.u3_29fixp = shl i32 %4, 1, !taffo.info !183
  ...
  %6 = shl i32 %mul.u3_29fixp, 1, !taffo.info !183
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !176 !taffo.funinfo !186 !taffo.sourceFunction !178 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u5_27fixp = load i32, i32* %arrayidx4.u5_27fixp, align 4, !taffo.info !93
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !187
  %1 = lshr i32 %u5_27fixp, 1, !taffo.info !93
  %2 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !187
  %3 = ashr i32 %1, 1, !taffo.info !93
  %4 = ashr i32 %2, 4, !taffo.info !187
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 25), !taffo.info !188
  %mul.u6_26fixp = shl i32 %5, 1, !taffo.info !190
  ...
  %7 = shl i32 %mul.u6_26fixp, 1, !taffo.info !190
...
!88 = !{i32 -1, i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
...
!92 = distinct !{null}
!93 = !{!94, !1, i1 false, i2 -1}
!94 = !{!"fixp", i32 32, i32 26}
!95 = !{!96, !97, i1 false, i2 -1}
!96 = !{!"fixp", i32 -32, i32 25}
!97 = !{double 0.000000e+00, double 3.230400e+01}
!98 = !{!94, !97, i1 false, i2 -1}
!99 = distinct !{!99, !23}
!100 = !{!101, !102, i1 false, i2 -1}
!101 = !{!"fixp", i32 -32, i32 28}
!102 = !{double 0.000000e+00, double 2.812500e+00}
!103 = !{!104, !102, i1 false, i2 -1}
!104 = !{!"fixp", i32 32, i32 29}
!105 = !{!104, !53, i1 false, i2 -1}
!106 = !{!101, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 0x40149FFFC115DF66}
!108 = !{!104, !107, i1 false, i2 -1}
!109 = !{!94, !110, i1 false, i2 -1}
!110 = !{double 0.000000e+00, double 0x404009C2877EE4E3}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = !{i32 -1, i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!115 = distinct !{null}
!116 = !{!117, i1 false}
...
!155 = !{!48, !91, i1 false, i2 1}
!156 = !{!157, !158, i1 false, i2 1}
!157 = !{!"fixp", i32 -32, i32 26}
!158 = !{double 0.000000e+00, double 9.375000e-01}
!159 = !{!143, !158, i1 false, i2 1}
!160 = !{!43, !51, i1 false, i2 1}
!161 = distinct !{!161, !23}
!162 = distinct !{!162, !23}
!163 = !{i1 false, !164, i1 false, i2 1}
!164 = !{double 2.000000e+00, double 1.800000e+01}
!165 = !{i1 false, !166, i1 false, i2 1}
!166 = !{double 0.000000e+00, double 2.880000e+02}
!167 = !{i1 false, !64, i1 false, i2 1}
!168 = !{!137, !64, i1 false, i2 1}
!169 = !{!137, !78, i1 false, i2 1}
!170 = !{!140, !171, i1 false, i2 1}
!171 = !{double 0.000000e+00, double 0x3FED555555555555}
!172 = !{!143, !171, i1 false, i2 1}
!173 = !{!43, !53, i1 false, i2 1}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
!176 = !{i32 -1, i32 -1, i32 3, i32 -1}
!177 = !{i32 1, !16, i32 1, !90, i32 1, !50, i32 1, !19}
!178 = !{void (i32, i32, float*, i32)* @scale_2d}
!179 = !{!104, !51, i1 false, i2 -1}
!180 = !{!104, !20, i1 false, i2 1}
!181 = !{!101, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 3.750000e+00}
!183 = !{!104, !182, i1 false, i2 -1}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
!186 = !{i32 1, !16, i32 1, !77, i32 1, !47, i32 1, !19}
!187 = !{!43, !20, i1 false, i2 1}
!188 = !{!96, !189, i1 false, i2 -1}
!189 = !{double 0.000000e+00, double 5.384000e+01}
!190 = !{!94, !189, i1 false, i2 -1}
!191 = distinct !{!191, !23}
!192 = distinct !{!192, !23}
