; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-512-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !141
...
for.body51:                                       ; preds = %for.cond49
  ...
  %29 = fdiv float %28, 3.276800e+04, !taffo.info !198
