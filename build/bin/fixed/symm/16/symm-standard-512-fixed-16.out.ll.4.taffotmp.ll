; ModuleID = './build/bin/fixed/symm/16/symm-standard-512-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 512), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 512), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 512), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 512), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
...
for.end:                                          ; preds = %for.cond4
  ...
  %mul29 = fmul float %alpha, %temp2.0, !taffo.info !127, !taffo.initweight !109
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %m, i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !134 !taffo.funinfo !105 !taffo.sourceFunction !64 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !62, !taffo.initweight !83, !taffo.constinfo !135
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !67, !taffo.initweight !83, !taffo.constinfo !137
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv = sitofp i32 %rem to float, !taffo.info !149, !taffo.initweight !83
  %conv6 = sitofp i32 %m to float, !taffo.info !151
  %div = fdiv float %conv, %conv6, !taffo.info !153, !taffo.initweight !109
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.info !155, !taffo.initweight !68
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !155, !taffo.initweight !68
  store float %div, float* %arrayidx7, align 4, !taffo.info !156, !taffo.initweight !70
  %add8 = add nsw i32 %n, %i.0, !taffo.info !157, !taffo.initweight !68
  ...
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !149, !taffo.initweight !83
  %conv11 = sitofp i32 %m to float, !taffo.info !151
  %div12 = fdiv float %conv10, %conv11, !taffo.info !153, !taffo.initweight !109
  %arrayidx13 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.info !159, !taffo.initweight !68
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.info !159, !taffo.initweight !68
  store float %div12, float* %arrayidx14, align 4, !taffo.info !156, !taffo.initweight !70
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !160, !taffo.initweight !68, !taffo.constinfo !21
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %i.0, 1, !taffo.info !163, !taffo.initweight !68, !taffo.constinfo !21
...
for.body25:                                       ; preds = %for.cond22
  ...
  %conv28 = sitofp i32 %rem27 to float, !taffo.info !149, !taffo.initweight !83
  %conv29 = sitofp i32 %m to float, !taffo.info !151
  %div30 = fdiv float %conv28, %conv29, !taffo.info !153, !taffo.initweight !109
  %arrayidx31 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.info !165, !taffo.initweight !68
  %arrayidx32 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx31, i32 0, i32 %j.1, !taffo.info !165, !taffo.initweight !68
  store float %div30, float* %arrayidx32, align 4, !taffo.info !156, !taffo.initweight !70
  br label %for.inc33

for.inc33:                                        ; preds = %for.body25
  %inc34 = add nsw i32 %j.1, 1, !taffo.info !160, !taffo.initweight !68, !taffo.constinfo !21
  br label %for.cond22, !llvm.loop !166

for.end35:                                        ; preds = %for.cond22
  %add36 = add nsw i32 %i.1, 1, !taffo.info !163, !taffo.initweight !68, !taffo.constinfo !21
  br label %for.cond37
...
for.body40:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.info !165, !taffo.initweight !68
  %arrayidx42 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx41, i32 0, i32 %j.2, !taffo.info !165, !taffo.initweight !68
  store float -9.990000e+02, float* %arrayidx42, align 4, !taffo.info !156, !taffo.initweight !70, !taffo.constinfo !167
  br label %for.inc43

for.inc43:                                        ; preds = %for.body40
  %inc44 = add nsw i32 %j.2, 1, !taffo.info !160, !taffo.initweight !68, !taffo.constinfo !21
...
for.inc46:                                        ; preds = %for.end45
  %inc47 = add nsw i32 %i.1, 1, !taffo.info !163, !taffo.initweight !68, !taffo.constinfo !21
  br label %for.cond18, !llvm.loop !171
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !172 !taffo.funinfo !173 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !172 !taffo.funinfo !181 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !174
  %mul = fmul float %1, %conv, !taffo.info !182, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !172 !taffo.funinfo !187 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !174
  %mul = fmul float %1, %conv, !taffo.info !188, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
...
!52 = !{!"fixp", i32 -32, i32 12}
!53 = !{double -5.114880e+05, double 0x408CCCCCC0379314}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 21}
!56 = !{double 0x40499999A1FD156A, double 1.280000e+03}
...
!103 = !{double 5.120000e+02, double 5.120000e+02}
...
!107 = !{!"float", i32 1, double 0x41C3830000000000}
!108 = !{double 0xC1C3830000000000, double 0x4131FFFFF822BBEC}
!109 = !{i32 5}
!110 = !{i32 6}
!111 = !{i32 7}
!112 = !{!55, !113, i1 false, i2 -1}
!113 = !{double 0x40533333397DD010, double 1.920000e+03}
!114 = !{!115, !116, i1 false, i2 -1}
!115 = !{!"float", i32 1, double 0x41CD448000000000}
!116 = !{double 0xC1CD448000000000, double 0x413AFFFFF43419E3}
!117 = !{!115, !118, i1 false, i2 -1}
!118 = !{double 0xC1CD448000000000, double 0x4168C0451E86833C}
!119 = !{!107, !108, i1 false, i2 -1}
!120 = !{i32 8}
!121 = !{i32 9}
!122 = distinct !{!122, !23}
!123 = !{!49, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4169A6B959999999}
!125 = !{!115, !126, i1 false, i2 -1}
!126 = !{double 0xC1CD448000000000, double 0x416D06B958201CD5}
!127 = !{!115, !128, i1 false, i2 -1}
!128 = !{double 0xC1CD448000000000, double 0x413AFFFFF43419E2}
!129 = !{!130, !131, i1 false, i2 -1}
!130 = !{!"float", i32 1, double 0x41DD448000000000}
!131 = !{double 0xC1DD448000000000, double 0x4170335CAB535009}
!132 = distinct !{!132, !23}
!133 = distinct !{!133, !23}
!134 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!135 = !{!136, i1 false}
!136 = !{i1 false, !44, i1 false, i2 0}
!137 = !{!138, i1 false}
!138 = !{i1 false, !139, i1 false, i2 0}
!139 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!140 = !{i1 false, !78, i1 false, i2 1}
!141 = !{i1 false, !80, i1 false, i2 1}
...
!151 = !{!152, !17, i1 false, i2 1}
!152 = !{!"fixp", i32 32, i32 28}
!153 = !{!152, !154, i1 false, i2 1}
!154 = !{double 0.000000e+00, double 2.600000e+00}
!155 = !{!49, !1, i1 false, i2 1}
!156 = !{i1 false, i1 false, i1 false, i2 1}
!157 = !{i1 false, !158, i1 false, i2 1}
!158 = !{double 1.600000e+01, double 2.600000e+01}
!159 = !{!55, !56, i1 false, i2 1}
!160 = !{i1 false, !161, i1 false, i2 1}
!161 = !{double 1.000000e+00, double 1.700000e+01}
!162 = distinct !{!162, !23}
!163 = !{i1 false, !88, i1 false, i2 1}
!164 = distinct !{!164, !23}
!165 = !{!52, !53, i1 false, i2 1}
!166 = distinct !{!166, !23}
!167 = !{!168, i1 false}
!168 = !{i1 false, !169, i1 false, i2 0}
!169 = !{double -9.990000e+02, double -9.990000e+02}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
!172 = !{i32 -1, i32 -1, i32 3, i32 -1}
!173 = !{i32 1, !16, i32 1, !92, i32 1, !48, i32 1, !102}
!174 = !{!175, !103, i1 false, i2 1}
!175 = !{!"fixp", i32 32, i32 22}
!176 = !{!177, !178, i1 false, i2 -1}
!177 = !{!"float", i32 1, double 0x41F5604520000000}
!178 = !{double 0.000000e+00, double 0x41F5604520000000}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !102}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 -32, i32 3}
!184 = !{double 0xC1AF380000000000, double 0x411CCCCCC0379314}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
!187 = !{i32 1, !16, i32 1, !92, i32 1, !54, i32 1, !102}
!188 = !{!189, !190, i1 false, i2 -1}
!189 = !{!"fixp", i32 32, i32 12}
!190 = !{double 0x40D99999A1FD156A, double 6.553600e+05}
!191 = distinct !{!191, !23}
!192 = distinct !{!192, !23}
