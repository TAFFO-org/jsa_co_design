; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-512-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [53 x i8] c"target('A') scalar(range(68.26667,546.133362) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-1d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [43 x i8] c"scalar(range(102.400002,580.266663) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 512), !taffo.initweight !54, !taffo.target !48, !taffo.info !49, !taffo.originalCall !57, !taffo.constinfo !56
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !53, !taffo.info !51
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 512), !taffo.initweight !54, !taffo.info !51, !taffo.originalCall !57, !taffo.constinfo !56
...
!7 = !{double 0.000000e+00, double 0x408111112018A43C}
...
!50 = !{double 0x405111111F0C34C2, double 0x408111112018A43C}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 0x40599999A1FD156A, double 0x408222222036006D}
!53 = !{i32 1}
!54 = !{i32 2}
...
!103 = !{double 0x40E111111F0C34C2, double 0x411111112018A43C}
!104 = distinct !{!104, !29}
...
!112 = !{double 0x406111111F0C34C2, double 0x409111112018A43C}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x40699999AE924F23, double 0x40999999B024F65A}
!115 = !{i32 8}
!116 = !{i32 9}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double 0x40511105EFBC6B1F, double 0x40811105F0C8D9E9}
!119 = !{i32 10}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x40511105E0000000, double 0x4081110600000000}
!122 = distinct !{!122, !29}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x40699999A1FD156A, double 0x409222222036006D}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0x40733333397DD010, double 0x409B3333305100A4}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0x40599988DB056F36, double 0x408222163DF1452F}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x40599988C0000000, double 0x4082221640000000}
!131 = distinct !{!131, !29}
!132 = distinct !{!132, !29}
!133 = !{i32 1, !88, i32 1, !51, i32 1, !97}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0x40E99999A1FD156A, double 0x411222222036006D}
!136 = distinct !{!136, !29}
