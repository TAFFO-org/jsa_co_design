; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-2-fixed-11.out.ll.4.taffotmp.ll'
...
for.body11:                                       ; preds = %for.cond9
  ...
  store float %1, float* %arrayidx14, align 4, !taffo.info !55, !taffo.target !49
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.7, i32 0, i32 0), double noundef %conv), !taffo.constinfo !69
  br label %for.inc
