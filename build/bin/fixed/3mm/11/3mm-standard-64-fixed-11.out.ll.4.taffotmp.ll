; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-64-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 64), !taffo.info !65, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 64), !taffo.info !72, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 64), !taffo.info !73, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 64), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 64), !taffo.info !75, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 64), !taffo.info !76, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 64), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !70, !taffo.target !59, !taffo.originalCall !71
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !231, !taffo.initweight !234
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !226 !taffo.funinfo !237 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !230
  %mul = fmul float %1, %conv, !taffo.info !238, !taffo.initweight !234
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !226 !taffo.funinfo !242 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !230
  %mul = fmul float %1, %conv, !taffo.info !243, !taffo.initweight !234
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !226 !taffo.funinfo !248 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !230
  %mul = fmul float %1, %conv, !taffo.info !249, !taffo.initweight !234
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
...
!47 = !{double 0.000000e+00, double 0x402555556084A516}
!48 = !{!46, !49, i1 false, i2 -1}
!49 = !{double 0.000000e+00, double 1.120000e+01}
!50 = !{!51, !52, i1 false, i2 -1}
!51 = !{!"fixp", i32 32, i32 22}
!52 = !{double 0.000000e+00, double 0x4080624DE00D1B71}
!53 = !{!46, !54, i1 false, i2 -1}
!54 = !{double 0.000000e+00, double 0x402777778DD616F8}
!55 = !{!46, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 1.152000e+01}
...
!119 = !{double 0.000000e+00, double 0x405DDDDDED8680B8}
!120 = !{i32 8}
!121 = !{!51, !43, i1 false, i2 -1}
!122 = !{!51, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40819999ADBB8F8E}
!124 = distinct !{!124, !23}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = !{!51, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x4060E56051A46275}
!129 = !{!51, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x40849BA5F476340E}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = distinct !{!133, !23}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 32, i32 14}
!136 = !{double 0.000000e+00, double 0x410C6620BAA52758}
!137 = !{!138, !1, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 11}
!139 = !{!138, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x413172475754A4EB}
!141 = distinct !{!141, !23}
!142 = distinct !{!142, !23}
!143 = distinct !{!143, !23}
...
!229 = !{double 6.400000e+01, double 6.400000e+01}
!230 = !{!118, !229, i1 false, i2 1}
!231 = !{!232, !233, i1 false, i2 -1}
!232 = !{!"fixp", i32 32, i32 17}
!233 = !{double 0.000000e+00, double 0x40DBBBBBE0157EED}
!234 = !{i32 9}
!235 = distinct !{!235, !23}
!236 = distinct !{!236, !23}
!237 = !{i32 1, !95, i32 1, !16, i32 1, !45, i32 1, !228}
!238 = !{!51, !239, i1 false, i2 -1}
!239 = !{double 0.000000e+00, double 0x408555556084A516}
!240 = distinct !{!240, !23}
!241 = distinct !{!241, !23}
!242 = !{i32 1, !108, i32 1, !97, i32 1, !50, i32 1, !228}
!243 = !{!244, !245, i1 false, i2 -1}
!244 = !{!"fixp", i32 32, i32 16}
!245 = !{double 0.000000e+00, double 0x40E0624DE00D1B71}
!246 = distinct !{!246, !23}
!247 = distinct !{!247, !23}
!248 = !{i32 1, !95, i32 1, !97, i32 1, !57, i32 1, !228}
!249 = !{!250, !251, i1 false, i2 -1}
!250 = !{!"fixp", i32 32, i32 6}
!251 = !{double 0.000000e+00, double 0x418BCB0680000000}
!252 = distinct !{!252, !23}
!253 = distinct !{!253, !23}
