; ModuleID = './build/bin/fixed/heat-3d/11/heat-3d-standard-8-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [44 x i8] c"target('A') scalar(range(16.0,208.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [20 x i8] c"./sources/heat-3d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [32 x i8] c"scalar(range(16.0,208.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 8), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
  ...
  call void @scale_3d.4(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 8), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!7 = !{double 0.000000e+00, double 2.080000e+02}
...
!50 = !{double 1.600000e+01, double 2.080000e+02}
!51 = !{i32 1}
!52 = !{i32 2}
...
!122 = !{double 3.200000e+01, double 4.160000e+02}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double -4.000000e+02, double 1.760000e+02}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double -3.840000e+02, double 3.840000e+02}
!127 = !{i32 10}
!128 = !{i1 false, !129, i1 false, i2 -1}
!129 = !{double -4.800000e+01, double 4.800000e+01}
!130 = !{i32 11}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -9.600000e+01, double 9.600000e+01}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -1.440000e+02, double 1.440000e+02}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -1.280000e+02, double 3.520000e+02}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
