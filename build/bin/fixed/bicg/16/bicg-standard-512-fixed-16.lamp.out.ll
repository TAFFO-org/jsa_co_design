; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-512-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u21_11fixp = load i32, i32* %arrayidx.u21_11fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u21_11fixp to float, !taffo.info !47, !taffo.target !49
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u21_11fixp1 = load i32, i32* %arrayidx25.u21_11fixp, align 4, !taffo.info !50, !taffo.target !51
  %2 = uitofp i32 %u21_11fixp1 to float, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u21_11fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !87 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim7 = and i32 %lampsim6, -256
  %lampsim8 = bitcast i32 %lampsim7 to float
  %3 = fdiv float %lampsim8, 0x4150000000000000, !taffo.info !91
  %lampsim9 = bitcast float %3 to i32
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !93
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !97 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !98
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !101
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !52
  %5 = shl i32 %mul.u18_14fixp, 9, !taffo.info !101
...
!94 = !{!"float", i32 1, double 0x41CB5D1760000000}
!95 = !{double 0.000000e+00, double 0x41CB5D1760000000}
!96 = distinct !{!96, !25}
!97 = !{i32 1, !75, i32 1, !52, i32 1, !88}
!98 = !{!99, !100, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 13}
!100 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!101 = !{!102, !100, i1 false, i2 -1}
!102 = !{!"fixp", i32 32, i32 14}
!103 = distinct !{!103, !25}
