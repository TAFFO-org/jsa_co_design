; ModuleID = './build/bin/fixed/2mm/8/2mm-standard-8-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !222 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !223
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !225
  %5 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %6 = shl i32 %mul.u6_26fixp, 3, !taffo.info !225
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !228 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 14), !taffo.info !229
  %mul.u17_15fixp = shl i32 %5, 1, !taffo.info !232
  ...
  %7 = shl i32 %mul.u17_15fixp, 3, !taffo.info !232
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !210 !taffo.funinfo !236 !taffo.sourceFunction !212 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !237
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !240
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u12_20fixp, 3, !taffo.info !240
...
!220 = distinct !{!220, !23}
!221 = distinct !{!221, !23}
!222 = !{i32 1, !87, i32 1, !102, i32 1, !50, i32 1, !87}
!223 = !{!217, !224, i1 false, i2 -1}
!224 = !{double 0.000000e+00, double 5.600000e+01}
!225 = !{!214, !224, i1 false, i2 -1}
!226 = distinct !{!226, !23}
!227 = distinct !{!227, !23}
!228 = !{i32 1, !87, i32 1, !89, i32 1, !58, i32 1, !87}
!229 = !{!230, !231, i1 false, i2 -1}
!230 = !{!"fixp", i32 -32, i32 14}
!231 = !{double 0.000000e+00, double 0x40F32E6660029F17}
!232 = !{!233, !231, i1 false, i2 -1}
!233 = !{!"fixp", i32 32, i32 15}
!234 = distinct !{!234, !23}
!235 = distinct !{!235, !23}
!236 = !{i32 1, !87, i32 1, !16, i32 1, !47, i32 1, !87}
!237 = !{!238, !239, i1 false, i2 -1}
!238 = !{!"fixp", i32 -32, i32 19}
!239 = !{double 0.000000e+00, double 0x40A2733320535C9E}
!240 = !{!241, !239, i1 false, i2 -1}
!241 = !{!"fixp", i32 32, i32 20}
!242 = distinct !{!242, !23}
!243 = distinct !{!243, !23}
