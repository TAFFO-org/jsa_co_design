; ModuleID = './build/bin/fixed/3mm/8/3mm-standard-8-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u2_30fixp = bitcast [8 x i32]* %arraydecay16.u2_30fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u2_30fixp, i32 8), !taffo.info !63, !taffo.constinfo !61
  ...
  %u2_30fixp3 = bitcast [14 x i32]* %arraydecay18.u2_30fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u2_30fixp3, i32 8), !taffo.info !65, !taffo.constinfo !61
  %arraydecay19.u2_30fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u2_30fixp, i32 0, i32 0, !taffo.info !54
  %u2_30fixp2 = bitcast [12 x i32]* %arraydecay19.u2_30fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u2_30fixp2, i32 8), !taffo.info !66, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !225 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !227
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !49
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !227
  %3 = ashr i32 %1, 3, !taffo.info !49
  %4 = ashr i32 %2, 3, !taffo.info !227
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 24), !taffo.info !228
  %mul.u7_25fixp = shl i32 %5, 1, !taffo.info !231
  ...
  %7 = shl i32 %mul.u7_25fixp, 3, !taffo.info !231
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !235 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp = load i32, i32* %arrayidx4.u2_30fixp, align 4, !taffo.info !236
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !227
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !236
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !227
  %3 = ashr i32 %1, 2, !taffo.info !236
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 27), !taffo.info !237
  %mul.u4_28fixp = shl i32 %4, 1, !taffo.info !239
  ...
  %6 = shl i32 %mul.u4_28fixp, 2, !taffo.info !239
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !242 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 7, !taffo.info !227
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 20), !taffo.info !243
  %mul.u11_21fixp = shl i32 %5, 1, !taffo.info !246
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u11_21fixp, 3, !taffo.info !246
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !250 !taffo.sourceFunction !226 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !251
  %1 = lshr i32 %u3_29fixp, 1, !taffo.info !41
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !251
  %3 = ashr i32 %1, 3, !taffo.info !41
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !252
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !254
  %5 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %6 = shl i32 %mul.u6_26fixp, 3, !taffo.info !254
...
!225 = !{i32 1, !96, i32 1, !85, i32 1, !49, i32 1, !96}
!226 = !{void (i32, i32, float*, i32)* @scale_2d}
!227 = !{!50, !97, i1 false, i2 1}
!228 = !{!229, !230, i1 false, i2 -1}
!229 = !{!"fixp", i32 -32, i32 24}
!230 = !{double 0.000000e+00, double 6.553600e+01}
!231 = !{!232, !230, i1 false, i2 -1}
!232 = !{!"fixp", i32 32, i32 25}
!233 = distinct !{!233, !23}
!234 = distinct !{!234, !23}
!235 = !{i32 1, !83, i32 1, !16, i32 1, !44, i32 1, !96}
!236 = !{!50, !46, i1 false, i2 -1}
!237 = !{!104, !238, i1 false, i2 -1}
!238 = !{double 0.000000e+00, double 0x40255554FBDAD752}
!239 = !{!50, !238, i1 false, i2 -1}
!240 = distinct !{!240, !23}
!241 = distinct !{!241, !23}
!242 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !96}
!243 = !{!244, !245, i1 false, i2 -1}
!244 = !{!"fixp", i32 -32, i32 20}
!245 = !{double 0.000000e+00, double 0x409BCB067F0AA21A}
!246 = !{!247, !245, i1 false, i2 -1}
!247 = !{!"fixp", i32 32, i32 21}
!248 = distinct !{!248, !23}
!249 = distinct !{!249, !23}
!250 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !96}
!251 = !{!122, !97, i1 false, i2 1}
!252 = !{!124, !253, i1 false, i2 -1}
!253 = !{double 0.000000e+00, double 0x404BBBBBE878FABE}
!254 = !{!122, !253, i1 false, i2 -1}
!255 = distinct !{!255, !23}
!256 = distinct !{!256, !23}
