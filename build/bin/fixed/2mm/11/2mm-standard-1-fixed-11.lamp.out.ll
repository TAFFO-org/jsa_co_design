; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-1-fixed-11.out.ll'
...
for.body19:                                       ; preds = %for.cond17
  ...
  %1 = fdiv float %lampsim2, 0x41A0000000000000, !taffo.info !43, !taffo.target !45
  ...
  store float %lampsim5, float* %arrayidx22, align 4, !taffo.info !55, !taffo.target !45
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !62
  br label %for.inc
