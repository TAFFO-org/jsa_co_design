; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-2-fixed-11.out.ll'
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u5_27fixp1 = load i32, i32* %arrayidx25.u5_27fixp, align 4, !taffo.info !50, !taffo.target !51
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !87 !taffo.sourceFunction !88 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u5_27fixp = load i32, i32* %arrayidx.u5_27fixp, align 4, !taffo.info !89
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !91
  %0 = lshr i32 %u5_27fixp, 1, !taffo.info !89
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !91
  %2 = ashr i32 %0, 1, !taffo.info !89
  %3 = ashr i32 %1, 4, !taffo.info !91
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 25), !taffo.info !92
  ...
  %5 = shl i32 %mul.u6_26fixp, 1, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !97 !taffo.sourceFunction !88 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u2_30fixp = load i32, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !98
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !100
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !98
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !100
  %2 = ashr i32 %0, 1, !taffo.info !98
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 28), !taffo.info !101
  %mul.u3_29fixp = shl i32 %3, 1, !taffo.info !104
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !52
  %4 = shl i32 %mul.u3_29fixp, 1, !taffo.info !104
...
for.body7:                                        ; preds = %for.cond5
  ...
  %u5_27fixp = load i32, i32* %arrayidx8.u5_27fixp, align 4, !taffo.info !89
  ...
  %5 = lshr i32 %u5_27fixp, 1, !taffo.info !89
  ...
  %u2_30fixp = load i32, i32* %arrayidx16.u2_30fixp, align 4, !taffo.info !98
  %8 = lshr i32 %u2_30fixp4, 1, !taffo.info !112
  %9 = lshr i32 %u2_30fixp, 1, !taffo.info !98
  %10 = ashr i32 %8, 3, !taffo.info !112
  %11 = ashr i32 %9, 3, !taffo.info !98
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !100
  %3 = ashr i32 %1, 1, !taffo.info !112
...
!110 = !{!81, i1 false}
!111 = distinct !{!111, !25}
!112 = !{!99, !46, i1 false, i2 -1}
!113 = !{!102, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 0x400D2832F576C918}
!115 = !{!99, !114, i1 false, i2 -1}
!116 = !{!90, !117, i1 false, i2 -1}
...
!165 = !{!102, !166, i1 false, i2 -1}
!166 = !{double 0.000000e+00, double 0x400E8BA301216830}
!167 = !{!99, !166, i1 false, i2 -1}
!168 = distinct !{!168, !25}
!169 = distinct !{!169, !25}
