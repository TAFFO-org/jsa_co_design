; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-2-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %2, 0x41C0000000000000, !taffo.info !65
  %arrayidx38 = getelementptr inbounds [20 x float], [20 x float]* @x_float, i32 0, i32 %i.0, !taffo.info !0
  store float %3, float* %arrayidx38, align 4, !taffo.info !83
  ...
  %5 = fdiv float %4, 0x4170000000000000, !taffo.info !62, !taffo.target !64
  %arrayidx40 = getelementptr inbounds [20 x float], [20 x float]* @w_float, i32 0, i32 %i.0, !taffo.info !2
  store float %5, float* %arrayidx40, align 4, !taffo.info !82, !taffo.target !64
  br label %for.cond41
...
for.body43:                                       ; preds = %for.cond41
  ...
  %7 = fdiv float %6, 0x41D0000000000000, !taffo.info !52
  ...
  store float %7, float* %arrayidx47, align 4, !taffo.info !75
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.15, i32 0, i32 0), double noundef %conv), !taffo.constinfo !78
  br label %for.inc
...
if.end19:                                         ; preds = %if.then17, %for.body13
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %4, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.15, i32 0, i32 0), double noundef %conv21), !taffo.constinfo !78
  br label %for.inc23
...
if.end35:                                         ; preds = %if.then33, %for.body29
  ...
  %call38 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %7, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.15, i32 0, i32 0), double noundef %conv37), !taffo.constinfo !78
  br label %for.inc39
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp7 = load i32, i32* %arrayidx4.u2_30fixp, align 4, !taffo.info !151
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 28), !taffo.info !152
  %mul.u3_29fixp = shl i32 %4, 1, !taffo.info !154
  %5 = lshr i32 %u2_30fixp7, 1, !taffo.info !151
  %add.u3_29fixp = add i32 %5, %mul.u3_29fixp, !taffo.info !155
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 28), !taffo.info !157
  %mul9.u3_29fixp = shl i32 %10, 1, !taffo.info !159
  %add10.u3_29fixp = add i32 %add.u3_29fixp, %mul9.u3_29fixp, !taffo.info !160
  ...
  %11 = shl i32 %add10.u3_29fixp, 1, !taffo.info !160
...
for.body21:                                       ; preds = %for.cond19
  ...
  %u2_30fixp8 = load i32, i32* %arrayidx24.u2_30fixp, align 4, !taffo.info !151
  %12 = lshr i32 %beta.u3_29fixp, 1, !taffo.info !88
  %13 = lshr i32 %u2_30fixp8, 1, !taffo.info !151
  %14 = ashr i32 %13, 1, !taffo.info !151
  %15 = call i32 @llvm.smul.fix.i32(i32 %12, i32 %14, i32 28), !taffo.info !164
  %mul25.u3_29fixp = shl i32 %15, 1, !taffo.info !166
  ...
  %16 = lshr i32 %mul25.u3_29fixp, 1, !taffo.info !166
  %17 = lshr i32 %u1_31fixp5, 1, !taffo.info !67
  %18 = ashr i32 %17, 2, !taffo.info !67
  %19 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %18, i32 28), !taffo.info !167
  %mul27.u3_29fixp = shl i32 %19, 1, !taffo.info !169
  %add28.u3_29fixp = add i32 %u3_29fixp, %mul27.u3_29fixp, !taffo.info !170
...
for.body38:                                       ; preds = %for.cond36
  ...
  %u1_31fixp6 = load i32, i32* %arrayidx40.u1_31fixp, align 4, !taffo.info !174
  %20 = lshr i32 %u1_31fixp6, 2, !taffo.info !174
  %add41.u3_29fixp = add i32 %u3_29fixp3, %20, !taffo.info !175
...
for.inc43:                                        ; preds = %for.body38
  ...
  br label %for.cond36, !llvm.loop !177
...
for.body51:                                       ; preds = %for.cond49
  ...
  %u2_30fixp9 = load i32, i32* %arrayidx54.u2_30fixp, align 4, !taffo.info !151
  %21 = lshr i32 %alpha.u3_29fixp, 1, !taffo.info !87
  %22 = lshr i32 %u2_30fixp9, 1, !taffo.info !151
  %23 = ashr i32 %21, 2, !taffo.info !87
  %24 = ashr i32 %22, 3, !taffo.info !151
  %25 = call i32 @llvm.smul.fix.i32(i32 %23, i32 %24, i32 26), !taffo.info !178
  %mul55.u5_27fixp = shl i32 %25, 1, !taffo.info !181
  %arrayidx56.u3_29fixp = getelementptr inbounds i32, i32* %x.u3_29fixp, i32 %j.2, !taffo.info !65
  %u3_29fixp4 = load i32, i32* %arrayidx56.u3_29fixp, align 4, !taffo.info !183
  %26 = lshr i32 %mul55.u5_27fixp, 1, !taffo.info !181
  %27 = lshr i32 %u3_29fixp4, 1, !taffo.info !183
  %28 = ashr i32 %27, 2, !taffo.info !183
  %29 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %28, i32 26), !taffo.info !184
  %mul57.u5_27fixp = shl i32 %29, 1, !taffo.info !186
  %30 = lshr i32 %mul57.u5_27fixp, 3, !taffo.info !186
  %add58.u8_24fixp = add i32 %u8_24fixp, %30, !taffo.info !187
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u2_30fixp = load i32, i32* %arrayidx4.u2_30fixp, align 4, !taffo.info !151
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !119
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !151
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !119
  %3 = ashr i32 %1, 1, !taffo.info !151
...
!147 = distinct !{!147, !27}
!148 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!149 = !{i32 1, !102, i32 1, !87, i32 1, !88, i32 1, !52, i32 1, !53, i32 1, !55, i32 1, !58, i32 1, !60, i32 1, !62, i32 1, !65, i32 1, !67, i32 1, !69}
!150 = distinct !{null}
!151 = !{!66, !5, i1 false, i2 -1}
!152 = !{!121, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x3FEE666666666666}
!154 = !{!66, !153, i1 false, i2 -1}
!155 = !{!66, !156, i1 false, i2 -1}
!156 = !{double 0.000000e+00, double 3.612500e+00}
!157 = !{!121, !158, i1 false, i2 -1}
!158 = !{double 0x3F4B4EA57F80E9A0, double 3.333330e-01}
!159 = !{!66, !158, i1 false, i2 -1}
!160 = !{!66, !161, i1 false, i2 -1}
!161 = !{double 0x3F4B4EA57F80E9A0, double 0x400F9110E453D20F}
!162 = distinct !{!162, !27}
!163 = distinct !{!163, !27}
!164 = !{!121, !165, i1 false, i2 -1}
!165 = !{double 0.000000e+00, double 3.195000e+00}
!166 = !{!66, !165, i1 false, i2 -1}
!167 = !{!121, !168, i1 false, i2 -1}
!168 = !{double 0.000000e+00, double 7.987500e-01}
!169 = !{!66, !168, i1 false, i2 -1}
!170 = !{!66, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 6.350000e+00}
!172 = distinct !{!172, !27}
!173 = distinct !{!173, !27}
!174 = !{!66, !70, i1 false, i2 -1}
!175 = !{!66, !176, i1 false, i2 -1}
!176 = !{double 1.111100e-02, double 0x401718090B417CA2}
!177 = distinct !{!177, !27}
!178 = !{!179, !180, i1 false, i2 -1}
!179 = !{!"fixp", i32 -32, i32 26}
!180 = !{double 0.000000e+00, double 0x400FF33333333334}
!181 = !{!182, !180, i1 false, i2 -1}
!182 = !{!"fixp", i32 32, i32 27}
!183 = !{!182, !1, i1 false, i2 -1}
!184 = !{!179, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 0x40362B9916872B02}
!186 = !{!182, !185, i1 false, i2 -1}
!187 = !{!63, !188, i1 false, i2 -1}
...
!266 = !{!182, !265, i1 false, i2 -1}
!267 = !{!179, !153, i1 false, i2 -1}
!268 = !{!56, !153, i1 false, i2 -1}
