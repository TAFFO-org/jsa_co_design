; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-512-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u9_23fixp2 = bitcast [16 x i32]* %arraydecay12.u9_23fixp to i32*, !taffo.info !48
  ...
  %u9_23fixp = bitcast [16 x i32]* %arraydecay13.u9_23fixp to i32*, !taffo.info !48
  ...
  call void @kernel_gesummv.5_fixp(i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay17.u9_23fixp, [16 x i32]* %arraydecay18.u9_23fixp, i32* %arraydecay19.u21_11fixp, i32* %arraydecay20.u9_23fixp, i32* %arraydecay21.u22_10fixp), !taffo.info !57, !taffo.constinfo !58
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 1.024000e+03, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u21_11fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !92
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u22_10fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !96 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 1.024000e+03, !taffo.info !54
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !90
  %2 = uitofp i32 %conv.u10_22fixp to float, !taffo.info !90
  %3 = fdiv float %2, 0x4150000000000000, !taffo.info !90
  ...
  %4 = fmul float 1.024000e+03, %mul.1flp, !taffo.info !97
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !101 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !102
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !105
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !48
  %5 = shl i32 %mul.u18_14fixp, 9, !taffo.info !105
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u9_23fixp, [16 x i32]* noundef %B.u9_23fixp, i32* noundef %x.u9_23fixp, i32* noundef %tmp.u21_11fixp, i32* noundef %y.u22_10fixp) #0 !taffo.initweight !108 !taffo.funinfo !109 !taffo.sourceFunction !110 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx.u9_23fixp = getelementptr inbounds i32, i32* %x.u9_23fixp, i32 %i.0, !taffo.info !134
  %4 = lshr i32 %div.u1_31fixp, 8, !taffo.info !132
  store i32 %4, i32* %arrayidx.u9_23fixp, align 4, !taffo.info !135
  %arrayidx4.u22_10fixp = getelementptr inbounds i32, i32* %y.u22_10fixp, i32 %i.0, !taffo.info !136
  store i32 0, i32* %arrayidx4.u22_10fixp, align 4, !taffo.info !135, !taffo.constinfo !137
  %arrayidx5.u21_11fixp = getelementptr inbounds i32, i32* %tmp.u21_11fixp, i32 %i.0, !taffo.info !138
  store i32 0, i32* %arrayidx5.u21_11fixp, align 4, !taffo.info !135, !taffo.constinfo !137
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx14.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u9_23fixp, i32 %i.0, !taffo.info !134
  %arrayidx15.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx14.u9_23fixp, i32 0, i32 %j.0, !taffo.info !134
  %9 = lshr i32 %div13.u1_31fixp, 8, !taffo.info !132
  store i32 %9, i32* %arrayidx15.u9_23fixp, align 4, !taffo.info !135
  ...
  %arrayidx22.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u9_23fixp, i32 %i.0, !taffo.info !134
  %arrayidx23.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx22.u9_23fixp, i32 0, i32 %j.0, !taffo.info !134
  %14 = lshr i32 %div21.u1_31fixp, 8, !taffo.info !132
  store i32 %14, i32* %arrayidx23.u9_23fixp, align 4, !taffo.info !135
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv.5_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u9_23fixp, [16 x i32]* noundef %B.u9_23fixp, i32* noundef %tmp.u21_11fixp, i32* noundef %x.u9_23fixp, i32* noundef %y.u22_10fixp) #0 !taffo.initweight !149 !taffo.funinfo !150 !taffo.sourceFunction !151 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 0, i32* %arrayidx.u21_11fixp, align 4, !taffo.info !135, !taffo.constinfo !137
  %arrayidx1.u22_10fixp = getelementptr inbounds i32, i32* %y.u22_10fixp, i32 %i.0, !taffo.info !54
  store i32 0, i32* %arrayidx1.u22_10fixp, align 4, !taffo.info !135, !taffo.constinfo !137
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !154
  ...
  %5 = lshr i32 %mul.u18_14fixp, 3, !taffo.info !154
  %add.u21_11fixp = add i32 %5, %u21_11fixp, !taffo.info !155
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 13), !taffo.info !152
  %mul13.u18_14fixp = shl i32 %10, 1, !taffo.info !154
  ...
  %11 = lshr i32 %mul13.u18_14fixp, 4, !taffo.info !154
  %add15.u22_10fixp = add i32 %11, %u22_10fixp, !taffo.info !157
...
for.end:                                          ; preds = %for.cond2
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 8), !taffo.info !160
  %mul18.u23_9fixp = shl i32 %16, 1, !taffo.info !163
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 8), !taffo.info !165
  %mul20.u23_9fixp = shl i32 %21, 1, !taffo.info !167
  %add21.u23_9fixp = add i32 %mul18.u23_9fixp, %mul20.u23_9fixp, !taffo.info !168
  %arrayidx22.u22_10fixp = getelementptr inbounds i32, i32* %y.u22_10fixp, i32 %i.0, !taffo.info !54
  %22 = shl i32 %add21.u23_9fixp, 1, !taffo.info !168
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !102
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !105
  ...
  %7 = shl i32 %mul.u18_14fixp, 9, !taffo.info !105
...
!93 = !{!"float", i32 1, double 0x41C1A00000000000}
!94 = !{double 0.000000e+00, double 0x41C1A00000000000}
!95 = distinct !{!95, !23}
!96 = !{i32 1, !75, i32 1, !54, i32 1, !84}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"float", i32 1, double 0x41D6A66680000000}
!99 = !{double 0.000000e+00, double 0x41D6A66680000000}
!100 = distinct !{!100, !23}
!101 = !{i32 1, !75, i32 1, !48, i32 1, !84}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 -32, i32 13}
!104 = !{double 0.000000e+00, double 2.457600e+05}
...
!153 = !{double 0.000000e+00, double 2.304000e+05}
!154 = !{!106, !153, i1 false, i2 -1}
!155 = !{!52, !156, i1 false, i2 -1}
!156 = !{double 0.000000e+00, double 0x4135240000000000}
!157 = !{!55, !158, i1 false, i2 -1}
!158 = !{double 0.000000e+00, double 0x4148686680000000}
!159 = distinct !{!159, !23}
!160 = !{!161, !162, i1 false, i2 -1}
!161 = !{!"fixp", i32 -32, i32 8}
!162 = !{double 0.000000e+00, double 0x413A700000000000}
!163 = !{!164, !162, i1 false, i2 -1}
!164 = !{!"fixp", i32 32, i32 9}
!165 = !{!161, !166, i1 false, i2 -1}
!166 = !{double 0.000000e+00, double 0x414B2E1499999999}
!167 = !{!164, !166, i1 false, i2 -1}
!168 = !{!164, !169, i1 false, i2 -1}
!169 = !{double 0.000000e+00, double 0x4154330A4CCCCCCC}
!170 = distinct !{!170, !23}
