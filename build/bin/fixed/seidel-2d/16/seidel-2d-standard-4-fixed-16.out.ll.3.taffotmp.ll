; ModuleID = './build/bin/fixed/seidel-2d/16/seidel-2d-standard-4-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [47 x i8] c"target('A') scalar(range(0.4,80.199997) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 4), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !141, !taffo.info !113
...
!5 = !{double 0.000000e+00, double 0x40540CCCC0379314}
...
!50 = !{double 4.000000e-01, double 0x40540CCCC0379314}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 8.000000e-01, double 0x40640CCCC0379314}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x3FF3333333333334, double 0x406E133320535C9E}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 1.600000e+00, double 0x40740CCCC0379314}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 2.000000e+00, double 0x40790FFFF04577D9}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 3.600000e+00, double 0x40868E66583E8576}
