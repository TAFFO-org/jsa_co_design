; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-16-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 16), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 16), !taffo.info !67, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.info !48, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 16), !taffo.info !68, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 16), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !69, !taffo.target !53, !taffo.originalCall !70
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !54, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 16), !taffo.info !72, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
...
for.cond69:                                       ; preds = %for.inc77, %for.body67
  ...
  %w.3 = phi float [ %10, %for.body67 ], [ %sub76, %for.inc77 ], !taffo.info !143, !taffo.initweight !45
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75 = fmul float %11, %12, !taffo.info !145, !taffo.initweight !103
...
!47 = !{double 1.600000e+01, double 0x40605851E108C3F4}
!48 = !{!49, !50, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 25}
!50 = !{double 0x40501999A1FD156A, double 7.200000e+01}
!51 = !{!52, !1, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 28}
!53 = !{!"x"}
!54 = !{!49, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x40501999A1FD156A}
...
!102 = !{double 0x40901999A1FD156A, double 1.152000e+03}
!103 = !{i32 7}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !85, i32 1, !51, i32 1, !94}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 24}
!108 = !{double -6.071520e-01, double 0x404FFCF893FAF428}
!109 = distinct !{!109, !23}
...
!116 = !{!"fixp", i32 -32, i32 16}
!117 = !{double 0x3F847AE147AE147C, double 0x40D0B28B485FEB29}
!118 = !{i32 8}
!119 = !{!116, !120, i1 false, i2 -1}
!120 = !{double 0xC0D0E48B485FEB29, double 1.999900e+02}
!121 = distinct !{!121, !23}
...
!132 = !{double 0.000000e+00, double 0x40C07278D3029BE1}
!133 = !{!131, !134, i1 false, i2 -1}
!134 = !{double 0xC0C0D678D3029BE1, double 2.000000e+02}
!135 = distinct !{!135, !23}
!136 = distinct !{!136, !23}
...
!143 = !{!144, !114, i1 false, i2 -1}
!144 = !{!"fixp", i32 -32, i32 21}
!145 = !{!144, !146, i1 false, i2 -1}
!146 = !{double 0xC013D9094C33901E, double 0x408056C5CEDD19B7}
!147 = !{!144, !148, i1 false, i2 -1}
!148 = !{double 0xC08696C5CEDD19B7, double 0x40699EC84A619C81}
...
!209 = !{!"fixp", i32 32, i32 17}
!210 = !{!209, !211, i1 false, i2 -1}
!211 = !{double 1.601000e+01, double 0x40D0D33BEC21FCB1}
!212 = distinct !{!212, !23}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = distinct !{!215, !23}
...
!220 = !{!"fixp", i32 32, i32 20}
!221 = !{double 1.600000e+00, double 0x40A05851E108C3F4}
!222 = !{i32 9}
!223 = distinct !{!223, !23}
!224 = distinct !{!224, !23}
