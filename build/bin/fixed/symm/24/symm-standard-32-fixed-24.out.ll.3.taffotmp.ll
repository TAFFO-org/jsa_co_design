; ModuleID = './build/bin/fixed/symm/24/symm-standard-32-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [50 x i8] c"target('C') scalar(range(0.0,43810.558594) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [40 x i8] c"scalar(range(-31968.0,57.599998) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(3.2,80.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.initweight !59, !taffo.info !49, !taffo.originalCall !62, !taffo.constinfo !63
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 32), !taffo.initweight !59, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 32), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x40E56451E0008638}
...
!56 = !{double -3.196800e+04, double 0x404CCCCCBC05D52C}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 3.200000e+00, double 8.000000e+01}
!59 = !{i32 1}
...
!121 = !{double 3.200000e+01, double 3.200000e+01}
...
!126 = !{double -2.557440e+06, double 0x40B1FFFFF583A53C}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4013333333333334, double 1.200000e+02}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -3.836160e+06, double 0x40BAFFFFF04577D9}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -3.836160e+06, double 0x40E8C451DE093533}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x40E9AB957333D443}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double -3.836160e+06, double 0x40ED0B95713C833E}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double -3.836160e+06, double 0x40BAFFFFF04577DA}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double -7.672320e+06, double 0x40F035CAB7A2991D}
!147 = distinct !{!147, !29}
!148 = distinct !{!148, !29}
...
!174 = !{double 0.000000e+00, double 0x41356451E0008638}
!175 = distinct !{!175, !29}
!176 = distinct !{!176, !29}
!177 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !120}
!178 = !{i1 false, !179, i1 false, i2 -1}
!179 = !{double 0xC12F380000000000, double 0x409CCCCCBC05D52C}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
!182 = !{i32 1, !22, i32 1, !110, i32 1, !57, i32 1, !120}
!183 = !{i1 false, !184, i1 false, i2 -1}
!184 = !{double 1.024000e+02, double 2.560000e+03}
!185 = distinct !{!185, !29}
!186 = distinct !{!186, !29}
