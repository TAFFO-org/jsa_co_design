; ModuleID = './build/bin/fixed/seidel-2d/11/seidel-2d-standard-16-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [48 x i8] c"target('A') scalar(range(1.6,320.799988) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 16), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40740CCCC0379314}
...
!50 = !{double 1.600000e+00, double 0x40740CCCC0379314}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 3.200000e+00, double 0x40840CCCC0379314}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x4013333333333334, double 0x408E133320535C9E}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 6.400000e+00, double 0x40940CCCC0379314}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 8.000000e+00, double 0x40990FFFF04577D9}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 1.440000e+01, double 0x40A68E66583E8576}
...
!140 = !{double 1.600000e+01, double 1.600000e+01}
!141 = !{i32 9}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 2.560000e+01, double 0x40B40CCCC0379314}
!144 = distinct !{!144, !29}
!145 = distinct !{!145, !29}
