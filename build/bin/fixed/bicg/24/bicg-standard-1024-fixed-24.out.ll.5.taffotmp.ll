; ModuleID = './build/bin/fixed/bicg/24/bicg-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
for.body24:                                       ; preds = %for.cond22
  ...
  %3 = fdiv float %2, 5.120000e+02, !taffo.info !50, !taffo.target !51
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 5.120000e+02, !taffo.info !47
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !91
  %2 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !91
  %3 = fdiv float %2, 0x4140000000000000, !taffo.info !91
  ...
  %4 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !100
