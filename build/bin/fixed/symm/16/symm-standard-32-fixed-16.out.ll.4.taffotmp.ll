; ModuleID = './build/bin/fixed/symm/16/symm-standard-32-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 32), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 32), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
...
!49 = !{!"fixp", i32 32, i32 16}
!50 = !{!"C"}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 16}
!53 = !{double -3.196800e+04, double 0x404CCCCCBC05D52C}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 25}
!56 = !{double 3.200000e+00, double 8.000000e+01}
...
!103 = !{double 3.200000e+01, double 3.200000e+01}
...
!107 = !{!"fixp", i32 -32, i32 9}
!108 = !{double -2.557440e+06, double 0x40B1FFFFF583A53C}
!109 = !{i32 5}
!110 = !{i32 6}
!111 = !{i32 7}
!112 = !{!55, !113, i1 false, i2 -1}
!113 = !{double 0x4013333333333334, double 1.200000e+02}
!114 = !{!107, !115, i1 false, i2 -1}
!115 = !{double -3.836160e+06, double 0x40BAFFFFF04577D9}
!116 = !{!107, !117, i1 false, i2 -1}
!117 = !{double -3.836160e+06, double 0x40E8C451DE093533}
!118 = !{!107, !108, i1 false, i2 -1}
!119 = !{i32 8}
!120 = !{i32 9}
!121 = distinct !{!121, !23}
!122 = !{!49, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40E9AB957333D443}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 -32, i32 8}
!126 = !{double -3.836160e+06, double 0x40ED0B95713C833E}
!127 = !{!125, !128, i1 false, i2 -1}
!128 = !{double -3.836160e+06, double 0x40BAFFFFF04577DA}
!129 = !{!125, !130, i1 false, i2 -1}
!130 = !{double -7.672320e+06, double 0x40F035CAB7A2991D}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
...
!176 = !{!"fixp", i32 32, i32 11}
!177 = !{double 0.000000e+00, double 0x41356451E0008638}
!178 = distinct !{!178, !23}
!179 = distinct !{!179, !23}
!180 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !102}
!181 = !{!182, !183, i1 false, i2 -1}
!182 = !{!"fixp", i32 -32, i32 11}
!183 = !{double 0xC12F380000000000, double 0x409CCCCCBC05D52C}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
!186 = !{i32 1, !16, i32 1, !92, i32 1, !54, i32 1, !102}
!187 = !{!188, !189, i1 false, i2 -1}
!188 = !{!"fixp", i32 32, i32 20}
!189 = !{double 1.024000e+02, double 2.560000e+03}
!190 = distinct !{!190, !23}
!191 = distinct !{!191, !23}
