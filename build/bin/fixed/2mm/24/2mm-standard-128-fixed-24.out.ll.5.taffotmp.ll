; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-128-fixed-24.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !236
  ...
  %6 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !236
  %7 = fptoui float %6 to i32, !taffo.info !236
