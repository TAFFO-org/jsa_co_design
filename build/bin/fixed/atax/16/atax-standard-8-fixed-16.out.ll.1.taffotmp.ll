...
@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,1.68) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(8.0,15.636364) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [49 x i8] c"target('y') scalar(range(0.0,3938.048096) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,244.160004) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %x2, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 112, i8* null)
  ...
  call void @llvm.var.annotation(i8* %tmp4, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 114, i8* null)
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, float* noundef %2, i32 noundef 8)
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 8)
  %arraydecay10 = getelementptr inbounds [22 x float], [22 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 8)
