; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-512-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.info !60, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 512), !taffo.info !65, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 512), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 512), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 512), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
!53 = !{double 0.000000e+00, double 4.800000e+02}
...
!101 = !{double 5.120000e+02, double 5.120000e+02}
...
!110 = !{double 0.000000e+00, double 0x414296E966666666}
!111 = distinct !{!111, !23}
!112 = !{!113, !53, i1 false, i2 -1}
!113 = !{!"fixp", i32 32, i32 22}
!114 = !{!113, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 7.200000e+02}
!116 = !{!117, !118, i1 false, i2 -1}
!117 = !{!"fixp", i32 32, i32 12}
!118 = !{double 0.000000e+00, double 0x41143FFFF727136A}
!119 = !{!113, !55, i1 false, i2 -1}
!120 = !{!113, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x408599999029AE4F}
!122 = !{!107, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x41243FFFF727136A}
!124 = !{!107, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x41448DC27DC9C4DA}
!126 = !{i32 8}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!184 = !{!"float", i32 1, double 0x41CEFB8500000000}
!185 = !{double 0.000000e+00, double 0x41CEFB8500000000}
!186 = !{i32 9}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
...
!192 = !{double 0.000000e+00, double 2.457600e+05}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
