...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 12, ptr noundef %arraydecay3, i32 noundef 256)
  %arraydecay4 = getelementptr inbounds [10 x [16 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 16, ptr noundef %arraydecay4, i32 noundef 256)
  %arraydecay5 = getelementptr inbounds [16 x [12 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 12, ptr noundef %arraydecay5, i32 noundef 256)
...
for.body38:                                       ; preds = %for.cond35
  ...
  %conv42 = sitofp i32 %rem41 to float
  %35 = load i32, ptr %nj.addr, align 4
  %conv43 = sitofp i32 %35 to float
  ...
  store float %div44, ptr %arrayidx46, align 4
  br label %for.inc47
