; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-256-fixed-11.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !127
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !131 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !132
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !135
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u15_17fixp, 8, !taffo.info !135
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !137 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 18), !taffo.info !138
  %mul.u13_19fixp = shl i32 %4, 1, !taffo.info !141
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u13_19fixp, 8, !taffo.info !141
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !144 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u16_16fixp, 8, !taffo.info !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !158 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 17), !taffo.info !159
  %mul.u14_18fixp = shl i32 %4, 1, !taffo.info !162
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u14_18fixp, 8, !taffo.info !162
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u15_17fixp = load i32, i32* %arrayidx4.u15_17fixp, align 4, !taffo.info !168
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !169
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !171
  %5 = lshr i32 %u15_17fixp, 1, !taffo.info !168
  %add.u16_16fixp = add i32 %5, %mul.u16_16fixp, !taffo.info !172
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 18), !taffo.info !174
  %mul9.u13_19fixp = shl i32 %10, 1, !taffo.info !176
  %11 = lshr i32 %mul9.u13_19fixp, 3, !taffo.info !176
  %add10.u16_16fixp = add i32 %add.u16_16fixp, %11, !taffo.info !177
  ...
  %12 = shl i32 %add10.u16_16fixp, 1, !taffo.info !177
...
for.body21:                                       ; preds = %for.cond19
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 16), !taffo.info !181
  %mul25.u15_17fixp = shl i32 %16, 1, !taffo.info !183
  ...
  %17 = lshr i32 %mul25.u15_17fixp, 1, !taffo.info !183
  %18 = lshr i32 %u6_26fixp4, 1, !taffo.info !71
  %19 = ashr i32 %17, 5, !taffo.info !183
  %20 = ashr i32 %18, 14, !taffo.info !71
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 11), !taffo.info !184
  %mul27.u20_12fixp = shl i32 %21, 1, !taffo.info !187
  %22 = lshr i32 %mul27.u20_12fixp, 3, !taffo.info !187
  %add28.u23_9fixp = add i32 %u23_9fixp, %22, !taffo.info !189
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u23_9fixp = add i32 %u23_9fixp2, %23, !taffo.info !193
...
for.body51:                                       ; preds = %for.cond49
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 16), !taffo.info !196
  %mul55.u15_17fixp = shl i32 %27, 1, !taffo.info !198
  %28 = uitofp i32 %mul55.u15_17fixp to float, !taffo.info !198
  %lampsim = bitcast float %28 to i32
  %lampsim1 = and i32 %lampsim, -8192
  %lampsim2 = bitcast i32 %lampsim1 to float
  %29 = fdiv float %lampsim2, 1.310720e+05, !taffo.info !198
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u15_17fixp, i32* noundef %u1.u8_24fixp, i32* noundef %v1.u7_25fixp, i32* noundef %u2.u8_24fixp, i32* noundef %v2.u6_26fixp, float* noundef %w, i32* noundef %x.u23_9fixp, i32* noundef %y.u6_26fixp, i32* noundef %z.u5_27fixp) #0 !taffo.initweight !207 !taffo.funinfo !166 !taffo.sourceFunction !208 {
entry:
...
!123 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!124 = !{void (i32, float*, i32)* @scale_1d}
!125 = !{!126, !120, i1 false, i2 1}
!126 = !{!"fixp", i32 32, i32 23}
!127 = !{!128, !129, i1 false, i2 -1}
!128 = !{!"float", i32 1, double 0x41D5D7B540000000}
!129 = !{double 0.000000e+00, double 0x41D5D7B540000000}
!130 = distinct !{!130, !27}
!131 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"fixp", i32 -32, i32 16}
!134 = !{double 8.192000e+02, double 1.638400e+04}
!135 = !{!53, !134, i1 false, i2 -1}
!136 = distinct !{!136, !27}
!137 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!138 = !{!139, !140, i1 false, i2 -1}
!139 = !{!"fixp", i32 -32, i32 18}
!140 = !{double 0x4076C16BDB1A6D6A, double 0x40BC71C725C3DEE8}
...
!147 = !{double 0.000000e+00, double 0x40EE6666601BC98A}
...
!155 = !{!"float", i32 1, double 0x42F311BCA0000000}
!156 = !{double 0.000000e+00, double 0x42F311BCA0000000}
!157 = distinct !{!157, !27}
!158 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!159 = !{!160, !161, i1 false, i2 -1}
!160 = !{!"fixp", i32 -32, i32 17}
!161 = !{double 0x40811110E453D20F, double 0x40C555556084A516}
!162 = !{!163, !161, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 18}
!164 = distinct !{!164, !27}
...
!167 = distinct !{null}
!168 = !{!149, !5, i1 false, i2 -1}
!169 = !{!146, !170, i1 false, i2 -1}
!170 = !{double 0.000000e+00, double 0x40CE6666601BC98A}
!171 = !{!149, !170, i1 false, i2 -1}
!172 = !{!149, !173, i1 false, i2 -1}
!173 = !{double 0.000000e+00, double 0x40E1DF777807789A}
!174 = !{!139, !175, i1 false, i2 -1}
!175 = !{double 0x402B4E816D52E9B2, double 0x40B555556084A516}
!176 = !{!142, !175, i1 false, i2 -1}
!177 = !{!149, !178, i1 false, i2 -1}
!178 = !{double 0x402B4E816D52E9B2, double 0x40E48A2224180D3D}
!179 = distinct !{!179, !27}
!180 = distinct !{!180, !27}
!181 = !{!133, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 0x40D8A7AE199ADBB8}
!183 = !{!53, !182, i1 false, i2 -1}
!184 = !{!185, !186, i1 false, i2 -1}
!185 = !{!"fixp", i32 -32, i32 11}
!186 = !{double 0.000000e+00, double 0x4128A7AE199ADBB8}
!187 = !{!188, !186, i1 false, i2 -1}
!188 = !{!"fixp", i32 32, i32 12}
!189 = !{!70, !190, i1 false, i2 -1}
!190 = !{double 0.000000e+00, double 0x4158ECAB03335B77}
!191 = distinct !{!191, !27}
!192 = distinct !{!192, !27}
!193 = !{!70, !194, i1 false, i2 -1}
!194 = !{double 0x3FF6C16BDB1A6D6A, double 0x4155D7BC5C71C971}
!195 = distinct !{!195, !27}
!196 = !{!133, !197, i1 false, i2 -1}
!197 = !{double 0.000000e+00, double 0x40DED199A00192A6}
!198 = !{!53, !197, i1 false, i2 -1}
!199 = !{!200, !201, i1 false, i2 -1}
!200 = !{!"float", i32 1, double 0x4245094BA05C3717}
!201 = !{double 0.000000e+00, double 0x4245094BA05C3717}
!202 = !{!203, !204, i1 false, i2 -1}
!203 = !{!"float", i32 1, double 0x4275B2E6140B86E3}
!204 = !{double 0.000000e+00, double 0x4275B2E6140B86E3}
!205 = distinct !{!205, !27}
!206 = distinct !{!206, !27}
