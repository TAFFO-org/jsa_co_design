; ModuleID = './build/bin/fixed/symm/24/symm-standard-8-fixed-24.out.ll'
...
for.body16:                                       ; preds = %for.cond14
  ...
  %1 = fdiv float %lampsim2, 0x4130000000000000, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %m, i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u12_20fixp, [10 x i32]* noundef %A.s14_18fixp, [16 x i32]* noundef %B.u5_27fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !94 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv6.u4_28fixp = shl i32 %m, 28, !taffo.info !113
  %0 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !112, !taffo.constinfo !21
  %1 = lshr i32 %conv6.u4_28fixp, 1, !taffo.info !113
  %2 = ashr i32 %1, 1, !taffo.info !113
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %2, i32 26), !taffo.info !115
  %div.u4_28fixp = shl i32 %3, 2, !taffo.info !118
  %arrayidx.u12_20fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u12_20fixp, i32 %i.0, !taffo.info !119
  %arrayidx7.u12_20fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u12_20fixp, i32 0, i32 %j.0, !taffo.info !119
  %4 = lshr i32 %div.u4_28fixp, 8, !taffo.info !118
  store i32 %4, i32* %arrayidx7.u12_20fixp, align 4, !taffo.info !120
  ...
  %conv11.u4_28fixp = shl i32 %m, 28, !taffo.info !113
  %5 = lshr i32 %conv10.u5_27fixp, 1, !taffo.info !112, !taffo.constinfo !21
  %6 = lshr i32 %conv11.u4_28fixp, 1, !taffo.info !113
  %7 = ashr i32 %6, 1, !taffo.info !113
  %8 = call i32 @llvm.sdiv.fix.i32(i32 %5, i32 %7, i32 26), !taffo.info !115
  %div12.u4_28fixp = shl i32 %8, 2, !taffo.info !118
  %arrayidx13.u5_27fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u5_27fixp, i32 %i.0, !taffo.info !123
  %arrayidx14.u5_27fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx13.u5_27fixp, i32 0, i32 %j.0, !taffo.info !123
  %9 = lshr i32 %div12.u4_28fixp, 1, !taffo.info !118
  store i32 %9, i32* %arrayidx14.u5_27fixp, align 4, !taffo.info !120
  br label %for.inc
...
for.body25:                                       ; preds = %for.cond22
  ...
  %conv29.u4_28fixp = shl i32 %m, 28, !taffo.info !113
  %10 = lshr i32 %conv28.u5_27fixp, 1, !taffo.info !112, !taffo.constinfo !21
  %11 = lshr i32 %conv29.u4_28fixp, 1, !taffo.info !113
  %12 = ashr i32 %11, 1, !taffo.info !113
  %13 = call i32 @llvm.sdiv.fix.i32(i32 %10, i32 %12, i32 26), !taffo.info !115
  %div30.u4_28fixp = shl i32 %13, 2, !taffo.info !118
  %arrayidx31.s14_18fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s14_18fixp, i32 %i.1, !taffo.info !129
  %arrayidx32.s14_18fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx31.s14_18fixp, i32 0, i32 %j.1, !taffo.info !129
  %14 = lshr i32 %div30.u4_28fixp, 10, !taffo.info !118
  store i32 %14, i32* %arrayidx32.s14_18fixp, align 4, !taffo.info !120
  br label %for.inc33
...
for.body40:                                       ; preds = %for.cond37
  %arrayidx41.s14_18fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s14_18fixp, i32 %i.1, !taffo.info !129
  %arrayidx42.s14_18fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx41.s14_18fixp, i32 0, i32 %j.2, !taffo.info !129
  store i32 -261881856, i32* %arrayidx42.s14_18fixp, align 4, !taffo.info !120, !taffo.constinfo !131
  br label %for.inc43
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3_fixp(i32 noundef %m, i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u12_20fixp, [10 x i32]* noundef %A.s14_18fixp, [16 x i32]* noundef %B.u5_27fixp) #0 !taffo.initweight !136 !taffo.funinfo !93 !taffo.sourceFunction !137 {
entry:
  br label %for.cond
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  ...
  %temp2.0.s19_13fixp = phi i32 [ %0, %for.body3 ], [ %add18.s19_13fixp, %for.inc ], !taffo.info !138
...
for.body6:                                        ; preds = %for.cond4
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 26), !taffo.info !141
  %mul.u5_27fixp = shl i32 %4, 1, !taffo.info !143
  ...
  %5 = lshr i32 %mul.u5_27fixp, 1, !taffo.info !143
  %6 = ashr i32 %5, 13, !taffo.info !143
  %7 = ashr i32 %s14_18fixp, 5, !taffo.info !50
  %mul10.s19_13fixp = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 13), !taffo.info !144
  ...
  %add.s19_13fixp = add i32 %8, %mul10.s19_13fixp, !taffo.info !146
  %9 = shl i32 %add.s19_13fixp, 7, !taffo.info !146
  ...
  %mul17.s19_13fixp = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 13), !taffo.info !148
  %add18.s19_13fixp = add i32 %temp2.0.s19_13fixp, %mul17.s19_13fixp, !taffo.info !148
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 19), !taffo.info !150
  %mul21.u12_20fixp = shl i32 %16, 1, !taffo.info !153
  ...
  %20 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %18, i32 26), !taffo.info !141
  %mul24.u5_27fixp = shl i32 %20, 1, !taffo.info !143
  ...
  %21 = lshr i32 %mul24.u5_27fixp, 1, !taffo.info !143
  %22 = ashr i32 %21, 13, !taffo.info !143
  %23 = ashr i32 %s14_18fixp3, 5, !taffo.info !50
  %mul27.s19_13fixp = call i32 @llvm.smul.fix.i32(i32 %22, i32 %23, i32 13), !taffo.info !144
  %24 = lshr i32 %mul21.u12_20fixp, 8, !taffo.info !153
  %25 = ashr i32 %mul27.s19_13fixp, 1, !taffo.info !144
  %add28.s20_12fixp = add i32 %24, %25, !taffo.info !154
  %26 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %27 = ashr i32 %26, 17, !taffo.info !42
  %28 = ashr i32 %temp2.0.s19_13fixp, 1, !taffo.info !138
  %mul29.s20_12fixp = call i32 @llvm.smul.fix.i32(i32 %27, i32 %28, i32 12), !taffo.info !157
  %add30.s20_12fixp = add i32 %add28.s20_12fixp, %mul29.s20_12fixp, !taffo.info !158
  ...
  %29 = shl i32 %add30.s20_12fixp, 8, !taffo.info !158
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s14_18fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !163 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.s17_15fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !166
  ...
  %5 = shl i32 %mul.s17_15fixp, 3, !taffo.info !166
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !171 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 23), !taffo.info !172
  %mul.u8_24fixp = shl i32 %5, 1, !taffo.info !175
  ...
  %7 = shl i32 %mul.u8_24fixp, 3, !taffo.info !175
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !162 !taffo.funinfo !179 !taffo.sourceFunction !164 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u15_17fixp, 3, !taffo.info !183
...
!140 = !{double -1.598400e+05, double 2.880000e+02}
!141 = !{!116, !142, i1 false, i2 -1}
!142 = !{double 0x3FF3333333333334, double 3.000000e+01}
!143 = !{!54, !142, i1 false, i2 -1}
!144 = !{!139, !145, i1 false, i2 -1}
!145 = !{double -2.397600e+05, double 4.320000e+02}
!146 = !{!139, !147, i1 false, i2 -1}
!147 = !{double -2.397600e+05, double 0x40A8D147C0096FEB}
!148 = !{!139, !140, i1 false, i2 -1}
!149 = distinct !{!149, !23}
!150 = !{!151, !152, i1 false, i2 -1}
!151 = !{!"fixp", i32 -32, i32 19}
!152 = !{double 0.000000e+00, double 0x40A9BB22E671B980}
!153 = !{!48, !152, i1 false, i2 -1}
!154 = !{!155, !156, i1 false, i2 -1}
!155 = !{!"fixp", i32 -32, i32 12}
!156 = !{double -2.397600e+05, double 0x40AD1B22E671B980}
!157 = !{!155, !145, i1 false, i2 -1}
!158 = !{!155, !159, i1 false, i2 -1}
!159 = !{double -4.795200e+05, double 0x40B03D917338DCC0}
!160 = distinct !{!160, !23}
!161 = distinct !{!161, !23}
!162 = !{i32 -1, i32 -1, i32 3, i32 -1}
!163 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !89}
!164 = !{void (i32, i32, float*, i32)* @scale_2d}
!165 = !{!114, !90, i1 false, i2 1}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 -32, i32 15}
!168 = !{double -6.393600e+04, double 1.152000e+02}
!169 = distinct !{!169, !23}
!170 = distinct !{!170, !23}
!171 = !{i32 1, !16, i32 1, !79, i32 1, !53, i32 1, !89}
!172 = !{!173, !174, i1 false, i2 -1}
!173 = !{!"fixp", i32 -32, i32 23}
!174 = !{double 6.400000e+00, double 1.600000e+02}
...
!182 = !{double 0.000000e+00, double 0x40D57147C0096FEB}
