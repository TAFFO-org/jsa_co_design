; ModuleID = './build/bin/fixed/ludcmp/16/ludcmp-standard-16-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u8_24fixp, i32* noundef %b.u7_25fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u7_25fixp) #0 !taffo.initweight !94 !taffo.funinfo !95 !taffo.sourceFunction !96 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u8_24fixp = load i32, i32* %arrayidx5.u8_24fixp, align 4, !taffo.info !97
  %0 = lshr i32 %u8_24fixp, 1, !taffo.info !97
  br label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s16_16fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 16), !taffo.info !100
  %5 = ashr i32 %w.0.s9_23fixp, 7, !taffo.info !97
  %sub.s16_16fixp = sub i32 %5, %mul.s16_16fixp, !taffo.info !103
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s16_16fixp, 7, !taffo.info !103
...
for.end:                                          ; preds = %for.cond6
  ...
  %10 = shl i32 %div.s12_20fixp, 4, !taffo.info !106
  store i32 %10, i32* %arrayidx16.u8_24fixp, align 4, !taffo.info !108
  br label %for.inc17
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u8_24fixp12 = load i32, i32* %arrayidx24.u8_24fixp, align 4, !taffo.info !97
  %11 = lshr i32 %u8_24fixp12, 1, !taffo.info !97
  br label %for.cond25
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s16_16fixp = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 16), !taffo.info !100
  %16 = ashr i32 %w.1.s9_23fixp, 7, !taffo.info !97
  %sub33.s16_16fixp = sub i32 %16, %mul32.s16_16fixp, !taffo.info !103
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %17 = shl i32 %sub33.s16_16fixp, 7, !taffo.info !103
...
for.end36:                                        ; preds = %for.cond25
  ...
  %18 = shl i32 %w.1.s9_23fixp, 1, !taffo.info !97
  store i32 %18, i32* %arrayidx38.u8_24fixp, align 4, !taffo.info !108
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u7_25fixp = load i32, i32* %arrayidx48.u7_25fixp, align 4, !taffo.info !97
  %19 = lshr i32 %u7_25fixp, 2, !taffo.info !97
  br label %for.cond49
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s15_17fixp = call i32 @llvm.smul.fix.i32(i32 %22, i32 %23, i32 17), !taffo.info !113
  %24 = ashr i32 %w.2.s9_23fixp, 6, !taffo.info !97
  %sub56.s15_17fixp = sub i32 %24, %mul55.s15_17fixp, !taffo.info !116
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !76, !taffo.constinfo !21
  %25 = shl i32 %sub56.s15_17fixp, 6, !taffo.info !116
...
for.end59:                                        ; preds = %for.cond49
  ...
  %26 = shl i32 %w.2.s9_23fixp, 2, !taffo.info !97
  store i32 %26, i32* %arrayidx60.u7_25fixp, align 4, !taffo.info !108
  br label %for.inc61
...
for.end63:                                        ; preds = %for.cond45
  %sub64 = sub nsw i32 %n, 1, !taffo.info !120, !taffo.constinfo !21
  br label %for.cond65

for.cond65:                                       ; preds = %for.inc84, %for.end63
  %i.2 = phi i32 [ %sub64, %for.end63 ], [ %dec, %for.inc84 ], !taffo.info !122
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u7_25fixp8 = load i32, i32* %arrayidx68.u7_25fixp, align 4, !taffo.info !97
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %27 = lshr i32 %u7_25fixp8, 4, !taffo.info !97
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc77, %for.body67
  %j.3 = phi i32 [ %add, %for.body67 ], [ %inc78, %for.inc77 ], !taffo.info !124
  %w.3.s11_21fixp = phi i32 [ %27, %for.body67 ], [ %sub76.s11_21fixp, %for.inc77 ], !taffo.info !126
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s11_21fixp = call i32 @llvm.smul.fix.i32(i32 %29, i32 %30, i32 21), !taffo.info !128
  %sub76.s11_21fixp = sub i32 %w.3.s11_21fixp, %mul75.s11_21fixp, !taffo.info !130
  br label %for.inc77
...
for.end79:                                        ; preds = %for.cond69
  ...
  %32 = ashr i32 %w.3.s11_21fixp, 1, !taffo.info !126
  ...
  store i32 %34, i32* %arrayidx83.s4_28fixp, align 4, !taffo.info !108
  br label %for.inc84
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s8_24fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 24), !taffo.info !139
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s8_24fixp, 4, !taffo.info !139
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 16), !taffo.info !100
...
!102 = !{double 0x3F847AE147AE147C, double 0x40D0B28B485FEB29}
!103 = !{!101, !104, i1 false, i2 -1}
!104 = !{double 0xC0D0E48B485FEB29, double 1.999900e+02}
!105 = distinct !{!105, !23}
!106 = !{!89, !107, i1 false, i2 -1}
!107 = !{double -2.000000e+03, double 2.000000e+03}
!108 = !{i1 false, !99, i1 false, i2 -1}
!109 = distinct !{!109, !23}
!110 = distinct !{!110, !23}
!111 = distinct !{!111, !23}
!112 = distinct !{!112, !23}
!113 = !{!114, !115, i1 false, i2 -1}
!114 = !{!"fixp", i32 -32, i32 17}
!115 = !{double 0.000000e+00, double 0x40C07278D3029BE1}
!116 = !{!114, !117, i1 false, i2 -1}
!117 = !{double 0xC0C0D678D3029BE1, double 2.000000e+02}
!118 = distinct !{!118, !23}
!119 = distinct !{!119, !23}
!120 = !{i1 false, !121, i1 false, i2 0}
!121 = !{double 1.900000e+01, double 1.900000e+01}
!122 = !{i1 false, !123, i1 false, i2 0}
!123 = !{double 1.800000e+01, double 1.900000e+01}
!124 = !{i1 false, !125, i1 false, i2 0}
!125 = !{double 2.000000e+01, double 2.100000e+01}
!126 = !{!127, !99, i1 false, i2 -1}
!127 = !{!"fixp", i32 -32, i32 21}
!128 = !{!127, !129, i1 false, i2 -1}
!129 = !{double 0xC013D9094C33901E, double 0x408056C5CEDD19B7}
!130 = !{!127, !131, i1 false, i2 -1}
!131 = !{double 0xC08696C5CEDD19B7, double 0x40699EC84A619C81}
...
!141 = !{double -6.071520e-01, double 0x404FFCF893FAF428}
!142 = distinct !{!142, !23}
