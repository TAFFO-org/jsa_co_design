; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-32-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 32), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !36
...
!31 = !{double 3.200000e+00, double 0x40840CCCC0379314}
!32 = !{i32 1}
!33 = !{i32 2}
