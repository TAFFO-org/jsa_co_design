; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-1024-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.info !85, !taffo.initweight !77, !taffo.constinfo !88, !taffo.originalCall !89
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 1024), !taffo.info !90, !taffo.initweight !77, !taffo.constinfo !88, !taffo.originalCall !89
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.info !92, !taffo.initweight !93, !taffo.constinfo !94, !taffo.originalCall !95
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.info !55, !taffo.initweight !77
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 1024), !taffo.info !96, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.info !58, !taffo.initweight !77
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 1024), !taffo.info !99, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.info !61, !taffo.initweight !77
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 1024), !taffo.info !100, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.info !63, !taffo.initweight !77
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 1024), !taffo.info !101, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 1024), !taffo.info !102, !taffo.initweight !91, !taffo.constinfo !97, !taffo.target !68, !taffo.originalCall !98
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.info !69, !taffo.initweight !77
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 1024), !taffo.info !103, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !71, !taffo.initweight !77
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 1024), !taffo.info !104, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.info !73, !taffo.initweight !77
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 1024), !taffo.info !105, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
...
for.cond:                                         ; preds = %for.inc51, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc52, %for.inc51 ], !taffo.info !215, !taffo.initweight !50
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !217, !taffo.initweight !91
  br i1 %cmp, label %for.body, label %for.end53, !taffo.info !215, !taffo.initweight !93

for.body:                                         ; preds = %for.cond
  %conv5 = sitofp i32 %i.0 to float, !taffo.info !218, !taffo.initweight !91
  %div = fdiv float %conv5, %conv, !taffo.info !219, !taffo.initweight !91
  %arrayidx = getelementptr inbounds float, float* %u1, i32 %i.0, !taffo.info !221, !taffo.initweight !91
  store float %div, float* %arrayidx, align 4, !taffo.info !222, !taffo.initweight !93
  %add = add nsw i32 %i.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
  %conv6 = sitofp i32 %add to float, !taffo.info !224, !taffo.initweight !93
  %div7 = fdiv float %conv6, %conv, !taffo.info !225, !taffo.initweight !91
  %conv8 = fpext float %div7 to double, !taffo.info !225, !taffo.initweight !93
  %div9 = fdiv double %conv8, 2.000000e+00, !taffo.info !227, !taffo.initweight !114, !taffo.constinfo !229
  %conv10 = fptrunc double %div9 to float, !taffo.info !230, !taffo.initweight !138
  %arrayidx11 = getelementptr inbounds float, float* %u2, i32 %i.0, !taffo.info !232, !taffo.initweight !91
  store float %conv10, float* %arrayidx11, align 4, !taffo.info !222, !taffo.initweight !93
  %add12 = add nsw i32 %i.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
  %conv13 = sitofp i32 %add12 to float, !taffo.info !224, !taffo.initweight !93
  %div14 = fdiv float %conv13, %conv, !taffo.info !225, !taffo.initweight !91
  %conv15 = fpext float %div14 to double, !taffo.info !225, !taffo.initweight !93
  %div16 = fdiv double %conv15, 4.000000e+00, !taffo.info !233, !taffo.initweight !114, !taffo.constinfo !235
  %conv17 = fptrunc double %div16 to float, !taffo.info !238, !taffo.initweight !138
  %arrayidx18 = getelementptr inbounds float, float* %v1, i32 %i.0, !taffo.info !240, !taffo.initweight !91
  store float %conv17, float* %arrayidx18, align 4, !taffo.info !222, !taffo.initweight !93
  %add19 = add nsw i32 %i.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
  %conv20 = sitofp i32 %add19 to float, !taffo.info !224, !taffo.initweight !93
  %div21 = fdiv float %conv20, %conv, !taffo.info !225, !taffo.initweight !91
  %conv22 = fpext float %div21 to double, !taffo.info !225, !taffo.initweight !93
  %div23 = fdiv double %conv22, 6.000000e+00, !taffo.info !241, !taffo.initweight !114, !taffo.constinfo !243
  %conv24 = fptrunc double %div23 to float, !taffo.info !246, !taffo.initweight !138
  %arrayidx25 = getelementptr inbounds float, float* %v2, i32 %i.0, !taffo.info !248, !taffo.initweight !91
  store float %conv24, float* %arrayidx25, align 4, !taffo.info !222, !taffo.initweight !93
  %add26 = add nsw i32 %i.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
  %conv27 = sitofp i32 %add26 to float, !taffo.info !224, !taffo.initweight !93
  %div28 = fdiv float %conv27, %conv, !taffo.info !225, !taffo.initweight !91
  %conv29 = fpext float %div28 to double, !taffo.info !225, !taffo.initweight !93
  %div30 = fdiv double %conv29, 8.000000e+00, !taffo.info !249, !taffo.initweight !114, !taffo.constinfo !251
  %conv31 = fptrunc double %div30 to float, !taffo.info !254, !taffo.initweight !138
  %arrayidx32 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !256, !taffo.initweight !91
  store float %conv31, float* %arrayidx32, align 4, !taffo.info !222, !taffo.initweight !93
  %add33 = add nsw i32 %i.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
  %conv34 = sitofp i32 %add33 to float, !taffo.info !224, !taffo.initweight !93
  %div35 = fdiv float %conv34, %conv, !taffo.info !225, !taffo.initweight !91
  %conv36 = fpext float %div35 to double, !taffo.info !225, !taffo.initweight !93
  %div37 = fdiv double %conv36, 9.000000e+00, !taffo.info !257, !taffo.initweight !114, !taffo.constinfo !259
  %conv38 = fptrunc double %div37 to float, !taffo.info !262, !taffo.initweight !138
  %arrayidx39 = getelementptr inbounds float, float* %z, i32 %i.0, !taffo.info !264, !taffo.initweight !91
  store float %conv38, float* %arrayidx39, align 4, !taffo.info !222, !taffo.initweight !93
  %arrayidx40 = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.info !265, !taffo.initweight !91
  store float 0.000000e+00, float* %arrayidx40, align 4, !taffo.info !222, !taffo.initweight !93, !taffo.constinfo !266
  %arrayidx41 = getelementptr inbounds float, float* %w, i32 %i.0, !taffo.info !267, !taffo.initweight !91
  store float 0.000000e+00, float* %arrayidx41, align 4, !taffo.info !222, !taffo.initweight !93, !taffo.constinfo !266
  br label %for.cond42

for.cond42:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !215, !taffo.initweight !50
  %cmp43 = icmp slt i32 %j.0, %n, !taffo.info !217, !taffo.initweight !91
  br i1 %cmp43, label %for.body45, label %for.end, !taffo.info !215, !taffo.initweight !93

for.body45:                                       ; preds = %for.cond42
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !268, !taffo.initweight !91
  %rem = srem i32 %mul, %n, !taffo.info !270, !taffo.initweight !93
  %conv46 = sitofp i32 %rem to float, !taffo.info !272, !taffo.initweight !114
  %conv47 = sitofp i32 %n to float, !taffo.info !213
  %div48 = fdiv float %conv46, %conv47, !taffo.info !273, !taffo.initweight !138
  %arrayidx49 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !275, !taffo.initweight !91
  %arrayidx50 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx49, i32 0, i32 %j.0, !taffo.info !275, !taffo.initweight !91
  store float %div48, float* %arrayidx50, align 4, !taffo.info !222, !taffo.initweight !93
  br label %for.inc

for.inc:                                          ; preds = %for.body45
  %inc = add nsw i32 %j.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
  br label %for.cond42, !llvm.loop !276

for.end:                                          ; preds = %for.cond42
  br label %for.inc51

for.inc51:                                        ; preds = %for.end
  %inc52 = add nsw i32 %i.0, 1, !taffo.info !223, !taffo.initweight !91, !taffo.constinfo !25
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.13(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !278 !taffo.funinfo !279 !taffo.sourceFunction !95 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !140
  %mul = fmul float %1, %conv, !taffo.info !280, !taffo.initweight !282
...
for.inc:                                          ; preds = %for.body3
  %inc = add nsw i32 %j.0, 1, !taffo.info !124, !taffo.constinfo !25
  br label %for.cond1, !llvm.loop !283
...
!54 = !{!"fixp", i32 32, i32 13}
!55 = !{!56, !57, i1 false, i2 -1}
!56 = !{!"fixp", i32 32, i32 22}
!57 = !{double 0.000000e+00, double 0x408E6666601BC98A}
!58 = !{!59, !60, i1 false, i2 -1}
!59 = !{!"fixp", i32 32, i32 23}
!60 = !{double 1.280000e+01, double 2.560000e+02}
!61 = !{!56, !62, i1 false, i2 -1}
!62 = !{double 2.560000e+01, double 5.120000e+02}
!63 = !{!64, !65, i1 false, i2 -1}
!64 = !{!"fixp", i32 32, i32 24}
!65 = !{double 0x40211111276FB092, double 0x406555556084A516}
!66 = !{!67, !3, i1 false, i2 -1}
!67 = !{!"float", i32 1, double 0x4312D0EAC0000000}
!68 = !{!"w"}
...
!135 = !{double 1.024000e+03, double 1.024000e+03}
...
!143 = !{!"fixp", i32 32, i32 12}
!144 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!145 = !{i32 7}
!146 = distinct !{!146, !27}
!147 = !{i32 1, !122, i32 1, !58, i32 1, !134}
!148 = !{!54, !149, i1 false, i2 -1}
!149 = !{double 1.310720e+04, double 2.621440e+05}
!150 = distinct !{!150, !27}
!151 = !{i32 1, !122, i32 1, !63, i32 1, !134}
!152 = !{!153, !154, i1 false, i2 -1}
!153 = !{!"fixp", i32 32, i32 14}
!154 = !{double 0x40C11111276FB092, double 0x410555556084A516}
!155 = distinct !{!155, !27}
!156 = !{i32 1, !122, i32 1, !66, i32 1, !134}
!157 = !{!158, !159, i1 false, i2 -1}
!158 = !{!"float", i32 1, double 0x43B2D0EAC0000000}
!159 = !{double 0.000000e+00, double 0x43B2D0EAC0000000}
!160 = distinct !{!160, !27}
!161 = !{i32 1, !122, i32 1, !69, i32 1, !134}
!162 = !{!163, !164, i1 false, i2 -1}
!163 = !{!"float", i32 1, double 0x4255BC5260000000}
!164 = !{double 0.000000e+00, double 0x4255BC5260000000}
!165 = distinct !{!165, !27}
...
!170 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!171 = !{!143, !172, i1 false, i2 -1}
!172 = !{double 0.000000e+00, double 0x4121DE444806F262}
!173 = !{i32 8}
!174 = !{!175, !176, i1 false, i2 -1}
!175 = !{!"fixp", i32 32, i32 15}
!176 = !{double 0x406B4E81D8B2B41D, double 0x40F555556084A516}
!177 = !{!143, !178, i1 false, i2 -1}
!178 = !{double 0x406B4E81D8B2B41D, double 0x412488EEF4178705}
!179 = distinct !{!179, !27}
!180 = distinct !{!180, !27}
!181 = !{!54, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 0x4118A4CCD9999999}
!183 = !{!184, !185, i1 false, i2 -1}
!184 = !{!"fixp", i32 32, i32 6}
!185 = !{double 0.000000e+00, double 0x4188A4CCD9999999}
!186 = !{!70, !187, i1 false, i2 -1}
!187 = !{double 0.000000e+00, double 0x41B8D0EBFB333333}
!188 = distinct !{!188, !27}
!189 = distinct !{!189, !27}
!190 = !{!70, !191, i1 false, i2 -1}
!191 = !{double 0x4016C16C1E364BEC, double 0x41B5BC52D1C71C86}
!192 = distinct !{!192, !27}
!193 = !{!54, !194, i1 false, i2 -1}
!194 = !{double 0.000000e+00, double 0x411ECE0010000000}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"float", i32 1, double 0x42E4EC7997282930}
!197 = !{double 0.000000e+00, double 0x42E4EC7997282930}
!198 = !{!199, !200, i1 false, i2 -1}
!199 = !{!"float", i32 1, double 0x43156E79F2E50526}
!200 = !{double 0.000000e+00, double 0x43156E79F2E50526}
!201 = distinct !{!201, !27}
!202 = distinct !{!202, !27}
!203 = !{i32 1, !122, i32 1, !73, i32 1, !134}
!204 = !{!175, !205, i1 false, i2 -1}
!205 = !{double 0x40B6C16C1E364BEC, double 0x40FC71C7219220FF}
!206 = distinct !{!206, !27}
...
!213 = !{!214, !123, i1 false, i2 1}
!214 = !{!"fixp", i32 32, i32 27}
!215 = !{i1 false, !216, i1 false, i2 -1}
!216 = !{double 0.000000e+00, double 2.000000e+01}
!217 = !{i1 false, !111, i1 false, i2 -1}
!218 = !{!214, !216, i1 false, i2 -1}
!219 = !{!220, !111, i1 false, i2 1}
!220 = !{!"fixp", i32 32, i32 31}
!221 = !{!56, !57, i1 false, i2 1}
!222 = !{i1 false, i1 false, i1 false, i2 1}
!223 = !{i1 false, !119, i1 false, i2 -1}
!224 = !{!214, !119, i1 false, i2 -1}
!225 = !{!48, !226, i1 false, i2 1}
!226 = !{double 5.000000e-02, double 1.050000e+00}
!227 = !{!48, !228, i1 false, i2 1}
!228 = !{double 2.500000e-02, double 5.250000e-01}
!229 = !{i1 false, !23}
!230 = !{!220, !231, i1 false, i2 1}
!231 = !{double 0x3F99999980000000, double 0x3FE0CCCCE0000000}
!232 = !{!56, !62, i1 false, i2 1}
!233 = !{!48, !234, i1 false, i2 1}
!234 = !{double 1.250000e-02, double 2.625000e-01}
!235 = !{i1 false, !236}
!236 = !{i1 false, !237, i1 false, i2 0}
!237 = !{double 4.000000e+00, double 4.000000e+00}
!238 = !{!220, !239, i1 false, i2 1}
!239 = !{double 0x3F89999980000000, double 0x3FD0CCCCE0000000}
!240 = !{!59, !60, i1 false, i2 1}
!241 = !{!48, !242, i1 false, i2 1}
!242 = !{double 0x3F81111111111111, double 0x3FC6666666666667}
!243 = !{i1 false, !244}
!244 = !{i1 false, !245, i1 false, i2 0}
!245 = !{double 6.000000e+00, double 6.000000e+00}
!246 = !{!220, !247, i1 false, i2 1}
!247 = !{double 0x3F81111100000000, double 0x3FC6666680000000}
!248 = !{!64, !65, i1 false, i2 1}
!249 = !{!48, !250, i1 false, i2 1}
!250 = !{double 6.250000e-03, double 1.312500e-01}
!251 = !{i1 false, !252}
!252 = !{i1 false, !253, i1 false, i2 0}
!253 = !{double 8.000000e+00, double 8.000000e+00}
!254 = !{!220, !255, i1 false, i2 1}
!255 = !{double 0x3F79999980000000, double 0x3FC0CCCCE0000000}
!256 = !{!64, !72, i1 false, i2 1}
!257 = !{!48, !258, i1 false, i2 1}
!258 = !{double 0x3F76C16C16C16C17, double 0x3FBDDDDDDDDDDDDE}
!259 = !{i1 false, !260}
!260 = !{i1 false, !261, i1 false, i2 0}
!261 = !{double 9.000000e+00, double 9.000000e+00}
!262 = !{!220, !263, i1 false, i2 1}
!263 = !{double 0x3F76C16C00000000, double 0x3FBDDDDDE0000000}
!264 = !{!74, !75, i1 false, i2 1}
!265 = !{!70, !1, i1 false, i2 1}
!266 = !{!126, i1 false}
!267 = !{!67, !3, i1 false, i2 1}
!268 = !{i1 false, !269, i1 false, i2 -1}
!269 = !{double 0.000000e+00, double 4.000000e+02}
!270 = !{i1 false, !271, i1 false, i2 -1}
!271 = !{double 0.000000e+00, double 1.900000e+01}
!272 = !{!214, !271, i1 false, i2 -1}
!273 = !{!220, !274, i1 false, i2 -1}
!274 = !{double 0.000000e+00, double 0x3FEE666666666666}
!275 = !{!54, !5, i1 false, i2 1}
!276 = distinct !{!276, !27}
!277 = distinct !{!277, !27}
!278 = !{i32 -1, i32 -1, i32 3, i32 -1}
!279 = !{i32 1, !122, i32 1, !122, i32 1, !53, i32 1, !134}
!280 = !{!70, !281, i1 false, i2 -1}
!281 = !{double 0.000000e+00, double 0x41B4895560000000}
!282 = !{i32 9}
!283 = distinct !{!283, !27}
!284 = distinct !{!284, !27}
