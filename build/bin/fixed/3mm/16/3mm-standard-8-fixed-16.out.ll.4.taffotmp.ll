; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-8-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 8), !taffo.info !65, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 8), !taffo.info !72, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 8), !taffo.info !73, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 8), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 8), !taffo.info !75, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 8), !taffo.info !76, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 8), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !70, !taffo.target !59, !taffo.originalCall !71
...
for.body7:                                        ; preds = %for.cond5
  ...
  %mul = fmul float %0, %1, !taffo.info !117, !taffo.initweight !119
  ...
  %2 = load float, float* %arrayidx13, align 4, !taffo.info !120, !taffo.initweight !116
  %add = fadd float %2, %mul, !taffo.info !121, !taffo.initweight !119
...
for.body30:                                       ; preds = %for.cond28
  ...
  %mul35 = fmul float %3, %4, !taffo.info !126, !taffo.initweight !119
  ...
  %add38 = fadd float %5, %mul35, !taffo.info !128, !taffo.initweight !119
...
for.inc42:                                        ; preds = %for.end41
  ...
  br label %for.cond23, !llvm.loop !131
...
for.inc45:                                        ; preds = %for.end44
  ...
  br label %for.cond20, !llvm.loop !132
...
for.body58:                                       ; preds = %for.cond56
  ...
  %7 = load float, float* %arrayidx62, align 4, !taffo.info !133, !taffo.initweight !116
  %mul63 = fmul float %6, %7, !taffo.info !135, !taffo.initweight !119
  ...
  %add66 = fadd float %8, %mul63, !taffo.info !139, !taffo.initweight !119
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv7 = sitofp i32 %mul6 to float, !taffo.info !159
...
for.body19:                                       ; preds = %for.cond16
  ...
  %div27 = fdiv float %conv24, %conv26, !taffo.info !177, !taffo.initweight !113
  %arrayidx28 = getelementptr inbounds [8 x float], [8 x float]* %B, i32 %i.1, !taffo.info !179, !taffo.initweight !66
  %arrayidx29 = getelementptr inbounds [8 x float], [8 x float]* %arrayidx28, i32 0, i32 %j.1, !taffo.info !179, !taffo.initweight !66
...
for.inc30:                                        ; preds = %for.body19
  ...
  br label %for.cond16, !llvm.loop !180
...
for.body43:                                       ; preds = %for.cond40
  %add44 = add nsw i32 %j.2, 3, !taffo.info !182, !taffo.initweight !66, !taffo.constinfo !21
  %mul45 = mul nsw i32 %i.2, %add44, !taffo.info !184, !taffo.initweight !66
  %rem46 = srem i32 %mul45, %nl, !taffo.info !186, !taffo.initweight !69
  %conv47 = sitofp i32 %rem46 to float, !taffo.info !188, !taffo.initweight !86
  %mul48 = mul nsw i32 5, %nl, !taffo.info !189, !taffo.constinfo !21
  %conv49 = sitofp i32 %mul48 to float, !taffo.info !191
  %div50 = fdiv float %conv47, %conv49, !taffo.info !192, !taffo.initweight !112
  %arrayidx51 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %i.2, !taffo.info !195, !taffo.initweight !66
  %arrayidx52 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx51, i32 0, i32 %j.2, !taffo.info !195, !taffo.initweight !66
...
for.inc53:                                        ; preds = %for.body43
  ...
  br label %for.cond40, !llvm.loop !196
...
for.body66:                                       ; preds = %for.cond63
  %add67 = add nsw i32 %j.3, 2, !taffo.info !198, !taffo.initweight !66, !taffo.constinfo !21
  %mul68 = mul nsw i32 %i.3, %add67, !taffo.info !200, !taffo.initweight !66
  %add69 = add nsw i32 %mul68, 2, !taffo.info !202, !taffo.initweight !69, !taffo.constinfo !21
  %rem70 = srem i32 %add69, %nk, !taffo.info !204, !taffo.initweight !86
  %conv71 = sitofp i32 %rem70 to float, !taffo.info !206, !taffo.initweight !112
  %mul72 = mul nsw i32 5, %nk, !taffo.info !207, !taffo.constinfo !21
  %conv73 = sitofp i32 %mul72 to float, !taffo.info !209
  %div74 = fdiv float %conv71, %conv73, !taffo.info !210, !taffo.initweight !113
  %arrayidx75 = getelementptr inbounds [12 x float], [12 x float]* %D, i32 %i.3, !taffo.info !212, !taffo.initweight !66
  %arrayidx76 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx75, i32 0, i32 %j.3, !taffo.info !212, !taffo.initweight !66
...
for.body90:                                       ; preds = %for.cond87
  %arrayidx91 = getelementptr inbounds [8 x float], [8 x float]* %E, i32 %i.4, !taffo.info !215, !taffo.initweight !66
  %arrayidx92 = getelementptr inbounds [8 x float], [8 x float]* %arrayidx91, i32 0, i32 %j.4, !taffo.info !215, !taffo.initweight !66
...
for.body106:                                      ; preds = %for.cond103
  %arrayidx107 = getelementptr inbounds [12 x float], [12 x float]* %F, i32 %i.5, !taffo.info !218, !taffo.initweight !66
  %arrayidx108 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx107, i32 0, i32 %j.5, !taffo.info !218, !taffo.initweight !66
...
for.body122:                                      ; preds = %for.cond119
  %arrayidx123 = getelementptr inbounds [12 x float], [12 x float]* %G, i32 %i.6, !taffo.info !221, !taffo.initweight !66
  %arrayidx124 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx123, i32 0, i32 %j.6, !taffo.info !221, !taffo.initweight !66
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !225 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !41, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !226
  %mul = fmul float %1, %conv, !taffo.info !227, !taffo.initweight !229
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !65, !taffo.initweight !119
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !232 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !233, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !234
  %mul = fmul float %1, %conv, !taffo.info !235, !taffo.initweight !229
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !72, !taffo.initweight !119
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !239 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !50, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !234
  %mul = fmul float %1, %conv, !taffo.info !240, !taffo.initweight !229
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !74, !taffo.initweight !119
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !224 !taffo.funinfo !245 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !57, !taffo.initweight !119
  %conv = sitofp i32 %factor to float, !taffo.info !234
  %mul = fmul float %1, %conv, !taffo.info !246, !taffo.initweight !229
  %2 = mul nsw i32 %i.0, %m, !taffo.info !101
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !77, !taffo.initweight !119
  br label %for.inc
...
!47 = !{double 0.000000e+00, double 0x3FF55554FBDAD752}
!48 = !{!46, !49, i1 false, i2 -1}
!49 = !{double 0.000000e+00, double 1.400000e+00}
!50 = !{!51, !52, i1 false, i2 -1}
!51 = !{!"fixp", i32 32, i32 28}
!52 = !{double 0.000000e+00, double 8.192000e+00}
!53 = !{!46, !54, i1 false, i2 -1}
!54 = !{double 0.000000e+00, double 0x3FF77777D0F1F57B}
!55 = !{!46, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 1.440000e+00}
...
!115 = !{!101, i1 false}
!116 = !{i32 7}
!117 = !{!51, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 0x3FFDDDDD6098C70C}
!119 = !{i32 8}
!120 = !{!51, !43, i1 false, i2 -1}
!121 = !{!51, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x40219999A04F9640}
!123 = distinct !{!123, !23}
!124 = distinct !{!124, !23}
!125 = distinct !{!125, !23}
!126 = !{!51, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x4000E56081F5E3F2}
!128 = !{!51, !129, i1 false, i2 -1}
!129 = !{double 0.000000e+00, double 0x40249BA5F36F22F8}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = !{!134, !52, i1 false, i2 -1}
!134 = !{!"fixp", i32 32, i32 26}
!135 = !{!134, !136, i1 false, i2 -1}
!136 = !{double 0.000000e+00, double 0x404C6620AC841331}
!137 = !{!138, !1, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 23}
!139 = !{!138, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x407172475515D373}
!141 = distinct !{!141, !23}
!142 = distinct !{!142, !23}
!143 = distinct !{!143, !23}
...
!173 = !{!42, !81, i1 false, i2 1}
!174 = !{i1 false, !175, i1 false, i2 0}
!175 = !{double 4.000000e+01, double 4.000000e+01}
!176 = !{!134, !175, i1 false, i2 1}
!177 = !{!42, !178, i1 false, i2 1}
!178 = !{double 0.000000e+00, double 1.750000e-01}
!179 = !{!46, !49, i1 false, i2 1}
!180 = distinct !{!180, !23}
!181 = distinct !{!181, !23}
!182 = !{i1 false, !183, i1 false, i2 1}
!183 = !{double 3.000000e+00, double 1.700000e+01}
!184 = !{i1 false, !185, i1 false, i2 1}
!185 = !{double 0.000000e+00, double 2.380000e+02}
!186 = !{i1 false, !187, i1 false, i2 1}
!187 = !{double 0.000000e+00, double 1.100000e+01}
!188 = !{!51, !187, i1 false, i2 1}
!189 = !{i1 false, !190, i1 false, i2 0}
!190 = !{double 6.000000e+01, double 6.000000e+01}
!191 = !{!134, !190, i1 false, i2 1}
!192 = !{!193, !194, i1 false, i2 1}
!193 = !{!"fixp", i32 32, i32 31}
!194 = !{double 0.000000e+00, double 0x3FC7777777777777}
!195 = !{!46, !54, i1 false, i2 1}
!196 = distinct !{!196, !23}
!197 = distinct !{!197, !23}
!198 = !{i1 false, !199, i1 false, i2 1}
!199 = !{double 2.000000e+00, double 1.600000e+01}
!200 = !{i1 false, !201, i1 false, i2 1}
!201 = !{double 0.000000e+00, double 2.240000e+02}
!202 = !{i1 false, !203, i1 false, i2 1}
!203 = !{double 2.000000e+00, double 2.260000e+02}
!204 = !{i1 false, !205, i1 false, i2 1}
!205 = !{double 0.000000e+00, double 9.000000e+00}
!206 = !{!51, !205, i1 false, i2 1}
!207 = !{i1 false, !208, i1 false, i2 0}
!208 = !{double 5.000000e+01, double 5.000000e+01}
!209 = !{!134, !208, i1 false, i2 1}
!210 = !{!193, !211, i1 false, i2 1}
!211 = !{double 0.000000e+00, double 1.800000e-01}
!212 = !{!46, !56, i1 false, i2 1}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = !{!42, !43, i1 false, i2 1}
!216 = distinct !{!216, !23}
!217 = distinct !{!217, !23}
!218 = !{!51, !52, i1 false, i2 1}
!219 = distinct !{!219, !23}
!220 = distinct !{!220, !23}
!221 = !{!58, !1, i1 false, i2 1}
!222 = distinct !{!222, !23}
!223 = distinct !{!223, !23}
!224 = !{i32 -1, i32 -1, i32 3, i32 -1}
!225 = !{i32 1, !95, i32 1, !108, i32 1, !41, i32 1, !108}
!226 = !{!134, !109, i1 false, i2 1}
!227 = !{!134, !228, i1 false, i2 -1}
!228 = !{double 0.000000e+00, double 0x404BBBBBE878FABE}
!229 = !{i32 9}
!230 = distinct !{!230, !23}
!231 = distinct !{!231, !23}
!232 = !{i32 1, !95, i32 1, !16, i32 1, !45, i32 1, !108}
!233 = !{!51, !47, i1 false, i2 -1}
!234 = !{!51, !109, i1 false, i2 1}
!235 = !{!51, !236, i1 false, i2 -1}
!236 = !{double 0.000000e+00, double 0x40255554FBDAD752}
!237 = distinct !{!237, !23}
!238 = distinct !{!238, !23}
!239 = !{i32 1, !108, i32 1, !97, i32 1, !50, i32 1, !108}
!240 = !{!241, !242, i1 false, i2 -1}
!241 = !{!"fixp", i32 32, i32 25}
!242 = !{double 0.000000e+00, double 6.553600e+01}
!243 = distinct !{!243, !23}
!244 = distinct !{!244, !23}
!245 = !{i32 1, !95, i32 1, !97, i32 1, !57, i32 1, !108}
!246 = !{!247, !248, i1 false, i2 -1}
!247 = !{!"fixp", i32 32, i32 21}
!248 = !{double 0.000000e+00, double 0x409BCB067F0AA21A}
!249 = distinct !{!249, !23}
!250 = distinct !{!250, !23}
