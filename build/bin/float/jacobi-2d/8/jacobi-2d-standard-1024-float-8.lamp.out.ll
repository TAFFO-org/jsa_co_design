; ModuleID = './build/bin/float/jacobi-2d/8/jacobi-2d-standard-1024-float-8.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 15, i32 noundef 15, ptr noundef %arraydecay2, i32 noundef 1024)
  %arraydecay3 = getelementptr inbounds [15 x [15 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 15, i32 noundef 15, ptr noundef %arraydecay3, i32 noundef 1024)
