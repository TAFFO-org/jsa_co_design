; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-16-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 16), !taffo.info !58, !taffo.initweight !62, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 16), !taffo.info !65, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !50, !taffo.originalCall !67
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 16), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !52, !taffo.originalCall !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.info !53, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 16), !taffo.info !69, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.info !44, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 16), !taffo.info !58, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_bicg.4(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %s, float* noundef %q, float* noundef %p, float* noundef %r) #0 !taffo.initweight !113 !taffo.funinfo !114 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !115, !taffo.initweight !100, !taffo.constinfo !116
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !115, !taffo.initweight !100, !taffo.constinfo !116
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %2 = load float, float* %arrayidx11, align 4, !taffo.info !44, !taffo.initweight !106
  %mul = fmul float %1, %2, !taffo.info !118, !taffo.initweight !106
  %add = fadd float %0, %mul, !taffo.info !120, !taffo.initweight !106
  ...
  %4 = load float, float* %arrayidx15, align 4, !taffo.info !44, !taffo.initweight !106
  ...
  %mul17 = fmul float %4, %5, !taffo.info !122, !taffo.initweight !106
  %add18 = fadd float %3, %mul17, !taffo.info !124, !taffo.initweight !106
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %r, float* noundef %p, float* noundef %s, float* noundef %q) #0 !taffo.initweight !113 !taffo.funinfo !128 !taffo.sourceFunction !61 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !129, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !130, !taffo.initweight !59
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !131, !taffo.initweight !62

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %m, !taffo.info !133, !taffo.initweight !59
  %conv = sitofp i32 %rem to float, !taffo.info !135, !taffo.initweight !62
  %conv3 = sitofp i32 %m to float, !taffo.info !136
  %div = fdiv float %conv, %conv3, !taffo.info !137, !taffo.initweight !140
  %arrayidx = getelementptr inbounds float, float* %p, i32 %i.0, !taffo.info !141, !taffo.initweight !59
  store float %div, float* %arrayidx, align 4, !taffo.info !115, !taffo.initweight !62
  %arrayidx4 = getelementptr inbounds float, float* %s, i32 %i.0, !taffo.info !142, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !115, !taffo.initweight !62, !taffo.constinfo !116
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !143, !taffo.initweight !59, !taffo.constinfo !23
...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc29, %for.inc28 ], !taffo.info !129, !taffo.initweight !47
  %cmp6 = icmp slt i32 %i.1, %n, !taffo.info !130, !taffo.initweight !59
  br i1 %cmp6, label %for.body8, label %for.end30, !taffo.info !131, !taffo.initweight !62

for.body8:                                        ; preds = %for.cond5
  %rem9 = srem i32 %i.1, %n, !taffo.info !145, !taffo.initweight !59
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !146, !taffo.initweight !62
  %conv11 = sitofp i32 %n to float, !taffo.info !147
  %div12 = fdiv float %conv10, %conv11, !taffo.info !148, !taffo.initweight !140
  %arrayidx13 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.info !150, !taffo.initweight !59
  store float %div12, float* %arrayidx13, align 4, !taffo.info !115, !taffo.initweight !62
  %arrayidx14 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !151, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx14, align 4, !taffo.info !115, !taffo.initweight !62, !taffo.constinfo !116
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc25, %for.body8
  %j.0 = phi i32 [ 0, %for.body8 ], [ %inc26, %for.inc25 ], !taffo.info !145, !taffo.initweight !47
  %cmp16 = icmp slt i32 %j.0, %m, !taffo.info !130, !taffo.initweight !59
  br i1 %cmp16, label %for.body18, label %for.end27, !taffo.info !152, !taffo.initweight !62

for.body18:                                       ; preds = %for.cond15
  %add = add nsw i32 %j.0, 1, !taffo.info !154, !taffo.initweight !59, !taffo.constinfo !23
  %mul = mul nsw i32 %i.1, %add, !taffo.info !155, !taffo.initweight !59
  %rem19 = srem i32 %mul, %n, !taffo.info !145, !taffo.initweight !62
  %conv20 = sitofp i32 %rem19 to float, !taffo.info !146, !taffo.initweight !140
  %conv21 = sitofp i32 %n to float, !taffo.info !147
  %div22 = fdiv float %conv20, %conv21, !taffo.info !148, !taffo.initweight !100
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !150, !taffo.initweight !59
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx23, i32 0, i32 %j.0, !taffo.info !150, !taffo.initweight !59
  store float %div22, float* %arrayidx24, align 4, !taffo.info !115, !taffo.initweight !62
  br label %for.inc25

for.inc25:                                        ; preds = %for.body18
  %inc26 = add nsw i32 %j.0, 1, !taffo.info !154, !taffo.initweight !59, !taffo.constinfo !23
...
for.inc28:                                        ; preds = %for.end27
  %inc29 = add nsw i32 %i.1, 1, !taffo.info !143, !taffo.initweight !59, !taffo.constinfo !23
  br label %for.cond5, !llvm.loop !158
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !159 !taffo.funinfo !160 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !44, !taffo.initweight !161
  %conv = sitofp i32 %factor to float, !taffo.info !102
  %mul = fmul float %1, %conv, !taffo.info !162, !taffo.initweight !164
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !58, !taffo.initweight !161
  br label %for.inc
...
!54 = !{double 0.000000e+00, double 1.520000e+01}
...
!99 = !{double 1.600000e+01, double 1.600000e+01}
!100 = !{i32 5}
!101 = !{i32 6}
!102 = !{!45, !99, i1 false, i2 1}
!103 = !{!104, !105, i1 false, i2 -1}
!104 = !{!"fixp", i32 32, i32 17}
!105 = !{double 0.000000e+00, double 0x40DB5D175FF609DD}
!106 = !{i32 7}
!107 = distinct !{!107, !25}
!108 = !{i32 1, !85, i32 1, !53, i32 1, !98}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 32, i32 24}
!111 = !{double 0.000000e+00, double 2.432000e+02}
!112 = distinct !{!112, !25}
!113 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!114 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !48, i32 1, !51, i32 1, !53, i32 1, !44}
!115 = !{i1 false, i1 false, i1 false, i2 1}
!116 = !{!91, i1 false}
!117 = distinct !{!117, !25}
!118 = !{!110, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x406D2832B567D1B8}
!120 = !{!49, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x409F021DB6A30414}
!122 = !{!110, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x406D04A78798E615}
!124 = !{!49, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x409BCF2091120B9C}
!126 = distinct !{!126, !25}
!127 = distinct !{!127, !25}
!128 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !44, i32 1, !53, i32 1, !48, i32 1, !51}
!129 = !{i1 false, !80, i1 false, i2 1}
!130 = !{i1 false, !75, i1 false, i2 1}
...
!136 = !{!45, !86, i1 false, i2 1}
!137 = !{!138, !139, i1 false, i2 1}
!138 = !{!"fixp", i32 32, i32 31}
!139 = !{double 0.000000e+00, double 0x3FEE666666666666}
!140 = !{i32 4}
!141 = !{!45, !54, i1 false, i2 1}
!142 = !{!49, !1, i1 false, i2 1}
!143 = !{i1 false, !82, i1 false, i2 1}
!144 = distinct !{!144, !25}
!145 = !{i1 false, !73, i1 false, i2 1}
!146 = !{!45, !73, i1 false, i2 1}
!147 = !{!45, !88, i1 false, i2 1}
!148 = !{!138, !149, i1 false, i2 1}
!149 = !{double 0.000000e+00, double 0x3FEE8BA2E8BA2E8C}
!150 = !{!45, !46, i1 false, i2 1}
!151 = !{!49, !3, i1 false, i2 1}
!152 = !{i1 false, !153, i1 false, i2 1}
!153 = !{double 0.000000e+00, double 2.000000e+01}
!154 = !{i1 false, !77, i1 false, i2 1}
!155 = !{i1 false, !156, i1 false, i2 1}
!156 = !{double 0.000000e+00, double 4.620000e+02}
!157 = distinct !{!157, !25}
!158 = distinct !{!158, !25}
!159 = !{i32 -1, i32 -1, i32 3, i32 -1}
!160 = !{i32 1, !87, i32 1, !85, i32 1, !44, i32 1, !98}
!161 = !{i32 8}
!162 = !{!110, !163, i1 false, i2 -1}
!163 = !{double 0.000000e+00, double 0x406E8BA2DF9378EE}
!164 = !{i32 9}
!165 = distinct !{!165, !25}
!166 = distinct !{!166, !25}
