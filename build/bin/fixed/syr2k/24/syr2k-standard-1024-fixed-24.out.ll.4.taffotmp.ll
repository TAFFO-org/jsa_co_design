; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-1024-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.info !60, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 1024), !taffo.info !65, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 1024), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 1024), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
!53 = !{double 0.000000e+00, double 9.600000e+02}
...
!101 = !{double 1.024000e+03, double 1.024000e+03}
...
!107 = !{!"fixp", i32 32, i32 8}
!108 = !{i32 7}
!109 = !{!107, !110, i1 false, i2 -1}
!110 = !{double 0.000000e+00, double 0x41629655F3333333}
!111 = distinct !{!111, !23}
!112 = !{!113, !53, i1 false, i2 -1}
!113 = !{!"fixp", i32 32, i32 21}
!114 = !{!113, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 1.440000e+03}
!116 = !{!117, !118, i1 false, i2 -1}
!117 = !{!"fixp", i32 32, i32 10}
!118 = !{double 0.000000e+00, double 0x41343FFFF727136A}
!119 = !{!113, !55, i1 false, i2 -1}
!120 = !{!113, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x409599999029AE4F}
!122 = !{!107, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x41443FFFF727136A}
!124 = !{!107, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x41648D479DC9C4DA}
!126 = !{i32 8}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!184 = !{!"float", i32 1, double 0x41FEFA8F40000000}
!185 = !{double 0.000000e+00, double 0x41FEFA8F40000000}
!186 = !{i32 9}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
...
!192 = !{double 0.000000e+00, double 9.830400e+05}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
