; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-1-fixed-24.out.ll.4.taffotmp.ll'
...
for.body23:                                       ; preds = %for.cond21
  ...
  %1 = fdiv float %0, 0x41E0000000000000, !taffo.info !41, !taffo.target !42
  ...
  store float %1, float* %arrayidx26, align 4, !taffo.info !52, !taffo.target !42
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.10, i32 0, i32 0), double noundef %conv), !taffo.constinfo !59
  br label %for.inc
