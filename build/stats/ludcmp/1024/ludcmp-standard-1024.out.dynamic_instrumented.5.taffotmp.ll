; ModuleID = './build/stats/ludcmp/1024/ludcmp-standard-1024.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 1024), !taffo.originalCall !28
