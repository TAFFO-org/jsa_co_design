; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-512-fixed-11.out.ll.4.taffotmp.ll'
...
for.body6:                                        ; preds = %for.cond4
  ...
  %1 = fdiv float %0, 0x4150000000000000, !taffo.info !45
  ...
  %3 = fdiv float %2, 2.048000e+03, !taffo.info !48
  ...
  %5 = fdiv float %4, 2.048000e+03, !taffo.info !48
  %add12.1flp = fadd float %5, %mul.1flp, !taffo.info !93
  %6 = fmul float 2.048000e+03, %add12.1flp, !taffo.info !93
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 2.048000e+03, !taffo.info !48
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !155
  %3 = uitofp i32 %conv.u10_22fixp to float, !taffo.info !155
  %4 = fdiv float %3, 0x4150000000000000, !taffo.info !155
  ...
  %6 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !90
