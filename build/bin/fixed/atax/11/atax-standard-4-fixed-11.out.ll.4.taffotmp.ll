; ModuleID = './build/bin/fixed/atax/11/atax-standard-4-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 4), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.info !46, !taffo.initweight !56
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 4), !taffo.info !67, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 4), !taffo.info !70, !taffo.initweight !61, !taffo.constinfo !68, !taffo.target !51, !taffo.originalCall !69
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !56
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 4), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
...
for.body:                                         ; preds = %for.cond
  ...
  store float %mul, float* %arrayidx1, align 4, !taffo.info !67, !taffo.initweight !96
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  ...
  store float %mul, float* %arrayidx1, align 4, !taffo.info !70, !taffo.initweight !96
  br label %for.inc
...
for.body7:                                        ; preds = %for.cond5
  ...
  %0 = load float, float* %arrayidx8, align 4, !taffo.info !116, !taffo.initweight !96
  %arrayidx9 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.info !42, !taffo.initweight !94
  %arrayidx10 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx9, i32 0, i32 %j.0, !taffo.info !42, !taffo.initweight !96
  %1 = load float, float* %arrayidx10, align 4, !taffo.info !118, !taffo.initweight !101
  %arrayidx11 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.info !46, !taffo.initweight !94
  %2 = load float, float* %arrayidx11, align 4, !taffo.info !46, !taffo.initweight !96
  ...
  store float %add, float* %arrayidx12, align 4, !taffo.info !71, !taffo.initweight !96
  br label %for.inc13
...
for.body18:                                       ; preds = %for.cond16
  ...
  %3 = load float, float* %arrayidx19, align 4, !taffo.info !124, !taffo.initweight !96
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.info !42, !taffo.initweight !94
  %arrayidx21 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx20, i32 0, i32 %j.1, !taffo.info !42, !taffo.initweight !96
  ...
  %5 = load float, float* %arrayidx22, align 4, !taffo.info !52, !taffo.initweight !96
  %mul23 = fmul float %4, %5, !taffo.info !126, !taffo.initweight !101
  %add24 = fadd float %3, %mul23, !taffo.info !128, !taffo.initweight !101
  %arrayidx25 = getelementptr inbounds float, float* %y, i32 %j.1, !taffo.info !49, !taffo.initweight !94
  store float %add24, float* %arrayidx25, align 4, !taffo.info !70, !taffo.initweight !96
  br label %for.inc26

for.inc26:                                        ; preds = %for.body18
  %inc27 = add nsw i32 %j.1, 1, !taffo.info !85, !taffo.constinfo !21
  br label %for.cond16, !llvm.loop !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !90 !taffo.funinfo !132 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !133, !taffo.initweight !96
  %conv = sitofp i32 %factor to float, !taffo.info !97
...
entry:
  %conv = sitofp i32 %n to float, !taffo.info !138, !taffo.initweight !61
  br label %for.cond
...
for.body15:                                       ; preds = %for.cond12
  ...
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.info !165, !taffo.initweight !61
  %arrayidx21 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx20, i32 0, i32 %j.0, !taffo.info !165, !taffo.initweight !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !168 !taffo.funinfo !169 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !118, !taffo.initweight !170
  %conv = sitofp i32 %factor to float, !taffo.info !97
  %mul = fmul float %1, %conv, !taffo.info !171, !taffo.initweight !173
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !60, !taffo.initweight !170
  br label %for.inc
...
!48 = !{double 4.000000e+00, double 0x401F45D18090B418}
!49 = !{!50, !1, i1 false, i2 -1}
!50 = !{!"fixp", i32 32, i32 23}
!51 = !{!"y"}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 26}
!54 = !{double 0.000000e+00, double 0x404E851EC0B56755}
...
!94 = !{i32 5}
!95 = !{!53, !48, i1 false, i2 -1}
!96 = !{i32 6}
!97 = !{!98, !93, i1 false, i2 1}
!98 = !{!"fixp", i32 32, i32 29}
!99 = !{!53, !100, i1 false, i2 -1}
!100 = !{double 1.600000e+01, double 0x403F45D18090B418}
!101 = !{i32 7}
!102 = distinct !{!102, !23}
...
!107 = !{double 0.000000e+00, double 0x409EC418A009F623}
!108 = distinct !{!108, !23}
...
!118 = !{!98, !44, i1 false, i2 -1}
!119 = !{!98, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x401A44E32E8E07EB}
!121 = !{!117, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x4050E6DD93439429}
!123 = distinct !{!123, !23}
!124 = !{!125, !1, i1 false, i2 -1}
!125 = !{!"fixp", i32 32, i32 22}
!126 = !{!53, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x4049A3055A31FAA3}
!128 = !{!125, !129, i1 false, i2 -1}
!129 = !{double 0.000000e+00, double 0x4080FC3CA5A81ABC}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{i32 1, !111, i32 1, !52, i32 1, !92}
!133 = !{!134, !54, i1 false, i2 -1}
!134 = !{!"fixp", i32 32, i32 24}
!135 = !{!134, !136, i1 false, i2 -1}
!136 = !{double 0.000000e+00, double 0x406E851EC0B56755}
!137 = distinct !{!137, !23}
!138 = !{!139, !84, i1 false, i2 1}
...
!158 = !{!139, !157, i1 false, i2 -1}
!159 = !{i32 4}
!160 = !{i1 false, !161, i1 false, i2 0}
!161 = !{double 1.000000e+02, double 1.000000e+02}
!162 = !{!117, !161, i1 false, i2 1}
!163 = !{!43, !164, i1 false, i2 -1}
!164 = !{double 0.000000e+00, double 2.100000e-01}
!165 = !{!43, !44, i1 false, i2 1}
!166 = distinct !{!166, !23}
!167 = distinct !{!167, !23}
!168 = !{i32 -1, i32 -1, i32 3, i32 -1}
!169 = !{i32 1, !111, i32 1, !83, i32 1, !42, i32 1, !92}
!170 = !{i32 8}
!171 = !{!98, !172, i1 false, i2 -1}
!172 = !{double 0.000000e+00, double 3.360000e+00}
!173 = !{i32 9}
!174 = distinct !{!174, !23}
!175 = distinct !{!175, !23}
