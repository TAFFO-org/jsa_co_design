; ModuleID = './build/bin/fixed/jacobi-1d/16/jacobi-1d-standard-4-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x41C0000000000000, !taffo.info !41, !taffo.target !44
