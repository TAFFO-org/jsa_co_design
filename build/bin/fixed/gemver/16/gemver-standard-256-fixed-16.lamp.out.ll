; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-256-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 5.120000e+02, !taffo.info !69
...
for.body43:                                       ; preds = %for.cond41
  ...
  %3 = fdiv float %lampsim8, 1.310720e+05, !taffo.info !52
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u16_16fixp, 8, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !133 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !134
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !135
  %conv.u9_23fixp = shl i32 %factor, 23, !taffo.info !125
  %0 = uitofp i32 %conv.u9_23fixp to float, !taffo.info !125
  %lampsim = bitcast float %0 to i32
  %lampsim1 = and i32 %lampsim, -256
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 0x4160000000000000, !taffo.info !125
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -256
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !136
  %lampsim7 = bitcast float %mul.1flp6 to i32
  %lampsim8 = and i32 %lampsim7, -256
  %lampsim9 = bitcast i32 %lampsim8 to float
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !134
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !140 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u14_18fixp, 8, !taffo.info !144
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !147 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim7 = and i32 %lampsim6, -256
  %lampsim8 = bitcast i32 %lampsim7 to float
  %3 = fdiv float %lampsim8, 0x4160000000000000, !taffo.info !125
  %lampsim9 = bitcast float %3 to i32
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  ...
  %4 = fmul float 5.120000e+02, %lampsim15, !taffo.info !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !152 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 18), !taffo.info !153
  %mul.u13_19fixp = shl i32 %4, 1, !taffo.info !156
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u13_19fixp, 8, !taffo.info !156
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u15_17fixp = load i32, i32* %arrayidx4.u15_17fixp, align 4, !taffo.info !162
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !163
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !165
  %5 = lshr i32 %u15_17fixp, 1, !taffo.info !162
  %add.u16_16fixp = add i32 %5, %mul.u16_16fixp, !taffo.info !166
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 18), !taffo.info !168
  %mul9.u13_19fixp = shl i32 %10, 1, !taffo.info !170
  %11 = lshr i32 %mul9.u13_19fixp, 3, !taffo.info !170
  %add10.u16_16fixp = add i32 %add.u16_16fixp, %11, !taffo.info !171
  ...
  %12 = shl i32 %add10.u16_16fixp, 1, !taffo.info !171
...
for.body21:                                       ; preds = %for.cond19
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %14, i32 16), !taffo.info !175
  %mul25.u15_17fixp = shl i32 %16, 1, !taffo.info !178
  ...
  %17 = lshr i32 %mul25.u15_17fixp, 1, !taffo.info !178
  %18 = lshr i32 %u6_26fixp4, 1, !taffo.info !71
  %19 = ashr i32 %17, 5, !taffo.info !178
  %20 = ashr i32 %18, 14, !taffo.info !71
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 11), !taffo.info !179
  %mul27.u20_12fixp = shl i32 %21, 1, !taffo.info !182
  %22 = lshr i32 %mul27.u20_12fixp, 3, !taffo.info !182
  %add28.u23_9fixp = add i32 %u23_9fixp, %22, !taffo.info !184
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u23_9fixp = add i32 %u23_9fixp2, %23, !taffo.info !188
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !134
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !135
  ...
  %lampsim1 = and i32 %lampsim, -256
  %lampsim2 = bitcast i32 %lampsim1 to float
  %29 = fdiv float %lampsim2, 1.310720e+05, !taffo.info !193
  ...
  %lampsim7 = and i32 %lampsim6, -256
  %lampsim8 = bitcast i32 %lampsim7 to float
  %31 = fdiv float %lampsim8, 5.120000e+02, !taffo.info !69
  %lampsim9 = bitcast float %31 to i32
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul57.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !194
  %lampsim13 = bitcast float %mul57.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -256
  %lampsim15 = bitcast i32 %lampsim14 to float
  %add58.1flp16 = fadd float %.flt.fallback.1flp, %lampsim15, !taffo.info !197
  %lampsim17 = bitcast float %add58.1flp16 to i32
  %lampsim18 = and i32 %lampsim17, -256
  %lampsim19 = bitcast i32 %lampsim18 to float
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !134
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !202 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !203
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !205
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u15_17fixp, 8, !taffo.info !205
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u15_17fixp, i32* noundef %u1.u8_24fixp, i32* noundef %v1.u7_25fixp, i32* noundef %u2.u8_24fixp, i32* noundef %v2.u6_26fixp, float* noundef %w, i32* noundef %x.u23_9fixp, i32* noundef %y.u6_26fixp, i32* noundef %z.u5_27fixp) #0 !taffo.initweight !207 !taffo.funinfo !160 !taffo.sourceFunction !208 {
entry:
...
!129 = !{double 0.000000e+00, double 0x40EE6666601BC98A}
!130 = !{!131, !129, i1 false, i2 -1}
!131 = !{!"fixp", i32 32, i32 16}
!132 = distinct !{!132, !27}
!133 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!134 = !{i32 5}
!135 = !{i32 6}
!136 = !{!137, !138, i1 false, i2 -1}
!137 = !{!"float", i32 1, double 0x42F311BCA0000000}
!138 = !{double 0.000000e+00, double 0x42F311BCA0000000}
!139 = distinct !{!139, !27}
!140 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!141 = !{!142, !143, i1 false, i2 -1}
!142 = !{!"fixp", i32 -32, i32 17}
!143 = !{double 0x40811110E453D20F, double 0x40C555556084A516}
!144 = !{!145, !143, i1 false, i2 -1}
!145 = !{!"fixp", i32 32, i32 18}
!146 = distinct !{!146, !27}
!147 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!148 = !{!149, !150, i1 false, i2 -1}
!149 = !{!"float", i32 1, double 0x41D5D7B540000000}
!150 = !{double 0.000000e+00, double 0x41D5D7B540000000}
!151 = distinct !{!151, !27}
!152 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!153 = !{!154, !155, i1 false, i2 -1}
!154 = !{!"fixp", i32 -32, i32 18}
!155 = !{double 0x4076C16BDB1A6D6A, double 0x40BC71C725C3DEE8}
...
!160 = !{i32 1, !107, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !60, i32 1, !62, i32 1, !65, i32 1, !69, i32 1, !71, i32 1, !73}
!161 = distinct !{null}
!162 = !{!131, !5, i1 false, i2 -1}
!163 = !{!128, !164, i1 false, i2 -1}
!164 = !{double 0.000000e+00, double 0x40CE6666601BC98A}
!165 = !{!131, !164, i1 false, i2 -1}
!166 = !{!131, !167, i1 false, i2 -1}
!167 = !{double 0.000000e+00, double 0x40E1DF777807789A}
!168 = !{!154, !169, i1 false, i2 -1}
!169 = !{double 0x402B4E816D52E9B2, double 0x40B555556084A516}
!170 = !{!157, !169, i1 false, i2 -1}
!171 = !{!131, !172, i1 false, i2 -1}
!172 = !{double 0x402B4E816D52E9B2, double 0x40E48A2224180D3D}
!173 = distinct !{!173, !27}
!174 = distinct !{!174, !27}
!175 = !{!176, !177, i1 false, i2 -1}
!176 = !{!"fixp", i32 -32, i32 16}
!177 = !{double 0.000000e+00, double 0x40D8A7AE199ADBB8}
!178 = !{!53, !177, i1 false, i2 -1}
!179 = !{!180, !181, i1 false, i2 -1}
!180 = !{!"fixp", i32 -32, i32 11}
!181 = !{double 0.000000e+00, double 0x4128A7AE199ADBB8}
!182 = !{!183, !181, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 12}
!184 = !{!70, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 0x4158ECAB03335B77}
!186 = distinct !{!186, !27}
!187 = distinct !{!187, !27}
!188 = !{!70, !189, i1 false, i2 -1}
!189 = !{double 0x3FF6C16BDB1A6D6A, double 0x4155D7BC5C71C971}
!190 = distinct !{!190, !27}
...
!200 = distinct !{!200, !27}
!201 = distinct !{!201, !27}
!202 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!203 = !{!176, !204, i1 false, i2 -1}
!204 = !{double 8.192000e+02, double 1.638400e+04}
!205 = !{!53, !204, i1 false, i2 -1}
!206 = distinct !{!206, !27}
