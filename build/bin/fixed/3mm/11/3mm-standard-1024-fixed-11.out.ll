; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-1024-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u8_24fixp3 = bitcast [8 x i32]* %arraydecay16.u8_24fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u8_24fixp3, i32 1024), !taffo.info !65, !taffo.constinfo !63
  ...
  %u8_24fixp = bitcast [14 x i32]* %arraydecay18.u8_24fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u8_24fixp, i32 1024), !taffo.info !67, !taffo.constinfo !63
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !231 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !237
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !239
  ...
  %7 = shl i32 %mul.u18_14fixp, 10, !taffo.info !239
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !242 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !243
  %mul.u27_5fixp = shl i32 %5, 1, !taffo.info !246
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u27_5fixp, 10, !taffo.info !246
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !250 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %.flt.fallback.1flp = load float, float* %arrayidx4.flt.1flp, align 4, !taffo.info !56, !taffo.initweight !251
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !235
  %1 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !235
  %2 = fdiv float %1, 0x4140000000000000, !taffo.info !235
  %mul.1flp = fmul float %.flt.fallback.1flp, %2, !taffo.info !252
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u18_14fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !257 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 3), !taffo.info !258
  %mul.u28_4fixp = shl i32 %5, 1, !taffo.info !261
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u28_4fixp, 10, !taffo.info !261
...
!238 = !{double 0.000000e+00, double 0x410555556084A516}
!239 = !{!50, !238, i1 false, i2 -1}
!240 = distinct !{!240, !23}
!241 = distinct !{!241, !23}
!242 = !{i32 1, !87, i32 1, !100, i32 1, !41, i32 1, !232}
!243 = !{!244, !245, i1 false, i2 -1}
!244 = !{!"fixp", i32 -32, i32 4}
!245 = !{double 0.000000e+00, double 0x419BBBBBE0008638}
!246 = !{!247, !245, i1 false, i2 -1}
!247 = !{!"fixp", i32 32, i32 5}
!248 = distinct !{!248, !23}
!249 = distinct !{!249, !23}
!250 = !{i32 1, !87, i32 1, !89, i32 1, !56, i32 1, !232}
!251 = !{i32 8}
!252 = !{!253, !254, i1 false, i2 -1}
!253 = !{!"float", i32 1, double 0x42CBCB0680000000}
!254 = !{double 0.000000e+00, double 0x42CBCB0680000000}
!255 = distinct !{!255, !23}
!256 = distinct !{!256, !23}
!257 = !{i32 1, !100, i32 1, !89, i32 1, !49, i32 1, !232}
!258 = !{!259, !260, i1 false, i2 -1}
!259 = !{!"fixp", i32 -32, i32 3}
!260 = !{double 0.000000e+00, double 0x41A0624DE0000000}
!261 = !{!262, !260, i1 false, i2 -1}
!262 = !{!"fixp", i32 32, i32 4}
!263 = distinct !{!263, !23}
!264 = distinct !{!264, !23}
