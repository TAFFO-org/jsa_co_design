...
entry:
  ...
  call void @llvm.var.annotation(i8* %tmp3, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 131, i8* null)
  %A4 = bitcast [8 x [12 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 132, i8* null)
  %B5 = bitcast [12 x [10 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B5, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 133, i8* null)
  %C6 = bitcast [10 x [14 x float]]* %C to i8*
  call void @llvm.var.annotation(i8* %C6, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 134, i8* null)
  %D7 = bitcast [8 x [14 x float]]* %D to i8*
  call void @llvm.var.annotation(i8* %D7, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 135, i8* null)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 12, float* noundef %4, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 12, i32 noundef 10, float* noundef %5, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 14, float* noundef %6, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 14, float* noundef %7, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 8, i32 noundef 10, float* noundef %8, i32 noundef 1024)
