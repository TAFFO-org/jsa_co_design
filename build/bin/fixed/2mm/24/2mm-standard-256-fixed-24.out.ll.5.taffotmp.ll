; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-256-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_2mm.3_fixp(i32 8, i32 10, i32 12, i32 14, i32 %u2_30fixp1, i32 %u2_30fixp, [10 x i32]* %arraydecay17.u19_13fixp, [12 x i32]* %arraydecay18.u8_24fixp, [10 x i32]* %arraydecay19.u8_24fixp, [14 x i32]* %arraydecay20.u8_24fixp, [14 x i32]* %arraydecay21.u29_3fixp), !taffo.info !60, !taffo.constinfo !61
...
for.body24:                                       ; preds = %for.cond22
  ...
  %1 = fdiv float %0, 8.000000e+00, !taffo.info !57, !taffo.target !59
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u29_3fixp, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !218 !taffo.sourceFunction !219 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 8.000000e+00, !taffo.info !57
  %conv.u9_23fixp = shl i32 %factor, 23, !taffo.info !220
  %3 = uitofp i32 %conv.u9_23fixp to float, !taffo.info !220
  %4 = fdiv float %3, 0x4160000000000000, !taffo.info !220
  %mul.1flp = fmul float %2, %4, !taffo.info !221
  ...
  %6 = fmul float 8.000000e+00, %mul.1flp, !taffo.info !221
  %7 = fptoui float %6 to i32, !taffo.info !221
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !226 !taffo.sourceFunction !219 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !227
  %mul.u27_5fixp = shl i32 %5, 1, !taffo.info !230
  ...
  %7 = shl i32 %mul.u27_5fixp, 8, !taffo.info !230
...
!222 = !{!"float", i32 1, double 0x42332E6660000000}
!223 = !{double 0.000000e+00, double 0x42332E6660000000}
!224 = distinct !{!224, !23}
!225 = distinct !{!225, !23}
!226 = !{i32 1, !85, i32 1, !16, i32 1, !47, i32 1, !97}
!227 = !{!228, !229, i1 false, i2 -1}
!228 = !{!"fixp", i32 -32, i32 4}
!229 = !{double 0.000000e+00, double 0x4192733320000000}
!230 = !{!231, !229, i1 false, i2 -1}
!231 = !{!"fixp", i32 32, i32 5}
!232 = distinct !{!232, !23}
!233 = distinct !{!233, !23}
