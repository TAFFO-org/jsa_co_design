; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-128-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.info !85, !taffo.initweight !77, !taffo.constinfo !88, !taffo.originalCall !89
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 128), !taffo.info !90, !taffo.initweight !77, !taffo.constinfo !88, !taffo.originalCall !89
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 128), !taffo.info !92, !taffo.initweight !93, !taffo.constinfo !94, !taffo.originalCall !95
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.info !55, !taffo.initweight !77
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 128), !taffo.info !96, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.info !58, !taffo.initweight !77
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 128), !taffo.info !99, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.info !61, !taffo.initweight !77
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 128), !taffo.info !100, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.info !63, !taffo.initweight !77
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 128), !taffo.info !101, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 128), !taffo.info !102, !taffo.initweight !91, !taffo.constinfo !97, !taffo.target !68, !taffo.originalCall !98
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.info !69, !taffo.initweight !77
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 128), !taffo.info !103, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !71, !taffo.initweight !77
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 128), !taffo.info !104, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.info !73, !taffo.initweight !77
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 128), !taffo.info !105, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
...
!54 = !{!"fixp", i32 32, i32 19}
!55 = !{!56, !57, i1 false, i2 -1}
!56 = !{!"fixp", i32 32, i32 25}
!57 = !{double 0.000000e+00, double 0x405E66665E02EA96}
!58 = !{!59, !60, i1 false, i2 -1}
!59 = !{!"fixp", i32 32, i32 26}
!60 = !{double 1.600000e+00, double 3.200000e+01}
!61 = !{!56, !62, i1 false, i2 -1}
!62 = !{double 3.200000e+00, double 6.400000e+01}
!63 = !{!64, !65, i1 false, i2 -1}
!64 = !{!"fixp", i32 32, i32 27}
!65 = !{double 0x3FF111116A8B8F15, double 0x403555556084A516}
!66 = !{!67, !3, i1 false, i2 -1}
!67 = !{!"float", i32 1, double 0x4223695F40000000}
!68 = !{!"w"}
...
!143 = !{!"fixp", i32 32, i32 18}
!144 = !{double 0.000000e+00, double 0x40CE66665E02EA96}
!145 = !{i32 7}
!146 = distinct !{!146, !27}
!147 = !{i32 1, !122, i32 1, !58, i32 1, !134}
!148 = !{!54, !149, i1 false, i2 -1}
!149 = !{double 2.048000e+02, double 4.096000e+03}
!150 = distinct !{!150, !27}
!151 = !{i32 1, !122, i32 1, !63, i32 1, !134}
!152 = !{!153, !154, i1 false, i2 -1}
!153 = !{!"fixp", i32 32, i32 20}
!154 = !{double 0x406111116A8B8F15, double 0x40A555556084A516}
!155 = distinct !{!155, !27}
!156 = !{i32 1, !122, i32 1, !66, i32 1, !134}
!157 = !{!158, !159, i1 false, i2 -1}
!158 = !{!"float", i32 1, double 0x4293695F40000000}
!159 = !{double 0.000000e+00, double 0x4293695F40000000}
!160 = distinct !{!160, !27}
!161 = !{i32 1, !122, i32 1, !69, i32 1, !134}
!162 = !{!163, !164, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 5}
!164 = !{double 0.000000e+00, double 0x4195FC45A0000000}
!165 = distinct !{!165, !27}
...
!170 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!171 = !{!143, !172, i1 false, i2 -1}
!172 = !{double 0.000000e+00, double 0x40C1E111077CCC04}
!173 = !{i32 8}
!174 = !{!175, !176, i1 false, i2 -1}
!175 = !{!"fixp", i32 32, i32 21}
!176 = !{double 0x400B4E8244127E88, double 0x409555556084A516}
!177 = !{!143, !178, i1 false, i2 -1}
!178 = !{double 0x400B4E8244127E88, double 0x40C48BBBB38D60A7}
!179 = distinct !{!179, !27}
!180 = distinct !{!180, !27}
!181 = !{!54, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 0x40B8AB850CC35CE1}
!183 = !{!184, !185, i1 false, i2 -1}
!184 = !{!"fixp", i32 32, i32 15}
!185 = !{double 0.000000e+00, double 0x40F8AB850CC35CE1}
!186 = !{!70, !187, i1 false, i2 -1}
!187 = !{double 0.000000e+00, double 0x412911B641986B9C}
!188 = distinct !{!188, !27}
!189 = distinct !{!189, !27}
!190 = !{!70, !191, i1 false, i2 -1}
!191 = !{double 7.111110e-01, double 0x4125FC6211C714FD}
!192 = distinct !{!192, !27}
!193 = !{!54, !194, i1 false, i2 -1}
!194 = !{double 0.000000e+00, double 0x40BED6664FF4341A}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"float", i32 1, double 0x41F52FCEA2AA8142}
!197 = !{double 0.000000e+00, double 0x41F52FCEA2AA8142}
!198 = !{!199, !200, i1 false, i2 -1}
!199 = !{!"float", i32 1, double 0x42260F5914555028}
!200 = !{double 0.000000e+00, double 0x42260F5914555028}
!201 = distinct !{!201, !27}
!202 = distinct !{!202, !27}
!203 = !{i32 1, !122, i32 1, !73, i32 1, !134}
!204 = !{!175, !205, i1 false, i2 -1}
!205 = !{double 0x4056C16BDB1A6D6A, double 0x409C71C714FCE747}
!206 = distinct !{!206, !27}
...
!280 = !{double 0.000000e+00, double 0x41248EEEDFF822BC}
!281 = !{i32 9}
!282 = distinct !{!282, !27}
!283 = distinct !{!283, !27}
