; ModuleID = './build/bin/fixed/gesummv/8/gesummv-standard-64-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_gesummv.5_fixp(i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay17.u6_26fixp, [16 x i32]* %arraydecay18.u6_26fixp, i32* %arraydecay19.u15_17fixp, i32* %arraydecay20.u6_26fixp, i32* %arraydecay21.u16_16fixp), !taffo.info !57, !taffo.constinfo !58
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 6.553600e+04, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u16_16fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 9), !taffo.info !92
  %mul.u22_10fixp = shl i32 %4, 1, !taffo.info !95
  %arrayidx1.u16_16fixp = getelementptr inbounds i32, i32* %val.u16_16fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u22_10fixp, 6, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !98 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !99
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !102
  ...
  %7 = shl i32 %mul.u12_20fixp, 6, !taffo.info !102
...
!93 = !{!"fixp", i32 -32, i32 9}
!94 = !{double 0.000000e+00, double 0x4146A66680000000}
!95 = !{!96, !94, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 10}
!97 = distinct !{!97, !23}
!98 = !{i32 1, !75, i32 1, !48, i32 1, !84}
!99 = !{!100, !101, i1 false, i2 -1}
!100 = !{!"fixp", i32 -32, i32 19}
!101 = !{double 0.000000e+00, double 3.840000e+03}
!102 = !{!103, !101, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 20}
!104 = distinct !{!104, !23}
