; ModuleID = './build/bin/fixed/mvt/16/mvt-standard-512-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 512), !taffo.info !56, !taffo.initweight !60, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 512), !taffo.info !63, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !50, !taffo.originalCall !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 512), !taffo.info !66, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !52, !taffo.originalCall !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 512), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 512), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
...
!95 = !{!"float", i32 1, double 0x41C39B4CE0000000}
!96 = !{double 0.000000e+00, double 0x41C39B4CE0000000}
!97 = !{i32 7}
!98 = distinct !{!98, !25}
!99 = !{i32 1, !77, i32 1, !44, i32 1, !88}
!100 = !{!101, !102, i1 false, i2 -1}
!101 = !{!"fixp", i32 32, i32 14}
!102 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!103 = distinct !{!103, !25}
...
!107 = !{double 0.000000e+00, double 0x410CE147A22050D9}
!108 = !{!49, !109, i1 false, i2 -1}
!109 = !{double 0.000000e+00, double 0x41373775D4440A1B}
!110 = distinct !{!110, !25}
!111 = distinct !{!111, !25}
!112 = !{!49, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x4137838F54440A1B}
!114 = distinct !{!114, !25}
!115 = distinct !{!115, !25}
