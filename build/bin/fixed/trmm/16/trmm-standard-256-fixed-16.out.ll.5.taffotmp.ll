; ModuleID = './build/bin/fixed/trmm/16/trmm-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %A.u9_23fixp = alloca [10 x [10 x i32]], align 4, !taffo.info !45
  %B.u19_13fixp = alloca [10 x [16 x i32]], align 4, !taffo.info !48, !taffo.target !50
  %arraydecay.u9_23fixp = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %A.u9_23fixp, i32 0, i32 0, !taffo.info !45
  %arraydecay4.u19_13fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u19_13fixp, i32 0, i32 0, !taffo.info !48, !taffo.target !50
  call void @init_array.3_fixp(i32 10, i32 16, i32* %alpha.u2_30fixp, [10 x i32]* %arraydecay.u9_23fixp, [16 x i32]* %arraydecay4.u19_13fixp), !taffo.info !51, !taffo.constinfo !52
  call void @scale_scalar.1_fixp(i32* %alpha.u2_30fixp, i32 256), !taffo.info !51, !taffo.constinfo !53
  %arraydecay5.u9_23fixp = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %A.u9_23fixp, i32 0, i32 0, !taffo.info !45
  %u9_23fixp = bitcast [10 x i32]* %arraydecay5.u9_23fixp to i32*, !taffo.info !45
  call void @scale_2d.4_fixp(i32 10, i32 10, i32* %u9_23fixp, i32 256), !taffo.info !54, !taffo.constinfo !55
  %arraydecay6.u19_13fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u19_13fixp, i32 0, i32 0, !taffo.info !48, !taffo.target !50
  %u19_13fixp = bitcast [16 x i32]* %arraydecay6.u19_13fixp to i32*, !taffo.info !48, !taffo.target !50
  call void @scale_2d.5_fixp(i32 10, i32 16, i32* %u19_13fixp, i32 256), !taffo.info !56, !taffo.constinfo !55, !taffo.target !50
  call void @timer_start(), !taffo.constinfo !57
  %u2_30fixp = load i32, i32* %alpha.u2_30fixp, align 4, !taffo.info !42
  %arraydecay7.u9_23fixp = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %A.u9_23fixp, i32 0, i32 0, !taffo.info !45
  %arraydecay8.u19_13fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u19_13fixp, i32 0, i32 0, !taffo.info !48, !taffo.target !50
  call void @kernel_trmm.2_fixp(i32 10, i32 16, i32 %u2_30fixp, [10 x i32]* %arraydecay7.u9_23fixp, [16 x i32]* %arraydecay8.u19_13fixp), !taffo.info !51, !taffo.constinfo !52
...
for.body11:                                       ; preds = %for.cond9
  %arrayidx.u19_13fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u19_13fixp, i32 0, i32 %i.0, !taffo.info !48, !taffo.target !50
  %arrayidx12.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u19_13fixp, i32 0, i32 %j.0, !taffo.info !48, !taffo.target !50
  %u19_13fixp1 = load i32, i32* %arrayidx12.u19_13fixp, align 4, !taffo.info !48, !taffo.target !50
  %0 = uitofp i32 %u19_13fixp1 to float, !taffo.info !48, !taffo.target !50
  %1 = fdiv float %0, 8.192000e+03, !taffo.info !48, !taffo.target !50
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_trmm.2_fixp(i32 noundef %m, i32 noundef %n, i32 noundef %alpha.u2_30fixp, [10 x i32]* noundef %A.u9_23fixp, [16 x i32]* noundef %B.u19_13fixp) #0 !taffo.initweight !85 !taffo.funinfo !86 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body6:                                        ; preds = %for.cond4
  %arrayidx.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u9_23fixp, i32 %k.0, !taffo.info !45
  %arrayidx7.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u9_23fixp, i32 0, i32 %i.0, !taffo.info !45
  %u9_23fixp = load i32, i32* %arrayidx7.u9_23fixp, align 4, !taffo.info !45
  %arrayidx8.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u19_13fixp, i32 %k.0, !taffo.info !48
  %arrayidx9.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx8.u19_13fixp, i32 0, i32 %j.0, !taffo.info !48
  %u19_13fixp = load i32, i32* %arrayidx9.u19_13fixp, align 4, !taffo.info !48
  %0 = lshr i32 %u9_23fixp, 1, !taffo.info !45
  %1 = lshr i32 %u19_13fixp, 1, !taffo.info !48
  %2 = ashr i32 %0, 18, !taffo.info !45
  ...
  %arrayidx10.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u19_13fixp, i32 %i.0, !taffo.info !48
  %arrayidx11.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx10.u19_13fixp, i32 0, i32 %j.0, !taffo.info !48
  %u19_13fixp1 = load i32, i32* %arrayidx11.u19_13fixp, align 4, !taffo.info !48
  %5 = lshr i32 %u19_13fixp1, 8, !taffo.info !48
  %add12.u27_5fixp = add i32 %5, %mul.u27_5fixp, !taffo.info !95
  %6 = shl i32 %add12.u27_5fixp, 8, !taffo.info !95
  store i32 %6, i32* %arrayidx11.u19_13fixp, align 4, !taffo.info !56
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  %arrayidx13.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u19_13fixp, i32 %i.0, !taffo.info !48
  %arrayidx14.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx13.u19_13fixp, i32 0, i32 %j.0, !taffo.info !48
  %u19_13fixp2 = load i32, i32* %arrayidx14.u19_13fixp, align 4, !taffo.info !48
  %7 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %8 = lshr i32 %u19_13fixp2, 1, !taffo.info !48
  %9 = ashr i32 %7, 17, !taffo.info !42
  %10 = call i32 @llvm.smul.fix.i32(i32 %9, i32 %8, i32 12), !taffo.info !98
  %mul15.u19_13fixp = shl i32 %10, 1, !taffo.info !101
  %arrayidx16.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u19_13fixp, i32 %i.0, !taffo.info !48
  %arrayidx17.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx16.u19_13fixp, i32 0, i32 %j.0, !taffo.info !48
  store i32 %mul15.u19_13fixp, i32* %arrayidx17.u19_13fixp, align 4, !taffo.info !51
  br label %for.inc18
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.3_fixp(i32 noundef %m, i32 noundef %n, i32* noundef %alpha.u2_30fixp, [10 x i32]* noundef %A.u9_23fixp, [16 x i32]* noundef %B.u19_13fixp) #0 !taffo.initweight !104 !taffo.funinfo !86 !taffo.sourceFunction !105 {
entry:
...
if.then:                                          ; preds = %for.body5
  ...
  %arrayidx.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u9_23fixp, i32 %i.0, !taffo.info !130
  %arrayidx8.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u9_23fixp, i32 0, i32 %j.0, !taffo.info !130
  %3 = lshr i32 %div.u1_31fixp, 8, !taffo.info !128
  store i32 %3, i32* %arrayidx8.u9_23fixp, align 4, !taffo.info !131
  br label %if.end

if.else:                                          ; preds = %for.body5
  %arrayidx9.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u9_23fixp, i32 %i.0, !taffo.info !130
  %arrayidx10.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx9.u9_23fixp, i32 0, i32 %j.0, !taffo.info !130
  store i32 0, i32* %arrayidx10.u9_23fixp, align 4, !taffo.info !131, !taffo.constinfo !132
  br label %if.end
...
for.end:                                          ; preds = %for.cond3
  %arrayidx11.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u9_23fixp, i32 %i.0, !taffo.info !130
  %arrayidx12.u9_23fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx11.u9_23fixp, i32 0, i32 %i.0, !taffo.info !130
  store i32 8388608, i32* %arrayidx12.u9_23fixp, align 4, !taffo.info !131, !taffo.constinfo !136
  br label %for.cond13
...
for.body16:                                       ; preds = %for.cond13
  ...
  %arrayidx22.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u19_13fixp, i32 %i.0, !taffo.info !149
  %arrayidx23.u19_13fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx22.u19_13fixp, i32 0, i32 %j.1, !taffo.info !149
  %8 = lshr i32 %div21.u1_31fixp, 18, !taffo.info !148
  store i32 %8, i32* %arrayidx23.u19_13fixp, align 4, !taffo.info !131
  br label %for.inc24
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !153 !taffo.funinfo !154 !taffo.sourceFunction !155 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u9_23fixp = shl i32 %factor, 23, !taffo.info !156
  %1 = lshr i32 %u9_23fixp, 1, !taffo.info !45
  %2 = lshr i32 %conv.u9_23fixp, 1, !taffo.info !156
  %3 = ashr i32 %1, 8, !taffo.info !45
  %4 = ashr i32 %2, 8, !taffo.info !156
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 14), !taffo.info !157
  %mul.u17_15fixp = shl i32 %5, 1, !taffo.info !160
  ...
  %7 = shl i32 %mul.u17_15fixp, 8, !taffo.info !160
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !153 !taffo.funinfo !164 !taffo.sourceFunction !155 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %0 = mul nsw i32 %i.0, %m, !taffo.info !76
  %arrayidx.u19_13fixp = getelementptr inbounds i32, i32* %val.u19_13fixp, i32 %0, !taffo.info !48
  %arrayidx4.u19_13fixp = getelementptr inbounds i32, i32* %arrayidx.u19_13fixp, i32 %j.0, !taffo.info !48
  %u19_13fixp = load i32, i32* %arrayidx4.u19_13fixp, align 4, !taffo.info !48
  %conv.u9_23fixp = shl i32 %factor, 23, !taffo.info !156
  %1 = lshr i32 %u19_13fixp, 1, !taffo.info !48
  %2 = lshr i32 %conv.u9_23fixp, 1, !taffo.info !156
  %3 = ashr i32 %1, 8, !taffo.info !48
  %4 = ashr i32 %2, 18, !taffo.info !156
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !90
  %mul.u27_5fixp = shl i32 %5, 1, !taffo.info !93
  %6 = mul nsw i32 %i.0, %m, !taffo.info !76
  %arrayidx5.u19_13fixp = getelementptr inbounds i32, i32* %val.u19_13fixp, i32 %6, !taffo.info !48
  %arrayidx6.u19_13fixp = getelementptr inbounds i32, i32* %arrayidx5.u19_13fixp, i32 %j.0, !taffo.info !48
  %7 = shl i32 %mul.u27_5fixp, 8, !taffo.info !93
  store i32 %7, i32* %arrayidx6.u19_13fixp, align 4, !taffo.info !56
  br label %for.inc
...
!47 = !{double 0.000000e+00, double 2.560000e+02}
!48 = !{!49, !1, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 13}
!50 = !{!"B"}
...
!83 = !{double 2.560000e+02, double 2.560000e+02}
...
!92 = !{double 0.000000e+00, double 0x4194D24000000000}
!93 = !{!94, !92, i1 false, i2 -1}
!94 = !{!"fixp", i32 32, i32 5}
!95 = !{!94, !96, i1 false, i2 -1}
!96 = !{double 0.000000e+00, double 0x4194E71240000000}
!97 = distinct !{!97, !23}
!98 = !{!99, !100, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 12}
!100 = !{double 0.000000e+00, double 5.117040e+05}
