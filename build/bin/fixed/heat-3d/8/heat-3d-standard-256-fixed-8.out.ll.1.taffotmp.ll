...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 113, i8* null)
  %B2 = bitcast [5 x [5 x [5 x float]]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 114, i8* null)
  ...
  call void @scale_3d(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 256)
  ...
  call void @scale_3d(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %2, i32 noundef 256)
