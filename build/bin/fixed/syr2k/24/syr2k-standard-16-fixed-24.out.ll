; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-16-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u4_28fixp2, i32 16), !taffo.info !61, !taffo.constinfo !60
  ...
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u4_28fixp, i32 16), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u11_21fixp, [10 x i32]* %arraydecay12.u4_28fixp, [10 x i32]* %arraydecay13.u4_28fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !176 !taffo.funinfo !177 !taffo.sourceFunction !178 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 16), !taffo.info !179
  %mul.u15_17fixp = shl i32 %5, 1, !taffo.info !182
  ...
  %7 = shl i32 %mul.u15_17fixp, 4, !taffo.info !182
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !176 !taffo.funinfo !186 !taffo.sourceFunction !178 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 23), !taffo.info !187
  %mul.u8_24fixp = shl i32 %5, 1, !taffo.info !190
  %6 = mul nsw i32 %i.0, %m, !taffo.info !81
  ...
  %7 = shl i32 %mul.u8_24fixp, 4, !taffo.info !190
...
!177 = !{i32 1, !77, i32 1, !77, i32 1, !47, i32 1, !77}
!178 = !{void (i32, i32, float*, i32)* @scale_2d}
!179 = !{!180, !181, i1 false, i2 -1}
!180 = !{!"fixp", i32 -32, i32 16}
!181 = !{double 0.000000e+00, double 0x40DF370A2014727E}
!182 = !{!183, !181, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 17}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
!186 = !{i32 1, !77, i32 1, !16, i32 1, !50, i32 1, !77}
!187 = !{!188, !189, i1 false, i2 -1}
!188 = !{!"fixp", i32 -32, i32 23}
!189 = !{double 0.000000e+00, double 2.400000e+02}
