; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-32-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u13_19fixp, [10 x i32]* %arraydecay12.u5_27fixp, [10 x i32]* %arraydecay13.u5_27fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !182 !taffo.funinfo !183 !taffo.sourceFunction !184 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !186
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !189
  ...
  %7 = shl i32 %mul.u18_14fixp, 5, !taffo.info !189
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !182 !taffo.funinfo !193 !taffo.sourceFunction !184 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !194
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !197
  %6 = mul nsw i32 %i.0, %m, !taffo.info !81
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !197
...
!183 = !{i32 1, !77, i32 1, !77, i32 1, !47, i32 1, !88}
!184 = !{void (i32, i32, float*, i32)* @scale_2d}
!185 = !{!102, !89, i1 false, i2 1}
!186 = !{!187, !188, i1 false, i2 -1}
!187 = !{!"fixp", i32 -32, i32 13}
!188 = !{double 0.000000e+00, double 0x410F1851C0010C6F}
!189 = !{!190, !188, i1 false, i2 -1}
!190 = !{!"fixp", i32 32, i32 14}
!191 = distinct !{!191, !23}
!192 = distinct !{!192, !23}
!193 = !{i32 1, !77, i32 1, !16, i32 1, !50, i32 1, !88}
!194 = !{!195, !196, i1 false, i2 -1}
!195 = !{!"fixp", i32 -32, i32 21}
!196 = !{double 0.000000e+00, double 9.600000e+02}
