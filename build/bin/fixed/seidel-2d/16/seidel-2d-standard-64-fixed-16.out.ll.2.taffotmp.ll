; ModuleID = './build/bin/fixed/seidel-2d/16/seidel-2d-standard-64-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 64), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !36
...
!31 = !{double 6.400000e+00, double 0x40940CCCBFF47736}
!32 = !{i32 1}
!33 = !{i32 2}
