; ModuleID = './build/bin/fixed/ludcmp/16/ludcmp-standard-256-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 256), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 256), !taffo.info !67, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.info !48, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 256), !taffo.info !68, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 256), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !69, !taffo.target !53, !taffo.originalCall !70
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !54, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 256), !taffo.info !72, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
...
!47 = !{double 2.560000e+02, double 0x40A05851DFFC547A}
!48 = !{!49, !50, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 21}
!50 = !{double 0x409019999FE43676, double 1.152000e+03}
!51 = !{!52, !1, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 28}
!53 = !{!"x"}
!54 = !{!49, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x409019999FE43676}
...
!101 = !{!"fixp", i32 32, i32 13}
!102 = !{double 0x411019999FE43676, double 2.949120e+05}
!103 = !{i32 7}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !85, i32 1, !51, i32 1, !94}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 20}
!108 = !{double 0xC0236DCA07F66E87, double 0x408FFCF893FAF428}
!109 = distinct !{!109, !23}
...
!116 = !{!"fixp", i32 -32, i32 8}
!117 = !{double 0x3F847AE147AE147C, double 0x4150B28B463B78B0}
!118 = !{i32 8}
!119 = !{!116, !120, i1 false, i2 -1}
!120 = !{double 0xC150B2BD463B78B0, double 1.999900e+02}
!121 = distinct !{!121, !23}
!122 = !{!123, !44, i1 false, i2 -1}
!123 = !{!"fixp", i32 -32, i32 19}
...
!132 = !{!"fixp", i32 -32, i32 9}
!133 = !{double 0.000000e+00, double 0x41407278CFD00C6E}
!134 = !{!132, !135, i1 false, i2 -1}
!135 = !{double 0xC14072DCCFD00C6E, double 2.000000e+02}
!136 = distinct !{!136, !23}
!137 = distinct !{!137, !23}
...
!146 = !{double 0xC053D9094AED99C8, double 0x40C056C5CDD0C3A5}
!147 = !{!145, !148, i1 false, i2 -1}
!148 = !{double 0xC0C0BAC5CDD0C3A5, double 0x4071764252BB6672}
...
!210 = !{!"fixp", i32 32, i32 9}
!211 = !{!210, !212, i1 false, i2 -1}
!212 = !{double 2.560100e+02, double 0x4150B4965077783B}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = distinct !{!215, !23}
!216 = distinct !{!216, !23}
...
!221 = !{!"fixp", i32 32, i32 12}
!222 = !{double 2.560000e+01, double 0x41205851DFFC547A}
!223 = !{i32 9}
!224 = distinct !{!224, !23}
!225 = distinct !{!225, !23}
