; ModuleID = './build/bin/fixed/lu/11/lu-standard-256-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [49 x i8] c"target('A') scalar(range(0.1,2092.159912) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 256), !taffo.initweight !55, !taffo.info !48, !taffo.target !50, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40A05851DFFC547A}
...
!49 = !{double 1.000000e-01, double 0x40A05851DFFC547A}
!50 = !{!"A"}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 0x3F847AE147AE147C, double 0x4150B28B463B78B0}
!109 = !{i1 false, !110, i1 false, i2 1}
!110 = !{double 0xC150B28B3FD5124A, double 0x40A0584CC144028E}
!111 = distinct !{!111, !29}
!112 = !{i32 8}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3F090F455FEACCE2, double 0x40D46E6657FB6998}
!115 = distinct !{!115, !29}
!116 = distinct !{!116, !29}
!117 = distinct !{!117, !29}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double 0.000000e+00, double 0x4150B28B463B78B0}
...
!152 = !{double 2.560000e+02, double 2.560000e+02}
!153 = !{i32 9}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 2.560000e+01, double 0x41205851DFFC547A}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
