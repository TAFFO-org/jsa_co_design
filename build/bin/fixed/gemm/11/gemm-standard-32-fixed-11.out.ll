; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-32-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %C.u13_19fixp = alloca [10 x [12 x i32]], align 4, !taffo.info !47, !taffo.target !49
  %A.u5_27fixp = alloca [10 x [16 x i32]], align 4, !taffo.info !50
  %B.u5_27fixp = alloca [16 x [12 x i32]], align 4, !taffo.info !53
  %arraydecay.u13_19fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay6.u5_27fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u5_27fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay7.u5_27fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u5_27fixp, i32 0, i32 0, !taffo.info !53
  call void @init_array.4_fixp(i32 10, i32 12, i32 16, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [12 x i32]* %arraydecay.u13_19fixp, [16 x i32]* %arraydecay6.u5_27fixp, [12 x i32]* %arraydecay7.u5_27fixp), !taffo.info !55, !taffo.constinfo !56
  ...
  %arraydecay8.u13_19fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u13_19fixp = bitcast [12 x i32]* %arraydecay8.u13_19fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 10, i32 12, i32* %u13_19fixp, i32 32), !taffo.info !59, !taffo.constinfo !60, !taffo.target !49
  %arraydecay9.u5_27fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u5_27fixp, i32 0, i32 0, !taffo.info !50
  %u5_27fixp = bitcast [16 x i32]* %arraydecay9.u5_27fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u5_27fixp, i32 32), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u5_27fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u5_27fixp, i32 0, i32 0, !taffo.info !53
  %u5_27fixp2 = bitcast [12 x i32]* %arraydecay10.u5_27fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u5_27fixp2, i32 32), !taffo.info !62, !taffo.constinfo !60
  ...
  %arraydecay11.u13_19fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u13_19fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay12.u5_27fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u5_27fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay13.u5_27fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u5_27fixp, i32 0, i32 0, !taffo.info !53
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [12 x i32]* %arraydecay11.u13_19fixp, [16 x i32]* %arraydecay12.u5_27fixp, [12 x i32]* %arraydecay13.u5_27fixp), !taffo.info !55, !taffo.constinfo !56
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx.u13_19fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u13_19fixp, i32 0, i32 %i.0, !taffo.info !47, !taffo.target !49
  %arrayidx17.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u13_19fixp, [16 x i32]* noundef %A.u5_27fixp, [12 x i32]* noundef %B.u5_27fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u13_19fixp, i32 %i.0, !taffo.info !47
  %arrayidx4.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !47
  ...
  %2 = ashr i32 %1, 11, !taffo.info !45
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 18), !taffo.info !96
  %mul.u13_19fixp = shl i32 %3, 1, !taffo.info !99
  store i32 %mul.u13_19fixp, i32* %arrayidx4.u13_19fixp, align 4, !taffo.info !58
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u5_27fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u5_27fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u5_27fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx11.u5_27fixp, i32 0, i32 %k.0, !taffo.info !50
  %u5_27fixp = load i32, i32* %arrayidx12.u5_27fixp, align 4, !taffo.info !101
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u5_27fixp, 1, !taffo.info !101
  %6 = ashr i32 %4, 4, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !101
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 25), !taffo.info !103
  %mul13.u6_26fixp = shl i32 %8, 1, !taffo.info !106
  %arrayidx14.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u5_27fixp, i32 %k.0, !taffo.info !53
  %arrayidx15.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx14.u5_27fixp, i32 0, i32 %j.1, !taffo.info !53
  %u5_27fixp2 = load i32, i32* %arrayidx15.u5_27fixp, align 4, !taffo.info !53
  %9 = lshr i32 %mul13.u6_26fixp, 1, !taffo.info !106
  %10 = lshr i32 %u5_27fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 7, !taffo.info !106
  %12 = ashr i32 %10, 8, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 18), !taffo.info !107
  %mul16.u13_19fixp = shl i32 %13, 1, !taffo.info !109
  %arrayidx17.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u13_19fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx17.u13_19fixp, i32 0, i32 %j.1, !taffo.info !47
  %u13_19fixp1 = load i32, i32* %arrayidx18.u13_19fixp, align 4, !taffo.info !47
  %add.u13_19fixp = add i32 %u13_19fixp1, %mul16.u13_19fixp, !taffo.info !110
  store i32 %add.u13_19fixp, i32* %arrayidx18.u13_19fixp, align 4, !taffo.info !59
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u13_19fixp, [16 x i32]* noundef %A.u5_27fixp, [12 x i32]* noundef %B.u5_27fixp) #0 !taffo.initweight !115 !taffo.funinfo !92 !taffo.sourceFunction !116 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u13_19fixp, i32 %i.0, !taffo.info !145
  %arrayidx7.u13_19fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u13_19fixp, i32 0, i32 %j.0, !taffo.info !145
  %3 = lshr i32 %div.u1_31fixp, 12, !taffo.info !143
  store i32 %3, i32* %arrayidx7.u13_19fixp, align 4, !taffo.info !146
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %7 = call i32 @llvm.sdiv.fix.i32(i32 %6, i32 %5, i32 26), !taffo.info !157
  %div24.u1_31fixp = shl i32 %7, 5, !taffo.info !160
  %arrayidx25.u5_27fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u5_27fixp, i32 %i.1, !taffo.info !161
  %arrayidx26.u5_27fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u5_27fixp, i32 0, i32 %j.1, !taffo.info !161
  %8 = lshr i32 %div24.u1_31fixp, 4, !taffo.info !160
  store i32 %8, i32* %arrayidx26.u5_27fixp, align 4, !taffo.info !146
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.info !164, !taffo.initweight !126, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !166, !taffo.initweight !126
  %rem43 = srem i32 %mul42, %nj, !taffo.info !168, !taffo.initweight !129
  %conv44.u4_28fixp = shl i32 %rem43, 28, !taffo.info !169
  %conv45.u4_28fixp = shl i32 %nj, 28, !taffo.info !170
  %9 = lshr i32 %conv44.u4_28fixp, 1, !taffo.info !169
  %10 = lshr i32 %conv45.u4_28fixp, 1, !taffo.info !170
  %11 = call i32 @llvm.sdiv.fix.i32(i32 %9, i32 %10, i32 27), !taffo.info !171
  %div46.u1_31fixp = shl i32 %11, 4, !taffo.info !173
  %arrayidx47.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u5_27fixp, i32 %i.2, !taffo.info !174
  %arrayidx48.u5_27fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u5_27fixp, i32 0, i32 %j.2, !taffo.info !174
  %12 = lshr i32 %div46.u1_31fixp, 4, !taffo.info !173
  store i32 %12, i32* %arrayidx48.u5_27fixp, align 4, !taffo.info !146
  br label %for.inc49
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !177 !taffo.funinfo !178 !taffo.sourceFunction !179 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !180
  %1 = lshr i32 %u5_27fixp, 1, !taffo.info !50
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !180
  %3 = ashr i32 %1, 5, !taffo.info !50
  %4 = ashr i32 %2, 4, !taffo.info !180
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !181
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !184
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !184
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !177 !taffo.funinfo !188 !taffo.sourceFunction !179 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 12, !taffo.info !180
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 13), !taffo.info !189
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !192
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u18_14fixp, 5, !taffo.info !192
...
!1 = !{double 0.000000e+00, double 0x40B91EB84007570C}
...
!54 = !{double 0.000000e+00, double 0x403D55556084A516}
...
!98 = !{double 0.000000e+00, double 0x40BE24DD19A26874}
...
!108 = !{double 0.000000e+00, double 0x4094A00007DD4413}
!109 = !{!48, !108, i1 false, i2 -1}
!110 = !{!48, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x40BE46B841FEA811}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = distinct !{!114, !23}
...
!168 = !{i1 false, !65, i1 false, i2 1}
!169 = !{!138, !65, i1 false, i2 1}
!170 = !{!138, !79, i1 false, i2 1}
!171 = !{!141, !172, i1 false, i2 1}
!172 = !{double 0.000000e+00, double 0x3FED555555555555}
!173 = !{!144, !172, i1 false, i2 1}
!174 = !{!51, !54, i1 false, i2 1}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = !{i32 -1, i32 -1, i32 3, i32 -1}
!178 = !{i32 1, !16, i32 1, !93, i32 1, !50, i32 1, !88}
!179 = !{void (i32, i32, float*, i32)* @scale_2d}
!180 = !{!102, !89, i1 false, i2 1}
!181 = !{!182, !183, i1 false, i2 -1}
!182 = !{!"fixp", i32 -32, i32 21}
!183 = !{double 0.000000e+00, double 9.600000e+02}
!184 = !{!185, !183, i1 false, i2 -1}
!185 = !{!"fixp", i32 32, i32 22}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
!188 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
!189 = !{!190, !191, i1 false, i2 -1}
!190 = !{!"fixp", i32 -32, i32 13}
!191 = !{double 0.000000e+00, double 0x41091EB84007570C}
!192 = !{!193, !191, i1 false, i2 -1}
!193 = !{!"fixp", i32 32, i32 14}
!194 = distinct !{!194, !23}
!195 = distinct !{!195, !23}
