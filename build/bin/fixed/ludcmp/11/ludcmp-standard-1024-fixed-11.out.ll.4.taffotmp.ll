; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 1024), !taffo.info !67, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.info !48, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 1024), !taffo.info !68, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !69, !taffo.target !53, !taffo.originalCall !70
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !54, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 1024), !taffo.info !72, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
...
for.end:                                          ; preds = %for.cond6
  ...
  %3 = load float, float* %arrayidx14, align 4, !taffo.info !42, !taffo.initweight !103
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55 = fmul float %8, %9, !taffo.info !130, !taffo.initweight !103
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75 = fmul float %11, %12, !taffo.info !143, !taffo.initweight !103
  %sub76 = fsub float %w.3, %mul75, !taffo.info !146, !taffo.initweight !61
  br label %for.inc77

for.inc77:                                        ; preds = %for.body71
  %inc78 = add nsw i32 %j.3, 1, !taffo.info !148, !taffo.constinfo !21
  br label %for.cond69, !llvm.loop !150
...
for.end79:                                        ; preds = %for.cond69
  ...
  %13 = load float, float* %arrayidx81, align 4, !taffo.info !42, !taffo.initweight !103
...
for.inc84:                                        ; preds = %for.end79
  %dec = add nsw i32 %i.2, -1, !taffo.info !151, !taffo.constinfo !21
  br label %for.cond65, !llvm.loop !153
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.5(i32 noundef %n, [20 x float]* noundef %A, [20 x float]* noundef %B, float* noundef %b, float* noundef %x, float* noundef %y) #0 !taffo.initweight !154 !taffo.funinfo !155 !taffo.sourceFunction !63 {
entry:
  %conv = sitofp i32 %n to float, !taffo.info !156, !taffo.initweight !61
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !158, !taffo.initweight !45
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !159, !taffo.initweight !61
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !160, !taffo.initweight !64

for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.info !162, !taffo.initweight !61
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !163, !taffo.initweight !64, !taffo.constinfo !164
  %arrayidx5 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !165, !taffo.initweight !61
  store float 0.000000e+00, float* %arrayidx5, align 4, !taffo.info !163, !taffo.initweight !64, !taffo.constinfo !164
  %add = add nsw i32 %i.0, 1, !taffo.info !166, !taffo.initweight !61, !taffo.constinfo !21
  %conv6 = sitofp i32 %add to float, !taffo.info !167, !taffo.initweight !64
  %div = fdiv float %conv6, %conv, !taffo.info !168, !taffo.initweight !61
  %conv7 = fpext float %div to double, !taffo.info !168, !taffo.initweight !64
  %div8 = fdiv double %conv7, 2.000000e+00, !taffo.info !171, !taffo.initweight !174, !taffo.constinfo !175
  %add9 = fadd double %div8, 4.000000e+00, !taffo.info !176, !taffo.initweight !96, !taffo.constinfo !178
  %conv10 = fptrunc double %add9 to float, !taffo.info !181, !taffo.initweight !97
  %arrayidx11 = getelementptr inbounds float, float* %b, i32 %i.0, !taffo.info !183, !taffo.initweight !61
  store float %conv10, float* %arrayidx11, align 4, !taffo.info !163, !taffo.initweight !64
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !166, !taffo.initweight !61, !taffo.constinfo !21
...
for.cond12:                                       ; preds = %for.inc41, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc42, %for.inc41 ], !taffo.info !158, !taffo.initweight !45
  %cmp13 = icmp slt i32 %i.1, %n, !taffo.info !159, !taffo.initweight !61
  br i1 %cmp13, label %for.body15, label %for.end43, !taffo.info !160, !taffo.initweight !64

for.body15:                                       ; preds = %for.cond12
  br label %for.cond16

for.cond16:                                       ; preds = %for.inc26, %for.body15
  %j.0 = phi i32 [ 0, %for.body15 ], [ %inc27, %for.inc26 ], !taffo.info !158, !taffo.initweight !45
  %cmp17 = icmp sle i32 %j.0, %i.1, !taffo.info !159, !taffo.initweight !61
  br i1 %cmp17, label %for.body19, label %for.end28, !taffo.info !160, !taffo.initweight !64

for.body19:                                       ; preds = %for.cond16
  %sub = sub nsw i32 0, %j.0, !taffo.info !185, !taffo.initweight !61, !taffo.constinfo !21
  %rem = srem i32 %sub, %n, !taffo.info !187, !taffo.initweight !64
  %conv20 = sitofp i32 %rem to float, !taffo.info !189, !taffo.initweight !174
  %conv21 = sitofp i32 %n to float, !taffo.info !156
  %div22 = fdiv float %conv20, %conv21, !taffo.info !191, !taffo.initweight !96
  %add23 = fadd float %div22, 1.000000e+00, !taffo.info !194, !taffo.initweight !96, !taffo.constinfo !196
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !197, !taffo.initweight !61
  %arrayidx25 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx24, i32 0, i32 %j.0, !taffo.info !197, !taffo.initweight !61
  store float %add23, float* %arrayidx25, align 4, !taffo.info !163, !taffo.initweight !64
  br label %for.inc26

for.inc26:                                        ; preds = %for.body19
  %inc27 = add nsw i32 %j.0, 1, !taffo.info !166, !taffo.initweight !61, !taffo.constinfo !21
  br label %for.cond16, !llvm.loop !198

for.end28:                                        ; preds = %for.cond16
  %add29 = add nsw i32 %i.1, 1, !taffo.info !166, !taffo.initweight !61, !taffo.constinfo !21
  br label %for.cond30

for.cond30:                                       ; preds = %for.inc36, %for.end28
  %j.1 = phi i32 [ %add29, %for.end28 ], [ %inc37, %for.inc36 ], !taffo.info !199, !taffo.initweight !45
  %cmp31 = icmp slt i32 %j.1, %n, !taffo.info !159, !taffo.initweight !61
  br i1 %cmp31, label %for.body33, label %for.end38, !taffo.info !160, !taffo.initweight !64

for.body33:                                       ; preds = %for.cond30
  %arrayidx34 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !197, !taffo.initweight !61
  %arrayidx35 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx34, i32 0, i32 %j.1, !taffo.info !197, !taffo.initweight !61
  store float 0.000000e+00, float* %arrayidx35, align 4, !taffo.info !163, !taffo.initweight !64, !taffo.constinfo !164
  br label %for.inc36

for.inc36:                                        ; preds = %for.body33
  %inc37 = add nsw i32 %j.1, 1, !taffo.info !201, !taffo.initweight !61, !taffo.constinfo !21
  br label %for.cond30, !llvm.loop !203

for.end38:                                        ; preds = %for.cond30
  %arrayidx39 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !197, !taffo.initweight !61
  %arrayidx40 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx39, i32 0, i32 %i.1, !taffo.info !197, !taffo.initweight !61
  store float 1.000000e+00, float* %arrayidx40, align 4, !taffo.info !163, !taffo.initweight !64, !taffo.constinfo !204
  br label %for.inc41

for.inc41:                                        ; preds = %for.end38
  %inc42 = add nsw i32 %i.1, 1, !taffo.info !166, !taffo.initweight !61, !taffo.constinfo !21
  br label %for.cond12, !llvm.loop !205
...
for.body51:                                       ; preds = %for.cond48
  ...
  store float 0.000000e+00, float* %arrayidx53, align 4, !taffo.info !163, !taffo.initweight !96, !taffo.constinfo !164
  br label %for.inc54

for.inc54:                                        ; preds = %for.body51
  %inc55 = add nsw i32 %s.0, 1, !taffo.info !87, !taffo.constinfo !21
  br label %for.cond48, !llvm.loop !206
...
for.inc57:                                        ; preds = %for.end56
  ...
  br label %for.cond44, !llvm.loop !207
...
for.body71:                                       ; preds = %for.cond68
  ...
  %mul = fmul float %0, %1, !taffo.info !208, !taffo.initweight !118
  ...
  %add78 = fadd float %2, %mul, !taffo.info !210, !taffo.initweight !118
...
for.inc79:                                        ; preds = %for.body71
  ...
  br label %for.cond68, !llvm.loop !212
...
for.inc82:                                        ; preds = %for.end81
  ...
  br label %for.cond64, !llvm.loop !213
...
for.inc100:                                       ; preds = %for.body95
  ...
  br label %for.cond92, !llvm.loop !215
...
for.inc103:                                       ; preds = %for.end102
  ...
  br label %for.cond88, !llvm.loop !216
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !218 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !98
  %mul = fmul float %1, %conv, !taffo.info !219, !taffo.initweight !222
...
!47 = !{double 1.024000e+03, double 0x40C05851DFFC547A}
!48 = !{!49, !50, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 19}
!50 = !{double 0x40B01999A005C465, double 4.608000e+03}
!51 = !{!52, !1, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 28}
!53 = !{!"x"}
!54 = !{!49, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x40B01999A005C465}
...
!101 = !{!"fixp", i32 32, i32 9}
!102 = !{double 0x41501999A005C465, double 0x4152000000000000}
!103 = !{i32 7}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !85, i32 1, !51, i32 1, !94}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 19}
!108 = !{double 0xC0436DCA07F66E87, double 0x40AFFCF893FAF428}
!109 = distinct !{!109, !23}
...
!116 = !{!"fixp", i32 -32, i32 4}
!117 = !{double 0x3F847AE147AE147C, double 0x4190B28B463B78B0}
!118 = !{i32 8}
!119 = !{!116, !120, i1 false, i2 -1}
!120 = !{double 0xC190B28E663B78B0, double 1.999900e+02}
!121 = distinct !{!121, !23}
!122 = !{!123, !124, i1 false, i2 -1}
!123 = !{!"fixp", i32 -32, i32 20}
!124 = !{double -2.000000e+03, double 2.000000e+03}
!125 = !{i1 false, !114, i1 false, i2 -1}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
!130 = !{!131, !132, i1 false, i2 -1}
!131 = !{!"fixp", i32 -32, i32 5}
!132 = !{double 0.000000e+00, double 0x41807278CFF25395}
!133 = !{!131, !134, i1 false, i2 -1}
!134 = !{double 0xC180727F0FF25395, double 2.000000e+02}
!135 = distinct !{!135, !23}
!136 = distinct !{!136, !23}
...
!144 = !{!"fixp", i32 -32, i32 15}
!145 = !{double 0xC073D9094AED99C8, double 0x40E056C5CDD0C3A5}
!146 = !{!144, !147, i1 false, i2 -1}
!147 = !{double 0xC0E06FC5CDD0C3A5, double 0x40802C84A576CCE4}
!148 = !{i1 false, !149, i1 false, i2 0}
!149 = !{double 2.100000e+01, double 2.100000e+01}
!150 = distinct !{!150, !23}
!151 = !{i1 false, !152, i1 false, i2 0}
!152 = !{double 1.800000e+01, double 1.800000e+01}
!153 = distinct !{!153, !23}
!154 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!155 = !{i32 1, !85, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!156 = !{!157, !86, i1 false, i2 1}
!157 = !{!"fixp", i32 32, i32 27}
!158 = !{i1 false, !77, i1 false, i2 1}
!159 = !{i1 false, !79, i1 false, i2 1}
!160 = !{i1 false, !161, i1 false, i2 1}
!161 = !{double 0.000000e+00, double 2.000000e+01}
!162 = !{!52, !1, i1 false, i2 1}
!163 = !{i1 false, i1 false, i1 false, i2 1}
!164 = !{!89, i1 false}
!165 = !{!49, !55, i1 false, i2 1}
!166 = !{i1 false, !81, i1 false, i2 1}
!167 = !{!157, !81, i1 false, i2 1}
!168 = !{!169, !170, i1 false, i2 1}
!169 = !{!"fixp", i32 32, i32 30}
!170 = !{double 5.000000e-02, double 1.050000e+00}
!171 = !{!172, !173, i1 false, i2 1}
!172 = !{!"fixp", i32 32, i32 29}
!173 = !{double 2.500000e-02, double 5.250000e-01}
!174 = !{i32 4}
!175 = !{i1 false, !19}
!176 = !{!172, !177, i1 false, i2 1}
!177 = !{double 4.025000e+00, double 4.525000e+00}
!178 = !{i1 false, !179}
!179 = !{i1 false, !180, i1 false, i2 0}
!180 = !{double 4.000000e+00, double 4.000000e+00}
!181 = !{!172, !182, i1 false, i2 1}
!182 = !{double 0x4010199980000000, double 0x40121999A0000000}
!183 = !{!49, !50, i1 false, i2 1}
!184 = distinct !{!184, !23}
!185 = !{i1 false, !186, i1 false, i2 1}
!186 = !{double -2.000000e+01, double 0.000000e+00}
!187 = !{i1 false, !188, i1 false, i2 1}
!188 = !{double -1.900000e+01, double 0.000000e+00}
!189 = !{!190, !188, i1 false, i2 1}
!190 = !{!"fixp", i32 -32, i32 26}
!191 = !{!192, !193, i1 false, i2 1}
!192 = !{!"fixp", i32 -32, i32 30}
!193 = !{double 0xBFEE666666666666, double 0.000000e+00}
!194 = !{!192, !195, i1 false, i2 1}
!195 = !{double 0x3FA99999999999A0, double 1.000000e+00}
!196 = !{i1 false, !87}
!197 = !{!43, !44, i1 false, i2 1}
!198 = distinct !{!198, !23}
!199 = !{i1 false, !200, i1 false, i2 1}
!200 = !{double 0.000000e+00, double 2.200000e+01}
!201 = !{i1 false, !202, i1 false, i2 1}
!202 = !{double 1.000000e+00, double 2.200000e+01}
!203 = distinct !{!203, !23}
!204 = !{!87, i1 false}
!205 = distinct !{!205, !23}
!206 = distinct !{!206, !23}
!207 = distinct !{!207, !23}
!208 = !{!209, !117, i1 false, i2 -1}
!209 = !{!"fixp", i32 32, i32 5}
!210 = !{!209, !211, i1 false, i2 -1}
!211 = !{double 1.024010e+03, double 0x4190B30E08CA7893}
!212 = distinct !{!212, !23}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = distinct !{!215, !23}
...
!218 = !{i32 1, !85, i32 1, !85, i32 1, !42, i32 1, !94}
!219 = !{!220, !221, i1 false, i2 -1}
!220 = !{!"fixp", i32 32, i32 8}
!221 = !{double 1.024000e+02, double 0x41605851DFFC547A}
!222 = !{i32 9}
!223 = distinct !{!223, !23}
!224 = distinct !{!224, !23}
