; ModuleID = './build/bin/fixed/syrk/16/syrk-standard-16-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,1664.939941) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.initweight !57, !taffo.info !49, !taffo.originalCall !60, !taffo.constinfo !61
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 16), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !60, !taffo.constinfo !61
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 16), !taffo.initweight !63, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 16), !taffo.initweight !63, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div = fdiv float %conv, %conv6, !taffo.initweight !89, !taffo.info !138
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !62, !taffo.info !137
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !62, !taffo.info !137
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !63, !taffo.info !90
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !62, !taffo.info !140, !taffo.constinfo !27
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.initweight !62, !taffo.info !143, !taffo.constinfo !27
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  ...
  %cmp16 = icmp slt i32 %j.1, %n, !taffo.initweight !62, !taffo.info !145
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.initweight !63, !taffo.info !87

for.body18:                                       ; preds = %for.cond15
  %mul19 = mul nsw i32 %i.1, %j.1, !taffo.initweight !62, !taffo.info !133
  %add20 = add nsw i32 %mul19, 2, !taffo.initweight !63, !taffo.info !146, !taffo.constinfo !27
  %rem21 = srem i32 %add20, %m, !taffo.initweight !72, !taffo.info !148
  %conv22 = sitofp i32 %rem21 to float, !taffo.initweight !88, !taffo.info !148
  %conv23 = sitofp i32 %m to float, !taffo.info !22
  %div24 = fdiv float %conv22, %conv23, !taffo.initweight !89, !taffo.info !150
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.initweight !62, !taffo.info !152
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.initweight !62, !taffo.info !152
  store float %div24, float* %arrayidx26, align 4, !taffo.initweight !63, !taffo.info !90
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.initweight !62, !taffo.info !140, !taffo.constinfo !27
  br label %for.cond15, !llvm.loop !153

for.end29:                                        ; preds = %for.cond15
  br label %for.inc30

for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.initweight !62, !taffo.info !143, !taffo.constinfo !27
  br label %for.cond11, !llvm.loop !154
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !155 !taffo.funinfo !156 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !157, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !101
  %mul = fmul float %1, %conv, !taffo.initweight !158, !taffo.info !159
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !157, !taffo.info !53
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !155 !taffo.funinfo !163 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !157, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !101
  %mul = fmul float %1, %conv, !taffo.initweight !158, !taffo.info !164
  %2 = mul nsw i32 %i.0, %m, !taffo.info !105
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !157, !taffo.info !55
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 0x409A03C27FE4BCAE}
...
!109 = distinct !{!109, !29}
!110 = !{i32 1, i32 -1}
!111 = !{i32 1, !49, i32 1, !101}
!112 = !{i32 1, !51, i32 1, !101}
...
!117 = !{double 0.000000e+00, double 0x409F37B633127C04}
!118 = distinct !{!118, !29}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 2.250000e+01}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 3.375000e+02}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x409F49C27FE4BCAE}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = distinct !{!127, !29}
...
!144 = distinct !{!144, !29}
!145 = !{i1 false, !104, i1 false, i2 1}
...
!151 = !{double 0.000000e+00, double 9.000000e-01}
!152 = !{i1 false, !7, i1 false, i2 1}
!153 = distinct !{!153, !29}
!154 = distinct !{!154, !29}
!155 = !{i32 -1, i32 -1, i32 3, i32 -1}
!156 = !{i32 1, !101, i32 1, !101, i32 1, !53, i32 1, !101}
!157 = !{i32 8}
!158 = !{i32 9}
!159 = !{i1 false, !160, i1 false, i2 -1}
!160 = !{double 0.000000e+00, double 0x40DA03C27FE4BCAE}
!161 = distinct !{!161, !29}
!162 = distinct !{!162, !29}
!163 = !{i32 1, !101, i32 1, !22, i32 1, !55, i32 1, !101}
