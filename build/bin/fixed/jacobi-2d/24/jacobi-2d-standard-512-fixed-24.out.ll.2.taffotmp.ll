; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-512-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 512), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 512), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x405111111F0C34C2, double 0x40BE22222003AB86}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 0x40599999A1FD156A, double 0x40C011111FFF79C8}
!34 = !{i32 1}
!35 = !{i32 2}
