...
@.str.3 = private unnamed_addr constant [50 x i8] c"target('C') scalar(range(0.0,26477.759766) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay2, i32 noundef 64)
  %arraydecay3 = getelementptr inbounds [16 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay3, i32 noundef 64)
