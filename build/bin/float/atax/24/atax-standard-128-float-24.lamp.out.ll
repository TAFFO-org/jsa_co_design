; ModuleID = './build/bin/float/atax/24/atax-standard-128-float-24.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, ptr noundef %arraydecay4, i32 noundef 128)
  %arraydecay5 = getelementptr inbounds [22 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, ptr noundef %arraydecay5, i32 noundef 128)
  %arraydecay6 = getelementptr inbounds [22 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, ptr noundef %arraydecay6, i32 noundef 128)
