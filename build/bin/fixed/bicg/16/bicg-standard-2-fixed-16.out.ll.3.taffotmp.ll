; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-2-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.909091) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/bicg.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [47 x i8] c"target('s') scalar(range(0.0,27.363638) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [47 x i8] c"target('q') scalar(range(0.0,24.181818) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 2), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.initweight !60, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 2), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 2), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.initweight !59, !taffo.info !51
  call void @scale_1d.5(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 2), !taffo.initweight !60, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !114, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !27
  ...
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !114, !taffo.info !53
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.2(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !112 !taffo.funinfo !119 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !114, !taffo.info !55
  %conv = sitofp i32 %factor to float, !taffo.info !27
  ...
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !114, !taffo.info !55
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !112 !taffo.funinfo !123 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !114, !taffo.info !57
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %0, %conv, !taffo.initweight !115, !taffo.info !124
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !95, !taffo.info !57
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !114, !taffo.info !57
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_bicg.4(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %s, float* noundef %q, float* noundef %p, float* noundef %r) #0 !taffo.initweight !127 !taffo.funinfo !128 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body7:                                        ; preds = %for.cond5
  ...
  %0 = load float, float* %arrayidx8, align 4, !taffo.initweight !114, !taffo.info !53
  %arrayidx9 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.initweight !95, !taffo.info !51
  %1 = load float, float* %arrayidx9, align 4, !taffo.initweight !114, !taffo.info !51
  %arrayidx10 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.initweight !95, !taffo.info !51
  %arrayidx11 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx10, i32 0, i32 %j.0, !taffo.initweight !114, !taffo.info !51
  %2 = load float, float* %arrayidx11, align 4, !taffo.initweight !115, !taffo.info !51
  %mul = fmul float %1, %2, !taffo.initweight !115, !taffo.info !130
  %add = fadd float %0, %mul, !taffo.initweight !115, !taffo.info !132
  %arrayidx12 = getelementptr inbounds float, float* %s, i32 %j.0, !taffo.initweight !95, !taffo.info !53
  store float %add, float* %arrayidx12, align 4, !taffo.initweight !114, !taffo.info !53
  %arrayidx13 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.initweight !95, !taffo.info !55
  %3 = load float, float* %arrayidx13, align 4, !taffo.initweight !114, !taffo.info !55
  %arrayidx14 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.initweight !95, !taffo.info !51
  %arrayidx15 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.initweight !114, !taffo.info !51
  %4 = load float, float* %arrayidx15, align 4, !taffo.initweight !115, !taffo.info !51
  %arrayidx16 = getelementptr inbounds float, float* %p, i32 %j.0, !taffo.initweight !95, !taffo.info !57
  %5 = load float, float* %arrayidx16, align 4, !taffo.initweight !114, !taffo.info !57
  %mul17 = fmul float %4, %5, !taffo.initweight !115, !taffo.info !134
  %add18 = fadd float %3, %mul17, !taffo.initweight !115, !taffo.info !136
  %arrayidx19 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.initweight !95, !taffo.info !55
  store float %add18, float* %arrayidx19, align 4, !taffo.initweight !114, !taffo.info !55
  br label %for.inc20

for.inc20:                                        ; preds = %for.body7
  %inc21 = add nsw i32 %j.0, 1, !taffo.info !107, !taffo.constinfo !29
  br label %for.cond5, !llvm.loop !138
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !112 !taffo.funinfo !140 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.initweight !114, !taffo.info !51
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %0, %conv, !taffo.initweight !115, !taffo.info !141
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.initweight !95, !taffo.info !51
  store float %mul, float* %arrayidx1, align 4, !taffo.initweight !114, !taffo.info !51
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %r, float* noundef %p, float* noundef %s, float* noundef %q) #0 !taffo.initweight !127 !taffo.funinfo !144 !taffo.sourceFunction !61 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.initweight !50, !taffo.info !145
  %cmp = icmp slt i32 %i.0, %m, !taffo.initweight !60, !taffo.info !146
  br i1 %cmp, label %for.body, label %for.end, !taffo.initweight !63, !taffo.info !85

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %m, !taffo.initweight !60, !taffo.info !147
  %conv = sitofp i32 %rem to float, !taffo.initweight !63, !taffo.info !147
  %conv3 = sitofp i32 %m to float, !taffo.info !103
  %div = fdiv float %conv, %conv3, !taffo.initweight !87, !taffo.info !149
  %arrayidx = getelementptr inbounds float, float* %p, i32 %i.0, !taffo.initweight !60, !taffo.info !151
  store float %div, float* %arrayidx, align 4, !taffo.initweight !63, !taffo.info !88
  %arrayidx4 = getelementptr inbounds float, float* %s, i32 %i.0, !taffo.initweight !60, !taffo.info !152
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !63, !taffo.info !88, !taffo.constinfo !89
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.initweight !60, !taffo.info !153, !taffo.constinfo !29
...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc29, %for.inc28 ], !taffo.initweight !50, !taffo.info !145
  %cmp6 = icmp slt i32 %i.1, %n, !taffo.initweight !60, !taffo.info !146
  br i1 %cmp6, label %for.body8, label %for.end30, !taffo.initweight !63, !taffo.info !85

for.body8:                                        ; preds = %for.cond5
  %rem9 = srem i32 %i.1, %n, !taffo.initweight !60, !taffo.info !155
  %conv10 = sitofp i32 %rem9 to float, !taffo.initweight !63, !taffo.info !155
  %conv11 = sitofp i32 %n to float, !taffo.info !105
  %div12 = fdiv float %conv10, %conv11, !taffo.initweight !87, !taffo.info !156
  %arrayidx13 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.initweight !60, !taffo.info !158
  store float %div12, float* %arrayidx13, align 4, !taffo.initweight !63, !taffo.info !88
  %arrayidx14 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.initweight !60, !taffo.info !159
  store float 0.000000e+00, float* %arrayidx14, align 4, !taffo.initweight !63, !taffo.info !88, !taffo.constinfo !89
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc25, %for.body8
  %j.0 = phi i32 [ 0, %for.body8 ], [ %inc26, %for.inc25 ], !taffo.initweight !50, !taffo.info !155
  %cmp16 = icmp slt i32 %j.0, %m, !taffo.initweight !60, !taffo.info !146
  br i1 %cmp16, label %for.body18, label %for.end27, !taffo.initweight !63, !taffo.info !93

for.body18:                                       ; preds = %for.cond15
  %add = add nsw i32 %j.0, 1, !taffo.initweight !60, !taffo.info !160, !taffo.constinfo !29
  %mul = mul nsw i32 %i.1, %add, !taffo.initweight !60, !taffo.info !161
  %rem19 = srem i32 %mul, %n, !taffo.initweight !63, !taffo.info !155
  %conv20 = sitofp i32 %rem19 to float, !taffo.initweight !87, !taffo.info !155
  %conv21 = sitofp i32 %n to float, !taffo.info !105
  %div22 = fdiv float %conv20, %conv21, !taffo.initweight !95, !taffo.info !156
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.initweight !60, !taffo.info !158
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx23, i32 0, i32 %j.0, !taffo.initweight !60, !taffo.info !158
  store float %div22, float* %arrayidx24, align 4, !taffo.initweight !63, !taffo.info !88
  br label %for.inc25

for.inc25:                                        ; preds = %for.body18
  %inc26 = add nsw i32 %j.0, 1, !taffo.initweight !60, !taffo.info !160, !taffo.constinfo !29
...
for.inc28:                                        ; preds = %for.end27
  %inc29 = add nsw i32 %i.1, 1, !taffo.initweight !60, !taffo.info !153, !taffo.constinfo !29
  br label %for.cond5, !llvm.loop !164
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !166 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.initweight !114, !taffo.info !51
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !115, !taffo.info !51
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !167, !taffo.info !51
  %conv = sitofp i32 %factor to float, !taffo.info !27
  %mul = fmul float %1, %conv, !taffo.initweight !168, !taffo.info !141
  %2 = mul nsw i32 %i.0, %m, !taffo.info !90
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !114, !taffo.info !51
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !115, !taffo.info !51
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !167, !taffo.info !51
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 0x403B5D1761459536}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x40382E8B9FDBD2FA}
...
!52 = !{double 0.000000e+00, double 0x3FFE8BA301216830}
!53 = !{i1 false, !7, i1 false, i2 -1}
!54 = !{!"s"}
!55 = !{i1 false, !9, i1 false, i2 -1}
!56 = !{!"q"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 1.900000e+00}
!59 = !{i32 1}
!60 = !{i32 2}
...
!113 = !{i32 1, !103, i32 1, !53, i32 1, !27}
!114 = !{i32 6}
!115 = !{i32 7}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x404B5D1761459536}
!118 = distinct !{!118, !31}
!119 = !{i32 1, !105, i32 1, !55, i32 1, !27}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x40482E8B9FDBD2FA}
!122 = distinct !{!122, !31}
!123 = !{i32 1, !103, i32 1, !57, i32 1, !27}
!124 = !{i1 false, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 3.800000e+00}
!126 = distinct !{!126, !31}
!127 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!128 = !{i32 1, !103, i32 1, !105, i32 1, !51, i32 1, !53, i32 1, !55, i32 1, !57, i32 1, !51}
!129 = distinct !{!129, !31}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 0x400D2832F576C918}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x403F021DBFF46E59}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x400D04A7A779562D}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x403BCF2094CAFDC0}
!138 = distinct !{!138, !31}
!139 = distinct !{!139, !31}
!140 = !{i32 1, !105, i32 1, !51, i32 1, !27}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0.000000e+00, double 0x400E8BA301216830}
!143 = distinct !{!143, !31}
!144 = !{i32 1, !103, i32 1, !105, i32 1, !51, i32 1, !51, i32 1, !57, i32 1, !53, i32 1, !55}
!145 = !{i1 false, !78, i1 false, i2 1}
!146 = !{i1 false, !73, i1 false, i2 1}
!147 = !{i1 false, !148, i1 false, i2 1}
!148 = !{double 0.000000e+00, double 1.900000e+01}
!149 = !{i1 false, !150, i1 false, i2 1}
!150 = !{double 0.000000e+00, double 0x3FEE666666666666}
!151 = !{i1 false, !58, i1 false, i2 1}
!152 = !{i1 false, !7, i1 false, i2 1}
!153 = !{i1 false, !80, i1 false, i2 1}
!154 = distinct !{!154, !31}
!155 = !{i1 false, !71, i1 false, i2 1}
!156 = !{i1 false, !157, i1 false, i2 1}
!157 = !{double 0.000000e+00, double 0x3FEE8BA2E8BA2E8C}
!158 = !{i1 false, !52, i1 false, i2 1}
!159 = !{i1 false, !9, i1 false, i2 1}
!160 = !{i1 false, !75, i1 false, i2 1}
!161 = !{i1 false, !162, i1 false, i2 1}
!162 = !{double 0.000000e+00, double 4.620000e+02}
!163 = distinct !{!163, !31}
!164 = distinct !{!164, !31}
!165 = !{i32 -1, i32 -1, i32 3, i32 -1}
!166 = !{i32 1, !105, i32 1, !103, i32 1, !51, i32 1, !27}
!167 = !{i32 8}
!168 = !{i32 9}
!169 = distinct !{!169, !31}
!170 = distinct !{!170, !31}
