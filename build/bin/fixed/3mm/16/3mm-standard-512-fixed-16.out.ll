; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-512-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp2 = bitcast [10 x i32]* %arraydecay15.u7_25fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u7_25fixp2, i32 512), !taffo.info !64, !taffo.constinfo !63
  %arraydecay16.u7_25fixp = getelementptr inbounds [10 x [8 x i32]], [10 x [8 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !47
  %u7_25fixp3 = bitcast [8 x i32]* %arraydecay16.u7_25fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u7_25fixp3, i32 512), !taffo.info !65, !taffo.constinfo !63
  ...
  %u7_25fixp = bitcast [14 x i32]* %arraydecay18.u7_25fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u7_25fixp, i32 512), !taffo.info !67, !taffo.constinfo !63
  %arraydecay19.u7_25fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u7_25fixp, i32 0, i32 0, !taffo.info !54
  %u7_25fixp1 = bitcast [12 x i32]* %arraydecay19.u7_25fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u7_25fixp1, i32 512), !taffo.info !68, !taffo.constinfo !63
...
for.body58:                                       ; preds = %for.cond56
  ...
  %14 = fdiv float %13, 1.310720e+05, !taffo.info !41
  ...
  %16 = fdiv float %15, 6.553600e+04, !taffo.info !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !231 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 7), !taffo.info !237
  %mul.u24_8fixp = shl i32 %5, 1, !taffo.info !240
  ...
  %7 = shl i32 %mul.u24_8fixp, 9, !taffo.info !240
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !244 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !245
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !247
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u16_16fixp, 9, !taffo.info !247
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 0x4150000000000000, !taffo.info !235
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u16_16fixp, i32 noundef %factor) #0 !taffo.initweight !230 !taffo.funinfo !257 !taffo.sourceFunction !234 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 6), !taffo.info !258
  %mul.u25_7fixp = shl i32 %5, 1, !taffo.info !261
  %6 = mul nsw i32 %i.0, %m, !taffo.info !93
  ...
  %7 = shl i32 %mul.u25_7fixp, 9, !taffo.info !261
...
!231 = !{i32 1, !87, i32 1, !100, i32 1, !41, i32 1, !232}
...
!238 = !{!"fixp", i32 -32, i32 7}
!239 = !{double 0.000000e+00, double 0x416BBBBBE0008638}
!240 = !{!241, !239, i1 false, i2 -1}
!241 = !{!"fixp", i32 32, i32 8}
!242 = distinct !{!242, !23}
!243 = distinct !{!243, !23}
!244 = !{i32 1, !87, i32 1, !16, i32 1, !44, i32 1, !232}
!245 = !{!119, !246, i1 false, i2 -1}
!246 = !{double 0.000000e+00, double 0x40E555556084A516}
!247 = !{!50, !246, i1 false, i2 -1}
!248 = distinct !{!248, !23}
!249 = distinct !{!249, !23}
!250 = !{i32 1, !87, i32 1, !89, i32 1, !56, i32 1, !232}
!251 = !{i32 8}
!252 = !{!253, !254, i1 false, i2 -1}
!253 = !{!"float", i32 1, double 0x427BCB0680000000}
!254 = !{double 0.000000e+00, double 0x427BCB0680000000}
!255 = distinct !{!255, !23}
!256 = distinct !{!256, !23}
!257 = !{i32 1, !100, i32 1, !89, i32 1, !49, i32 1, !232}
!258 = !{!259, !260, i1 false, i2 -1}
!259 = !{!"fixp", i32 -32, i32 6}
!260 = !{double 0.000000e+00, double 0x4170624DE0008638}
!261 = !{!262, !260, i1 false, i2 -1}
!262 = !{!"fixp", i32 32, i32 7}
!263 = distinct !{!263, !23}
!264 = distinct !{!264, !23}
