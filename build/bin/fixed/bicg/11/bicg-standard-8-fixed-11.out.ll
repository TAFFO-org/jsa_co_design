; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-8-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u9_23fixp1 = load i32, i32* %arrayidx.u9_23fixp, align 4, !taffo.info !47, !taffo.target !49
  %0 = uitofp i32 %u9_23fixp1 to float, !taffo.info !47, !taffo.target !49
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u9_23fixp = load i32, i32* %arrayidx25.u9_23fixp, align 4, !taffo.info !50, !taffo.target !51
  %2 = uitofp i32 %u9_23fixp to float, !taffo.info !50, !taffo.target !51
