; ModuleID = './build/bin/fixed/mvt/16/mvt-standard-16-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,15.2) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [50 x i8] c"target('x1') scalar(range(0.0,1267.999878) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [50 x i8] c"target('x2') scalar(range(0.0,1281.599976) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 16), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 16), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 16), !taffo.initweight !58, !taffo.info !55, !taffo.target !56, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 16), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 16), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x4093CFFFE004B7F6}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x40940666601BC98A}
...
!52 = !{double 0.000000e+00, double 1.520000e+01}
...
!107 = !{double 0.000000e+00, double 0x40D3CFFFE004B7F6}
!108 = distinct !{!108, !31}
!109 = !{i32 1, !91, i32 1, !55, i32 1, !102}
!110 = !{i1 false, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x40D40666601BC98A}
!112 = distinct !{!112, !31}
!113 = !{i32 1, !91, i32 1, !51, i32 1, !102}
!114 = !{i1 false, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 2.432000e+02}
!116 = distinct !{!116, !31}
...
!120 = !{double 0.000000e+00, double 2.310400e+02}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x40976C28D5C74752}
!123 = distinct !{!123, !31}
!124 = distinct !{!124, !31}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4097A28F55DE58E6}
!127 = distinct !{!127, !31}
!128 = distinct !{!128, !31}
!129 = distinct !{!129, !31}
