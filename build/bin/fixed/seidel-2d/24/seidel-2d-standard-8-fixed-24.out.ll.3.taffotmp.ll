; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-8-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [48 x i8] c"target('A') scalar(range(0.8,160.399994) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 8), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40640CCCC0379314}
...
!50 = !{double 8.000000e-01, double 0x40640CCCC0379314}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 1.600000e+00, double 0x40740CCCC0379314}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x4003333333333334, double 0x407E133320535C9E}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 3.200000e+00, double 0x40840CCCC0379314}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 4.000000e+00, double 0x40890FFFF04577D9}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 7.200000e+00, double 0x40968E66583E8576}
...
!143 = !{double 6.400000e+00, double 0x40940CCCC0379314}
!144 = distinct !{!144, !29}
!145 = distinct !{!145, !29}
