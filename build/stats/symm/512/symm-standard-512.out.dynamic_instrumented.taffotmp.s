...
# %bb.0:                                # %entry
	...
	movss	%xmm0, -1728(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movl	-1736(%rbp), %edi               # 4-byte Reload
	movl	-1732(%rbp), %esi               # 4-byte Reload
	movss	-1728(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	-1724(%rbp), %xmm1              # 4-byte Reload
                                        # xmm1 = mem[0],zero,zero,zero
	leaq	-672(%rbp), %rdx
	leaq	-1072(%rbp), %rcx
	leaq	-1712(%rbp), %r8
...
# %bb.4:                                # %for.body16
	...
	movslq	-1720(%rbp), %rcx
	movss	(%rax,%rcx,4), %xmm0            # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1740(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1740(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movslq	-1716(%rbp), %rcx
...
.Lfunc_end8:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_symm
...
.LBB9_12:                               # %for.end55
	...
	retq
.Lfunc_end9:
	.size	kernel_symm, .Lfunc_end9-kernel_symm
	.cfi_endproc
                                        # -- End function
...
.Lfunc_end15:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_symm.7
...
.LBB16_12:                              # %for.end55
	...
	retq
.Lfunc_end16:
	.size	kernel_symm.7, .Lfunc_end16-kernel_symm.7
	.cfi_endproc
                                        # -- End function
