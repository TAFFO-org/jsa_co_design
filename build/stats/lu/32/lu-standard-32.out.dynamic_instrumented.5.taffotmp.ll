; ModuleID = './build/stats/lu/32/lu-standard-32.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.1(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 32), !taffo.originalCall !27
