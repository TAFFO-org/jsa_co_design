; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-8-fixed-16.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !127 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 20), !taffo.info !129
  %mul.u11_21fixp = shl i32 %4, 1, !taffo.info !132
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !67
  %5 = shl i32 %mul.u11_21fixp, 3, !taffo.info !132
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.9_fixp(i32 noundef %n, i32* noundef %val.u1_31fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !143 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 27), !taffo.info !144
  %mul.u4_28fixp = shl i32 %3, 1, !taffo.info !147
  %arrayidx1.u1_31fixp = getelementptr inbounds i32, i32* %val.u1_31fixp, i32 %i.0, !taffo.info !69
  %4 = shl i32 %mul.u4_28fixp, 3, !taffo.info !147
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !155 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !156
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !159
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !64
  %5 = shl i32 %mul.u20_12fixp, 3, !taffo.info !159
...
!126 = distinct !{!126, !27}
!127 = !{i32 1, !103, i32 1, !67, i32 1, !115}
!128 = !{!55, !116, i1 false, i2 1}
!129 = !{!130, !131, i1 false, i2 -1}
!130 = !{!"fixp", i32 -32, i32 20}
!131 = !{double 0.000000e+00, double 0x409A5F011F4F50A0}
...
!142 = distinct !{!142, !27}
!143 = !{i32 1, !103, i32 1, !69, i32 1, !115}
!144 = !{!145, !146, i1 false, i2 -1}
!145 = !{!"fixp", i32 -32, i32 27}
!146 = !{double 4.000000e-01, double 8.000000e+00}
!147 = !{!55, !146, i1 false, i2 -1}
!148 = distinct !{!148, !27}
!149 = !{i32 1, !103, i32 1, !54, i32 1, !115}
!150 = !{!137, !56, i1 false, i2 -1}
!151 = !{!139, !152, i1 false, i2 -1}
!152 = !{double 0.000000e+00, double 6.080000e+01}
!153 = !{!137, !152, i1 false, i2 -1}
!154 = distinct !{!154, !27}
!155 = !{i32 1, !103, i32 1, !64, i32 1, !115}
!156 = !{!157, !158, i1 false, i2 -1}
!157 = !{!"fixp", i32 -32, i32 11}
!158 = !{double 0.000000e+00, double 0x41201ADA40000000}
!159 = !{!160, !158, i1 false, i2 -1}
!160 = !{!"fixp", i32 32, i32 12}
!161 = distinct !{!161, !27}
...
!245 = distinct !{null}
!246 = !{!137, !5, i1 false, i2 -1}
!247 = !{!53, !56, i1 false, i2 -1}
!248 = !{!139, !249, i1 false, i2 -1}
!249 = !{double 0.000000e+00, double 1.520000e+01}
!250 = !{!137, !249, i1 false, i2 -1}
!251 = !{!137, !252, i1 false, i2 -1}
...
!270 = distinct !{!270, !27}
!271 = !{!139, !272, i1 false, i2 -1}
!272 = !{double 0.000000e+00, double 0x403FB3335D249E44}
!273 = !{!137, !272, i1 false, i2 -1}
