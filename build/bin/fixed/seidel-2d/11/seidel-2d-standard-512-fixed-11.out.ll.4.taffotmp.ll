; ModuleID = './build/bin/fixed/seidel-2d/11/seidel-2d-standard-512-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 512), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
!94 = !{double 0x40599999A1FD156A, double 0x40D40CCCBFFCDAB2}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 16}
!98 = !{double 0x40633333397DD010, double 0x40DE13331FFB480B}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 15}
!102 = !{double 0x40699999A1FD156A, double 0x40E40CCCBFFCDAB2}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 0x40700000053E2D62, double 0x40E90FFFEFFC115E}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 0x407CCCCCD63CB817, double 0x40F68E6657FC7608}
...
!144 = !{!"fixp", i32 32, i32 9}
!145 = !{double 0x40D99999A1FD156A, double 0x41540CCCBFFCDAB2}
!146 = !{i32 9}
!147 = distinct !{!147, !23}
!148 = distinct !{!148, !23}
