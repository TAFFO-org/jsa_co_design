; ModuleID = './build/bin/fixed/ludcmp/24/ludcmp-standard-8-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp1 = bitcast [20 x i32]* %arraydecay10.u7_25fixp to i32*, !taffo.info !42
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u7_25fixp1, i32 8), !taffo.info !55, !taffo.constinfo !57
  %arraydecay11.u7_25fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !45
  %u7_25fixp = bitcast [20 x i32]* %arraydecay11.u7_25fixp to i32*, !taffo.info !45
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u7_25fixp, i32 8), !taffo.info !58, !taffo.constinfo !57
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s7_25fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 25), !taffo.info !95
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s7_25fixp, 3, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_ludcmp.3_fixp(i32 noundef %n, [20 x i32]* noundef %A.u7_25fixp, i32* noundef %b.u6_26fixp, i32* noundef %x.s4_28fixp, i32* noundef %y.u6_26fixp) #0 !taffo.initweight !99 !taffo.funinfo !100 !taffo.sourceFunction !101 {
entry:
  br label %for.cond
...
for.body4:                                        ; preds = %for.cond2
  ...
  %u7_25fixp = load i32, i32* %arrayidx5.u7_25fixp, align 4, !taffo.info !102
  %0 = lshr i32 %u7_25fixp, 2, !taffo.info !102
  br label %for.cond6
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul.s14_18fixp = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 18), !taffo.info !105
  %5 = ashr i32 %w.0.s9_23fixp, 5, !taffo.info !102
  %sub.s14_18fixp = sub i32 %5, %mul.s14_18fixp, !taffo.info !108
  br label %for.inc

for.inc:                                          ; preds = %for.body8
  %inc = add nsw i32 %k.0, 1, !taffo.info !76, !taffo.constinfo !21
  %6 = shl i32 %sub.s14_18fixp, 5, !taffo.info !108
...
for.end:                                          ; preds = %for.cond6
  ...
  %10 = shl i32 %div.s12_20fixp, 5, !taffo.info !111
  store i32 %10, i32* %arrayidx16.u7_25fixp, align 4, !taffo.info !114
  br label %for.inc17
...
for.body22:                                       ; preds = %for.cond20
  ...
  %u7_25fixp12 = load i32, i32* %arrayidx24.u7_25fixp, align 4, !taffo.info !102
  %11 = lshr i32 %u7_25fixp12, 2, !taffo.info !102
  br label %for.cond25
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32.s14_18fixp = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 18), !taffo.info !105
  %16 = ashr i32 %w.1.s9_23fixp, 5, !taffo.info !102
  %sub33.s14_18fixp = sub i32 %16, %mul32.s14_18fixp, !taffo.info !108
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !76, !taffo.constinfo !21
  %17 = shl i32 %sub33.s14_18fixp, 5, !taffo.info !108
...
for.end36:                                        ; preds = %for.cond25
  ...
  %18 = shl i32 %w.1.s9_23fixp, 2, !taffo.info !102
  store i32 %18, i32* %arrayidx38.u7_25fixp, align 4, !taffo.info !114
  br label %for.inc39
...
for.body47:                                       ; preds = %for.cond45
  ...
  %u6_26fixp = load i32, i32* %arrayidx48.u6_26fixp, align 4, !taffo.info !102
  %19 = lshr i32 %u6_26fixp, 3, !taffo.info !102
  br label %for.cond49
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55.s13_19fixp = call i32 @llvm.smul.fix.i32(i32 %22, i32 %23, i32 19), !taffo.info !119
  %24 = ashr i32 %w.2.s9_23fixp, 4, !taffo.info !102
  %sub56.s13_19fixp = sub i32 %24, %mul55.s13_19fixp, !taffo.info !122
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !76, !taffo.constinfo !21
  %25 = shl i32 %sub56.s13_19fixp, 4, !taffo.info !122
...
for.end59:                                        ; preds = %for.cond49
  ...
  %26 = shl i32 %w.2.s9_23fixp, 3, !taffo.info !102
  store i32 %26, i32* %arrayidx60.u6_26fixp, align 4, !taffo.info !114
  br label %for.inc61
...
for.body67:                                       ; preds = %for.cond65
  ...
  %u6_26fixp8 = load i32, i32* %arrayidx68.u6_26fixp, align 4, !taffo.info !102
  %add = add nsw i32 %i.2, 1, !taffo.info !74, !taffo.constinfo !21
  %27 = lshr i32 %u6_26fixp8, 4, !taffo.info !102
  br label %for.cond69

for.cond69:                                       ; preds = %for.inc77, %for.body67
  %j.3 = phi i32 [ %add, %for.body67 ], [ %inc78, %for.inc77 ], !taffo.info !130
  %w.3.s10_22fixp = phi i32 [ %27, %for.body67 ], [ %sub76.s10_22fixp, %for.inc77 ], !taffo.info !132
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75.s10_22fixp = call i32 @llvm.smul.fix.i32(i32 %29, i32 %30, i32 22), !taffo.info !133
...
for.end79:                                        ; preds = %for.cond69
  ...
  %32 = ashr i32 %w.3.s10_22fixp, 2, !taffo.info !132
  ...
  store i32 %34, i32* %arrayidx83.s4_28fixp, align 4, !taffo.info !114
  br label %for.inc84
...
for.body71:                                       ; preds = %for.cond68
  ...
  %17 = call i32 @llvm.smul.fix.i32(i32 %15, i32 %16, i32 18), !taffo.info !105
...
!97 = !{double -3.035760e-01, double 0x403FFCF893FAF428}
!98 = distinct !{!98, !23}
...
!107 = !{double 0x3F847AE147AE147C, double 0x40B0B28B44170636}
!108 = !{!106, !109, i1 false, i2 -1}
!109 = !{double 0xC0B17A8B44170636, double 1.999900e+02}
!110 = distinct !{!110, !23}
...
!121 = !{double 0.000000e+00, double 0x40A07278D0E661EE}
!122 = !{!120, !123, i1 false, i2 -1}
!123 = !{double 0xC0A20278D0E661EE, double 2.000000e+02}
!124 = distinct !{!124, !23}
!125 = distinct !{!125, !23}
...
!132 = !{!89, !104, i1 false, i2 -1}
!133 = !{!89, !134, i1 false, i2 -1}
!134 = !{double 0xC003D90949A7A372, double 0x407056C5CCC46D94}
!135 = !{!89, !136, i1 false, i2 -1}
!136 = !{double 0xC07CD6C5CCC46D94, double 0x40694F6425269E8E}
