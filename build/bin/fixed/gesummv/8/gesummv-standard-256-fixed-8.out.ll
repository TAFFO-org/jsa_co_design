; ModuleID = './build/bin/fixed/gesummv/8/gesummv-standard-256-fixed-8.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !92
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !95
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !48
  %5 = shl i32 %mul.u16_16fixp, 8, !taffo.info !95
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !92
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !95
  ...
  %7 = shl i32 %mul.u16_16fixp, 8, !taffo.info !95
...
!93 = !{!"fixp", i32 -32, i32 15}
!94 = !{double 0.000000e+00, double 6.144000e+04}
!95 = !{!96, !94, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 16}
!97 = distinct !{!97, !23}
