; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-64-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [49 x i8] c"target('A') scalar(range(6.4,1283.199951) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 64), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
!5 = !{double 0.000000e+00, double 0x40940CCCBFF47736}
...
!50 = !{double 6.400000e+00, double 0x40940CCCBFF47736}
!51 = !{i32 1}
!52 = !{i32 2}
...
!108 = !{double 1.280000e+01, double 0x40A40CCCBFF47736}
!109 = !{i1 false, !110, i1 false, i2 -1}
!110 = !{double 0x4033333333333334, double 0x40AE13331FEEB2D1}
!111 = !{i1 false, !112, i1 false, i2 1}
!112 = !{double 2.560000e+01, double 0x40B40CCCBFF47736}
!113 = !{i1 false, !112, i1 false, i2 -1}
!114 = !{i1 false, !115, i1 false, i2 1}
!115 = !{double 3.200000e+01, double 0x40B90FFFEFF19504}
!116 = !{i1 false, !117, i1 false, i2 1}
!117 = !{double 5.760000e+01, double 0x40C68E6657F3061D}
...
!140 = !{double 6.400000e+01, double 6.400000e+01}
!141 = !{i32 9}
!142 = !{i1 false, !143, i1 false, i2 -1}
!143 = !{double 4.096000e+02, double 0x40F40CCCBFF47736}
!144 = distinct !{!144, !29}
!145 = distinct !{!145, !29}
