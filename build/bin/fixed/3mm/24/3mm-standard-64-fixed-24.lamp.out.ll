; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-64-fixed-24.out.ll'
...
entry:
  ...
  %u4_28fixp = bitcast [14 x i32]* %arraydecay18.u4_28fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u4_28fixp, i32 64), !taffo.info !65, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u15_17fixp, 6, !taffo.info !237
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !255 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !256
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !259
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u16_16fixp, 6, !taffo.info !259
...
!236 = !{double 0.000000e+00, double 0x40DBBBBBE0157EED}
...
!253 = distinct !{!253, !23}
!254 = distinct !{!254, !23}
!255 = !{i32 1, !96, i32 1, !85, i32 1, !49, i32 1, !230}
!256 = !{!257, !258, i1 false, i2 -1}
!257 = !{!"fixp", i32 -32, i32 15}
!258 = !{double 0.000000e+00, double 0x40E0624DE00D1B71}
