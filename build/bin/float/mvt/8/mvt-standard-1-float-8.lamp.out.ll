; ModuleID = './build/bin/float/mvt/8/mvt-standard-1-float-8.out.ll'
...
entry:
  ...
  %arraydecay5 = getelementptr inbounds [20 x float], ptr %x1, i32 0, i32 0
  %arraydecay6 = getelementptr inbounds [20 x float], ptr %x2, i32 0, i32 0
  %arraydecay7 = getelementptr inbounds [20 x float], ptr %y_1, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [20 x float], ptr %y_2, i32 0, i32 0
  %arraydecay9 = getelementptr inbounds [20 x [20 x float]], ptr %A, i32 0, i32 0
  call void @kernel_mvt(i32 noundef %1, ptr noundef %arraydecay5, ptr noundef %arraydecay6, ptr noundef %arraydecay7, ptr noundef %arraydecay8, ptr noundef %arraydecay9)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx10 = getelementptr inbounds [20 x float], ptr @x1_float, i32 0, i32 %6
  store float %5, ptr %arrayidx10, align 4
  %7 = load i32, ptr %i, align 4
  %arrayidx11 = getelementptr inbounds [20 x float], ptr %x2, i32 0, i32 %7
  %8 = load float, ptr %arrayidx11, align 4
  %9 = load i32, ptr %i, align 4
  %arrayidx12 = getelementptr inbounds [20 x float], ptr @x2_float, i32 0, i32 %9
