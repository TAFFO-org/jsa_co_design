...
entry:
  ...
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 97, i8* null)
  ...
  call void @scale_1d(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 256)
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i64 0, i64 0
  call void @scale_1d(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 256)
