; ModuleID = './build/bin/fixed/atax/16/atax-standard-512-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4150000000000000, !taffo.info !86
...
for.body18:                                       ; preds = %for.cond16
  ...
  %14 = fdiv float %13, 3.200000e+01, !taffo.info !121
  %add24.1flp = fadd float %.flt.fallback.1flp, %14, !taffo.info !123
