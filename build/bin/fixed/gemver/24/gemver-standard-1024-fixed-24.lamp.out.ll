; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-1024-fixed-24.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u20_12fixp, 10, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u29_3fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !140 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 8.000000e+00, %lampsim15, !taffo.info !141
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !145 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !146
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !149
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u19_13fixp, 10, !taffo.info !149
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !158 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !159
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !162
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u18_14fixp, 10, !taffo.info !162
...
!129 = !{double 0.000000e+00, double 0x412E6666601BC98A}
...
!142 = !{!"float", i32 1, double 0x4255BC5260000000}
!143 = !{double 0.000000e+00, double 0x4255BC5260000000}
!144 = distinct !{!144, !27}
!145 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!146 = !{!147, !148, i1 false, i2 -1}
!147 = !{!"fixp", i32 -32, i32 12}
!148 = !{double 1.310720e+04, double 2.621440e+05}
...
!155 = !{!"float", i32 1, double 0x43B2D0EAC0000000}
!156 = !{double 0.000000e+00, double 0x43B2D0EAC0000000}
!157 = distinct !{!157, !27}
!158 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!159 = !{!160, !161, i1 false, i2 -1}
!160 = !{!"fixp", i32 -32, i32 13}
!161 = !{double 0x40C11111276FB092, double 0x410555556084A516}
!162 = !{!163, !161, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 14}
!164 = distinct !{!164, !27}
