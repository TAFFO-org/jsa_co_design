...
# %bb.2:                                # %for.body
	...
	movslq	-1956(%rbp), %rax
	movss	-1712(%rbp,%rax,4), %xmm0       # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1964(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1964(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movslq	-1956(%rbp), %rcx
	leaq	x1_float(%rip), %rax
	movss	%xmm0, (%rax,%rcx,4)
	movslq	-1956(%rbp), %rax
	movss	-1792(%rbp,%rax,4), %xmm0       # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1960(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1960(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movslq	-1956(%rbp), %rcx
	leaq	x2_float(%rip), %rax
	movss	%xmm0, (%rax,%rcx,4)
# %bb.3:                                # %for.inc
                                        #   in Loop: Header=BB7_1 Depth=1
	movl	-1956(%rbp), %eax
...
.Lfunc_end14:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function init_array.6
...
.Lfunc_end15:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_mvt.7
...
.LBB16_16:                              # %for.end38
	...
	retq
.Lfunc_end16:
	.size	kernel_mvt.7, .Lfunc_end16-kernel_mvt.7
	.cfi_endproc
                                        # -- End function
...
PrintfTimerStr:
	...
	.type	.L__unnamed_111,@object         # @0
	.section	.rodata.str1.1,"aMS",@progbits,1
.L__unnamed_111:
	.asciz	"Float_half"
	.size	.L__unnamed_111, 11

	.type	.L__unnamed_112,@object         # @1
.L__unnamed_112:
	.asciz	"Float_bfloat"
	.size	.L__unnamed_112, 13
...
.L__unnamed_2:
	...
	.type	.L__unnamed_113,@object         # @3
.L__unnamed_113:
	.asciz	"Float_double"
	.size	.L__unnamed_113, 13

	.type	.L__unnamed_114,@object         # @4
.L__unnamed_114:
	.asciz	"Float_x86_fp80"
	.size	.L__unnamed_114, 15

	.type	.L__unnamed_115,@object         # @5
.L__unnamed_115:
	.asciz	"Float_fp128"
	.size	.L__unnamed_115, 12

	.type	.L__unnamed_116,@object         # @6
.L__unnamed_116:
