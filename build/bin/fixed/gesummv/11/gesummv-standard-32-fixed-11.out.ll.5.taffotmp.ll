; ModuleID = './build/bin/fixed/gesummv/11/gesummv-standard-32-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_gesummv.5_fixp(i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay17.u5_27fixp, [16 x i32]* %arraydecay18.u5_27fixp, i32* %arraydecay19.u13_19fixp, i32* %arraydecay20.u5_27fixp, i32* %arraydecay21.u14_18fixp), !taffo.info !57, !taffo.constinfo !58
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !92
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !95
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !48
  %5 = shl i32 %mul.u10_22fixp, 5, !taffo.info !95
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !98 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !99
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !102
  %arrayidx1.u14_18fixp = getelementptr inbounds i32, i32* %val.u14_18fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u19_13fixp, 5, !taffo.info !102
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !105 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !106
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !109
  %arrayidx1.u13_19fixp = getelementptr inbounds i32, i32* %val.u13_19fixp, i32 %i.0, !taffo.info !51
  %5 = shl i32 %mul.u18_14fixp, 5, !taffo.info !109
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !92
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !95
  ...
  %7 = shl i32 %mul.u10_22fixp, 5, !taffo.info !95
...
!94 = !{double 0.000000e+00, double 9.600000e+02}
!95 = !{!96, !94, i1 false, i2 -1}
!96 = !{!"fixp", i32 32, i32 22}
!97 = distinct !{!97, !23}
!98 = !{i32 1, !75, i32 1, !54, i32 1, !84}
!99 = !{!100, !101, i1 false, i2 -1}
!100 = !{!"fixp", i32 -32, i32 12}
!101 = !{double 0.000000e+00, double 0x4116A6667FFDE721}
...
!108 = !{double 0.000000e+00, double 1.443840e+05}
!109 = !{!110, !108, i1 false, i2 -1}
!110 = !{!"fixp", i32 32, i32 14}
!111 = distinct !{!111, !23}
...
!116 = !{!79, i1 false}
!117 = !{!93, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 9.000000e+02}
!119 = !{!96, !118, i1 false, i2 -1}
