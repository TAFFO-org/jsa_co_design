; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-64-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 64), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 64), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 64), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
!55 = !{double 0.000000e+00, double 0x404D55556084A516}
...
!110 = !{double 0.000000e+00, double 0x40DE126E8CCC2BBC}
!111 = distinct !{!111, !23}
...
!117 = !{double 0.000000e+00, double 0x40B4A00007DD4413}
!118 = !{!49, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x40DE375C21F6CACD}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = distinct !{!122, !23}
...
!181 = !{!"fixp", i32 32, i32 11}
!182 = !{double 0.000000e+00, double 0x41390F5C1FFF79C8}
!183 = !{i32 9}
!184 = distinct !{!184, !23}
!185 = distinct !{!185, !23}
