; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !136
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !148
