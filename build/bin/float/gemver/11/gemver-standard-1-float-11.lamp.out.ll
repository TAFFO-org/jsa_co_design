; ModuleID = './build/bin/float/gemver/11/gemver-standard-1-float-11.out.ll'
...
entry:
  ...
  call void @kernel_gemver(i32 noundef %1, float noundef %2, float noundef %3, ptr noundef %arraydecay9, ptr noundef %arraydecay10, ptr noundef %arraydecay11, ptr noundef %arraydecay12, ptr noundef %arraydecay13, ptr noundef %arraydecay14, ptr noundef %arraydecay15, ptr noundef %arraydecay16, ptr noundef %arraydecay17)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx18 = getelementptr inbounds [20 x float], ptr @x_float, i32 0, i32 %8
  store float %7, ptr %arrayidx18, align 4
  %9 = load i32, ptr %i, align 4
  %arrayidx19 = getelementptr inbounds [20 x float], ptr %w, i32 0, i32 %9
  %10 = load float, ptr %arrayidx19, align 4
  %11 = load i32, ptr %i, align 4
  %arrayidx20 = getelementptr inbounds [20 x float], ptr @w_float, i32 0, i32 %11
...
for.body23:                                       ; preds = %for.cond21
  ...
  %arrayidx24 = getelementptr inbounds [20 x [20 x float]], ptr %A, i32 0, i32 %14
  %15 = load i32, ptr %j, align 4
  %arrayidx25 = getelementptr inbounds [20 x float], ptr %arrayidx24, i32 0, i32 %15
  %16 = load float, ptr %arrayidx25, align 4
  %17 = load i32, ptr %i, align 4
  %arrayidx26 = getelementptr inbounds [20 x [20 x float]], ptr @A_float, i32 0, i32 %17
  %18 = load i32, ptr %j, align 4
  %arrayidx27 = getelementptr inbounds [20 x float], ptr %arrayidx26, i32 0, i32 %18
  store float %16, ptr %arrayidx27, align 4
  br label %for.inc
