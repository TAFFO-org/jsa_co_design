; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-1-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  store float %1, float* %arrayidx15, align 4, !taffo.info !45, !taffo.target !35
  ...
  store float %3, float* %arrayidx17, align 4, !taffo.info !46, !taffo.target !37
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.6, i32 0, i32 0), double noundef %conv), !taffo.constinfo !50
  br label %for.inc
...
if.end12:                                         ; preds = %if.then10, %for.body6
  ...
  %call15 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %4, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.6, i32 0, i32 0), double noundef %conv14), !taffo.constinfo !50
  br label %for.inc16
