; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-4-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u6_26fixp = bitcast [20 x i32]* %arraydecay10.u6_26fixp to i32*, !taffo.info !42
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u6_26fixp, i32 4), !taffo.info !55, !taffo.constinfo !57
  %arraydecay11.u6_26fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %B.u6_26fixp, i32 0, i32 0, !taffo.info !45
  %u6_26fixp1 = bitcast [20 x i32]* %arraydecay11.u6_26fixp to i32*, !taffo.info !45
  call void @scale_2d.6_fixp(i32 20, i32 20, i32* %u6_26fixp1, i32 4), !taffo.info !58, !taffo.constinfo !57
...
for.body:                                         ; preds = %for.cond
  ...
  %s4_28fixp = load i32, i32* %arrayidx.s4_28fixp, align 4, !taffo.info !86
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !88
  %0 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !88
  %1 = ashr i32 %s4_28fixp, 2, !taffo.info !86
  %2 = ashr i32 %0, 2, !taffo.info !88
  %mul.s6_26fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 26), !taffo.info !90
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s6_26fixp, 2, !taffo.info !90
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !93 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u5_27fixp = load i32, i32* %arrayidx.u5_27fixp, align 4, !taffo.info !94
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !88
  %0 = lshr i32 %u5_27fixp, 1, !taffo.info !94
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !88
  %2 = ashr i32 %0, 2, !taffo.info !94
  %3 = ashr i32 %1, 4, !taffo.info !88
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 24), !taffo.info !96
  %mul.u7_25fixp = shl i32 %4, 1, !taffo.info !99
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u7_25fixp, 2, !taffo.info !99
...
!91 = !{double -1.517880e-01, double 0x402FFCF893FAF428}
!92 = distinct !{!92, !23}
!93 = !{i32 1, !74, i32 1, !47, i32 1, !83}
!94 = !{!95, !49, i1 false, i2 -1}
!95 = !{!"fixp", i32 32, i32 25}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 -32, i32 24}
!98 = !{double 6.440000e+01, double 7.200000e+01}
...
!180 = !{!87, !179, i1 false, i2 1}
!181 = !{!87, !182, i1 false, i2 1}
