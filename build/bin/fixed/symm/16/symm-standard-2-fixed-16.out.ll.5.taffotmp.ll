; ModuleID = './build/bin/fixed/symm/16/symm-standard-2-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_symm.3_fixp(i32 10, i32 16, i32 %0, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u8_24fixp, [10 x i32]* %arraydecay12.s12_20fixp, [16 x i32]* %arraydecay13.u3_29fixp), !taffo.info !56, !taffo.constinfo !57
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !166 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u8_24fixp = load i32, i32* %arrayidx4.u8_24fixp, align 4, !taffo.info !168
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !170
  %1 = lshr i32 %u8_24fixp, 1, !taffo.info !168
  %2 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !170
  %3 = ashr i32 %1, 1, !taffo.info !168
  %4 = ashr i32 %2, 7, !taffo.info !170
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 22), !taffo.info !171
  %mul.u9_23fixp = shl i32 %5, 1, !taffo.info !174
  ...
  %7 = shl i32 %mul.u9_23fixp, 1, !taffo.info !174
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.s12_20fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !177 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %s12_20fixp = load i32, i32* %arrayidx4.s12_20fixp, align 4, !taffo.info !178
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !170
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !170
  %2 = ashr i32 %s12_20fixp, 1, !taffo.info !178
  %3 = ashr i32 %1, 10, !taffo.info !170
  %mul.s13_19fixp = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !180
  ...
  %5 = shl i32 %mul.s13_19fixp, 1, !taffo.info !180
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !184 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.u4_28fixp = shl i32 %4, 1, !taffo.info !188
  ...
  %6 = shl i32 %mul.u4_28fixp, 1, !taffo.info !188
...
!166 = !{i32 1, !16, i32 1, !81, i32 1, !47, i32 1, !19}
!167 = !{void (i32, i32, float*, i32)* @scale_2d}
!168 = !{!169, !1, i1 false, i2 -1}
!169 = !{!"fixp", i32 32, i32 23}
!170 = !{!43, !20, i1 false, i2 1}
!171 = !{!172, !173, i1 false, i2 -1}
!172 = !{!"fixp", i32 -32, i32 22}
!173 = !{double 0.000000e+00, double 0x4075A51EC0B56755}
!174 = !{!169, !173, i1 false, i2 -1}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = !{i32 1, !16, i32 1, !16, i32 1, !50, i32 1, !19}
!178 = !{!179, !52, i1 false, i2 -1}
!179 = !{!"fixp", i32 -32, i32 19}
!180 = !{!179, !181, i1 false, i2 -1}
!181 = !{double -3.996000e+03, double 7.200000e+00}
!182 = distinct !{!182, !23}
!183 = distinct !{!183, !23}
!184 = !{i32 1, !16, i32 1, !81, i32 1, !53, i32 1, !19}
!185 = !{!66, !20, i1 false, i2 1}
!186 = !{!100, !187, i1 false, i2 -1}
!187 = !{double 4.000000e-01, double 1.000000e+01}
!188 = !{!66, !187, i1 false, i2 -1}
!189 = distinct !{!189, !23}
!190 = distinct !{!190, !23}
