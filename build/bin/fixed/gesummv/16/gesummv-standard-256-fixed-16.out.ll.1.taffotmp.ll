...
entry:
  ...
  call void @llvm.var.annotation(i8* %alpha1, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 115, i8* null)
  %beta2 = bitcast float* %beta to i8*
  call void @llvm.var.annotation(i8* %beta2, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 116, i8* null)
  %A3 = bitcast [16 x [16 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 117, i8* null)
  %B4 = bitcast [16 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B4, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 118, i8* null)
  %tmp5 = bitcast [16 x float]* %tmp to i8*
  call void @llvm.var.annotation(i8* %tmp5, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 119, i8* null)
  %x6 = bitcast [16 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x6, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  %y7 = bitcast [16 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y7, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 121, i8* null)
  %0 = load i32, i32* %n, align 4
  %arraydecay = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %A, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %B, i32 0, i32 0
  %arraydecay9 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0
  %arraydecay10 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0
  %arraydecay11 = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 0
  ...
  call void @scale_scalar(float* noundef %alpha, i32 noundef 256)
  call void @scale_scalar(float* noundef %beta, i32 noundef 256)
  %arraydecay12 = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %A, i32 0, i32 0
  %1 = bitcast [16 x float]* %arraydecay12 to float*
  call void @scale_2d(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 256)
  %arraydecay13 = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %B, i32 0, i32 0
  %2 = bitcast [16 x float]* %arraydecay13 to float*
  call void @scale_2d(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 256)
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 256)
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 256)
  %arraydecay16 = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 256)
  call void @timer_start()
  %3 = load i32, i32* %n, align 4
  %4 = load float, float* %alpha, align 4
  %5 = load float, float* %beta, align 4
  %arraydecay17 = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %A, i32 0, i32 0
  %arraydecay18 = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %B, i32 0, i32 0
  %arraydecay19 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0
  %arraydecay20 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0
  %arraydecay21 = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 0
...
for.body:                                         ; preds = %for.cond
  %8 = load i32, i32* %i, align 4
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 %8
...
entry:
  ...
  call void @llvm.var.annotation(i8* %i1, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 39, i8* null)
  %j2 = bitcast i32* %j to i8*
  call void @llvm.var.annotation(i8* %j2, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 40, i8* null)
...
for.body:                                         ; preds = %for.cond
  ...
  %10 = load i32, i32* %i, align 4
  %arrayidx4 = getelementptr inbounds float, float* %9, i32 %10
  store float 0.000000e+00, float* %arrayidx4, align 4
  %11 = load float*, float** %tmp.addr, align 4
  %12 = load i32, i32* %i, align 4
  %arrayidx5 = getelementptr inbounds float, float* %11, i32 %12
...
for.body9:                                        ; preds = %for.cond6
  ...
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %19, i32 %20
  %21 = load i32, i32* %j, align 4
  %arrayidx15 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx14, i32 0, i32 %21
  ...
  %27 = load i32, i32* %i, align 4
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %26, i32 %27
  %28 = load i32, i32* %j, align 4
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %28
