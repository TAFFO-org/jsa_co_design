; ModuleID = './build/bin/fixed/heat-3d/16/heat-3d-standard-64-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 64), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 64), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
!103 = !{double 2.560000e+02, double 3.328000e+03}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -3.200000e+03, double 1.408000e+03}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -3.072000e+03, double 3.072000e+03}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 21}
!111 = !{double -3.840000e+02, double 3.840000e+02}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -7.680000e+02, double 7.680000e+02}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -1.152000e+03, double 1.152000e+03}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -1.024000e+03, double 2.816000e+03}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!168 = !{double 8.192000e+03, double 1.064960e+05}
!169 = distinct !{!169, !23}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
