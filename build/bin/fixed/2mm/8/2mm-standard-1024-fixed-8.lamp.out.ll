; ModuleID = './build/bin/fixed/2mm/8/2mm-standard-1024-fixed-8.out.ll'
...
entry:
  ...
  call void @kernel_2mm.3_fixp(i32 8, i32 10, i32 12, i32 14, i32 %u2_30fixp, i32 %u2_30fixp1, [10 x i32]* %arraydecay17.u23_9fixp, [12 x i32]* %arraydecay18.u10_22fixp, [10 x i32]* %arraydecay19.u10_22fixp, [14 x i32]* %arraydecay20.u10_22fixp, [14 x float]* %arraydecay21.flt.1flp), !taffo.info !62, !taffo.constinfo !63
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !221 !taffo.funinfo !232 !taffo.sourceFunction !223 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !224
  ...
  %6 = fmul float 5.120000e+02, %lampsim15, !taffo.info !233
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim1 = and i32 %lampsim, -65536
  %lampsim2 = bitcast i32 %lampsim1 to float
  %2 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !224
  %lampsim3 = bitcast float %2 to i32
  %lampsim4 = and i32 %lampsim3, -65536
  %lampsim5 = bitcast i32 %lampsim4 to float
...
!234 = !{!"float", i32 1, double 0x41F2733320000000}
!235 = !{double 0.000000e+00, double 0x41F2733320000000}
!236 = distinct !{!236, !23}
!237 = distinct !{!237, !23}
!238 = !{i32 1, !89, i32 1, !91, i32 1, !57, i32 1, !101}
!239 = !{i32 8}
!240 = !{!241, !242, i1 false, i2 -1}
!241 = !{!"float", i32 1, double 0x42B32E6660000000}
!242 = !{double 0.000000e+00, double 0x42B32E6660000000}
!243 = distinct !{!243, !23}
!244 = distinct !{!244, !23}
