; ModuleID = './build/bin/fixed/heat-3d/16/heat-3d-standard-2-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [42 x i8] c"target('A') scalar(range(4.0,52.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [20 x i8] c"./sources/heat-3d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [30 x i8] c"scalar(range(4.0,52.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 2), !taffo.initweight !55, !taffo.target !48, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
  ...
  call void @scale_3d.4(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 2), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !56, !taffo.constinfo !57
...
for.body6:                                        ; preds = %for.cond4
  ...
  %mul = fmul float %3, %conv, !taffo.initweight !127, !taffo.info !121
...
!7 = !{double 0.000000e+00, double 5.200000e+01}
...
!50 = !{double 4.000000e+00, double 5.200000e+01}
!51 = !{i32 1}
!52 = !{i32 2}
...
!122 = !{double 8.000000e+00, double 1.040000e+02}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double -1.000000e+02, double 4.400000e+01}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double -9.600000e+01, double 9.600000e+01}
!127 = !{i32 10}
!128 = !{i1 false, !129, i1 false, i2 -1}
!129 = !{double -1.200000e+01, double 1.200000e+01}
!130 = !{i32 11}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -2.400000e+01, double 2.400000e+01}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double -3.600000e+01, double 3.600000e+01}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -3.200000e+01, double 8.800000e+01}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
...
!164 = !{i32 1, !101, i32 1, !101, i32 1, !101, i32 1, !49, i32 1, !25}
