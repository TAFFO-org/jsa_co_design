; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-16-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.info !60, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 16), !taffo.info !65, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 16), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 16), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 16), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k.3(i32 noundef %n, i32 noundef %m, float noundef %alpha, float noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [10 x float]* noundef %B) #0 !taffo.initweight !100 !taffo.funinfo !101 !taffo.sourceFunction !74 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.info !48, !taffo.initweight !102
  %arrayidx4 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !48, !taffo.initweight !103
  ...
  store float %mul, float* %arrayidx4, align 4, !taffo.info !65, !taffo.initweight !103
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %j.1, !taffo.info !51, !taffo.initweight !102
  %arrayidx12 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx11, i32 0, i32 %k.0, !taffo.info !51, !taffo.initweight !103
  %1 = load float, float* %arrayidx12, align 4, !taffo.info !110, !taffo.initweight !106
  %mul13 = fmul float %1, %alpha, !taffo.info !112, !taffo.initweight !102
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.0, !taffo.info !54, !taffo.initweight !102
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx14, i32 0, i32 %k.0, !taffo.info !54, !taffo.initweight !103
  %2 = load float, float* %arrayidx15, align 4, !taffo.info !54, !taffo.initweight !106
  %mul16 = fmul float %mul13, %2, !taffo.info !114, !taffo.initweight !103
  %arrayidx17 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %j.1, !taffo.info !54, !taffo.initweight !102
  %arrayidx18 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx17, i32 0, i32 %k.0, !taffo.info !54, !taffo.initweight !103
  %3 = load float, float* %arrayidx18, align 4, !taffo.info !117, !taffo.initweight !106
  %mul19 = fmul float %3, %alpha, !taffo.info !118, !taffo.initweight !102
  %arrayidx20 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !51, !taffo.initweight !102
  %arrayidx21 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx20, i32 0, i32 %k.0, !taffo.info !51, !taffo.initweight !103
  %4 = load float, float* %arrayidx21, align 4, !taffo.info !51, !taffo.initweight !106
  %mul22 = fmul float %mul19, %4, !taffo.info !114, !taffo.initweight !103
  %add = fadd float %mul16, %mul22, !taffo.info !120, !taffo.initweight !106
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.info !48, !taffo.initweight !102
  %arrayidx24 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx23, i32 0, i32 %j.1, !taffo.info !48, !taffo.initweight !103
  %5 = load float, float* %arrayidx24, align 4, !taffo.info !104, !taffo.initweight !106
  %add25 = fadd float %5, %add, !taffo.info !122, !taffo.initweight !124
  store float %add25, float* %arrayidx24, align 4, !taffo.info !67, !taffo.initweight !106
  br label %for.inc26
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, i32 noundef %m, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [10 x float]* noundef %B) #0 !taffo.initweight !128 !taffo.funinfo !101 !taffo.sourceFunction !62 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !60, !taffo.initweight !81, !taffo.constinfo !129
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !65, !taffo.initweight !81, !taffo.constinfo !131
  br label %for.cond

for.cond:                                         ; preds = %for.inc16, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc17, %for.inc16 ], !taffo.info !134, !taffo.initweight !45
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !135, !taffo.initweight !66
  br i1 %cmp, label %for.body, label %for.end18, !taffo.info !136, !taffo.initweight !68

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !138, !taffo.initweight !45
  %cmp4 = icmp slt i32 %j.0, %m, !taffo.info !135, !taffo.initweight !66
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !140, !taffo.initweight !68

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !141, !taffo.initweight !66
  %add = add nsw i32 %mul, 1, !taffo.info !143, !taffo.initweight !68, !taffo.constinfo !21
  %rem = srem i32 %add, %n, !taffo.info !145, !taffo.initweight !81
  %conv = sitofp i32 %rem to float, !taffo.info !146, !taffo.initweight !102
  %conv6 = sitofp i32 %n to float, !taffo.info !147
  %div = fdiv float %conv, %conv6, !taffo.info !148, !taffo.initweight !103
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !146, !taffo.initweight !66
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !146, !taffo.initweight !66
  store float %div, float* %arrayidx7, align 4, !taffo.info !151, !taffo.initweight !68
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.info !141, !taffo.initweight !66
  %add9 = add nsw i32 %mul8, 2, !taffo.info !152, !taffo.initweight !68, !taffo.constinfo !21
  %rem10 = srem i32 %add9, %m, !taffo.info !154, !taffo.initweight !81
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !156, !taffo.initweight !102
  %conv12 = sitofp i32 %m to float, !taffo.info !157
  %div13 = fdiv float %conv11, %conv12, !taffo.info !158, !taffo.initweight !103
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.0, !taffo.info !160, !taffo.initweight !66
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.info !160, !taffo.initweight !66
  store float %div13, float* %arrayidx15, align 4, !taffo.info !151, !taffo.initweight !68
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !161, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.info !164, !taffo.initweight !66, !taffo.constinfo !21
...
for.cond19:                                       ; preds = %for.inc38, %for.end18
  %i.1 = phi i32 [ 0, %for.end18 ], [ %inc39, %for.inc38 ], !taffo.info !134, !taffo.initweight !45
  %cmp20 = icmp slt i32 %i.1, %n, !taffo.info !135, !taffo.initweight !66
  br i1 %cmp20, label %for.body22, label %for.end40, !taffo.info !136, !taffo.initweight !68

for.body22:                                       ; preds = %for.cond19
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc35, %for.body22
  %j.1 = phi i32 [ 0, %for.body22 ], [ %inc36, %for.inc35 ], !taffo.info !138, !taffo.initweight !45
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.info !166, !taffo.initweight !66
  br i1 %cmp24, label %for.body26, label %for.end37, !taffo.info !140, !taffo.initweight !68

for.body26:                                       ; preds = %for.cond23
  %mul27 = mul nsw i32 %i.1, %j.1, !taffo.info !141, !taffo.initweight !66
  %add28 = add nsw i32 %mul27, 3, !taffo.info !167, !taffo.initweight !68, !taffo.constinfo !21
  %rem29 = srem i32 %add28, %n, !taffo.info !145, !taffo.initweight !81
  %conv30 = sitofp i32 %rem29 to float, !taffo.info !146, !taffo.initweight !102
  %conv31 = sitofp i32 %m to float, !taffo.info !157
  %div32 = fdiv float %conv30, %conv31, !taffo.info !169, !taffo.initweight !103
  %arrayidx33 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.info !171, !taffo.initweight !66
  %arrayidx34 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx33, i32 0, i32 %j.1, !taffo.info !171, !taffo.initweight !66
  store float %div32, float* %arrayidx34, align 4, !taffo.info !151, !taffo.initweight !68
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.info !161, !taffo.initweight !66, !taffo.constinfo !21
  br label %for.cond23, !llvm.loop !172

for.end37:                                        ; preds = %for.cond23
  br label %for.inc38

for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.info !164, !taffo.initweight !66, !taffo.constinfo !21
  br label %for.cond19, !llvm.loop !173
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !174 !taffo.funinfo !175 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !176, !taffo.initweight !179
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !174 !taffo.funinfo !182 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !124
  %conv = sitofp i32 %factor to float, !taffo.info !147
  %mul = fmul float %1, %conv, !taffo.info !183, !taffo.initweight !179
  %2 = mul nsw i32 %i.0, %m, !taffo.info !93
...
!53 = !{double 0.000000e+00, double 1.500000e+01}
!54 = !{!52, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 1.440000e+01}
...
!97 = distinct !{!97, !23}
!98 = !{i32 1, i32 -1}
!99 = !{i32 1, !42, i32 1, !89}
!100 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!101 = !{i32 1, !89, i32 1, !16, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!102 = !{i32 5}
!103 = !{i32 6}
...
!108 = !{double 0.000000e+00, double 0x40A2BA9FACD9117F}
!109 = distinct !{!109, !23}
!110 = !{!111, !53, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 27}
!112 = !{!111, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 2.250000e+01}
!114 = !{!115, !116, i1 false, i2 -1}
!115 = !{!"fixp", i32 32, i32 22}
!116 = !{double 0.000000e+00, double 3.240000e+02}
!117 = !{!111, !55, i1 false, i2 -1}
!118 = !{!111, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 2.160000e+01}
!120 = !{!105, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 6.480000e+02}
!122 = !{!105, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40A4AB85100A393F}
!124 = !{i32 8}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
...
!129 = !{!130, i1 false}
!130 = !{i1 false, !44, i1 false, i2 0}
!131 = !{!132, i1 false}
!132 = !{i1 false, !133, i1 false, i2 0}
!133 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!134 = !{i1 false, !76, i1 false, i2 1}
!135 = !{i1 false, !78, i1 false, i2 1}
!136 = !{i1 false, !137, i1 false, i2 1}
!137 = !{double 0.000000e+00, double 1.600000e+01}
!138 = !{i1 false, !139, i1 false, i2 1}
!139 = !{double 0.000000e+00, double 1.100000e+01}
!140 = !{i1 false, !3, i1 false, i2 1}
!141 = !{i1 false, !142, i1 false, i2 1}
!142 = !{double 0.000000e+00, double 1.600000e+02}
!143 = !{i1 false, !144, i1 false, i2 1}
!144 = !{double 1.000000e+00, double 1.610000e+02}
!145 = !{i1 false, !53, i1 false, i2 1}
!146 = !{!52, !53, i1 false, i2 1}
!147 = !{!111, !90, i1 false, i2 1}
...
!156 = !{!52, !155, i1 false, i2 1}
!157 = !{!52, !17, i1 false, i2 1}
!158 = !{!149, !159, i1 false, i2 1}
!159 = !{double 0.000000e+00, double 9.000000e-01}
!160 = !{!52, !55, i1 false, i2 1}
!161 = !{i1 false, !162, i1 false, i2 1}
!162 = !{double 1.000000e+00, double 1.100000e+01}
!163 = distinct !{!163, !23}
!164 = !{i1 false, !86, i1 false, i2 1}
!165 = distinct !{!165, !23}
!166 = !{i1 false, !92, i1 false, i2 1}
!167 = !{i1 false, !168, i1 false, i2 1}
!168 = !{double 3.000000e+00, double 1.630000e+02}
!169 = !{!52, !170, i1 false, i2 1}
!170 = !{double 0.000000e+00, double 1.500000e+00}
!171 = !{!49, !1, i1 false, i2 1}
!172 = distinct !{!172, !23}
!173 = distinct !{!173, !23}
!174 = !{i32 -1, i32 -1, i32 3, i32 -1}
!175 = !{i32 1, !89, i32 1, !89, i32 1, !48, i32 1, !89}
!176 = !{!177, !178, i1 false, i2 -1}
!177 = !{!"fixp", i32 32, i32 17}
!178 = !{double 0.000000e+00, double 0x40DF370A2014727E}
!179 = !{i32 9}
!180 = distinct !{!180, !23}
!181 = distinct !{!181, !23}
!182 = !{i32 1, !89, i32 1, !16, i32 1, !51, i32 1, !89}
!183 = !{!184, !185, i1 false, i2 -1}
!184 = !{!"fixp", i32 32, i32 24}
!185 = !{double 0.000000e+00, double 2.400000e+02}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
