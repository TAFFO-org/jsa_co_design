; ModuleID = './build/bin/float/mvt/8/mvt-standard-32-float-8.out.ll'
source_filename = "./sources/mvt.c"
target datalayout = "e-m:e-p:32:32-p270:32:32-p271:32:32-p272:64:64-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-unknown-linux-gnu"

@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,30.4) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [50 x i8] c"target('x1') scalar(range(0.0,5044.800293) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [50 x i8] c"target('x2') scalar(range(0.0,5110.399902) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay5, i32 noundef 32)
  ...
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay9, i32 noundef 32)
