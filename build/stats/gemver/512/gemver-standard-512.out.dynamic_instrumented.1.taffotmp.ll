...
entry:
  ...
  call void @llvm.var.annotation(i8* %alpha1, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 153, i8* null)
  %beta2 = bitcast float* %beta to i8*
  call void @llvm.var.annotation(i8* %beta2, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 154, i8* null)
  %A3 = bitcast [20 x [20 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 155, i8* null)
  %u14 = bitcast [20 x float]* %u1 to i8*
  call void @llvm.var.annotation(i8* %u14, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 156, i8* null)
  %v15 = bitcast [20 x float]* %v1 to i8*
  call void @llvm.var.annotation(i8* %v15, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 157, i8* null)
  %u26 = bitcast [20 x float]* %u2 to i8*
  call void @llvm.var.annotation(i8* %u26, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 158, i8* null)
  %v27 = bitcast [20 x float]* %v2 to i8*
  call void @llvm.var.annotation(i8* %v27, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 159, i8* null)
  ...
  call void @llvm.var.annotation(i8* %x9, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 161, i8* null)
  %y10 = bitcast [20 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y10, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 162, i8* null)
  %z11 = bitcast [20 x float]* %z to i8*
  call void @llvm.var.annotation(i8* %z11, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 163, i8* null)
