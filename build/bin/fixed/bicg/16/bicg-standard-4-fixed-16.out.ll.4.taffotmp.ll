; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-4-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 4), !taffo.info !58, !taffo.initweight !62, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 4), !taffo.info !65, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !50, !taffo.originalCall !67
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 4), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !52, !taffo.originalCall !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.info !53, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 4), !taffo.info !69, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.info !44, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 4), !taffo.info !58, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !101, !taffo.initweight !103
  %conv = sitofp i32 %factor to float, !taffo.info !104
  %mul = fmul float %0, %conv, !taffo.info !105, !taffo.initweight !107
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !48, !taffo.initweight !100
  store float %mul, float* %arrayidx1, align 4, !taffo.info !65, !taffo.initweight !103
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !96 !taffo.funinfo !109 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !110, !taffo.initweight !103
  ...
  store float %mul, float* %arrayidx1, align 4, !taffo.info !69, !taffo.initweight !103
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_bicg.4(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %s, float* noundef %q, float* noundef %p, float* noundef %r) #0 !taffo.initweight !116 !taffo.funinfo !117 !taffo.sourceFunction !71 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !118, !taffo.initweight !100, !taffo.constinfo !119
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !118, !taffo.initweight !100, !taffo.constinfo !119
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %0 = load float, float* %arrayidx8, align 4, !taffo.info !48, !taffo.initweight !103
  %arrayidx9 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.info !44, !taffo.initweight !100
  %1 = load float, float* %arrayidx9, align 4, !taffo.info !121, !taffo.initweight !103
  %arrayidx10 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !44, !taffo.initweight !100
  %arrayidx11 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx10, i32 0, i32 %j.0, !taffo.info !44, !taffo.initweight !103
  %2 = load float, float* %arrayidx11, align 4, !taffo.info !121, !taffo.initweight !107
  %mul = fmul float %1, %2, !taffo.info !123, !taffo.initweight !107
  %add = fadd float %0, %mul, !taffo.info !125, !taffo.initweight !107
  %arrayidx12 = getelementptr inbounds float, float* %s, i32 %j.0, !taffo.info !48, !taffo.initweight !100
  store float %add, float* %arrayidx12, align 4, !taffo.info !65, !taffo.initweight !103
  %arrayidx13 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !51, !taffo.initweight !100
  %3 = load float, float* %arrayidx13, align 4, !taffo.info !51, !taffo.initweight !103
  %arrayidx14 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !44, !taffo.initweight !100
  %arrayidx15 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.info !44, !taffo.initweight !103
  %4 = load float, float* %arrayidx15, align 4, !taffo.info !121, !taffo.initweight !107
  %arrayidx16 = getelementptr inbounds float, float* %p, i32 %j.0, !taffo.info !53, !taffo.initweight !100
  %5 = load float, float* %arrayidx16, align 4, !taffo.info !127, !taffo.initweight !103
  %mul17 = fmul float %4, %5, !taffo.info !128, !taffo.initweight !107
  %add18 = fadd float %3, %mul17, !taffo.info !130, !taffo.initweight !107
  %arrayidx19 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !51, !taffo.initweight !100
  store float %add18, float* %arrayidx19, align 4, !taffo.info !68, !taffo.initweight !103
  br label %for.inc20
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %m, i32 noundef %n, [20 x float]* noundef %A, float* noundef %r, float* noundef %p, float* noundef %s, float* noundef %q) #0 !taffo.initweight !116 !taffo.funinfo !134 !taffo.sourceFunction !61 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !135, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !136, !taffo.initweight !59
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !137, !taffo.initweight !62

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %m, !taffo.info !139, !taffo.initweight !59
  %conv = sitofp i32 %rem to float, !taffo.info !141, !taffo.initweight !62
  %conv3 = sitofp i32 %m to float, !taffo.info !142
  %div = fdiv float %conv, %conv3, !taffo.info !143, !taffo.initweight !146
  %arrayidx = getelementptr inbounds float, float* %p, i32 %i.0, !taffo.info !147, !taffo.initweight !59
  store float %div, float* %arrayidx, align 4, !taffo.info !118, !taffo.initweight !62
  %arrayidx4 = getelementptr inbounds float, float* %s, i32 %i.0, !taffo.info !148, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !118, !taffo.initweight !62, !taffo.constinfo !119
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !149, !taffo.initweight !59, !taffo.constinfo !23
...
for.cond5:                                        ; preds = %for.inc28, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc29, %for.inc28 ], !taffo.info !135, !taffo.initweight !47
  %cmp6 = icmp slt i32 %i.1, %n, !taffo.info !136, !taffo.initweight !59
  br i1 %cmp6, label %for.body8, label %for.end30, !taffo.info !137, !taffo.initweight !62

for.body8:                                        ; preds = %for.cond5
  %rem9 = srem i32 %i.1, %n, !taffo.info !151, !taffo.initweight !59
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !152, !taffo.initweight !62
  %conv11 = sitofp i32 %n to float, !taffo.info !153
  %div12 = fdiv float %conv10, %conv11, !taffo.info !154, !taffo.initweight !146
  %arrayidx13 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.info !156, !taffo.initweight !59
  store float %div12, float* %arrayidx13, align 4, !taffo.info !118, !taffo.initweight !62
  %arrayidx14 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !157, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx14, align 4, !taffo.info !118, !taffo.initweight !62, !taffo.constinfo !119
  br label %for.cond15

for.cond15:                                       ; preds = %for.inc25, %for.body8
  %j.0 = phi i32 [ 0, %for.body8 ], [ %inc26, %for.inc25 ], !taffo.info !151, !taffo.initweight !47
  %cmp16 = icmp slt i32 %j.0, %m, !taffo.info !136, !taffo.initweight !59
  br i1 %cmp16, label %for.body18, label %for.end27, !taffo.info !158, !taffo.initweight !62

for.body18:                                       ; preds = %for.cond15
  %add = add nsw i32 %j.0, 1, !taffo.info !160, !taffo.initweight !59, !taffo.constinfo !23
  %mul = mul nsw i32 %i.1, %add, !taffo.info !161, !taffo.initweight !59
  %rem19 = srem i32 %mul, %n, !taffo.info !151, !taffo.initweight !62
  %conv20 = sitofp i32 %rem19 to float, !taffo.info !152, !taffo.initweight !146
  %conv21 = sitofp i32 %n to float, !taffo.info !153
  %div22 = fdiv float %conv20, %conv21, !taffo.info !154, !taffo.initweight !100
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !156, !taffo.initweight !59
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx23, i32 0, i32 %j.0, !taffo.info !156, !taffo.initweight !59
  store float %div22, float* %arrayidx24, align 4, !taffo.info !118, !taffo.initweight !62
  br label %for.inc25

for.inc25:                                        ; preds = %for.body18
  %inc26 = add nsw i32 %j.0, 1, !taffo.info !160, !taffo.initweight !59, !taffo.constinfo !23
...
for.inc28:                                        ; preds = %for.end27
  %inc29 = add nsw i32 %i.1, 1, !taffo.info !149, !taffo.initweight !59, !taffo.constinfo !23
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.info !44, !taffo.initweight !103
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !44, !taffo.initweight !107
  ...
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !44, !taffo.initweight !103
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !44, !taffo.initweight !107
  store float %mul, float* %arrayidx6, align 4, !taffo.info !58, !taffo.initweight !168
  br label %for.inc
...
!54 = !{double 0.000000e+00, double 3.800000e+00}
...
!100 = !{i32 5}
!101 = !{!102, !1, i1 false, i2 -1}
!102 = !{!"fixp", i32 32, i32 23}
!103 = !{i32 6}
!104 = !{!45, !99, i1 false, i2 1}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double 0.000000e+00, double 0x407B5D1761459536}
!107 = !{i32 7}
!108 = distinct !{!108, !25}
!109 = !{i32 1, !85, i32 1, !53, i32 1, !98}
!110 = !{!111, !54, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 27}
!112 = !{!111, !99, i1 false, i2 1}
!113 = !{!111, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 1.520000e+01}
!115 = distinct !{!115, !25}
!116 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!117 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !48, i32 1, !51, i32 1, !53, i32 1, !44}
!118 = !{i1 false, i1 false, i1 false, i2 1}
!119 = !{!91, i1 false}
!120 = distinct !{!120, !25}
!121 = !{!122, !46, i1 false, i2 -1}
!122 = !{!"fixp", i32 32, i32 28}
!123 = !{!122, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x402D2832F576C918}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x405F021DBFF46E59}
!127 = !{!122, !54, i1 false, i2 -1}
!128 = !{!122, !129, i1 false, i2 -1}
!129 = !{double 0.000000e+00, double 0x402D04A7A779562D}
!130 = !{!49, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 0x405BCF2094CAFDC0}
!132 = distinct !{!132, !25}
!133 = distinct !{!133, !25}
!134 = !{i32 1, !85, i32 1, !87, i32 1, !44, i32 1, !44, i32 1, !53, i32 1, !48, i32 1, !51}
!135 = !{i1 false, !80, i1 false, i2 1}
!136 = !{i1 false, !75, i1 false, i2 1}
...
!141 = !{!111, !140, i1 false, i2 1}
!142 = !{!111, !86, i1 false, i2 1}
!143 = !{!144, !145, i1 false, i2 1}
!144 = !{!"fixp", i32 32, i32 31}
!145 = !{double 0.000000e+00, double 0x3FEE666666666666}
!146 = !{i32 4}
!147 = !{!45, !54, i1 false, i2 1}
!148 = !{!49, !1, i1 false, i2 1}
!149 = !{i1 false, !82, i1 false, i2 1}
!150 = distinct !{!150, !25}
!151 = !{i1 false, !73, i1 false, i2 1}
!152 = !{!111, !73, i1 false, i2 1}
!153 = !{!111, !88, i1 false, i2 1}
!154 = !{!144, !155, i1 false, i2 1}
!155 = !{double 0.000000e+00, double 0x3FEE8BA2E8BA2E8C}
!156 = !{!45, !46, i1 false, i2 1}
!157 = !{!49, !3, i1 false, i2 1}
...
!166 = !{i32 1, !87, i32 1, !85, i32 1, !44, i32 1, !98}
!167 = !{!111, !46, i1 false, i2 -1}
!168 = !{i32 8}
!169 = !{!111, !170, i1 false, i2 -1}
!170 = !{double 0.000000e+00, double 0x402E8BA301216830}
!171 = !{i32 9}
!172 = distinct !{!172, !25}
!173 = distinct !{!173, !25}
