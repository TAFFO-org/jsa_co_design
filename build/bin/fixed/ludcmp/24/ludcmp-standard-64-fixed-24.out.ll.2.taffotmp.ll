; ModuleID = './build/bin/fixed/ludcmp/24/ludcmp-standard-64-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 64), !taffo.initweight !46, !taffo.info !32, !taffo.originalCall !47
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 64), !taffo.initweight !46, !taffo.info !34, !taffo.originalCall !47
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !43, !taffo.info !36
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 64), !taffo.initweight !44, !taffo.info !36, !taffo.originalCall !48
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 64), !taffo.initweight !44, !taffo.info !38, !taffo.target !40, !taffo.originalCall !48
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !43, !taffo.info !41
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 64), !taffo.initweight !44, !taffo.info !41, !taffo.originalCall !48
...
!33 = !{double 1.000000e-01, double 0x40805851DFFC547A}
!34 = !{i1 false, !35, i1 false, i2 -1}
!35 = !{double 6.400000e+01, double 0x40805851DFFC547A}
!36 = !{i1 false, !37, i1 false, i2 -1}
!37 = !{double 0x407019999FE43676, double 2.880000e+02}
!38 = !{i1 false, !39, i1 false, i2 -1}
!39 = !{double -3.794700e-02, double 0x400FFCF893FAF428}
!40 = !{!"x"}
!41 = !{i1 false, !42, i1 false, i2 -1}
!42 = !{double 0.000000e+00, double 0x407019999FE43676}
!43 = !{i32 1}
!44 = !{i32 2}
