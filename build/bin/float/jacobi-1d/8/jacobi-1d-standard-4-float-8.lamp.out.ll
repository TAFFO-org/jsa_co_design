; ModuleID = './build/bin/float/jacobi-1d/8/jacobi-1d-standard-4-float-8.out.ll'
...
entry:
  ...
  call void @scale_1d(i32 noundef 15, ptr noundef %arraydecay2, i32 noundef 4)
  %arraydecay3 = getelementptr inbounds [15 x float], ptr %B, i32 0, i32 0
  call void @scale_1d(i32 noundef 15, ptr noundef %arraydecay3, i32 noundef 4)
