; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-64-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 3.276800e+04, !taffo.info !69
  %arrayidx38 = getelementptr inbounds [20 x float], [20 x float]* @x_float, i32 0, i32 %i.0, !taffo.info !0
  store float %1, float* %arrayidx38, align 4, !taffo.info !88
...
for.body43:                                       ; preds = %for.cond41
  ...
  %3 = fdiv float %2, 0x4140000000000000, !taffo.info !52
  ...
  store float %3, float* %arrayidx47, align 4, !taffo.info !80
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.15, i32 0, i32 0), double noundef %conv), !taffo.constinfo !83
  br label %for.inc
...
if.end19:                                         ; preds = %if.then17, %for.body13
  ...
  %call22 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %4, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.15, i32 0, i32 0), double noundef %conv21), !taffo.constinfo !83
  br label %for.inc23
...
if.end35:                                         ; preds = %if.then33, %for.body29
  ...
  %call38 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %7, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.15, i32 0, i32 0), double noundef %conv37), !taffo.constinfo !83
  br label %for.inc39
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !122 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !126
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !129
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u10_22fixp, 6, !taffo.info !129
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !132 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !133
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !136
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u12_20fixp, 6, !taffo.info !136
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !139 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !140
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !141
  %conv.u7_25fixp = shl i32 %factor, 25, !taffo.info !124
  %0 = uitofp i32 %conv.u7_25fixp to float, !taffo.info !124
  %1 = fdiv float %0, 0x4180000000000000, !taffo.info !124
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !142
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !140
  store float %mul.1flp, float* %arrayidx1.flt.1flp, align 4, !taffo.info !87
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u5_27fixp, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !146 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 20), !taffo.info !147
  %mul.u11_21fixp = shl i32 %4, 1, !taffo.info !150
  %arrayidx1.u5_27fixp = getelementptr inbounds i32, i32* %val.u5_27fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u11_21fixp, 6, !taffo.info !150
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !121 !taffo.funinfo !152 !taffo.sourceFunction !123 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 8), !taffo.info !153
  %mul.u23_9fixp = shl i32 %4, 1, !taffo.info !156
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !69
  %5 = shl i32 %mul.u23_9fixp, 6, !taffo.info !156
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !140
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !141
  ...
  %34 = fdiv float %33, 1.600000e+01, !taffo.info !198
  %add58.1flp = fadd float %.flt.fallback.1flp, %34, !taffo.info !200
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !140
  store float %add58.1flp, float* %arrayidx59.flt.1flp, align 4, !taffo.info !87
  br label %for.inc60
...
!122 = !{i32 1, !106, i32 1, !62, i32 1, !118}
...
!128 = !{double 0x404111105E1C1509, double 0x408555556084A516}
!129 = !{!130, !128, i1 false, i2 -1}
!130 = !{!"fixp", i32 32, i32 22}
!131 = distinct !{!131, !27}
!132 = !{i32 1, !106, i32 1, !54, i32 1, !118}
!133 = !{!134, !135, i1 false, i2 -1}
!134 = !{!"fixp", i32 -32, i32 19}
!135 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!136 = !{!137, !135, i1 false, i2 -1}
!137 = !{!"fixp", i32 32, i32 20}
!138 = distinct !{!138, !27}
!139 = !{i32 1, !106, i32 1, !65, i32 1, !118}
!140 = !{i32 5}
!141 = !{i32 6}
!142 = !{!143, !144, i1 false, i2 -1}
!143 = !{!"float", i32 1, double 0x42341CCAE0000000}
!144 = !{double 0.000000e+00, double 0x42341CCAE0000000}
!145 = distinct !{!145, !27}
!146 = !{i32 1, !106, i32 1, !57, i32 1, !118}
!147 = !{!148, !149, i1 false, i2 -1}
!148 = !{!"fixp", i32 -32, i32 20}
!149 = !{double 5.120000e+01, double 1.024000e+03}
!150 = !{!53, !149, i1 false, i2 -1}
!151 = distinct !{!151, !27}
!152 = !{i32 1, !106, i32 1, !69, i32 1, !118}
!153 = !{!154, !155, i1 false, i2 -1}
!154 = !{!"fixp", i32 -32, i32 8}
!155 = !{double 0.000000e+00, double 0x4156459080000000}
!156 = !{!157, !155, i1 false, i2 -1}
!157 = !{!"fixp", i32 32, i32 9}
!158 = distinct !{!158, !27}
...
!161 = distinct !{null}
!162 = !{!137, !5, i1 false, i2 -1}
!163 = !{!134, !164, i1 false, i2 -1}
!164 = !{double 0.000000e+00, double 0x408E66665E02EA96}
!165 = !{!137, !164, i1 false, i2 -1}
!166 = !{!137, !167, i1 false, i2 -1}
