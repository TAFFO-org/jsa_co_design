; ModuleID = './build/stats/jacobi-1d/8/jacobi-1d-standard-8.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.2(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 8), !taffo.originalCall !27
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i64 0, i64 0
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 8), !taffo.originalCall !27
