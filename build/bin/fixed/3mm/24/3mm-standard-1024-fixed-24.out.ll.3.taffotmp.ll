; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-1024-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [39 x i8] c"scalar(range(0.0,113595.742188) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,170.666672) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,179.199997) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [39 x i8] c"scalar(range(0.0,134217.734375) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,187.733337) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,184.320007) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [51 x i8] c"target('G') scalar(range(0.0,59685158912.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 1024), !taffo.initweight !66, !taffo.info !48, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.initweight !66, !taffo.info !50, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 1024), !taffo.initweight !66, !taffo.info !52, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 1024), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.7(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 1024), !taffo.initweight !66, !taffo.info !56, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.8(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 1024), !taffo.initweight !66, !taffo.info !58, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 1024), !taffo.initweight !66, !taffo.info !60, !taffo.target !61, !taffo.originalCall !67, !taffo.constinfo !68
...
!7 = !{double 0.000000e+00, double 0x422BCB0680000000}
...
!49 = !{double 0.000000e+00, double 0x40FBBBBBE0008638}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 0x406555556084A516}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 0.000000e+00, double 0x40666666601BC98A}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x4100624DE0000000}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x406777777F27FE4C}
!58 = !{i1 false, !59, i1 false, i2 -1}
!59 = !{double 0.000000e+00, double 0x40670A3D7F51EFB7}
...
!139 = !{double 0.000000e+00, double 0x40DDDDDDE52304E3}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x41019999ACA4A3B8}
!142 = distinct !{!142, !29}
!143 = distinct !{!143, !29}
!144 = distinct !{!144, !29}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0.000000e+00, double 0x40E0E56051D67E1C}
!147 = !{i1 false, !148, i1 false, i2 -1}
!148 = !{double 0.000000e+00, double 0x41049BA5F4759F87}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = distinct !{!151, !29}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x420C6620BA78F5B1}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x42317247574F1EB6}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
...
!230 = !{double 1.024000e+03, double 1.024000e+03}
!231 = !{i32 9}
!232 = !{i1 false, !233, i1 false, i2 -1}
!233 = !{double 0.000000e+00, double 0x419BBBBBE0008638}
!234 = distinct !{!234, !29}
!235 = distinct !{!235, !29}
