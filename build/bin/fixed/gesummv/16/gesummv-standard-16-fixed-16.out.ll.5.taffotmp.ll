; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-16-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !85 !taffo.funinfo !96 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !97
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !100
  %arrayidx1.u12_20fixp = getelementptr inbounds i32, i32* %val.u12_20fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u16_16fixp, 4, !taffo.info !100
...
for.body4:                                        ; preds = %for.cond2
  ...
  %mul.u8_24fixp = shl i32 %4, 1, !taffo.info !111
  ...
  %5 = lshr i32 %mul.u8_24fixp, 3, !taffo.info !111
  %add.u11_21fixp = add i32 %5, %u11_21fixp, !taffo.info !113
  ...
  %mul13.u8_24fixp = shl i32 %10, 1, !taffo.info !111
  ...
  %11 = lshr i32 %mul13.u8_24fixp, 4, !taffo.info !111
  %add15.u12_20fixp = add i32 %11, %u12_20fixp, !taffo.info !115
...
for.end:                                          ; preds = %for.cond2
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 18), !taffo.info !118
  %mul18.u13_19fixp = shl i32 %16, 1, !taffo.info !121
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 18), !taffo.info !123
  %mul20.u13_19fixp = shl i32 %21, 1, !taffo.info !125
  %add21.u13_19fixp = add i32 %mul18.u13_19fixp, %mul20.u13_19fixp, !taffo.info !126
  %arrayidx22.u12_20fixp = getelementptr inbounds i32, i32* %y.u12_20fixp, i32 %i.0, !taffo.info !54
  %22 = shl i32 %add21.u13_19fixp, 1, !taffo.info !126
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !85 !taffo.funinfo !129 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u8_24fixp, 4, !taffo.info !132
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 23), !taffo.info !130
  %mul.u8_24fixp = shl i32 %5, 1, !taffo.info !132
  ...
  %7 = shl i32 %mul.u8_24fixp, 4, !taffo.info !132
...
!95 = distinct !{!95, !23}
!96 = !{i32 1, !75, i32 1, !54, i32 1, !75}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"fixp", i32 -32, i32 15}
!99 = !{double 0.000000e+00, double 0x40E6A6667FF583A5}
...
!110 = !{double 0.000000e+00, double 2.250000e+02}
!111 = !{!112, !110, i1 false, i2 -1}
!112 = !{!"fixp", i32 32, i32 24}
!113 = !{!52, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 1.353000e+03}
!115 = !{!55, !116, i1 false, i2 -1}
!116 = !{double 0.000000e+00, double 0x40A868667FF583A5}
!117 = distinct !{!117, !23}
!118 = !{!119, !120, i1 false, i2 -1}
!119 = !{!"fixp", i32 -32, i32 18}
!120 = !{double 0.000000e+00, double 1.692000e+03}
!121 = !{!122, !120, i1 false, i2 -1}
!122 = !{!"fixp", i32 32, i32 19}
!123 = !{!119, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x40AB2E14998D045F}
!125 = !{!122, !124, i1 false, i2 -1}
!126 = !{!122, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x40B4330A4CC68230}
!128 = distinct !{!128, !23}
!129 = !{i32 1, !75, i32 1, !48, i32 1, !75}
!130 = !{!109, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 2.400000e+02}
!132 = !{!112, !131, i1 false, i2 -1}
!133 = distinct !{!133, !23}
