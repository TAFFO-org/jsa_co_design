...
entry:
  ...
  call void @llvm.var.annotation(i8* %s2, i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  ...
  call void @scale_2d(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 128)
  ...
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 128)
  ...
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 128)
