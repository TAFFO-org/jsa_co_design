...
entry:
  ...
  call void @llvm.var.annotation(i8* %A2, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 116, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 1024)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 1024)
