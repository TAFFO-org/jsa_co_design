; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-32-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 32), !taffo.info !56, !taffo.initweight !60, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 32), !taffo.info !63, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !50, !taffo.originalCall !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 32), !taffo.info !66, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !52, !taffo.originalCall !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 32), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 32), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
...
for.body:                                         ; preds = %for.cond
  ...
  %div7 = fdiv float %conv5, %conv6, !taffo.info !124, !taffo.initweight !90
  ...
  %div13 = fdiv float %conv11, %conv12, !taffo.info !124, !taffo.initweight !90
  ...
  %div19 = fdiv float %conv17, %conv18, !taffo.info !124, !taffo.initweight !90
...
for.body24:                                       ; preds = %for.cond21
  ...
  %div28 = fdiv float %conv26, %conv27, !taffo.info !124, !taffo.initweight !90
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !44, !taffo.initweight !143
  %conv = sitofp i32 %factor to float, !taffo.info !92
  %mul = fmul float %1, %conv, !taffo.info !100, !taffo.initweight !144
...
!96 = !{double 0.000000e+00, double 0x4103B4CCE0008638}
!97 = !{i32 7}
!98 = distinct !{!98, !25}
...
!107 = !{double 0.000000e+00, double 0x408CE147AE147AE1}
!108 = !{!49, !109, i1 false, i2 -1}
!109 = !{double 0.000000e+00, double 0x40B750F5D5C31594}
!110 = distinct !{!110, !25}
!111 = distinct !{!111, !25}
!112 = !{!49, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x40B7928F55BCCAF7}
!114 = distinct !{!114, !25}
!115 = distinct !{!115, !25}
...
!122 = !{!45, !121, i1 false, i2 1}
!123 = !{!45, !78, i1 false, i2 1}
...
!142 = !{i32 1, !77, i32 1, !77, i32 1, !44, i32 1, !88}
!143 = !{i32 8}
!144 = !{i32 9}
!145 = distinct !{!145, !25}
!146 = distinct !{!146, !25}
