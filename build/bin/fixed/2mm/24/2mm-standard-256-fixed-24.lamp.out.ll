; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-256-fixed-24.out.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !221
