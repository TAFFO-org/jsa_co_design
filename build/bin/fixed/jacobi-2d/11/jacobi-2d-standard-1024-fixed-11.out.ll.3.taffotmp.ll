; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-1024-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [56 x i8] c"target('A') scalar(range(136.53334,15428.266602) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [45 x i8] c"scalar(range(204.800003,16452.267578) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 1024), !taffo.initweight !57, !taffo.target !48, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 1024), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !58, !taffo.constinfo !59
...
!7 = !{double 0.000000e+00, double 0x40CE22222003AB86}
...
!50 = !{double 0x406111111F0C34C2, double 0x40CE22222003AB86}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 0x406999999FE43676, double 0x40D011111FFF79C8}
!53 = !{i32 1}
!54 = !{i32 2}
...
!115 = !{double 0x407111111F0C34C2, double 0x40DE22222003AB86}
!116 = !{i1 false, !117, i1 false, i2 -1}
!117 = !{double 0x40799999AE924F23, double 0x40E699999802C0A4}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0x408111111F0C34C2, double 0x40EE22222003AB86}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x4085555566CF41F2, double 0x40F2D55554024B34}
!122 = !{i32 9}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x4061111123507909, double 0x40CE2222278C340E}
!125 = distinct !{!125, !29}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0x407999999FE43676, double 0x40E011111FFF79C8}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4083333337EB28D8, double 0x40E81999AFFF36AC}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0x408999999FE43676, double 0x40F011111FFF79C8}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0x4090000003EEA20A, double 0x40F4155567FF583A}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0x40699999A64A9CDE, double 0x40D011112403BE10}
!137 = distinct !{!137, !29}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
...
!170 = !{double 0x410111111F0C34C2, double 0x416E22222003AB86}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
!173 = !{i32 1, !97, i32 1, !97, i32 1, !51, i32 1, !167}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double 0x410999999FE43676, double 0x417011111FFF79C8}
!176 = distinct !{!176, !29}
!177 = distinct !{!177, !29}
