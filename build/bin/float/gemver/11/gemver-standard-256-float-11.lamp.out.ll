; ModuleID = './build/bin/float/gemver/11/gemver-standard-256-float-11.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay9, i32 noundef 256)
  %arraydecay10 = getelementptr inbounds [20 x float], ptr %u1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay10, i32 noundef 256)
  %arraydecay11 = getelementptr inbounds [20 x float], ptr %v1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay11, i32 noundef 256)
  %arraydecay12 = getelementptr inbounds [20 x float], ptr %u2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay12, i32 noundef 256)
  %arraydecay13 = getelementptr inbounds [20 x float], ptr %v2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay13, i32 noundef 256)
  %arraydecay14 = getelementptr inbounds [20 x float], ptr %w, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay14, i32 noundef 256)
  %arraydecay15 = getelementptr inbounds [20 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay15, i32 noundef 256)
  %arraydecay16 = getelementptr inbounds [20 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay16, i32 noundef 256)
  %arraydecay17 = getelementptr inbounds [20 x float], ptr %z, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay17, i32 noundef 256)
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim43 = and i64 %lampsim42, -4398046511104
  ...
  %lampsim47 = and i64 %lampsim46, -4398046511104
  ...
  %lampsim51 = and i32 %lampsim50, -8192
  ...
  %lampsim55 = and i32 %lampsim54, -8192
  ...
  %lampsim63 = and i64 %lampsim62, -4398046511104
  ...
  %lampsim67 = and i64 %lampsim66, -4398046511104
  ...
  %lampsim83 = and i64 %lampsim82, -4398046511104
  ...
  %lampsim87 = and i64 %lampsim86, -4398046511104
  ...
  %lampsim91 = and i32 %lampsim90, -8192
  ...
  %lampsim95 = and i32 %lampsim94, -8192
  ...
  %lampsim99 = and i32 %lampsim98, -8192
  ...
  %lampsim103 = and i64 %lampsim102, -4398046511104
  ...
  %lampsim107 = and i64 %lampsim106, -4398046511104
  ...
  %lampsim111 = and i32 %lampsim110, -8192
...
for.body42:                                       ; preds = %for.cond39
  ...
  %lampsim115 = and i32 %lampsim114, -8192
  ...
  %lampsim119 = and i32 %lampsim118, -8192
  ...
  %lampsim123 = and i32 %lampsim122, -8192
