; ModuleID = './build/bin/fixed/gemm/16/gemm-standard-128-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp2 = bitcast [16 x i32]* %arraydecay9.u7_25fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u7_25fixp2, i32 128), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u7_25fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !53
  %u7_25fixp = bitcast [12 x i32]* %arraydecay10.u7_25fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u7_25fixp, i32 128), !taffo.info !62, !taffo.constinfo !60
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 7), !taffo.info !182
  %mul.u24_8fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u24_8fixp, 7, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !189 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 17), !taffo.info !190
  %mul.u14_18fixp = shl i32 %5, 1, !taffo.info !193
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u14_18fixp, 7, !taffo.info !193
...
!183 = !{!"fixp", i32 -32, i32 7}
!184 = !{double 0.000000e+00, double 0x416907AE00000000}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 8}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
