; ModuleID = './build/bin/fixed/3mm/16/3mm-standard-32-fixed-16.out.ll'
...
entry:
  ...
  %u3_29fixp2 = bitcast [10 x i32]* %arraydecay15.u3_29fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u3_29fixp2, i32 32), !taffo.info !62, !taffo.constinfo !61
  %arraydecay16.u3_29fixp = getelementptr inbounds [10 x [8 x i32]], [10 x [8 x i32]]* %B.u3_29fixp, i32 0, i32 0, !taffo.info !47
  %u3_29fixp = bitcast [8 x i32]* %arraydecay16.u3_29fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u3_29fixp, i32 32), !taffo.info !63, !taffo.constinfo !61
  ...
  %u3_29fixp1 = bitcast [14 x i32]* %arraydecay18.u3_29fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u3_29fixp1, i32 32), !taffo.info !65, !taffo.constinfo !61
  %arraydecay19.u3_29fixp = getelementptr inbounds [14 x [12 x i32]], [14 x [12 x i32]]* %D.u3_29fixp, i32 0, i32 0, !taffo.info !54
  %u3_29fixp3 = bitcast [12 x i32]* %arraydecay19.u3_29fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u3_29fixp3, i32 32), !taffo.info !66, !taffo.constinfo !61
...
for.body30:                                       ; preds = %for.cond28
  ...
  %1 = fdiv float %lampsim2, 6.553600e+04, !taffo.info !56, !taffo.target !58
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u16_16fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !239 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u21_11fixp, 5, !taffo.info !244
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !256 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !257
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !260
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u12_20fixp, 5, !taffo.info !260
...
!243 = !{double 0.000000e+00, double 0x413BCB0680000000}
...
!254 = distinct !{!254, !23}
!255 = distinct !{!255, !23}
!256 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !230}
!257 = !{!258, !259, i1 false, i2 -1}
!258 = !{!"fixp", i32 -32, i32 19}
!259 = !{double 0.000000e+00, double 0x40ABBBBBE0157EED}
