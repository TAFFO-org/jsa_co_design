...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 113, i8* null)
  %B2 = bitcast [5 x [5 x [5 x float]]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 114, i8* null)
  ...
  call void @kernel_heat_3d(i32 noundef %1, i32 noundef %2, [5 x [5 x float]]* noundef %arraydecay4, [5 x [5 x float]]* noundef %arraydecay5)
...
for.body11:                                       ; preds = %for.cond9
  ...
  %arrayidx = getelementptr inbounds [5 x [5 x [5 x float]]], [5 x [5 x [5 x float]]]* %A, i32 0, i32 %9
  %10 = load i32, i32* %j, align 4
  %arrayidx12 = getelementptr inbounds [5 x [5 x float]], [5 x [5 x float]]* %arrayidx, i32 0, i32 %10
  %11 = load i32, i32* %k, align 4
  %arrayidx13 = getelementptr inbounds [5 x float], [5 x float]* %arrayidx12, i32 0, i32 %11
  ...
  store float %12, float* %arrayidx16, align 4
  br label %for.inc
