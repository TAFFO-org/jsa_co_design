...
entry:
  ...
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 155, i8* null)
  ...
  call void @llvm.var.annotation(i8* %v15, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 157, i8* null)
  ...
  call void @llvm.var.annotation(i8* %w8, i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 160, i8* null)
  %x9 = bitcast [20 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x9, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 161, i8* null)
  %y10 = bitcast [20 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y10, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 162, i8* null)
...
for.body:                                         ; preds = %for.cond
  ...
  store float %7, float* %arrayidx29, align 4
  %9 = load i32, i32* %i, align 4
  %arrayidx30 = getelementptr inbounds [20 x float], [20 x float]* %w, i32 0, i32 %9
  %10 = load float, float* %arrayidx30, align 4
...
for.body34:                                       ; preds = %for.cond32
  ...
  %arrayidx35 = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %A, i32 0, i32 %14
  %15 = load i32, i32* %j, align 4
  %arrayidx36 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx35, i32 0, i32 %15
  ...
  store float %16, float* %arrayidx38, align 4
  br label %for.inc
