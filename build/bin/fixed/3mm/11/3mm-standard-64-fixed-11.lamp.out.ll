; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-64-fixed-11.out.ll'
...
entry:
  ...
  %u4_28fixp2 = bitcast [10 x i32]* %arraydecay15.u4_28fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u4_28fixp2, i32 64), !taffo.info !62, !taffo.constinfo !61
  %arraydecay16.u4_28fixp = getelementptr inbounds [10 x [8 x i32]], [10 x [8 x i32]]* %B.u4_28fixp, i32 0, i32 0, !taffo.info !47
  %u4_28fixp = bitcast [8 x i32]* %arraydecay16.u4_28fixp to i32*, !taffo.info !47
  call void @scale_2d.4_fixp(i32 10, i32 8, i32* %u4_28fixp, i32 64), !taffo.info !63, !taffo.constinfo !61
  ...
  %u4_28fixp3 = bitcast [14 x i32]* %arraydecay18.u4_28fixp to i32*, !taffo.info !52
  call void @scale_2d.4_fixp(i32 8, i32 14, i32* %u4_28fixp3, i32 64), !taffo.info !65, !taffo.constinfo !61
...
for.body30:                                       ; preds = %for.cond28
  ...
  %1 = fdiv float %lampsim2, 4.096000e+03, !taffo.info !56, !taffo.target !58
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !229 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !234
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !237
  ...
  %7 = shl i32 %mul.u16_16fixp, 6, !taffo.info !237
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !241 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 21), !taffo.info !242
  %mul.u10_22fixp = shl i32 %5, 1, !taffo.info !244
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u10_22fixp, 6, !taffo.info !244
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u20_12fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !247 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 5), !taffo.info !248
  %mul.u26_6fixp = shl i32 %5, 1, !taffo.info !251
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u26_6fixp, 6, !taffo.info !251
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !228 !taffo.funinfo !255 !taffo.sourceFunction !232 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 16), !taffo.info !256
  %mul.u15_17fixp = shl i32 %5, 1, !taffo.info !259
  %6 = mul nsw i32 %i.0, %m, !taffo.info !89
  ...
  %7 = shl i32 %mul.u15_17fixp, 6, !taffo.info !259
...
!235 = !{!"fixp", i32 -32, i32 15}
!236 = !{double 0.000000e+00, double 0x40E0624DE00D1B71}
!237 = !{!238, !236, i1 false, i2 -1}
!238 = !{!"fixp", i32 32, i32 16}
!239 = distinct !{!239, !23}
!240 = distinct !{!240, !23}
!241 = !{i32 1, !83, i32 1, !16, i32 1, !44, i32 1, !230}
!242 = !{!115, !243, i1 false, i2 -1}
!243 = !{double 0.000000e+00, double 0x408555556084A516}
!244 = !{!50, !243, i1 false, i2 -1}
!245 = distinct !{!245, !23}
!246 = distinct !{!246, !23}
!247 = !{i32 1, !83, i32 1, !85, i32 1, !56, i32 1, !230}
!248 = !{!249, !250, i1 false, i2 -1}
!249 = !{!"fixp", i32 -32, i32 5}
!250 = !{double 0.000000e+00, double 0x418BCB0680000000}
!251 = !{!252, !250, i1 false, i2 -1}
!252 = !{!"fixp", i32 32, i32 6}
!253 = distinct !{!253, !23}
!254 = distinct !{!254, !23}
!255 = !{i32 1, !83, i32 1, !96, i32 1, !41, i32 1, !230}
!256 = !{!257, !258, i1 false, i2 -1}
!257 = !{!"fixp", i32 -32, i32 16}
!258 = !{double 0.000000e+00, double 0x40DBBBBBE0157EED}
!259 = !{!260, !258, i1 false, i2 -1}
!260 = !{!"fixp", i32 32, i32 17}
!261 = distinct !{!261, !23}
!262 = distinct !{!262, !23}
