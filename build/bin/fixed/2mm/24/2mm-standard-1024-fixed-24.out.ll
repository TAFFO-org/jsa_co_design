; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 0x4140000000000000, !taffo.info !225
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = fdiv float %3, 0x4140000000000000, !taffo.info !225
  ...
  %6 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !232
