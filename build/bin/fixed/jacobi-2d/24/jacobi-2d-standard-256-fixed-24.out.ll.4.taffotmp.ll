; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-256-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 256), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 256), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
!47 = !{!"fixp", i32 32, i32 19}
!48 = !{double 0x40499999A1FD156A, double 0x40B011112007DD44}
...
!97 = !{double 0x405111111F0C34C2, double 0x40BE22221FF2E48F}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x40599999AE924F23, double 0x40C6999997F62B6B}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 17}
!104 = !{double 0x406111111F0C34C2, double 0x40CE22221FF2E48F}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x4065555566CF41F2, double 0x40D2D55553F7CED9}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x4041111123507909, double 0x40AE2222277B6D16}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 0x40599999A1FD156A, double 0x40C011112007DD44}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x40633333397DD010, double 0x40C81999B00BCBE6}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 0x40699999A1FD156A, double 0x40D011112007DD44}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 0x40700000053E2D62, double 0x40D415556809D495}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x40499999A8637BD2, double 0x40B01111240C218C}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!177 = !{!"fixp", i32 32, i32 12}
!178 = !{double 0x40C111111F0C34C2, double 0x412E22221FF2E48F}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !77, i32 1, !77, i32 1, !46, i32 1, !172}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 11}
!184 = !{double 0x40C99999A1FD156A, double 0x413011112007DD44}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
