...
entry:
  ...
  call void @llvm.var.annotation(i8* %x12, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 114, i8* null)
  %x23 = bitcast [20 x float]* %x2 to i8*
  call void @llvm.var.annotation(i8* %x23, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 115, i8* null)
