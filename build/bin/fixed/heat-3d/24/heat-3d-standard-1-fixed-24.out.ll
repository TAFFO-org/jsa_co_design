; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-1-fixed-24.out.ll.4.taffotmp.ll'
...
for.body11:                                       ; preds = %for.cond9
  ...
  store float %1, float* %arrayidx16, align 4, !taffo.info !32, !taffo.target !31
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body6
  ...
  %call13 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double noundef %conv), !taffo.constinfo !33
  br label %for.inc
