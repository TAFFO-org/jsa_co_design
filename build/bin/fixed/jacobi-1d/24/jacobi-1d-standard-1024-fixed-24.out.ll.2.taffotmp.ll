; ModuleID = './build/bin/fixed/jacobi-1d/24/jacobi-1d-standard-1024-fixed-24.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 1024), !taffo.initweight !35, !taffo.target !29, !taffo.info !30, !taffo.originalCall !37
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !34, !taffo.info !32
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 1024), !taffo.initweight !35, !taffo.info !32, !taffo.originalCall !37
...
!31 = !{double 0x406111111F0C34C2, double 0x409111112018A43C}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 0x406999999FE43676, double 0x409222221FF2E48F}
!34 = !{i32 1}
!35 = !{i32 2}
