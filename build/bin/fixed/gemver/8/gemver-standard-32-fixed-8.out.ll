; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-32-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %1, %3, !taffo.info !130
  %arrayidx1.u26_6fixp = getelementptr inbounds i32, i32* %val.u26_6fixp, i32 %i.0, !taffo.info !65
  %4 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !130
  %5 = fptoui float %4 to i32, !taffo.info !130
