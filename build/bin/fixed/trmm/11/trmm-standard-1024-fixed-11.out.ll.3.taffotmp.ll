; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-1024-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,1024.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [47 x i8] c"target('B') scalar(range(0.0,5456448.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 1024), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 1024), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
!7 = !{double 0.000000e+00, double 0x4154D09000000000}
...
!52 = !{double 0.000000e+00, double 1.024000e+03}
...
!110 = !{double 1.024000e+03, double 1.024000e+03}
...
!118 = !{double 0.000000e+00, double 0x41F4D09000000000}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x41F4D5C424000000}
!121 = distinct !{!121, !29}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x415F38D800000000}
!124 = distinct !{!124, !29}
!125 = distinct !{!125, !29}
...
!155 = !{double 0.000000e+00, double 0x4130000000000000}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
