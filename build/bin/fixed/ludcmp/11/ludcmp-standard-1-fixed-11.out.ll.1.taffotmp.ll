...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 166, i8* null)
  %B2 = bitcast [20 x [20 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 167, i8* null)
  ...
  call void @llvm.var.annotation(i8* %y5, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 170, i8* null)
  ...
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @kernel_ludcmp(i32 noundef %1, [20 x float]* noundef %arraydecay10, float* noundef %arraydecay11, float* noundef %arraydecay12, float* noundef %arraydecay13)
...
for.body:                                         ; preds = %for.cond
  %4 = load i32, i32* %i, align 4
  %arrayidx = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 %4
  %5 = load float, float* %arrayidx, align 4
  %6 = load i32, i32* %i, align 4
  %arrayidx14 = getelementptr inbounds [20 x float], [20 x float]* @x_float, i32 0, i32 %6
  store float %5, float* %arrayidx14, align 4
  br label %for.inc
