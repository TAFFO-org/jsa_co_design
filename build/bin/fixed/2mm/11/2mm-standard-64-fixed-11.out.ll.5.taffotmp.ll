; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-64-fixed-11.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_2mm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [10 x i32]* noundef %tmp.u15_17fixp, [12 x i32]* noundef %A.u6_26fixp, [10 x i32]* noundef %B.u6_26fixp, [14 x i32]* noundef %C.u6_26fixp, [14 x i32]* noundef %D.u23_9fixp) #0 !taffo.initweight !100 !taffo.funinfo !101 !taffo.sourceFunction !104 {
entry:
  br label %for.cond
...
for.body7:                                        ; preds = %for.cond5
  ...
  %u6_26fixp = load i32, i32* %arrayidx9.u6_26fixp, align 4, !taffo.info !107
  %0 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %1 = lshr i32 %u6_26fixp, 1, !taffo.info !107
  %2 = ashr i32 %0, 5, !taffo.info !42
  %3 = ashr i32 %1, 1, !taffo.info !107
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 24), !taffo.info !109
  %mul.u7_25fixp = shl i32 %4, 1, !taffo.info !112
  ...
  %5 = lshr i32 %mul.u7_25fixp, 1, !taffo.info !112
  %6 = lshr i32 %u6_26fixp2, 1, !taffo.info !53
  %7 = ashr i32 %5, 8, !taffo.info !112
  %8 = ashr i32 %6, 9, !taffo.info !53
  %9 = call i32 @llvm.smul.fix.i32(i32 %7, i32 %8, i32 16), !taffo.info !113
  %mul12.u15_17fixp = shl i32 %9, 1, !taffo.info !116
  ...
  %add.u15_17fixp = add i32 %u15_17fixp, %mul12.u15_17fixp, !taffo.info !117
...
for.body26:                                       ; preds = %for.cond24
  ...
  %13 = call i32 @llvm.smul.fix.i32(i32 %10, i32 %12, i32 8), !taffo.info !122
  %mul29.u23_9fixp = shl i32 %13, 1, !taffo.info !125
...
for.body32:                                       ; preds = %for.cond30
  ...
  %18 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %17, i32 8), !taffo.info !126
  %mul37.u23_9fixp = shl i32 %18, 1, !taffo.info !128
  ...
  %add40.u23_9fixp = add i32 %u23_9fixp4, %mul37.u23_9fixp, !taffo.info !129
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %A.u6_26fixp, [10 x i32]* noundef %B.u6_26fixp, [14 x i32]* noundef %C.u6_26fixp, [14 x i32]* noundef %D.u23_9fixp, [10 x i32]* noundef %tmp.u15_17fixp) #0 !taffo.initweight !134 !taffo.funinfo !135 !taffo.sourceFunction !136 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u6_26fixp = getelementptr inbounds [12 x i32], [12 x i32]* %A.u6_26fixp, i32 %i.0, !taffo.info !165
  %arrayidx7.u6_26fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u6_26fixp, i32 0, i32 %j.0, !taffo.info !165
  %4 = lshr i32 %div.u3_29fixp, 3, !taffo.info !164
  store i32 %4, i32* %arrayidx7.u6_26fixp, align 4, !taffo.info !105
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u6_26fixp, i32 %i.1, !taffo.info !181
  %arrayidx26.u6_26fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx25.u6_26fixp, i32 0, i32 %j.1, !taffo.info !181
  %8 = lshr i32 %div24.u1_31fixp, 5, !taffo.info !179
  store i32 %8, i32* %arrayidx26.u6_26fixp, align 4, !taffo.info !105
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx48.u6_26fixp = getelementptr inbounds [14 x i32], [14 x i32]* %C.u6_26fixp, i32 %i.2, !taffo.info !197
  %arrayidx49.u6_26fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx48.u6_26fixp, i32 0, i32 %j.2, !taffo.info !197
  %12 = lshr i32 %div47.u1_31fixp, 5, !taffo.info !196
  store i32 %12, i32* %arrayidx49.u6_26fixp, align 4, !taffo.info !105
  br label %for.inc50
...
for.body63:                                       ; preds = %for.cond60
  ...
  %arrayidx70.u23_9fixp = getelementptr inbounds [14 x i32], [14 x i32]* %D.u23_9fixp, i32 %i.3, !taffo.info !211
  %arrayidx71.u23_9fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx70.u23_9fixp, i32 0, i32 %j.3, !taffo.info !211
  %16 = lshr i32 %div69.u1_31fixp, 22, !taffo.info !210
  store i32 %16, i32* %arrayidx71.u23_9fixp, align 4, !taffo.info !105
  br label %for.inc72
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86.u15_17fixp = getelementptr inbounds [10 x i32], [10 x i32]* %tmp.u15_17fixp, i32 %i.4, !taffo.info !214
  %arrayidx87.u15_17fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx86.u15_17fixp, i32 0, i32 %j.4, !taffo.info !214
  store i32 0, i32* %arrayidx87.u15_17fixp, align 4, !taffo.info !105, !taffo.constinfo !106
  br label %for.inc88
...
!110 = !{!"fixp", i32 -32, i32 24}
!111 = !{double 0.000000e+00, double 8.400000e+01}
!112 = !{!108, !111, i1 false, i2 -1}
!113 = !{!114, !115, i1 false, i2 -1}
!114 = !{!"fixp", i32 -32, i32 16}
!115 = !{double 0.000000e+00, double 0x40B2E6665B63D3E5}
!116 = !{!48, !115, i1 false, i2 -1}
!117 = !{!48, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 0x40D72CCCB6D86EC1}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
!122 = !{!123, !124, i1 false, i2 -1}
!123 = !{!"fixp", i32 -32, i32 8}
!124 = !{double 0.000000e+00, double 0x4157047AD9999999}
!125 = !{!58, !124, i1 false, i2 -1}
!126 = !{!123, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x413121D404846DFD}
!128 = !{!58, !127, i1 false, i2 -1}
!129 = !{!58, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x415776DB61211B7F}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = distinct !{!133, !23}
