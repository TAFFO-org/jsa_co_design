; ModuleID = './build/bin/fixed/heat-3d/16/heat-3d-standard-4-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 4), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 4), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
for.body6:                                        ; preds = %for.cond4
  %0 = mul nuw i32 %m, %p, !taffo.info !160
  ...
  %3 = load float, float* %arrayidx8, align 4, !taffo.info !162, !taffo.initweight !104
  %conv = sitofp i32 %factor to float, !taffo.info !164
  %mul = fmul float %3, %conv, !taffo.info !165, !taffo.initweight !112
  %4 = mul nuw i32 %m, %p, !taffo.info !160
...
!103 = !{double 1.600000e+01, double 2.080000e+02}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -2.000000e+02, double 8.800000e+01}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -1.920000e+02, double 1.920000e+02}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 25}
!111 = !{double -2.400000e+01, double 2.400000e+01}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -4.800000e+01, double 4.800000e+01}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -7.200000e+01, double 7.200000e+01}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -6.400000e+01, double 1.760000e+02}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!159 = !{i32 1, !79, i32 1, !79, i32 1, !79, i32 1, !41, i32 1, !92}
!160 = !{i1 false, !161, i1 false, i2 0}
!161 = !{double 2.500000e+01, double 2.500000e+01}
!162 = !{!163, !43, i1 false, i2 -1}
!163 = !{!"fixp", i32 32, i32 23}
!164 = !{!148, !93, i1 false, i2 1}
!165 = !{!163, !166, i1 false, i2 -1}
!166 = !{double 3.200000e+01, double 4.160000e+02}
!167 = distinct !{!167, !23}
!168 = distinct !{!168, !23}
!169 = distinct !{!169, !23}
