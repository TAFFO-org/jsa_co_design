; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-128-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.info !66, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 128), !taffo.info !71, !taffo.initweight !62, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 128), !taffo.info !73, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 128), !taffo.info !77, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 128), !taffo.info !78, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 128), !taffo.info !79, !taffo.initweight !74, !taffo.constinfo !75, !taffo.target !60, !taffo.originalCall !76
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 128), !taffo.info !80, !taffo.initweight !74, !taffo.constinfo !75, !taffo.originalCall !76
...
for.body5:                                        ; preds = %for.cond3
  ...
  %add = add nsw i32 %mul, 1, !taffo.info !155, !taffo.initweight !74, !taffo.constinfo !21
  %rem = srem i32 %add, %ni, !taffo.info !157, !taffo.initweight !89
  %conv = sitofp i32 %rem to float, !taffo.info !159, !taffo.initweight !116
  %conv6 = sitofp i32 %ni to float, !taffo.info !161
  %div = fdiv float %conv, %conv6, !taffo.info !163, !taffo.initweight !117
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %A, i32 %i.0, !taffo.info !165, !taffo.initweight !72
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !165, !taffo.initweight !72
  store float %div, float* %arrayidx7, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !166, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !169, !taffo.initweight !72, !taffo.constinfo !21
...
for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !166, !taffo.initweight !72, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !172, !taffo.initweight !72
  %rem21 = srem i32 %mul20, %nj, !taffo.info !174, !taffo.initweight !74
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !175, !taffo.initweight !89
  %conv23 = sitofp i32 %nj to float, !taffo.info !176
  %div24 = fdiv float %conv22, %conv23, !taffo.info !177, !taffo.initweight !116
  %arrayidx25 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.1, !taffo.info !180, !taffo.initweight !72
  %arrayidx26 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.info !180, !taffo.initweight !72
  store float %div24, float* %arrayidx26, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !166, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !169, !taffo.initweight !72, !taffo.constinfo !21
...
for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 3, !taffo.info !183, !taffo.initweight !72, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !185, !taffo.initweight !72
  %add43 = add nsw i32 %mul42, 1, !taffo.info !187, !taffo.initweight !74, !taffo.constinfo !21
  %rem44 = srem i32 %add43, %nl, !taffo.info !189, !taffo.initweight !89
  %conv45 = sitofp i32 %rem44 to float, !taffo.info !191, !taffo.initweight !116
  %conv46 = sitofp i32 %nl to float, !taffo.info !192
  %div47 = fdiv float %conv45, %conv46, !taffo.info !193, !taffo.initweight !117
  %arrayidx48 = getelementptr inbounds [14 x float], [14 x float]* %C, i32 %i.2, !taffo.info !195, !taffo.initweight !72
  %arrayidx49 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx48, i32 0, i32 %j.2, !taffo.info !195, !taffo.initweight !72
  store float %div47, float* %arrayidx49, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc50

for.inc50:                                        ; preds = %for.body40
  %inc51 = add nsw i32 %j.2, 1, !taffo.info !166, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc53:                                        ; preds = %for.end52
  %inc54 = add nsw i32 %i.2, 1, !taffo.info !169, !taffo.initweight !72, !taffo.constinfo !21
...
for.body63:                                       ; preds = %for.cond60
  %add64 = add nsw i32 %j.3, 2, !taffo.info !198, !taffo.initweight !72, !taffo.constinfo !21
  %mul65 = mul nsw i32 %i.3, %add64, !taffo.info !200, !taffo.initweight !72
  %rem66 = srem i32 %mul65, %nk, !taffo.info !202, !taffo.initweight !74
  %conv67 = sitofp i32 %rem66 to float, !taffo.info !204, !taffo.initweight !89
  %conv68 = sitofp i32 %nk to float, !taffo.info !205
  %div69 = fdiv float %conv67, %conv68, !taffo.info !206, !taffo.initweight !116
  %arrayidx70 = getelementptr inbounds [14 x float], [14 x float]* %D, i32 %i.3, !taffo.info !208, !taffo.initweight !72
  %arrayidx71 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx70, i32 0, i32 %j.3, !taffo.info !208, !taffo.initweight !72
  store float %div69, float* %arrayidx71, align 4, !taffo.info !118, !taffo.initweight !74
  br label %for.inc72

for.inc72:                                        ; preds = %for.body63
  %inc73 = add nsw i32 %j.3, 1, !taffo.info !166, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc75:                                        ; preds = %for.end74
  %inc76 = add nsw i32 %i.3, 1, !taffo.info !169, !taffo.initweight !72, !taffo.constinfo !21
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86 = getelementptr inbounds [10 x float], [10 x float]* %tmp, i32 %i.4, !taffo.info !211, !taffo.initweight !72
  %arrayidx87 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx86, i32 0, i32 %j.4, !taffo.info !211, !taffo.initweight !72
...
for.inc88:                                        ; preds = %for.body85
  %inc89 = add nsw i32 %j.4, 1, !taffo.info !166, !taffo.initweight !72, !taffo.constinfo !21
...
for.inc91:                                        ; preds = %for.end90
  %inc92 = add nsw i32 %i.4, 1, !taffo.info !169, !taffo.initweight !72, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !215 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !216
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !223 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !216
  %mul = fmul float %1, %conv, !taffo.info !224, !taffo.initweight !220
  %2 = mul nsw i32 %i.0, %m, !taffo.info !104
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !229 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !216
  %mul = fmul float %1, %conv, !taffo.info !230, !taffo.initweight !220
  %2 = mul nsw i32 %i.0, %m, !taffo.info !104
...
!50 = !{double 0.000000e+00, double 0x40F273331FFF79C8}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 32, i32 25}
!53 = !{double 0.000000e+00, double 1.120000e+02}
!54 = !{!52, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x405CCCCCC0379314}
!56 = !{!52, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x405DB6DB61BB05FB}
!58 = !{!59, !1, i1 false, i2 -1}
!59 = !{!"fixp", i32 32, i32 6}
!60 = !{!"D"}
...
!111 = !{double 1.280000e+02, double 1.280000e+02}
...
!121 = !{!"fixp", i32 32, i32 24}
!122 = !{i32 7}
!123 = !{!121, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 1.680000e+02}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x40D2E6665E247885}
!127 = !{!49, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x40F72CCCB78897E9}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{!59, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x4187047AD9999999}
!134 = !{!59, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x416121D404846DFD}
!136 = !{i32 8}
!137 = !{!59, !138, i1 false, i2 -1}
!138 = !{double 0.000000e+00, double 0x418776DB61211B7F}
!139 = distinct !{!139, !23}
!140 = distinct !{!140, !23}
!141 = distinct !{!141, !23}
...
!154 = !{i1 false, !124, i1 false, i2 -1}
...
!161 = !{!162, !99, i1 false, i2 1}
!162 = !{!"fixp", i32 32, i32 28}
!163 = !{!160, !164, i1 false, i2 -1}
!164 = !{double 0.000000e+00, double 8.750000e-01}
...
!174 = !{i1 false, !84, i1 false, i2 -1}
!175 = !{!162, !84, i1 false, i2 -1}
!176 = !{!162, !17, i1 false, i2 1}
!177 = !{!178, !179, i1 false, i2 -1}
!178 = !{!"fixp", i32 32, i32 31}
!179 = !{double 0.000000e+00, double 9.000000e-01}
!180 = !{!52, !55, i1 false, i2 1}
!181 = distinct !{!181, !23}
!182 = distinct !{!182, !23}
...
!191 = !{!162, !190, i1 false, i2 -1}
!192 = !{!162, !101, i1 false, i2 1}
!193 = !{!178, !194, i1 false, i2 -1}
!194 = !{double 0.000000e+00, double 0x3FEDB6DB6DB6DB6E}
!195 = !{!52, !57, i1 false, i2 1}
!196 = distinct !{!196, !23}
!197 = distinct !{!197, !23}
...
!204 = !{!162, !203, i1 false, i2 -1}
!205 = !{!162, !115, i1 false, i2 1}
!206 = !{!178, !207, i1 false, i2 -1}
!207 = !{double 0.000000e+00, double 0x3FED555555555555}
!208 = !{!59, !1, i1 false, i2 1}
!209 = distinct !{!209, !23}
!210 = distinct !{!210, !23}
!211 = !{!49, !50, i1 false, i2 1}
!212 = distinct !{!212, !23}
!213 = distinct !{!213, !23}
!214 = !{i32 -1, i32 -1, i32 3, i32 -1}
!215 = !{i32 1, !98, i32 1, !16, i32 1, !48, i32 1, !110}
!216 = !{!121, !111, i1 false, i2 1}
!217 = !{!218, !219, i1 false, i2 -1}
!218 = !{!"fixp", i32 32, i32 8}
!219 = !{double 0.000000e+00, double 0x416273331FFF79C8}
!220 = !{i32 9}
!221 = distinct !{!221, !23}
!222 = distinct !{!222, !23}
!223 = !{i32 1, !98, i32 1, !114, i32 1, !51, i32 1, !110}
!224 = !{!225, !226, i1 false, i2 -1}
!225 = !{!"fixp", i32 32, i32 18}
!226 = !{double 0.000000e+00, double 1.433600e+04}
!227 = distinct !{!227, !23}
!228 = distinct !{!228, !23}
!229 = !{i32 1, !98, i32 1, !100, i32 1, !58, i32 1, !110}
!230 = !{!231, !232, i1 false, i2 -1}
!231 = !{!"float", i32 1, double 0x41F32E6660000000}
!232 = !{double 0.000000e+00, double 0x41F32E6660000000}
!233 = distinct !{!233, !23}
!234 = distinct !{!234, !23}
