; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-4-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 4), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 4), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !99, !taffo.initweight !98
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !120, !taffo.initweight !98
  %conv = sitofp i32 %factor to float, !taffo.info !174
  %mul = fmul float %1, %conv, !taffo.info !121, !taffo.initweight !109
  %2 = mul nsw i32 %i.0, %m, !taffo.info !81
...
!48 = !{double 8.000000e-01, double 0x405011111F0C34C2}
...
!97 = !{double 0x3FF111105E1C1509, double 0x405E22221C8A7A42}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x3FF999988D2A1F8E, double 0x406699999567DBB2}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 23}
!104 = !{double 0x400111105E1C1509, double 0x406E22221C8A7A42}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x4005555475A31A4B, double 0x4072D55551D68C69}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x3FE1111062605920, double 0x404E2222241302C9}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 1.600000e+00, double 0x406011111F0C34C2}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x4003333333333334, double 0x40681999AE924F23}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 3.200000e+00, double 0x407011111F0C34C2}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 4.000000e+00, double 0x4074155566CF41F2}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x3FE99999A0000000, double 0x4050111123107909}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!175 = !{!"fixp", i32 32, i32 29}
!176 = !{!96, !104, i1 false, i2 -1}
!177 = distinct !{!177, !23}
!178 = distinct !{!178, !23}
