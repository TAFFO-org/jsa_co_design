; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-1-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %lampsim2, 0x41B0000000000000, !taffo.info !36, !taffo.target !38
  ...
  store float %lampsim5, float* %arrayidx14, align 4, !taffo.info !49, !taffo.target !38
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.10, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !61
  br label %for.inc
