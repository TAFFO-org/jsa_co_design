; ModuleID = './build/bin/fixed/ludcmp/24/ludcmp-standard-8-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 8), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 8), !taffo.info !67, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.info !48, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 8), !taffo.info !68, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 8), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !69, !taffo.target !53, !taffo.originalCall !70
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !54, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 8), !taffo.info !72, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
...
!47 = !{double 8.000000e+00, double 0x40505851DEEFE500}
!48 = !{!49, !50, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 26}
!50 = !{double 0x40401999A1FD156A, double 3.600000e+01}
!51 = !{!52, !1, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 28}
!53 = !{!"x"}
!54 = !{!49, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x40401999A1FD156A}
...
!102 = !{double 0x40701999A1FD156A, double 2.880000e+02}
!103 = !{i32 7}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !85, i32 1, !51, i32 1, !94}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 25}
!108 = !{double -3.035760e-01, double 0x403FFCF893FAF428}
!109 = distinct !{!109, !23}
...
!116 = !{!"fixp", i32 -32, i32 18}
!117 = !{double 0x3F847AE147AE147C, double 0x40B0B28B44170636}
!118 = !{i32 8}
!119 = !{!116, !120, i1 false, i2 -1}
!120 = !{double 0xC0B17A8B44170636, double 1.999900e+02}
!121 = distinct !{!121, !23}
...
!131 = !{!"fixp", i32 -32, i32 19}
!132 = !{double 0.000000e+00, double 0x40A07278D0E661EE}
!133 = !{!131, !134, i1 false, i2 -1}
!134 = !{double 0xC0A20278D0E661EE, double 2.000000e+02}
!135 = distinct !{!135, !23}
!136 = distinct !{!136, !23}
...
!146 = !{double 0xC003D90949A7A372, double 0x407056C5CCC46D94}
!147 = !{!144, !148, i1 false, i2 -1}
!148 = !{double 0xC07CD6C5CCC46D94, double 0x40694F6425269E8E}
...
!210 = !{!"fixp", i32 32, i32 19}
!211 = !{!210, !212, i1 false, i2 -1}
!212 = !{double 8.010000e+00, double 0x40B0F3EC8B92C5CA}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = distinct !{!215, !23}
!216 = distinct !{!216, !23}
...
!221 = !{!"fixp", i32 32, i32 22}
!222 = !{double 8.000000e-01, double 0x40805851DEEFE500}
!223 = !{i32 9}
!224 = distinct !{!224, !23}
!225 = distinct !{!225, !23}
