; ModuleID = './build/bin/fixed/symm/16/symm-standard-1024-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.info !62, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 1024), !taffo.info !67, !taffo.initweight !58, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 1024), !taffo.info !69, !taffo.initweight !70, !taffo.constinfo !71, !taffo.target !50, !taffo.originalCall !72
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.info !73, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 1024), !taffo.info !74, !taffo.initweight !70, !taffo.constinfo !71, !taffo.originalCall !72
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3(i32 noundef %m, i32 noundef %n, float noundef %alpha, float noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !104 !taffo.funinfo !105 !taffo.sourceFunction !76 {
entry:
  br label %for.cond
...
for.body6:                                        ; preds = %for.cond4
  ...
  %0 = load float, float* %arrayidx7, align 4, !taffo.info !54, !taffo.initweight !111
  %mul = fmul float %alpha, %0, !taffo.info !112, !taffo.initweight !109
  ...
  %1 = load float, float* %arrayidx9, align 4, !taffo.info !51, !taffo.initweight !111
  %mul10 = fmul float %mul, %1, !taffo.info !114, !taffo.initweight !110
  ...
  %2 = load float, float* %arrayidx12, align 4, !taffo.info !48, !taffo.initweight !111
  %add = fadd float %2, %mul10, !taffo.info !117, !taffo.initweight !111
  store float %add, float* %arrayidx12, align 4, !taffo.info !69, !taffo.initweight !111
  ...
  %3 = load float, float* %arrayidx14, align 4, !taffo.info !54, !taffo.initweight !111
  ...
  %4 = load float, float* %arrayidx16, align 4, !taffo.info !51, !taffo.initweight !111
...
for.end:                                          ; preds = %for.cond4
  ...
  %5 = load float, float* %arrayidx20, align 4, !taffo.info !48, !taffo.initweight !111
  ...
  %6 = load float, float* %arrayidx23, align 4, !taffo.info !54, !taffo.initweight !111
  %mul24 = fmul float %alpha, %6, !taffo.info !112, !taffo.initweight !109
  ...
  %7 = load float, float* %arrayidx26, align 4, !taffo.info !51, !taffo.initweight !111
  %mul27 = fmul float %mul24, %7, !taffo.info !114, !taffo.initweight !110
  %add28 = fadd float %mul21, %mul27, !taffo.info !125, !taffo.initweight !110
  %mul29 = fmul float %alpha, %temp2.0, !taffo.info !114, !taffo.initweight !109
  %add30 = fadd float %add28, %mul29, !taffo.info !127, !taffo.initweight !110
  ...
  store float %add30, float* %arrayidx32, align 4, !taffo.info !62, !taffo.initweight !111
  br label %for.inc33
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %m, i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !132 !taffo.funinfo !105 !taffo.sourceFunction !64 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !62, !taffo.initweight !83, !taffo.constinfo !133
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !67, !taffo.initweight !83, !taffo.constinfo !135
  br label %for.cond

for.cond:                                         ; preds = %for.inc15, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc16, %for.inc15 ], !taffo.info !138, !taffo.initweight !45
  %cmp = icmp slt i32 %i.0, %m, !taffo.info !139, !taffo.initweight !68
  br i1 %cmp, label %for.body, label %for.end17, !taffo.info !140, !taffo.initweight !70

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !141, !taffo.initweight !45
  %cmp4 = icmp slt i32 %j.0, %n, !taffo.info !139, !taffo.initweight !68
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !143, !taffo.initweight !70

for.body5:                                        ; preds = %for.cond3
  %add = add nsw i32 %i.0, %j.0, !taffo.info !145, !taffo.initweight !68
  %rem = srem i32 %add, 100, !taffo.info !145, !taffo.initweight !70, !taffo.constinfo !21
  %conv = sitofp i32 %rem to float, !taffo.info !147, !taffo.initweight !83
  %conv6 = sitofp i32 %m to float, !taffo.info !149
  %div = fdiv float %conv, %conv6, !taffo.info !151, !taffo.initweight !109
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.info !153, !taffo.initweight !68
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !153, !taffo.initweight !68
  store float %div, float* %arrayidx7, align 4, !taffo.info !154, !taffo.initweight !70
  %add8 = add nsw i32 %n, %i.0, !taffo.info !155, !taffo.initweight !68
  %sub = sub nsw i32 %add8, %j.0, !taffo.info !145, !taffo.initweight !68
  %rem9 = srem i32 %sub, 100, !taffo.info !145, !taffo.initweight !70, !taffo.constinfo !21
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !147, !taffo.initweight !83
  %conv11 = sitofp i32 %m to float, !taffo.info !149
  %div12 = fdiv float %conv10, %conv11, !taffo.info !151, !taffo.initweight !109
  %arrayidx13 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.info !157, !taffo.initweight !68
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.info !157, !taffo.initweight !68
  store float %div12, float* %arrayidx14, align 4, !taffo.info !154, !taffo.initweight !70
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !158, !taffo.initweight !68, !taffo.constinfo !21
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %i.0, 1, !taffo.info !161, !taffo.initweight !68, !taffo.constinfo !21
...
for.cond18:                                       ; preds = %for.inc46, %for.end17
  %i.1 = phi i32 [ 0, %for.end17 ], [ %inc47, %for.inc46 ], !taffo.info !138, !taffo.initweight !45
  %cmp19 = icmp slt i32 %i.1, %m, !taffo.info !139, !taffo.initweight !68
  br i1 %cmp19, label %for.body21, label %for.end48, !taffo.info !140, !taffo.initweight !70

for.body21:                                       ; preds = %for.cond18
  br label %for.cond22

for.cond22:                                       ; preds = %for.inc33, %for.body21
  %j.1 = phi i32 [ 0, %for.body21 ], [ %inc34, %for.inc33 ], !taffo.info !141, !taffo.initweight !45
  %cmp23 = icmp sle i32 %j.1, %i.1, !taffo.info !139, !taffo.initweight !68
  br i1 %cmp23, label %for.body25, label %for.end35, !taffo.info !140, !taffo.initweight !70

for.body25:                                       ; preds = %for.cond22
  %add26 = add nsw i32 %i.1, %j.1, !taffo.info !145, !taffo.initweight !68
  %rem27 = srem i32 %add26, 100, !taffo.info !145, !taffo.initweight !70, !taffo.constinfo !21
  %conv28 = sitofp i32 %rem27 to float, !taffo.info !147, !taffo.initweight !83
  %conv29 = sitofp i32 %m to float, !taffo.info !149
  %div30 = fdiv float %conv28, %conv29, !taffo.info !151, !taffo.initweight !109
  %arrayidx31 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.info !163, !taffo.initweight !68
  %arrayidx32 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx31, i32 0, i32 %j.1, !taffo.info !163, !taffo.initweight !68
  store float %div30, float* %arrayidx32, align 4, !taffo.info !154, !taffo.initweight !70
  br label %for.inc33

for.inc33:                                        ; preds = %for.body25
  %inc34 = add nsw i32 %j.1, 1, !taffo.info !158, !taffo.initweight !68, !taffo.constinfo !21
  br label %for.cond22, !llvm.loop !164

for.end35:                                        ; preds = %for.cond22
  %add36 = add nsw i32 %i.1, 1, !taffo.info !161, !taffo.initweight !68, !taffo.constinfo !21
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc43, %for.end35
  %j.2 = phi i32 [ %add36, %for.end35 ], [ %inc44, %for.inc43 ], !taffo.info !141, !taffo.initweight !45
  %cmp38 = icmp slt i32 %j.2, %m, !taffo.info !139, !taffo.initweight !68
  br i1 %cmp38, label %for.body40, label %for.end45, !taffo.info !143, !taffo.initweight !70

for.body40:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.info !163, !taffo.initweight !68
  %arrayidx42 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx41, i32 0, i32 %j.2, !taffo.info !163, !taffo.initweight !68
  store float -9.990000e+02, float* %arrayidx42, align 4, !taffo.info !154, !taffo.initweight !70, !taffo.constinfo !165
  br label %for.inc43

for.inc43:                                        ; preds = %for.body40
  %inc44 = add nsw i32 %j.2, 1, !taffo.info !158, !taffo.initweight !68, !taffo.constinfo !21
...
for.inc46:                                        ; preds = %for.end45
  %inc47 = add nsw i32 %i.1, 1, !taffo.info !161, !taffo.initweight !68, !taffo.constinfo !21
  br label %for.cond18, !llvm.loop !169
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !171 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !48, !taffo.initweight !111
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !120
  %conv = sitofp i32 %factor to float, !taffo.info !172
  %mul = fmul float %1, %conv, !taffo.info !174, !taffo.initweight !121
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !48, !taffo.initweight !111
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !179 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !51, !taffo.initweight !111
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !120
  %conv = sitofp i32 %factor to float, !taffo.info !172
  %mul = fmul float %1, %conv, !taffo.info !180, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !51, !taffo.initweight !110
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !51, !taffo.initweight !111
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !185 !taffo.sourceFunction !72 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !54, !taffo.initweight !111
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !54, !taffo.initweight !120
  %conv = sitofp i32 %factor to float, !taffo.info !172
  %mul = fmul float %1, %conv, !taffo.info !186, !taffo.initweight !121
  %2 = mul nsw i32 %i.0, %m, !taffo.info !96
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !54, !taffo.initweight !110
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !54, !taffo.initweight !111
...
!49 = !{!"fixp", i32 32, i32 6}
!50 = !{!"C"}
!51 = !{!52, !53, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 11}
!53 = !{double 0xC12F380000000000, double 0x409CCCCCBFF47736}
!54 = !{!55, !56, i1 false, i2 -1}
!55 = !{!"fixp", i32 32, i32 20}
!56 = !{double 0x40599999A1FD156A, double 2.560000e+03}
...
!99 = distinct !{!99, !23}
!100 = !{i32 1, i32 -1}
!101 = !{i32 1, !42, i32 1, !102}
!102 = !{i1 false, !103, i1 false, i2 0}
!103 = !{double 1.024000e+03, double 1.024000e+03}
!104 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!105 = !{i32 1, !16, i32 1, !92, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!106 = !{!107, !108, i1 false, i2 1}
!107 = !{!"float", i32 1, double 0x41E3830000000000}
!108 = !{double 0xC1E3830000000000, double 0x4151FFFFF7F8CA82}
!109 = !{i32 5}
!110 = !{i32 6}
!111 = !{i32 7}
!112 = !{!55, !113, i1 false, i2 -1}
!113 = !{double 0x40633333397DD010, double 3.840000e+03}
!114 = !{!115, !116, i1 false, i2 -1}
!115 = !{!"float", i32 1, double 0x41ED448000000000}
!116 = !{double 0xC1ED448000000000, double 0x415AFFFFF3F52FC3}
!117 = !{!115, !118, i1 false, i2 -1}
!118 = !{double 0xC1ED448000000000, double 0x4188C0227E7EA5F8}
!119 = !{!107, !108, i1 false, i2 -1}
!120 = !{i32 8}
!121 = !{i32 9}
!122 = distinct !{!122, !23}
!123 = !{!49, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4189A68FCCCCCCCD}
!125 = !{!115, !126, i1 false, i2 -1}
!126 = !{double 0xC1ED448000000000, double 0x418D068FCB4B72C5}
!127 = !{!128, !129, i1 false, i2 -1}
!128 = !{!"float", i32 1, double 0x41FD448000000000}
!129 = !{double 0xC1FD448000000000, double 0x41903347E4E50C5F}
!130 = distinct !{!130, !23}
!131 = distinct !{!131, !23}
!132 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!133 = !{!134, i1 false}
!134 = !{i1 false, !44, i1 false, i2 0}
!135 = !{!136, i1 false}
!136 = !{i1 false, !137, i1 false, i2 0}
!137 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!138 = !{i1 false, !78, i1 false, i2 1}
!139 = !{i1 false, !80, i1 false, i2 1}
!140 = !{i1 false, !3, i1 false, i2 1}
!141 = !{i1 false, !142, i1 false, i2 1}
!142 = !{double 0.000000e+00, double 1.700000e+01}
!143 = !{i1 false, !144, i1 false, i2 1}
!144 = !{double 0.000000e+00, double 1.600000e+01}
!145 = !{i1 false, !146, i1 false, i2 1}
!146 = !{double 0.000000e+00, double 2.600000e+01}
!147 = !{!148, !146, i1 false, i2 1}
!148 = !{!"fixp", i32 32, i32 27}
!149 = !{!150, !17, i1 false, i2 1}
!150 = !{!"fixp", i32 32, i32 28}
!151 = !{!150, !152, i1 false, i2 1}
!152 = !{double 0.000000e+00, double 2.600000e+00}
!153 = !{!49, !1, i1 false, i2 1}
!154 = !{i1 false, i1 false, i1 false, i2 1}
!155 = !{i1 false, !156, i1 false, i2 1}
!156 = !{double 1.600000e+01, double 2.600000e+01}
!157 = !{!55, !56, i1 false, i2 1}
!158 = !{i1 false, !159, i1 false, i2 1}
!159 = !{double 1.000000e+00, double 1.700000e+01}
!160 = distinct !{!160, !23}
!161 = !{i1 false, !88, i1 false, i2 1}
!162 = distinct !{!162, !23}
!163 = !{!52, !53, i1 false, i2 1}
!164 = distinct !{!164, !23}
!165 = !{!166, i1 false}
!166 = !{i1 false, !167, i1 false, i2 0}
!167 = !{double -9.990000e+02, double -9.990000e+02}
!168 = distinct !{!168, !23}
!169 = distinct !{!169, !23}
!170 = !{i32 -1, i32 -1, i32 3, i32 -1}
!171 = !{i32 1, !16, i32 1, !92, i32 1, !48, i32 1, !102}
!172 = !{!173, !103, i1 false, i2 1}
!173 = !{!"fixp", i32 32, i32 21}
!174 = !{!175, !176, i1 false, i2 -1}
!175 = !{!"float", i32 1, double 0x4225602280000000}
!176 = !{double 0.000000e+00, double 0x4225602280000000}
!177 = distinct !{!177, !23}
!178 = distinct !{!178, !23}
!179 = !{i32 1, !16, i32 1, !16, i32 1, !51, i32 1, !102}
!180 = !{!181, !182, i1 false, i2 -1}
!181 = !{!"float", i32 1, double 0x41CF380000000000}
!182 = !{double 0xC1CF380000000000, double 0x413CCCCCBFF47736}
!183 = distinct !{!183, !23}
!184 = distinct !{!184, !23}
!185 = !{i32 1, !16, i32 1, !92, i32 1, !54, i32 1, !102}
!186 = !{!187, !188, i1 false, i2 -1}
!187 = !{!"fixp", i32 32, i32 10}
!188 = !{double 0x40F99999A1FD156A, double 2.621440e+06}
!189 = distinct !{!189, !23}
!190 = distinct !{!190, !23}
