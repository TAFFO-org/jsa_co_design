; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-256-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 256), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
for.body8:                                        ; preds = %for.cond5
  ...
  %div49 = fdiv float %add47, 9.000000e+00, !taffo.info !108, !taffo.initweight !49, !taffo.constinfo !110
  ...
  store float %div49, float* %arrayidx51, align 4, !taffo.info !111, !taffo.initweight !49
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.2(i32 noundef %n, [20 x float]* noundef %A) #0 !taffo.initweight !115 !taffo.funinfo !116 !taffo.sourceFunction !51 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc10, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc11, %for.inc10 ], !taffo.info !117, !taffo.initweight !44
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !119, !taffo.initweight !49
  br i1 %cmp, label %for.body, label %for.end12, !taffo.info !117, !taffo.initweight !52

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !117, !taffo.initweight !44
  %cmp4 = icmp slt i32 %j.0, %n, !taffo.info !119, !taffo.initweight !49
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !117, !taffo.initweight !52

for.body5:                                        ; preds = %for.cond3
  %conv = sitofp i32 %i.0 to float, !taffo.info !120, !taffo.initweight !49
  %add = add nsw i32 %j.0, 2, !taffo.info !122, !taffo.initweight !49, !taffo.constinfo !21
  %conv6 = sitofp i32 %add to float, !taffo.info !124, !taffo.initweight !52
  %mul = fmul float %conv, %conv6, !taffo.info !125, !taffo.initweight !52
  %add7 = fadd float %mul, 2.000000e+00, !taffo.info !128, !taffo.initweight !64, !taffo.constinfo !130
  %conv8 = sitofp i32 %n to float, !taffo.info !131
  %div = fdiv float %add7, %conv8, !taffo.info !132, !taffo.initweight !88
  %arrayidx = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !134, !taffo.initweight !49
  %arrayidx9 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !134, !taffo.initweight !49
  store float %div, float* %arrayidx9, align 4, !taffo.info !111, !taffo.initweight !52
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !135, !taffo.initweight !49, !taffo.constinfo !21
...
for.inc10:                                        ; preds = %for.end
  %inc11 = add nsw i32 %i.0, 1, !taffo.info !135, !taffo.initweight !49, !taffo.constinfo !21
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !41, !taffo.initweight !95
...
!91 = !{!"fixp", i32 32, i32 18}
!92 = !{i32 7}
!93 = !{!91, !94, i1 false, i2 -1}
!94 = !{double 5.120000e+01, double 0x40C40CCCC0053E2D}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 17}
!98 = !{double 0x4053333333333334, double 0x40CE13332007DD44}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 16}
!102 = !{double 1.024000e+02, double 0x40D40CCCC0053E2D}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 1.280000e+02, double 0x40D90FFFF0068DB8}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 2.304000e+02, double 0x40E68E665805E5F2}
!108 = !{!42, !109, i1 false, i2 1}
!109 = !{double 2.560000e+01, double 0x40B40CCCC0053E2C}
!110 = !{i1 false, !82}
...
!114 = distinct !{!114, !23}
!115 = !{i32 -1, i32 2}
!116 = !{i32 1, !72, i32 1, !41}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double -2.000000e+01, double 2.000000e+01}
!119 = !{i1 false, !61, i1 false, i2 -1}
!120 = !{!121, !118, i1 false, i2 -1}
!121 = !{!"fixp", i32 -32, i32 26}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double -1.800000e+01, double 2.200000e+01}
!124 = !{!121, !123, i1 false, i2 -1}
!125 = !{!126, !127, i1 false, i2 -1}
!126 = !{!"fixp", i32 -32, i32 22}
!127 = !{double -4.400000e+02, double 4.400000e+02}
!128 = !{!126, !129, i1 false, i2 -1}
!129 = !{double -4.380000e+02, double 4.420000e+02}
!130 = !{i1 false, !19}
!131 = !{!121, !73, i1 false, i2 1}
!132 = !{!121, !133, i1 false, i2 -1}
!133 = !{double -2.190000e+01, double 2.210000e+01}
!134 = !{!42, !43, i1 false, i2 1}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double -1.900000e+01, double 2.100000e+01}
!137 = distinct !{!137, !23}
!138 = distinct !{!138, !23}
!139 = !{i32 -1, i32 -1, i32 3, i32 -1}
!140 = !{i32 1, !72, i32 1, !72, i32 1, !41, i32 1, !141}
...
!147 = !{double 6.553600e+03, double 0x41340CCCC0053E2D}
!148 = !{i32 9}
!149 = distinct !{!149, !23}
!150 = distinct !{!150, !23}
