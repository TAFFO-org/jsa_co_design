; ModuleID = './build/bin/fixed/lu/16/lu-standard-512-fixed-16.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 512), !taffo.initweight !37, !taffo.target !31, !taffo.info !32, !taffo.originalCall !38
