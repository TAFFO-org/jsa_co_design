; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u21_11fixp1 = load i32, i32* %arrayidx21.u21_11fixp, align 4, !taffo.info !50, !taffo.target !51
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %2, 0x4150000000000000, !taffo.info !81
  ...
  %4 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !83
