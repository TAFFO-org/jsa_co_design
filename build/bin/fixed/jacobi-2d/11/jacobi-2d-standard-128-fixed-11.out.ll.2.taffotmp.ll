; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-128-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 128), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 128), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x40311111276FB092, double 0x409E22221FF2E48F}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 2.560000e+01, double 0x40A011111FF7164C}
!34 = !{i32 1}
!35 = !{i32 2}
