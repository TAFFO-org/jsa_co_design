; ModuleID = './build/bin/fixed/3mm/11/3mm-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 1024), !taffo.info !65, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 1024), !taffo.info !72, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 1024), !taffo.info !73, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 1024), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 1024), !taffo.info !75, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.4(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 1024), !taffo.info !76, !taffo.initweight !69, !taffo.constinfo !70, !taffo.originalCall !71
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 1024), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !70, !taffo.target !59, !taffo.originalCall !71
...
for.body58:                                       ; preds = %for.cond56
  ...
  %8 = load float, float* %arrayidx65, align 4, !taffo.info !57, !taffo.initweight !116
  %add66 = fadd float %8, %mul63, !taffo.info !137, !taffo.initweight !120
...
for.inc67:                                        ; preds = %for.body58
  ...
  br label %for.cond56, !llvm.loop !140
...
for.inc70:                                        ; preds = %for.end69
  ...
  br label %for.cond51, !llvm.loop !141
...
for.inc73:                                        ; preds = %for.end72
  ...
  br label %for.cond48, !llvm.loop !142
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.2(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32 noundef %nm, [10 x float]* noundef %A, [8 x float]* noundef %B, [14 x float]* noundef %C, [12 x float]* noundef %D, [8 x float]* noundef %E, [12 x float]* noundef %F, [12 x float]* noundef %G) #0 !taffo.initweight !106 !taffo.funinfo !143 !taffo.sourceFunction !68 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc9, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc10, %for.inc9 ], !taffo.info !144, !taffo.initweight !44
  %cmp = icmp slt i32 %i.0, %ni, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp, label %for.body, label %for.end11, !taffo.info !147, !taffo.initweight !69

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !144, !taffo.initweight !44
  %cmp4 = icmp slt i32 %j.0, %nk, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !147, !taffo.initweight !69

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !149, !taffo.initweight !66
  %add = add nsw i32 %mul, 1, !taffo.info !151, !taffo.initweight !69, !taffo.constinfo !21
  %rem = srem i32 %add, %ni, !taffo.info !153, !taffo.initweight !86
  %conv = sitofp i32 %rem to float, !taffo.info !155, !taffo.initweight !112
...
for.cond12:                                       ; preds = %for.inc33, %for.end11
  %i.1 = phi i32 [ 0, %for.end11 ], [ %inc34, %for.inc33 ], !taffo.info !144, !taffo.initweight !44
  %cmp13 = icmp slt i32 %i.1, %nk, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp13, label %for.body15, label %for.end35, !taffo.info !147, !taffo.initweight !69

for.body15:                                       ; preds = %for.cond12
  br label %for.cond16

for.cond16:                                       ; preds = %for.inc30, %for.body15
  %j.1 = phi i32 [ 0, %for.body15 ], [ %inc31, %for.inc30 ], !taffo.info !144, !taffo.initweight !44
  %cmp17 = icmp slt i32 %j.1, %nj, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp17, label %for.body19, label %for.end32, !taffo.info !147, !taffo.initweight !69
...
for.cond36:                                       ; preds = %for.inc56, %for.end35
  %i.2 = phi i32 [ 0, %for.end35 ], [ %inc57, %for.inc56 ], !taffo.info !144, !taffo.initweight !44
  %cmp37 = icmp slt i32 %i.2, %nj, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp37, label %for.body39, label %for.end58, !taffo.info !147, !taffo.initweight !69

for.body39:                                       ; preds = %for.cond36
  br label %for.cond40

for.cond40:                                       ; preds = %for.inc53, %for.body39
  %j.2 = phi i32 [ 0, %for.body39 ], [ %inc54, %for.inc53 ], !taffo.info !144, !taffo.initweight !44
  %cmp41 = icmp slt i32 %j.2, %nm, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp41, label %for.body43, label %for.end55, !taffo.info !147, !taffo.initweight !69
...
for.cond59:                                       ; preds = %for.inc80, %for.end58
  %i.3 = phi i32 [ 0, %for.end58 ], [ %inc81, %for.inc80 ], !taffo.info !144, !taffo.initweight !44
  %cmp60 = icmp slt i32 %i.3, %nm, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp60, label %for.body62, label %for.end82, !taffo.info !147, !taffo.initweight !69

for.body62:                                       ; preds = %for.cond59
  br label %for.cond63

for.cond63:                                       ; preds = %for.inc77, %for.body62
  %j.3 = phi i32 [ 0, %for.body62 ], [ %inc78, %for.inc77 ], !taffo.info !144, !taffo.initweight !44
  %cmp64 = icmp slt i32 %j.3, %nl, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp64, label %for.body66, label %for.end79, !taffo.info !147, !taffo.initweight !69
...
for.cond83:                                       ; preds = %for.inc96, %for.end82
  %i.4 = phi i32 [ 0, %for.end82 ], [ %inc97, %for.inc96 ], !taffo.info !144, !taffo.initweight !44
  %cmp84 = icmp slt i32 %i.4, %ni, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp84, label %for.body86, label %for.end98, !taffo.info !147, !taffo.initweight !69

for.body86:                                       ; preds = %for.cond83
  br label %for.cond87

for.cond87:                                       ; preds = %for.inc93, %for.body86
  %j.4 = phi i32 [ 0, %for.body86 ], [ %inc94, %for.inc93 ], !taffo.info !144, !taffo.initweight !44
  %cmp88 = icmp slt i32 %j.4, %nj, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp88, label %for.body90, label %for.end95, !taffo.info !147, !taffo.initweight !69
...
for.cond99:                                       ; preds = %for.inc112, %for.end98
  %i.5 = phi i32 [ 0, %for.end98 ], [ %inc113, %for.inc112 ], !taffo.info !144, !taffo.initweight !44
  %cmp100 = icmp slt i32 %i.5, %nj, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp100, label %for.body102, label %for.end114, !taffo.info !147, !taffo.initweight !69

for.body102:                                      ; preds = %for.cond99
  br label %for.cond103

for.cond103:                                      ; preds = %for.inc109, %for.body102
  %j.5 = phi i32 [ 0, %for.body102 ], [ %inc110, %for.inc109 ], !taffo.info !144, !taffo.initweight !44
  %cmp104 = icmp slt i32 %j.5, %nl, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp104, label %for.body106, label %for.end111, !taffo.info !147, !taffo.initweight !69
...
for.cond115:                                      ; preds = %for.inc128, %for.end114
  %i.6 = phi i32 [ 0, %for.end114 ], [ %inc129, %for.inc128 ], !taffo.info !144, !taffo.initweight !44
  %cmp116 = icmp slt i32 %i.6, %ni, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp116, label %for.body118, label %for.end130, !taffo.info !147, !taffo.initweight !69

for.body118:                                      ; preds = %for.cond115
  br label %for.cond119

for.cond119:                                      ; preds = %for.inc125, %for.body118
  %j.6 = phi i32 [ 0, %for.body118 ], [ %inc126, %for.inc125 ], !taffo.info !144, !taffo.initweight !44
  %cmp120 = icmp slt i32 %j.6, %nl, !taffo.info !146, !taffo.initweight !66
  br i1 %cmp120, label %for.body122, label %for.end127, !taffo.info !147, !taffo.initweight !69
...
!47 = !{double 0.000000e+00, double 0x406555556084A516}
!48 = !{!46, !49, i1 false, i2 -1}
!49 = !{double 0.000000e+00, double 0x40666666601BC98A}
!50 = !{!51, !52, i1 false, i2 -1}
!51 = !{!"fixp", i32 32, i32 14}
!52 = !{double 0.000000e+00, double 0x4100624DE0000000}
!53 = !{!46, !54, i1 false, i2 -1}
!54 = !{double 0.000000e+00, double 0x406777777F27FE4C}
!55 = !{!46, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 0x40670A3D7F51EFB7}
!57 = !{!58, !1, i1 false, i2 -1}
!58 = !{!"float", i32 1, double 0x422BCB0680000000}
!59 = !{!"G"}
...
!119 = !{double 0.000000e+00, double 0x40DDDDDDE52304E3}
!120 = !{i32 8}
!121 = !{!51, !43, i1 false, i2 -1}
!122 = !{!51, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x41019999ACA4A3B8}
!124 = distinct !{!124, !23}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = !{!51, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x40E0E56051D67E1C}
!129 = !{!51, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x41049BA5F4759F87}
!131 = distinct !{!131, !23}
!132 = distinct !{!132, !23}
!133 = distinct !{!133, !23}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"float", i32 1, double 0x420C6620BA78F5B1}
!136 = !{double 0.000000e+00, double 0x420C6620BA78F5B1}
!137 = !{!138, !139, i1 false, i2 -1}
!138 = !{!"float", i32 1, double 0x42317247574F1EB6}
!139 = !{double 0.000000e+00, double 0x42317247574F1EB6}
!140 = distinct !{!140, !23}
!141 = distinct !{!141, !23}
!142 = distinct !{!142, !23}
!143 = !{i32 1, !95, i32 1, !108, i32 1, !16, i32 1, !97, i32 1, !110, i32 1, !45, i32 1, !48, i32 1, !53, i32 1, !55, i32 1, !41, i32 1, !50, i32 1, !57}
...
!150 = !{double 0.000000e+00, double 1.960000e+02}
!151 = !{i1 false, !152, i1 false, i2 1}
!152 = !{double 1.000000e+00, double 1.970000e+02}
!153 = !{i1 false, !154, i1 false, i2 1}
!154 = !{double 0.000000e+00, double 5.000000e+00}
...
!229 = !{double 1.024000e+03, double 1.024000e+03}
!230 = !{!231, !229, i1 false, i2 1}
!231 = !{!"fixp", i32 32, i32 21}
!232 = !{!233, !234, i1 false, i2 -1}
!233 = !{!"fixp", i32 32, i32 5}
!234 = !{double 0.000000e+00, double 0x419BBBBBE0008638}
!235 = !{i32 9}
!236 = distinct !{!236, !23}
!237 = distinct !{!237, !23}
!238 = !{i32 1, !95, i32 1, !16, i32 1, !45, i32 1, !228}
!239 = !{!51, !240, i1 false, i2 -1}
!240 = !{double 0.000000e+00, double 0x410555556084A516}
!241 = distinct !{!241, !23}
!242 = distinct !{!242, !23}
!243 = !{i32 1, !108, i32 1, !97, i32 1, !50, i32 1, !228}
!244 = !{!245, !246, i1 false, i2 -1}
!245 = !{!"fixp", i32 32, i32 4}
!246 = !{double 0.000000e+00, double 0x41A0624DE0000000}
!247 = distinct !{!247, !23}
!248 = distinct !{!248, !23}
!249 = !{i32 1, !95, i32 1, !97, i32 1, !57, i32 1, !228}
!250 = !{!251, !252, i1 false, i2 -1}
!251 = !{!"float", i32 1, double 0x42CBCB0680000000}
!252 = !{double 0.000000e+00, double 0x42CBCB0680000000}
!253 = distinct !{!253, !23}
!254 = distinct !{!254, !23}
