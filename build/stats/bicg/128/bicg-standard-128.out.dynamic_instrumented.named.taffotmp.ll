; ModuleID = './build/stats/bicg/128/bicg-standard-128.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 128), !taffo.originalCall !28
  ...
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 128), !taffo.originalCall !29
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 128), !taffo.originalCall !29
