; ModuleID = './build/bin/fixed/symm/16/symm-standard-2-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,173.160004) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [33 x i8] c"scalar(range(-1998.0,3.6) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [29 x i8] c"scalar(range(0.2,5.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 2), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 2), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 2), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
for.end:                                          ; preds = %for.cond4
  ...
  %mul29 = fmul float %alpha, %temp2.0, !taffo.initweight !95, !taffo.info !129
  %add30 = fadd float %add28, %mul29, !taffo.initweight !125, !taffo.info !141
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %m, i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !145 !taffo.funinfo !122 !taffo.sourceFunction !60 {
entry:
...
for.cond:                                         ; preds = %for.inc15, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc16, %for.inc15 ], !taffo.initweight !48, !taffo.info !146
  %cmp = icmp slt i32 %i.0, %m, !taffo.initweight !64, !taffo.info !147
  br i1 %cmp, label %for.body, label %for.end17, !taffo.initweight !65, !taffo.info !92
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !148
  %cmp4 = icmp slt i32 %j.0, %n, !taffo.initweight !64, !taffo.info !147
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !65, !taffo.info !93

for.body5:                                        ; preds = %for.cond3
  %add = add nsw i32 %i.0, %j.0, !taffo.initweight !64, !taffo.info !150
  %rem = srem i32 %add, 100, !taffo.initweight !65, !taffo.info !150, !taffo.constinfo !27
  %conv = sitofp i32 %rem to float, !taffo.initweight !76, !taffo.info !150
  %conv6 = sitofp i32 %m to float, !taffo.info !22
  %div = fdiv float %conv, %conv6, !taffo.initweight !95, !taffo.info !152
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.0, !taffo.initweight !64, !taffo.info !154
  %arrayidx7 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !154
  store float %div, float* %arrayidx7, align 4, !taffo.initweight !65, !taffo.info !96
  %add8 = add nsw i32 %n, %i.0, !taffo.initweight !64, !taffo.info !155
  %sub = sub nsw i32 %add8, %j.0, !taffo.initweight !64, !taffo.info !150
  %rem9 = srem i32 %sub, 100, !taffo.initweight !65, !taffo.info !150, !taffo.constinfo !27
  %conv10 = sitofp i32 %rem9 to float, !taffo.initweight !76, !taffo.info !150
  %conv11 = sitofp i32 %m to float, !taffo.info !22
  %div12 = fdiv float %conv10, %conv11, !taffo.initweight !95, !taffo.info !152
  %arrayidx13 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !64, !taffo.info !157
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx13, i32 0, i32 %j.0, !taffo.initweight !64, !taffo.info !157
  store float %div12, float* %arrayidx14, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %i.0, 1, !taffo.initweight !64, !taffo.info !161, !taffo.constinfo !27
...
for.cond18:                                       ; preds = %for.inc46, %for.end17
  %i.1 = phi i32 [ 0, %for.end17 ], [ %inc47, %for.inc46 ], !taffo.initweight !48, !taffo.info !146
  %cmp19 = icmp slt i32 %i.1, %m, !taffo.initweight !64, !taffo.info !147
  br i1 %cmp19, label %for.body21, label %for.end48, !taffo.initweight !65, !taffo.info !92
...
for.cond22:                                       ; preds = %for.inc33, %for.body21
  %j.1 = phi i32 [ 0, %for.body21 ], [ %inc34, %for.inc33 ], !taffo.initweight !48, !taffo.info !148
  %cmp23 = icmp sle i32 %j.1, %i.1, !taffo.initweight !64, !taffo.info !147
  br i1 %cmp23, label %for.body25, label %for.end35, !taffo.initweight !65, !taffo.info !92

for.body25:                                       ; preds = %for.cond22
  %add26 = add nsw i32 %i.1, %j.1, !taffo.initweight !64, !taffo.info !150
  %rem27 = srem i32 %add26, 100, !taffo.initweight !65, !taffo.info !150, !taffo.constinfo !27
  %conv28 = sitofp i32 %rem27 to float, !taffo.initweight !76, !taffo.info !150
  %conv29 = sitofp i32 %m to float, !taffo.info !22
  %div30 = fdiv float %conv28, %conv29, !taffo.initweight !95, !taffo.info !152
  %arrayidx31 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.initweight !64, !taffo.info !163
  %arrayidx32 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx31, i32 0, i32 %j.1, !taffo.initweight !64, !taffo.info !163
  store float %div30, float* %arrayidx32, align 4, !taffo.initweight !65, !taffo.info !96
  br label %for.inc33

for.inc33:                                        ; preds = %for.body25
  %inc34 = add nsw i32 %j.1, 1, !taffo.initweight !64, !taffo.info !158, !taffo.constinfo !27
  br label %for.cond22, !llvm.loop !164

for.end35:                                        ; preds = %for.cond22
  %add36 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !161, !taffo.constinfo !27
  br label %for.cond37

for.cond37:                                       ; preds = %for.inc43, %for.end35
  %j.2 = phi i32 [ %add36, %for.end35 ], [ %inc44, %for.inc43 ], !taffo.initweight !48, !taffo.info !148
  %cmp38 = icmp slt i32 %j.2, %m, !taffo.initweight !64, !taffo.info !147
  br i1 %cmp38, label %for.body40, label %for.end45, !taffo.initweight !65, !taffo.info !93

for.body40:                                       ; preds = %for.cond37
  %arrayidx41 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.1, !taffo.initweight !64, !taffo.info !163
  %arrayidx42 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx41, i32 0, i32 %j.2, !taffo.initweight !64, !taffo.info !163
  store float -9.990000e+02, float* %arrayidx42, align 4, !taffo.initweight !65, !taffo.info !96, !taffo.constinfo !100
  br label %for.inc43

for.inc43:                                        ; preds = %for.body40
  %inc44 = add nsw i32 %j.2, 1, !taffo.initweight !64, !taffo.info !158, !taffo.constinfo !27
  br label %for.cond37, !llvm.loop !165

for.end45:                                        ; preds = %for.cond37
  br label %for.inc46

for.inc46:                                        ; preds = %for.end45
  %inc47 = add nsw i32 %i.1, 1, !taffo.initweight !64, !taffo.info !161, !taffo.constinfo !27
  br label %for.cond18, !llvm.loop !166
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !167 !taffo.funinfo !168 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.initweight !135, !taffo.info !169
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !167 !taffo.funinfo !173 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !135, !taffo.info !174
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !167 !taffo.funinfo !178 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !135, !taffo.info !179
  %2 = mul nsw i32 %i.0, %m, !taffo.info !114
...
!7 = !{double 0.000000e+00, double 0x4065A51EC0B56755}
...
!56 = !{double -1.998000e+03, double 3.600000e+00}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 2.000000e-01, double 5.000000e+00}
!59 = !{i32 1}
...
!117 = distinct !{!117, !29}
!118 = !{i32 1, i32 -1}
!119 = !{i32 1, !49, i32 1, !25}
!120 = !{i32 1, !51, i32 1, !25}
...
!124 = !{double -9.990000e+03, double 1.800000e+01}
!125 = !{i32 6}
!126 = !{i32 7}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0x3FD3333333333334, double 7.500000e+00}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double -1.498500e+04, double 2.700000e+01}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double -1.498500e+04, double 0x4069051EC0B56755}
!133 = !{i32 8}
!134 = !{i1 false, !124, i1 false, i2 -1}
!135 = !{i32 9}
!136 = distinct !{!136, !29}
!137 = !{i1 false, !138, i1 false, i2 -1}
!138 = !{double 0.000000e+00, double 0x4069F9581A7348CC}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double -1.498500e+04, double 0x406D59581A7348CC}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double -2.997000e+04, double 0x40705CAC0D39A466}
!143 = distinct !{!143, !29}
!144 = distinct !{!144, !29}
!145 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!146 = !{i1 false, !71, i1 false, i2 1}
!147 = !{i1 false, !73, i1 false, i2 1}
!148 = !{i1 false, !149, i1 false, i2 1}
!149 = !{double 0.000000e+00, double 1.700000e+01}
!150 = !{i1 false, !151, i1 false, i2 1}
!151 = !{double 0.000000e+00, double 2.600000e+01}
...
!168 = !{i32 1, !22, i32 1, !110, i32 1, !53, i32 1, !25}
!169 = !{i1 false, !170, i1 false, i2 -1}
!170 = !{double 0.000000e+00, double 0x4075A51EC0B56755}
!171 = distinct !{!171, !29}
!172 = distinct !{!172, !29}
!173 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !25}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double -3.996000e+03, double 7.200000e+00}
!176 = distinct !{!176, !29}
!177 = distinct !{!177, !29}
!178 = !{i32 1, !22, i32 1, !110, i32 1, !57, i32 1, !25}
!179 = !{i1 false, !180, i1 false, i2 -1}
!180 = !{double 4.000000e-01, double 1.000000e+01}
!181 = distinct !{!181, !29}
!182 = distinct !{!182, !29}
