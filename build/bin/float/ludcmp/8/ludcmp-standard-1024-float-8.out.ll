...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay6, i32 noundef 1024)
...
for.body16:                                       ; preds = %for.cond13
  ...
  %add20 = fadd float %div19, 1.000000e+00
  ...
  store float %add20, ptr %arrayidx22, align 4
  br label %for.inc23
...
for.end:                                          ; preds = %for.cond5
  ...
  store float %div, ptr %arrayidx15, align 4
  br label %for.inc16
...
for.body26:                                       ; preds = %for.cond24
  ...
  %mul31 = fmul float %41, %45
  %46 = load float, ptr %w, align 4
  %sub32 = fsub float %46, %mul31
  store float %sub32, ptr %w, align 4
  br label %for.inc33
...
for.body50:                                       ; preds = %for.cond48
  ...
  %mul54 = fmul float %64, %67
  %68 = load float, ptr %w, align 4
  %sub55 = fsub float %68, %mul54
  store float %sub55, ptr %w, align 4
  br label %for.inc56
...
for.body70:                                       ; preds = %for.cond68
  ...
  %mul74 = fmul float %85, %88
  %89 = load float, ptr %w, align 4
  %sub75 = fsub float %89, %mul74
  store float %sub75, ptr %w, align 4
  br label %for.inc76
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef @.str.10, double noundef %conv)
  br label %for.inc
