...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,6.933334) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.333333) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,1.4) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,8.192) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.466667) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,1.44) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [48 x i8] c"target('G') scalar(range(0.0,222.344543) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, ptr noundef %arraydecay7, i32 noundef 8)
  %arraydecay8 = getelementptr inbounds [6 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 10, ptr noundef %arraydecay8, i32 noundef 8)
  %arraydecay9 = getelementptr inbounds [10 x [8 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 8, ptr noundef %arraydecay9, i32 noundef 8)
  %arraydecay10 = getelementptr inbounds [8 x [12 x float]], ptr %F, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 12, ptr noundef %arraydecay10, i32 noundef 8)
  %arraydecay11 = getelementptr inbounds [8 x [14 x float]], ptr %C, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 14, ptr noundef %arraydecay11, i32 noundef 8)
  %arraydecay12 = getelementptr inbounds [14 x [12 x float]], ptr %D, i32 0, i32 0
  call void @scale_2d(i32 noundef 14, i32 noundef 12, ptr noundef %arraydecay12, i32 noundef 8)
  %arraydecay13 = getelementptr inbounds [6 x [12 x float]], ptr %G, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 12, ptr noundef %arraydecay13, i32 noundef 8)
