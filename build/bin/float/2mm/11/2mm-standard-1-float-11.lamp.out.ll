; ModuleID = './build/bin/float/2mm/11/2mm-standard-1-float-11.out.ll'
...
entry:
  ...
  %arraydecay5 = getelementptr inbounds [8 x [10 x float]], ptr %tmp, i32 0, i32 0
  %arraydecay6 = getelementptr inbounds [8 x [12 x float]], ptr %A, i32 0, i32 0
  %arraydecay7 = getelementptr inbounds [12 x [10 x float]], ptr %B, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [10 x [14 x float]], ptr %C, i32 0, i32 0
  %arraydecay9 = getelementptr inbounds [8 x [14 x float]], ptr %D, i32 0, i32 0
  call void @kernel_2mm(i32 noundef %4, i32 noundef %5, i32 noundef %6, i32 noundef %7, float noundef %8, float noundef %9, ptr noundef %arraydecay5, ptr noundef %arraydecay6, ptr noundef %arraydecay7, ptr noundef %arraydecay8, ptr noundef %arraydecay9)
...
for.body12:                                       ; preds = %for.cond10
  ...
  %arrayidx13 = getelementptr inbounds [14 x float], ptr %arrayidx, i32 0, i32 %15
  %16 = load float, ptr %arrayidx13, align 4
  %17 = load i32, ptr %i, align 4
  %arrayidx14 = getelementptr inbounds [8 x [14 x float]], ptr @D_float, i32 0, i32 %17
  %18 = load i32, ptr %j, align 4
  %arrayidx15 = getelementptr inbounds [14 x float], ptr %arrayidx14, i32 0, i32 %18
  store float %16, ptr %arrayidx15, align 4
  br label %for.inc
