; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-32-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %u13_19fixp1 = load i32, i32* %arrayidx21.u13_19fixp, align 4, !taffo.info !50, !taffo.target !51
