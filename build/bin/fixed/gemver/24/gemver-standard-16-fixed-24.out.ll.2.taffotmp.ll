; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-16-fixed-24.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,82.933334) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,15.2) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [29 x i8] c"scalar(range(0.2,4.0) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [29 x i8] c"scalar(range(0.4,8.0) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [39 x i8] c"scalar(range(0.133333,2.666667) final)\00", section "llvm.metadata"
@.str.8 = private unnamed_addr constant [48 x i8] c"target('w') scalar(range(0.0,1623528.25) final)\00", section "llvm.metadata"
@.str.9 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,1536.497925) final)\00", section "llvm.metadata"
@.str.10 = private unnamed_addr constant [29 x i8] c"scalar(range(0.1,2.0) final)\00", section "llvm.metadata"
@.str.11 = private unnamed_addr constant [39 x i8] c"scalar(range(0.088889,1.777778) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.initweight !56, !taffo.info !33, !taffo.originalCall !58
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 16), !taffo.initweight !56, !taffo.info !35, !taffo.originalCall !58
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 16), !taffo.initweight !60, !taffo.info !37, !taffo.originalCall !61
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !56, !taffo.info !39
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 16), !taffo.initweight !59, !taffo.info !39, !taffo.originalCall !62
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !56, !taffo.info !41
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 16), !taffo.initweight !59, !taffo.info !41, !taffo.originalCall !62
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !56, !taffo.info !43
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 16), !taffo.initweight !59, !taffo.info !43, !taffo.originalCall !62
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !56, !taffo.info !45
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 16), !taffo.initweight !59, !taffo.info !45, !taffo.originalCall !62
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 16), !taffo.initweight !59, !taffo.info !47, !taffo.target !49, !taffo.originalCall !62
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !56, !taffo.info !50
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 16), !taffo.initweight !59, !taffo.info !50, !taffo.originalCall !62
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !56, !taffo.info !52
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 16), !taffo.initweight !59, !taffo.info !52, !taffo.originalCall !62
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !56, !taffo.info !54
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 16), !taffo.initweight !59, !taffo.info !54, !taffo.originalCall !62
...
!38 = !{double 0.000000e+00, double 0x4054BBBBBE878FAC}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 0.000000e+00, double 1.520000e+01}
!41 = !{i1 false, !42, i1 false, i2 -1}
!42 = !{double 2.000000e-01, double 4.000000e+00}
!43 = !{i1 false, !44, i1 false, i2 -1}
!44 = !{double 4.000000e-01, double 8.000000e+00}
!45 = !{i1 false, !46, i1 false, i2 -1}
!46 = !{double 1.333330e-01, double 0x4005555582129457}
!47 = !{i1 false, !48, i1 false, i2 -1}
!48 = !{double 0.000000e+00, double 0x4138C5E840000000}
!49 = !{!"w"}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 0x409801FDE00D1B71}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 1.000000e-01, double 2.000000e+00}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 0x3FB6C16DF3F96180, double 0x3FFC71C75818C5CA}
!56 = !{i32 1}
