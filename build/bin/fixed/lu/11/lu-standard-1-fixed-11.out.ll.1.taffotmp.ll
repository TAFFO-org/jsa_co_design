...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i32 121, i8* null)
  ...
  call void @kernel_lu(i32 noundef %1, [20 x float]* noundef %arraydecay2)
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx = getelementptr inbounds [20 x [20 x float]], [20 x [20 x float]]* %A, i32 0, i32 %6
  %7 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx, i32 0, i32 %7
