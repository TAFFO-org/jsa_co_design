; ModuleID = './build/bin/float/atax/11/atax-standard-2-float-11.out.ll'
source_filename = "./sources/atax.c"
target datalayout = "e-m:e-p:32:32-p270:32:32-p271:32:32-p272:64:64-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-unknown-linux-gnu"

@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.42) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(2.0,3.909091) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [47 x i8] c"target('y') scalar(range(0.0,61.532001) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,15.26) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, ptr noundef %arraydecay4, i32 noundef 2)
  %arraydecay5 = getelementptr inbounds [22 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, ptr noundef %arraydecay5, i32 noundef 2)
  %arraydecay6 = getelementptr inbounds [22 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, ptr noundef %arraydecay6, i32 noundef 2)
