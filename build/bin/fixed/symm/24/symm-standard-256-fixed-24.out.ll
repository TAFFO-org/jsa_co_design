; ModuleID = './build/bin/fixed/symm/24/symm-standard-256-fixed-24.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !170
  ...
  %6 = fmul float 1.024000e+03, %mul.1flp, !taffo.info !170
  %7 = fptoui float %6 to i32, !taffo.info !170
