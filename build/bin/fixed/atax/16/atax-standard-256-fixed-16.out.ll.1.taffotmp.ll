...
@.str = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,53.759998) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [38 x i8] c"scalar(range(256.0,500.363647) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [49 x i8] c"target('y') scalar(range(0.0,129041960.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,250019.84375) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 111, i8* null)
  %x2 = bitcast [22 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x2, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 112, i8* null)
  %y3 = bitcast [22 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y3, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 113, i8* null)
  %tmp4 = bitcast [20 x float]* %tmp to i8*
  call void @llvm.var.annotation(i8* %tmp4, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 114, i8* null)
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, float* noundef %2, i32 noundef 256)
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 256)
  %arraydecay10 = getelementptr inbounds [22 x float], [22 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 256)
