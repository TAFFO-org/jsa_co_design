; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-4-fixed-11.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !119 !taffo.funinfo !129 !taffo.sourceFunction !121 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u6_26fixp = load i32, i32* %arrayidx.u6_26fixp, align 4, !taffo.info !130
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !123
  %0 = lshr i32 %u6_26fixp, 1, !taffo.info !130
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !123
  %2 = ashr i32 %0, 1, !taffo.info !130
  %3 = ashr i32 %1, 4, !taffo.info !123
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 24), !taffo.info !132
  %mul.u7_25fixp = shl i32 %4, 1, !taffo.info !135
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !67
  %5 = shl i32 %mul.u7_25fixp, 1, !taffo.info !135
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !119 !taffo.funinfo !137 !taffo.sourceFunction !121 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u2_30fixp = load i32, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !138
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !139
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !138
  %1 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !139
  %2 = ashr i32 %0, 2, !taffo.info !138
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 27), !taffo.info !140
  %mul.u4_28fixp = shl i32 %3, 1, !taffo.info !143
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !60
  %4 = shl i32 %mul.u4_28fixp, 2, !taffo.info !143
...
!128 = distinct !{!128, !27}
!129 = !{i32 1, !104, i32 1, !67, i32 1, !116}
!130 = !{!131, !1, i1 false, i2 -1}
!131 = !{!"fixp", i32 32, i32 25}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"fixp", i32 -32, i32 24}
!134 = !{double 0.000000e+00, double 0x405F91EB6390C910}
!135 = !{!131, !134, i1 false, i2 -1}
!136 = distinct !{!136, !27}
!137 = !{i32 1, !104, i32 1, !60, i32 1, !116}
!138 = !{!53, !61, i1 false, i2 -1}
!139 = !{!53, !117, i1 false, i2 1}
!140 = !{!141, !142, i1 false, i2 -1}
!141 = !{!"fixp", i32 -32, i32 27}
!142 = !{double 4.000000e-01, double 8.000000e+00}
!143 = !{!53, !142, i1 false, i2 -1}
!144 = distinct !{!144, !27}
...
!236 = !{!147, !235, i1 false, i2 -1}
!237 = !{!150, !238, i1 false, i2 -1}
