...
entry:
  ...
  call void @llvm.var.annotation(i8* %v15, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 157, i8* null)
  ...
  call void @llvm.var.annotation(i8* %v27, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 159, i8* null)
  %w8 = bitcast [20 x float]* %w to i8*
  call void @llvm.var.annotation(i8* %w8, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 160, i8* null)
