; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-32-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !145
