; ModuleID = './build/bin/fixed/ludcmp/11/ludcmp-standard-128-fixed-11.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [37 x i8] c"scalar(range(0.1,1046.079956) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [39 x i8] c"scalar(range(128.0,1046.079956) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(515.200012,576.0) final)\00", section "llvm.metadata", !taffo.info !0
...
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,515.200012) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 128), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 128), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.initweight !59, !taffo.info !53
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 128), !taffo.initweight !60, !taffo.info !53, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 128), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 128), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!50 = !{double 1.000000e-01, double 0x40905851DFFC547A}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 1.280000e+02, double 0x40905851DFFC547A}
!53 = !{i1 false, !54, i1 false, i2 -1}
!54 = !{double 0x408019999FE43676, double 5.760000e+02}
!55 = !{i1 false, !7, i1 false, i2 -1}
!56 = !{!"x"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x408019999FE43676}
!59 = !{i32 1}
!60 = !{i32 2}
...
!129 = !{double 1.280000e+02, double 1.280000e+02}
!130 = !{i32 7}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0x40F019999FE43676, double 7.372800e+04}
!133 = distinct !{!133, !29}
!134 = !{i32 1, !123, i32 1, !55, i32 1, !128}
!135 = !{i1 false, !136, i1 false, i2 -1}
!136 = !{double 0xC0136DCA07F66E87, double 0x407FFCF893FAF428}
!137 = distinct !{!137, !29}
!138 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!139 = !{i32 1, !123, i32 1, !49, i32 1, !53, i32 1, !55, i32 1, !57}
!140 = !{i32 8}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0x3F847AE147AE147C, double 0x4130B28B463B78B0}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC130B353463B78B0, double 1.999900e+02}
!145 = distinct !{!145, !29}
...
!153 = !{double 0.000000e+00, double 0x41207278CFD00C6E}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0xC1207408CFD00C6E, double 2.000000e+02}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
...
!165 = !{double 0xC043D9094AED99C8, double 0x40B056C5CDD0C3A5}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 0xC0B11EC5CDD0C3A5, double 0x406DF64252BB6672}
...
!176 = !{double 0.000000e+00, double 0x40F019999FE43676}
!177 = distinct !{!177, !29}
...
!215 = !{double 1.280100e+02, double 0x4130B6A15AB377C5}
!216 = distinct !{!216, !29}
!217 = distinct !{!217, !29}
!218 = distinct !{!218, !29}
!219 = distinct !{!219, !29}
...
!225 = !{double 1.280000e+01, double 0x41005851DFFC547A}
!226 = distinct !{!226, !29}
!227 = distinct !{!227, !29}
!228 = !{i32 1, !123, i32 1, !123, i32 1, !51, i32 1, !128}
!229 = !{i1 false, !230, i1 false, i2 -1}
!230 = !{double 1.638400e+04, double 0x41005851DFFC547A}
!231 = distinct !{!231, !29}
!232 = distinct !{!232, !29}
