; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-64-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u6_26fixp3 = bitcast [12 x i32]* %arraydecay12.u6_26fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 8, i32 12, i32* %u6_26fixp3, i32 64), !taffo.info !64, !taffo.constinfo !65
  %arraydecay13.u6_26fixp = getelementptr inbounds [12 x [10 x i32]], [12 x [10 x i32]]* %B.u6_26fixp, i32 0, i32 0, !taffo.info !53
  %u6_26fixp2 = bitcast [10 x i32]* %arraydecay13.u6_26fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u6_26fixp2, i32 64), !taffo.info !66, !taffo.constinfo !65
  %arraydecay14.u6_26fixp = getelementptr inbounds [10 x [14 x i32]], [10 x [14 x i32]]* %C.u6_26fixp, i32 0, i32 0, !taffo.info !55
  %u6_26fixp = bitcast [14 x i32]* %arraydecay14.u6_26fixp to i32*, !taffo.info !55
  call void @scale_2d.6_fixp(i32 10, i32 14, i32* %u6_26fixp, i32 64), !taffo.info !67, !taffo.constinfo !65
  ...
  call void @kernel_2mm.3_fixp(i32 8, i32 10, i32 12, i32 14, i32 %u2_30fixp, i32 %u2_30fixp1, [10 x i32]* %arraydecay17.u15_17fixp, [12 x i32]* %arraydecay18.u6_26fixp, [10 x i32]* %arraydecay19.u6_26fixp, [14 x i32]* %arraydecay20.u6_26fixp, [14 x i32]* %arraydecay21.u23_9fixp), !taffo.info !60, !taffo.constinfo !61
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !228 !taffo.sourceFunction !219 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 2), !taffo.info !229
  %mul.u29_3fixp = shl i32 %5, 1, !taffo.info !232
  %6 = mul nsw i32 %i.0, %m, !taffo.info !91
  ...
  %7 = shl i32 %mul.u29_3fixp, 6, !taffo.info !232
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !217 !taffo.funinfo !236 !taffo.sourceFunction !219 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !237
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !240
  %6 = mul nsw i32 %i.0, %m, !taffo.info !91
  ...
  %7 = shl i32 %mul.u21_11fixp, 6, !taffo.info !240
...
!230 = !{!"fixp", i32 -32, i32 2}
!231 = !{double 0.000000e+00, double 0x41B32E6660000000}
!232 = !{!233, !231, i1 false, i2 -1}
!233 = !{!"fixp", i32 32, i32 3}
!234 = distinct !{!234, !23}
!235 = distinct !{!235, !23}
!236 = !{i32 1, !85, i32 1, !16, i32 1, !47, i32 1, !97}
!237 = !{!238, !239, i1 false, i2 -1}
!238 = !{!"fixp", i32 -32, i32 10}
!239 = !{double 0.000000e+00, double 0x413273331FFF79C8}
!240 = !{!241, !239, i1 false, i2 -1}
!241 = !{!"fixp", i32 32, i32 11}
!242 = distinct !{!242, !23}
!243 = distinct !{!243, !23}
