; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-256-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %C.u19_13fixp = alloca [10 x [12 x i32]], align 4, !taffo.info !47, !taffo.target !49
  %A.u8_24fixp = alloca [10 x [16 x i32]], align 4, !taffo.info !50
  %B.u8_24fixp = alloca [16 x [12 x i32]], align 4, !taffo.info !53
  %arraydecay.u19_13fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u19_13fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay6.u8_24fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u8_24fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay7.u8_24fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !53
  call void @init_array.4_fixp(i32 10, i32 12, i32 16, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [12 x i32]* %arraydecay.u19_13fixp, [16 x i32]* %arraydecay6.u8_24fixp, [12 x i32]* %arraydecay7.u8_24fixp), !taffo.info !55, !taffo.constinfo !56
  ...
  %arraydecay8.u19_13fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u19_13fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u19_13fixp = bitcast [12 x i32]* %arraydecay8.u19_13fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 10, i32 12, i32* %u19_13fixp, i32 256), !taffo.info !59, !taffo.constinfo !60, !taffo.target !49
  %arraydecay9.u8_24fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u8_24fixp, i32 0, i32 0, !taffo.info !50
  %u8_24fixp2 = bitcast [16 x i32]* %arraydecay9.u8_24fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u8_24fixp2, i32 256), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u8_24fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !53
  %u8_24fixp = bitcast [12 x i32]* %arraydecay10.u8_24fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u8_24fixp, i32 256), !taffo.info !62, !taffo.constinfo !60
  ...
  %arraydecay11.u19_13fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u19_13fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay12.u8_24fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u8_24fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay13.u8_24fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !53
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp1, i32 %u2_30fixp, [12 x i32]* %arraydecay11.u19_13fixp, [16 x i32]* %arraydecay12.u8_24fixp, [12 x i32]* %arraydecay13.u8_24fixp), !taffo.info !55, !taffo.constinfo !56
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx.u19_13fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u19_13fixp, i32 0, i32 %i.0, !taffo.info !47, !taffo.target !49
  %arrayidx17.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u19_13fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u19_13fixp, [16 x i32]* noundef %A.u8_24fixp, [12 x i32]* noundef %B.u8_24fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u19_13fixp, i32 %i.0, !taffo.info !47
  %arrayidx4.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u19_13fixp, i32 0, i32 %j.0, !taffo.info !47
  ...
  %2 = ashr i32 %1, 17, !taffo.info !45
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 12), !taffo.info !96
  %mul.u19_13fixp = shl i32 %3, 1, !taffo.info !99
  store i32 %mul.u19_13fixp, i32* %arrayidx4.u19_13fixp, align 4, !taffo.info !58
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u8_24fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx11.u8_24fixp, i32 0, i32 %k.0, !taffo.info !50
  %u8_24fixp = load i32, i32* %arrayidx12.u8_24fixp, align 4, !taffo.info !101
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u8_24fixp, 1, !taffo.info !101
  %6 = ashr i32 %4, 7, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !101
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 22), !taffo.info !103
  %mul13.u9_23fixp = shl i32 %8, 1, !taffo.info !106
  %arrayidx14.u8_24fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u8_24fixp, i32 %k.0, !taffo.info !53
  %arrayidx15.u8_24fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx14.u8_24fixp, i32 0, i32 %j.1, !taffo.info !53
  %u8_24fixp2 = load i32, i32* %arrayidx15.u8_24fixp, align 4, !taffo.info !53
  %9 = lshr i32 %mul13.u9_23fixp, 1, !taffo.info !106
  %10 = lshr i32 %u8_24fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 10, !taffo.info !106
  %12 = ashr i32 %10, 11, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 12), !taffo.info !107
  %mul16.u19_13fixp = shl i32 %13, 1, !taffo.info !109
  %arrayidx17.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u19_13fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx17.u19_13fixp, i32 0, i32 %j.1, !taffo.info !47
  %u19_13fixp1 = load i32, i32* %arrayidx18.u19_13fixp, align 4, !taffo.info !47
  %add.u19_13fixp = add i32 %u19_13fixp1, %mul16.u19_13fixp, !taffo.info !110
  store i32 %add.u19_13fixp, i32* %arrayidx18.u19_13fixp, align 4, !taffo.info !59
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u19_13fixp, [16 x i32]* noundef %A.u8_24fixp, [12 x i32]* noundef %B.u8_24fixp) #0 !taffo.initweight !115 !taffo.funinfo !92 !taffo.sourceFunction !116 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u19_13fixp, i32 %i.0, !taffo.info !145
  %arrayidx7.u19_13fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u19_13fixp, i32 0, i32 %j.0, !taffo.info !145
  %3 = lshr i32 %div.u1_31fixp, 18, !taffo.info !143
  store i32 %3, i32* %arrayidx7.u19_13fixp, align 4, !taffo.info !146
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u8_24fixp, i32 %i.1, !taffo.info !162
  %arrayidx26.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u8_24fixp, i32 0, i32 %j.1, !taffo.info !162
  %8 = lshr i32 %div24.u1_31fixp, 7, !taffo.info !161
  store i32 %8, i32* %arrayidx26.u8_24fixp, align 4, !taffo.info !146
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx47.u8_24fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u8_24fixp, i32 %i.2, !taffo.info !175
  %arrayidx48.u8_24fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u8_24fixp, i32 0, i32 %j.2, !taffo.info !175
  %12 = lshr i32 %div46.u1_31fixp, 7, !taffo.info !174
  store i32 %12, i32* %arrayidx48.u8_24fixp, align 4, !taffo.info !146
  br label %for.inc49
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u19_13fixp = load i32, i32* %arrayidx4.u19_13fixp, align 4, !taffo.info !47
  %conv.u9_23fixp = shl i32 %factor, 23, !taffo.info !181
  %1 = lshr i32 %u19_13fixp, 1, !taffo.info !47
  %2 = lshr i32 %conv.u9_23fixp, 1, !taffo.info !181
  %3 = ashr i32 %1, 8, !taffo.info !47
  %4 = ashr i32 %2, 18, !taffo.info !181
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !182
  %mul.u27_5fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u27_5fixp, 8, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !189 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 7, !taffo.info !181
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !190
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !193
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u16_16fixp, 8, !taffo.info !193
...
!1 = !{double 0.000000e+00, double 0x411903D700000000}
...
!54 = !{double 0.000000e+00, double 0x406D55556084A516}
...
!98 = !{double 0.000000e+00, double 0x411E049B99999999}
...
!108 = !{double 0.000000e+00, double 0x40F4A00007DD4413}
!109 = !{!48, !108, i1 false, i2 -1}
!110 = !{!48, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x411E2BD701F75105}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = distinct !{!114, !23}
...
!183 = !{!"fixp", i32 -32, i32 4}
!184 = !{double 0.000000e+00, double 0x419903D700000000}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 5}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
!189 = !{i32 1, !16, i32 1, !93, i32 1, !50, i32 1, !88}
!190 = !{!191, !192, i1 false, i2 -1}
!191 = !{!"fixp", i32 -32, i32 15}
!192 = !{double 0.000000e+00, double 6.144000e+04}
!193 = !{!194, !192, i1 false, i2 -1}
!194 = !{!"fixp", i32 32, i32 16}
!195 = distinct !{!195, !23}
!196 = distinct !{!196, !23}
