...
# %bb.4:                                # %for.body6
	...
	movslq	-1640(%rbp), %rcx
	movss	(%rax,%rcx,4), %xmm0            # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1644(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1644(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movslq	-1636(%rbp), %rcx
...
# %bb.4:                                # %for.body5
	...
	idivl	-4(%rbp)
	cvtsi2ss	%edx, %xmm0
	movss	%xmm0, -1664(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movss	%xmm0, -1660(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1664(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	-1660(%rbp), %xmm1              # 4-byte Reload
                                        # xmm1 = mem[0],zero,zero,zero
	divss	%xmm1, %xmm0
	movss	%xmm0, -1656(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1656(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	.LCPI8_0(%rip), %xmm1           # xmm1 = mem[0],zero,zero,zero
	addss	%xmm1, %xmm0
	movss	%xmm0, -1652(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1652(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movq	-16(%rbp), %rax
	movslq	-20(%rbp), %rcx
	imulq	$80, %rcx, %rcx
...
# %bb.26:                               # %for.body58
	...
	movslq	-36(%rbp), %rcx
	movss	(%rax,%rcx,4), %xmm0            # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1700(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movslq	-36(%rbp), %rcx
	movss	(%rax,%rcx,4), %xmm0            # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1696(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1700(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	-1696(%rbp), %xmm1              # 4-byte Reload
                                        # xmm1 = mem[0],zero,zero,zero
	mulss	%xmm1, %xmm0
	movss	%xmm0, -1688(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movss	(%rax,%rcx,4), %xmm0            # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1692(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1692(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	-1688(%rbp), %xmm1              # 4-byte Reload
                                        # xmm1 = mem[0],zero,zero,zero
	addss	%xmm1, %xmm0
	movss	%xmm0, -1684(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1684(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
...
# %bb.36:                               # %for.body88
	...
	movslq	-32(%rbp), %rcx
	movss	(%rax,%rcx,4), %xmm0            # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -1704(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-1704(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movq	-16(%rbp), %rax
	movslq	-28(%rbp), %rcx
	imulq	$80, %rcx, %rcx
...
.Lfunc_end8:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_lu
...
.LBB9_20:                               # %for.end59
	...
	retq
.Lfunc_end9:
	.size	kernel_lu, .Lfunc_end9-kernel_lu
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function scale_2d.1
	.type	scale_2d.1,@function
scale_2d.1:                             # @scale_2d.1
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
.LBB10_8:                               # %for.end12
	...
	retq
.Lfunc_end10:
	.size	scale_2d.1, .Lfunc_end10-scale_2d.1
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function init_array.2
.LCPI11_0:
	.long	0x3f800000                      # float 1
	.text
	.p2align	4, 0x90
...
.LBB11_25:                              # %for.cond55
	...
	jge	.LBB11_28
# %bb.26:                               # %for.body58
                                        #   in Loop: Header=BB11_25 Depth=3
	movq	-16(%rbp), %rax
	movslq	-28(%rbp), %rcx
	imulq	$80, %rcx, %rcx
	addq	%rcx, %rax
...
.LBB11_40:                              # %for.end102
	...
	retq
.Lfunc_end11:
	.size	init_array.2, .Lfunc_end11-init_array.2
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_lu.3
...
.LBB12_20:                              # %for.end59
	...
	retq
.Lfunc_end12:
	.size	kernel_lu.3, .Lfunc_end12-kernel_lu.3
	.cfi_endproc
                                        # -- End function
...
PrintfTimerStr:
	...
	.type	.L__unnamed_98,@object          # @0
	.section	.rodata.str1.1,"aMS",@progbits,1
.L__unnamed_98:
	.asciz	"Float_half"
	.size	.L__unnamed_98, 11

	.type	.L__unnamed_99,@object          # @1
.L__unnamed_99:
	.asciz	"Float_bfloat"
...
.L__unnamed_2:
	...
	.type	.L__unnamed_100,@object         # @3
.L__unnamed_100:
	.asciz	"Float_double"
	.size	.L__unnamed_100, 13

	.type	.L__unnamed_101,@object         # @4
.L__unnamed_101:
	.asciz	"Float_x86_fp80"
	.size	.L__unnamed_101, 15

	.type	.L__unnamed_102,@object         # @5
.L__unnamed_102:
	.asciz	"Float_fp128"
	.size	.L__unnamed_102, 12

	.type	.L__unnamed_103,@object         # @6
.L__unnamed_103:
...
.L__unnamed_97:
	...
	.addrsig_sym scale_2d.1
	.addrsig_sym init_array.2
	.addrsig_sym kernel_lu.3
	.addrsig_sym printf
	.addrsig_sym A_float
