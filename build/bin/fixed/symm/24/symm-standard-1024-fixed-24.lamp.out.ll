; ModuleID = './build/bin/fixed/symm/24/symm-standard-1024-fixed-24.out.ll'
...
for.body6:                                        ; preds = %for.cond4
  ...
  %7 = fdiv float %lampsim8, 0x4130000000000000, !taffo.info !101
  ...
  %lampsim30 = and i32 %lampsim29, -1
  %lampsim31 = bitcast i32 %lampsim30 to float
  %12 = fmul float 6.400000e+01, %lampsim31, !taffo.info !105
...
for.end:                                          ; preds = %for.cond4
  ...
  %23 = fdiv float %lampsim57, 6.400000e+01, !taffo.info !112
  ...
  %29 = fdiv float %lampsim63, 0x4130000000000000, !taffo.info !101
  ...
  %mul29.1flp81 = fmul float %lampsim5, %temp2.0.1flp, !taffo.info !102
  %lampsim82 = bitcast float %mul29.1flp81 to i32
  %lampsim83 = and i32 %lampsim82, -1
  %lampsim84 = bitcast i32 %lampsim83 to float
  %add30.1flp85 = fadd float %lampsim80, %lampsim84, !taffo.info !115
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -1
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !169
