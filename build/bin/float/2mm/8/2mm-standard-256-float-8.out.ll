...
for.body38:                                       ; preds = %for.cond35
  ...
  %conv43 = sitofp i32 %rem42 to float
...
for.body61:                                       ; preds = %for.cond58
  ...
  %conv65 = sitofp i32 %rem64 to float
  %48 = load i32, ptr %nk.addr, align 4
  %conv66 = sitofp i32 %48 to float
  %div67 = fdiv float %conv65, %conv66
  ...
  store float %div67, ptr %arrayidx69, align 4
  br label %for.inc70
...
for.body26:                                       ; preds = %for.cond24
  ...
  store float %mul29, ptr %arrayidx28, align 4
  store i32 0, ptr %k, align 4
  br label %for.cond30
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef @.str.11, double noundef %conv)
  br label %for.inc
