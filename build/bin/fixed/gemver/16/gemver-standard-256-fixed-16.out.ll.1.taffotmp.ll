...
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,21038.933594) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,243.199997) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(3.2,64.0) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [31 x i8] c"scalar(range(6.4,128.0) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [40 x i8] c"scalar(range(2.133333,42.666668) final)\00", section "llvm.metadata"
@.str.8 = private unnamed_addr constant [53 x i8] c"target('w') scalar(range(0.0,1310431248384.0) final)\00", section "llvm.metadata"
@.str.9 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,5725909.0) final)\00", section "llvm.metadata"
@.str.10 = private unnamed_addr constant [30 x i8] c"scalar(range(1.6,32.0) final)\00", section "llvm.metadata"
@.str.11 = private unnamed_addr constant [40 x i8] c"scalar(range(1.422222,28.444445) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 155, i8* null)
  %u14 = bitcast [20 x float]* %u1 to i8*
  call void @llvm.var.annotation(i8* %u14, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 156, i8* null)
  %v15 = bitcast [20 x float]* %v1 to i8*
  call void @llvm.var.annotation(i8* %v15, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 157, i8* null)
  %u26 = bitcast [20 x float]* %u2 to i8*
  call void @llvm.var.annotation(i8* %u26, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 158, i8* null)
  %v27 = bitcast [20 x float]* %v2 to i8*
  call void @llvm.var.annotation(i8* %v27, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 159, i8* null)
  %w8 = bitcast [20 x float]* %w to i8*
  call void @llvm.var.annotation(i8* %w8, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 160, i8* null)
  %x9 = bitcast [20 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x9, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 161, i8* null)
  %y10 = bitcast [20 x float]* %y to i8*
  call void @llvm.var.annotation(i8* %y10, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 162, i8* null)
  %z11 = bitcast [20 x float]* %z to i8*
  call void @llvm.var.annotation(i8* %z11, i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 163, i8* null)
  ...
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 256)
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 256)
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 256)
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 256)
  %arraydecay25 = getelementptr inbounds [20 x float], [20 x float]* %w, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 256)
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 256)
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 256)
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 256)
