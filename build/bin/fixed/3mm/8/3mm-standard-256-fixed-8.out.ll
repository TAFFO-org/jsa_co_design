; ModuleID = './build/bin/fixed/3mm/8/3mm-standard-256-fixed-8.out.ll.4.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.1flp = fmul float %2, %4, !taffo.info !249
  ...
  %6 = fmul float 1.600000e+01, %mul.1flp, !taffo.info !249
  %7 = fptoui float %6 to i32, !taffo.info !249
