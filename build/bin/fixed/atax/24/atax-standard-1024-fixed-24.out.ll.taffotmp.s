...
.Ltmp1:
	...
	movl	%ebx, -2032(%ebp)               # 4-byte Spill
	leal	-1768(%ebp), %esi
	leal	-1856(%ebp), %edx
	leal	-1944(%ebp), %ecx
	leal	-2024(%ebp), %eax
...
.LBB7_1:                                # %for.cond
                                        # =>This Inner Loop Header: Depth=1
	movl	-2028(%ebp), %eax               # 4-byte Reload
	movl	%eax, -2036(%ebp)               # 4-byte Spill
	cmpl	$22, %eax
	jge	.LBB7_4
# %bb.2:                                # %for.body
                                        #   in Loop: Header=BB7_1 Depth=1
	movl	-2032(%ebp), %eax               # 4-byte Reload
	movl	-2036(%ebp), %ecx               # 4-byte Reload
	flds	-1944(%ebp,%ecx,4)
...
.Lfunc_end9:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function scale_1d.2_fixp
.LCPI10_0:
...
.Lfunc_end10:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function kernel_atax.3_fixp
.LCPI11_0:
...
.Lfunc_end11:
	...
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
	.p2align	2                               # -- Begin function scale_1d.4_fixp
.LCPI12_0:
	.long	0x44800000                      # float 1024
.LCPI12_1:
	.long	0x4a000000                      # float 2097152
