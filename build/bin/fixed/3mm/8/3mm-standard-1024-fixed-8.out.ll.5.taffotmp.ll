; ModuleID = './build/bin/fixed/3mm/8/3mm-standard-1024-fixed-8.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u8_24fixp2 = bitcast [10 x i32]* %arraydecay15.u8_24fixp to i32*, !taffo.info !44
  call void @scale_2d.4_fixp(i32 6, i32 10, i32* %u8_24fixp2, i32 1024), !taffo.info !64, !taffo.constinfo !63
  ...
  %u8_24fixp1 = bitcast [12 x i32]* %arraydecay19.u8_24fixp to i32*, !taffo.info !54
  call void @scale_2d.4_fixp(i32 14, i32 12, i32* %u8_24fixp1, i32 1024), !taffo.info !68, !taffo.constinfo !63
