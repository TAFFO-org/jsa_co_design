; ModuleID = './build/bin/fixed/heat-3d/24/heat-3d-standard-512-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 512), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 512), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
for.body6:                                        ; preds = %for.cond4
  %0 = mul nuw i32 %m, %p, !taffo.info !163
  ...
  %mul = fmul float %3, %conv, !taffo.info !167, !taffo.initweight !112
  %4 = mul nuw i32 %m, %p, !taffo.info !163
...
!102 = !{!"fixp", i32 -32, i32 16}
!103 = !{double 2.048000e+03, double 2.662400e+04}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -2.560000e+04, double 1.126400e+04}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -2.457600e+04, double 2.457600e+04}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 18}
!111 = !{double -3.072000e+03, double 3.072000e+03}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -6.144000e+03, double 6.144000e+03}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -9.216000e+03, double 9.216000e+03}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -8.192000e+03, double 2.252800e+04}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!160 = !{i32 1, !79, i32 1, !79, i32 1, !79, i32 1, !41, i32 1, !161}
!161 = !{i1 false, !162, i1 false, i2 0}
!162 = !{double 5.120000e+02, double 5.120000e+02}
!163 = !{i1 false, !164, i1 false, i2 0}
!164 = !{double 2.500000e+01, double 2.500000e+01}
!165 = !{!166, !162, i1 false, i2 1}
!166 = !{!"fixp", i32 32, i32 22}
!167 = !{!168, !169, i1 false, i2 -1}
!168 = !{!"fixp", i32 32, i32 9}
!169 = !{double 5.242880e+05, double 0x415A000000000000}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
!172 = distinct !{!172, !23}
