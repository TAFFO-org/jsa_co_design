; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-64-fixed-24.out.ll'
...
entry:
  ...
  %u6_26fixp = bitcast [10 x i32]* %arraydecay9.u6_26fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u6_26fixp, i32 64), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u6_26fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %B.u6_26fixp, i32 0, i32 0, !taffo.info !53
  %u6_26fixp2 = bitcast [10 x i32]* %arraydecay10.u6_26fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u6_26fixp2, i32 64), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay11.u15_17fixp, [10 x i32]* %arraydecay12.u6_26fixp, [10 x i32]* %arraydecay13.u6_26fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !183 !taffo.funinfo !184 !taffo.sourceFunction !185 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !187
  ...
  %7 = shl i32 %mul.u12_20fixp, 6, !taffo.info !190
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !183 !taffo.funinfo !194 !taffo.sourceFunction !185 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !195
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !198
  %6 = mul nsw i32 %i.0, %m, !taffo.info !81
  ...
  %7 = shl i32 %mul.u21_11fixp, 6, !taffo.info !198
...
!188 = !{!"fixp", i32 -32, i32 19}
!189 = !{double 0.000000e+00, double 3.840000e+03}
!190 = !{!191, !189, i1 false, i2 -1}
!191 = !{!"fixp", i32 32, i32 20}
!192 = distinct !{!192, !23}
!193 = distinct !{!193, !23}
!194 = !{i32 1, !77, i32 1, !77, i32 1, !47, i32 1, !88}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"fixp", i32 -32, i32 10}
!197 = !{double 0.000000e+00, double 0x413F08F5A00192A7}
!198 = !{!199, !197, i1 false, i2 -1}
!199 = !{!"fixp", i32 32, i32 11}
!200 = distinct !{!200, !23}
!201 = distinct !{!201, !23}
