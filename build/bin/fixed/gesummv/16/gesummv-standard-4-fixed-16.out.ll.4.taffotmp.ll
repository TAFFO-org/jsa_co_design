; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-4-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.info !63, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 4), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 4), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 4), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !59
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 4), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.info !49, !taffo.initweight !59
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 4), !taffo.info !70, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 4), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !75, !taffo.target !57, !taffo.originalCall !76
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !102, !taffo.initweight !104
  %conv = sitofp i32 %factor to float, !taffo.info !105
  %mul = fmul float %0, %conv, !taffo.info !106, !taffo.initweight !108
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !52, !taffo.initweight !101
  store float %mul, float* %arrayidx1, align 4, !taffo.info !74, !taffo.initweight !104
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !111, !taffo.initweight !104
  %conv = sitofp i32 %factor to float, !taffo.info !113
  %mul = fmul float %0, %conv, !taffo.info !114, !taffo.initweight !108
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !49, !taffo.initweight !101
  store float %mul, float* %arrayidx1, align 4, !taffo.info !70, !taffo.initweight !104
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv.5(i32 noundef %n, float noundef %alpha, float noundef %beta, [16 x float]* noundef %A, [16 x float]* noundef %B, float* noundef %tmp, float* noundef %x, float* noundef %y) #0 !taffo.initweight !117 !taffo.funinfo !118 !taffo.sourceFunction !79 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !119, !taffo.initweight !101, !taffo.constinfo !120
  %arrayidx1 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  store float 0.000000e+00, float* %arrayidx1, align 4, !taffo.info !119, !taffo.initweight !101, !taffo.constinfo !120
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx6 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx5, i32 0, i32 %j.0, !taffo.info !49, !taffo.initweight !104
  %0 = load float, float* %arrayidx6, align 4, !taffo.info !111, !taffo.initweight !108
  %arrayidx7 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.info !49, !taffo.initweight !101
  %1 = load float, float* %arrayidx7, align 4, !taffo.info !111, !taffo.initweight !104
  %mul = fmul float %0, %1, !taffo.info !121, !taffo.initweight !108
  %arrayidx8 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.info !52, !taffo.initweight !101
  %2 = load float, float* %arrayidx8, align 4, !taffo.info !52, !taffo.initweight !104
  %add = fadd float %mul, %2, !taffo.info !123, !taffo.initweight !108
  %arrayidx9 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.info !52, !taffo.initweight !101
  store float %add, float* %arrayidx9, align 4, !taffo.info !74, !taffo.initweight !104
  %arrayidx10 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.info !49, !taffo.initweight !101
  %arrayidx11 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx10, i32 0, i32 %j.0, !taffo.info !49, !taffo.initweight !104
  %3 = load float, float* %arrayidx11, align 4, !taffo.info !111, !taffo.initweight !108
  %arrayidx12 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.info !49, !taffo.initweight !101
  %4 = load float, float* %arrayidx12, align 4, !taffo.info !111, !taffo.initweight !104
  %mul13 = fmul float %3, %4, !taffo.info !121, !taffo.initweight !108
  %arrayidx14 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  %5 = load float, float* %arrayidx14, align 4, !taffo.info !55, !taffo.initweight !104
  %add15 = fadd float %mul13, %5, !taffo.info !125, !taffo.initweight !108
  %arrayidx16 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  store float %add15, float* %arrayidx16, align 4, !taffo.info !77, !taffo.initweight !104
  br label %for.inc
...
for.end:                                          ; preds = %for.cond2
  ...
  %6 = load float, float* %arrayidx17, align 4, !taffo.info !52, !taffo.initweight !104
  %mul18 = fmul float %alpha, %6, !taffo.info !128, !taffo.initweight !101
  %arrayidx19 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  %7 = load float, float* %arrayidx19, align 4, !taffo.info !55, !taffo.initweight !104
  %mul20 = fmul float %beta, %7, !taffo.info !130, !taffo.initweight !101
  %add21 = fadd float %mul18, %mul20, !taffo.info !132, !taffo.initweight !104
  %arrayidx22 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  store float %add21, float* %arrayidx22, align 4, !taffo.info !77, !taffo.initweight !104
  br label %for.inc23
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !136, !taffo.initweight !104
  %conv = sitofp i32 %factor to float, !taffo.info !105
  %mul = fmul float %0, %conv, !taffo.info !138, !taffo.initweight !108
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !55, !taffo.initweight !101
  store float %mul, float* %arrayidx1, align 4, !taffo.info !77, !taffo.initweight !104
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7(i32 noundef %n, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %A, [16 x float]* noundef %B, float* noundef %x, float* noundef %tmp, float* noundef %y) #0 !taffo.initweight !141 !taffo.funinfo !142 !taffo.sourceFunction !65 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !63, !taffo.initweight !143, !taffo.constinfo !144
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !68, !taffo.initweight !143, !taffo.constinfo !146
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc25, %for.inc24 ], !taffo.info !149, !taffo.initweight !46
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !150, !taffo.initweight !69
  br i1 %cmp, label %for.body, label %for.end26, !taffo.info !151, !taffo.initweight !71

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.info !153, !taffo.initweight !69
  %conv = sitofp i32 %rem to float, !taffo.info !154, !taffo.initweight !71
  %conv3 = sitofp i32 %n to float, !taffo.info !155
  %div = fdiv float %conv, %conv3, !taffo.info !157, !taffo.initweight !143
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.info !160, !taffo.initweight !69
  store float %div, float* %arrayidx, align 4, !taffo.info !119, !taffo.initweight !71
  %arrayidx4 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !161, !taffo.initweight !69
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !119, !taffo.initweight !71, !taffo.constinfo !120
  %arrayidx5 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.info !162, !taffo.initweight !69
  store float 0.000000e+00, float* %arrayidx5, align 4, !taffo.info !119, !taffo.initweight !71, !taffo.constinfo !120
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !149, !taffo.initweight !46
  %cmp7 = icmp slt i32 %j.0, %n, !taffo.info !150, !taffo.initweight !69
  br i1 %cmp7, label %for.body9, label %for.end, !taffo.info !151, !taffo.initweight !71
...
for.body9:                                        ; preds = %for.cond6
  ...
  %rem10 = srem i32 %add, %n, !taffo.info !153, !taffo.initweight !143
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !154, !taffo.initweight !101
  %conv12 = sitofp i32 %n to float, !taffo.info !155
  %div13 = fdiv float %conv11, %conv12, !taffo.info !157, !taffo.initweight !104
  ...
  store float %div13, float* %arrayidx15, align 4, !taffo.info !119, !taffo.initweight !71
  ...
  %rem18 = srem i32 %add17, %n, !taffo.info !153, !taffo.initweight !143
  %conv19 = sitofp i32 %rem18 to float, !taffo.info !154, !taffo.initweight !101
  %conv20 = sitofp i32 %n to float, !taffo.info !155
  %div21 = fdiv float %conv19, %conv20, !taffo.info !157, !taffo.initweight !104
  ...
  store float %div21, float* %arrayidx23, align 4, !taffo.info !119, !taffo.initweight !71
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx = getelementptr inbounds float, float* %val, i32 %0, !taffo.info !49, !taffo.initweight !104
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !49, !taffo.initweight !108
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !111, !taffo.initweight !174
  %conv = sitofp i32 %factor to float, !taffo.info !113
  %mul = fmul float %1, %conv, !taffo.info !114, !taffo.initweight !175
  %2 = mul nsw i32 %i.0, %m, !taffo.info !92
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !49, !taffo.initweight !104
...
!51 = !{double 0.000000e+00, double 3.750000e+00}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 25}
!54 = !{double 0.000000e+00, double 7.050000e+01}
...
!98 = !{double 4.000000e+00, double 4.000000e+00}
!99 = !{i32 -1, i32 2, i32 -1}
!100 = !{i32 1, !88, i32 1, !52, i32 1, !97}
!101 = !{i32 5}
!102 = !{!103, !54, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 23}
!104 = !{i32 6}
!105 = !{!50, !98, i1 false, i2 1}
!106 = !{!103, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 2.820000e+02}
!108 = !{i32 7}
!109 = distinct !{!109, !23}
!110 = !{i32 1, !88, i32 1, !49, i32 1, !97}
!111 = !{!112, !51, i1 false, i2 -1}
!112 = !{!"fixp", i32 32, i32 28}
!113 = !{!112, !98, i1 false, i2 1}
!114 = !{!112, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 1.500000e+01}
!116 = distinct !{!116, !23}
!117 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!118 = !{i32 1, !88, i32 1, !43, i32 1, !47, i32 1, !49, i32 1, !49, i32 1, !52, i32 1, !49, i32 1, !55}
!119 = !{i1 false, i1 false, i1 false, i2 1}
!120 = !{!92, i1 false}
!121 = !{!112, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 1.406250e+01}
!123 = !{!53, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 8.456250e+01}
!125 = !{!56, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x406868667F90D9D7}
!127 = distinct !{!127, !23}
!128 = !{!103, !129, i1 false, i2 -1}
!129 = !{double 0.000000e+00, double 1.057500e+02}
!130 = !{!103, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 0x406B2E149914389B}
!132 = !{!103, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x4074330A4C8A1C4E}
!134 = distinct !{!134, !23}
!135 = !{i32 1, !88, i32 1, !55, i32 1, !97}
!136 = !{!137, !1, i1 false, i2 -1}
!137 = !{!"fixp", i32 32, i32 22}
!138 = !{!137, !139, i1 false, i2 -1}
!139 = !{double 0.000000e+00, double 0x4086A6667F90D9D7}
!140 = distinct !{!140, !23}
!141 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2}
!142 = !{i32 1, !88, i32 1, !43, i32 1, !47, i32 1, !49, i32 1, !49, i32 1, !49, i32 1, !52, i32 1, !55}
!143 = !{i32 4}
!144 = !{!145, i1 false}
!145 = !{i1 false, !45, i1 false, i2 0}
!146 = !{!147, i1 false}
!147 = !{i1 false, !148, i1 false, i2 0}
!148 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!149 = !{i1 false, !81, i1 false, i2 1}
!150 = !{i1 false, !83, i1 false, i2 1}
!151 = !{i1 false, !152, i1 false, i2 1}
!152 = !{double 0.000000e+00, double 1.600000e+01}
!153 = !{i1 false, !115, i1 false, i2 1}
!154 = !{!112, !115, i1 false, i2 1}
