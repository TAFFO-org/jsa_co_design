; ModuleID = './build/bin/fixed/syr2k/11/syr2k-standard-4-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u3_29fixp2 = bitcast [10 x i32]* %arraydecay9.u3_29fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u3_29fixp2, i32 4), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u3_29fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %B.u3_29fixp, i32 0, i32 0, !taffo.info !53
  %u3_29fixp = bitcast [10 x i32]* %arraydecay10.u3_29fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u3_29fixp, i32 4), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %0, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u8_24fixp, [10 x i32]* %arraydecay12.u3_29fixp, [10 x i32]* %arraydecay13.u3_29fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u8_24fixp, [10 x i32]* noundef %A.u3_29fixp, [10 x i32]* noundef %B.u3_29fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !94 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv6.u5_27fixp = shl i32 %n, 27, !taffo.info !119
  %0 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !117
  %1 = lshr i32 %conv6.u5_27fixp, 1, !taffo.info !119
  %2 = ashr i32 %0, 1, !taffo.info !117
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %2, i32 %1, i32 26), !taffo.info !121
  %div.u1_31fixp = shl i32 %3, 5, !taffo.info !124
  %arrayidx.u3_29fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u3_29fixp, i32 %i.0, !taffo.info !126
  %arrayidx7.u3_29fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u3_29fixp, i32 0, i32 %j.0, !taffo.info !126
  %4 = lshr i32 %div.u1_31fixp, 2, !taffo.info !124
  store i32 %4, i32* %arrayidx7.u3_29fixp, align 4, !taffo.info !127
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.info !110, !taffo.initweight !103
  %add9 = add nsw i32 %mul8, 2, !taffo.info !128, !taffo.initweight !106, !taffo.constinfo !21
  %rem10 = srem i32 %add9, %m, !taffo.info !130, !taffo.initweight !116
  %conv11.u4_28fixp = shl i32 %rem10, 28, !taffo.info !132
  %conv12.u4_28fixp = shl i32 %m, 28, !taffo.info !133
  %5 = lshr i32 %conv11.u4_28fixp, 1, !taffo.info !132
  %6 = lshr i32 %conv12.u4_28fixp, 1, !taffo.info !133
  %7 = call i32 @llvm.sdiv.fix.i32(i32 %5, i32 %6, i32 27), !taffo.info !134
  %div13.u1_31fixp = shl i32 %7, 4, !taffo.info !137
  %arrayidx14.u3_29fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u3_29fixp, i32 %i.0, !taffo.info !138
  %arrayidx15.u3_29fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u3_29fixp, i32 0, i32 %j.0, !taffo.info !138
  %8 = lshr i32 %div13.u1_31fixp, 2, !taffo.info !137
  store i32 %8, i32* %arrayidx15.u3_29fixp, align 4, !taffo.info !127
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !139, !taffo.initweight !103, !taffo.constinfo !21
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.info !142, !taffo.initweight !103, !taffo.constinfo !21
...
for.cond23:                                       ; preds = %for.inc35, %for.body22
  ...
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.info !144, !taffo.initweight !103
...
for.body26:                                       ; preds = %for.cond23
  ...
  %add28 = add nsw i32 %mul27, 3, !taffo.info !145, !taffo.initweight !106, !taffo.constinfo !21
  %rem29 = srem i32 %add28, %n, !taffo.info !114, !taffo.initweight !116
  %conv30.u4_28fixp = shl i32 %rem29, 28, !taffo.info !117
  %conv31.u4_28fixp = shl i32 %m, 28, !taffo.info !133
  %9 = lshr i32 %conv30.u4_28fixp, 1, !taffo.info !117
  %10 = lshr i32 %conv31.u4_28fixp, 1, !taffo.info !133
  %11 = call i32 @llvm.sdiv.fix.i32(i32 %9, i32 %10, i32 27), !taffo.info !147
  %div32.u4_28fixp = shl i32 %11, 1, !taffo.info !149
  %arrayidx33.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u8_24fixp, i32 %i.1, !taffo.info !150
  %arrayidx34.u8_24fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx33.u8_24fixp, i32 0, i32 %j.1, !taffo.info !150
  %12 = lshr i32 %div32.u4_28fixp, 4, !taffo.info !149
  store i32 %12, i32* %arrayidx34.u8_24fixp, align 4, !taffo.info !127
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.info !139, !taffo.initweight !103, !taffo.constinfo !21
  br label %for.cond23, !llvm.loop !151

for.end37:                                        ; preds = %for.cond23
  br label %for.inc38

for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.info !142, !taffo.initweight !103, !taffo.constinfo !21
  br label %for.cond19, !llvm.loop !152
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u3_29fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u8_24fixp, [10 x i32]* noundef %A.u3_29fixp, [10 x i32]* noundef %B.u3_29fixp) #0 !taffo.initweight !153 !taffo.funinfo !154 !taffo.sourceFunction !155 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 23), !taffo.info !156
  %mul.u8_24fixp = shl i32 %3, 1, !taffo.info !159
...
for.body10:                                       ; preds = %for.cond8
  ...
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 26), !taffo.info !161
  %mul13.u5_27fixp = shl i32 %8, 1, !taffo.info !163
  ...
  %u3_29fixp3 = load i32, i32* %arrayidx15.u3_29fixp, align 4, !taffo.info !164
  %9 = lshr i32 %mul13.u5_27fixp, 1, !taffo.info !163
  %10 = lshr i32 %u3_29fixp3, 1, !taffo.info !164
  %11 = ashr i32 %9, 1, !taffo.info !163
  %12 = ashr i32 %10, 3, !taffo.info !164
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 25), !taffo.info !165
  %mul16.u6_26fixp = shl i32 %13, 1, !taffo.info !168
  ...
  %18 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %17, i32 26), !taffo.info !170
  %mul19.u5_27fixp = shl i32 %18, 1, !taffo.info !172
  ...
  %u3_29fixp2 = load i32, i32* %arrayidx21.u3_29fixp, align 4, !taffo.info !173
  %19 = lshr i32 %mul19.u5_27fixp, 1, !taffo.info !172
  %20 = lshr i32 %u3_29fixp2, 1, !taffo.info !173
  %21 = ashr i32 %19, 1, !taffo.info !172
  %22 = ashr i32 %20, 3, !taffo.info !173
  %23 = call i32 @llvm.smul.fix.i32(i32 %21, i32 %22, i32 25), !taffo.info !165
  %mul22.u6_26fixp = shl i32 %23, 1, !taffo.info !168
  %24 = lshr i32 %mul16.u6_26fixp, 2, !taffo.info !168
  %25 = lshr i32 %mul22.u6_26fixp, 2, !taffo.info !168
  %add.u8_24fixp = add i32 %24, %25, !taffo.info !174
  ...
  %add25.u8_24fixp = add i32 %u8_24fixp1, %add.u8_24fixp, !taffo.info !176
...
for.inc26:                                        ; preds = %for.body10
  ...
  br label %for.cond8, !llvm.loop !178
...
!132 = !{!118, !131, i1 false, i2 1}
!133 = !{!118, !17, i1 false, i2 1}
!134 = !{!135, !136, i1 false, i2 1}
!135 = !{!"fixp", i32 -32, i32 27}
!136 = !{double 0.000000e+00, double 9.000000e-01}
!137 = !{!125, !136, i1 false, i2 1}
!138 = !{!51, !54, i1 false, i2 1}
!139 = !{i1 false, !140, i1 false, i2 1}
!140 = !{double 1.000000e+00, double 1.100000e+01}
!141 = distinct !{!141, !23}
!142 = !{i1 false, !75, i1 false, i2 1}
!143 = distinct !{!143, !23}
!144 = !{i1 false, !81, i1 false, i2 1}
!145 = !{i1 false, !146, i1 false, i2 1}
!146 = !{double 3.000000e+00, double 1.630000e+02}
!147 = !{!135, !148, i1 false, i2 1}
!148 = !{double 0.000000e+00, double 1.500000e+00}
!149 = !{!118, !148, i1 false, i2 1}
!150 = !{!48, !1, i1 false, i2 1}
!151 = distinct !{!151, !23}
!152 = distinct !{!152, !23}
!153 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!154 = !{i32 1, !78, i32 1, !16, i32 1, !64, i32 1, !45, i32 1, !47, i32 1, !50, i32 1, !53}
!155 = distinct !{null}
!156 = !{!157, !158, i1 false, i2 -1}
!157 = !{!"fixp", i32 -32, i32 23}
!158 = !{double 0.000000e+00, double 0x40632937329C347F}
!159 = !{!48, !158, i1 false, i2 -1}
!160 = distinct !{!160, !23}
!161 = !{!122, !162, i1 false, i2 -1}
!162 = !{double 0.000000e+00, double 5.625000e+00}
!163 = !{!120, !162, i1 false, i2 -1}
!164 = !{!120, !54, i1 false, i2 -1}
!165 = !{!166, !167, i1 false, i2 -1}
!166 = !{!"fixp", i32 -32, i32 25}
!167 = !{double 0.000000e+00, double 2.025000e+01}
!168 = !{!169, !167, i1 false, i2 -1}
!169 = !{!"fixp", i32 32, i32 26}
!170 = !{!122, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 5.400000e+00}
!172 = !{!120, !171, i1 false, i2 -1}
!173 = !{!120, !52, i1 false, i2 -1}
!174 = !{!48, !175, i1 false, i2 -1}
!175 = !{double 0.000000e+00, double 4.050000e+01}
!176 = !{!48, !177, i1 false, i2 -1}
!177 = !{double 0.000000e+00, double 0x406507ADFF822BBF}
!178 = distinct !{!178, !23}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
...
!184 = !{!118, !52, i1 false, i2 -1}
!185 = !{!118, !90, i1 false, i2 1}
!186 = !{!135, !115, i1 false, i2 -1}
!187 = !{!118, !115, i1 false, i2 -1}
!188 = distinct !{!188, !23}
!189 = distinct !{!189, !23}
