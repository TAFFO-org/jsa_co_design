; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-1024-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %0, i32 noundef 1024), !taffo.info !52, !taffo.initweight !56, !taffo.constinfo !57, !taffo.target !45, !taffo.originalCall !58
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 1024), !taffo.info !59, !taffo.initweight !56, !taffo.constinfo !57, !taffo.originalCall !58
...
!47 = !{!"fixp", i32 32, i32 17}
!48 = !{double 0x406999999FE43676, double 0x40D011111FFF79C8}
...
!97 = !{double 0x407111111F0C34C2, double 0x40DE22222003AB86}
!98 = !{i32 8}
!99 = !{!96, !43, i1 false, i2 -1}
!100 = !{!96, !101, i1 false, i2 -1}
!101 = !{double 0x40799999AE924F23, double 0x40E699999802C0A4}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 15}
!104 = !{double 0x408111111F0C34C2, double 0x40EE22222003AB86}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0x4085555566CF41F2, double 0x40F2D55554024B34}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x4061111123507909, double 0x40CE2222278C340E}
!109 = !{i32 9}
!110 = !{!111, i1 false}
...
!117 = !{double 0x407999999FE43676, double 0x40E011111FFF79C8}
!118 = !{!103, !119, i1 false, i2 -1}
!119 = !{double 0x4083333337EB28D8, double 0x40E81999AFFF36AC}
!120 = !{!103, !48, i1 false, i2 -1}
!121 = !{!103, !122, i1 false, i2 -1}
!122 = !{double 0x408999999FE43676, double 0x40F011111FFF79C8}
!123 = !{!103, !124, i1 false, i2 -1}
!124 = !{double 0x4090000003EEA20A, double 0x40F4155567FF583A}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0x40699999A64A9CDE, double 0x40D011112403BE10}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!173 = !{double 1.024000e+03, double 1.024000e+03}
!174 = !{!175, !173, i1 false, i2 1}
!175 = !{!"fixp", i32 32, i32 21}
!176 = !{!177, !178, i1 false, i2 -1}
!177 = !{!"fixp", i32 32, i32 8}
!178 = !{double 0x410111111F0C34C2, double 0x416E22222003AB86}
!179 = distinct !{!179, !23}
!180 = distinct !{!180, !23}
!181 = !{i32 1, !77, i32 1, !77, i32 1, !46, i32 1, !172}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 7}
!184 = !{double 0x410999999FE43676, double 0x417011111FFF79C8}
!185 = distinct !{!185, !23}
!186 = distinct !{!186, !23}
