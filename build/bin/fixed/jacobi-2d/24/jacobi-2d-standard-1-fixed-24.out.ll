; ModuleID = './build/bin/fixed/jacobi-2d/24/jacobi-2d-standard-1-fixed-24.out.ll.4.taffotmp.ll'
...
for.body8:                                        ; preds = %for.cond6
  ...
  %1 = fdiv float %0, 0x41A0000000000000, !taffo.info !28, !taffo.target !31
  ...
  store float %1, float* %arrayidx11, align 4, !taffo.info !34, !taffo.target !31
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), double noundef %conv), !taffo.constinfo !35
  br label %for.inc
