; ModuleID = './build/bin/fixed/trmm/16/trmm-standard-256-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,256.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [46 x i8] c"target('B') scalar(range(0.0,341136.0) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 256), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 256), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 256), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
!7 = !{double 0.000000e+00, double 3.411360e+05}
...
!110 = !{double 2.560000e+02, double 2.560000e+02}
...
!118 = !{double 0.000000e+00, double 0x4194D24000000000}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x4194E71240000000}
!121 = distinct !{!121, !29}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 5.117040e+05}
!124 = distinct !{!124, !29}
!125 = distinct !{!125, !29}
...
!155 = !{double 0.000000e+00, double 6.553600e+04}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
