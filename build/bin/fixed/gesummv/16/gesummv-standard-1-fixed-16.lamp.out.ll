; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-1-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %lampsim2, 0x41B0000000000000, !taffo.info !39, !taffo.target !41
  ...
  store float %lampsim5, float* %arrayidx17, align 4, !taffo.info !51, !taffo.target !41
  br label %for.inc
