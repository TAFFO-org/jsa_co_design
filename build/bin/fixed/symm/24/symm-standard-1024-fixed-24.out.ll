; ModuleID = './build/bin/fixed/symm/24/symm-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
for.body16:                                       ; preds = %for.cond14
  ...
  %1 = fdiv float %0, 6.400000e+01, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_symm.3_fixp(i32 noundef %m, i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u26_6fixp, [10 x i32]* noundef %A.s21_11fixp, [16 x i32]* noundef %B.u12_20fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !94 {
entry:
...
for.body6:                                        ; preds = %for.cond4
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %4, i32 %3, i32 19), !taffo.info !98
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !101
  %6 = uitofp i32 %mul.u12_20fixp to float, !taffo.info !101
  %7 = fdiv float %6, 0x4130000000000000, !taffo.info !101
  ...
  %9 = fdiv float %8, 2.048000e+03, !taffo.info !50
  ...
  %11 = fdiv float %10, 6.400000e+01, !taffo.info !47
  %add.1flp = fadd float %11, %mul10.1flp, !taffo.info !105
  %12 = fmul float 6.400000e+01, %add.1flp, !taffo.info !105
  ...
  %15 = fdiv float %14, 0x4130000000000000, !taffo.info !53
  ...
  %17 = fdiv float %16, 2.048000e+03, !taffo.info !50
...
for.end:                                          ; preds = %for.cond4
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %20, i32 %19, i32 5), !taffo.info !109
  %mul21.u26_6fixp = shl i32 %21, 1, !taffo.info !112
  %22 = uitofp i32 %mul21.u26_6fixp to float, !taffo.info !112
  %23 = fdiv float %22, 6.400000e+01, !taffo.info !112
  ...
  %27 = call i32 @llvm.smul.fix.i32(i32 %26, i32 %25, i32 19), !taffo.info !98
  %mul24.u12_20fixp = shl i32 %27, 1, !taffo.info !101
  %28 = uitofp i32 %mul24.u12_20fixp to float, !taffo.info !101
  %29 = fdiv float %28, 0x4130000000000000, !taffo.info !101
  ...
  %31 = fdiv float %30, 2.048000e+03, !taffo.info !50
  %mul27.1flp = fmul float %29, %31, !taffo.info !102
  %add28.1flp = fadd float %23, %mul27.1flp, !taffo.info !113
  %mul29.1flp = fmul float %1, %temp2.0.1flp, !taffo.info !102
  %add30.1flp = fadd float %add28.1flp, %mul29.1flp, !taffo.info !115
  ...
  %32 = fmul float 6.400000e+01, %add30.1flp, !taffo.info !115
  %33 = fptoui float %32 to i32, !taffo.info !115
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %m, i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u26_6fixp, [10 x i32]* noundef %A.s21_11fixp, [16 x i32]* noundef %B.u12_20fixp) #0 !taffo.initweight !120 !taffo.funinfo !93 !taffo.sourceFunction !121 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %conv6.u4_28fixp = shl i32 %m, 28, !taffo.info !141
  %0 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !139, !taffo.constinfo !21
  %1 = lshr i32 %conv6.u4_28fixp, 1, !taffo.info !141
  %2 = ashr i32 %1, 1, !taffo.info !141
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %0, i32 %2, i32 26), !taffo.info !143
  %div.u4_28fixp = shl i32 %3, 2, !taffo.info !146
  %arrayidx.u26_6fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u26_6fixp, i32 %i.0, !taffo.info !147
  %arrayidx7.u26_6fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u26_6fixp, i32 0, i32 %j.0, !taffo.info !147
  %4 = lshr i32 %div.u4_28fixp, 22, !taffo.info !146
  store i32 %4, i32* %arrayidx7.u26_6fixp, align 4, !taffo.info !148
  %add8 = add nsw i32 %n, %i.0, !taffo.info !149, !taffo.initweight !130
  ...
  %conv11.u4_28fixp = shl i32 %m, 28, !taffo.info !141
  %5 = lshr i32 %conv10.u5_27fixp, 1, !taffo.info !139, !taffo.constinfo !21
  %6 = lshr i32 %conv11.u4_28fixp, 1, !taffo.info !141
  %7 = ashr i32 %6, 1, !taffo.info !141
  %8 = call i32 @llvm.sdiv.fix.i32(i32 %5, i32 %7, i32 26), !taffo.info !143
  %div12.u4_28fixp = shl i32 %8, 2, !taffo.info !146
  %arrayidx13.u12_20fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u12_20fixp, i32 %i.0, !taffo.info !151
  %arrayidx14.u12_20fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx13.u12_20fixp, i32 0, i32 %j.0, !taffo.info !151
  %9 = lshr i32 %div12.u4_28fixp, 8, !taffo.info !146
  store i32 %9, i32* %arrayidx14.u12_20fixp, align 4, !taffo.info !148
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !152, !taffo.initweight !130, !taffo.constinfo !21
...
for.inc15:                                        ; preds = %for.end
  %inc16 = add nsw i32 %i.0, 1, !taffo.info !155, !taffo.initweight !130, !taffo.constinfo !21
...
for.body25:                                       ; preds = %for.cond22
  ...
  %conv29.u4_28fixp = shl i32 %m, 28, !taffo.info !141
  %10 = lshr i32 %conv28.u5_27fixp, 1, !taffo.info !139, !taffo.constinfo !21
  %11 = lshr i32 %conv29.u4_28fixp, 1, !taffo.info !141
  %12 = ashr i32 %11, 1, !taffo.info !141
  %13 = call i32 @llvm.sdiv.fix.i32(i32 %10, i32 %12, i32 26), !taffo.info !143
  %div30.u4_28fixp = shl i32 %13, 2, !taffo.info !146
  %arrayidx31.s21_11fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s21_11fixp, i32 %i.1, !taffo.info !157
  %arrayidx32.s21_11fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx31.s21_11fixp, i32 0, i32 %j.1, !taffo.info !157
  %14 = lshr i32 %div30.u4_28fixp, 17, !taffo.info !146
  store i32 %14, i32* %arrayidx32.s21_11fixp, align 4, !taffo.info !148
  br label %for.inc33

for.inc33:                                        ; preds = %for.body25
  %inc34 = add nsw i32 %j.1, 1, !taffo.info !152, !taffo.initweight !130, !taffo.constinfo !21
  br label %for.cond22, !llvm.loop !158

for.end35:                                        ; preds = %for.cond22
  %add36 = add nsw i32 %i.1, 1, !taffo.info !155, !taffo.initweight !130, !taffo.constinfo !21
  br label %for.cond37
...
for.body40:                                       ; preds = %for.cond37
  %arrayidx41.s21_11fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.s21_11fixp, i32 %i.1, !taffo.info !157
  %arrayidx42.s21_11fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx41.s21_11fixp, i32 0, i32 %j.2, !taffo.info !157
  store i32 -2045952, i32* %arrayidx42.s21_11fixp, align 4, !taffo.info !148, !taffo.constinfo !159
  br label %for.inc43

for.inc43:                                        ; preds = %for.body40
  %inc44 = add nsw i32 %j.2, 1, !taffo.info !152, !taffo.initweight !130, !taffo.constinfo !21
...
for.inc46:                                        ; preds = %for.end45
  %inc47 = add nsw i32 %i.1, 1, !taffo.info !155, !taffo.initweight !130, !taffo.constinfo !21
  br label %for.cond18, !llvm.loop !163
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u26_6fixp, i32 noundef %factor) #0 !taffo.initweight !164 !taffo.funinfo !165 !taffo.sourceFunction !166 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 6.400000e+01, !taffo.info !47
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !167
  %3 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !167
  %4 = fdiv float %3, 0x4140000000000000, !taffo.info !167
  %mul.1flp = fmul float %2, %4, !taffo.info !169
  ...
  %6 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !169
  %7 = fptoui float %6 to i32, !taffo.info !169
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !164 !taffo.funinfo !174 !taffo.sourceFunction !166 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 9), !taffo.info !175
  %mul.u22_10fixp = shl i32 %5, 1, !taffo.info !178
  ...
  %7 = shl i32 %mul.u22_10fixp, 10, !taffo.info !178
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 2.048000e+03, !taffo.info !50
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !167
  %3 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !167
  %4 = fdiv float %3, 0x4140000000000000, !taffo.info !167
  %mul.1flp = fmul float %2, %4, !taffo.info !183
  %5 = mul nsw i32 %i.0, %m, !taffo.info !83
  ...
  %6 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !183
  %7 = fptosi float %6 to i32, !taffo.info !183
...
!96 = !{!"float", i32 1, double 0x41E3830000000000}
!97 = !{double 0xC1E3830000000000, double 0x4151FFFFF7F8CA82}
!98 = !{!99, !100, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 19}
!100 = !{double 0x40633333397DD010, double 3.840000e+03}
!101 = !{!54, !100, i1 false, i2 -1}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"float", i32 1, double 0x41ED448000000000}
!104 = !{double 0xC1ED448000000000, double 0x415AFFFFF3F52FC3}
!105 = !{!103, !106, i1 false, i2 -1}
!106 = !{double 0xC1ED448000000000, double 0x4188C0227E7EA5F8}
!107 = !{!96, !97, i1 false, i2 -1}
!108 = distinct !{!108, !23}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 5}
!111 = !{double 0.000000e+00, double 0x4189A68FCCCCCCCD}
!112 = !{!48, !111, i1 false, i2 -1}
!113 = !{!103, !114, i1 false, i2 -1}
!114 = !{double 0xC1ED448000000000, double 0x418D068FCB4B72C5}
!115 = !{!116, !117, i1 false, i2 -1}
!116 = !{!"float", i32 1, double 0x41FD448000000000}
!117 = !{double 0xC1FD448000000000, double 0x41903347E4E50C5F}
!118 = distinct !{!118, !23}
!119 = distinct !{!119, !23}
...
!141 = !{!142, !17, i1 false, i2 1}
!142 = !{!"fixp", i32 32, i32 28}
!143 = !{!144, !145, i1 false, i2 1}
!144 = !{!"fixp", i32 -32, i32 26}
!145 = !{double 0.000000e+00, double 2.600000e+00}
!146 = !{!142, !145, i1 false, i2 1}
!147 = !{!48, !1, i1 false, i2 1}
!148 = !{i1 false, i1 false, i1 false, i2 1}
!149 = !{i1 false, !150, i1 false, i2 1}
!150 = !{double 1.600000e+01, double 2.600000e+01}
!151 = !{!54, !55, i1 false, i2 1}
!152 = !{i1 false, !153, i1 false, i2 1}
!153 = !{double 1.000000e+00, double 1.700000e+01}
!154 = distinct !{!154, !23}
!155 = !{i1 false, !75, i1 false, i2 1}
!156 = distinct !{!156, !23}
!157 = !{!51, !52, i1 false, i2 1}
!158 = distinct !{!158, !23}
!159 = !{!160, i1 false}
!160 = !{i1 false, !161, i1 false, i2 0}
!161 = !{double -9.990000e+02, double -9.990000e+02}
!162 = distinct !{!162, !23}
!163 = distinct !{!163, !23}
!164 = !{i32 -1, i32 -1, i32 3, i32 -1}
!165 = !{i32 1, !16, i32 1, !79, i32 1, !47, i32 1, !89}
!166 = !{void (i32, i32, float*, i32)* @scale_2d}
!167 = !{!168, !90, i1 false, i2 1}
!168 = !{!"fixp", i32 32, i32 21}
!169 = !{!170, !171, i1 false, i2 -1}
!170 = !{!"float", i32 1, double 0x4225602280000000}
!171 = !{double 0.000000e+00, double 0x4225602280000000}
!172 = distinct !{!172, !23}
!173 = distinct !{!173, !23}
!174 = !{i32 1, !16, i32 1, !79, i32 1, !53, i32 1, !89}
!175 = !{!176, !177, i1 false, i2 -1}
!176 = !{!"fixp", i32 -32, i32 9}
!177 = !{double 0x40F99999A1FD156A, double 2.621440e+06}
!178 = !{!179, !177, i1 false, i2 -1}
!179 = !{!"fixp", i32 32, i32 10}
!180 = distinct !{!180, !23}
!181 = distinct !{!181, !23}
