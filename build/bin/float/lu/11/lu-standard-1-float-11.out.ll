...
entry:
  ...
  call void @kernel_lu(i32 noundef %1, ptr noundef %arraydecay1)
...
for.body4:                                        ; preds = %for.cond2
  ...
  %arrayidx5 = getelementptr inbounds [20 x float], ptr %arrayidx, i32 0, i32 %7
  %8 = load float, ptr %arrayidx5, align 4
  %9 = load i32, ptr %i, align 4
  %arrayidx6 = getelementptr inbounds [20 x [20 x float]], ptr @A_float, i32 0, i32 %9
  %10 = load i32, ptr %j, align 4
  %arrayidx7 = getelementptr inbounds [20 x float], ptr %arrayidx6, i32 0, i32 %10
  store float %8, ptr %arrayidx7, align 4
  br label %for.inc
...
for.body6:                                        ; preds = %for.cond4
  ...
  %mul = fmul float %9, %13
  store float %mul, ptr %tmp, align 4
...
for.body24:                                       ; preds = %for.cond22
  ...
  %mul30 = fmul float %37, %41
  store float %mul30, ptr %tmp25, align 4
  ...
  %sub33 = fsub float %46, %42
  store float %sub33, ptr %arrayidx32, align 4
  br label %for.inc34
