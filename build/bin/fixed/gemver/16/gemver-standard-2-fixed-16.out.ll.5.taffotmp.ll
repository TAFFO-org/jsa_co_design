; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-2-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u2_30fixp = load i32, i32* %alpha.u2_30fixp, align 4, !taffo.info !87
  %u2_30fixp1 = load i32, i32* %beta.u2_30fixp, align 4, !taffo.info !88
  ...
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !87
  %1 = lshr i32 %u2_30fixp1, 1, !taffo.info !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !115 !taffo.funinfo !123 !taffo.sourceFunction !117 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u8_24fixp = load i32, i32* %arrayidx.u8_24fixp, align 4, !taffo.info !124
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !118
  %0 = lshr i32 %u8_24fixp, 1, !taffo.info !124
  %1 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !118
  %2 = ashr i32 %0, 1, !taffo.info !124
  %3 = ashr i32 %1, 7, !taffo.info !118
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 22), !taffo.info !126
  %mul.u9_23fixp = shl i32 %4, 1, !taffo.info !129
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u9_23fixp, 1, !taffo.info !129
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !115 !taffo.funinfo !131 !taffo.sourceFunction !117 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u2_30fixp = load i32, i32* %arrayidx.u2_30fixp, align 4, !taffo.info !132
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !133
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !132
  %1 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !133
  %2 = ashr i32 %0, 1, !taffo.info !132
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 28), !taffo.info !134
  %mul.u3_29fixp = shl i32 %3, 1, !taffo.info !137
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !53
  %4 = shl i32 %mul.u3_29fixp, 1, !taffo.info !137
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !133
...
!122 = distinct !{!122, !27}
!123 = !{i32 1, !102, i32 1, !62, i32 1, !23}
!124 = !{!125, !3, i1 false, i2 -1}
!125 = !{!"fixp", i32 32, i32 23}
!126 = !{!127, !128, i1 false, i2 -1}
!127 = !{!"fixp", i32 -32, i32 22}
!128 = !{double 0.000000e+00, double 0x407ABE8B60F1B25F}
!129 = !{!125, !128, i1 false, i2 -1}
!130 = distinct !{!130, !27}
!131 = !{i32 1, !102, i32 1, !53, i32 1, !23}
!132 = !{!66, !54, i1 false, i2 -1}
!133 = !{!66, !24, i1 false, i2 1}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 -32, i32 28}
!136 = !{double 0.000000e+00, double 3.800000e+00}
!137 = !{!66, !136, i1 false, i2 -1}
!138 = distinct !{!138, !27}
