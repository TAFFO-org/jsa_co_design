...
@.str.3 = private unnamed_addr constant [50 x i8] c"target('C') scalar(range(0.0,25661.439453) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,60.0) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,58.666668) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %C3, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 119, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 12, float* noundef %3, i32 noundef 64)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 64)
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 12, float* noundef %5, i32 noundef 64)
