...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,110.933342) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,5.333333) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,5.6) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,131.072006) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,5.866667) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,5.76) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [50 x i8] c"target('G') scalar(range(0.0,56920.203125) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, ptr noundef %arraydecay7, i32 noundef 32)
  %arraydecay8 = getelementptr inbounds [6 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 10, ptr noundef %arraydecay8, i32 noundef 32)
  %arraydecay9 = getelementptr inbounds [10 x [8 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 8, ptr noundef %arraydecay9, i32 noundef 32)
  %arraydecay10 = getelementptr inbounds [8 x [12 x float]], ptr %F, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 12, ptr noundef %arraydecay10, i32 noundef 32)
  %arraydecay11 = getelementptr inbounds [8 x [14 x float]], ptr %C, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 14, ptr noundef %arraydecay11, i32 noundef 32)
  %arraydecay12 = getelementptr inbounds [14 x [12 x float]], ptr %D, i32 0, i32 0
  call void @scale_2d(i32 noundef 14, i32 noundef 12, ptr noundef %arraydecay12, i32 noundef 32)
  %arraydecay13 = getelementptr inbounds [6 x [12 x float]], ptr %G, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 12, ptr noundef %arraydecay13, i32 noundef 32)
