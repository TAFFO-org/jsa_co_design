; ModuleID = './build/bin/fixed/atax/24/atax-standard-32-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 32), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.info !46, !taffo.initweight !56
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 32), !taffo.info !67, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 32), !taffo.info !70, !taffo.initweight !61, !taffo.constinfo !68, !taffo.target !51, !taffo.originalCall !69
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !56
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 32), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
...
!48 = !{double 3.200000e+01, double 0x404F45D18090B418}
!49 = !{!50, !1, i1 false, i2 -1}
!50 = !{!"fixp", i32 32, i32 14}
!51 = !{!"y"}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 20}
!54 = !{double 0.000000e+00, double 0x40AE851EC00DA1A9}
...
!93 = !{double 3.200000e+01, double 3.200000e+01}
!94 = !{i32 5}
!95 = !{i32 6}
!96 = !{!47, !93, i1 false, i2 1}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"fixp", i32 32, i32 21}
!99 = !{double 1.024000e+03, double 0x409F45D18090B418}
!100 = !{i32 7}
!101 = distinct !{!101, !23}
!102 = !{i32 1, !83, i32 1, !49, i32 1, !92}
!103 = !{!104, !105, i1 false, i2 -1}
!104 = !{!"fixp", i32 32, i32 9}
!105 = !{double 0.000000e+00, double 0x415EC418A0000000}
!106 = distinct !{!106, !23}
...
!118 = !{double 0.000000e+00, double 0x407A44E32E8E07EB}
!119 = !{!115, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x40B0E6DD92EFB153}
!121 = distinct !{!121, !23}
!122 = !{!123, !1, i1 false, i2 -1}
!123 = !{!"fixp", i32 32, i32 13}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 32, i32 17}
!126 = !{double 0.000000e+00, double 0x40D9A30559A50CEA}
!127 = !{!123, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x4110FC3CA59A50CF}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = !{i32 1, !109, i32 1, !52, i32 1, !92}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"fixp", i32 32, i32 15}
!134 = !{double 0.000000e+00, double 0x40FE851EC00DA1A9}
!135 = distinct !{!135, !23}
...
!172 = !{!"fixp", i32 32, i32 24}
!173 = !{!172, !174, i1 false, i2 -1}
!174 = !{double 0.000000e+00, double 2.150400e+02}
!175 = !{i32 9}
!176 = distinct !{!176, !23}
!177 = distinct !{!177, !23}
