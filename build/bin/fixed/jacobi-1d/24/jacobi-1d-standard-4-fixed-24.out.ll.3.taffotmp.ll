; ModuleID = './build/bin/fixed/jacobi-1d/24/jacobi-1d-standard-4-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [51 x i8] c"target('A') scalar(range(0.533333,4.266667) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-1d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(0.8,4.533333) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 4), !taffo.initweight !54, !taffo.target !48, !taffo.info !49, !taffo.originalCall !57, !taffo.constinfo !56
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !53, !taffo.info !51
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 4), !taffo.initweight !54, !taffo.info !51, !taffo.originalCall !57, !taffo.constinfo !56
...
!7 = !{double 0.000000e+00, double 0x40111111276FB092}
...
!50 = !{double 5.333330e-01, double 0x40111111276FB092}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 8.000000e-01, double 0x401222220BC382A1}
!53 = !{i32 1}
!54 = !{i32 2}
...
!103 = !{double 0x400111105E1C1509, double 0x40311111276FB092}
!104 = distinct !{!104, !29}
...
!112 = !{double 0x3FF111105E1C1509, double 0x40211111276FB092}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x3FF999988D2A1F8E, double 0x40299999BB2788DB}
!115 = !{i32 8}
!116 = !{i32 9}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double 0x3FE111052ECCC9D8, double 0x40111105F81FE170}
!119 = !{i32 10}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x3FE1110520000000, double 0x4011110600000000}
!122 = distinct !{!122, !29}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 1.600000e+00, double 0x402222220BC382A1}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0x4003333333333334, double 0x402B333311A543F2}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0x3FE99988D2A1F8E5, double 0x40122216297ED4CA}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x3FE99988C0000000, double 0x4012221640000000}
!131 = distinct !{!131, !29}
!132 = distinct !{!132, !29}
!133 = !{i32 1, !88, i32 1, !51, i32 1, !97}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 3.200000e+00, double 0x403222220BC382A1}
!136 = distinct !{!136, !29}
