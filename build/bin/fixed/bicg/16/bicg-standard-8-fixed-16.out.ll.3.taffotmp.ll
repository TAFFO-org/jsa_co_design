; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-8-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,7.636364) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/bicg.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [48 x i8] c"target('s') scalar(range(0.0,437.818207) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [48 x i8] c"target('q') scalar(range(0.0,386.909088) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 8), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 8), !taffo.initweight !60, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 8), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 8), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.initweight !59, !taffo.info !51
  call void @scale_1d.5(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 8), !taffo.initweight !60, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x407B5D17603925BB}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x40782E8B9FDBD2FA}
...
!52 = !{double 0.000000e+00, double 0x401E8BA301216830}
!53 = !{i1 false, !7, i1 false, i2 -1}
!54 = !{!"s"}
!55 = !{i1 false, !9, i1 false, i2 -1}
!56 = !{!"q"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 7.600000e+00}
!59 = !{i32 1}
!60 = !{i32 2}
...
!115 = !{double 8.000000e+00, double 8.000000e+00}
!116 = !{i32 6}
!117 = !{i32 7}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 0x40AB5D17603925BB}
!120 = distinct !{!120, !31}
!121 = !{i32 1, !105, i32 1, !55, i32 1, !114}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40A82E8B9FDBD2FA}
!124 = distinct !{!124, !31}
!125 = !{i32 1, !103, i32 1, !57, i32 1, !114}
!126 = !{i1 false, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 6.080000e+01}
!128 = distinct !{!128, !31}
...
!133 = !{double 0.000000e+00, double 0x404D2832F576C918}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x407F021DBEE7FEDE}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x404D04A7A779562D}
!138 = !{i1 false, !139, i1 false, i2 -1}
!139 = !{double 0.000000e+00, double 0x407BCF2094CAFDC0}
!140 = distinct !{!140, !31}
!141 = distinct !{!141, !31}
!142 = !{i32 1, !105, i32 1, !51, i32 1, !114}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0.000000e+00, double 0x404E8BA301216830}
!145 = distinct !{!145, !31}
