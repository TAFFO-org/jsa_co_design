; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-1024-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,972.799988) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [48 x i8] c"target('x1') scalar(range(0.0,5138892.5) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [48 x i8] c"target('x2') scalar(range(0.0,5217177.5) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 1024), !taffo.initweight !58, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 1024), !taffo.initweight !58, !taffo.info !55, !taffo.target !56, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.initweight !57, !taffo.info !51
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 1024), !taffo.initweight !58, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x41539A7320000000}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x4153E6E660000000}
...
!52 = !{double 0.000000e+00, double 0x408E6666601BC98A}
...
!107 = !{double 0.000000e+00, double 0x41F39A7320000000}
!108 = distinct !{!108, !31}
!109 = !{i32 1, !91, i32 1, !55, i32 1, !102}
!110 = !{i1 false, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x41F3E6E660000000}
!112 = distinct !{!112, !31}
!113 = !{i32 1, !91, i32 1, !51, i32 1, !102}
!114 = !{i1 false, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!116 = distinct !{!116, !31}
...
!120 = !{double 0.000000e+00, double 0x412CE147A22050D9}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x4157369C14440A1B}
!123 = distinct !{!123, !31}
!124 = distinct !{!124, !31}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4157830F54440A1B}
!127 = distinct !{!127, !31}
!128 = distinct !{!128, !31}
!129 = distinct !{!129, !31}
