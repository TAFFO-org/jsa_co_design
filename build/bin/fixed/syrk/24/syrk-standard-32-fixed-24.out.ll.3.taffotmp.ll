; ModuleID = './build/bin/fixed/syrk/24/syrk-standard-32-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [49 x i8] c"target('C') scalar(range(0.0,6632.879883) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.initweight !57, !taffo.info !49, !taffo.originalCall !60, !taffo.constinfo !61
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 32), !taffo.initweight !57, !taffo.info !51, !taffo.originalCall !60, !taffo.constinfo !61
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.initweight !63, !taffo.info !53, !taffo.target !54, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.initweight !63, !taffo.info !55, !taffo.originalCall !64, !taffo.constinfo !65
...
!7 = !{double 0.000000e+00, double 0x40B9E8E14003254E}
...
!113 = !{double 3.200000e+01, double 3.200000e+01}
...
!119 = !{double 0.000000e+00, double 0x40BF1774B336F990}
!120 = distinct !{!120, !29}
!121 = !{i1 false, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 4.500000e+01}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 1.350000e+03}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x40BF2EE14003254E}
!127 = distinct !{!127, !29}
!128 = distinct !{!128, !29}
!129 = distinct !{!129, !29}
...
!169 = !{double 0.000000e+00, double 9.600000e+02}
!170 = distinct !{!170, !29}
!171 = distinct !{!171, !29}
