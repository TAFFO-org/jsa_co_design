; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-4-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 4), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 4), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 4), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
for.body3:                                        ; preds = %for.cond1
  ...
  %0 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !107
  %mul = fmul float %0, %beta, !taffo.info !108, !taffo.initweight !105
...
for.body10:                                       ; preds = %for.cond8
  ...
  %1 = load float, float* %arrayidx12, align 4, !taffo.info !51, !taffo.initweight !107
  %mul13 = fmul float %1, %alpha, !taffo.info !111, !taffo.initweight !105
  ...
  %2 = load float, float* %arrayidx15, align 4, !taffo.info !114, !taffo.initweight !107
  ...
  %3 = load float, float* %arrayidx18, align 4, !taffo.info !54, !taffo.initweight !107
  ...
  %4 = load float, float* %arrayidx21, align 4, !taffo.info !120, !taffo.initweight !107
  %mul22 = fmul float %mul19, %4, !taffo.info !115, !taffo.initweight !106
  %add = fadd float %mul16, %mul22, !taffo.info !121, !taffo.initweight !107
  ...
  %5 = load float, float* %arrayidx24, align 4, !taffo.info !48, !taffo.initweight !107
  %add25 = fadd float %5, %add, !taffo.info !123, !taffo.initweight !125
  store float %add25, float* %arrayidx24, align 4, !taffo.info !67, !taffo.initweight !107
  br label %for.inc26

for.inc26:                                        ; preds = %for.body10
  %inc27 = add nsw i32 %j.1, 1, !taffo.info !92, !taffo.constinfo !21
  br label %for.cond8, !llvm.loop !126
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %n, i32 noundef %m, float* noundef %alpha, float* noundef %beta, [16 x float]* noundef %C, [10 x float]* noundef %A, [10 x float]* noundef %B) #0 !taffo.initweight !129 !taffo.funinfo !130 !taffo.sourceFunction !62 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !60, !taffo.initweight !82, !taffo.constinfo !131
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !65, !taffo.initweight !82, !taffo.constinfo !133
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %rem = srem i32 %add, %n, !taffo.info !147, !taffo.initweight !82
  %conv = sitofp i32 %rem to float, !taffo.info !149, !taffo.initweight !105
  %conv6 = sitofp i32 %n to float, !taffo.info !151
  %div = fdiv float %conv, %conv6, !taffo.info !152, !taffo.initweight !106
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.info !155, !taffo.initweight !66
  %arrayidx7 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !155, !taffo.initweight !66
  store float %div, float* %arrayidx7, align 4, !taffo.info !156, !taffo.initweight !68
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.info !143, !taffo.initweight !66
  %add9 = add nsw i32 %mul8, 2, !taffo.info !157, !taffo.initweight !68, !taffo.constinfo !21
  %rem10 = srem i32 %add9, %m, !taffo.info !159, !taffo.initweight !82
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !161, !taffo.initweight !105
  %conv12 = sitofp i32 %m to float, !taffo.info !162
  %div13 = fdiv float %conv11, %conv12, !taffo.info !163, !taffo.initweight !106
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %B, i32 %i.0, !taffo.info !165, !taffo.initweight !66
  %arrayidx15 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.info !165, !taffo.initweight !66
  store float %div13, float* %arrayidx15, align 4, !taffo.info !156, !taffo.initweight !68
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !166, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.info !169, !taffo.initweight !66, !taffo.constinfo !21
...
for.cond23:                                       ; preds = %for.inc35, %for.body22
  ...
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.info !171, !taffo.initweight !66
...
for.body26:                                       ; preds = %for.cond23
  ...
  %add28 = add nsw i32 %mul27, 3, !taffo.info !172, !taffo.initweight !68, !taffo.constinfo !21
  %rem29 = srem i32 %add28, %n, !taffo.info !147, !taffo.initweight !82
  %conv30 = sitofp i32 %rem29 to float, !taffo.info !149, !taffo.initweight !105
  %conv31 = sitofp i32 %m to float, !taffo.info !162
  %div32 = fdiv float %conv30, %conv31, !taffo.info !174, !taffo.initweight !106
  %arrayidx33 = getelementptr inbounds [16 x float], [16 x float]* %C, i32 %i.1, !taffo.info !176, !taffo.initweight !66
  %arrayidx34 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx33, i32 0, i32 %j.1, !taffo.info !176, !taffo.initweight !66
  store float %div32, float* %arrayidx34, align 4, !taffo.info !156, !taffo.initweight !68
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.info !166, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.info !169, !taffo.initweight !66, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !179 !taffo.funinfo !180 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !48, !taffo.initweight !107
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !181, !taffo.initweight !125
  %conv = sitofp i32 %factor to float, !taffo.info !183
  %mul = fmul float %1, %conv, !taffo.info !184, !taffo.initweight !186
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !48, !taffo.initweight !107
  store float %mul, float* %arrayidx6, align 4, !taffo.info !67, !taffo.initweight !125
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !179 !taffo.funinfo !189 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !51, !taffo.initweight !107
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !190, !taffo.initweight !125
  %conv = sitofp i32 %factor to float, !taffo.info !191
  %mul = fmul float %1, %conv, !taffo.info !192, !taffo.initweight !186
  %2 = mul nsw i32 %i.0, %m, !taffo.info !94
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.info !51, !taffo.initweight !106
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !51, !taffo.initweight !107
  store float %mul, float* %arrayidx6, align 4, !taffo.info !71, !taffo.initweight !125
  br label %for.inc
...
!109 = !{double 0.000000e+00, double 0x40632937329C347F}
!110 = distinct !{!110, !23}
!111 = !{!112, !113, i1 false, i2 -1}
!112 = !{!"fixp", i32 32, i32 27}
!113 = !{double 0.000000e+00, double 5.625000e+00}
!114 = !{!112, !55, i1 false, i2 -1}
!115 = !{!116, !117, i1 false, i2 -1}
!116 = !{!"fixp", i32 32, i32 26}
!117 = !{double 0.000000e+00, double 2.025000e+01}
!118 = !{!112, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 5.400000e+00}
!120 = !{!112, !53, i1 false, i2 -1}
!121 = !{!49, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 4.050000e+01}
!123 = !{!49, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x406507ADFF822BBF}
!125 = !{i32 8}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!130 = !{i32 1, !90, i32 1, !16, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!131 = !{!132, i1 false}
...
!161 = !{!150, !160, i1 false, i2 1}
!162 = !{!150, !17, i1 false, i2 1}
!163 = !{!153, !164, i1 false, i2 1}
!164 = !{double 0.000000e+00, double 9.000000e-01}
!165 = !{!52, !55, i1 false, i2 1}
!166 = !{i1 false, !167, i1 false, i2 1}
!167 = !{double 1.000000e+00, double 1.100000e+01}
!168 = distinct !{!168, !23}
!169 = !{i1 false, !87, i1 false, i2 1}
!170 = distinct !{!170, !23}
!171 = !{i1 false, !93, i1 false, i2 1}
!172 = !{i1 false, !173, i1 false, i2 1}
!173 = !{double 3.000000e+00, double 1.630000e+02}
!174 = !{!150, !175, i1 false, i2 1}
!175 = !{double 0.000000e+00, double 1.500000e+00}
!176 = !{!49, !1, i1 false, i2 1}
!177 = distinct !{!177, !23}
!178 = distinct !{!178, !23}
!179 = !{i32 -1, i32 -1, i32 3, i32 -1}
!180 = !{i32 1, !90, i32 1, !90, i32 1, !48, i32 1, !101}
!181 = !{!182, !1, i1 false, i2 -1}
!182 = !{!"fixp", i32 32, i32 23}
!183 = !{!52, !102, i1 false, i2 1}
!184 = !{!182, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 0x407FEF5BFF04577E}
!186 = !{i32 9}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
!189 = !{i32 1, !90, i32 1, !16, i32 1, !51, i32 1, !101}
!190 = !{!150, !53, i1 false, i2 -1}
!191 = !{!150, !102, i1 false, i2 1}
!192 = !{!150, !148, i1 false, i2 -1}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
