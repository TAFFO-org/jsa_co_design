; ModuleID = './build/bin/fixed/3mm/24/3mm-standard-64-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,443.733368) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,10.666667) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,11.2) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,524.288025) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,11.733334) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,11.52) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [47 x i8] c"target('G') scalar(range(0.0,910723.25) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 6, i32 noundef 8, float* noundef %0, i32 noundef 64), !taffo.initweight !66, !taffo.info !48, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.4(i32 noundef 6, i32 noundef 10, float* noundef %1, i32 noundef 64), !taffo.initweight !66, !taffo.info !50, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 8, float* noundef %2, i32 noundef 64), !taffo.initweight !66, !taffo.info !52, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %3, i32 noundef 64), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.7(i32 noundef 8, i32 noundef 14, float* noundef %4, i32 noundef 64), !taffo.initweight !66, !taffo.info !56, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.8(i32 noundef 14, i32 noundef 12, float* noundef %5, i32 noundef 64), !taffo.initweight !66, !taffo.info !58, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 6, i32 noundef 12, float* noundef %6, i32 noundef 64), !taffo.initweight !66, !taffo.info !60, !taffo.target !61, !taffo.originalCall !67, !taffo.constinfo !68
...
!7 = !{double 0.000000e+00, double 0x412BCB0680000000}
...
!49 = !{double 0.000000e+00, double 0x407BBBBBE0157EED}
!50 = !{i1 false, !51, i1 false, i2 -1}
!51 = !{double 0.000000e+00, double 0x402555556084A516}
!52 = !{i1 false, !53, i1 false, i2 -1}
!53 = !{double 0.000000e+00, double 1.120000e+01}
!54 = !{i1 false, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x4080624DE00D1B71}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 0x402777778DD616F8}
!58 = !{i1 false, !59, i1 false, i2 -1}
!59 = !{double 0.000000e+00, double 1.152000e+01}
...
!139 = !{double 0.000000e+00, double 0x405DDDDDED8680B8}
!140 = !{i1 false, !141, i1 false, i2 -1}
!141 = !{double 0.000000e+00, double 0x40819999ADBB8F8E}
!142 = distinct !{!142, !29}
!143 = distinct !{!143, !29}
!144 = distinct !{!144, !29}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0.000000e+00, double 0x4060E56051A46275}
!147 = !{i1 false, !148, i1 false, i2 -1}
!148 = !{double 0.000000e+00, double 0x40849BA5F476340E}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = distinct !{!151, !29}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 0x410C6620BAA52758}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x413172475754A4EB}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
...
!230 = !{double 6.400000e+01, double 6.400000e+01}
!231 = !{i32 9}
