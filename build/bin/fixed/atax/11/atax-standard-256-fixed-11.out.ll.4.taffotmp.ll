; ModuleID = './build/bin/fixed/atax/11/atax-standard-256-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 256), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.info !46, !taffo.initweight !56
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 256), !taffo.info !67, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 256), !taffo.info !70, !taffo.initweight !61, !taffo.constinfo !68, !taffo.target !51, !taffo.originalCall !69
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !56
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 256), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
...
for.body15:                                       ; preds = %for.cond12
  ...
  %div19 = fdiv float %conv17, %conv18, !taffo.info !162, !taffo.initweight !94
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !42, !taffo.initweight !170
  %conv = sitofp i32 %factor to float, !taffo.info !96
  %mul = fmul float %1, %conv, !taffo.info !171, !taffo.initweight !174
...
!48 = !{double 2.560000e+02, double 0x407F45D17F84449E}
!49 = !{!50, !1, i1 false, i2 -1}
!50 = !{!"fixp", i32 32, i32 5}
!51 = !{!"y"}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 14}
!54 = !{double 0.000000e+00, double 0x410E851EC0000000}
...
!99 = !{double 6.553600e+04, double 0x40FF45D17F84449E}
!100 = !{i32 7}
!101 = distinct !{!101, !23}
!102 = !{i32 1, !83, i32 1, !49, i32 1, !92}
!103 = !{!104, !105, i1 false, i2 -1}
!104 = !{!"float", i32 1, double 0x421EC418A0000000}
!105 = !{double 0.000000e+00, double 0x421EC418A0000000}
!106 = distinct !{!106, !23}
...
!117 = !{!"fixp", i32 32, i32 17}
!118 = !{double 0.000000e+00, double 0x40DA44E31D4730CF}
!119 = !{!115, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x4110E6DD91D4730D}
!121 = distinct !{!121, !23}
!122 = !{!123, !1, i1 false, i2 -1}
!123 = !{!"fixp", i32 32, i32 4}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 32, i32 8}
!126 = !{double 0.000000e+00, double 0x4169A3054999465F}
!127 = !{!123, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x41A0FC3CA4999466}
!129 = distinct !{!129, !23}
!130 = distinct !{!130, !23}
!131 = !{i32 1, !109, i32 1, !52, i32 1, !92}
!132 = !{!133, !134, i1 false, i2 -1}
!133 = !{!"fixp", i32 32, i32 6}
!134 = !{double 0.000000e+00, double 0x418E851EC0000000}
!135 = distinct !{!135, !23}
...
!169 = !{i32 1, !109, i32 1, !83, i32 1, !42, i32 1, !92}
!170 = !{i32 8}
!171 = !{!172, !173, i1 false, i2 -1}
!172 = !{!"fixp", i32 32, i32 18}
!173 = !{double 0.000000e+00, double 0x40CAE1479D4D8341}
!174 = !{i32 9}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
