; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-128-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [51 x i8] c"target('C') scalar(range(0.0,126996.476562) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 128), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 128), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 128), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x40FF01479FFF79C8}
...
!119 = !{double 1.280000e+02, double 1.280000e+02}
...
!125 = !{double 0.000000e+00, double 0x41029A5E2CCC7C45}
!126 = distinct !{!126, !29}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 1.800000e+02}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x40D43FFFF727136A}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 0x406599999029AE4F}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0.000000e+00, double 0x40E43FFFF727136A}
!135 = !{i32 8}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x410490A3CDC981BE}
!138 = distinct !{!138, !29}
!139 = distinct !{!139, !29}
!140 = distinct !{!140, !29}
...
!179 = !{double 0.000000e+00, double 0x416F01479FFF79C8}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
...
!189 = !{double 0.000000e+00, double 0x40CCCCCCC0379314}
!190 = distinct !{!190, !29}
!191 = distinct !{!191, !29}
