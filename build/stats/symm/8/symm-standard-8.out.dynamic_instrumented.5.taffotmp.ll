; ModuleID = './build/stats/symm/8/symm-standard-8.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.2(float* noundef %alpha, i32 noundef 8), !taffo.originalCall !28
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 8), !taffo.originalCall !28
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 8), !taffo.originalCall !29
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 8), !taffo.originalCall !29
  ...
  call void @scale_2d.3(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 8), !taffo.originalCall !29
