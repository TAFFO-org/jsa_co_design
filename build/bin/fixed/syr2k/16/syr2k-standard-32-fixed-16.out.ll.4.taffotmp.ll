; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-32-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.info !60, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 32), !taffo.info !65, !taffo.initweight !57, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_2d.5(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 32), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 10, float* noundef %2, i32 noundef 32), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
for.body5:                                        ; preds = %for.cond3
  ...
  %div = fdiv float %conv, %conv6, !taffo.info !152, !taffo.initweight !105
  ...
  %rem10 = srem i32 %add9, %m, !taffo.info !159, !taffo.initweight !81
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !161, !taffo.initweight !104
  %conv12 = sitofp i32 %m to float, !taffo.info !162
  %div13 = fdiv float %conv11, %conv12, !taffo.info !163, !taffo.initweight !105
...
for.body26:                                       ; preds = %for.cond23
  ...
  %div32 = fdiv float %conv30, %conv31, !taffo.info !174, !taffo.initweight !105
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !181
  %mul = fmul float %1, %conv, !taffo.info !182, !taffo.initweight !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !179 !taffo.funinfo !188 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !181
  %mul = fmul float %1, %conv, !taffo.info !189, !taffo.initweight !185
  %2 = mul nsw i32 %i.0, %m, !taffo.info !93
...
!53 = !{double 0.000000e+00, double 3.000000e+01}
...
!101 = !{double 3.200000e+01, double 3.200000e+01}
...
!110 = !{double 0.000000e+00, double 0x40C2A8310CCD6DDC}
!111 = distinct !{!111, !23}
!112 = !{!113, !53, i1 false, i2 -1}
!113 = !{!"fixp", i32 32, i32 26}
!114 = !{!113, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 4.500000e+01}
!116 = !{!117, !118, i1 false, i2 -1}
!117 = !{!"fixp", i32 32, i32 20}
!118 = !{double 0.000000e+00, double 0x40943FFFF43419E3}
!119 = !{!113, !55, i1 false, i2 -1}
!120 = !{!113, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x404599998D045FE1}
!122 = !{!107, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x40A43FFFF43419E3}
!124 = !{!107, !125, i1 false, i2 -1}
!125 = !{double 0.000000e+00, double 0x40C49C28DD0D8CB0}
!126 = !{i32 8}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = distinct !{!129, !23}
...
!168 = distinct !{!168, !23}
!169 = !{i1 false, !86, i1 false, i2 1}
!170 = distinct !{!170, !23}
!171 = !{i1 false, !92, i1 false, i2 1}
...
!180 = !{i32 1, !89, i32 1, !89, i32 1, !48, i32 1, !100}
!181 = !{!113, !101, i1 false, i2 1}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 32, i32 14}
!184 = !{double 0.000000e+00, double 0x410F1851C0010C6F}
!185 = !{i32 9}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
!188 = !{i32 1, !89, i32 1, !16, i32 1, !51, i32 1, !100}
