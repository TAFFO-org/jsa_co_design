; ModuleID = './build/bin/fixed/jacobi-2d/16/jacobi-2d-standard-16-fixed-16.out.ll.1.taffotmp.ll'
...
@.str = private unnamed_addr constant [53 x i8] c"target('A') scalar(range(2.133333,241.066666) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [36 x i8] c"scalar(range(3.2,257.066681) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 16), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 16), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x40011110E453D20F, double 0x406E222220BC382A}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 3.200000e+00, double 0x407011112018A43C}
!34 = !{i32 1}
!35 = !{i32 2}
