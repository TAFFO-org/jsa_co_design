; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-512-fixed-11.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul.u18_14fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u18_14fixp, 9, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u21_11fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !189 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !190
...
!183 = !{!"fixp", i32 -32, i32 13}
!184 = !{double 0.000000e+00, double 2.457600e+05}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 14}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
!189 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
!190 = !{!191, !192, i1 false, i2 -1}
!191 = !{!"float", i32 1, double 0x41C901EB80000000}
!192 = !{double 0.000000e+00, double 0x41C901EB80000000}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
