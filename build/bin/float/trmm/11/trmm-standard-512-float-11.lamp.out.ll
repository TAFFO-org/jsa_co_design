; ModuleID = './build/bin/float/trmm/11/trmm-standard-512-float-11.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, ptr noundef %arraydecay2, i32 noundef 512)
