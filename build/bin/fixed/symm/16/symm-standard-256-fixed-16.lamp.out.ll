; ModuleID = './build/bin/fixed/symm/16/symm-standard-256-fixed-16.out.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !176
  ...
  %6 = fmul float 1.024000e+03, %lampsim15, !taffo.info !176
  %lampsim16 = bitcast float %6 to i32
  %lampsim17 = and i32 %lampsim16, -256
  %lampsim18 = bitcast i32 %lampsim17 to float
  %7 = fptoui float %lampsim18 to i32, !taffo.info !176
