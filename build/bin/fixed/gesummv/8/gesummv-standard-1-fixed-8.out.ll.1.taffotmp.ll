...
entry:
  ...
  call void @llvm.var.annotation(i8* %A3, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 117, i8* null)
  %B4 = bitcast [16 x [16 x float]]* %B to i8*
  call void @llvm.var.annotation(i8* %B4, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 118, i8* null)
  ...
  call void @llvm.var.annotation(i8* %x6, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32 120, i8* null)
  ...
  call void @kernel_gesummv(i32 noundef %1, float noundef %2, float noundef %3, [16 x float]* noundef %arraydecay12, [16 x float]* noundef %arraydecay13, float* noundef %arraydecay14, float* noundef %arraydecay15, float* noundef %arraydecay16)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [16 x float], [16 x float]* %y, i32 0, i32 %6
