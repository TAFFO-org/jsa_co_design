...
@.str = private unnamed_addr constant [37 x i8] c"scalar(range(0.1,2092.159912) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [19 x i8] c"./sources/ludcmp.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [39 x i8] c"scalar(range(256.0,2092.159912) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [40 x i8] c"scalar(range(1030.400024,1152.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [52 x i8] c"target('x') scalar(range(-0.037947,3.998521) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,1030.400024) final)\00", section "llvm.metadata"
