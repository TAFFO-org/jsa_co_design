; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-1024-fixed-11.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u18_14fixp, 10, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !133 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 14), !taffo.info !134
  %mul.u17_15fixp = shl i32 %4, 1, !taffo.info !137
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u17_15fixp, 10, !taffo.info !137
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !147 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !148
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !149
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !125
  %0 = uitofp i32 %conv.u11_21fixp to float, !taffo.info !125
  %lampsim = bitcast float %0 to i32
  %lampsim1 = and i32 %lampsim, -8192
  %lampsim2 = bitcast i32 %lampsim1 to float
  %1 = fdiv float %lampsim2, 0x4140000000000000, !taffo.info !125
  %lampsim3 = bitcast float %1 to i32
  %lampsim4 = and i32 %lampsim3, -8192
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !150
  %lampsim7 = bitcast float %mul.1flp6 to i32
  %lampsim8 = and i32 %lampsim7, -8192
  %lampsim9 = bitcast i32 %lampsim8 to float
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !154 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 12), !taffo.info !155
  %mul.u19_13fixp = shl i32 %4, 1, !taffo.info !158
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !57
  %5 = shl i32 %mul.u19_13fixp, 10, !taffo.info !158
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u29_3fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !160 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim7 = and i32 %lampsim6, -8192
  %lampsim8 = bitcast i32 %lampsim7 to float
  %3 = fdiv float %lampsim8, 0x4140000000000000, !taffo.info !125
  %lampsim9 = bitcast float %3 to i32
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  ...
  %4 = fmul float 8.000000e+00, %lampsim15, !taffo.info !161
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !148
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !149
  ...
  %lampsim18 = and i32 %lampsim17, -8192
  %lampsim19 = bitcast i32 %lampsim18 to float
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !148
...
!129 = !{double 0x40C11111276FB092, double 0x410555556084A516}
!130 = !{!131, !129, i1 false, i2 -1}
!131 = !{!"fixp", i32 32, i32 14}
!132 = distinct !{!132, !27}
!133 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!134 = !{!135, !136, i1 false, i2 -1}
!135 = !{!"fixp", i32 -32, i32 14}
!136 = !{double 0x40B6C16C1E364BEC, double 0x40FC71C7219220FF}
!137 = !{!138, !136, i1 false, i2 -1}
!138 = !{!"fixp", i32 32, i32 15}
!139 = distinct !{!139, !27}
...
!146 = distinct !{!146, !27}
!147 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!148 = !{i32 5}
!149 = !{i32 6}
!150 = !{!151, !152, i1 false, i2 -1}
!151 = !{!"float", i32 1, double 0x43B2D0EAC0000000}
!152 = !{double 0.000000e+00, double 0x43B2D0EAC0000000}
!153 = distinct !{!153, !27}
!154 = !{i32 1, !107, i32 1, !57, i32 1, !119}
!155 = !{!156, !157, i1 false, i2 -1}
!156 = !{!"fixp", i32 -32, i32 12}
!157 = !{double 1.310720e+04, double 2.621440e+05}
!158 = !{!53, !157, i1 false, i2 -1}
!159 = distinct !{!159, !27}
!160 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!161 = !{!162, !163, i1 false, i2 -1}
!162 = !{!"float", i32 1, double 0x4255BC5260000000}
!163 = !{double 0.000000e+00, double 0x4255BC5260000000}
!164 = distinct !{!164, !27}
