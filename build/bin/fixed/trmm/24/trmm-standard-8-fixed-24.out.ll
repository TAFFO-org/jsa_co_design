; ModuleID = './build/bin/fixed/trmm/24/trmm-standard-8-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %A.u4_28fixp = alloca [10 x [10 x i32]], align 4, !taffo.info !45
  %B.u9_23fixp = alloca [10 x [16 x i32]], align 4, !taffo.info !48, !taffo.target !50
  %arraydecay.u4_28fixp = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %A.u4_28fixp, i32 0, i32 0, !taffo.info !45
  %arraydecay4.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !48, !taffo.target !50
  call void @init_array.3_fixp(i32 10, i32 16, i32* %alpha.u2_30fixp, [10 x i32]* %arraydecay.u4_28fixp, [16 x i32]* %arraydecay4.u9_23fixp), !taffo.info !51, !taffo.constinfo !52
  call void @scale_scalar.1_fixp(i32* %alpha.u2_30fixp, i32 8), !taffo.info !51, !taffo.constinfo !53
  %arraydecay5.u4_28fixp = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %A.u4_28fixp, i32 0, i32 0, !taffo.info !45
  %u4_28fixp = bitcast [10 x i32]* %arraydecay5.u4_28fixp to i32*, !taffo.info !45
  call void @scale_2d.4_fixp(i32 10, i32 10, i32* %u4_28fixp, i32 8), !taffo.info !54, !taffo.constinfo !55
  %arraydecay6.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !48, !taffo.target !50
  %u9_23fixp = bitcast [16 x i32]* %arraydecay6.u9_23fixp to i32*, !taffo.info !48, !taffo.target !50
  call void @scale_2d.5_fixp(i32 10, i32 16, i32* %u9_23fixp, i32 8), !taffo.info !56, !taffo.constinfo !55, !taffo.target !50
  call void @timer_start(), !taffo.constinfo !57
  %u2_30fixp = load i32, i32* %alpha.u2_30fixp, align 4, !taffo.info !42
  %arraydecay7.u4_28fixp = getelementptr inbounds [10 x [10 x i32]], [10 x [10 x i32]]* %A.u4_28fixp, i32 0, i32 0, !taffo.info !45
  %arraydecay8.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u9_23fixp, i32 0, i32 0, !taffo.info !48, !taffo.target !50
  call void @kernel_trmm.2_fixp(i32 10, i32 16, i32 %u2_30fixp, [10 x i32]* %arraydecay7.u4_28fixp, [16 x i32]* %arraydecay8.u9_23fixp), !taffo.info !51, !taffo.constinfo !52
...
for.body11:                                       ; preds = %for.cond9
  %arrayidx.u9_23fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %B.u9_23fixp, i32 0, i32 %i.0, !taffo.info !48, !taffo.target !50
  %arrayidx12.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx.u9_23fixp, i32 0, i32 %j.0, !taffo.info !48, !taffo.target !50
  %u9_23fixp1 = load i32, i32* %arrayidx12.u9_23fixp, align 4, !taffo.info !48, !taffo.target !50
  %0 = uitofp i32 %u9_23fixp1 to float, !taffo.info !48, !taffo.target !50
  %1 = fdiv float %0, 0x4160000000000000, !taffo.info !48, !taffo.target !50
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_trmm.2_fixp(i32 noundef %m, i32 noundef %n, i32 noundef %alpha.u2_30fixp, [10 x i32]* noundef %A.u4_28fixp, [16 x i32]* noundef %B.u9_23fixp) #0 !taffo.initweight !85 !taffo.funinfo !86 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body6:                                        ; preds = %for.cond4
  %arrayidx.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u4_28fixp, i32 %k.0, !taffo.info !45
  %arrayidx7.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u4_28fixp, i32 0, i32 %i.0, !taffo.info !45
  %u4_28fixp = load i32, i32* %arrayidx7.u4_28fixp, align 4, !taffo.info !45
  %arrayidx8.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u9_23fixp, i32 %k.0, !taffo.info !48
  %arrayidx9.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx8.u9_23fixp, i32 0, i32 %j.0, !taffo.info !48
  %u9_23fixp = load i32, i32* %arrayidx9.u9_23fixp, align 4, !taffo.info !48
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !45
  %1 = lshr i32 %u9_23fixp, 1, !taffo.info !48
  %2 = ashr i32 %0, 8, !taffo.info !45
  %3 = ashr i32 %1, 3, !taffo.info !48
  ...
  %u9_23fixp1 = load i32, i32* %arrayidx11.u9_23fixp, align 4, !taffo.info !48
  %5 = lshr i32 %u9_23fixp1, 3, !taffo.info !48
  %add12.u12_20fixp = add i32 %5, %mul.u12_20fixp, !taffo.info !95
  %6 = shl i32 %add12.u12_20fixp, 3, !taffo.info !95
  store i32 %6, i32* %arrayidx11.u9_23fixp, align 4, !taffo.info !56
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  %arrayidx13.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u9_23fixp, i32 %i.0, !taffo.info !48
  %arrayidx14.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx13.u9_23fixp, i32 0, i32 %j.0, !taffo.info !48
  %u9_23fixp2 = load i32, i32* %arrayidx14.u9_23fixp, align 4, !taffo.info !48
  %7 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %8 = lshr i32 %u9_23fixp2, 1, !taffo.info !48
  %9 = ashr i32 %7, 7, !taffo.info !42
  %10 = call i32 @llvm.smul.fix.i32(i32 %9, i32 %8, i32 22), !taffo.info !98
  %mul15.u9_23fixp = shl i32 %10, 1, !taffo.info !101
  %arrayidx16.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u9_23fixp, i32 %i.0, !taffo.info !48
  %arrayidx17.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx16.u9_23fixp, i32 0, i32 %j.0, !taffo.info !48
  store i32 %mul15.u9_23fixp, i32* %arrayidx17.u9_23fixp, align 4, !taffo.info !51
  br label %for.inc18
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.3_fixp(i32 noundef %m, i32 noundef %n, i32* noundef %alpha.u2_30fixp, [10 x i32]* noundef %A.u4_28fixp, [16 x i32]* noundef %B.u9_23fixp) #0 !taffo.initweight !104 !taffo.funinfo !86 !taffo.sourceFunction !105 {
entry:
...
if.then:                                          ; preds = %for.body5
  ...
  %arrayidx.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u4_28fixp, i32 %i.0, !taffo.info !129
  %arrayidx8.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u4_28fixp, i32 0, i32 %j.0, !taffo.info !129
  %3 = lshr i32 %div.u1_31fixp, 3, !taffo.info !127
  store i32 %3, i32* %arrayidx8.u4_28fixp, align 4, !taffo.info !130
  br label %if.end

if.else:                                          ; preds = %for.body5
  %arrayidx9.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u4_28fixp, i32 %i.0, !taffo.info !129
  %arrayidx10.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx9.u4_28fixp, i32 0, i32 %j.0, !taffo.info !129
  store i32 0, i32* %arrayidx10.u4_28fixp, align 4, !taffo.info !130, !taffo.constinfo !131
  br label %if.end
...
for.end:                                          ; preds = %for.cond3
  %arrayidx11.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u4_28fixp, i32 %i.0, !taffo.info !129
  %arrayidx12.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx11.u4_28fixp, i32 0, i32 %i.0, !taffo.info !129
  store i32 268435456, i32* %arrayidx12.u4_28fixp, align 4, !taffo.info !130, !taffo.constinfo !135
  br label %for.cond13
...
for.body16:                                       ; preds = %for.cond13
  %sub = sub nsw i32 %i.0, %j.1, !taffo.info !136, !taffo.initweight !111
  ...
  %arrayidx22.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u9_23fixp, i32 %i.0, !taffo.info !148
  %arrayidx23.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx22.u9_23fixp, i32 0, i32 %j.1, !taffo.info !148
  %8 = lshr i32 %div21.u1_31fixp, 8, !taffo.info !147
  store i32 %8, i32* %arrayidx23.u9_23fixp, align 4, !taffo.info !130
  br label %for.inc24

for.inc24:                                        ; preds = %for.body16
  %inc25 = add nsw i32 %j.1, 1, !taffo.info !132, !taffo.initweight !111, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !152 !taffo.funinfo !153 !taffo.sourceFunction !154 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %0, !taffo.info !45
  %arrayidx4.u4_28fixp = getelementptr inbounds i32, i32* %arrayidx.u4_28fixp, i32 %j.0, !taffo.info !45
  %u4_28fixp = load i32, i32* %arrayidx4.u4_28fixp, align 4, !taffo.info !45
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !155
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !45
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !155
  %3 = ashr i32 %1, 3, !taffo.info !45
  %4 = ashr i32 %2, 3, !taffo.info !155
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 24), !taffo.info !156
  %mul.u7_25fixp = shl i32 %5, 1, !taffo.info !159
  %6 = mul nsw i32 %i.0, %m, !taffo.info !76
  %arrayidx5.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %6, !taffo.info !45
  %arrayidx6.u4_28fixp = getelementptr inbounds i32, i32* %arrayidx5.u4_28fixp, i32 %j.0, !taffo.info !45
  %7 = shl i32 %mul.u7_25fixp, 3, !taffo.info !159
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !152 !taffo.funinfo !163 !taffo.sourceFunction !154 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = shl i32 %mul.u12_20fixp, 3, !taffo.info !93
  store i32 %7, i32* %arrayidx6.u9_23fixp, align 4, !taffo.info !56
  br label %for.inc
...
!47 = !{double 0.000000e+00, double 8.000000e+00}
...
!92 = !{double 0.000000e+00, double 2.700000e+03}
!93 = !{!94, !92, i1 false, i2 -1}
!94 = !{!"fixp", i32 32, i32 20}
!95 = !{!94, !96, i1 false, i2 -1}
!96 = !{double 0.000000e+00, double 3.037500e+03}
!97 = distinct !{!97, !23}
!98 = !{!99, !100, i1 false, i2 -1}
!99 = !{!"fixp", i32 -32, i32 22}
!100 = !{double 0.000000e+00, double 5.062500e+02}
...
!122 = !{!46, !121, i1 false, i2 1}
!123 = !{!46, !17, i1 false, i2 1}
