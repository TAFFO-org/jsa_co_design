; ModuleID = './build/bin/fixed/jacobi-1d/24/jacobi-1d-standard-256-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 256), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 256), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
!47 = !{double 0x40499999A1FD156A, double 0x407222221FAFC8B0}
...
!85 = !{double 0x40C111111F0C34C2, double 0x40F111112018A43C}
!86 = !{i32 7}
!87 = distinct !{!87, !23}
...
!97 = !{double 0x405111111F0C34C2, double 0x408111112018A43C}
!98 = !{!95, !99, i1 false, i2 -1}
!99 = !{double 0x40599999AE924F23, double 0x40899999B024F65A}
!100 = !{i32 8}
!101 = !{!95, !102, i1 false, i2 -1}
!102 = !{double 0x40411105EFBC6B1F, double 0x40711105F0C8D9E9}
!103 = !{i32 9}
!104 = !{!105, i1 false}
!105 = !{i1 false, !106, i1 false, i2 0}
!106 = !{double 3.333300e-01, double 3.333300e-01}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x40411105E0000000, double 0x4071110600000000}
!109 = !{i32 10}
!110 = distinct !{!110, !23}
!111 = !{!95, !47, i1 false, i2 -1}
!112 = !{!95, !113, i1 false, i2 -1}
!113 = !{double 0x40599999A1FD156A, double 0x408222221FAFC8B0}
!114 = !{!95, !115, i1 false, i2 -1}
!115 = !{double 0x40633333397DD010, double 0x408B33332F87AD08}
!116 = !{!95, !117, i1 false, i2 -1}
!117 = !{double 0x40499988DB056F36, double 0x407222163D6B0DCA}
!118 = !{!42, !119, i1 false, i2 -1}
!119 = !{double 0x40499988C0000000, double 0x4072221640000000}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
