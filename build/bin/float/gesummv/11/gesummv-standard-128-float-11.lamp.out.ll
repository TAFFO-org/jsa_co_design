; ModuleID = './build/bin/float/gesummv/11/gesummv-standard-128-float-11.out.ll'
...
@.str.3 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,120.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [33 x i8] c"scalar(range(0.0,72192.0) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [49 x i8] c"target('y') scalar(range(0.0,185548.8125) final)\00", section "llvm.metadata"
...
entry:
  ...
  %B = alloca [16 x [16 x float]], align 4
  %tmp = alloca [16 x float], align 4
  %x = alloca [16 x float], align 4
  %y = alloca [16 x float], align 4
  %i = alloca i32, align 4
  ...
  call void @llvm.var.annotation(ptr %beta, ptr @.str.2, ptr @.str.1, i32 116, ptr null)
  call void @llvm.var.annotation(ptr %A, ptr @.str.3, ptr @.str.1, i32 117, ptr null)
  call void @llvm.var.annotation(ptr %B, ptr @.str.3, ptr @.str.1, i32 118, ptr null)
  call void @llvm.var.annotation(ptr %tmp, ptr @.str.4, ptr @.str.1, i32 119, ptr null)
  call void @llvm.var.annotation(ptr %x, ptr @.str.3, ptr @.str.1, i32 120, ptr null)
  call void @llvm.var.annotation(ptr %y, ptr @.str.5, ptr @.str.1, i32 121, ptr null)
  %0 = load i32, ptr %n, align 4
  %arraydecay = getelementptr inbounds [16 x [16 x float]], ptr %A, i32 0, i32 0
  %arraydecay1 = getelementptr inbounds [16 x [16 x float]], ptr %B, i32 0, i32 0
  %arraydecay2 = getelementptr inbounds [16 x float], ptr %x, i32 0, i32 0
  %arraydecay3 = getelementptr inbounds [16 x float], ptr %tmp, i32 0, i32 0
  %arraydecay4 = getelementptr inbounds [16 x float], ptr %y, i32 0, i32 0
  call void @init_array(i32 noundef %0, ptr noundef %alpha, ptr noundef %beta, ptr noundef %arraydecay, ptr noundef %arraydecay1, ptr noundef %arraydecay2, ptr noundef %arraydecay3, ptr noundef %arraydecay4)
  call void @scale_scalar(ptr noundef %alpha, i32 noundef 128)
  call void @scale_scalar(ptr noundef %beta, i32 noundef 128)
  %arraydecay5 = getelementptr inbounds [16 x [16 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay5, i32 noundef 128)
  %arraydecay6 = getelementptr inbounds [16 x [16 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay6, i32 noundef 128)
  %arraydecay7 = getelementptr inbounds [16 x float], ptr %tmp, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay7, i32 noundef 128)
  %arraydecay8 = getelementptr inbounds [16 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay8, i32 noundef 128)
  %arraydecay9 = getelementptr inbounds [16 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay9, i32 noundef 128)
  call void @timer_start()
  %1 = load i32, ptr %n, align 4
  %2 = load float, ptr %alpha, align 4
  %3 = load float, ptr %beta, align 4
  %arraydecay10 = getelementptr inbounds [16 x [16 x float]], ptr %A, i32 0, i32 0
  %arraydecay11 = getelementptr inbounds [16 x [16 x float]], ptr %B, i32 0, i32 0
  %arraydecay12 = getelementptr inbounds [16 x float], ptr %tmp, i32 0, i32 0
  %arraydecay13 = getelementptr inbounds [16 x float], ptr %x, i32 0, i32 0
  %arraydecay14 = getelementptr inbounds [16 x float], ptr %y, i32 0, i32 0
  call void @kernel_gesummv(i32 noundef %1, float noundef %2, float noundef %3, ptr noundef %arraydecay10, ptr noundef %arraydecay11, ptr noundef %arraydecay12, ptr noundef %arraydecay13, ptr noundef %arraydecay14)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [16 x float], ptr %y, i32 0, i32 %6
  %7 = load float, ptr %arrayidx, align 4
  %8 = load i32, ptr %i, align 4
  %arrayidx15 = getelementptr inbounds [16 x float], ptr @y_float, i32 0, i32 %8
...
for.end:                                          ; preds = %for.cond
  ...
  call void @print_array(i32 noundef %10, ptr noundef @y_float)
  ret i32 0
}
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array(i32 noundef %n, ptr noundef %alpha, ptr noundef %beta, ptr noundef %A, ptr noundef %B, ptr noundef %x, ptr noundef %tmp, ptr noundef %y) #0 {
entry:
  %n.addr = alloca i32, align 4
  ...
  call void @llvm.var.annotation(ptr %i, ptr @.str.6, ptr @.str.1, i32 39, ptr null)
  call void @llvm.var.annotation(ptr %j, ptr @.str.6, ptr @.str.1, i32 40, ptr null)
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = load ptr, ptr %x.addr, align 4
  %8 = load i32, ptr %i, align 4
  %arrayidx = getelementptr inbounds float, ptr %7, i32 %8
  store float %lampsim12, ptr %arrayidx, align 4
  %9 = load ptr, ptr %y.addr, align 4
  %10 = load i32, ptr %i, align 4
  %arrayidx2 = getelementptr inbounds float, ptr %9, i32 %10
...
for.body7:                                        ; preds = %for.cond4
  ...
  %rem8 = srem i32 %add, %17
  %conv913 = sitofp i32 %rem8 to float
  %lampsim14 = bitcast float %conv913 to i32
  %lampsim15 = and i32 %lampsim14, -8192
  %lampsim16 = bitcast i32 %lampsim15 to float
  %18 = load i32, ptr %n.addr, align 4
  %conv1017 = sitofp i32 %18 to float
  %lampsim18 = bitcast float %conv1017 to i32
  %lampsim19 = and i32 %lampsim18, -8192
  %lampsim20 = bitcast i32 %lampsim19 to float
  %div1121 = fdiv float %lampsim16, %lampsim20
  %lampsim22 = bitcast float %div1121 to i32
  %lampsim23 = and i32 %lampsim22, -8192
  %lampsim24 = bitcast i32 %lampsim23 to float
  %19 = load ptr, ptr %A.addr, align 4
  %20 = load i32, ptr %i, align 4
  %arrayidx12 = getelementptr inbounds [16 x float], ptr %19, i32 %20
  %21 = load i32, ptr %j, align 4
  %arrayidx13 = getelementptr inbounds [16 x float], ptr %arrayidx12, i32 0, i32 %21
  store float %lampsim24, ptr %arrayidx13, align 4
  %22 = load i32, ptr %i, align 4
  %23 = load i32, ptr %j, align 4
  %mul14 = mul nsw i32 %22, %23
  %add15 = add nsw i32 %mul14, 2
  %24 = load i32, ptr %n.addr, align 4
  %rem16 = srem i32 %add15, %24
  %conv1725 = sitofp i32 %rem16 to float
  %lampsim26 = bitcast float %conv1725 to i32
  %lampsim27 = and i32 %lampsim26, -8192
  %lampsim28 = bitcast i32 %lampsim27 to float
  %25 = load i32, ptr %n.addr, align 4
  %conv1829 = sitofp i32 %25 to float
  %lampsim30 = bitcast float %conv1829 to i32
  %lampsim31 = and i32 %lampsim30, -8192
  %lampsim32 = bitcast i32 %lampsim31 to float
  %div1933 = fdiv float %lampsim28, %lampsim32
  %lampsim34 = bitcast float %div1933 to i32
  %lampsim35 = and i32 %lampsim34, -8192
  %lampsim36 = bitcast i32 %lampsim35 to float
  %26 = load ptr, ptr %B.addr, align 4
  %27 = load i32, ptr %i, align 4
  %arrayidx20 = getelementptr inbounds [16 x float], ptr %26, i32 %27
  %28 = load i32, ptr %j, align 4
  %arrayidx21 = getelementptr inbounds [16 x float], ptr %arrayidx20, i32 0, i32 %28
  store float %lampsim36, ptr %arrayidx21, align 4
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv(i32 noundef %n, float noundef %alpha, float noundef %beta, ptr noundef %A, ptr noundef %B, ptr noundef %tmp, ptr noundef %x, ptr noundef %y) #0 {
entry:
  %n.addr = alloca i32, align 4
...
for.body4:                                        ; preds = %for.cond2
  ...
  %9 = load i32, ptr %i, align 4
  %arrayidx5 = getelementptr inbounds [16 x float], ptr %8, i32 %9
  %10 = load i32, ptr %j, align 4
  %arrayidx6 = getelementptr inbounds [16 x float], ptr %arrayidx5, i32 0, i32 %10
  %11 = load float, ptr %arrayidx6, align 4
  %12 = load ptr, ptr %x.addr, align 4
  %13 = load i32, ptr %j, align 4
  %arrayidx7 = getelementptr inbounds float, ptr %12, i32 %13
  %14 = load float, ptr %arrayidx7, align 4
  %mul1 = fmul float %11, %14
  %lampsim = bitcast float %mul1 to i32
  %lampsim2 = and i32 %lampsim, -8192
  %lampsim3 = bitcast i32 %lampsim2 to float
  %15 = load ptr, ptr %tmp.addr, align 4
  %16 = load i32, ptr %i, align 4
  %arrayidx8 = getelementptr inbounds float, ptr %15, i32 %16
  %17 = load float, ptr %arrayidx8, align 4
  %add4 = fadd float %lampsim3, %17
  %lampsim5 = bitcast float %add4 to i32
  %lampsim6 = and i32 %lampsim5, -8192
  %lampsim7 = bitcast i32 %lampsim6 to float
  %18 = load ptr, ptr %tmp.addr, align 4
  %19 = load i32, ptr %i, align 4
  %arrayidx9 = getelementptr inbounds float, ptr %18, i32 %19
  store float %lampsim7, ptr %arrayidx9, align 4
  %20 = load ptr, ptr %B.addr, align 4
  %21 = load i32, ptr %i, align 4
  %arrayidx10 = getelementptr inbounds [16 x float], ptr %20, i32 %21
  %22 = load i32, ptr %j, align 4
  %arrayidx11 = getelementptr inbounds [16 x float], ptr %arrayidx10, i32 0, i32 %22
  %23 = load float, ptr %arrayidx11, align 4
  %24 = load ptr, ptr %x.addr, align 4
  %25 = load i32, ptr %j, align 4
  %arrayidx12 = getelementptr inbounds float, ptr %24, i32 %25
  %26 = load float, ptr %arrayidx12, align 4
  %mul138 = fmul float %23, %26
  %lampsim9 = bitcast float %mul138 to i32
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %27 = load ptr, ptr %y.addr, align 4
  %28 = load i32, ptr %i, align 4
  %arrayidx14 = getelementptr inbounds float, ptr %27, i32 %28
  %29 = load float, ptr %arrayidx14, align 4
  %add1512 = fadd float %lampsim11, %29
  %lampsim13 = bitcast float %add1512 to i32
  %lampsim14 = and i32 %lampsim13, -8192
  %lampsim15 = bitcast i32 %lampsim14 to float
  %30 = load ptr, ptr %y.addr, align 4
  %31 = load i32, ptr %i, align 4
  %arrayidx16 = getelementptr inbounds float, ptr %30, i32 %31
  store float %lampsim15, ptr %arrayidx16, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond2
  %33 = load float, ptr %alpha.addr, align 4
  %34 = load ptr, ptr %tmp.addr, align 4
  %35 = load i32, ptr %i, align 4
  %arrayidx17 = getelementptr inbounds float, ptr %34, i32 %35
  %36 = load float, ptr %arrayidx17, align 4
  %mul1816 = fmul float %33, %36
  %lampsim17 = bitcast float %mul1816 to i32
  %lampsim18 = and i32 %lampsim17, -8192
  %lampsim19 = bitcast i32 %lampsim18 to float
  %37 = load float, ptr %beta.addr, align 4
  %38 = load ptr, ptr %y.addr, align 4
  %39 = load i32, ptr %i, align 4
  %arrayidx19 = getelementptr inbounds float, ptr %38, i32 %39
  %40 = load float, ptr %arrayidx19, align 4
  %mul2020 = fmul float %37, %40
  %lampsim21 = bitcast float %mul2020 to i32
  %lampsim22 = and i32 %lampsim21, -8192
  %lampsim23 = bitcast i32 %lampsim22 to float
  %add2124 = fadd float %lampsim19, %lampsim23
  %lampsim25 = bitcast float %add2124 to i32
  %lampsim26 = and i32 %lampsim25, -8192
  %lampsim27 = bitcast i32 %lampsim26 to float
  %41 = load ptr, ptr %y.addr, align 4
  %42 = load i32, ptr %i, align 4
  %arrayidx22 = getelementptr inbounds float, ptr %41, i32 %42
  store float %lampsim27, ptr %arrayidx22, align 4
  br label %for.inc23
