; ModuleID = './build/bin/fixed/bicg/16/bicg-standard-1024-fixed-16.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,977.454529) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/bicg.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [47 x i8] c"target('s') scalar(range(0.0,7173213.5) final)\00", section "llvm.metadata", !taffo.info !4
@.str.3 = private unnamed_addr constant [47 x i8] c"target('q') scalar(range(0.0,6339118.5) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !64, !taffo.constinfo !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 1024), !taffo.initweight !60, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 1024), !taffo.initweight !60, !taffo.info !55, !taffo.target !56, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.initweight !59, !taffo.info !57
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024), !taffo.initweight !60, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.initweight !59, !taffo.info !51
  call void @scale_1d.5(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 1024), !taffo.initweight !60, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x415B5D1760000000}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x41582E8BA0000000}
...
!52 = !{double 0.000000e+00, double 0x408E8BA2E019B0AB}
!53 = !{i1 false, !7, i1 false, i2 -1}
!54 = !{!"s"}
!55 = !{i1 false, !9, i1 false, i2 -1}
!56 = !{!"q"}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x408E6666601BC98A}
!59 = !{i32 1}
!60 = !{i32 2}
...
!119 = !{double 0.000000e+00, double 0x41FB5D1760000000}
!120 = distinct !{!120, !31}
!121 = !{i32 1, !105, i32 1, !55, i32 1, !114}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 0x41F82E8BA0000000}
!124 = distinct !{!124, !31}
!125 = !{i32 1, !103, i32 1, !57, i32 1, !114}
!126 = !{i1 false, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!128 = distinct !{!128, !31}
...
!133 = !{double 0.000000e+00, double 0x412D2832B6680D95}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x415F021DB6CD01B3}
!136 = !{i1 false, !137, i1 false, i2 -1}
!137 = !{double 0.000000e+00, double 0x412D04A7821700A8}
!138 = !{i1 false, !139, i1 false, i2 -1}
!139 = !{double 0.000000e+00, double 0x415BCF209042E015}
!140 = distinct !{!140, !31}
!141 = distinct !{!141, !31}
!142 = !{i32 1, !105, i32 1, !51, i32 1, !114}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0.000000e+00, double 0x412E8BA2E019B0AB}
!145 = distinct !{!145, !31}
