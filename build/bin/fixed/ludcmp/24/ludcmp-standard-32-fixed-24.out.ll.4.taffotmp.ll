; ModuleID = './build/bin/fixed/ludcmp/24/ludcmp-standard-32-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 32), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 32), !taffo.info !67, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i32 0, i32 0, !taffo.info !48, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 32), !taffo.info !68, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 32), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !69, !taffo.target !53, !taffo.originalCall !70
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !54, !taffo.initweight !57
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 32), !taffo.info !72, !taffo.initweight !61, !taffo.constinfo !69, !taffo.originalCall !70
...
for.body8:                                        ; preds = %for.cond6
  ...
  %mul = fmul float %1, %2, !taffo.info !114, !taffo.initweight !117
  %sub = fsub float %w.0, %mul, !taffo.info !118, !taffo.initweight !61
  br label %for.inc
...
for.end:                                          ; preds = %for.cond6
  ...
  %div = fdiv float %w.0, %3, !taffo.info !121, !taffo.initweight !61
  ...
  store float %div, float* %arrayidx16, align 4, !taffo.info !124, !taffo.initweight !64
  br label %for.inc17
...
for.body27:                                       ; preds = %for.cond25
  ...
  %mul32 = fmul float %5, %6, !taffo.info !114, !taffo.initweight !117
  %sub33 = fsub float %w.1, %mul32, !taffo.info !118, !taffo.initweight !61
  br label %for.inc34

for.inc34:                                        ; preds = %for.body27
  %inc35 = add nsw i32 %k.1, 1, !taffo.info !87, !taffo.constinfo !21
  br label %for.cond25, !llvm.loop !126
...
for.end36:                                        ; preds = %for.cond25
  ...
  store float %w.1, float* %arrayidx38, align 4, !taffo.info !124, !taffo.initweight !61
  br label %for.inc39

for.inc39:                                        ; preds = %for.end36
  %inc40 = add nsw i32 %j.1, 1, !taffo.info !87, !taffo.constinfo !21
  br label %for.cond20, !llvm.loop !127
...
for.body51:                                       ; preds = %for.cond49
  ...
  %mul55 = fmul float %8, %9, !taffo.info !129, !taffo.initweight !103
  %sub56 = fsub float %w.2, %mul55, !taffo.info !132, !taffo.initweight !61
  br label %for.inc57

for.inc57:                                        ; preds = %for.body51
  %inc58 = add nsw i32 %j.2, 1, !taffo.info !87, !taffo.constinfo !21
  br label %for.cond49, !llvm.loop !134

for.end59:                                        ; preds = %for.cond49
  %arrayidx60 = getelementptr inbounds float, float* %y, i32 %i.1, !taffo.info !54, !taffo.initweight !96
  store float %w.2, float* %arrayidx60, align 4, !taffo.info !124, !taffo.initweight !61
  br label %for.inc61

for.inc61:                                        ; preds = %for.end59
  %inc62 = add nsw i32 %i.1, 1, !taffo.info !87, !taffo.constinfo !21
  br label %for.cond45, !llvm.loop !135

for.end63:                                        ; preds = %for.cond45
  %sub64 = sub nsw i32 %n, 1, !taffo.info !136, !taffo.constinfo !21
  br label %for.cond65

for.cond65:                                       ; preds = %for.inc84, %for.end63
  %i.2 = phi i32 [ %sub64, %for.end63 ], [ %dec, %for.inc84 ], !taffo.info !138
...
for.cond69:                                       ; preds = %for.inc77, %for.body67
  %j.3 = phi i32 [ %add, %for.body67 ], [ %inc78, %for.inc77 ], !taffo.info !140
...
for.body71:                                       ; preds = %for.cond69
  ...
  %mul75 = fmul float %11, %12, !taffo.info !142, !taffo.initweight !103
  %sub76 = fsub float %w.3, %mul75, !taffo.info !144, !taffo.initweight !61
  br label %for.inc77

for.inc77:                                        ; preds = %for.body71
  %inc78 = add nsw i32 %j.3, 1, !taffo.info !146, !taffo.constinfo !21
...
for.end79:                                        ; preds = %for.cond69
  ...
  %div82 = fdiv float %w.3, %13, !taffo.info !121, !taffo.initweight !61
  %arrayidx83 = getelementptr inbounds float, float* %x, i32 %i.2, !taffo.info !51, !taffo.initweight !96
  store float %div82, float* %arrayidx83, align 4, !taffo.info !124, !taffo.initweight !64
  br label %for.inc84

for.inc84:                                        ; preds = %for.end79
  %dec = add nsw i32 %i.2, -1, !taffo.info !149, !taffo.constinfo !21
  br label %for.cond65, !llvm.loop !151
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.5(i32 noundef %n, [20 x float]* noundef %A, [20 x float]* noundef %B, float* noundef %b, float* noundef %x, float* noundef %y) #0 !taffo.initweight !152 !taffo.funinfo !153 !taffo.sourceFunction !63 {
entry:
  %conv = sitofp i32 %n to float, !taffo.info !154, !taffo.initweight !61
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %div8 = fdiv double %conv7, 2.000000e+00, !taffo.info !169, !taffo.initweight !172, !taffo.constinfo !173
  %add9 = fadd double %div8, 4.000000e+00, !taffo.info !174, !taffo.initweight !96, !taffo.constinfo !176
  %conv10 = fptrunc double %add9 to float, !taffo.info !179, !taffo.initweight !97
  %arrayidx11 = getelementptr inbounds float, float* %b, i32 %i.0, !taffo.info !181, !taffo.initweight !61
...
for.body19:                                       ; preds = %for.cond16
  %sub = sub nsw i32 0, %j.0, !taffo.info !183, !taffo.initweight !61, !taffo.constinfo !21
  %rem = srem i32 %sub, %n, !taffo.info !185, !taffo.initweight !64
  %conv20 = sitofp i32 %rem to float, !taffo.info !187, !taffo.initweight !172
  %conv21 = sitofp i32 %n to float, !taffo.info !154
...
for.end38:                                        ; preds = %for.cond30
  ...
  store float 1.000000e+00, float* %arrayidx40, align 4, !taffo.info !161, !taffo.initweight !64, !taffo.constinfo !202
  br label %for.inc41
...
for.body51:                                       ; preds = %for.cond48
  ...
  store float 0.000000e+00, float* %arrayidx53, align 4, !taffo.info !161, !taffo.initweight !96, !taffo.constinfo !162
  br label %for.inc54
...
for.body71:                                       ; preds = %for.cond68
  ...
  %mul = fmul float %0, %1, !taffo.info !206, !taffo.initweight !117
  ...
  %add78 = fadd float %2, %mul, !taffo.info !208, !taffo.initweight !117
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !42, !taffo.initweight !117
  %conv = sitofp i32 %factor to float, !taffo.info !98
  %mul = fmul float %1, %conv, !taffo.info !217, !taffo.initweight !220
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !60, !taffo.initweight !117
  br label %for.inc
...
!47 = !{double 3.200000e+01, double 0x40705851DFFC547A}
!48 = !{!49, !50, i1 false, i2 -1}
!49 = !{!"fixp", i32 32, i32 24}
!50 = !{double 0x406019999FE43676, double 1.440000e+02}
!51 = !{!52, !1, i1 false, i2 -1}
!52 = !{!"fixp", i32 -32, i32 28}
!53 = !{!"x"}
!54 = !{!49, !55, i1 false, i2 -1}
!55 = !{double 0.000000e+00, double 0x406019999FE43676}
...
!101 = !{!"fixp", i32 32, i32 19}
!102 = !{double 0x40B019999FE43676, double 4.608000e+03}
!103 = !{i32 7}
!104 = distinct !{!104, !23}
!105 = !{i32 1, !85, i32 1, !51, i32 1, !94}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 23}
!108 = !{double 0xBFF36DCA07F66E87, double 0x405FFCF893FAF428}
!109 = distinct !{!109, !23}
!110 = !{i32 -1, i32 2, i32 2, i32 2, i32 2}
!111 = !{i32 1, !85, i32 1, !42, i32 1, !48, i32 1, !51, i32 1, !54}
!112 = !{!107, !113, i1 false, i2 -1}
!113 = !{double -2.000000e+02, double 2.000000e+02}
!114 = !{!115, !116, i1 false, i2 -1}
!115 = !{!"fixp", i32 -32, i32 14}
!116 = !{double 0x3F847AE147AE147C, double 0x40F0B28B463B78B0}
!117 = !{i32 8}
!118 = !{!115, !119, i1 false, i2 -1}
!119 = !{double 0xC0F0BF0B463B78B0, double 1.999900e+02}
!120 = distinct !{!120, !23}
!121 = !{!122, !123, i1 false, i2 -1}
!122 = !{!"fixp", i32 -32, i32 20}
!123 = !{double -2.000000e+03, double 2.000000e+03}
!124 = !{i1 false, !113, i1 false, i2 -1}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!131 = !{double 0.000000e+00, double 0x40E07278CFD00C6E}
!132 = !{!130, !133, i1 false, i2 -1}
!133 = !{double 0xC0E08B78CFD00C6E, double 2.000000e+02}
!134 = distinct !{!134, !23}
!135 = distinct !{!135, !23}
!136 = !{i1 false, !137, i1 false, i2 0}
!137 = !{double 1.900000e+01, double 1.900000e+01}
!138 = !{i1 false, !139, i1 false, i2 0}
!139 = !{double 1.800000e+01, double 1.900000e+01}
!140 = !{i1 false, !141, i1 false, i2 0}
!141 = !{double 2.000000e+01, double 2.100000e+01}
!142 = !{!122, !143, i1 false, i2 -1}
!143 = !{double 0xC023D9094AED99C8, double 0x409056C5CDD0C3A5}
!144 = !{!122, !145, i1 false, i2 -1}
!145 = !{double 0xC09376C5CDD0C3A5, double 0x406A3D9094AED99C}
!146 = !{i1 false, !147, i1 false, i2 0}
!147 = !{double 2.100000e+01, double 2.100000e+01}
!148 = distinct !{!148, !23}
!149 = !{i1 false, !150, i1 false, i2 0}
!150 = !{double 1.800000e+01, double 1.800000e+01}
!151 = distinct !{!151, !23}
!152 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!153 = !{i32 1, !85, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!154 = !{!155, !86, i1 false, i2 1}
...
!165 = !{!155, !81, i1 false, i2 1}
!166 = !{!167, !168, i1 false, i2 1}
!167 = !{!"fixp", i32 32, i32 30}
!168 = !{double 5.000000e-02, double 1.050000e+00}
!169 = !{!170, !171, i1 false, i2 1}
!170 = !{!"fixp", i32 32, i32 29}
!171 = !{double 2.500000e-02, double 5.250000e-01}
!172 = !{i32 4}
!173 = !{i1 false, !19}
!174 = !{!170, !175, i1 false, i2 1}
!175 = !{double 4.025000e+00, double 4.525000e+00}
!176 = !{i1 false, !177}
!177 = !{i1 false, !178, i1 false, i2 0}
!178 = !{double 4.000000e+00, double 4.000000e+00}
!179 = !{!170, !180, i1 false, i2 1}
!180 = !{double 0x4010199980000000, double 0x40121999A0000000}
!181 = !{!49, !50, i1 false, i2 1}
!182 = distinct !{!182, !23}
!183 = !{i1 false, !184, i1 false, i2 1}
!184 = !{double -2.000000e+01, double 0.000000e+00}
!185 = !{i1 false, !186, i1 false, i2 1}
!186 = !{double -1.900000e+01, double 0.000000e+00}
!187 = !{!188, !186, i1 false, i2 1}
!188 = !{!"fixp", i32 -32, i32 26}
...
!204 = distinct !{!204, !23}
!205 = distinct !{!205, !23}
!206 = !{!207, !116, i1 false, i2 -1}
!207 = !{!"fixp", i32 32, i32 15}
!208 = !{!207, !209, i1 false, i2 -1}
!209 = !{double 3.201000e+01, double 0x40F0C2E3981B7504}
!210 = distinct !{!210, !23}
!211 = distinct !{!211, !23}
!212 = distinct !{!212, !23}
!213 = distinct !{!213, !23}
...
!217 = !{!218, !219, i1 false, i2 -1}
!218 = !{!"fixp", i32 32, i32 18}
!219 = !{double 3.200000e+00, double 0x40C05851DFFC547A}
!220 = !{i32 9}
!221 = distinct !{!221, !23}
!222 = distinct !{!222, !23}
