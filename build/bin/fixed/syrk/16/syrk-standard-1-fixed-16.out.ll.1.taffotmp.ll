...
entry:
  ...
  call void @llvm.var.annotation(i8* %C3, i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 112, i8* null)
  %A4 = bitcast [16 x [10 x float]]* %A to i8*
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 113, i8* null)
  ...
  call void @kernel_syrk(i32 noundef %2, i32 noundef %3, float noundef %4, float noundef %5, [16 x float]* noundef %arraydecay6, [10 x float]* noundef %arraydecay7)
...
for.body10:                                       ; preds = %for.cond8
  ...
  %arrayidx = getelementptr inbounds [16 x [16 x float]], [16 x [16 x float]]* %C, i32 0, i32 %10
  %11 = load i32, i32* %j, align 4
  %arrayidx11 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx, i32 0, i32 %11
  ...
  store float %12, float* %arrayidx13, align 4
  br label %for.inc
