; ModuleID = './build/bin/fixed/2mm/16/2mm-standard-128-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u7_25fixp = bitcast [12 x i32]* %arraydecay12.u7_25fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 8, i32 12, i32* %u7_25fixp, i32 128), !taffo.info !64, !taffo.constinfo !65
  %arraydecay13.u7_25fixp = getelementptr inbounds [12 x [10 x i32]], [12 x [10 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !53
  %u7_25fixp3 = bitcast [10 x i32]* %arraydecay13.u7_25fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u7_25fixp3, i32 128), !taffo.info !66, !taffo.constinfo !65
...
for.body24:                                       ; preds = %for.cond22
  ...
  %1 = fdiv float %0, 6.400000e+01, !taffo.info !57, !taffo.target !59
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %A.u7_25fixp, [10 x i32]* noundef %B.u7_25fixp, [14 x i32]* noundef %C.u7_25fixp, [14 x i32]* noundef %D.u26_6fixp, [10 x i32]* noundef %tmp.u17_15fixp) #0 !taffo.initweight !100 !taffo.funinfo !101 !taffo.sourceFunction !104 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u7_25fixp = getelementptr inbounds [12 x i32], [12 x i32]* %A.u7_25fixp, i32 %i.0, !taffo.info !133
  %arrayidx7.u7_25fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u7_25fixp, i32 0, i32 %j.0, !taffo.info !133
  %4 = lshr i32 %div.u3_29fixp, 4, !taffo.info !132
  store i32 %4, i32* %arrayidx7.u7_25fixp, align 4, !taffo.info !134
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u7_25fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u7_25fixp, i32 %i.1, !taffo.info !150
  %arrayidx26.u7_25fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx25.u7_25fixp, i32 0, i32 %j.1, !taffo.info !150
  %8 = lshr i32 %div24.u1_31fixp, 6, !taffo.info !148
  store i32 %8, i32* %arrayidx26.u7_25fixp, align 4, !taffo.info !134
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx48.u7_25fixp = getelementptr inbounds [14 x i32], [14 x i32]* %C.u7_25fixp, i32 %i.2, !taffo.info !166
  %arrayidx49.u7_25fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx48.u7_25fixp, i32 0, i32 %j.2, !taffo.info !166
  %12 = lshr i32 %div47.u1_31fixp, 6, !taffo.info !165
  store i32 %12, i32* %arrayidx49.u7_25fixp, align 4, !taffo.info !134
  br label %for.inc50
...
for.body63:                                       ; preds = %for.cond60
  ...
  %arrayidx70.u26_6fixp = getelementptr inbounds [14 x i32], [14 x i32]* %D.u26_6fixp, i32 %i.3, !taffo.info !180
  %arrayidx71.u26_6fixp = getelementptr inbounds [14 x i32], [14 x i32]* %arrayidx70.u26_6fixp, i32 0, i32 %j.3, !taffo.info !180
  %16 = lshr i32 %div69.u1_31fixp, 25, !taffo.info !179
  store i32 %16, i32* %arrayidx71.u26_6fixp, align 4, !taffo.info !134
  br label %for.inc72
...
for.body85:                                       ; preds = %for.cond82
  %arrayidx86.u17_15fixp = getelementptr inbounds [10 x i32], [10 x i32]* %tmp.u17_15fixp, i32 %i.4, !taffo.info !183
  %arrayidx87.u17_15fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx86.u17_15fixp, i32 0, i32 %j.4, !taffo.info !183
  store i32 0, i32* %arrayidx87.u17_15fixp, align 4, !taffo.info !134, !taffo.constinfo !184
  br label %for.inc88
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_2mm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [10 x i32]* noundef %tmp.u17_15fixp, [12 x i32]* noundef %A.u7_25fixp, [10 x i32]* noundef %B.u7_25fixp, [14 x i32]* noundef %C.u7_25fixp, [14 x i32]* noundef %D.u26_6fixp) #0 !taffo.initweight !187 !taffo.funinfo !188 !taffo.sourceFunction !189 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  store i32 0, i32* %arrayidx4.u17_15fixp, align 4, !taffo.info !134, !taffo.constinfo !184
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %u7_25fixp = load i32, i32* %arrayidx9.u7_25fixp, align 4, !taffo.info !190
  %0 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %1 = lshr i32 %u7_25fixp, 1, !taffo.info !190
  %2 = ashr i32 %0, 6, !taffo.info !42
  %3 = ashr i32 %1, 1, !taffo.info !190
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 23), !taffo.info !192
  %mul.u8_24fixp = shl i32 %4, 1, !taffo.info !194
  ...
  %5 = lshr i32 %mul.u8_24fixp, 1, !taffo.info !194
  %6 = lshr i32 %u7_25fixp2, 1, !taffo.info !53
  %7 = ashr i32 %5, 9, !taffo.info !194
  %8 = ashr i32 %6, 10, !taffo.info !53
  %9 = call i32 @llvm.smul.fix.i32(i32 %7, i32 %8, i32 14), !taffo.info !195
  %mul12.u17_15fixp = shl i32 %9, 1, !taffo.info !198
  ...
  %add.u17_15fixp = add i32 %u17_15fixp, %mul12.u17_15fixp, !taffo.info !199
...
for.inc15:                                        ; preds = %for.end
  ...
  br label %for.cond1, !llvm.loop !202
...
for.body26:                                       ; preds = %for.cond24
  ...
  %13 = call i32 @llvm.smul.fix.i32(i32 %10, i32 %12, i32 5), !taffo.info !204
  %mul29.u26_6fixp = shl i32 %13, 1, !taffo.info !207
...
for.body32:                                       ; preds = %for.cond30
  ...
  %18 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %17, i32 5), !taffo.info !208
  %mul37.u26_6fixp = shl i32 %18, 1, !taffo.info !210
  ...
  %add40.u26_6fixp = add i32 %u26_6fixp4, %mul37.u26_6fixp, !taffo.info !211
...
for.inc41:                                        ; preds = %for.body32
  ...
  br label %for.cond30, !llvm.loop !213
...
for.inc44:                                        ; preds = %for.end43
  ...
  br label %for.cond24, !llvm.loop !214
...
for.inc47:                                        ; preds = %for.end46
  ...
  br label %for.cond21, !llvm.loop !215
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u26_6fixp, i32 noundef %factor) #0 !taffo.initweight !216 !taffo.funinfo !227 !taffo.sourceFunction !218 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = fdiv float %1, 6.400000e+01, !taffo.info !57
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !219
  %3 = uitofp i32 %conv.u8_24fixp to float, !taffo.info !219
  %4 = fdiv float %3, 0x4170000000000000, !taffo.info !219
  %mul.1flp = fmul float %2, %4, !taffo.info !228
  ...
  %6 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !228
  %7 = fptoui float %6 to i32, !taffo.info !228
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !216 !taffo.funinfo !233 !taffo.sourceFunction !218 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 7), !taffo.info !234
  %mul.u24_8fixp = shl i32 %5, 1, !taffo.info !237
  %6 = mul nsw i32 %i.0, %m, !taffo.info !91
  ...
  %7 = shl i32 %mul.u24_8fixp, 7, !taffo.info !237
...
!191 = !{!"fixp", i32 32, i32 24}
!192 = !{!193, !119, i1 false, i2 -1}
!193 = !{!"fixp", i32 -32, i32 23}
!194 = !{!191, !119, i1 false, i2 -1}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"fixp", i32 -32, i32 14}
!197 = !{double 0.000000e+00, double 0x40D2E6665E247885}
!198 = !{!48, !197, i1 false, i2 -1}
!199 = !{!48, !200, i1 false, i2 -1}
!200 = !{double 0.000000e+00, double 0x40F72CCCB78897E9}
!201 = distinct !{!201, !23}
!202 = distinct !{!202, !23}
!203 = distinct !{!203, !23}
!204 = !{!205, !206, i1 false, i2 -1}
!205 = !{!"fixp", i32 -32, i32 5}
!206 = !{double 0.000000e+00, double 0x4187047AD9999999}
!207 = !{!58, !206, i1 false, i2 -1}
!208 = !{!205, !209, i1 false, i2 -1}
!209 = !{double 0.000000e+00, double 0x416121D404846DFD}
!210 = !{!58, !209, i1 false, i2 -1}
!211 = !{!58, !212, i1 false, i2 -1}
!212 = !{double 0.000000e+00, double 0x418776DB61211B7F}
!213 = distinct !{!213, !23}
!214 = distinct !{!214, !23}
!215 = distinct !{!215, !23}
...
!225 = distinct !{!225, !23}
!226 = distinct !{!226, !23}
!227 = !{i32 1, !85, i32 1, !87, i32 1, !57, i32 1, !97}
!228 = !{!229, !230, i1 false, i2 -1}
!229 = !{!"float", i32 1, double 0x41F32E6660000000}
!230 = !{double 0.000000e+00, double 0x41F32E6660000000}
!231 = distinct !{!231, !23}
!232 = distinct !{!232, !23}
!233 = !{i32 1, !85, i32 1, !16, i32 1, !47, i32 1, !97}
!234 = !{!235, !236, i1 false, i2 -1}
!235 = !{!"fixp", i32 -32, i32 7}
!236 = !{double 0.000000e+00, double 0x416273331FFF79C8}
!237 = !{!238, !236, i1 false, i2 -1}
!238 = !{!"fixp", i32 32, i32 8}
!239 = distinct !{!239, !23}
!240 = distinct !{!240, !23}
