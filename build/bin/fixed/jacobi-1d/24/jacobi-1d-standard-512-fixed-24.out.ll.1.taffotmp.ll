...
entry:
  ...
  call void @llvm.var.annotation(i8* %A1, i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 96, i8* null)
  %B2 = bitcast [15 x float]* %B to i8*
  call void @llvm.var.annotation(i8* %B2, i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.1, i32 0, i32 0), i32 97, i8* null)
  ...
  call void @scale_1d(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 512)
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0
  call void @scale_1d(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 512)
