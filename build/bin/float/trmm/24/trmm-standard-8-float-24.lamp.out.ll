; ModuleID = './build/bin/float/trmm/24/trmm-standard-8-float-24.out.ll'
...
entry:
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, ptr noundef %arraydecay2, i32 noundef 8)
