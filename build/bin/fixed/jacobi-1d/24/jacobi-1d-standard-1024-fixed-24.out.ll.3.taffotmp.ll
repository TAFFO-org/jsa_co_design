; ModuleID = './build/bin/fixed/jacobi-1d/24/jacobi-1d-standard-1024-fixed-24.out.ll.2.taffotmp.ll'
...
@.str = private unnamed_addr constant [55 x i8] c"target('A') scalar(range(136.53334,1092.266724) final)\00", section "llvm.metadata", !taffo.info !0
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-1d.c\00", section "llvm.metadata", !taffo.info !2
@.str.2 = private unnamed_addr constant [44 x i8] c"scalar(range(204.800003,1160.533325) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 1024), !taffo.initweight !54, !taffo.target !48, !taffo.info !49, !taffo.originalCall !57, !taffo.constinfo !56
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.initweight !53, !taffo.info !51
  call void @scale_1d.3(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 1024), !taffo.initweight !54, !taffo.info !51, !taffo.originalCall !57, !taffo.constinfo !56
...
!7 = !{double 0.000000e+00, double 0x409111112018A43C}
...
!50 = !{double 0x406111111F0C34C2, double 0x409111112018A43C}
!51 = !{i1 false, !52, i1 false, i2 -1}
!52 = !{double 0x406999999FE43676, double 0x409222221FF2E48F}
!53 = !{i32 1}
!54 = !{i32 2}
...
!103 = !{double 0x410111111F0C34C2, double 0x413111112018A43C}
!104 = distinct !{!104, !29}
...
!112 = !{double 0x407111111F0C34C2, double 0x40A111112018A43C}
!113 = !{i1 false, !114, i1 false, i2 -1}
!114 = !{double 0x40799999AE924F23, double 0x40A99999B024F65A}
!115 = !{i32 8}
!116 = !{i32 9}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double 0x40611105EFBC6B1F, double 0x40911105F0C8D9E9}
!119 = !{i32 10}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0x40611105E0000000, double 0x4091110600000000}
!122 = distinct !{!122, !29}
!123 = !{i1 false, !124, i1 false, i2 -1}
!124 = !{double 0x407999999FE43676, double 0x40A222221FF2E48F}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0x4083333337EB28D8, double 0x40AB33332FEC56D6}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0x40699988D8EC91A0, double 0x409222163DAE297D}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x40699988C0000000, double 0x4092221640000000}
!131 = distinct !{!131, !29}
!132 = distinct !{!132, !29}
!133 = !{i32 1, !88, i32 1, !51, i32 1, !97}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0x410999999FE43676, double 0x413222221FF2E48F}
!136 = distinct !{!136, !29}
