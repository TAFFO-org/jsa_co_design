; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-8-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,8.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [43 x i8] c"target('B') scalar(range(0.0,337.5) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 8), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 8), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 8), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
!7 = !{double 0.000000e+00, double 3.375000e+02}
...
!52 = !{double 0.000000e+00, double 8.000000e+00}
...
!118 = !{double 0.000000e+00, double 2.700000e+03}
!119 = !{i1 false, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 3.037500e+03}
!121 = distinct !{!121, !29}
!122 = !{i1 false, !123, i1 false, i2 -1}
!123 = !{double 0.000000e+00, double 5.062500e+02}
!124 = distinct !{!124, !29}
!125 = distinct !{!125, !29}
...
!155 = !{double 0.000000e+00, double 6.400000e+01}
!156 = distinct !{!156, !29}
!157 = distinct !{!157, !29}
