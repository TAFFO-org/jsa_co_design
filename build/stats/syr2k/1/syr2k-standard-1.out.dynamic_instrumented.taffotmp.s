...
# %bb.0:                                # %entry
	...
	movss	%xmm0, -2352(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	callq	printf@PLT
	movss	-32(%rbp), %xmm0                # xmm0 = mem[0],zero,zero,zero
	movss	%xmm0, -2348(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movl	-2360(%rbp), %edi               # 4-byte Reload
	movl	-2356(%rbp), %esi               # 4-byte Reload
	movss	-2352(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movss	-2348(%rbp), %xmm1              # 4-byte Reload
                                        # xmm1 = mem[0],zero,zero,zero
	leaq	-1056(%rbp), %rdx
	leaq	-1696(%rbp), %rcx
	leaq	-2336(%rbp), %r8
	callq	kernel_syr2k.2
	callq	timer_stop
	movl	$0, -2340(%rbp)
.LBB3_1:                                # %for.cond
...
# %bb.4:                                # %for.body13
	...
	movss	%xmm0, -2364(%rbp)              # 4-byte Spill
	cvtss2sd	%xmm0, %xmm0
	movq	PrintfFormatStr@GOTPCREL(%rip), %rdi
	...
	movb	$1, %al
	callq	printf@PLT
	movss	-2364(%rbp), %xmm0              # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	movslq	-2340(%rbp), %rcx
...
.LBB5_16:                               # %for.end45
	...
	retq
.Lfunc_end5:
	.size	kernel_syr2k, .Lfunc_end5-kernel_syr2k
	.cfi_endproc
                                        # -- End function
	.section	.rodata.cst4,"aM",@progbits,4
...
.Lfunc_end6:
	...
	.cfi_endproc
                                        # -- End function
	.p2align	4, 0x90                         # -- Begin function kernel_syr2k.2
...
.LBB7_16:                               # %for.end45
	...
	retq
.Lfunc_end7:
	.size	kernel_syr2k.2, .Lfunc_end7-kernel_syr2k.2
	.cfi_endproc
                                        # -- End function
