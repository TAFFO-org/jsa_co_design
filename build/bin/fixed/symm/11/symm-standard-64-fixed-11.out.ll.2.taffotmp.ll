; ModuleID = './build/bin/fixed/symm/11/symm-standard-64-fixed-11.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,175173.125) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [41 x i8] c"scalar(range(-63936.0,115.199997) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [31 x i8] c"scalar(range(6.4,160.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 64), !taffo.initweight !41, !taffo.info !30, !taffo.originalCall !43
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 64), !taffo.initweight !41, !taffo.info !32, !taffo.originalCall !43
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 64), !taffo.initweight !45, !taffo.info !34, !taffo.target !36, !taffo.originalCall !46
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 64), !taffo.initweight !45, !taffo.info !37, !taffo.originalCall !46
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %4, i32 noundef 64), !taffo.initweight !45, !taffo.info !39, !taffo.originalCall !46
...
!35 = !{double 0.000000e+00, double 0x4105622900000000}
!36 = !{!"C"}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double -6.393600e+04, double 0x405CCCCCC0379314}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 6.400000e+00, double 1.600000e+02}
!41 = !{i32 1}
