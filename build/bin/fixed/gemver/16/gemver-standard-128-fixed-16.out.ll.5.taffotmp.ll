; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-128-fixed-16.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u20_12fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 4), !taffo.info !127
  %mul.u27_5fixp = shl i32 %4, 1, !taffo.info !130
  %arrayidx1.u20_12fixp = getelementptr inbounds i32, i32* %val.u20_12fixp, i32 %i.0, !taffo.info !69
  %5 = shl i32 %mul.u27_5fixp, 7, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !140 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 20), !taffo.info !141
  %mul.u11_21fixp = shl i32 %4, 1, !taffo.info !144
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u11_21fixp, 7, !taffo.info !144
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !156
...
for.body51:                                       ; preds = %for.cond49
  ...
  %29 = fdiv float %28, 5.242880e+05, !taffo.info !200
  ...
  %mul57.1flp = fmul float %29, %31, !taffo.info !201
  %add58.1flp = fadd float %.flt.fallback.1flp, %mul57.1flp, !taffo.info !204
...
!128 = !{!"fixp", i32 -32, i32 4}
!129 = !{double 0.000000e+00, double 0x4195FC45A0000000}
...
!139 = distinct !{!139, !27}
!140 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!141 = !{!142, !143, i1 false, i2 -1}
!142 = !{!"fixp", i32 -32, i32 20}
!143 = !{double 0x4056C16BDB1A6D6A, double 0x409C71C714FCE747}
...
!169 = distinct !{null}
!170 = !{!138, !5, i1 false, i2 -1}
!171 = !{!135, !172, i1 false, i2 -1}
!172 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!173 = !{!138, !172, i1 false, i2 -1}
!174 = !{!138, !175, i1 false, i2 -1}
!175 = !{double 0.000000e+00, double 0x40C1E111077CCC04}
!176 = !{!142, !177, i1 false, i2 -1}
!177 = !{double 0x400B4E8244127E88, double 0x409555556084A516}
!178 = !{!145, !177, i1 false, i2 -1}
!179 = !{!138, !180, i1 false, i2 -1}
