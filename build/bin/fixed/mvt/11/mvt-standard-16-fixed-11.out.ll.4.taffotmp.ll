; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-16-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 16), !taffo.info !56, !taffo.initweight !60, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 16), !taffo.info !63, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !50, !taffo.originalCall !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 16), !taffo.info !66, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !52, !taffo.originalCall !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 16), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 16), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
...
for.body:                                         ; preds = %for.cond
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !92
  %mul = fmul float %0, %conv, !taffo.info !99, !taffo.initweight !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_mvt.4(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !103 !taffo.funinfo !104 !taffo.sourceFunction !68 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx5, align 4, !taffo.info !44, !taffo.initweight !96
  ...
  %mul = fmul float %1, %2, !taffo.info !105, !taffo.initweight !96
  %add = fadd float %0, %mul, !taffo.info !107, !taffo.initweight !96
...
for.body16:                                       ; preds = %for.cond14
  ...
  %4 = load float, float* %arrayidx19, align 4, !taffo.info !44, !taffo.initweight !96
  ...
  %mul21 = fmul float %4, %5, !taffo.info !105, !taffo.initweight !96
  %add22 = fadd float %3, %mul21, !taffo.info !111, !taffo.initweight !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.6(i32 noundef %n, float* noundef %x1, float* noundef %x2, float* noundef %y_1, float* noundef %y_2, [20 x float]* noundef %A) #0 !taffo.initweight !103 !taffo.funinfo !104 !taffo.sourceFunction !59 {
entry:
  br label %for.cond

for.cond:                                         ; preds = %for.inc31, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc32, %for.inc31 ], !taffo.info !115, !taffo.initweight !47
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !116, !taffo.initweight !57
  br i1 %cmp, label %for.body, label %for.end33, !taffo.info !117, !taffo.initweight !60

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.info !119, !taffo.initweight !57
  %conv = sitofp i32 %rem to float, !taffo.info !121, !taffo.initweight !60
  %conv3 = sitofp i32 %n to float, !taffo.info !122
  %div = fdiv float %conv, %conv3, !taffo.info !123, !taffo.initweight !126
  %arrayidx = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !127, !taffo.initweight !57
  store float %div, float* %arrayidx, align 4, !taffo.info !128, !taffo.initweight !60
  %add = add nsw i32 %i.0, 1, !taffo.info !129, !taffo.initweight !57, !taffo.constinfo !23
  %rem4 = srem i32 %add, %n, !taffo.info !119, !taffo.initweight !60
  %conv5 = sitofp i32 %rem4 to float, !taffo.info !121, !taffo.initweight !126
  %conv6 = sitofp i32 %n to float, !taffo.info !122
  %div7 = fdiv float %conv5, %conv6, !taffo.info !123, !taffo.initweight !90
  %arrayidx8 = getelementptr inbounds float, float* %x2, i32 %i.0, !taffo.info !130, !taffo.initweight !57
  store float %div7, float* %arrayidx8, align 4, !taffo.info !128, !taffo.initweight !60
  %add9 = add nsw i32 %i.0, 3, !taffo.info !131, !taffo.initweight !57, !taffo.constinfo !23
  %rem10 = srem i32 %add9, %n, !taffo.info !119, !taffo.initweight !60
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !121, !taffo.initweight !126
  %conv12 = sitofp i32 %n to float, !taffo.info !122
  %div13 = fdiv float %conv11, %conv12, !taffo.info !123, !taffo.initweight !90
  %arrayidx14 = getelementptr inbounds float, float* %y_1, i32 %i.0, !taffo.info !133, !taffo.initweight !57
  store float %div13, float* %arrayidx14, align 4, !taffo.info !128, !taffo.initweight !60
  %add15 = add nsw i32 %i.0, 4, !taffo.info !134, !taffo.initweight !57, !taffo.constinfo !23
  %rem16 = srem i32 %add15, %n, !taffo.info !119, !taffo.initweight !60
  %conv17 = sitofp i32 %rem16 to float, !taffo.info !121, !taffo.initweight !126
  %conv18 = sitofp i32 %n to float, !taffo.info !122
  %div19 = fdiv float %conv17, %conv18, !taffo.info !123, !taffo.initweight !90
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %i.0, !taffo.info !133, !taffo.initweight !57
  store float %div19, float* %arrayidx20, align 4, !taffo.info !128, !taffo.initweight !60
  br label %for.cond21

for.cond21:                                       ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !115, !taffo.initweight !47
  %cmp22 = icmp slt i32 %j.0, %n, !taffo.info !116, !taffo.initweight !57
  br i1 %cmp22, label %for.body24, label %for.end, !taffo.info !117, !taffo.initweight !60

for.body24:                                       ; preds = %for.cond21
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !136, !taffo.initweight !57
  %rem25 = srem i32 %mul, %n, !taffo.info !119, !taffo.initweight !60
  %conv26 = sitofp i32 %rem25 to float, !taffo.info !121, !taffo.initweight !126
  %conv27 = sitofp i32 %n to float, !taffo.info !122
  %div28 = fdiv float %conv26, %conv27, !taffo.info !123, !taffo.initweight !90
  %arrayidx29 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !133, !taffo.initweight !57
  %arrayidx30 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx29, i32 0, i32 %j.0, !taffo.info !133, !taffo.initweight !57
  store float %div28, float* %arrayidx30, align 4, !taffo.info !128, !taffo.initweight !60
  br label %for.inc

for.inc:                                          ; preds = %for.body24
  %inc = add nsw i32 %j.0, 1, !taffo.info !129, !taffo.initweight !57, !taffo.constinfo !23
...
for.inc31:                                        ; preds = %for.end
  %inc32 = add nsw i32 %i.0, 1, !taffo.info !129, !taffo.initweight !57, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !140 !taffo.funinfo !141 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !44, !taffo.initweight !142
  %conv = sitofp i32 %factor to float, !taffo.info !92
  %mul = fmul float %1, %conv, !taffo.info !99, !taffo.initweight !143
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !56, !taffo.initweight !142
  br label %for.inc
...
!95 = !{double 0.000000e+00, double 0x40D3CFFFE004B7F6}
!96 = !{i32 7}
!97 = distinct !{!97, !25}
!98 = !{i32 1, !77, i32 1, !44, i32 1, !88}
!99 = !{!100, !101, i1 false, i2 -1}
!100 = !{!"fixp", i32 32, i32 24}
!101 = !{double 0.000000e+00, double 2.432000e+02}
!102 = distinct !{!102, !25}
!103 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2}
!104 = !{i32 1, !77, i32 1, !48, i32 1, !51, i32 1, !44, i32 1, !44, i32 1, !44}
!105 = !{!100, !106, i1 false, i2 -1}
!106 = !{double 0.000000e+00, double 2.310400e+02}
!107 = !{!49, !108, i1 false, i2 -1}
!108 = !{double 0.000000e+00, double 0x40976C28D5C74752}
!109 = distinct !{!109, !25}
!110 = distinct !{!110, !25}
!111 = !{!49, !112, i1 false, i2 -1}
!112 = !{double 0.000000e+00, double 0x4097A28F55DE58E6}
!113 = distinct !{!113, !25}
!114 = distinct !{!114, !25}
!115 = !{i1 false, !70, i1 false, i2 1}
!116 = !{i1 false, !72, i1 false, i2 1}
!117 = !{i1 false, !118, i1 false, i2 1}
!118 = !{double 0.000000e+00, double 2.000000e+01}
!119 = !{i1 false, !120, i1 false, i2 1}
!120 = !{double 0.000000e+00, double 1.900000e+01}
!121 = !{!45, !120, i1 false, i2 1}
!122 = !{!45, !78, i1 false, i2 1}
!123 = !{!124, !125, i1 false, i2 1}
!124 = !{!"fixp", i32 32, i32 31}
!125 = !{double 0.000000e+00, double 0x3FEE666666666666}
!126 = !{i32 4}
!127 = !{!49, !1, i1 false, i2 1}
!128 = !{i1 false, i1 false, i1 false, i2 1}
!129 = !{i1 false, !74, i1 false, i2 1}
!130 = !{!49, !3, i1 false, i2 1}
...
!141 = !{i32 1, !77, i32 1, !77, i32 1, !44, i32 1, !88}
!142 = !{i32 8}
!143 = !{i32 9}
!144 = distinct !{!144, !25}
!145 = distinct !{!145, !25}
