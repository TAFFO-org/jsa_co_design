; ModuleID = './build/bin/fixed/lu/16/lu-standard-64-fixed-16.out.ll.3.taffotmp.ll'
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !146, !taffo.initweight !149
...
!82 = !{!"fixp", i32 -32, i32 12}
!83 = !{double 0x3F847AE147AE147C, double 0x4110B28B463B78B0}
!84 = !{!82, !85, i1 false, i2 1}
!85 = !{double 0xC110B28ADFD5124A, double 0x4080583D651B0CCC}
!86 = !{i1 false, i1 false, i1 false, i2 1}
!87 = distinct !{!87, !23}
!88 = !{!89, !90, i1 false, i2 -1}
!89 = !{!"fixp", i32 32, i32 19}
!90 = !{double 0x3F290F455FEACCE2, double 0x40B46E6657FB6998}
!91 = !{i32 8}
!92 = distinct !{!92, !23}
!93 = distinct !{!93, !23}
!94 = distinct !{!94, !23}
...
!98 = !{double 0.000000e+00, double 0x4110B28B463B78B0}
...
!143 = !{double 6.400000e+01, double 6.400000e+01}
!144 = !{!145, !143, i1 false, i2 1}
!145 = !{!"fixp", i32 32, i32 25}
!146 = !{!147, !148, i1 false, i2 -1}
!147 = !{!"fixp", i32 32, i32 16}
!148 = !{double 6.400000e+00, double 0x40E05851DFFC547A}
!149 = !{i32 9}
!150 = distinct !{!150, !23}
!151 = distinct !{!151, !23}
