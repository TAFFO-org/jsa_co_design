; ModuleID = './build/stats/ludcmp/4/ludcmp-standard-4.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 4), !taffo.originalCall !28
  ...
  call void @scale_2d.4(i32 noundef 20, i32 noundef 20, float* noundef %2, i32 noundef 4), !taffo.originalCall !28
  %arraydecay12 = getelementptr inbounds [20 x float], [20 x float]* %b, i64 0, i64 0
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 4), !taffo.originalCall !29
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %x, i64 0, i64 0
  call void @scale_1d.2(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 4), !taffo.originalCall !29
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y, i64 0, i64 0
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 4), !taffo.originalCall !29
