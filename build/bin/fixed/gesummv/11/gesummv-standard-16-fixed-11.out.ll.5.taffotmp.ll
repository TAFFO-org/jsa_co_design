; ModuleID = './build/bin/fixed/gesummv/11/gesummv-standard-16-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  call void @kernel_gesummv.5_fixp(i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [16 x i32]* %arraydecay17.u4_28fixp, [16 x i32]* %arraydecay18.u4_28fixp, i32* %arraydecay19.u11_21fixp, i32* %arraydecay20.u4_28fixp, i32* %arraydecay21.u12_20fixp), !taffo.info !57, !taffo.constinfo !58
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4130000000000000, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !85 !taffo.funinfo !86 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !90
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !93
  %arrayidx1.u11_21fixp = getelementptr inbounds i32, i32* %val.u11_21fixp, i32 %i.0, !taffo.info !51
  %5 = shl i32 %mul.u15_17fixp, 4, !taffo.info !93
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u12_20fixp, i32 noundef %factor) #0 !taffo.initweight !85 !taffo.funinfo !103 !taffo.sourceFunction !87 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !104
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !107
  %arrayidx1.u12_20fixp = getelementptr inbounds i32, i32* %val.u12_20fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u16_16fixp, 4, !taffo.info !107
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.7_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u4_28fixp, [16 x i32]* noundef %B.u4_28fixp, i32* noundef %x.u4_28fixp, i32* noundef %tmp.u11_21fixp, i32* noundef %y.u12_20fixp) #0 !taffo.initweight !110 !taffo.funinfo !111 !taffo.sourceFunction !112 {
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !57, !taffo.constinfo !113
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !60, !taffo.constinfo !115
  br label %for.cond

for.cond:                                         ; preds = %for.inc24, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc25, %for.inc24 ], !taffo.info !118, !taffo.initweight !119
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !120, !taffo.initweight !121
  br i1 %cmp, label %for.body, label %for.end26, !taffo.info !122, !taffo.initweight !124

for.body:                                         ; preds = %for.cond
  %rem = srem i32 %i.0, %n, !taffo.info !125, !taffo.initweight !121
  %conv.u4_28fixp = shl i32 %rem, 28, !taffo.info !126
  %conv3.u5_27fixp = shl i32 %n, 27, !taffo.info !88
  %0 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !126
  %1 = lshr i32 %conv3.u5_27fixp, 1, !taffo.info !88
  %2 = ashr i32 %0, 1, !taffo.info !126
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %2, i32 %1, i32 26), !taffo.info !127
  %div.u1_31fixp = shl i32 %3, 5, !taffo.info !130
  %arrayidx.u4_28fixp = getelementptr inbounds i32, i32* %x.u4_28fixp, i32 %i.0, !taffo.info !126
  %4 = lshr i32 %div.u1_31fixp, 3, !taffo.info !130
  store i32 %4, i32* %arrayidx.u4_28fixp, align 4, !taffo.info !132
  %arrayidx4.u12_20fixp = getelementptr inbounds i32, i32* %y.u12_20fixp, i32 %i.0, !taffo.info !133
  store i32 0, i32* %arrayidx4.u12_20fixp, align 4, !taffo.info !132, !taffo.constinfo !134
  %arrayidx5.u11_21fixp = getelementptr inbounds i32, i32* %tmp.u11_21fixp, i32 %i.0, !taffo.info !135
  store i32 0, i32* %arrayidx5.u11_21fixp, align 4, !taffo.info !132, !taffo.constinfo !134
  br label %for.cond6

for.cond6:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !118, !taffo.initweight !119
  %cmp7 = icmp slt i32 %j.0, %n, !taffo.info !120, !taffo.initweight !121
  br i1 %cmp7, label %for.body9, label %for.end, !taffo.info !122, !taffo.initweight !124

for.body9:                                        ; preds = %for.cond6
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !136, !taffo.initweight !121
  %add = add nsw i32 %mul, 1, !taffo.info !138, !taffo.initweight !124, !taffo.constinfo !21
  %rem10 = srem i32 %add, %n, !taffo.info !125, !taffo.initweight !140
  ...
  %7 = ashr i32 %5, 1, !taffo.info !126
  %8 = call i32 @llvm.sdiv.fix.i32(i32 %7, i32 %6, i32 26), !taffo.info !127
  %div13.u1_31fixp = shl i32 %8, 5, !taffo.info !130
  %arrayidx14.u4_28fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u4_28fixp, i32 %i.0, !taffo.info !126
  %arrayidx15.u4_28fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx14.u4_28fixp, i32 0, i32 %j.0, !taffo.info !126
  %9 = lshr i32 %div13.u1_31fixp, 3, !taffo.info !130
  store i32 %9, i32* %arrayidx15.u4_28fixp, align 4, !taffo.info !132
  %mul16 = mul nsw i32 %i.0, %j.0, !taffo.info !136, !taffo.initweight !121
  %add17 = add nsw i32 %mul16, 2, !taffo.info !141, !taffo.initweight !124, !taffo.constinfo !21
  %rem18 = srem i32 %add17, %n, !taffo.info !125, !taffo.initweight !140
  %conv19.u4_28fixp = shl i32 %rem18, 28, !taffo.info !126
  %conv20.u5_27fixp = shl i32 %n, 27, !taffo.info !88
  %10 = lshr i32 %conv19.u4_28fixp, 1, !taffo.info !126
  %11 = lshr i32 %conv20.u5_27fixp, 1, !taffo.info !88
  %12 = ashr i32 %10, 1, !taffo.info !126
  %13 = call i32 @llvm.sdiv.fix.i32(i32 %12, i32 %11, i32 26), !taffo.info !127
  %div21.u1_31fixp = shl i32 %13, 5, !taffo.info !130
  %arrayidx22.u4_28fixp = getelementptr inbounds [16 x i32], [16 x i32]* %B.u4_28fixp, i32 %i.0, !taffo.info !126
  %arrayidx23.u4_28fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx22.u4_28fixp, i32 0, i32 %j.0, !taffo.info !126
  %14 = lshr i32 %div21.u1_31fixp, 3, !taffo.info !130
  store i32 %14, i32* %arrayidx23.u4_28fixp, align 4, !taffo.info !132
  br label %for.inc

for.inc:                                          ; preds = %for.body9
  %inc = add nsw i32 %j.0, 1, !taffo.info !143, !taffo.initweight !121, !taffo.constinfo !21
  br label %for.cond6, !llvm.loop !144

for.end:                                          ; preds = %for.cond6
  br label %for.inc24

for.inc24:                                        ; preds = %for.end
  %inc25 = add nsw i32 %i.0, 1, !taffo.info !143, !taffo.initweight !121, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gesummv.5_fixp(i32 noundef %n, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %A.u4_28fixp, [16 x i32]* noundef %B.u4_28fixp, i32* noundef %tmp.u11_21fixp, i32* noundef %x.u4_28fixp, i32* noundef %y.u12_20fixp) #0 !taffo.initweight !146 !taffo.funinfo !147 !taffo.sourceFunction !148 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 0, i32* %arrayidx.u11_21fixp, align 4, !taffo.info !132, !taffo.constinfo !134
  %arrayidx1.u12_20fixp = getelementptr inbounds i32, i32* %y.u12_20fixp, i32 %i.0, !taffo.info !54
  store i32 0, i32* %arrayidx1.u12_20fixp, align 4, !taffo.info !132, !taffo.constinfo !134
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 23), !taffo.info !149
  %mul.u8_24fixp = shl i32 %4, 1, !taffo.info !151
  ...
  %5 = lshr i32 %mul.u8_24fixp, 3, !taffo.info !151
  %add.u11_21fixp = add i32 %5, %u11_21fixp, !taffo.info !152
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 23), !taffo.info !149
  %mul13.u8_24fixp = shl i32 %10, 1, !taffo.info !151
  ...
  %11 = lshr i32 %mul13.u8_24fixp, 4, !taffo.info !151
  %add15.u12_20fixp = add i32 %11, %u12_20fixp, !taffo.info !154
...
for.inc:                                          ; preds = %for.body4
  ...
  br label %for.cond2, !llvm.loop !156
...
for.end:                                          ; preds = %for.cond2
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 18), !taffo.info !157
  %mul18.u13_19fixp = shl i32 %16, 1, !taffo.info !160
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 18), !taffo.info !162
  %mul20.u13_19fixp = shl i32 %21, 1, !taffo.info !164
  %add21.u13_19fixp = add i32 %mul18.u13_19fixp, %mul20.u13_19fixp, !taffo.info !165
  %arrayidx22.u12_20fixp = getelementptr inbounds i32, i32* %y.u12_20fixp, i32 %i.0, !taffo.info !54
  %22 = shl i32 %add21.u13_19fixp, 1, !taffo.info !165
...
!102 = distinct !{!102, !23}
!103 = !{i32 1, !75, i32 1, !54, i32 1, !75}
!104 = !{!105, !106, i1 false, i2 -1}
!105 = !{!"fixp", i32 -32, i32 15}
!106 = !{double 0.000000e+00, double 0x40E6A6667FF583A5}
!107 = !{!108, !106, i1 false, i2 -1}
!108 = !{!"fixp", i32 32, i32 16}
!109 = distinct !{!109, !23}
!110 = !{i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2, i32 2, i32 2}
!111 = !{i32 1, !75, i32 1, !43, i32 1, !46, i32 1, !48, i32 1, !48, i32 1, !48, i32 1, !51, i32 1, !54}
!112 = distinct !{null}
!113 = !{!114, i1 false}
!114 = !{i1 false, !45, i1 false, i2 0}
!115 = !{!116, i1 false}
!116 = !{i1 false, !117, i1 false, i2 0}
!117 = !{double 0x3FF3333340000000, double 0x3FF3333340000000}
!118 = !{i1 false, !68, i1 false, i2 1}
!119 = !{i32 0}
...
!124 = !{i32 3}
!125 = !{i1 false, !50, i1 false, i2 1}
!126 = !{!49, !50, i1 false, i2 1}
!127 = !{!128, !129, i1 false, i2 1}
!128 = !{!"fixp", i32 -32, i32 26}
!129 = !{double 0.000000e+00, double 9.375000e-01}
!130 = !{!131, !129, i1 false, i2 1}
!131 = !{!"fixp", i32 32, i32 31}
!132 = !{i1 false, i1 false, i1 false, i2 1}
!133 = !{!55, !1, i1 false, i2 1}
!134 = !{!79, i1 false}
!135 = !{!52, !53, i1 false, i2 1}
...
!142 = !{double 2.000000e+00, double 2.580000e+02}
!143 = !{i1 false, !72, i1 false, i2 1}
!144 = distinct !{!144, !23}
!145 = distinct !{!145, !23}
!146 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!147 = !{i32 1, !75, i32 1, !43, i32 1, !46, i32 1, !48, i32 1, !48, i32 1, !51, i32 1, !48, i32 1, !54}
!148 = distinct !{null}
!149 = !{!98, !150, i1 false, i2 -1}
!150 = !{double 0.000000e+00, double 2.250000e+02}
!151 = !{!101, !150, i1 false, i2 -1}
!152 = !{!52, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 1.353000e+03}
!154 = !{!55, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x40A868667FF583A5}
!156 = distinct !{!156, !23}
!157 = !{!158, !159, i1 false, i2 -1}
!158 = !{!"fixp", i32 -32, i32 18}
!159 = !{double 0.000000e+00, double 1.692000e+03}
!160 = !{!161, !159, i1 false, i2 -1}
!161 = !{!"fixp", i32 32, i32 19}
!162 = !{!158, !163, i1 false, i2 -1}
!163 = !{double 0.000000e+00, double 0x40AB2E14998D045F}
!164 = !{!161, !163, i1 false, i2 -1}
!165 = !{!161, !166, i1 false, i2 -1}
!166 = !{double 0.000000e+00, double 0x40B4330A4CC68230}
!167 = distinct !{!167, !23}
