; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-1024-fixed-11.out.ll.1.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,4836556.5) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [31 x i8] c"scalar(range(0.0,896.0) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,921.599976) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,950.857117) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [51 x i8] c"target('D') scalar(range(0.0,20595709952.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 1024), !taffo.initweight !47, !taffo.info !32, !taffo.originalCall !49
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 1024), !taffo.initweight !47, !taffo.info !34, !taffo.originalCall !49
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %4, i32 noundef 1024), !taffo.initweight !51, !taffo.info !38, !taffo.originalCall !52
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %5, i32 noundef 1024), !taffo.initweight !51, !taffo.info !40, !taffo.originalCall !52
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %6, i32 noundef 1024), !taffo.initweight !51, !taffo.info !42, !taffo.originalCall !52
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %7, i32 noundef 1024), !taffo.initweight !51, !taffo.info !44, !taffo.target !46, !taffo.originalCall !52
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %8, i32 noundef 1024), !taffo.initweight !51, !taffo.info !36, !taffo.originalCall !52
...
entry:
  ...
  %j = alloca i32, align 4, !taffo.initweight !31, !taffo.info !62
  ...
  %j2 = bitcast i32* %j to i8*, !taffo.initweight !47, !taffo.info !62
...
for.body:                                         ; preds = %for.cond
  store i32 0, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %4 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %5 = load i32, i32* %nk.addr, align 4
  %cmp4 = icmp slt i32 %4, %5, !taffo.initweight !50, !taffo.info !62
...
for.body5:                                        ; preds = %for.cond3
  ...
  %7 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  ...
  %div = fdiv float %conv, %conv6, !taffo.initweight !64, !taffo.info !60
  ...
  %12 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.inc:                                          ; preds = %for.body5
  %13 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %inc = add nsw i32 %13, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  %17 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %18 = load i32, i32* %nj.addr, align 4
  %cmp16 = icmp slt i32 %17, %18, !taffo.initweight !50, !taffo.info !62
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.initweight !51, !taffo.info !62

for.body18:                                       ; preds = %for.cond15
  %19 = load i32, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  %20 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %add19 = add nsw i32 %20, 1, !taffo.initweight !50, !taffo.info !62
  ...
  %25 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.inc27:                                        ; preds = %for.body18
  %26 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %inc28 = add nsw i32 %26, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc28, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond15, !llvm.loop !67
...
for.cond37:                                       ; preds = %for.inc50, %for.body36
  %30 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %31 = load i32, i32* %nl.addr, align 4
  %cmp38 = icmp slt i32 %30, %31, !taffo.initweight !50, !taffo.info !62
  br i1 %cmp38, label %for.body40, label %for.end52, !taffo.initweight !51, !taffo.info !62

for.body40:                                       ; preds = %for.cond37
  %32 = load i32, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  %33 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %add41 = add nsw i32 %33, 3, !taffo.initweight !50, !taffo.info !62
  ...
  %div47 = fdiv float %conv45, %conv46, !taffo.initweight !64, !taffo.info !60
  ...
  %38 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.inc50:                                        ; preds = %for.body40
  %39 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %inc51 = add nsw i32 %39, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc51, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.inc53:                                        ; preds = %for.end52
  ...
  br label %for.cond33, !llvm.loop !70
...
for.cond60:                                       ; preds = %for.inc72, %for.body59
  %43 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %44 = load i32, i32* %nl.addr, align 4
  %cmp61 = icmp slt i32 %43, %44, !taffo.initweight !50, !taffo.info !62
  br i1 %cmp61, label %for.body63, label %for.end74, !taffo.initweight !51, !taffo.info !62

for.body63:                                       ; preds = %for.cond60
  %45 = load i32, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  %46 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %add64 = add nsw i32 %46, 2, !taffo.initweight !50, !taffo.info !62
  ...
  %51 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.inc72:                                        ; preds = %for.body63
  %52 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %inc73 = add nsw i32 %52, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc73, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond60, !llvm.loop !71
...
for.inc75:                                        ; preds = %for.end74
  ...
  br label %for.cond56, !llvm.loop !72
...
for.cond82:                                       ; preds = %for.inc88, %for.body81
  %56 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %57 = load i32, i32* %nj.addr, align 4
  %cmp83 = icmp slt i32 %56, %57, !taffo.initweight !50, !taffo.info !62
  br i1 %cmp83, label %for.body85, label %for.end90, !taffo.initweight !51, !taffo.info !62
...
for.body85:                                       ; preds = %for.cond82
  ...
  %60 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
...
for.inc88:                                        ; preds = %for.body85
  %61 = load i32, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  %inc89 = add nsw i32 %61, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc89, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond82, !llvm.loop !73
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_2mm(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, float noundef %alpha, float noundef %beta, [10 x float]* noundef %tmp, [12 x float]* noundef %A, [10 x float]* noundef %B, [14 x float]* noundef %C, [14 x float]* noundef %D) #0 !taffo.initweight !57 !taffo.equivalentChild !75 !taffo.funinfo !59 {
entry:
  %ni.addr = alloca i32, align 4
  %nj.addr = alloca i32, align 4
  %nk.addr = alloca i32, align 4
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.1(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !84 !taffo.sourceFunction !49 !taffo.funinfo !85 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_scalar.2(float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !84 !taffo.sourceFunction !49 !taffo.funinfo !86 {
entry:
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_2mm.3(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, float noundef %alpha, float noundef %beta, [10 x float]* noundef %tmp, [12 x float]* noundef %A, [10 x float]* noundef %B, [14 x float]* noundef %C, [14 x float]* noundef %D) #0 !taffo.initweight !87 !taffo.sourceFunction !53 !taffo.funinfo !88 {
entry:
  %ni.addr = alloca i32, align 4
  %nj.addr = alloca i32, align 4
  %nk.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %6, !taffo.initweight !64, !taffo.info !36
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !9, !taffo.info !10
  store i32 0, i32* %k, align 4
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  ...
  %12 = load i32, i32* %k, align 4
  %arrayidx9 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx8, i32 0, i32 %12, !taffo.initweight !64, !taffo.info !38
  %13 = load float, float* %arrayidx9, align 4, !taffo.initweight !89, !taffo.info !38
  ...
  %16 = load i32, i32* %j, align 4
  %arrayidx11 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx10, i32 0, i32 %16, !taffo.initweight !64, !taffo.info !40
  %17 = load float, float* %arrayidx11, align 4, !taffo.initweight !89, !taffo.info !40
  %mul12 = fmul float %mul, %17, !taffo.initweight !64, !taffo.info !32
  ...
  %20 = load i32, i32* %j, align 4
  %arrayidx14 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx13, i32 0, i32 %20, !taffo.initweight !64, !taffo.info !36
  %21 = load float, float* %arrayidx14, align 4, !taffo.initweight !89, !taffo.info !36
  %add = fadd float %21, %mul12, !taffo.initweight !89, !taffo.info !32
  store float %add, float* %arrayidx14, align 4, !taffo.initweight !89, !taffo.info !36
  br label %for.inc
...
for.body26:                                       ; preds = %for.cond24
  ...
  %32 = load i32, i32* %j, align 4
  %arrayidx28 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx27, i32 0, i32 %32, !taffo.initweight !64, !taffo.info !44
  %33 = load float, float* %arrayidx28, align 4, !taffo.initweight !89, !taffo.info !44
  %mul29 = fmul float %33, %29, !taffo.initweight !9, !taffo.info !34
  store float %mul29, float* %arrayidx28, align 4, !taffo.initweight !64, !taffo.info !34
  store i32 0, i32* %k, align 4
  br label %for.cond30
...
for.body32:                                       ; preds = %for.cond30
  ...
  %38 = load i32, i32* %k, align 4
  %arrayidx34 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx33, i32 0, i32 %38, !taffo.initweight !64, !taffo.info !36
  %39 = load float, float* %arrayidx34, align 4, !taffo.initweight !89, !taffo.info !36
  ...
  %42 = load i32, i32* %j, align 4
  %arrayidx36 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx35, i32 0, i32 %42, !taffo.initweight !64, !taffo.info !42
  %43 = load float, float* %arrayidx36, align 4, !taffo.initweight !89, !taffo.info !42
  %mul37 = fmul float %39, %43, !taffo.initweight !93, !taffo.info !36
  ...
  %46 = load i32, i32* %j, align 4
  %arrayidx39 = getelementptr inbounds [14 x float], [14 x float]* %arrayidx38, i32 0, i32 %46, !taffo.initweight !64, !taffo.info !44
  %47 = load float, float* %arrayidx39, align 4, !taffo.initweight !89, !taffo.info !44
  %add40 = fadd float %47, %mul37, !taffo.initweight !93, !taffo.info !44
  store float %add40, float* %arrayidx39, align 4, !taffo.initweight !89, !taffo.info !44
  br label %for.inc41
...
for.inc41:                                        ; preds = %for.body32
  ...
  %inc42 = add nsw i32 %48, 1
  store i32 %inc42, i32* %k, align 4
  br label %for.cond30, !llvm.loop !94
...
for.inc44:                                        ; preds = %for.end43
  ...
  %inc45 = add nsw i32 %49, 1
  store i32 %inc45, i32* %j, align 4
  br label %for.cond24, !llvm.loop !95
...
for.inc47:                                        ; preds = %for.end46
  ...
  %inc48 = add nsw i32 %50, 1
  store i32 %inc48, i32* %i, align 4
  br label %for.cond21, !llvm.loop !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %nl, float* noundef %alpha, float* noundef %beta, [12 x float]* noundef %A, [10 x float]* noundef %B, [14 x float]* noundef %C, [14 x float]* noundef %D, [10 x float]* noundef %tmp) #0 !taffo.initweight !97 !taffo.sourceFunction !48 !taffo.funinfo !98 {
entry:
  %ni.addr = alloca i32, align 4
  %nj.addr = alloca i32, align 4
  %nk.addr = alloca i32, align 4
...
for.inc27:                                        ; preds = %for.body18
  ...
  %inc28 = add nsw i32 %26, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc28, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond15, !llvm.loop !101
...
for.inc30:                                        ; preds = %for.end29
  ...
  %inc31 = add nsw i32 %27, 1, !taffo.initweight !50, !taffo.info !60
  store i32 %inc31, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  br label %for.cond11, !llvm.loop !102
...
for.inc53:                                        ; preds = %for.end52
  ...
  %inc54 = add nsw i32 %40, 1, !taffo.initweight !50, !taffo.info !60
  store i32 %inc54, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  br label %for.cond33, !llvm.loop !104
...
for.inc72:                                        ; preds = %for.body63
  ...
  %inc73 = add nsw i32 %52, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc73, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond60, !llvm.loop !105
...
for.inc75:                                        ; preds = %for.end74
  ...
  %inc76 = add nsw i32 %53, 1, !taffo.initweight !50, !taffo.info !60
  store i32 %inc76, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  br label %for.cond56, !llvm.loop !106
...
for.inc88:                                        ; preds = %for.body85
  ...
  %inc89 = add nsw i32 %61, 1, !taffo.initweight !50, !taffo.info !62
  store i32 %inc89, i32* %j, align 4, !taffo.initweight !47, !taffo.info !62
  br label %for.cond82, !llvm.loop !107
...
for.inc91:                                        ; preds = %for.end90
  ...
  %inc92 = add nsw i32 %62, 1, !taffo.initweight !50, !taffo.info !60
  store i32 %inc92, i32* %i, align 4, !taffo.initweight !47, !taffo.info !60
  br label %for.cond78, !llvm.loop !108
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !109 !taffo.sourceFunction !52 !taffo.funinfo !110 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !64, !taffo.info !36
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !89, !taffo.info !36
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !93, !taffo.info !36
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !111, !taffo.info !36
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !36
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !64, !taffo.info !36
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !89, !taffo.info !36
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !93, !taffo.info !36
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !109 !taffo.sourceFunction !52 !taffo.funinfo !114 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !64, !taffo.info !38
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !89, !taffo.info !38
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !93, !taffo.info !38
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !111, !taffo.info !38
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !38
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !64, !taffo.info !38
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !89, !taffo.info !38
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !93, !taffo.info !38
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !109 !taffo.sourceFunction !52 !taffo.funinfo !117 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !64, !taffo.info !40
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !89, !taffo.info !40
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !93, !taffo.info !40
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !111, !taffo.info !40
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !40
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !64, !taffo.info !40
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !89, !taffo.info !40
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !93, !taffo.info !40
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !109 !taffo.sourceFunction !52 !taffo.funinfo !120 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !64, !taffo.info !42
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !89, !taffo.info !42
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !93, !taffo.info !42
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !111, !taffo.info !42
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !42
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !64, !taffo.info !42
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !89, !taffo.info !42
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !93, !taffo.info !42
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !109 !taffo.sourceFunction !52 !taffo.funinfo !123 {
entry:
  %n.addr = alloca i32, align 4
  %m.addr = alloca i32, align 4
...
for.body3:                                        ; preds = %for.cond1
  ...
  %7 = load i32, i32* %i, align 4
  %8 = mul nsw i32 %7, %1
  %arrayidx = getelementptr inbounds float, float* %6, i32 %8, !taffo.initweight !64, !taffo.info !44
  %9 = load i32, i32* %j, align 4
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %9, !taffo.initweight !89, !taffo.info !44
  %10 = load float, float* %arrayidx4, align 4, !taffo.initweight !93, !taffo.info !44
  %11 = load i32, i32* %factor.addr, align 4
  %conv = sitofp i32 %11 to float
  %mul = fmul float %10, %conv, !taffo.initweight !111, !taffo.info !44
  %12 = load float*, float** %val.addr, align 4, !taffo.initweight !9, !taffo.info !44
  %13 = load i32, i32* %i, align 4
  %14 = mul nsw i32 %13, %1
  %arrayidx5 = getelementptr inbounds float, float* %12, i32 %14, !taffo.initweight !64, !taffo.info !44
  %15 = load i32, i32* %j, align 4
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %15, !taffo.initweight !89, !taffo.info !44
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !93, !taffo.info !44
  br label %for.inc
...
!37 = !{double 0.000000e+00, double 0x4152733320000000}
!38 = !{i1 false, !39, i1 false, i2 -1}
!39 = !{double 0.000000e+00, double 8.960000e+02}
!40 = !{i1 false, !41, i1 false, i2 -1}
!41 = !{double 0.000000e+00, double 0x408CCCCCC0379314}
!42 = !{i1 false, !43, i1 false, i2 -1}
!43 = !{double 0.000000e+00, double 0x408DB6DB60285EC4}
!44 = !{i1 false, !45, i1 false, i2 -1}
!45 = !{double 0.000000e+00, double 0x42132E6660000000}
!46 = !{!"D"}
!47 = !{i32 1}
...
!63 = !{double 0.000000e+00, double 1.400000e+01}
!64 = !{i32 6}
!65 = distinct !{!65, !12}
!66 = distinct !{!66, !12}
!67 = distinct !{!67, !12}
...
!73 = distinct !{!73, !12}
!74 = distinct !{!74, !12}
!75 = !{void (i32, i32, i32, i32, float, float, [10 x float]*, [12 x float]*, [10 x float]*, [14 x float]*, [14 x float]*)* @kernel_2mm.3}
!76 = distinct !{!76, !12}
!77 = distinct !{!77, !12}
!78 = distinct !{!78, !12}
!79 = distinct !{!79, !12}
...
!83 = distinct !{!83, !12}
!84 = !{i32 1, i32 -1}
!85 = !{i32 1, !32, i32 0, i1 false}
!86 = !{i32 1, !34, i32 0, i1 false}
!87 = !{i32 -1, i32 -1, i32 -1, i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!88 = !{i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 1, !32, i32 1, !34, i32 1, !36, i32 1, !38, i32 1, !40, i32 1, !42, i32 1, !44}
!89 = !{i32 7}
!90 = distinct !{!90, !12}
!91 = distinct !{!91, !12}
!92 = distinct !{!92, !12}
...
!98 = !{i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 0, i1 false, i32 1, !32, i32 1, !34, i32 1, !38, i32 1, !40, i32 1, !42, i32 1, !44, i32 1, !36}
!99 = distinct !{!99, !12}
!100 = distinct !{!100, !12}
!101 = distinct !{!101, !12}
!102 = distinct !{!102, !12}
...
!107 = distinct !{!107, !12}
!108 = distinct !{!108, !12}
!109 = !{i32 -1, i32 -1, i32 3, i32 -1}
!110 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !36, i32 0, i1 false}
!111 = !{i32 9}
!112 = distinct !{!112, !12}
!113 = distinct !{!113, !12}
!114 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !38, i32 0, i1 false}
!115 = distinct !{!115, !12}
!116 = distinct !{!116, !12}
!117 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !40, i32 0, i1 false}
!118 = distinct !{!118, !12}
!119 = distinct !{!119, !12}
!120 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !42, i32 0, i1 false}
!121 = distinct !{!121, !12}
!122 = distinct !{!122, !12}
!123 = !{i32 0, i1 false, i32 0, i1 false, i32 1, !44, i32 0, i1 false}
!124 = distinct !{!124, !12}
!125 = distinct !{!125, !12}
