; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-16-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,15.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,1128.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [49 x i8] c"target('y') scalar(range(0.0,2899.200195) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 16), !taffo.initweight !60, !taffo.info !50, !taffo.originalCall !63, !taffo.constinfo !64
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 16), !taffo.initweight !60, !taffo.info !52, !taffo.originalCall !63, !taffo.constinfo !64
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 16), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  ...
  call void @scale_2d.9(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 16), !taffo.initweight !66, !taffo.info !54, !taffo.originalCall !67, !taffo.constinfo !68
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.initweight !60, !taffo.info !56
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 16), !taffo.initweight !65, !taffo.info !56, !taffo.originalCall !69, !taffo.constinfo !70
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.initweight !60, !taffo.info !54
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 16), !taffo.initweight !65, !taffo.info !54, !taffo.originalCall !69, !taffo.constinfo !70
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 16), !taffo.initweight !65, !taffo.info !58, !taffo.target !59, !taffo.originalCall !69, !taffo.constinfo !70
...
for.body:                                         ; preds = %for.cond
  ...
  %div = fdiv float %conv, %conv3, !taffo.initweight !90, !taffo.info !146
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.initweight !65, !taffo.info !145
  store float %div, float* %arrayidx, align 4, !taffo.initweight !66, !taffo.info !91
  %arrayidx4 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.initweight !65, !taffo.info !148
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.initweight !66, !taffo.info !91, !taffo.constinfo !92
  %arrayidx5 = getelementptr inbounds float, float* %tmp, i32 %i.0, !taffo.initweight !65, !taffo.info !149
  store float 0.000000e+00, float* %arrayidx5, align 4, !taffo.initweight !66, !taffo.info !91, !taffo.constinfo !92
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  %mul = mul nsw i32 %i.0, %j.0, !taffo.initweight !65, !taffo.info !150
  %add = add nsw i32 %mul, 1, !taffo.initweight !66, !taffo.info !152, !taffo.constinfo !27
  ...
  %div13 = fdiv float %conv11, %conv12, !taffo.initweight !96, !taffo.info !146
  %arrayidx14 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.0, !taffo.initweight !65, !taffo.info !145
  %arrayidx15 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx14, i32 0, i32 %j.0, !taffo.initweight !65, !taffo.info !145
  store float %div13, float* %arrayidx15, align 4, !taffo.initweight !66, !taffo.info !91
  %mul16 = mul nsw i32 %i.0, %j.0, !taffo.initweight !65, !taffo.info !150
  %add17 = add nsw i32 %mul16, 2, !taffo.initweight !66, !taffo.info !154, !taffo.constinfo !27
  ...
  %div21 = fdiv float %conv19, %conv20, !taffo.initweight !96, !taffo.info !146
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !65, !taffo.info !145
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.0, !taffo.initweight !65, !taffo.info !145
  store float %div21, float* %arrayidx23, align 4, !taffo.initweight !66, !taffo.info !91
  br label %for.inc

for.inc:                                          ; preds = %for.body9
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !65, !taffo.info !156, !taffo.constinfo !27
  br label %for.cond6, !llvm.loop !157

for.end:                                          ; preds = %for.cond6
  br label %for.inc24

for.inc24:                                        ; preds = %for.end
  %inc25 = add nsw i32 %i.0, 1, !taffo.initweight !65, !taffo.info !156, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.8(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !159 !taffo.funinfo !160 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !161, !taffo.info !54
  %conv = sitofp i32 %factor to float, !taffo.info !103
  %mul = fmul float %1, %conv, !taffo.initweight !162, !taffo.info !118
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !161, !taffo.info !54
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !159 !taffo.funinfo !160 !taffo.sourceFunction !67 {
entry:
  br label %for.cond
...
!7 = !{double 0.000000e+00, double 0x40A6A6667FF583A5}
...
!55 = !{double 0.000000e+00, double 1.500000e+01}
!56 = !{i1 false, !57, i1 false, i2 -1}
!57 = !{double 0.000000e+00, double 1.128000e+03}
...
!107 = distinct !{!107, !29}
!108 = !{i32 1, i32 -1}
!109 = !{i32 1, !50, i32 1, !103}
!110 = !{i32 1, !52, i32 1, !103}
!111 = !{i32 -1, i32 2, i32 -1}
!112 = !{i32 1, !103, i32 1, !56, i32 1, !103}
!113 = !{i32 7}
!114 = !{i1 false, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 1.804800e+04}
!116 = distinct !{!116, !29}
!117 = !{i32 1, !103, i32 1, !54, i32 1, !103}
!118 = !{i1 false, !119, i1 false, i2 -1}
!119 = !{double 0.000000e+00, double 2.400000e+02}
!120 = distinct !{!120, !29}
...
!124 = !{double 0.000000e+00, double 2.250000e+02}
!125 = !{i1 false, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 1.353000e+03}
!127 = !{i1 false, !128, i1 false, i2 -1}
!128 = !{double 0.000000e+00, double 0x40A868667FF583A5}
!129 = distinct !{!129, !29}
!130 = !{i1 false, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 1.692000e+03}
!132 = !{i1 false, !133, i1 false, i2 -1}
!133 = !{double 0.000000e+00, double 0x40AB2E14998D045F}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 0x40B4330A4CC68230}
!136 = distinct !{!136, !29}
!137 = !{i32 1, !103, i32 1, !58, i32 1, !103}
!138 = !{i1 false, !139, i1 false, i2 -1}
!139 = !{double 0.000000e+00, double 0x40E6A6667FF583A5}
!140 = distinct !{!140, !29}
