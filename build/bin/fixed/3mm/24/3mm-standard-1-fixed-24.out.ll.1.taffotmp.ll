...
entry:
  ...
  call void @llvm.var.annotation(i8* %B3, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i32 145, i8* null)
...
for.body23:                                       ; preds = %for.cond21
  ...
  %arrayidx = getelementptr inbounds [6 x [12 x float]], [6 x [12 x float]]* %G, i32 0, i32 %14
  %15 = load i32, i32* %j, align 4
  %arrayidx24 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %15
  ...
  store float %16, float* %arrayidx26, align 4
  br label %for.inc
...
for.inc93:                                        ; preds = %for.body90
  ...
  br label %for.cond87, !llvm.loop !19
...
for.inc128:                                       ; preds = %for.end127
  ...
  br label %for.cond115, !llvm.loop !24
