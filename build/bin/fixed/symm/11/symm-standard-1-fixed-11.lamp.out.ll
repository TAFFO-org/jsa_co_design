; ModuleID = './build/bin/fixed/symm/11/symm-standard-1-fixed-11.out.ll'
...
for.body13:                                       ; preds = %for.cond11
  ...
  %2 = fdiv float %lampsim2, 0x4190000000000000, !taffo.info !33, !taffo.target !35
  ...
  store float %lampsim5, float* %arrayidx16, align 4, !taffo.info !52, !taffo.target !35
  br label %for.inc
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !59
  br label %for.inc
