; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-1024-fixed-16.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim10 = and i32 %lampsim9, -256
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !140
...
for.body51:                                       ; preds = %for.cond49
  ...
  %lampsim1 = and i32 %lampsim, -256
  %lampsim2 = bitcast i32 %lampsim1 to float
  %29 = fdiv float %lampsim2, 8.192000e+03, !taffo.info !193
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim4 = and i32 %lampsim3, -256
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !203
