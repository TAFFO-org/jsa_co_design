; ModuleID = './build/stats/gemver/128/gemver-standard-128.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.2(float* noundef %alpha, i32 noundef 128), !taffo.originalCall !29
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 128), !taffo.originalCall !29
  ...
  call void @scale_2d.11(i32 noundef 20, i32 noundef 20, float* noundef %1, i32 noundef 128), !taffo.originalCall !30
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i64 0, i64 0
  call void @scale_1d.10(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 128), !taffo.originalCall !31
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i64 0, i64 0
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 128), !taffo.originalCall !31
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i64 0, i64 0
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 128), !taffo.originalCall !31
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i64 0, i64 0
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 128), !taffo.originalCall !31
  %arraydecay25 = getelementptr inbounds [20 x float], [20 x float]* %w, i64 0, i64 0
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 128), !taffo.originalCall !31
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i64 0, i64 0
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 128), !taffo.originalCall !31
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i64 0, i64 0
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 128), !taffo.originalCall !31
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i64 0, i64 0
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 128), !taffo.originalCall !31
