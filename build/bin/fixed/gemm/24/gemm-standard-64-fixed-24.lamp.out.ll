; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-64-fixed-24.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u15_17fixp, [16 x i32]* noundef %A.u6_26fixp, [12 x i32]* noundef %B.u6_26fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 16), !taffo.info !96
  %mul.u15_17fixp = shl i32 %3, 1, !taffo.info !99
...
for.body10:                                       ; preds = %for.cond8
  ...
  %5 = lshr i32 %u6_26fixp, 1, !taffo.info !101
  %6 = ashr i32 %4, 5, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !101
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 24), !taffo.info !103
  %mul13.u7_25fixp = shl i32 %8, 1, !taffo.info !106
  ...
  %9 = lshr i32 %mul13.u7_25fixp, 1, !taffo.info !106
  %10 = lshr i32 %u6_26fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 8, !taffo.info !106
  %12 = ashr i32 %10, 9, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 16), !taffo.info !107
  %mul16.u15_17fixp = shl i32 %13, 1, !taffo.info !109
  ...
  %add.u15_17fixp = add i32 %u15_17fixp1, %mul16.u15_17fixp, !taffo.info !110
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u15_17fixp, [16 x i32]* noundef %A.u6_26fixp, [12 x i32]* noundef %B.u6_26fixp) #0 !taffo.initweight !115 !taffo.funinfo !92 !taffo.sourceFunction !116 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u15_17fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u15_17fixp, i32 %i.0, !taffo.info !145
  %arrayidx7.u15_17fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u15_17fixp, i32 0, i32 %j.0, !taffo.info !145
  %3 = lshr i32 %div.u1_31fixp, 14, !taffo.info !143
  store i32 %3, i32* %arrayidx7.u15_17fixp, align 4, !taffo.info !146
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u6_26fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u6_26fixp, i32 %i.1, !taffo.info !162
  %arrayidx26.u6_26fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u6_26fixp, i32 0, i32 %j.1, !taffo.info !162
  %8 = lshr i32 %div24.u1_31fixp, 5, !taffo.info !161
  store i32 %8, i32* %arrayidx26.u6_26fixp, align 4, !taffo.info !146
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx47.u6_26fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u6_26fixp, i32 %i.2, !taffo.info !175
  %arrayidx48.u6_26fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u6_26fixp, i32 0, i32 %j.2, !taffo.info !175
  %12 = lshr i32 %div46.u1_31fixp, 5, !taffo.info !174
  store i32 %12, i32* %arrayidx48.u6_26fixp, align 4, !taffo.info !146
  br label %for.inc49
...
!98 = !{double 0.000000e+00, double 0x40DE126E8CCC2BBC}
...
!108 = !{double 0.000000e+00, double 0x40B4A00007DD4413}
!109 = !{!48, !108, i1 false, i2 -1}
!110 = !{!48, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 0x40DE375C21F6CACD}
!112 = distinct !{!112, !23}
!113 = distinct !{!113, !23}
!114 = distinct !{!114, !23}
