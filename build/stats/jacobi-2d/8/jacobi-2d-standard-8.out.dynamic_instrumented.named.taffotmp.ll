; ModuleID = './build/stats/jacobi-2d/8/jacobi-2d-standard-8.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.2(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 8), !taffo.originalCall !27
  ...
  call void @scale_2d.1(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 8), !taffo.originalCall !27
