; ModuleID = './build/bin/fixed/ludcmp/8/ludcmp-standard-8-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.s7_25fixp = call i32 @llvm.smul.fix.i32(i32 %1, i32 %2, i32 25), !taffo.info !88
  %arrayidx1.s4_28fixp = getelementptr inbounds i32, i32* %val.s4_28fixp, i32 %i.0, !taffo.info !50
  %3 = shl i32 %mul.s7_25fixp, 3, !taffo.info !88
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !81 !taffo.funinfo !92 !taffo.sourceFunction !85 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u9_23fixp, 3, !taffo.info !96
...
!89 = !{!"fixp", i32 -32, i32 25}
!90 = !{double -3.035760e-01, double 0x403FFCF893FAF428}
!91 = distinct !{!91, !23}
!92 = !{i32 1, !74, i32 1, !47, i32 1, !83}
!93 = !{!94, !95, i1 false, i2 -1}
!94 = !{!"fixp", i32 -32, i32 22}
!95 = !{double 0x40701999A1FD156A, double 2.880000e+02}
...
!132 = !{!94, !104, i1 false, i2 -1}
!133 = !{!94, !134, i1 false, i2 -1}
