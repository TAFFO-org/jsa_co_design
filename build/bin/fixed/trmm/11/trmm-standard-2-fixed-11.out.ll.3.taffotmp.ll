; ModuleID = './build/bin/fixed/trmm/11/trmm-standard-2-fixed-11.out.ll.2.taffotmp.ll'
...
@.str.2 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,2.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.3 = private unnamed_addr constant [45 x i8] c"target('B') scalar(range(0.0,21.9375) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 2), !taffo.initweight !55, !taffo.info !49, !taffo.originalCall !58, !taffo.constinfo !59
  ...
  call void @scale_2d.4(i32 noundef 10, i32 noundef 10, float* noundef %0, i32 noundef 2), !taffo.initweight !61, !taffo.info !51, !taffo.originalCall !62, !taffo.constinfo !63
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 2), !taffo.initweight !61, !taffo.info !53, !taffo.target !54, !taffo.originalCall !62, !taffo.constinfo !63
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_trmm.2(i32 noundef %m, i32 noundef %n, float noundef %alpha, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !109 !taffo.funinfo !110 !taffo.sourceFunction !65 {
entry:
  br label %for.cond
...
for.cond4:                                        ; preds = %for.inc, %for.body3
  %k.0 = phi i32 [ %add, %for.body3 ], [ %inc, %for.inc ], !taffo.info !111
...
for.body6:                                        ; preds = %for.cond4
  ...
  %0 = load float, float* %arrayidx7, align 4, !taffo.initweight !113, !taffo.info !51
  ...
  %1 = load float, float* %arrayidx9, align 4, !taffo.initweight !113, !taffo.info !53
  ...
  %2 = load float, float* %arrayidx11, align 4, !taffo.initweight !113, !taffo.info !53
  %add12 = fadd float %2, %mul, !taffo.initweight !114, !taffo.info !117
  store float %add12, float* %arrayidx11, align 4, !taffo.initweight !113, !taffo.info !53
  br label %for.inc
...
for.end:                                          ; preds = %for.cond4
  ...
  %3 = load float, float* %arrayidx14, align 4, !taffo.initweight !113, !taffo.info !53
  %mul15 = fmul float %alpha, %3, !taffo.initweight !86, !taffo.info !120
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.3(i32 noundef %m, i32 noundef %n, float* noundef %alpha, [10 x float]* noundef %A, [16 x float]* noundef %B) #0 !taffo.initweight !124 !taffo.funinfo !110 !taffo.sourceFunction !56 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.initweight !72, !taffo.info !49, !taffo.constinfo !81
  br label %for.cond

for.cond:                                         ; preds = %for.inc27, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc28, %for.inc27 ], !taffo.initweight !48, !taffo.info !125
  %cmp = icmp slt i32 %i.0, %m, !taffo.initweight !60, !taffo.info !126
  br i1 %cmp, label %for.body, label %for.end29, !taffo.initweight !61, !taffo.info !83
...
for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.initweight !48, !taffo.info !127
  %cmp4 = icmp slt i32 %j.0, %m, !taffo.initweight !60, !taffo.info !126
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.initweight !61, !taffo.info !84

for.body5:                                        ; preds = %for.cond3
  %cmp6 = icmp slt i32 %j.0, %i.0, !taffo.initweight !60, !taffo.info !126
  br i1 %cmp6, label %if.then, label %if.else, !taffo.initweight !61, !taffo.info !83

if.then:                                          ; preds = %for.body5
  %add = add nsw i32 %i.0, %j.0, !taffo.initweight !60, !taffo.info !129
  %rem = srem i32 %add, %m, !taffo.initweight !61, !taffo.info !131
  %conv = sitofp i32 %rem to float, !taffo.initweight !72, !taffo.info !131
  %conv7 = sitofp i32 %m to float, !taffo.info !22
  %div = fdiv float %conv, %conv7, !taffo.initweight !86, !taffo.info !133
  %arrayidx = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !60, !taffo.info !135
  %arrayidx8 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.initweight !60, !taffo.info !135
  store float %div, float* %arrayidx8, align 4, !taffo.initweight !61, !taffo.info !87
  br label %if.end

if.else:                                          ; preds = %for.body5
  %arrayidx9 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !60, !taffo.info !135
  %arrayidx10 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx9, i32 0, i32 %j.0, !taffo.initweight !60, !taffo.info !135
  store float 0.000000e+00, float* %arrayidx10, align 4, !taffo.initweight !61, !taffo.info !87, !taffo.constinfo !88
  br label %if.end
...
for.inc:                                          ; preds = %if.end
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !60, !taffo.info !136, !taffo.constinfo !27
  br label %for.cond3, !llvm.loop !138

for.end:                                          ; preds = %for.cond3
  %arrayidx11 = getelementptr inbounds [10 x float], [10 x float]* %A, i32 %i.0, !taffo.initweight !60, !taffo.info !135
  %arrayidx12 = getelementptr inbounds [10 x float], [10 x float]* %arrayidx11, i32 0, i32 %i.0, !taffo.initweight !60, !taffo.info !135
  store float 1.000000e+00, float* %arrayidx12, align 4, !taffo.initweight !61, !taffo.info !87, !taffo.constinfo !92
  br label %for.cond13

for.cond13:                                       ; preds = %for.inc24, %for.end
  %j.1 = phi i32 [ 0, %for.end ], [ %inc25, %for.inc24 ], !taffo.initweight !48, !taffo.info !127
  %cmp14 = icmp slt i32 %j.1, %n, !taffo.initweight !60, !taffo.info !126
  br i1 %cmp14, label %for.body16, label %for.end26, !taffo.initweight !61, !taffo.info !84

for.body16:                                       ; preds = %for.cond13
  %sub = sub nsw i32 %i.0, %j.1, !taffo.initweight !60, !taffo.info !139
  %add17 = add nsw i32 %n, %sub, !taffo.initweight !61, !taffo.info !129
  %rem18 = srem i32 %add17, %n, !taffo.initweight !72, !taffo.info !141
  %conv19 = sitofp i32 %rem18 to float, !taffo.initweight !86, !taffo.info !141
  %conv20 = sitofp i32 %n to float, !taffo.info !103
  %div21 = fdiv float %conv19, %conv20, !taffo.initweight !95, !taffo.info !143
  %arrayidx22 = getelementptr inbounds [16 x float], [16 x float]* %B, i32 %i.0, !taffo.initweight !60, !taffo.info !145
  %arrayidx23 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx22, i32 0, i32 %j.1, !taffo.initweight !60, !taffo.info !145
  store float %div21, float* %arrayidx23, align 4, !taffo.initweight !61, !taffo.info !87
  br label %for.inc24

for.inc24:                                        ; preds = %for.body16
  %inc25 = add nsw i32 %j.1, 1, !taffo.initweight !60, !taffo.info !136, !taffo.constinfo !27
...
for.inc27:                                        ; preds = %for.end26
  %inc28 = add nsw i32 %i.0, 1, !taffo.initweight !60, !taffo.info !147, !taffo.constinfo !27
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.4(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !149 !taffo.funinfo !150 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !113, !taffo.info !51
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !114, !taffo.info !51
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !151, !taffo.info !152
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !113, !taffo.info !51
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !114, !taffo.info !51
  br label %for.inc

for.inc:                                          ; preds = %for.body3
  %inc = add nsw i32 %j.0, 1, !taffo.info !93, !taffo.constinfo !27
  br label %for.cond1, !llvm.loop !154
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !149 !taffo.funinfo !156 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.initweight !113, !taffo.info !53
  %1 = load float, float* %arrayidx4, align 4, !taffo.initweight !114, !taffo.info !53
  %conv = sitofp i32 %factor to float, !taffo.info !25
  %mul = fmul float %1, %conv, !taffo.initweight !151, !taffo.info !115
  %2 = mul nsw i32 %i.0, %m, !taffo.info !89
  %arrayidx5 = getelementptr inbounds float, float* %val, i32 %2, !taffo.initweight !95, !taffo.info !53
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.initweight !113, !taffo.info !53
  store float %mul, float* %arrayidx6, align 4, !taffo.initweight !114, !taffo.info !53
  br label %for.inc
...
!7 = !{double 0.000000e+00, double 2.193750e+01}
...
!52 = !{double 0.000000e+00, double 2.000000e+00}
...
!106 = distinct !{!106, !29}
!107 = !{i32 1, i32 -1}
!108 = !{i32 1, !49, i32 1, !25}
!109 = !{i32 -1, i32 -1, i32 2, i32 2, i32 2}
!110 = !{i32 1, !22, i32 1, !103, i32 1, !49, i32 1, !51, i32 1, !53}
!111 = !{i1 false, !112, i1 false, i2 0}
!112 = !{double 1.000000e+00, double 2.000000e+00}
!113 = !{i32 7}
!114 = !{i32 8}
!115 = !{i1 false, !116, i1 false, i2 -1}
!116 = !{double 0.000000e+00, double 4.387500e+01}
!117 = !{i1 false, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 6.581250e+01}
!119 = distinct !{!119, !29}
!120 = !{i1 false, !121, i1 false, i2 -1}
!121 = !{double 0.000000e+00, double 0x4040740000000000}
!122 = distinct !{!122, !29}
!123 = distinct !{!123, !29}
!124 = !{i32 -1, i32 -1, i32 1, i32 2, i32 2}
!125 = !{i1 false, !67, i1 false, i2 1}
!126 = !{i1 false, !69, i1 false, i2 1}
!127 = !{i1 false, !128, i1 false, i2 1}
!128 = !{double 0.000000e+00, double 1.700000e+01}
!129 = !{i1 false, !130, i1 false, i2 1}
!130 = !{double 0.000000e+00, double 2.600000e+01}
...
!135 = !{i1 false, !52, i1 false, i2 1}
!136 = !{i1 false, !137, i1 false, i2 1}
!137 = !{double 1.000000e+00, double 1.700000e+01}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 1}
!140 = !{double -1.600000e+01, double 1.000000e+01}
!141 = !{i1 false, !142, i1 false, i2 1}
!142 = !{double 0.000000e+00, double 1.500000e+01}
!143 = !{i1 false, !144, i1 false, i2 1}
!144 = !{double 0.000000e+00, double 9.375000e-01}
!145 = !{i1 false, !7, i1 false, i2 1}
!146 = distinct !{!146, !29}
!147 = !{i1 false, !77, i1 false, i2 1}
!148 = distinct !{!148, !29}
!149 = !{i32 -1, i32 -1, i32 3, i32 -1}
!150 = !{i32 1, !22, i32 1, !22, i32 1, !51, i32 1, !25}
!151 = !{i32 9}
!152 = !{i1 false, !153, i1 false, i2 -1}
!153 = !{double 0.000000e+00, double 4.000000e+00}
!154 = distinct !{!154, !29}
!155 = distinct !{!155, !29}
!156 = !{i32 1, !22, i32 1, !103, i32 1, !53, i32 1, !25}
!157 = distinct !{!157, !29}
!158 = distinct !{!158, !29}
