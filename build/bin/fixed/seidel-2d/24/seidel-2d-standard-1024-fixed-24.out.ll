; ModuleID = './build/bin/fixed/seidel-2d/24/seidel-2d-standard-1024-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  %A.u15_17fixp = alloca [20 x [20 x i32]], align 4, !taffo.info !41, !taffo.target !44
  %arraydecay.u15_17fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %A.u15_17fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  call void @init_array.2_fixp(i32 20, [20 x i32]* %arraydecay.u15_17fixp), !taffo.info !45, !taffo.constinfo !46, !taffo.target !44
  %arraydecay2.u15_17fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %A.u15_17fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  %u15_17fixp = bitcast [20 x i32]* %arraydecay2.u15_17fixp to i32*, !taffo.info !41, !taffo.target !44
  call void @scale_2d.3_fixp(i32 20, i32 20, i32* %u15_17fixp, i32 1024), !taffo.info !45, !taffo.constinfo !47, !taffo.target !44
  call void @timer_start(), !taffo.constinfo !48
  %arraydecay3.u15_17fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %A.u15_17fixp, i32 0, i32 0, !taffo.info !41, !taffo.target !44
  call void @kernel_seidel_2d.1_fixp(i32 10, i32 20, [20 x i32]* %arraydecay3.u15_17fixp), !taffo.info !45, !taffo.constinfo !49, !taffo.target !44
  br label %for.cond
...
for.body6:                                        ; preds = %for.cond4
  %arrayidx.u15_17fixp = getelementptr inbounds [20 x [20 x i32]], [20 x [20 x i32]]* %A.u15_17fixp, i32 0, i32 %i.0, !taffo.info !41, !taffo.target !44
  %arrayidx7.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u15_17fixp, i32 0, i32 %j.0, !taffo.info !41, !taffo.target !44
  %u15_17fixp1 = load i32, i32* %arrayidx7.u15_17fixp, align 4, !taffo.info !41, !taffo.target !44
  %0 = uitofp i32 %u15_17fixp1 to float, !taffo.info !41, !taffo.target !44
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_seidel_2d.1_fixp(i32 noundef %tsteps, i32 noundef %n, [20 x i32]* noundef %A.u15_17fixp) #0 !taffo.initweight !71 !taffo.funinfo !72 !taffo.sourceFunction !73 {
entry:
  br label %for.cond
...
for.body8:                                        ; preds = %for.cond5
  ...
  %arrayidx.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %sub10, !taffo.info !41
  %sub11 = sub nsw i32 %j.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx12.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u15_17fixp, i32 0, i32 %sub11, !taffo.info !41
  %u15_17fixp = load i32, i32* %arrayidx12.u15_17fixp, align 4, !taffo.info !80
  %sub13 = sub nsw i32 %i.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx14.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %sub13, !taffo.info !41
  %arrayidx15.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx14.u15_17fixp, i32 0, i32 %j.0, !taffo.info !41
  %u15_17fixp1 = load i32, i32* %arrayidx15.u15_17fixp, align 4, !taffo.info !80
  %0 = lshr i32 %u15_17fixp, 1, !taffo.info !80
  %1 = lshr i32 %u15_17fixp1, 1, !taffo.info !80
  %add.u16_16fixp = add i32 %0, %1, !taffo.info !82
  %sub16 = sub nsw i32 %i.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx17.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %sub16, !taffo.info !41
  %add18 = add nsw i32 %j.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx19.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx17.u15_17fixp, i32 0, i32 %add18, !taffo.info !41
  %u15_17fixp2 = load i32, i32* %arrayidx19.u15_17fixp, align 4, !taffo.info !80
  %2 = lshr i32 %add.u16_16fixp, 1, !taffo.info !82
  %3 = lshr i32 %u15_17fixp2, 2, !taffo.info !80
  %add20.u17_15fixp = add i32 %2, %3, !taffo.info !84
  %arrayidx21.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %i.0, !taffo.info !41
  %sub22 = sub nsw i32 %j.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx23.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx21.u15_17fixp, i32 0, i32 %sub22, !taffo.info !41
  %u15_17fixp3 = load i32, i32* %arrayidx23.u15_17fixp, align 4, !taffo.info !87
  %4 = lshr i32 %add20.u17_15fixp, 1, !taffo.info !84
  %5 = lshr i32 %u15_17fixp3, 3, !taffo.info !87
  %add24.u18_14fixp = add i32 %4, %5, !taffo.info !88
  %arrayidx26.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %i.0, !taffo.info !41
  %arrayidx27.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx26.u15_17fixp, i32 0, i32 %j.0, !taffo.info !41
  %u15_17fixp4 = load i32, i32* %arrayidx27.u15_17fixp, align 4, !taffo.info !80
  %arrayidx28.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %i.0, !taffo.info !41
  %add29 = add nsw i32 %j.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx30.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx28.u15_17fixp, i32 0, i32 %add29, !taffo.info !41
  %u15_17fixp5 = load i32, i32* %arrayidx30.u15_17fixp, align 4, !taffo.info !80
  %6 = lshr i32 %u15_17fixp4, 1, !taffo.info !80
  %7 = lshr i32 %u15_17fixp5, 1, !taffo.info !80
  %add31.u16_16fixp = add i32 %6, %7, !taffo.info !82
  %add32 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx33.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %add32, !taffo.info !41
  %sub34 = sub nsw i32 %j.0, 1, !taffo.info !67, !taffo.constinfo !21
  %arrayidx35.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx33.u15_17fixp, i32 0, i32 %sub34, !taffo.info !41
  %u15_17fixp6 = load i32, i32* %arrayidx35.u15_17fixp, align 4, !taffo.info !80
  %8 = lshr i32 %add31.u16_16fixp, 1, !taffo.info !82
  %9 = lshr i32 %u15_17fixp6, 2, !taffo.info !80
  %add36.u17_15fixp = add i32 %8, %9, !taffo.info !84
  %add37 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx38.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %add37, !taffo.info !41
  %arrayidx39.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx38.u15_17fixp, i32 0, i32 %j.0, !taffo.info !41
  %u15_17fixp7 = load i32, i32* %arrayidx39.u15_17fixp, align 4, !taffo.info !87
  %10 = lshr i32 %u15_17fixp7, 2, !taffo.info !87
  %add40.u17_15fixp = add i32 %add36.u17_15fixp, %10, !taffo.info !91
  %add41 = add nsw i32 %i.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx42.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %add41, !taffo.info !41
  %add43 = add nsw i32 %j.0, 1, !taffo.info !19, !taffo.constinfo !21
  %arrayidx44.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx42.u15_17fixp, i32 0, i32 %add43, !taffo.info !41
  %u15_17fixp8 = load i32, i32* %arrayidx44.u15_17fixp, align 4, !taffo.info !87
  %11 = lshr i32 %add40.u17_15fixp, 1, !taffo.info !91
  %12 = lshr i32 %u15_17fixp8, 3, !taffo.info !87
  %add45.u18_14fixp = add i32 %11, %12, !taffo.info !92
  %add47.u18_14fixp = add i32 %add24.u18_14fixp, %add45.u18_14fixp, !taffo.info !94
  %13 = lshr i32 %add47.u18_14fixp, 1, !taffo.info !94
  %14 = shl i32 9, 27
  %15 = ashr i32 %14, 14
  %16 = call i32 @llvm.sdiv.fix.i32(i32 %13, i32 %15, i32 13), !taffo.info !96
  %div49.u15_17fixp = shl i32 %16, 4, !taffo.info !98, !taffo.constinfo !99
  %arrayidx50.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %i.0, !taffo.info !41
  %arrayidx51.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx50.u15_17fixp, i32 0, i32 %j.0, !taffo.info !41
  store i32 %div49.u15_17fixp, i32* %arrayidx51.u15_17fixp, align 4, !taffo.info !100
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.2_fixp(i32 noundef %n, [20 x i32]* noundef %A.u15_17fixp) #0 !taffo.initweight !104 !taffo.funinfo !105 !taffo.sourceFunction !106 {
entry:
  br label %for.cond
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %A.u15_17fixp, i32 %i.0, !taffo.info !98
  %arrayidx9.u15_17fixp = getelementptr inbounds [20 x i32], [20 x i32]* %arrayidx.u15_17fixp, i32 0, i32 %j.0, !taffo.info !98
  %5 = ashr i32 %div.s6_26fixp, 9, !taffo.info !127
  store i32 %5, i32* %arrayidx9.u15_17fixp, align 4, !taffo.info !100
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.3_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !132 !taffo.funinfo !133 !taffo.sourceFunction !136 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u11_21fixp = shl i32 %factor, 21, !taffo.info !137
  %1 = lshr i32 %u15_17fixp, 1, !taffo.info !41
  %2 = lshr i32 %conv.u11_21fixp, 1, !taffo.info !137
  %3 = ashr i32 %1, 10, !taffo.info !41
  %4 = ashr i32 %2, 14, !taffo.info !137
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 6), !taffo.info !139
  %mul.u25_7fixp = shl i32 %5, 1, !taffo.info !142
  ...
  %7 = shl i32 %mul.u25_7fixp, 10, !taffo.info !142
  store i32 %7, i32* %arrayidx6.u15_17fixp, align 4, !taffo.info !45
  br label %for.inc
...
!1 = !{double 0.000000e+00, double 0x40D40CCCC0010C6F}
...
!43 = !{double 0x40599999A1FD156A, double 0x40D40CCCC0010C6F}
!44 = !{!"A"}
...
!83 = !{double 0x40699999A1FD156A, double 0x40E40CCCC0010C6F}
!84 = !{!85, !86, i1 false, i2 -1}
!85 = !{!"fixp", i32 32, i32 15}
!86 = !{double 0x40733333397DD010, double 0x40EE1333200192A6}
!87 = !{!85, !43, i1 false, i2 -1}
!88 = !{!89, !90, i1 false, i2 1}
!89 = !{!"fixp", i32 32, i32 14}
!90 = !{double 0x40799999A1FD156A, double 0x40F40CCCC0010C6F}
!91 = !{!85, !90, i1 false, i2 -1}
!92 = !{!89, !93, i1 false, i2 1}
!93 = !{double 0x40800000053E2D62, double 0x40F90FFFF0014F8B}
!94 = !{!89, !95, i1 false, i2 1}
!95 = !{double 0x408CCCCCD63CB817, double 0x41068E6658012DFD}
...
!140 = !{!"fixp", i32 -32, i32 6}
!141 = !{double 0x40F99999A1FD156A, double 0x41740CCCC0010C6F}
