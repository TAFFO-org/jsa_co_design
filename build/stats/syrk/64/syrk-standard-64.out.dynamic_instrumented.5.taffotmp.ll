; ModuleID = './build/stats/syrk/64/syrk-standard-64.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 64), !taffo.originalCall !29
  ...
  call void @scale_2d.3(i32 noundef 16, i32 noundef 10, float* noundef %3, i32 noundef 64), !taffo.originalCall !29
