; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-32-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,330.133331) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,30.4) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [29 x i8] c"scalar(range(0.4,8.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [30 x i8] c"scalar(range(0.8,16.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [39 x i8] c"scalar(range(0.266667,5.333333) final)\00", section "llvm.metadata", !taffo.info !0
@.str.8 = private unnamed_addr constant [48 x i8] c"target('w') scalar(range(0.0,45254740.0) final)\00", section "llvm.metadata", !taffo.info !4
@.str.9 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,11697.635742) final)\00", section "llvm.metadata", !taffo.info !0
@.str.10 = private unnamed_addr constant [29 x i8] c"scalar(range(0.2,4.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.11 = private unnamed_addr constant [39 x i8] c"scalar(range(0.177778,3.555556) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.initweight !74, !taffo.info !54, !taffo.originalCall !77, !taffo.constinfo !78
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 32), !taffo.initweight !74, !taffo.info !56, !taffo.originalCall !77, !taffo.constinfo !78
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 32), !taffo.initweight !80, !taffo.info !58, !taffo.originalCall !81, !taffo.constinfo !82
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !59
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 32), !taffo.initweight !79, !taffo.info !59, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !61
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 32), !taffo.initweight !79, !taffo.info !61, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !63
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 32), !taffo.initweight !79, !taffo.info !63, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !65
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 32), !taffo.initweight !79, !taffo.info !65, !taffo.originalCall !83, !taffo.constinfo !84
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 32), !taffo.initweight !79, !taffo.info !67, !taffo.target !68, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !74, !taffo.info !69
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 32), !taffo.initweight !79, !taffo.info !69, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !74, !taffo.info !70
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 32), !taffo.initweight !79, !taffo.info !70, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !74, !taffo.info !72
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 32), !taffo.initweight !79, !taffo.info !72, !taffo.originalCall !83, !taffo.constinfo !84
...
!7 = !{double 0.000000e+00, double 0x40C6D8D15FFE6D59}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x41859442A0000000}
!10 = !{i1 false, !11, i1 false, i2 0}
!11 = !{double 0.000000e+00, double 0x4074A2221FAFC8B0}
...
!60 = !{double 0.000000e+00, double 3.040000e+01}
!61 = !{i1 false, !62, i1 false, i2 -1}
!62 = !{double 4.000000e-01, double 8.000000e+00}
!63 = !{i1 false, !64, i1 false, i2 -1}
!64 = !{double 8.000000e-01, double 1.600000e+01}
!65 = !{i1 false, !66, i1 false, i2 -1}
!66 = !{double 2.666670e-01, double 0x401555553EF6B5D4}
...
!150 = !{double 3.200000e+01, double 3.200000e+01}
...
!186 = !{double 0.000000e+00, double 2.432000e+02}
!187 = !{i32 8}
!188 = !{i1 false, !189, i1 false, i2 -1}
!189 = !{double 0.000000e+00, double 0x4081EAAAA9717DF2}
!190 = !{i1 false, !191, i1 false, i2 -1}
!191 = !{double 0x3FCB4E83F191A834, double 0x405555553EF6B5D4}
!192 = !{i1 false, !193, i1 false, i2 -1}
!193 = !{double 0x3FCB4E83F191A834, double 0x40849555515054AC}
!194 = distinct !{!194, !33}
!195 = distinct !{!195, !33}
!196 = !{i1 false, !197, i1 false, i2 -1}
!197 = !{double 0.000000e+00, double 0x4078C28F59395739}
!198 = !{i1 false, !199, i1 false, i2 -1}
!199 = !{double 0.000000e+00, double 0x4098C28F59395739}
!200 = !{i1 false, !201, i1 false, i2 -1}
!201 = !{double 0.000000e+00, double 0x40C9F1234B259840}
!202 = distinct !{!202, !33}
!203 = distinct !{!203, !33}
!204 = !{i1 false, !205, i1 false, i2 -1}
!205 = !{double 1.777780e-01, double 0x40C6DA987C73EEE5}
!206 = distinct !{!206, !33}
!207 = !{i1 false, !208, i1 false, i2 -1}
!208 = !{double 0.000000e+00, double 0x407EF3332F87AD08}
!209 = !{i1 false, !210, i1 false, i2 -1}
!210 = !{double 0.000000e+00, double 0x415618E74B6C7D51}
!211 = !{i1 false, !212, i1 false, i2 -1}
!212 = !{double 0.000000e+00, double 0x4188575F896D8FAA}
!213 = distinct !{!213, !33}
!214 = distinct !{!214, !33}
!215 = !{i32 1, !139, i32 1, !72, i32 1, !149}
!216 = !{i1 false, !217, i1 false, i2 -1}
!217 = !{double 0x4016C16DF3F96180, double 0x405C71C75818C5CA}
!218 = distinct !{!218, !33}
...
!267 = !{double 0.000000e+00, double 0x40C4A2221FAFC8B0}
!268 = distinct !{!268, !33}
!269 = distinct !{!269, !33}
