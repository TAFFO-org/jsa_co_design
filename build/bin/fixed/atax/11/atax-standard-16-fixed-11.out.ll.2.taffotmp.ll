; ModuleID = './build/bin/fixed/atax/11/atax-standard-16-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %2, i32 noundef 16), !taffo.initweight !44, !taffo.info !32, !taffo.originalCall !45
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.initweight !41, !taffo.info !34
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 16), !taffo.initweight !42, !taffo.info !34, !taffo.originalCall !46
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 16), !taffo.initweight !42, !taffo.info !36, !taffo.target !38, !taffo.originalCall !46
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.initweight !41, !taffo.info !39
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 16), !taffo.initweight !42, !taffo.info !39, !taffo.originalCall !46
...
!33 = !{double 0.000000e+00, double 3.360000e+00}
!34 = !{i1 false, !35, i1 false, i2 -1}
!35 = !{double 1.600000e+01, double 0x403F45D18090B418}
!36 = !{i1 false, !37, i1 false, i2 -1}
!37 = !{double 0.000000e+00, double 0x40DEC418A00192A7}
!38 = !{!"y"}
!39 = !{i1 false, !40, i1 false, i2 -1}
!40 = !{double 0.000000e+00, double 0x408E851EC02F2F98}
!41 = !{i32 1}
!42 = !{i32 2}
