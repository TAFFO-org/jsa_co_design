...
for.body:                                         ; preds = %for.cond
  ...
  %div11 = fdiv float %conv10, %14
  %conv12 = fpext float %div11 to double
  %div13 = fdiv double %conv12, 4.000000e+00
  ...
  %div18 = fdiv float %conv17, %18
  %conv19 = fpext float %div18 to double
  %div20 = fdiv double %conv19, 6.000000e+00
  ...
  %div25 = fdiv float %conv24, %22
  %conv26 = fpext float %div25 to double
  %div27 = fdiv double %conv26, 8.000000e+00
  ...
  %div32 = fdiv float %conv31, %26
  %conv33 = fpext float %div32 to double
  %div34 = fdiv double %conv33, 9.000000e+00
  ...
  store float %conv35, ptr %arrayidx36, align 4
...
for.body42:                                       ; preds = %for.cond39
  ...
  %rem = srem i32 %mul, %37
  %conv43 = sitofp i32 %rem to float
  %38 = load i32, ptr %n.addr, align 4
  %conv44 = sitofp i32 %38 to float
  ...
  store float %div45, ptr %arrayidx47, align 4
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  store float %add10, ptr %arrayidx12, align 4
  br label %for.inc
...
for.body51:                                       ; preds = %for.cond49
  ...
  store float %add58, ptr %arrayidx59, align 4
  br label %for.inc60
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef @.str.15, double noundef %conv)
  br label %for.inc
...
if.end19:                                         ; preds = %if.then17, %for.body13
  ...
  %call22 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %19, ptr noundef @.str.15, double noundef %conv21)
  br label %for.inc23
...
if.end35:                                         ; preds = %if.then33, %for.body29
  ...
  %call38 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %28, ptr noundef @.str.15, double noundef %conv37)
  br label %for.inc39
