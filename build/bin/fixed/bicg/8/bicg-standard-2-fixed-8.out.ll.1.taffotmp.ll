...
@.str = private unnamed_addr constant [34 x i8] c"scalar(range(0.0,1.909091) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/bicg.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [47 x i8] c"target('s') scalar(range(0.0,27.363638) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [47 x i8] c"target('q') scalar(range(0.0,24.181818) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 2)
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %s, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2)
  %arraydecay12 = getelementptr inbounds [22 x float], [22 x float]* %q, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 2)
  ...
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 2)
