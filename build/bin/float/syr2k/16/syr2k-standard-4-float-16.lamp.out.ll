; ModuleID = './build/bin/float/syr2k/16/syr2k-standard-4-float-16.out.ll'
...
@.str.3 = private unnamed_addr constant [47 x i8] c"target('C') scalar(range(0.0,127.73999) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay3, i32 noundef 4)
  %arraydecay4 = getelementptr inbounds [16 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay4, i32 noundef 4)
  %arraydecay5 = getelementptr inbounds [16 x [10 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 10, ptr noundef %arraydecay5, i32 noundef 4)
