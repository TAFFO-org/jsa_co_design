; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-32-fixed-11.out.ll.1.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 32), !taffo.initweight !45, !taffo.info !32, !taffo.originalCall !46
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 32), !taffo.initweight !43, !taffo.info !34, !taffo.target !36, !taffo.originalCall !47
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 32), !taffo.initweight !43, !taffo.info !37, !taffo.target !39, !taffo.originalCall !47
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.initweight !42, !taffo.info !40
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 32), !taffo.initweight !43, !taffo.info !40, !taffo.originalCall !47
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.initweight !42, !taffo.info !32
  call void @scale_1d.5(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 32), !taffo.initweight !43, !taffo.info !32, !taffo.originalCall !47
...
!33 = !{double 0.000000e+00, double 0x403E8BA2DF9378EE}
!34 = !{i1 false, !35, i1 false, i2 -1}
!35 = !{double 0.000000e+00, double 0x40BB5D176006D0D5}
!36 = !{!"s"}
!37 = !{i1 false, !38, i1 false, i2 -1}
!38 = !{double 0.000000e+00, double 0x40B82E8B9FFD60E9}
!39 = !{!"q"}
!40 = !{i1 false, !41, i1 false, i2 -1}
!41 = !{double 0.000000e+00, double 3.040000e+01}
!42 = !{i32 1}
!43 = !{i32 2}
