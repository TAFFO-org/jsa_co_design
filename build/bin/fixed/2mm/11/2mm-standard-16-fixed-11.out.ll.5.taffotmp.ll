; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-16-fixed-11.out.ll.4.taffotmp.ll'
...
for.body24:                                       ; preds = %for.cond22
  ...
  %1 = fdiv float %0, 3.276800e+04, !taffo.info !57, !taffo.target !59
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u11_21fixp, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !225 !taffo.sourceFunction !216 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 16), !taffo.info !226
  %mul.u15_17fixp = shl i32 %5, 1, !taffo.info !229
  %6 = mul nsw i32 %i.0, %m, !taffo.info !91
  ...
  %7 = shl i32 %mul.u15_17fixp, 4, !taffo.info !229
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.9_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !214 !taffo.funinfo !233 !taffo.sourceFunction !216 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 10), !taffo.info !234
  %mul.u21_11fixp = shl i32 %5, 1, !taffo.info !237
  %6 = mul nsw i32 %i.0, %m, !taffo.info !91
  ...
  %7 = shl i32 %mul.u21_11fixp, 4, !taffo.info !237
...
!223 = distinct !{!223, !23}
!224 = distinct !{!224, !23}
!225 = !{i32 1, !85, i32 1, !16, i32 1, !47, i32 1, !97}
!226 = !{!227, !228, i1 false, i2 -1}
!227 = !{!"fixp", i32 -32, i32 16}
!228 = !{double 0.000000e+00, double 0x40D27333201040C0}
!229 = !{!230, !228, i1 false, i2 -1}
!230 = !{!"fixp", i32 32, i32 17}
!231 = distinct !{!231, !23}
!232 = distinct !{!232, !23}
!233 = !{i32 1, !85, i32 1, !87, i32 1, !57, i32 1, !97}
!234 = !{!235, !236, i1 false, i2 -1}
!235 = !{!"fixp", i32 -32, i32 10}
!236 = !{double 0.000000e+00, double 0x41332E6660008638}
!237 = !{!238, !236, i1 false, i2 -1}
!238 = !{!"fixp", i32 32, i32 11}
!239 = distinct !{!239, !23}
!240 = distinct !{!240, !23}
