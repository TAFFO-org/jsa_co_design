; ModuleID = './build/bin/fixed/gesummv/11/gesummv-standard-512-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 1.024000e+03, %mul.1flp, !taffo.info !92
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u21_11fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !96 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = fmul float 2.048000e+03, %mul.1flp, !taffo.info !97
...
!95 = distinct !{!95, !23}
!96 = !{i32 1, !75, i32 1, !51, i32 1, !84}
!97 = !{!98, !99, i1 false, i2 -1}
!98 = !{!"float", i32 1, double 0x41C1A00000000000}
!99 = !{double 0.000000e+00, double 0x41C1A00000000000}
!100 = distinct !{!100, !23}
