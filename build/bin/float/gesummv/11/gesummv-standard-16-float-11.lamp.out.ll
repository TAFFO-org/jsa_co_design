; ModuleID = './build/bin/float/gesummv/11/gesummv-standard-16-float-11.out.ll'
...
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,15.0) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [32 x i8] c"scalar(range(0.0,1128.0) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [49 x i8] c"target('y') scalar(range(0.0,2899.200195) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_scalar(ptr noundef %alpha, i32 noundef 16)
  call void @scale_scalar(ptr noundef %beta, i32 noundef 16)
  %arraydecay5 = getelementptr inbounds [16 x [16 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay5, i32 noundef 16)
  %arraydecay6 = getelementptr inbounds [16 x [16 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 16, i32 noundef 16, ptr noundef %arraydecay6, i32 noundef 16)
  %arraydecay7 = getelementptr inbounds [16 x float], ptr %tmp, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay7, i32 noundef 16)
  %arraydecay8 = getelementptr inbounds [16 x float], ptr %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay8, i32 noundef 16)
  %arraydecay9 = getelementptr inbounds [16 x float], ptr %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 16, ptr noundef %arraydecay9, i32 noundef 16)
