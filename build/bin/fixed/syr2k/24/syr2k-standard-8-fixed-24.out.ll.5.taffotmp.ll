; ModuleID = './build/bin/fixed/syr2k/24/syr2k-standard-8-fixed-24.out.ll.4.taffotmp.ll'
...
for.body16:                                       ; preds = %for.cond14
  ...
  %2 = fdiv float %1, 0x4160000000000000, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_syr2k.3_fixp(i32 noundef %n, i32 noundef %m, i32 noundef %alpha.u4_28fixp, i32 noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u9_23fixp, [10 x i32]* noundef %A.u4_28fixp, [10 x i32]* noundef %B.u4_28fixp) #0 !taffo.initweight !92 !taffo.funinfo !93 !taffo.sourceFunction !94 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u9_23fixp = load i32, i32* %arrayidx4.u9_23fixp, align 4, !taffo.info !95
  %0 = lshr i32 %u9_23fixp, 1, !taffo.info !95
  %1 = lshr i32 %beta.u2_30fixp, 1, !taffo.info !45
  %2 = ashr i32 %0, 1, !taffo.info !95
  %3 = ashr i32 %1, 8, !taffo.info !45
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !97
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !100
  %5 = shl i32 %mul.u10_22fixp, 1, !taffo.info !100
...
for.body10:                                       ; preds = %for.cond8
  ...
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 27), !taffo.info !102
  %mul13.u4_28fixp = shl i32 %8, 1, !taffo.info !105
  ...
  %9 = lshr i32 %mul13.u4_28fixp, 1, !taffo.info !105
  %10 = lshr i32 %u4_28fixp3, 1, !taffo.info !53
  %11 = ashr i32 %9, 4, !taffo.info !105
  %12 = ashr i32 %10, 4, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 23), !taffo.info !106
  %mul16.u8_24fixp = shl i32 %13, 1, !taffo.info !109
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 27), !taffo.info !111
  %mul19.u4_28fixp = shl i32 %16, 1, !taffo.info !113
  ...
  %17 = lshr i32 %mul19.u4_28fixp, 1, !taffo.info !113
  %18 = lshr i32 %u4_28fixp2, 1, !taffo.info !50
  %19 = ashr i32 %17, 4, !taffo.info !113
  %20 = ashr i32 %18, 4, !taffo.info !50
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 23), !taffo.info !106
  %mul22.u8_24fixp = shl i32 %21, 1, !taffo.info !109
  %22 = lshr i32 %mul16.u8_24fixp, 2, !taffo.info !109
  %23 = lshr i32 %mul22.u8_24fixp, 2, !taffo.info !109
  %add.u10_22fixp = add i32 %22, %23, !taffo.info !114
  ...
  %u9_23fixp1 = load i32, i32* %arrayidx24.u9_23fixp, align 4, !taffo.info !95
  %24 = lshr i32 %u9_23fixp1, 1, !taffo.info !95
  %add25.u10_22fixp = add i32 %24, %add.u10_22fixp, !taffo.info !116
  %25 = shl i32 %add25.u10_22fixp, 1, !taffo.info !116
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [16 x i32]* noundef %C.u9_23fixp, [10 x i32]* noundef %A.u4_28fixp, [10 x i32]* noundef %B.u4_28fixp) #0 !taffo.initweight !121 !taffo.funinfo !122 !taffo.sourceFunction !123 {
entry:
  store i32 1610612736, i32* %alpha.u2_30fixp, align 4, !taffo.info !55, !taffo.constinfo !124
  store i32 1288490240, i32* %beta.u2_30fixp, align 4, !taffo.info !58, !taffo.constinfo !126
  br label %for.cond

for.cond:                                         ; preds = %for.inc16, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc17, %for.inc16 ], !taffo.info !129, !taffo.initweight !130
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !131, !taffo.initweight !132
  br i1 %cmp, label %for.body, label %for.end18, !taffo.info !133, !taffo.initweight !135

for.body:                                         ; preds = %for.cond
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc, %for.body
  %j.0 = phi i32 [ 0, %for.body ], [ %inc, %for.inc ], !taffo.info !136, !taffo.initweight !130
  %cmp4 = icmp slt i32 %j.0, %m, !taffo.info !131, !taffo.initweight !132
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !138, !taffo.initweight !135

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !139, !taffo.initweight !132
  %add = add nsw i32 %mul, 1, !taffo.info !141, !taffo.initweight !135, !taffo.constinfo !21
  %rem = srem i32 %add, %n, !taffo.info !143, !taffo.initweight !145
  %conv.u4_28fixp = shl i32 %rem, 28, !taffo.info !146
  %conv6.u5_27fixp = shl i32 %n, 27, !taffo.info !147
  %0 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !146
  %1 = lshr i32 %conv6.u5_27fixp, 1, !taffo.info !147
  %2 = ashr i32 %0, 1, !taffo.info !146
  %3 = call i32 @llvm.sdiv.fix.i32(i32 %2, i32 %1, i32 26), !taffo.info !149
  %div.u1_31fixp = shl i32 %3, 5, !taffo.info !152
  %arrayidx.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %A.u4_28fixp, i32 %i.0, !taffo.info !154
  %arrayidx7.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx.u4_28fixp, i32 0, i32 %j.0, !taffo.info !154
  %4 = lshr i32 %div.u1_31fixp, 3, !taffo.info !152
  store i32 %4, i32* %arrayidx7.u4_28fixp, align 4, !taffo.info !155
  %mul8 = mul nsw i32 %i.0, %j.0, !taffo.info !139, !taffo.initweight !132
  %add9 = add nsw i32 %mul8, 2, !taffo.info !156, !taffo.initweight !135, !taffo.constinfo !21
  %rem10 = srem i32 %add9, %m, !taffo.info !158, !taffo.initweight !145
  ...
  %div13.u1_31fixp = shl i32 %7, 4, !taffo.info !164
  %arrayidx14.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %B.u4_28fixp, i32 %i.0, !taffo.info !165
  %arrayidx15.u4_28fixp = getelementptr inbounds [10 x i32], [10 x i32]* %arrayidx14.u4_28fixp, i32 0, i32 %j.0, !taffo.info !165
  %8 = lshr i32 %div13.u1_31fixp, 3, !taffo.info !164
  store i32 %8, i32* %arrayidx15.u4_28fixp, align 4, !taffo.info !155
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !166, !taffo.initweight !132, !taffo.constinfo !21
...
for.inc16:                                        ; preds = %for.end
  %inc17 = add nsw i32 %i.0, 1, !taffo.info !169, !taffo.initweight !132, !taffo.constinfo !21
...
for.cond19:                                       ; preds = %for.inc38, %for.end18
  %i.1 = phi i32 [ 0, %for.end18 ], [ %inc39, %for.inc38 ], !taffo.info !129, !taffo.initweight !130
  %cmp20 = icmp slt i32 %i.1, %n, !taffo.info !131, !taffo.initweight !132
  br i1 %cmp20, label %for.body22, label %for.end40, !taffo.info !133, !taffo.initweight !135

for.body22:                                       ; preds = %for.cond19
  br label %for.cond23

for.cond23:                                       ; preds = %for.inc35, %for.body22
  %j.1 = phi i32 [ 0, %for.body22 ], [ %inc36, %for.inc35 ], !taffo.info !136, !taffo.initweight !130
  %cmp24 = icmp slt i32 %j.1, %n, !taffo.info !171, !taffo.initweight !132
  br i1 %cmp24, label %for.body26, label %for.end37, !taffo.info !138, !taffo.initweight !135

for.body26:                                       ; preds = %for.cond23
  %mul27 = mul nsw i32 %i.1, %j.1, !taffo.info !139, !taffo.initweight !132
  %add28 = add nsw i32 %mul27, 3, !taffo.info !172, !taffo.initweight !135, !taffo.constinfo !21
  %rem29 = srem i32 %add28, %n, !taffo.info !143, !taffo.initweight !145
  %conv30.u4_28fixp = shl i32 %rem29, 28, !taffo.info !146
  %conv31.u4_28fixp = shl i32 %m, 28, !taffo.info !161
  %9 = lshr i32 %conv30.u4_28fixp, 1, !taffo.info !146
  %10 = lshr i32 %conv31.u4_28fixp, 1, !taffo.info !161
  %11 = call i32 @llvm.sdiv.fix.i32(i32 %9, i32 %10, i32 27), !taffo.info !174
  %div32.u4_28fixp = shl i32 %11, 1, !taffo.info !176
  %arrayidx33.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %C.u9_23fixp, i32 %i.1, !taffo.info !177
  %arrayidx34.u9_23fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx33.u9_23fixp, i32 0, i32 %j.1, !taffo.info !177
  %12 = lshr i32 %div32.u4_28fixp, 5, !taffo.info !176
  store i32 %12, i32* %arrayidx34.u9_23fixp, align 4, !taffo.info !155
  br label %for.inc35

for.inc35:                                        ; preds = %for.body26
  %inc36 = add nsw i32 %j.1, 1, !taffo.info !166, !taffo.initweight !132, !taffo.constinfo !21
...
for.inc38:                                        ; preds = %for.end37
  %inc39 = add nsw i32 %i.1, 1, !taffo.info !169, !taffo.initweight !132, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !180 !taffo.funinfo !181 !taffo.sourceFunction !182 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !183
  %1 = lshr i32 %u9_23fixp, 1, !taffo.info !47
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !183
  %3 = ashr i32 %1, 3, !taffo.info !47
  %4 = ashr i32 %2, 8, !taffo.info !183
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !184
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !187
  ...
  %7 = shl i32 %mul.u12_20fixp, 3, !taffo.info !187
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !180 !taffo.funinfo !191 !taffo.sourceFunction !182 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u4_28fixp = load i32, i32* %arrayidx4.u4_28fixp, align 4, !taffo.info !192
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !194
  %1 = lshr i32 %u4_28fixp, 1, !taffo.info !192
  %2 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !194
  %3 = ashr i32 %1, 2, !taffo.info !192
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 25), !taffo.info !195
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !198
  ...
  %6 = shl i32 %mul.u6_26fixp, 2, !taffo.info !198
...
!98 = !{!"fixp", i32 -32, i32 21}
!99 = !{double 0.000000e+00, double 0x4082DF7CD96F727E}
!100 = !{!96, !99, i1 false, i2 -1}
!101 = distinct !{!101, !23}
!102 = !{!103, !104, i1 false, i2 -1}
!103 = !{!"fixp", i32 -32, i32 27}
!104 = !{double 0.000000e+00, double 1.125000e+01}
!105 = !{!51, !104, i1 false, i2 -1}
!106 = !{!107, !108, i1 false, i2 -1}
!107 = !{!"fixp", i32 -32, i32 23}
!108 = !{double 0.000000e+00, double 8.100000e+01}
!109 = !{!110, !108, i1 false, i2 -1}
!110 = !{!"fixp", i32 32, i32 24}
!111 = !{!103, !112, i1 false, i2 -1}
!112 = !{double 0.000000e+00, double 1.080000e+01}
!113 = !{!51, !112, i1 false, i2 -1}
!114 = !{!96, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 1.620000e+02}
!116 = !{!96, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x4084CA3D5FDCDF6A}
!118 = distinct !{!118, !23}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
!121 = !{i32 -1, i32 -1, i32 1, i32 1, i32 2, i32 2, i32 2}
!122 = !{i32 1, !78, i32 1, !16, i32 1, !42, i32 1, !45, i32 1, !47, i32 1, !50, i32 1, !53}
!123 = distinct !{null}
!124 = !{!125, i1 false}
...
!137 = !{double 0.000000e+00, double 1.100000e+01}
!138 = !{i1 false, !3, i1 false, i2 1}
!139 = !{i1 false, !140, i1 false, i2 1}
!140 = !{double 0.000000e+00, double 1.600000e+02}
!141 = !{i1 false, !142, i1 false, i2 1}
!142 = !{double 1.000000e+00, double 1.610000e+02}
!143 = !{i1 false, !144, i1 false, i2 1}
!144 = !{double 0.000000e+00, double 1.500000e+01}
!145 = !{i32 4}
!146 = !{!51, !144, i1 false, i2 1}
!147 = !{!148, !79, i1 false, i2 1}
...
!160 = !{!51, !159, i1 false, i2 1}
!161 = !{!51, !17, i1 false, i2 1}
!162 = !{!103, !163, i1 false, i2 1}
!163 = !{double 0.000000e+00, double 9.000000e-01}
!164 = !{!153, !163, i1 false, i2 1}
!165 = !{!51, !54, i1 false, i2 1}
!166 = !{i1 false, !167, i1 false, i2 1}
!167 = !{double 1.000000e+00, double 1.100000e+01}
!168 = distinct !{!168, !23}
!169 = !{i1 false, !75, i1 false, i2 1}
!170 = distinct !{!170, !23}
!171 = !{i1 false, !81, i1 false, i2 1}
!172 = !{i1 false, !173, i1 false, i2 1}
!173 = !{double 3.000000e+00, double 1.630000e+02}
!174 = !{!103, !175, i1 false, i2 1}
!175 = !{double 0.000000e+00, double 1.500000e+00}
!176 = !{!51, !175, i1 false, i2 1}
!177 = !{!48, !1, i1 false, i2 1}
!178 = distinct !{!178, !23}
!179 = distinct !{!179, !23}
!180 = !{i32 -1, i32 -1, i32 3, i32 -1}
!181 = !{i32 1, !78, i32 1, !78, i32 1, !47, i32 1, !89}
!182 = !{void (i32, i32, float*, i32)* @scale_2d}
!183 = !{!51, !90, i1 false, i2 1}
!184 = !{!185, !186, i1 false, i2 -1}
!185 = !{!"fixp", i32 -32, i32 19}
!186 = !{double 0.000000e+00, double 0x40AF747ABFB9BED3}
!187 = !{!188, !186, i1 false, i2 -1}
!188 = !{!"fixp", i32 32, i32 20}
!189 = distinct !{!189, !23}
!190 = distinct !{!190, !23}
!191 = !{i32 1, !78, i32 1, !16, i32 1, !50, i32 1, !89}
!192 = !{!193, !52, i1 false, i2 -1}
!193 = !{!"fixp", i32 32, i32 26}
!194 = !{!193, !90, i1 false, i2 1}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"fixp", i32 -32, i32 25}
!197 = !{double 0.000000e+00, double 6.000000e+01}
!198 = !{!193, !197, i1 false, i2 -1}
!199 = distinct !{!199, !23}
!200 = distinct !{!200, !23}
