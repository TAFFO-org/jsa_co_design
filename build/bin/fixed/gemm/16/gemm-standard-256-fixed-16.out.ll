; ModuleID = './build/bin/fixed/gemm/16/gemm-standard-256-fixed-16.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u8_24fixp = bitcast [16 x i32]* %arraydecay9.u8_24fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u8_24fixp, i32 256), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u8_24fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u8_24fixp, i32 0, i32 0, !taffo.info !53
  %u8_24fixp2 = bitcast [12 x i32]* %arraydecay10.u8_24fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u8_24fixp2, i32 256), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [12 x i32]* %arraydecay11.u19_13fixp, [16 x i32]* %arraydecay12.u8_24fixp, [12 x i32]* %arraydecay13.u8_24fixp), !taffo.info !55, !taffo.constinfo !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 15), !taffo.info !182
  %mul.u16_16fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u16_16fixp, 8, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u19_13fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !189 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 4), !taffo.info !190
  %mul.u27_5fixp = shl i32 %5, 1, !taffo.info !193
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u27_5fixp, 8, !taffo.info !193
...
!183 = !{!"fixp", i32 -32, i32 15}
!184 = !{double 0.000000e+00, double 6.144000e+04}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 16}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
!189 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
!190 = !{!191, !192, i1 false, i2 -1}
!191 = !{!"fixp", i32 -32, i32 4}
!192 = !{double 0.000000e+00, double 0x419903D700000000}
!193 = !{!194, !192, i1 false, i2 -1}
!194 = !{!"fixp", i32 32, i32 5}
!195 = distinct !{!195, !23}
!196 = distinct !{!196, !23}
