; ModuleID = './build/bin/float/atax/11/atax-standard-1-float-11.out.ll'
...
entry:
  ...
  call void @kernel_atax(i32 noundef %2, i32 noundef %3, ptr noundef %arraydecay4, ptr noundef %arraydecay5, ptr noundef %arraydecay6, ptr noundef %arraydecay7)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx8 = getelementptr inbounds [22 x float], ptr @y_float, i32 0, i32 %7
