; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-512-fixed-11.out.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim4 = and i32 %lampsim3, -8192
  %lampsim5 = bitcast i32 %lampsim4 to float
  %mul.1flp6 = fmul float %.flt.fallback.1flp, %lampsim5, !taffo.info !143
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !161
...
for.body51:                                       ; preds = %for.cond49
  ...
  %lampsim1 = and i32 %lampsim, -8192
  %lampsim2 = bitcast i32 %lampsim1 to float
  %29 = fdiv float %lampsim2, 3.276800e+04, !taffo.info !283
  ...
  %lampsim10 = and i32 %lampsim9, -8192
  %lampsim11 = bitcast i32 %lampsim10 to float
  %mul57.1flp12 = fmul float %lampsim5, %lampsim11, !taffo.info !284
  %lampsim13 = bitcast float %mul57.1flp12 to i32
  %lampsim14 = and i32 %lampsim13, -8192
  %lampsim15 = bitcast i32 %lampsim14 to float
  %add58.1flp16 = fadd float %.flt.fallback.1flp, %lampsim15, !taffo.info !287
