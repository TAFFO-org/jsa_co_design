...
@.str.3 = private unnamed_addr constant [38 x i8] c"scalar(range(0.0,84130.132812) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,486.399994) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [31 x i8] c"scalar(range(6.4,128.0) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [32 x i8] c"scalar(range(12.8,256.0) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [40 x i8] c"scalar(range(4.266667,85.333336) final)\00", section "llvm.metadata"
@.str.8 = private unnamed_addr constant [54 x i8] c"target('w') scalar(range(0.0,41561861652480.0) final)\00", section "llvm.metadata"
@.str.9 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,45657680.0) final)\00", section "llvm.metadata"
@.str.10 = private unnamed_addr constant [30 x i8] c"scalar(range(3.2,64.0) final)\00", section "llvm.metadata"
@.str.11 = private unnamed_addr constant [40 x i8] c"scalar(range(2.844445,56.888889) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %u26, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 158, i8* null)
  ...
  call void @llvm.var.annotation(i8* %w8, i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 160, i8* null)
  %x9 = bitcast [20 x float]* %x to i8*
  call void @llvm.var.annotation(i8* %x9, i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i32 161, i8* null)
  ...
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 512)
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 512)
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 512)
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 512)
  %arraydecay25 = getelementptr inbounds [20 x float], [20 x float]* %w, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 512)
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 512)
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 512)
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 512)
