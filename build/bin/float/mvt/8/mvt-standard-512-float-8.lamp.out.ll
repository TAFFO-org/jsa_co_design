; ModuleID = './build/bin/float/mvt/8/mvt-standard-512-float-8.out.ll'
source_filename = "./sources/mvt.c"
target datalayout = "e-m:e-p:32:32-p270:32:32-p271:32:32-p272:64:64-f64:32:64-f80:32-n8:16:32-S128"
target triple = "i386-unknown-linux-gnu"

@.str = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,486.399994) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/mvt.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [50 x i8] c"target('x1') scalar(range(0.0,1284940.875) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [50 x i8] c"target('x2') scalar(range(0.0,1304422.375) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 20, ptr noundef %arraydecay5, i32 noundef 512)
  %arraydecay6 = getelementptr inbounds [20 x float], ptr %x1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay6, i32 noundef 512)
  %arraydecay7 = getelementptr inbounds [20 x float], ptr %x2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay7, i32 noundef 512)
  %arraydecay8 = getelementptr inbounds [20 x float], ptr %y_1, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay8, i32 noundef 512)
  %arraydecay9 = getelementptr inbounds [20 x float], ptr %y_2, i32 0, i32 0
  call void @scale_1d(i32 noundef 20, ptr noundef %arraydecay9, i32 noundef 512)
...
for.body:                                         ; preds = %for.cond
  ...
  %lampsim8 = bitcast float %conv17 to i32
  %lampsim9 = and i32 %lampsim8, -65536
  %lampsim10 = bitcast i32 %lampsim9 to float
  %div12 = fdiv float %lampsim4, %lampsim10
  ...
  store float %lampsim15, ptr %arrayidx, align 4
  %7 = load i32, ptr %i, align 4
  %add = add nsw i32 %7, 1
  %8 = load i32, ptr %n.addr, align 4
  %rem2 = srem i32 %add, %8
  %conv316 = sitofp i32 %rem2 to float
  %lampsim17 = bitcast float %conv316 to i32
  %lampsim18 = and i32 %lampsim17, -65536
  %lampsim19 = bitcast i32 %lampsim18 to float
  %9 = load i32, ptr %n.addr, align 4
  %conv420 = sitofp i32 %9 to float
  %lampsim21 = bitcast float %conv420 to i32
  %lampsim22 = and i32 %lampsim21, -65536
  %lampsim23 = bitcast i32 %lampsim22 to float
  %div524 = fdiv float %lampsim19, %lampsim23
  %lampsim25 = bitcast float %div524 to i32
  %lampsim26 = and i32 %lampsim25, -65536
  %lampsim27 = bitcast i32 %lampsim26 to float
  %10 = load ptr, ptr %x2.addr, align 4
  %11 = load i32, ptr %i, align 4
  %arrayidx6 = getelementptr inbounds float, ptr %10, i32 %11
  store float %lampsim27, ptr %arrayidx6, align 4
  %12 = load i32, ptr %i, align 4
  %add7 = add nsw i32 %12, 3
  %13 = load i32, ptr %n.addr, align 4
  %rem8 = srem i32 %add7, %13
  %conv928 = sitofp i32 %rem8 to float
  %lampsim29 = bitcast float %conv928 to i32
  %lampsim30 = and i32 %lampsim29, -65536
  %lampsim31 = bitcast i32 %lampsim30 to float
  %14 = load i32, ptr %n.addr, align 4
  %conv1032 = sitofp i32 %14 to float
  %lampsim33 = bitcast float %conv1032 to i32
  %lampsim34 = and i32 %lampsim33, -65536
  %lampsim35 = bitcast i32 %lampsim34 to float
  %div1136 = fdiv float %lampsim31, %lampsim35
  %lampsim37 = bitcast float %div1136 to i32
  ...
  store float %lampsim39, ptr %arrayidx12, align 4
  %17 = load i32, ptr %i, align 4
  %add13 = add nsw i32 %17, 4
  %18 = load i32, ptr %n.addr, align 4
  %rem14 = srem i32 %add13, %18
  %conv1540 = sitofp i32 %rem14 to float
  %lampsim41 = bitcast float %conv1540 to i32
  %lampsim42 = and i32 %lampsim41, -65536
  %lampsim43 = bitcast i32 %lampsim42 to float
  %19 = load i32, ptr %n.addr, align 4
  %conv1644 = sitofp i32 %19 to float
  %lampsim45 = bitcast float %conv1644 to i32
  %lampsim46 = and i32 %lampsim45, -65536
  %lampsim47 = bitcast i32 %lampsim46 to float
  %div1748 = fdiv float %lampsim43, %lampsim47
  %lampsim49 = bitcast float %div1748 to i32
  %lampsim50 = and i32 %lampsim49, -65536
  ...
  store float %lampsim51, ptr %arrayidx18, align 4
  store i32 0, ptr %j, align 4
  br label %for.cond19
...
for.body22:                                       ; preds = %for.cond19
  ...
  %conv2452 = sitofp i32 %rem23 to float
  %lampsim53 = bitcast float %conv2452 to i32
  %lampsim54 = and i32 %lampsim53, -65536
  %lampsim55 = bitcast i32 %lampsim54 to float
  %27 = load i32, ptr %n.addr, align 4
  %conv2556 = sitofp i32 %27 to float
  %lampsim57 = bitcast float %conv2556 to i32
  %lampsim58 = and i32 %lampsim57, -65536
  %lampsim59 = bitcast i32 %lampsim58 to float
  %div2660 = fdiv float %lampsim55, %lampsim59
  %lampsim61 = bitcast float %div2660 to i32
  ...
  store float %lampsim63, ptr %arrayidx28, align 4
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  ...
  store float %lampsim7, ptr %arrayidx7, align 4
  br label %for.inc
...
for.body16:                                       ; preds = %for.cond14
  ...
  %mul218 = fmul float %28, %31
  %lampsim9 = bitcast float %mul218 to i32
  %lampsim10 = and i32 %lampsim9, -65536
  %lampsim11 = bitcast i32 %lampsim10 to float
  %add2212 = fadd float %24, %lampsim11
  %lampsim13 = bitcast float %add2212 to i32
  %lampsim14 = and i32 %lampsim13, -65536
  %lampsim15 = bitcast i32 %lampsim14 to float
  %32 = load ptr, ptr %x2.addr, align 4
  %33 = load i32, ptr %i, align 4
  %arrayidx23 = getelementptr inbounds float, ptr %32, i32 %33
  store float %lampsim15, ptr %arrayidx23, align 4
  br label %for.inc24
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %call2 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef @.str.6, double noundef %lampsim3)
  br label %for.inc
...
if.end12:                                         ; preds = %if.then10, %for.body6
  ...
  %call15 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef @.str.6, double noundef %lampsim7)
  br label %for.inc16
