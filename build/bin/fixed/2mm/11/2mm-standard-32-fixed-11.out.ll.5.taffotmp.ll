; ModuleID = './build/bin/fixed/2mm/11/2mm-standard-32-fixed-11.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u5_27fixp = bitcast [10 x i32]* %arraydecay13.u5_27fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 12, i32 10, i32* %u5_27fixp, i32 32), !taffo.info !66, !taffo.constinfo !65
