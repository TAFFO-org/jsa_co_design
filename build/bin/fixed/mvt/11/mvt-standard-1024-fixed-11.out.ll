; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-1024-fixed-11.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u23_9fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %1, %3, !taffo.info !83
  %arrayidx1.u23_9fixp = getelementptr inbounds i32, i32* %val.u23_9fixp, i32 %i.0, !taffo.info !47
  %4 = fmul float 5.120000e+02, %mul.1flp, !taffo.info !83
  %5 = fptoui float %4 to i32, !taffo.info !83
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u10_22fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !87 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !88
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !91
  %arrayidx1.u10_22fixp = getelementptr inbounds i32, i32* %val.u10_22fixp, i32 %i.0, !taffo.info !44
  %5 = shl i32 %mul.u20_12fixp, 10, !taffo.info !91
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 11), !taffo.info !88
  %mul.u20_12fixp = shl i32 %5, 1, !taffo.info !91
  ...
  %7 = shl i32 %mul.u20_12fixp, 10, !taffo.info !91
...
!84 = !{!"float", i32 1, double 0x41F39A7320000000}
!85 = !{double 0.000000e+00, double 0x41F39A7320000000}
!86 = distinct !{!86, !25}
!87 = !{i32 1, !67, i32 1, !44, i32 1, !78}
!88 = !{!89, !90, i1 false, i2 -1}
!89 = !{!"fixp", i32 -32, i32 11}
!90 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!91 = !{!92, !90, i1 false, i2 -1}
!92 = !{!"fixp", i32 32, i32 12}
!93 = distinct !{!93, !25}
