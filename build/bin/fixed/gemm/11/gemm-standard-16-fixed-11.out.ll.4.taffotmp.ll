; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-16-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 12, float* noundef %0, i32 noundef 16), !taffo.info !67, !taffo.initweight !68, !taffo.constinfo !69, !taffo.target !50, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 16, float* noundef %1, i32 noundef 16), !taffo.info !71, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
  ...
  call void @scale_2d.6(i32 noundef 16, i32 noundef 12, float* noundef %2, i32 noundef 16), !taffo.info !72, !taffo.initweight !68, !taffo.constinfo !69, !taffo.originalCall !70
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %C, i32 %i.0, !taffo.info !48, !taffo.initweight !104
  %arrayidx4 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !48, !taffo.initweight !105
  %0 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !106
  %mul = fmul float %0, %beta, !taffo.info !107, !taffo.initweight !104
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.0, !taffo.info !51, !taffo.initweight !104
  %arrayidx12 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx11, i32 0, i32 %k.0, !taffo.info !51, !taffo.initweight !105
  %1 = load float, float* %arrayidx12, align 4, !taffo.info !110, !taffo.initweight !106
  %mul13 = fmul float %alpha, %1, !taffo.info !112, !taffo.initweight !104
  %arrayidx14 = getelementptr inbounds [12 x float], [12 x float]* %B, i32 %k.0, !taffo.info !54, !taffo.initweight !104
  %arrayidx15 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx14, i32 0, i32 %j.1, !taffo.info !54, !taffo.initweight !105
  %2 = load float, float* %arrayidx15, align 4, !taffo.info !54, !taffo.initweight !106
  %mul16 = fmul float %mul13, %2, !taffo.info !114, !taffo.initweight !105
  %arrayidx17 = getelementptr inbounds [12 x float], [12 x float]* %C, i32 %i.0, !taffo.info !48, !taffo.initweight !104
  %arrayidx18 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx17, i32 0, i32 %j.1, !taffo.info !48, !taffo.initweight !105
  %3 = load float, float* %arrayidx18, align 4, !taffo.info !48, !taffo.initweight !106
  %add = fadd float %3, %mul16, !taffo.info !116, !taffo.initweight !106
  store float %add, float* %arrayidx18, align 4, !taffo.info !67, !taffo.initweight !106
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, float* noundef %alpha, float* noundef %beta, [12 x float]* noundef %C, [16 x float]* noundef %A, [12 x float]* noundef %B) #0 !taffo.initweight !121 !taffo.funinfo !103 !taffo.sourceFunction !62 {
entry:
  store float 1.500000e+00, float* %alpha, align 4, !taffo.info !60, !taffo.initweight !81, !taffo.constinfo !122
  store float 0x3FF3333340000000, float* %beta, align 4, !taffo.info !65, !taffo.initweight !81, !taffo.constinfo !124
  br label %for.cond

for.cond:                                         ; preds = %for.inc8, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc9, %for.inc8 ], !taffo.info !127, !taffo.initweight !45
  %cmp = icmp slt i32 %i.0, %ni, !taffo.info !129, !taffo.initweight !66
  br i1 %cmp, label %for.body, label %for.end10, !taffo.info !130, !taffo.initweight !68
...
for.cond3:                                        ; preds = %for.inc, %for.body
  ...
  %cmp4 = icmp slt i32 %j.0, %nj, !taffo.info !129, !taffo.initweight !66
  br i1 %cmp4, label %for.body5, label %for.end, !taffo.info !130, !taffo.initweight !68

for.body5:                                        ; preds = %for.cond3
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !132, !taffo.initweight !66
  %add = add nsw i32 %mul, 1, !taffo.info !134, !taffo.initweight !68, !taffo.constinfo !21
  %rem = srem i32 %add, %ni, !taffo.info !136, !taffo.initweight !81
  %conv = sitofp i32 %rem to float, !taffo.info !138, !taffo.initweight !104
  %conv6 = sitofp i32 %ni to float, !taffo.info !139
  %div = fdiv float %conv, %conv6, !taffo.info !140, !taffo.initweight !105
  %arrayidx = getelementptr inbounds [12 x float], [12 x float]* %C, i32 %i.0, !taffo.info !143, !taffo.initweight !66
  %arrayidx7 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx, i32 0, i32 %j.0, !taffo.info !143, !taffo.initweight !66
  store float %div, float* %arrayidx7, align 4, !taffo.info !144, !taffo.initweight !68
  br label %for.inc

for.inc:                                          ; preds = %for.body5
  %inc = add nsw i32 %j.0, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc8:                                         ; preds = %for.end
  %inc9 = add nsw i32 %i.0, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
...
for.cond11:                                       ; preds = %for.inc30, %for.end10
  ...
  %cmp12 = icmp slt i32 %i.1, %ni, !taffo.info !129, !taffo.initweight !66
  br i1 %cmp12, label %for.body14, label %for.end32, !taffo.info !130, !taffo.initweight !68
...
for.cond15:                                       ; preds = %for.inc27, %for.body14
  ...
  %cmp16 = icmp slt i32 %j.1, %nk, !taffo.info !129, !taffo.initweight !66
  br i1 %cmp16, label %for.body18, label %for.end29, !taffo.info !130, !taffo.initweight !68

for.body18:                                       ; preds = %for.cond15
  %add19 = add nsw i32 %j.1, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
  %mul20 = mul nsw i32 %i.1, %add19, !taffo.info !149, !taffo.initweight !66
  %rem21 = srem i32 %mul20, %nk, !taffo.info !151, !taffo.initweight !68
  %conv22 = sitofp i32 %rem21 to float, !taffo.info !152, !taffo.initweight !81
  %conv23 = sitofp i32 %nk to float, !taffo.info !153
  %div24 = fdiv float %conv22, %conv23, !taffo.info !154, !taffo.initweight !104
  %arrayidx25 = getelementptr inbounds [16 x float], [16 x float]* %A, i32 %i.1, !taffo.info !152, !taffo.initweight !66
  %arrayidx26 = getelementptr inbounds [16 x float], [16 x float]* %arrayidx25, i32 0, i32 %j.1, !taffo.info !152, !taffo.initweight !66
  store float %div24, float* %arrayidx26, align 4, !taffo.info !144, !taffo.initweight !68
  br label %for.inc27

for.inc27:                                        ; preds = %for.body18
  %inc28 = add nsw i32 %j.1, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc30:                                        ; preds = %for.end29
  %inc31 = add nsw i32 %i.1, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
...
for.cond33:                                       ; preds = %for.inc52, %for.end32
  ...
  %cmp34 = icmp slt i32 %i.2, %nk, !taffo.info !129, !taffo.initweight !66
  br i1 %cmp34, label %for.body36, label %for.end54, !taffo.info !130, !taffo.initweight !68
...
for.cond37:                                       ; preds = %for.inc49, %for.body36
  ...
  %cmp38 = icmp slt i32 %j.2, %nj, !taffo.info !129, !taffo.initweight !66
  br i1 %cmp38, label %for.body40, label %for.end51, !taffo.info !130, !taffo.initweight !68

for.body40:                                       ; preds = %for.cond37
  %add41 = add nsw i32 %j.2, 2, !taffo.info !158, !taffo.initweight !66, !taffo.constinfo !21
  %mul42 = mul nsw i32 %i.2, %add41, !taffo.info !160, !taffo.initweight !66
  %rem43 = srem i32 %mul42, %nj, !taffo.info !162, !taffo.initweight !68
  %conv44 = sitofp i32 %rem43 to float, !taffo.info !163, !taffo.initweight !81
  %conv45 = sitofp i32 %nj to float, !taffo.info !164
  %div46 = fdiv float %conv44, %conv45, !taffo.info !165, !taffo.initweight !104
  %arrayidx47 = getelementptr inbounds [12 x float], [12 x float]* %B, i32 %i.2, !taffo.info !167, !taffo.initweight !66
  %arrayidx48 = getelementptr inbounds [12 x float], [12 x float]* %arrayidx47, i32 0, i32 %j.2, !taffo.info !167, !taffo.initweight !66
  store float %div46, float* %arrayidx48, align 4, !taffo.info !144, !taffo.initweight !68
  br label %for.inc49

for.inc49:                                        ; preds = %for.body40
  %inc50 = add nsw i32 %j.2, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
...
for.inc52:                                        ; preds = %for.end51
  %inc53 = add nsw i32 %i.2, 1, !taffo.info !145, !taffo.initweight !66, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !171 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !48, !taffo.initweight !172
  %conv = sitofp i32 %factor to float, !taffo.info !153
  %mul = fmul float %1, %conv, !taffo.info !173, !taffo.initweight !176
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !67, !taffo.initweight !172
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !170 !taffo.funinfo !179 !taffo.sourceFunction !70 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !51, !taffo.initweight !172
  %conv = sitofp i32 %factor to float, !taffo.info !153
  %mul = fmul float %1, %conv, !taffo.info !180, !taffo.initweight !176
  %2 = mul nsw i32 %i.0, %m, !taffo.info !94
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !71, !taffo.initweight !172
  br label %for.inc
...
!55 = !{double 0.000000e+00, double 0x402D55556084A516}
...
!103 = !{i32 1, !16, i32 1, !90, i32 1, !100, i32 1, !42, i32 1, !46, i32 1, !48, i32 1, !51, i32 1, !54}
!104 = !{i32 5}
!105 = !{i32 6}
!106 = !{i32 7}
!107 = !{!49, !108, i1 false, i2 -1}
!108 = !{double 0.000000e+00, double 0x409E49BA597D49D8}
!109 = distinct !{!109, !23}
!110 = !{!111, !53, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 27}
!112 = !{!111, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 2.250000e+01}
!114 = !{!49, !115, i1 false, i2 -1}
!115 = !{double 0.000000e+00, double 0x4074A00007DD4413}
!116 = !{!49, !117, i1 false, i2 -1}
!117 = !{double 0.000000e+00, double 0x409E6570A1DFB939}
!118 = distinct !{!118, !23}
!119 = distinct !{!119, !23}
!120 = distinct !{!120, !23}
...
!162 = !{i1 false, !76, i1 false, i2 1}
!163 = !{!52, !76, i1 false, i2 1}
!164 = !{!52, !91, i1 false, i2 1}
!165 = !{!141, !166, i1 false, i2 1}
!166 = !{double 0.000000e+00, double 0x3FED555555555555}
!167 = !{!52, !55, i1 false, i2 1}
!168 = distinct !{!168, !23}
!169 = distinct !{!169, !23}
!170 = !{i32 -1, i32 -1, i32 3, i32 -1}
!171 = !{i32 1, !16, i32 1, !90, i32 1, !48, i32 1, !100}
!172 = !{i32 8}
!173 = !{!174, !175, i1 false, i2 -1}
!174 = !{!"fixp", i32 32, i32 17}
!175 = !{double 0.000000e+00, double 0x40D93D709FE86834}
!176 = !{i32 9}
!177 = distinct !{!177, !23}
!178 = distinct !{!178, !23}
!179 = !{i32 1, !16, i32 1, !100, i32 1, !51, i32 1, !100}
!180 = !{!181, !182, i1 false, i2 -1}
!181 = !{!"fixp", i32 32, i32 24}
!182 = !{double 0.000000e+00, double 2.400000e+02}
!183 = distinct !{!183, !23}
!184 = distinct !{!184, !23}
