; ModuleID = './build/bin/fixed/syr2k/16/syr2k-standard-2-fixed-16.out.ll'
...
entry:
  ...
  %u2_30fixp3 = bitcast [10 x i32]* %arraydecay9.u2_30fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u2_30fixp3, i32 2), !taffo.info !60, !taffo.constinfo !59
  %arraydecay10.u2_30fixp = getelementptr inbounds [16 x [10 x i32]], [16 x [10 x i32]]* %B.u2_30fixp, i32 0, i32 0, !taffo.info !52
  %u2_30fixp2 = bitcast [10 x i32]* %arraydecay10.u2_30fixp to i32*, !taffo.info !52
  call void @scale_2d.6_fixp(i32 16, i32 10, i32* %u2_30fixp2, i32 2), !taffo.info !61, !taffo.constinfo !59
  ...
  call void @kernel_syr2k.3_fixp(i32 16, i32 10, i32 %u2_30fixp1, i32 %u2_30fixp, [16 x i32]* %arraydecay11.u6_26fixp, [10 x i32]* %arraydecay12.u2_30fixp, [10 x i32]* %arraydecay13.u2_30fixp), !taffo.info !54, !taffo.constinfo !55
...
for.body16:                                       ; preds = %for.cond14
  ...
  %1 = fdiv float %lampsim2, 0x4190000000000000, !taffo.info !47, !taffo.target !49
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* noundef %1, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), double noundef %lampsim3), !taffo.constinfo !82
  br label %for.inc
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !176 !taffo.funinfo !177 !taffo.sourceFunction !178 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u6_26fixp = load i32, i32* %arrayidx4.u6_26fixp, align 4, !taffo.info !179
  %conv.u2_30fixp = shl i32 %factor, 30, !taffo.info !181
  %1 = lshr i32 %u6_26fixp, 1, !taffo.info !179
  %2 = lshr i32 %conv.u2_30fixp, 1, !taffo.info !181
  %3 = ashr i32 %1, 1, !taffo.info !179
  %4 = ashr i32 %2, 5, !taffo.info !181
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 24), !taffo.info !182
  %mul.u7_25fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u7_25fixp, 1, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !176 !taffo.funinfo !188 !taffo.sourceFunction !178 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u3_29fixp = shl i32 %factor, 29, !taffo.info !189
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !110
  %2 = lshr i32 %conv.u3_29fixp, 1, !taffo.info !189
  %3 = ashr i32 %1, 1, !taffo.info !110
  %4 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %2, i32 28), !taffo.info !190
  %mul.u3_29fixp = shl i32 %4, 1, !taffo.info !192
  ...
  %6 = shl i32 %mul.u3_29fixp, 1, !taffo.info !192
...
!177 = !{i32 1, !76, i32 1, !76, i32 1, !47, i32 1, !19}
!178 = !{void (i32, i32, float*, i32)* @scale_2d}
!179 = !{!180, !1, i1 false, i2 -1}
!180 = !{!"fixp", i32 32, i32 25}
!181 = !{!43, !20, i1 false, i2 1}
!182 = !{!183, !184, i1 false, i2 -1}
!183 = !{!"fixp", i32 -32, i32 24}
!184 = !{double 0.000000e+00, double 0x4050728F42FE8251}
!185 = !{!180, !184, i1 false, i2 -1}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
!188 = !{i32 1, !76, i32 1, !16, i32 1, !50, i32 1, !19}
!189 = !{!100, !20, i1 false, i2 1}
!190 = !{!97, !191, i1 false, i2 -1}
!191 = !{double 0.000000e+00, double 3.750000e+00}
!192 = !{!100, !191, i1 false, i2 -1}
!193 = distinct !{!193, !23}
!194 = distinct !{!194, !23}
