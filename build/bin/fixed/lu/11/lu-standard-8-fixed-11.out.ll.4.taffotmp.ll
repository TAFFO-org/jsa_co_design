; ModuleID = './build/bin/fixed/lu/11/lu-standard-8-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 8), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %conv, !taffo.info !146, !taffo.initweight !148
...
!82 = !{!"fixp", i32 -32, i32 18}
!83 = !{double 0x3F847AE147AE147C, double 0x40B0B28B44170636}
!84 = !{!82, !85, i1 false, i2 1}
!85 = !{double 0xC0B0B271AA7D6C9C, double 0x405057AE07E5A78F}
!86 = !{i1 false, i1 false, i1 false, i2 1}
!87 = distinct !{!87, !23}
!88 = !{!89, !90, i1 false, i2 -1}
!89 = !{!"fixp", i32 32, i32 22}
!90 = !{double 0x3F590F4561865B7B, double 0x40846E6656ABDE40}
!91 = !{i32 8}
!92 = distinct !{!92, !23}
!93 = distinct !{!93, !23}
!94 = distinct !{!94, !23}
...
!98 = !{double 0.000000e+00, double 0x40B0B28B44170636}
...
!143 = !{double 8.000000e+00, double 8.000000e+00}
!144 = !{!145, !143, i1 false, i2 1}
!145 = !{!"fixp", i32 32, i32 28}
!146 = !{!89, !147, i1 false, i2 -1}
!147 = !{double 8.000000e-01, double 0x40805851DEEFE500}
!148 = !{i32 9}
!149 = distinct !{!149, !23}
!150 = distinct !{!150, !23}
