; ModuleID = './build/bin/fixed/jacobi-1d/11/jacobi-1d-standard-8-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay4, i32 noundef 8), !taffo.info !50, !taffo.initweight !51, !taffo.constinfo !52, !taffo.target !45, !taffo.originalCall !54
  %arraydecay5 = getelementptr inbounds [15 x float], [15 x float]* %B, i32 0, i32 0, !taffo.info !46, !taffo.initweight !49
  call void @scale_1d.1(i32 noundef 15, float* noundef %arraydecay5, i32 noundef 8), !taffo.info !55, !taffo.initweight !51, !taffo.constinfo !52, !taffo.originalCall !54
...
!47 = !{double 1.600000e+00, double 0x402222222D5171E3}
...
!85 = !{double 0x402111116A8B8F15, double 0x40511111276FB092}
!86 = !{i32 7}
!87 = distinct !{!87, !23}
...
!97 = !{double 0x400111116A8B8F15, double 0x40311111276FB092}
!98 = !{!95, !99, i1 false, i2 -1}
!99 = !{double 0x4009999A1FD156A0, double 0x40399999BB2788DB}
!100 = !{i32 8}
!101 = !{!95, !102, i1 false, i2 -1}
!102 = !{double 0x3FF111063B3B93F8, double 0x40211105F81FE170}
!103 = !{i32 9}
!104 = !{!105, i1 false}
!105 = !{i1 false, !106, i1 false, i2 0}
!106 = !{double 3.333300e-01, double 3.333300e-01}
!107 = !{!42, !108, i1 false, i2 -1}
!108 = !{double 0x3FF1110620000000, double 0x4021110600000000}
!109 = !{i32 10}
!110 = distinct !{!110, !23}
!111 = !{!95, !47, i1 false, i2 -1}
!112 = !{!95, !113, i1 false, i2 -1}
!113 = !{double 3.200000e+00, double 0x403222222D5171E3}
!114 = !{!95, !115, i1 false, i2 -1}
!115 = !{double 0x4013333333333334, double 0x403B333343FA2AD4}
!116 = !{!95, !117, i1 false, i2 -1}
!117 = !{double 0x3FF99988D2A1F8E5, double 0x402222164B0CAE0E}
!118 = !{!42, !119, i1 false, i2 -1}
!119 = !{double 0x3FF99988C0000000, double 0x4022221660000000}
!120 = distinct !{!120, !23}
!121 = distinct !{!121, !23}
