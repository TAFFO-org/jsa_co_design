; ModuleID = './build/bin/fixed/mvt/11/mvt-standard-1024-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 1024), !taffo.info !56, !taffo.initweight !60, !taffo.constinfo !61, !taffo.originalCall !62
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 1024), !taffo.info !63, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !50, !taffo.originalCall !65
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay12, i32 noundef 1024), !taffo.info !66, !taffo.initweight !57, !taffo.constinfo !64, !taffo.target !52, !taffo.originalCall !65
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %y_1, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 1024), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
  %arraydecay14 = getelementptr inbounds [20 x float], [20 x float]* %y_2, i32 0, i32 0, !taffo.info !44, !taffo.initweight !54
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay14, i32 noundef 1024), !taffo.info !56, !taffo.initweight !57, !taffo.constinfo !64, !taffo.originalCall !65
...
for.body:                                         ; preds = %for.cond
  ...
  %mul = fmul float %0, %conv, !taffo.info !94, !taffo.initweight !97
...
for.body:                                         ; preds = %for.cond
  ...
  %0 = load float, float* %arrayidx, align 4, !taffo.info !44, !taffo.initweight !91
  %conv = sitofp i32 %factor to float, !taffo.info !92
  %mul = fmul float %0, %conv, !taffo.info !100, !taffo.initweight !97
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx5, align 4, !taffo.info !44, !taffo.initweight !97
  %arrayidx6 = getelementptr inbounds float, float* %y_1, i32 %j.0, !taffo.info !44, !taffo.initweight !90
  %2 = load float, float* %arrayidx6, align 4, !taffo.info !44, !taffo.initweight !91
  %mul = fmul float %1, %2, !taffo.info !106, !taffo.initweight !97
  %add = fadd float %0, %mul, !taffo.info !108, !taffo.initweight !97
...
for.body16:                                       ; preds = %for.cond14
  ...
  %4 = load float, float* %arrayidx19, align 4, !taffo.info !44, !taffo.initweight !97
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %j.1, !taffo.info !44, !taffo.initweight !90
  %5 = load float, float* %arrayidx20, align 4, !taffo.info !44, !taffo.initweight !91
  %mul21 = fmul float %4, %5, !taffo.info !106, !taffo.initweight !97
  %add22 = fadd float %3, %mul21, !taffo.info !112, !taffo.initweight !97
...
for.body:                                         ; preds = %for.cond
  ...
  %conv3 = sitofp i32 %n to float, !taffo.info !124
  %div = fdiv float %conv, %conv3, !taffo.info !125, !taffo.initweight !128
  %arrayidx = getelementptr inbounds float, float* %x1, i32 %i.0, !taffo.info !129, !taffo.initweight !57
  store float %div, float* %arrayidx, align 4, !taffo.info !130, !taffo.initweight !60
  %add = add nsw i32 %i.0, 1, !taffo.info !131, !taffo.initweight !57, !taffo.constinfo !23
  %rem4 = srem i32 %add, %n, !taffo.info !120, !taffo.initweight !60
  %conv5 = sitofp i32 %rem4 to float, !taffo.info !122, !taffo.initweight !128
  %conv6 = sitofp i32 %n to float, !taffo.info !124
  %div7 = fdiv float %conv5, %conv6, !taffo.info !125, !taffo.initweight !90
  %arrayidx8 = getelementptr inbounds float, float* %x2, i32 %i.0, !taffo.info !132, !taffo.initweight !57
  store float %div7, float* %arrayidx8, align 4, !taffo.info !130, !taffo.initweight !60
  %add9 = add nsw i32 %i.0, 3, !taffo.info !133, !taffo.initweight !57, !taffo.constinfo !23
  %rem10 = srem i32 %add9, %n, !taffo.info !120, !taffo.initweight !60
  %conv11 = sitofp i32 %rem10 to float, !taffo.info !122, !taffo.initweight !128
  %conv12 = sitofp i32 %n to float, !taffo.info !124
  %div13 = fdiv float %conv11, %conv12, !taffo.info !125, !taffo.initweight !90
  %arrayidx14 = getelementptr inbounds float, float* %y_1, i32 %i.0, !taffo.info !135, !taffo.initweight !57
  store float %div13, float* %arrayidx14, align 4, !taffo.info !130, !taffo.initweight !60
  %add15 = add nsw i32 %i.0, 4, !taffo.info !136, !taffo.initweight !57, !taffo.constinfo !23
  %rem16 = srem i32 %add15, %n, !taffo.info !120, !taffo.initweight !60
  %conv17 = sitofp i32 %rem16 to float, !taffo.info !122, !taffo.initweight !128
  %conv18 = sitofp i32 %n to float, !taffo.info !124
  %div19 = fdiv float %conv17, %conv18, !taffo.info !125, !taffo.initweight !90
  %arrayidx20 = getelementptr inbounds float, float* %y_2, i32 %i.0, !taffo.info !135, !taffo.initweight !57
  store float %div19, float* %arrayidx20, align 4, !taffo.info !130, !taffo.initweight !60
  br label %for.cond21
...
for.body24:                                       ; preds = %for.cond21
  %mul = mul nsw i32 %i.0, %j.0, !taffo.info !138, !taffo.initweight !57
  %rem25 = srem i32 %mul, %n, !taffo.info !120, !taffo.initweight !60
  %conv26 = sitofp i32 %rem25 to float, !taffo.info !122, !taffo.initweight !128
  %conv27 = sitofp i32 %n to float, !taffo.info !124
  %div28 = fdiv float %conv26, %conv27, !taffo.info !125, !taffo.initweight !90
  %arrayidx29 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.info !135, !taffo.initweight !57
  %arrayidx30 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx29, i32 0, i32 %j.0, !taffo.info !135, !taffo.initweight !57
  store float %div28, float* %arrayidx30, align 4, !taffo.info !130, !taffo.initweight !60
  br label %for.inc

for.inc:                                          ; preds = %for.body24
  %inc = add nsw i32 %j.0, 1, !taffo.info !131, !taffo.initweight !57, !taffo.constinfo !23
...
for.inc31:                                        ; preds = %for.end
  %inc32 = add nsw i32 %i.0, 1, !taffo.info !131, !taffo.initweight !57, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !142 !taffo.funinfo !143 !taffo.sourceFunction !62 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !44, !taffo.initweight !144
  %conv = sitofp i32 %factor to float, !taffo.info !92
  %mul = fmul float %1, %conv, !taffo.info !100, !taffo.initweight !145
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !56, !taffo.initweight !144
  br label %for.inc
...
!95 = !{!"float", i32 1, double 0x41F39A7320000000}
!96 = !{double 0.000000e+00, double 0x41F39A7320000000}
!97 = !{i32 7}
!98 = distinct !{!98, !25}
!99 = !{i32 1, !77, i32 1, !44, i32 1, !88}
!100 = !{!101, !102, i1 false, i2 -1}
!101 = !{!"fixp", i32 32, i32 12}
!102 = !{double 0.000000e+00, double 0x412E6666601BC98A}
!103 = distinct !{!103, !25}
...
!107 = !{double 0.000000e+00, double 0x412CE147A22050D9}
!108 = !{!49, !109, i1 false, i2 -1}
!109 = !{double 0.000000e+00, double 0x4157369C14440A1B}
!110 = distinct !{!110, !25}
!111 = distinct !{!111, !25}
!112 = !{!49, !113, i1 false, i2 -1}
!113 = !{double 0.000000e+00, double 0x4157830F54440A1B}
!114 = distinct !{!114, !25}
!115 = distinct !{!115, !25}
...
!124 = !{!123, !78, i1 false, i2 1}
!125 = !{!126, !127, i1 false, i2 1}
!126 = !{!"fixp", i32 32, i32 31}
!127 = !{double 0.000000e+00, double 0x3FEE666666666666}
!128 = !{i32 4}
!129 = !{!49, !1, i1 false, i2 1}
!130 = !{i1 false, i1 false, i1 false, i2 1}
!131 = !{i1 false, !74, i1 false, i2 1}
!132 = !{!49, !3, i1 false, i2 1}
...
!143 = !{i32 1, !77, i32 1, !77, i32 1, !44, i32 1, !88}
!144 = !{i32 8}
!145 = !{i32 9}
!146 = distinct !{!146, !25}
!147 = distinct !{!147, !25}
