; ModuleID = './build/bin/fixed/heat-3d/11/heat-3d-standard-256-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %0, i32 noundef 256), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
  ...
  call void @scale_3d.3(i32 noundef 5, i32 noundef 5, i32 noundef 5, float* noundef %1, i32 noundef 256), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.originalCall !54
...
!103 = !{double 1.024000e+03, double 1.331200e+04}
!104 = !{i32 9}
!105 = !{!102, !106, i1 false, i2 -1}
!106 = !{double -1.280000e+04, double 5.632000e+03}
!107 = !{!102, !108, i1 false, i2 -1}
!108 = !{double -1.228800e+04, double 1.228800e+04}
!109 = !{!110, !111, i1 false, i2 -1}
!110 = !{!"fixp", i32 -32, i32 19}
!111 = !{double -1.536000e+03, double 1.536000e+03}
!112 = !{i32 10}
!113 = !{!114, i1 false}
...
!118 = !{double -3.072000e+03, double 3.072000e+03}
!119 = !{i32 11}
!120 = !{!117, !111, i1 false, i2 -1}
!121 = !{!102, !122, i1 false, i2 -1}
!122 = !{double -4.608000e+03, double 4.608000e+03}
!123 = !{!102, !124, i1 false, i2 -1}
!124 = !{double -4.096000e+03, double 1.126400e+04}
!125 = distinct !{!125, !23}
!126 = distinct !{!126, !23}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
...
!162 = !{double 2.560000e+02, double 2.560000e+02}
...
!169 = !{double 1.310720e+05, double 0x413A000000000000}
!170 = distinct !{!170, !23}
!171 = distinct !{!171, !23}
!172 = distinct !{!172, !23}
