; ModuleID = './build/bin/fixed/atax/11/atax-standard-2-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.6(i32 noundef 20, i32 noundef 22, float* noundef %0, i32 noundef 2), !taffo.info !60, !taffo.initweight !64, !taffo.constinfo !65, !taffo.originalCall !66
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0, !taffo.info !46, !taffo.initweight !56
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 2), !taffo.info !67, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
  ...
  call void @scale_1d.2(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 2), !taffo.info !70, !taffo.initweight !61, !taffo.constinfo !68, !taffo.target !51, !taffo.originalCall !69
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !56
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.info !71, !taffo.initweight !61, !taffo.constinfo !68, !taffo.originalCall !69
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !46, !taffo.initweight !92
  %0 = load float, float* %arrayidx, align 4, !taffo.info !93, !taffo.initweight !95
  %conv = sitofp i32 %factor to float, !taffo.info !96
  %mul = fmul float %0, %conv, !taffo.info !97, !taffo.initweight !99
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !46, !taffo.initweight !92
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.2(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !90 !taffo.funinfo !101 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !49, !taffo.initweight !92
  %0 = load float, float* %arrayidx, align 4, !taffo.info !102, !taffo.initweight !95
  %conv = sitofp i32 %factor to float, !taffo.info !104
  %mul = fmul float %0, %conv, !taffo.info !106, !taffo.initweight !99
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !49, !taffo.initweight !92
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !49, !taffo.initweight !92
  store float 0.000000e+00, float* %arrayidx, align 4, !taffo.info !113, !taffo.initweight !92, !taffo.constinfo !114
  br label %for.inc
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx4 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.info !52, !taffo.initweight !92
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !113, !taffo.initweight !92, !taffo.constinfo !114
  br label %for.cond5
...
for.body7:                                        ; preds = %for.cond5
  %arrayidx8 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.info !52, !taffo.initweight !92
  %0 = load float, float* %arrayidx8, align 4, !taffo.info !52, !taffo.initweight !95
  %arrayidx9 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.info !42, !taffo.initweight !92
  %arrayidx10 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx9, i32 0, i32 %j.0, !taffo.info !42, !taffo.initweight !95
  %1 = load float, float* %arrayidx10, align 4, !taffo.info !116, !taffo.initweight !99
  %arrayidx11 = getelementptr inbounds float, float* %x, i32 %j.0, !taffo.info !46, !taffo.initweight !92
  %2 = load float, float* %arrayidx11, align 4, !taffo.info !46, !taffo.initweight !95
  %mul = fmul float %1, %2, !taffo.info !117, !taffo.initweight !99
  %add = fadd float %0, %mul, !taffo.info !119, !taffo.initweight !99
  %arrayidx12 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.info !52, !taffo.initweight !92
...
for.body18:                                       ; preds = %for.cond16
  %arrayidx19 = getelementptr inbounds float, float* %y, i32 %j.1, !taffo.info !49, !taffo.initweight !92
  %3 = load float, float* %arrayidx19, align 4, !taffo.info !102, !taffo.initweight !95
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.info !42, !taffo.initweight !92
  %arrayidx21 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx20, i32 0, i32 %j.1, !taffo.info !42, !taffo.initweight !95
  %4 = load float, float* %arrayidx21, align 4, !taffo.info !122, !taffo.initweight !99
  %arrayidx22 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.info !52, !taffo.initweight !92
  %5 = load float, float* %arrayidx22, align 4, !taffo.info !52, !taffo.initweight !95
  %mul23 = fmul float %4, %5, !taffo.info !123, !taffo.initweight !99
  %add24 = fadd float %3, %mul23, !taffo.info !125, !taffo.initweight !99
  %arrayidx25 = getelementptr inbounds float, float* %y, i32 %j.1, !taffo.info !49, !taffo.initweight !92
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !90 !taffo.funinfo !129 !taffo.sourceFunction !69 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !52, !taffo.initweight !92
  %0 = load float, float* %arrayidx, align 4, !taffo.info !52, !taffo.initweight !95
  %conv = sitofp i32 %factor to float, !taffo.info !104
  %mul = fmul float %0, %conv, !taffo.info !130, !taffo.initweight !99
  %arrayidx1 = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !52, !taffo.initweight !92
...
entry:
  %conv = sitofp i32 %n to float, !taffo.info !133, !taffo.initweight !61
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %i.0 = phi i32 [ 0, %entry ], [ %inc, %for.inc ], !taffo.info !134, !taffo.initweight !45
  %cmp = icmp slt i32 %i.0, %n, !taffo.info !136, !taffo.initweight !61
  br i1 %cmp, label %for.body, label %for.end, !taffo.info !134, !taffo.initweight !64

for.body:                                         ; preds = %for.cond
  %conv5 = sitofp i32 %i.0 to float, !taffo.info !137, !taffo.initweight !61
  %div = fdiv float %conv5, %conv, !taffo.info !138, !taffo.initweight !61
  %add = fadd float 1.000000e+00, %div, !taffo.info !139, !taffo.initweight !64, !taffo.constinfo !141
  %arrayidx = getelementptr inbounds float, float* %x, i32 %i.0, !taffo.info !142, !taffo.initweight !61
  store float %add, float* %arrayidx, align 4, !taffo.info !113, !taffo.initweight !64
  %arrayidx6 = getelementptr inbounds float, float* %y, i32 %i.0, !taffo.info !143, !taffo.initweight !61
  store float 0.000000e+00, float* %arrayidx6, align 4, !taffo.info !113, !taffo.initweight !64, !taffo.constinfo !114
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !144, !taffo.initweight !61, !taffo.constinfo !21
...
for.cond7:                                        ; preds = %for.inc25, %for.end
  %i.1 = phi i32 [ 0, %for.end ], [ %inc26, %for.inc25 ], !taffo.info !134, !taffo.initweight !45
  %cmp8 = icmp slt i32 %i.1, %m, !taffo.info !136, !taffo.initweight !61
  br i1 %cmp8, label %for.body10, label %for.end27, !taffo.info !134, !taffo.initweight !64

for.body10:                                       ; preds = %for.cond7
  %arrayidx11 = getelementptr inbounds float, float* %tmp, i32 %i.1, !taffo.info !146, !taffo.initweight !61
...
for.cond12:                                       ; preds = %for.inc22, %for.body10
  %j.0 = phi i32 [ 0, %for.body10 ], [ %inc23, %for.inc22 ], !taffo.info !134, !taffo.initweight !45
  %cmp13 = icmp slt i32 %j.0, %n, !taffo.info !136, !taffo.initweight !61
  br i1 %cmp13, label %for.body15, label %for.end24, !taffo.info !134, !taffo.initweight !64

for.body15:                                       ; preds = %for.cond12
  %add16 = add nsw i32 %i.1, %j.0, !taffo.info !147, !taffo.initweight !61
  %rem = srem i32 %add16, %n, !taffo.info !149, !taffo.initweight !64
  %conv17 = sitofp i32 %rem to float, !taffo.info !151, !taffo.initweight !152
  %mul = mul nsw i32 5, %m, !taffo.info !153, !taffo.constinfo !21
  %conv18 = sitofp i32 %mul to float, !taffo.info !155
  %div19 = fdiv float %conv17, %conv18, !taffo.info !156, !taffo.initweight !92
  %arrayidx20 = getelementptr inbounds [22 x float], [22 x float]* %A, i32 %i.1, !taffo.info !158, !taffo.initweight !61
  %arrayidx21 = getelementptr inbounds [22 x float], [22 x float]* %arrayidx20, i32 0, i32 %j.0, !taffo.info !158, !taffo.initweight !61
  store float %div19, float* %arrayidx21, align 4, !taffo.info !113, !taffo.initweight !64
  br label %for.inc22

for.inc22:                                        ; preds = %for.body15
  %inc23 = add nsw i32 %j.0, 1, !taffo.info !144, !taffo.initweight !61, !taffo.constinfo !21
...
for.inc25:                                        ; preds = %for.end24
  %inc26 = add nsw i32 %i.1, 1, !taffo.info !144, !taffo.initweight !61, !taffo.constinfo !21
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !161 !taffo.funinfo !162 !taffo.sourceFunction !66 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %arrayidx4 = getelementptr inbounds float, float* %arrayidx, i32 %j.0, !taffo.info !42, !taffo.initweight !99
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !42, !taffo.initweight !163
  %conv = sitofp i32 %factor to float, !taffo.info !104
  ...
  %arrayidx6 = getelementptr inbounds float, float* %arrayidx5, i32 %j.0, !taffo.info !42, !taffo.initweight !99
  store float %mul, float* %arrayidx6, align 4, !taffo.info !60, !taffo.initweight !163
  br label %for.inc
...
!48 = !{double 2.000000e+00, double 0x400F45D18090B418}
!49 = !{!50, !1, i1 false, i2 -1}
!50 = !{!"fixp", i32 32, i32 26}
!51 = !{!"y"}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 27}
!54 = !{double 0.000000e+00, double 1.526000e+01}
...
!91 = !{i32 1, !83, i32 1, !46, i32 1, !19}
!92 = !{i32 5}
!93 = !{!94, !48, i1 false, i2 -1}
!94 = !{!"fixp", i32 32, i32 28}
!95 = !{i32 6}
!96 = !{!94, !20, i1 false, i2 1}
!97 = !{!94, !98, i1 false, i2 -1}
!98 = !{double 4.000000e+00, double 0x401F45D18090B418}
!99 = !{i32 7}
!100 = distinct !{!100, !23}
!101 = !{i32 1, !83, i32 1, !49, i32 1, !19}
!102 = !{!103, !1, i1 false, i2 -1}
!103 = !{!"fixp", i32 32, i32 25}
!104 = !{!105, !20, i1 false, i2 1}
!105 = !{!"fixp", i32 32, i32 30}
!106 = !{!103, !107, i1 false, i2 -1}
!107 = !{double 0.000000e+00, double 0x405EC4189BD8383B}
!108 = distinct !{!108, !23}
...
!114 = !{!87, i1 false}
!115 = distinct !{!115, !23}
!116 = !{!105, !44, i1 false, i2 -1}
!117 = !{!105, !118, i1 false, i2 -1}
!118 = !{double 0.000000e+00, double 0x3FFA44E32E8E07EB}
!119 = !{!53, !120, i1 false, i2 -1}
!120 = !{double 0.000000e+00, double 0x4030E6DD8F11D641}
!121 = distinct !{!121, !23}
!122 = !{!47, !44, i1 false, i2 -1}
!123 = !{!47, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4019A305532617C1}
!125 = !{!103, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x4050FC3CA31E7D9A}
!127 = distinct !{!127, !23}
!128 = distinct !{!128, !23}
!129 = !{i32 1, !111, i32 1, !52, i32 1, !19}
!130 = !{!53, !131, i1 false, i2 -1}
!131 = !{double 0.000000e+00, double 3.052000e+01}
!132 = distinct !{!132, !23}
!133 = !{!53, !84, i1 false, i2 1}
!134 = !{i1 false, !135, i1 false, i2 -1}
!135 = !{double 0.000000e+00, double 2.200000e+01}
!136 = !{i1 false, !77, i1 false, i2 -1}
!137 = !{!53, !135, i1 false, i2 -1}
!138 = !{!105, !77, i1 false, i2 1}
!139 = !{!105, !140, i1 false, i2 1}
!140 = !{double 1.000000e+00, double 2.000000e+00}
!141 = !{!85, i1 false}
!142 = !{!47, !48, i1 false, i2 1}
!143 = !{!50, !1, i1 false, i2 1}
!144 = !{i1 false, !79, i1 false, i2 -1}
!145 = distinct !{!145, !23}
!146 = !{!53, !54, i1 false, i2 1}
!147 = !{i1 false, !148, i1 false, i2 -1}
!148 = !{double 0.000000e+00, double 4.400000e+01}
!149 = !{i1 false, !150, i1 false, i2 -1}
!150 = !{double 0.000000e+00, double 2.100000e+01}
!151 = !{!53, !150, i1 false, i2 -1}
!152 = !{i32 4}
!153 = !{i1 false, !154, i1 false, i2 0}
!154 = !{double 1.000000e+02, double 1.000000e+02}
!155 = !{!103, !154, i1 false, i2 1}
!156 = !{!43, !157, i1 false, i2 -1}
!157 = !{double 0.000000e+00, double 2.100000e-01}
!158 = !{!43, !44, i1 false, i2 1}
!159 = distinct !{!159, !23}
!160 = distinct !{!160, !23}
!161 = !{i32 -1, i32 -1, i32 3, i32 -1}
!162 = !{i32 1, !111, i32 1, !83, i32 1, !42, i32 1, !19}
!163 = !{i32 8}
!164 = !{!105, !165, i1 false, i2 -1}
!165 = !{double 0.000000e+00, double 8.400000e-01}
!166 = !{i32 9}
!167 = distinct !{!167, !23}
!168 = distinct !{!168, !23}
