; ModuleID = './build/bin/fixed/bicg/24/bicg-standard-32-fixed-24.out.ll.4.taffotmp.ll'
...
for.body24:                                       ; preds = %for.cond22
  ...
  %u13_19fixp = load i32, i32* %arrayidx25.u13_19fixp, align 4, !taffo.info !50, !taffo.target !51
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u10_22fixp, 5, !taffo.info !96
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !86 !taffo.funinfo !99 !taffo.sourceFunction !90 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !100
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !103
  %arrayidx1.u13_19fixp = getelementptr inbounds i32, i32* %val.u13_19fixp, i32 %i.0, !taffo.info !47
  %5 = shl i32 %mul.u18_14fixp, 5, !taffo.info !103
...
!95 = !{double 0.000000e+00, double 0x408E666666666666}
...
!102 = !{double 0.000000e+00, double 0x410B5D176006D0D5}
