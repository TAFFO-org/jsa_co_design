; ModuleID = './build/stats/syrk/1024/syrk-standard-1024.out.dynamic_instrumented.named.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.4(i32 noundef 16, i32 noundef 16, float* noundef %2, i32 noundef 1024), !taffo.originalCall !29
  ...
  call void @scale_2d.3(i32 noundef 16, i32 noundef 10, float* noundef %3, i32 noundef 1024), !taffo.originalCall !29
