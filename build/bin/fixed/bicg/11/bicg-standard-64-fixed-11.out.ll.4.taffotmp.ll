; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-64-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 64), !taffo.info !58, !taffo.initweight !62, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 64), !taffo.info !65, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !50, !taffo.originalCall !67
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 64), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !52, !taffo.originalCall !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.info !53, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 64), !taffo.info !69, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.info !44, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 64), !taffo.info !58, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
...
!54 = !{double 0.000000e+00, double 0x404E66665E02EA96}
...
!99 = !{double 6.400000e+01, double 6.400000e+01}
!100 = !{i32 5}
!101 = !{i32 6}
...
!106 = !{double 0.000000e+00, double 0x413B5D175FFE6D59}
!107 = !{i32 7}
!108 = distinct !{!108, !25}
!109 = !{i32 1, !85, i32 1, !53, i32 1, !98}
!110 = !{!111, !112, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 20}
!112 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!113 = distinct !{!113, !25}
...
!120 = !{double 0.000000e+00, double 0x40AD2832B567D1B8}
!121 = !{!49, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x40DF021DB6AB6790}
!123 = !{!111, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x40AD04A77F97072E}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x40DBCF208FF4738D}
!127 = distinct !{!127, !25}
!128 = distinct !{!128, !25}
...
!165 = !{double 0.000000e+00, double 0x40AE8BA2DF9378EE}
!166 = !{i32 9}
!167 = distinct !{!167, !25}
!168 = distinct !{!168, !25}
