; ModuleID = './build/bin/fixed/gemver/8/gemver-standard-1024-fixed-8.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4140000000000000, !taffo.info !127
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !129
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = fdiv float %2, 0x4140000000000000, !taffo.info !127
  %mul.1flp = fmul float %1, %3, !taffo.info !148
  %arrayidx1.u29_3fixp = getelementptr inbounds i32, i32* %val.u29_3fixp, i32 %i.0, !taffo.info !69
  %4 = fmul float 8.000000e+00, %mul.1flp, !taffo.info !148
  %5 = fptoui float %4 to i32, !taffo.info !148
...
for.body51:                                       ; preds = %for.cond49
  ...
  %29 = fdiv float %28, 8.192000e+03, !taffo.info !198
  ...
  %mul57.1flp = fmul float %29, %31, !taffo.info !199
  %add58.1flp = fadd float %.flt.fallback.1flp, %mul57.1flp, !taffo.info !202
