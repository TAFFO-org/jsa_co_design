...
@.str = private unnamed_addr constant [39 x i8] c"scalar(range(0.0,113595.742188) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [16 x i8] c"./sources/3mm.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,170.666672) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,179.199997) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [39 x i8] c"scalar(range(0.0,134217.734375) final)\00", section "llvm.metadata"
@.str.5 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,187.733337) final)\00", section "llvm.metadata"
@.str.6 = private unnamed_addr constant [36 x i8] c"scalar(range(0.0,184.320007) final)\00", section "llvm.metadata"
@.str.7 = private unnamed_addr constant [51 x i8] c"target('G') scalar(range(0.0,59685158912.0) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d(i32 noundef 6, i32 noundef 8, ptr noundef %arraydecay7, i32 noundef 1024)
  %arraydecay8 = getelementptr inbounds [6 x [10 x float]], ptr %A, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 10, ptr noundef %arraydecay8, i32 noundef 1024)
  %arraydecay9 = getelementptr inbounds [10 x [8 x float]], ptr %B, i32 0, i32 0
  call void @scale_2d(i32 noundef 10, i32 noundef 8, ptr noundef %arraydecay9, i32 noundef 1024)
  %arraydecay10 = getelementptr inbounds [8 x [12 x float]], ptr %F, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 12, ptr noundef %arraydecay10, i32 noundef 1024)
  %arraydecay11 = getelementptr inbounds [8 x [14 x float]], ptr %C, i32 0, i32 0
  call void @scale_2d(i32 noundef 8, i32 noundef 14, ptr noundef %arraydecay11, i32 noundef 1024)
  %arraydecay12 = getelementptr inbounds [14 x [12 x float]], ptr %D, i32 0, i32 0
  call void @scale_2d(i32 noundef 14, i32 noundef 12, ptr noundef %arraydecay12, i32 noundef 1024)
  %arraydecay13 = getelementptr inbounds [6 x [12 x float]], ptr %G, i32 0, i32 0
  call void @scale_2d(i32 noundef 6, i32 noundef 12, ptr noundef %arraydecay13, i32 noundef 1024)
  ...
  %arraydecay14 = getelementptr inbounds [6 x [8 x float]], ptr %E, i32 0, i32 0
  %arraydecay15 = getelementptr inbounds [6 x [10 x float]], ptr %A, i32 0, i32 0
  %arraydecay16 = getelementptr inbounds [10 x [8 x float]], ptr %B, i32 0, i32 0
  %arraydecay17 = getelementptr inbounds [8 x [12 x float]], ptr %F, i32 0, i32 0
  %arraydecay18 = getelementptr inbounds [8 x [14 x float]], ptr %C, i32 0, i32 0
  %arraydecay19 = getelementptr inbounds [14 x [12 x float]], ptr %D, i32 0, i32 0
  %arraydecay20 = getelementptr inbounds [6 x [12 x float]], ptr %G, i32 0, i32 0
  call void @kernel_3mm(i32 noundef %5, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9, ptr noundef %arraydecay14, ptr noundef %arraydecay15, ptr noundef %arraydecay16, ptr noundef %arraydecay17, ptr noundef %arraydecay18, ptr noundef %arraydecay19, ptr noundef %arraydecay20)
...
for.body23:                                       ; preds = %for.cond21
  ...
  %15 = load i32, ptr %j, align 4
  %arrayidx24 = getelementptr inbounds [12 x float], ptr %arrayidx, i32 0, i32 %15
  %16 = load float, ptr %arrayidx24, align 4
  %17 = load i32, ptr %i, align 4
  %arrayidx25 = getelementptr inbounds [6 x [12 x float]], ptr @G_float, i32 0, i32 %17
  %18 = load i32, ptr %j, align 4
  %arrayidx26 = getelementptr inbounds [12 x float], ptr %arrayidx25, i32 0, i32 %18
...
for.body17:                                       ; preds = %for.cond14
  ...
  %conv24 = sitofp i32 %mul23 to float
  ...
  store float %div25, ptr %arrayidx27, align 4
  br label %for.inc28
...
for.body41:                                       ; preds = %for.cond38
  ...
  %div48 = fdiv float %conv45, %conv47
  ...
  store float %div48, ptr %arrayidx50, align 4
  br label %for.inc51
...
for.body64:                                       ; preds = %for.cond61
  ...
  store float %div72, ptr %arrayidx74, align 4
  br label %for.inc75
...
for.inc110:                                       ; preds = %for.end109
  ...
  br label %for.cond97, !llvm.loop !28
...
for.inc123:                                       ; preds = %for.body120
  ...
  br label %for.cond117, !llvm.loop !29
...
for.inc126:                                       ; preds = %for.end125
  ...
  br label %for.cond113, !llvm.loop !30
...
if.end:                                           ; preds = %if.then, %for.body3
  ...
  %call6 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef @.str.10, double noundef %conv)
  br label %for.inc
