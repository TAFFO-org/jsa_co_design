...
@.str = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,0.84) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [17 x i8] c"./sources/atax.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [34 x i8] c"scalar(range(4.0,7.818182) final)\00", section "llvm.metadata"
@.str.3 = private unnamed_addr constant [48 x i8] c"target('y') scalar(range(0.0,492.256012) final)\00", section "llvm.metadata"
@.str.4 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,61.040001) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @llvm.var.annotation(i8* %y3, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 113, i8* null)
  ...
  call void @scale_2d(i32 noundef 20, i32 noundef 22, float* noundef %2, i32 noundef 4)
  %arraydecay9 = getelementptr inbounds [22 x float], [22 x float]* %x, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay9, i32 noundef 4)
  %arraydecay10 = getelementptr inbounds [22 x float], [22 x float]* %y, i32 0, i32 0
  call void @scale_1d(i32 noundef 22, float* noundef %arraydecay10, i32 noundef 4)
