; ModuleID = './build/bin/fixed/2mm/24/2mm-standard-32-fixed-24.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [37 x i8] c"scalar(range(0.0,4723.199707) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,28.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,28.799999) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,29.714285) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [49 x i8] c"target('D') scalar(range(0.0,628531.1875) final)\00", section "llvm.metadata", !taffo.info !4
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 32), !taffo.initweight !63, !taffo.info !49, !taffo.originalCall !66, !taffo.constinfo !67
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 32), !taffo.initweight !63, !taffo.info !51, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 8, i32 noundef 12, float* noundef %0, i32 noundef 32), !taffo.initweight !69, !taffo.info !55, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.7(i32 noundef 12, i32 noundef 10, float* noundef %1, i32 noundef 32), !taffo.initweight !69, !taffo.info !57, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.8(i32 noundef 10, i32 noundef 14, float* noundef %2, i32 noundef 32), !taffo.initweight !69, !taffo.info !59, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.9(i32 noundef 8, i32 noundef 14, float* noundef %3, i32 noundef 32), !taffo.initweight !69, !taffo.info !61, !taffo.target !62, !taffo.originalCall !70, !taffo.constinfo !71
  ...
  call void @scale_2d.5(i32 noundef 8, i32 noundef 10, float* noundef %4, i32 noundef 32), !taffo.initweight !69, !taffo.info !53, !taffo.originalCall !70, !taffo.constinfo !71
...
!7 = !{double 0.000000e+00, double 0x41232E6660000000}
...
!54 = !{double 0.000000e+00, double 0x40B273331FFF79C8}
!55 = !{i1 false, !56, i1 false, i2 -1}
!56 = !{double 0.000000e+00, double 2.800000e+01}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 0.000000e+00, double 0x403CCCCCBC05D52C}
!59 = !{i1 false, !60, i1 false, i2 -1}
!60 = !{double 0.000000e+00, double 0x403DB6DB61BB05FB}
...
!143 = !{double 0.000000e+00, double 4.200000e+01}
!144 = !{i1 false, !145, i1 false, i2 -1}
!145 = !{double 0.000000e+00, double 0x4092E6665B63D3E5}
!146 = !{i1 false, !147, i1 false, i2 -1}
!147 = !{double 0.000000e+00, double 0x40B72CCCB6D86EC1}
!148 = distinct !{!148, !29}
!149 = distinct !{!149, !29}
!150 = distinct !{!150, !29}
!151 = !{i1 false, !152, i1 false, i2 -1}
!152 = !{double 0.000000e+00, double 0x4127047AD9999999}
!153 = !{i32 8}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 0x410121D404846DFD}
!156 = !{i1 false, !157, i1 false, i2 -1}
!157 = !{double 0.000000e+00, double 0x412776DB61211B7F}
!158 = distinct !{!158, !29}
!159 = distinct !{!159, !29}
!160 = distinct !{!160, !29}
...
!218 = !{double 0.000000e+00, double 0x410273331FFF79C8}
!219 = distinct !{!219, !29}
!220 = distinct !{!220, !29}
...
!228 = !{double 0.000000e+00, double 0x408CCCCCBC05D52C}
!229 = distinct !{!229, !29}
!230 = distinct !{!230, !29}
!231 = !{i32 1, !22, i32 1, !126, i32 1, !59, i32 1, !134}
!232 = !{i1 false, !233, i1 false, i2 -1}
!233 = !{double 0.000000e+00, double 0x408DB6DB61BB05FB}
!234 = distinct !{!234, !29}
!235 = distinct !{!235, !29}
!236 = !{i32 1, !124, i32 1, !126, i32 1, !61, i32 1, !134}
!237 = !{i1 false, !238, i1 false, i2 -1}
!238 = !{double 0.000000e+00, double 0x41732E6660000000}
!239 = distinct !{!239, !29}
!240 = distinct !{!240, !29}
