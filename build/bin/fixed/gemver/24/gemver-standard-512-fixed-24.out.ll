; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-512-fixed-24.out.ll.4.taffotmp.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !123 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u17_15fixp, 9, !taffo.info !130
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u26_6fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !132 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %mul.1flp = fmul float %1, %3, !taffo.info !133
  %arrayidx1.u26_6fixp = getelementptr inbounds i32, i32* %val.u26_6fixp, i32 %i.0, !taffo.info !69
  %4 = fmul float 6.400000e+01, %mul.1flp, !taffo.info !133
  %5 = fptoui float %4 to i32, !taffo.info !133
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u9_23fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !137 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !138
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !141
  %arrayidx1.u9_23fixp = getelementptr inbounds i32, i32* %val.u9_23fixp, i32 %i.0, !taffo.info !54
  %5 = shl i32 %mul.u18_14fixp, 9, !taffo.info !141
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !144 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 15), !taffo.info !145
  %mul.u16_16fixp = shl i32 %4, 1, !taffo.info !148
  %arrayidx1.u7_25fixp = getelementptr inbounds i32, i32* %val.u7_25fixp, i32 %i.0, !taffo.info !62
  %5 = shl i32 %mul.u16_16fixp, 9, !taffo.info !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.11_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !151 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 16), !taffo.info !152
  %mul.u15_17fixp = shl i32 %4, 1, !taffo.info !155
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !73
  %5 = shl i32 %mul.u15_17fixp, 9, !taffo.info !155
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !122 !taffo.funinfo !158 !taffo.sourceFunction !124 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %arrayidx.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !159
  %.flt.fallback.1flp = load float, float* %arrayidx.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !160
  %conv.u10_22fixp = shl i32 %factor, 22, !taffo.info !125
  %0 = uitofp i32 %conv.u10_22fixp to float, !taffo.info !125
  %1 = fdiv float %0, 0x4150000000000000, !taffo.info !125
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !161
  %arrayidx1.flt.1flp = getelementptr inbounds float, float* %val, i32 %i.0, !taffo.info !65, !taffo.initweight !159
...
for.body51:                                       ; preds = %for.cond49
  %arrayidx52.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !159
  %.flt.fallback.1flp = load float, float* %arrayidx52.flt.1flp, align 4, !taffo.info !65, !taffo.initweight !160
  ...
  %arrayidx59.flt.1flp = getelementptr inbounds float, float* %w, i32 %i.3, !taffo.info !65, !taffo.initweight !159
...
!129 = !{double 3.276800e+03, double 6.553600e+04}
!130 = !{!53, !129, i1 false, i2 -1}
!131 = distinct !{!131, !27}
!132 = !{i32 1, !107, i32 1, !69, i32 1, !119}
!133 = !{!134, !135, i1 false, i2 -1}
!134 = !{!"float", i32 1, double 0x4215C57280000000}
!135 = !{double 0.000000e+00, double 0x4215C57280000000}
!136 = distinct !{!136, !27}
!137 = !{i32 1, !107, i32 1, !54, i32 1, !119}
!138 = !{!139, !140, i1 false, i2 -1}
!139 = !{!"fixp", i32 -32, i32 13}
!140 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!141 = !{!142, !140, i1 false, i2 -1}
!142 = !{!"fixp", i32 32, i32 14}
!143 = distinct !{!143, !27}
!144 = !{i32 1, !107, i32 1, !62, i32 1, !119}
!145 = !{!146, !147, i1 false, i2 -1}
!146 = !{!"fixp", i32 -32, i32 15}
!147 = !{double 0x40A11111276FB092, double 0x40E555556084A516}
!148 = !{!149, !147, i1 false, i2 -1}
!149 = !{!"fixp", i32 32, i32 16}
!150 = distinct !{!150, !27}
!151 = !{i32 1, !107, i32 1, !73, i32 1, !119}
!152 = !{!153, !154, i1 false, i2 -1}
!153 = !{!"fixp", i32 -32, i32 16}
!154 = !{double 0x4096C16C61522A6F, double 0x40DC71C71D606317}
!155 = !{!156, !154, i1 false, i2 -1}
!156 = !{!"fixp", i32 32, i32 17}
!157 = distinct !{!157, !27}
!158 = !{i32 1, !107, i32 1, !65, i32 1, !119}
!159 = !{i32 5}
!160 = !{i32 6}
!161 = !{!162, !163, i1 false, i2 -1}
!162 = !{!"float", i32 1, double 0x4352E67000000000}
!163 = !{double 0.000000e+00, double 0x4352E67000000000}
!164 = distinct !{!164, !27}
