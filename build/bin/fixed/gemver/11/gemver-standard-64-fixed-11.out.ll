; ModuleID = './build/bin/fixed/gemver/11/gemver-standard-64-fixed-11.out.ll.4.taffotmp.ll'
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 0x4180000000000000, !taffo.info !126
  %mul.1flp = fmul float %.flt.fallback.1flp, %1, !taffo.info !128
