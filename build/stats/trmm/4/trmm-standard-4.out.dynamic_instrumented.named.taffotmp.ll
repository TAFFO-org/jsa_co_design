; ModuleID = './build/stats/trmm/4/trmm-standard-4.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.originalCall !28
  ...
  call void @scale_2d.3(i32 noundef 10, i32 noundef 10, float* noundef %2, i32 noundef 4), !taffo.originalCall !29
  ...
  call void @scale_2d.2(i32 noundef 10, i32 noundef 16, float* noundef %3, i32 noundef 4), !taffo.originalCall !29
