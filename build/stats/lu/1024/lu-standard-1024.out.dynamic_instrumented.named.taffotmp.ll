; ModuleID = './build/stats/lu/1024/lu-standard-1024.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
for.body58:                                       ; preds = %for.cond55
  ...
  %arrayidx64 = getelementptr inbounds [20 x float], [20 x float]* %39, i64 %idxprom63
...
for.body88:                                       ; preds = %for.cond85
  ...
  %arrayidx94 = getelementptr inbounds [20 x float], [20 x float]* %53, i64 %idxprom93
...
for.end:                                          ; preds = %for.cond4
  ...
  %arrayidx19 = getelementptr inbounds [20 x float], [20 x float]* %16, i64 %idxprom18
  ...
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %19, i64 %idxprom22
...
for.body34:                                       ; preds = %for.cond32
  ...
  %arrayidx38 = getelementptr inbounds [20 x float], [20 x float]* %28, i64 %idxprom37
  %30 = load i32, i32* %k, align 4
  %idxprom39 = sext i32 %30 to i64
  %arrayidx40 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx38, i64 0, i64 %idxprom39
  %"a::var53" = load float, float* %arrayidx40, align 4
  %31 = load [20 x float]*, [20 x float]** %A.addr, align 8
  %32 = load i32, i32* %k, align 4
  %idxprom41 = sext i32 %32 to i64
  %arrayidx42 = getelementptr inbounds [20 x float], [20 x float]* %31, i64 %idxprom41
  ...
  %arrayidx47 = getelementptr inbounds [20 x float], [20 x float]* %34, i64 %idxprom46
...
for.body3:                                        ; preds = %for.cond1
  ...
  %12 = load i32, i32* %factor.addr, align 4
  %"a::var60" = sitofp i32 %12 to float
