; ModuleID = './build/bin/fixed/jacobi-2d/11/jacobi-2d-standard-32-fixed-11.out.ll.1.taffotmp.ll'
...
@.str = private unnamed_addr constant [53 x i8] c"target('A') scalar(range(4.266667,482.133331) final)\00", section "llvm.metadata"
@.str.1 = private unnamed_addr constant [22 x i8] c"./sources/jacobi-2d.c\00", section "llvm.metadata"
@.str.2 = private unnamed_addr constant [36 x i8] c"scalar(range(6.4,514.133362) final)\00", section "llvm.metadata"
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 15, i32 noundef 15, float* noundef %1, i32 noundef 32), !taffo.initweight !37, !taffo.target !29, !taffo.info !30, !taffo.originalCall !38
  ...
  call void @scale_2d.4(i32 noundef 15, i32 noundef 15, float* noundef %2, i32 noundef 32), !taffo.initweight !37, !taffo.info !32, !taffo.originalCall !38
...
!31 = !{double 0x40111111276FB092, double 0x407E22221FAFC8B0}
!32 = !{i1 false, !33, i1 false, i2 -1}
!33 = !{double 6.400000e+00, double 0x408011112018A43C}
!34 = !{i32 1}
!35 = !{i32 2}
