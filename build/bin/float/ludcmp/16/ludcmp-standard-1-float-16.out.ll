...
entry:
  ...
  %arraydecay6 = getelementptr inbounds [20 x float], ptr %b, i32 0, i32 0
  %arraydecay7 = getelementptr inbounds [20 x float], ptr %x, i32 0, i32 0
  %arraydecay8 = getelementptr inbounds [20 x float], ptr %y, i32 0, i32 0
  call void @kernel_ludcmp(i32 noundef %1, ptr noundef %arraydecay5, ptr noundef %arraydecay6, ptr noundef %arraydecay7, ptr noundef %arraydecay8)
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx9 = getelementptr inbounds [20 x float], ptr @x_float, i32 0, i32 %6
