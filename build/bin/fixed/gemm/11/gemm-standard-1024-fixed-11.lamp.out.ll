; ModuleID = './build/bin/fixed/gemm/11/gemm-standard-1024-fixed-11.out.ll'
...
entry:
  ...
  %u10_22fixp = bitcast [16 x i32]* %arraydecay9.u10_22fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u10_22fixp, i32 1024), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u10_22fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u10_22fixp, i32 0, i32 0, !taffo.info !53
  %u10_22fixp2 = bitcast [12 x i32]* %arraydecay10.u10_22fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u10_22fixp2, i32 1024), !taffo.info !62, !taffo.constinfo !60
  ...
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [12 x i32]* %arraydecay11.u23_9fixp, [16 x i32]* %arraydecay12.u10_22fixp, [12 x i32]* %arraydecay13.u10_22fixp), !taffo.info !55, !taffo.constinfo !56
