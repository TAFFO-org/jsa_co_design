; ModuleID = './build/bin/fixed/symm/11/symm-standard-256-fixed-11.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u22_10fixp, i32 noundef %factor) #0 !taffo.initweight !165 !taffo.funinfo !182 !taffo.sourceFunction !167 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %6 = fmul float 1.024000e+03, %lampsim15, !taffo.info !183
  %lampsim16 = bitcast float %6 to i32
  %lampsim17 = and i32 %lampsim16, -8192
  %lampsim18 = bitcast i32 %lampsim17 to float
  %7 = fptoui float %lampsim18 to i32, !taffo.info !183
...
!180 = distinct !{!180, !23}
!181 = distinct !{!181, !23}
!182 = !{i32 1, !16, i32 1, !79, i32 1, !47, i32 1, !89}
!183 = !{!184, !185, i1 false, i2 -1}
!184 = !{!"float", i32 1, double 0x41C5608A40000000}
!185 = !{double 0.000000e+00, double 0x41C5608A40000000}
!186 = distinct !{!186, !23}
!187 = distinct !{!187, !23}
