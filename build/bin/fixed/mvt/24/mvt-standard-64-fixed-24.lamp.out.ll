; ModuleID = './build/bin/fixed/mvt/24/mvt-standard-64-fixed-24.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u6_26fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !77 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 19), !taffo.info !83
  %mul.u12_20fixp = shl i32 %4, 1, !taffo.info !86
  %arrayidx1.u6_26fixp = getelementptr inbounds i32, i32* %val.u6_26fixp, i32 %i.0, !taffo.info !44
  %5 = shl i32 %mul.u12_20fixp, 6, !taffo.info !86
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.1_fixp(i32 noundef %n, i32* noundef %val.u15_17fixp, i32 noundef %factor) #0 !taffo.initweight !76 !taffo.funinfo !89 !taffo.sourceFunction !80 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u21_11fixp, 6, !taffo.info !93
...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 19), !taffo.info !83
  %mul.u12_20fixp = shl i32 %5, 1, !taffo.info !86
  ...
  %7 = shl i32 %mul.u12_20fixp, 6, !taffo.info !86
...
!85 = !{double 0.000000e+00, double 0x40AE66665E02EA96}
!86 = !{!87, !85, i1 false, i2 -1}
!87 = !{!"fixp", i32 32, i32 20}
!88 = distinct !{!88, !25}
!89 = !{i32 1, !67, i32 1, !47, i32 1, !78}
!90 = !{!91, !92, i1 false, i2 -1}
!91 = !{!"fixp", i32 -32, i32 10}
!92 = !{double 0.000000e+00, double 0x4133A7331FFF79C8}
