; ModuleID = './build/bin/fixed/gemver/16/gemver-standard-4-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [30 x i8] c"scalar(range(0.0,7.05) final)\00", section "llvm.metadata", !taffo.info !0
@.str.4 = private unnamed_addr constant [29 x i8] c"scalar(range(0.0,3.8) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [30 x i8] c"scalar(range(0.05,1.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.6 = private unnamed_addr constant [29 x i8] c"scalar(range(0.1,2.0) final)\00", section "llvm.metadata", !taffo.info !0
@.str.7 = private unnamed_addr constant [39 x i8] c"scalar(range(0.033333,0.666667) final)\00", section "llvm.metadata", !taffo.info !0
@.str.8 = private unnamed_addr constant [49 x i8] c"target('w') scalar(range(0.0,3285.157471) final)\00", section "llvm.metadata", !taffo.info !4
@.str.9 = private unnamed_addr constant [35 x i8] c"scalar(range(0.0,31.569998) final)\00", section "llvm.metadata", !taffo.info !0
@.str.10 = private unnamed_addr constant [31 x i8] c"scalar(range(0.025,0.5) final)\00", section "llvm.metadata", !taffo.info !0
@.str.11 = private unnamed_addr constant [39 x i8] c"scalar(range(0.022222,0.444444) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 4), !taffo.initweight !74, !taffo.info !54, !taffo.originalCall !77, !taffo.constinfo !78
  call void @scale_scalar.2(float* noundef %beta, i32 noundef 4), !taffo.initweight !74, !taffo.info !56, !taffo.originalCall !77, !taffo.constinfo !78
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 4), !taffo.initweight !80, !taffo.info !58, !taffo.originalCall !81, !taffo.constinfo !82
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !59
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 4), !taffo.initweight !79, !taffo.info !59, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.initweight !74, !taffo.info !61
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 4), !taffo.initweight !79, !taffo.info !61, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !63
  call void @scale_1d.5(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 4), !taffo.initweight !79, !taffo.info !63, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.initweight !74, !taffo.info !65
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 4), !taffo.initweight !79, !taffo.info !65, !taffo.originalCall !83, !taffo.constinfo !84
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 4), !taffo.initweight !79, !taffo.info !67, !taffo.target !68, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.initweight !74, !taffo.info !69
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 4), !taffo.initweight !79, !taffo.info !69, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.initweight !74, !taffo.info !70
  call void @scale_1d.9(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 4), !taffo.initweight !79, !taffo.info !70, !taffo.originalCall !83, !taffo.constinfo !84
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.initweight !74, !taffo.info !72
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 4), !taffo.initweight !79, !taffo.info !72, !taffo.originalCall !83, !taffo.constinfo !84
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemver.10(i32 noundef %n, float noundef %alpha, float noundef %beta, [20 x float]* noundef %A, float* noundef %u1, float* noundef %v1, float* noundef %u2, float* noundef %v2, float* noundef %w, float* noundef %x, float* noundef %y, float* noundef %z) #0 !taffo.initweight !179 !taffo.funinfo !180 !taffo.sourceFunction !86 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %mul = fmul float %1, %2, !taffo.initweight !153, !taffo.info !59
...
for.body45:                                       ; preds = %for.cond42
  ...
  %div48 = fdiv float %conv46, %conv47, !taffo.initweight !112, !taffo.info !252
  %arrayidx49 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.0, !taffo.initweight !79, !taffo.info !254
  %arrayidx50 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx49, i32 0, i32 %j.0, !taffo.initweight !79, !taffo.info !254
  store float %div48, float* %arrayidx50, align 4, !taffo.initweight !80, !taffo.info !108
  br label %for.inc

for.inc:                                          ; preds = %for.body45
  %inc = add nsw i32 %j.0, 1, !taffo.initweight !79, !taffo.info !218, !taffo.constinfo !31
  br label %for.cond42, !llvm.loop !255
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.13(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !257 !taffo.funinfo !258 !taffo.sourceFunction !81 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv = sitofp i32 %factor to float, !taffo.info !114
  %mul = fmul float %1, %conv, !taffo.initweight !259, !taffo.info !260
...
!7 = !{double 0.000000e+00, double 0x403F91EB6390C910}
!8 = !{i1 false, !9, i1 false, i2 0}
!9 = !{double 0.000000e+00, double 0x40A9AA50A009F623}
!10 = !{i1 false, !11, i1 false, i2 0}
!11 = !{double 0.000000e+00, double 7.050000e+00}
...
!60 = !{double 0.000000e+00, double 3.800000e+00}
!61 = !{i1 false, !62, i1 false, i2 -1}
!62 = !{double 5.000000e-02, double 1.000000e+00}
!63 = !{i1 false, !64, i1 false, i2 -1}
!64 = !{double 1.000000e-01, double 2.000000e+00}
!65 = !{i1 false, !66, i1 false, i2 -1}
!66 = !{double 3.333300e-02, double 6.666670e-01}
...
!146 = distinct !{!146, !33}
!147 = !{i32 1, i32 -1}
!148 = !{i32 1, !54, i32 1, !114}
!149 = !{i32 1, !56, i32 1, !114}
!150 = !{i32 -1, i32 2, i32 -1}
!151 = !{i32 1, !139, i32 1, !59, i32 1, !114}
!152 = !{i32 6}
!153 = !{i32 7}
!154 = !{i1 false, !155, i1 false, i2 -1}
!155 = !{double 0.000000e+00, double 1.520000e+01}
!156 = distinct !{!156, !33}
!157 = !{i32 1, !139, i32 1, !61, i32 1, !114}
!158 = !{i1 false, !159, i1 false, i2 -1}
!159 = !{double 2.000000e-01, double 4.000000e+00}
!160 = distinct !{!160, !33}
!161 = !{i32 1, !139, i32 1, !63, i32 1, !114}
!162 = !{i1 false, !163, i1 false, i2 -1}
!163 = !{double 4.000000e-01, double 8.000000e+00}
!164 = distinct !{!164, !33}
!165 = !{i32 1, !139, i32 1, !65, i32 1, !114}
!166 = !{i1 false, !167, i1 false, i2 -1}
!167 = !{double 1.333320e-01, double 0x40055556084A515D}
!168 = distinct !{!168, !33}
!169 = !{i32 1, !139, i32 1, !67, i32 1, !114}
!170 = !{i1 false, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 0x40C9AA50A009F623}
!172 = distinct !{!172, !33}
!173 = !{i32 1, !139, i32 1, !69, i32 1, !114}
!174 = !{i1 false, !175, i1 false, i2 -1}
!175 = !{double 0.000000e+00, double 0x405F91EB6390C910}
!176 = distinct !{!176, !33}
!177 = !{i32 1, !139, i32 1, !70, i32 1, !114}
!178 = distinct !{!178, !33}
!179 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!180 = !{i32 1, !139, i32 1, !54, i32 1, !56, i32 1, !58, i32 1, !59, i32 1, !61, i32 1, !63, i32 1, !65, i32 1, !67, i32 1, !69, i32 1, !70, i32 1, !72}
!181 = !{i32 8}
!182 = !{i1 false, !183, i1 false, i2 -1}
!183 = !{double 0.000000e+00, double 1.085000e+01}
!184 = !{i1 false, !185, i1 false, i2 -1}
!185 = !{double 0x3F6B4E6FCF9BB427, double 0x3FF55556084A515D}
!186 = !{i1 false, !187, i1 false, i2 -1}
!187 = !{double 0x3F6B4E6FCF9BB427, double 0x40285DDDF43C7D5F}
!188 = distinct !{!188, !33}
!189 = distinct !{!189, !33}
!190 = !{i1 false, !191, i1 false, i2 -1}
!191 = !{double 0.000000e+00, double 0x4020EB851EB851EB}
!192 = !{i1 false, !193, i1 false, i2 -1}
!193 = !{double 0.000000e+00, double 0x4010EB851EB851EB}
!194 = !{i1 false, !195, i1 false, i2 -1}
!195 = !{double 0.000000e+00, double 0x4041E666559F6EC5}
!196 = distinct !{!196, !33}
!197 = distinct !{!197, !33}
!198 = !{i1 false, !199, i1 false, i2 -1}
!199 = !{double 2.222200e-02, double 0x404001D93C46D82B}
!200 = distinct !{!200, !33}
!201 = !{i1 false, !202, i1 false, i2 -1}
!202 = !{double 0.000000e+00, double 1.057500e+01}
!203 = !{i1 false, !204, i1 false, i2 -1}
!204 = !{double 0.000000e+00, double 0x4074DDA4C701B1B0}
!205 = !{i1 false, !206, i1 false, i2 -1}
!206 = !{double 0.000000e+00, double 0x40AC460538EA2C59}
!207 = distinct !{!207, !33}
!208 = distinct !{!208, !33}
!209 = !{i32 1, !139, i32 1, !72, i32 1, !114}
!210 = !{i1 false, !211, i1 false, i2 -1}
!211 = !{double 0x3FB6C15D2D01C0CA, double 0x3FFC71C53F39D1B3}
!212 = distinct !{!212, !33}
...
!253 = !{double 0.000000e+00, double 0x3FEE666666666666}
!254 = !{i1 false, !11, i1 false, i2 1}
!255 = distinct !{!255, !33}
!256 = distinct !{!256, !33}
!257 = !{i32 -1, i32 -1, i32 3, i32 -1}
!258 = !{i32 1, !139, i32 1, !139, i32 1, !58, i32 1, !114}
!259 = !{i32 9}
!260 = !{i1 false, !261, i1 false, i2 -1}
!261 = !{double 0.000000e+00, double 2.820000e+01}
!262 = distinct !{!262, !33}
!263 = distinct !{!263, !33}
