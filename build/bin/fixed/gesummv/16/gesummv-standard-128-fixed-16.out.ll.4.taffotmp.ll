; ModuleID = './build/bin/fixed/gesummv/16/gesummv-standard-128-fixed-16.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 128), !taffo.info !63, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 128), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %0, i32 noundef 128), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  ...
  call void @scale_2d.8(i32 noundef 16, i32 noundef 16, float* noundef %1, i32 noundef 128), !taffo.info !70, !taffo.initweight !71, !taffo.constinfo !72, !taffo.originalCall !73
  %arraydecay14 = getelementptr inbounds [16 x float], [16 x float]* %tmp, i32 0, i32 0, !taffo.info !52, !taffo.initweight !59
  call void @scale_1d.3(i32 noundef 16, float* noundef %arraydecay14, i32 noundef 128), !taffo.info !74, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  %arraydecay15 = getelementptr inbounds [16 x float], [16 x float]* %x, i32 0, i32 0, !taffo.info !49, !taffo.initweight !59
  call void @scale_1d.4(i32 noundef 16, float* noundef %arraydecay15, i32 noundef 128), !taffo.info !70, !taffo.initweight !69, !taffo.constinfo !75, !taffo.originalCall !76
  ...
  call void @scale_1d.6(i32 noundef 16, float* noundef %arraydecay16, i32 noundef 128), !taffo.info !77, !taffo.initweight !69, !taffo.constinfo !75, !taffo.target !57, !taffo.originalCall !76
...
!51 = !{double 0.000000e+00, double 1.200000e+02}
!52 = !{!53, !54, i1 false, i2 -1}
!53 = !{!"fixp", i32 32, i32 15}
!54 = !{double 0.000000e+00, double 7.219200e+04}
!55 = !{!56, !1, i1 false, i2 -1}
!56 = !{!"fixp", i32 32, i32 14}
!57 = !{!"y"}
...
!107 = !{double 0.000000e+00, double 0x4161A00000000000}
!108 = !{i32 7}
!109 = distinct !{!109, !23}
!110 = !{i32 1, !88, i32 1, !49, i32 1, !97}
!111 = !{!112, !113, i1 false, i2 -1}
!112 = !{!"fixp", i32 32, i32 18}
!113 = !{double 0.000000e+00, double 1.536000e+04}
!114 = distinct !{!114, !23}
...
!120 = !{double 0.000000e+00, double 1.440000e+04}
!121 = !{!53, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 8.659200e+04}
!123 = !{!56, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x4108686680000000}
!125 = distinct !{!125, !23}
!126 = !{!127, !128, i1 false, i2 -1}
!127 = !{!"fixp", i32 32, i32 13}
!128 = !{double 0.000000e+00, double 1.082880e+05}
!129 = !{!127, !130, i1 false, i2 -1}
!130 = !{double 0.000000e+00, double 0x410B2E1499999999}
!131 = !{!127, !132, i1 false, i2 -1}
!132 = !{double 0.000000e+00, double 0x4114330A4CCCCCCC}
!133 = distinct !{!133, !23}
!134 = !{i32 1, !88, i32 1, !55, i32 1, !97}
!135 = !{!136, !137, i1 false, i2 -1}
!136 = !{!"fixp", i32 32, i32 7}
!137 = !{double 0.000000e+00, double 0x4176A66680000000}
!138 = distinct !{!138, !23}
