; ModuleID = './build/stats/bicg/2/bicg-standard-2.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 22, i32 noundef 20, float* noundef %2, i32 noundef 2), !taffo.originalCall !28
  %arraydecay11 = getelementptr inbounds [20 x float], [20 x float]* %s, i64 0, i64 0
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 2), !taffo.originalCall !29
  %arraydecay12 = getelementptr inbounds [22 x float], [22 x float]* %q, i64 0, i64 0
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 2), !taffo.originalCall !29
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 2), !taffo.originalCall !29
