; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-512-fixed-24.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_scalar.1(float* noundef %alpha, i32 noundef 512), !taffo.info !85, !taffo.initweight !77, !taffo.constinfo !88, !taffo.originalCall !89
  call void @scale_scalar.1(float* noundef %beta, i32 noundef 512), !taffo.info !90, !taffo.initweight !77, !taffo.constinfo !88, !taffo.originalCall !89
  ...
  call void @scale_2d.13(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 512), !taffo.info !92, !taffo.initweight !93, !taffo.constinfo !94, !taffo.originalCall !95
  %arraydecay21 = getelementptr inbounds [20 x float], [20 x float]* %u1, i32 0, i32 0, !taffo.info !55, !taffo.initweight !77
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay21, i32 noundef 512), !taffo.info !96, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay22 = getelementptr inbounds [20 x float], [20 x float]* %v1, i32 0, i32 0, !taffo.info !58, !taffo.initweight !77
  call void @scale_1d.4(i32 noundef 20, float* noundef %arraydecay22, i32 noundef 512), !taffo.info !99, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay23 = getelementptr inbounds [20 x float], [20 x float]* %u2, i32 0, i32 0, !taffo.info !61, !taffo.initweight !77
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay23, i32 noundef 512), !taffo.info !100, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay24 = getelementptr inbounds [20 x float], [20 x float]* %v2, i32 0, i32 0, !taffo.info !63, !taffo.initweight !77
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay24, i32 noundef 512), !taffo.info !101, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  ...
  call void @scale_1d.7(i32 noundef 20, float* noundef %arraydecay25, i32 noundef 512), !taffo.info !102, !taffo.initweight !91, !taffo.constinfo !97, !taffo.target !68, !taffo.originalCall !98
  %arraydecay26 = getelementptr inbounds [20 x float], [20 x float]* %x, i32 0, i32 0, !taffo.info !69, !taffo.initweight !77
  call void @scale_1d.8(i32 noundef 20, float* noundef %arraydecay26, i32 noundef 512), !taffo.info !103, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay27 = getelementptr inbounds [20 x float], [20 x float]* %y, i32 0, i32 0, !taffo.info !71, !taffo.initweight !77
  call void @scale_1d.6(i32 noundef 20, float* noundef %arraydecay27, i32 noundef 512), !taffo.info !104, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
  %arraydecay28 = getelementptr inbounds [20 x float], [20 x float]* %z, i32 0, i32 0, !taffo.info !73, !taffo.initweight !77
  call void @scale_1d.11(i32 noundef 20, float* noundef %arraydecay28, i32 noundef 512), !taffo.info !105, !taffo.initweight !91, !taffo.constinfo !97, !taffo.originalCall !98
...
!54 = !{!"fixp", i32 32, i32 15}
!55 = !{!56, !57, i1 false, i2 -1}
!56 = !{!"fixp", i32 32, i32 23}
!57 = !{double 0.000000e+00, double 0x407E6666601BC98A}
!58 = !{!59, !60, i1 false, i2 -1}
!59 = !{!"fixp", i32 32, i32 24}
!60 = !{double 6.400000e+00, double 1.280000e+02}
!61 = !{!56, !62, i1 false, i2 -1}
!62 = !{double 1.280000e+01, double 2.560000e+02}
!63 = !{!64, !65, i1 false, i2 -1}
!64 = !{!"fixp", i32 32, i32 25}
!65 = !{double 0x40111111276FB092, double 0x405555556084A516}
!66 = !{!67, !3, i1 false, i2 -1}
!67 = !{!"float", i32 1, double 0x42C2E67000000000}
!68 = !{!"w"}
...
!135 = !{double 5.120000e+02, double 5.120000e+02}
...
!143 = !{!"fixp", i32 32, i32 14}
!144 = !{double 0.000000e+00, double 0x410E6666601BC98A}
!145 = !{i32 7}
!146 = distinct !{!146, !27}
!147 = !{i32 1, !122, i32 1, !58, i32 1, !134}
!148 = !{!54, !149, i1 false, i2 -1}
!149 = !{double 3.276800e+03, double 6.553600e+04}
!150 = distinct !{!150, !27}
!151 = !{i32 1, !122, i32 1, !63, i32 1, !134}
!152 = !{!153, !154, i1 false, i2 -1}
!153 = !{!"fixp", i32 32, i32 16}
!154 = !{double 0x40A11111276FB092, double 0x40E555556084A516}
!155 = distinct !{!155, !27}
!156 = !{i32 1, !122, i32 1, !66, i32 1, !134}
!157 = !{!158, !159, i1 false, i2 -1}
!158 = !{!"float", i32 1, double 0x4352E67000000000}
!159 = !{double 0.000000e+00, double 0x4352E67000000000}
!160 = distinct !{!160, !27}
!161 = !{i32 1, !122, i32 1, !69, i32 1, !134}
!162 = !{!163, !164, i1 false, i2 -1}
!163 = !{!"float", i32 1, double 0x4215C57280000000}
!164 = !{double 0.000000e+00, double 0x4215C57280000000}
!165 = distinct !{!165, !27}
...
!172 = !{double 0.000000e+00, double 0x4101DEAAA806AF46}
!173 = !{i32 8}
!174 = !{!175, !176, i1 false, i2 -1}
!175 = !{!"fixp", i32 32, i32 17}
!176 = !{double 0x404B4E81D8B2B41D, double 0x40D555556084A516}
...
!185 = !{double 0.000000e+00, double 0x4158A5C28CCC2BBD}
!186 = !{!70, !187, i1 false, i2 -1}
!187 = !{double 0.000000e+00, double 0x4188DA2AD1998578}
!188 = distinct !{!188, !27}
!189 = distinct !{!189, !27}
!190 = !{!70, !191, i1 false, i2 -1}
!191 = !{double 0x4006C16C61522A6F, double 0x4185C574471C71D6}
!192 = distinct !{!192, !27}
!193 = !{!54, !194, i1 false, i2 -1}
!194 = !{double 0.000000e+00, double 0x40FECF332FFF36AC}
!195 = !{!196, !197, i1 false, i2 -1}
!196 = !{!"float", i32 1, double 0x4294F61368021EC7}
!197 = !{double 0.000000e+00, double 0x4294F61368021EC7}
!198 = !{!199, !200, i1 false, i2 -1}
!199 = !{!"float", i32 1, double 0x42C585326D0043D9}
!200 = !{double 0.000000e+00, double 0x42C585326D0043D9}
!201 = distinct !{!201, !27}
!202 = distinct !{!202, !27}
!203 = !{i32 1, !122, i32 1, !73, i32 1, !134}
!204 = !{!175, !205, i1 false, i2 -1}
!205 = !{double 0x4096C16C61522A6F, double 0x40DC71C71D606317}
!206 = distinct !{!206, !27}
...
!281 = !{double 0.000000e+00, double 0x41848A221FFF79C8}
!282 = !{i32 9}
!283 = distinct !{!283, !27}
!284 = distinct !{!284, !27}
