; ModuleID = './build/stats/3mm/64/3mm-standard-64.out.dynamic_instrumented.taffoinit.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 6, i32 noundef 8, float* noundef %5, i32 noundef 64), !taffo.originalCall !27
  ...
  call void @scale_2d.6(i32 noundef 6, i32 noundef 10, float* noundef %6, i32 noundef 64), !taffo.originalCall !27
  %arraydecay16 = getelementptr inbounds [10 x [8 x float]], [10 x [8 x float]]* %B, i64 0, i64 0
  %7 = bitcast [8 x float]* %arraydecay16 to float*
  call void @scale_2d.5(i32 noundef 10, i32 noundef 8, float* noundef %7, i32 noundef 64), !taffo.originalCall !27
  ...
  call void @scale_2d.4(i32 noundef 8, i32 noundef 12, float* noundef %8, i32 noundef 64), !taffo.originalCall !27
  ...
  call void @scale_2d.3(i32 noundef 8, i32 noundef 14, float* noundef %9, i32 noundef 64), !taffo.originalCall !27
  ...
  call void @scale_2d.2(i32 noundef 14, i32 noundef 12, float* noundef %10, i32 noundef 64), !taffo.originalCall !27
  ...
  call void @scale_2d.1(i32 noundef 6, i32 noundef 12, float* noundef %11, i32 noundef 64), !taffo.originalCall !27
