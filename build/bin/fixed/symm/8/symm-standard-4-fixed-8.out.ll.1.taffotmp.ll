...
entry:
  ...
  call void @llvm.var.annotation(i8* %A4, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i32 125, i8* null)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 4)
  ...
  call void @scale_2d(i32 noundef 10, i32 noundef 10, float* noundef %3, i32 noundef 4)
