; ModuleID = './build/bin/fixed/seidel-2d/11/seidel-2d-standard-64-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.3(i32 noundef 20, i32 noundef 20, float* noundef %0, i32 noundef 64), !taffo.info !48, !taffo.initweight !52, !taffo.constinfo !53, !taffo.target !45, !taffo.originalCall !54
...
!91 = !{!"fixp", i32 32, i32 20}
!92 = !{i32 7}
!93 = !{!91, !94, i1 false, i2 -1}
!94 = !{double 1.280000e+01, double 0x40A40CCCBFF47736}
!95 = !{i32 8}
!96 = !{!97, !98, i1 false, i2 -1}
!97 = !{!"fixp", i32 32, i32 19}
!98 = !{double 0x4033333333333334, double 0x40AE13331FEEB2D1}
!99 = !{!97, !43, i1 false, i2 -1}
!100 = !{!101, !102, i1 false, i2 1}
!101 = !{!"fixp", i32 32, i32 18}
!102 = !{double 2.560000e+01, double 0x40B40CCCBFF47736}
!103 = !{!97, !102, i1 false, i2 -1}
!104 = !{!101, !105, i1 false, i2 1}
!105 = !{double 3.200000e+01, double 0x40B90FFFEFF19504}
!106 = !{!101, !107, i1 false, i2 1}
!107 = !{double 5.760000e+01, double 0x40C68E6657F3061D}
...
!145 = !{double 4.096000e+02, double 0x40F40CCCBFF47736}
!146 = !{i32 9}
!147 = distinct !{!147, !23}
!148 = distinct !{!148, !23}
