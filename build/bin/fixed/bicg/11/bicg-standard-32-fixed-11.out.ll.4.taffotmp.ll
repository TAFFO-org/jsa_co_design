; ModuleID = './build/bin/fixed/bicg/11/bicg-standard-32-fixed-11.out.ll.3.taffotmp.ll'
...
entry:
  ...
  call void @scale_2d.7(i32 noundef 22, i32 noundef 20, float* noundef %0, i32 noundef 32), !taffo.info !58, !taffo.initweight !62, !taffo.constinfo !63, !taffo.originalCall !64
  ...
  call void @scale_1d.1(i32 noundef 20, float* noundef %arraydecay11, i32 noundef 32), !taffo.info !65, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !50, !taffo.originalCall !67
  ...
  call void @scale_1d.1(i32 noundef 22, float* noundef %arraydecay12, i32 noundef 32), !taffo.info !68, !taffo.initweight !59, !taffo.constinfo !66, !taffo.target !52, !taffo.originalCall !67
  %arraydecay13 = getelementptr inbounds [20 x float], [20 x float]* %p, i32 0, i32 0, !taffo.info !53, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 20, float* noundef %arraydecay13, i32 noundef 32), !taffo.info !69, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
  %arraydecay14 = getelementptr inbounds [22 x float], [22 x float]* %r, i32 0, i32 0, !taffo.info !44, !taffo.initweight !56
  call void @scale_1d.3(i32 noundef 22, float* noundef %arraydecay14, i32 noundef 32), !taffo.info !58, !taffo.initweight !59, !taffo.constinfo !66, !taffo.originalCall !67
...
for.body:                                         ; preds = %for.cond
  ...
  %conv3 = sitofp i32 %m to float, !taffo.info !137
  %div = fdiv float %conv, %conv3, !taffo.info !138, !taffo.initweight !141
  %arrayidx = getelementptr inbounds float, float* %p, i32 %i.0, !taffo.info !142, !taffo.initweight !59
  store float %div, float* %arrayidx, align 4, !taffo.info !116, !taffo.initweight !62
  %arrayidx4 = getelementptr inbounds float, float* %s, i32 %i.0, !taffo.info !143, !taffo.initweight !59
  store float 0.000000e+00, float* %arrayidx4, align 4, !taffo.info !116, !taffo.initweight !62, !taffo.constinfo !117
  br label %for.inc

for.inc:                                          ; preds = %for.body
  %inc = add nsw i32 %i.0, 1, !taffo.info !144, !taffo.initweight !59, !taffo.constinfo !23
...
for.body8:                                        ; preds = %for.cond5
  %rem9 = srem i32 %i.1, %n, !taffo.info !146, !taffo.initweight !59
  %conv10 = sitofp i32 %rem9 to float, !taffo.info !147, !taffo.initweight !62
  %conv11 = sitofp i32 %n to float, !taffo.info !148
  %div12 = fdiv float %conv10, %conv11, !taffo.info !149, !taffo.initweight !141
  %arrayidx13 = getelementptr inbounds float, float* %r, i32 %i.1, !taffo.info !151, !taffo.initweight !59
  store float %div12, float* %arrayidx13, align 4, !taffo.info !116, !taffo.initweight !62
  %arrayidx14 = getelementptr inbounds float, float* %q, i32 %i.1, !taffo.info !152, !taffo.initweight !59
...
for.cond15:                                       ; preds = %for.inc25, %for.body8
  %j.0 = phi i32 [ 0, %for.body8 ], [ %inc26, %for.inc25 ], !taffo.info !146, !taffo.initweight !47
  %cmp16 = icmp slt i32 %j.0, %m, !taffo.info !131, !taffo.initweight !59
  br i1 %cmp16, label %for.body18, label %for.end27, !taffo.info !153, !taffo.initweight !62

for.body18:                                       ; preds = %for.cond15
  %add = add nsw i32 %j.0, 1, !taffo.info !155, !taffo.initweight !59, !taffo.constinfo !23
  %mul = mul nsw i32 %i.1, %add, !taffo.info !156, !taffo.initweight !59
  %rem19 = srem i32 %mul, %n, !taffo.info !146, !taffo.initweight !62
  %conv20 = sitofp i32 %rem19 to float, !taffo.info !147, !taffo.initweight !141
  %conv21 = sitofp i32 %n to float, !taffo.info !148
  %div22 = fdiv float %conv20, %conv21, !taffo.info !149, !taffo.initweight !100
  %arrayidx23 = getelementptr inbounds [20 x float], [20 x float]* %A, i32 %i.1, !taffo.info !151, !taffo.initweight !59
  %arrayidx24 = getelementptr inbounds [20 x float], [20 x float]* %arrayidx23, i32 0, i32 %j.0, !taffo.info !151, !taffo.initweight !59
  store float %div22, float* %arrayidx24, align 4, !taffo.info !116, !taffo.initweight !62
  br label %for.inc25

for.inc25:                                        ; preds = %for.body18
  %inc26 = add nsw i32 %j.0, 1, !taffo.info !155, !taffo.initweight !59, !taffo.constinfo !23
...
for.inc28:                                        ; preds = %for.end27
  %inc29 = add nsw i32 %i.1, 1, !taffo.info !144, !taffo.initweight !59, !taffo.constinfo !23
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.7(i32 noundef %n, i32 noundef %m, float* noundef %val, i32 noundef %factor) #0 !taffo.initweight !160 !taffo.funinfo !161 !taffo.sourceFunction !64 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %1 = load float, float* %arrayidx4, align 4, !taffo.info !44, !taffo.initweight !162
  %conv = sitofp i32 %factor to float, !taffo.info !102
  %mul = fmul float %1, %conv, !taffo.info !163, !taffo.initweight !165
  ...
  store float %mul, float* %arrayidx6, align 4, !taffo.info !58, !taffo.initweight !162
  br label %for.inc
...
!54 = !{double 0.000000e+00, double 3.040000e+01}
...
!99 = !{double 3.200000e+01, double 3.200000e+01}
!100 = !{i32 5}
!101 = !{i32 6}
...
!106 = !{double 0.000000e+00, double 0x410B5D176006D0D5}
!107 = !{i32 7}
!108 = distinct !{!108, !25}
!109 = !{i32 1, !85, i32 1, !53, i32 1, !98}
!110 = !{!111, !112, i1 false, i2 -1}
!111 = !{!"fixp", i32 32, i32 22}
!112 = !{double 0.000000e+00, double 0x408E666666666666}
!113 = distinct !{!113, !25}
...
!120 = !{double 0.000000e+00, double 0x408D2832B567D1B8}
!121 = !{!49, !122, i1 false, i2 -1}
!122 = !{double 0.000000e+00, double 0x40BF021DB6B3CB0C}
!123 = !{!111, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x408D04A78798E615}
!125 = !{!49, !126, i1 false, i2 -1}
!126 = !{double 0.000000e+00, double 0x40BBCF2090F07DAC}
!127 = distinct !{!127, !25}
!128 = distinct !{!128, !25}
