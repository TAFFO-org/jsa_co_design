; ModuleID = './build/bin/fixed/gemm/24/gemm-standard-128-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %C.u17_15fixp = alloca [10 x [12 x i32]], align 4, !taffo.info !47, !taffo.target !49
  %A.u7_25fixp = alloca [10 x [16 x i32]], align 4, !taffo.info !50
  %B.u7_25fixp = alloca [16 x [12 x i32]], align 4, !taffo.info !53
  %arraydecay.u17_15fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u17_15fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay6.u7_25fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u7_25fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay7.u7_25fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !53
  call void @init_array.4_fixp(i32 10, i32 12, i32 16, i32* %alpha.u2_30fixp, i32* %beta.u2_30fixp, [12 x i32]* %arraydecay.u17_15fixp, [16 x i32]* %arraydecay6.u7_25fixp, [12 x i32]* %arraydecay7.u7_25fixp), !taffo.info !55, !taffo.constinfo !56
  ...
  %arraydecay8.u17_15fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u17_15fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %u17_15fixp = bitcast [12 x i32]* %arraydecay8.u17_15fixp to i32*, !taffo.info !47, !taffo.target !49
  call void @scale_2d.5_fixp(i32 10, i32 12, i32* %u17_15fixp, i32 128), !taffo.info !59, !taffo.constinfo !60, !taffo.target !49
  %arraydecay9.u7_25fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u7_25fixp, i32 0, i32 0, !taffo.info !50
  %u7_25fixp = bitcast [16 x i32]* %arraydecay9.u7_25fixp to i32*, !taffo.info !50
  call void @scale_2d.6_fixp(i32 10, i32 16, i32* %u7_25fixp, i32 128), !taffo.info !61, !taffo.constinfo !60
  %arraydecay10.u7_25fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !53
  %u7_25fixp2 = bitcast [12 x i32]* %arraydecay10.u7_25fixp to i32*, !taffo.info !53
  call void @scale_2d.6_fixp(i32 16, i32 12, i32* %u7_25fixp2, i32 128), !taffo.info !62, !taffo.constinfo !60
  ...
  %arraydecay11.u17_15fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u17_15fixp, i32 0, i32 0, !taffo.info !47, !taffo.target !49
  %arraydecay12.u7_25fixp = getelementptr inbounds [10 x [16 x i32]], [10 x [16 x i32]]* %A.u7_25fixp, i32 0, i32 0, !taffo.info !50
  %arraydecay13.u7_25fixp = getelementptr inbounds [16 x [12 x i32]], [16 x [12 x i32]]* %B.u7_25fixp, i32 0, i32 0, !taffo.info !53
  call void @kernel_gemm.3_fixp(i32 10, i32 12, i32 16, i32 %u2_30fixp, i32 %u2_30fixp1, [12 x i32]* %arraydecay11.u17_15fixp, [16 x i32]* %arraydecay12.u7_25fixp, [12 x i32]* %arraydecay13.u7_25fixp), !taffo.info !55, !taffo.constinfo !56
...
for.body16:                                       ; preds = %for.cond14
  %arrayidx.u17_15fixp = getelementptr inbounds [10 x [12 x i32]], [10 x [12 x i32]]* %C.u17_15fixp, i32 0, i32 %i.0, !taffo.info !47, !taffo.target !49
  %arrayidx17.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u17_15fixp, i32 0, i32 %j.0, !taffo.info !47, !taffo.target !49
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.4_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u17_15fixp, [16 x i32]* noundef %A.u7_25fixp, [12 x i32]* noundef %B.u7_25fixp) #0 !taffo.initweight !91 !taffo.funinfo !92 !taffo.sourceFunction !95 {
entry:
...
for.body5:                                        ; preds = %for.cond3
  ...
  %arrayidx.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u17_15fixp, i32 %i.0, !taffo.info !124
  %arrayidx7.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u17_15fixp, i32 0, i32 %j.0, !taffo.info !124
  %3 = lshr i32 %div.u1_31fixp, 16, !taffo.info !122
  store i32 %3, i32* %arrayidx7.u17_15fixp, align 4, !taffo.info !125
  br label %for.inc
...
for.body18:                                       ; preds = %for.cond15
  ...
  %arrayidx25.u7_25fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u7_25fixp, i32 %i.1, !taffo.info !141
  %arrayidx26.u7_25fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx25.u7_25fixp, i32 0, i32 %j.1, !taffo.info !141
  %8 = lshr i32 %div24.u1_31fixp, 6, !taffo.info !140
  store i32 %8, i32* %arrayidx26.u7_25fixp, align 4, !taffo.info !125
  br label %for.inc27
...
for.body40:                                       ; preds = %for.cond37
  ...
  %arrayidx47.u7_25fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u7_25fixp, i32 %i.2, !taffo.info !154
  %arrayidx48.u7_25fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx47.u7_25fixp, i32 0, i32 %j.2, !taffo.info !154
  %12 = lshr i32 %div46.u1_31fixp, 6, !taffo.info !153
  store i32 %12, i32* %arrayidx48.u7_25fixp, align 4, !taffo.info !125
  br label %for.inc49
...
; Function Attrs: noinline nounwind uwtable
define internal void @kernel_gemm.3_fixp(i32 noundef %ni, i32 noundef %nj, i32 noundef %nk, i32 noundef %alpha.u2_30fixp, i32 noundef %beta.u2_30fixp, [12 x i32]* noundef %C.u17_15fixp, [16 x i32]* noundef %A.u7_25fixp, [12 x i32]* noundef %B.u7_25fixp) #0 !taffo.initweight !157 !taffo.funinfo !92 !taffo.sourceFunction !158 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  %arrayidx.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u17_15fixp, i32 %i.0, !taffo.info !47
  %arrayidx4.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx.u17_15fixp, i32 0, i32 %j.0, !taffo.info !47
  ...
  %2 = ashr i32 %1, 15, !taffo.info !45
  %3 = call i32 @llvm.smul.fix.i32(i32 %0, i32 %2, i32 14), !taffo.info !159
  %mul.u17_15fixp = shl i32 %3, 1, !taffo.info !162
  store i32 %mul.u17_15fixp, i32* %arrayidx4.u17_15fixp, align 4, !taffo.info !58
  br label %for.inc
...
for.body10:                                       ; preds = %for.cond8
  %arrayidx11.u7_25fixp = getelementptr inbounds [16 x i32], [16 x i32]* %A.u7_25fixp, i32 %i.0, !taffo.info !50
  %arrayidx12.u7_25fixp = getelementptr inbounds [16 x i32], [16 x i32]* %arrayidx11.u7_25fixp, i32 0, i32 %k.0, !taffo.info !50
  %u7_25fixp = load i32, i32* %arrayidx12.u7_25fixp, align 4, !taffo.info !164
  %4 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !42
  %5 = lshr i32 %u7_25fixp, 1, !taffo.info !164
  %6 = ashr i32 %4, 6, !taffo.info !42
  %7 = ashr i32 %5, 1, !taffo.info !164
  %8 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %7, i32 23), !taffo.info !166
  %mul13.u8_24fixp = shl i32 %8, 1, !taffo.info !169
  %arrayidx14.u7_25fixp = getelementptr inbounds [12 x i32], [12 x i32]* %B.u7_25fixp, i32 %k.0, !taffo.info !53
  %arrayidx15.u7_25fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx14.u7_25fixp, i32 0, i32 %j.1, !taffo.info !53
  %u7_25fixp2 = load i32, i32* %arrayidx15.u7_25fixp, align 4, !taffo.info !53
  %9 = lshr i32 %mul13.u8_24fixp, 1, !taffo.info !169
  %10 = lshr i32 %u7_25fixp2, 1, !taffo.info !53
  %11 = ashr i32 %9, 9, !taffo.info !169
  %12 = ashr i32 %10, 10, !taffo.info !53
  %13 = call i32 @llvm.smul.fix.i32(i32 %11, i32 %12, i32 14), !taffo.info !170
  %mul16.u17_15fixp = shl i32 %13, 1, !taffo.info !172
  %arrayidx17.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %C.u17_15fixp, i32 %i.0, !taffo.info !47
  %arrayidx18.u17_15fixp = getelementptr inbounds [12 x i32], [12 x i32]* %arrayidx17.u17_15fixp, i32 0, i32 %j.1, !taffo.info !47
  %u17_15fixp1 = load i32, i32* %arrayidx18.u17_15fixp, align 4, !taffo.info !47
  %add.u17_15fixp = add i32 %u17_15fixp1, %mul16.u17_15fixp, !taffo.info !173
  store i32 %add.u17_15fixp, i32* %arrayidx18.u17_15fixp, align 4, !taffo.info !59
  br label %for.inc19
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.6_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u7_25fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !179 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %conv.u8_24fixp = shl i32 %factor, 24, !taffo.info !181
  %1 = lshr i32 %u7_25fixp, 1, !taffo.info !50
  %2 = lshr i32 %conv.u8_24fixp, 1, !taffo.info !181
  %3 = ashr i32 %1, 7, !taffo.info !50
  %4 = ashr i32 %2, 6, !taffo.info !181
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 17), !taffo.info !182
  %mul.u14_18fixp = shl i32 %5, 1, !taffo.info !185
  ...
  %7 = shl i32 %mul.u14_18fixp, 7, !taffo.info !185
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_2d.5_fixp(i32 noundef %n, i32 noundef %m, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !178 !taffo.funinfo !189 !taffo.sourceFunction !180 {
entry:
  br label %for.cond
...
for.body3:                                        ; preds = %for.cond1
  ...
  %4 = ashr i32 %2, 16, !taffo.info !181
  %5 = call i32 @llvm.smul.fix.i32(i32 %3, i32 %4, i32 7), !taffo.info !190
  %mul.u24_8fixp = shl i32 %5, 1, !taffo.info !193
  %6 = mul nsw i32 %i.0, %m, !taffo.info !82
  ...
  %7 = shl i32 %mul.u24_8fixp, 7, !taffo.info !193
...
!54 = !{double 0.000000e+00, double 0x405D55556084A516}
...
!160 = !{!"fixp", i32 -32, i32 14}
!161 = !{double 0.000000e+00, double 0x40FE093733333333}
!162 = !{!48, !161, i1 false, i2 -1}
!163 = distinct !{!163, !23}
!164 = !{!165, !52, i1 false, i2 -1}
!165 = !{!"fixp", i32 32, i32 24}
!166 = !{!167, !168, i1 false, i2 -1}
!167 = !{!"fixp", i32 -32, i32 23}
!168 = !{double 0.000000e+00, double 1.800000e+02}
!169 = !{!165, !168, i1 false, i2 -1}
!170 = !{!160, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 0x40D4A00007DD4413}
!172 = !{!48, !171, i1 false, i2 -1}
!173 = !{!48, !174, i1 false, i2 -1}
!174 = !{double 0.000000e+00, double 0x40FE2FAE01F75105}
!175 = distinct !{!175, !23}
!176 = distinct !{!176, !23}
!177 = distinct !{!177, !23}
...
!184 = !{double 0.000000e+00, double 1.536000e+04}
!185 = !{!186, !184, i1 false, i2 -1}
!186 = !{!"fixp", i32 32, i32 18}
!187 = distinct !{!187, !23}
!188 = distinct !{!188, !23}
!189 = !{i32 1, !16, i32 1, !78, i32 1, !47, i32 1, !88}
!190 = !{!191, !192, i1 false, i2 -1}
!191 = !{!"fixp", i32 -32, i32 7}
!192 = !{double 0.000000e+00, double 0x416907AE00000000}
!193 = !{!194, !192, i1 false, i2 -1}
!194 = !{!"fixp", i32 32, i32 8}
!195 = distinct !{!195, !23}
!196 = distinct !{!196, !23}
