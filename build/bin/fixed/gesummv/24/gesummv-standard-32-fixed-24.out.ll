; ModuleID = './build/bin/fixed/gesummv/24/gesummv-standard-32-fixed-24.out.ll.4.taffotmp.ll'
...
entry:
  ...
  %u5_27fixp = bitcast [16 x i32]* %arraydecay12.u5_27fixp to i32*, !taffo.info !48
  ...
  %u5_27fixp2 = bitcast [16 x i32]* %arraydecay13.u5_27fixp to i32*, !taffo.info !48
...
for.body:                                         ; preds = %for.cond
  ...
  %1 = fdiv float %0, 2.621440e+05, !taffo.info !54, !taffo.target !56
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.6_fixp(i32 noundef %n, i32* noundef %val.u14_18fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !88 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = shl i32 %mul.u19_13fixp, 5, !taffo.info !95
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 0, i32* %arrayidx.u13_19fixp, align 4, !taffo.info !108, !taffo.constinfo !109
  %arrayidx1.u14_18fixp = getelementptr inbounds i32, i32* %y.u14_18fixp, i32 %i.0, !taffo.info !54
  store i32 0, i32* %arrayidx1.u14_18fixp, align 4, !taffo.info !108, !taffo.constinfo !109
  br label %for.cond2
...
for.body4:                                        ; preds = %for.cond2
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 21), !taffo.info !110
  %mul.u10_22fixp = shl i32 %4, 1, !taffo.info !112
  ...
  %5 = lshr i32 %mul.u10_22fixp, 3, !taffo.info !112
  %add.u13_19fixp = add i32 %5, %u13_19fixp, !taffo.info !113
  ...
  %10 = call i32 @llvm.smul.fix.i32(i32 %8, i32 %9, i32 21), !taffo.info !110
  %mul13.u10_22fixp = shl i32 %10, 1, !taffo.info !112
  ...
  %11 = lshr i32 %mul13.u10_22fixp, 4, !taffo.info !112
  %add15.u14_18fixp = add i32 %11, %u14_18fixp, !taffo.info !115
...
for.end:                                          ; preds = %for.cond2
  ...
  %16 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %15, i32 16), !taffo.info !118
  %mul18.u15_17fixp = shl i32 %16, 1, !taffo.info !121
  ...
  %21 = call i32 @llvm.smul.fix.i32(i32 %19, i32 %20, i32 16), !taffo.info !123
  %mul20.u15_17fixp = shl i32 %21, 1, !taffo.info !125
  %add21.u15_17fixp = add i32 %mul18.u15_17fixp, %mul20.u15_17fixp, !taffo.info !126
  %arrayidx22.u14_18fixp = getelementptr inbounds i32, i32* %y.u14_18fixp, i32 %i.0, !taffo.info !54
  %22 = shl i32 %add21.u15_17fixp, 1, !taffo.info !126
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u13_19fixp, i32 noundef %factor) #0 !taffo.initweight !87 !taffo.funinfo !129 !taffo.sourceFunction !89 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 13), !taffo.info !130
  %mul.u18_14fixp = shl i32 %4, 1, !taffo.info !133
  %arrayidx1.u13_19fixp = getelementptr inbounds i32, i32* %val.u13_19fixp, i32 %i.0, !taffo.info !51
  %5 = shl i32 %mul.u18_14fixp, 5, !taffo.info !133
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 %4, i32* %arrayidx.u5_27fixp, align 4, !taffo.info !108
  %arrayidx4.u14_18fixp = getelementptr inbounds i32, i32* %y.u14_18fixp, i32 %i.0, !taffo.info !162
  store i32 0, i32* %arrayidx4.u14_18fixp, align 4, !taffo.info !108, !taffo.constinfo !109
  %arrayidx5.u13_19fixp = getelementptr inbounds i32, i32* %tmp.u13_19fixp, i32 %i.0, !taffo.info !163
  store i32 0, i32* %arrayidx5.u13_19fixp, align 4, !taffo.info !108, !taffo.constinfo !109
  br label %for.cond6
...
for.body9:                                        ; preds = %for.cond6
  ...
  store i32 %9, i32* %arrayidx15.u5_27fixp, align 4, !taffo.info !108
  ...
  store i32 %14, i32* %arrayidx23.u5_27fixp, align 4, !taffo.info !108
  br label %for.inc
...
!94 = !{double 0.000000e+00, double 0x4116A6667FFDE721}
...
!109 = !{!79, i1 false}
!110 = !{!100, !111, i1 false, i2 -1}
!111 = !{double 0.000000e+00, double 9.000000e+02}
!112 = !{!103, !111, i1 false, i2 -1}
!113 = !{!52, !114, i1 false, i2 -1}
!114 = !{double 0.000000e+00, double 5.412000e+03}
!115 = !{!55, !116, i1 false, i2 -1}
!116 = !{double 0.000000e+00, double 0x40C868667FFDE721}
!117 = distinct !{!117, !23}
!118 = !{!119, !120, i1 false, i2 -1}
!119 = !{!"fixp", i32 -32, i32 16}
!120 = !{double 0.000000e+00, double 6.768000e+03}
!121 = !{!122, !120, i1 false, i2 -1}
!122 = !{!"fixp", i32 32, i32 17}
!123 = !{!119, !124, i1 false, i2 -1}
!124 = !{double 0.000000e+00, double 0x40CB2E149997155B}
!125 = !{!122, !124, i1 false, i2 -1}
!126 = !{!122, !127, i1 false, i2 -1}
!127 = !{double 0.000000e+00, double 0x40D4330A4CCB8AAE}
!128 = distinct !{!128, !23}
!129 = !{i32 1, !75, i32 1, !51, i32 1, !84}
!130 = !{!131, !132, i1 false, i2 -1}
!131 = !{!"fixp", i32 -32, i32 13}
!132 = !{double 0.000000e+00, double 1.443840e+05}
!133 = !{!134, !132, i1 false, i2 -1}
!134 = !{!"fixp", i32 32, i32 14}
!135 = distinct !{!135, !23}
