; ModuleID = './build/bin/fixed/symm/16/symm-standard-64-fixed-16.out.ll.2.taffotmp.ll'
...
@.str.3 = private unnamed_addr constant [48 x i8] c"target('C') scalar(range(0.0,175173.125) final)\00", section "llvm.metadata", !taffo.info !4
@.str.4 = private unnamed_addr constant [41 x i8] c"scalar(range(-63936.0,115.199997) final)\00", section "llvm.metadata", !taffo.info !0
@.str.5 = private unnamed_addr constant [31 x i8] c"scalar(range(6.4,160.0) final)\00", section "llvm.metadata", !taffo.info !0
...
entry:
  ...
  call void @scale_2d.5(i32 noundef 10, i32 noundef 16, float* noundef %0, i32 noundef 64), !taffo.initweight !65, !taffo.info !53, !taffo.target !54, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.6(i32 noundef 10, i32 noundef 10, float* noundef %1, i32 noundef 64), !taffo.initweight !65, !taffo.info !55, !taffo.originalCall !66, !taffo.constinfo !67
  ...
  call void @scale_2d.7(i32 noundef 10, i32 noundef 16, float* noundef %2, i32 noundef 64), !taffo.initweight !65, !taffo.info !57, !taffo.originalCall !66, !taffo.constinfo !67
...
!7 = !{double 0.000000e+00, double 0x4105622900000000}
...
!56 = !{double -6.393600e+04, double 0x405CCCCCC0379314}
!57 = !{i1 false, !58, i1 false, i2 -1}
!58 = !{double 6.400000e+00, double 1.600000e+02}
!59 = !{i32 1}
...
!121 = !{double 6.400000e+01, double 6.400000e+01}
...
!126 = !{double 0xC163830000000000, double 0x40D1FFFFF822BBEC}
!127 = !{i32 6}
!128 = !{i32 7}
!129 = !{i1 false, !130, i1 false, i2 -1}
!130 = !{double 0x4023333333333334, double 2.400000e+02}
!131 = !{i1 false, !132, i1 false, i2 -1}
!132 = !{double 0xC16D448000000000, double 0x40DAFFFFF43419E3}
!133 = !{i1 false, !134, i1 false, i2 -1}
!134 = !{double 0xC16D448000000000, double 0x4108C228FE86833C}
!135 = !{i32 8}
!136 = !{i1 false, !126, i1 false, i2 -1}
!137 = !{i32 9}
!138 = distinct !{!138, !29}
!139 = !{i1 false, !140, i1 false, i2 -1}
!140 = !{double 0.000000e+00, double 0x4109A8FE00000000}
!141 = !{i1 false, !142, i1 false, i2 -1}
!142 = !{double 0xC16D448000000000, double 0x410D08FDFE86833C}
!143 = !{i1 false, !144, i1 false, i2 -1}
!144 = !{double 0xC16D448000000000, double 0x40DAFFFFF43419E2}
!145 = !{i1 false, !146, i1 false, i2 -1}
!146 = !{double 0xC17D448000000000, double 0x4110347EFE86833C}
!147 = distinct !{!147, !29}
!148 = distinct !{!148, !29}
...
!174 = !{double 0.000000e+00, double 0x4165622900000000}
!175 = distinct !{!175, !29}
!176 = distinct !{!176, !29}
!177 = !{i32 1, !22, i32 1, !22, i32 1, !55, i32 1, !120}
!178 = !{i1 false, !179, i1 false, i2 -1}
!179 = !{double 0xC14F380000000000, double 0x40BCCCCCC0379314}
!180 = distinct !{!180, !29}
!181 = distinct !{!181, !29}
!182 = !{i32 1, !22, i32 1, !110, i32 1, !57, i32 1, !120}
!183 = !{i1 false, !184, i1 false, i2 -1}
!184 = !{double 4.096000e+02, double 1.024000e+04}
!185 = distinct !{!185, !29}
!186 = distinct !{!186, !29}
