; ModuleID = './build/bin/fixed/gemver/24/gemver-standard-8-fixed-24.out.ll'
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.3_fixp(i32 noundef %n, i32* noundef %val.u4_28fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !119 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %u4_28fixp = load i32, i32* %arrayidx.u4_28fixp, align 4, !taffo.info !121
  %conv.u6_26fixp = shl i32 %factor, 26, !taffo.info !123
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !121
  %1 = lshr i32 %conv.u6_26fixp, 1, !taffo.info !123
  %2 = ashr i32 %0, 2, !taffo.info !121
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 25), !taffo.info !124
  %mul.u6_26fixp = shl i32 %3, 1, !taffo.info !127
  %arrayidx1.u4_28fixp = getelementptr inbounds i32, i32* %val.u4_28fixp, i32 %i.0, !taffo.info !54
  %4 = shl i32 %mul.u6_26fixp, 2, !taffo.info !127
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.7_fixp(i32 noundef %n, i32* noundef %val.u17_15fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !129 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u4_28fixp = shl i32 %factor, 28, !taffo.info !130
  %0 = lshr i32 %u17_15fixp, 1, !taffo.info !64
  %1 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !130
  %2 = ashr i32 %0, 3, !taffo.info !64
  %3 = ashr i32 %1, 16, !taffo.info !130
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 11), !taffo.info !131
  %mul.u20_12fixp = shl i32 %4, 1, !taffo.info !134
  %arrayidx1.u17_15fixp = getelementptr inbounds i32, i32* %val.u17_15fixp, i32 %i.0, !taffo.info !64
  %5 = shl i32 %mul.u20_12fixp, 3, !taffo.info !134
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.4_fixp(i32 noundef %n, i32* noundef %val.u2_30fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !137 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %conv.u5_27fixp = shl i32 %factor, 27, !taffo.info !138
  %0 = lshr i32 %u2_30fixp, 1, !taffo.info !57
  %1 = lshr i32 %conv.u5_27fixp, 1, !taffo.info !138
  %2 = ashr i32 %0, 3, !taffo.info !57
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 26), !taffo.info !139
  %mul.u5_27fixp = shl i32 %3, 1, !taffo.info !142
  %arrayidx1.u2_30fixp = getelementptr inbounds i32, i32* %val.u2_30fixp, i32 %i.0, !taffo.info !57
  %4 = shl i32 %mul.u5_27fixp, 3, !taffo.info !142
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.9_fixp(i32 noundef %n, i32* noundef %val.u1_31fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !144 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 27), !taffo.info !145
  %mul.u4_28fixp = shl i32 %3, 1, !taffo.info !148
  %arrayidx1.u1_31fixp = getelementptr inbounds i32, i32* %val.u1_31fixp, i32 %i.0, !taffo.info !69
  %4 = shl i32 %mul.u4_28fixp, 3, !taffo.info !148
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.8_fixp(i32 noundef %n, i32* noundef %val.u8_24fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !150 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = ashr i32 %1, 7, !taffo.info !130
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 20), !taffo.info !151
  %mul.u11_21fixp = shl i32 %4, 1, !taffo.info !154
  %arrayidx1.u8_24fixp = getelementptr inbounds i32, i32* %val.u8_24fixp, i32 %i.0, !taffo.info !67
  %5 = shl i32 %mul.u11_21fixp, 3, !taffo.info !154
...
; Function Attrs: noinline nounwind uwtable
define internal void @scale_1d.5_fixp(i32 noundef %n, i32* noundef %val.u3_29fixp, i32 noundef %factor) #0 !taffo.initweight !118 !taffo.funinfo !157 !taffo.sourceFunction !120 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %1, i32 25), !taffo.info !158
  %mul.u6_26fixp = shl i32 %3, 1, !taffo.info !160
  %arrayidx1.u3_29fixp = getelementptr inbounds i32, i32* %val.u3_29fixp, i32 %i.0, !taffo.info !59
  %4 = shl i32 %mul.u6_26fixp, 3, !taffo.info !160
...
for.body3:                                        ; preds = %for.cond1
  ...
  %u5_27fixp = load i32, i32* %arrayidx4.u5_27fixp, align 4, !taffo.info !165
  %arrayidx5.u4_28fixp = getelementptr inbounds i32, i32* %u1.u4_28fixp, i32 %i.0, !taffo.info !54
  %u4_28fixp = load i32, i32* %arrayidx5.u4_28fixp, align 4, !taffo.info !166
  ...
  %0 = lshr i32 %u4_28fixp, 1, !taffo.info !166
  %1 = lshr i32 %u2_30fixp, 1, !taffo.info !57
  %2 = ashr i32 %0, 2, !taffo.info !166
  %3 = ashr i32 %1, 4, !taffo.info !57
  %4 = call i32 @llvm.smul.fix.i32(i32 %2, i32 %3, i32 25), !taffo.info !167
  %mul.u6_26fixp = shl i32 %4, 1, !taffo.info !169
  %5 = lshr i32 %u5_27fixp, 1, !taffo.info !165
  %add.u6_26fixp = add i32 %5, %mul.u6_26fixp, !taffo.info !170
  ...
  %u2_30fixp1 = load i32, i32* %arrayidx8.u2_30fixp, align 4, !taffo.info !172
  %6 = lshr i32 %u3_29fixp, 1, !taffo.info !59
  %7 = lshr i32 %u2_30fixp1, 1, !taffo.info !172
  %8 = ashr i32 %7, 1, !taffo.info !172
  %9 = call i32 @llvm.smul.fix.i32(i32 %6, i32 %8, i32 28), !taffo.info !173
  %mul9.u3_29fixp = shl i32 %9, 1, !taffo.info !176
  %10 = lshr i32 %mul9.u3_29fixp, 3, !taffo.info !176
  %add10.u6_26fixp = add i32 %add.u6_26fixp, %10, !taffo.info !177
  ...
  %11 = shl i32 %add10.u6_26fixp, 1, !taffo.info !177
...
for.body21:                                       ; preds = %for.cond19
  ...
  %15 = call i32 @llvm.smul.fix.i32(i32 %14, i32 %13, i32 26), !taffo.info !181
  %mul25.u5_27fixp = shl i32 %15, 1, !taffo.info !183
  ...
  %16 = lshr i32 %mul25.u5_27fixp, 1, !taffo.info !183
  %17 = lshr i32 %u1_31fixp, 1, !taffo.info !69
  %18 = ashr i32 %17, 4, !taffo.info !69
  %19 = call i32 @llvm.smul.fix.i32(i32 %16, i32 %18, i32 26), !taffo.info !181
  %mul27.u5_27fixp = shl i32 %19, 1, !taffo.info !183
  %20 = lshr i32 %mul27.u5_27fixp, 3, !taffo.info !183
  %add28.u8_24fixp = add i32 %u8_24fixp, %20, !taffo.info !184
...
for.body38:                                       ; preds = %for.cond36
  ...
  %add41.u8_24fixp = add i32 %u8_24fixp2, %21, !taffo.info !188
...
for.body51:                                       ; preds = %for.cond49
  ...
  %u5_27fixp6 = load i32, i32* %arrayidx54.u5_27fixp, align 4, !taffo.info !165
  %22 = lshr i32 %alpha.u2_30fixp, 1, !taffo.info !47
  %23 = lshr i32 %u5_27fixp6, 1, !taffo.info !165
  %24 = ashr i32 %22, 4, !taffo.info !47
  %25 = ashr i32 %23, 1, !taffo.info !165
  %26 = call i32 @llvm.smul.fix.i32(i32 %24, i32 %25, i32 25), !taffo.info !191
  %mul55.u6_26fixp = shl i32 %26, 1, !taffo.info !193
  ...
  %27 = lshr i32 %mul55.u6_26fixp, 1, !taffo.info !193
  %28 = lshr i32 %u8_24fixp3, 1, !taffo.info !67
  %29 = ashr i32 %27, 7, !taffo.info !193
  %30 = ashr i32 %28, 5, !taffo.info !67
  %31 = call i32 @llvm.smul.fix.i32(i32 %29, i32 %30, i32 18), !taffo.info !194
  %mul57.u13_19fixp = shl i32 %31, 1, !taffo.info !197
  %32 = lshr i32 %mul57.u13_19fixp, 4, !taffo.info !197
  %add58.u17_15fixp = add i32 %u17_15fixp, %32, !taffo.info !199
...
; Function Attrs: noinline nounwind uwtable
define internal void @init_array.12_fixp(i32 noundef %n, i32* noundef %alpha.u2_30fixp, i32* noundef %beta.u2_30fixp, [20 x i32]* noundef %A.u5_27fixp, i32* noundef %u1.u4_28fixp, i32* noundef %v1.u2_30fixp, i32* noundef %u2.u3_29fixp, i32* noundef %v2.u2_30fixp, i32* noundef %w.u17_15fixp, i32* noundef %x.u8_24fixp, i32* noundef %y.u1_31fixp, i32* noundef %z.u1_31fixp) #0 !taffo.initweight !203 !taffo.funinfo !163 !taffo.sourceFunction !204 {
entry:
...
for.body3:                                        ; preds = %for.cond1
  ...
  %2 = lshr i32 %conv.u4_28fixp, 1, !taffo.info !130
  %3 = ashr i32 %1, 3, !taffo.info !52
  %4 = ashr i32 %2, 4, !taffo.info !130
...
!121 = !{!122, !56, i1 false, i2 -1}
!122 = !{!"fixp", i32 32, i32 26}
!123 = !{!122, !116, i1 false, i2 1}
!124 = !{!125, !126, i1 false, i2 -1}
!125 = !{!"fixp", i32 -32, i32 25}
!126 = !{double 0.000000e+00, double 6.080000e+01}
!127 = !{!122, !126, i1 false, i2 -1}
!128 = distinct !{!128, !27}
!129 = !{i32 1, !103, i32 1, !64, i32 1, !115}
!130 = !{!55, !116, i1 false, i2 1}
!131 = !{!132, !133, i1 false, i2 -1}
!132 = !{!"fixp", i32 -32, i32 11}
!133 = !{double 0.000000e+00, double 0x41201ADA40000000}
!134 = !{!135, !133, i1 false, i2 -1}
!135 = !{!"fixp", i32 32, i32 12}
!136 = distinct !{!136, !27}
!137 = !{i32 1, !103, i32 1, !57, i32 1, !115}
!138 = !{!53, !116, i1 false, i2 1}
!139 = !{!140, !141, i1 false, i2 -1}
!140 = !{!"fixp", i32 -32, i32 26}
!141 = !{double 8.000000e-01, double 1.600000e+01}
!142 = !{!53, !141, i1 false, i2 -1}
!143 = distinct !{!143, !27}
!144 = !{i32 1, !103, i32 1, !69, i32 1, !115}
!145 = !{!146, !147, i1 false, i2 -1}
!146 = !{!"fixp", i32 -32, i32 27}
!147 = !{double 4.000000e-01, double 8.000000e+00}
!148 = !{!55, !147, i1 false, i2 -1}
!149 = distinct !{!149, !27}
!150 = !{i32 1, !103, i32 1, !67, i32 1, !115}
!151 = !{!152, !153, i1 false, i2 -1}
!152 = !{!"fixp", i32 -32, i32 20}
!153 = !{double 0.000000e+00, double 0x409A5F011F4F50A0}
!154 = !{!155, !153, i1 false, i2 -1}
!155 = !{!"fixp", i32 32, i32 21}
!156 = distinct !{!156, !27}
!157 = !{i32 1, !103, i32 1, !59, i32 1, !115}
!158 = !{!125, !159, i1 false, i2 -1}
!159 = !{double 1.600000e+00, double 3.200000e+01}
!160 = !{!122, !159, i1 false, i2 -1}
!161 = distinct !{!161, !27}
!162 = !{i32 -1, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2}
!163 = !{i32 1, !103, i32 1, !47, i32 1, !50, i32 1, !52, i32 1, !54, i32 1, !57, i32 1, !59, i32 1, !62, i32 1, !64, i32 1, !67, i32 1, !69, i32 1, !72}
!164 = distinct !{null}
!165 = !{!122, !5, i1 false, i2 -1}
!166 = !{!53, !56, i1 false, i2 -1}
!167 = !{!125, !168, i1 false, i2 -1}
!168 = !{double 0.000000e+00, double 1.520000e+01}
!169 = !{!122, !168, i1 false, i2 -1}
!170 = !{!122, !171, i1 false, i2 -1}
!171 = !{double 0.000000e+00, double 0x40422AAAB8A5CE5B}
!172 = !{!60, !63, i1 false, i2 -1}
!173 = !{!174, !175, i1 false, i2 -1}
!174 = !{!"fixp", i32 -32, i32 28}
!175 = !{double 0x3F8B4E8AA78E4EE4, double 0x40155554FBDAD752}
!176 = !{!60, !175, i1 false, i2 -1}
!177 = !{!122, !178, i1 false, i2 -1}
!178 = !{double 0x3F8B4E8AA78E4EE4, double 0x4044D55558212945}
!179 = distinct !{!179, !27}
!180 = distinct !{!180, !27}
!181 = !{!140, !182, i1 false, i2 -1}
!182 = !{double 0.000000e+00, double 0x40395C2917507E9D}
!183 = !{!53, !182, i1 false, i2 -1}
!184 = !{!68, !185, i1 false, i2 -1}
!185 = !{double 0.000000e+00, double 0x406D8A8642396074}
!186 = distinct !{!186, !27}
!187 = distinct !{!187, !27}
!188 = !{!68, !189, i1 false, i2 -1}
!189 = !{double 4.444400e-02, double 0x406A7B72E6A76966}
!190 = distinct !{!190, !27}
!191 = !{!125, !192, i1 false, i2 -1}
!192 = !{double 0.000000e+00, double 0x403FB3335D249E44}
!193 = !{!122, !192, i1 false, i2 -1}
!194 = !{!195, !196, i1 false, i2 -1}
!195 = !{!"fixp", i32 -32, i32 18}
!196 = !{double 0.000000e+00, double 0x40BA1FB6D8C80C3E}
!197 = !{!198, !196, i1 false, i2 -1}
!198 = !{!"fixp", i32 32, i32 19}
!199 = !{!65, !200, i1 false, i2 -1}
